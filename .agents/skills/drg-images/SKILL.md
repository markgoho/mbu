...
**Uniform rule:** When an image depicts Scouts or teenagers in a Scouting context (meetings, service projects, badge activities, interviews with professionals), **default to describing them in a clean Scout uniform** unless the activity calls for more appropriate clothing. If the activity would genuinely damage a uniform, requires getting wet, involves wading, swimming, boating, muddy conditions, heavy exertion, protective outerwear, or otherwise demands activity-specific clothing for safety or realism, describe Scouts in appropriate non-uniform clothing instead. Scout uniforms must always appear clean and presentable — no paint, mud, stains, water-soaking, or visible wear. Never depict the uniform as dirty, soaked, damaged, or used where impractical.
