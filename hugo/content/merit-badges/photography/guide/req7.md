...
{{< drg/inherited-requirement number="7a" req_path="7.a" topic="Plan the images you need to photograph for your photo story." />}}
...
{{< drg/download
    ...
    url="/merit-badges/photography/guide/photo-story-planning-worksheet/"
    type="printable" >}}

## Official Resources

{{< drg/video
    title="Storytelling in Photography (video)"
    url="https://youtu.be/UtMXpomDWlk?si=Zo4DOxTQMgshkjFA" >}}

## Requirement 7b

{{< drg/inherited-requirement number="7b" req_path="7.b" topic="Share your plan with your counselor, and get your counselor's input and approval before you proceed." />}}
...
{{< drg/inherited-requirement number="7c" req_path="7.c" topic="Select eight to 12 images that best tell your story. Arrange your images in order and mount the prints on a poster board, OR create an electronic presentation. Share your visual story with your counselor." />}}
...
{{< drg/checklist title="Build a Strong Photo Story" subtitle="What your final sequence should include" >}}
...
{{< drg/video
    title="How to Make a PowerPoint Photo Slideshow (video)"
    url="https://youtu.be/G-qyX_Ri17M?si=mFi7rrxZa1KDlNrT" >}}
...
{{< drg/next-page
    text="Finish the badge by looking ahead to where photography can lead."
    teaser="The final requirement explores real photography careers and how someone prepares for them."
