...
{{< drg/image src="images/camera-parts-labeled.avif" alt="Diagram of a digital camera with major parts labeled, including lens, shutter button, mode dial, flash, sensor, memory card slot, and screen" >}}

{{< drg/checklist title="Know These Controls" subtitle="You should be able to point to these on your own camera" >}}
...
1. The camera meters the light in the scene.
2. It focuses on the chosen subject area.
3. The aperture sets how wide the lens opening should be.
4. The shutter opens for the selected time.
5. Light hits the sensor.
6. The camera processes that light into an image file.
7. The file is saved to the memory card.
...
This connects directly to [Req 2](/merit-badges/photography/guide/req2/), where you learned how light, aperture, shutter speed, ISO, and composition affect the result.

{{< drg/tip >}}
If your camera has both automatic and manual-style modes, start by learning what the camera chooses in auto. Then compare that to what happens when you change just one setting at a time.
{{< /drg/tip >}}

{{< drg/did-you-know >}}
The word "camera" comes from the Latin phrase *camera obscura*, meaning "dark chamber." Long before digital cameras existed, people used dark rooms and tiny openings to project outside scenes onto a surface.
{{< /drg/did-you-know >}}
...
{{< drg/video
    title="Parts of a Camera (video)"
    url="https://youtu.be/BsSjEhktkzU" >}}

{{< drg/video
    title="How Digital Cameras Work (video)"
    url="https://youtu.be/Ey6S3rKH_o4" >}}

Understanding the camera makes the next set of photo exercises much easier.

{{< drg/next-page
    text="Now use what you know by choosing two hands-on photo experiments."
    teaser="You will compare angle, light, focus, and composition by photographing the same subject in different ways."
