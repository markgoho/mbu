...
{{< drg/tip >}}
If one career interests you, research what a normal workday looks like. Loving photography is important, but it also helps to know whether you enjoy the pace, clients, travel, deadlines, or technical demands of that specific job.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Top 10 Careers For Photographers (video)"
    url="https://youtu.be/fEp_EDQE0IM?si=4IIC3sAbXyD1_6tK" >}}

{{< drg/external-link
    title="Indeed Career Guide (website)"
    url="https://www.indeed.com/career-advice/finding-a-job/list-of-careers-in-photography"
    description="A broad overview of photography-related careers, including what the work involves and where the jobs appear." >}}

You have now covered the full badge. The next page goes beyond the requirements and suggests ways to keep growing as a photographer.

{{< drg/next-page
    text="You finished the badge requirements."
    teaser="Head to Extended Learning for ideas that can keep photography part of your life long after the badge is complete."
