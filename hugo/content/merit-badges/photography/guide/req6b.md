...
{{< drg/tip >}}
If people start looking orange, gray, or unnatural, you have probably gone too far. The best corrections often feel almost invisible because they make the image look right, not edited.
{{< /drg/tip >}}

When you present your work, describe the problem in the original image and the exact fix you made.

{{< drg/next-page
    text="If your photo needs a different kind of improvement, there is one more option."
    teaser="The next page covers other editing choices that can strengthen impact."
