...
{{< drg/checklist title="Choose the Right Approach" subtitle="Match the style to the moment" >}}
...
{{< drg/tip >}}
Talk to your subject if the photo is not truly candid. A short, respectful conversation often improves the picture and helps the person feel comfortable.
{{< /drg/tip >}}

The next requirement moves from capturing the image to improving it after the shot.

{{< drg/next-page
    text="Now that you have created several photographs, learn how editing software can strengthen one of them."
    teaser="The next section helps you choose one editing path and explain why it improved the image."
