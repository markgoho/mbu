...
req_number: "4c"
req_path: "4.c"
prev: "/merit-badges/photography/guide/req4b/"
prev_title: "Change the Light"
next: "/merit-badges/photography/guide/req4d/"
next_title: "Change the Composition"
---
...
{{< drg/tip >}}
If your phone offers portrait mode, try that for the shallow-focus shot and normal photo mode for the deeper-focus shot. Then compare what details disappear and what details stay readable.
{{< /drg/tip >}}

When you share your work, explain which version is better for isolation and which is better for context.

{{< drg/next-page
    text="One more option changes not the light or focus, but the visual design."
    teaser="The next page asks you to photograph one subject using two different compositional techniques."
