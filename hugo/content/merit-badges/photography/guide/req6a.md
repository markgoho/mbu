...
{{< drg/checklist title="Smart Cropping Questions" subtitle="Ask these before you save the edited version" >}}
...
{{< drg/next-page
    text="Another common fix is correcting brightness or color."
    teaser="The next option focuses on exposure and color correction."
