...
{{< drg/inherited-requirement number="2a" req_path="2.a" topic="Light—natural light (ambient/existing), low light (such as at night), and artificial light (such as from a flash)" />}}
...
{{< drg/tip >}}
When a photo looks boring, first ask whether the problem is really the subject or just the light. Turning your subject toward a window can improve a picture more than changing the camera.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Golden Hour Magic: Perfect Light for Stunning Photos (video)"
    url="https://youtu.be/FWcOshGthBI?si=Ft8P8g7G36BnSSle" >}}

{{< drg/video
    title="Artificial Lighting for Photography (So Much Easier Than You Think!) (video)"
    url="https://youtu.be/Z9znfhFQPbE?si=iynxep4eY2ZuuzNY" >}}

{{< drg/video
    title="Why Most Natural Light Photography is Flat (and How to Fix It) (video)"
    url="https://youtu.be/VgT4O6CclfA?si=Gw4HDf3VeGxeE6z7" >}}

## Requirement 2b

{{< drg/inherited-requirement number="2b" req_path="2.b" topic="Exposure—aperture (f-stops), shutter speed, ISO" />}}
...
{{< drg/video
    title="Iso, Shutter Speed and Aperture Explained | Exposure Basics for Beginners (video)"
    url="https://youtu.be/Edvpu_939l4?si=lFqGf0-AJuUJR-v-" >}}

{{< drg/video
    title="Photography Basics in 10 Minutes (video)"
    url="https://youtu.be/V7z7BAZdt2M?si=0XATnG-lMciqFgr0" >}}

## Requirement 2c

{{< drg/inherited-requirement number="2c" req_path="2.c" topic="Depth of field" />}}
...
{{< drg/image src="images/depth-of-field-comparison.avif" alt="Side-by-side comparison of the same subject with shallow depth of field and deep depth of field" >}}

## Official Resources

{{< drg/video
    title="Depth of Field in 30 Seconds (video)"
    url="https://youtube.com/shorts/98B3dvdAX6c?si=a6zX8YPAisVYAszi" >}}

## Requirement 2d

{{< drg/inherited-requirement number="2d" req_path="2.d" topic="Composition—rule of thirds, leading lines, framing, depth" />}}
...
{{< drg/video
    title="Basic Photography | Composition: The Only Rules You Need to Know (video)"
    url="https://youtu.be/eImryR3yKz8?si=ITbUmVHQYD9gR72Y" >}}

{{< drg/video
    title="Photography Composition: Master Leading Lines for Stunning Shots! (video)"
    url="https://youtu.be/2uAYj6WScJQ?si=SrzE5OUdOVWWH65y" >}}

{{< drg/video
    title="Master the Rule of Thirds for Better Photos (video)"
    url="https://youtube.com/shorts/Z1Wb8ZH0uvc?si=e6TjeQIgyqaYBcUr" >}}

## Requirement 2e

{{< drg/inherited-requirement number="2e" req_path="2.e" topic="Angle of view" />}}
...
{{< drg/video
    title="Angle of View and Framing (video)"
    url="https://youtu.be/9SZy4ptc5ws?si=SfIb8MuYpZziiVaW" >}}

## Requirement 2f

{{< drg/inherited-requirement number="2f" req_path="2.f" topic="Stop action and blur motion" />}}
...
{{< drg/be-prepared title="Trying to Photograph Motion?" >}}

- **Start in good light.** Bright conditions make it easier to use the shutter speed you want.
- **Take several frames.** Timing changes by fractions of a second.
- **Brace yourself.** If you want only the subject blurred, keep the camera as steady as possible.
- **Practice panning.** Move the camera with the subject to keep the subject sharper while the background streaks.
{{< /drg/be-prepared >}}

## Official Resources

{{< drg/video
    title="How to Shoot Motion Blur Photography Like a Pro (video)"
    url="https://youtu.be/5h4J8nZn1Sw?si=n6r01F0XG_ncDOxH" >}}

{{< drg/video
    title="Photography Tips: How to Do Stop Action Photography (video)"
    url="https://youtu.be/YtkIsA4VdRw?si=T0IV9u60N-evsqrl" >}}

## Requirement 2g

{{< drg/inherited-requirement number="2g" req_path="2.g" topic="Decisive moment (action or expression captured by the photographer)" />}}
...
{{< drg/video
    title="Decisive Moment (video)"
    url="https://youtu.be/meeqJ58eSzk?si=lxhdmU83SSLCDxvw" >}}

## Camera Setting Guides

{{< drg/external-link
    title="Easy to Understand Guide to Camera Settings for Beginners (website)"
    url="https://shotkit.com/camera-settings/"
    description="A plain-language overview of common settings and how they affect brightness, focus, and motion." >}}

{{< drg/external-link
    title="Common Camera Settings for Beginners (website)"
    url="https://photographylife.com/common-camera-settings#camera-setup"
    description="A detailed beginner guide to camera settings, with examples of when to adjust each one." >}}

By now you know the words photographers use when they talk about why a picture worked.

{{< drg/next-page
    text="Next, connect those ideas to the actual buttons and parts on your camera."
    teaser="You will learn what each main camera part does and how a real exposure is made."
