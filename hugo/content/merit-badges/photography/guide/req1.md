...
{{< drg/checklist title="Photo Safety Scan" subtitle="Ask these questions before every shoot" >}}
...
{{< drg/safety-first >}}
Never climb onto railroad tracks, roofs, ledges, or unsafe structures for a better photo. If a location would be dangerous without a camera, it is still dangerous with one.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
A simple neck strap or wrist strap prevents many dropped-camera accidents. Use it whenever you are near hard ground, water, or crowds.
{{< /drg/tip >}}

## Official Resources

{{< drg/external-link
    title="Is Photography a Dangerous Career? (website)"
    url="https://www.coverhound.com/insurance-learning-center/is-photography-a-dangerous-career"
    description="A practical look at common photography risks, from lifting gear to working on location." >}}

{{< drg/external-link
    title="Health and Safety in a Photography Studio (website)"
    url="https://thephotocove.com/health-and-safety-in-a-photography-studio/"
    description="Useful reminders about cords, light stands, electrical safety, and keeping a shooting space organized." >}}

{{< drg/external-link
    title="9 Safety Tips for Landscape and Nature Photographers (website)"
    url="https://loadedlandscapes.com/safety-tips-nature-photography/"
    description="Outdoor-specific advice for weather, terrain, wildlife awareness, and remote shooting conditions." >}}

## Requirement 1b

{{< drg/inherited-requirement number="1b" req_path="1.b" topic="View the Personal Safety Awareness \"Digital Safety\" video (with your parent or guardian's permission)." />}}
...
{{< drg/checklist title="Before You Share a Photo" subtitle="Use this quick digital-safety test" >}}
...
{{< drg/external-link
    ...
    description="Scouting America's youth-protection page that hosts the Digital Safety training context for Scouts and families." >}}

{{< drg/external-link
    title="Digital Safety (video)"
    url="https://filestore.scouting.org/filestore/YPSAT/YT%20Mod1%20Final%20Master%20Small.mp4"
    description="The official Scouting America Digital Safety video required for this badge." >}}

Knowing how to photograph safely will help with every picture you take for the rest of the badge.

{{< drg/next-page
    text="Now that you can think like a safe photographer, start learning how light, exposure, and timing change a picture."
    teaser="The next requirement explains the camera choices that make a photo bright, sharp, dramatic, or blurry on purpose."
