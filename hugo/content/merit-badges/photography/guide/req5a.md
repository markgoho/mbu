...
{{< drg/tip >}}
A close-up does not mean you must cut off the top of the head or crop awkwardly. Leave enough space so the framing feels intentional, not accidental.
{{< /drg/tip >}}

If you share this image with your counselor, explain what you wanted the viewer to notice first.

{{< drg/next-page
    text="Next, try photographing more than one person at once."
    teaser="The next option is about showing interaction instead of a single face."
