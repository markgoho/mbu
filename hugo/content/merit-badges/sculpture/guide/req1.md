...
{{< drg/checklist title="Safe setup before you begin" subtitle="Do these things before the first cut, mix, or sculpting session" >}}
...
{{< drg/safety-first >}}
Never try to hold a piece in one hand while cutting forcefully toward that hand with the other. Clamp, brace, or stabilize the material first. A rushed cut is one of the easiest ways to turn an art project into an emergency.
{{< /drg/safety-first >}}

{{< drg/image src="images/sculpture-tool-safety-layout.avif" alt="Carving tools laid out beside goggles, gloves, and a properly braced workpiece with arrows showing safe cutting direction" >}}
...
{{< drg/video
    title="Working Safely With Clay & DIY Modeling Tools (video)"
    url="https://youtu.be/-fX0YeZnEME?si=suWmdxmEVZaWz3L2" >}}
...
{{< drg/external-link
    title="The Essential Rules of Clay Safety: What You Need to Know (website)"
    url="https://artabys.com/the-essential-rules-of-clay-safety-what-you-need-to-know/"
    description="A Scout-friendly overview of clay dust, ventilation, cleanup, and studio habits that support the safety points in this requirement." >}}

{{< drg/tip >}}
When you explain this requirement to your counselor, organize your answer by hazard: sharp tools, dust and fumes, heat, and general cleanup. That makes it easier to show that you understand the reason behind each precaution.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If your project suddenly feels unsafe" >}}
Stop and reset instead of trying to "push through."

- **Tool slipping?** Put it down and secure the workpiece better.
- **Dust in the air?** Stop sanding or scraping until you have the right respiratory protection and ventilation.
- **Material heating, smoking, or smelling wrong?** Step back and get an adult immediately.
- **Hands covered in clay, plaster, or paint?** Clean up before touching your face, phone, food, or other surfaces.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have the safety habits that every sculpture project depends on."
    teaser="Choose the two project paths that fit your interests, tools, and time."
