...
- **[Req 2a — Head and Figure Study](/merit-badges/sculpture/guide/req2a/)**: Build observation and modeling skills by shaping a life-size clay head and then making a smaller animal or person. This option teaches proportion, structure, and how sculptors use tools to refine form.
- **[Req 2b — Mold and Cast](/merit-badges/sculpture/guide/req2b/)**: Learn the basic idea behind mold making by creating a plaster mold of a fruit or vegetable and using it to make a copy. This option teaches planning, surface detail, and the difference between an original form and a cast.
- **[Req 2c — Art in Public and Community Life](/merit-badges/sculpture/guide/req2c/)**: Visit a museum, gallery, co-op, exhibit, or studio and then discuss what you learned. This option teaches close looking, art vocabulary, and how visual art supports culture, empathy, and community life.

## How to Choose

{{< drg/checklist title="Choosing your two options" subtitle="Think about tools, access, and what you most want to learn" >}}
...
{{< drg/tip >}}
Choose two options that stretch different skills. A Scout who only picks hands-on making may miss the chance to practice discussing art, while a Scout who only thinks about visiting spaces may miss the chance to solve material problems with their hands.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have compared the three project paths and know you must complete two."
    teaser="Start with the option that teaches careful observation through a life-size head and a smaller figure study."
