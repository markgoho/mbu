...
- foundry worker or mold maker
- museum curator or conservator
- art teacher or museum educator
- gallery owner or art consultant
- art critic or reviewer
...
{{< drg/checklist title="Questions your career research should answer" subtitle="These are the key parts your counselor expects you to cover" >}}
...
{{< drg/external-link
    title="12 Careers for Sculptors (website)"
    url="https://www.indeed.com/career-advice/finding-a-job/careers-for-sculptors"
    description="A useful overview of sculpture-related roles that can help you narrow your research to one realistic career path." >}}
...
{{< drg/tip >}}
If salary numbers vary a lot by region or experience level, mention the range instead of pretending there is one single answer. That shows you did real research.
{{< /drg/tip >}}
...
{{< drg/video
    title="How To Become an Artist/Sculptor (video)"
    url="https://youtu.be/N6HeVopwRmQ?si=YJyPrJ4CvPLj9cx0" >}}

{{< drg/video
    title="Craft Artist Careers (video)"
    url="https://youtu.be/T_X9ZdUq-2Q?si=p0lV3ApJiQH0OqXe" >}}
...
{{< drg/be-prepared title="If you cannot interview someone directly" >}}
You can still do strong research by combining sources.

- Use the official resources and a library or school career database.
- Look for museum, school, foundry, or artist websites that describe staff roles.
- Compare more than one source so you do not rely on a single salary claim or job description.
- Bring notes with source names so you can show your counselor where your information came from.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have a framework for researching a sculpture-related profession in a realistic way."
    teaser="Now look at the other path: building sculpture into your life as a serious, sustainable hobby."
