---
title: "Your Ethical Guidelines"
layout: guide
group_title: "4. Ethics in AI"
req_number: "4c"
prev: "/merit-badges/artificial-intelligence/guide/req4b/"
prev_title: "What Would You Do?"
next: "/merit-badges/artificial-intelligence/guide/req4d/"
next_title: "The Turing Test"
---
...
{{< drg/tip >}}
Look at the Scout Law for inspiration. "A Scout is trustworthy, loyal, helpful, friendly, courteous, kind, obedient, cheerful, thrifty, brave, clean, and reverent." Many of these values translate directly to AI ethics. "Trustworthy" → AI should be reliable and honest. "Helpful" → AI should benefit people. "Kind" → AI should not cause unnecessary harm.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The European Union's AI Act, which took effect in 2024, is the world's first comprehensive AI law. It classifies AI systems by risk level — from "minimal risk" (like spam filters) to "unacceptable risk" (like AI that manipulates children). Unacceptable-risk AI is banned outright.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Presentation Tips" subtitle="How to present your AI ethics guidelines effectively" >}}
...
{{< drg/external-link title="Google AI Principles" url="https://ai.google/responsibility/principles/" description="Read Google's own AI ethics principles to see how one of the world's largest AI companies approaches responsible development." >}}

{{< drg/external-link title="UNESCO — Recommendation on the Ethics of AI" url="https://www.unesco.org/en/artificial-intelligence/recommendation-ethics" description="The United Nations' global framework for AI ethics, adopted by 193 countries." >}}

{{< drg/next-page
    text="You have created your own ethical framework for AI."
    teaser="Now discover one of the most famous ideas in AI history — the Turing Test."
