...
prev_title: "Bias, Privacy & Decisions"
next: "/merit-badges/artificial-intelligence/guide/req4c/"
next_title: "Your Ethical Guidelines"
---

{{< drg/requirement number="4b" >}}
Meet with your counselor, play, and discuss 5 rounds of the "What Would You Do?" ethical decision-making scenarios.
{{< /drg/requirement >}}
...
{{< drg/checklist title="Ethical Thinking Framework" subtitle="Steps to work through any AI ethics scenario" >}}
...
{{< drg/did-you-know >}}
The classic "Trolley Problem" in philosophy — where you must choose who is harmed in an unavoidable accident — has taken on new urgency in the age of self-driving cars. Researchers at MIT created a "Moral Machine" experiment where millions of people worldwide shared how they thought a self-driving car should handle ethical dilemmas.
{{< /drg/did-you-know >}}

{{< drg/tip >}}
Your counselor does not expect you to have a perfect answer. They want to hear you THINK through the problem. Start with "I think…" and then explain your reasoning. If you change your mind during the discussion, that shows you are listening and learning.
{{< /drg/tip >}}

{{< drg/external-link title="MIT Moral Machine" url="https://www.moralmachine.net/" description="An interactive platform where you can explore ethical dilemmas facing self-driving cars and see how your choices compare to people around the world." >}}

{{< drg/next-page
    text="You have wrestled with real ethical dilemmas."
    teaser="Now it is time to create your own ethical guidelines for how AI should be used."
