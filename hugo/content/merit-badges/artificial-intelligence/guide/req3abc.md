---
title: "Automation All Around You"
layout: guide
group_title: "3. Automation Basics"
req_number: "3a"
prev: "/merit-badges/artificial-intelligence/guide/req2e/"
prev_title: "AI Timeline"
next: "/merit-badges/artificial-intelligence/guide/req3d/"
next_title: "How Automation Works"
---

{{< drg/requirement number="3a" >}}
Identify 10 examples of how automation is currently used in everyday life.
{{< /drg/requirement >}}

{{< drg/requirement number="3b" >}}
Identify 5 examples of how automation is currently used in the workplace.
{{< /drg/requirement >}}

{{< drg/requirement number="3c" >}}
Identify 5 examples of how automation can be used at school or in support of your education.
{{< /drg/requirement >}}

In [Requirement 2](/merit-badges/artificial-intelligence/guide/req2abc/), you explored where AI shows up in your life. Now we turn to its close relative: **automation**. While AI and automation are related, they are not the same thing. Understanding the difference is one of the key lessons of this merit badge.
...
{{< drg/did-you-know >}}
The first automatic traffic signal was installed in Cleveland, Ohio, in 1914. It had just two positions — "Stop" and "Move" — and had to be manually operated by a police officer. Fully automated traffic lights came later in the 1920s.
{{< /drg/did-you-know >}}

{{< drg/tip >}}
A good trick for coming up with examples: walk through your typical day from morning to night. How many automated things do you interact with before you even leave the house? Alarm clock, automatic lights, coffeemaker, toaster, thermostat, garage door opener — the list adds up fast.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Automation is powerful, but it is only as good as its programming. If someone sets up an automated system with the wrong rules — like a payroll system with incorrect tax rates — the mistakes happen automatically too, potentially affecting many people before anyone notices. That is why testing and oversight are critical.
{{< /drg/safety-first >}}

{{< drg/external-link title="Coursera — Automation vs. AI: Key Differences" url="https://www.coursera.org/articles/automation-vs-ai" description="A clear comparison of automation and AI, with examples that help you understand where one ends and the other begins." >}}

{{< drg/next-page
    text="You can now spot automation in your daily life. Next, let's understand how it works under the hood."
    teaser="Learn how automation performs tasks without human help — and where its limits are."
