...
{{< drg/safety-first >}}
Using AI to complete your schoolwork and turning it in as your own is academic dishonesty — just like copying from a textbook or another student. Your school likely has a policy about AI use. The examples below show how to use AI as a **study aid and learning tool**, not as a way to cheat. Always follow your school's rules about AI.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Notice the difference: the weak prompt asks the AI to do the work. The strong prompt asks the AI to help you prepare to do the work yourself. This is the key distinction that keeps AI use ethical and educational.
{{< /drg/tip >}}
...
{{< drg/checklist title="Prompt-Writing Framework" subtitle="For each of your three examples, include:" >}}
...
{{< drg/be-prepared title="Demonstration Tips" >}}
When demonstrating for your counselor:
...
{{< drg/external-link title="Code.org — Generative AI in the Classroom" url="https://code.org/curriculum/generative-ai" description="A free curriculum exploring how generative AI works and how to use it responsibly for learning." >}}

{{< drg/external-link title="Common Sense Education — AI Literacy for Students" url="https://www.commonsense.org/education/collections/ai-literacy-for-students" description="Resources and lesson plans for understanding and using AI tools responsibly in school settings." >}}

{{< drg/next-page
    text="You have demonstrated that you can write clear, effective instructions for AI."
    teaser="Now it is time to put everything together — plan and build your own AI project or teach others what you have learned."
