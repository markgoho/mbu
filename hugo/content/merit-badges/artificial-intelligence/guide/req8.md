...
{{< drg/did-you-know >}}
The U.S. Bureau of Labor Statistics projects that computer and information technology occupations will grow by 15% from 2022 to 2032 — much faster than the average for all occupations. AI-specific roles are growing even faster, with some estimates suggesting a 40% increase in demand for AI and machine learning specialists by 2027.
{{< /drg/did-you-know >}}
...
{{< drg/external-link title="AI4ALL — Open Learning" url="https://ai-4-all.org/" description="A nonprofit working to increase diversity and inclusion in AI education, with free learning resources." >}}

{{< drg/external-link title="Coursera — Artificial Intelligence Salary Guide" url="https://www.coursera.org/articles/artificial-intelligence-salary" description="A detailed breakdown of AI career salaries by role, experience level, and location." >}}
...
{{< drg/tip >}}
When reaching out to a potential interviewee, introduce yourself, explain that you are working on the Artificial Intelligence merit badge, and ask if they would be willing to spend 20-30 minutes answering some questions. Most people are flattered to be asked and happy to help. Be flexible about format — in-person, phone, or video call all work.
{{< /drg/tip >}}
...
{{< drg/checklist title="Interview Question Guide" subtitle="Choose 8-10 questions from this list:" >}}
...
{{< drg/be-prepared title="Interview Best Practices" >}}

1. **Prepare your questions in advance** and share them with the interviewee beforehand so they can think about their answers.
2. **Take notes during the interview** — or ask permission to record it.
3. **Listen more than you talk.** This is their time to share their experience.
4. **Ask follow-up questions.** If something interests you, dig deeper: "Can you tell me more about that?"
5. **Send a thank-you note** afterward. This is good manners and good networking.
6. **Be on time** and dress appropriately (business casual for in-person).
   {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have explored the world of AI careers."
    teaser="Keep going! Discover tools, experiences, and organizations that will take your AI knowledge even further."
    url="/merit-badges/artificial-intelligence/guide/extended-learning/" >}}
