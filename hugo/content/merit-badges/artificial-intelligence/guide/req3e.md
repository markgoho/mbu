...
{{< drg/did-you-know >}}
The Jacquard Loom (1804), an improved version that used punched cards to control weaving patterns, is often considered an ancestor of computer programming. The punched cards told the loom which threads to raise — a concept that directly influenced early computers.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Automation Timeline Tips" subtitle="Make your timeline stand out" >}}
...
{{< drg/tip >}}
Think about how your two timelines — AI and automation — overlap. The invention of the transistor (1947) made both modern automation AND modern AI possible. The launch of tools like IFTTT shows how automation is becoming accessible to everyone, not just engineers.
{{< /drg/tip >}}

{{< drg/external-link title="Science Museum — History of Automation" url="https://www.sciencemuseum.org.uk/objects-and-stories/everyday-wonders/how-did-automation-get-started" description="An engaging look at the history of automated machines from the Science Museum in London." >}}

{{< drg/next-page
    text="You now understand both AI and automation — their history, their differences, and where they show up in your life."
    teaser="It is time to tackle one of the most important topics in technology: ethics. How should we use AI responsibly?"
