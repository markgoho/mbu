...
{{< drg/did-you-know >}}
During the AI winters, many researchers avoided using the term "artificial intelligence" in their grant proposals because it had become associated with overpromising. They used terms like "machine learning," "pattern recognition," or "knowledge systems" instead.
{{< /drg/did-you-know >}}
...
IBM Watson competed on the TV quiz show _Jeopardy!_ against two of the show's greatest human champions — Ken Jennings and Brad Rutter — and won. Unlike chess, _Jeopardy!_ requires understanding puns, wordplay, and general knowledge. Watson's victory showed that AI could handle the messy, ambiguous nature of human language.
...
{{< drg/checklist title="Timeline Tips" subtitle="How to create a strong timeline for your counselor" >}}
...
{{< drg/tip >}}
You do not have to use only the milestones listed here. If you discover another event that you find fascinating — like the creation of a specific AI tool you use — include it! Your counselor will appreciate seeing your personal research.
{{< /drg/tip >}}

{{< drg/external-link title="IBM — History of Artificial Intelligence" url="https://www.ibm.com/think/topics/history-of-artificial-intelligence" description="A detailed timeline of AI history from IBM, covering the major breakthroughs and the people behind them." >}}

{{< drg/external-link title="Stanford Encyclopedia of Philosophy — The Turing Test" url="https://plato.stanford.edu/entries/turing-test" description="An in-depth look at Alan Turing's original paper and the philosophical questions it raised about machine intelligence." >}}

{{< drg/next-page
    text="You have explored the past of AI. Now let's look at a closely related field that is often confused with AI."
    teaser="Discover where automation shows up in your everyday life — and how it differs from artificial intelligence."
