...
req_number: "2d"
prev: "/merit-badges/artificial-intelligence/guide/req2abc/"
prev_title: "Req 2A–C — AI All Around You"
next: "/merit-badges/artificial-intelligence/guide/req2e/"
next_title: "Req 2E — AI Timeline"
---
...
1. **Simple automation** — Fixed rules, no learning. (Timer, thermostat set to 72°F)
2. **Complex automation** — Many rules, but still no learning. (A calculator, an alarm system with zones)
3. **AI-assisted** — Uses some machine learning, but mostly rule-based. (Basic spam filter)
4. **AI-powered** — Machine learning is central to how it works. (Voice assistant, recommendation engine)

{{< drg/did-you-know >}}
The automatic doors at a grocery store are not AI — they use a simple motion sensor. But the self-checkout system that scans and identifies products using a camera? That uses computer vision, which is a form of AI.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When playing the game with your counselor, do not just say "AI" or "Not AI." Explain your reasoning. Say something like: "I think this IS AI because the system adapts based on user behavior, which means it is using machine learning." That kind of explanation shows real understanding.
{{< /drg/tip >}}
...
{{< drg/external-link title="Machine Learning for Kids" url="https://machinelearningforkids.co.uk/" description="A free, hands-on tool where you can train your own simple AI models using Scratch. A great way to see the difference between AI and regular programming." >}}

{{< drg/external-link title="Google Teachable Machine" url="https://teachablemachine.withgoogle.com/" description="Train a machine learning model using your webcam, microphone, or images. No coding required — see AI learning in real time." >}}

{{< drg/next-page
    text="Now that you can tell AI from ordinary technology, let's look at how we got here."
    teaser="Build a timeline of the key milestones that shaped the history of artificial intelligence."
