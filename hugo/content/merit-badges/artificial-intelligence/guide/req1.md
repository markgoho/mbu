...
{{< drg/did-you-know >}}
The term "artificial intelligence" was coined in 1956 by John McCarthy at the Dartmouth Conference. He defined it as "the science and engineering of making intelligent machines."
{{< /drg/did-you-know >}}
...
Automation is the use of technology to perform tasks with minimal human involvement. It is important to understand that **not all automation is AI**. A simple timer that turns your porch light on at sunset is automation — it follows a fixed rule. AI-powered automation can adapt and learn. We will explore this distinction much more in [Requirement 3](/merit-badges/artificial-intelligence/guide/req3abc/).
...
{{< drg/safety-first >}}
Not all bots are helpful. Some bots are designed to spread misinformation, send spam, or trick people. If you are chatting online and something feels "off" — repetitive answers, strange phrasing, or too-good-to-be-true offers — you may be talking to a malicious bot. Always verify who you are communicating with.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Researchers disagree about when — or even whether — general AI will be achieved. Some predict it could happen within a few decades, while others believe it may never be possible. It remains one of the biggest open questions in computer science.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When you meet with your counselor, try explaining each term in your own words instead of reading a definition. Then give a real-world example. For instance: "Machine learning is when a computer learns from examples instead of being given exact rules. Like how my email automatically knows what is spam — nobody programmed every spam email, but the system learned the patterns."
{{< /drg/tip >}}

{{< drg/external-link title="IBM — What is Artificial Intelligence?" url="https://www.ibm.com/think/topics/artificial-intelligence" description="A clear, comprehensive overview of AI concepts from one of the world's leading technology companies." >}}

{{< drg/external-link title="Code.org — How AI Works" url="https://code.org/curriculum/how-ai-works" description="Free video series explaining AI concepts in a way that is perfect for students. Covers machine learning, training data, and ethics." >}}

{{< drg/next-page
    text="Now that you have the vocabulary, it is time to see AI in action."
    teaser="Discover how artificial intelligence shows up in your everyday life, at work, and at school."
