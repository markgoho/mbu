...
{{< drg/did-you-know >}}
Every AI system you use today — from ChatGPT to self-driving car software — is technically "narrow AI." No one has yet built a true general AI that can do everything a human mind can do.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Machine learning systems are only as good as the data they are trained on. If the training data contains biases — for example, if it mostly includes examples from one group of people — the AI can make unfair or inaccurate decisions. This is one of the biggest ethical challenges in AI today.
{{< /drg/safety-first >}}
...
{{< drg/safety-first >}}
Just because generative AI can create something does not mean the output is always accurate, original, or safe. AI-generated text can contain factual errors, and AI-generated images can be used to create deepfakes. Always verify AI output and use these tools responsibly.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You have learned about the different kinds of AI and why this badge matters."
    teaser="Start by learning the key terms and vocabulary you will need throughout this badge."
    url="/merit-badges/artificial-intelligence/guide/req1/" >}}
