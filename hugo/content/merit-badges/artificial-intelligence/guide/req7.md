...
{{< drg/tip >}}
Start small. A focused, well-executed project is far better than an ambitious one you cannot finish. You can always expand later. Your counselor would rather see a simple project done well than a complex one done halfway.
{{< /drg/tip >}}
...
{{< drg/checklist title="Project Plan Template" subtitle="Your plan should cover each of these:" >}}
...
{{< drg/external-link title="Google Teachable Machine" url="https://teachablemachine.withgoogle.com/" description="Train image, sound, or pose recognition models in your browser. No coding needed — just use your webcam." >}}

{{< drg/external-link title="Machine Learning for Kids" url="https://machinelearningforkids.co.uk/" description="Build AI projects using Scratch-like visual programming. Great for text classification, image recognition, and more." >}}

{{< drg/external-link title="Microsoft Copilot" url="https://copilot.microsoft.com/" description="A free AI assistant you can use to generate text, images, and code for your project." >}}
...
{{< drg/checklist title="Lesson Plan Template" subtitle="Include each of these in your plan:" >}}
...
{{< drg/be-prepared title="Teaching Tips" >}}

1. **Practice your lesson** at least once before the real thing. Time yourself.
2. **Have a backup plan** in case the internet goes down or a tool is not working. Screenshots or a printed example can save you.
3. **Keep it interactive.** Do not just talk at your audience — ask questions, take suggestions, and let them try things.
4. **Know your audience's level.** Cub Scouts need simpler language than fellow merit badge candidates.
5. **It is okay to say "I don't know."** If someone asks a question you cannot answer, say "Great question — let me find out and get back to you."
   {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have built or taught something real with AI."
    teaser="Finally, explore the careers that are shaping the future of artificial intelligence."
