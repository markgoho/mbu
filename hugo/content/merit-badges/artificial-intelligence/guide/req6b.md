...
prev_title: "How AI Learns"
next: "/merit-badges/artificial-intelligence/guide/req6c/"
next_title: "Prompt Engineering"
---
...
{{< drg/did-you-know >}}
Many modern AI tools accept multiple types of input at once. This is called **multimodal AI**. For example, you can send ChatGPT a photo along with a text question about the photo, or describe an image you want generated using both text and a reference picture. Multimodal communication is one of the fastest-growing areas in AI.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
You do not need to master all five methods for this requirement — but you should be able to describe each one and give an example. Try to think of a situation where each method would be the best choice. For instance, voice commands are great when your hands are busy cooking, but code is better when you need an AI to process 10,000 data points with exact specifications.
{{< /drg/tip >}}
...
{{< drg/checklist title="Discussion Preparation" subtitle="Be ready to share:" >}}
...
{{< drg/external-link title="Google AI Experiments" url="https://experiments.withgoogle.com/collection/ai" description="A collection of interactive AI experiments that let you communicate with AI through text, voice, images, and drawings." >}}

{{< drg/external-link title="Code.org — How AI Works: Communicating with Computers" url="https://code.org/curriculum/how-ai-works" description="Free video lessons covering how humans and AI communicate, including natural language processing." >}}

{{< drg/next-page
    text="You know the five ways to communicate with AI."
    teaser="Now learn how to do it really well — through the art and science of prompt engineering."
