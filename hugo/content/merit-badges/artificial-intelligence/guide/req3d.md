...
req_number: "3d"
prev: "/merit-badges/artificial-intelligence/guide/req3abc/"
prev_title: "Req 3A–C — Automation All Around You"
next: "/merit-badges/artificial-intelligence/guide/req3e/"
next_title: "Req 3E — Automation Timeline"
---

{{< drg/requirement number="3d" >}}
Explain how automation performs repetitive tasks without human intervention and how it reduces human error and optimizes resources.
{{< /drg/requirement >}}
...
A **trigger** is the event that starts an automated process. Remember this term from [Requirement 1](/merit-badges/artificial-intelligence/guide/req1/)? Here it is in action:
...
{{< drg/tip >}}
When explaining this to your counselor, use a concrete comparison. For example: "Imagine handwriting 10,000 addresses on envelopes. You would make mistakes — smudged letters, wrong zip codes, skipped envelopes. A mail merge system does it perfectly every time, in a fraction of the time."
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Automation is incredibly helpful, but it must be supervised. An automated system following bad rules will produce bad results — quickly and at scale. This is why human oversight is always necessary. A misconfigurated automated email system once sent thousands of customers the wrong bill. The system worked perfectly — it just followed the wrong instructions.
{{< /drg/safety-first >}}

{{< drg/external-link title="IFTTT — If This, Then That" url="https://ifttt.com/" description="A free tool that lets you build simple automations connecting your apps and devices. Great for understanding triggers, rules, and actions." >}}

{{< drg/next-page
    text="You now understand how automation works and why it matters."
    teaser="Build a timeline of the key milestones in the history of automation."
