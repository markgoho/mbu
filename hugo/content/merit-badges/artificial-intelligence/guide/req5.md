...
{{< drg/did-you-know >}}
Deepfake videos have surged by more than 550% since 2019. By 2023, researchers had documented over 95,000 deepfake videos online. The technology that once required powerful computers and expert skills is now available in free smartphone apps — meaning anyone can create a deepfake in minutes.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Deepfakes that target individuals — especially minors — may be illegal in many states and countries. Creating, sharing, or possessing deepfakes of anyone without their consent is not just unethical — it can be a crime. If you encounter a deepfake of yourself or someone you know, take it seriously and tell a trusted adult immediately.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Deepfake Detection Checklist" subtitle="Look for these red flags when evaluating suspicious media:" >}}
...
- **The Cyberbullying Research Center** — [cyberbullying.org](https://cyberbullying.org/) has resources for youth and families
- **The National Center for Missing & Exploited Children (NCMEC)** — If the deepfake involves inappropriate content of a minor, report it at [missingkids.org/gethelpnow/cybertipline](https://www.missingkids.org/gethelpnow/cybertipline)
...
{{< drg/be-prepared title="Your Deepfake Response Plan" >}}
Before a deepfake situation happens, know your plan:

1. **Who is your trusted adult?** Identify 2-3 adults you would tell immediately.
2. **How do you report on your platforms?** Practice finding the report button on the apps you use.
3. **Where is your evidence saved?** Have a secure place (like a folder shared with a parent) to store screenshots.
4. **Do you know your school's policy?** Many schools now have specific policies about AI-generated content and cyberbullying.
   {{< /drg/be-prepared >}}
...
{{< drg/external-link title="UNESCO — Deepfakes and the Crisis of Knowing" url="https://www.unesco.org/en/articles/deepfakes-and-crisis-knowing" description="UNESCO's analysis of how deepfakes threaten trust in information and what can be done about it." >}}

{{< drg/external-link title="Cyberbullying Research Center" url="https://cyberbullying.org/" description="Research-based resources for preventing and responding to cyberbullying, including deepfake-related harassment." >}}

{{< drg/external-link title="Common Sense Media — How to Spot a Deepfake" url="https://www.commonsensemedia.org/articles/how-to-spot-a-deepfake" description="A practical, youth-friendly guide to identifying AI-manipulated media." >}}

{{< drg/next-page
    text="You now understand one of AI's most dangerous misuses and how to protect yourself."
    teaser="Next, learn how AI actually learns — and discover its surprising limitations."
