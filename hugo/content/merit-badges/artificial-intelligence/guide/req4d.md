...
{{< drg/did-you-know >}}
Turing predicted that by the year 2000, computers would be able to fool 30% of human judges during a 5-minute conversation. In 2014, a chatbot called "Eugene Goostman" — which pretended to be a 13-year-old Ukrainian boy — convinced 33% of judges at a competition in London. Many researchers dispute whether this truly counts as "passing" the test.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When discussing the Turing Test with your counselor, try to go beyond just describing how it works. Share your opinion: Do you think passing the Turing Test would prove a machine is truly intelligent? Why or why not? There is no right answer — but having a thoughtful perspective shows deeper understanding.
{{< /drg/tip >}}
...
New benchmarks focus on whether AI can _reason_, _understand cause and effect_, _learn from very little data_, and _explain its thinking_. These are much harder tests — and ones that current AI systems still struggle with.
...
{{< drg/external-link title="Stanford Encyclopedia of Philosophy — The Turing Test" url="https://plato.stanford.edu/entries/turing-test" description="A detailed philosophical exploration of the Turing Test, its history, and the debates surrounding it." >}}

{{< drg/external-link title="IEEE — The Turing Test at 75" url="https://www.computer.org/csdl/magazine/ex/2025/01/10897255/24uGRl1DvJC" description="A modern analysis of the Turing Test's legacy and relevance in the age of large language models." >}}

{{< drg/next-page
    text="You have explored one of AI's deepest questions. Now let's turn to one of its most dangerous applications."
    teaser="Learn what deepfakes are, how they can hurt people, and what to do about them."
