...
{{< drg/safety-first >}}
AI bias is not just a technical problem — it can have real consequences for real people. Biased AI in hiring can deny someone a job. Biased AI in healthcare can lead to worse treatment for certain patients. Biased AI in criminal justice can result in unfair sentencing. Recognizing bias is the first step to fixing it.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
A 2024 survey found that only 14% of American schools teach AI ethics to all students, while 44% teach no students about ethical AI use at all. By earning this merit badge, you are ahead of the curve.
{{< /drg/did-you-know >}}
...
Many advanced AI systems, especially deep neural networks, are so complex that even their creators cannot fully explain _why_ they made a specific decision. This is called the "black box" problem. If an AI denies someone a loan, and nobody can explain why, is that fair? Most people — and most ethicists — say no.
...
{{< drg/tip >}}
For your discussion with your counselor, come prepared with an opinion. It is okay to say "I'm not sure" — but try to explain your reasoning. For example: "I think AI should be allowed to help doctors, but a human doctor should always make the final decision about treatment, because the AI can't explain its reasoning to the patient."
{{< /drg/tip >}}

{{< drg/external-link title="AI4ALL — Ethics Resources" url="https://ai-4-all.org/resources/" description="Educational resources about AI ethics designed for students, including lesson plans and discussion activities." >}}

{{< drg/external-link title="Code.org — How AI Works: Ethics" url="https://code.org/curriculum/how-ai-works" description="Free video lessons covering AI bias, fairness, and responsible use — built for middle and high school students." >}}

{{< drg/next-page
    text="You have explored the big ethical questions. Now it is time to put your ethical thinking to the test."
    teaser="Play the 'What Would You Do?' game with scenarios that challenge you to think through AI ethics in real-world situations."
