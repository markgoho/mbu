...
req_number: "2a"
prev: "/merit-badges/artificial-intelligence/guide/req1/"
prev_title: "Requirement 1 — Key AI Terms"
next: "/merit-badges/artificial-intelligence/guide/req2d/"
next_title: "Req 2D — AI or Not?"
---
...
{{< drg/did-you-know >}}
Netflix estimates that its recommendation engine saves the company over $1 billion per year by keeping subscribers engaged. About 80% of the content people watch on Netflix comes from AI recommendations — not from searching.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
For your counselor meeting, try to come up with at least a few examples that are NOT on this list. Think about apps you use, devices in your home, or services your family relies on. The more personal your examples, the better your discussion will be.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Using AI tools to help you learn is encouraged — but using AI to do your homework for you is not. There is a big difference between asking an AI to explain a concept and asking it to write your essay. Your counselor will want to hear your thoughts on where that line is.
{{< /drg/safety-first >}}

{{< drg/external-link title="AI4ALL — Open Learning" url="https://ai-4-all.org/resources/" description="Free AI education resources designed for students. Explore lessons, activities, and real-world AI examples." >}}

{{< drg/external-link title="Google AI Experiments" url="https://experiments.withgoogle.com/collection/ai" description="A collection of interactive AI experiments you can try right in your browser — including Quick, Draw! where AI tries to guess your doodles." >}}

{{< drg/next-page
    text="Now that you can spot AI in the wild, it is time to put your skills to the test."
    teaser="Play the 'AI or Not?' game and learn to tell the difference between AI and regular technology."
