...
{{< drg/checklist title="How to fit a life jacket" subtitle="Use this sequence when you demonstrate for your counselor" >}}
...
{{< drg/safety-first >}}
Life belts and ski belts are not acceptable substitutes for a proper life jacket. If a jacket is torn, sun-damaged, missing hardware, or altered, replace it instead of trying to make it "good enough."
{{< /drg/safety-first >}}

{{< drg/image src="images/life-jacket-fit-check-water-sports.avif" alt="Rider checking zipper, buckles, and shoulder fit on a Type III water-sports life jacket" >}}
...
{{< drg/checklist title="Water Sports Safety Code — Always" subtitle="Habits that should be true on every run" >}}
...
{{< drg/checklist title="Water Sports Safety Code — Never" subtitle="Rules that prevent some of the worst accidents" >}}
...
- **Driver circles back under control**: Approach carefully and avoid the propeller zone.
- **Slow and secure the boat**: Use neutral or shut down as needed during pickup.
- **Check for injury before restarting**: Ask simple questions and look for head, neck, or back concerns.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
When you promise to live up to the Water Sports Safety Code, make it personal. Tell your counselor which point would be easiest for you to forget when excited, and what habit will help you remember it anyway.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have covered the gear, the crew, and the safety code that support every run."
    teaser="Next, review the swimmer test that proves you are ready for deep-water water sports."
