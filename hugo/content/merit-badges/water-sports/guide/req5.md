...
{{< drg/checklist title="Deepwater start sequence" subtitle="Think smooth, not sudden" >}}
...
{{< drg/tip >}}
Many beginners fail deepwater starts because they try to muscle the boat. Think of yourself as getting pulled into standing position, not doing a squat against the towrope.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="You hit the wake and feel yourself getting pulled forward" >}}
Do not panic or yank the handle.

- **Bend your knees more**: Let your legs absorb the wake.
- **Keep the handle in**: A close handle helps keep your body centered.
- **Stay looking ahead**: Looking down often pulls your shoulders forward.
- **Reset after center**: If your balance is off, regain control before the next crossing.
{{< /drg/be-prepared >}}
...
{{< drg/image src="images/wake-crossing-path.avif" alt="Top-down diagram showing a rider starting outside the wakes, crossing both wakes, and returning to center repeatedly" >}}
...
{{< drg/safety-first >}}
Trying to dodge an obstacle while holding the handle too long can pull you into a harder fall. If the safe choice is to release, release decisively and let the crew recover you.
{{< /drg/safety-first >}}

{{< drg/did-you-know >}}
One mark of an experienced rider is not that they never fall. It is that they recognize earlier when a run is going bad and choose a controlled release before the crash becomes bigger.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You have worked through the core riding skills that make a run smooth and safe."
    teaser="Next, learn how to adjust your bindings correctly and recover your gear in deep water."
