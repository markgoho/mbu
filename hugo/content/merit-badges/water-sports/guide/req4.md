...
{{< drg/checklist title="Standard skier signals to know" subtitle="Be ready to show and explain each one" >}}
...
- **Stay visible**: Hold up a ski in traffic if possible.
- **Keep distance from the stern**: Wait for the boat to be secured before moving in.
- **Speak up once close**: Tell the crew if you are hurt, dizzy, or need to stop.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
Do not mumble signals with tiny hand motions. Make them large, high, and obvious. The driver and observer may be dealing with spray, distance, engine noise, and bright sun.
{{< /drg/tip >}}

{{< drg/image src="images/skier-hand-signals-water-sports.avif" alt="Diagram of the standard skier safe, faster, slower, back to dock, cut motor, and skier in water hand signals" >}}
...
{{< drg/safety-first >}}
If the skier does not give the skier-safe signal after a fall, the driver and observer should assume help may be needed. Respond like it could be an emergency until you know otherwise.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You have learned the communication system that connects rider, observer, and driver."
    teaser="Next, focus on the riding skills themselves: starts, wake crossings, and safe falls."
