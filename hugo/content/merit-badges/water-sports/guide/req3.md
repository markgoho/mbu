---
title: "Pass the Swimmer Test"
layout: "guide"
group_title: "1. Building Safe Habits"
req_number: "3"
req_path: "3"
prev: "/merit-badges/water-sports/guide/req2/"
prev_title: "Gear and Boat Safety"
next: "/merit-badges/water-sports/guide/req4/"
next_title: "Hand Signals That Keep You Safe"
---

{{< drg/requirement number="3" >}}
Before doing requirements 4 through 6, successfully complete the Scouting America swimmer test. Note: See the Swimming merit badge pamphlet for details about the Scouting America swimmer test.
{{< /drg/requirement >}}
...
{{< drg/checklist title="What the swimmer test includes" subtitle="The sequence you must complete successfully" >}}
...
{{< drg/tip >}}
If you are nervous about the swimmer test, practice the transitions. Many Scouts can swim the distance but lose confidence when switching strokes or floating after effort. Rehearsing those changes makes the full test feel much smoother.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Do not try to hide weak swimming ability just to move ahead in the badge. Requirements 4 through 6 become much safer when you know you can handle deep water without panic.
{{< /drg/safety-first >}}
...
1. jump into deep water feetfirst
2. swim 75 yards with a strong, steady stroke
3. switch cleanly into a restful backstroke for 25 yards
4. make a sharp turn in deep water
5. float long enough to show real control
...
{{< drg/next-page
    text="You have seen why deep-water swimming ability is required before the skiing skills begin."
    teaser="Next, learn the standard hand signals that keep the whole boat crew coordinated."
