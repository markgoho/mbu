...
{{< drg/checklist title="Binding fit check" subtitle="Questions to ask before you leave shore" >}}
...
{{< drg/be-prepared title="A ski comes off and you feel frustrated in deep water" >}}
Do not let frustration rush you.

- **Pause and breathe**: Your life jacket buys you time.
- **Get oriented**: Know where the boat, rope, and loose gear are.
- **Work one task at a time**: Recover the gear, then fit it, then reset for the next start.
- **Ask for a boat reset if needed**: There is no prize for fixing everything while drifting badly positioned in chop.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
Scouts often do better in this requirement when they narrate what they are doing: "I am checking my heel, tightening the strap, and keeping the rope clear." That makes your process obvious to your counselor.
{{< /drg/tip >}}

{{< drg/safety-first >}}
Never put your body in a dangerous position just to recover gear quickly. Stay clear of the stern and propeller area, and wait for the boat crew to secure the situation before moving close to the boat.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You have finished the core skills of safe starts, control, signaling, and gear management."
    teaser="Continue to Extended Learning for next-step skills, places to ride, and organizations to explore."
