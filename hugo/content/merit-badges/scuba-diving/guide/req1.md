...
{{< drg/checklist title="Early warning signs divers should never ignore" subtitle="Small symptoms often come before bigger emergencies" >}}
...
- **Stay factual.** Calm, accurate information helps rescuers much more than guesses do.
{{< /drg/be-prepared >}}

{{< drg/safety-first >}}
Never try to “tough out” ear pain, confusion, breathing trouble, or unusual symptoms after a dive. In scuba, delaying help can make a manageable problem much worse.
{{< /drg/safety-first >}}
...
{{< drg/external-link
    ...
    description="Trusted first-aid guidance that helps you review symptoms, priorities, and basic care for many injuries and illnesses." >}}
...
- **Send for 911 and an AED immediately.** Time matters.
- **Begin CPR if the conditions are met and you are trained to do so.** Follow the method taught by your instructor and counselor.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="American Red Cross — CPR Training"
    url="https://www.redcross.org/take-a-class/cpr/cpr-training"
    description="Overview of CPR training and why hands-on practice matters for real emergencies." >}}
...
{{< drg/next-page
    text="You have reviewed dive-specific first aid and when CPR is appropriate."
    teaser="Next, see why strong swimming skills come before scuba certification in this badge."
