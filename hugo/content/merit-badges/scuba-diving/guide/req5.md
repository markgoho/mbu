...
{{< drg/image src="images/coral-reef-buoyancy-control.avif" alt="Diver hovering carefully above a coral reef without touching coral while small reef fish move around the scene" >}}
...
{{< drg/checklist title="What to notice when describing an aquatic ecosystem" subtitle="These details help you move beyond just naming the habitat" >}}
...
{{< drg/did-you-know >}}
Some coral reef animals spend part of their lives in mangroves or seagrass beds before moving to the reef. Protecting one habitat often helps protect another.
{{< /drg/did-you-know >}}

{{< drg/safety-first >}}
Do not touch coral, chase wildlife, or plant your hands on the bottom unless safety absolutely requires it. A stable diver protects both the environment and the buddy team.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="NOAA Ocean Service"
    url="https://oceanservice.noaa.gov/"
    description="Explore reliable background on coral reefs, coasts, habitats, and the living systems divers may encounter." >}}
...
{{< drg/next-page
    text="You have explored several underwater habitats and how divers should move through them responsibly."
    teaser="Next, look at the professional side of scuba and the careers built around diving knowledge."
