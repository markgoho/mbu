...
{{< drg/video
    title="5 SCUBA Jobs that can take you anywhere in the world 🌎 // SCUBA diving careers — Ocean Scholar"
    url="https://www.youtube.com/watch?v=DmKPYSH0gOA" >}}

{{< drg/checklist title="What to bring to your counselor discussion" subtitle="Research details that make your answer stronger" >}}
...
{{< drg/tip >}}
If possible, talk to a real diver or instructor, even briefly. Ask what a normal day looks like, what training took the longest, and what beginners misunderstand about the job.
{{< /drg/tip >}}

{{< drg/be-prepared title="You are interested in a scuba career but not sure where to start" >}}
- **Start with the kind of work you enjoy.** Teaching, science, mechanics, rescue, travel, or photography each point in different directions.
- **Match the career to the bigger field.** Marine biology is mostly science. Instructing is mostly teaching. Public safety diving is mostly emergency service.
- **Look for stepping stones.** Volunteer work, extra science classes, lifeguarding, swimming instruction, and dive travel all build useful experience.
- **Ask what the job is really like.** The day-to-day work matters more than the highlight reel.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="American Red Cross — Volunteer Opportunities"
    url="https://www.redcross.org/volunteer/volunteer-opportunities.html"
    description="A reminder that many safety and service careers start with volunteering, training, and helping in organized programs." >}}
...
{{< drg/next-page
    text="You have connected scuba skills to real jobs and real training paths."
    teaser="Go beyond the requirements with advanced topics, experiences, and organizations to explore next."
