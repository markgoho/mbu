...
{{< drg/video
    title="How to Get Scuba Certified — PADI"
    url="https://www.youtube.com/watch?v=PCcTAS53Inc" >}}

{{< drg/checklist title="What helps a new diver succeed in certification" subtitle="These habits make training smoother and safer" >}}
...
{{< drg/be-prepared title="A skill that felt easy in the pool feels harder in open water" >}}
- **Slow down.** Conditions change how a skill feels.
- **Tell your instructor clearly what feels different.** Visibility, cold, current, and stress all matter.
- **Reset the basics.** Breathing, body position, and simple hand signals come first.
- **Trust the training sequence.** Open-water confidence grows through repetition, not bravado.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
Keep a small dive notebook or digital note after training days. Writing down one skill that improved, one question you still have, and one safety lesson you noticed can make your counselor discussion much stronger.
{{< /drg/tip >}}

{{< drg/external-link
    title="Scuba Diving Merit Badge Pamphlet"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Pamphlets/Scuba%20Diving.pdf"
    description="The badge's official pamphlet helps you review the certification path and the training expectations behind this requirement." >}}
...
{{< drg/next-page
    text="You have seen how certification builds real dive skills through guided practice."
    teaser="Next, explore the aquatic ecosystems divers may visit and what makes each one distinct."
