...
{{< drg/tip >}}
When you talk with your counselor, use examples from training, swimming, boating, or camping if you have not done many dives yet. Good judgment transfers across activities.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    description="Review the badge's official guidance as you prepare to discuss the Scuba Diver's Code with your counselor." >}}

{{< drg/be-prepared title="Your buddy wants to continue even though they feel off before the dive" >}}
- **Pause the plan.** Do not let schedule pressure make the choice.
- **Talk honestly.** “Feeling off” is enough reason to stop and reassess.
- **Normalize backing out.** Canceling a dive is a smart safety decision, not a failure.
- **Dive another time if needed.** A missed dive is better than a preventable emergency.
{{< /drg/be-prepared >}}

{{< drg/safety-first >}}
Never exceed your training, depth limits, or dive plan just because conditions look manageable in the moment. Scuba problems often start when a diver decides the rules are optional.
{{< /drg/safety-first >}}

{{< drg/checklist title="How to explain the Scuba Diver's Code well" subtitle="Move from slogans to real safety meaning" >}}
...
{{< drg/next-page
    text="You have broken the Scuba Diver's Code into real safety choices."
    teaser="Next, look at what Open Water certification includes and how to prepare for it well."
