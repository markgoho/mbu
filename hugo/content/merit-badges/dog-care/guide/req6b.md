...
req_number: "6b"
prev: "/merit-badges/dog-care/guide/req6a/"
prev_title: "Req 6a — Vaccination Planning"
next: "/merit-badges/dog-care/guide/req6c/"
next_title: "Req 6c — Dental Care"
---
...
{{< drg/image src="images/parasite-transmission-routes.avif" alt="Four-panel diagram showing flea, tick, mosquito, and contaminated-ground parasite transmission routes for dogs" >}}

{{< drg/checklist title="A Strong Parasite Prevention Plan" subtitle="These habits work together" >}}
...
{{< drg/video
    title="How to Treat Fleas, Ticks & Worms in Dogs (video)"
    url="https://www.youtube.com/watch?v=NdykIsBmmao" >}}

{{< drg/tip >}}
When discussing this requirement with your counselor, mention that prevention plans can change with local climate. A dog in a humid, mosquito-heavy region may face different risks from a dog in a colder, drier place.
{{< /drg/tip >}}

{{< drg/safety-first >}}
Do not use random home remedies or products made for other species. Some flea, tick, and worm treatments can be dangerous if used incorrectly or on the wrong animal.
{{< /drg/safety-first >}}
...
In [Req 6a](/merit-badges/dog-care/guide/req6a/), you looked at vaccines as preventive care. Parasite control is the same kind of thinking: stop trouble before it starts.
...
{{< drg/next-page
    text="You now know the basics of preventing fleas, ticks, heartworms, and intestinal parasites."
    teaser="Next, learn why dental care and tooth brushing are important parts of dog health."
