...
{{< drg/image src="images/dog-groups-overview.avif" alt="Seven representative dog types shown side by side for the sporting, hound, working, terrier, toy, non-sporting, and herding groups" >}}

{{< drg/checklist title="How to Describe a Dog Group" subtitle="Use these four categories with your counselor" >}}
...
{{< drg/video
    title="Dog Breed Groups (video)"
    url="https://www.youtube.com/watch?v=CITzpWbTSE8" >}}

{{< drg/external-link
    title="7 Different Groups of Basic Dog Breeds (website)"
    url="https://petcontrolhq.com/en-us/pages/different-dog-breed-types?srsltid=AfmBOoriR8nmRFZgjdYVNRzqBBq5JrrEedlNFCFNmHuWf31yizOyEUx_"
    description="A quick-reference guide that summarizes the purpose and general traits of each major dog group." >}}
...
In [Req 1a](/merit-badges/dog-care/guide/req1a/), you saw how humans shaped dogs over time. Next, you will bring that idea down to the breed level by looking at seven specific breeds or the story of one breed in depth.

{{< drg/next-page
    text="You now know the seven dog groups and the traits often linked to each one."
    teaser="Choose specific breeds to describe, or dig into the history of one breed in detail."
