...
{{< drg/checklist title="Seasonal Questions to Ask" subtitle="Use these with your counselor for your local area" >}}
...
{{< drg/video
    title="Hot Weather Tips for Dogs! (video)"
    url="https://www.youtube.com/shorts/JsnPl3mvgG4" >}}

{{< drg/video
    title="Winter Weather - Pet Safety Tips (video)"
    url="https://www.youtube.com/watch?v=P7nVESKP_sA" >}}

{{< drg/be-prepared title="Your Dog Starts Overheating" >}}
If your dog seems to be overheating:

- **Move the dog to shade or a cooler area immediately.**
- **Stop exercise right away.**
- **Offer cool water in small amounts.**
- **Use cool, not ice-cold, water on the body if needed.**
- **Contact a veterinarian quickly if the dog seems weak, confused, or distressed.**
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You now know how seasonal conditions can change safe dog care in your area."
    teaser="Next, discuss the reasons people consider spaying or neutering their dogs."
