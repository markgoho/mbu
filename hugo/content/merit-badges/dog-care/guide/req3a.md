...
{{< drg/checklist title="What Good Training Should Look Like" subtitle="Use these ideas no matter what skill you are teaching" >}}
...
{{< drg/video
    title="How Important is Dog Training and Socialization? (video)"
    url="https://www.youtube.com/watch?v=bwB7qNdifP4" >}}

{{< drg/tip >}}
If a dog seems to be ignoring you, first ask whether the dog truly understands the cue in that setting. A behavior learned in a quiet kitchen may fall apart outside unless you practice it in many places.
{{< /drg/tip >}}

{{< drg/be-prepared title="The Dog Panics Around New People" >}}
If a dog becomes fearful when meeting someone new:

- **Create distance first.** Do not force the dog closer.
- **Keep your voice calm.** Excited yelling adds pressure.
- **Let the dog observe.** Give it time to watch from a safer distance.
- **Reward calm behavior.** Treats or praise can help build a better association.
- **End on success.** Even a small calm moment is worth reinforcing.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You now see how house-training, obedience, and socialization shape a safe, confident dog."
    teaser="Next, define responsible pet ownership and what it looks like in real life."
