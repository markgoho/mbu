...
{{< drg/checklist title="Dangers of Home Treatment for Serious Illness" subtitle="These are strong points to discuss with your counselor" >}}
...
{{< drg/external-link
    title="8 Risks of Treating Your Pet (website)"
    url="https://www.petmd.com/dog/care/8-risks-treating-your-pet-home"
    description="An overview of common mistakes owners make when trying to diagnose or treat pets at home without veterinary guidance." >}}

{{< drg/external-link
    title="Dangers of Dr. Google (website)"
    url="https://www.thedrakecenter.com/services/blog/diagnosing-and-treating-your-own-pet-dangers-dr-google"
    description="A veterinarian-written reminder that online symptom searches cannot replace professional diagnosis and treatment." >}}

{{< drg/safety-first >}}
If a dog has trouble breathing, collapses, is hit by a car, has repeated vomiting, has severe bleeding, or seems suddenly very weak or confused, seek veterinary help immediately instead of experimenting at home.
{{< /drg/safety-first >}}

{{< drg/tip >}}
A strong answer for your counselor includes this idea: first aid is for stabilizing and helping, not for replacing professional care when the illness is serious.
{{< /drg/tip >}}

### Know the Line Between Care and Delay
...
{{< drg/next-page
    text="You now understand why serious illness should not be handled casually at home."
    teaser="Next, learn the causes, spread, symptoms, and prevention of several major dog diseases."
