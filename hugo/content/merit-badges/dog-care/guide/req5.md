...
{{< drg/checklist title="Before You Demonstrate Three Commands" subtitle="Set yourself and your dog up for success" >}}
...
{{< drg/video
    title="10 Most Basic Commands Every Dog Owner Should Know (video)"
    url="https://www.youtube.com/watch?v=eHbcb2EQC88" >}}

{{< drg/video
    title="How to Teach Your Dog the Basics (video)"
    url="https://www.youtube.com/watch?v=lUzcA9qa_P8" >}}

{{< drg/tip >}}
If a command falls apart outside, that does not mean the dog is stubborn. It often means the dog learned the cue only in easy conditions and needs more practice with distractions.
{{< /drg/tip >}}

{{< drg/be-prepared title="The Dog Stops Listening During Training" >}}
If your dog suddenly seems distracted or confused:

- **Make the task easier.** Go back to a simpler version.
- **Reduce distractions.** Move to a quieter area.
- **Shorten the session.** Two good minutes beats ten bad ones.
- **Use better timing.** Reward faster when the dog gets it right.
- **Check your own cues.** Mixed signals from the human can confuse the dog.
{{< /drg/be-prepared >}}

### Training Is a Daily Habit

In [Req 4](/merit-badges/dog-care/guide/req4/), you tracked daily routines. Obedience fits right into that same pattern. Dogs learn best when training is woven into ordinary life: before meals, during walks, at the door, and in short practice sessions throughout the week.
...
{{< drg/next-page
    text="You now know how basic obedience training works and what equipment helps."
    teaser="Next, learn how vaccination schedules protect dogs from puppyhood through adulthood."
