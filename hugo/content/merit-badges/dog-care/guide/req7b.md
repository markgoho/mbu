---
title: "Emergency Muzzle"
layout: guide
group_title: "7. Dog First Aid"
req_number: "7b"
prev: "/merit-badges/dog-care/guide/req7a/"
prev_title: "Handling an Injured Dog"
next: "/merit-badges/dog-care/guide/req7c/"
next_title: "Wounds and Dog Bites"
---
...
{{< drg/image src="images/emergency-muzzle-steps.avif" alt="Four-step sequence showing how to place an improvised emergency muzzle on a dog using gauze or cloth" >}}

{{< drg/checklist title="Before Using an Emergency Muzzle" subtitle="Ask these questions first" >}}
...
{{< drg/video
    title="How Do I Safely Muzzle a Pet in an Emergency? (video)"
    url="https://www.youtube.com/watch?v=E7_77X7hAqQ" >}}

{{< drg/safety-first >}}
Never leave a dog unattended in an emergency muzzle. Remove it as soon as it is safe to do so and the immediate handling task is finished.
{{< /drg/safety-first >}}

{{< drg/tip >}}
If you ever demonstrate this skill for your counselor, explain out loud when you would not use a muzzle. Knowing the limits of first aid is part of doing it correctly.
{{< /drg/tip >}}

In [Req 7a](/merit-badges/dog-care/guide/req7a/), you learned why injured dogs may bite. Now that you know one way to manage that risk, you are ready to think about actual wound care and what to do after a dog bite.

{{< drg/next-page
    text="You now understand how and when an emergency muzzle can be used."
    teaser="Next, learn the basics of wound care and first aid for dog bites."
