...
{{< drg/image src="images/puppy-vaccine-timeline.avif" alt="Timeline showing a puppy vaccine series from 6 to 8 weeks through 16 weeks, followed by adult booster stages" >}}
...
{{< drg/checklist title="What Shapes a Dog's Vaccine Plan" subtitle="Discuss these with your counselor and veterinarian" >}}
...
{{< drg/video
    title="Puppy Vaccinations 101: What, When, and Why (video)"
    url="https://www.youtube.com/watch?v=BnVVSciMymE" >}}

{{< drg/safety-first >}}
Do not skip, delay, or combine vaccines based on guesses or internet advice alone. Vaccination schedules should be set with a veterinarian because timing matters, especially for puppies.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You now understand how vaccination schedules change from puppyhood to adulthood."
    teaser="Next, learn how to prevent fleas, ticks, heartworms, and intestinal parasites."
