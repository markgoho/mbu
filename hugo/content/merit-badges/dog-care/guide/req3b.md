...
{{< drg/checklist title="Signs of Responsible Pet Ownership" subtitle="A responsible owner usually does all of these" >}}
...
{{< drg/video
    title="Pet Protector - Responsible Pet Ownership (video)"
    url="https://www.youtube.com/watch?v=R_0HgVBhwBM" >}}

{{< drg/safety-first >}}
A responsible owner never leaves a dog loose around roads, children, or unfamiliar animals without proper control. Many preventable injuries and bites happen when adults assume "it will probably be fine."
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
When talking with your counselor, give examples. Saying "responsible ownership means regular vet care, safe housing, cleanup, and training" is much stronger than just saying "taking care of your dog."
{{< /drg/tip >}}

In [Req 3a](/merit-badges/dog-care/guide/req3a/), you learned how training supports good behavior. Next, you will use that same idea to think about the big decision of choosing a breed or type of dog that fits a family well.

{{< drg/next-page
    text="You now know that responsible pet ownership is a long-term commitment, not just affection."
    teaser="Next, learn what a family should consider before choosing a breed or type of dog."
