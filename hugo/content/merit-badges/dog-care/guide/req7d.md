...
{{< drg/image src="images/paw-bandage-technique.avif" alt="Annotated photo showing a correctly wrapped dog paw bandage with dressing pad, wrap, and toes left visible" >}}
...
{{< drg/checklist title="A Good Emergency Bandage Should Be" subtitle="Use these standards when you demonstrate" >}}
...
{{< drg/video
    title="Pet First Aid: How to Bandage Your Pet's Paw in Case of Emergency (video)"
    url="https://www.youtube.com/watch?v=s7ZvhxUv8HU" >}}

{{< drg/safety-first >}}
If a bandage causes swelling above or below the wrap, slips badly, gets soaked, or seems to make the dog more uncomfortable, remove or adjust it and seek help. A bad bandage can do damage quickly.
{{< /drg/safety-first >}}

{{< drg/tip >}}
When demonstrating for your counselor, explain what you are checking as you go. Saying "I am making this snug but not tight" shows better understanding than silently wrapping.
{{< /drg/tip >}}

### Bandaging Fits Into the Bigger First-Aid Picture

In [Req 7c](/merit-badges/dog-care/guide/req7c/), you learned about wound care. Bandaging is one more tool for protecting those injuries until a veterinarian can take over when needed.

Next you will look at one of the most urgent emergencies in dog first aid: what to do if a dog is hit by a car.

{{< drg/next-page
    text="You now know the basics of using a simple dressing and bandage on a dog."
    teaser="Next, learn the immediate priorities if a dog is struck by a car."
