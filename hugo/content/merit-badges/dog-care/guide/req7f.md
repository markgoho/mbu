...
{{< drg/checklist title="What Makes a Good Dog First-Aid Kit" subtitle="Think beyond just owning supplies" >}}
- **Portable:** Easy to carry in a car, on a trip, or around the house
...
{{< drg/video
    title="DIY Dog First Aid Kit - Basics and Beyond (video)"
    url="https://www.youtube.com/watch?v=Cz_ogJQhWmo" >}}

{{< drg/video
    title="What to Put in a Dog First Aid Kit for Hiking (video)"
    url="https://www.youtube.com/watch?v=7sszmRkdOyM" >}}

{{< drg/tip >}}
Keep a small card in the kit with your dog's normal weight, any medical conditions, allergies, and your veterinarian's phone number. In an emergency, that information saves time.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You now know what a well-prepared dog first-aid kit should contain."
    teaser="Next, learn why home treatment of serious illness can be dangerous."
