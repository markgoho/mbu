...
{{< drg/checklist title="Precautions When Handling an Injured Dog" subtitle="Use these in the order that fits the situation" >}}
...
{{< drg/video
    title="How to Be Safe When Handling a Sick or Injured Dog (video)"
    url="https://www.youtube.com/watch?v=7JP3IFdClU8" >}}

{{< drg/safety-first >}}
Never put your face close to an injured dog's face. Even a small dog can bite quickly, and severe facial injuries can happen in a split second.
{{< /drg/safety-first >}}

{{< drg/be-prepared title="The Dog Is Injured but Tries to Escape" >}}
If an injured dog is trying to run away:

- **Do not chase wildly.** That can increase fear and risk.
- **Close exits or block hazards if you can do it safely.**
- **Use a calm voice and slow movement.**
- **Offer a leash, blanket, or barrier if available.**
- **Call for adult or veterinary help if the dog cannot be safely controlled.**
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You now understand the basic precautions needed before touching or moving an injured dog."
    teaser="Next, learn how to put on an emergency muzzle safely."
