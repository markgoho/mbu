...
{{< drg/video
    title="Rabies Information (video)"
    url="https://www.youtube.com/watch?v=_tMORbU5c3Y" >}}
...
{{< drg/video
    title="Parvo Information (video)"
    url="https://www.youtube.com/watch?v=7pBKnJQlwSQ" >}}
...
{{< drg/image src="images/disease-spread-comparison.avif" alt="Four-row comparison diagram showing how rabies, parvovirus, distemper, and heartworms spread" >}}

{{< drg/checklist title="How These Diseases Differ" subtitle="A useful way to explain them clearly" >}}
...
{{< drg/external-link
    title="Disease Risks for Dogs in Social Settings (website)"
    url="https://www.avma.org/resources-tools/pet-owners/petcare/disease-risks-dogs-social-settings"
    description="A veterinarian-reviewed guide to contagious disease risks in places like dog parks, classes, shelters, and boarding facilities." >}}

{{< drg/safety-first >}}
If a dog may have been exposed to rabies, or is showing serious neurologic signs, do not handle the situation casually. Get adult and veterinary guidance immediately because rabies exposure affects both animal and human safety.
{{< /drg/safety-first >}}

### Look for Patterns in Prevention

Three of these diseases are prevented mainly through vaccination. Heartworms are prevented mainly through regular medication and mosquito control. That pattern should sound familiar from [Req 6a](/merit-badges/dog-care/guide/req6a/) and [Req 6b](/merit-badges/dog-care/guide/req6b/): the best dog care often prevents disease before it starts.
...
{{< drg/next-page
    text="You now understand the causes, spread, symptoms, and prevention of four major dog diseases."
    teaser="Next, prepare for a visit to a veterinary hospital or animal shelter and report what you learn."
