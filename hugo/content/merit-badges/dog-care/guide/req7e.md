...
req_number: "7e"
prev: "/merit-badges/dog-care/guide/req7d/"
prev_title: "Req 7d — Dressings and Bandages"
next: "/merit-badges/dog-care/guide/req7f/"
next_title: "Req 7f — Dog First-Aid Kit"
---
...
An injured dog may try to run, bite, or collapse. Use the precautions from [Req 7a](/merit-badges/dog-care/guide/req7a/). Speak calmly, move slowly, and do not assume the dog recognizes you or understands what is happening.
...
{{< drg/checklist title="Priorities After a Dog Is Hit by a Car" subtitle="Keep these in order" >}}
...
{{< drg/video
    title="What to Do to Help a Dog Hit by a Car (video)"
    url="https://www.youtube.com/watch?v=Zidt9dhMEZ4" >}}

{{< drg/safety-first >}}
Do not assume a dog is "fine" just because it gets up and walks. Shock and internal injuries may not be obvious right away, and delay can be dangerous.
{{< /drg/safety-first >}}

{{< drg/be-prepared title="The Dog Tries to Run Into Traffic Again" >}}
If the dog is injured and panicking near a road:

- **Do not sprint straight at it if that may drive it farther into danger.**
- **Use a calm, low voice.**
- **Create barriers with people or vehicles only if it is safe to do so.**
- **Use a leash, blanket, or board if available.**
- **Call emergency veterinary help or animal control if you cannot safely secure the dog.**
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You now know the immediate priorities if a dog is hit by a car."
    teaser="Next, learn what belongs in a well-stocked dog first-aid kit."
