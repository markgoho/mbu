  ...
  - group_title: "Beyond the Badge"
    items:
      - title: "Extended Learning"
        url: "/merit-badges/space-exploration/guide/extended-learning/"
        is_sub: false
---
...
{{< drg/did-you-know >}}
A GPS receiver often needs signals from at least four satellites just to calculate where you are. A tool many Scouts use while hiking depends on space technology every time it works.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
As you work through this guide, keep a short list of missions that interest you. That list will help with Requirements 2, 5, 6, 7, and 8 because those pages all ask you to choose examples and explain why they matter.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Real space exploration depends on careful planning, checklists, and respect for danger. Bring that same attitude to this badge when you build rockets, use tools, or launch outdoors. Curiosity is powerful, but safety rules are what make exploration possible.
{{< /drg/safety-first >}}

You are ready to start with the biggest question of all: why people choose to explore space in the first place.

{{< drg/next-page
    text="You have seen how space exploration grew from stargazing into science, engineering, and global teamwork."
    teaser="Next, break down the historical, scientific, practical, and international reasons humans keep going outward."
    url="/merit-badges/space-exploration/guide/req1/" >}}
