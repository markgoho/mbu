...
{{< drg/safety-first >}}
Follow the National Association of Rocketry safety code and all local rules every time. Launch only in an approved area, use the recommended engine for the kit, keep spectators back, and never try to modify motors or igniters. If launches are not allowed where you live, take the alternative requirement seriously and explain the same parts and principles using a model instead.
{{< /drg/safety-first >}}

{{< drg/checklist title="What makes a successful second launch" subtitle="Pick one clear objective before you fly again" >}}
...
{{< drg/inherited-requirement number="3a" req_path="3.a" topic="Body tube" />}}
...
{{< drg/inherited-requirement number="3b" req_path="3.b" topic="Engine mount" />}}
...
{{< drg/inherited-requirement number="3c" req_path="3.c" topic="Fins" />}}
...
{{< drg/image src="images/model-rocket-fin-alignment.avif" alt="Diagram of a model rocket showing correct fin alignment and an incorrect crooked-fin example" >}}

## Requirement 3d

{{< drg/inherited-requirement number="3d" req_path="3.d" topic="Igniter" />}}
...
{{< drg/inherited-requirement number="3e" req_path="3.e" topic="Launch lug" />}}
...
{{< drg/inherited-requirement number="3f" req_path="3.f" topic="Nose cone" />}}
...
{{< drg/inherited-requirement number="3g" req_path="3.g" topic="Payload" />}}
...
{{< drg/inherited-requirement number="3h" req_path="3.h" topic="Recovery system" />}}
...
{{< drg/inherited-requirement number="3i" req_path="3.i" topic="Rocket engine" />}}
...
{{< drg/external-link
    title="NASA \"Rocket Parts\" - Beginner's Guide (website)"
    url="https://www.grc.nasa.gov/www/k-12/VirtualAero/BottleRocket/airplane/bgmr.html"
    description="A labeled guide that explains how the main parts of a rocket fit together and what each one does." >}}

{{< drg/external-link
    title="National Association of Rocketry Educational Video Series on Model Rocketry (website)"
    url="https://www.nar.org/content.aspx?page_id=22&club_id=114127&module_id=669619"
    description="Launch safety, building basics, and rocketry lessons from the organization whose safety code this requirement references." >}}
...
{{< drg/next-page
    text="You have looked inside a rocket and seen how its parts work together."
    teaser="Next, connect that hardware to the science of thrust, engines, orbit, and space imaging."
