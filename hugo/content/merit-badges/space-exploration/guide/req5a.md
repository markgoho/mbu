...
req_number: "5a"
req_path: "5.a"
prev: "/merit-badges/space-exploration/guide/req5/"
prev_title: "Req 5 — Choose Two Missions"
next: "/merit-badges/space-exploration/guide/req5b/"
next_title: "Req 5b — Build a Mission Story"
---
...
{{< drg/checklist title="A strong mission comparison" subtitle="Use the same categories for both missions" >}}
...
{{< drg/tip >}}
Choose missions you can actually explain, not just missions you have heard of. A less famous mission that you understand well is better than a famous one you can barely describe.
{{< /drg/tip >}}

{{< drg/video
    title="Voyager (video)"
    url="https://youtu.be/uJpJ79AxrzI?list=PLTiv_XWHnOZq5bv1w9Db2uNJVFiVCkWW5" >}}

{{< drg/video
    title="Putting Man on The Moon in 11 Years | The Apollo Program (video)"
    url="https://youtu.be/jUW_1XlrWmg" >}}

{{< drg/video
    title="NASA SpaceX Crew Dragon Launch (video)"
    url="https://youtu.be/1gmvUPTdoP4" >}}

{{< drg/video
    title="Mars Perseverance Rover (video)"
    url="https://www.youtube.com/watch?v=0-oQRSViZQE&pp=ygUUcGVyc2VydmVyYW5jZSByb3ZlciA%3D" >}}
...
{{< drg/be-prepared title="One useful comparison sentence frame" >}}

- **Robotic mission**: "This mission was important because it could explore ___ without risking a human crew." 
- **Crewed mission**: "This mission was important because astronauts could ___ in a way a robot could not at that time." 
- **Comparison**: "Together, these missions show that space exploration needs both robots and people." 
  {{< /drg/be-prepared >}}

{{< drg/next-page
    text="Once you can compare missions, you can also tell the story of one mission in a format other people can explore."
    teaser="Next, build a blog, slideshow, website, or scrapbook about a current planetary mission."
