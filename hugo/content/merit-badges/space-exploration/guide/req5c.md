...
req_number: "5c"
req_path: "5.c"
prev: "/merit-badges/space-exploration/guide/req5b/"
prev_title: "Req 5b — Build a Mission Story"
next: "/merit-badges/space-exploration/guide/req6/"
next_title: "Req 6 — Choose a Space Home"
---
...
{{< drg/checklist title="Questions your design must answer" subtitle="Use the environment to drive the spacecraft design" >}}
...
{{< drg/tip >}}
When you describe your spacecraft, connect every feature to a problem. For example, "I added wide solar arrays because my mission stays far from the Sun" is much stronger than just saying "It has solar panels." 
{{< /drg/tip >}}
...
{{< drg/image src="images/sample-return-mission-diagram.avif" alt="Diagram showing the stages of a robotic sample-return mission from launch to Earth recovery" >}}

{{< drg/be-prepared title="What to emphasize when you present your design" >}}

- **Destination choice**: Why is that world worth sampling?
- **Sample method**: How exactly will the spacecraft grab material?
- **Environment problems**: What could go wrong there?
- **Engineering answer**: What design choices solve those problems?
  {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have planned missions that explore and return."
    teaser="Next, choose between studying crewed orbital vehicles and the International Space Station."
