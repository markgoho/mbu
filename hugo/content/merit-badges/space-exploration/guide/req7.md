...
{{< drg/video
    title="How NASA Will Build a City on the Moon (video)"
    url="https://youtu.be/ATgwz_hS3Qg" >}}

## Requirement 7a

{{< drg/inherited-requirement number="7a" req_path="7.a" topic="Source of energy" />}}
...
{{< drg/external-link
    title="You Can't Take It All With You (PDF)"
    url="https://www.nasa.gov/wp-content/uploads/2023/05/you-cant-take-it-all-with-you-grades-6-12-students-tagged.pdf"
    description="A NASA activity that helps you think through limited cargo space, power, and tradeoffs when planning what a mission must bring." >}}

## Requirement 7b

{{< drg/inherited-requirement number="7b" req_path="7.b" topic="How it will be constructed" />}}
...
{{< drg/video
    title="How NASA Plans to Build the First Moon Base (video)"
    url="https://youtu.be/ajP0AlYxhug?si=lKaqYRoM8V4LiXSg" >}}

## Requirement 7c

{{< drg/inherited-requirement number="7c" req_path="7.c" topic="Life-support system" />}}
...
{{< drg/safety-first >}}
On another world, life support is not a comfort system. It is survival equipment. If power fails, pressure drops, or water recycling breaks, the crew could be in danger fast. Treat this part of your design as the highest priority.
{{< /drg/safety-first >}}

{{< drg/video
    title="Robots Building a Mars Base (video)"
    url="https://youtu.be/2tr6rJrv8hs?si=dm1LYgNqLCH7smpr" >}}

## Requirement 7d

{{< drg/inherited-requirement number="7d" req_path="7.d" topic="Purpose and function" />}}
...
{{< drg/video
    title="How Robots Will Build on Mars (video)"
    url="https://youtu.be/ZbOg_cC1_Eo" >}}

## Pulling the whole design together

{{< drg/checklist title="Before you present your base" subtitle="Make sure the four parts support each other" >}}
...
{{< drg/image src="images/lunar-or-mars-base-cutaway.avif" alt="Cutaway diagram of an off-world space base showing habitat modules, power systems, life support, and robotic construction equipment" >}}
...
{{< drg/next-page
    text="You have designed a place where humans could live and work beyond Earth."
    teaser="Next, turn from missions and habitats to the real jobs people do in the space field."
