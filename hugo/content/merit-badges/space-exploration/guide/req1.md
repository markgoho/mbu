...
{{< drg/inherited-requirement number="1a" req_path="1.a" topic="Historical reasons" />}}
...
{{< drg/did-you-know >}}
Sputnik 1 was about the size of a beach ball, but its 1957 launch changed world history because it proved a human-made object could orbit Earth.
{{< /drg/did-you-know >}}

{{< drg/video
    title="The History of Space Exploration (video)"
    url="https://youtu.be/TL__l9gC1Ss?si=BXoLcRCoNZXPEALe" >}}

{{< drg/video
    title="The History of Space Exploration: A Timeline (video)"
    url="https://youtu.be/3JuKR7jf46o" >}}

{{< drg/external-link
    title="The History of the Space Race (website)"
    url="https://education.nationalgeographic.org/resource/history-space-exploration/"
    description="A clear timeline showing how rivalry, discovery, and technology pushed early space milestones forward." >}}

## Requirement 1b

{{< drg/inherited-requirement number="1b" req_path="1.b" topic="Immediate goals in terms of specific knowledge" />}}
...
{{< drg/checklist title="How to explain an immediate goal" subtitle="Use this simple pattern when you talk with your counselor" >}}
...
{{< drg/tip >}}
Words like *measure*, *map*, *detect*, *test*, *observe*, and *sample* often point to immediate scientific goals. Use those verbs in your explanation.
{{< /drg/tip >}}

## Requirement 1c

{{< drg/inherited-requirement number="1c" req_path="1.c" topic="Benefits related to Earth resources, technology, and new products" />}}
...
{{< drg/image src="images/earth-observation-satellite-data.avif" alt="Diagram of an Earth-observation satellite collecting weather, crop, wildfire, and ocean data" >}}

{{< drg/video
    title="How Space Benefits Earth (video)"
    url="https://youtube.com/shorts/i3D4pCq_lyg?si=S_3HJWJ9TrvcHvry" >}}

{{< drg/video
    title="Space Exploration, Is It Really Worth It? Yes. (video)"
    url="https://youtube.com/shorts/jPuqA136SfA?si=EgcAXSXcMBJmVLw4" >}}

{{< drg/video
    title="10 Surprising Ways Space Exploration Benefits Life on Earth (video)"
    url="https://youtube.com/shorts/_2uSv1C-FDw?si=JCFVs8xAXqeJvozN" >}}

## Requirement 1d

{{< drg/inherited-requirement number="1d" req_path="1.d" topic="International relations and cooperation" />}}
...
{{< drg/be-prepared title="If your counselor asks why cooperation matters" >}}

- **Start with cost**: Space missions are expensive, so sharing work makes bigger projects possible.
- **Add expertise**: Different nations and agencies bring different skills and equipment.
- **End with diplomacy**: Working together in space can improve relationships on Earth.
  {{< /drg/be-prepared >}}

{{< drg/video
    title="What Role Does International Cooperation Play in Space Exploration? (video)"
    url="https://youtu.be/TS27Br2-XgY?si=W1CeXgcrzOZ-Trgm" >}}
...
{{< drg/next-page
    text="Now that you know why humans explore space, you can focus on the people who made that story possible."
    teaser="Next, choose a space pioneer and turn research into a collector card you can actually share and discuss."
