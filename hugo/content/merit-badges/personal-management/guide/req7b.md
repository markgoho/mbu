...
req_number: "7b"
prev: "/merit-badges/personal-management/guide/req7a/"
prev_title: "Req 7a — Loans & Interest"
next: "/merit-badges/personal-management/guide/req7c/"
next_title: "Req 7c — Cards & Their Costs"
---
...
**Auto loan:** A loan to buy a car. The car is the collateral. Terms are usually 3 to 7 years. As you learned in [Requirement 7a](/merit-badges/personal-management/guide/req7a/), shorter terms mean less total interest.
...
{{< drg/image src="images/types-of-borrowing.avif" alt="An illustrated chart showing different types of loans arranged by interest rate from lowest to highest: mortgage, auto loan, student loan, personal loan, credit card, payday loan" >}}
...
**Credit cards:** Technically a form of borrowing, covered in detail in [Requirement 7c](/merit-badges/personal-management/guide/req7c/). You borrow money every time you charge something and do not pay it off by the due date.

{{< drg/tip >}}
Before borrowing from any source, ask yourself two questions: "Do I truly need this loan, or can I save up instead?" and "Can I realistically afford the monthly payments?" If the answer to either question is no, reconsider.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Predatory lenders specifically target people who are desperate or uneducated about their options. If a loan offer sounds too easy — "No credit check! Cash in minutes!" — it is almost certainly a bad deal. Legitimate lenders do not need to use those tactics.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
The average American household carries about $104,000 in total debt — including mortgages, car loans, student loans, and credit cards. Understanding the different types of borrowing now helps you make better choices when it is your turn.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Consumer Financial Protection Bureau — Choosing a Loan"
    url="https://www.consumerfinance.gov/consumer-tools/"
    description="Tools and guides from the CFPB to help you compare different types of loans and understand your rights as a borrower." >}}

{{< drg/next-page
    text="You know the different ways to borrow"
    teaser="Next, learn about the three types of plastic in your wallet — and why they are not all the same."
