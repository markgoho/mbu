...
{{< drg/tip >}}
Think of saving as a parking lot and investing as a highway. The parking lot is safe — your car will not crash — but you are not going anywhere. The highway gets you to your destination faster, but there are risks along the way. Smart financial planning uses both.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Social Security — the government retirement program — was never meant to be someone's only income in retirement. It replaces only about 40% of the average worker's pre-retirement income. The rest needs to come from personal savings and investments. That is why learning these skills now matters so much.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Investor.gov — Introduction to Investing"
    url="https://www.investor.gov/introduction-investing"
    description="The SEC's free educational site explaining investing basics, risk, and how different investments work. Designed for beginners." >}}

{{< drg/external-link
    title="Compound Interest Calculator"
    url="https://www.investor.gov/financial-tools-calculators/calculators/compound-interest-calculator"
    description="Try different amounts, interest rates, and time periods to see how compound interest works with your own numbers." >}}

{{< drg/next-page
    text="You understand the principles of saving and investing"
    teaser="Now learn about the specific types of investments — stocks, mutual funds, bonds, and more."
