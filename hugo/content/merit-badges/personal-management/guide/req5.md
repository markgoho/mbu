...
In [Requirement 4](/merit-badges/personal-management/guide/req4/), you learned the principles of investing — risk, return, diversification, and compound interest. Now it is time to meet the specific tools. Think of these six investment types as different tools in a toolbox. Each one has a purpose, and smart investors use a combination of them.
...
**Why it is listed as an investment:** Some types of life insurance (called **whole life** or **universal life**) include a savings component that builds **cash value** over time. You will learn more about the differences between whole life and term life in [Requirement 6](/merit-badges/personal-management/guide/req6/).
...
**How to buy them:** U.S. savings bonds are purchased online through [TreasuryDirect.gov](https://www.treasurydirect.gov). You can buy them for as little as $25.

{{< drg/did-you-know >}}
During World War II, the U.S. government sold "war bonds" to help fund the military effort. Scouts actually helped sell them — going door to door in their communities. Over $185 billion in war bonds were sold, with ordinary Americans funding a huge portion of the war effort.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    title="Investor.gov — Types of Investments"
    url="https://www.investor.gov/introduction-investing/investing-basics/investment-products"
    description="The SEC's guide to different investment types, with clear explanations of how each one works, its risks, and its benefits." >}}

{{< drg/next-page
    text="You now know the major investment types"
    teaser="Next, learn about insurance — how it protects you and your family from financial disaster."
