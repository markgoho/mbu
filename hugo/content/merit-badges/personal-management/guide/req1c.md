...
req_number: "1c"
prev: "/merit-badges/personal-management/guide/req1b/"
prev_title: "Req 1b — Creating a Savings Plan"
next: "/merit-badges/personal-management/guide/req2a/"
next_title: "Req 2a — Building a Budget"
---
...
{{< drg/tip >}}
When reading online reviews, pay attention to reviews from people who have owned the item for months, not just days. A laptop might seem great on day one but overheat after three months. Look for reviews that mention long-term durability.
{{< /drg/tip >}}
...
{{< drg/image src="images/scout-comparison-shopping.avif" alt="A Scout at a library table with a laptop open showing product comparison charts, with a notepad where they are writing down prices from different sources" >}}
...
{{< drg/checklist title="Comparison Shopping Checklist" subtitle="Places to check for prices" >}}
...
{{< drg/safety-first >}}
Never buy used safety equipment like bicycle helmets, car seats, or climbing gear. These items can have invisible damage from previous impacts that compromises their ability to protect you. Always buy safety gear new.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
The average American can save 20 to 40 percent on major purchases just by timing them right. Retailers follow predictable sale cycles, and knowing those patterns puts money back in your pocket.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    ...
    description="Independent, nonprofit product testing organization. One of the most trusted sources for unbiased product ratings and buying advice." >}}

{{< drg/external-link
    title="CNET Product Reviews"
    url="https://www.cnet.com/reviews/"
    description="Technology and electronics reviews with detailed testing, comparisons, and buying recommendations." >}}

{{< drg/next-page
    text="You are now a smart shopper"
    teaser="Next up — learn how to build a personal budget and track your money for 13 weeks."
