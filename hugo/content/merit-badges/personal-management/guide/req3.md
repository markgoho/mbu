...
{{< drg/image src="images/scout-thinking-about-money.avif" alt="A Scout sitting thoughtfully on a park bench, with a thought bubble containing icons representing different financial concepts like a piggy bank, a shopping cart, and a clock" >}}
...
{{< drg/tip >}}
Try an experiment: carry only the amount of cash you intend to spend for a week. No debit card, no extra bills. Notice how it changes your spending decisions. This is sometimes called the "envelope method" — you physically limit what is available to spend.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Studies show that people get more lasting happiness from *experiences* (like a camping trip or concert) than from *things* (like a new gadget). Experiences create memories and stories, while things become ordinary surprisingly fast.
{{< /drg/did-you-know >}}
...
Over time, you earn interest not just on your original deposit, but on the interest you have already earned. This is called **compound interest**, and you will dive deeper into it in [Requirement 4c](/merit-badges/personal-management/guide/req4/). For now, the key idea is that a savings account is not just a safe place to park money — it is a place where your money slowly grows.
...
- **Track your spending** (as you did in [Requirement 2c](/merit-badges/personal-management/guide/req2c/))
...
Choose your five topics, then for each one:
- **Reflect on personal experience.** Your counselor wants to hear *your* thoughts and experiences, not textbook definitions.
- **Be specific.** Instead of "I feel happy when I get money," try "When I got birthday money last year, I immediately wanted to spend it on a new game, but I made myself wait a week."
- **Connect the concepts.** Show how these ideas relate to each other and to the budgeting you did in Requirement 2.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Next Gen Personal Finance — Behavioral Economics"
    url="https://www.ngpf.org/curriculum/behavioral-economics/"
    description="Interactive lessons on how psychology affects financial decisions, designed for students and young adults." >}}

{{< drg/next-page
    text="You have explored the psychology behind your spending"
    teaser="Now learn the difference between saving and investing — and how to make your money grow."
