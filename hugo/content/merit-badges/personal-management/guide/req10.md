...
{{< drg/image src="images/scout-career-exploration.avif" alt="A Scout sitting in a library with career guidebooks open, looking at the Bureau of Labor Statistics website on a laptop, with thought bubbles showing different career paths" >}}

**What to research about your chosen career:**

{{< drg/checklist title="Career Research Checklist" subtitle="Information to gather for your counselor discussion" >}}
...
The budgeting and savings skills from [Requirements 1 and 2](/merit-badges/personal-management/guide/req1a/) apply directly here:

- **Start saving now:** Even small amounts add up over years, thanks to compound interest from [Requirement 4](/merit-badges/personal-management/guide/req4/)
...
{{< drg/did-you-know >}}
The average student loan debt for a bachelor's degree graduate is about $30,000. While that number can feel overwhelming, understanding it now — and planning for it — puts you ahead of most students who do not think about costs until they are already enrolled.
{{< /drg/did-you-know >}}
...
- **Federal student loans** — lower interest rates and better repayment options than private loans (review [Requirement 7](/merit-badges/personal-management/guide/req7a/))
...
{{< drg/be-prepared title="Career Paths Without a Four-Year Degree" >}}
A four-year college degree is one path, but it is not the only path. Many rewarding, well-paying careers require different types of training:
- **Trade schools and apprenticeships:** Electricians, plumbers, HVAC technicians, and welders are in high demand and often earn more than many four-year degree holders
- **Associate degrees:** Two-year programs in nursing, IT, dental hygiene, and other fields
- **Certifications:** IT certifications (CompTIA, AWS), real estate licenses, EMT training
- **Military careers:** Training in leadership, technology, healthcare, logistics, and more
- **Entrepreneurship:** Starting your own business based on a skill or idea
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    ...
    description="The most comprehensive career research tool available. Search hundreds of occupations with details on education, pay, job outlook, and daily duties." >}}

{{< drg/external-link
    title="Federal Student Aid (FAFSA)"
    url="https://studentaid.gov/"
    description="The U.S. Department of Education's site for federal student aid — grants, work-study, and loans. Start here to understand your financial aid options." >}}

{{< drg/next-page
    text="You have completed all ten requirements"
    teaser="Explore Extended Learning for deeper dives, real-world experiences, and resources to continue your financial journey."
    url="/merit-badges/personal-management/guide/extended-learning/" >}}
