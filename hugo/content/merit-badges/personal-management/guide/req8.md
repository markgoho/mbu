...
{{< drg/tip >}}
Use the "Must Do / Should Do / Nice to Do" method to prioritize:
- **Must Do:** Tasks with deadlines or consequences (homework due Tuesday, take out trash)
- **Should Do:** Important but flexible (practice guitar, clean room)
...
{{< drg/checklist title="Scheduling Tips" subtitle="Strategies for fitting everything in" >}}
...
{{< drg/be-prepared title="What If Your Whole Schedule Falls Apart?" >}}
Some weeks are just like that. A family emergency, getting sick, or an unexpected school project can throw everything off. Do not panic and do not abandon the exercise:
- **Keep journaling** — record what actually happened, even if it looks nothing like your plan
- **Adapt in real time** — reschedule what you can to later in the week
...
{{< drg/external-link
    title="Eisenhower Matrix — Time Management Framework"
    url="https://www.eisenhower.me/eisenhower-matrix/"
    description="A simple, powerful framework for prioritizing tasks based on urgency and importance. Named after President Dwight D. Eisenhower, who was famous for his productivity." >}}
