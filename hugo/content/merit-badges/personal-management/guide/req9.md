...
{{< drg/tip >}}
Choose a project that is complex enough to plan but realistic enough to be achievable. "Plan a troop camping trip" is a sweet spot — it involves people, logistics, food, gear, transportation, and a budget. "Plan a trip to Mars" is too complex. "Plan to clean my room" is too simple.
{{< /drg/tip >}}
...
- **S**pecific: What exactly will happen?
- **M**easurable: How will you know it is done?
- **A**chievable: Can it realistically be accomplished?
- **R**elevant: Why does this project matter?
- **T**ime-bound: When will it be completed?
...
{{< drg/checklist title="Sample Timeline (Park Cleanup)" subtitle="Working backward from event date" >}}
...
{{< drg/tip >}}
Always include a contingency line in your budget — extra money set aside for things you did not anticipate. Professional project managers typically add 10 to 15 percent of the total budget as contingency. Things always cost more than you expect.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Making Your Plan Stand Out" >}}
Your counselor reviews many project plans. Here is how to make yours excellent:
- **Be specific with numbers.** "We need trash bags" is weak. "We need 50 heavy-duty 33-gallon trash bags at $0.40 each = $20" is strong.
- **Think about what could go wrong.** Include a brief risk section: What if it rains? What if half the volunteers cancel? Having backup plans shows mature thinking.
- **Make it visual.** A timeline chart, a budget table, or a simple map of the project site makes your plan clearer and more professional.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Scouting America — Service Project Planning"
    url="https://www.scouting.org/resources/guide-to-advancement/service-projects/"
    description="Scouting America's guide to planning and executing service projects, with templates and checklists." >}}
