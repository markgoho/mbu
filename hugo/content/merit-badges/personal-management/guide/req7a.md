...
req_number: "7a"
prev: "/merit-badges/personal-management/guide/req6/"
prev_title: "Req 6 — Understanding Insurance"
next: "/merit-badges/personal-management/guide/req7b/"
next_title: "Req 7b — Ways to Borrow"
---
...
In [Requirement 4](/merit-badges/personal-management/guide/req4/), you learned about interest as something you *earn* on savings. With loans, interest is something you *pay*. It is the price of using someone else's money.
...
{{< drg/image src="images/scout-understanding-loans.avif" alt="A Scout reading a document labeled Loan Agreement with a magnifying glass focused on the interest rate section, sitting at a desk with a calculator" >}}
...
{{< drg/did-you-know >}}
Federal law (the Truth in Lending Act) requires lenders to disclose the APR before you agree to any loan. This law was passed in 1968 specifically to protect borrowers from hidden costs and deceptive lending practices.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When you borrow money, always ask: "What is the total amount I will pay over the life of this loan?" Lenders often focus on the low monthly payment to make a loan seem affordable, but the total cost tells the real story.
{{< /drg/tip >}}

{{< drg/external-link
    title="Consumer Financial Protection Bureau — Understanding Loan Costs"
    url="https://www.consumerfinance.gov/consumer-tools/loans/"
    description="The CFPB's guide to understanding loans, comparing offers, and avoiding costly mistakes when borrowing money." >}}

{{< drg/next-page
    text="You understand how loans and interest work"
    teaser="Next, explore the different ways you can borrow money."
