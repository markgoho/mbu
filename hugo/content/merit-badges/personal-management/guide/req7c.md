...
req_number: "7c"
prev: "/merit-badges/personal-management/guide/req7b/"
prev_title: "Req 7b — Ways to Borrow"
next: "/merit-badges/personal-management/guide/req7d/"
next_title: "Req 7d — Credit Reports"
---
...
**Pros:**
- Builds credit history (important for [Requirement 7d](/merit-badges/personal-management/guide/req7d/))
...
{{< drg/image src="images/three-cards-comparison.avif" alt="Three cards side by side — a debit card, credit card, and charge card — each with a brief label underneath highlighting their key difference" >}}
...
{{< drg/did-you-know >}}
Credit card companies are required by law to print a "minimum payment warning" on every statement, showing how long it will take to pay off your balance if you only make minimum payments. Look for this box on any credit card statement — the numbers are often shocking.
{{< /drg/did-you-know >}}

### Costs and Pitfalls to Watch For

{{< drg/checklist title="Hidden Costs of Cards" subtitle="Fees and charges that catch people off guard" >}}
...
{{< drg/be-prepared title="What If You Cannot Pay Your Credit Card Bill?" >}}
If you find yourself unable to pay your full credit card balance:
- **Pay as much as you can** — anything above the minimum reduces how much interest you owe
- **Call the card company** — many will work with you on a payment plan if you are honest about your situation
- **Do not ignore it** — missed payments damage your credit score and trigger penalty interest rates
- **Do not take a cash advance** to pay a credit card — this creates a cycle of debt
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Federal Reserve — Credit Card Repayment Calculator"
    url="https://www.federalreserve.gov/creditcardcalculator/"
    description="See exactly how long it will take to pay off a credit card balance at different payment amounts. A powerful visual tool for understanding minimum payments." >}}

{{< drg/next-page
    text="You understand how cards work and their hidden costs"
    teaser="Next, learn about credit reports — your financial reputation and how to protect it."
