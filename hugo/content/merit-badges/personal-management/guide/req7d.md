...
{{< drg/image src="images/scout-credit-report.avif" alt="A Scout looking at a document labeled Credit Report with a magnifying glass, with sections highlighted showing payment history, accounts, and credit score" >}}
...
{{< drg/did-you-know >}}
A single late payment can lower your credit score by 60 to 100 points and stay on your credit report for seven years. That one missed payment could cost you thousands of dollars in higher interest rates on future loans.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Even if you do not have credit yet, it is a good idea to check your credit report once you turn 18. Identity theft can affect anyone, and checking your report helps you catch unauthorized accounts early. Some parents check their children's credit reports to make sure no one has opened accounts in their child's name.
{{< /drg/tip >}}

{{< drg/external-link
    title="AnnualCreditReport.com"
    url="https://www.annualcreditreport.com"
    description="The only federally authorized source for free annual credit reports from all three major credit bureaus." >}}
...
{{< drg/external-link
    ...
    description="Comprehensive guide to understanding, checking, and disputing errors on your credit report." >}}

{{< drg/next-page
    text="You understand your financial reputation"
    teaser="Now learn practical strategies for reducing and eliminating debt."
