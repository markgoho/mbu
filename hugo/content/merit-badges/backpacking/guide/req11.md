...
{{< drg/tip >}}
Build flexibility into your schedule. Allow at least one "buffer day" or shorter mileage day in case of bad weather, injuries, or slower-than-expected progress. A rigid schedule that falls apart on day 2 creates stress and poor decisions.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Get approval from the land management agency (Forest Service, Park Service, BLM) before performing any trail work. Some areas require training or specific tools. Your counselor can help coordinate with the local ranger district.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Bring a small, lightweight notebook and a pencil (pens can freeze or leak). Write in your journal at camp each evening while the day is fresh. Keep it in a zip-lock bag to protect it from rain. Your future self will thank you for these notes when planning the next adventure.
{{< /drg/tip >}}

{{< drg/image src="images/journal-writing-campfire.avif" alt="A Scout writing in a small journal by the light of a headlamp at a backcountry campsite in the evening" >}}

### Video Resources

{{< drg/external-link title="Philmont Scout Ranch — Plan Your Trek" url="https://www.philmontscoutranch.org/treks/" description="Learn about Scouting's premier backpacking experience at Philmont Scout Ranch in New Mexico." >}}

{{< drg/external-link title="National Park Service — Plan Your Backcountry Trip" url="https://www.nps.gov/subjects/camping/backcountry-camping.htm" description="The National Park Service guide to planning backcountry trips in America's national parks." >}}

{{< drg/next-page
    text="You have planned and completed the ultimate backpacking challenge."
    teaser="Explore additional resources, experiences, and organizations to continue your backpacking journey."
