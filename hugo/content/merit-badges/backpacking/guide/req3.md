...
{{< drg/tip >}}
Check the regulations for your specific trail or wilderness area before your trip. Some places limit group size to as few as 6 people, and popular trails may require advance permits.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
At Philmont Scout Ranch, crews assign formal positions including Crew Leader, Chaplain's Aide, Wilderness Guia (guide), and Leave No Trace Trainer. Every crew member has a specific job, and crews rotate roles throughout the trek so everyone builds leadership skills.
{{< /drg/did-you-know >}}

{{< drg/image src="images/crew-hiking-formation.avif" alt="A small group of Scouts hiking single file on a mountain trail, with the leader in front and sweep in back, spaced evenly apart" >}}
...
{{< drg/checklist title="Risk Reduction Strategies" subtitle="Steps to take before and during every trek" >}}
...
- **Step 2**: Your first aider assesses the injury — is it a sprain or a fracture?
- **Step 3**: Treat the injury with your first-aid kit (wrap, splint, elevate).
- **Step 4**: Consult your emergency response plan — where is the nearest evacuation point?
- **Step 5**: If the person cannot walk, send two crew members for help while at least one person stays with the injured Scout.
- **Step 6**: Use your emergency communication device if available.
{{< /drg/be-prepared >}}

### Video Resources

{{< drg/video title="Backpacking Emergency Response Plan" url="https://youtu.be/kypwGloorRk?si=EU5OPuV3A5yDbfx8" >}}

{{< drg/external-link title="Philmont Crew Requirements" url="https://www.philmontscoutranch.org/treks/trekrequirements/crewrequirements/" description="See how Philmont Scout Ranch organizes trek crews, including size requirements and crew positions." >}}

{{< drg/external-link title="Philmont Crew Positions" url="https://www.philmontscoutranch.org/treks/trek-resources/crew-positions/" description="Detailed descriptions of crew roles used at Philmont, a model for organizing any backpacking crew." >}}

{{< drg/next-page
    text="Your crew is organized and your risk plan is in place."
    teaser="Learn how to protect the wilderness you are hiking through with Leave No Trace."
