...
{{< drg/checklist title="Weather Preparation Checklist" subtitle="Pack and plan for bad weather before you leave" >}}
...
{{< drg/image src="images/rain-gear-trail.avif" alt="A Scout hiking along a forest trail in rain gear — waterproof jacket, pack cover, and gaiters — with rain falling through the tree canopy" >}}
...
{{< drg/safety-first >}}
If you hear thunder, you are within striking range. The "30-30 rule" is your guide: if the time between a lightning flash and thunder is less than 30 seconds, seek shelter immediately. Wait at least 30 minutes after the last thunder before resuming your hike.
{{< /drg/safety-first >}}
...
- **Step 2**: Eat a high-calorie snack — your body burns calories to produce heat.
- **Step 3**: Boil water and fill a water bottle to use as a hot-water bottle inside your sleeping bag.
- **Step 4**: If your sleeping bag is not warm enough, layer an emergency blanket over it or inside it for extra insulation.
- **Step 5**: In the morning, reassess whether conditions are safe to continue or if your crew should adjust the plan.
{{< /drg/be-prepared >}}

{{< drg/did-you-know >}}
Wind chill makes air temperature feel much colder than it actually is. A 40°F day with 30 mph winds feels like 28°F on exposed skin. Always factor wind chill into your clothing decisions, especially above the tree line.
{{< /drg/did-you-know >}}

### Video Resources

{{< drg/video title="Backpacking in Rain, Lightning, Hail, and Wind" url="https://youtu.be/J4atUCcf4p0?si=E5kHrCGO6P7evExq" >}}

{{< drg/external-link title="National Weather Service — Point Forecasts" url="https://www.weather.gov/" description="Get accurate point forecasts for any GPS coordinates in the United States — essential for backcountry trip planning." >}}

{{< drg/next-page
    text="You are ready to handle whatever the weather throws at you."
    teaser="Learn about backpacking stoves, fuels, and how to cook in the backcountry."
