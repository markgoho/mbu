...
{{< drg/safety-first >}}
Hypothermia sneaks up on you. A person with hypothermia may not realize they are in trouble because the cold affects their thinking. Watch your hiking partners closely — if someone stops shivering, stumbles, or seems confused, act immediately.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/hydration-break-shade.avif" alt="Scouts taking a hydration break in the shade of trees along a trail, drinking from water bottles" >}}
...
{{< drg/tip >}}
Set a hydration alarm on your watch or phone. Every 15–20 minutes, take a few sips of water — even if you do not feel thirsty. By the time thirst kicks in, you are already behind on fluids.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
A tick must be attached for 36 to 48 hours to transmit Lyme disease. That is why daily tick checks are so effective — finding and removing ticks quickly dramatically reduces your risk.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/first-aid-kit-trail.avif" alt="An open backpacking first-aid kit laid out on a flat rock showing bandages, moleskin, tweezers, and antiseptic wipes" >}}
...
{{< drg/be-prepared title="Hotspot on the Trail" >}}
You are three miles into a hike and feel a burning sensation on your heel. Do not ignore it — stop immediately.

- **Step 1**: Take off your boot and sock. Inspect the area.
- **Step 2**: Dry your foot thoroughly.
- **Step 3**: Apply moleskin, athletic tape, or a blister bandage directly over the hotspot.
- **Step 4**: Put on a dry sock if you have one.
- **Step 5**: Adjust your boot lacing to reduce friction in that area.

Catching a hotspot early takes two minutes. Ignoring it can sideline you for the rest of the trek.
{{< /drg/be-prepared >}}

### Video Resources

{{< drg/video title="Backpacking First Aid" url="https://youtu.be/nxExCQiWa_U?si=E-FC1vbHZYI0vxhb" >}}

{{< drg/video title="Preventing and Treating Blisters" url="https://youtu.be/lIvLRG31MZI?si=Y7vTYYNYNzcl_MV2" >}}

{{< drg/external-link title="Wilderness First Aid Basics — NOLS" url="https://www.nols.edu/en/coursefinder/courses/wilderness-first-aid-WFA/" description="Learn about wilderness first aid courses that teach you to handle medical emergencies far from hospitals." >}}

{{< drg/next-page
    text="Now that you know how to stay healthy on the trail"
    teaser="learn what essential gear belongs in every backpacker's pack."
