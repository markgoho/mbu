...
req_number: "4a"
prev: "/merit-badges/backpacking/guide/req3/"
prev_title: "Crew Organization & Safety"
next: "/merit-badges/backpacking/guide/req4b/"
next_title: "Waste & Hygiene"
---
...
{{< drg/image src="images/leave-no-trace-campsite.avif" alt="A pristine backcountry campsite with no visible impact — no litter, no fire scars, tent pitched on durable ground" >}}
...
{{< drg/tip >}}
Carry a small, dedicated "trash bag" attached to the outside of your pack. Make it easy to grab — the harder it is to reach, the more tempting it is to drop that granola bar wrapper on the trail.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Cryptobiotic soil — the dark, crusty surface found in desert environments — is actually a living community of bacteria, algae, and fungi. A single footprint can destroy decades of growth. In desert environments, stepping only on rock and established trails is critical.
{{< /drg/did-you-know >}}

### Video Resources

{{< drg/video title="What is Leave No Trace?" url="https://youtu.be/Rpq01rO9ZR0?si=YIELlDJ5aYqUmUi9" >}}

{{< drg/external-link title="Leave No Trace Seven Principles" url="https://lnt.org/why/7-principles/" description="The official Leave No Trace Center for Outdoor Ethics guide to the seven principles." >}}

{{< drg/next-page
    text="You understand why protecting the backcountry matters."
    teaser="Learn the practical skills of waste management and personal hygiene on the trail."
