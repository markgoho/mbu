...
req_number: "4b"
prev: "/merit-badges/backpacking/guide/req4a/"
prev_title: "Req 4a — Leave No Trace"
next: "/merit-badges/backpacking/guide/req4c/"
next_title: "Req 4c — Choosing a Campsite"
---
...
{{< drg/safety-first >}}
Always carry a lightweight backpacking trowel. Trying to dig a cathole with a stick or rock is unreliable — the hole may not be deep enough for proper decomposition, which increases the risk of contamination and disease.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Bring two or three small zip-lock bags specifically labeled for waste: one for used toilet paper, one for food scraps, and one for general trash. Double-bagging eliminates odor issues in your pack.
{{< /drg/tip >}}
...
{{< drg/image src="images/backcountry-hand-washing.avif" alt="A Scout using a small bottle of biodegradable soap and water from a pot to wash their hands at a backcountry campsite, well away from a stream" >}}
...
{{< drg/video title="How to Poop in the Woods" url="https://youtu.be/Dk2k1QEyY7U?si=f4XaWPIgmh29_Cm9" >}}

{{< drg/external-link title="Leave No Trace — Disposal of Human Waste" url="https://lnt.org/why/7-principles/dispose-of-waste-properly/" description="Official guidance on waste disposal methods for different backcountry environments." >}}

{{< drg/next-page
    text="You know how to handle waste and keep yourself clean on the trail."
    teaser="Learn how to choose the perfect campsite."
