...
Explain the following terms: native metal, malleable, metallurgy, alloy, nonferrous, and ferrous. Then do the following:
{{< /drg/requirement >}}
...
{{< drg/image src="images/ferrous-vs-nonferrous-comparison.avif" alt="A side-by-side comparison showing common ferrous and nonferrous metals with icons for magnetism, corrosion resistance, and typical uses" >}}
...
{{< drg/did-you-know >}}
The Bronze Age is named after an alloy, not a pure metal. That tells you how important the discovery of mixing copper with tin was to human history.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
A metal getting harder to bend is not the tool becoming weaker—it is a sign the metal itself is changing because of the work you are doing to it.
{{< /drg/tip >}}
...
{{< drg/checklist title="What Req 2 Teaches You" subtitle="Carry these ideas into the next requirement" >}}
...
{{< drg/next-page
    text="Now it is time to feel these ideas instead of just defining them."
    teaser="Work-harden, anneal, and temper metal so you can see how heat and hammering change its behavior."
