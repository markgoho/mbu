...
{{< drg/safety-first >}}
Molten metal and moisture are a dangerous combination. Follow your counselor's exact shop rules for dry materials, protective gear, pouring position, and safe distance. Never improvise with molten metal.
{{< /drg/safety-first >}}

{{< drg/image src="images/casting-pour-sequence.avif" alt="A step-by-step sequence showing a prepared two-piece mold, molten lead-free pewter being poured into the gate, and the finished casting after release" >}}
...
{{< drg/next-page
    text="You have completed the founder path."
    teaser="The blacksmith path returns to direct force and heat, where a hammer and anvil shape hot steel in real time."
