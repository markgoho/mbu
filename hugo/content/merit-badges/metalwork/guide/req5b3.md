...
{{< drg/inherited-requirement number="5b3a" req_path="5.b.3.a" topic="At least one object must include a sawed component you have made yourself." />}}
...
{{< drg/inherited-requirement number="5b3b" req_path="5.b.3.b" topic="At least one object must include a sunken part you have made yourself." />}}
...
{{< drg/inherited-requirement number="5b3c" req_path="5.b.3.c" topic="Clean and polish your objects." />}}
...
{{< drg/image src="images/silversmith-project-sequence.avif" alt="A four-step sequence showing copper sheet being sawed, a shallow sunken form being made, a soldered seam being heated, and the finished polished object" >}}

{{< drg/safety-first >}}
Flux, torch heat, and polishing compounds all create hazards. Ventilation, eye protection, and careful handling of hot small parts matter throughout this process—not just during soldering.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You have completed the silversmith path."
    teaser="The founder path approaches metal from a different direction by shaping molds first and letting molten metal fill the form."
