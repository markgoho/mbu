  ...
  - group_title: "1. Safety & Vocabulary"
    items:
      ...
      - title: "2. The Language of Metal"
        ...
        is_sub: false
  - group_title: "Hardening, Softening & Tempering"
    items:
...
{{< drg/safety-first >}}
Hot metal does not always look hot. In many shops, the most dangerous piece in the room is the one that looks dark and harmless but is still hot enough to burn skin instantly. Assume heated metal stays dangerous until your instructor or counselor says otherwise.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="Every good metalworker starts the same way."
    teaser="Learn the safety habits that protect you, your tools, and everyone else in the shop."
    url="/merit-badges/metalwork/guide/req1/" >}}
