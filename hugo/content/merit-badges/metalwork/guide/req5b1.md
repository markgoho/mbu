...
{{< drg/image src="images/silversmith-bench-tools.avif" alt="A silversmith bench with a jeweler's saw, bench pin, small hammers, files, soldering torch, tweezers, and forming stakes neatly arranged" >}}
...
{{< drg/safety-first >}}
Small hot parts can be more dangerous than large ones because people forget how quickly they heat up. Use tools to move recently soldered pieces, and never assume a tiny object is safe to touch just because it looks harmless.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="With the tools in mind, you can start planning your projects."
    teaser="Sketch two objects and think through their dimensions, joints, and shaped areas before you cut any metal."
