...
Identify how you might use the skills and knowledge in metalworking to pursue a personal hobby. Research the additional training required, expenses, and affiliation with organizations that would help you maximize the enjoyment and benefit you might gain from it. Discuss what you learned with your counselor and share what short-term and long-term goals you might have if you pursued this.
{{< /drg/requirement >}}
...
{{< drg/checklist title="Hobby Planning Questions" subtitle="Use these to build a practical plan" >}}
...
{{< drg/tip >}}
The best hobby plan is the one you can actually sustain. A shared studio membership and two careful projects might teach you more than a pile of tools you barely know how to use.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have explored how metalworking can fit your future."
    teaser="Now choose the craft path you want to study in depth: tinsmithing, silversmithing, founding, or blacksmithing."
