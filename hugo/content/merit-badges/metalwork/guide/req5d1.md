...
{{< drg/image src="images/blacksmith-tool-station.avif" alt="A blacksmith shop setup with forge, anvil, hammer, tongs, vise, and wire brush labeled by function" >}}
...
{{< drg/safety-first >}}
Never leave hot stock where someone could mistake it for cool metal. In a forge area, communication and tool placement are safety tools too.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="With the toolset in mind, you can start planning forged projects."
    teaser="Sketch two hot-forged objects and think through size, bends, twists, and how the pieces will be worked at the anvil."
