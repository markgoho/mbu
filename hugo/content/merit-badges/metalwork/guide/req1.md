...
{{< drg/checklist title="Metal Shop Safety Habits" subtitle="Build these habits before every session" >}}
...
{{< drg/tip >}}
A glove is not magic armor. Thin fabric gloves can burn, melt, snag, or give you false confidence. Use the protective gear that matches the job, not the gear that simply feels toughest.
{{< /drg/tip >}}
...
{{< drg/image src="images/heat-zones-on-a-metalwork-bench.avif" alt="A metalworking bench showing a clearly marked hot zone, tool zone, and scrap zone around a freshly heated workpiece" >}}

{{< drg/safety-first >}}
Never cool metal by guessing. Use the shop method your counselor teaches. Some pieces should air-cool, some may be quenched, and some should be left alone. Wrong cooling can injure you and ruin the workpiece.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="Before You Start a Shop Session" >}}
If you are about to begin a metalworking activity, stop and do this quick scan first:

- **Look at the floor**: Remove cords, scrap, and tripping hazards.
- **Look at the bench**: Set your tools down in a deliberate order.
- **Look at the material**: Check for sharp edges, burrs, coatings, and the correct thickness.
- **Look at the heat source**: Confirm ventilation, clear space, and where hot material will go.
- **Look at yourself**: Eye protection on, sleeves controlled, and attention focused.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="Now that you know how to stay safe, you can start speaking the language of the shop."
    teaser="Learn the key words that explain how metals are classified, combined, hardened, and softened."
