...
{{< drg/image src="images/tinsmith-basic-tools-layout.avif" alt="A neatly arranged set of tinsmith tools labeled by function: layout, cutting, bending, shaping, supporting, and joining" >}}
...
{{< drg/safety-first >}}
Do not use a damaged cutting tool or a loose-headed hammer. In metalwork, a worn or broken tool does not just make sloppy work—it can send sharp metal or tool parts flying.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="Now that you know the tools, plan the projects that will use them."
    teaser="Sketch two sheet-metal objects and think through dimensions, parts, and how the pieces will fit together."
