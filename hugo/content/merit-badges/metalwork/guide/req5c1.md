...
{{< drg/image src="images/two-piece-mold-parts-labeled.avif" alt="A clear cutaway diagram of a two-piece mold with cope, drag, cavity, pouring gate, runner, and vent labeled" >}}

{{< drg/tip >}}
If you remember only one thing, remember this: the cavity gives the shape, the gate brings metal in, and the vent lets air out. Those three ideas explain a lot of casting behavior.
{{< /drg/tip >}}

Understanding mold structure now will help you design smarter objects in the next requirement.

{{< drg/next-page
    text="With the mold structure in mind, you can plan objects for casting."
    teaser="Sketch two cast objects and think through size, shape, and how molten metal will reach every part of the design."
