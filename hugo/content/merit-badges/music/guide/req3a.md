...
req_number: "3a"
req_path: "3.a"
prev: "/merit-badges/music/guide/req3/"
prev_title: "Req 3 — Choose Your Music Experiences"
next: "/merit-badges/music/guide/req3b/"
next_title: "Req 3b — Family Music Interview"
---
...
{{< drg/checklist title="What to Notice While You Listen" subtitle="Write down observations while the details are fresh" >}}
...
{{< drg/tip >}}
Take brief notes during breaks or right after each piece. Waiting until the end of a three-hour listening session makes titles, performers, and first impressions much harder to remember.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The same melody can feel completely different when tempo, instrumentation, or harmony changes. A tune played by solo violin may sound intimate, while the same tune played by full brass can sound heroic.
{{< /drg/did-you-know >}}
...
This discussion skill connects strongly to [Req 3b](/merit-badges/music/guide/req3b/), where you compare reactions across generations, and to [Req 3d](/merit-badges/music/guide/req3d/), where you connect people and influence.

{{< drg/be-prepared title="If You Feel Unsure Talking About Music" >}}
Use a simple four-part pattern:

- **Name what you heard:** instrument, voice, style, or tempo.
- **Describe it:** bright, heavy, smooth, syncopated, dramatic, relaxed.
- **Point to evidence:** a solo, chorus, repeated beat, or dynamic change.
- **Say your reaction:** what it made you think or feel.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Kennedy Center Education"
    url="https://www.kennedy-center.org/education/"
    description="Arts education resources that can help you think and talk more clearly about what you hear in performance." >}}
...
{{< drg/next-page
    text="You are ready to listen like a musician instead of a bystander"
    teaser="Next, compare your musical world with a family member's and see how taste changes across time."
