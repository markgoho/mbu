...
{{< drg/checklist title="What Counts as Strong Evidence" subtitle="Keep track as you go instead of trying to remember later" >}}
...
{{< drg/tip >}}
A Scout who quietly counts and enters at the right time is already serving the group well. Reliable timing is one of the most valuable ensemble skills there is.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Getting Ready for a Public Performance" >}}
Use this simple routine before each appearance:

- **Choose music you can play or sing securely.**
- **Practice the opening and ending extra times.**
- **Do one run-through without stopping, even if you make a mistake.**
- **Check logistics:** music stand, instrument, accompaniment, page turns, and tuning.
{{< /drg/be-prepared >}}
...
That reflection connects directly back to [Req 1](/merit-badges/music/guide/req1/), where you focused on technique, phrasing, tone, rhythm, and dynamics. This option shows what happens when you practice those skills over months instead of days.

{{< drg/external-link
    title="NAfME"
    url="https://nafme.org/"
    description="Music education resources that highlight ensemble learning, performance skills, and long-term musical growth." >}}

After looking at the performance path, the next option steps back and studies the people who shaped American music itself.

{{< drg/next-page
    text="You have seen how repeated performance builds real musicianship"
    teaser="Next, research five people whose ideas, songs, or performances changed American music."
