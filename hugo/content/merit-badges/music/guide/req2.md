...
{{< drg/did-you-know >}}
A saxophone is made of metal, but it is still a woodwind because a reed starts the vibration. The material matters less than the sound-making method.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="What to Label in Your Illustration" subtitle="Make the sound path easy to follow" >}}
...
{{< drg/image src="images/instrument-families-vibration-diagram.avif" alt="Five instrument families side by side with the first vibrating part labeled for violin, clarinet, trumpet, snare drum, and piano" >}}
...
{{< drg/video
    title="Classification of Musical Instruments (video)"
    url="https://youtu.be/WencyslK76o" >}}

{{< drg/video
    title="Orchestral Instruments and How They Sound (video)"
    url="https://youtu.be/Sr-l2m8twX0?si=6Fj8mHWGIRqhrhwi" >}}

{{< drg/tip >}}
If you are not sure whether your illustration is detailed enough, imagine explaining it to a younger Scout. If they can point to each part and say how the sound begins, you are on the right track.
{{< /drg/tip >}}

[Req 1](/merit-badges/music/guide/req1/) asked you to think about tone and expression. This requirement helps you explain where that tone comes from in the first place.

{{< drg/external-link
    title="The Metropolitan Museum of Art"
    url="https://www.metmuseum.org/"
    description="Explore instrument collections and learn how design, material, and culture shape musical sound." >}}

Next you will reach one of the choose-your-own sections of this badge and decide which music experiences fit you best.

{{< drg/next-page
    text="You can now explain how the five instrument groups create sound"
    teaser="Choose two music experiences that let you listen, perform, research, or connect music to your own life."
