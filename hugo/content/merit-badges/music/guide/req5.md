...
{{< drg/video
    title="What Are Intellectual Property Rights? (video)"
    url="https://youtu.be/UqZJPuyK9VY" >}}
...
{{< drg/checklist title="Questions to Ask About a Music Source" subtitle="Use these when deciding whether access is proper" >}}
...
{{< drg/tip >}}
When in doubt, share a legal link instead of a file. That simple choice avoids many common copyright mistakes.
{{< /drg/tip >}}
...
This connects naturally to [Req 4b](/merit-badges/music/guide/req4b/). Once you try composing something yourself, it becomes easier to understand why creators care about ownership and permission.

{{< drg/did-you-know >}}
One song can involve several layers of ownership at once: the lyrics, the melody, the arrangement, and the recorded performance may all involve different people or rights.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="U.S. Copyright Office"
    url="https://copyright.gov/"
    description="Official information about copyright, registration, and how creative works such as music are protected in the United States." >}}

{{< drg/be-prepared title="Explaining This to Your Counselor" >}}
A clear explanation might sound like this:

- **Intellectual property** means creative work protected by law.
- **Music should be obtained legally** through authorized purchases, libraries, or licensed streaming.
- **Music should be shared legally** by following permissions and platform rules, often by sharing links instead of files.
{{< /drg/be-prepared >}}

The badge ends with one more choice: think ahead to how music might shape your future as a career or a long-term hobby.

{{< drg/next-page
    text="You can now explain why recorded music is creative property, not just data"
    teaser="Next, choose a future-facing path: research a music career or build a music hobby plan."
