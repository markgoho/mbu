...
{{< drg/checklist title="Helpful Interview Questions" subtitle="Use these to move beyond one-word answers" >}}
...
{{< drg/tip >}}
When your relative names a favorite song, ask, "What makes this one stick with you?" The answer is often more interesting than the song title itself.
{{< /drg/tip >}}
...
That note-taking habit will also help in [Req 3a](/merit-badges/music/guide/req3a/) and [Req 6b](/merit-badges/music/guide/req6b/), where you reflect on how music fits into your life.

{{< drg/be-prepared title="If the Conversation Starts to Stall" >}}
Try one of these prompts:

- **"What song takes you back to middle school or high school right away?"**
- **"Was there music your parents liked that you did not understand until later?"**
- **"What was a song everyone seemed to know back then?"**
- **"Is there a style you grew to appreciate only as an adult?"**
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Library of Congress"
    url="https://www.loc.gov/"
    description="Use music collections and recordings to place favorite songs in a larger American history and culture context." >}}
...
{{< drg/next-page
    text="You have used conversation to explore how music carries memory and identity"
    teaser="Next, look at the long-term performance option: six months in a group or six public solo appearances."
