...
{{< drg/video
    title="Music Hobbies (video)"
    url="https://youtu.be/2XdqwW4zDtE?si=DBqxq3JLiPrE1mG9" >}}
...
{{< drg/checklist title="Build a Realistic Hobby Plan" subtitle="Use this to prepare for your counselor discussion" >}}
...
{{< drg/tip >}}
A strong hobby plan is specific enough to act on next week. "Get better at music" is vague. "Take beginner guitar lessons this summer and learn four campfire songs" is a real plan.
{{< /drg/tip >}}
...
This option ties back to [Req 3b](/merit-badges/music/guide/req3b/), where you heard how music can stay meaningful across generations. It also connects to [Req 6a](/merit-badges/music/guide/req6a/), because the same research habits help you plan either a job path or a hobby path.

{{< drg/external-link
    title="National Association for Music Education"
    url="https://nafme.org/"
    description="Find music-learning ideas, organizations, and resources that can help you keep music in your life long after the badge is finished." >}}

You have reached the end of the requirements. The next page looks beyond them and explores where music can take you next.

{{< drg/next-page
    text="You have a plan for keeping music alive as part of your life"
    teaser="Continue into Extended Learning for deeper ideas, real-world experiences, and organizations worth exploring."
    url="/merit-badges/music/guide/extended-learning/" >}}
