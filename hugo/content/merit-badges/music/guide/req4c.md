...
{{< drg/checklist title="Questions to Answer Before You Build" subtitle="Knowing the tradition helps you build with purpose" >}}
...
[Req 2](/merit-badges/music/guide/req2/) is a big help here because it taught you to think about what vibrates first and what amplifies that vibration.

{{< drg/safety-first >}}
If your build uses cutting tools, heated materials, wire, or stretched parts under tension, slow down and use proper supervision. Sharp edges, splinters, and snapping materials can turn a fun project into an injury fast.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Keep your first performance goal simple. A steady rhythm on a hand drum or a short repeating melody on a simple flute is better than attempting something far beyond the instrument's design or your current skill level.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Explaining Your Instrument to Your Counselor" >}}
Be ready to describe:

- **what tradition it comes from**
- **how it makes sound**
- **what materials you used**
- **what you changed in your Scout-built version**
- **what you learned while practicing it**
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Smithsonian Folkways"
    url="https://folkways.si.edu/"
    description="Explore recordings and cultural context for traditional instruments and music from many communities around the world." >}}
...
{{< drg/next-page
    text="You have connected music to materials, design, and tradition"
    teaser="Next, learn what intellectual property means and how to obtain and share recorded music properly."
