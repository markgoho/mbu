...
{{< drg/checklist title="Before You Perform" subtitle="Use this quick run-through before you sing or play for your counselor" >}}
...
{{< drg/video
    title="How to Read Music (video)"
    url="https://youtu.be/ZN41d7Txcq0?si=G50I4GaI0d62XHew" >}}
...
{{< drg/tip >}}
If you make the same mistake three times in a row, stop and isolate just those two or three notes. Slow practice fixes more problems than repeating the whole song at full speed.
{{< /drg/tip >}}
...
{{< drg/video
    title="Violin Demonstration (video)"
    url="https://youtu.be/XbppMuZF3_8?si=c9BYdNXj6_VO4WEY" >}}

{{< drg/video
    title="Instrument Demonstration for Beginning Band (video)"
    url="https://youtu.be/CCTeSjpDsIs?si=NZkosauuFJR21A14" >}}

{{< drg/be-prepared title="If You Get Nervous" >}}
Performance nerves are normal. Use a simple reset:

- **Breathe in slowly for four counts** before you start.
- **Look at the first line of music**, not the whole page.
- **Commit to the beat** even if one note goes wrong.
- **Keep going.** Most listeners notice stopping more than they notice a small mistake.
{{< /drg/be-prepared >}}

In [Req 3c](/merit-badges/music/guide/req3c/), you may choose to perform repeatedly for a group. The preparation habits you build here will help there too.

{{< drg/external-link
    title="NAfME"
    url="https://nafme.org/"
    description="The National Association for Music Education offers articles and resources about music learning, practice, and performance." >}}

Once you know how to perform one piece well, the next step is understanding how instruments make their different sounds.

{{< drg/next-page
    text="You have practiced how musical expression shows up in a real performance"
    teaser="Next, learn the five major instrument families and how each one creates tone."
