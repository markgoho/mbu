...
{{< drg/video
    title="Careers in the Music Industry (video)"
    url="https://youtu.be/X9baGNtXjv4?si=thzzvSy24o1fR6gn" >}}

## Gather the Facts Your Counselor Needs

This requirement names six important areas. Make sure your notes cover each one.

{{< drg/checklist title="Career Research Notes" subtitle="Do not leave any of these out" >}}
...
{{< drg/tip >}}
Ask professionals what surprised them most about the job. That question often reveals the real difference between the dream version of a career and the day-to-day reality.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Good Questions for an Interview or Visit" >}}
- **What does a normal week look like?**
- **What training mattered most to getting started?**
- **What are the biggest costs or challenges in this field?**
- **What skills matter besides musical talent?**
- **What do you enjoy most, and what is hardest?**
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    ...
    description="Use this career guide to look up job duties, pay, education, and outlook for music-related professions." >}}
...
{{< drg/next-page
    text="You now have a framework for studying music work as a real profession"
    teaser="Next, explore how music can stay in your life as a hobby with goals, costs, and community support."
