...
{{< drg/checklist title="Teaching Plan for Each Song" subtitle="Keep the group moving instead of guessing" >}}
...
{{< drg/tip >}}
Face the group, keep motions slightly larger than feels natural, and make eye contact before major cues. People follow confidence.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If the Group Gets Off Together" >}}
Here is how to recover without losing the room:

- **Stop cleanly** instead of letting the group drift farther apart.
- **Reset the beat** with a clear count-in.
- **Re-teach the trouble spot** one phrase at a time.
- **Restart with confidence** and keep motions visible.
{{< /drg/be-prepared >}}

This option shares skills with [Req 3c](/merit-badges/music/guide/req3c/). In both cases, steady tempo, calm leadership, and expressive communication matter more than flashy difficulty.

{{< drg/image src="images/scout-leading-group-song.avif" alt="A Scout leading a small group in singing with labeled beat pattern and cutoff gesture" >}}

{{< drg/external-link
    title="Kennedy Center Education"
    url="https://www.kennedy-center.org/education/"
    description="Arts education materials that support clear teaching, conducting, and group music-making." >}}
...
{{< drg/next-page
    text="You now know how to turn a song you know into one other people can learn"
    teaser="Next, see how to invent your own musical idea and write it down in a score."
