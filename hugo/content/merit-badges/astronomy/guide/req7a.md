...
{{< drg/image src="images/sun-cross-section.avif" alt="A cross-section diagram of the Sun showing its core, radiative zone, convective zone, photosphere, chromosphere, and corona with labels and approximate temperatures" >}}
...
{{< drg/did-you-know >}}
If the Sun were the size of a basketball, Earth would be the size of a pinhead about 93 feet away. Jupiter would be about the size of a marble 490 feet away. The nearest star, Proxima Centauri, would be another basketball about 4,800 miles away.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
NASA's Space Weather Prediction Center (spaceweather.gov) tracks solar activity in real time. Check it before your observation sessions — a solar storm might mean aurora watching is possible from your location.
{{< /drg/tip >}}

{{< drg/external-link title="What Is the Sun Made Of?" url="https://youtu.be/LuT7RF8gWFA" description="Video explaining the Sun's composition and the nuclear fusion process that powers it." >}}

Next, let's zoom in on one of the most interesting features on the Sun's surface — sunspots.

{{< drg/next-page text="You now understand the Sun's composition and its effects on Earth." teaser="Learn about sunspots and how they affect solar radiation." url="/merit-badges/astronomy/guide/req7b/" >}}
