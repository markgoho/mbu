...
{{< drg/image src="images/star-colors-temperature.avif" alt="An illustrated temperature scale showing stars ranging from cool red on the left to hot blue on the right, with example stars labeled at each color" >}}
...
{{< drg/did-you-know >}}
Betelgeuse is so large and so close (astronomically speaking) that the Hubble Space Telescope has actually resolved its surface — making it one of the only stars other than the Sun where we can see surface details. In late 2019, Betelgeuse dramatically dimmed, leading some to wonder if it was about to explode. It turned out a cloud of dust ejected from the star was temporarily blocking its light.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Orion is the perfect constellation for seeing star colors. Betelgeuse (red-orange) and Rigel (blue-white) are in opposite corners, making it easy to compare them directly. If you can also spot Bellatrix (blue-white) and the stars of Orion's Belt (blue-white), you will have multiple color comparisons in one constellation.
{{< /drg/tip >}}

{{< drg/external-link title="Why Are Stars Different Colors?" url="https://youtu.be/LCZPZfc8nHE?si=tYaIruw7NwHR1ya7" description="Video explaining the relationship between star color, temperature, and stellar classification." >}}
...
{{< drg/next-page text="You can now identify red, blue, and yellow stars and explain what their colors mean." teaser="Choose one of six hands-on astronomy projects for your badge." url="/merit-badges/astronomy/guide/req8/" >}}
