...
req_number: "4a"
prev: "/merit-badges/astronomy/guide/req3d/"
prev_title: "Req 3d — Care & Storage"
next: "/merit-badges/astronomy/guide/req4b/"
next_title: "Req 4b — Bright Stars"
---
...
{{< drg/image src="images/constellation-chart-zodiac.avif" alt="A star chart showing several zodiac constellations (Leo, Scorpius, Taurus, Gemini) with their star patterns connected by lines and labeled" >}}
...
{{< drg/did-you-know >}}
The Big Dipper is not actually a constellation — it is an "asterism," which is a recognizable pattern of stars that is part of a larger constellation. The Big Dipper is the brightest part of Ursa Major (the Great Bear).
{{< /drg/did-you-know >}}

### Tips for Finding Constellations

{{< drg/checklist title="Constellation-Finding Strategy" subtitle="A step-by-step approach for your observation session" >}}
...
{{< drg/tip >}}
Free planetarium apps like Stellarium, Sky Map, or Star Walk let you hold your phone up to the sky and see constellation outlines overlaid on the stars in real time. They are an incredible learning tool — just make sure to use the app's red night-vision mode to protect your dark adaptation.
{{< /drg/tip >}}

{{< drg/external-link title="88 Officially Recognized Constellations" url="https://starchild.gsfc.nasa.gov/docs/StarChild/questions/88constellations.html" description="NASA StarChild's list of all 88 constellations with descriptions and charts." >}}

Now let's learn to identify some of the sky's brightest individual stars.

{{< drg/next-page text="You have learned how to find constellations in the night sky." teaser="Learn to identify eight of the brightest stars visible from Earth." url="/merit-badges/astronomy/guide/req4b/" >}}
