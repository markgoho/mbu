...
req_number: "6c"
prev: "/merit-badges/astronomy/guide/req6b/"
prev_title: "Sketching Moon Phases"
next: "/merit-badges/astronomy/guide/req6d/"
next_title: "Eclipses & Moon Phases"
---
...
{{< drg/did-you-know >}}
Isaac Newton figured this out in the 1680s. He imagined a cannon on top of a very tall mountain. If the cannonball was fired fast enough, it would fall toward Earth but never hit the ground — it would orbit. Newton realized the Moon is simply a very large "cannonball" that was set in motion billions of years ago and has been orbiting ever since.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/moon-orbit-forces.avif" alt="A diagram showing the Moon in orbit around Earth with arrows illustrating gravitational pull toward Earth and the Moon's velocity tangent to its orbit, creating the curved orbital path" >}}
...
{{< drg/tip >}}
A great way to explain the Moon's orbit to your counselor is to use a ball on a string. If you swing the ball in a circle, the string provides the inward force (like gravity), while the ball's speed keeps it moving outward. If you let go of the string, the ball flies off in a straight line — just like the Moon would if gravity suddenly stopped.
{{< /drg/tip >}}
...
{{< drg/external-link title="Why Doesn't the Moon Fall Down?" url="https://youtu.be/OnONWCVXO5o?si=LSzURg_cSrP5zDMC" description="Video explaining why the Moon orbits Earth instead of falling into it." >}}

Now let's bring everything together by exploring eclipses and the phases of the Moon in detail.

{{< drg/next-page text="You now understand the forces that keep the Moon in orbit." teaser="Learn about eclipses and the geometry behind the Moon's phases." url="/merit-badges/astronomy/guide/req6d/" >}}
