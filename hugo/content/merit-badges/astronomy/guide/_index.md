  ...
  - group_title: "Beyond the Badge"
    items:
      - title: "Extended Learning"
        url: "/merit-badges/astronomy/guide/extended-learning/"
---
...
{{< drg/image src="images/scout-stargazing-field.avif" alt="A Scout standing in an open field at night gazing up at a vivid starry sky with the Milky Way visible overhead" >}}
...
{{< drg/did-you-know >}}
The human eye can see about 5,000 stars on a clear, dark night without any optical aid. That is more than enough to learn dozens of constellations and spot all five visible planets.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Never look directly at the Sun with your naked eyes, binoculars, or a telescope without proper solar filters. Even a brief glance through unfiltered optics can cause permanent eye damage or blindness. Special solar filters and projection methods exist for safe solar viewing.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/telescope-star-cluster.avif" alt="A telescope pointed at the night sky with a bright star cluster visible in the background" >}}
...
{{< drg/tip >}}
You do not need a telescope to start astrophotography. A smartphone on a tripod can capture stunning photos of the Moon, star trails, and bright planets. Many free apps will help you plan your shots by showing exactly where objects will appear in the sky.
{{< /drg/tip >}}

{{< drg/image src="images/astrophotography-setup.avif" alt="An amateur astrophotography setup with a camera mounted on a telescope under a starry sky" >}}
...
{{< drg/next-page
    text="You have learned about the many branches of astronomy and why this badge matters."
    teaser="Find out about the hazards you may encounter while stargazing — and how to stay safe."
    url="/merit-badges/astronomy/guide/req1a/" >}}
