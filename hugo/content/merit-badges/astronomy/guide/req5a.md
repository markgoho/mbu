...
{{< drg/image src="images/five-planets-lineup.avif" alt="An illustrated lineup of the five visible planets (Mercury, Venus, Mars, Jupiter, Saturn) with size comparisons and key identifying features labeled" >}}
...
{{< drg/did-you-know >}}
When Galileo first observed Venus through his telescope in 1610, he saw it go through phases — from crescent to full — just like the Moon. This was impossible under the old Earth-centered model of the universe and was powerful evidence that Venus orbits the Sun.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
To tell a planet from a star, watch for two clues: planets shine with a steady light (they do not twinkle as much as stars), and over weeks they slowly change position relative to the background stars. Stars stay fixed relative to each other.
{{< /drg/tip >}}

{{< drg/external-link title="Phases of Planets — Wolfram Demonstrations" url="https://demonstrations.wolfram.com/PhasesOfPlanets/" description="Interactive demonstration showing how the phases of Venus and Mercury change as they orbit the Sun." >}}

Next, let's find out when you can actually see these planets in the sky.

{{< drg/next-page text="You now know the five visible planets and which ones show phases." teaser="Create a chart showing when each planet will be visible in the evening sky." url="/merit-badges/astronomy/guide/req5b/" >}}
