...
{{< drg/checklist title="Optics Cleaning Steps" subtitle="When cleaning is truly necessary, follow this order" >}}
...
{{< drg/safety-first >}}
Never use household glass cleaner, paper towels, tissues, or your shirt to clean telescope or binocular optics. These materials contain chemicals and fibers that will scratch and damage optical coatings. Use only materials specifically designed for optics.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/telescope-storage-setup.avif" alt="A telescope stored properly indoors with dust caps on, alongside a padded eyepiece case and binoculars in their case" >}}

### Care in the Field

The field — whether it is your backyard, a campsite, or a dark-sky park — presents its own challenges.

{{< drg/checklist title="Field Care Checklist" subtitle="Protect your equipment during observation sessions" >}}
...
{{< drg/tip >}}
Create a "landing pad" for your observing sessions — a small folding table or even a towel on the ground — where all your eyepieces, star charts, and accessories live. This prevents the common disaster of stepping on an eyepiece in the dark.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Dew Fogging Your Optics?" >}}
Dew is the most common field problem for astronomers. When your optics cool below the dew point, moisture condenses on the glass:

- **Do not wipe.** You will smear moisture and grit across the surface.
- **Use a dew shield** — a simple tube that extends past the front lens, slowing heat loss.
- **Try a battery-powered dew heater strip** wrapped around the front of the tube. It keeps the glass just warm enough to prevent condensation.
- **As a last resort,** cap the optics and bring them inside. Let everything dry naturally before storing.
{{< /drg/be-prepared >}}

{{< drg/external-link title="How to Care for Your Telescope" url="https://www.astronomy.com/observing/how-to-care-for-your-telescope/" description="Astronomy magazine's guide to telescope maintenance and care." >}}

{{< drg/external-link title="Caring for Your Optics" url="https://skyandtelescope.org/astronomy-resources/caring-for-your-optics/" description="Sky & Telescope's detailed guide to cleaning and maintaining telescope optics." >}}
...
{{< drg/next-page text="You have learned how to care for and store your astronomical equipment." teaser="Start navigating the night sky by learning to identify constellations." url="/merit-badges/astronomy/guide/req4a/" >}}
