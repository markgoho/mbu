...
req_number: "3a"
prev: "/merit-badges/astronomy/guide/req2/"
prev_title: "Light Pollution"
next: "/merit-badges/astronomy/guide/req3b/"
next_title: "Types of Telescopes"
---
...
{{< drg/did-you-know >}}
Many experienced astronomers say binoculars are the best "first telescope." A good pair of 7x50 or 10x50 binoculars reveals craters on the Moon, the moons of Jupiter, star clusters, and even the Andromeda Galaxy — all for a fraction of the cost of a telescope.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/binoculars-telescope-comparison.avif" alt="A Scout looking through binoculars on the left and another Scout looking through a telescope on the right, both under a starry sky" >}}
...
{{< drg/tip >}}
The most common mistake new telescope users make is cranking the magnification too high. At very high magnification, images become dim, blurry, and hard to keep in the field of view. Start low and only increase magnification when conditions allow it.
{{< /drg/tip >}}

{{< drg/external-link title="Telescopes and Binoculars" url="https://youtu.be/vz3yD9VxWoY?si=rCb5NCft79HdzwbL" description="Video overview of how binoculars and telescopes work as astronomical tools." >}}

Next, let's explore the different types of telescopes and how they work.

{{< drg/next-page text="You now understand why binoculars and telescopes are essential for astronomy." teaser="Learn about the different types of telescopes, including those that see beyond visible light." url="/merit-badges/astronomy/guide/req3b/" >}}
