---
title: "Sketching the Big Dipper"
layout: guide
group_title: "4. Navigating the Night Sky"
req_number: "4c"
prev: "/merit-badges/astronomy/guide/req4b/"
prev_title: "Bright Stars"
next: "/merit-badges/astronomy/guide/req4d/"
next_title: "The Milky Way"
---

{{< drg/requirement number="4c" >}}
Make two sketches of the Big Dipper or Cassiopeia from direct observation. In one sketch, show the Big Dipper's or Cassiopeia's orientation in the early evening sky. Make another sketch, showing its position several hours later. In both sketches, show the North Star and the horizon. Record the date and time each sketch was made.
{{< /drg/requirement >}}
...
{{< drg/tip >}}
Not sure which to choose? Pick whichever is higher in the sky on your observing night — it will be easier to sketch. In spring and summer evenings, the Big Dipper is high. In fall and winter evenings, Cassiopeia is high.
{{< /drg/tip >}}
...
{{< drg/image src="images/big-dipper-sketches.avif" alt="Two side-by-side astronomical sketches showing the Big Dipper at different orientations around Polaris, with horizon landmarks, dates, and times labeled" >}}
...
{{< drg/did-you-know >}}
In the Southern Hemisphere, there is no bright star marking the south celestial pole. Southern observers do not have a convenient "South Star" equivalent to Polaris. Instead, they use the constellation Crux (the Southern Cross) to estimate where the south pole is.
{{< /drg/did-you-know >}}

{{< drg/checklist title="Sketching Supplies" subtitle="What to bring to your observation session" >}}
- Clipboard with white paper (or a dedicated astronomy sketchbook).
- Pencil (not pen — you will want to erase and adjust).
- Red-light flashlight or headlamp so you can see your paper without losing dark adaptation.
- A watch or phone for recording accurate times.
- A compass or compass app for confirming which direction is north.
{{< /drg/checklist >}}

{{< drg/external-link title="How to Find the Big Dipper" url="https://youtu.be/grAOh38clHI?si=ROyvngrW4KPn1Y60" description="Video guide to finding Ursa Major and the Big Dipper in the night sky." >}}

Now let's look at the most spectacular feature visible on any clear dark night — the Milky Way.

{{< drg/next-page text="You have sketched the sky and observed Earth's rotation in action." teaser="Learn what we are actually seeing when we look at the Milky Way." url="/merit-badges/astronomy/guide/req4d/" >}}
