...
{{< drg/tip >}}
If you have never looked at a planet through a telescope before, start with Jupiter or the Moon. They are easy to find, bright enough to tolerate any light pollution, and rewarding at any magnification. Saturn's rings are worth any effort to see.
{{< /drg/tip >}}

### Preparing for Your Observation

{{< drg/checklist title="Planet Observation Prep" subtitle="Before heading out" >}}
...
{{< drg/image src="images/planet-observation-notebook.avif" alt="A Scout's observation notebook page showing a sketch of Jupiter with its moons, along with written notes about date, time, conditions, and what was visible" >}}
...
{{< drg/did-you-know >}}
Jupiter's four largest moons — Io, Europa, Ganymede, and Callisto — change their positions visibly from night to night and even hour to hour. Galileo discovered them in 1610 and recognized that they orbited Jupiter, proving that not everything in the sky orbits Earth.
{{< /drg/did-you-know >}}

{{< drg/external-link title="NASA Skywatching" url="https://science.nasa.gov/skywatching/" description="NASA's monthly guide to what is visible in the sky, including planet positions and special events." >}}

{{< drg/external-link title="Planets Visible Tonight" url="https://theskylive.com/planets-visible-tonight" description="Real-time guide showing which planets are visible from your location right now." >}}

You have explored the planets — now let's turn our attention to Earth's closest companion in space.

{{< drg/next-page text="You have observed a planet and recorded what you saw." teaser="Get to know the Moon by identifying its seas and craters." url="/merit-badges/astronomy/guide/req6a/" >}}
