...
req_number: "7b"
prev: "/merit-badges/astronomy/guide/req7a/"
prev_title: "Composition of the Sun"
next: "/merit-badges/astronomy/guide/req7c/"
next_title: "Star Colors"
---
...
{{< drg/did-you-know >}}
Chinese astronomers recorded sunspots visible to the naked eye as early as 28 BC, and Galileo studied them through his telescope in 1612. By watching sunspots move across the Sun's face over several days, Galileo proved that the Sun rotates on its axis — completing one rotation roughly every 25 days at its equator.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/sunspot-closeup.avif" alt="A detailed view of a sunspot group showing dark umbrae surrounded by lighter penumbrae on the bright solar surface" >}}
...
{{< drg/tip >}}
You can safely observe sunspots yourself using the solar projection method described in Requirement 1d. Track them from day to day and you will see them move across the Sun's disk as the Sun rotates. Some sunspots last only a few days, while others persist for weeks.
{{< /drg/tip >}}

{{< drg/external-link title="Sunspots — NASA" url="https://science.nasa.gov/sun/sunspots/" description="NASA's comprehensive guide to sunspots, including current sunspot data and the solar cycle." >}}

Now let's look at something you can observe with just your eyes — the different colors of stars and what they tell us.

{{< drg/next-page text="You now understand sunspots and their effects on solar radiation." teaser="Learn why stars appear in different colors and what those colors reveal." url="/merit-badges/astronomy/guide/req7c/" >}}
