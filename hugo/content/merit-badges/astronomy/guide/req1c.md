---
title: "Clothing & Night Precautions"
layout: guide
group_title: "1. Safety Under the Stars"
req_number: "1c"
prev: "/merit-badges/astronomy/guide/req1b/"
prev_title: "First Aid for Observers"
next: "/merit-badges/astronomy/guide/req1d/"
next_title: "Safe Solar Observation"
---
...
{{< drg/checklist title="Cold-Weather Stargazing Gear" subtitle="What to wear and bring for nighttime observations" >}}
...
{{< drg/tip >}}
Dress as if the temperature will be 15–20 degrees colder than the forecast says. You are not generating heat through movement, and temperatures continue to drop throughout the night. It is always easier to remove a layer than to wish you had brought one.
{{< /drg/tip >}}
...
{{< drg/image src="images/layered-astronomer-night.avif" alt="A warmly dressed Scout at a telescope on a cold clear night, wearing layers with a red headlamp, thermos nearby" >}}
...
- **Gather loose equipment** before the wind picks up — eyepieces and charts blow away easily.
- **Move to shelter.** If lightning is nearby (you can see it or hear thunder), get to a building or enclosed vehicle immediately. Do not shelter under isolated trees.
- **Wait 30 minutes** after the last thunder before returning outdoors.
{{< /drg/be-prepared >}}

{{< drg/did-you-know >}}
Experienced astronomers often say the best observing nights are the coldest ones. Cold air holds less moisture, which means less atmospheric turbulence and sharper views through your telescope. The clearest, steadiest skies often come on crisp winter nights.
{{< /drg/did-you-know >}}

{{< drg/external-link title="Dressing for Cold-Weather Astronomy" url="https://youtu.be/8nTJ_gpulI0?si=vJytSVx2n0gpKyME" description="Video guide on how to stay warm during long winter observation sessions." >}}
...
{{< drg/next-page text="You have learned how to dress and prepare for safe nighttime observing." teaser="Learn the critical rules for safely observing the Sun and solar eclipses." url="/merit-badges/astronomy/guide/req1d/" >}}
