...
{{< drg/checklist title="Report Checklist" subtitle="What to include in your report, scrapbook, or video" >}}
...
{{< drg/external-link title="U.S. Planetariums Directory" url="https://www.go-astronomy.com/planetariums.htm" description="Find a planetarium near you with this comprehensive directory." >}}

{{< drg/external-link title="Best Observatories to Visit" url="https://spacetourismguide.com/best-observatories-united-states/" description="Guide to some of the best public observatories in the United States." >}}
...
{{< drg/tip >}}
Before your session, make a written target list of 12–15 objects. This gives you backup targets in case some are below the horizon or hidden by clouds. For each object, note which constellation it is in and how to find it.
{{< /drg/tip >}}
...
{{< drg/checklist title="Star Party Planning" subtitle="Steps to a successful event" >}}
...
{{< drg/image src="images/scout-star-party.avif" alt="A group of Scouts gathered around a telescope at a star party, with one Scout pointing at the sky and explaining something to the group" >}}
...
{{< drg/tip >}}
You can do basic astrophotography with just a smartphone. For Moon and planet photos, hold your phone up to the eyepiece of a telescope or binoculars — this technique is called "afocal photography" and can produce surprisingly good results.
{{< /drg/tip >}}

{{< drg/external-link title="Smartphone Astrophotography Guide" url="https://astrobackyard.com/smartphone-astrophotography/" description="Beginner's guide to taking astronomical photos with your smartphone." >}}
...
{{< drg/external-link title="Skynet Robotic Telescope Network" url="https://skynet.unc.edu/" description="University of North Carolina's network of robotic telescopes available for educational use. Request observations of galaxies, nebulae, and more." >}}

{{< drg/external-link title="MicroObservatory — Harvard" url="https://mo-www.cfa.harvard.edu/MicroObservatory/" description="Free robotic telescopes operated by Harvard-Smithsonian Center for Astrophysics, designed for students." >}}
...
{{< drg/next-page text="You have chosen and completed a hands-on astronomy project." teaser="Explore astronomy as a career path or lifelong hobby." url="/merit-badges/astronomy/guide/req9/" >}}
