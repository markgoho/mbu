...
{{< drg/image src="images/retrograde-motion-diagram.avif" alt="A diagram showing Earth passing Mars in their orbits around the Sun, with numbered positions and corresponding apparent positions of Mars against the background stars showing a retrograde loop" >}}

{{< drg/did-you-know >}}
Retrograde motion confused astronomers for over 1,500 years. The ancient Greek astronomer Ptolemy needed over 80 epicycles (circles on circles) to predict planetary positions in his Earth-centered model. Copernicus's Sun-centered model explained the same observations simply and elegantly — planets only appear to go backward because we are passing them.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Track a planet's position by noting which constellation it is in each week. After a month, you will see clear eastward movement. If you catch it during a retrograde period, you will see it reverse direction — a truly exciting observation to make on your own.
{{< /drg/tip >}}

{{< drg/external-link title="Apparent Retrograde Motion" url="https://youtu.be/sBzGGoBQVDA" description="Clear animation showing how retrograde motion works as Earth overtakes an outer planet." >}}

Time to go outside and actually observe a planet for yourself.

{{< drg/next-page text="You now understand how planets move through the sky, including retrograde motion." teaser="Go outside, find a planet, and describe what you observe." url="/merit-badges/astronomy/guide/req5d/" >}}
