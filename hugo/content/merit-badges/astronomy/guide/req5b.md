---
title: "Planet Visibility Chart"
layout: guide
group_title: "5. Exploring the Planets"
req_number: "5b"
prev: "/merit-badges/astronomy/guide/req5a/"
prev_title: "Visible Planets & Phases"
next: "/merit-badges/astronomy/guide/req5c/"
next_title: "Planetary Motion"
---
...
{{< drg/external-link title="NASA Skywatching" url="https://science.nasa.gov/skywatching/" description="NASA's monthly skywatching guide with planet visibility, meteor showers, and other celestial events." >}}

{{< drg/external-link title="EarthSky — Visible Planets Tonight" url="https://earthsky.org/astronomy-essentials/visible-planets-tonight-mars-jupiter-venus-saturn-mercury/" description="Updated daily with information about which planets are visible and where to look for them." >}}

{{< drg/external-link title="The Sky Live — Planets Visible Tonight" url="https://theskylive.com/planets-visible-tonight" description="Shows which planets are visible from your location right now, with rise and set times." >}}

### How to Build Your Chart

Your chart should cover the next 12 months and include the following information for each planet:

{{< drg/checklist title="Chart Information" subtitle="What to include for each planet, each month" >}}
- Planet name.
...
{{< drg/tip >}}
NASA's Skywatching page is updated monthly and is the most reliable source for planning observations. Bookmark it and check it at the beginning of each month to update your chart and plan your viewing.
{{< /drg/tip >}}
...
{{< drg/image src="images/planet-visibility-timeline.avif" alt="A colorful timeline chart showing the approximate evening visibility windows of all five naked-eye planets across 12 months" >}}

{{< drg/did-you-know >}}
Venus is so bright that it has been reported as a UFO more times than any other natural object. Its peak brightness (magnitude -4.6) makes it visible even in broad daylight if you know exactly where to look.
{{< /drg/did-you-know >}}

Now let's explore how planets actually move through the sky — including one very strange trick they seem to play.

{{< drg/next-page text="You have researched when each planet will be visible and built your visibility chart." teaser="Learn how planets move across the sky and why they sometimes appear to go backwards." url="/merit-badges/astronomy/guide/req5c/" >}}
