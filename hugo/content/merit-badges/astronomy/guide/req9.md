...
{{< drg/image src="images/astronomy-careers-collage.avif" alt="A collage showing different astronomy careers: a researcher at a computer analyzing data, an engineer working on a satellite, a planetarium presenter speaking to an audience" >}}

{{< drg/tip >}}
When researching a career for your counselor discussion, use the Bureau of Labor Statistics Occupational Outlook Handbook (bls.gov/ooh/) for reliable data on education requirements, salary ranges, and job outlook. It is the most authoritative source for career information in the United States.
{{< /drg/tip >}}
...
{{< drg/checklist title="Getting Started as a Hobbyist" subtitle="Short-term and long-term goals to discuss with your counselor" >}}
...
{{< drg/external-link title="Astronomical League" url="https://www.astroleague.org/" description="The largest federation of astronomy clubs in the United States, offering observing programs, awards, and resources for amateur astronomers." >}}

{{< drg/external-link title="Getting Started in Astronomy" url="https://ras.ac.uk/education-and-careers/for-everyone/92-getting-started-in-astronomy" description="The Royal Astronomical Society's guide for beginners interested in astronomy as a hobby." >}}

{{< drg/did-you-know >}}
Amateur astronomers have made extraordinary contributions to science. In 2024 alone, amateur observers discovered multiple comets, tracked near-Earth asteroids, and monitored variable stars that provided data for professional research papers. Astronomy is one of the few sciences where amateurs routinely contribute alongside professionals.
{{< /drg/did-you-know >}}
...
{{< drg/next-page text="You have explored astronomy as a career or hobby." teaser="Discover more ways to continue your journey into the universe." url="/merit-badges/astronomy/guide/extended-learning/" >}}
