...
{{< drg/did-you-know >}}
More than 80% of the world's population lives under light-polluted skies. In the United States and Europe, that number rises to over 99%. Most children growing up today have never seen the Milky Way from their own backyard.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/bortle-scale-comparison.avif" alt="A side-by-side comparison showing the night sky from a dark rural site (Bortle 2, rich with stars and Milky Way) versus a city site (Bortle 8, only a handful of stars visible)" >}}
...
{{< drg/tip >}}
Check your local air quality index (AQI) before planning an observation session. Nights with low humidity, low AQI, and clear skies offer the best views. Many weather apps include an "astronomy forecast" that rates seeing and transparency conditions.
{{< /drg/tip >}}
...
{{< drg/external-link title="International Dark-Sky Association" url="https://www.darksky.org/" description="The leading organization working to protect the night sky through education, policy, and dark-sky place designations." >}}

{{< drg/external-link title="Dark Sky Map" url="https://www.lightpollutionmap.info/" description="Interactive map showing light pollution levels worldwide. Find the darkest skies near you for your best observing sessions." >}}

{{< drg/be-prepared title="Stuck Observing from a Light-Polluted Area?" >}}
If you cannot travel to a dark site, you can still do meaningful astronomy:

- **Focus on bright objects.** The Moon, planets, double stars, and bright star clusters are still visible from cities.
- **Use light-pollution filters.** These screw onto telescope eyepieces and block the specific wavelengths of light from streetlights, improving contrast.
- **Look straight up.** The zenith (directly overhead) has the least atmosphere and light pollution to look through.
- **Observe during moonless periods.** Even in the suburbs, a moonless night is noticeably darker.
{{< /drg/be-prepared >}}
...
{{< drg/next-page text="You now understand how light and air pollution affect astronomy." teaser="Learn why binoculars and telescopes are essential astronomical tools." url="/merit-badges/astronomy/guide/req3a/" >}}
