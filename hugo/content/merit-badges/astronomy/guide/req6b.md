---
title: "Sketching Moon Phases"
layout: guide
group_title: "6. Our Moon"
req_number: "6b"
prev: "/merit-badges/astronomy/guide/req6a/"
prev_title: "Lunar Seas & Craters"
next: "/merit-badges/astronomy/guide/req6c/"
next_title: "Moon"
---

{{< drg/requirement number="6b" >}}
Sketch the phase and position of the Moon, at the same hour and place, for four nights (or days) within a one-week period by direct observation. Include landmarks on the horizon such as hills, trees, and buildings. Explain the changes you observe.
{{< /drg/requirement >}}
...
{{< drg/image src="images/moon-phase-sketches-four-nights.avif" alt="Four sketches side by side showing the Moon's changing phase and position over four consecutive nights, with consistent horizon landmarks (tree, building, hill) in each sketch" >}}
...
{{< drg/checklist title="Moon Sketch Checklist" subtitle="Include these on every sketch" >}}
...
{{< drg/tip >}}
If clouds block your view on one night, that is okay — just observe on the next clear night and note the gap in your records. Four observations within a one-week span gives you flexibility to skip a cloudy night.
{{< /drg/tip >}}

{{< drg/did-you-know >}}
The Moon always shows the same face to Earth. This is called "tidal locking" — the Moon rotates on its axis at exactly the same rate it orbits Earth, so the same side always points toward us. The far side of the Moon was not seen by human eyes until 1959, when the Soviet Luna 3 spacecraft photographed it.
{{< /drg/did-you-know >}}

{{< drg/external-link title="Moon Phase Calendar" url="https://www.timeanddate.com/moon/phases/" description="Interactive calendar showing Moon phases for any date and location, perfect for planning your observation week." >}}

Next, let's explore the forces that keep the Moon orbiting Earth.

{{< drg/next-page text="You have tracked the Moon's changing phase and position over several nights." teaser="Learn about the forces that keep the Moon in orbit around Earth." url="/merit-badges/astronomy/guide/req6c/" >}}
