...
req_number: "6d"
prev: "/merit-badges/astronomy/guide/req6c/"
prev_title: "Req 6c — Moon's Orbit"
next: "/merit-badges/astronomy/guide/req7a/"
next_title: "Req 7a — Composition of the Sun"
---
...
{{< drg/image src="images/moon-phases-diagram.avif" alt="A circular diagram showing the Moon at eight positions around Earth with the Sun's light coming from one side, illustrating how the phase changes depending on the Moon's orbital position" >}}
...
{{< drg/safety-first >}}
Remember: you must use certified eclipse glasses or solar filters to watch any solar eclipse. During a total eclipse, you may observe without filters ONLY during the brief period of totality. See Requirement 1d for full details on safe solar observation.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
During a total lunar eclipse, the Moon turns red because Earth's atmosphere acts like a lens, bending red wavelengths of sunlight around our planet and into the shadow. If you were standing on the Moon during a total lunar eclipse, you would see a glowing red ring around Earth — every sunrise and sunset on Earth happening simultaneously.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
For your counselor discussion, try drawing a simple diagram showing the Sun, Earth, and Moon positions for each phase and eclipse type. A top-down view of the Moon's orbit with arrows showing the direction of sunlight makes the geometry much clearer.
{{< /drg/tip >}}

{{< drg/external-link title="Why Do Eclipses Happen? — NASA" url="https://science.nasa.gov/eclipses/geometry/" description="NASA's visual explanation of the geometry behind solar and lunar eclipses." >}}

{{< drg/external-link title="Moon Phases Explained" url="https://www.planetary.org/articles/the-phases-of-the-moon-explained" description="The Planetary Society's guide to understanding why the Moon's appearance changes throughout the month." >}}

Now let's turn from reflected light to the original source — our Sun.

{{< drg/next-page text="You now understand the geometry of Moon phases and eclipses." teaser="Learn about the composition of the Sun and its effects on Earth." url="/merit-badges/astronomy/guide/req7a/" >}}
