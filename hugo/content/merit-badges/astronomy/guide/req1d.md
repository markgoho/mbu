---
title: "Safe Solar Observation"
layout: guide
group_title: "1. Safety Under the Stars"
req_number: "1d"
prev: "/merit-badges/astronomy/guide/req1c/"
prev_title: "Clothing & Night Precautions"
next: "/merit-badges/astronomy/guide/req2/"
next_title: "Light Pollution"
---
...
{{< drg/safety-first >}}
The Sun is 400,000 times brighter than the full Moon. Looking at it through binoculars or a telescope without a proper solar filter concentrates that light and can cause instant, permanent blindness. There is no safe amount of time to look at the unfiltered Sun through optics — even a split second can cause damage.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/solar-observation-methods.avif" alt="A split illustration showing three safe solar observation methods: eclipse glasses, telescope with solar filter, and pinhole projection" >}}
...
- **At second contact (totality begins):** When the last bead of sunlight disappears and the corona appears, you may carefully remove your glasses.
- **During totality:** Observe with your naked eyes or unfiltered binoculars. This lasts only 1–4 minutes depending on the eclipse.
- **At third contact (totality ends):** The instant you see the first flash of sunlight returning, put your glasses back on immediately. This happens fast — be ready.
- **After totality:** Keep your glasses on for the rest of the partial phase.
{{< /drg/be-prepared >}}
...
{{< drg/tip >}}
If you want to practice solar projection, try it with binoculars first. Cover one barrel with a lens cap, point the open barrel at the Sun (without looking through it!), and project the image onto a white card. You will be amazed at how clearly you can see sunspots using this simple technique.
{{< /drg/tip >}}

{{< drg/external-link title="How to View the Sun Safely" url="https://eclipse.aas.org/eye-safety" description="The American Astronomical Society's comprehensive guide to safe solar viewing methods and recommended filters." >}}

{{< drg/external-link title="How to View the Sun Safely — Eclipses, Sunspots" url="https://youtu.be/avxnK7MGYIA?si=hnW7se_YfpY2lxGv" description="Video guide covering safe solar observation techniques including filters and projection." >}}
...
{{< drg/next-page text="You have learned how to safely observe the Sun and solar eclipses." teaser="Discover how light and air pollution affect what you can see in the night sky." url="/merit-badges/astronomy/guide/req2/" >}}
