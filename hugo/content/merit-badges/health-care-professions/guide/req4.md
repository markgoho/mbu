...
{{< drg/image src="images/imaging-vs-ultrasound-comparison.avif" alt="Side-by-side comparison of an X-ray room with protective shielding and a sonographer using an ultrasound probe on a patient, showing how the equipment and exam setup differ between radiology and ultrasound" >}}
...
{{< drg/safety-first >}}
Many Group 4 careers involve safety rules that are easy to overlook because the work feels technical instead of dramatic. Correct patient identification, clean sample handling, radiation precautions, and secure records all protect patients from serious harm.
{{< /drg/safety-first >}}

{{< drg/checklist title="How Group 4 Supports the Care Team" subtitle="Think of these roles as evidence builders" >}}
...
{{< drg/did-you-know >}}
Ultrasound images are made with sound waves, not radiation. That is why ultrasound is commonly used during pregnancy and for many soft-tissue exams.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Explaining a Technical Career Clearly" >}}
Try this structure when you talk about one of these jobs:

- **Main job:** what the person does
- **Why it matters:** how that affects patient care
- **Training path:** what education and certification are required
- **Best fit:** what kind of person might enjoy that work

That keeps a technical topic from sounding too abstract.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Society of Diagnostic Medical Sonography — What Is a Sonographer?"
    url="https://www.sdms.org/resources/careers/work-description"
    description="A career overview explaining what sonographers do and how ultrasound helps diagnose medical problems." >}}

{{< drg/external-link
    title="American Society for Clinical Laboratory Science — Medical Laboratory Professionals"
    url="https://ascls.org/about-us/medical-laboratory-professionals/"
    description="Information about laboratory careers and how lab professionals support diagnosis and treatment." >}}

{{< drg/external-link
    title="MedlinePlus — Medical Tests"
    url="https://medlineplus.gov/lab-tests/"
    description="Patient-friendly explanations of many common lab tests and why clinicians order them." >}}
...
{{< drg/next-page
    text="You now understand how Group 4 careers collect, protect, and interpret the information modern medicine relies on."
    teaser="Next, get ready for a workplace visit and learn how to turn one conversation into a meaningful career exploration."
