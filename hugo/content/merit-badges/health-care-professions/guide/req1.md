...
1. Osteopathic physician (DO)—all specialties
1. Podiatrist (DPM)
1. Chiropractor (DC)
...
{{< drg/checklist title="Choosing Your Three Careers" subtitle="Pick jobs that show real differences" >}}
...
{{< drg/tip >}}
When you talk with your counselor, do not just recite job titles. Use a sentence frame like: "A podiatrist helps patients by..." or "An audiologist plays an important role because..." That makes your explanation clearer and more natural.
{{< /drg/tip >}}
...
1. **What degree is required?**
2. **How many years of school does that usually mean after high school?**
3. **Is supervised clinical training required?**
4. **What license, board exam, or certification allows that person to practice?**
...
{{< drg/image src="images/group-1-training-paths.avif" alt="Horizontal comparison chart showing seven Group 1 careers as rows with icons for degree, school years, supervised clinical training, and licensure, making it easy to compare how long and complex each path is" >}}
...
{{< drg/did-you-know >}}
Most physicians keep training well after medical school ends. Residency can last anywhere from about three years to seven years or more, depending on the specialty.
{{< /drg/did-you-know >}}

{{< drg/be-prepared title="If the Training Path Feels Confusing" >}}
Break it into stages:

- **Stage 1:** college or required prerequisite courses
- **Stage 2:** professional school or graduate school
- **Stage 3:** supervised clinical training
- **Stage 4:** exam, license, or certification

If you organize your notes this way, even a long path like physician training becomes easier to explain.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    title="U.S. Bureau of Labor Statistics — Healthcare Occupations"
    url="https://www.bls.gov/ooh/healthcare/home.htm"
    description="Career summaries showing what many health care professionals do, where they work, and the typical education needed." >}}

{{< drg/external-link
    title="AAMC — Careers in Medicine"
    url="https://www.aamc.org/cim/explore-options/specialty-profiles"
    description="Profiles of physician specialties that can help you understand how broad the physician career path really is." >}}

{{< drg/external-link
    title="American Academy of Audiology — What Is an Audiologist?"
    url="https://www.audiology.org/consumers-and-patients/what-is-an-audiologist/"
    description="An overview of what audiologists do and how they help patients with hearing and balance." >}}

In Req 2, you will compare another set of careers where direct bedside care, medicines, and emergency response are central to the job.

{{< drg/next-page
    text="You now have a framework for comparing Group 1 careers by both role and training."
    teaser="Next, explore nurses, pharmacists, paramedics, and other professionals who keep care moving hour by hour."
