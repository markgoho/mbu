...
{{< drg/image src="images/health-care-team-map.avif" alt="Four-panel comparison showing a family doctor listening to a patient, an optometrist using an eye exam device, an audiologist performing a hearing test, and a physical therapist helping a patient walk, illustrating how different specialists solve different health problems" >}}
...
{{< drg/safety-first >}}
In emergency settings, teamwork and clear communication can be life-saving. If you ever observe a medical setting for this badge, stay with your approved adult, follow every instruction, and never touch equipment or patients unless a professional clearly invites you to do something simple and safe.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
A modern hospital can have thousands of different medical devices in use, from infusion pumps and heart monitors to MRI scanners and ventilators. Keeping that equipment working safely is a major job in itself.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You now have a big-picture view of how health care teams work together."
    teaser="Start with Group 1 careers and learn how different specialists diagnose, treat, and guide patient care."
