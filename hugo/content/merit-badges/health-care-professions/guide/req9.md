...
{{< drg/image src="images/community-health-event-flow.avif" alt="Bird's-eye diagram of a community health fair with labeled stations for check-in, waiting area, screening tables, privacy area, volunteer help desk, and exit, showing how visitor flow and teamwork keep the event organized" >}}

{{< drg/checklist title="Before You Volunteer" subtitle="Handle the basics first" >}}
...
{{< drg/safety-first >}}
At a health event or facility, stay within your assigned role. Do not touch medical equipment, handle private paperwork, give health advice, or assist with patient care unless a responsible adult has clearly assigned a simple approved task. If you are unsure, ask before acting.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Many health systems and community organizations rely on volunteers for public events because outreach works best when the community helps care for itself.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Right after your volunteer experience, jot down three specific moments you remember. Specific details make your counselor report more convincing and easier to discuss.
{{< /drg/tip >}}

{{< drg/be-prepared title="If Your First Opportunity Falls Through" >}}
Health-related events can be canceled, rescheduled, or filled up.

- Ask local hospitals, clinics, senior centers, public health departments, and blood centers about future events.
- Check whether your school or chartered organization partners with community wellness programs.
- Be flexible about the type of event as long as it is clearly health-related and approved.

Persistence is part of service.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="American Red Cross — Volunteer"
    url="https://www.redcross.org/volunteer/volunteer-opportunities.html"
    description="A good starting point for finding community service opportunities connected to health, blood drives, disaster care, and preparedness." >}}

{{< drg/external-link
    title="America's Blood Centers — Find a Blood Center"
    url="https://www.americasblood.org/for-donors/find-a-blood-center/"
    description="Find local blood centers that may host drives or volunteer-supported community events." >}}
...
{{< drg/next-page
    text="You have now connected career exploration, ethics, privacy, innovation, and service into one bigger picture of health care."
    teaser="Head to Extended Learning for deeper topics, real-world experiences, and organizations to explore next."
