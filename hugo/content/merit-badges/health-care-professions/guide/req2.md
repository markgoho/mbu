...
1. Licensed Practical Nurse (LPN/LVN)
1. Nurse Anesthetist (CRNA)
1. Pharmacist (PharmD)
1. Pharmacy Technician
1. Emergency Medical Technician (EMT)/Paramedic
{{< /drg/requirement >}}
...
{{< drg/image src="images/group-2-care-settings.avif" alt="Three-panel comparison showing a registered nurse checking a hospital patient, a pharmacist counseling at a pharmacy counter, and a paramedic treating a patient beside an ambulance, highlighting how Group 2 roles work in very different care settings" >}}

{{< drg/safety-first >}}
Emergency scenes can be chaotic and dangerous. EMTs and paramedics must protect themselves first, watch for traffic, fire, unstable structures, or hazardous materials, and work inside clear protocols. Safety is part of patient care, not separate from it.
{{< /drg/safety-first >}}

{{< drg/checklist title="Questions to Ask About Group 2 Careers" subtitle="These questions can help you compare your three choices" >}}
...
{{< drg/did-you-know >}}
Paramedics often need to master advanced skills while working in unpredictable places such as homes, highways, schools, or public events. Their classroom learning has to hold up in noisy, stressful real-world situations.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Building a Clear Comparison" >}}
If you are comparing three careers from this group, try making a note card for each one with:

- required degree or training program
- licensing or certification step
- typical workplace
- biggest patient-care responsibility

Those note cards make it easier to spot patterns and talk confidently with your counselor.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    ...
    description="A clear overview of the role nurses play in patient care and the many settings where they work." >}}

{{< drg/external-link
    title="MedlinePlus — Medicines: Using Them Safely"
    url="https://medlineplus.gov/medicines.html"
    description="Reliable patient-friendly information about medications, side effects, and safe medicine use." >}}

{{< drg/external-link
    title="EMS.gov"
    url="https://www.ems.gov/"
    description="Information about emergency medical services, including how EMTs and paramedics fit into emergency care systems." >}}
...
{{< drg/next-page
    text="You now understand how Group 2 careers keep patients safe through nursing, medication support, and emergency care."
    teaser="Next, explore the professions that help people move, speak, breathe, eat, and live more independently."
