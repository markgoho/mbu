...
{{< drg/tip >}}
If the professional gives a short answer like "time pressure," ask a respectful follow-up such as, "What does that look like during a normal day?" Follow-up questions often produce the most useful insights.
{{< /drg/tip >}}
...
{{< drg/image src="images/health-care-workplace-observation-grid.avif" alt="Six-panel observation grid showing a clinic exam room, pharmacy counter, ambulance equipment area, lab bench, electronic health record screen viewed over a shoulder, and front desk check-in station, helping Scouts notice the tools and work zones during a workplace visit" >}}

{{< drg/checklist title="What to Observe During Your Visit" subtitle="Watch for these details while you are there" >}}
...
{{< drg/did-you-know >}}
In many health care fields, a license can expire if the professional does not complete the required continuing education hours on time. Staying current is part of protecting patients.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="If You Feel Nervous Before the Visit" >}}
Bring a short written question list and keep it in your pocket or notebook.

- Start with easy questions about the workplace.
- Move to the six required discussion topics.
- End by asking what advice they would give a teenager interested in health care.

Professionals usually appreciate thoughtful curiosity.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="ExploreHealthCareers.org"
    url="https://explorehealthcareers.org/"
    description="Career profiles and planning ideas that can help you prepare better questions before your workplace visit." >}}

{{< drg/external-link
    title="U.S. Bureau of Labor Statistics — Occupational Outlook Handbook"
    url="https://www.bls.gov/ooh/"
    description="A useful place to review day-to-day duties, work environments, and required training before you visit a professional." >}}

Next, you will shift from careers to ethics by exploring one of medicine's oldest and most important ideas: the Physician's Oath.

{{< drg/next-page
    text="You now know how to turn a workplace visit into a real career investigation instead of a quick tour."
    teaser="Next, explore what the Physician's Oath means and why ethics matters in every health care profession."
