...
{{< drg/image src="images/confidentiality-do-dont-comparison.avif" alt="Split comparison showing correct privacy habits on one side and crossed-out mistakes on the other: a clinician speaking quietly behind a curtain, a locked computer screen, and verified paperwork versus gossiping in a hallway, an unattended open chart, and records visible to others" >}}

{{< drg/video
    title="5 Scenarios of Maintaining Patient Confidentiality — Etactics"
    url="https://www.youtube.com/watch?v=8kNlqc7H8pY" >}}

{{< drg/safety-first >}}
Privacy mistakes can harm patients in real ways. They can cause embarrassment, stress, identity theft, damaged trust, and even avoidance of medical care. Protecting information is a safety issue as well as a legal one.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="A Simple Way to Explain HIPAA" subtitle="Use this structure with your counselor" >}}
...
{{< drg/did-you-know >}}
One major privacy risk in health care is not dramatic hacking. It is ordinary carelessness, such as talking too loudly, sending information to the wrong person, or leaving records visible where they should not be.
{{< /drg/did-you-know >}}

{{< drg/tip >}}
If you are explaining confidentiality to your counselor, use the phrase "need to know." That is the heart of the idea: patient information should be shared only with people who truly need it for the patient's care or other proper legal reasons.
{{< /drg/tip >}}

{{< drg/be-prepared title="If Someone Asks About Exceptions" >}}
Confidentiality is strong, but it is not absolute. Health care providers may sometimes need to share information to:

- treat the patient safely
- report certain public health concerns or abuse as required by law
- respond to legal requirements
- protect someone from serious harm in limited situations

The key idea is that privacy is protected by default, but some carefully defined exceptions exist.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="U.S. Department of Health & Human Services — Health Information Privacy"
    url="https://www.hhs.gov/hipaa/index.html"
    description="The federal government's main HIPAA privacy information hub, with consumer-friendly explanations and guidance." >}}

{{< drg/external-link
    title="MedlinePlus — Personal Health Records"
    url="https://medlineplus.gov/personalhealthrecords.html"
    description="Helpful background on health records, privacy, and how patients manage their own medical information." >}}

Next, you will examine how new discoveries and medical breakthroughs can change the way patients are diagnosed, treated, and cared for.

{{< drg/next-page
    text="You now understand confidentiality as both an ethical duty and a legal responsibility in health care."
    teaser="Next, look at a recent medical advancement and think about how innovation can improve patient care."
