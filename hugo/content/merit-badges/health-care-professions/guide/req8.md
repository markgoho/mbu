...
{{< drg/image src="images/ai-diagnosis-workflow.avif" alt="Five-step visual workflow showing patient scan input, AI system highlighting a suspicious area, clinician reviewing the flagged image, specialist consultation, and earlier treatment decision, with minimal labels and clear arrows between steps" >}}

{{< drg/video
    title="High-tech hospital uses artificial intelligence in patient care — NBC News"
    url="https://www.youtube.com/watch?v=qetKUFDDF4A" >}}

{{< drg/did-you-know >}}
Some medical AI systems are trained using enormous collections of scans, slides, or records so they can learn patterns across thousands or even millions of examples — far more cases than any one clinician could personally see during training.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="How to Evaluate a Medical Breakthrough" subtitle="Use these questions with any news story you choose" >}}
...
{{< drg/tip >}}
When you discuss a breakthrough, avoid saying only that it is "better" or "more advanced." Say exactly how it could change care: faster diagnosis, fewer mistakes, more comfort, better recovery, or wider access to treatment.
{{< /drg/tip >}}

{{< drg/be-prepared title="If a News Story Sounds Overhyped" >}}
A lot of health headlines make early research sound like an instant cure.

- Check who did the research.
- Look for whether the work was tested in real patients.
- Notice whether the result is already in use or still experimental.
- Ask what needs to happen before patients widely benefit.

That kind of thinking shows maturity and good scientific judgment.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="National Institutes of Health — Research News"
    url="https://www.nih.gov/news-events/news-releases"
    description="Current medical research news from NIH that can help you find a recent advancement to discuss with your counselor." >}}

{{< drg/external-link
    title="U.S. Food and Drug Administration — Medical Devices"
    url="https://www.fda.gov/medical-devices"
    description="Information about how new medical devices and technologies are reviewed and used in patient care." >}}

Your last requirement takes you into service. Instead of only studying health care, you will step into your community and help at a real health-related event or facility.

{{< drg/next-page
    text="You now have a framework for discussing medical breakthroughs in terms of real patient impact."
    teaser="Next, put service into practice by volunteering at a health-related event or facility in your community."
