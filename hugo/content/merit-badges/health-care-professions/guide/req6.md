...
{{< drg/did-you-know >}}
Many medical schools now use updated oath language that includes respect for diversity, teamwork, lifelong learning, and service to the community. The tradition is ancient, but it keeps evolving with modern medicine.
{{< /drg/did-you-know >}}

{{< drg/video
    title="The Hippocratic Oath — CBS Sunday Morning"
    url="https://www.youtube.com/watch?v=iMiJDSbxLWE" >}}
...
{{< drg/checklist title="Ideas to Include in Your Discussion" subtitle="Use these points to build your own explanation" >}}
...
{{< drg/tip >}}
If you want to sound thoughtful instead of memorized, explain one part of the oath and give an example. For instance: "Respecting privacy matters because patients may hide important information if they do not trust the doctor."
{{< /drg/tip >}}

{{< drg/be-prepared title="When Ethics Is Not Obvious" >}}
Some medical choices do not have a perfect answer.

- One treatment may help but also carry risks.
- A patient may refuse advice.
- New technology may create new privacy or fairness concerns.

In those moments, the oath acts like a compass. It does not solve everything automatically, but it helps point clinicians toward patient-centered decisions.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="American Medical Association — Code of Medical Ethics Overview"
    url="https://code-medical-ethics.ama-assn.org/"
    description="An overview of the ethical principles physicians use to guide modern medical practice." >}}

{{< drg/external-link
    title="PBS — The Hippocratic Oath Today"
    url="https://www.pbs.org/wgbh/nova/article/hippocratic-oath-today/"
    description="A readable look at how the Hippocratic Oath has changed over time and why it still matters." >}}

In Req 7, you will build on this idea of trust by looking at confidentiality and the privacy law known as HIPAA.

{{< drg/next-page
    text="You now have a practical understanding of the Physician's Oath as an ethical promise to put patients first."
    teaser="Next, learn why confidentiality matters and how HIPAA helps protect patient information."
