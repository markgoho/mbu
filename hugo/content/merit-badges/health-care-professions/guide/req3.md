...
1. Medical Assistant
1. Dietitian (RD)
1. Speech-Language Pathologist (Speech Therapist) (SLP)
{{< /drg/requirement >}}
...
{{< drg/image src="images/rehab-goals-comparison.avif" alt="Four-panel comparison showing a patient practicing stairs with a physical therapist, using adaptive kitchen tools with an occupational therapist, receiving breathing treatment from a respiratory therapist, and doing speech or swallowing exercises with a speech-language pathologist" >}}
...
{{< drg/tip >}}
A simple way to explain these careers is to finish this sentence: "This professional helps a patient do more of life on their own by..." That works especially well for PT, OT, RT, SLP, and dietitian roles.
{{< /drg/tip >}}

{{< drg/checklist title="What Makes Group 3 Different?" subtitle="Look for these patterns as you compare careers" >}}
...
{{< drg/did-you-know >}}
Speech-language pathologists do not just help people speak. They also work with swallowing, which can be a serious safety issue for patients recovering from strokes, surgeries, or neurological disorders.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="When Two Jobs Sound Similar" >}}
If two careers seem close, compare them by their main goal:

- **PT:** improve movement and physical function
- **OT:** improve daily living and independence
- **RT:** improve breathing and airway support
- **SLP:** improve communication and swallowing
- **RD:** improve health through food and nutrition

That one step often clears up confusion fast.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="American Physical Therapy Association — Choose PT"
    url="https://www.choosept.com/"
    description="An overview of what physical therapists do and how they help patients recover movement and function." >}}

{{< drg/external-link
    title="American Occupational Therapy Association — About Occupational Therapy"
    url="https://www.aota.org/about/for-the-public"
    description="A plain-language explanation of how occupational therapists help people participate in everyday life." >}}

{{< drg/external-link
    title="American Speech-Language-Hearing Association — Speech-Language Pathologists"
    url="https://www.asha.org/public/who-are-speech-language-pathologists/"
    description="A patient-friendly overview of speech-language pathology and the communication and swallowing challenges SLPs address." >}}
...
{{< drg/next-page
    text="You now see how Group 3 careers help patients recover function, confidence, and independence."
    teaser="Next, explore the lab, imaging, and technology careers that make modern diagnosis and treatment possible behind the scenes."
