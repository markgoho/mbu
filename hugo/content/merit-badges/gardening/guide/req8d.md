...
req_number: "8d"
prev: "/merit-badges/gardening/guide/req8c/"
prev_title: "Req 8c — Hydroponic Garden Project"
next: "/merit-badges/gardening/guide/req8e/"
next_title: "Req 8e — Honey Super Project"
---
...
{{< drg/video
    title="How to Create a Water Garden in a Pot"
    url="https://youtu.be/Y2ZL-9hRtLc?si=wxK-wWUh_DNaTdsX" >}}
...
- **Submerged or oxygenating plants** that live mostly underwater
- **Floating plants** that rest on the surface
- **Marginal plants** that grow at the edges with roots in wet conditions

The right plant mix depends on the size and depth of your setup. Your counselor can help you keep the project realistic.

{{< drg/image src="images/water-garden-plant-zones.avif" alt="Cross-section of a small container water garden showing floating plants at the surface, submerged oxygenating plants below, and marginal plants rooted on raised shelves around the edge" >}}
...
{{< drg/checklist title="Water Garden Watch List" subtitle="These details tell you whether the system is staying balanced" >}}
...
{{< drg/safety-first >}}
Place the water garden where it will not be a tripping hazard and where younger children or pets cannot fall into it accidentally. If you build an in-ground feature, make sure an adult approves the location and construction plan.
{{< /drg/safety-first >}}
...
It also connects nicely to [Req 6](/merit-badges/gardening/guide/req6/), because water gardens may support pollinators and other small wildlife when designed thoughtfully.

{{< drg/be-prepared title="The Water Turns Green Fast" >}}
If algae begins taking over:

- **Reduce extra nutrients.** Decaying material can feed algae.
- **Remove dying leaves promptly.**
- **Check how much direct sun the setup gets.**
- **Thin overcrowded plants if needed.**
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Missouri Botanical Garden — Water Gardens"
    url="https://www.missouribotanicalgarden.org/gardens-gardening/your-garden/help-for-the-home-gardener/advice-tips-resources/gardening-help"
    description="A reputable botanical-garden resource hub that can support research into plant care, pond conditions, and water-garden planning." >}}
...
{{< drg/next-page
    text="You have learned how to set up and maintain a small water garden over a full project period."
    teaser="See how a honey super fits into beekeeping and why this option requires careful supervision and timing."
