---
title: "Nutritional Value of Garden Crops"
layout: guide
group_title: "2. Growing Plants"
req_number: "3a"
prev: "/merit-badges/gardening/guide/req2b/"
prev_title: "Growing Flowers"
next: "/merit-badges/gardening/guide/req4/"
next_title: "Seed Germination Testing"
---
...
{{< drg/video
    title="Potatoes"
    url="https://youtu.be/3qCh8KZw_e0?si=f9aIa5z8f8LDDeLm" >}}
...
{{< drg/video
    ...
    url="https://youtu.be/o7ZwuSd8KRg?si=EEj5qNHCID4FDxYX" >}}
...
{{< drg/video
    title="Taro"
    url="https://youtu.be/0VjgXZBKfuQ?si=Uw0UYQkPgWfgqQfx" >}}
...
{{< drg/video
    title="Lettuce"
    url="https://youtu.be/kzX-0rUbkOo?si=9hpUmjCR-dFy9sTi" >}}
...
{{< drg/video
    title="Tomatoes"
    url="https://youtu.be/niTBMlWtW5w?si=gksvt0kr-ZljJtEh" >}}
...
{{< drg/video
    title="Apples"
    url="https://youtu.be/0yEPKXlYQqQ?si=MLy5YBr_XZ34hQEN" >}}
...
{{< drg/video
    title="Oranges"
    url="https://youtu.be/DkxhGscNC18?si=iny8kROTvx7-PKkq&t=1" >}}
...
{{< drg/video
    title="Grapes"
    url="https://youtu.be/NLS15CrmEYU?si=6Sl4-RSS8dd2d0BS" >}}

{{< drg/did-you-know >}}
Tomatoes are botanically fruits because they develop from a flower and contain seeds, but in cooking they are usually treated as vegetables. That is one reason gardeners and cooks sometimes sort crops differently.
{{< /drg/did-you-know >}}

## Comparing the Three Crop Groups

| Crop Group | Main Strengths | Common Nutrients |
|---|---|---|
| Root/tuber crops | Energy storage foods | Carbohydrates, fiber, potassium, vitamin A or C depending on crop |
| Above-ground vegetables | Low-calorie nutrient density | Water, fiber, vitamin K, vitamin C, folate, antioxidants |
| Fruits | Sweetness plus hydration and vitamins | Vitamin C, fiber, water, natural sugars, antioxidants |
...
This requirement also connects back to [Req 2a](/merit-badges/gardening/guide/req2a/). When you grow vegetables yourself, the nutritional discussion becomes personal. You are not just talking about potatoes or tomatoes in theory. You may be eating something you raised.

{{< drg/external-link
    title="USDA MyPlate — Vegetables"
    url="https://www.myplate.gov/eat-healthy/vegetables"
    description="A simple guide to vegetable groups, nutrients, and why variety matters in a healthy eating pattern." >}}

{{< drg/external-link
    title="USDA MyPlate — Fruits"
    url="https://www.myplate.gov/eat-healthy/fruits"
    description="An easy-to-understand overview of the nutritional benefits of fruits and how they fit into balanced meals." >}}
...
{{< drg/next-page
    text="You have explored how root crops, above-ground vegetables, and fruits contribute to a healthy diet."
    teaser="Test seeds scientifically and learn what germination rates reveal about seed quality and growing conditions."
