...
{{< drg/video
    title="Benefits of Gardening as a Hobby and Why You Should Be a Gardener"
    url="https://youtu.be/iVecXN-JQ64?si=Oi7akvlN2S3UerRT" >}}
...
{{< drg/image src="images/small-space-gardening-progression.avif" alt="Comparison showing a beginner container herb setup, a mid-size patio vegetable arrangement, and a larger home garden setup to visualize short-term and long-term hobby growth" >}}
...
{{< drg/checklist title="What to Research for This Option" subtitle="Build a realistic picture of gardening as a long-term hobby" >}}
...
{{< drg/tip >}}
The best gardening goals are specific enough to act on. "I want to garden more" is weak. "I want to grow three herbs and two vegetables in containers this summer" is much stronger.
{{< /drg/tip >}}
...
It also connects with nearly every earlier part of the badge. If you liked the projects in [Req 8](/merit-badges/gardening/guide/req8/), this option helps you imagine continuing one of them after the badge is complete.

{{< drg/be-prepared title="You Like Gardening but Worry You Will Not Stick With It" >}}
If you want gardening to become a real habit:

- **Start small.** A few containers are easier to maintain than a huge plot.
- **Choose plants you care about.** Interest keeps motivation high.
- **Build a routine.** Tie garden checks to a regular day or time.
- **Join a group or garden with others.** Community makes hobbies more durable.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="National Garden Clubs"
    url="https://gardenclub.org/"
    description="A nationwide organization that can help gardeners find clubs, projects, and educational opportunities." >}}

{{< drg/external-link
    title="American Community Gardening Association"
    url="https://www.communitygarden.org/"
    description="A useful resource for learning how community gardens support food access, education, and local involvement." >}}
...
{{< drg/next-page
    text="You have explored how gardening can become part of a healthy lifestyle, a lasting hobby, and a personal set of goals."
    teaser="Go beyond the badge with deeper learning, places to visit, and organizations that can support your next steps."
    url="/merit-badges/gardening/guide/extended-learning/" >}}
