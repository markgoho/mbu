...
{{< drg/video
    title="5 Minute Compost Bin"
    url="https://youtu.be/B43nL_xGs5Q?si=mLxGeUVlKRMG2T9n" >}}
...
{{< drg/image src="images/compost-browns-greens-layers.avif" alt="Cross-section of a backyard compost bin showing alternating layers of browns and greens, airflow spaces, moisture, and finished compost forming at the bottom" >}}
...
{{< drg/checklist title="Keys to a Good Compost Setup" subtitle="Make the system easy to maintain for 90 days" >}}
...
{{< drg/tip >}}
If your pile smells bad, it is often too wet or too heavy on green material. Add more dry browns and turn the pile to bring in oxygen.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Your Compost Pile Stops Changing" >}}
If the pile seems stuck:

- **Turn it.** It may need more oxygen.
- **Check moisture.** Too dry means microbes slow down.
- **Add balance.** Mix in greens if it is all dry browns, or browns if it is too wet.
- **Chop large pieces smaller.** Smaller materials break down faster.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    title="EPA — Composting Basics"
    url="https://www.epa.gov/recycle/composting-home"
    description="A practical guide to starting and maintaining a compost pile or bin at home." >}}
...
{{< drg/next-page
    text="You have learned how a compost bin works and what to watch over a 90-day project."
    teaser="See how worms can turn food scraps into rich compost in a smaller, more controlled system."
