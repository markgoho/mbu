...
{{< drg/video
    title="Seed Germination Test"
    url="https://youtu.be/E0jzPVGiKHs?si=6sRjzeuX1P0CgsSA" >}}
...
{{< drg/image src="images/seed-germination-test-sequence.avif" alt="Four-step visual sequence showing 100 seeds arranged on a damp paper towel, folded into a labeled bag, early root tips emerging, and a final count of germinated versus ungerminated seeds" >}}

Some seeds sprout in a few days. Others take longer. Use a reasonable timeframe for the crop you chose.

{{< drg/checklist title="What Counts as Germinated?" subtitle="Use a consistent standard for your 100-seed test" >}}
...
- 92 germinated = **92% germination**
- 75 germinated = **75% germination**
- 41 germinated = **41% germination**
...
{{< drg/tip >}}
Write down the crop, seed source, date, temperature conditions, and daily counts as you run your test. That turns a simple activity into a real experiment you can explain clearly to your counselor.
{{< /drg/tip >}}
...
If your rate is 90% or higher, that is a strong sign your seed is in good shape. That kind of information is especially useful when planning [Req 2a](/merit-badges/gardening/guide/req2a/) or a longer project in [Req 8](/merit-badges/gardening/guide/req8/).
...
{{< drg/be-prepared title="Mold Appears in Your Germination Test" >}}
If the towel or container grows mold before you get clear results:

- **Check moisture level.** It was probably too wet.
- **Improve airflow slightly if your method allows it.**
- **Restart the test with fresh materials.**
- **Note the problem in your observations.** That is still useful information.
{{< /drg/be-prepared >}}

{{< drg/did-you-know >}}
Some seeds can stay alive for surprisingly long periods under the right conditions. Researchers have successfully germinated seeds that were decades old, and in rare scientific cases much older, though that is not typical for ordinary garden seed packets.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Iowa State University Extension — Testing Vegetable Seeds for Germination"
    url="https://yardandgarden.extension.iastate.edu/how-to/test-germination-saved-seed"
    description="A straightforward guide to running a home germination test and interpreting the results." >}}
...
{{< drg/next-page
    text="You have learned how to test seed viability and explain why some seeds fail to sprout."
    teaser="Visit a gardening expert or plant-focused site and report what you learned from the experience."
