...
{{< drg/video
    title="Setting Up Your Honey Super"
    url="https://youtu.be/TGdH4vtR3JM?si=o8S51hqQASjVsbxc" >}}
...
{{< drg/safety-first >}}
Never open or work a hive without trained adult supervision and proper protective equipment. Bee behavior, weather, colony condition, and your own allergy risk all matter. If anyone involved has a known severe allergy, follow the agreed safety plan exactly.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/honey-super-frame-layout.avif" alt="Exploded view of a honey super showing the outer box, parallel frames, wax foundation sheets, and the way the super sits above the brood boxes in a stacked hive" >}}
...
{{< drg/checklist title="What to Observe in This Project" subtitle="Focus on process, timing, and bee management" >}}
...
This option may sound more like beekeeping than gardening, but the link is strong. Honeybee colonies are managed partly because of the pollination service they provide, which you studied in [Req 6](/merit-badges/gardening/guide/req6/). Seeing the honey super process helps you understand that pollination and food systems are connected in practical ways.
...
{{< drg/tip >}}
If you choose this option, take especially careful notes because the process may happen at a specific time and move quickly. Good observations will help you explain the full sequence later.
{{< /drg/tip >}}

{{< drg/external-link
    title="USDA ARS — Honey Bees and Pollination"
    url="https://www.ars.usda.gov/oc/br/honeybees/"
    description="Background on managed honey bees, pollination, and the agricultural importance of bee colonies." >}}
...
{{< drg/next-page
    text="You have learned how a honey super fits into hive management and honey production."
    teaser="Finish the project options by exploring the most flexible path: building and maintaining your own soil garden."
