...
{{< drg/video
    title="Hydroponics Bucket Grower for UNDER $40!"
    url="https://youtu.be/JZCNd4THUhs?si=9vDD-oMODBjJM8-z" >}}

{{< drg/video
    title="How To Build Your Own Hydroponics System"
    url="https://youtu.be/Z_3ccmK6NVM?si=e0HLkGdP-M1otv22" >}}
...
{{< drg/image src="images/simple-hydroponic-bucket-parts.avif" alt="Cutaway diagram of a simple bucket hydroponic system with plant basket, support media, roots, nutrient solution, air stone, airline tube, and bucket lid labeled" >}}

The three big ideas are:

- **Roots still need oxygen**
- **Plants still need nutrients**
- **Light still drives growth**
...
{{< drg/checklist title="Hydroponic Success Factors" subtitle="These matter more than fancy equipment" >}}
...
{{< drg/tip >}}
Start with fewer plants than the system could theoretically hold. A slightly underfilled beginner system is easier to observe and manage than one crammed to the limit.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Plants Are Alive but Barely Growing" >}}
If growth stalls:

- **Check the light first.** Weak light causes many beginner problems.
- **Inspect the roots.** Healthy roots are usually firm and lighter colored, not slimy or foul-smelling.
- **Review nutrient strength and water quality.**
- **Clean the system if algae or buildup is developing.**
{{< /drg/be-prepared >}}
...
This option connects well to [Req 4](/merit-badges/gardening/guide/req4/) because both require careful observation and evidence-based thinking. It also helps you appreciate how flexible gardening can be when space or soil quality is limited.

{{< drg/external-link
    title="University of Florida IFAS — Hydroponic Gardening"
    url="https://gardeningsolutions.ifas.ufl.edu/design/types-of-gardens/hydroponic-gardening/"
    description="A clear introduction to hydroponic gardening systems, plant choices, and practical home-growing considerations." >}}
...
{{< drg/next-page
    text="You have learned how hydroponic systems provide water, nutrients, and support without soil."
    teaser="Build a small water garden and learn how aquatic or moisture-loving plants create a stable mini-ecosystem."
