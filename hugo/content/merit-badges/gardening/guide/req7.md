...
{{< drg/video
    title="5 Organic Methods to Control Pests in Your Garden, Finally a Way to Fight Back!"
    url="https://youtu.be/JXEtmKRnMZk?si=itMLTvAvBfDXA8w4" >}}

{{< drg/video
    title="7 Pests You Probably Have in Your Garden (and What to Do)"
    url="https://youtu.be/em5t8bScq9s?si=kj3Qye8wAYMEvWhA" >}}

## Five Good Pest Examples to Know
...
{{< drg/image src="images/common-garden-pests-identification-grid.avif" alt="Identification grid showing aphids, tomato hornworm, slug, powdery mildew, and tomato leaf spot side by side with one clear visual symptom for each" >}}
...
- **Organic solution:** Blast them off with a firm spray of water or remove heavily infested plant tips.
- **Second solution:** Encourage natural predators such as lady beetles, lacewings, and syrphid fly larvae; insecticidal soap may also be used carefully.

### 2. Tomato Hornworms

These large green caterpillars can strip tomato plants fast because they blend in so well.

- **Organic solution:** Hand-pick them off the plant.
- **Second solution:** Encourage beneficial wasps and inspect plants daily so you catch damage early.
...
- **Organic solution:** Hand-pick at night or use barriers and traps.
- **Second solution:** Reduce hiding places by cleaning up dense debris and watering earlier in the day so surfaces dry sooner.

### 4. Powdery Mildew

This plant disease appears as a pale, powdery coating on leaves. It often thrives when air circulation is poor.

- **Organic solution:** Remove badly affected leaves and improve spacing and airflow.
- **Second solution:** Choose resistant varieties or adjust watering and pruning practices to reduce conditions that favor disease.
...
- **Organic solution:** Remove infected plant material and avoid overhead watering that splashes spores.
- **Second solution:** Rotate crops and do not plant the same family in the same place every year.
...
That systems-based thinking fits well with [Req 6](/merit-badges/gardening/guide/req6/), where you learned not all insects are enemies. Some of the insects in your garden are helpers.

{{< drg/checklist title="A Smarter Pest Response" subtitle="Use this order before reaching for any product" >}}
...
{{< drg/tip >}}
Take close photos of damage and affected plant parts before you remove them. That gives you something clear to show your counselor, extension office, nursery staff, or a plant clinic if you need help identifying the issue.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="You See Damage but No Pest" >}}
If the pest is gone by the time you look:

- **Check the time of day.** Some pests feed mostly at night.
- **Look under leaves and near the soil line.**
- **Study the damage pattern.** Chewing, stippling, spots, and wilt all suggest different causes.
- **Ask for help from a local extension office or nursery if needed.**
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="University of California IPM — Home and Landscape Pests"
    url="https://ipm.ucanr.edu/PMG/menu.homegarden.html"
    description="A strong identification and management resource for common garden insects, diseases, and integrated pest management strategies." >}}
...
{{< drg/next-page
    text="You have learned how to identify common garden pests and compare at least two solutions for each, including organic methods."
    teaser="Choose one major gardening project and decide which path fits your space, tools, and interests best."
