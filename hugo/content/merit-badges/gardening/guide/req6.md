...
{{< drg/video
    ...
    url="https://youtu.be/Kdm9daKTRsc?si=I5GPFtrnBBb3RwPu" >}}

{{< drg/video
    title="Why Bees Are Important"
    url="https://youtu.be/Jzp6H8BAJ7o?si=GSLeo8yCvfJUS-4e" >}}
...
{{< drg/image src="images/pollination-flower-transfer-sequence.avif" alt="Close-up three-panel sequence of a honeybee visiting one blossom, pollen sticking to its fuzzy body, and pollen being deposited on the next flower's stigma" >}}
...
{{< drg/safety-first >}}
Helping pollinators does not mean handling bees casually. If you are near hives or active bee work, follow the instructions of trained adults, move calmly, and respect anyone's known allergy plan.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="If There Were No Pollinators" subtitle="The impact would spread far beyond honey" >}}
...
- Avoid spraying pesticides during bloom, especially when bees are active.
- Leave some nesting habitat for native pollinators.
- Provide shallow water sources with safe landing spots.

This also connects strongly to [Req 8d](/merit-badges/gardening/guide/req8d/) if you choose a water garden and to [Req 8e](/merit-badges/gardening/guide/req8e/) if you explore the honey super option.

{{< drg/did-you-know >}}
A single honeybee colony may visit millions of flowers in a season. That huge amount of flower-to-flower travel is why managed hives can make such a big difference in crop pollination.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="USDA — Pollinator Research and Action"
    url="https://www.usda.gov/pollinators"
    description="An overview of why pollinators matter, the challenges they face, and what people can do to help." >}}
...
{{< drg/next-page
    text="You have learned how honeybees support food crops and why pollinators are essential to ecosystems and agriculture."
    teaser="Identify common garden pests and compare practical solutions, including organic control methods."
