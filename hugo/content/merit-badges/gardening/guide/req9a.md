---
title: "Gardening Careers"
layout: guide
group_title: "9. Careers & Lifelong Gardening"
req_number: "9a"
prev: "/merit-badges/gardening/guide/req9/"
prev_title: "Careers or Healthy Living"
next: "/merit-badges/gardening/guide/req9b/"
next_title: "Gardening as a Hobby & Healthy Lifestyle"
---
...
{{< drg/video
    title="Gardener - Career Spotlight"
    url="https://youtu.be/RVIvWuZ-TUk?si=Iyu26yzBvJHanASD" >}}
...
{{< drg/checklist title="Questions to Ask About a Career" subtitle="Use these to organize your research" >}}
...
{{< drg/tip >}}
If possible, talk to a real person in the field. A short conversation with a nursery manager, public garden staff member, extension agent, or landscaper can teach you more than an hour of generic internet reading.
{{< /drg/tip >}}
...
This option also connects well to [Req 5](/merit-badges/gardening/guide/req5/), because a visit to a nursery, university, or botanical garden may introduce you to people already doing this work.

{{< drg/external-link
    title="U.S. Bureau of Labor Statistics — Landscaping and Groundskeeping Workers"
    url="https://www.bls.gov/ooh/building-and-grounds-cleaning/grounds-maintenance-workers.htm"
    description="Career outlook information, pay data, and work descriptions for plant-focused grounds and landscape jobs." >}}

{{< drg/external-link
    title="AmericanHort"
    url="https://www.americanhort.org/"
    description="A horticulture industry organization that helps show how professional plant work connects to careers, training, and advancement." >}}

You have now looked at gardening as work. Next, compare that with the other final path: how gardening can become part of your own healthy lifestyle and long-term goals.

{{< drg/next-page
    text="You have learned how gardening skills connect to real careers and what it takes to enter one of those fields."
    teaser="Explore gardening as a personal hobby and healthy lifestyle choice with benefits that can last for years."
