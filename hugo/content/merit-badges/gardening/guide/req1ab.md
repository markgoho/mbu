...
- **How to recognize hazards in the garden**
- **How to prevent and treat common gardening injuries and health problems**
...
{{< drg/image src="images/garden-tool-carry-storage-comparison.avif" alt="Side-by-side comparison of safe and unsafe garden tool handling, showing a person carrying pointed tools downward and storing them neatly in one area versus tools scattered with blades up on the ground" >}}
...
{{< drg/safety-first >}}
If a person becomes confused, stops sweating, vomits repeatedly, or loses consciousness in the heat, treat it as a medical emergency. Call 911 right away. Heat stroke can become life-threatening very quickly.
{{< /drg/safety-first >}}
...
- **Use the person's prescribed epinephrine auto-injector if trained and authorized to help.**
- **Call 911 right away.** Even if symptoms improve, the person still needs medical care.
- **Keep them lying down or sitting still unless they are vomiting or having breathing trouble in a different position.**
{{< /drg/be-prepared >}}

{{< drg/video
    title="How to Be Safe in the Garden"
    url="https://youtu.be/XWNaWVOar3Q?si=5bJv6elbMcRZ92oX" >}}
...
{{< drg/video
    ...
    url="https://youtu.be/fMidlx7VB0A?si=v5o_p4iwXa6Dxy8A" >}}

## Requirement 1b: Preventing and Treating Common Garden Health Problems

### Preventing Common Garden Injuries

{{< drg/checklist title="Before You Start Gardening" subtitle="A quick safety routine that prevents most problems" >}}
...
{{< drg/tip >}}
Store garden chemicals in their original containers. Never pour them into drink bottles or food containers. That is one of the easiest ways to cause a dangerous mistake.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="CDC — Protect Yourself From Tick Bites"
    url="https://www.cdc.gov/ticks/prevention/index.html"
    description="Practical guidance for avoiding ticks while working outdoors in grass, brush, and garden spaces." >}}

{{< drg/external-link
    title="Poison Control"
    url="https://www.poison.org/"
    description="What to do if someone is exposed to a chemical, plant, or garden product. Includes the U.S. Poison Help number." >}}
...
{{< drg/next-page
    text="You have learned how to recognize hazards, prevent injuries, and respond to common garden health problems."
    teaser="Start growing food crops and learn what seeds and seedlings each need to reach harvest."
