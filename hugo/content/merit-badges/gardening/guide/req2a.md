...
req_number: "2a"
prev: "/merit-badges/gardening/guide/req1ab/"
prev_title: "Garden Safety & First Aid"
next: "/merit-badges/gardening/guide/req2b/"
next_title: "Growing Flowers"
---
...
- **Grow six vegetables through harvest**
- **Use both seeds and seedlings so you experience each starting method**
...
{{< drg/video
    ...
    url="https://youtu.be/bRWac1OpxPY?si=h96A-L4r9Yb5Qcy3" >}}
...
{{< drg/checklist title="How to Pick Your Six Vegetables" subtitle="Build a realistic plan before you plant" >}}
...
{{< drg/tip >}}
Label what you plant on day one. Many young vegetable seedlings look similar, and it is surprisingly easy to forget which row is lettuce and which row is carrot after a week or two.
{{< /drg/tip >}}
...
{{< drg/image src="images/seed-vs-seedling-growth-path.avif" alt="Three-panel comparison showing vegetable growth stages from seed packet to sprout, from nursery seedling to transplanted plant, and both paths reaching harvest size" >}}

{{< drg/be-prepared title="Your Seedlings Wilt After Planting" >}}
If newly transplanted vegetables droop right away:

- **Check soil moisture first.** They may need a deep watering.
- **Give temporary shade if the sun is intense.** Tender seedlings may need a day or two to adjust.
- **Do not overfertilize to "fix" the problem.** That can stress roots even more.
- **Watch new growth.** Recovery is a better sign than instant perkiness.
{{< /drg/be-prepared >}}
...
- Which vegetables sprouted fastest
- Which plants needed the most water
- How seedlings responded after transplanting
- Which plants attracted insects
- Whether weather helped or slowed growth
- How long it took to reach harvest
- What you would change next time

Those observations prepare you well for [Req 4](/merit-badges/gardening/guide/req4/), where you will test germination scientifically, and for [Req 7](/merit-badges/gardening/guide/req7/), where you will identify pests and solutions.

{{< drg/external-link
    title="University of Minnesota Extension — Growing Vegetables"
    url="https://extension.umn.edu/planting-and-growing-guides/growing-vegetables"
    description="Reliable growing guides for common vegetables, including planting depth, spacing, and harvest timing." >}}
...
{{< drg/next-page
    text="You have learned how to choose, start, transplant, and harvest vegetable crops successfully."
    teaser="Shift from food crops to flowers and learn how to grow plants all the way through bloom."
