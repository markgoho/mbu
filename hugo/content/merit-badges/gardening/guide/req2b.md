...
{{< drg/video
    ...
    url="https://youtu.be/kcLMLyTAKmo?si=Suj-BOnu6B6-ELxu" >}}

{{< drg/checklist title="Questions to Ask Before Choosing Flowers" subtitle="Strong choices make this requirement much easier" >}}
...
{{< drg/tip >}}
Remove spent blooms on flowers that benefit from deadheading, such as marigolds or zinnias. That often encourages the plant to make more flowers instead of putting energy into seed production.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Some flowers can change how often pollinators visit based on temperature, time of day, and even ultraviolet patterns in the petals that human eyes cannot see. To a bee, a flower may look like it has landing guides painted right on it.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Buds Form, Then Dry Up" >}}
If your plant forms buds but they do not open well:

- **Check water consistency.** Alternating dry and soggy soil stresses flowering plants.
- **Review sun exposure.** Many bloomers need stronger light than their leaves suggest.
- **Look for insect damage.** Tiny pests can attack buds before they open.
- **Be patient with the season.** Some plants simply bloom later than others.
{{< /drg/be-prepared >}}
...
This page also connects naturally to [Req 6](/merit-badges/gardening/guide/req6/), where you will study pollinators. Once you have seen bees visiting your own flowers, that later discussion becomes much more real.

{{< drg/external-link
    title="Royal Horticultural Society — Annuals and Biennials"
    url="https://www.rhs.org.uk/plants/types/annuals-biennials"
    description="Clear explanations of common flowering plant types and how gardeners use them in beds and containers." >}}

You have now grown flowers all the way to bloom. Next, step back from cultivation and think about what garden crops contribute to nutrition and healthy eating.

{{< drg/next-page
    text="You have learned how to grow flowering plants from both seed and seedlings."
    teaser="Explore the nutritional value of roots, above-ground vegetables, and fruits commonly grown in gardens."
