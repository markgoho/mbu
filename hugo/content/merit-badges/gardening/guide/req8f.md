...
req_number: "8f"
prev: "/merit-badges/gardening/guide/req8e/"
prev_title: "Req 8e — Honey Super Project"
next: "/merit-badges/gardening/guide/req9/"
next_title: "Req 9 — Careers or Healthy Living"
---
...
{{< drg/video
    title="Start a Garden | Step-by-Step | Gardening Tips"
    url="https://youtu.be/EPmV8iqZIps?si=OsN9RZoNPdfpWJxb" >}}
...
{{< drg/image src="images/garden-layout-spacing-plan.avif" alt="Top-down garden bed plan showing three crop types with mature spacing, support trellis placement, walking access, and sun direction" >}}

{{< drg/checklist title="Build a Strong Garden Plan" subtitle="Think through the project before you start planting" >}}
...
This is where lessons from [Req 8a](/merit-badges/gardening/guide/req8a/) or [Req 8b](/merit-badges/gardening/guide/req8b/) can help. Compost and worm castings improve the growing environment, which can directly help this project succeed.
...
{{< drg/tip >}}
Do your garden check at about the same time each week, and if possible add short in-between checks for watering and pest scouting. Consistency makes your notes more useful.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="One Plant Starts Failing While Others Are Fine" >}}
If one of your three plant types struggles:

- **Compare conditions.** Is that plant in different light or soil moisture?
- **Inspect for pests or disease.**
- **Review spacing and root room.**
- **Adjust care early instead of waiting too long.**
{{< /drg/be-prepared >}}

## Why This Option Is So Valuable

This project brings together most of the badge. You use safe habits from [Req 1a–1b](/merit-badges/gardening/guide/req1ab/), growing knowledge from [Req 2a](/merit-badges/gardening/guide/req2a/) and [Req 2b](/merit-badges/gardening/guide/req2b/), and problem-solving skills from [Req 7](/merit-badges/gardening/guide/req7/). It is the broadest single test of what you have learned.

{{< drg/external-link
    title="University of Illinois Extension — Vegetable Garden Basics"
    url="https://extension.illinois.edu/vegetables/home-vegetable-gardening"
    description="A practical overview of planning, planting, and maintaining a home vegetable garden." >}}
...
{{< drg/next-page
    text="You have learned how to plan, plant, observe, and maintain a soil-based garden over time."
    teaser="Decide whether to explore gardening as a career path or as a personal hobby and healthy lifestyle."
