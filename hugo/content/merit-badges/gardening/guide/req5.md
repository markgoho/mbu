...
{{< drg/video
    title="Eyes on Agriculture"
    url="https://youtu.be/zMB6lTyXdnE?si=LtY7M54LNZpkafpn" >}}

## What to Look For During Your Visit

Do not wander around and only say, "It was interesting." Go with questions. Look for systems, decisions, and reasons.

{{< drg/checklist title="Questions to Take on Your Visit" subtitle="These will help you build a stronger report" >}}
...
- A new planting method or tool you saw
- Advice about local growing seasons
- How professionals manage pests responsibly
- Why certain plants were grouped together
- How pollinators or native plants are supported
...
This visit can support many later discussions. You may see pollinator plantings that connect to [Req 6](/merit-badges/gardening/guide/req6/). You may learn pest control methods that help with [Req 7](/merit-badges/gardening/guide/req7/). You may even discover a project idea for [Req 8](/merit-badges/gardening/guide/req8/).
...
{{< drg/tip >}}
Bring a notebook or use your phone, with permission, to record names of plants, key ideas, and questions. You will remember much more accurately later if you take notes during the visit.
{{< /drg/tip >}}

{{< drg/be-prepared title="You Do Not Know What to Ask" >}}
If you arrive and feel shy or unsure:

- **Start with one simple question.** "What grows best for beginners here?"
- **Ask follow-ups.** "Why?" and "What problems do people run into?"
- **Notice labels and displays.** They often suggest useful questions.
- **Listen carefully.** Experts often answer one question by teaching three more things.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="National Institute of Food and Agriculture — Cooperative Extension System"
    url="https://www.nifa.usda.gov/about-nifa/how-we-work/extension/cooperative-extension-system"
    description="Explains how the Cooperative Extension System connects universities with local communities and practical education." >}}
...
{{< drg/next-page
    text="You have explored how professional growers, educators, and plant experts share practical gardening knowledge."
    teaser="Learn why honeybees and other pollinators matter so much to gardens, farms, and the human food supply."
