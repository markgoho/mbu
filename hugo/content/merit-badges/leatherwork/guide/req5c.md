...
{{< drg/video
    title="How to Clean & Shine Leather Shoes! (video)"
    url="https://youtu.be/MSaNoMNrZxU?si=NLIb7JASM5tkReY9" >}}

{{< drg/video
    title="How to Care for Your Baseball Glove (video)"
    url="https://youtu.be/sNXcHCHK-wI?si=PN2HDyT5eopuOtnZ" >}}

{{< drg/video
    title="How to Clean a Western Saddle (video)"
    url="https://youtu.be/g_oDJhwVKFI?si=RyU4gxTsFrK672hj" >}}

{{< drg/video
    title="How to Remove Mold and Mildew on Leather (video)"
    url="https://youtu.be/2NUr6y3R7Mg?si=6s2_1YHwovPiZQ_S" >}}
...
{{< drg/image src="images/leather-vs-synthetic-aging-comparison.avif" alt="Comparison image of two similar wallet corners after wear: leather showing patina and smooth edge wear, synthetic showing peeling surface and cracking" >}}

{{< drg/checklist title="Points to compare with your counselor" subtitle="Build a balanced discussion" >}}
...
{{< drg/next-page
    text="You know how to care for finished leather items and compare them thoughtfully with synthetics."
    teaser="Next, visit a leather-related business and learn how professionals work with the material."
