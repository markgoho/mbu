...
{{< drg/tip >}}
Start simple. A small project finished neatly teaches you more than a giant project that frustrates you halfway through.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Many classic floral and basket-weave patterns are designed so the eye notices the overall flow first, not each individual stamp. A good pattern feels organized even before you study the details.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Leathercraft uses sharp blades, hole punches, dyes, cements, and finishes. Always work on a protected surface, keep fingers out of the cutting path, and use finishes only with good ventilation and adult guidance when needed.
{{< /drg/safety-first >}}

Now you have the big picture. The first step is learning how to work safely and how to respond if something goes wrong.

{{< drg/next-page
    text="You have the overview of what leatherwork is and where the craft shows up in daily life."
    teaser="Learn the hazards of leather tools and materials, plus first aid for common shop injuries."
    url="/merit-badges/leatherwork/guide/req1/" >}}
