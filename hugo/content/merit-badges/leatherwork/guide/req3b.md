...
{{< drg/video
    title="Best Practices for Cutting Leather (video)"
    url="https://youtu.be/KwamMpHW9Ls?si=8jzWvnYf8rteJcQd" >}}
...
{{< drg/safety-first >}}
Never put your support hand in front of the blade. If the tool slips, it should move into open space, not into your fingers.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="You cut slightly off the line" >}}
- **Stop and assess the size of the error.** A tiny deviation may trim out during edge work.
- **Do not keep slicing farther off course.** Reset before making the error larger.
- **Compare both sides of the project.** Symmetry matters more than perfection on one side.
- **Use the mistake as a decision point.** Sometimes the best recovery is slightly resizing the whole piece so it stays balanced.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You know how to make safer, cleaner cuts that match your pattern."
    teaser="Next, learn how to punch neat holes for stitching, lacing, and hardware."
