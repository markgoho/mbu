...
{{< drg/video
    title="Edge Finishing Techniques (video)"
    url="https://youtu.be/kb8yyG3TO70?si=3neDiHe3jxmRj7UJ" >}}
...
{{< drg/tip >}}
Do not wait until the very end to think about edges. In [Req 3b](/merit-badges/leatherwork/guide/req3b/), clean cutting makes later edge work much easier.
{{< /drg/tip >}}
...
{{< drg/image src="images/edge-finishing-before-after.avif" alt="Side-by-side close-up of a rough fuzzy leather edge before finishing and a smooth burnished rounded edge after finishing" >}}
...
{{< drg/next-page
    text="You know how dressed edges improve both appearance and durability."
    teaser="Next, learn how braiding and plaiting create strong woven leather articles."
