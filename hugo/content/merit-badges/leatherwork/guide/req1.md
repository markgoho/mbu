...
- **Req 1a** helps you spot hazards before they become injuries.
- **Req 1b** helps you respond calmly if someone gets cut, poked, or exposed to chemicals.
...
{{< drg/video
    title="Safety in Leatherwork | Dangers and Health and Safety Tips (video)"
    url="https://youtu.be/eDDvWMyOPO8?si=svFeILuCoVTRbjng" >}}
...
{{< drg/checklist title="Leatherwork Safety Setup" subtitle="Use this before every session" >}}
...
{{< drg/safety-first >}}
Always cut away from your body and keep your other hand out of the blade path. If you would hit your hand when the tool slips, your hands are in the wrong positions.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="Your blade started to slip" >}}
If you feel a cut beginning to wander or the leather starts moving unexpectedly:

- **Stop pushing immediately.** Do not try to save the cut with extra force.
- **Lift the blade away from the project.** Reset your hands.
- **Check the leather and the surface underneath.** A shifting scrap or soft backing may be the real problem.
- **Make the next pass lighter.** Two or three controlled cuts are better than one aggressive cut.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    title="First Aid (PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Leatherwork/Leatherwork_First%20Aid.pdf"
    description="Official Scouting guidance for the specific first-aid situations named in this requirement." >}}

{{< drg/external-link
    title="First Aid for Minor Cuts (website)"
    url="https://www.aad.org/public/everyday-care/injured-skin/burns/treat-minor-cuts"
    description="A quick step-by-step guide for cleaning, protecting, and monitoring minor cuts." >}}
...
{{< drg/external-link
    title="First Aid for Puncture Wounds (website)"
    url="https://www.mayoclinic.org/first-aid/first-aid-puncture-wounds/basics/art-20056665"
    description="Explains how puncture wounds differ from surface cuts and when medical care is needed." >}}
...
{{< drg/safety-first >}}
If a chemical gets in the eye, begin flushing with clean water right away. Do not wait to see whether it starts feeling better first.
{{< /drg/safety-first >}}

{{< drg/video
    title="Be Prepared (video)"
    url="https://youtu.be/p5wSqJO-bIc?si=_-SM0CzDAFnIRrEm" >}}

{{< drg/tip >}}
Keep a basic first-aid kit at the same bench where you work. If the bandages are in another room, you are more likely to drip blood, touch tools, or delay care.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You now know how to prevent common leatherwork injuries and respond to them if they happen."
    teaser="Learn where leather comes from, the major kinds of hides, and how different leathers are used."
