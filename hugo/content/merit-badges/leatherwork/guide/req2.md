...
- **what kinds of hides are used**
- **five types of leather**
- **which projects match each type best**

Once you understand those differences, your project choices in [Req 3](/merit-badges/leatherwork/guide/req3/) will make much more sense.
...
{{< drg/video
    title="How is Leather Made? (video)"
    url="https://youtu.be/oNTWz7bwolc?si=MTkSYtqnDxvJIgC8" >}}

{{< drg/did-you-know >}}
Leather is made mostly from collagen, the same structural protein that helps give skin, tendons, and other connective tissue their strength.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/hide-sections-firmness-guide.avif" alt="Diagram of a full hide showing back, shoulder, side, and belly sections with simple labels for firmer and stretchier areas" >}}

{{< drg/video
    title="Picking the Best Part of the Leather Hide (video)"
    url="https://youtu.be/UifaYowyj44?si=mz4_Fm3dsS2IdwDf" >}}

{{< drg/external-link
    title="Useful Leather Crafting Charts (website)"
    url="https://leatherado.com/pages/useful-leather-craft-charts"
    description="Charts that help you compare thickness, hide sections, and common project choices." >}}

{{< drg/tip >}}
If a project must keep its shape, avoid very stretchy belly cuts. Firmer parts of the hide are easier for beginners to cut and assemble accurately.
{{< /drg/tip >}}
...
{{< drg/video
    title="Leather Is Made From Which Animal (video)"
    url="https://youtu.be/fCrCwKpBXe4?si=ZosX3COH795k644n" >}}
...
| Leather type | Best uses | Why it fits |
|---|---|---|
| Vegetable-tanned | belts, coasters, sheaths, carved patches, stamped projects | holds shape, takes tooling well, accepts dye |
| Chrome-tanned | bags, soft pouches, garments, linings | flexible, comfortable, often already finished |
| Full-grain | heavy-duty gear, long-lasting everyday goods | strong surface, durable, ages well |
| Top-grain | wallets, handbags, cleaner-looking finished goods | smooth appearance, reliable consistency |
| Suede | lining, trim, soft accessories | soft texture, flexible feel |
...
{{< drg/video
    title="What Leather Should I Use for Tooling? (video)"
    url="https://youtu.be/NNppGlzskQU?si=a3Kf5tP4MR28dcjf" >}}

{{< drg/video
    title="Choosing the Correct Leather for your Project (video)"
    url="https://youtu.be/i9chSW724QI?si=m5PgNOUbjl-obxra" >}}

{{< drg/checklist title="How to choose the right leather" subtitle="Ask these questions before you start a project" >}}
...
{{< drg/next-page
    text="You now know where leather comes from and how different types behave."
    teaser="Compare the eight project-building skills and choose the five that best fit your article."
