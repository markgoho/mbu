---
title: "Patterns and Transfer"
layout: guide
group_title: "3. Building Your Project"
req_number: "3a"
prev: "/merit-badges/leatherwork/guide/req3/"
prev_title: "Choosing Your Five Skills"
next: "/merit-badges/leatherwork/guide/req3b/"
next_title: "Clean Cutting"
---
...
{{< drg/checklist title="Before you transfer a pattern" subtitle="Set up the project so your marks end up where you want them" >}}
...
{{< drg/video
    title="Transferring Patterns (video)"
    url="https://youtu.be/zkA_TImwL7k?si=uy8jlrqb-_nJdl3v" >}}

{{< drg/video
    title="\"Tap offs\" or Mirrored Image Transfers (video)"
    url="https://youtu.be/dIZWhRV43WE?si=hEtWo21YxszT8uoa" >}}
...
{{< drg/image src="images/pattern-transfer-layout-sequence.avif" alt="Four-panel step sequence showing paper pattern aligned on leather, centerline marked, tracing with stylus, and final transferred outline ready to cut" >}}

{{< drg/tip >}}
Tape or hold the pattern so it cannot slide midway through tracing. A tiny shift at the start becomes a very visible mistake at the end.
{{< /drg/tip >}}
...
In [Req 3b](/merit-badges/leatherwork/guide/req3b/), you will see why clean transfer lines matter so much — they are the roadmap for accurate cutting.

{{< drg/next-page
    text="You have set up your project with a pattern that is placed and marked accurately."
    teaser="Next, learn how to cut leather cleanly and safely without drifting off the line."
