...
{{< drg/did-you-know >}}
The average American lives within 10 minutes of a fire station. Fire departments strategically locate their stations so they can reach any address in their coverage area within 4–8 minutes — because in a fire, every second counts.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Google Maps lets you right-click any location and select "Measure distance" to draw a straight line or route between two points. This makes recording distances fast and accurate.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
In any emergency, call 911 first. But knowing the physical location of your nearest fire station, police station, and hospital can be critical if phone service is unavailable or if you need to direct someone to the right place.
{{< /drg/safety-first >}}
...
{{< drg/download
    ...
    url="/merit-badges/citizenship-in-the-community/guide/community-map-worksheet/"
    type="printable" >}}
...
{{< drg/external-link
    ...
    url="https://support.google.com/maps/answer/1628031"
    description="Learn how to measure distances between points on Google Maps." >}}

---

{{< drg/next-page
    text="You have mapped the key services and landmarks in your community."
    teaser="Now learn how your local government is organized — who is in charge and how they got there."
