...
{{< drg/did-you-know >}}
More than half of U.S. cities with populations over 25,000 use the council-manager form of government. The idea was popularized in the early 1900s as a way to run cities more like efficient businesses and reduce corruption.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Use a simple organizational chart (org chart) format. Put the top leader at the top and draw lines down to the positions that report to them. Use color coding or labels to show which positions are elected (try blue) and which are appointed (try green).
{{< /drg/tip >}}
...
{{< drg/checklist title="Chart Checklist" subtitle="Make sure your chart includes these elements" >}}
...
{{< drg/external-link
    title="National League of Cities — Forms of Municipal Government"
...
{{< drg/next-page
    text="You have charted how your local government is organized."
    teaser="Now it is time to see democracy in action — by attending a real government meeting."
