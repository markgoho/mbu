...
{{< drg/checklist title="Interview Prep Checklist" subtitle="Be ready before you make contact" >}}
...
{{< drg/external-link
    title="iCivics — Community Action Project"
...
{{< drg/next-page
    text="You have investigated a real issue and talked to the people working on it."
    teaser="Now explore how films and media can show the power of community action."
