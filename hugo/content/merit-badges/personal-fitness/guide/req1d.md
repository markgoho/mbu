...
req_number: "1d"
prev: "/merit-badges/personal-fitness/guide/req1c/"
prev_title: "Req 1c — Spiritual Fitness"
next: "/merit-badges/personal-fitness/guide/req1e/"
next_title: "Req 1e — Scout Oath and Law"
---
...
{{< drg/tip >}}
When you talk to your counselor about why all four areas matter, use real examples. Think about a time when being physically tired made it hard to think clearly, or a time when feeling stressed affected your body. Personal examples are more powerful than textbook answers.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Feeling Overwhelmed?" >}}
If trying to improve in all four areas at once feels like too much, start with one. Pick the area where you feel weakest and focus there for a few weeks. Small improvements in one area naturally boost the others. You do not have to do everything at once — you just have to start.
{{< /drg/be-prepared >}}

### Explore More

{{< drg/video
    title="Being Fit Overall"
    url="https://kcts9.pbslearningmedia.org/resource/wellness-video/mind-frame/?student=true&focus=true" >}}

{{< drg/external-link
    title="American Heart Association — Healthy Living"
    url="https://www.heart.org/en/healthy-living/fitness"
    description="Learn how physical fitness connects to heart health and overall well-being." >}}

{{< drg/next-page
    text="You understand why all four dimensions of fitness matter"
    teaser="now connect personal fitness to the Scout Oath and Scout Law."
