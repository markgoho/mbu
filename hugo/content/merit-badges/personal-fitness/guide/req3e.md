...
{{< drg/did-you-know >}}
BMI was invented in the 1830s by a Belgian mathematician. It was designed as a population-level statistic, not a diagnostic tool for individuals. That is why healthcare providers use it as a starting point, not a final answer, when assessing your health.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Healthy Weight Habits" subtitle="Daily choices that add up over time" >}}
- Stay active: Regular physical activity — at least 60 minutes a day — is the most effective way to maintain a healthy weight.
- Eat balanced meals: Follow the MyPlate guidelines you learned about in the [nutrition requirement](/merit-badges/personal-fitness/guide/req3d/).
...
- Get enough sleep: Sleep deprivation increases hunger hormones and cravings for high-calorie foods. More on this in the [next requirement](/merit-badges/personal-fitness/guide/req3f/).
{{< /drg/checklist >}}

{{< drg/tip >}}
Focus on what you **do** rather than what you weigh. If you are exercising regularly, eating well, sleeping enough, and feeling good, your weight will likely take care of itself. The scale is one data point — it is not the whole story.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
If you find yourself obsessing over your weight, skipping meals, exercising to "punish" yourself for eating, or feeling intense shame about your body, please talk to a trusted adult. These can be signs of an eating disorder, which is a serious but treatable medical condition. You deserve help, and there is no shame in asking for it.
{{< /drg/safety-first >}}

### Explore More

{{< drg/external-link
    title="CDC — BMI Calculator for Children and Teens"
    url="https://www.cdc.gov/bmi/child-teen-calculator/index.html"
    description="Calculate your BMI-for-age percentile using the CDC's official tool." >}}

{{< drg/video
    title="Your Body Composition"
    url="https://youtu.be/Yk3UkkJk474?si=MIO8KBdqsszMGPRo" >}}

{{< drg/next-page
    text="You understand what a healthy weight means for you"
    teaser="now learn why sleep is one of the most underrated parts of fitness."
