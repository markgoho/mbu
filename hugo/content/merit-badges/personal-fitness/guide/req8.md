...
{{< drg/did-you-know >}}
The average American adult will spend approximately $155,000 on healthcare over their lifetime. Regular physical activity can reduce that number significantly by preventing chronic diseases. Investing in fitness now — through a hobby you love — is one of the smartest financial decisions you can make.
{{< /drg/did-you-know >}}

{{< drg/be-prepared title="Finding Your Activity" >}}
Not sure which activity is right for you? Try this approach:

- **Sample widely.** Take a free trial class at a climbing gym, attend a community yoga session, or join a friend for a bike ride. You do not have to commit until you find what clicks.
- **Consider cost.** Some activities (running, bodyweight exercises) cost almost nothing. Others (martial arts, climbing) have ongoing fees. Factor this into your research.
- **Look for community.** The activities that stick are the ones that connect you with other people. A running club, a climbing crew, or a martial arts dojo gives you built-in accountability and friendships.
- **Think long-term.** Choose something you can imagine doing at age 30, 50, or 70. Activities like swimming, cycling, yoga, and hiking are popular with people of all ages because they are sustainable for life.
{{< /drg/be-prepared >}}

### Explore More

{{< drg/video
    title="Careers Related to Personal Fitness"
    url="https://youtu.be/9a9XU7D0DIo?si=BTdpODHe1FhUa-Sq" >}}

{{< drg/video
    title="Seated Wheelchair Workout"
    url="https://youtu.be/d6x-A0CmI-I?si=BlRXUSzEPxx22VYv" >}}

{{< drg/video
    title="Seated Cardio Workout"
    url="https://youtu.be/hHiSWTU9xNk?si=6MgZZKv2n3RN-fVl" >}}

{{< drg/external-link
    title="Bureau of Labor Statistics — Fitness Trainers and Instructors"
    url="https://www.bls.gov/ooh/personal-care-and-service/fitness-trainers-and-instructors.htm"
    description="Official job outlook, salary data, and career information for fitness professionals from the U.S. Bureau of Labor Statistics." >}}

{{< drg/external-link
    title="Move United — Adaptive Sports"
    url="https://www.moveunitedsport.org/"
    description="A national organization that provides adaptive sports and recreation opportunities for people with disabilities." >}}

{{< drg/next-page
    text="You have explored how fitness fits into your future"
    teaser="discover additional resources and opportunities to take your fitness even further."
    url="/merit-badges/personal-fitness/guide/extended-learning/" >}}
