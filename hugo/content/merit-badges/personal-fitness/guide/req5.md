...
Take each test you chose in [Requirement 4](/merit-badges/personal-fitness/guide/req4/) and record your results carefully. These numbers are your baseline — the "before" picture that you will compare against during and after your program.

{{< drg/checklist title="Pre-Assessment Day Checklist" subtitle="Set yourself up for accurate results" >}}
...
{{< drg/download
    title="3-Day Food and Drink Log (fillable PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Personal%20Fitness/3-Day%20Food%20and%20Drink%20Log%20%28fillable%29.pdf" >}}
...
{{< drg/checklist title="Sample Nutrition Goals" subtitle="Choose goals that address your specific patterns" >}}
...
{{< drg/tip >}}
Write your two goals down and post them somewhere you will see them every day — on your bathroom mirror, in your locker, or as a note on your phone. Goals that are visible get accomplished more often than goals that are forgotten in a notebook.
{{< /drg/tip >}}

### Explore More

{{< drg/video
    title="Food Groups and MyPlate"
    url="https://youtu.be/L7QOUiQCb5E?si=aSUG980t0c5bQt0p" >}}

{{< drg/external-link
    title="1-Mile Walk/Run — Compare Results (PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Personal%20Fitness/1-Mile%20Walk-Run%20-%20Compare%20Results.pdf"
    description="Compare your mile time against age-appropriate benchmarks." >}}

{{< drg/external-link
    title="Muscular Strength — Compare Results (PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Personal%20Fitness/Muscular%20Strength%20-%20Compare%20Results.pdf"
    description="Compare your strength test results against age-appropriate benchmarks." >}}

{{< drg/next-page
    text="You have completed your baseline testing and set your goals"
    teaser="now it is time to design your 12-week fitness and nutrition program."
