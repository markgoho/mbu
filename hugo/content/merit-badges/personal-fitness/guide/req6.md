...
Take the two nutrition goals you set in [Requirement 5d](/merit-badges/personal-fitness/guide/req5/) and turn them into a week-by-week plan. Your nutrition plan should be specific enough that you know exactly what to do each week.
...
{{< drg/download
    title="12-Week Physical Fitness Program (fillable PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Personal%20Fitness/physical_fitness_12week_program%20%28fillable%29.pdf" >}}

### Explore More

{{< drg/video
    title="Sample Full Workout"
    url="https://youtu.be/WpIFlh5whcs?si=khfLv9X7TNHJ3kqF" >}}

{{< drg/video
    title="Sample Short Workout — Core Strength"
    url="https://youtu.be/jYfda_ccTjc?si=iATnjRp8ZHz6uy6a" >}}

{{< drg/video
    title="Sample Short Workout — Variety"
    url="https://youtu.be/bhsu24pEgVY?si=_4LBRA_N3sWjx777" >}}

{{< drg/external-link
    title="The MyPlate Quiz"
    url="https://www.myplate.gov/form/myplate-quiz"
    description="Take the MyPlate quiz to see how your current diet compares to the recommended guidelines." >}}

{{< drg/next-page
    text="Your 12-week program is designed and ready"
    teaser="now it is time to execute the plan, track your progress, and see real results."
