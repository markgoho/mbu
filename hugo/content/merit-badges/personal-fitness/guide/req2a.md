...
{{< drg/did-you-know >}}
Scouting America requires a current Annual Health and Medical Record (AHMR) for participation in many Scouting events. The form has three parts, and Part C — which requires a physician's signature — is needed for events lasting more than 72 hours, like summer camp and high-adventure trips.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
If you have any chronic condition — asthma, diabetes, a heart condition, a recent injury — make sure your healthcare provider knows about your fitness plan before you begin. They can help you exercise safely and effectively, and some conditions require specific precautions during physical activity.
{{< /drg/safety-first >}}
...
{{< drg/external-link
    ...
    description="Information about the Annual Health and Medical Record required for Scouting events, including the forms and instructions." >}}

{{< drg/external-link
    title="KidsHealth — Going to the Doctor"
    url="https://kidshealth.org/en/teens/checkups.html"
    description="A teen-friendly guide to what happens during a physical exam and why it matters." >}}

{{< drg/next-page
    text="Now that you understand the value of a physical exam"
    teaser="learn why dental health is an essential part of staying well."
