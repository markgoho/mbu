...
{{< drg/tip >}}
Do not sprint the first quarter-mile and then walk the rest. Pace yourself. A steady, sustainable pace from start to finish will produce a better time than starting fast and fading. Your counselor can help you figure out a target pace based on your current fitness level.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Flexibility varies naturally from person to person and is influenced by your body structure, activity level, and even the temperature of your muscles. You will get a more accurate reading if you do your flexibility test after a light warm-up, since cold muscles are less flexible.
{{< /drg/did-you-know >}}
...
{{< drg/download
    title="Measures of Physical Fitness (fillable PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Personal%20Fitness/measures_of_physical_fitness%20%28fillable%29.pdf" >}}

### Explore More

{{< drg/video title="Sit-Up" url="https://youtu.be/pCX65Mtc_Kk" >}}

{{< drg/video title="Plank" url="https://youtu.be/yeKv5oX_6GY" >}}

{{< drg/video title="Push-Up" url="https://youtu.be/YopP5mCAMSI" >}}

{{< drg/video title="Pull-Up" url="https://youtu.be/mohJShUxbdI" >}}

{{< drg/external-link
    title="Back-Saver Sit-and-Reach Test"
    url="https://youtu.be/T2LzgbHXbUI?si=UZl1SrQ5DFTGpCGE"
    description="Video demonstrating proper technique for the back-saver sit-and-reach flexibility test." >}}

{{< drg/external-link
    title="Back Scratch Test"
    url="https://youtu.be/EKiTmkgEFH4"
    description="Video demonstrating proper technique for the back scratch shoulder flexibility test." >}}

{{< drg/next-page
    text="You have chosen your fitness assessments"
    teaser="now it is time to take your baseline measurements before starting your 12-week program."
