...
You learned about these in [Requirement 1a](/merit-badges/personal-fitness/guide/req1a/), but now it is time to apply them to your own life.
...
{{< drg/tip >}}
Before talking to your counselor, write down everything you do in a typical week that involves physical activity. Include organized sports, gym class, walking to school, playing outside, and household chores. You might be doing more than you think — or you might spot some gaps.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
A study published by the American Heart Association found that teenagers who are physically active have healthier arteries — more flexible and less likely to develop the stiff, clogged arteries that cause heart attacks decades later. The exercise you do now is literally protecting your future heart.
{{< /drg/did-you-know >}}

{{< drg/safety-first >}}
If you have been mostly inactive and want to start exercising, begin gradually. Jumping straight into intense workouts can cause injuries and make you feel discouraged. Start with 15–20 minutes of moderate activity and increase by about 10% per week. Your body needs time to adapt.
{{< /drg/safety-first >}}
...
{{< drg/video
    ...
    url="https://youtu.be/dwMMn2FdBFQ?si=vaYCckwx-xqsUky-" >}}

{{< drg/external-link
    title="CDC — How Much Physical Activity Do Youth Need?"
    url="https://www.cdc.gov/physical-activity-basics/guidelines/children-and-adolescents.html"
    description="Official guidelines on how much exercise young people need each day, broken down by type." >}}

{{< drg/next-page
    text="Now that you have assessed your exercise habits"
    teaser="let's talk about the harmful substances you should consciously avoid."
