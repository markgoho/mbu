...
req_number: "3g"
prev: "/merit-badges/personal-fitness/guide/req3f/"
prev_title: "Req 3f — Sleep"
next: "/merit-badges/personal-fitness/guide/req4/"
next_title: "Req 4 — Fitness Assessments"
---
...
{{< drg/did-you-know >}}
A famous 85-year study by Harvard University — the longest study on happiness ever conducted — found that the single strongest predictor of health and happiness was not money, career success, or fitness. It was the quality of a person's close relationships.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Contributing to Your Home" subtitle="Small actions that make a big difference" >}}
...
{{< drg/be-prepared title="Feeling Disconnected?" >}}
If you are feeling isolated or struggling to connect with friends or family, here are some steps you can take:

- **Reach out first.** Do not wait for others to invite you. Send a text, suggest an activity, or just say hello.
- **Join something.** Scouting, sports, clubs, volunteering, or a part-time job all create natural opportunities for connection.
- **Talk to someone.** If loneliness or sadness is persistent, talk to a parent, counselor, or other trusted adult. They can help.
- **Limit comparison.** Social media often makes other people's lives look perfect. Remember that you are seeing a highlight reel, not reality.
{{< /drg/be-prepared >}}
...
{{< drg/video
    ...
    url="https://youtu.be/d4_rFMo7lCo?si=OkbtRuJzRNoVysV1" >}}

{{< drg/external-link
    title="Child Mind Institute — Healthy Social Development"
    url="https://childmind.org/article/tips-for-socializing-teens/"
    description="Tips and strategies for building healthy social connections as a teenager." >}}

{{< drg/next-page
    text="You have explored all aspects of your fitness knowledge and habits"
    teaser="now it is time to choose the fitness assessments you will use to measure your progress."
