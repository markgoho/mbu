...
{{< drg/checklist title="Before You Plant" subtitle="Set the project up to survive, not just to happen" >}}
...
{{< drg/safety-first >}}
Use the right tools, lift carefully, and protect young plants from mower damage, trampling, or drought after planting. A rushed planting day can lead to poor survival if follow-up care is ignored.
{{< /drg/safety-first >}}

Req 7c is similar in spirit but works at a larger area scale using grasses or legumes instead of woody plants.

{{< drg/next-page
    text="Planting woody species is one way to restore land"
    teaser="Next, learn how seeding grasses or legumes can protect and rebuild a larger disturbed area."
