...
{{< drg/video
    title="Water Pollution and How We Can Reduce It (video)"
    url="https://youtu.be/4Q8dL8RtQM0" >}}

{{< drg/video
    title="H2-Oh No! Water Pollution 101 (video)"
    url="https://www.youtube.com/shorts/mgtpMLsAds0" >}}
...
- **sediment from erosion** — clouds water, covers stream habitat, and often carries attached pollutants
- **fertilizer and manure** — add excess nutrients that can trigger algae blooms
- **sewage and failing septic systems** — introduce disease-causing organisms and organic waste
- **industrial discharges** — may add chemicals, metals, or heat
- **oil and fuel leaks** — harm aquatic life and contaminate shorelines
- **stormwater runoff from streets and parking lots** — carries trash, salt, metals, and other pollutants
...
{{< drg/checklist title="Source → Effect" subtitle="Use this pattern when you explain pollution" >}}
...
{{< drg/video
    title="How Does Wastewater Treatment Work? (video)"
    url="https://youtu.be/cUFKay8VPqo" >}}

{{< drg/did-you-know >}}
Dirty-looking water is not always the worst water, and clear water is not always safe. Some serious water-quality problems, including high BOD or dissolved pollutants, may not be obvious just by looking.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/wastewater-treatment-flow.avif" alt="Simple flow diagram of complete wastewater treatment showing screening, primary settling, secondary biological treatment, clarification, disinfection, and effluent discharge" >}}

{{< drg/safety-first >}}
Never enter treatment structures, drainage channels, or stormwater facilities on your own. Observe only from public access points or as part of an approved tour with proper supervision.
{{< /drg/safety-first >}}

[Req 7a6](/merit-badges/soil-and-water-conservation/guide/req7a6/) gives you a chance to see many of these treatment ideas in action during a site visit.

{{< drg/next-page
    text="You have gone from pollution sources to treatment systems"
    teaser="Next, choose two hands-on conservation projects and plan the ones that fit your interests and local opportunities."
