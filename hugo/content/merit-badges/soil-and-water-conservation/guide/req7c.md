...
{{< drg/checklist title="Plan the Plot Before You Seed" subtitle="A little planning makes a big difference" >}}
...
{{< drg/tip >}}
One-fifth acre is larger than many Scouts expect. Mark the area first so you understand the size, then talk with your counselor or site manager about whether your seed mix and labor plan make sense for that scale.
{{< /drg/tip >}}

The next option trades field work for map interpretation and soil analysis.

{{< drg/next-page
    text="You have looked at restoring land with living cover"
    teaser="Next, use a soil survey report to read mapped soils and trace an area with different soil types."
