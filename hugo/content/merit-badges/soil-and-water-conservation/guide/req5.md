...
- **runoff** moving downhill over land
- **infiltration or percolation** into soil
- **groundwater flow** underground
- **transpiration** from plants back to the air

{{< drg/video
    title="The Water (Hydrologic) Cycle (video)"
    url="https://youtu.be/FzYjPpxP-Cw" >}}

{{< drg/image src="images/hydrologic-cycle-labeled.avif" alt="Labeled hydrologic cycle showing evaporation, condensation, precipitation, transpiration, runoff, infiltration, and groundwater flow" >}}
...
{{< drg/video
    title="Capillary Rise (video)"
    url="https://youtu.be/5waNTa2b-yg" >}}

{{< drg/video
    title="Soil Capillary Action Demonstration (video)"
    url="https://youtu.be/0Hcp2UGkbj4?si=7U9FAlP5XbSnUVha" >}}

{{< drg/video
    title="Soil Percolation Experiment (video)"
    url="https://youtu.be/CBmDlbFOZKU" >}}
...
- more water runs off the surface
- runoff reaches streams faster
- erosion and sediment increase
- flooding risk rises
- stream temperatures can increase if shade is lost

{{< drg/video
    title="How Vegetation Protects Soil (video)"
    url="https://youtu.be/wa9MTy_lSpY" >}}
...
{{< drg/video
    title="Rangeland Management and Water Supply (video)"
    url="https://youtu.be/PQf0gdomgGg?si=MNPoiCVV6Cc3QQlQ" >}}
...
{{< drg/external-link
    title="Reimagining Industrial Water for Sustainable Impact (video)"
    url="https://youtu.be/xeTGV3e1QB8?si=rxKeNygqQnzccQd2"
    description="A useful look at how industry can reduce freshwater demand, reuse water, and improve treatment, even though this video must be opened on YouTube instead of embedded here." >}}

{{< drg/tip >}}
A strong counselor explanation compares two situations: the same land or facility with good management and with poor management. That helps show you understand that conservation depends on practices, not just labels like "farm" or "industry."
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have followed water across land and through soil"
    teaser="Next, learn what pollutes water and how communities try to clean wastewater before it returns to the environment."
