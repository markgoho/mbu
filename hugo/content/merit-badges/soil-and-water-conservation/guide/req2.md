...
{{< drg/video
    title="Soil Basics: Erosion (video)"
    url="https://youtu.be/DRkw5kOZsc8?si=Gq7gY0l0JDMjxhFD" >}}
...
{{< drg/video
    title="Why Soil Conservation is Important to Human Agriculture? (video)"
    url="https://youtu.be/BuEdKEh2buI" >}}

{{< drg/did-you-know >}}
Sediment is one of the most common pollutants in surface water. A stream can look muddy from a storm and still be carrying nutrients, pesticides, and other pollutants attached to those soil particles.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/erosion-types-comparison.avif" alt="Side-by-side comparison of sheet erosion, rill erosion, and gully erosion on a slope" >}}
...
{{< drg/external-link
    title="Soil Erosion: Causes, Impacts, and Sustainable Solutions (website)"
    url="https://ardasclasses.com/blog/soil-erosion-causes-impacts-and-sustainable-solutions/"
    description="Use this to compare real-world examples of erosion and possible fixes before you head out to photograph or sketch your own examples." >}}

{{< drg/tip >}}
Try to photograph one early-stage problem, like sheet or rill erosion, and one more advanced problem, like a gully or badly eroded bank. That shows your counselor you can recognize different stages of damage.
{{< /drg/tip >}}

In [Req 3](/merit-badges/soil-and-water-conservation/guide/req3/), you will switch from spotting problems to explaining solutions.

{{< drg/next-page
    text="You can now recognize erosion when you see it"
    teaser="Next, learn the conservation practices that slow runoff, hold soil in place, and repair damage."
