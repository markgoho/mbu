...
{{< drg/video
    title="What is Soil Conservation (video)"
    url="https://youtu.be/YGu_09HH-Xo" >}}
...
{{< drg/checklist title="A Simple Way to Explain the Effect" subtitle="Use this sentence pattern with any practice you choose" >}}
...
1. the practice you are showing
2. the erosion problem it helps prevent
3. the reason it works
...
{{< drg/external-link
    ...
    description="Browse this for examples of erosion-control methods so you know what to look for before taking your own pictures or making drawings." >}}

{{< drg/tip >}}
If you cannot visit a farm or a large project site, start small. A mulched garden bed, a grassed drainage ditch, or a planted streambank still counts if you can explain how it protects soil and water.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have gone from problem to solution"
    teaser="Next, follow water across the landscape as you learn how watersheds, river basins, and aquifers connect communities."
