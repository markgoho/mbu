...
{{< drg/video
    title="What is a Watershed (video)"
    url="https://youtu.be/gVdq4pWUiQM" >}}

{{< drg/video
    title="Watersheds, Rivers and Floodplains (video)"
    url="https://youtu.be/ButQspZX2yA?si=TgRhRG8uoKpe4oS3" >}}

{{< drg/video
    title="How (and Why) to Find Your Watershed (video)"
    url="https://youtu.be/kqwYulqfC9k" >}}
...
{{< drg/tip >}}
Use two different colored pencils when you trace. One color for the smallest watershed and another for the next larger one makes the nesting pattern much easier to explain to your counselor.
{{< /drg/tip >}}
...
{{< drg/video
    title="River Basins (video)"
    url="https://youtu.be/x7lBi6OaFMo?si=Z2hmQJEjQjmIlQvv" >}}

{{< drg/be-prepared title="Thinking Like Someone Downstream" >}}
When you explain why river basin planning matters, use a chain of cause and effect:

- **Upstream land use changes**: more bare soil, pavement, or pollution.
- **Water carries the result downstream**: more sediment, faster runoff, or poorer water quality.
- **Downstream communities pay the price**: flooding, treatment costs, habitat loss, or unsafe recreation.
{{< /drg/be-prepared >}}
...
{{< drg/video
    title="What is an Aquifer (video)"
    url="https://youtu.be/g7R0yLX0V9E" >}}

{{< drg/safety-first >}}
Groundwater often looks protected because you cannot see it, but contamination can still reach it through spills, leaking tanks, poorly managed waste, or polluted recharge areas. Once groundwater is contaminated, cleanup can take years.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You can now map where water goes"
    teaser="Next, trace water through the hydrologic cycle and see how land cover changes the way it moves."
