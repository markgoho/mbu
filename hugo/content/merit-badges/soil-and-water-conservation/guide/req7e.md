...
{{< drg/checklist title="Think in Practical Fixes" subtitle="Your solutions should match the scale of the problem" >}}
...
{{< drg/tip >}}
Avoid writing fixes that depend on giant budgets or major construction unless that truly is the only answer. Your counselor will usually be more impressed by a realistic, well-observed solution than by a dramatic but unlikely one.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have practiced spotting local problems and matching them with realistic fixes"
    teaser="Next, design or carry out an approved conservation project of your own."
