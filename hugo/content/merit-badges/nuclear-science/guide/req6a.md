...
{{< drg/video
    title="What Really Happened the First Time We Split a Heavy Atom in Half (video)"
    url="https://youtu.be/O2pyRDQgVjk?si=xYh6mItbfRQoaWqN" >}}

{{< drg/video
    title="What is Critical Mass | Nuclear Chain Reaction| Fission Chain Reaction| Critical Mass Of Uranium (video)"
    url="https://youtu.be/czjAtx8GjjA?si=l0xUwP2x5pJyQB85" >}}

{{< drg/video
    title="Mousetrap Fission (video)"
    url="https://youtu.be/vjqIJW_Qr3c?si=VFFlUgoPcuDMwqWh" >}}

{{< drg/checklist title="The four ideas to explain clearly" subtitle="These are the core teaching points of this requirement" >}}
...
{{< drg/safety-first >}}
Only an adult should set up a mousetrap reactor demonstration. The model itself is not radioactive, but it can snap fingers, launch objects unexpectedly, and become unsafe if people stand too close.
{{< /drg/safety-first >}}

{{< drg/image src="images/fission-chain-reaction-diagram.avif" alt="Step-by-step diagram showing neutron hitting uranium nucleus, split products, released neutrons, and controlled reactor rods" >}}
...
{{< drg/next-page
    text="From the atom to the power grid"
    teaser="See how reactors, turbines, and the electrical grid fit together in a working nuclear energy system."
