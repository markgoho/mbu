...
Explain the following terms: atom, nucleus, proton, neutron, electron, quark, isotope; alpha particle, beta particle, gamma ray, X-ray; ionization, radioactivity, radioisotope, and stability.
{{< /drg/requirement >}}
...
{{< drg/tip >}}
If you are explaining these terms to your counselor, build from the inside out: nucleus first, then electrons, then isotopes, then radiation types, then what makes an atom stable or unstable.
{{< /drg/tip >}}

{{< drg/external-link
    title="Glossary of Nuclear Science Terms (website)"
    url="https://nplab.webspace.durham.ac.uk/glossary/"
    description="A plain-language glossary you can use to check your definitions and make sure you are using each term correctly." >}}

{{< drg/video
    title="What Are Isotopes? (video)"
    url="https://youtu.be/faB9Gb7bl9I?si=Et7Yi1cp8zLvyppP" >}}

{{< drg/video
    title="Quarks Explained (video)"
    url="https://youtu.be/LraNu_78sCw?si=o4zrlNUwhUT69eB6" >}}
...
{{< drg/checklist title="What to label on each isotope model" subtitle="Make the differences easy to see" >}}
...
{{< drg/did-you-know >}}
Two atoms of carbon can behave almost identically in chemistry while having different numbers of neutrons. That small change is enough to create different isotopes with different nuclear behavior.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Make a Model of an Isotope (PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Nuclear%20Science/Isotope%20Model%20Activity.pdf"
    description="A step-by-step activity sheet that can help you organize your isotope models and notation." >}}

{{< drg/external-link
    title="Interactive Isotopes (website)"
    url="https://isotopes.ans.org/"
    description="Lets you explore real isotope data and compare proton, neutron, and mass-number patterns before you build your model." >}}

{{< drg/image src="images/isotope-model-example.avif" alt="Three side-by-side isotope models of the same element with protons, neutrons, electrons, and isotope notation labeled" >}}
...
{{< drg/next-page
    text="Tiny particles need big tools"
    teaser="See how particle accelerators speed up matter and help scientists study nuclei and nucleons."
    url="/merit-badges/nuclear-science/guide/req3a/" >}}
