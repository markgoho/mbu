...
{{< drg/checklist title="Steps to mention" subtitle="A clear answer should include these parts" >}}
- **Where the test is placed**: usually in a livable low level of the building, following kit directions.
...
{{< drg/video
    title="What is Radon, Anyway? (video)"
    url="https://youtu.be/24aoot_CwoM?si=IYOyLpbVk2z2fb4R" >}}

{{< drg/video
    title="How Dangerous Is Radon to Your Health? (video)"
    url="https://youtu.be/SlRVdKdTBFE?si=pJrBWumWDON3uPcG" >}}

{{< drg/tip >}}
When you discuss test results with your counselor, explain both **what the number says** and **how confident you are that it reflects long-term conditions**. That is why long-term testing matters.
{{< /drg/tip >}}

If you want to see how radiation safety is designed into a workplace instead of a home, the X-ray room option is next.

{{< drg/next-page
    text="Radiation safety also depends on room design"
    teaser="Visit a place that uses X-rays and learn how layout and procedure protect the operator."
