...
{{< drg/video
    title="How Radioactive Decay Works | Decay Chains (video)"
    url="https://youtu.be/fo1tgibNLss?si=K2DrEfEaGW5MSdOR" >}}

{{< drg/video
    title="Skittles Half Life Lab | Radioactive Isotope Decay | Half Life Graph (video)"
    url="https://youtu.be/mCSXJNVdK0Y?si=A3UPqOjowKtkSmxk" >}}

## How to discuss your experiment

Your counselor will likely want more than a graph. Be ready to explain the pattern.

{{< drg/checklist title="What your discussion should include" subtitle="Explain the idea, not just the procedure" >}}
...
{{< drg/did-you-know >}}
Some radioactive materials do not decay straight to a stable ending in one step. They move through a chain of different daughter products, each with its own properties and half-life.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="Understanding radiation leads naturally to protection"
    teaser="Choose a radiation safety investigation focused on shielding, radon, or X-ray room practice."
