...
{{< drg/external-link
    title="How Materials Shield Radiation (PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Nuclear%20Science/shutterstock_1169023357.pdf"
    description="A visual guide that helps you compare how different materials reduce radiation in different situations." >}}

{{< drg/video
    title="Time, Distance and Shielding (video)"
    url="https://youtu.be/bNSKIbRNy3c?si=3WqSseNb_EbOeZAx" >}}

{{< drg/video
    title="Measuring Radiation (video)"
    url="https://youtu.be/GdZD_hJBdOE?si=p4mOulsJpBxDWH5j" >}}

{{< drg/video
    title="Using a Survey Meter: CPM vs Distance (video)"
    url="https://youtu.be/0-Yaeh3dOZk?si=Z1MokzEOznMdvlZD" >}}

{{< drg/checklist title="Three ideas to say out loud" subtitle="These are the real lesson of the activity" >}}
...
{{< drg/safety-first >}}
Only a qualified adult should provide the source, meter, and setup for this activity. Never point unknown materials at a detector just to "see what happens," and never handle sources unless you have direct instruction to do so.
{{< /drg/safety-first >}}

If you want to explore a radiation issue that shows up in ordinary buildings, the radon option is next.

{{< drg/next-page
    text="Safety also matters at home"
    teaser="Learn how radon enters buildings, how homes are tested, and what the results mean."
