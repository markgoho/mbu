...
List three particle accelerators and describe several experiments conducted and their associated basic science and practical applications.
{{< /drg/requirement >}}
...
{{< drg/checklist title="Your comparison notes" subtitle="Collect these details for each machine" >}}
- **Name and location**
...
{{< drg/did-you-know >}}
Technology built for particle physics has influenced fields far outside nuclear science, including medical imaging, data analysis, and even the tools scientists use to share huge amounts of information.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="From giant machines back to elegant experiments"
    teaser="Choose two classic activities that show how scientists first detected and modeled radiation."
