...
{{< drg/checklist title="What an accelerator must do" subtitle="Four jobs every particle accelerator handles" >}}
- **Create particles** such as electrons, protons, or ions.
...
{{< drg/did-you-know >}}
Some accelerators are small enough to fit in hospitals, where they help produce isotopes used in medical imaging. Others are so large they stretch for miles and involve scientists from many countries.
{{< /drg/did-you-know >}}
...
{{< drg/video
    title="Particle Accelerators: What Are They, How Do They Work and Why Are They Important To Us? (video)"
    url="https://youtu.be/vIeRLeQq7V4?si=wf3TBAQxCGd1nYA5" >}}

{{< drg/tip >}}
If you want your explanation to sound clear, say what each part does in order: source, acceleration, steering, collision or target, and detection. That gives your answer a natural flow.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You know the machine; now choose your path"
    teaser="Decide whether to visit a lab or compare major particle accelerators and their experiments."
