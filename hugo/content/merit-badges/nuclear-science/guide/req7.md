...
{{< drg/video
    title="Radiation Technologies in Daily Life (video)"
    url="https://youtu.be/ePiNdzWjoWM?si=-VppE0yfL7AjUIN_" >}}

{{< drg/video
    title="Ways Nuclear Science Helps Cancer Patients (video)"
    url="https://youtu.be/zEihqK-jhBM?si=uLt8bBAD2BtJPBKJ" >}}

{{< drg/video
    title="Ways Nuclear Techniques Combat Malnutrition (video)"
    url="https://youtu.be/Wya79Ly8ec4?si=tCRoh8i2hF04R_F3" >}}

{{< drg/video
    title="Ways Nuclear Science Helps Ocean Health (video)"
    url="https://youtu.be/WYxo_iuzGYk?si=62AsgY7kDBUzLiZd" >}}

{{< drg/checklist title="How to answer this requirement well" subtitle="Use the same pattern for each application" >}}
...
{{< drg/did-you-know >}}
Some deep-space probes keep working for decades because radioactive decay provides a steady power source far from the sun, where solar panels would be much less effective.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="Now turn applications into career paths"
    teaser="Research one nuclear science career and learn what education, duties, and opportunities come with it."
