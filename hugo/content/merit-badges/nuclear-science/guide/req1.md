...
{{< drg/did-you-know >}}
Visible light from a flashlight and gamma rays from radioactive material are both part of the electromagnetic family. The big difference is energy, not whether one is "real radiation" and the other is not.
{{< /drg/did-you-know >}}

{{< drg/video
    title="Radiation & You (video)"
    url="https://youtu.be/FrVUJ2c_Rwc?si=3e61M3Jbgg9w3ToV" >}}

{{< drg/video
    title="IDTIMWYTIM: Radiation (video)"
    url="https://youtu.be/uJ3ea9fa6CA?si=lpSg7dn3koa5wAOV" >}}
...
{{< drg/checklist title="Your ALARA game plan" subtitle="Use this before any activity involving a source or detector" >}}
...
{{< drg/safety-first >}}
ALARA is about control, not luck. Do not touch sources, shielding, or x-ray equipment unless your counselor or another qualified adult directs you to do so. If you are unsure where to stand or what to handle, stop and ask before continuing.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="The ALARA Principle (website)"
    url="https://www.cdc.gov/radiation-health/safety/alara.html"
    description="A clear overview of why time, distance, and shielding work together to reduce dose." >}}
...
{{< drg/tip >}}
If your counselor asks where the symbol belongs, answer in terms of **real hazard areas and equipment**, not "anything related to nuclear science." The symbol is for protection, not style.
{{< /drg/tip >}}

{{< drg/video
    title="Radiation Hazard Symbol (video)"
    url="https://youtu.be/Nss1nl56fPo?si=gjiyC4gVAGL9CMsk" >}}

{{< drg/external-link
    title="How Are Universal Ionizing Radiation Symbols Used Around the World? (website)"
    url="https://www.iaea.org/newscenter/news/how-are-universal-ionizing-radiation-symbols-used-around-the-world/"
    description="Shows how warning symbols help communicate danger clearly across countries and languages." >}}
...
{{< drg/did-you-know >}}
Your own body is naturally radioactive because it contains potassium, including a tiny fraction of potassium-40. That does not mean your body is dangerous. It means radioactivity is part of the natural world.
{{< /drg/did-you-know >}}

{{< drg/video
    title="Five Radioactive Products We Use Every Day (video)"
    url="https://youtu.be/-9gD6FMivTQ?si=O-BCuqRKLgTMGZpg" >}}

{{< drg/video
    title="Your Grocery Store is Radioactive (and So Is Everything Else) (video)"
    url="https://youtu.be/FZtR3UEEkXA?si=jC5BJJVPgtDS4nK3" >}}

{{< drg/video
    title="The Mystery of High-Energy Cosmic Rays (video)"
    url="https://youtu.be/_bKbMARsE-4?si=ba7MFiT_UCPs9WZj" >}}
...
{{< drg/be-prepared title="How to explain your dose comparison" >}}
Before you meet with your counselor, write down three things:

- **Your estimated annual dose** and the unit used
- **The comparison value** for a nuclear plant worker or occupational setting
- **What the comparison actually means**: similar, lower, or higher, and why that does not automatically tell the whole safety story
{{< /drg/be-prepared >}}

{{< drg/video
    title="What Do Radiation Contamination and Exposure Mean? (video)"
    url="https://youtu.be/Ry2YpGjnakg?si=zaj2augqvJll6mwb" >}}

{{< drg/video
    title="Biological Effects of Radiation (video)"
    url="https://youtu.be/EuKzI3g5ra4?si=0z8dwKUGPc34S2YD" >}}

{{< drg/external-link
    title="Radiation Dose Calculator (website)"
    url="https://www.ans.org/nuclear/dosechart/"
    description="Helps you estimate common annual radiation sources and compare them with familiar dose benchmarks." >}}
...
{{< drg/next-page
    text="Radiation comes from atoms, so atoms come next"
    teaser="Learn the parts of the atom, what isotopes are, and how scientists model them."
