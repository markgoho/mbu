...
req_number: "2"
prev: "/merit-badges/electricity/guide/req1/"
prev_title: "Req 1 — Electrical Emergencies"
next: "/merit-badges/electricity/guide/req3/"
next_title: "Req 3 — Build an Electromagnet"
---
...
{{< drg/checklist title="Common home electrical hazards" subtitle="Use these ideas alongside your counselor-approved checklist" >}}
...
{{< drg/safety-first >}}
Do not remove outlet covers, open panels, or test wiring by taking anything apart. This requirement is an inspection and discussion exercise, not a repair project.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Counselors like clear observations. Instead of saying "the kitchen seemed unsafe," say "I found one power strip with a toaster oven and microwave on it, and an extension cord under a rug in the den." Specific details show you did a real inspection.
{{< /drg/tip >}}
...
This is also a great moment to connect back to [Req 1 — Electrical Emergencies](/merit-badges/electricity/guide/req1/). The best emergency response is preventing the emergency in the first place.

{{< drg/external-link
    title="Electrical Safety Foundation International — Home Electrical Safety"
    url="https://www.esfi.org/home-electrical-safety/"
    description="Room-by-room safety guidance, hazard explanations, and practical home electrical safety tips." >}}

{{< drg/next-page
    text="You have learned how to inspect a home for real-world electrical hazards and discuss what you find."
    teaser="Now build a simple electromagnet and see electricity and magnetism work together."
