...
{{< drg/image src="images/battery-bell-circuit-diagram.avif" alt="Labeled battery and electric bell circuit showing the coil, armature, striker, bell, and interrupter cycle" >}}

{{< drg/checklist title="What your drawing should show" subtitle="Focus on function, not artistic detail" >}}
...
{{< drg/tip >}}
If you are drawing this for your counselor, use arrows to show the sequence: close switch, energize coil, pull armature, strike bell, break contact, release armature, restore contact, repeat.
{{< /drg/tip >}}

This requirement also connects directly to [Req 3 — Build an Electromagnet](/merit-badges/electricity/guide/req3/). An electric bell is really an electromagnet project that has been turned into a practical device.

{{< drg/external-link
    title="Britannica — Electric Bell"
    url="https://www.britannica.com/technology/electric-bell"
    description="A concise reference explaining the components and operating cycle of an electric bell." >}}

{{< drg/next-page
    text="You can now explain how a battery-powered bell turns current into repeated motion and sound."
    teaser="Next, learn why circuits overload, why breakers trip, and how home protection devices keep wiring safer."
