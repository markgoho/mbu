...
{{< drg/image src="images/electric-careers-at-work-grid.avif" alt="Side-by-side view of an electrician, a power line worker, and an electrical engineer or electronics technician in their work settings" >}}
...
{{< drg/checklist title="Career research topics" subtitle="Use these points to structure your counselor discussion" >}}
...
- Do you enjoy physical, hands-on work?
- Are you interested in math, design, and problem-solving?
- Would you rather work indoors, outdoors, or both?
- Do you want to build systems, maintain them, or design new ones?

{{< drg/tip >}}
If possible, ask a real person in the field what a normal day looks like. Job titles can sound exciting or confusing, but a working electrician or engineer can tell you what the job is actually like hour by hour.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="U.S. Bureau of Labor Statistics — Electrical and Electronics Occupations"
    url="https://www.bls.gov/ooh/architecture-and-engineering/electrical-and-electronics-engineers.htm"
    description="Career outlook information for electrical and electronics engineering, including education, pay, and job growth." >}}

{{< drg/external-link
    title="U.S. Bureau of Labor Statistics — Electricians"
    url="https://www.bls.gov/ooh/construction-and-extraction/electricians.htm"
    description="Career information for electricians, including training paths, wages, and outlook." >}}

{{< drg/next-page
    text="You have connected this badge to real careers and started thinking about where electrical skills could take you in the future."
    teaser="Finish by exploring a few bigger ideas, experiences, and organizations beyond the badge requirements."
