...
- doors and windows for orientation,
- light fixtures,
- switches,
- wall outlets,
- special outlets if present, and
- the breaker or fuse number for each device or group.

If a switch controls a specific ceiling light or lamp outlet, show that connection with a simple line or note.

{{< drg/image src="images/room-wiring-floor-plan-example.avif" alt="Top-down room wiring diagram showing outlets, switch, ceiling light, and the breaker protecting them" >}}

## How to Build It Step by Step

{{< drg/checklist title="Make your wiring diagram" subtitle="A simple process works best" >}}
...
{{< drg/safety-first >}}
Never remove outlets, switch plates, or light fixtures to figure out what is on a circuit. A room diagram is based on observation and safe testing, not opening electrical equipment.
{{< /drg/safety-first >}}

## Why This Skill Matters

Knowing how a room is wired helps in real life. It makes troubleshooting easier when a light stops working, when a breaker trips, or when you are trying to avoid overloading a circuit. It also reinforces what you learned in [Req 6 — Overloads, Fuses, and Breakers](/merit-badges/electricity/guide/req6/): every load in that room depends on a protective device somewhere upstream.

{{< drg/tip >}}
Use a legend on your drawing. A small circle can mean a ceiling light, a rectangle can mean an outlet, and an "S" can mean a switch. Simple symbols make your work look organized and easier to explain.
{{< /drg/tip >}}

{{< drg/external-link
    title="Family Handyman — Understanding Your Home's Electrical System"
    url="https://www.familyhandyman.com/article/home-electrical-system/"
    description="A beginner-friendly overview of panels, circuits, outlets, and how home wiring is organized." >}}

{{< drg/next-page
    text="You can now map a room's wiring layout and connect what you see to the breaker that protects it."
    teaser="Next, read an electric bill, decode the charges, and look for ways your family can save energy."
