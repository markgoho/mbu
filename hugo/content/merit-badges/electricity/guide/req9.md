...
{{< drg/image src="images/generation-to-home-grid-flow.avif" alt="Diagram showing electricity flowing from generation through transmission, substations, transformers, distribution, and home protection devices" >}}

{{< drg/checklist title="How these terms fit together" subtitle="From power plant to plug" >}}
...
{{< drg/tip >}}
Do not try to memorize these as isolated definitions. Link each one to a real object you have seen: a solar panel on a roof, a breaker-protected bathroom outlet, a phone charger that acts like a rectifier and power supply, or a substation near a roadway.
{{< /drg/tip >}}

{{< drg/external-link
    title="Energy.gov — Electricity Basics"
    url="https://www.energy.gov/articles/how-electricity-delivered-you"
    description="A practical overview of electrical generation, transmission, substations, transformers, and delivery to homes." >}}

{{< drg/next-page
    text="You now have the basic language needed to explain circuits, devices, and power systems clearly."
    teaser="Next, choose two hands-on project options and decide which builds best match your interests and materials."
