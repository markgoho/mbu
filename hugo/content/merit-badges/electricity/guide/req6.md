...
Define what overloading an electric circuit means. Tell what you have done to make sure your home circuits are not overloaded.
{{< /drg/requirement >}}
...
{{< drg/tip >}}
When your counselor asks what you have done at home, be specific. You might say, "We moved the space heater off the same circuit as the gaming setup" or "I stopped plugging multiple kitchen appliances into one strip."
{{< /drg/tip >}}
...
{{< drg/image src="images/overload-wattage-add-up-example.avif" alt="Three kitchen appliances adding up to more current than a 15-amp or 20-amp branch circuit can safely carry" >}}

{{< drg/checklist title="How to check for overload" subtitle="Use labels or the power equation" >}}
...
{{< drg/did-you-know >}}
A short circuit can cause current to rise so fast that a breaker trips almost instantly using magnetic force rather than waiting for heat to build up. That is why some breaker trips feel immediate and dramatic.
{{< /drg/did-you-know >}}

## Requirement 6d

{{< drg/requirement number="6d" >}}
Tell how to find a blown fuse and a tripped circuit breaker in your home. Show how to safely reset the circuit breaker.
{{< /drg/requirement >}}
...
1. Turn off or unplug devices on the affected circuit.
2. Stand to the side of the panel, not directly in front of it.
3. Move the breaker fully to **off** first.
4. Then move it firmly to **on**.
5. Restore loads one at a time.
...
{{< drg/image src="images/tripped-breaker-reset-sequence.avif" alt="Breaker handle positions showing on, tripped, off, and the correct reset sequence back to on" >}}

{{< drg/safety-first >}}
Never keep resetting a breaker again and again to "see if it holds." Repeated tripping is a warning sign. It may point to an overload, damaged device, or fault in the circuit.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="Electrical Safety Foundation International — Extension Cords and Power Strips"
    url="https://www.esfi.org/extension-cords-and-power-strips/"
    description="Practical safety advice on avoiding overloads and unsafe power-strip use in real homes." >}}

{{< drg/next-page
    text="You now understand how overloaded circuits happen and how fuses and breakers protect home wiring."
    teaser="Next, map a real room and show how its outlets, lights, and switches connect to specific breakers."
