...
{{< drg/image src="images/ac-dc-wave-comparison.avif" alt="Side-by-side comparison of direct current flowing one direction and alternating current reversing direction over time" >}}
...
{{< drg/tip >}}
Many modern devices use both. Your wall outlet supplies AC, but your phone charger converts it to DC because the battery and electronics inside the phone need direct current.
{{< /drg/tip >}}
...
This is why a battery-powered circuit in [Req 3 — Build an Electromagnet](/merit-badges/electricity/guide/req3/) can work even though there is no generator spinning anywhere nearby.

{{< drg/did-you-know >}}
The first true electric battery, invented by Alessandro Volta around 1800, was called a voltaic pile. It stacked layers of zinc, copper, and saltwater-soaked material to create a steady electric current.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="U.S. Energy Information Administration — Electricity Explained"
    url="https://www.eia.gov/energyexplained/electricity/"
    description="Clear explanations of how electricity is generated, transmitted, and used in the United States." >}}

{{< drg/next-page
    text="You now understand the two major types of current and several major ways electrical power is produced."
    teaser="Next, trace the parts of a battery-and-bell circuit and explain what each component does."
