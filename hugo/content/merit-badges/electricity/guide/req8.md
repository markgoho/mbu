...
{{< drg/image src="images/sample-electric-bill-breakdown.avif" alt="Mock electric bill with the usage line, energy charge, delivery charges, taxes, fees, and total due clearly highlighted" >}}

{{< drg/tip >}}
Bring a marked-up copy of the bill to your counselor. Circle the energy-use line, underline the taxes and fees, and write short notes about what each one seems to represent.
{{< /drg/tip >}}
...
{{< drg/checklist title="Five smart conservation strategies" subtitle="Choose the ones that really fit your home" >}}
...
{{< drg/did-you-know >}}
LED bulbs use far less electricity than old incandescent bulbs and can last many years longer. In many homes, switching the most-used lights to LED is one of the fastest and easiest ways to lower electric use.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="U.S. Department of Energy — Energy Saver"
    url="https://www.energy.gov/energysaver/energy-saver"
    description="Practical home energy-saving advice covering lighting, heating and cooling, appliances, and everyday habits." >}}

{{< drg/next-page
    text="You can now read the basics of an electric bill and talk clearly about where the charges come from and how to lower them."
    teaser="Next, build your electrical vocabulary so terms like voltage, resistance, GFCI, and transformer make sense."
