...
{{< drg/image src="images/electromagnet-coil-around-nail.avif" alt="Simple electromagnet with a battery, coiled wire around an iron nail, and paper clips attracted to the tip" >}}

- **Battery:** pushes current through the circuit.
- **Wire:** carries the current.
- **Coil:** strengthens the magnetic field by looping the wire.
- **Iron core:** focuses and boosts the magnetic effect.
...
{{< drg/did-you-know >}}
Huge scrapyard cranes use electromagnets powerful enough to lift entire cars. The reason they are so useful is that the operator can switch the magnetic force on and off just by controlling the current.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Electromagnet build steps" subtitle="Keep it simple and safe" >}}
...
{{< drg/tip >}}
If your electromagnet seems weak, try adding more wraps of wire, using a fresh battery, or making sure you have clean metal contact at the wire ends. Do not leave it connected for long periods while troubleshooting.
{{< /drg/tip >}}

{{< drg/safety-first >}}
Use low-voltage batteries only, and disconnect the circuit after short tests. Thin wire can get hot if current flows too long. Never connect your project directly to household current.
{{< /drg/safety-first >}}
...
{{< drg/external-link
    title="Khan Academy — Electromagnetism"
    url="https://www.khanacademy.org/science/physics/magnetic-forces-and-magnetic-fields/magnets-magnetic/v/electromagnetism"
    description="A clear explanation of how electric current creates magnetic fields and how coils make electromagnets stronger." >}}

{{< drg/next-page
    text="You have seen how current can create magnetism and make a simple device do work."
    teaser="Next, compare AC and DC and learn three major ways electricity is produced."
