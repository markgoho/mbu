...
{{< drg/checklist title="What this requirement covers" subtitle="Seven emergency situations every Scout should be ready to discuss or demonstrate" >}}
...
{{< drg/image src="images/service-panel-breaker-layout.avif" alt="Residential breaker panel showing the main breaker and several labeled branch circuit breakers" >}}
...
{{< drg/safety-first >}}
Never reach into a damaged panel, touch bare metal parts, or stand in water while trying to shut off power. If the panel area itself is damaged, sparking, or wet, back away and call 911 or the utility company.
{{< /drg/safety-first >}}

{{< drg/tip >}}
Walk through your home with a parent or guardian before your counselor meeting. Find the service panel, the main disconnect, and the labels for key circuits like kitchen outlets, bathroom outlets, and your bedroom.
{{< /drg/tip >}}
...
- **Cut the power** at the breaker or unplug the appliance if you can do so safely.
- **If the current is still live and the scene is otherwise safe,** use a dry nonconductive object to separate the person from the source.
- **Call 911 immediately.**
- **Once the source is no longer energizing the victim,** check breathing and responsiveness and begin first aid.
{{< /drg/be-prepared >}}

{{< drg/safety-first >}}
Never use metal, anything wet, or anything you are not sure is nonconductive. Water, damp floors, and metal tools make electrical rescue much more dangerous.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/car-downed-line-exit-sequence.avif" alt="Correct versus incorrect way to exit a car with a downed utility wire, showing the jump-clear and shuffle-away method" >}}

{{< drg/checklist title="Vehicle and downed-wire safety" subtitle="What to remember under stress" >}}
...
{{< drg/safety-first >}}
Do not begin care until you are certain the current is off or the person is separated from the source. Electrical current can stop the heart, disturb its rhythm, or damage deep tissues that are not obvious from the outside.
{{< /drg/safety-first >}}

{{< drg/tip >}}
This requirement connects directly to first-aid skills. If you have also worked on [First Aid merit badge](/merit-badges/first-aid/), use the same calm assessment pattern here: scene safety, responsiveness, breathing, emergency help, then treatment.
{{< /drg/tip >}}
...
- **Cool the burn safely** once the electrical source is no longer a danger.
- **Cover it with a clean dressing.**
- **Get medical advice or emergency care** because internal injury may be worse than the skin suggests.
{{< /drg/be-prepared >}}
...
{{< drg/safety-first >}}
Never throw water on an electrical fire. Water conducts electricity and can turn a small fire into a shock emergency. Never stay in a building to fight a fire that is spreading or filling the area with smoke.
{{< /drg/safety-first >}}

### What to Remember

- Shut off power if it is safe to do so.
- Use the proper extinguisher.
- Keep an exit behind you.
- Evacuate early if the fire is not immediately controlled.
...
{{< drg/did-you-know >}}
Lightning can strike more than 10 miles from the center of a storm. That is why the first distant rumble of thunder matters — the storm does not need to be directly overhead yet to be dangerous.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="National Weather Service — Lightning Safety"
    url="https://www.weather.gov/safety/lightning"
    description="Official lightning safety guidance for storms, vehicles, buildings, and outdoor activities." >}}

{{< drg/next-page
    text="You now know how to respond to the most important electrical emergencies without making the situation worse."
    teaser="Next, inspect a home for everyday electrical hazards before they become emergencies."
