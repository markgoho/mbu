...
{{< drg/checklist title="Emergency Call Information" subtitle="Have this ready before you need it" >}}
...
{{< drg/tip >}}
Before you start climbing, drop a pin on your phone's map app at the base of the crag. Write down the GPS coordinates on a piece of tape on the inside of your helmet. If you need to call for help, you will have exact coordinates ready — no fumbling with your phone while stressed.
{{< /drg/tip >}}
...
- Treat injuries with your first aid knowledge from [Req 1b](/merit-badges/climbing/guide/req1b/)
...
{{< drg/safety-first >}}
Never leave an injured climber alone unless you have absolutely no other option for getting help. Assign roles: one person stays with the patient, one person calls for help, one person guides rescuers to the location.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Wilderness First Aid (WFA) courses teach you to make critical decisions that differ from standard first aid. For example, in a wilderness setting, you may need to reduce a dislocated shoulder or decide whether to evacuate someone with a back injury — decisions that standard first aid teaches you to leave for paramedics. The 16-hour WFA course is offered by NOLS Wilderness Medicine, SOLO, and other providers.
{{< /drg/did-you-know >}}

{{< drg/image src="images/emergency-plan-crag.avif" alt="Climbing area with emergency planning annotations showing GPS pin location, cell signal spot, evacuation route to parking, and first aid kit placement" >}}
...
{{< drg/external-link
    title="NOLS Wilderness Medicine — Course Finder"
    url="https://www.nols.edu/en/coursefinder/wilderness-medicine/"
    description="Find Wilderness First Aid and Wilderness First Responder courses near you." >}}

{{< drg/next-page
    text="Your emergency plan is in place"
    teaser="Learn the verbal signals that keep climbers, belayers, and rappellers communicating safely."
