---
title: "Climbing Hazards"
layout: guide
group_title: "1. Safety & First Aid"
req_number: "1a"
prev: "/merit-badges/climbing/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/climbing/guide/req1b/"
next_title: "Injury Prevention & First Aid"
---
...
{{< drg/safety-first >}}
Never climb without a belay unless you are bouldering with proper crash pads and spotters. Even experienced climbers use protection. The rope and belayer are your primary safety system — treat them with absolute seriousness.
{{< /drg/safety-first >}}
...
**How to anticipate and prevent:** Inspect all equipment before every climb (you will learn the CHECK system in [Req 9](/merit-badges/climbing/guide/req9/)). Retire gear that shows signs of wear or damage. Never use equipment you did not inspect yourself.
...
- **Descend or lower off** rather than pushing to finish the route.
- **Move away from the cliff** once on the ground. Rock faces attract lightning.
- **Seek shelter** in a low area away from tall trees and metal objects.
- **Wait at least 30 minutes** after the last thunder before climbing again.
{{< /drg/be-prepared >}}
...
{{< drg/tip >}}
Before your first visit to a climbing area, research it online or ask experienced climbers about specific hazards. Sites like Mountain Project often list approach trail conditions, loose rock warnings, and seasonal concerns like nesting raptors.
{{< /drg/tip >}}
...
**How to anticipate and prevent:** Use the buddy system. Before every climb, have your partner check your harness, knot, and belay device while you check theirs. Follow established communication protocols (covered in [Req 5](/merit-badges/climbing/guide/req5/)). Never rush.

{{< drg/did-you-know >}}
The American Alpine Club's annual *Accidents in North American Climbing* report shows that the majority of climbing accidents involve human error — not equipment failure. Partner checks and verbal signals prevent most of these incidents.
{{< /drg/did-you-know >}}

{{< drg/image src="images/climbing-hazard-awareness.avif" alt="Outdoor rock climbing scene with labeled hazard zones including rockfall zone above, weather approaching, loose ground at base, and climber wearing helmet" >}}
...
{{< drg/external-link
    title="American Alpine Club — Accidents in North American Climbing"
    url="https://americanalpineclub.org/annual-report"
    description="Annual reports analyzing real climbing accidents and the lessons they teach." >}}

{{< drg/next-page
    text="Now that you know the hazards"
    teaser="Learn the first aid skills specific to climbing injuries."
