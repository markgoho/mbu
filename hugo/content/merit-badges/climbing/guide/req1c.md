...
{{< drg/safety-first >}}
If you are alone with an unresponsive, non-breathing person, call 911 (or have someone else call) **before** starting CPR. If an AED is nearby, send someone to get it. Every minute without CPR reduces the chance of survival by about 10%.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Hands-only CPR (chest compressions without rescue breaths) is recommended by the American Heart Association for bystanders who witness an adult suddenly collapse. Push hard and fast in the center of the chest at a rate of 100–120 compressions per minute — roughly the tempo of the song "Stayin' Alive" by the Bee Gees.
{{< /drg/did-you-know >}}
...
- **Tap and shout** — try to wake them. Check for responsiveness.
- **Call for help** — have someone call 911 and note your location.
- **Check breathing** — look, listen, feel for 10 seconds.
- **Check pulse** — carotid artery, 10 seconds.
- **Begin CPR** if they are unresponsive, not breathing normally, and have no pulse.
- **Use an AED** if one is available (many climbing gyms have them).
{{< /drg/be-prepared >}}

{{< drg/image src="images/cpr-check-sequence.avif" alt="Three-panel diagram showing the CPR assessment sequence: checking responsiveness, checking breathing, and checking carotid pulse" >}}

## Get Trained

Reading about CPR is not the same as practicing it. To be truly prepared, take a hands-on CPR course where you practice on a training mannequin with a certified instructor. Many Scout councils offer CPR training, and the [First Aid merit badge](/merit-badges/first-aid/) covers CPR in detail.

{{< drg/external-link
    title="American Heart Association — CPR Training"
    url="https://cpr.heart.org/en/cpr-courses-and-kits"
    description="Find CPR courses and certification near you through the American Heart Association." >}}

{{< drg/next-page
    text="With safety and first aid covered"
    teaser="Learn how the Leave No Trace principles apply to climbing areas."
