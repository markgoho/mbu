...
Verbal signals. Explain the importance of using verbal signals during every climb and rappel, and while bouldering. With the help of the counselor or another Scout, demonstrate the verbal signals used by each of the following:
{{< /drg/requirement >}}
...
{{< drg/did-you-know >}}
The call "ROCK!" is used even in indoor climbing gyms when someone drops a piece of gear. Carabiners and belay devices falling from height can cause serious injuries. The protocol is the same: shout "ROCK!" and everyone below takes cover. Yelling "heads up!" is actually counterproductive because people tend to look up — directly into the path of the falling object.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Miscommunication Scenario" >}}
You are belaying and hear your climber shout something, but wind makes it unclear. Did they say "Slack" or "Take"?

- **Do not guess.** Shout back: "Say again!"
- Keep the rope in its current position until the signal is repeated clearly.
- If you still cannot hear, ask the climber to descend to where communication is clearer.
- This is why some climbing teams establish a backup system: two tugs on the rope means "take," three tugs means "slack."
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Petzl — Climbing Communication"
    url="https://www.petzl.com/US/en/Sport/Signals-and-communication-while-climbing"
    description="Visual guide to climbing communication signals from a leading climbing equipment manufacturer." >}}

{{< drg/next-page
    text="Communication skills are dialed in"
    teaser="Learn about the lifeline that connects you to safety — climbing rope."
