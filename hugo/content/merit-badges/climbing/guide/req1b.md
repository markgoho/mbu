---
title: "Injury Prevention & First Aid"
layout: guide
group_title: "1. Safety & First Aid"
req_number: "1b"
prev: "/merit-badges/climbing/guide/req1a/"
prev_title: "Climbing Hazards"
next: "/merit-badges/climbing/guide/req1c/"
next_title: "CPR Readiness"
---
...
{{< drg/safety-first >}}
Heat stroke can kill. If someone stops sweating on a hot day, becomes confused, or has skin that feels hot and dry, treat it as a medical emergency. Cool first, call 911, and do not leave them alone.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Carry a water bottle on your harness or keep one at the base of the route. It is easy to forget to drink when you are focused on climbing. Set a reminder to hydrate between every climb.
{{< /drg/tip >}}
...
- **R**est — Stop using the injured joint
- **I**ce — Apply cold for 20 minutes on, 20 minutes off
- **C**ompression — Wrap with an elastic bandage (snug, not tight)
...
{{< drg/did-you-know >}}
Most venomous snakebites in the U.S. are "dry bites" — the snake strikes defensively but does not inject venom. However, you should always treat a bite from a venomous snake as a medical emergency since there is no way to tell in the field whether venom was injected.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/climbing-first-aid-kit.avif" alt="A compact climbing first aid kit laid open showing elastic bandage, moleskin, antiseptic wipes, gauze, athletic tape, emergency blanket, and SAM splint" >}}
...
{{< drg/checklist title="Climbing First Aid Additions" subtitle="Items to add to your standard kit" >}}
...
{{< drg/external-link
    ...
    description="Find first aid and CPR certification courses near you." >}}

{{< drg/next-page
    text="You now know how to handle climbing injuries"
    teaser="Next, learn when CPR is necessary and the conditions that must be present before you perform it."
