...
1. **Inspect** the rope while coiling it — run it through your hands and check for damage (review the inspection process from [Req 6b](/merit-badges/climbing/guide/req6/))
...
{{< drg/tip >}}
A rope bag is the best investment for rope storage and transport. You flake the rope into the bag at the crag, cinch it closed, and the rope stays clean and organized. At home, leave the bag open in a closet so air circulates. When you return to the crag, the rope feeds out of the bag tangle-free.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Never store climbing hardware with automotive chemicals, pool chemicals, cleaning solvents, or batteries. Chemical fumes can invisibly weaken nylon webbing, harness materials, and rope — even without direct contact. Store climbing gear in a dedicated closet or gear bin away from the garage.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/gear-storage-organized.avif" alt="A well-organized gear storage area with rope in a bag, carabiners on a gear sling, harness on a peg, helmet on a shelf, and climbing shoes airing out" >}}
...
|---|---|---|
| **Dynamic rope** | 2–10 years depending on use | See retirement criteria in [Req 6d](/merit-badges/climbing/guide/req6/) |
...
{{< drg/did-you-know >}}
Climbing gear manufacturers stamp a production date on harnesses, slings, and helmets. Even if gear looks perfect, manufacturers recommend retirement after a set number of years because nylon and plastics degrade over time from UV exposure, humidity, and temperature cycling. Check your gear's date stamps — a harness sitting in a closet for 10 years may look new but should not be trusted.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    title="Black Diamond — Gear Care and Maintenance"
    url="https://www.blackdiamondequipment.com/en_US/experience-story?cid=qc-lab-702"
    description="Detailed care instructions from one of the world's leading climbing gear manufacturers." >}}

{{< drg/next-page
    text="You know how to care for every piece of climbing equipment"
    teaser="Explore what lies beyond the badge — deeper skills, real-world experiences, and organizations that can fuel a lifetime of climbing."
    url="/merit-badges/climbing/guide/extended-learning/" >}}
