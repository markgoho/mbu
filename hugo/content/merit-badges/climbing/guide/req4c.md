...
- **Lower any climbers on the wall** immediately.
- **Retreat from the cliff base.** Rock faces attract lightning, and water runoff can send debris down.
- **Seek low ground** away from tall trees and cliff edges.
- **Wait 30 minutes** after the last lightning or thunder before considering a return.
{{< /drg/be-prepared >}}
...
{{< drg/tip >}}
Test handholds before committing your weight. Push down on the hold, tap it with your palm, and listen. A solid hold sounds dull and does not move. A loose hold sounds hollow and shifts slightly. Never pull outward on a suspect hold — that is the direction most likely to cause it to break free.
{{< /drg/tip >}}
...
{{< drg/image src="images/site-safety-evaluation.avif" alt="A climbing area with annotated callouts highlighting weather assessment, rock quality, ground hazards, and approach trail evaluation" >}}
...
{{< drg/did-you-know >}}
Professional mountain guides use a structured risk assessment method called the "3x3" — they evaluate conditions at three scales (broad area, specific site, individual route) across three timeframes (before the trip, during approach, at the crag). This systematic approach catches hazards that a casual glance would miss.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="American Alpine Club — Know Before You Go"
    url="https://americanalpineclub.org/safety-resources"
    description="Safety resources for climbers, including accident reports that highlight real-world consequences of poor site evaluation." >}}

{{< drg/next-page
    text="You can evaluate whether a site is safe"
    teaser="Learn how to plan for emergencies at the climbing area."
