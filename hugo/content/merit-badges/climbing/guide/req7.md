...
{{< drg/be-prepared title="Stuck on the Rope" >}}
Your belayer lowers you, but the rope jams at the anchor and you are stuck hanging 20 feet off the ground. What now?

- **Do not panic.** You are on belay and safe — just stuck.
- If you have Prusik cord, tie two Prusik hitches on the rope above you — one for your foot, one attached to your harness.
- Alternate loading each Prusik to slowly climb the rope back to the anchor.
- This is why carrying a few feet of accessory cord on your harness is smart practice.
- If you do not have Prusik cord, communicate with your belayer and wait for assistance.
{{< /drg/be-prepared >}}

{{< drg/image src="images/five-climbing-knots.avif" alt="Five-panel diagram showing each essential climbing knot: figure eight on a bight, figure eight follow-through, water knot, double fisherman's knot, and Prusik hitch" >}}
...
{{< drg/external-link
    title="Animated Knots — Climbing Knots"
    url="https://www.animatedknots.com/climbing-knots"
    description="Step-by-step animated instructions for every climbing knot, including all five required for this badge." >}}

{{< drg/next-page
    text="Your knot skills are solid"
    teaser="Learn about the harness, helmet, and gloves that protect you on every climb."
