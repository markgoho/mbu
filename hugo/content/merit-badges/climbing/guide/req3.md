...
{{< drg/tip >}}
Before you head to the crag, test your outfit at home. Can you squat all the way down? Can you lift your leg onto a kitchen chair? Can you reach both arms fully overhead? If your clothes restrict any of these movements, choose something else.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Before every climb, check yourself for entanglement hazards: drawstrings, jewelry, lanyards, loose straps, and long hair. Tuck in or remove anything that could catch in your belay device or rappel setup. A single drawstring pulled into an ATC or GriGri can lock the device and leave a climber stranded.
{{< /drg/safety-first >}}

**Specific entanglement risks:**

- **Drawstrings** on hoodies and jackets — tuck them in or tie them short
- **Jewelry** — remove necklaces, bracelets, and dangling earrings
- **Long hair** — tie it back in a bun or braid and tuck it under your helmet
- **Loose straps** on backpacks or chalk bags — secure all dangling webbing
- **Watch bands and fitness trackers** — remove or cover them
...
If rain is possible, carry a waterproof shell. Rain makes rock extremely slippery and increases the risk of hypothermia. As you learned in [Req 1a](/merit-badges/climbing/guide/req1a/), wet conditions are a serious hazard — you should stop climbing in rain.
...
|---|---|---|
| **Base layer** | Wicks sweat away from skin | Synthetic or merino wool T-shirt |
| **Mid layer** | Insulates and retains heat | Fleece pullover, thin puffy jacket |
| **Outer layer** | Blocks wind and rain | Lightweight wind shell or rain jacket |
...
{{< drg/image src="images/climbing-attire-checklist.avif" alt="Labeled diagram of a properly dressed climber showing fitted pants, moisture-wicking shirt, climbing shoes, harness, helmet, and chalk bag with callouts" >}}
...
{{< drg/did-you-know >}}
Modern climbing shoe rubber was revolutionized in the 1980s by a Spanish company called Boreal. Their "Fire" shoe used a sticky rubber compound that dramatically changed what climbers could do on the rock. Before sticky rubber, climbers relied on stiff-soled boots and brute strength. Today, every major climbing shoe uses some variation of high-friction rubber.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Pre-Climb Clothing Check" subtitle="Run through this before every climb" >}}
...
{{< drg/external-link
    title="REI — What to Wear Rock Climbing"
    url="https://www.rei.com/learn/expert-advice/rock-climbing-basics.html"
    description="Comprehensive guide to clothing and gear for different climbing environments." >}}

{{< drg/next-page
    text="You are dressed and ready to climb"
    teaser="Learn how climbing routes are rated for difficulty."
