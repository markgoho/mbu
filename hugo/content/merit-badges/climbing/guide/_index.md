...
{{< drg/did-you-know >}}
Sport climbing became an Olympic event at the 2020 Tokyo Games. Competitors were scored across three disciplines — lead climbing, speed climbing, and bouldering. By the 2024 Paris Games, speed climbing had its own separate medal event because the skills are so different from the other two.
{{< /drg/did-you-know >}}

## Get Ready!

{{< drg/tip >}}
You are about to learn skills that let you move vertically through the world — up cliffs, across boulders, and down rappel routes. This badge combines physical strength, mental focus, safety systems, and teamwork into one unforgettable experience. Lace up your shoes, chalk your hands, and let's climb.
{{< /drg/tip >}}
...
{{< drg/image src="images/top-rope-climbing-overview.avif" alt="Two teenagers on an outdoor rock face with top-rope setup, showing the rope running through an anchor at top and back down to the belayer at the base" >}}
...
{{< drg/safety-first >}}
Even though bouldering heights are low, injuries can still happen. Always use crash pads, have a trained spotter, and never boulder alone. Ankle sprains and wrist fractures are the most common bouldering injuries, usually from awkward landings.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/indoor-climbing-gym.avif" alt="Interior of a modern climbing gym with colorful holds on angled walls, teenagers climbing and belaying, crash pads on the floor" >}}
...
{{< drg/next-page
    text="Before you touch the rock, you need to understand the hazards"
    teaser="Learn to identify and manage the risks that come with climbing."
    url="/merit-badges/climbing/guide/req1a/" >}}
