...
{{< drg/safety-first >}}
Never use a static rope for top-rope climbing or lead climbing. A fall onto a static rope generates forces that can break bones, damage anchors, and snap the rope itself. Static ropes are for situations where stretch is undesirable and falls should never occur.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Rope Protection Habits" subtitle="Follow these every time you climb" >}}
...
{{< drg/be-prepared title="Tangled Rope at the Crag" >}}
You uncoil your rope and it is a tangled mess. Now what?

- **Do not yank.** Pulling on tangles makes them worse and stresses the rope.
- **Flake the rope** — lay it out loosely on a tarp, working tangles free from the ends.
- **Use a rope bag** to prevent tangles. A rope bag lets you stack (flake) the rope loosely, then cinch the bag closed. When you open it at the crag, the rope feeds out tangle-free.
- **After climbing**, flake the rope back into the bag from one end — do not just stuff it in.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Sterling Rope — Rope Care and Maintenance"
    url="https://sterlingrope.com/resource-center/rope-care"
    description="Detailed rope care guidelines from one of the leading climbing rope manufacturers." >}}

{{< drg/next-page
    text="You understand how to choose, inspect, and care for your rope"
    teaser="Now learn the five essential knots every climber needs."
