...
{{< drg/did-you-know >}}
A standard locking carabiner is rated to hold about 24 kN (roughly 5,400 pounds of force) along the spine. But when cross-loaded or loaded with the gate open, that drops to as low as 7 kN — barely enough to hold a moderate climbing fall. Gate orientation matters enormously.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
The Connections check is where most errors are caught. A figure eight that looks "close enough" might have a twist that weakens it. A belay device loaded backward will not brake properly. Take the time to trace the rope from the climber's harness through the entire system to the belayer's device. Every connection point must be correct.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/check-system-diagram.avif" alt="Infographic showing the five elements of the CHECK system: Carabiners, Harness, Environment, Connections, and Knots" >}}
...
{{< drg/tip >}}
Run the CHECK system out loud with your partner. "Carabiners — locked. Harness — buckled and snug. Environment — clear. Connections — knot looks good, device loaded. Knots — dressed, tail long enough." Speaking the checks aloud makes it a conversation, not a solo exercise, and catches things both people might miss alone.
{{< /drg/tip >}}

{{< drg/checklist title="CHECK Quick Reference" subtitle="Run through before every climb" >}}
- **C**arabiners: Locked, properly oriented, loaded on the spine.
- **H**arness: Waist belt above hips, buckles secure, leg loops snug.
- **E**nvironment: Ground clear, weather stable, no overhead hazards.
- **C**onnections: Knot to harness correct, belay device loaded properly, anchor solid.
- **K**nots: Figure eight dressed, stopper knot on rope end if needed.
{{< /drg/checklist >}}

{{< drg/external-link
    title="Petzl — Partner Check Before Climbing"
    url="https://www.petzl.com/US/en/Sport/Partner-check-before-climbing"
    description="Illustrated guide to pre-climb partner checks from Petzl, with detailed photos of what to inspect." >}}

{{< drg/next-page
    text="The CHECK system is your pre-climb routine"
    teaser="Now learn the critical skill of belaying — managing the rope that protects your climbing partner."
