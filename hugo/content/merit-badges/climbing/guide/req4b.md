...
req_number: "4b"
prev: "/merit-badges/climbing/guide/req4a/"
prev_title: "Climb Difficulty Ratings"
next: "/merit-badges/climbing/guide/req4c/"
next_title: "Site Safety Evaluation"
---
...
{{< drg/tip >}}
When you are top-rope climbing, trust the system. The rope is always above you. If you fall, you barely move. This lets you focus on technique rather than fear. Try moves you are not sure you can complete — the worst that happens is a gentle sit-back onto the rope.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Lead climbing involves fall factors that are fundamentally different from top-roping. Do not attempt lead climbing without proper instruction from a qualified instructor. For this merit badge, you will primarily use top-rope systems. Your counselor will explain lead climbing concepts, but you are not required to lead climb.
{{< /drg/safety-first >}}
...
**Spotting:** A spotter does not catch the falling climber. Instead, the spotter guides the climber's upper body so they land feet-first on the crash pad. Spotting is a skill that requires attention and positioning — you will practice it in [Req 5d](/merit-badges/climbing/guide/req5/).
...
{{< drg/image src="images/three-climbing-styles.avif" alt="Three-panel comparison of top-rope climbing, lead climbing, and bouldering showing rope systems and protection differences" >}}

## Comparing the Three Styles

| Feature | Top-Rope | Lead | Bouldering |
|---|---|---|---|
| **Rope** | Anchored at top | Climber clips as they go | No rope |
| **Fall distance** | Inches | Feet to tens of feet | Full height to ground |
| **Protection** | Top anchor | Bolts or removable gear | Crash pads + spotter |
| **Best for** | Beginners, skill building | Experienced climbers | Strength, problem-solving |
| **Height** | Full wall height | Full wall height | Under 20 feet |

{{< drg/did-you-know >}}
Bouldering was once considered just a training exercise for "real" climbing. It became a respected discipline in its own right during the 1990s, and now has its own Olympic medal event. Some of the hardest climbing moves ever done have been on boulders less than 15 feet tall.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="REI — Types of Rock Climbing"
    url="https://www.rei.com/learn/expert-advice/getting-started-rock-climbing.html"
    description="An overview of climbing styles with guidance on getting started in each one." >}}

{{< drg/next-page
    text="You understand the three main climbing styles"
    teaser="Learn how to evaluate whether a climbing area is safe before you start."
