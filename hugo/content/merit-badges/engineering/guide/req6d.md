...
req_number: "6d"
prev: "/merit-badges/engineering/guide/req6c/"
prev_title: "Understanding Electronics"
next: "/merit-badges/engineering/guide/req6e/"
next_title: "Converting Energy"
---
...
{{< drg/tip >}}
Use samples of similar thickness for a fair comparison. A thick piece of wood will outperform a thin piece of metal — the experiment tests the material's properties, not its dimensions. Hardware stores sell thin metal strips, wooden craft sticks, and plastic rulers that make good test samples.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Use hot tap water, not boiling water, for the heat conductivity experiment. Do not heat materials with an open flame unless directly supervised by an adult. Metal samples will get hot enough to cause a burn — use tongs or pliers to handle them after the experiment. Always have cold water available in case of minor burns.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Spider silk is five times stronger than steel by weight and more flexible than nylon. Materials engineers have been trying for decades to manufacture synthetic spider silk at scale. If they succeed, it could revolutionize everything from bulletproof vests to surgical sutures.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/materials-strength-test.avif" alt="A teenager in a Scout uniform conducting a materials strength experiment with thin strips of wood, metal, and plastic bridging two supports, with a small weight container hanging from the center strip and a notebook for recording data" >}}

{{< drg/external-link
    title="Material Properties Database — MatWeb"
    url="https://www.matweb.com/"
    description="A comprehensive database of material properties for thousands of metals, plastics, ceramics, and composites — the same reference engineers use professionally." >}}

{{< drg/next-page
    text="Done experimenting with materials?"
    teaser="Explore how energy transforms from one form to another — the foundation of every engine, power plant, and living organism."
