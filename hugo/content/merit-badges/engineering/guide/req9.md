...
In [Req 3](/merit-badges/engineering/guide/req3/), you learned about different types of engineers. Now pick one to research in detail. Consider which activities you enjoyed most in this badge:
...
- Must the program be **ABET-accredited**? (For P.E. licensure, yes — as you learned in [Req 7](/merit-badges/engineering/guide/req7/))
...
{{< drg/tip >}}
The Bureau of Labor Statistics Occupational Outlook Handbook (bls.gov/ooh) is the single best source for career research. It covers every engineering specialty with salary data, job outlook, required education, and day-to-day duties — all updated annually with reliable government data.
{{< /drg/tip >}}
...
If you met an engineer during [Req 4](/merit-badges/engineering/guide/req4/), ask follow-up questions about their career path. You might also reach out to:
...
{{< drg/did-you-know >}}
Engineering graduates earn some of the highest starting salaries of any bachelor's degree. According to the National Association of Colleges and Employers, the average starting salary for engineering graduates in 2023 was over $75,000 — compared to about $60,000 for all bachelor's degree graduates combined.
{{< /drg/did-you-know >}}

{{< drg/checklist title="Career Research Checklist" subtitle="Make sure you cover everything" >}}
...
{{< drg/image src="images/engineering-career-paths.avif" alt="An infographic showing three engineering career paths — civil, mechanical, and electrical — each as a vertical progression from high school through college, early career, and senior positions, with salary ranges and key milestones" >}}

{{< drg/external-link
    title="Bureau of Labor Statistics — Architecture and Engineering Occupations"
    url="https://www.bls.gov/ooh/architecture-and-engineering/home.htm"
    description="Comprehensive career profiles for every major engineering specialty — job duties, education, salary, and employment outlook from the U.S. government." >}}

{{< drg/next-page
    text="You have completed all nine requirements"
    teaser="Go beyond the badge with advanced engineering topics, real-world experiences, and organizations that can fuel your engineering journey."
    url="/merit-badges/engineering/guide/extended-learning/" >}}
