...
{{< drg/tip >}}
Choose something you can safely open up or take apart with adult supervision. Seeing the actual components — gears, wires, circuit boards, springs — makes it much easier to understand how the item works. Take photos as you go so you can reference them when talking with your counselor.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The pop-up toaster was invented in 1921 by Charles Strite, a factory worker in Minnesota who was tired of the burned toast served in his company cafeteria. He engineered a timer mechanism with a spring that automatically ejected the toast when it was done — solving a problem that annoyed him every day at lunch.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Investigation Checklist" subtitle="Track your progress" >}}
...
{{< drg/image src="images/disassembled-appliance-investigation.avif" alt="A teenager in a Scout uniform at a workbench carefully examining the disassembled internal components of a small appliance, with parts laid out in organized groups, a notebook with sketches, and basic tools nearby" >}}

{{< drg/safety-first >}}
Never disassemble an item that is plugged in or connected to a power source. Unplug electrical devices and remove batteries before opening them. Some items contain capacitors that store electrical charge even after being unplugged — if you encounter large capacitors (common in microwaves, TVs, and monitors), do not touch them. Stick to battery-operated or simple mechanical items for the safest experience.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="How Stuff Works — Engineering Channel"
    url="https://science.howstuffworks.com/engineering-channel.htm"
    description="Detailed explanations of how everyday devices work, from engines to elevators to household appliances." >}}

{{< drg/next-page
    text="Now that you have investigated how an everyday item works"
    teaser="Research an engineering achievement that changed the world."
