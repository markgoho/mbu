...
{{< drg/tip >}}
Survey your neighborhood. Ask family members, neighbors, or troop parents how they get to work. Tally the results and calculate percentages. Compare your findings to national averages — are people in your community more or less car-dependent than the national norm?
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Traffic engineers have calculated that a single highway lane can carry about 2,000 cars per hour at optimal conditions. A single bus lane carrying buses every 3 minutes can move 4,000–8,000 people per hour — two to four times more people in the same space.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Presenting Transportation Improvements" >}}
Your counselor asks what you would change about transportation in your community. Here is how to give a strong answer:

- **Start with evidence**: "During my traffic study, I counted 87 cars in 15 minutes during rush hour, with moderate congestion and a long backup at the Main Street light."
- **Identify the problem**: "The traffic light cycle gives equal time to both directions, but northbound traffic is three times heavier in the morning."
- **Propose a solution**: "Adjusting the signal timing to give northbound traffic a longer green phase during morning rush would reduce the backup."
- **Acknowledge tradeoffs**: "This would mean shorter green lights for southbound traffic, so we would need to check that it does not create a new problem."
{{< /drg/be-prepared >}}

{{< drg/image src="images/traffic-flow-observation.avif" alt="A teenager in a Scout uniform standing safely on a sidewalk with a clipboard and stopwatch, observing and recording traffic at a nearby intersection during a traffic study" >}}

{{< drg/external-link
    title="Federal Highway Administration — Traffic Analysis Tools"
    url="https://ops.fhwa.dot.gov/trafficanalysistools/"
    description="FHWA resources on traffic analysis methods and tools — see how professional transportation engineers study and improve traffic flow." >}}

{{< drg/next-page
    text="Done with your traffic study?"
    teaser="Take your engineering skills to a competition — enter a science or engineering fair."
