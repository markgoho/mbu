...
{{< drg/did-you-know >}}
A car engine is only about 20–25% efficient — meaning 75–80% of the chemical energy in gasoline is lost as waste heat rather than being converted into motion. That is why your car's engine gets so hot and needs a cooling system. Engineers are constantly working to improve this number.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Draw an **energy flow diagram** for your experiment. Start with the input energy on the left, show arrows pointing to each output form on the right, and make the arrow sizes proportional to how much energy goes each way. This visual makes the conversion process clear and impresses counselors.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
For heat-related experiments, use caution with hot water and heated surfaces. Never use open flames without adult supervision. If using a Peltier module or any electrical components, use only low-voltage battery-powered setups. Do not connect experiments to household electrical outlets.
{{< /drg/safety-first >}}

{{< drg/image src="images/energy-conversion-experiment.avif" alt="A teenager in a Scout uniform conducting an energy conversion experiment at a table, showing a rubber-band-powered car on a test track with a notebook recording results nearby" >}}

{{< drg/external-link
    title="U.S. Department of Energy — Energy 101"
    url="https://www.energy.gov/eere/education/energy-literacy-essential-principles-and-fundamental-concepts-energy-education"
    description="The DOE's comprehensive guide to energy literacy, covering fundamental concepts of energy, energy sources, and energy use in daily life." >}}

{{< drg/next-page
    text="Finished with energy conversion?"
    teaser="Study how people move through your community — and how transportation engineering could make it better."
