...
{{< drg/did-you-know >}}
The FE exam has a pass rate of about 70% for first-time takers who studied engineering in college. The PE exam is even harder — pass rates vary by discipline, but some specialties see only 50–60% of candidates pass on their first attempt. The difficulty ensures that the P.E. title genuinely means something.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When explaining P.E. registration to your counselor, emphasize the *why*: it exists to protect the public. When an engineer stamps a set of plans, they are putting their name, reputation, and legal liability on the line. That stamp tells the public: "I have verified that this design is safe."
{{< /drg/tip >}}
...
{{< drg/image src="images/pe-stamp-and-documents.avif" alt="A clean illustration showing a Professional Engineer's seal/stamp on engineering drawings, with a blueprint and technical specifications visible in the background" >}}

{{< drg/external-link
    title="National Society of Professional Engineers — What Is a P.E.?"
    url="https://www.nspe.org/resources/licensure/what-pe"
    description="NSPE's comprehensive guide to Professional Engineer licensure — requirements, benefits, and the path to becoming a licensed P.E." >}}

{{< drg/next-page
    text="Now that you understand Professional Engineer registration"
    teaser="Explore the ethical code that guides every engineer — and see how it connects to the Scout Oath and Law."
