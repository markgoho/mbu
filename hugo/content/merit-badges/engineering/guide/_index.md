...
{{< drg/image src="images/engineering-overview-collage.avif" alt="A teenager in a Scout uniform examining the internal components of a disassembled toaster on a workbench, with engineering tools like calipers, a multimeter, and a notebook nearby" >}}
...
{{< drg/did-you-know >}}
The International Space Station is the most complex engineering project ever built. Over 100,000 people across 15 countries contributed to its construction, and it orbits Earth at 17,500 miles per hour — roughly five miles per second. Every component had to be designed to survive launch forces, extreme temperature swings, and the vacuum of space.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/engineering-get-ready.avif" alt="Three teenagers in Scout uniforms collaborating at a table covered with sketches, a laptop showing a CAD model, and a simple mechanical prototype made of cardboard and wooden dowels" >}}
...
{{< drg/safety-first >}}
Electricity is one of the most useful forces engineers harness — and one of the most dangerous. Even household current (120 volts in the US) can cause serious injury or death. Throughout this badge, any experiments involving electricity should use only batteries or low-voltage sources unless you are directly supervised by a knowledgeable adult.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="Now that you know what engineering is all about"
    teaser="Pick a manufactured item in your home and investigate how it works."
    url="/merit-badges/engineering/guide/req1/" >}}
