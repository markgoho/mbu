...
{{< drg/did-you-know >}}
Archimedes reportedly said, "Give me a lever long enough and a fulcrum on which to place it, and I shall move the world." He was not exaggerating the math — a lever really can multiply force without limit. The tradeoff is that you must move the long end a much greater distance to move the short end a little.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Model Building Steps" subtitle="Follow this process" >}}
...
{{< drg/safety-first >}}
If your model launches projectiles (like a catapult), always aim away from people, pets, and breakable objects. Wear safety glasses when testing. Use soft projectiles like marshmallows or ping-pong balls rather than hard objects.
{{< /drg/safety-first >}}

{{< drg/image src="images/simple-machines-diagram.avif" alt="A clean educational diagram showing the six simple machines — lever, inclined plane, wheel and axle, pulley, screw, and wedge — each illustrated with a labeled example and arrows showing the direction of force and motion" >}}

{{< drg/external-link
    title="Museum of Science and Industry — Simple Machines"
    url="https://www.msichicago.org/explore/whats-here/exhibits/simple-machines/"
    description="Interactive exhibit guide from Chicago's Museum of Science and Industry explaining how simple machines work with real-world examples." >}}

{{< drg/next-page
    text="Finished with Transforming Motion?"
    teaser="Explore how your home uses electricity — and how to use less of it."
