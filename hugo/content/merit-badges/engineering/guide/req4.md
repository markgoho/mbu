...
{{< drg/tip >}}
If an in-person visit is not possible, a video call can work. Many engineers are willing to do a 30-minute video chat. Prepare your questions in advance and be respectful of their time — arrive on time, stay focused, and send a thank-you note afterward.
{{< /drg/tip >}}
...
{{< drg/checklist title="Visit Preparation Checklist" subtitle="Get ready for your engineer visit" >}}
...
{{< drg/did-you-know >}}
Studies consistently show that engineers spend 20 to 40 percent of their working time writing — emails, reports, proposals, specifications, and documentation. Strong communication skills are just as important as technical ability in most engineering careers.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/scout-visiting-engineer-office.avif" alt="A teenager in a Scout uniform sitting across a desk from a professional engineer who is pointing at a computer screen displaying a CAD drawing, with engineering drawings and models visible in the office" >}}

{{< drg/image src="images/engineering-tools-workspace.avif" alt="A clean engineering workspace showing a variety of tools — a laptop with CAD software, calipers, a 3D-printed prototype part, engineering drawings, and a calculator — arranged on a professional desk" >}}

{{< drg/external-link
    title="Discover Engineering — What Do Engineers Do?"
    url="https://www.discovere.org/discover-engineering/what-do-engineers-do/"
    description="DiscoverE profiles real engineers across many disciplines, with videos and descriptions of their daily work — great background research before your visit." >}}

{{< drg/next-page
    text="Now that you have seen engineering in practice"
    teaser="Put on your own engineering hat and design something using the systems engineering approach."
