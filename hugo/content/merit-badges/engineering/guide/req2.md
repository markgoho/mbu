...
{{< drg/tip >}}
Avoid picking something too broad (like "electricity" or "the computer"). Choose a specific project or invention so you can tell a focused story with real people, real obstacles, and real impact.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="When Your Research Hits a Wall" >}}
You start researching and find only basic Wikipedia-level information. What now?

- **Go deeper**: Search for the specific engineer's name plus "biography" or "challenges"
- **Try different sources**: Engineering magazines, university websites, PBS or History Channel documentaries, and books often have details that general websites miss
- **Look for primary sources**: Letters, speeches, and technical papers from the engineers themselves reveal obstacles they faced in their own words
- **Ask a librarian**: Reference librarians are trained to help you find specialized information — and they enjoy the challenge
{{< /drg/be-prepared >}}
...
{{< drg/did-you-know >}}
The Haber-Bosch process — an engineering method for converting nitrogen from the air into ammonia for fertilizer — is estimated to support the food supply for roughly half the world's population. Without this single chemical engineering achievement, billions of people alive today could not be fed.
{{< /drg/did-you-know >}}

{{< drg/image src="images/great-engineering-achievements-montage.avif" alt="A panoramic illustrated scene showing iconic engineering achievements — a large suspension bridge, a rocket launch pad, and a hydroelectric dam — set against a dramatic sky" >}}

{{< drg/image src="images/engineer-research-process.avif" alt="A teenager in a Scout uniform at a library table surrounded by open books, a laptop showing a bridge diagram, and handwritten notes with sketches, actively researching an engineering topic" >}}

{{< drg/external-link
    title="National Academy of Engineering — Greatest Engineering Achievements"
    url="https://www.nae.edu/63221/Greatest-Engineering-Achievements-of-the-20th-Century"
    description="The National Academy of Engineering's list of the 20 greatest engineering achievements of the 20th century, with detailed descriptions of each." >}}

{{< drg/next-page
    text="Now that you have explored one great engineering achievement"
    teaser="Learn about the many different types of engineers and how their work connects."
