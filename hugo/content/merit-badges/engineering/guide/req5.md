...
{{< drg/tip >}}
Write your requirements as a numbered list before you start designing. This list becomes your scorecard — when you have multiple design ideas, you can compare each one against the requirements to see which design best meets the need.
{{< /drg/tip >}}
...
|---|---|---|---|
| Holds 10 utensils | Yes | Yes | No |
| Folds flat | No | Yes | Yes |
| Costs under $15 | Yes | Yes | Yes |
| Weighs under 2 lbs | Yes | No | Yes |
| **Score** | **3/4** | **3/4** | **3/4** |
...
{{< drg/did-you-know >}}
James Dyson built 5,127 prototypes of his bagless vacuum cleaner over five years before getting the design right. Each failed prototype taught him something. The systems engineering approach does not guarantee success on the first try — it guarantees that you learn from every attempt.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="When Your Prototype Fails" >}}
Your first prototype does not work as planned. This is not a setback — it is engineering working exactly as it should.

- **Document what went wrong**: Write down the specific failure. Did a joint break? Did the mechanism bind? Was it too heavy?
- **Trace the cause**: Why did it fail? Wrong materials? Dimensions too small? Unexpected forces?
- **Redesign the weak point**: Focus your changes on the specific area that failed, not the entire design
- **Test again**: Each cycle of failure and improvement makes your design stronger

Engineers call this "failing forward" — every failure teaches you something you could not have learned any other way.
{{< /drg/be-prepared >}}
...
{{< drg/image src="images/systems-engineering-process.avif" alt="A step-by-step flow diagram showing the systems engineering process with eight labeled stages — Define Problem, Identify Requirements, Research, Generate Concepts, Select Design, Build Prototype, Test, and Refine — connected by arrows in a cycle" >}}

{{< drg/image src="images/prototype-building-workbench.avif" alt="A teenager in a Scout uniform at a workbench building a prototype from wood and simple materials, with sketches pinned to a corkboard behind them and basic tools visible" >}}

{{< drg/external-link
    title="NASA Systems Engineering Handbook (Simplified)"
    url="https://www.nasa.gov/reference/systems-engineering-handbook/"
    description="NASA's official systems engineering guide — see how the same design process you are learning scales up to spacecraft and space missions." >}}

{{< drg/next-page
    text="Now that you have designed your own engineering project"
    teaser="Choose two hands-on engineering activities to explore motion, electricity, electronics, materials, energy, transportation, or competition."
