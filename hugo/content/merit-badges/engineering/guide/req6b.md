...
For example, a 100-watt TV watched 5 hours per day:
(100 x 5 x 30) / 1,000 = **15 kWh per month**
...
{{< drg/tip >}}
If the label shows amps instead of watts, multiply by your home's voltage (120 volts in the US) to get watts. A hair dryer rated at 12.5 amps uses 12.5 x 120 = 1,500 watts.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The average American home uses about 886 kWh of electricity per month — roughly the same amount of energy contained in 75 pounds of coal. In some states, the average is much higher (Louisiana averages over 1,100 kWh) and in others much lower (Hawaii averages about 500 kWh).
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Never open electrical panels, modify wiring, or work with live electrical circuits. Reading your electric meter from the outside is safe, but leave any work inside the breaker box to a licensed electrician. If you use a kill-a-watt meter, only plug it into standard outlets — never attempt to measure hardwired appliances like your oven or central air conditioner.
{{< /drg/safety-first >}}

{{< drg/image src="images/home-electricity-audit.avif" alt="A teenager in a Scout uniform in a kitchen, crouching to read the label on the back of a microwave oven, with a notebook in hand documenting wattage information for an electricity audit" >}}

{{< drg/external-link
    title="U.S. Energy Information Administration — Electricity Explained"
    url="https://www.eia.gov/energyexplained/electricity/"
    description="Comprehensive guide to how electricity is generated, delivered, and used in the United States — with data on residential consumption by state." >}}

{{< drg/next-page
    text="Done investigating electricity usage?"
    teaser="Find out how your smartphone sends sound, video, and text across the world."
