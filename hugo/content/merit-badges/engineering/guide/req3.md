...
{{< drg/did-you-know >}}
There are over 40 recognized engineering specialties today, and new ones keep emerging. Genetic engineering, nanotechnology engineering, and robotics engineering did not exist as formal disciplines 30 years ago. The engineering field you end up working in might not have a name yet.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When you explain the relationship to your counselor, use a specific real-world example. Instead of saying "mechanical and electrical engineers both work on machines," say "a wind turbine needs mechanical engineers to design the blades and gearbox, and electrical engineers to design the generator and grid connection system." Concrete examples are always more convincing.
{{< /drg/tip >}}

{{< drg/image src="images/engineering-disciplines-diagram.avif" alt="A clean diagram showing six engineering fields — mechanical, civil, electrical, chemical, aerospace, and biomedical — arranged in a hexagonal grid with icons representing each field and lines connecting related disciplines" >}}

{{< drg/external-link
    title="Bureau of Labor Statistics — Engineers"
    url="https://www.bls.gov/ooh/architecture-and-engineering/home.htm"
    description="Detailed career profiles for every major engineering discipline, including job duties, education requirements, salary data, and growth outlook." >}}

{{< drg/next-page
    text="Now that you understand the range of engineering fields"
    teaser="Prepare to visit with a real engineer and learn about their day-to-day work."
