...
### Trustworthy
Engineers must be trusted with public safety. When a P.E. stamps a set of plans (as you learned in [Req 7](/merit-badges/engineering/guide/req7/)), they are saying "I stake my professional reputation on this being safe." Trustworthiness is the foundation of the engineering profession.
...
{{< drg/did-you-know >}}
After the Challenger disaster, the engineering profession created the concept of the "Order of the Engineer" — a ceremony inspired by a Canadian tradition where graduating engineers receive a stainless steel ring they wear on their working hand. The ring is a constant reminder of their ethical obligations every time they pick up a pen or type on a keyboard.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="The Pressure to Cut Corners" >}}
You are an engineer working on a construction project. The contractor asks you to approve a change that uses cheaper materials than your design specified. The cheaper materials meet the minimum building code but provide less of a safety margin than your original design.

- **What the code says**: Canon 1 — Hold paramount public safety. Canon 2 — Perform services only in your area of competence.
- **What you should do**: Review the proposed change carefully. If it compromises safety, refuse to approve it — even if the contractor is angry, even if it delays the project.
- **Why it matters**: Building codes are minimums, not targets. Engineers design above the minimum to account for unexpected loads, aging materials, and construction imperfections.
{{< /drg/be-prepared >}}
...
{{< drg/image src="images/ethics-comparison-chart.avif" alt="An infographic with two columns comparing the Scout Law points on the left with corresponding Engineering Code of Ethics canons on the right, with connecting lines showing parallels" >}}

{{< drg/external-link
    title="NSPE Code of Ethics for Engineers"
    url="https://www.nspe.org/career-growth/nspe-code-ethics-engineers"
    description="The full text of the NSPE Code of Ethics for Engineers — read all six fundamental canons and their detailed rules of practice." >}}

{{< drg/next-page
    text="Now that you understand the ethical foundation of engineering"
    teaser="Explore engineering careers and find out what it takes to become an engineer."
