---
title: "First Aid & Protection"
layout: guide
group_title: "1. Safety First"
req_number: "1b"
prev: "/merit-badges/woodwork/guide/req1a/"
prev_title: "Workshop Hazards"
next: "/merit-badges/woodwork/guide/req1c/"
next_title: "Totin"
---
...
{{< drg/tip >}}
Keep a pair of fine-point tweezers in your workshop first aid kit. The precision tips make splinter removal much easier than using standard tweezers.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Never use a tourniquet for a woodworking cut unless you have been specifically trained in tourniquet use and the bleeding is life-threatening. Direct pressure is the correct first response for the vast majority of workshop injuries.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/workshop-first-aid-kit.avif" alt="A well-stocked first aid kit mounted on a woodworking workshop wall, with the cabinet open showing bandages, gauze, antiseptic, tweezers, and eye wash, with a workbench visible in the background" >}}
...
{{< drg/checklist title="Eye Protection Rules" subtitle="Non-negotiable workshop habits" >}}
...
{{< drg/did-you-know >}}
Hearing damage from noise is cumulative and permanent. Your ears do not "heal" from loud noise the way a cut heals. Every unprotected exposure adds up over your lifetime.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/scout-dust-mask-sanding.avif" alt="A Scout wearing an N95 dust mask and safety glasses while hand-sanding a wooden project at a workbench, fine dust particles visible in a beam of sunlight" >}}

{{< drg/external-link
    title="CDC — Wood Dust Health Effects"
    url="https://www.cdc.gov/niosh/topics/wooddust/"
    description="Research and guidance on the health effects of wood dust exposure from the National Institute for Occupational Safety and Health." >}}

---

{{< drg/next-page
    text="You know how to stay safe and respond to injuries"
    teaser="Now earn the Totin' Chip — your license to use cutting tools."
