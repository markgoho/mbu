...
- **Purpose:** Shelter, tools, transportation, furniture — survival itself
- **Mindset:** Master the craft or go without
...
- **Purpose:** Creative expression, practical skills, career paths, personal satisfaction
- **Mindset:** Build something real — something you designed, measured, cut, and finished yourself
...
{{< drg/image src="images/woodwork-workshop-overview.avif" alt="A well-organized woodworking workshop with hand tools hanging on a pegboard wall, a sturdy workbench with wood shavings, and natural light streaming in" >}}
...
{{< drg/did-you-know >}}
The oldest known wooden structure in the world is a well in the Czech Republic, built around 5,256 BC. Its builders used mortise and tenon joints — the same technique you can learn in this merit badge.
{{< /drg/did-you-know >}}

{{< drg/image src="images/woodwork-joinery-closeup.avif" alt="A close-up photograph of beautifully crafted dovetail joints in light-colored hardwood, showing the precise interlocking fingers of the joint" >}}

---

{{< drg/next-page
    text="Before you pick up any tools"
    teaser="Learn how to stay safe in the workshop."
    url="/merit-badges/woodwork/guide/req1a/" >}}
