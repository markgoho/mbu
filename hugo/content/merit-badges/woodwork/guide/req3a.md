...
{{< drg/image src="images/hand-plane-shavings.avif" alt="A brass and wood hand plane sitting on a wooden workbench surrounded by thin curled wood shavings, with warm workshop lighting and a partially planed board visible" >}}
...
{{< drg/safety-first >}}
Before every work session, inspect each tool you plan to use. Check for loose handles, cracked blades, mushroomed striking faces, and damaged teeth. A broken tool in motion is unpredictable and dangerous. If a tool is damaged, set it aside and repair it before use.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Always measure from the same end of the tape, and when marking, make a V-shaped mark (not just a line) at the exact measurement point. The point of the V is more precise than a thick pencil line.
{{< /drg/tip >}}

## General Storage Principles

{{< drg/checklist title="Tool Storage Best Practices" subtitle="Keep your tools ready for the next project" >}}
...
{{< drg/image src="images/tool-chest-organized.avif" alt="A traditional wooden tool chest with the lid open, revealing neatly organized hand tools — chisels in a rack, saws in dividers, planes on a shelf, and small tools in compartments, with warm ambient lighting" >}}

{{< drg/external-link
    title="Popular Woodworking — Hand Tool Basics"
    url="https://www.popularwoodworking.com/article/hand-tool-basics/"
    description="A comprehensive guide to selecting, using, and maintaining hand tools for woodworking." >}}

---

{{< drg/next-page
    text="Now that you know how to care for your tools"
    teaser="Learn the essential skill of sharpening cutting edges."
