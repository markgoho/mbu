...
{{< drg/tip >}}
Many countries do not fit neatly into one category. The United Kingdom is both a democracy and a constitutional monarchy. China calls itself a "people's republic" but is governed as a single-party state. When you discuss government types with your counselor, it is fine to note that some countries blend elements of different systems.
{{< /drg/tip >}}
...
{{< drg/checklist title="Map Activity Checklist" subtitle="Steps to complete your world government map" >}}
...
{{< drg/external-link
    title="CIA World Factbook — Government Type"
...
{{< drg/next-page
    text="You have surveyed the world's government types."
    teaser="Learn how countries represent themselves abroad through ambassadors, consuls, and the machinery of diplomacy."
