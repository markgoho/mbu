...
1. **Go to [state.gov](https://www.state.gov/)** with a parent or guardian's permission.
...
{{< drg/tip >}}
Pick an issue that connects to something else in this merit badge. If you studied a particular country for Requirement 3b, see what the State Department says about U.S. relations with that country. If you explored international organizations in Requirement 4c, look up how the U.S. works with those organizations.
{{< /drg/tip >}}

{{< drg/external-link
    title="U.S. Department of State"
    url="https://www.state.gov/"
    description="The official website of the U.S. State Department — explore policy issues, country profiles, and how America engages with the world." >}}
...
- **BBC World News** ([bbc.com/news/world](https://www.bbc.com/news/world))
- **Al Jazeera English** ([aljazeera.com](https://www.aljazeera.com/))
- **Deutsche Welle (DW)** ([dw.com](https://www.dw.com/en/)) — Germany's international broadcaster
- **Reporters Without Borders** ([rsf.org](https://rsf.org/en)) — Tracks press freedom worldwide
- Your local library may carry foreign newspapers or provide access to international news databases.

{{< drg/did-you-know >}}
Reporters Without Borders publishes an annual World Press Freedom Index that ranks 180 countries on press freedom. In some countries ranked near the bottom, journalists face imprisonment or worse for reporting the truth.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Discussion Topics" subtitle="Questions to ask your international friend" >}}
...
{{< drg/tip >}}
Ask if you can try a traditional food together or attend a cultural event. Hands-on experiences stick with you much longer than facts from a textbook. Take notes during your conversation so you can share specifics with your counselor.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="World Organization of the Scout Movement — Events"
    url="https://www.scout.org/our-work/events"
    description="Find upcoming WOSM events, including Jamboree Over The Air and Jamboree Over The Internet, which you can participate in from home." >}}
...
{{< drg/be-prepared title="Making the Most of Your Event" >}}
To get the most out of your experience:
- **Step one**: Research the culture or country represented before you go.
- **Step two**: Take notes or photos (with permission) to share with your counselor.
- **Step three**: Talk to organizers or participants — ask about the significance of what you are seeing.
- **Step four**: Try something new — taste a food, learn a dance step, or try a craft.
...
{{< drg/next-page
    text="You have explored the world through research, conversations, and experiences."
    teaser="Go beyond the badge — discover deeper topics, real-world opportunities, and organizations that can keep you connected to the global community."
