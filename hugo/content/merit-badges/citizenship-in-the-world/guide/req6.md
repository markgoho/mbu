...
{{< drg/be-prepared title="Getting Your First Passport" >}}
If you do not have a passport yet, here is what to know:
- **Step one**: Get a passport application form (Form DS-11) from the State Department website or a local post office.
- **Step two**: Gather required documents — proof of citizenship (birth certificate), a photo ID, and a passport photo.
- **Step three**: Apply in person at an authorized passport acceptance facility (many post offices serve this role).
- **Step four**: Pay the application fee. Processing takes 6–8 weeks for standard service.
- **Step five**: Consider getting a passport card as well — it works for land and sea travel to Canada, Mexico, the Caribbean, and Bermuda.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="U.S. Department of State — Passports"
    url="https://travel.state.gov/content/travel/en/passports.html"
    description="Everything you need to know about applying for, renewing, or replacing a U.S. passport." >}}

{{< drg/external-link
    title="U.S. Department of State — About the Bureau of Global Public Affairs"
...
{{< drg/next-page
    text="You have learned how nations connect through diplomacy and travel."
    teaser="Choose two hands-on activities to explore the world through research, conversations, and real experiences."
