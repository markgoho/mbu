...
{{< drg/did-you-know >}}
The International Court of Justice, located in The Hague, Netherlands, has settled disputes between countries on topics ranging from border disagreements to fishing rights. Only countries (not individuals) can bring cases to the ICJ.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="International Court of Justice"
    url="https://www.icj-cij.org/"
    description="The official website of the ICJ — explore current cases and learn how international disputes are resolved." >}}
...
{{< drg/tip >}}
Search for news stories about trade disputes, tariff changes, or new trade agreements. Good sources include the Associated Press, Reuters, BBC Business, and the Wall Street Journal. Pick one story and use the trade concepts above to analyze what is happening and why.
{{< /drg/tip >}}

{{< drg/external-link
    title="World Trade Organization — What Is the WTO?"
    url="https://www.wto.org/english/thewto_e/whatis_e/whatis_e.htm"
    description="Learn how the WTO helps countries negotiate trade rules and settle trade disputes." >}}

---

## Option C: Global Organizations
...
{{< drg/be-prepared title="Preparing Your Organization Descriptions" >}}
For each of your two chosen organizations:
- **Step one**: Research the organization's history — when and why was it founded?
- **Step two**: Summarize its main mission in 1–2 sentences.
- **Step three**: Find a recent example of the organization in action (a news story, a project, a campaign).
...
{{< drg/next-page
    text="You have examined how nations connect through law, trade, and organizations."
    teaser="Discover the different types of government used around the world — and find them on a map."
