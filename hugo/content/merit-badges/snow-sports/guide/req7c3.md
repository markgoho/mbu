...
{{< drg/video
    title="How to Adjust Bindings (video)"
    url="https://youtu.be/1NQ-G0qn4UA" >}}

---

{{< drg/next-page
    text="You can use and maintain strap bindings, explain different binding methods, and explain the need for leashes."
    teaser="Learn the four types of snowboards and demonstrate how to carry a board safely."
