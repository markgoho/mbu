...
req_number: "7b2"
req_path: "7.b.2"
prev: "/merit-badges/snow-sports/guide/req7b1/"
prev_title: "Req 7b1 — Equipment Selection"
next: "/merit-badges/snow-sports/guide/req7b3/"
next_title: "Req 7b3 — Types of Nordic Skis"
---
...
{{< drg/tip >}}
When in doubt at any Nordic center, check the trail map for rules specific to that location. Rules may vary — for example, some centers allow classic skiing in snowshoe-only zones during low-traffic hours.
{{< /drg/tip >}}

---

{{< drg/next-page
    text="You can explain the reasons behind the common Nordic trail rules."
    teaser="Learn the different types of Nordic skis — classic, skating, touring, and telemark — and how each one is designed for its purpose."
