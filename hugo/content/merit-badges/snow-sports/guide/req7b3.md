...
{{< drg/tip >}}
For your counselor discussion, focus on the key differences: classic uses kick zones and a diagonal stride; skate uses no kick zone and a skating motion; touring is wider for off-track; telemark is for alpine descents with a free heel. You do not need to know every binding standard.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Types of Cross Country Skis (video)"
    url="https://youtu.be/oXIp-lJJH4E?si=yNMZNIMyDHQjO_uC" >}}

---

{{< drg/next-page
    text="You can discuss classic, skating, touring, and telemark skis and what makes each one suited to its discipline."
    teaser="Learn the basic principles of waxing for cross-country ski touring."
