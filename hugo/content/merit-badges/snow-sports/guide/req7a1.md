...
req_number: "7a1"
req_path: "7.a.1"
prev: "/merit-badges/snow-sports/guide/req7a/"
prev_title: "Req 7a — Downhill (Alpine) Skiing"
next: "/merit-badges/snow-sports/guide/req7a2/"
next_title: "Req 7a2 — American Teaching System"
---
...
- Have bindings tested and certified by a qualified technician every year — or whenever you switch to new boots. Only a certified technician should adjust the release setting.
...
- **Lower DIN settings** release more easily — appropriate for children, lighter skiers, beginners, or anyone who prefers quicker release.
- **Higher DIN settings** require more force to release — appropriate for heavier, more aggressive, or advanced skiers who generate greater forces in turns.
...
{{< drg/tip >}}
Always have your binding DIN setting verified by a ski shop technician whenever you get new boots or have not skied in more than a year. The setting is printed on a card that the technician gives you — keep it in your wallet.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="How to Wax Skis (video)"
    url="https://youtu.be/1Xt1gZfZ2Rw" >}}

{{< drg/video
    title="How to Test Ski Bindings (video)"
    url="https://youtu.be/Ix27SNEsRYM" >}}

{{< drg/video
    title="Ski Binding DIN Settings (video)"
    url="https://youtu.be/DkNAXgc2-rk?si=p-0U6YH1kIngZ47t" >}}
...
{{< drg/next-page
    text="You can show how to wax skis, maintain release bindings, and explain the DIN standard."
    teaser="Learn the American Teaching System and what a basic skiing progression looks like from beginner through advanced."
