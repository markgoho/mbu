...
- **Right ski kicks back → Left arm/pole plants and pushes**
- **Left ski kicks back → Right arm/pole plants and pushes**
...
- A visible glide phase after each kick — not just a shuffle

{{< drg/tip >}}
Watch your shadow on the snow on a sunny day. You should see your arms swinging opposite to your legs, and a brief moment where one leg is fully extended behind you during glide. If your shadow looks like you are shuffling with both skis always on the ground, focus on committing more fully to each kick.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Basic Moves on Cross-Country Skis (video)"
    url="https://youtu.be/ctrIUq9kCJI?si=QoPaYBG0365ZvZF1" >}}

---

{{< drg/next-page
    text="You can demonstrate effective cross-country propulsion with proper weight transfer, pole timing, rhythm, flow, and glide."
    teaser="Put it all together — complete a 4-mile tour demonstrating your ability to handle varied snow conditions."
