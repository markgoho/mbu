...
req_number: "7c11"
req_path: "7.c.11"
prev: "/merit-badges/snow-sports/guide/req7c-10/"
prev_title: "Req 7c10 — Varied Conditions"
next: "/merit-badges/snow-sports/guide/req7d/"
next_title: "Req 7d — Snowshoeing"
---

{{< drg/requirement number="7c11" >}}
...
{{< drg/tip >}}
For your counselor discussion, you need at least the AASI (instruction/certification), U.S. Ski & Snowboard (competition/Olympics), and either NSAA (resort safety) or NSP (on-mountain emergency response). Having all four shows thorough preparation.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="American Association of Snowboarding Instructors (video)"
    url="https://youtu.be/UrtwvLd2sbU" >}}

---

You have completed all the requirements for Option C — Snowboarding. If you chose another option, continue to that section. Otherwise, head to Extended Learning.

{{< drg/next-page
    text="You can name the major snowboarding organizations in the United States and explain the function of each."
    teaser="Option D — Snowshoeing starts here."
