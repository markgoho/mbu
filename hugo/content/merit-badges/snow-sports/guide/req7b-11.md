...
2. Lift one ski and swing the tip far forward, then rotate the ski 180° so it points in the opposite direction and place it on the snow.
...
{{< drg/tip >}}
Plant both poles uphill for stability during a kick turn. Try to practice on easy slopes before attempting kick turns on steep terrain.
{{< /drg/tip >}}
...
{{< drg/video
    title="Dealing With Hills (video)"
    url="https://youtu.be/MWskz4ZnPl4?si=pyET65PzEaPCW94o" >}}
...
{{< drg/next-page
    text="You can demonstrate traverses, kick turns, sidesteps, and pole drag for navigating steep Nordic terrain."
    teaser="Option C — Snowboarding starts here."
