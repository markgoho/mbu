...
{{< drg/tip >}}
The most important first aid steps are often the simplest: stay calm, protect the scene, keep the person still and warm, and get help. You do not need to be a paramedic to make a real difference.
{{< /drg/tip >}}
...
2. **Do not move a seriously injured person** unless they are in immediate danger. A fall hard enough to cause a loss of consciousness or spine injury requires ski patrol — not a well-meaning bystander.

3. **Send someone to get help — or go yourself.** At most resorts, ski patrol can be reached by:
...
{{< drg/did-you-know >}}
National Ski Patrol volunteers and professionals respond to more than 600,000 incidents in the United States each year. Many are trained as Emergency Medical Technicians (EMTs) or Outdoor Emergency Care (OEC) technicians.
{{< /drg/did-you-know >}}

## Official Resources

{{< drg/video
    title="How to Report an Accident to the Ski Patrol (video)"
    url="https://youtu.be/Zl0ZyNoox8M?si=xgYuHNUn5izc4HA7" >}}
...
{{< drg/next-page
    text="You can explain why every participant must be ready to help and how to report an accident to ski patrol."
    teaser="Learn the symbols, colors, and signs that tell you how difficult every run is — and what terrain to avoid."
