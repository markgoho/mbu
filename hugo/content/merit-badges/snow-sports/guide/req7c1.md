...
req_number: "7c1"
req_path: "7.c.1"
prev: "/merit-badges/snow-sports/guide/req7c/"
prev_title: "Req 7c — Snowboarding"
next: "/merit-badges/snow-sports/guide/req7c2/"
next_title: "Req 7c2 — Equipment Selection"
---

{{< drg/requirement number="7c1" >}}
...
**Shoulder injuries**
When you fall onto an outstretched arm, the force can travel up the arm to the shoulder, causing AC joint separations (where the collarbone meets the shoulder blade) or dislocations.
...
**Facial injuries**
A board edge or hard snow contact with the face can cause cuts, broken noses, and eye injuries.
...
**Concussion**
Forward falls can involve head contact with the snow if your momentum carries you over your outstretched arms.
...
3. **Roll** with the momentum rather than slamming to a stop — a rolling fall reduces peak impact force.
4. **Wear wrist guards** — especially as a beginner, when falls are most frequent.

{{< drg/tip >}}
Falling on relaxed, bent arms is safer than trying to stop yourself with stiff, locked-out arms. Practice the relaxed-arm fall before you need it. Many snowboard lessons start with falling practice on flat or very gentle terrain for exactly this reason.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="How to Fall on a Snowboard (video)"
    url="https://youtu.be/pAuRz-QP5tM" >}}

---

{{< drg/next-page
    text="You can discuss forward-fall injuries in snowboarding and how to reduce the risk."
    teaser="Learn how to select the right snowboard, boots, and gear for safety and comfort."
