...
{{< drg/checklist title="One-Day Ski Tour Checklist" subtitle="Review before every outing" >}}
...
{{< drg/tip >}}
Keep your water and food in an inside jacket pocket on cold days. Hydration bladder tubes freeze. Cold food is harder to eat and provides less motivation to stop and refuel. Warm hands and accessible snacks keep you moving.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Gear Checklist for a Day Tour (video)"
    url="https://youtu.be/3rHuEqZgUMc" >}}

---

{{< drg/next-page
    text="You have a complete gear list for a one-day ski tour."
    teaser="Learn to use a topographic map and compass — essential skills for any off-trail Nordic adventure."
