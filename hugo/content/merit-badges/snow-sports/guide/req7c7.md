...
{{< drg/inherited-requirement number="7c7a" req_path="7.c.7.a" topic="On a gentle slope, demonstrate beginning snowboarding maneuvers. Show basic ways to control speed and direction. Include the sideslipping maneuver." />}}
...
{{< drg/video
    title="Beginning Snowboard Maneuvers (video)"
    url="https://youtu.be/9YGruvaETK4" >}}

{{< drg/video
    title="How to Make Your Board Go Straight (video)"
    url="https://youtu.be/UoPxRNsLrZ8" >}}

---

## Requirement 7c7b

{{< drg/inherited-requirement number="7c7b" req_path="7.c.7.b" topic="On slightly steeper terrain, show traversing." />}}
...
{{< drg/tip >}}
Keep your head and eyes level on the horizon, not tilted with the slope. Looking at the slope rather than across the horizon throws off your balance and makes traversing feel unsteady.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Maneuvering Hills & Traversing the Slope (video)"
    url="https://youtu.be/eIcLMojBopA" >}}

---

{{< drg/next-page
    text="You can demonstrate beginning snowboarding maneuvers and traversing on slightly steeper terrain."
    teaser="Move to a moderate slope and learn three freestyle techniques: the ollie, nose-end grab, and wheelie."
