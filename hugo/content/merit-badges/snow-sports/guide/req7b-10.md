...
{{< drg/safety-first >}}
Turn back before you are exhausted. The second half of the tour requires the same energy as the first half. A common mistake is pushing too hard in the first two miles and struggling to return. If you feel significantly tired at the halfway point, reassess your pace and remaining energy reserves.
{{< /drg/safety-first >}}

## Official Resources

{{< drg/video
    title="Skiing on Varied Conditions (video)"
    url="https://youtu.be/nCqNLC8PzNM?si=_vD2U1nIhE-khHVQ" >}}

---

{{< drg/next-page
    text="You have completed a 4-mile Nordic tour, handling varied snow conditions throughout."
    teaser="Learn the techniques for dealing with steep hills and difficult conditions — traverses, kick turns, sidesteps, and pole drag."
