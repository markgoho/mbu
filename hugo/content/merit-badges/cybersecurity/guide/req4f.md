...
{{< drg/did-you-know >}}
The website "Have I Been Pwned" (haveibeenpwned.com) tracks data breaches. Enter your email address and it tells you which breaches have exposed your information. Most people discover their email has been included in multiple breaches they never knew about.
{{< /drg/did-you-know >}}
...
- IoT devices (you will explore these more in [Req 7](/merit-badges/cybersecurity/guide/req7/))
...
- Your digital footprint from [Req 1b](/merit-badges/cybersecurity/guide/req1b/)

## Creating Your List

Here is how to systematically map your attack surface:

{{< drg/checklist title="Attack Surface Inventory" subtitle="Go through each category and list everything" >}}
...
- **Use unique passwords** for every account (a password manager helps — covered in [Req 5c](/merit-badges/cybersecurity/guide/req5c/)).

{{< drg/tip >}}
Your attack surface audit is something worth updating periodically — maybe every few months. New devices, new accounts, and new apps continuously expand your surface. Think of it like cleaning your room: if you never tidy up, the mess grows until it is overwhelming.
{{< /drg/tip >}}

{{< drg/external-link
    title="Connected Devices — Keys to Cybersecurity"
    url="https://cyber.org/find-curricula/connected-devices-keys-cybersecurity"
    description="A lesson module from Cyber.org about managing the security of your connected devices." >}}

{{< drg/image src="images/attack-surface-map.avif" alt="Infographic showing a teenager with radiating connections to their digital attack surface: devices, accounts, and networks" >}}

{{< drg/next-page
    text="Now that you have mapped your attack surface"
    teaser="learn about the technologies that defend against all these threats."
