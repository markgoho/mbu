...
{{< drg/did-you-know >}}
The cybersecurity field has a 0% unemployment rate — demand for qualified professionals far exceeds supply. The U.S. has over 500,000 unfilled cybersecurity positions, and the global shortage exceeds 3 million. This gap is expected to persist for years, making cybersecurity one of the most job-secure career paths available.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Career Research Guide" subtitle="Answer these questions for your chosen career" >}}
...
{{< drg/tip >}}
If an in-person visit is not possible, many cybersecurity professionals are active on LinkedIn and are willing to do informational interviews over video calls. Your Scout leader or counselor may be able to help you connect with someone in the field. You can also attend virtual cybersecurity career events — many organizations like CISA and ISC² host free online career days.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="Careers in Cybersecurity — CompTIA Future of Tech"
    url="https://www.futureoftech.org/cybersecurity/6-careers-in-cybersecurity/"
    description="Explore cybersecurity career paths, required skills, and how to get started in the field." >}}

{{< drg/external-link
    title="Degrees & Certifications — Cyber.org"
    url="https://cyber.org/career-exploration/degrees-certifications"
    description="Learn about the education and certification pathways into cybersecurity careers." >}}

{{< drg/image src="images/cybersecurity-career-paths.avif" alt="Career progression infographic showing paths from Entry Level to Security Analyst, Penetration Tester, Forensics Investigator, Security Engineer, and CISO" >}}

{{< drg/next-page
    text="You have explored the career possibilities in cybersecurity"
    teaser="go deeper with extended learning resources, competitions, and organizations."
    url="/merit-badges/cybersecurity/guide/extended-learning/" >}}
