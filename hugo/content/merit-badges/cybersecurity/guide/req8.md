...
{{< drg/tip >}}
Start with picoCTF's practice challenges at picoctf.org. They are free, available year-round, and organized by difficulty level. Even if you have never done a CTF before, the beginner challenges will teach you real skills while being genuinely fun to solve.
{{< /drg/tip >}}

{{< drg/external-link
    title="CyberPatriot — National Youth Cyber Defense Competition"
    url="https://www.uscyberpatriot.org/"
    description="The premier youth cyber defense competition. Learn about teams, seasons, and how to register." >}}

{{< drg/external-link
    title="picoCTF — Free Cybersecurity Competition"
    url="https://picoctf.org/"
    description="A free, beginner-friendly Capture The Flag competition from Carnegie Mellon University with year-round practice challenges." >}}
...
{{< drg/did-you-know >}}
Professional cybersecurity experts regularly compete in CTF competitions to sharpen their skills. DEF CON, one of the world's largest hacking conferences, hosts a CTF that is considered the "Super Bowl of hacking." Teams from government agencies, tech companies, and universities compete for the title.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Presentation Checklist" subtitle="Make your presentation effective and engaging" >}}
...
{{< drg/external-link
    title="K-12 Cybersecurity Games — UTSA CIAS"
    url="https://cias.utsa.edu/k-12/cybersecurity-games/"
    description="Free cybersecurity games and activities designed for K-12 students, perfect for troop presentations or competitions." >}}

{{< drg/image src="images/scouts-cyber-competition.avif" alt="Four teenagers gathered around laptops in a CTF-style cybersecurity competition with a scoreboard in the background" >}}

{{< drg/next-page
    text="You have put your cybersecurity skills to the test"
    teaser="explore the career possibilities that cybersecurity opens up."
