...
req_number: "3a"
prev: "/merit-badges/cybersecurity/guide/req2b/"
prev_title: "Req 2b — Ethical Behavior"
next: "/merit-badges/cybersecurity/guide/req3b/"
next_title: "Req 3b — The CIA Triad"
---
...
{{< drg/did-you-know >}}
In 2016, a massive cyberattack called the Mirai botnet took down major websites including Twitter, Netflix, and Reddit — not by attacking those sites directly, but by hijacking over 600,000 home devices like security cameras and routers that had weak default passwords. Your home router could be a weapon without you knowing.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Cyberattacks on critical infrastructure are not hypothetical. In 2021, attackers used ransomware to shut down Colonial Pipeline, which supplies roughly 45% of the fuel to the eastern United States. Gas stations ran dry, airlines could not refuel, and it took days to restore operations. In the same year, a hacker attempted to change the chemical levels at a Florida water treatment plant to dangerous concentrations. An alert operator caught the change in time.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Make it personal. Instead of saying "hospitals need protection," say "If the hospital where my grandmother gets her heart medication was hit by ransomware, doctors might not be able to access her medical records to know what she is allergic to." Concrete examples show real understanding.
{{< /drg/tip >}}

{{< drg/external-link
    title="Cybersecurity in Critical Infrastructure"
    url="https://www.cyberdefensemagazine.com/cybersecurity-in-critical-infrastructure-protecting-power-grids-and-smart-grids/"
    description="A detailed look at how cybersecurity protects the power grids and smart grids that keep our lights on." >}}

{{< drg/image src="images/systems-to-protect-layers.avif" alt="Three concentric layers of computer systems: Personal Devices, Business Systems, and Critical Infrastructure" >}}

{{< drg/next-page
    text="Now you understand what needs protecting"
    teaser="learn the three fundamental principles that guide all cybersecurity — the CIA Triad."
