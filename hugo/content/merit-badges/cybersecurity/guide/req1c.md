...
{{< drg/tip >}}
Adjust your screen brightness to match the room around you. If your screen looks like a light source in the room, it is too bright. If it looks dull and gray, it is too dim. Matching the ambient light reduces eye fatigue significantly.
{{< /drg/tip >}}
...
{{< drg/checklist title="Workstation Ergonomics" subtitle="Set up your desk to prevent injury" >}}
...
{{< drg/safety-first >}}
If a device's battery is swelling (the case is bulging or the screen is separating), stop using it immediately. Do not try to puncture or remove the battery yourself. Place the device in a cool, non-flammable area away from anything that could catch fire and take it to a professional for safe disposal.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="Distracted on the Trail" >}}
You are hiking on a Scout outing and want to check the trail map on your phone. You glance down while walking and trip on a root, twisting your ankle on a rocky slope.

- **Prevention:** Stop walking before looking at your phone. Step off the trail if needed. It takes two seconds.
- **If it happens:** Apply RICE — Rest, Ice (cool water from a stream works), Compression, Elevation. Refer to your [First Aid](/merit-badges/first-aid/) training for sprains and strains.
- **The bigger lesson:** The wilderness has more trip hazards than a sidewalk. If looking at your phone on a city street is risky, doing it on a trail is even more so.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Computer Ergonomics for Kids"
    url="https://www.kidsplus.com/parent-resources/doctors-notes/computer-ergonomics/"
    description="Guidance from pediatric specialists on setting up ergonomic workstations for young people." >}}

{{< drg/image src="images/ergonomic-desk-setup.avif" alt="Side-view diagram of proper computer workstation ergonomics showing screen at eye level, elbows at 90 degrees, feet flat on floor" >}}

{{< drg/next-page
    text="You have covered the physical and digital safety basics"
    teaser="now explore how the Scout Law applies to your online behavior."
