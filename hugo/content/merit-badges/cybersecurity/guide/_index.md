...
{{< drg/image src="images/cybersecurity-digital-shield.avif" alt="A glowing digital shield icon overlaid on a network of connected devices including a laptop, smartphone, smart home hub, and gaming console" >}}
...
{{< drg/did-you-know >}}
The first computer password was created at MIT in 1961 for the Compatible Time-Sharing System. Within a year, a researcher figured out how to print the password file and shared everyone's passwords. Security problems are literally as old as computer passwords themselves.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
OpSec is the area where you personally have the most power. You cannot control every firewall on the internet, but you can control whether you use strong passwords, update your software, and think before you click.
{{< /drg/tip >}}
...
{{< drg/image src="images/cybersecurity-domains-overview.avif" alt="Five domains of cybersecurity: Network Security, Application Security, Information Security, Operational Security, and Personal Security" >}}

{{< drg/next-page
    text="Now that you know what cybersecurity is and why it matters"
    teaser="start with the foundation — keeping yourself safe online."
    url="/merit-badges/cybersecurity/guide/req1a/" >}}
