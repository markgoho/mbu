...
req_number: "1b"
prev: "/merit-badges/cybersecurity/guide/req1a/"
prev_title: "Digital Safety Video"
next: "/merit-badges/cybersecurity/guide/req1c/"
next_title: "Physical Safety"
---
...
{{< drg/did-you-know >}}
The average person has over 100 online accounts. Each one stores personal data — email addresses, birthdays, phone numbers, browsing habits. Even "deleted" accounts often retain your data in their servers for years.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Privacy Settings Audit" subtitle="Check these on every platform you use" >}}
...
{{< drg/tip >}}
Go through your phone's app permissions right now. On both iPhone and Android, you can see exactly which apps have access to your camera, microphone, location, and contacts. Revoke any permission that does not make sense. A flashlight app has no reason to access your contacts.
{{< /drg/tip >}}
...
- **Talk to a parent or guardian.** If you genuinely want to meet an online friend, involve an adult. Any legitimate person will understand.
- **Never go alone.** If a meeting is arranged with parental approval, do it in a public place with an adult present.
- **Trust your instincts.** If something feels off about the request, it probably is.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    title="Protecting Your Digital Footprint — Keys to Cybersecurity"
    url="https://cyber.org/find-curricula/protecting-your-digital-footprint-keys-cybersecurity"
    description="A curriculum module from Cyber.org on understanding and managing your digital footprint." >}}

{{< drg/image src="images/digital-footprint-trail.avif" alt="A trail of digital footprints containing icons for social media, location, search, shopping, and gaming" >}}

{{< drg/next-page
    text="You now know how to protect your information online"
    teaser="but what about protecting your body? Learn about the physical safety risks of device use."
