...
{{< drg/did-you-know >}}
Research shows that people are 2–3 times more likely to say something hurtful online than they would face-to-face. Psychologists call this the "online disinhibition effect" — the feeling that screens and anonymity remove consequences for bad behavior. Being a Scout means resisting that pull.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Choose at least one point that you find *genuinely difficult* to follow online. It is easy to say "I am trustworthy" — it is more meaningful to say "I struggle with being courteous in online arguments, and here is what I am working on." Honest self-reflection will make a strong impression on your counselor.
{{< /drg/tip >}}

{{< drg/external-link
    title="Code of Ethics — EC-Council"
    url="https://www.eccouncil.org/code-of-ethics/"
    description="A professional cybersecurity code of ethics that mirrors many Scout Law principles in a technical context." >}}

{{< drg/image src="images/scout-law-digital-icons.avif" alt="Six points of the Scout Law represented as icons connected to digital scenarios: Trustworthy, Loyal, Brave, Kind, Courteous, and Helpful" >}}

{{< drg/next-page
    text="Now that you have connected the Scout Law to digital life"
    teaser="explore specific ethical scenarios you might encounter in cyberspace."
