...
req_number: "3a"
prev: "/merit-badges/home-repairs/guide/req3/"
prev_title: "Req 3 — Shop and Structure Projects"
next: "/merit-badges/home-repairs/guide/req3b/"
next_title: "Req 3b — Building a Workbench"
---
...
{{< drg/video
    title="80 Tool Storarge Ideas (video)"
    url="https://www.youtube.com/watch?v=txhES7lKfCI" >}}

{{< drg/video
    title="Easy Scrap Wood Yard Tool Organizer (video)"
    url="https://www.youtube.com/shorts/L0CgzmPzOeI" >}}
...
{{< drg/checklist title="Storage Design Questions" subtitle="Plan before you install or build" >}}
...
{{< drg/tip >}}
Arrange the most-used tools where they are easiest to reach. Good storage is not only about fitting everything in. It is about making the next repair smoother and safer.
{{< /drg/tip >}}

In [Req 2a — Yard Tool Tune-Up](/merit-badges/home-repairs/guide/req2a/), you learned why tool storage affects tool life. This requirement turns that idea into a permanent solution.

{{< drg/next-page
    text="You now know how a thoughtful storage system protects tools and makes work more efficient."
    teaser="Next, learn how to build one of the most useful fixtures in any shop: a stable workbench."
