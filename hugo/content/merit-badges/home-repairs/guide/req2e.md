...
{{< drg/video
    title="How to Repair a Window Screen (video)"
    url="https://youtu.be/t7emMleueHg" >}}
...
{{< drg/image src="images/screen-repair-parts-layout.avif" alt="Top-down layout of a screen frame, mesh, spline, and roller tool before assembly" >}}
...
{{< drg/safety-first >}}
Use a flat, stable surface and keep hands out of the blade path while trimming mesh. If the frame is bent or the corners are loose, show that problem to your supervising adult before installing new material.
{{< /drg/safety-first >}}
...
That is the same judgment you used in [Req 2d — Patching Concrete or Asphalt](/merit-badges/home-repairs/guide/req2d/): first understand the condition, then choose the repair method that fits.

{{< drg/checklist title="What to Point Out to Your Counselor" subtitle="Show the difference between a quick patch and a neat repair" >}}
...
{{< drg/next-page
    text="You now understand how screen mesh, spline, and careful trimming create a neat repair."
    teaser="The next option raises the stakes: learn the caution and patience needed to replace broken window glass safely."
