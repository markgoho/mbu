...
{{< drg/video
    title="How to Paint a Wall (video)"
    url="https://www.youtube.com/watch?v=ftDSnccAx_Q" >}}
...
{{< drg/checklist title="Painting Habits That Improve Results" subtitle="Simple steps that matter more than people expect" >}}
...
{{< drg/next-page
    text="You now know why clean prep, even coverage, and careful cleanup shape a good paint job."
    teaser="Next, repair damaged flooring and learn how patching a surface depends on accurate fit and material matching."
