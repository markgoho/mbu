...
{{< drg/tip >}}
Call at least two weeks in advance. Let the office know you will want to ask questions afterward, so they can plan a few extra minutes. If you are scheduling during a regular cleaning appointment, mention the merit badge when you book.
{{< /drg/tip >}}
...
{{< drg/image src="images/scout-dental-visit-prep.avif" alt="A Scout in a clean Scout uniform sitting in a dental office waiting room, reviewing a small notebook of prepared questions" >}}
...
The dentist or hygienist starts by reviewing your medical history. They need to know about medications, allergies, and health conditions that could affect your dental care. This happens because your mouth is connected to the rest of your body — a concept you will explore more in [Req 5b](/merit-badges/dentistry/guide/req5/).
...
The dentist or hygienist measures the depth of the gum pockets around each tooth using a thin instrument called a **periodontal probe**. Healthy pockets are 1–3 millimeters deep. Pockets deeper than 4 mm suggest gum disease — the same condition you studied in [Req 2a](/merit-badges/dentistry/guide/req2a/).
...
You already learned to read X-rays in [Req 1](/merit-badges/dentistry/guide/req1/), so you should recognize some of what appears on the screen.
...
{{< drg/did-you-know >}}
Disclosing tablets use a harmless vegetable dye that stains plaque but washes off clean teeth. Some newer versions use two colors — one for new plaque (less than 24 hours old) and another for old plaque (more than 48 hours old), so you can see which spots you have been missing consistently.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Visit Preparation Checklist" subtitle="Before your dental office visit" >}}
...
{{< drg/image src="images/dental-exam-steps.avif" alt="An infographic showing six steps of a dental checkup: medical history review, visual exam, periodontal probing, X-ray, professional cleaning, and findings discussion" >}}

{{< drg/external-link
    title="Mouth Healthy — Dental Visit"
    url="https://www.mouthhealthy.org/en/dental-care-concerns/questions-about-going-to-the-dentist"
    description="The ADA's patient-friendly guide to what happens during a dental visit and how to prepare." >}}

{{< drg/next-page
    text="You are prepared for a great dental office visit."
    teaser="Explore the instruments and equipment dentists use every day — and try your hand at some dental lab work."
