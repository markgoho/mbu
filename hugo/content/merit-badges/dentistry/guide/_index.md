...
{{< drg/image src="images/scout-dental-office-tour.avif" alt="A Scout in a clean Scout uniform receiving a tour of a modern dental office, looking at equipment with interest while a dentist in a white coat gestures toward the dental chair and instruments" >}}
...
- **Tools:** Iron pliers, hand drills, herbal pastes
- **Approach:** Wait until it hurts, then pull it out
- **Legacy:** Fauchard's scientific approach laid the foundation for everything that followed
...
- **Tools:** Digital X-rays, intraoral cameras, 3D printers, lasers
- **Approach:** Prevent problems before they start
- **Impact:** The average American today has far fewer cavities than their grandparents did at the same age

{{< drg/did-you-know >}}
In 1900, the average American lost all of their teeth by age 50. Today, thanks to fluoride, better hygiene, and preventive care, most Americans keep the majority of their natural teeth for life.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/dental-history-comparison.avif" alt="Split image showing a medieval barber-surgeon scene with simple iron tools on the left, and a modern dental office with digital screens, an adjustable chair, and high-tech equipment on the right" >}}
...
{{< drg/safety-first >}}
If you experience a serious mouth or jaw injury — a broken jaw, a tooth knocked completely out, or heavy bleeding that will not stop — get to an emergency room or oral surgeon immediately. Time matters, especially for saving a knocked-out tooth (you will learn exactly what to do in Requirement 2c).
{{< /drg/safety-first >}}
...
{{< drg/image src="images/dental-specialties-overview.avif" alt="An infographic showing six icons representing dental specialties: General, Orthodontics, Oral Surgery, Pediatric, Periodontics, and Cosmetic, arranged in a clean grid layout" >}}

{{< drg/tip >}}
When you visit a dentist for Requirement 3, ask which specialty they practice and what drew them to it. Most dentists love talking about why they chose their field.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You now know the history, branches, and scope of modern dentistry."
    teaser="Dive into the anatomy of a tooth — and learn to read dental X-rays like a professional."
    url="/merit-badges/dentistry/guide/req1/" >}}
