...
Remember those plaque-prone zones you marked on your molar drawing in [Req 1](/merit-badges/dentistry/guide/req1/)? Now you are going to learn exactly what happens in those zones when plaque, sugar, and acid work together to attack your teeth.
...
{{< drg/did-you-know >}}
There are over 700 species of bacteria that can live in your mouth. A single milliliter of saliva contains roughly 100 million bacterial cells. Most are harmless — but a few troublemakers can cause serious damage if plaque is not removed regularly.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
If you are going to eat something sweet, eat it with a meal rather than as a standalone snack. Your mouth produces more saliva during meals, which helps rinse away sugar and neutralize acid.
{{< /drg/tip >}}
...
{{< drg/image src="images/decay-cycle-diagram.avif" alt="A circular diagram showing four stages of tooth decay: sugar enters the mouth, plaque bacteria consume sugar and produce acid, acid dissolves enamel minerals, and saliva repairs the damage" >}}
...
{{< drg/safety-first >}}
If your gums bleed every time you brush, do not ignore it. Bleeding gums are not normal — they are a warning sign of gingivitis. Tell a parent or guardian and schedule a dental visit. Caught early, gum disease is easy to reverse.
{{< /drg/safety-first >}}

{{< drg/image src="images/healthy-vs-gingivitis-gums.avif" alt="A comparison showing healthy gums on the left — pink, firm, and fitting snugly around teeth — versus gums with gingivitis on the right — red, swollen, and slightly pulled away from the teeth" >}}
...
You will learn more about fluoride's protective role in [Req 5](/merit-badges/dentistry/guide/req5/).

{{< drg/external-link
    title="NIDCR — Tooth Decay (Dental Caries)"
    url="https://www.nidcr.nih.gov/health-info/tooth-decay"
    description="The National Institute of Dental and Craniofacial Research explains the science of tooth decay in plain language." >}}

{{< drg/next-page
    text="You now understand how plaque, sugar, and acid team up to cause decay and gum disease."
    teaser="Learn what happens when teeth are damaged by impact — and how mouth guards can prevent it."
