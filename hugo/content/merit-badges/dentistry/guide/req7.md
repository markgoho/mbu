...
Hygienists are licensed professionals who specialize in preventive oral care. They perform cleanings, take X-rays, apply fluoride and sealants, and educate patients about oral hygiene. If you had your teeth cleaned at the dental office for [Req 3](/merit-badges/dentistry/guide/req3/), a hygienist likely did that work.
...
{{< drg/did-you-know >}}
Dental hygiene is consistently ranked as one of the best healthcare jobs in America for work-life balance. Many hygienists work only three or four days per week and still earn a full-time salary.
{{< /drg/did-you-know >}}
...
Lab technicians create the crowns, bridges, dentures, and orthodontic appliances that dentists design. This is a craft-based career that combines science with artistry. If you made a dental stone cast in [Req 4b](/merit-badges/dentistry/guide/req4/), you got a small taste of lab work.
...
{{< drg/image src="images/dental-careers-spectrum.avif" alt="An infographic showing six dental career paths from shortest to longest education: dental assistant, dental hygienist, lab technician, general dentist, orthodontist, and oral surgeon" >}}

## Researching Your Chosen Career

For the career you choose to research in depth, gather information on these topics:

{{< drg/checklist title="Career Research Guide" subtitle="Information to discuss with your counselor" >}}
...
{{< drg/external-link
    title="Bureau of Labor Statistics — Dentists"
    url="https://www.bls.gov/ooh/healthcare/dentists.htm"
    description="The BLS Occupational Outlook Handbook provides detailed data on education, pay, job outlook, and working conditions for dental careers." >}}

{{< drg/external-link
    title="ADA — Careers in Dentistry"
    url="https://www.ada.org/resources/careers"
    description="The American Dental Association's career exploration resources, including information on dental school, specialties, and related careers." >}}

{{< drg/tip >}}
The best research often comes from talking to people who do the job. If you met a dentist, hygienist, or assistant during your [Req 3](/merit-badges/dentistry/guide/req3/) visit, ask if they would be willing to answer a few questions about their career path, what they enjoy, and what surprised them about the profession.
{{< /drg/tip >}}

{{< drg/image src="images/dental-professional-at-work.avif" alt="A dental professional in scrubs and a white coat examining a digital X-ray on a wall-mounted screen in a modern dental office" >}}

{{< drg/next-page
    text="You have explored the diverse career paths available in dentistry."
    teaser="Go beyond the badge requirements — discover advanced topics, real-world experiences, and organizations that can deepen your interest in dental science."
