...
{{< drg/did-you-know >}}
The American Dental Association estimates that mouth guards prevent approximately 200,000 oral injuries in high school and college football alone each year. Athletes who do not wear mouth guards are 60 times more likely to suffer dental injuries.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
If you wear braces, ask your orthodontist about a mouth guard designed for braces. Standard boil-and-bite guards can damage brackets and wires. Your orthodontist may recommend a custom guard that fits over your braces and protects both your teeth and your hardware.
{{< /drg/tip >}}

{{< drg/image src="images/three-mouth-guard-types.avif" alt="Three mouth guards displayed side by side: a generic stock guard, a boil-and-bite guard, and a custom-fitted guard, each labeled" >}}
...
{{< drg/safety-first >}}
A mouth guard only works if you actually wear it. Keep it in your gear bag so it is always available, replace it each season or when it shows signs of wear, and rinse it with cold water after each use. A mouth guard that sits in your locker does nothing to protect your teeth.
{{< /drg/safety-first >}}

{{< drg/image src="images/scout-sports-mouth-guard.avif" alt="A teenager in a clean Scout uniform putting on a mouth guard before a flag football game, with other Scouts visible in the background on a grassy field" >}}

{{< drg/external-link
    title="ADA — Mouth Guards"
    url="https://www.mouthhealthy.org/en/az-topics/m/mouthguards"
    description="The American Dental Association's guide to choosing and caring for mouth guards." >}}

{{< drg/next-page
    text="You now know what causes dental trauma and how mouth guards prevent it."
    teaser="Learn the critical first-aid steps that can save a knocked-out tooth — timing is everything."
