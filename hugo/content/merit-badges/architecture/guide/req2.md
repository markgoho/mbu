...
In following the Leave No Trace Seven Principles and the Outdoor Code, Scouts pledge to "Travel and camp on durable surfaces" and to "Leave what you find" and to "Be conservation-minded." Discuss the following with your counselor:
{{< /drg/requirement >}}
...
{{< drg/did-you-know >}}
Buildings account for nearly 40% of all energy used in the United States and about 30% of greenhouse gas emissions. Designing greener buildings is one of the most impactful ways to fight climate change.
{{< /drg/did-you-know >}}

{{< drg/image src="images/green-building-features.avif" alt="A cutaway diagram of a green building showing labeled sustainable features: solar panels on roof, green roof section, rainwater collection system, large windows for natural light, and high-performance insulation in walls" >}}
...
{{< drg/tip >}}
A simple way to remember the difference: **Renewable** = nature makes more. **Recycled** = humans reuse what already exists. Both reduce the demand for new raw materials, but they work in different ways.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="U.S. Green Building Council — What Is Green Building?"
    url="https://www.usgbc.org/articles/what-green-building"
    description="The organization behind LEED certification explains green building principles, benefits, and how sustainable design impacts communities." >}}
...
{{< drg/did-you-know >}}
The Tate Modern in London was originally the Bankside Power Station, which burned oil to generate electricity. When it closed in 1981, architects converted its massive turbine hall — a room big enough to hold a small aircraft — into one of the world's most dramatic art galleries.
{{< /drg/did-you-know >}}

{{< drg/tip >}}
For your counselor conversation, try to find an example of adaptive reuse in your own community or region. Local examples show that you understand the concept beyond textbook cases — and your counselor will be impressed that you did the extra research.
{{< /drg/tip >}}

{{< drg/image src="images/adaptive-reuse-example.avif" alt="A before-and-after comparison showing an old industrial warehouse on the left and the same building converted into a modern community space with large windows, outdoor seating, and greenery on the right" >}}
...
{{< drg/next-page
    text="You now understand sustainable architecture, green building features, and adaptive reuse."
    teaser="See what it is like to work as a professional architect — by meeting one in person."
