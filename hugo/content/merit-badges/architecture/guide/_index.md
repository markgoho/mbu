...
{{< drg/image src="images/scout-examining-building.avif" alt="A Scout looking up at an interesting building facade, holding a sketchbook and pencil" >}}
...
{{< drg/did-you-know >}}
The average American home has grown from about 980 square feet in the 1950s to over 2,300 square feet today — even though family sizes have gotten smaller.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/institutional-buildings.avif" alt="A row of notable institutional buildings including a library with columns, a modern school, and a hospital" >}}
...
{{< drg/safety-first >}}
Landscape architects must consider accessibility in every design. Paths, ramps, and seating areas should be usable by people of all abilities. The Americans with Disabilities Act (ADA) sets requirements that architects follow to make public spaces welcoming to everyone.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/architecture-styles-collage.avif" alt="A visual comparison showing different architectural styles: a Greek revival building with columns, a modern glass skyscraper, a Gothic cathedral, and a Frank Lloyd Wright prairie-style home" >}}
...
{{< drg/next-page
    text="You have learned about the world of architecture and its many specialties."
    teaser="Head outside and discover the architectural styles hiding in plain sight in your own neighborhood."
    url="/merit-badges/architecture/guide/req1a/" >}}
