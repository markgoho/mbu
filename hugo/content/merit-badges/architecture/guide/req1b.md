...
req_number: "1b"
prev: "/merit-badges/architecture/guide/req1a/"
prev_title: "Req 1a — Community Building Tour"
next: "/merit-badges/architecture/guide/req2/"
next_title: "Req 2 — Sustainable Architecture"
---
...
{{< drg/image src="images/historical-achievements-montage.avif" alt="A montage showing four famous architectural achievements: the Roman Colosseum, a Gothic cathedral with flying buttresses, the Eiffel Tower, and the Sydney Opera House" >}}

{{< drg/did-you-know >}}
The Great Pyramid of Giza was the tallest structure on Earth for over 3,800 years — from roughly 2560 BC until the Lincoln Cathedral spire was completed in England around 1311 AD. No other human-made record has lasted anywhere close to that long.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Research Framework" subtitle="Key questions to answer about your chosen achievement" >}}
...
{{< drg/tip >}}
When researching online, look for sources from architectural organizations, universities, museums, and educational sites. Wikipedia is a good starting point, but always check the references at the bottom of the article for more detailed and reliable sources.
{{< /drg/tip >}}

{{< drg/external-link
    title="ArchDaily — Architecture History"
    url="https://www.archdaily.com/tag/architecture-history"
    description="A curated collection of articles about historically significant buildings and architectural movements, with detailed photos and analysis." >}}

{{< drg/external-link
    title="National Building Museum"
    url="https://www.nbm.org/"
    description="The National Building Museum in Washington, D.C. offers exhibits and educational resources about architecture, engineering, and design throughout American history." >}}
...
{{< drg/be-prepared title="Making Your Research Come Alive" >}}
Dry facts are hard to remember — stories stick. Find the human story behind your achievement.
- **Who risked something?** The Eiffel Tower's designer bet his reputation on a structure most people hated.
- **What went wrong?** The Sydney Opera House went wildly over budget and took 16 years to build instead of the planned 4.
- **What surprised people?** The Crystal Palace was built from 300,000 panes of glass — a material no one thought could hold up a building.
- A good story makes your counselor conversation memorable for both of you.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have explored a historical architectural achievement and its lasting impact."
    teaser="Learn how modern architects are designing buildings that protect the planet."
