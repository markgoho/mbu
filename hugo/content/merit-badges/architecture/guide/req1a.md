...
{{< drg/tip >}}
Bring a camera or phone to photograph buildings during your tour. Photos help you remember details when you sit down to sketch later, and they are great references when discussing your findings with your merit badge counselor.
{{< /drg/tip >}}
...
{{< drg/image src="images/architectural-styles-guide.avif" alt="A visual guide showing six different architectural styles side by side: Colonial, Victorian, Craftsman, Art Deco, Mid-Century Modern, and Contemporary, with labels and key features highlighted" >}}

{{< drg/did-you-know >}}
Many buildings are not pure examples of one style — they mix elements from different eras. A Victorian house might have a Colonial-era addition, or a Mid-Century Modern school might have a contemporary wing. Architects call this "eclectic" design.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Building Observation Checklist" subtitle="Questions to answer for each building you study" >}}
...
{{< drg/tip >}}
Start with the basic outline — the overall shape of the building. Then add major features like the roofline, windows, and doors. Save details like decorative trim and textures for last. Lightly sketch in pencil first so you can adjust proportions before committing.
{{< /drg/tip >}}

{{< drg/external-link
    title="Architectural Styles Visual Guide — ThoughtCo"
    url="https://www.thoughtco.com/architecture-4133010"
    description="An illustrated guide to major architectural styles throughout history, with photos and key features to help you identify buildings in your community." >}}

{{< drg/image src="images/scout-sketching-building.avif" alt="A Scout sitting on a park bench sketching a historic building in their sketchbook, with the building visible in the background" >}}
...
{{< drg/be-prepared title="What If You Can't Identify a Style?" >}}
Not every building fits neatly into a category, and that is perfectly fine.
- **Write down what you see.** Describe the materials, shapes, and details in your own words.
- **Take a photo.** You can research the style later using your photo as a reference.
- **Ask around.** A local historical society or library may have information about older buildings in your area.
- **Check the cornerstone.** Many public and commercial buildings have a cornerstone engraved with the year they were built — look near the base of the building.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have toured your community and identified local architectural styles."
    teaser="Discover a historical architectural achievement that changed the world."
