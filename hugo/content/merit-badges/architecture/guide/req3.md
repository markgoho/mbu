...
{{< drg/checklist title="Questions for the Architect" subtitle="Prepare these before your visit" >}}
...
{{< drg/tip >}}
When looking at construction drawings, pay attention to the tiny notes and symbols. Every line, number, and abbreviation means something specific to the builder. Ask the architect to walk you through a detail drawing — it is like reading a recipe for assembling a building.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
A construction site is a dangerous place. You **must** have advance permission from your parent or guardian, your merit badge counselor, the architect, **and** the site manager. While on site, follow every safety rule: wear a hard hat, protective eyewear, and closed-toe shoes (no sandals or sneakers). Stay with your guide at all times. Never touch equipment or materials without permission. Be aware that conditions change — watch where you step.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/construction-site-overview.avif" alt="An active construction site showing a partially completed building with visible steel framing, workers in hard hats, and construction equipment, with an architect pointing at construction drawings on a table" >}}
...
{{< drg/checklist title="Client Interview Questions" subtitle="What to ask your prospective client" >}}
...
{{< drg/tip >}}
Draw a simple bubble diagram to show functional relationships. Put each room or space in a circle, then draw lines between circles that need to be near each other. This is exactly what real architects do in the early stages of design.
{{< /drg/tip >}}
...
{{< drg/checklist title="Visit Planning Checklist" subtitle="Steps to set up your meeting" >}}
...
{{< drg/external-link
    title="American Institute of Architects — Find an Architect"
    url="https://www.aia.org/find-an-architect"
    description="The AIA's directory helps you find architects in your area. Many AIA members enjoy mentoring young people and may be happy to help with your merit badge." >}}
...
{{< drg/next-page
    text="You have met with an architect or interviewed a client and learned how buildings go from idea to reality."
    teaser="Put your skills to the test by measuring a room and drawing an accurate floor plan."
