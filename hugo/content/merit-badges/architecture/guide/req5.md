...
{{< drg/image src="images/architecture-careers.avif" alt="Four professionals representing different architecture careers: an architect reviewing blueprints, a landscape architect sketching a park design outdoors, an interior designer selecting material samples, and an urban planner presenting a city map" >}}
...
{{< drg/did-you-know >}}
Architecture is one of the few professions that combines art and science in equal measure. Architects must be creative enough to imagine a building that has never existed — and technical enough to make sure it will not fall down.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Career Deep Dive" subtitle="Questions to answer about your chosen career" >}}
...
{{< drg/tip >}}
If you can, talk to someone who actually works in the career you chose. A 15-minute conversation with a working professional will teach you more than hours of reading. Your merit badge counselor, parents, or local AIA chapter may be able to connect you with someone.
{{< /drg/tip >}}

{{< drg/external-link
    title="Bureau of Labor Statistics — Architects"
    url="https://www.bls.gov/ooh/architecture-and-engineering/architects.htm"
    description="Detailed career information from the U.S. government including job duties, education requirements, salary data, and job outlook for architects." >}}

{{< drg/external-link
    title="American Institute of Architects — Career Resources"
    url="https://www.aia.org/career-resources"
    description="The AIA offers resources for students and young professionals interested in architecture careers, including mentorship programs and educational guidance." >}}
...
{{< drg/next-page
    text="You have explored careers in architecture and identified one that interests you."
    teaser="Go beyond the badge with deeper dives, real-world experiences, and organizations that can fuel your passion for architecture."
