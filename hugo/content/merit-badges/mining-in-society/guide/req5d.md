...
{{< drg/checklist title="What to ask the supplier or manufacturer" subtitle="Focus on purpose, not just size or brand" >}}
...
{{< drg/did-you-know >}}
In some surface mines, a single haul truck can carry hundreds of tons of rock in one trip. That is one reason traffic patterns, visibility, and communication are such major safety concerns.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    ...
    description="Provides background on mining methods and processing systems so you can better understand where each piece of equipment fits." >}}

You have looked at equipment as a system. Next, you will zoom in on ore processing and the difference between breaking rock apart and chemically separating valuable minerals.

{{< drg/next-page
    text="You have connected mining machines to the work stages they support"
    teaser="Learn two ways rock is reduced and how extraction, smelting, and refining fit into the path from ore to finished metal."
