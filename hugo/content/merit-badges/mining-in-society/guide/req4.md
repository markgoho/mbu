...
{{< drg/checklist title="Common hazards at abandoned mines and quarries" subtitle="These sites are dangerous even when nobody is working there" >}}
...
{{< drg/safety-first >}}
The right decision at an abandoned mine or quarry is simple: stay out and stay away. Do not enter openings, climb on structures, or go near water edges, spoil piles, or steep walls. If you find a dangerous-looking site, leave the area and tell a responsible adult or land manager.
{{< /drg/safety-first >}}
...
- **Tell an adult or site authority if needed**: Especially if the site is near homes, trails, or a place where other people might wander in.
{{< /drg/be-prepared >}}

{{< drg/image src="images/abandoned-mine-warning-scene.avif" alt="Fence and warning signs near an abandoned mine opening with unstable ground and dark water nearby" >}}

{{< drg/video
    title="Hidden dangers in abandoned mines — 4 News Now"
    url="https://www.youtube.com/watch?v=5NQ-zlfPV4g" >}}

{{< drg/external-link
    title="EPA — Abandoned Mine Lands"
    url="https://www.epa.gov/superfund/abandoned-mine-lands"
    description="Explains the environmental and physical hazards associated with abandoned mine lands and why cleanup can be so important." >}}

{{< drg/external-link
    title="MSHA — Stay Out, Stay Alive"
    url="https://www.msha.gov/safety-and-health/safety-topics/accidents-injuries-illness/stay-out-stay-alive"
    description="A mine-safety message focused on keeping the public away from abandoned mine hazards." >}}
...
{{< drg/next-page
    text="You know why abandoned mines and quarries are never safe places to explore"
    teaser="Choose one mining-related path such as a tour, museum visit, equipment visit, processing study, or local history project."
