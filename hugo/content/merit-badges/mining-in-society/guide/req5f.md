...
How did mining change the land, water, vegetation, or later land use? Was there cleanup, reclamation, or redevelopment? This connects naturally to [Req 6](/merit-badges/mining-in-society/guide/req6/), where you will focus more directly on sustainability and reclamation.

{{< drg/checklist title="Good interview questions" subtitle="Use these with a historian, community leader, or local business person" >}}
...
{{< drg/be-prepared title="If your area has no famous mine" >}}
That is okay. Look for quarries, clay pits, sand and gravel operations, salt-related industry, cement materials, or older small-scale mineral workings. The requirement says local mine, and “local” can include the broader area that shaped your community's building materials, roads, or industry.
{{< /drg/be-prepared >}}
...
{{< drg/video
    title="The history and future of Butte, Montana — CBS Sunday Morning"
    url="https://www.youtube.com/watch?v=_-UA0Bc2_PI" >}}

{{< drg/external-link
    title="National Park Service — Mining"
    url="https://www.nps.gov/subjects/mining/index.htm"
    description="Offers examples of how mining history is preserved and interpreted, which can help you frame your own local-history research." >}}
...
{{< drg/next-page
    text="You have explored how a mine can shape a whole community story"
    teaser="Turn next to reclamation and sustainability to see how mining sites can be stabilized, restored, and given new purpose."
