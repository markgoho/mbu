...
{{< drg/checklist title="Build a balanced mineral list" subtitle="Aim for variety so your examples show how wide mining reaches" >}}
...
{{< drg/tip >}}
If you get stuck, walk through a room and ask what each object is made from. Walls, windows, pipes, lightbulbs, batteries, ceramics, and concrete all point back to mined materials.
{{< /drg/tip >}}

{{< drg/image src="images/minerals-to-products-grid.avif" alt="Grid showing raw minerals matched to common finished products such as gypsum to drywall and copper to wire" >}}
...
{{< drg/did-you-know >}}
A bag of fertilizer may look simple, but the nutrients inside can come from minerals mined hundreds or even thousands of miles away before they are processed and blended for farms.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="For each mineral on your list" subtitle="Capture the same details every time" >}}
...
In [Req 2](/merit-badges/mining-in-society/guide/req2/), you will shift from the world map to your own state or region. That makes this global research a useful warm-up.

{{< drg/external-link
    title="USGS Mineral Commodity Summaries"
    url="https://www.usgs.gov/centers/nmic/mineral-commodity-summaries"
    description="A trusted source for mineral uses, production, and major producing countries. It is one of the best places to research both your product examples and where each mineral is found." >}}

{{< drg/external-link
    title="Minerals Education Coalition — Minerals in Your Life"
    url="https://mineralseducationcoalition.org/mining-minerals-information/minerals-in-your-life/"
    description="Student-friendly examples of how mined minerals show up in everyday objects such as phones, homes, vehicles, and clean-energy technology." >}}
...
{{< drg/next-page
    text="You have connected minerals to products and global supply"
    teaser="Map five mining enterprises in your state or region and see how resource locations link to roads, rivers, railroads, and cities."
