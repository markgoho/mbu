...
{{< drg/checklist title="How the two methods differ" subtitle="This comparison is useful in your counselor discussion" >}}
...
{{< drg/image src="images/ore-processing-flow.avif" alt="Process flow showing blasted rock moving to crusher, mill, chemical extraction, and metal product" >}}
...
{{< drg/tip >}}
If your counselor asks for an example, you might explain that ore may be crushed first, then chemically or physically concentrated, then smelted to recover metal, and finally refined to produce a purer final material.
{{< /drg/tip >}}

{{< drg/external-link
    title="Minerals Education Coalition — Mining and Mineral Processing"
    url="https://mineralseducationcoalition.org/mining-minerals-information/"
    description="A readable introduction to mining, processing, and the steps between ore and finished mineral products." >}}

You have looked at processing from a technical angle. The next option turns back toward people and place by asking how a mine shaped a local community.

{{< drg/next-page
    text="You understand how ore can be physically reduced and chemically extracted"
    teaser="Explore a local mine story and see how mining changes communities, jobs, culture, and local history."
