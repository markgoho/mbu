...
{{< drg/checklist title="Why space mining is harder than Earth mining" subtitle="These are great discussion points for your counselor" >}}
...
{{< drg/did-you-know >}}
A space mission may spend years traveling just to collect a small sample that fits inside a container much smaller than a lunch box. Scientists then study that sample for clues about composition, history, and future resource use.
{{< /drg/did-you-know >}}

{{< drg/image src="images/lunar-resource-mining-concept.avif" alt="Concept diagram of a robotic rover collecting icy lunar soil near a crater and processing local resources" >}}

{{< drg/external-link
    title="NASA — In-Situ Resource Utilization"
    url="https://www.nasa.gov/isru"
    description="Explains NASA's work on using local resources from the Moon, Mars, and other destinations to support exploration." >}}
...
{{< drg/next-page
    text="You have explored why future missions may need to mine or process local resources in space"
    teaser="Turn from the Moon and asteroids to Earth’s oceans, where valuable minerals raise both economic interest and serious environmental questions."
