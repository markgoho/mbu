...
{{< drg/checklist title="Environmental controls to look for" subtitle="Choose a site and see which of these are mentioned" >}}
...
{{< drg/tip >}}
When you explain this to your counselor, say clearly that reclamation is not the same as pretending mining never happened. It is a stewardship response to real disturbance.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
A reclaimed site does not always return to one single use. The same former mine area might support habitat, stormwater management, trails, and educational programs all at once.
{{< /drg/did-you-know >}}

{{< drg/image src="images/reclaimed-mine-to-scout-reserve.avif" alt="Before-and-after comparison of a former mine landscape transformed into green recreation land with trails and trees" >}}

{{< drg/video
    title="This Is What Happens When We Mine for Metals — Lumina Learning"
    url="https://www.youtube.com/watch?v=K6FasptWdeU" >}}

{{< drg/external-link
    title="Office of Surface Mining Reclamation and Enforcement — Programs"
    url="https://www.osmre.gov/programs"
    description="Explains reclamation programs and the long-term work of restoring and managing formerly mined lands." >}}

{{< drg/external-link
    title="EPA — Abandoned Mine Lands"
    url="https://www.epa.gov/superfund/abandoned-mine-lands"
    description="Provides examples of why restoration and cleanup matter for people, water, wildlife, and future land use." >}}
...
{{< drg/next-page
    text="You have connected mining to stewardship, reclamation, and future land use"
    teaser="Choose one modern topic and explore how mining reaches into technology, sustainability, and global markets."
