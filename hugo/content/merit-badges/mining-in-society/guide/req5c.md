...
req_number: "5c"
req_path: "5.c"
prev: "/merit-badges/mining-in-society/guide/req5b/"
prev_title: "Req 5b — Museum Mining History"
next: "/merit-badges/mining-in-society/guide/req5d/"
next_title: "Req 5d — Mining Equipment in Action"
---
...
{{< drg/checklist title="Questions to ask on the visit" subtitle="These make your counselor discussion much stronger" >}}
...
{{< drg/safety-first >}}
When visiting an active mine, follow every instruction from the host, your parent or guardian, and your counselor. Stay only in approved visitor areas, wear required gear, and never wander off for a better photo or a closer look at equipment.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
If the site guide uses unfamiliar words, ask for a short explanation right away. Terms like overburden, bench, ventilation, concentrate, tailings, and reclamation sound much clearer when you hear them in context.
{{< /drg/tip >}}

{{< drg/external-link
    title="MSHA Safety and Health"
    url="https://www.msha.gov/safety-and-health"
    description="Useful background reading before a mine visit so you understand the kinds of safety systems and procedures you may hear about on site." >}}
...
{{< drg/next-page
    text="You know how to organize an active-mine visit around the full mining process"
    teaser="Focus next on the equipment side and learn how specific machines fit into exploration, extraction, hauling, and processing."
