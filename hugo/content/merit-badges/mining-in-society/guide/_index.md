  ...
  - group_title: "Beyond the Badge"
    items:
      - title: "Extended Learning"
        url: "/merit-badges/mining-in-society/guide/extended-learning/"
        is_sub: false
---
...
{{< drg/image src="mining-in-society-merit-badge.avif" alt="The Mining in Society merit badge patch showing crossed mining tools over a mine entrance" >}}
...
{{< drg/did-you-know >}}
Almost every room in a home contains dozens of mined materials. Drywall uses gypsum, windows use silica sand, wiring uses copper, concrete uses crushed stone and limestone, and many paints and ceramics use minerals too.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/surface-mine-overview.avif" alt="Wide educational diagram of a modern stepped open-pit mine with haul roads, benches, and giant haul trucks" >}}
...
{{< drg/image src="images/underground-mine-sections.avif" alt="Cutaway diagram showing shaft, ramp, tunnels, ventilation, and refuge area inside an underground mine" >}}
...
{{< drg/tip >}}
As you work through this badge, keep asking one simple question: “Where did this material come from, and what had to happen before I could use it?” That question ties the whole badge together.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have seen how mining connects history, technology, and daily life"
    teaser="Start with the minerals around you and trace them into the products people use every day."
    url="/merit-badges/mining-in-society/guide/req1/" >}}
