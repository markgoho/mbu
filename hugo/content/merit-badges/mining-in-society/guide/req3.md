...
{{< drg/inherited-requirement number="3a" req_path="3.a" topic="The miner's personal protective equipment is worn and used, including a hard hat, safety glasses, earplugs, dust mask or respirator, self-rescue device, and high-visibility vest." />}}
...
{{< drg/checklist title="Think hazard first" subtitle="A good counselor answer connects each piece of PPE to a specific risk" >}}
...
{{< drg/image src="images/miner-ppe-labeled.avif" alt="Miner wearing hard hat, safety glasses, hearing protection, respirator, self-rescue device, gloves, boots, and high-visibility vest with labels" >}}

## Requirement 3b

{{< drg/inherited-requirement number="3b" req_path="3.b" topic="Miners protect their hands and feet from impact, pinch, vibration, slipping, and tripping/falling hazards." />}}
...
{{< drg/tip >}}
When you discuss this part with your counselor, do not stop at “wear gloves and boots.” Explain what those items protect against and how work practices such as cleanup, guards, and careful tool use reduce the hazard before an injury happens.
{{< /drg/tip >}}

## Requirement 3c

{{< drg/inherited-requirement number="3c" req_path="3.c" topic="Monitoring equipment warns miners of imminent danger, and how robots, drones, and other technology may be used in mine rescues." />}}
...
{{< drg/safety-first >}}
Mine emergencies are handled by trained workers and rescue teams using strict procedures. Technology supports those teams, but it does not make mining casual or low-risk. Safety depends on following procedures every day, not only when something goes wrong.
{{< /drg/safety-first >}}

{{< drg/image src="images/mine-monitoring-and-rescue-tech.avif" alt="Split scene showing a handheld gas monitor underground and a rescue drone inspecting a hazardous mine area" >}}

{{< drg/external-link
    title="MSHA Safety and Health"
    url="https://www.msha.gov/safety-and-health"
    description="Federal mine-safety information about hazards, training, inspections, and emergency response in active mines." >}}

{{< drg/external-link
    title="CDC NIOSH Mining Safety and Health"
    url="https://www.cdc.gov/niosh/mining"
    description="Research and prevention information on dust, noise, ground falls, injuries, and other mining health and safety risks." >}}
...
{{< drg/next-page
    text="You have matched mining hazards with the protections that reduce them"
    teaser="See why old mines and quarries can be deadly even when they look quiet, empty, or harmless from the outside."
