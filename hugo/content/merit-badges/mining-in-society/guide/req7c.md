...
{{< drg/checklist title="For each recycled material" subtitle="Use the same short structure for all six" >}}
...
{{< drg/tip >}}
A strong discussion with your counselor will include balance. Say clearly that recycling supports sustainability, but it works best together with responsible mining, smart product design, and good collection systems.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    description="National recycling data that can help you see how different materials are recovered and why recycling matters." >}}

{{< drg/external-link
    title="USGS Commodity Statistics and Information"
    url="https://www.usgs.gov/centers/nmic/commodity-statistics-and-information"
    description="Useful for learning how recycled supply fits into the bigger picture for many mined commodities." >}}
...
{{< drg/next-page
    text="You have connected recycling to resource conservation and the continuing need for mining"
    teaser="Study real commodity prices next and see how five-year trends shape decisions in the mining world."
