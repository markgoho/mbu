...
{{< drg/checklist title="What each mine entry should include" subtitle="Capture the same details at all five locations" >}}
- **Mine or operation name**: Write the specific name if you can find it.
...
{{< drg/tip >}}
If you cannot find a formal statement that says “surface” or “underground,” look for clues such as photos, aerial images, or descriptions of shafts, pits, benches, portals, or ramps.
{{< /drg/tip >}}

{{< drg/image src="images/annotated-mining-map-example.avif" alt="Example map showing five marked mining sites with surface and underground icons plus highway, rail, and river connections" >}}
...
{{< drg/be-prepared title="A simple way to present your map" >}}
- **First**: Point out the region and why you chose it.
- **Next**: For each site, explain the resource and whether it is surface or underground.
- **Then**: Show the nearest transportation links.
- **Finally**: Explain what the resource is used for and why that use makes sense in your region.

If you notice a pattern, say it out loud. Maybe quarries cluster near highways, or maybe underground mines appear where geology pushed the deposit deeper.
{{< /drg/be-prepared >}}

{{< drg/video
    title="Mining For Beginners - How Does a Metals and Mineral Mine Work? — Energy and Mining Innovation"
    url="https://www.youtube.com/watch?v=wsAzlmz5dso" >}}

{{< drg/external-link
    title="USGS Mineral Resources On-Line Spatial Data"
    url="https://mrdata.usgs.gov/"
    description="Interactive maps and spatial data that can help you locate mining districts, mines, and mineral-resource information for a state or region." >}}
...
{{< drg/next-page
    text="You have mapped mining enterprises and the routes that connect them"
    teaser="Learn the hazards miners face and the protective equipment and technology that help keep them safe."
