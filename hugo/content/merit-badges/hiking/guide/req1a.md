...
{{< drg/safety-first >}}
Never hike alone. The "Buddy System" is your first line of defense against almost every trail hazard. Having a friend with you means there is someone to help if you trip, get confused by a trail marker, or just need an extra hand.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Scout Essentials" subtitle="The ten things you should never leave without" >}}
...
{{< drg/checklist title="Personal First-Aid Kit" subtitle="Must-haves for your individual kit" >}}
...
{{< drg/checklist title="Warm-Weather Clothing" subtitle="Stay cool and protected" >}}
...
{{< drg/checklist title="Cold-Weather Clothing" subtitle="The layering system" >}}
...
{{< drg/checklist title="Accessories" subtitle="Extra help on the trail" >}}
...
{{< drg/be-prepared title="Run Out of Water?" >}}
...
- **T**hink: How did you get here? When was the last time you saw a trail marker?
- **O**bserve: Look for landmarks. Listen for voices or cars. Check your map and compass.
...
- Never run! Running triggers their instinct to chase.
...
{{< drg/external-link title="Wilderness.net" url="https://wilderness.net/visit-wilderness/find-a-wilderness.php" description="Find wilderness areas near you and learn about the rules for visiting these protected lands." >}}

{{< drg/external-link title="Leave No Trace" url="https://lnt.org/why/7-principles/" description="Learn the seven principles that every Scout should follow to keep the outdoors beautiful for everyone." >}}

{{< drg/external-link title="National Wildlife Federation — Respect Wildlife" url="https://www.nwf.org/Educational-Resources/Wildlife-Guide" description="Learn how to safely observe and respect the wildlife you may encounter on the trail." >}}
