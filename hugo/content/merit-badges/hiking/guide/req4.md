...
{{< drg/safety-first >}}
**The Golden Rule of Hiking:** Always share your written plan with a "home contact"—someone who is NOT going on the hike. If you aren't back by your "When" time, they are the ones who will call for help. Also, never hike alone. Use the buddy system or go with your troop or family.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
When presenting your plan to your counselor, use a digital tool like AllTrails or a paper USGS map to highlight your path. It shows you've really done your homework!
{{< /drg/tip >}}
...
- **High Energy:** Lots of calories to keep you moving.
- **Lightweight:** You have to carry it, so avoid heavy cans or glass jars.
- **Non-Perishable:** It needs to stay safe to eat even after sitting in a warm backpack for four hours.
- **Easy to Eat:** You don't want to spend an hour "cooking" in the middle of a 20-mile hike.

{{< drg/checklist title="Trail Lunch Essentials" subtitle="Pack these for a high-energy day on the trail" >}}
...
- **Different Terrains:** A forest trail one day, a coastal path another, and maybe a hilly ridge for the third.
- **Different Seasons:** If your schedule allows, seeing a trail in the fall colors versus the spring bloom is a totally different experience.
- **Different Challenges:** One hike might be flat and fast, while another might be rocky and technical.
...
- **Short rest periods:** 5–10 minutes every hour to catch your breath and hydrate.
- **One meal stop:** A longer break (usually 30 minutes) to eat your trail lunch.
...
{{< drg/external-link title="Hiking Project" url="https://www.hikingproject.com/" description="Find maps, trail descriptions, and ideas for hikes near you." >}}

{{< drg/external-link title="AllTrails" url="https://www.alltrails.com/" description="Search for trails by location, difficulty, and length with reviews from other hikers." >}}

{{< drg/external-link title="National Park Service — Find a Park" url="https://www.nps.gov/findapark/index.htm" description="Explore trails and hiking opportunities in America's national parks." >}}

{{< drg/external-link title="USGS Topographic Maps" url="https://www.usgs.gov/programs/national-geospatial-program/topographic-maps" description="Download free topographic maps from the U.S. Geological Survey to plan your route and study the terrain." >}}

{{< drg/external-link title="U.S. Forest Service — Recreation" url="https://www.fs.usda.gov/recreation" description="Find trails, campgrounds, and recreation areas in America's national forests and grasslands." >}}

{{< drg/external-link title="Rails-to-Trails Conservancy — TrailLink" url="https://www.traillink.com/" description="Search for converted rail-trails — flat, well-maintained paths that are perfect for long-distance hiking." >}}

{{< drg/external-link title="Bureau of Land Management — Recreation" url="https://www.blm.gov/programs/recreation" description="Explore hiking opportunities on public lands managed by the BLM across the western United States." >}}

Once you finish each of these hikes, your job isn't quite done. You need to document what happened!

{{< drg/next-page text="Once you return from your 10-mile and 20-mile treks, it's time to tell your story." teaser="Requirement 5 — Hike Reports" url="/merit-badges/hiking/guide/req5/" >}}
