---
title: "Triathlon Swim Skills"
layout: "guide"
group_title: "4. Triathlon Path"
req_number: "4a1"
req_path: "4.a.1"
prev: "/merit-badges/multisport/guide/req4a/"
prev_title: "Triathlon Roadmap"
next: "/merit-badges/multisport/guide/req4a2/"
next_title: "Triathlon Bike Skills"
---

{{< drg/requirement number="4a1" >}}
Swimming
{{< /drg/requirement >}}
...
{{< drg/external-link
    title="Swimming Merit Badge (website)"
    url="https://www.scouting.org/merit-badges/swimming/%20"
    description="Review the official Swimming merit badge page so you understand the prerequisite skills and safety expectations behind this branch." >}}
...
{{< drg/safety-first >}}
In open water or any unfamiliar setting, do not assume a place is safe just because other people are swimming there. Safe Swim Defense requires actual supervision, planning, and clear roles.
{{< /drg/safety-first >}}

## Requirement 4a1c

{{< drg/requirement number="4a1c" >}}
...
{{< drg/video
    title="4 Things To Know Before Your First Open Water Swim (video)"
    url="https://youtu.be/0VN9xikjs2E" >}}

{{< drg/video
    title="The Dangers of Cold Water Immersion (video)"
    url="https://youtu.be/fLdw5NBOf6g" >}}

{{< drg/video
    title="How Do Wetsuits Keep You Warm? (video)"
    url="https://youtu.be/6B05sU20-Jw" >}}

{{< drg/be-prepared title="If open water makes you nervous" >}}
- **Say so early** to your counselor or supervising adult.
- **Practice in controlled settings first** instead of jumping straight into race-style conditions.
- **Enter the water calmly** and focus on steady breathing.
- **Stop and signal for help** if you feel disoriented or panicked.
{{< /drg/be-prepared >}}

Triathlon continues on land. Next, you will turn from water safety to bike handling and equipment checks.

{{< drg/next-page
    text="You have built the swimming safety foundation for triathlon."
    teaser="Now shift to the bike leg and learn the habits that keep riders safe and predictable."
