---
title: "Duathlon Bike Skills"
layout: "guide"
group_title: "4. Duathlon Path"
req_number: "4b1"
req_path: "4.b.1"
prev: "/merit-badges/multisport/guide/req4b/"
prev_title: "Duathlon Roadmap"
next: "/merit-badges/multisport/guide/req4b2/"
next_title: "Duathlon Run Skills"
---

{{< drg/requirement number="4b1" >}}
Biking
{{< /drg/requirement >}}
...
{{< drg/video
    title="Bike Safety | Hand Signals (video)"
    url="https://youtu.be/v_hRsNHlq8M?" >}}

## Requirement 4b1b

{{< drg/requirement number="4b1b" >}}
...
{{< drg/video
    title="Bike Tips: Preflight Checklist for a Safe Ride (video)"
    url="https://youtu.be/EHLq5Em-EPI" >}}

{{< drg/checklist title="Quick bike check" subtitle="A simple routine before every session" >}}
...
{{< drg/video
    title="Fitting a Bike Helmet (video)"
    url="https://youtu.be/hLlXswx0VvQ" >}}

{{< drg/safety-first >}}
In duathlon, you may start the bike leg already breathing hard from the first run. That is exactly when good judgment matters most. Stay smooth before you try to be fast.
{{< /drg/safety-first >}}

Next, you will move to the run skills that bookend the bike section and make duathlon unique.

{{< drg/next-page
    text="You have the cycling foundation for duathlon."
    teaser="Now build the run habits that help you handle both the opening and closing run segments safely."
