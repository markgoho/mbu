...
{{< drg/checklist title="Hazard Scan Before Training" subtitle="Use this quick check before every multisport session" >}}
...
{{< drg/be-prepared title="If the bike course feels unsafe" >}}
If traffic is heavier than expected, the road surface is broken up, or you do not feel in control:

- **Slow down immediately** instead of trying to keep pace with others.
- **Move to a safer line** and signal clearly.
- **Tell your coach, parent, or counselor** about the hazard.
- **Choose safety over the workout plan.** Missing one hard session is better than crashing.
{{< /drg/be-prepared >}}

{{< drg/video
    title="How To Avoid Injury When Triathlon Training (video)"
    url="https://youtu.be/LckcSB-O8UI" >}}

{{< drg/tip >}}
When your counselor asks about hazards, do not just list them. Explain what you would do before, during, and after the problem. That shows real understanding.
{{< /drg/tip >}}
...
{{< drg/video
    title="How To Avoid and Treat Foot Blisters (video)"
    url="https://youtu.be/H6xlECl9ZBg" >}}
...
{{< drg/safety-first >}}
A Scout with possible concussion should not return to training the same day just because they say they feel better. Head injuries need serious evaluation.
{{< /drg/safety-first >}}
...
{{< drg/video
    title="Treating Heat Exhaustion and Heat Stroke (video)"
    url="https://youtu.be/5hSpMdlXZw0" >}}
...
{{< drg/video
    title="R.I.C.E. Treatment for Sprains and Strains (video)"
    url="https://youtu.be/TZqDBgiEfL8" >}}
...
{{< drg/did-you-know >}}
Blisters are one of the smallest injuries that can ruin a big day. In endurance sports, a tiny hot spot can change your stride, slow you down, and lead to bigger problems up the chain in your ankles, knees, and hips.
{{< /drg/did-you-know >}}

{{< drg/image src="images/multisport-first-aid-kit-layout.avif" alt="Open first-aid kit beside running shoes, bike helmet, and swim gear with key items visible for treating common multisport injuries" >}}
...
{{< drg/next-page
    text="You know the major hazards and the first aid that goes with them."
    teaser="Now learn how physical exams, daily habits, and smart nutrition support safe training."
