...
{{< drg/video
    title="Setting Up Your Transition Area (video)"
    url="https://www.youtube.com/watch?v=HvIq5NExAFU" >}}

{{< drg/checklist title="Transition area basics" subtitle="Build a setup you can use without panic" >}}
...
{{< drg/safety-first >}}
Never mount your bike until you are in the allowed area and your helmet is on and buckled. Likewise, dismount where required instead of trying to save a second with a risky move.
{{< /drg/safety-first >}}

{{< drg/image src="images/multisport-transition-area.avif" alt="Neatly organized beginner transition area with swim gear, helmet, bike shoes, running shoes, and bike laid out in logical order" >}}
...
{{< drg/next-page
    text="You have learned how to build an organized and safe transition area."
    teaser="Now choose your race simulation and decide which event format you will complete in one consecutive effort."
