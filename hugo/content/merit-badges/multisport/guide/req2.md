...
{{< drg/external-link
    title="Scouting America Annual Health and Medical Record (website)"
    url="https://www.scouting.org/health-and-safety/ahmr/"
    description="Use Scouting America’s health record forms to organize medical information that helps leaders and counselors support you safely." >}}

{{< drg/tip >}}
When you talk with your counselor, be ready to explain why this information matters for sports safety, not just to say that you had a checkup.
{{< /drg/tip >}}
...
{{< drg/video
    title="7 Reasons To Be Smoke-Free (video)"
    url="https://youtu.be/hCC1dgmwO_4" >}}

{{< drg/video
    title="Vaping Impacts Your Athletic Ability (video)"
    url="https://youtu.be/zXL9k-rJvIo" >}}

{{< drg/video
    title="3 Things To Know About Drinking Alcohol (video)"
    url="https://youtu.be/YbBIl2KcVIQ" >}}

{{< drg/safety-first >}}
If a substance affects your breathing, balance, reaction time, or judgment, it affects your safety in the water, on the bike, and on the run. That is not a small effect. It is a serious one.
{{< /drg/safety-first >}}
...
{{< drg/video
    title="Nutrition Fuels Training! (video)"
    url="https://youtu.be/zMposrWrPC0" >}}

{{< drg/checklist title="Simple Fueling Habits" subtitle="Small choices that make training easier" >}}
...
{{< drg/did-you-know >}}
Even mild dehydration can make exercise feel harder than it should. Sometimes what feels like “bad fitness” is really a hydration problem.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You have covered the basics of staying healthy enough to train well."
    teaser="Now it is time to assess your strengths and choose which multisport format you want to focus on."
