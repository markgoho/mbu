---
title: "Triathlon Run Skills"
layout: "guide"
group_title: "4. Triathlon Path"
req_number: "4a3"
req_path: "4.a.3"
prev: "/merit-badges/multisport/guide/req4a2/"
prev_title: "Triathlon Bike Skills"
next: "/merit-badges/multisport/guide/req4b/"
next_title: "Duathlon Roadmap"
---
...
{{< drg/video
    title="Warm-Up for Running (video)"
    url="https://youtu.be/PkF3jjFZc0s" >}}

{{< drg/video
    title="Hydration for Running (video)"
    url="https://youtu.be/MpCO8Y7iPYk" >}}

## Requirement 4a3b

{{< drg/inherited-requirement number="4a3b" req_path="4.a.3.b" topic="Learn and state the basic rules of the road for runners." />}}
...
{{< drg/video
    title="Safety Tips for Running (video)"
    url="https://youtu.be/I6aDhB_uC8A" >}}

## Requirement 4a3c

{{< drg/requirement number="4a3c" >}}
...
{{< drg/video
    title="High Knees and Butt Kicks (video)"
    url="https://youtu.be/tY2bLt7roOQ" >}}

{{< drg/video
    title="Lunges (video)"
    url="https://youtu.be/amElt61OHgM" >}}

{{< drg/video
    title="Inchworms (video)"
    url="https://youtu.be/pv_8CdDPAAk" >}}

{{< drg/video
    title="Soldier Kicks (video)"
    url="https://youtu.be/9cacAKZESf0" >}}

{{< drg/tip >}}
Do your drills with control, not in a hurry. The goal is better movement quality, not trying to “win” the warmup.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have completed the triathlon discipline overview."
    teaser="See how the duathlon branch changes the order and focus by removing the swim and emphasizing bike-plus-run skills."
