...
{{< drg/checklist title="Bike check before training" subtitle="Look for these each time" >}}
...
{{< drg/safety-first >}}
Never wear a damaged helmet after a crash. Even if the crack is small or hidden, the helmet may no longer protect you the way it should.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You are ready to ride safer and smarter."
    teaser="Now move to the run section and build habits that help you run efficiently when fatigue starts to build."
