...
{{< drg/did-you-know >}}
In a triathlon, the transition area is often called the “fourth discipline.” Athletes can lose a surprising amount of time there if their gear is disorganized or they panic.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Multisport asks you to switch environments quickly. Water, pavement, weather, traffic awareness, and fatigue all matter. Never treat this badge as a speed contest first and a safety challenge second. Learn the safety rules for each discipline, then build speed on top of that foundation.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="Every strong multisport athlete starts with safety awareness."
    teaser="Learn how to spot common hazards and respond to the injuries and illnesses most likely to happen in training or competition."
    url="/merit-badges/multisport/guide/req1/" >}}
