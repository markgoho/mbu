...
- **Mealtime** — "Come and eat!"
- **Striking camp** — "Time to pack up!"
- **Patrol meeting** — "Patrols, gather up!"
- **Campfire** — "Head to the fire ring!"
- **Flag ceremony** — "Form up for colors!"

Choose something your troop actually does regularly. A call that gets used is more meaningful than one that sits on paper.

{{< drg/tip >}}
Ask your Scoutmaster or patrol leader what signal would be most useful. If your troop already struggles to get everyone to meals on time, a mealtime call is a perfect choice.
{{< /drg/tip >}}
...
- **Low B-flat** — Deep and attention-getting. Good for opening a call.
- **Mid B-flat** — Steady and strong. The "home base" note.
- **F** — Bright and energetic. Creates a natural upward lift.
- **High B-flat** — Clear and ringing. Stands out above everything.
- **High D** — Sharp and piercing. Use sparingly for dramatic effect.
...
- **Number system**: Write the notes as numbers (1 = low B-flat, 2 = mid B-flat, 3 = F, 4 = high B-flat, 5 = high D) and mark long notes with a dash.
- **Record yourself**: Play different combinations on your bugle and record them with a phone. Listen back and pick the version you like best.
- **Sing it first**: Hum or whistle a short melody using just the bugle's notes. Once you have a tune you like, figure out the notes on the instrument.
{{< /drg/be-prepared >}}
...
{{< drg/checklist title="Performance Preparation" subtitle="Get ready to debut your bugle call" >}}
...
{{< drg/tip >}}
After you debut your call, use it consistently at troop events. The more your troop hears it, the faster they will learn to recognize it. A call that people actually respond to is the ultimate sign of success.
{{< /drg/tip >}}

{{< drg/external-link
    title="How to Compose a Bugle Call — wikiHow"
    url="https://www.wikihow.com/Play-the-Bugle"
    description="Step-by-step guide covering basic bugle technique that can help you experiment with note combinations." >}}
...
{{< drg/next-page
    text="You have created and performed your own original bugle call."
    teaser="Learn the 15 standard bugle calls and prepare to sound ten of them for your counselor."
