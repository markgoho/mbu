---
title: "How It Makes Sound"
layout: guide
group_title: "2. How the Bugle Works"
req_number: "2a"
prev: "/merit-badges/bugling/guide/req1/"
prev_title: "History of the Bugle"
next: "/merit-badges/bugling/guide/req2b/"
next_title: "Compose a Bugle Call"
---
...
{{< drg/tip >}}
Try buzzing your lips without the bugle first. Press them together loosely, blow air through them, and let them vibrate. If you can make a buzzing sound, you are already halfway to playing the bugle.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
If you uncoiled a standard bugle, the tubing would stretch to about 4.5 feet (1.4 meters) long. That length determines the instrument's fundamental pitch.
{{< /drg/did-you-know >}}
...
| Instrument | How It Changes Pitch | Relation to Bugle |
|------------|---------------------|-------------------|
| **Bugle** | Embouchure only (no valves) | The original |
| **Trumpet** | Three piston valves | A bugle with valves added |
| **French Horn** | Three rotary valves + hand in bell | Longer tubing, lower pitch |
| **Trombone** | Slide changes tubing length | Uses a slide instead of valves |
| **Tuba** | Three to six valves | Largest brass, lowest pitch |
| **Flugelhorn** | Three valves, wider bore | A bugle with valves and a wider bell |
...
{{< drg/image src="images/brass-family-comparison.avif" alt="Illustrated comparison of brass instruments arranged from smallest to largest: bugle, trumpet, flugelhorn, French horn, trombone, tuba, with labels" >}}

{{< drg/video
    title="The Physics of Music — Playing Fire, Ice and Jelly Trumpets"
    url="https://www.youtube.com/watch?v=o0Gl4tfh3KA" >}}

{{< drg/external-link
    title="How Brass Instruments Work — Smithsonian"
    url="https://www.si.edu/spotlight/musical-instruments/brass"
    description="The Smithsonian's overview of how brass instruments produce sound, with photos from their collection." >}}
...
{{< drg/next-page
    text="You know the physics behind the bugle and how it connects to other brass instruments."
    teaser="Put that knowledge to use — compose your own original bugle call for your troop or patrol."
