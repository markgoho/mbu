...
{{< drg/image src="images/scout-bugle-sunrise.avif" alt="A Scout in clean uniform playing a bugle at sunrise at a Scout camp, with tents and trees in the background" >}}
...
{{< drg/did-you-know >}}
There are so many funerals at Arlington National Cemetery that buglers sometimes play "Taps" more than 30 times in a single day.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/drum-bugle-corps-performance.avif" alt="A drum and bugle corps performing on a football field at night under bright lights, with brass instruments gleaming" >}}
...
{{< drg/next-page
    text="You have seen how bugling connects military tradition, Scout camp life, and modern performance."
    teaser="Dive into the full history of the bugle — from ancient horns to the instrument you will learn to play."
    url="/merit-badges/bugling/guide/req1/" >}}
