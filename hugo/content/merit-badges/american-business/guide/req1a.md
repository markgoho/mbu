...
{{< drg/did-you-know >}}
The term "free enterprise" does not mean businesses are free from all rules. The government still enforces laws against fraud, unsafe products, and unfair practices. The "free" part means people are free to make their own economic decisions within those rules.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Think of it this way: freedom is driving a car on the highway. License is driving 120 mph with no regard for other drivers. The freedom to drive comes with the responsibility to follow traffic laws and protect others.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="When Freedom and Ethics Collide" >}}
Imagine you run a small business and discover that a cheaper supplier uses child labor overseas. Your competitors use that supplier and can undercut your prices.

- **Step one**: Recognize the ethical problem — lower cost does not justify harm to others.
- **Step two**: Research alternative suppliers, even if they cost more.
- **Step three**: Consider whether your customers would value knowing you made the ethical choice.
- **Step four**: Make the decision that aligns with your values — and be prepared to explain it.

This is freedom in action, not license. You are free to choose the cheap supplier, but exercising that freedom responsibly means considering the impact of your choices.
{{< /drg/be-prepared >}}

{{< drg/image src="images/free-enterprise-market.avif" alt="A vibrant farmers market scene showing multiple vendors competing for customers, with diverse shoppers making choices between different stalls" >}}

{{< drg/external-link
    title="Free Enterprise System Overview"
    url="https://www.investopedia.com/terms/f/free_enterprise.asp"
    description="A clear explanation of how the free enterprise system works, including its key principles and history." >}}
...
{{< drg/next-page
    text="You have learned the foundations of free enterprise."
    teaser="Discover the inventions and entrepreneurs that launched modern American industry."
