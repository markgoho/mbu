...
{{< drg/did-you-know >}}
Frances Perkins, who served as Secretary of Labor from 1933 to 1945, was the first woman to hold a U.S. cabinet position. She played a major role in creating Social Security, establishing the minimum wage, and banning child labor. Many of the worker protections we take for granted today exist because of her work.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="U.S. Department of Labor — About Us"
    url="https://www.dol.gov/general/aboutdol"
    description="Learn about the Department of Labor's mission, history, and the programs it administers." >}}
...
{{< drg/tip >}}
The FLSA affects you directly. If you have a part-time job, the hours you are allowed to work and the minimum you are paid are determined by this law. If you are under 16, there are strict limits on how many hours you can work during the school year.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Every worker has the right to a safe workplace. If you ever feel unsafe at a job — whether it is a summer position, a part-time retail job, or volunteer work — you have the right to speak up. OSHA protects workers who report safety concerns from being punished by their employers.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
When choosing your two topics, pick the ones you find most interesting or that you can relate to. If you have a part-time job, the FLSA and OSHA are directly relevant to you. If you have family members who have used medical leave or have retirement plans, FMLA and ERISA might be more relatable.
{{< /drg/tip >}}

{{< drg/image src="images/worker-protections-collage.avif" alt="A collage of four workplace scenes: a teenager checking their pay stub, a construction worker wearing safety equipment, a parent holding a newborn at home, and a retiree reviewing financial documents" >}}

{{< drg/checklist title="Discussion Prep" subtitle="For each topic you choose, be ready to explain" >}}
...
{{< drg/external-link
    title="Major Laws Administered by the DOL"
    url="https://www.dol.gov/general/aboutdol/majorlaws"
    description="The Department of Labor's official summary of the major laws it enforces, including FLSA, OSHA, FMLA, and ERISA." >}}
...
{{< drg/next-page
    text="You have learned about labor laws and worker protections."
    teaser="Apply everything you have learned by researching a real business across all five areas."
