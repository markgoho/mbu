...
req_number: "1d"
prev: "/merit-badges/american-business/guide/req1c/"
prev_title: "Areas of Business"
next: "/merit-badges/american-business/guide/req1e/"
next_title: "Business & the Economy"
---
...
{{< drg/did-you-know >}}
The Triangle Shirtwaist Factory fire happened partly because the factory owners had locked the exit doors to prevent workers from taking breaks. This tragedy led to dozens of new workplace safety laws and helped build public support for unions.
{{< /drg/did-you-know >}}
...
Sometimes unions and employers cannot reach an agreement. Here is what can happen and how both sides can handle it constructively:

- **Step one**: Both sides present their positions and listen to the other's concerns.
- **Step two**: A neutral **mediator** may be brought in to help find common ground.
- **Step three**: If mediation fails, the dispute may go to **arbitration**, where a third party makes a binding decision.
- **Step four**: As a last resort, workers may **strike** (refuse to work) or employers may **lock out** workers — but both actions are costly and usually a sign that cooperation has broken down.

The best outcomes happen when both sides approach the table with respect and a willingness to compromise.
{{< /drg/be-prepared >}}

{{< drg/image src="images/workers-negotiating-table.avif" alt="Union representatives and business managers sitting across a conference table engaged in collaborative negotiation, with documents and charts between them" >}}
...
{{< drg/external-link
    title="History of Labor Unions — U.S. Department of Labor"
    url="https://www.dol.gov/general/aboutdol/history/union-702"
    description="The Department of Labor's overview of American labor union history, from early organizing to modern-day challenges." >}}
...
{{< drg/next-page
    text="You have explored labor unions and the power of collective action."
    teaser="See how business activity ripples through local, national, and global economies."
