...
{{< drg/tip >}}
Think of the income statement like your own monthly budget. Money in (allowance, job earnings) minus money out (food, entertainment, savings) equals what you have left. A business does the exact same calculation — just with a lot more zeros.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The balance sheet is called a "balance" sheet because it must always balance — assets on one side must equal liabilities plus equity on the other. If it does not balance, something is wrong with the records.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/financial-statements-desk.avif" alt="A business professional reviewing printed financial statements at a desk with a calculator, coffee cup, and laptop showing charts and graphs" >}}
...
{{< drg/checklist title="Key Terms to Know" subtitle="Be ready to explain these to your counselor" >}}
...
{{< drg/external-link
    title="Financial Statements Explained — Investopedia"
    url="https://www.investopedia.com/terms/f/financial-statements.asp"
    description="A beginner-friendly overview of the three financial statements and how they work together." >}}
...
{{< drg/next-page
    text="You now understand the three key financial statements."
    teaser="Discover how interest rates, taxes, and government spending shape business decisions."
