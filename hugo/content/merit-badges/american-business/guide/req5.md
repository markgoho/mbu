...
This requirement brings everything together. You will pick a real business and examine it through the lens of the five primary areas you learned about in [Req 1c — Areas of Business](/merit-badges/american-business/guide/req1c/). Think of yourself as a business analyst — someone whose job is to understand how a company operates and explain it clearly.
...
{{< drg/tip >}}
Local businesses are often the best choice for this requirement. Owners of small businesses are usually happy to talk about how they run their company. You will get real, firsthand information instead of just reading about a big corporation online. Plus, it is great practice for the interview option in Requirement 6.
{{< /drg/tip >}}
...
{{< drg/image src="images/scout-researching-business.avif" alt="A Scout sitting at a desk with a notebook and laptop, researching a business — with notes organized into five sections labeled Accounting, Finance, Economics, Marketing, and Management" >}}
...
{{< drg/checklist title="Research Organizer" subtitle="Use this framework to organize your findings" >}}
...
{{< drg/be-prepared title="Making the Most of Your Research" >}}
You have chosen a local pizza restaurant to research. Here is how to prepare:

- **Step one**: Visit the restaurant and observe. How busy is it? How is the space laid out? What is the menu like?
- **Step two**: Ask the manager if you can schedule a brief interview for a Scout merit badge. Come with written questions.
- **Step three**: Check their website and social media. How do they market themselves? Do they offer online ordering?
- **Step four**: Organize your notes by the five areas. Look for connections — for example, how does their marketing strategy affect their revenue (accounting)?
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="SEC EDGAR — Public Company Filings"
    url="https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&type=10-K&dateb=&owner=include&count=40"
    description="Search for annual reports (10-K filings) from any publicly traded company. A great resource for researching large corporations." >}}
...
{{< drg/next-page
    text="You have researched a real business across all five areas."
    teaser="Explore career paths in business — or interview a business leader to learn from their experience."
