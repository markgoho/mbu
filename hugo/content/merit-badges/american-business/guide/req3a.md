...
{{< drg/did-you-know >}}
Not all profits are the same size. The average profit margin (profit as a percentage of revenue) varies dramatically by industry. Grocery stores typically earn around 1–3% profit margins — meaning for every $100 in sales, they keep just $1 to $3. Software companies, on the other hand, can have profit margins above 30%.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When you explain the role of profit to your counselor, go beyond the simple definition. Talk about profit as a motivator, a survival tool, a signal of value, and a responsibility. Show that you understand both why businesses need profit and how they should earn it.
{{< /drg/tip >}}

{{< drg/image src="images/profit-reinvestment-cycle.avif" alt="A circular diagram showing how profit flows: business earns revenue, pays expenses, uses remaining profit to reinvest in the business, which creates more value and more revenue" >}}
...
{{< drg/be-prepared title="When Profit Drops to Zero" >}}
Imagine you have been running a successful lawn care business, but a wet summer means fewer customers. Your revenue drops, but your expenses (equipment payments, gas, insurance) stay the same.

- **Step one**: Review your expenses. Can you reduce any costs without hurting service quality?
- **Step two**: Look for new revenue. Could you offer additional services like leaf removal or gutter cleaning?
- **Step three**: Use your savings. This is exactly why smart businesses keep a cash reserve.
- **Step four**: Plan for next season. Adjust pricing, marketing, or your service area to restore profitability.

Profit is not guaranteed — it takes constant attention, adaptation, and good decision-making.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Understanding Business Profit — Investopedia"
    url="https://www.investopedia.com/terms/p/profit.asp"
    description="A clear explanation of the different types of profit and why they matter for businesses of all sizes." >}}

---

Profit drives business, but today's consumers also care about how businesses treat the planet. Let's explore green marketing and sustainability.

{{< drg/next-page
    text="You understand why profit is central to business."
    teaser="Learn how businesses balance profitability with environmental responsibility."
