...
{{< drg/did-you-know >}}
About 73% of all U.S. businesses are sole proprietorships. They are the most common business structure because they are the easiest and cheapest to set up — in many cases, you just start working and file the appropriate tax forms.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/raising-capital-paths.avif" alt="A visual diagram showing different paths for raising capital — a sole proprietor with personal savings, partners pooling resources, and a corporation with stock certificates, bonds, and bank documents" >}}

{{< drg/tip >}}
A quick way to remember the difference between stocks and bonds: when you buy **stock**, you become an **owner**. When you buy a **bond**, you become a **lender**. Owners share in the profits (and the risks). Lenders get their money back with interest.
{{< /drg/tip >}}

{{< drg/checklist title="Capital Sources Summary" subtitle="Quick reference for your counselor discussion" >}}
...
{{< drg/external-link
    ...
    description="The U.S. Small Business Administration explains the different business structures and their advantages." >}}
...
{{< drg/next-page
    text="You know how different businesses raise the capital they need."
    teaser="Discover the five types of insurance that keep businesses safe from the unexpected."
