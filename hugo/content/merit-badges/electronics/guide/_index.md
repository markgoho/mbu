...
{{< drg/image src="images/scout-electronics-workbench.avif" alt="A teenager in a clean Scout uniform examining a circuit board at an electronics workbench with a soldering iron, multimeter, and components visible" >}}
...
{{< drg/did-you-know >}}
The first transistor built at Bell Labs in 1947 was about the size of your palm. Today, transistors on modern chips are just 3 nanometers wide — about 25,000 times thinner than a human hair. Engineers can fit over 100 billion transistors onto a single chip.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/electronics-branches-overview.avif" alt="Four-panel grid showing analog electronics, digital electronics, power electronics, and embedded systems" >}}

{{< drg/safety-first >}}
Electronics involve electricity, hot tools, and chemicals. Before you start any project, always work in a well-ventilated area, wear safety glasses when soldering, and never work on a powered circuit. You will learn the full set of safety precautions in Requirement 1.
{{< /drg/safety-first >}}

{{< drg/next-page
    text="Before you pick up a soldering iron or touch a circuit board"
    teaser="learn the safety precautions that keep you and your equipment protected."
    url="/merit-badges/electronics/guide/req1/" >}}
