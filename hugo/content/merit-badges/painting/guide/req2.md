...
{{< drg/did-you-know >}}
Even a clear finish with no added color is still a coating. Its job may be protection, sheen, or moisture resistance rather than color change.
{{< /drg/did-you-know >}}

{{< drg/video
    title="Epoxy Resin Coatings (video)"
    url="https://www.youtube.com/watch?v=A-ERekKoohI" >}}
...
{{< drg/tip >}}
Do not assume "water-based" means "works everywhere." Always match the product to the surface, the primer, and the conditions listed on the label.
{{< /drg/tip >}}

{{< drg/video
    title="Paints - Oil, Water, Enamel, Acrylic (video)"
    url="https://www.youtube.com/watch?v=jEyTpUfbrYA" >}}

{{< drg/video
    title="Water vs Oil Based Paints (video)"
    url="https://www.youtube.com/watch?v=T99OFHCLF4s" >}}
...
{{< drg/video
    title="Paint Sheen Differences Explained (video)"
    url="https://www.youtube.com/watch?v=DyKh80Yt9k0" >}}

{{< drg/image src="images/paint-sheen-board.avif" alt="Sample board showing the same paint color in flat, eggshell, satin, semi-gloss, and gloss finishes under angled light" >}}
...
{{< drg/checklist title="How to explain your choice" subtitle="Use this logic for each finish" >}}
...
{{< drg/external-link
    title="OSHA — Safety and Health Topics: Lead"
    url="https://www.osha.gov/lead"
    description="Background on lead hazards that matter when older painted surfaces are sanded, scraped, or repaired." >}}

As you head to the next page, shift from paint theory to real planning. You are about to choose projects, prepare surfaces, and make the same kinds of decisions real painters make.

{{< drg/next-page
    text="You can now explain what different coatings do and when to use them."
    teaser="Next, plan two real painting projects with proper prep, patching, primers, and topcoats."
