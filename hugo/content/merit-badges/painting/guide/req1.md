---
title: "Work Safe Before You Paint"
layout: "guide"
group_title: "1. Safe Prep & Application"
req_number: "1"
req_path: "1"
prev: "/merit-badges/painting/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/painting/guide/req2/"
next_title: "Coatings, Paint Types & Sheen"
---
...
{{< drg/checklist title="Safe Setup Before Painting" subtitle="Do these things before you stir, sand, or roll" >}}
...
{{< drg/safety-first >}}
If you are working on an older building, never assume old paint is harmless. Older coatings may contain lead. If lead is possible, stop and get adult guidance before sanding, scraping, or creating dust.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Sand only as aggressively as the surface needs. You are trying to create a smooth, paint-ready surface, not grind the material away.
{{< /drg/tip >}}
...
- **Tell an adult right away** if you are not already working directly with one.
- **Bring the product label** if medical help is needed.
  {{< /drg/be-prepared >}}
...
{{< drg/did-you-know >}}
Fresh paint may feel dry to the touch long before all of its vapors have fully cleared from the room. That is one reason ventilation should continue after you stop painting.
{{< /drg/did-you-know >}}
...
{{< drg/video
    title="Interior Painting Safety (video)"
    url="https://www.youtube.com/watch?v=4vpr3e_erug" >}}
...
{{< drg/next-page
    text="You know how to protect yourself and your workspace before painting."
    teaser="Now learn what different coatings actually do and why painters choose one finish over another."
