---
title: "Research a Painting Career"
layout: "guide"
group_title: "8. Futures in Painting"
req_number: "8a"
req_path: "8.a"
prev: "/merit-badges/painting/guide/req8/"
prev_title: "Choose a Painting Path"
next: "/merit-badges/painting/guide/req8b/"
next_title: "Make Painting Part of Your Life"
---
...
{{< drg/checklist title="Career research notes" subtitle="Make sure you can speak to each of these" >}}
...
{{< drg/tip >}}
Bring your own questions instead of relying only on a website. The most interesting counselor discussion usually comes from details like "What makes this work satisfying?" or "What mistakes do beginners make most often?"
{{< /drg/tip >}}
...
{{< drg/video
    title="Painters Career Overview (video)"
    url="https://youtu.be/5glRwgnb5gk" >}}

{{< drg/video
    title="Scenic Painter (video)"
    url="https://youtu.be/mWjbRoAId_4" >}}

{{< drg/external-link
    title="Painting Contractors Association"
    url="https://www.pcapainted.org/"
    description="An industry association with education, standards, and career information related to professional painting contractors." >}}
...
{{< drg/next-page
    text="You have explored how painting skills connect to real careers."
    teaser="Next, see how the same skills can support hobbies, creative projects, and a healthy lifestyle."
