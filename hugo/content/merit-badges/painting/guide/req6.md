...
{{< drg/video
    title="Ladder Safety (video)"
    url="https://www.youtube.com/watch?v=b7ArZilnnTE" >}}

{{< drg/safety-first >}}
Do not stand on the top step or top cap of a step ladder unless the ladder is specifically designed for it. If the ladder is too short for the job, the fix is a taller ladder, not riskier behavior.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
One of the easiest ways hazardous dust enters the body is not through some dramatic accident. It happens when someone touches their face or eats lunch without washing up first.
{{< /drg/did-you-know >}}
...
{{< drg/video
    title="Personal Protective Equipment for Painting (PPE) (video)"
    url="https://www.youtube.com/watch?v=67G06bhuxPA" >}}
...
{{< drg/checklist title="Ask these questions before you start" subtitle="They will tell you what protection you need" >}}
...
- **Move to fresh air.**
- **Tell an adult and review the product label.**
- **Do not resume until the cause is understood and corrected.**
  {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You understand how ladders, hygiene, and PPE keep a painter safe."
    teaser="Next, explore what can go wrong for people and the environment when paint is removed, applied, or discarded carelessly."
