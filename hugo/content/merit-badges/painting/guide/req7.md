...
{{< drg/video
    title="Paint Removers (video)"
    url="https://www.youtube.com/watch?v=8lG6dAZE52k" >}}
...
{{< drg/tip >}}
Think of your drop cloth and masking setup as environmental protection, not just cleanup convenience. Containing the product is part of doing the job right.
{{< /drg/tip >}}
...
{{< drg/video
    title="How to Dispose of Old Paint (video)"
    url="https://www.youtube.com/watch?v=7YKuwlGgWpc" >}}

{{< drg/checklist title="Responsible paint disposal habits" subtitle="Use local rules, but keep these principles in mind" >}}
...
{{< drg/external-link
    ...
    description="Find paint recycling and take-back information in states that participate in the PaintCare program." >}}

{{< drg/external-link
    title="EPA — Lead"
    url="https://www.epa.gov/lead"
    description="Federal guidance on lead hazards, especially important when removing old paint from older buildings." >}}

{{< drg/safety-first >}}
Never burn painted material, grind unknown old paint into dust, or improvise disposal because you want the mess gone quickly. When you are uncertain, stop and ask an adult or local disposal authority before continuing.
{{< /drg/safety-first >}}

{{< drg/image src="images/responsible-paint-disposal-flow.avif" alt="Diagram showing leftover paint being sealed in labeled containers, kept off storm drains, and taken to an approved recycling or disposal site" >}}
...
{{< drg/next-page
    text="You can now explain how painting choices affect people and the environment."
    teaser="Next, choose whether to explore a painting career or a painting-related hobby and future goal."
