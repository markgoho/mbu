...
req_number: "5"
prev: "/merit-badges/citizenship-in-the-nation/guide/req4c/"
prev_title: "Req 4c — E Pluribus Unum"
next: "/merit-badges/citizenship-in-the-nation/guide/req6/"
next_title: "Req 6 — A Historic Speech"
---
...
{{< drg/tip >}}
Choose one source and stick with it for all five days. This makes it easier to follow developing stories and see how issues evolve over time. Consistency matters more than variety for this requirement.
{{< /drg/tip >}}
...
{{< drg/checklist title="Daily News Tracker" subtitle="Record these details each day" >}}
- Date: What day is it?
...
{{< drg/be-prepared title="How to Make the Connection" >}}
For any issue you choose, try answering these questions:

- **How does it affect me?** Does this issue change anything about my school, my rights, my future opportunities, or my daily life?
- **How does it affect my family?** Does it involve taxes, healthcare, jobs, housing, or any services my family uses?
- **How does it affect my community?** Does it impact local businesses, schools, infrastructure, the environment, or public safety in my area?
{{< /drg/be-prepared >}}
...
{{< drg/safety-first >}}
Be cautious about information you find on social media. Social media posts are not the same as journalism. Legitimate news organizations employ trained reporters, use fact-checkers, and follow editorial standards. When in doubt, check whether a story is reported by multiple credible outlets before accepting it as fact.
{{< /drg/safety-first >}}
...
{{< drg/external-link
    ...
    description="Watch or stream the PBS NewsHour for in-depth, balanced coverage of national and international news." >}}

{{< drg/external-link
    title="C-SPAN"
    url="https://www.c-span.org/"
    description="Watch live coverage of Congress, the White House, and the Supreme Court — unfiltered and without commentary." >}}

{{< drg/next-page
    text="Now that you have practiced following national news"
    teaser="Discover the power of words by choosing and analyzing a historic American speech."
