...
{{< drg/tip >}}
When discussing the Declaration with your counselor, connect its ideas to today. Where do you see the principles of equality, unalienable rights, and government by consent at work in modern America? Where does the country still fall short?
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    description="Read the full text of the Declaration, learn about the signers, and explore the story behind the document." >}}

{{< drg/external-link
    title="National Constitution Center — Declaration of Independence"
    url="https://constitutioncenter.org/the-constitution/historic-document-library/detail/declaration-of-independence"
    description="Expert analysis of the Declaration's key passages and their meaning in American history." >}}

{{< drg/next-page
    text="Now that you know why the Declaration matters"
    teaser="Explore the Bill of Rights and the 14th Amendment — the protections that guarantee your individual freedoms."
