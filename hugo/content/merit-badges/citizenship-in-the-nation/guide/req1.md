...
1. **Creates the government.** It establishes three branches — legislative, executive, and judicial — and spells out what each branch can and cannot do.
2. **Limits the government.** It puts boundaries on government power so that no single person or group can become a tyrant.
3. **Protects individual rights.** Through the Bill of Rights and later amendments, it guarantees freedoms like speech, religion, and due process.
4. **Provides a way to change.** The amendment process allows the Constitution to grow and adapt as the nation evolves.

{{< drg/did-you-know >}}
The U.S. Constitution is the oldest written national constitution still in use anywhere in the world. It has been amended only 27 times in over 230 years — a testament to how carefully it was designed.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="What If Someone Says the Constitution Is Outdated?" >}}
You might hear people argue that a document written over 230 years ago cannot possibly apply to modern life. Here is how to think about it:

- The Constitution was intentionally written in broad principles, not specific details, so it could adapt to changing times.
- The amendment process allows the country to update it when needed — as it has 27 times.
- The courts constantly interpret the Constitution in light of modern issues, from internet privacy to digital free speech.
- The core ideas — limited government, individual rights, rule of law — are timeless.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    ...
    description="Read the full text of the Constitution with expert analysis and commentary on every section and amendment." >}}
...
{{< drg/next-page
    ...
    teaser="Explore the Preamble — the six purposes that explain why the Constitution was created."
