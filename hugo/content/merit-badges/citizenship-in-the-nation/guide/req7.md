...
{{< drg/tip >}}
Bring a notebook and take notes during your visit. Jot down dates, names, and interesting details while they are fresh. This will make your discussion with your counselor much easier and more detailed.
{{< /drg/tip >}}
...
{{< drg/tip >}}
If you are not sure what federal facilities are near you, ask a parent or your counselor. A local post office is available in almost every community, and many post offices have interesting historical displays or architecture worth exploring.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="National Park Service — Find a Park"
    url="https://www.nps.gov/findapark/index.htm"
    description="Search for national parks, monuments, historic sites, and other NPS-managed places near you." >}}

{{< drg/external-link
    title="National Register of Historic Places"
    url="https://www.nps.gov/subjects/nationalregister/database-research.htm"
    description="Search the database of over 95,000 historic places across the United States to find one near you." >}}

{{< drg/external-link
    title="U.S. Capitol Visitor Center"
    url="https://www.visitthecapitol.gov/"
    description="Plan your visit to the U.S. Capitol, schedule a free tour, and explore the Capitol's history and architecture." >}}

{{< drg/next-page
    text="Now that you have experienced your nation's history and government in person"
    teaser="Take the final step — contact your representative in Congress and make your voice heard."
