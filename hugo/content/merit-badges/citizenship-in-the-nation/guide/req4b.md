...
{{< drg/safety-first >}}
Freedom of speech has limits. It does not protect threats of violence, incitement to immediate lawless action, or knowingly false statements that harm someone's reputation (defamation). Understanding these limits is part of being a responsible citizen.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
When discussing the Bill of Rights and 14th Amendment with your counselor, pick two or three amendments that you feel are most important to your everyday life. Be ready to explain why you chose them and give a specific example of each one in action.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    description="Explore each amendment in the Bill of Rights with primary sources, explanations, and lesson resources." >}}

{{< drg/external-link
    title="National Archives — The Bill of Rights"
    url="https://www.archives.gov/founding-docs/bill-of-rights"
    description="View the original document, read the full text, and learn about the ratification process." >}}

{{< drg/next-page
    text="Now that you understand the rights the Constitution guarantees"
    teaser="Discover the meaning behind America's traditional motto — E Pluribus Unum."
