...
prev: "/merit-badges/citizenship-in-the-nation/guide/req8/"
prev_title: "Req 8 — Contacting Congress"
---
...
{{< drg/did-you-know >}}
In Tinker v. Des Moines, the Supreme Court ruled 7–2 that students have the right to free expression in school, as long as it does not substantially disrupt the educational process. Mary Beth Tinker was just 13 years old when she wore the armband that led to this landmark case.
{{< /drg/did-you-know >}}

{{< drg/tip >}}
Want to follow the Supreme Court? The website oyez.org has audio recordings of oral arguments and plain-language summaries of every case. It is one of the best free legal resources available.
{{< /drg/tip >}}
...
{{< drg/experience-card title="Visit Washington, D.C." details="Location: Washington, D.C. | Highlights: Tour the Capitol, visit the Smithsonian museums, walk the National Mall, see the monuments and memorials up close" >}}

{{< drg/experience-card title="Attend a Naturalization Ceremony" details="Location: Federal courthouses nationwide | Highlights: Watch new citizens take the Oath of Allegiance and celebrate becoming Americans — one of the most moving civic events you can witness" >}}

{{< drg/experience-card title="Visit Your State Capitol During a Legislative Session" details="Location: Your state capital | Highlights: Watch lawmakers debate and vote on bills in real time from the public gallery" >}}

{{< drg/experience-card title="Join a Mock Trial or Model Congress" details="Location: Schools, civic organizations, and youth programs nationwide | Highlights: Role-play as lawyers, judges, or legislators and see how the legal and legislative processes work from the inside" >}}

{{< drg/experience-card title="Participate in a Citizenship Day Event" details="Location: National Archives and community events nationwide (September 17) | Highlights: Celebrate Constitution Day with readings, reenactments, and educational programs" >}}

### F. Organizations

These organizations offer resources, programs, and opportunities for young citizens who want to stay engaged.

{{< drg/org-card name="National Constitution Center" description="An interactive museum in Philadelphia dedicated to the U.S. Constitution, with extensive online resources and educational programs for students." url="https://constitutioncenter.org/" >}}

{{< drg/org-card name="iCivics" description="Founded by Justice Sandra Day O'Connor, iCivics provides free games, lesson plans, and resources that teach students how government works through interactive experiences." url="https://www.icivics.org/" >}}

{{< drg/org-card name="Bill of Rights Institute" description="Provides educational resources about the Constitution and the Bill of Rights, including primary sources, videos, and lesson plans for students and educators." url="https://billofrightsinstitute.org/" >}}

{{< drg/org-card name="Close Up Foundation" description="Runs civic education programs that bring students to Washington, D.C. to experience government firsthand, including Capitol Hill visits and discussions with policymakers." url="https://www.closeup.org/" >}}

{{< drg/org-card name="C-SPAN Classroom" description="Free educational resources built around C-SPAN's coverage of Congress, the White House, and the courts — including video clips, lesson plans, and discussion guides." url="https://www.c-span.org/classroom/" >}}
