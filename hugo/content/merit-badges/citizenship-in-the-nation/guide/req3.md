...
{{< drg/did-you-know >}}
A bill must pass both the House and the Senate in identical form before it can be sent to the President. On average, only about 5% of bills introduced in Congress ever become law.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="How the Branches Check Each Other" subtitle="Key checks and balances" >}}
...
{{< drg/external-link
    title="USA.gov — Branches of the U.S. Government"
    url="https://www.usa.gov/branches-of-government"
    description="The official U.S. government resource explaining how each branch works and how they interact." >}}

{{< drg/external-link
    title="Congress.gov — How Laws Are Made"
    url="https://www.congress.gov/legislative-process"
    description="Follow a bill from introduction to the President's desk and learn how the legislative process works step by step." >}}

{{< drg/next-page
    text="Now that you understand how the government is structured"
    teaser="Explore the Declaration of Independence — the document that started it all."
