...
{{< drg/tip >}}
Try to find a video or audio recording of your chosen speech. Hearing the words spoken aloud — with the speaker's voice, tone, and emotion — is a completely different experience from just reading them on a page. Many historic speeches are available on YouTube.
{{< /drg/tip >}}
...
{{< drg/checklist title="Speech Analysis Checklist" subtitle="Make sure you cover each point" >}}
...
{{< drg/be-prepared title="What If You Cannot Decide on a Speech?" >}}
If you are stuck choosing, try this approach:

- **Think about a time period that interests you.** Revolutionary War? Civil War? Civil rights era? Space race?
- **Think about an issue you care about.** Freedom? Equality? Service? Courage? Find a speech that addresses that theme.
- **Ask your counselor.** They may have suggestions based on what they know about your interests.
- **Start with the short ones.** The Gettysburg Address is only 272 words. Kennedy's inaugural address is about 1,400 words. Shorter speeches are easier to study deeply.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    ...
    description="Browse the top 100 American speeches of the 20th century with full texts, audio, and video where available." >}}

{{< drg/external-link
    title="National Archives — Milestone Documents"
...
{{< drg/next-page
    ...
    teaser="Get out and experience your nation firsthand — by visiting historic landmarks, government buildings, and national monuments."
