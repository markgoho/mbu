...
{{< drg/video
    title="What Kind of Tree Does Paper Come From (video)"
    url="https://youtube.com/shorts/oRgPQdX0CLI" >}}
...
{{< drg/external-link
    title="Purposes and Techniques of Forest Management (website)"
    url="https://www.britannica.com/science/forestry/Range-and-forage"
    description="Explains how forestland can support more than one use at the same time, including timber, water, wildlife, and grazing." >}}
...
| Method | Main idea | Strengths | Trade-offs |
|---|---|---|---|
| Mechanical | Physically grind or refine wood apart | High fiber yield, good for some printing uses | More lignin stays in the pulp, which can affect brightness and aging |
| Chemical | Use chemicals to dissolve lignin and release fibers | Stronger pulp, cleaner cellulose fiber | Lower yield from the original wood, more process complexity |

A simple way to remember it: **mechanical pulping tears wood apart; chemical pulping cooks it apart**.

{{< drg/video
    title="From Tree to Paper (video)"
    url="https://youtube.com/shorts/c-87Bw_lXso" >}}

{{< drg/tip >}}
If your counselor asks for the "major differences," talk about three things: **how fibers are separated, how much lignin remains, and what that means for yield and strength**.
{{< /drg/tip >}}
...
{{< drg/video
    title="Bleaching (video)"
    url="https://youtu.be/d43q0j831f8" >}}

{{< drg/be-prepared title="A good way to explain bleaching" >}}
Use this sequence when you talk about it:

- **Why bleach?** To make some pulps brighter and cleaner-looking.
- **What is being removed or changed?** Color-causing compounds left after pulping.
- **How does it happen?** In controlled chemical stages with washing and testing between steps.
{{< /drg/be-prepared >}}

{{< drg/image src="images/softwood-vs-hardwood-fibers.avif" alt="Side-by-side diagram showing longer softwood fibers and shorter hardwood fibers, plus simple notes about strength and smoothness" >}}
...
{{< drg/next-page
    text="You now know where papermaking fibers come from and how pulp is produced."
    teaser="Next, learn how paper is formed, recycled, and even made by hand."
