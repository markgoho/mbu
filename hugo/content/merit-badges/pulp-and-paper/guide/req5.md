...
{{< drg/video
    title="Coated vs. Uncoated Paper (video)"
    url="https://youtu.be/TCFpE6vtC4s" >}}
...
{{< drg/checklist title="Match the Paper to the Job" subtitle="Ask these questions when you compare coated papers" >}}
...
{{< drg/did-you-know >}}
A glossy printed sheet can actually use less ink on the surface because the coating keeps the ink from soaking too deeply into the paper.
{{< /drg/did-you-know >}}

{{< drg/image src="images/coated-vs-uncoated-paper.avif" alt="Side-by-side comparison of glossy magazine paper, matte brochure paper, uncoated notebook paper, and absorbent paper towel with short notes on how each surface behaves" >}}
...
{{< drg/next-page
    text="You can now explain why different paper surfaces and treatments exist."
    teaser="Next, build a list of paper products in your home and learn how to choose strong examples for your counselor."
