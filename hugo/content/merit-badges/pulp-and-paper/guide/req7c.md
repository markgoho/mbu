...
{{< drg/external-link
    title="Corrugated Box Companies Listings (website)"
    url="https://corrugatedboxcompanies.com/more-corrugated-box-companies-listings/"
    description="A directory that can help you identify nearby corrugated box and container manufacturers for a possible visit." >}}

## What to Watch for During the Visit

{{< drg/checklist title="Observe These Details" subtitle="They will help you describe the plant's products clearly" >}}
...
{{< drg/tip >}}
Ask whether the plant receives flat board from another facility or makes corrugated board on site. That helps you understand where the plant fits in the larger supply chain.
{{< /drg/tip >}}

{{< drg/image src="images/corrugated-box-layers.avif" alt="Cutaway view of corrugated board showing outer liner, fluted medium, and inner liner, with labels explaining how the structure adds strength" >}}
...
{{< drg/next-page
    text="You are ready to explain how container plants turn paperboard into useful packaging products."
    teaser="Next, head to a recycling collection or sorting facility to see what happens after paper products are used."
