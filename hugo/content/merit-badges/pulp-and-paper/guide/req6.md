...
{{< drg/checklist title="Categories to Include" subtitle="Aim for variety, not just quantity" >}}
...
{{< drg/tip >}}
If you cannot bring the actual product, take a photo or save part of the packaging. Flattened cartons and small box panels are easy to store and compare.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="An easy way to organize your counselor discussion" >}}
Sort your 10 examples into small groups before you meet:

- **Absorbent products**
- **Writing and reading papers**
- **Packaging papers and paperboard**
- **Specialty or coated products**

That structure makes it easier to explain what each product is made to do.
{{< /drg/be-prepared >}}

{{< drg/image src="images/paper-products-sort-table.avif" alt="A tabletop with 10 household paper products grouped into absorbent, writing, packaging, and specialty categories, each with simple labels" >}}
...
{{< drg/next-page
    text="You can now identify and compare real pulp and paper products at home."
    teaser="Next, choose the industry experience that best fits your location, access, and interests."
