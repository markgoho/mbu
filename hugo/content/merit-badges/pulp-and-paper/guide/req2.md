...
{{< drg/video
    title="How They Grow Trees for Paper Manufacture (video)"
    url="https://youtu.be/qNX5EkbqYek" >}}

{{< drg/tip >}}
When you explain this to your counselor, connect the three verbs in order: **plant or regenerate**, **manage while trees grow**, and **harvest for the right end use**. That shows you understand it as a cycle, not three separate facts.
{{< /drg/tip >}}
...
{{< drg/video
    title="Forest Management (video)"
    url="https://youtu.be/jGvlrhivWo8" >}}

{{< drg/checklist title="How the Industry Tries to Keep Pace" subtitle="These are the levers foresters and mills can adjust" >}}
...
{{< drg/video
    title="Sustainable Forestry (video)"
    url="https://youtu.be/dYFt-3LNNNg" >}}

{{< drg/did-you-know >}}
A forest can be both productive and renewable, but only if new growth replaces what is harvested and the land stays healthy enough to keep producing fiber. Sustainability is about the next rotation of trees, not just today's cut.
{{< /drg/did-you-know >}}
...
{{< drg/video
    title="Green Spotlight on the Paper Industry (video)"
    url="https://youtu.be/bNjp_J3yang" >}}

{{< drg/be-prepared title="What to listen for on a tour or in a discussion" >}}
If you visit a mill or talk with someone in the industry, listen for these ideas:

- **Water treatment:** How is process water cleaned and reused?
- **Air emissions:** What equipment helps reduce smoke, odors, or particulates?
- **Fiber recovery:** What happens to scraps, sludge, or off-spec material?
- **Monitoring:** How does the plant know whether it is meeting environmental rules?
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You now understand the forest side of the industry."
    teaser="Next, learn which trees supply papermaking fiber and how wood is turned into pulp."
