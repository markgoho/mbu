...
{{< drg/video
    title="Production of Paper (video)"
    url="https://youtu.be/OEbf9ffkyy8" >}}

{{< drg/video
    title="From Tree to Sheet: How Paper Is Made | Unveiling the Manufacturing Process (video)"
    url="https://youtu.be/invUjqvE0Oc" >}}

{{< drg/did-you-know >}}
In many mills, the paper machine is so large and fast that workers think of it as a whole production line by itself, not just a single machine.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When you discuss recycling, mention both the benefit and the limit: recycling saves usable fiber and reduces waste, but fibers wear out over repeated cycles, so fresh fiber is still important.
{{< /drg/tip >}}
...
{{< drg/video
    title="How to Make Handmade Paper from Recycled Materials (video)"
    url="https://youtu.be/Ow5LeG-zzyg" >}}

{{< drg/checklist title="Before You Make a Sheet by Hand" subtitle="Set yourself up for a cleaner result" >}}
...
{{< drg/be-prepared title="If your first handmade sheet looks rough" >}}
That is normal. Try these fixes:

- **Too thick?** Add more water to the slurry.
- **Falls apart?** Use longer soaking time or gentler lifting.
- **Lumpy?** Blend the pulp more evenly.
- **Sticks to the screen?** Let it drain longer before pressing.
{{< /drg/be-prepared >}}

{{< drg/safety-first >}}
If you make paper at home, use scissors and blenders with adult awareness and follow your household rules. Never put metal, plastic, or unknown scraps into a blender. Keep cords, wet hands, and outlets separated.
{{< /drg/safety-first >}}

{{< drg/image src="images/hand-papermaking-steps.avif" alt="Four-panel diagram showing soaked scraps, blended pulp slurry, sheet lifting on a screen, and pressed handmade paper drying flat" >}}
...
{{< drg/next-page
    text="You now know how paper is formed, recycled, and made by hand."
    teaser="Next, explore coated paper and other ways manufacturers engineer paper for special uses."
