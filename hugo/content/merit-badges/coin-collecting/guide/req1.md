...
{{< drg/did-you-know >}}
The U.S. Mint produces roughly 14 billion coins per year. Laid edge to edge, that is enough to circle the Earth more than 20 times.
{{< /drg/did-you-know >}}

{{< drg/image src="images/coin-striking-process.avif" alt="Diagram showing the six steps of coin production: metal coil, blanking press punching circles, annealing furnace, upsetting mill adding rim, coining press with two dies striking, and finished coins in a bag" >}}
...
{{< drg/tip >}}
When you examine your coins for this badge, look for the mint mark. On modern coins, it is usually found on the obverse (front) near the date. The mint mark tells you exactly which facility struck that coin — and some mint marks are much rarer than others for certain years.
{{< /drg/tip >}}

{{< drg/external-link
    title="How Coins Are Made — U.S. Mint"
    url="https://www.usmint.gov/learn/coin-and-medal-programs/how-coins-are-made"
    description="The official U.S. Mint page walks through the entire coin production process with photos and diagrams." >}}

{{< drg/image src="images/us-mint-facilities-map.avif" alt="A simple map of the United States showing the locations of all active U.S. Mint facilities: Philadelphia (PA), Denver (CO), San Francisco (CA), West Point (NY), Washington D.C. headquarters, and Fort Knox (KY), with each location labeled with its mint mark letter" >}}
...
{{< drg/next-page
    text="Now that you know how coins are made"
    teaser="Learn the language collectors use to describe what they see."
