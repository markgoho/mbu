...
req_number: "4d"
prev: "/merit-badges/coin-collecting/guide/req4c/"
prev_title: "Req 4c — The Ten-Cent Coin"
next: "/merit-badges/coin-collecting/guide/req4e/"
next_title: "Req 4e — The Half Dollar"
---
...
**Design features:**
- **Obverse:** Washington facing left. "LIBERTY" above, "IN GOD WE TRUST" below and to the left, date at the bottom. Flanagan's initials "JF" (later "JFL") appear at the base of Washington's neck.
- **Reverse:** A heraldic eagle with outstretched wings, clutching arrows and an olive branch. "UNITED STATES OF AMERICA" and "E PLURIBUS UNUM" above, "QUARTER DOLLAR" below.

This design ran without major changes from 1965 through 1998 (the 1975–1976 Bicentennial coins were a temporary exception — you will learn about those in [Req 5](/merit-badges/coin-collecting/guide/req5/)).
...
{{< drg/did-you-know >}}
The 50 State Quarters Program inspired an estimated 147 million Americans to start collecting coins — nearly half the population at the time. It remains the most successful coin program in U.S. Mint history by any measure.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
For the American Women Quarters, the requirement specifies 2022–2024 even though the program extends through 2025. You need two designs from this program. Check your change carefully — these quarters are in active circulation. Coin roll hunting (buying rolls of quarters from the bank and searching through them) is an efficient way to find specific designs.
{{< /drg/tip >}}
...
{{< drg/checklist title="Quarter Collection Checklist" >}}
...
{{< drg/external-link
    title="Quarter Programs — U.S. Mint"
    url="https://www.usmint.gov/learn/coin-and-medal-programs/quarter-programs"
    description="The Mint's hub page for all quarter programs, with design galleries and background on each series." >}}

{{< drg/next-page
    text="Your quarter collection is taking shape"
    teaser="Next up: the half dollar — a coin you might not see every day, but one with a powerful story."
