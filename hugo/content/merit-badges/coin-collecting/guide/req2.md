...
{{< drg/did-you-know >}}
"E Pluribus Unum" originally referred to the thirteen colonies uniting to form one nation. It appeared on U.S. coins as early as 1795 and was the country's unofficial motto until "In God We Trust" was officially adopted in 1956.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Knowing about clad construction helps you date coins at a glance. If a dime or quarter has a uniform silvery edge with no copper stripe, it was likely minted before 1965 and contains real silver. That is a good coin to set aside and show your counselor.
{{< /drg/tip >}}

{{< drg/image src="images/coin-anatomy-labeled.avif" alt="A large detailed diagram of a quarter showing both obverse and reverse sides with labeled parts: obverse (portrait, date, mint mark, motto, designer initials), reverse (design, denomination, mottos), edge showing reeding grooves, and a cross-section cutaway showing the clad layers (copper core between copper-nickel outer layers)" >}}
...
{{< drg/be-prepared title="Which Approach Is Right for You?" >}}
Not sure whether to start with a type set or a date set? Ask yourself these questions:

- **Do you love variety?** A type set lets you explore many different designs and time periods.
- **Do you love the hunt?** A date set turns every coin jar, bank roll, and flea market into a treasure hunt for that one missing year.
- **What is your budget?** Type sets can include expensive coins (like silver dollars) but you only need one of each. Date sets can be built cheaply if you pick an affordable series like Lincoln cents.

Many collectors do both — a type set for the big picture and a date set for their favorite series.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    title="Coin Terminology Glossary — American Numismatic Association"
    url="https://www.money.org/numismatic-glossary"
    description="A comprehensive glossary of coin collecting terms from the ANA, covering hundreds of terms beyond the six covered here." >}}

{{< drg/next-page
    text="Now that you speak the language"
    teaser="Learn how to protect and store the coins you collect."
