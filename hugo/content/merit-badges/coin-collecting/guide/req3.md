...
{{< drg/image src="images/coin-album-open.avif" alt="An open coin album showing a page of Lincoln cents organized by year, with some slots filled and others empty, a clear plastic slide partially lifted to reveal a coin underneath" >}}
...
{{< drg/safety-first >}}
Avoid any coin holder made with PVC (polyvinyl chloride). Over time, PVC breaks down and deposits a green, oily residue on the coin's surface that can permanently damage it. Always look for holders labeled "PVC-free," "Mylar," or "archival quality." If a soft plastic flip feels oily or has a chemical smell, do not use it.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
You do not need to slab every coin in your collection. Most collectors reserve third-party grading for their most valuable or questionable coins. For the coins you are collecting for this merit badge, albums and individual holders are perfectly appropriate.
{{< /drg/tip >}}
...
{{< drg/checklist title="Coin Storage Essentials" >}}
...
{{< drg/did-you-know >}}
A coin's original mint luster — the frosty, cartwheel-like sheen on an uncirculated coin — is caused by microscopic flow lines created when metal is forced into the die at high pressure. Once that luster is polished or cleaned away, it can never be restored. That is why "never clean your coins" is the first rule of collecting.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Coin Care and Preservation — PCGS"
    url="https://www.pcgs.com/news/coin-care-and-preservation"
    description="PCGS's guide to handling, storing, and preserving coins covers best practices used by serious collectors." >}}

{{< drg/next-page
    text="Your storage plan is set"
    teaser="Start building your collection with the one-cent coin — and discover why the pennies in your pocket are more interesting than you think."
