...
{{< drg/did-you-know >}}
The Susan B. Anthony dollar has an eleven-sided inner border (a hendecagon) on both sides. This was supposed to help distinguish it from the quarter by touch, but the coin's overall round shape and similar color meant most people never noticed.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/dollar-coins-three-series.avif" alt="Three U.S. dollar coins arranged side by side: the Susan B. Anthony dollar (silver-colored with eleven-sided border), the Sacagawea dollar (golden color, smooth edge), and a Presidential dollar (golden, with edge lettering), each labeled with series name and years" >}}
...
{{< drg/tip >}}
The edge lettering on Presidential dollars is a feature you should examine closely. Rotate the coin slowly under good light and you will see the date, mint mark, and mottos pressed into the rim. Occasionally, coins escaped the Mint without edge lettering — these error coins (called "smooth edge" or "godless" dollars) are worth a significant premium to collectors.
{{< /drg/tip >}}
...
{{< drg/checklist title="Finding Dollar Coins" >}}
...
{{< drg/external-link
    title="Dollar Coin Programs — U.S. Mint"
    url="https://www.usmint.gov/learn/coin-and-medal-programs/dollar"
    description="The Mint's hub page covering all modern dollar coin programs, from the Susan B. Anthony through the current Native American series." >}}

{{< drg/next-page
    text="All six denominations are in your collection"
    teaser="Before moving on, take a special look at the coins from 1975 and 1976 — the year America turned 200."
