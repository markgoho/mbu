...
{{< drg/safety-first >}}
Do not soak rare covers, first day covers, or any item you might want to keep intact as a whole. Once you separate the stamp, you cannot undo it.
{{< /drg/safety-first >}}

{{< drg/video
    title="How to Soak Postage Stamps off Paper (video)"
    url="https://youtu.be/xbdFwdo7gW8?si=GiMrdGKX3twCE_rl" >}}
...
{{< drg/next-page
    text="You can now explain how collectors soak used stamps safely."
    teaser="Next, see how magnifiers help you inspect details too small to trust to the naked eye."
