...
{{< drg/video
    title="How Do You Mount Your Stamps in an Album (video)"
    url="https://www.youtube.com/watch?v=WvQGoi62i9U" >}}
...
{{< drg/video
    title="How to Trim Self-Adhesive Stamps for Mounts (video)"
    url="https://youtu.be/_HT-sU7NHdI?si=X14V2fIh0yn2ndZd" >}}

{{< drg/tip >}}
Before mounting anything, lay the stamps on the page without attaching them. That lets you adjust spacing and order before you commit.
{{< /drg/tip >}}
...
{{< drg/video
    title="3 Attractive Ways to Store and Display Your Stamp Collection (video)"
    url="https://youtu.be/i6sIwSc3jYs?si=UdDB47GrWSNvSdqa" >}}

{{< drg/checklist title="Three preservation points to mention" subtitle="Choose any three, but explain why they matter" >}}
...
{{< drg/safety-first >}}
Never trim, soak, or mount something valuable until you know exactly what it is. A careless "improvement" can destroy the very feature that makes a cover or stamp important.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You can now show an album page and explain how to protect a collection for the long term."
    teaser="Next, choose two project options that let you design, visit, research, review, or build something with your stamps."
