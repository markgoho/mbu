...
{{< drg/external-link
    title="Have Lasting Fun: How to Create an Exhibit and Enter It Into a Show (website)"
    url="https://www.linns.com/insights/have-lasting-fun--how-to-create-an-exhibit-and-enter-it-into-a-s.html"
    description="A helpful introduction to organizing a stamp exhibit so the viewer can follow a clear theme and story from page to page." >}}

{{< drg/tip >}}
If you cannot explain your display in one sentence, the theme may be too broad. Tight themes make stronger exhibits.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You know how to shape stamps into a display that tells a story."
    teaser="Next, choose the final collection project you will mount and show in an album."
