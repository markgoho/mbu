...
{{< drg/checklist title="Progress plan for option 8a" subtitle="A simple way to build toward 250 stamps" >}}
...
{{< drg/next-page
    text="You know how to turn a large international pile into an organized album project."
    teaser="Next, see how geography can become the organizing idea for a 50-country map collection."
