...
{{< drg/checklist title="Catalog demonstration steps" subtitle="Use this order when you show your counselor how a catalog works" >}}
...
{{< drg/video
    title="What is Grading In Stamp Collecting? (video)"
    url="https://youtu.be/xlmqU1LOoAw?si=1uEac-awB-qJ8JjJ" >}}

{{< drg/video
    title="Stamp Collecting Basics - The Scott Catalogue: More Than Just Stamp Values (Pt 1) (video)"
    url="https://youtu.be/fjnm2Val5UQ?si=C_AUKlkD-vV9Nir3" >}}

{{< drg/video
    title="Stamp Collecting Basics - The Scott Catalogue: Reading Stamp Listings (Pt 2) (video)"
    url="https://youtu.be/_-m6ctmETJ8?si=6DamNPvgEw7dmThC" >}}

{{< drg/external-link
    title="Scott Stamp catalog (website)"
    url="https://www.amosadvantage.com/stamp-guides/understanding-the-scott-catalogue-listings?srsltid=AfmBOoqte-RSdjk3HCWRZaloAtUI6Paw1_kCOXQeFaMd4VOzwe-axbCh"
    description="A practical guide to reading Scott catalog listings, including the details collectors use to match the right stamp to the right entry." >}}
...
{{< drg/did-you-know >}}
A missing perforation or a small thin spot on the back can make a stamp lose most of its value, even if the front still looks fine at first glance.
{{< /drg/did-you-know >}}

{{< drg/tip >}}
When you show examples to your counselor, bring at least two similar stamps and point out the differences side by side. Condition is much easier to explain by comparison than by definition alone.
{{< /drg/tip >}}

{{< drg/video
    title="Stamp Collecting Basics - The Scott Catalogue (video)"
    url="https://youtu.be/fjnm2Val5UQ?si=C_AUKlkD-vV9Nir3" >}}

{{< drg/be-prepared title="What to say when comparing two stamps" >}}
Use a simple pattern when you explain value differences:

- **First**, identify what the two stamps have in common.
- **Next**, point out the condition differences such as centering, gum, perforations, or tears.
- **Then**, explain how those differences affect desirability and price.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You now know why value depends on both catalog information and physical condition."
    teaser="Next, choose stamp collector's tools and learn what each one helps you do."
