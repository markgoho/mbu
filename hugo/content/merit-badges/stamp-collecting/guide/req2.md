...
### Regional or related-country collection
...
{{< drg/checklist title="Choosing a collecting style" subtitle="Think through these questions before you start filling an album" >}}
...
{{< drg/tip >}}
A great beginner topic is one that is broad enough to find often but narrow enough to feel organized. "Animals" is probably too broad. "Owls" or "Scouting" is much easier to shape into a collection with personality.
{{< /drg/tip >}}

{{< drg/did-you-know >}}
Topical collecting became especially popular because it lets collectors mix two hobbies into one. Someone who loves both railroads and history, for example, can build a collection that teaches both at the same time.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="What to Collect? (website)"
    url="https://stamps.org/learn/getting-started/what-to-collect"
    description="The American Philatelic Society walks through several collecting directions so beginners can pick a focus that fits their interests and budget." >}}

{{< drg/external-link
    title="Topical Stamp Collecting (website)"
    url="https://www.linns.com/content/collector-resources/collecting-basics/topical-stamp-collecting"
    description="Linn's explains why topical collecting is flexible, fun, and easy to personalize with subjects you already enjoy." >}}
...
{{< drg/next-page
    text="You now know several ways to build a collection with purpose."
    teaser="Next, learn the stamp terms that help collectors identify what they are looking at."
