...
{{< drg/tip >}}
If you already started a topical collection for [Req 2](/merit-badges/stamp-collecting/guide/req2/), this option may be the easiest final project to build into a finished album.
{{< /drg/tip >}}

A strong thematic album feels like a mini exhibit: one big idea shown through many small pieces.

{{< drg/next-page
    text="You can now shape a favorite subject into a full topical album project."
    teaser="Next, explore the most detective-like option: collecting real postal items from your own mail over 30 days."
