...
{{< drg/video
    title="Stamp Collecting (video)"
    url="https://youtu.be/Bu6vw5qlO3M?si=2ly00w2ou8AHx4LO" >}}
...
{{< drg/checklist title="How a Stamp Teaches You Something" subtitle="Use these prompts when you study any stamp" >}}
...
{{< drg/did-you-know >}}
Collectors sometimes call stamps "windows on the world" because a single album can hold examples from dozens of countries, all showing what each nation wants to celebrate or remember.
{{< /drg/did-you-know >}}

{{< drg/video
    title="Stamp Collecting Is for Old People (Just Kidding) (video)"
    url="https://youtu.be/mp07V-_-lc0?si=qw61WgakvzvCy7sz" >}}

{{< drg/video
    title="Stamps: A World of Fun (video)"
    url="https://youtu.be/FRMsUTbLK4U?si=vFyVadEM1Zd9Ww75" >}}

{{< drg/tip >}}
When you bring stamps to your counselor, do not just show the stamp. Tell the story behind it: what it shows, where it came from, and what you learned from looking it up.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="How to compare postal systems" >}}
When your counselor asks how the U.S. postal system differs from others, compare a few clear categories:

- **Size of service area**: Is the country tiny, island-based, or continent-sized?
- **Delivery expectations**: How often is mail delivered, and to how many remote places?
- **Stamp themes**: What subjects appear most often on stamps?
- **Special products**: Look for differences in airmail, souvenir sheets, postal stationery, or commemorative issues.
{{< /drg/be-prepared >}}

{{< drg/video
    title="A Chaotic History of the US Postal Service | Illustrated U.S. History (video)"
    url="https://youtu.be/aZ9j5t25CaU?si=b2xn0FgNumDoiiNU" >}}

{{< drg/video
    title="History of US Mail - From the Beginning (video)"
    url="https://youtu.be/U8ioOqupzmo?si=UlX_1ztm7NDn3yyL" >}}

{{< drg/external-link
    title="USPS Postal History"
    url="https://about.usps.com/who/profile/history/"
    description="A concise official history of how the U.S. postal system developed from colonial mail routes to the modern USPS." >}}
...
{{< drg/next-page
    text="You have connected stamp collecting to history, geography, and the real postal world."
    teaser="Next, learn the difference between topical collecting and other common ways to organize a collection."
