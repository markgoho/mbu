...
{{< drg/image src="images/single-culture-city.avif" alt="A Scout sitting at a desk with thought bubbles above their head, imagining a city skyline with architecture reflecting a single cultural tradition" >}}
...
{{< drg/did-you-know >}}
Jazz, one of America's most celebrated art forms, was born from the blending of West African musical traditions, European harmonies, and the African American experience in New Orleans. Without cultural mixing, this entire genre of music would never have existed.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
There is no wrong answer to this requirement — but there are shallow answers. Go beyond "the food would be different." Think about government, education, art, conflict, and innovation. The more specific you are, the more interesting your discussion with your counselor will be.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Your Counselor Asks a Tough Follow-Up Question" >}}
Your counselor might push your thinking with questions like "Would that single-culture city be better or worse?" or "What would be missing?" Here is how to handle it:
- **Be honest.** There are real advantages to a homogeneous society (less conflict, shared understanding) and real disadvantages (less innovation, narrower perspective).
- **Use examples.** Point to specific things — a food, a song, an invention, a law — that exist because cultures met and mixed.
- **Stay curious.** The point is not to have the "right" opinion, but to show that you have thought deeply about the question.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="PBS — The Story of Us: Immigration"
    url="https://www.pbs.org/topic/immigration/"
    description="Explore how immigration has shaped American communities, culture, and identity through documentaries and educational resources." >}}
...
{{< drg/next-page
    text="You have imagined how a single culture and multiple cultures shape a society."
    teaser="Now explore the real customs — religious and social — that make each group unique and the common threads that connect them."
