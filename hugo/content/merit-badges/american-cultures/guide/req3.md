...
{{< drg/did-you-know >}}
Fasting — going without food for a set period as a spiritual practice — appears in nearly every major world religion. Christians fast during Lent, Muslims fast during Ramadan, Jews fast on Yom Kippur, Hindus fast on various holy days, and Buddhists may fast as part of meditation practice. Different methods, same core idea: self-discipline as a path to spiritual growth.
{{< /drg/did-you-know >}}

{{< drg/image src="images/comparing-customs-chart.avif" alt="A Scout creating a colorful three-column comparison chart on a large poster board, with each column representing a different cultural group" >}}
...
{{< drg/tip >}}
Use a comparison chart to organize your research. Create three columns — one for each group — and list categories down the side (worship, holidays, food, family, greetings, art). Fill in what you learn. Patterns and similarities will jump out at you.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    description="Explore cultural traditions from communities around the world through articles, videos, and interactive exhibits from the Smithsonian." >}}

### Organizing Your Discussion

When you talk with your counselor, try this structure:

{{< drg/checklist title="Discussion Outline" subtitle="Organize your comparison" >}}
...
{{< drg/be-prepared title="Your Counselor Asks Why Similarities Matter" >}}
If your counselor asks why shared values matter, consider this:
- **Common ground builds trust.** When you discover that a group you thought was "totally different" shares your values around family, hospitality, or fairness, it becomes easier to relate to them.
- **Differences enrich, similarities connect.** The differences between groups make life interesting and creative. The similarities remind us that we are all human.
- **Understanding reduces fear.** A lot of prejudice comes from not knowing. When you learn about another group's customs, the "unknown" becomes the "understood."
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have compared the customs and found the common ground among your three groups."
    teaser="Now discover how individuals from different backgrounds have shaped the country we all share."
