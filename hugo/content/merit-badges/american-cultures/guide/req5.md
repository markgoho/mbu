...
{{< drg/tip >}}
The best talks use personal experience. Instead of saying "festivals help people understand each other," say "When I went to [specific festival], I learned [specific thing], and it changed how I think about [specific group]." Real stories are more powerful than general statements.
{{< /drg/tip >}}

{{< drg/image src="images/scout-giving-talk.avif" alt="A Scout standing confidently in front of a troop meeting, gesturing while giving a talk, with a simple visual aid on an easel behind them" >}}

#### Delivery Tips

{{< drg/checklist title="Talk Delivery Checklist" subtitle="Before and during your talk" >}}
...
{{< drg/did-you-know >}}
Research shows that one of the most effective ways to reduce prejudice between groups is simple personal contact — having a real conversation with someone from a different background. Psychologist Gordon Allport first proposed this "contact hypothesis" in 1954, and decades of studies have confirmed it.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Someone Says Something Insensitive" >}}
If a participant says something that could be hurtful or stereotyping:
- **Stay calm.** Do not embarrass the person or shut them down.
- **Redirect with a question.** "That is an interesting point — what do you think someone from that group might say about that?" This encourages perspective-taking without a lecture.
- **Reaffirm the ground rules.** "Remember, we are here to understand, not to judge."
- **Move on.** Do not let one comment derail the whole discussion.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Learning for Justice — Facilitating Critical Conversations"
    url="https://www.learningforjustice.org/professional-development/facilitating-critical-conversations"
    description="Practical strategies for leading productive conversations about culture, identity, and justice — useful for anyone facilitating a group discussion." >}}
...
{{< drg/next-page
    text="You have completed the final requirement — congratulations!"
    teaser="Explore additional resources, experiences, and organizations that will keep your cultural learning going long after the badge is earned."
