...
{{< drg/tip >}}
Pick your three cultural groups for the entire badge early on. Requirements 2, 3, and 4 also ask you to work with specific groups. Having a plan from the start will help everything connect.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Juneteenth, which celebrates the end of slavery in the United States, became a federal holiday in 2021 — making it the first new federal holiday established in nearly four decades.
{{< /drg/did-you-know >}}

{{< drg/be-prepared title="You Arrive at a Festival and Feel Out of Place" >}}
It is completely normal to feel a little awkward when you are the newcomer. Here is how to handle it:
- **Smile and be open.** Most people at cultural events are proud of their heritage and happy to share it.
- **Ask questions.** "Can you tell me about this tradition?" is almost always welcome.
- **Try the food.** Sharing a meal is one of the oldest ways humans connect across differences.
- **Be respectful.** If a ceremony is taking place, watch quietly. Follow the lead of the people around you.
{{< /drg/be-prepared >}}
...
{{< drg/tip >}}
Before visiting a place of worship, contact them to ask about visitor policies. Many houses of worship offer guided tours or "open house" events specifically designed for visitors. Ask if there is someone who can answer your questions — most religious communities have someone dedicated to welcoming guests.
{{< /drg/tip >}}
...
{{< drg/image src="images/visiting-cultural-institution.avif" alt="A Scout respectfully observing the interior architecture and decorations of a cultural institution, taking notes in a small notebook" >}}
...
{{< drg/safety-first >}}
Always arrange conversations through a trusted adult — your parent, counselor, or Scout leader. Meet in public places or with an adult present. This is standard Scout safety practice for meeting with adults outside your family.
{{< /drg/safety-first >}}

{{< drg/tip >}}
Bring a notebook and ask permission before taking notes. People appreciate when you show genuine interest by writing down what they share. It also helps you remember details for your report.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The tradition of oral storytelling — passing down history, lessons, and values through spoken stories rather than written text — is one of the oldest and most universal human practices. West African griots, Native American elders, and Celtic bards all served as the living libraries of their peoples.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    ...
    description="Explore exhibits and resources about the history, culture, and contemporary life of Indigenous peoples of the Western Hemisphere." >}}

{{< drg/external-link
    title="Smithsonian National Museum of African American History and Culture"
    url="https://nmaahc.si.edu/"
    description="Discover the African American experience through interactive exhibits, artifacts, and multimedia presentations." >}}

{{< drg/external-link
    title="Library of Congress — American Folklife Center"
    url="https://www.loc.gov/folklife/"
    description="Access one of the world's largest collections of folk culture materials, including music, stories, and traditions from communities across America." >}}
...
{{< drg/checklist title="Report Framework" subtitle="Cover these points in your report" >}}
...
{{< drg/next-page
    text="You have explored two different cultural groups through hands-on experiences."
    teaser="Now imagine what the world would look like if only one culture existed — and what happens when many cultures come together."
