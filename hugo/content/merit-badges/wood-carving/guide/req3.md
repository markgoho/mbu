...
{{< drg/checklist title="How to talk about a carving tool" subtitle="Use this pattern for any tool you choose" >}}
...
{{< drg/tip >}}
When your tool starts tearing fibers instead of slicing them cleanly, do not keep pushing. That is your sign to stop and sharpen.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="A simple sharpening routine" >}}

- **Start with the right surface**: Use the stone or plate your counselor recommends.
- **Hold a steady angle**: Match the bevel already on the blade as closely as you can.
- **Use controlled strokes**: Smooth, even motions work better than fast scrubbing.
- **Check for a burr**: A tiny wire edge tells you the stone has reached the cutting edge.
- **Strop to finish**: Polish the edge and remove the burr.
- **Test safely**: Look for a clean slicing feel on soft wood—never test by touching the edge directly.
  {{< /drg/be-prepared >}}

{{< drg/image src="images/sharpening-knife-on-stone.avif" alt="Carving knife held at a steady bevel angle on a sharpening stone with arrows showing controlled stroke direction" >}}

{{< drg/did-you-know >}}
Many carving sessions include stropping before they include major sharpening. A few light passes on a strop can restore an edge before it becomes truly dull.
{{< /drg/did-you-know >}}

{{< drg/safety-first >}}
Sharpen with the same attention you use while carving. Keep fingers away from the edge path, secure the sharpening surface, and move slowly enough to stay in control.
{{< /drg/safety-first >}}

In [Req 4](/merit-badges/wood-carving/guide/req4/), you will put these sharp tools to work on the core cuts that appear again and again in carving projects.

{{< drg/next-page
    text="You know what the tools are for and how to maintain them."
    teaser="Now practice the basic cuts that build almost every carving project."
