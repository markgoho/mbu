...
| Wood | Why carvers use it | Things to watch for |
|---|---|---|
| **Basswood** | Soft, smooth, fine grain, easy for beginners | Dents easily if handled roughly |
| **Butternut** | Good for relief carving, warm color, cuts fairly easily | Grain can be more open and fuzzy |
| **Pine** | Easy to find and inexpensive | Resin, knots, and uneven grain can frustrate carving |
| **Poplar** | Affordable and available in boards | Harder than basswood and sometimes stringy |
| **Cedar** | Pleasant smell and good for rustic work | Can be soft and crumbly, with strong grain |

{{< drg/did-you-know >}}
Basswood is so common in beginner carving kits because its fine, even grain makes it easier to learn technique without fighting the wood.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Questions to ask before choosing wood" subtitle="Use these to justify your decision" >}}
...
For **carving in the round** in [Req 6](/merit-badges/wood-carving/guide/req6/), many Scouts choose a soft, straight-grained wood because shaping a 3-D form already requires plenty of control.

For **relief or chip carving** in [Req 7](/merit-badges/wood-carving/guide/req7/), flat, stable stock matters even more. Chip carving especially benefits from a smooth board and predictable grain so the small geometric chips pop out cleanly.

{{< drg/tip >}}
If you are choosing between a cool-looking piece of wood and an easy-to-carve piece of wood, beginners usually learn more from the easier one.
{{< /drg/tip >}}

{{< drg/next-page
    text="You know how wood choice affects the whole project."
    teaser="Now use that judgment to plan and complete a simple carving in the round."
