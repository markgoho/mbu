...
This is an inherited-action requirement: the real task is to **show** each cut clearly and under control. Think of these cuts as the carving alphabet. Most projects in [Req 6](/merit-badges/wood-carving/guide/req6/) and [Req 7](/merit-badges/wood-carving/guide/req7/) are built from them.

## Requirement 4a

{{< drg/inherited-requirement number="4a" req_path="4.a" topic="Paring cut" />}}
...
{{< drg/inherited-requirement number="4b" req_path="4.b" topic="Basic cut and push cut" />}}
...
{{< drg/tip >}}
Practice these cuts on scrap wood first and pay attention to the surface left behind. A clean shaving usually means your edge is sharp and your cut direction matches the grain.
{{< /drg/tip >}}

## Requirement 4c

{{< drg/inherited-requirement number="4c" req_path="4.c" topic="\"V\" cut" />}}
...
{{< drg/image src="images/carving-v-cut-sequence.avif" alt="Step-by-step diagram showing two angled knife cuts meeting to form a clean V-shaped groove in wood" >}}

## Requirement 4d

{{< drg/inherited-requirement number="4d" req_path="4.d" topic="Stop cut or score line" />}}
...
{{< drg/checklist title="What your counselor will notice" subtitle="Good demonstration habits for every cut" >}}
...
{{< drg/safety-first >}}
When practicing cuts, use scrap wood large enough to hold safely. Tiny offcuts can twist suddenly and pull your hand into the blade path.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You have practiced the core knife motions of carving."
    teaser="Next, learn why the type of wood matters so much to the success of a project."
