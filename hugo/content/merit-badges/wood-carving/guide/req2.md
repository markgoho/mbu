...
req_number: "2"
req_path: "2"
prev: "/merit-badges/wood-carving/guide/req1/"
prev_title: "Req 1 — Carving Safely"
next: "/merit-badges/wood-carving/guide/req3/"
next_title: "Req 3 — Tools and Sharpening"
---
...
{{< drg/checklist title="What your counselor wants to see" subtitle="The Totin' Chip is about behavior as much as knowledge" >}}
...
{{< drg/tip >}}
If you already earned Totin' Chip a while ago, review the rules before meeting with your counselor. They may ask you to explain safe habits out loud, not just say that you earned it once.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="Safety Checklist for Carving (PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Wood%20Carving/WoodcarvingChecklist.pdf"
    description="Official Scout checklist covering maturity, tool care, workspace control, knife handling, and smart carving choices." >}}

### How to discuss the checklist well

Instead of reciting the list mechanically, connect each item to a real action:

- "I keep my elbows supported so my cuts stay short."
- "I stop carving if people start crowding around my chair."
- "I would practice on scrap wood before trying a face or detailed figure."
- "I keep a thumb guard on because my supporting hand is often close to the blade."

{{< drg/be-prepared title="If a carving session starts to feel unsafe" >}}

- **Pause the work**: Put the knife down or close it.
- **Name the problem**: Is the blade dull, the wood unstable, or the area too crowded?
- **Fix the setup**: Sharpen, clamp, clear space, or move to better light.
- **Restart only when the risk is controlled**: If you cannot fix it quickly, wait.
  {{< /drg/be-prepared >}}

{{< drg/safety-first >}}
One of the smartest carving decisions is stopping early. If the setup is bad or the project is beyond your current skill, the safe choice is to change the plan—not force the cut.
{{< /drg/safety-first >}}

In [Req 1](/merit-badges/wood-carving/guide/req1/), you looked at hazards and first aid. In [Req 3](/merit-badges/wood-carving/guide/req3/), you will build the tool-care skills that make this checklist easier to follow every time.

{{< drg/next-page
    text="You have the safety rules in place."
    teaser="Next, learn how carving tools work and how sharp edges are maintained."
