...
- **Purpose:** Hunting, warfare, survival
- **Mindset:** Accuracy meant food on the table — every shot counted
...
- **Purpose:** Competition, recreation, fitness, personal challenge
- **Mindset:** Consistency and mental focus — archery is as much a mental sport as a physical one
...
{{< drg/image src="images/scout-archery-range.avif" alt="A Scout standing at an outdoor archery range with a recurve bow, targets visible downrange, sunny day with trees in the background" >}}
...
{{< drg/safety-first >}}
On a target range, never cross the shooting line until the range officer gives the "all clear" signal. Arrows travel fast and are nearly invisible in flight. Always follow the range commands exactly.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/3d-archery-course.avif" alt="A foam deer target on a wooded 3-D archery course, surrounded by trees and natural terrain" >}}
...
{{< drg/safety-first >}}
Bowhunting has its own set of safety rules and legal requirements beyond target archery. Never hunt with a bow without completing a hunter education course and obtaining all required licenses and permits for your state.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
At the 2024 Paris Paralympics, Para Archery athletes competed at the same venue — the Esplanade des Invalides — as Olympic archers, shooting at the same distances and targets. The scores at the top of the field rival those of any archer in the world.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You have learned about the rich history and many styles of archery."
    teaser="Discover what makes archery safe — starting with understanding projectiles and why they demand respect."
    url="/merit-badges/archery/guide/req1a/" >}}
