...
{{< drg/safety-first >}}
This rule applies even when you think there is no arrow on the string. Building the habit of always pointing toward the target means you will never accidentally send an arrow in the wrong direction.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
A good way to remember these five rules is to think of them as layers of protection. Each rule covers a different type of risk — from when you handle arrows, to where you aim, to what is around you. Together, they create a complete safety system.
{{< /drg/tip >}}
...
- **Let down your bow safely** by slowly easing the string back to its resting position.
- **Call out "Hold!"** or alert the range officer right away.
- **Keep your bow pointed at the target** and your arrow nocked until the range officer gives further instructions.

Never assume someone else will see the intruder. Speak up immediately.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="USA Archery Range Safety Guidelines"
    url="https://www.usarchery.org/participate/safety"
    description="Detailed range safety standards from the national governing body for archery in the United States." >}}

{{< drg/next-page
    text="You know the five rules that keep the range safe."
    teaser="Next, learn the four whistle commands that control the flow of shooting on the range."
