...
{{< drg/did-you-know >}}
3-D archery targets are made of self-healing foam. When you pull an arrow out, the foam closes back up. A well-made 3-D target can take thousands of shots before it needs to be replaced.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="What if your arrow lands on the line?" >}}
In both WA and NFAA scoring, an arrow that touches the line between two scoring zones always gets the **higher** score. Here is how to handle it:

- **Do not touch the arrow** before it is scored. Moving it can change the call.
- **Look straight down** at where the shaft meets the target face, not at an angle.
- **If you disagree** with a scoring call in competition, ask the range judge to make the final decision.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="NFAA — Rules and Bylaws"
    url="https://www.nfaausa.com/rules"
    description="Official NFAA rules including target specifications, scoring procedures, and competition formats." >}}

{{< drg/external-link
    title="World Archery — Rules"
    url="https://worldarchery.sport/rulebook"
    description="The complete World Archery rulebook, including target specifications, scoring, and competition formats used at the Olympics." >}}

{{< drg/next-page
    text="You understand archery formats and how different targets are scored."
    teaser="Now it is time to pick up the bow — learn about the two shooting options for earning this badge."
