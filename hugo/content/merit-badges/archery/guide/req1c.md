---
title: "Whistle Commands"
layout: guide
group_title: "1. Safety on the Range"
req_number: "1c"
prev: "/merit-badges/archery/guide/req1b/"
prev_title: "Range Safety Rules"
next: "/merit-badges/archery/guide/req1d/"
next_title: "Retrieving Arrows"
---
...
{{< drg/safety-first >}}
Never nock an arrow before hearing the single whistle blast. Even if everyone else looks ready, wait for the signal. Jumping ahead puts you and others at risk.
{{< /drg/safety-first >}}
...
- If you are at full draw, **let down carefully** — do not release the arrow.
- Place your arrow back in your quiver.
- Set your bow down.
...
{{< drg/tip >}}
Here is a quick memory trick: **2 – 1 – 3 – 5+**. Two to the line, one to shoot, three to retrieve, five-plus for emergency. Practice saying it out loud a few times and it will stick.
{{< /drg/tip >}}
...
{{< drg/image src="images/range-officer-whistle.avif" alt="A range officer standing behind the shooting line holding a whistle, with archers visible at the shooting line in the background, targets downrange" >}}
...
{{< drg/did-you-know >}}
The whistle command system used in archery is standardized by USA Archery and is used at every level of competition — from summer camp ranges all the way to the Olympic Games.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="USA Archery — Getting Started"
    url="https://www.usarchery.org/participate"
    description="Learn more about range procedures and how to get involved in organized archery through USA Archery." >}}

{{< drg/next-page
    text="You know the whistle commands that control the range."
    teaser="Learn the safe way to pull your arrows from the target and return them to your quiver."
