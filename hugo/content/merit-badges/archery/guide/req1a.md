...
req_number: "1a"
prev: "/merit-badges/archery/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/archery/guide/req1b/"
next_title: "Req 1b — Range Safety Rules"
---
...
{{< drg/did-you-know >}}
A modern compound bow can launch an arrow at over 300 feet per second — that is roughly 200 miles per hour. At close range, an arrow can penetrate materials that would stop many other projectiles.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
An arrow that misses or passes through a target keeps going. That is why ranges use backstops and buffer zones. Never shoot unless you are certain the area behind your target is clear and safe.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Looking for a place to shoot? Check with your local Scout council, community parks department, or search for USA Archery-affiliated clubs in your area. Many clubs welcome beginners and have all the equipment you need.
{{< /drg/tip >}}

{{< drg/image src="images/archery-range-overview.avif" alt="An overhead view of a well-organized outdoor archery range showing the shooting line, target line with backstop, and safety buffer zones clearly marked" >}}
...
{{< drg/external-link
    title="USA Archery — Safety"
    url="https://www.usarchery.org/participate/safety"
    description="Official safety resources from USA Archery, the national governing body for the sport." >}}

{{< drg/next-page
    text="You understand why archery equipment demands care and respect."
    teaser="Learn the five range safety rules that keep every archer protected."
