...
**Word-of-mouth referrals.** A customer tells a friend, who tells another friend. Suddenly you have more orders than you expected. This is exciting — and it tests your capacity planning from [Req 5a](/merit-badges/entrepreneurship/guide/req5a/).
...
{{< drg/tip >}}
Keep a "wins journal" from day one. Write down every positive outcome, no matter how small — a compliment from a customer, a successful delivery, a new follower on social media. On tough days (and there will be tough days), flipping through that journal reminds you why you started.
{{< /drg/tip >}}
...
| Too many customers | Underestimated demand, viral word of mouth | Raise prices, set order limits, or recruit help (see [Req 5d](/merit-badges/entrepreneurship/guide/req5d/)) |
...
{{< drg/image src="images/problem-solving-flowchart.avif" alt="A simple flowchart showing three steps for handling a business problem: Identify the Problem at the top, then Evaluate Options in the middle, then Choose and Act at the bottom, with a feedback arrow looping back to the top" >}}
...
**You lose money.** Maybe your costs were higher than expected, or sales were slower than projected. Go back to the financial plan you built in [Req 5c](/merit-badges/entrepreneurship/guide/req5c/). Where did the numbers diverge from reality? Adjust your plan and try again.

{{< drg/be-prepared title="The Failure Recovery Plan" >}}
When something goes wrong, resist the urge to panic or quit. Follow this four-step framework:

- **Step 1: Acknowledge it.** Denial makes problems worse. Name the failure clearly.
- **Step 2: Analyze it.** What specifically went wrong? Was it within your control?
- **Step 3: Adjust.** Change the thing that caused the failure. If you priced too low, raise prices. If demand was weak, change your marketing approach.
- **Step 4: Act again.** The worst thing you can do after a setback is freeze. Make the adjustment and get back to work.
{{< /drg/be-prepared >}}
...
{{< drg/did-you-know >}}
A 2023 study by the Edelman Trust Barometer found that 63% of consumers buy from or boycott brands based on the company's values and ethical behavior. Doing the right thing is not just morally correct — it is good business. Customers who trust you become loyal customers.
{{< /drg/did-you-know >}}
...
1. **Pick 2–3 specific successes** you would realistically expect in your first few months.
2. **Identify 2–3 realistic problems** your particular business might face and explain your response.
3. **Describe at least one ethical dilemma** relevant to your business and explain how you would handle it.
4. **Connect your answers** to your business plan — show that you are thinking about *your* business, not generic examples.
...
{{< drg/external-link
    title="Better Business Bureau — Ethics Resources"
    url="https://www.bbb.org/all/bbb-standards-for-trust"
    description="The BBB Standards for Trust outline ethical principles that businesses of all sizes can follow to build and maintain customer trust." >}}

{{< drg/next-page
    text="You have completed all six requirements for the Entrepreneurship merit badge"
    teaser="Explore additional resources, organizations, and experiences to take your entrepreneurial journey even further."
