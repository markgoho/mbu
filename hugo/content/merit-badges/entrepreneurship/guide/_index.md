...
{{< drg/image src="images/teen-entrepreneur-lemonade-stand.avif" alt="A teenager in a clean Scout uniform running a well-organized outdoor stand selling handmade crafts, with a small chalkboard sign listing prices and a cash box on the table" >}}
...
{{< drg/did-you-know >}}
More than 5.5 million new business applications were filed in the United States in 2023 alone. That is more than 15,000 new business ideas every single day — and many of them came from people under 30.
{{< /drg/did-you-know >}}

### Get Ready!

{{< drg/tip >}}
You do not need a revolutionary invention to earn this badge. Some of the most successful businesses solve simple, everyday problems — mowing lawns, tutoring classmates, baking cookies for events. The goal is to learn the *process* of entrepreneurship. Start with what you know and what your community needs.
{{< /drg/tip >}}
...
{{< drg/image src="images/types-of-entrepreneurship.avif" alt="Three-panel illustration showing different types of entrepreneurship: left panel shows handmade products on a craft table, center panel shows a teenager walking dogs, right panel shows a laptop screen with a simple website storefront" >}}
...
{{< drg/next-page
    text="Now that you have a sense of what entrepreneurship looks like"
    teaser="Let's start with the basics — what exactly is an entrepreneur, and why do they matter?"
    url="/merit-badges/entrepreneurship/guide/req1/" >}}
