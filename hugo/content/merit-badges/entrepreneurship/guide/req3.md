...
{{< drg/tip >}}
Reach out politely by email, phone, or in person. Explain that you are working on a Scout merit badge and would like 20–30 minutes of their time. Most entrepreneurs love talking about their journey — especially to a young person who is genuinely interested.
{{< /drg/tip >}}
...
{{< drg/image src="images/scout-interviewing-entrepreneur.avif" alt="A teenager in a clean Scout uniform sitting across a desk from a small business owner in a bakery or shop, with a notebook open and taking notes, warm natural lighting" >}}

{{< drg/checklist title="Interview Preparation Checklist" subtitle="Complete these steps before your interview" >}}
...
{{< drg/be-prepared title="What If They Say Something Unexpected?" >}}
Real entrepreneurs do not always have Hollywood success stories. You might hear about:

- **Failure** — a business that closed, a product that flopped, a partnership that fell apart
- **Financial stress** — taking on debt, struggling to pay bills, working without a salary
- **Sacrifices** — missing family events, working holidays, giving up hobbies

These are not negatives. They are the honest reality of entrepreneurship, and hearing them makes your interview more valuable. Take notes on the challenges and think about how they connect to the skills you studied in [Req 2](/merit-badges/entrepreneurship/guide/req2/).
{{< /drg/be-prepared >}}
...
5. How their story connects to the skills from [Req 2](/merit-badges/entrepreneurship/guide/req2/)

{{< drg/external-link
    title="SCORE Mentoring"
    url="https://www.score.org/"
    description="SCORE is a nonprofit network of volunteer business mentors. If you cannot find an entrepreneur to interview locally, SCORE can connect you with experienced business owners." >}}

{{< drg/next-page
    text="You have heard a real entrepreneur's story"
    teaser="Now it is your turn to start generating your own business ideas."
