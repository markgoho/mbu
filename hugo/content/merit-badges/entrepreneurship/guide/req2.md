...
{{< drg/tip >}}
If you already use a planner, calendar app, or checklist system for school or Scouting, you are practicing organization skills. The same habits that help you track homework assignments will help you track business tasks.
{{< /drg/tip >}}
...
{{< drg/image src="images/entrepreneur-problem-solving.avif" alt="A teenager in a clean Scout uniform standing at a whiteboard with sticky notes arranged in a decision-making framework, brainstorming solutions to a business challenge" >}}
...
{{< drg/did-you-know >}}
According to a U.S. Bank study, 82% of small businesses that fail cite cash flow problems as a factor. Many of those problems stem from basic math errors — underestimating costs, overestimating revenue, or failing to track expenses.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/entrepreneur-skills-wheel.avif" alt="A circular diagram showing ten entrepreneur skills arranged around a central hub, with icons representing each skill: a speech bubble for communication, a calendar for planning, a folder for organization, a puzzle piece for problem solving, a compass for decision making, a calculator for basic math, arrows bending for adaptability, a gear for technical skills, two people for social skills, hands joined for teamwork, and a flag for leadership" >}}

{{< drg/checklist title="Skills Self-Assessment" subtitle="Rate yourself honestly on each skill before meeting with your counselor" >}}
...
{{< drg/external-link
    title="Junior Achievement — Entrepreneurship Programs"
    url="https://jausa.ja.org/"
    description="Junior Achievement offers free programs that teach entrepreneurship skills to young people through hands-on business simulations." >}}

{{< drg/next-page
    text="You have mapped out the skills that make entrepreneurs successful"
    teaser="Now it is time to learn from someone who has actually done it — by interviewing a real entrepreneur."
