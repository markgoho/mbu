...
req_number: "5a"
prev: "/merit-badges/entrepreneurship/guide/req4/"
prev_title: "Req 4 — Brainstorming Business Ideas"
next: "/merit-badges/entrepreneurship/guide/req5b/"
next_title: "Req 5b — Market Analysis"
---
...
This is the first section of your written business plan. In [Req 4](/merit-badges/entrepreneurship/guide/req4/), you chose your best business idea. Now you need to describe it clearly enough that someone who has never heard of it can understand exactly what you are offering, why it matters, and how you will deliver it.
...
{{< drg/tip >}}
Write your description as if you are explaining it to someone at a career fair who has thirty seconds to understand your business before moving on. If they walk away confused, your description needs work.
{{< /drg/tip >}}
...
{{< drg/image src="images/business-capacity-planning.avif" alt="A teenager sitting at a kitchen table with ingredients, baking supplies, and a notebook, planning out a weekly production schedule with a whiteboard calendar in the background" >}}

{{< drg/did-you-know >}}
In manufacturing, the concept of a "bottleneck" comes from the neck of a bottle — no matter how wide the bottle is, liquid can only flow out as fast as the narrowest point allows. In your business, the bottleneck might be your oven (you can only bake two dozen cookies at a time), your schedule (you only have Saturdays free), or your budget (you can only buy supplies for ten orders at once).
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
If your business involves food preparation, working with tools, or providing services at other people's homes, discuss safety precautions with a parent or guardian before you begin. Some activities may require adult supervision, insurance, or compliance with local health and safety regulations.
{{< /drg/safety-first >}}
...
{{< drg/external-link
    title="SBA Business License and Permit Guide"
    url="https://www.sba.gov/business-guide/launch-your-business/apply-licenses-permits"
    description="The U.S. Small Business Administration explains which licenses and permits you may need, with links to state-specific resources." >}}

{{< drg/next-page
    text="Your product or service section is taking shape"
    teaser="Next, you will analyze your market — who your customers are and what your competition looks like."
