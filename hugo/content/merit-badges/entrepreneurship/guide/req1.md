...
req_number: "1"
prev: "/merit-badges/entrepreneurship/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/entrepreneurship/guide/req2/"
next_title: "Essential Entrepreneur Skills"
---

{{< drg/requirement number="1" >}}
In your own words, define entrepreneurship. Explain to your counselor how entrepreneurs impact the U.S. economy.
{{< /drg/requirement >}}
...
{{< drg/did-you-know >}}
The word "entrepreneur" comes from the French word *entreprendre*, which means "to undertake." It entered the English language in the early 1800s, originally describing someone who organizes and manages a business venture.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/entrepreneur-economic-impact.avif" alt="An infographic showing four icons representing the economic impact of entrepreneurs: a group of people icon for job creation, a lightbulb for innovation, a government building for tax revenue, and a neighborhood of small shops for community development" >}}

{{< drg/tip >}}
When you explain entrepreneurship to your counselor, use your own words — not a textbook definition. Think of a business you know about (even a small one in your neighborhood) and describe what the owner does and why it matters. That personal connection makes your answer stronger.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="SBA Small Business Profile"
    url="https://advocacy.sba.gov/small-business-profiles/"
    description="The U.S. Small Business Administration publishes annual profiles showing how small businesses impact each state's economy." >}}

{{< drg/be-prepared title="Defining It in Your Own Words" >}}
Your counselor will ask you to define entrepreneurship without reading from a book. Here is how to prepare:

- **Start broad**: "Entrepreneurship is the process of starting and running a business."
- **Add the risk element**: "The entrepreneur takes on financial risk — they might lose money if it doesn't work out."
- **Add the value element**: "But the goal is to create something valuable — a product or service people need."
- **Make it personal**: "For example, my neighbor started a landscaping company because she noticed nobody in our area offered organic lawn care."
{{< /drg/be-prepared >}}

{{< drg/next-page
    text="Now that you understand what entrepreneurship is and why it matters"
    teaser="Learn the ten essential skills every entrepreneur needs to succeed."
