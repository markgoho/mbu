...
req_number: "5e"
prev: "/merit-badges/entrepreneurship/guide/req5d/"
prev_title: "Personnel Plan"
next: "/merit-badges/entrepreneurship/guide/req6/"
next_title: "Running the Business"
---
...
{{< drg/image src="images/marketing-channels-overview.avif" alt="Six icons in two rows representing different marketing channels: a speech bubble for word of mouth, a phone with social media icons, a flyer on a bulletin board, a market booth with a banner, a gift card for referral bonus, and two hands shaking for partnerships" >}}

{{< drg/tip >}}
Start with one or two marketing methods and do them well. Trying to be everywhere at once — posting on five platforms, printing flyers, running promotions, and attending events — will spread you too thin. Focus on the channels where your target customers actually spend their time.
{{< /drg/tip >}}
...
|----------|----------|-------------|
| Instagram | Visual products (food, crafts, art) | Photos, Reels, Stories |
...
{{< drg/safety-first >}}
Protect your privacy online. Never share your home address, phone number, or school name on public social media accounts. Use a business email address (not your personal one) for customer inquiries. If you are under 13, most social media platforms require parental permission. Even if you are older, discuss your online presence with a parent or guardian before posting.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Marketing research shows that people decide whether to keep reading a flyer within three seconds. That means your headline and main image need to grab attention instantly. A wall of small text — no matter how informative — will end up in the recycling bin.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Flyer Design Pitfalls" >}}
Common mistakes that make flyers ineffective:

- **Too much text.** If it looks like a homework assignment, nobody will read it. Cut your text in half, then cut it in half again.
- **No contact information.** If people cannot figure out how to reach you, the flyer is useless.
- **Low-quality images.** Blurry or pixelated photos make your business look unprofessional.
- **No call to action.** "Nice flyer" is not a sale. Tell people exactly what step to take next.
- **Hard-to-read fonts.** Decorative fonts are fun, but if your customer cannot read the text from arm's length, switch to something cleaner.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Canva — Free Design Tool"
    url="https://www.canva.com/"
    description="Create professional-looking flyers, posters, social media graphics, and business cards using free drag-and-drop templates." >}}

{{< drg/next-page
    text="Your business plan is complete — product, market, finances, personnel, and marketing"
    teaser="Now imagine your business is up and running. What challenges and ethical questions might you face?"
