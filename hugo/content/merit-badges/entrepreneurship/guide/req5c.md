...
req_number: "5c"
prev: "/merit-badges/entrepreneurship/guide/req5b/"
prev_title: "Market Analysis"
next: "/merit-badges/entrepreneurship/guide/req5d/"
next_title: "Personnel Plan"
---
...
{{< drg/checklist title="Startup Cost Worksheet" subtitle="List every expense you can think of — it is better to overestimate than be surprised" >}}
...
{{< drg/did-you-know >}}
When Steve Wozniak and Steve Jobs started Apple in 1976, they funded it partly by selling Jobs's Volkswagen van and Wozniak's HP-65 calculator. Total startup capital: about $1,300. Not every great business starts with a huge investment.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/pricing-profit-example.avif" alt="A simple infographic showing the profit equation: a row of three boxes with Price minus Cost equals Profit, using green for profit and red for cost" >}}

{{< drg/tip >}}
When setting your price, research what competitors charge for similar products or services. Price too high and customers will go elsewhere. Price too low and you will not cover your costs — or worse, customers might assume your product is low quality. A good starting point is to calculate your cost, then add a markup of 50–100%.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Keep your business money separate from your personal money. Even a simple envelope system or a dedicated savings account makes it much easier to track what you are earning, spending, and saving. Mixing business and personal finances is one of the most common mistakes new entrepreneurs make.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="Practical Money Skills — Teen Budgeting"
    url="https://www.practicalmoneyskills.com/"
    description="Free financial literacy resources, including budgeting tools and calculators suitable for young entrepreneurs." >}}

{{< drg/next-page
    text="Your financial plan proves that the numbers work"
    teaser="Next, figure out who will actually do the work — your personnel plan."
