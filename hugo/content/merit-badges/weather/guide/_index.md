...
{{< drg/did-you-know >}}
A weather forecast is really a giant teamwork project. Data from instruments around the world gets collected, shared, and analyzed in just minutes so forecasters can build a picture of what the atmosphere is doing.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Weather does not have to be dramatic to be dangerous. Heat, cold, lightning, flooding, fog, and high winds can all become hazards during ordinary outdoor plans. A Scout who checks forecasts early and changes plans when needed is making a smart safety decision.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/weather-tools-overview.avif" alt="Educational diagram collage showing radar, satellite imagery, a weather balloon, and clouds over a campsite" >}}
...
{{< drg/next-page
    text="Start by learning the language of weather science."
    teaser="You will define meteorology and see why forecasts matter to farmers, sailors, aviators, and builders."
    url="/merit-badges/weather/guide/req1/" >}}
