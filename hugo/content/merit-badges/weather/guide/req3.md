...
{{< drg/external-link
    title="National Weather Service (website)"
    url="https://www.weather.gov/"
    description="Find local forecasts, radar, alerts, and hourly details for the exact area where your troop or family will be outdoors." >}}
...
{{< drg/video
    title="The Best Weather App? (video)"
    url="https://www.youtube.com/shorts/Nve356YrnFg" >}}
...
{{< drg/video
    title="Ways To Get Warnings (video)"
    url="https://youtu.be/ZqmguEWojYw?si=i5mOnz2kN1QUpdKO" >}}
...
{{< drg/tip >}}
Before any hike or campout, ask: who is monitoring the weather, how often, and what conditions would trigger a plan change? That turns weather awareness into action.
{{< /drg/tip >}}
...
{{< drg/checklist title="Pre-trip weather check" subtitle="A simple routine Scouts can use before heading outdoors" >}}
...
{{< drg/next-page
    text="Next, learn how pressure systems and fronts shape the weather map."
    teaser="You will connect high and low pressure to cloud types, precipitation, and changing conditions."
