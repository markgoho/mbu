...
{{< drg/video
    title="What Are the Different Types of Clouds? (video)"
    url="https://youtu.be/JIkEMBiT6hQ?si=3bZrjTTiTTFmspzQ" >}}

## Matching clouds to weather

| Cloud type | Level | Common weather clue |
| --- | --- | --- |
| **Cirrus** | Upper | Fair weather now, but change may be coming |
| **Cirrostratus** | Upper | Moisture increasing aloft; front may be on the way |
| **Altostratus** | Middle | Thickening sky; rain or snow may follow |
| **Stratus** | Low | Gray, damp, drizzly weather |
| **Nimbostratus** | Low | Steady rain or snow |
| **Cumulus** | Low to growing vertical | Fair weather if small and scattered |
| **Cumulonimbus** | Towering vertical | Thunderstorms and severe weather risk |

{{< drg/image src="images/cloud-family-chart.avif" alt="Cloud family chart showing common cloud types by altitude band" >}}

{{< drg/tip >}}
The best way to learn clouds is to look up every day at about the same time. Write down the cloud type, the temperature, and what weather followed a few hours later. Patterns will start to stand out.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If clouds start building during a hike or camp activity" >}}
- **Notice the shape**: Flat gray layers and fast-growing towers tell different stories.
- **Compare with the forecast**: Cloud changes can tell you whether the timing is speeding up.
- **Leave exposed terrain early**: Especially if cumulus clouds are growing taller and darker.
- **Treat thunderstorm clouds seriously**: A towering cloud can become dangerous before rain reaches you.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="Next, trace how water moves through the atmosphere and back to Earth."
    teaser="You will draw and explain the major steps in the water cycle."
