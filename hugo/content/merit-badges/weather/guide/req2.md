---
title: "Dangerous Weather and Family Safety"
layout: "guide"
group_title: "1. Weather Basics"
req_number: "2"
req_path: "2"
prev: "/merit-badges/weather/guide/req1/"
prev_title: "Meteorology, Weather, and Climate"
next: "/merit-badges/weather/guide/req3/"
next_title: "Forecasts and Warnings"
---
...
{{< drg/video
    title="Know the Difference Between a Watch and a Warning (video)"
    url="https://youtu.be/bXWZdKVoII8" >}}

{{< drg/checklist title="Fast memory trick" subtitle="Use this to explain the difference clearly" >}}
...
{{< drg/safety-first >}}
Never shelter under a lone tree during lightning. It feels protected, but it is one of the worst places to be because lightning often strikes tall isolated objects.
{{< /drg/safety-first >}}
...
{{< drg/video
    title="Winter's Hidden Hazard - Cold Weather Health & Safety (video)"
    url="https://youtu.be/g3vEkqotiE8?si=cw3WFhC7u4ewKzU2" >}}
...
{{< drg/video
    title="Hurricane Preparation and Safety (video)"
    url="https://youtu.be/SsTPG8Occv4?si=gNVnhnMLDcnG9sEL" >}}
...
- **Use the safest nearby shelter**: Building first, vehicle second, open area last.
- **Tell others clearly**: A calm, direct warning helps everyone move faster.
- **Recheck conditions later**: Do not return just because the first burst of weather has passed.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="Next, learn where reliable forecasts and emergency warnings come from."
    teaser="You will identify the sources Scouts should use before and during outdoor activities."
