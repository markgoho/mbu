...
{{< drg/video
    title="Behind the Scenes of the National Weather Service Atlanta/Peachtree City (video)"
    url="https://youtu.be/DuZqz7wGXGY?si=cS4abYCrQrbtR3Qp" >}}
...
{{< drg/checklist title="Questions for your weather expert" subtitle="Use these to guide your visit or interview" >}}
...
{{< drg/tip >}}
When you talk with your expert, ask not only how warnings are issued, but how people actually hear them at night, during power outages, or while away from home. That makes the discussion more realistic.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="Next, turn weather knowledge into a clear safety talk."
    teaser="You will build an outline that teaches others what to do during lightning, flash floods, and tornadoes."
