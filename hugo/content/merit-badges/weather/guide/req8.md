...
{{< drg/video
    title="Causes and Effects of Climate Change (video)"
    url="https://youtu.be/oD4gvDliieY?si=hdY-Hb4veM6tWsRF" >}}
...
{{< drg/checklist title="A strong requirement answer" subtitle="Connect each activity to both climate and people" >}}
...
{{< drg/tip >}}
Your counselor will probably be more impressed by two well-explained examples than by a long list with almost no detail.
{{< /drg/tip >}}

{{< drg/video
    title="10 Human Activities Heavily Impacting Climate Change (video)"
    url="https://youtu.be/yS0D9xOlzNc?si=tm7nGt5kuKq9XxhE" >}}

{{< drg/image src="images/urban-heat-island-vs-tree-cover.avif" alt="Comparison of a paved city block and a tree-covered neighborhood showing heat and runoff differences" >}}
...
{{< drg/next-page
    text="Next, connect Earth's tilt to climate zones around the globe."
    teaser="You will explain why regions near the equator, poles, and middle latitudes receive different sunlight and climate patterns."
