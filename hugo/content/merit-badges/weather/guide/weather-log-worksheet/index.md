...
<a href="/merit-badges/weather/guide/req10a/" class="req-worksheet__back-link">
...
<h2 class="req-worksheet__title">Weather Log Worksheet</h2>
<p class="req-worksheet__subtitle">Weather Merit Badge — Requirement 10a</p>

<div class="req-worksheet__section">
  <h3 class="req-worksheet__section-title">Observer Setup</h3>

  <div class="req-worksheet__field">
    <span class="req-worksheet__label">Observer name</span>
    <span class="req-worksheet__line"></span>
  </div>

  <div class="req-worksheet__field">
    <span class="req-worksheet__label">Instrument built</span>
    <span class="req-worksheet__line"></span>
  </div>

  <div class="req-worksheet__field">
    <span class="req-worksheet__label">Observation location</span>
    <span class="req-worksheet__line"></span>
  </div>

  <div class="req-worksheet__field">
    <span class="req-worksheet__label">Observation time each day</span>
    <span class="req-worksheet__line"></span>
  </div>
</div>

<div class="req-worksheet__section">
  <h3 class="req-worksheet__section-title">Seven-Day Weather Log</h3>
  ...
  <table class="req-worksheet__table">
    <thead>
      <tr>
        ...
        <th style="width: 10%">Precip.</th>
        <th style="width: 14%">Clouds</th>
        <th style="width: 10%">Dew/Frost</th>
        <th style="width: 12%">Forecast</th>
        <th style="width: 12%">What happened?</th>
      </tr>
    </thead>
    <tbody>
