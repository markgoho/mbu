...
{{< drg/download
    ...
    url="/merit-badges/weather/guide/weather-safety-talk-outline/"
    type="printable" >}}
...
{{< drg/safety-first >}}
When teaching younger Scouts, keep the message simple: dangerous weather is not the time to stand around and watch. Move early, use real shelter, and listen to leaders and warnings.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="If you get nervous about public speaking" >}}
- **Use note cards**: Do not try to memorize every word.
- **Teach one point at a time**: Hazard, danger, rule, action.
- **Practice out loud**: Timing feels different when you speak than when you read silently.
- **End with the main idea**: The safest choice is to act early, not late.
{{< /drg/be-prepared >}}

## What makes a strong presentation

{{< drg/checklist title="Talk checklist" subtitle="Before you present, make sure your talk does these things" >}}
...
{{< drg/next-page
    text="Next, explore careers that grow out of weather science."
    teaser="You will research training, costs, duties, and opportunities in meteorology-related work."
