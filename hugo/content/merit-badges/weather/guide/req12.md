...
req_number: "12"
req_path: "12"
prev: "/merit-badges/weather/guide/req11/"
prev_title: "Req 11 — Teach Weather Safety"
next: "/merit-badges/weather/guide/extended-learning/"
...
{{< drg/video
    title="Hurricane Hunter (video)"
    url="https://youtu.be/F8pF3jOtM0U?si=V_vTXWHWd7JcRRAz&t=22" >}}

{{< drg/video
    title="Careers in Meteorology - National Weather Service Hurricanne Meteorologist (video)"
    url="https://youtu.be/Jmzry0djEQA?si=O_Pvh47t0WegPRU4" >}}

{{< drg/video
    title="Careers in Meteorology - Broadcast Meteorology (video)"
    url="https://youtu.be/CkmLI5VsdbY?si=4golNNv7EBcqZ2Ds" >}}

{{< drg/video
    title="Careers in Meteorology - Digital Meteorology (video)"
    url="https://youtu.be/jzmwzbhIhJQ?si=RfiZhEq-gtxMp-g6" >}}
...
{{< drg/checklist title="Career research checklist" subtitle="Use these categories to organize your notes" >}}
...
{{< drg/tip >}}
If salary numbers vary between sources, that is normal. Use a recent source, note that pay depends on experience and location, and focus on understanding the career rather than finding one exact number.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="Finish the guide with ideas for going beyond the badge."
    teaser="Explore real-world weather experiences, organizations, and deeper learning opportunities."
    url="/merit-badges/weather/guide/extended-learning/" >}}
