...
{{< drg/video
    title="What Creates Weather? (video)"
    url="https://youtu.be/OtHc497jn_U?si=TZ7dkSYs7wj_8P_c" >}}
...
{{< drg/video
    title="What Causes Lightning? (video)"
    url="https://youtu.be/VqXnN_FQfrc?si=YiUTVTx49LXWtYbO" >}}

{{< drg/safety-first >}}
If you can hear thunder, lightning is already close enough to be dangerous. Do not wait for rain to start or for the storm to be overhead before seeking shelter.
{{< /drg/safety-first >}}
...
{{< drg/video
    title="What is Hail? (video)"
    url="https://youtu.be/6M-ycZLSF1w?si=eMavnw4Y-B1ma5QY" >}}
...
{{< drg/did-you-know >}}
A hailstone can travel up and down inside a thunderstorm several times before it finally falls. That is why some hailstones have layers, almost like a tiny onion made of ice.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="Next, learn how to read the sky by identifying cloud types."
    teaser="You will connect low, middle, and high clouds to the weather they usually bring."
