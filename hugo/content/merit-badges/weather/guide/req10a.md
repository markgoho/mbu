...
{{< drg/video
    title="Weather 101: Build Your Own Wind Vane! (video)"
    url="https://youtu.be/kSHRBUTMq0o?si=6XqGX8yB-svIK85z" >}}

{{< drg/video
    title="DIY Anemometer (Measure Wind Speed) (video)"
    url="https://youtu.be/Gab07UaoeZI?si=iQpXL42eMjDoNIkz" >}}

{{< drg/video
    title="How to Make a Rain Gauge (video)"
    url="https://youtu.be/MLmVaiSEF9w?si=atHOcyY2Yfn2Vu-W" >}}

{{< drg/video
    title="How to Make Your Own Hygrometer (video)"
    url="https://youtu.be/lNPSzifZ-Y0?si=4_dPuJHkkLw5hp75" >}}
...
{{< drg/download
    title="Weather Log Worksheet"
    url="/merit-badges/weather/guide/weather-log-worksheet/"
    type="printable" >}}

{{< drg/checklist title="Good weather log habits" subtitle="Small choices make your data much better" >}}
...
{{< drg/image src="images/backyard-weather-station-log.avif" alt="Backyard weather observation setup with homemade instruments and a notebook for daily logging" >}}
...
{{< drg/tip >}}
If your chosen instrument gives only one part of the weather story, that is fine. The requirement expects you to combine your instrument data with other sources, not measure everything yourself.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="Next, explore the visit-or-interview option."
    teaser="You will prepare strong questions for a weather professional and learn how warnings reach your community."
