...
{{< drg/video
    title="Weather 101: High Pressure vs. Low Pressure (video)"
    url="https://youtu.be/8mHEry8tSPM?si=_Rx2aPuB2UpvW9o1" >}}
...
{{< drg/video
    title="What Are Weather Fronts? Warm Front, Cold Front? (video)"
    url="https://youtu.be/5Cnx5Bzctas?si=bJcnCUw3ysbD99rD" >}}
...
| --- | --- | --- |
| **Which air mass is advancing** | Cold air | Warm air |
| **Slope of the front** | Steep | Gentle |
| **Typical clouds** | Cumulonimbus, stratocumulus | Stratus, nimbostratus |
| **Where precipitation tends to form** | Near or just ahead of the front | Ahead of the front over a broader area |
| **How weather changes** | Faster and more dramatic | Slower and more gradual |

{{< drg/image src="images/cold-vs-warm-front-cross-sections.avif" alt="Side-by-side cross sections of a cold front and a warm front showing air movement, clouds, and precipitation" >}}

{{< drg/tip >}}
When you draw your fronts, use color or shading if your counselor allows it. That makes it easier to show cold air staying lower and warm air rising above it.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If you spot signs of an approaching front during an outing" >}}
- **Check the forecast again**: Frontal timing changes.
- **Notice wind shifts and cloud changes**: They often tell you the front is getting closer.
- **Shorten exposed activities**: Ridge hikes, paddling, and open-field games become riskier as storms near.
- **Have shelter and exit plans ready**: Especially if thunderstorms may develop.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="Next, break down the main forces behind common weather events."
    teaser="You will explain what causes wind, rain, lightning, and hail."
