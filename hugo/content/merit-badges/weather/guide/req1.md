...
{{< drg/tip >}}
If you mix up weather and climate, think about time. Weather is what is happening now or soon. Climate is what usually happens over many years.
{{< /drg/tip >}}
...
{{< drg/video
    title="What is Meteorology? (video)"
    url="https://youtu.be/UKOu9OKvvb4?si=dhC0zfySCYRgQ_Md" >}}

{{< drg/video
    title="Weather vs Climate (video)"
    url="https://youtu.be/6Aigcv7UnTU?si=CUj8ne3OVaoeZB_W" >}}
...
{{< drg/checklist title="Why forecasts matter" subtitle="Each group depends on weather for a different reason" >}}
...
{{< drg/external-link
    ...
    description="Explore current forecasts, hazard maps, radar, and forecast discussions from the official U.S. weather agency." >}}
...
{{< drg/next-page
    text="Next, focus on dangerous weather and the safety rules Scouts should know."
    teaser="You will compare watches and warnings and build a family-ready safety mindset."
