...
{{< drg/did-you-know >}}
Only about 3% of Earth's water is freshwater, and most of that is locked in glaciers and ice caps. Less than 1% of all water on Earth is available for humans to use. That tiny fraction supports all of civilization.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
For your diagram, draw a simple flow chart showing: Natural Source → Treatment Plant → Pipes → Your Home → Drain → Sewer/Septic → Wastewater Treatment → Back to Nature. Ask a parent which source your water comes from (city water or well) and whether you have a sewer connection or septic system.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Never drink water directly from a natural source — even if it looks clean. Rivers, lakes, and streams can contain bacteria, parasites, and chemical pollutants invisible to the eye. Always treat or filter water before drinking it in the outdoors.
{{< /drg/safety-first >}}

{{< drg/image src="images/water-cycle-diagram.avif" alt="An illustrated cross-section showing the journey of water from a river through a treatment plant, to homes, then through wastewater treatment and back to the river" >}}

{{< drg/external-link
    title="Water Science School — USGS"
    url="https://www.usgs.gov/special-topics/water-science-school"
    description="Interactive resources about the water cycle, water use, and water quality from the U.S. Geological Survey." >}}

{{< drg/video
    title="Why Do We Drink Water? - Facts About Water for Kids"
    url="https://www.youtube.com/watch?v=paUYby1kbMs" >}}

{{< drg/next-page
    text="Now you understand how water systems work"
    teaser="Explore how floods and droughts affect communities and what can be done about them."
