...
{{< drg/checklist title="Campout Observation Checklist" subtitle="Bring this to your next outdoor activity" >}}
...
{{< drg/tip >}}
Do not just observe what went well — note areas for improvement too. Your counselor will be more impressed by honest, balanced observations than by a report that says everything was perfect. If you notice that Scouts are washing dishes too close to a stream, that is exactly the kind of observation this requirement is looking for.
{{< /drg/tip >}}

{{< drg/be-prepared title="Leading by Example" >}}
If you notice unsustainable practices during the campout, you do not have to just write them down. Consider:

- **Suggesting a solution** — "Hey, let's set up the dishwashing station farther from the creek."
- **Modeling good behavior** — Carry a trash bag and pick up litter as you go.
- **Teaching younger Scouts** — Explain *why* we keep food in bear boxes, not just that we should.
- **Talking to adult leaders** — If you notice a systemic issue (like a camp that lacks recycling), bring it to the attention of leadership in a constructive way.
{{< /drg/be-prepared >}}

{{< drg/image src="images/scouts-campsite-observation.avif" alt="A Scout writing notes in a notebook while observing a well-organized campsite with a fire ring, proper food storage, and a trail leading into the forest" >}}

{{< drg/external-link
    title="Leave No Trace Seven Principles"
    url="https://lnt.org/why/7-principles/"
    description="The seven principles of outdoor ethics that guide responsible recreation and camping practices." >}}

{{< drg/video
    title="What Does Leave No Trace Mean to Scouts?"
    url="https://www.youtube.com/watch?v=oTs29BZzf8U" >}}

{{< drg/next-page
    text="You have observed sustainability practices in action at a campout"
    teaser="Explore how the Scout Oath, Scout Law, and Leave No Trace connect to sustainability in your daily life."
