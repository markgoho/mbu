...
{{< drg/tip >}}
NASA's "Global Temperature" page has interactive maps showing how temperatures have changed decade by decade. NOAA's Climate.gov also has excellent visualization tools. Use one of these for your counselor discussion — being able to point to a specific map makes your explanation much stronger.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The last time CO2 levels were as high as they are today (over 420 parts per million) was about 3 million years ago, during the Pliocene Epoch. At that time, sea levels were 50–80 feet higher than today and the Arctic was forested.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Climate change is increasing the frequency of extreme weather events — heat waves, hurricanes, wildfires, and severe storms. Stay informed about weather conditions in your area, especially before outdoor activities. Know your community's emergency plans and have a family preparedness kit ready.
{{< /drg/safety-first >}}

{{< drg/image src="images/temperature-change-globe.avif" alt="A stylized globe showing temperature change patterns over 100 years, with color gradients from blue (cooler) to red (warmer), with the Arctic showing the most intense warming" >}}

{{< drg/external-link
    title="NASA Global Climate Change — Vital Signs"
    url="https://climate.nasa.gov/"
    description="NASA's comprehensive resource on climate change, featuring interactive data visualizations, temperature records, and the latest research findings." >}}

{{< drg/video
    title="Global Warming from 1880 to 2022"
    url="https://www.youtube.com/watch?v=LwRTw_7NNJs" >}}

{{< drg/next-page
    text="You have explored climate change and its connections to sustainability"
    teaser="Now bring everything together by observing sustainability practices in action at a Scouting campout."
