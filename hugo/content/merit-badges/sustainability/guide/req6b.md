...
{{< drg/did-you-know >}}
Americans make up about 4% of the world's population but generate about 12% of its municipal solid waste. The average American produces about 4.4 pounds of trash per day — nearly double the global average.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
For your discussion with your counselor, create a chart or table that shows each of the five ways and maps out the financial impact, time, maintenance, health, storage, and waste generation aspects. This organized approach demonstrates thorough thinking and makes the conversation more productive.
{{< /drg/tip >}}

{{< drg/image src="images/stuff-impact-infographic.avif" alt="An illustrated infographic showing the lifecycle of consumer goods — from resource extraction through manufacturing, shipping, use, and disposal in a landfill" >}}

{{< drg/external-link
    title="The Story of Stuff — Free Resources"
    url="https://www.storyofstuff.org/"
    description="Videos, articles, and lesson plans exploring where our stuff comes from, where it goes, and how we can do better." >}}

{{< drg/video
    title="Why Do We Have So Much Stuff?"
    url="https://www.youtube.com/watch?v=KtWlmbDsx-U" >}}

{{< drg/next-page
    text="You understand the hidden costs of too much stuff"
    teaser="Research how waste affects the environment and learn about recycling systems, the trash vortex, and electronic waste."
