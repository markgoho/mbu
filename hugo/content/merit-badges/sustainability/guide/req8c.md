...
req_number: "8c"
prev: "/merit-badges/sustainability/guide/req8b/"
prev_title: "Req 8b — Scout Values & Sustainability"
next: "/merit-badges/sustainability/guide/req9/"
...
{{< drg/did-you-know >}}
Research shows it takes an average of 66 days for a new behavior to become automatic. The changes you make now might feel awkward at first, but if you stick with them for about two months, they become second nature.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="When Changes Do Not Stick" >}}
Some changes might fail — and that is okay. If a behavior change is not working, ask:

- **Is it too hard?** Maybe the change needs to be smaller or more gradual.
- **Is it not rewarding?** Find a way to make the results visible (track savings, celebrate milestones).
- **Does it need a trigger?** Link the new behavior to an existing habit ("When I brush my teeth, I also turn off the bathroom light").
- **Try a different change.** There are dozens of ways to be more sustainable. If one does not work for your family, try another.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
For your counselor discussion, be ready to explain not just what the five changes are, but *why* you chose them, *how* you plan to implement them, and *what impact* you expect each one to have. If you have already started implementing some changes, share your results.
{{< /drg/tip >}}

{{< drg/image src="images/family-sustainability-chart.avif" alt="A family gathered around a kitchen table reviewing a colorful sustainability tracking chart posted on the refrigerator, with reusable bags and a compost bin visible" >}}

{{< drg/external-link
    title="Sustainability Tips for Families — National Wildlife Federation"
    url="https://www.nwf.org/Home/Educational-Resources/Conservation-Strategies"
    description="Practical sustainability tips for families, including activity guides and conservation challenges." >}}

{{< drg/video
    title="Sustainability in Your Life"
    url="https://www.youtube.com/watch?v=kZIrIQDf1nQ" >}}

{{< drg/next-page
    text="You have identified five changes to make your household more sustainable"
    teaser="Explore career opportunities in the growing field of sustainability."
