...
{{< drg/did-you-know >}}
Since 1970, wildlife populations (mammals, birds, fish, reptiles, and amphibians) have declined by an average of 69%, according to the World Wildlife Fund. That does not mean 69% of animals are gone — it means that on average, monitored populations are less than one-third the size they were 50 years ago.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
For your counselor discussion, pick a specific example of species decline that resonates with you — monarch butterflies, coral reefs, polar bears, or a species native to your region. Research the causes, the current status, and what is being done. Specific examples are more compelling than general statements.
{{< /drg/tip >}}

{{< drg/image src="images/wildlife-conservation.avif" alt="A diverse group of Scouts observing wildlife at a nature reserve, using binoculars and field guides, with birds and a deer visible in the background" >}}

{{< drg/external-link
    title="IUCN Red List of Threatened Species"
    url="https://www.iucnredlist.org/"
    description="The world's most comprehensive inventory of the global conservation status of biological species, searchable by species name or region." >}}

{{< drg/video
    title="Animal Extinction Explained"
    url="https://www.youtube.com/watch?v=2N8VkDcIhIk" >}}

{{< drg/next-page
    text="You understand species decline and why biodiversity matters"
    teaser="Explore climate change — the science, the data, and how it connects to everything you have learned so far."
