...
{{< drg/did-you-know >}}
The average American drives about 13,500 miles per year. Transportation accounts for roughly 29% of U.S. greenhouse gas emissions — the largest share of any sector. Designing communities where people can walk, bike, or take transit for daily needs could dramatically cut these emissions.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Sketch Planning Guide" subtitle="Elements to include in your community design" >}}
...
{{< drg/tip >}}
Use a large piece of paper and start with a bird's-eye view. Draw roads first, then place buildings, green spaces, and transportation. Use a legend with symbols and colors to keep it organized. Label everything clearly so you can explain each element to your counselor.
{{< /drg/tip >}}
...
{{< drg/image src="images/sustainable-community-sketch.avif" alt="A bird's-eye view illustration of a sustainable community showing mixed housing, a walkable town center, bike lanes, solar panels on rooftops, green spaces, and a bus line" >}}

{{< drg/external-link
    title="Smart Growth Principles — U.S. EPA"
    url="https://www.epa.gov/smartgrowth/about-smart-growth"
    description="The EPA's guide to smart growth principles that make communities more sustainable, including walkability, mixed-use development, and green infrastructure." >}}

{{< drg/video
    title="How to Plan and Design a Sustainable Community"
    url="https://www.youtube.com/watch?v=RBQiRx6VP7o" >}}

{{< drg/next-page
    text="You have designed a sustainable community from scratch"
    teaser="Now look at your own community and identify something unsustainable that you could help fix."
