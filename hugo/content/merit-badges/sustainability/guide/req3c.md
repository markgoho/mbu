...
req_number: "3c"
prev: "/merit-badges/sustainability/guide/req3b/"
prev_title: "Global Food Supply"
next: "/merit-badges/sustainability/guide/req4a/"
next_title: "Design a Community"
---

{{< drg/requirement number="3c" >}}
Develop a plan to reduce your household food waste in a sustainable manner. Establish a baseline and then track and record your results for two weeks.
{{< /drg/requirement >}}
...
{{< drg/checklist title="Common Food Waste Categories" subtitle="What to track during your baseline" >}}
...
{{< drg/did-you-know >}}
Confusion over date labels is responsible for an estimated 20% of consumer food waste. Except for infant formula, federal law does not require date labels on food products. Most "best by" dates are set by manufacturers as quality suggestions, not safety deadlines.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Take photos of your food waste each day — it makes the tracking easier and gives you a powerful visual record to share with your counselor. A picture of a half-full waste container on Day 1 versus a nearly empty one on Day 14 tells a compelling story.
{{< /drg/tip >}}

{{< drg/be-prepared title="When Your Family Resists" >}}
Changing habits can be hard, and not everyone in your household may be on board at first. Here is how to handle pushback:

- **Make it easy.** Set up systems (labeled containers, a visible meal plan) so reducing waste takes less effort, not more.
- **Show the money.** Track how much wasted food cost. Families that reduce food waste often save $50–$100 per month on groceries.
- **Start small.** Focus on one change at a time instead of overhauling everything at once.
- **Lead by example.** When your family sees you eating leftovers, composting scraps, and planning meals, they are more likely to join in.
{{< /drg/be-prepared >}}

{{< drg/image src="images/food-waste-tracking.avif" alt="A Scout at a kitchen table logging food waste in a notebook, with a small compost bin and organized refrigerator visible in the background" >}}

{{< drg/external-link
    title="Save the Food — NRDC"
    url="https://savethefood.com/"
    description="Practical tips and tools for reducing food waste at home, including a guest-imator for planning party portions and storage guides." >}}

{{< drg/video
    title="5 Food Waste Reduction Tips for Your Home"
    url="https://www.youtube.com/watch?v=waMsKjl8HkM" >}}

{{< drg/next-page
    text="You now have tools to reduce food waste in your home"
    teaser="Explore how communities are designed — and how to make them more sustainable."
