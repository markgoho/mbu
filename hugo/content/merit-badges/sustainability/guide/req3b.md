...
Identify four factors that limit the availability of food in different regions of the world. Discuss how each factor influences the sustainability of worldwide food supplies. Share three ways individuals, families, or your community can create their own food sources.
{{< /drg/requirement >}}
...
{{< drg/did-you-know >}}
About one-third of all food produced for human consumption is lost or wasted every year — roughly 1.3 billion tons globally. In developing countries, most loss happens after harvest due to poor storage and transportation. In wealthy countries, most waste happens at the consumer level — food thrown away at home or by restaurants.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
If you are interested in starting a garden, begin small. A 4-foot by 4-foot raised bed can grow a surprising amount of food. Talk to local gardeners, your county extension office, or a garden center for advice on what grows best in your area and climate.
{{< /drg/tip >}}

{{< drg/image src="images/community-garden-scouts.avif" alt="Scouts of different ages working in a community garden, some planting seedlings and others harvesting vegetables, with raised beds and a tool shed in the background" >}}

{{< drg/external-link
    title="Feeding America — Understanding Food Insecurity"
    url="https://www.feedingamerica.org/hunger-in-america/food-insecurity"
    description="Data and stories about food insecurity in America, including maps showing which communities are most affected." >}}

{{< drg/video
    title="Food Security"
    url="https://www.youtube.com/watch?v=YF18lUXUIk4" >}}

{{< drg/next-page
    text="You have explored the factors that limit global food supplies"
    teaser="Learn practical strategies for reducing food waste in your own home."
