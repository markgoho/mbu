...
{{< drg/safety-first >}}
Have a parent or guardian adjust the water heater temperature. The water heater may be gas or electric and located in a utility closet, basement, or garage. Never attempt to service a gas water heater yourself — there are risks of gas leaks and burns.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
"Vampire" electronics waste enough energy across the U.S. to power 11 million homes for a year. That is like leaving a light bulb on in every room of your house 24/7 — just from devices you think are "off."
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Create a simple chart listing your five ideas, their benefits, their risks, and whether you implemented them. This gives you a clear, organized way to present the information to your counselor.
{{< /drg/tip >}}

{{< drg/image src="images/energy-saving-home.avif" alt="A Scout adjusting a programmable thermostat on a wall, with an LED bulb overhead and a window with natural light streaming in" >}}

{{< drg/external-link
    title="Energy Saver Guide — U.S. Department of Energy"
    url="https://www.energy.gov/energysaver/energy-saver"
    description="Comprehensive tips for saving energy at home, from heating and cooling to appliances and lighting." >}}

{{< drg/video
    title="How to Reduce Energy Consumption in Your Home"
    url="https://www.youtube.com/watch?v=AKcfc2WXIWY" >}}

{{< drg/next-page
    text="You have found practical ways to reduce energy at home"
    teaser="Now turn your attention to 'stuff' — the things you own, the things you want, and the difference between needs and wants."
