...
{{< drg/did-you-know >}}
The amount of solar energy that hits Earth's surface in one hour is enough to power the entire world for a year. The challenge is capturing, storing, and distributing that energy efficiently.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Visit the U.S. Energy Information Administration (EIA) website to find current data on how much energy each source provides. You can even look up the energy mix for your specific state — it varies widely across the country.
{{< /drg/tip >}}

{{< drg/image src="images/energy-sources-comparison.avif" alt="An illustrated comparison showing different energy sources side by side — a coal plant, wind turbines, solar panels, and a hydroelectric dam — with the sky transitioning from smoky to clear" >}}

{{< drg/external-link
    title="U.S. Energy Information Administration — Energy Explained"
    url="https://www.eia.gov/energyexplained/"
    description="Clear, data-driven explanations of every major energy source, how they work, and how much the U.S. uses." >}}
...
{{< drg/next-page
    text="You now understand the major energy sources and their sustainability trade-offs"
    teaser="Look at how your own family uses energy every day and find ways to reduce your carbon footprint."
