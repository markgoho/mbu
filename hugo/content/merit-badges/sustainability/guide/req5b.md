...
req_number: "5b"
prev: "/merit-badges/sustainability/guide/req5a/"
prev_title: "Req 5a — Energy Sources"
next: "/merit-badges/sustainability/guide/req5c/"
next_title: "Req 5c — Reducing Home Energy"
---
...
{{< drg/checklist title="Energy Audit Walk-Through" subtitle="Room-by-room checklist for identifying energy use" >}}
...
{{< drg/did-you-know >}}
A car idling for just 10 seconds uses more fuel than restarting the engine. If you are waiting to pick someone up, turning off the engine saves gas and reduces emissions. Some cities have anti-idling laws for exactly this reason.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Use an online carbon footprint calculator (like the EPA's or CoolClimate calculator) to estimate your family's footprint. It can help you identify which changes would have the biggest impact. This makes for a great visual aid when discussing the requirement with your counselor.
{{< /drg/tip >}}

{{< drg/image src="images/family-energy-use.avif" alt="A cutaway illustration of a house showing different energy uses in each room — heating vents, kitchen appliances, electronics, lighting — with a car in the driveway" >}}

{{< drg/external-link
    title="Carbon Footprint Calculator — EPA"
    url="https://www.epa.gov/ghgemissions/household-carbon-footprint-calculator"
    description="Calculate your household's carbon footprint and see how specific changes could reduce your emissions." >}}

{{< drg/video
    title="How to Reduce Your Carbon Footprint"
    url="https://www.youtube.com/watch?v=J_iDcKDAwbA" >}}

{{< drg/next-page
    text="You have identified how your family uses energy and ways to reduce consumption"
    teaser="Discover specific ways to cut energy use at home, from adjusting your thermostat to rethinking your daily habits."
