...
req_number: "7d"
prev: "/merit-badges/sustainability/guide/req7c/"
prev_title: "Req 7c — Product Life Cycles"
next: "/merit-badges/sustainability/guide/req7e/"
next_title: "Req 7e — Species Decline"
---
...
{{< drg/did-you-know >}}
If everyone on Earth consumed resources at the rate of the average American, we would need about five Earths to sustain that level of consumption. The sustainability challenge is not just about population — it is about consumption patterns.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
For your counselor discussion, be ready to explain not just what these activities are, but *why* they put Earth at risk. Connect each activity to specific sustainability impacts — like how deforestation affects the carbon cycle, water cycle, and biodiversity all at once.
{{< /drg/tip >}}

{{< drg/image src="images/population-growth-timeline.avif" alt="An illustrated timeline showing world population growth from 1800 to projected 2100, with icons representing key milestones and resource consumption alongside" >}}

{{< drg/external-link
    title="World Population Dashboard — UNFPA"
    url="https://www.unfpa.org/data/world-population-dashboard"
    description="Interactive data on world population, growth trends, and demographic indicators by country." >}}

{{< drg/video
    title="How Population Growth Impacts the Planet"
    url="https://www.youtube.com/watch?v=mRcxGJcBDVo" >}}

{{< drg/next-page
    text="You understand how population growth and human activities affect Earth"
    teaser="Learn about species decline — what it means, why it happens, and what can be done to reverse it."
