...
req_number: "7c"
prev: "/merit-badges/sustainability/guide/req7b/"
prev_title: "Req 7b — Planetary Life-Support Systems"
next: "/merit-badges/sustainability/guide/req7d/"
next_title: "Req 7d — Population & Sustainability"
---
...
{{< drg/did-you-know >}}
The concept of a "circular economy" aims to eliminate waste entirely by designing products so that every material can be reused, repaired, or recycled. Instead of the traditional "take, make, dispose" model, a circular economy keeps materials in use for as long as possible.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
For your counselor discussion, choose a product you use every day and trace its complete life cycle. Good options include a smartphone, a water bottle, a pair of sneakers, or a school notebook. Research where the raw materials come from, where it was manufactured, and what recycling options exist at end of life.
{{< /drg/tip >}}

{{< drg/image src="images/product-lifecycle-circle.avif" alt="A circular diagram showing the five stages of a product life cycle — Design, Sourcing, Production, Use, Disposal/Reuse — with icons for each stage and arrows connecting them in a loop" >}}

{{< drg/external-link
    title="Life Cycle Assessment — EPA"
    url="https://www.epa.gov/design-environment/learn-about-life-cycle-assessment"
    description="The EPA's introduction to Life Cycle Assessment, a scientific method for evaluating the environmental impact of a product from cradle to grave." >}}

{{< drg/video
    title="Product Life Cycle Assessment"
    url="https://www.youtube.com/watch?v=-9JRowyICbo" >}}

{{< drg/next-page
    text="You understand how product life cycles influence sustainability"
    teaser="Explore how the world's growing population affects Earth's resources and sustainability."
