...
{{< drg/did-you-know >}}
The 17 SDGs have 169 specific targets and over 230 indicators to measure progress. Every country reports on its progress annually, creating one of the largest collaborative efforts in human history.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
The official UN SDG website has dedicated pages for each goal with current data, stories, and progress reports. Use these as your primary research source — the information is authoritative and frequently updated.
{{< /drg/tip >}}

{{< drg/image src="images/un-sdg-goals-display.avif" alt="A colorful display of the United Nations 17 Sustainable Development Goals icons arranged in a grid, with a Scout studying them at a library table" >}}

{{< drg/external-link
    title="United Nations Sustainable Development Goals"
    url="https://sdgs.un.org/goals"
    description="Official UN page with detailed information, data, targets, and progress reports for all 17 Sustainable Development Goals." >}}

{{< drg/video
    title="UN Sustainable Development Goals - Overview"
    url="https://www.youtube.com/watch?v=M-iJM02m_Hg" >}}

{{< drg/next-page
    text="You have explored the UN's Sustainable Development Goals"
    teaser="Learn about the planetary systems that keep Earth alive — and what happens when they are disrupted."
