...
{{< drg/did-you-know >}}
Earth's systems are so interconnected that scientists use the term "planetary boundaries" to describe nine critical thresholds. If we push past these boundaries, Earth may shift into a state that is fundamentally different — and potentially hostile to human civilization. As of now, six of the nine boundaries have been crossed.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Explaining System Disruption" >}}
When your counselor asks what happens when these systems are disrupted, use a specific example:

- **Natural disruption:** A volcanic eruption can cool global temperatures by injecting ash into the atmosphere, disrupt ecosystems near the volcano, and alter nutrient cycles — but the planet usually recovers within a few years.
- **Human disruption:** Deforestation removes trees that store carbon, disrupts water cycles, destroys habitat, degrades soil, and reduces biodiversity — and recovery takes decades or centuries, if it happens at all.

The key difference: natural disruptions are usually temporary. Human disruptions are often permanent or very long-lasting.
{{< /drg/be-prepared >}}

{{< drg/image src="images/planetary-systems-web.avif" alt="An illustrated web diagram showing Earth's eight life-support systems connected by arrows, demonstrating their interactions, with Earth at the center" >}}

{{< drg/external-link
    title="Earth's Systems — NASA Climate Kids"
    url="https://climatekids.nasa.gov/menu/big-questions/"
    description="NASA's kid-friendly exploration of Earth's climate systems, how they interact, and how human activities affect them." >}}

{{< drg/video
    title="Earth's Interconnected Cycles"
    url="https://www.youtube.com/watch?v=6j5iHvYBIcg" >}}

{{< drg/next-page
    text="You now understand how Earth's life-support systems work together"
    teaser="Explore how the products you use every day follow a life cycle from design to disposal — and how that cycle affects sustainability."
