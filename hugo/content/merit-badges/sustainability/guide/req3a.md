...
req_number: "3a"
prev: "/merit-badges/sustainability/guide/req2c/"
prev_title: "Floods & Droughts"
next: "/merit-badges/sustainability/guide/req3b/"
next_title: "Global Food Supply"
---
...
{{< drg/did-you-know >}}
It takes about 1,800 gallons of water to produce a single pound of beef — compared to about 100 gallons for a pound of wheat and 25 gallons for a pound of lettuce. Water use is one of the biggest sustainability differences between food types.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Food Journey Checklist" subtitle="Questions to answer for each food" >}}
...
{{< drg/tip >}}
Check the labels on foods in your kitchen. Many list the country of origin. For packaged foods, the ingredients list and company website can help you trace the supply chain. Look for certifications like Fair Trade, Rainforest Alliance, or Marine Stewardship Council — these indicate sustainability efforts.
{{< /drg/tip >}}

{{< drg/image src="images/food-journey-map.avif" alt="An illustrated map showing the journey of different foods from their source (farm, ocean, orchard) through processing and transportation to a grocery store" >}}

{{< drg/external-link
    title="FoodPrint — Understanding Your Food"
    url="https://foodprint.org/"
    description="In-depth guides on how different foods are produced, processed, and transported, with a focus on sustainability and environmental impact." >}}

{{< drg/video
    title="Exploring Food Sustainability"
    url="https://www.youtube.com/watch?v=PyiVf26C5pc" >}}

{{< drg/next-page
    text="Now you understand how different foods get from their source to your table"
    teaser="Discover the factors that limit food availability around the world and how communities can grow their own food."
