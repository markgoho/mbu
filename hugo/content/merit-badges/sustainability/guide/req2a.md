...
req_number: "2a"
prev: "/merit-badges/sustainability/guide/req1/"
prev_title: "Req 1 — Defining Sustainability"
next: "/merit-badges/sustainability/guide/req2b/"
next_title: "Req 2b — Water Systems"
---
...
{{< drg/checklist title="Where Does Household Water Go?" subtitle="Average indoor water use breakdown" >}}
...
{{< drg/did-you-know >}}
A single leaky faucet dripping once per second wastes about 3,000 gallons of water per year. That is enough for 180 showers. Fixing household leaks can save the average home about 10% on its water bill.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
If your family does not have access to water bills, you can still complete this requirement. Estimate your usage by timing showers, counting toilet flushes, and tracking how often you run appliances for a week. Then multiply to estimate monthly and yearly totals.
{{< /drg/tip >}}

{{< drg/image src="images/scout-checking-faucet.avif" alt="A Scout inspecting a kitchen faucet with a parent, with a water bill and notebook on the counter beside them" >}}

{{< drg/external-link
    title="WaterSense — U.S. EPA"
    url="https://www.epa.gov/watersense"
    description="EPA's program for water efficiency, including tips for reducing water use at home and a water budget calculator." >}}

{{< drg/video
    title="How We Use Water"
    url="https://www.youtube.com/watch?v=dEmYud2wGlc" >}}

{{< drg/next-page
    text="Now you know how to evaluate your household water usage"
    teaser="Learn about where your clean water comes from and where it goes after you use it."
