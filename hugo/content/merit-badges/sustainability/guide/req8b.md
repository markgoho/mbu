...
{{< drg/did-you-know >}}
The Scout Law point "A Scout is Thrifty" was included by Lord Baden-Powell in the original 1908 Scout Law. He defined it as: "He saves every penny he can, and puts it into the bank, so as to have money to keep himself when out of work, and thus not make himself a burden to others." Today, being thrifty extends to all resources — not just money.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
For your counselor discussion, do not just list connections — give specific examples from your own life. "Being thrifty connects to sustainability because I started using a reusable water bottle instead of buying disposable ones" is more powerful than "A Scout is thrifty, and sustainability means being thrifty."
{{< /drg/tip >}}

{{< drg/image src="images/scout-oath-outdoors.avif" alt="A group of Scouts reciting the Scout Oath at a trailhead before a hike, with a Leave No Trace principles sign visible nearby" >}}

{{< drg/external-link
    title="Leave No Trace Center for Outdoor Ethics"
    url="https://lnt.org/"
    description="The official Leave No Trace organization with educational resources, training programs, and guides for practicing outdoor ethics." >}}

{{< drg/video
    title="Camping Tricks: The Scout Turn Around Rule LNT"
    url="https://www.youtube.com/watch?v=kc59VSGN-dg" >}}

{{< drg/next-page
    text="You see how Scouting values align with sustainability"
    teaser="Identify five behavior changes your household can make to live more sustainably every day."
