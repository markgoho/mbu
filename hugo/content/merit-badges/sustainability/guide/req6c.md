...
{{< drg/safety-first >}}
Never burn household trash in a backyard fire pit or barrel. Burning plastics, treated wood, and other materials releases toxic chemicals into the air that you and your neighbors breathe. It is also illegal in many areas.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
There are actually five major ocean garbage patches — one in each of the world's subtropical gyres. The Great Pacific Garbage Patch is the largest, but similar accumulations exist in the North Atlantic, South Atlantic, South Pacific, and Indian oceans.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
The triangle of arrows on plastic containers does not mean the item is recyclable — it only identifies the type of plastic. This is one of the most common misconceptions about recycling. Always check your local program's accepted materials list.
{{< /drg/tip >}}
...
{{< drg/image src="images/plastic-recycling-numbers.avif" alt="A clear illustration showing the seven plastic recycling symbols with their numbers, names, and common product examples" >}}

{{< drg/external-link
    title="How to Recycle Electronics — EPA"
    url="https://www.epa.gov/recycle/electronics-donation-and-recycling"
    description="EPA guide to donating and recycling electronics responsibly, including certified recycler directories." >}}

{{< drg/video
    title="The Great Pacific Garbage Patch"
    url="https://www.youtube.com/watch?v=dtaNqGyHkNE" >}}

{{< drg/next-page
    text="You now understand how waste impacts the environment and how recycling systems work"
    teaser="Zoom out to the global scale and explore the United Nations' Sustainable Development Goals."
