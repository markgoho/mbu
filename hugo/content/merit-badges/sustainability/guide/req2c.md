...
req_number: "2c"
prev: "/merit-badges/sustainability/guide/req2b/"
prev_title: "Req 2b — Water Systems"
next: "/merit-badges/sustainability/guide/req3a/"
next_title: "Req 3a — Food Sources"
---

{{< drg/requirement number="2c" >}}
Different areas of the world are affected by either too much (flooding) or too little (drought) water. Explore whether either or both affect where you live. Identify three water conservation or flood mitigation practices (successful or unsuccessful) that have been tried where you live or in an area of the world that interests you.
{{< /drg/requirement >}}
...
{{< drg/did-you-know >}}
Flash floods can produce walls of water 10 to 20 feet high. They can roll boulders, tear out trees, and destroy buildings. Most flood-related deaths happen when people try to walk or drive through floodwater — just six inches of moving water can knock you off your feet.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When identifying practices for your counselor, include whether each practice was successful or not. A practice that failed can teach just as much as one that worked. For example, the levee failures in New Orleans led to major improvements in flood protection design.
{{< /drg/tip >}}

{{< drg/image src="images/drought-vs-flood.avif" alt="A split image showing a dried, cracked lakebed on one side and a flooded neighborhood street on the other, illustrating the extremes of too little and too much water" >}}

{{< drg/external-link
    title="U.S. Drought Monitor"
    url="https://droughtmonitor.unl.edu/"
    description="Weekly updated map showing drought conditions across the United States, with historical data and state-by-state analysis." >}}

{{< drg/video
    title="Science Behind Drought"
    url="https://www.youtube.com/watch?v=Do6cC05LuDs" >}}

{{< drg/next-page
    text="You have explored how water challenges affect communities"
    teaser="Now shift your focus to food — where it comes from, how it reaches your plate, and what makes food systems sustainable."
