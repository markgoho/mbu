...
{{< drg/checklist title="What to notice in each cultural area" subtitle="Use the same lens for each region so your comparison stays organized" >}}
- **Land and climate:** Is it coastal, forested, dry, mountainous, grassy, or Arctic?
...
{{< drg/image src="images/cultural-regions-homes-grid.avif" alt="Four-panel comparison of Indigenous homes and environments from the Arctic, Northwest Coast, Southwest, and Plains." >}}
...
{{< drg/did-you-know >}}
The horse is strongly associated with Plains cultures today, but horses were introduced to the Americas by Europeans. Native nations adapted horse culture so effectively that it reshaped travel, hunting, and warfare across the Plains in just a few generations.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
If you are trying to remember each region, connect it to one strong image: cedar canoe for the Northwest Coast, pueblo for the Southwest, tipi for the Plains, longhouse for the Northeast, and kayak for the Arctic.
{{< /drg/tip >}}

{{< drg/video
    title="Adapting to the Environment - How Geography Shaped Native American Cultures — Miacademy & MiaPrep Learning Channel"
    url="https://www.youtube.com/watch?v=AMjKWONNmgA" >}}
...
{{< drg/external-link
    ...
    description="Explore Indigenous territories, languages, and treaties connected to specific places. Use it as a starting point, then follow up with tribal or museum sources." >}}

Now that you understand the broad map, the next step is to research one nation closely enough to see how a real community's story goes far beyond a regional label.

{{< drg/next-page
    text="You can now identify the major cultural areas and explain why geography shaped them differently."
    teaser="Choose one tribe, group, or nation and learn how to research it in depth."
