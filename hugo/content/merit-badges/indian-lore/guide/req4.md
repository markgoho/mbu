...
{{< drg/checklist title="Make your eight examples stronger" subtitle="Go beyond naming the object" >}}
...
{{< drg/safety-first >}}
Choose a game that fits your space, your group size, and your equipment. Check for tripping hazards, set clear boundaries, and explain how to play before anyone starts moving at full speed. If a game involves throwing, tagging, or sticks, review safety rules first.
{{< /drg/safety-first >}}

{{< drg/be-prepared title="Teaching a traditional game to your troop or patrol" >}}
Before game day:

- **Learn the game's origin** and say which nation or region it comes from.
- **Practice the rules yourself** so you can explain them simply.
- **Adapt only what you need** for safety or age level.
- **Tell the group why the game matters,** not just how to score.
- **Keep the tone respectful.** Do not turn cultural traditions into jokes or costumes.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
A short introduction works well: "Today we're learning a game connected to Native traditions from this nation or region. We'll focus on the rules, skills, and respectful background before we play." That frames the activity the right way.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have explored how Native knowledge shaped survival, culture, and exchange in North America."
    teaser="Choose your final experience: a museum visit or a contemporary Native gathering."
