...
Start by choosing a language connected to the nation you researched in [Req 2](/merit-badges/indian-lore/guide/req2/). Then look for terms that are actually useful in daily or community life: greetings, kinship words, numbers, names for natural features, animals, or polite expressions. Learn how to pronounce them if you can. Your counselor will probably care more about respectful learning than perfect accent.

{{< drg/checklist title="How to learn your 10 terms" subtitle="Build understanding, not just a memorized list" >}}
...
{{< drg/did-you-know >}}
During both World Wars, Native speakers used their languages in military communication as code talkers. Their success showed not only bravery, but also how rich and structurally complex Native languages are.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
If you find several different meanings for a place name, tell your counselor that too. Language histories are sometimes messy because settlers changed spellings or borrowed words through another language first.
{{< /drg/tip >}}

{{< drg/external-link
    title="Native Land Digital"
    url="https://native-land.ca/"
    description="Use the map to identify nations and languages connected to a location, then follow up with local tribal or historical sources for place-name meanings." >}}

## Requirement 3c: Leaders
...
{{< drg/be-prepared title="If you are worried about picking the 'wrong' leaders" >}}
You do not need the five most famous names in history. Choose people you can explain well.

- **Pick from different time periods** so you show range.
- **Include at least one present-day figure** to show Native leadership did not stop in the past.
- **Match each leader to their nation** and one clear contribution.
- **Avoid reducing someone to a stereotype** like "war chief" without context.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Library of Congress — Indigenous Peoples of North America"
    url="https://www.loc.gov/classroom-materials/indigenous-peoples-of-north-america/"
    description="A useful place to look for primary sources and biographies when you research Native leaders and historical context." >}}

Words, place names, and leaders all remind you that Native presence is not hidden or finished. Next you will look at how Native peoples shaped the lives of others and how cultural exchange changed North America.

{{< drg/next-page
    text="You have explored how language, geography, and leadership keep Native identity visible."
    teaser="Next, think about Native influence on daily life, survival, and shared culture in North America."
