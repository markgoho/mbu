...
{{< drg/checklist title="Guest etiquette at a Native gathering" subtitle="Follow local rules first if they differ" >}}
...
{{< drg/image src="images/powwow-etiquette-scene.avif" alt="Contemporary Native gathering showing arena, audience, and respectful guest observation areas." >}}

{{< drg/video
    title="Celebration of Powwow | The Living History of Native American Gatherings — NBC News"
    url="https://www.youtube.com/watch?v=N2CmYbpjIz8" >}}

{{< drg/safety-first >}}
If the event is crowded, outdoors, or very hot, take normal outing precautions. Stay with your group, keep track of meeting points, drink water, and follow all event staff instructions. Respectful behavior includes basic personal responsibility.
{{< /drg/safety-first >}}

{{< drg/tip >}}
Write quick notes right after important moments. You do not need to write during a dance or song if that would be distracting, but short notes afterward will help you remember details for your counselor conversation.
{{< /drg/tip >}}

{{< drg/be-prepared title="If you are unsure whether an event is appropriate to attend" >}}
Before you go:

- **Check whether the event is open to the public.**
- **Look for posted guest guidelines** on the event website or flyer.
- **Ask a parent, leader, or counselor** if they know the event's expectations.
- **Be ready to observe quietly** if you are not sure what something means.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You are ready to attend a contemporary gathering with respect and curiosity."
    teaser="Finish the guide by exploring deeper ways to keep learning beyond the badge."
