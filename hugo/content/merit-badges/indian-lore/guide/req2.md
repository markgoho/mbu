...
{{< drg/tip >}}
Use the most specific name you can. "Lakota," "Diné," "Haudenosaunee," or "Choctaw Nation of Oklahoma" is stronger than a vague label like "Plains Indians" or "Southwestern tribes."
{{< /drg/tip >}}
...
{{< drg/checklist title="Research categories to cover" subtitle="Make one short section in your notes for each topic" >}}
...
{{< drg/be-prepared title="When your source only talks about the past" >}}
Some books and websites focus only on the 1700s or 1800s. If that happens:

- **Add a second source** from a tribal government, cultural center, or museum.
- **Look for present-day community life,** not just historical images.
- **Ask how traditions continue** through language programs, arts, leadership, education, or public events.
- **Avoid speaking as if the nation disappeared.** Use present tense when it fits: "The nation operates..." or "The community continues..."
{{< /drg/be-prepared >}}
...
{{< drg/did-you-know >}}
There are hundreds of federally recognized tribal nations in the United States, and each one has its own government-to-government relationship with the United States. Native nations are not all branches of one larger organization.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    ...
    description="A research starting point with primary sources, maps, and teaching materials that can help you gather strong background information." >}}

{{< drg/external-link
    title="National Congress of American Indians — Tribal Nations and the United States"
    url="https://archive.ncai.org/about-tribes"
    description="A helpful overview of tribal sovereignty and why Native nations have distinct governments, histories, and identities." >}}
...
{{< drg/next-page
    text="You now have a research plan for telling the story of one Native nation with depth and respect."
    teaser="Next, explore Native language terms, place names, and leaders whose influence still matters."
