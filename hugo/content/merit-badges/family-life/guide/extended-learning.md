...
prev: "/merit-badges/family-life/guide/req7/"
prev_title: "Req 7 — Understanding Parenthood"
---
...
{{< drg/tip >}}
Practice active listening with a friend or sibling this week. Have them tell you about something for two minutes while you listen without interrupting. Then summarize what they said before responding. Notice how it changes the quality of the conversation.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Psychologist John Gottman's research found that stable, healthy relationships have a ratio of at least five positive interactions for every one negative interaction. That means for every argument or frustration, you need five moments of kindness, humor, appreciation, or connection to keep the relationship strong.
{{< /drg/did-you-know >}}
...
{{< drg/experience-card title="Family Volunteer Day" details="What: Volunteer together at a local food bank, Habitat for Humanity, or community event | Why: Working together on something bigger than yourselves strengthens family bonds and models service" >}}

{{< drg/experience-card title="Intergenerational Interview Project" details="What: Interview a grandparent or older relative about their childhood and family traditions | Why: Preserves family history and deepens your connection to previous generations" >}}

{{< drg/experience-card title="Family Budget Challenge" details="What: Work with your family to create a one-month budget and track spending together | Why: Builds financial literacy and teamwork while addressing a real-world family need" >}}

{{< drg/experience-card title="Tech-Free Weekend" details="What: Challenge your family to spend one full weekend without recreational screens | Why: Rediscover face-to-face connection and find out what your family does when devices aren't an option" >}}

{{< drg/experience-card title="Family Heritage Meal" details="What: Research a traditional recipe from your family's cultural background and cook it together | Why: Connects you to your roots through food, storytelling, and hands-on collaboration" >}}

### F. Organizations

{{< drg/org-card name="National Alliance on Mental Illness (NAMI)" description="The nation's largest grassroots mental health organization, offering education, support groups, and advocacy for individuals and families affected by mental illness." url="https://www.nami.org/" >}}

{{< drg/org-card name="Boys & Girls Clubs of America" description="Provides programs and services for young people to help them reach their full potential, with a focus on academic success, healthy lifestyles, and character development." url="https://www.bgca.org/" >}}

{{< drg/org-card name="National Council on Family Relations (NCFR)" description="A nonpartisan professional organization focused on understanding and strengthening families through research, education, and practice." url="https://www.ncfr.org/" >}}

{{< drg/org-card name="StrongFamilies / Annie E. Casey Foundation" description="Works to build a brighter future for children and families through research, policy, and community initiatives focused on child well-being." url="https://www.aecf.org/" >}}

{{< drg/org-card name="SAMHSA (Substance Abuse and Mental Health Services Administration)" description="A federal agency providing resources, treatment locators, and information about mental health and substance use prevention for individuals and families." url="https://www.samhsa.gov/" >}}
