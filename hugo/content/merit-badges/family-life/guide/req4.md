...
{{< drg/checklist title="Project Planning Steps" subtitle="Map out your project before you start" >}}
...
{{< drg/safety-first >}}
If your project involves tools, chemicals (like paint or cleaning products), electrical work, or anything at heights, always have an adult present. Never take shortcuts with safety to save time. A Scout is careful and thoughtful — especially at home.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="Your Project Doesn't Go as Planned" >}}
Maybe the paint color looked different on the wall than it did on the chip. Maybe organizing the garage took three times longer than you thought. Maybe the garden bed didn't come out perfectly square. That's okay.

- **Focus on what you accomplished**, not what went wrong.
- **Be honest about the challenges.** Your counselor will appreciate your self-awareness more than a perfect outcome.
- **Consider what you'd change.** Reflection is where the real learning happens.
{{< /drg/be-prepared >}}

### Explore More Resources

{{< drg/external-link title="How to Start a Project (video)" url="https://www.youtube.com/watch?v=h1ooM4vaOaU" description="A helpful guide for planning and starting any kind of project from scratch." >}}
...
{{< drg/next-page
    ...
    teaser="Now plan a project that involves your whole family working together."
