...
{{< drg/tip >}}
Think of crossovers as "over and under" — the inside foot goes OVER, the outside foot goes UNDER. This simple memory cue helps keep the footwork straight when learning.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="How To Do Back Crossovers in a Figure 8 (video)"
    url="https://youtu.be/krBVgF52z8M" >}}

{{< drg/next-page
    text="You can perform forward crossovers through a figure-eight pattern."
    teaser="Next, discuss the safety considerations for ice-skating races with your counselor."
