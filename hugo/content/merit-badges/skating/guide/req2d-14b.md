...
{{< drg/tip >}}
For your counselor demonstration, pick the trick you land most consistently. A clean, repeated shove-it demonstrates the category as well as a more advanced kickflip. Consistency matters more than difficulty.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Flip a Skateboard (video)"
    url="https://youtu.be/MDkVYN6Rk_I" >}}

{{< drg/video
    title="Shove-It (video)"
    url="https://youtu.be/fBAW51ilpLw" >}}

{{< drg/next-page
    text="You can demonstrate at least one flip or shove-it trick."
    teaser="Next, explore grind and slide tricks — bringing the board in contact with rails and ledges."
