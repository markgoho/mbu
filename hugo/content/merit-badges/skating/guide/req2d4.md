...
{{< drg/image src="images/protective-gear-fit-checkpoints.avif" alt="Annotated photo of a skateboarder in full protective gear with callouts showing correct helmet level, knee pad placement, elbow pad position, and wrist guard orientation" >}}

{{< drg/checklist title="Full Gear Checklist" subtitle="Complete before every skateboarding session" >}}
...
{{< drg/external-link
    title="Skateboarding Safety (website)"
    url="https://www.scouting.org/health-and-safety/safety-moments/skateboard-safety/"
    description="Scouting America's official skateboarding safety guidance, covering required protective gear and how to use it correctly — the official reference for this requirement." >}}

{{< drg/next-page
    text="You can explain and demonstrate correct wear for all four pieces of protective gear."
    teaser="Next, learn the two styles of skateboarding and the features you will find at skate parks."
