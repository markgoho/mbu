...
req_number: "2a14"
req_path: "2.a.14"
prev: "/merit-badges/skating/guide/req2a-13/"
prev_title: "Ice Race Safety"
next: "/merit-badges/skating/guide/req2b/"
next_title: "Roller Skating Overview"
---

{{< drg/requirement number="2a14" >}}
...
{{< drg/safety-first >}}
Practice hockey stops at moderate speed and increase gradually. Attempting at maximum speed before the technique is solid often leads to a hard fall. Build up incrementally.
{{< /drg/safety-first >}}

{{< drg/did-you-know >}}
The ice spray in a perfect hockey stop comes from the blade scraping a thin layer of ice crystals from the surface. The heat from friction briefly melts the ice surface, and the rapid scraping launches those near-liquid crystals forward in a dramatic fan.
{{< /drg/did-you-know >}}

## Official Resources

{{< drg/video
    title="Perform a Hockey Stop (video)"
    url="https://youtu.be/nIfU38nAYYk" >}}

{{< drg/next-page
    text="You have completed all 14 subrequirements for Option A — Ice Skating."
    teaser="Continue to Option B — Roller Skating, or jump to whichever option you have chosen."
