...
{{< drg/tip >}}
Hockey skates have no toe pick, so this concern does not apply if you are wearing hockey skates. Focus on the clean inside-edge push instead.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Forward From a T Position (video)"
    url="https://youtu.be/-7QqRz2EZAM" >}}

{{< drg/next-page
    text="You can start from a T position and stroke forward cleanly around the rink."
    teaser="Next, turn around — Requirement 2a9 introduces backward gliding."
