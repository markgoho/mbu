...
{{< drg/tip >}}
Practice backward swizzles near a wall first. Stand facing the wall, put your hands lightly on the wall for support, and practice the heel-out/toe-in motion at a standstill. Once you have the foot pattern, move away from the wall and try it free.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Backward Swizzles (video)"
    url="https://youtu.be/t3dO_3vh0Ig" >}}

{{< drg/next-page
    text="You can skate backward for 40 feet in linked backward swizzles."
    teaser="Next, add speed and direction change with a lunge turn."
