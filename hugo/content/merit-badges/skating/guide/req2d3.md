...
req_number: "2d3"
req_path: "2.d.3"
prev: "/merit-badges/skating/guide/req2d2/"
prev_title: "Req 2d2 — Benefits of Skateboarding"
next: "/merit-badges/skating/guide/req2d4/"
next_title: "Req 2d4 — Protective Gear"
---
...
{{< drg/tip >}}
These rules are rarely written down at parks — they are understood through observation and experience. When you visit a new skate park, spend 10–15 minutes watching how others navigate the space before you start skating. You will quickly learn the flow of that specific park.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Skate Park Safety Rules (video)"
    url="https://youtu.be/Yw9bBDZ2kUo" >}}

{{< drg/video
    title="How to Ride Skateparks for Beginners (video)"
    url="https://youtu.be/zTVb4bmoiw0" >}}

{{< drg/video
    title="Skatepark Terrain (video)"
    url="https://youtu.be/qrq6KlaIe8Y" >}}

{{< drg/external-link
    title="How to Ride Safely on a Skateboard (video)"
    url="https://player.vimeo.com/video/903371803"
    description="A foundational guide from the BSA's skateboarding program covering safe riding practices and skate park behavior — directly relevant to this requirement." >}}

{{< drg/next-page
    text="You can explain skateboarding safety rules, courtesy, right-of-way, and communication signals."
    teaser="Next, cover the protective gear itself — what each piece does and how to wear it correctly."
