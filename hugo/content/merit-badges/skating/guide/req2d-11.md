...
{{< drg/safety-first >}}
Never stop by grabbing fences, walls, or other people. These sudden anchoring stops can cause you to fall over or injure others. Use one of the friction-based stopping techniques above.
{{< /drg/safety-first >}}

## Official Resources

{{< drg/video
    title="How to Stop a Skateboard (video)"
    url="https://youtu.be/gLikGjxWCUQ" >}}

{{< drg/next-page
    text="You can demonstrate at least two braking and stopping techniques."
    teaser="Next, the iconic milestone — Requirement 2d12 asks you to land a basic ollie."
