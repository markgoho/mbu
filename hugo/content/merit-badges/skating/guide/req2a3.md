...
{{< drg/image src="images/ice-skate-types-comparison.avif" alt="Side-by-side diagram of figure skate, hockey skate, and speed skate with labeled parts including blade, toe pick, rocker, and boot height" >}}

{{< drg/tip >}}
When discussing this requirement with your counselor, bring your skates and point to each part as you explain it. Physical examples are more convincing than reciting a list from memory.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Figure Skates vs. Hockey Skates (video)"
    url="https://youtu.be/H6hUVU57Wpk" >}}

{{< drg/next-page
    text="You can identify and explain the parts of figure, hockey, and speed skates."
    teaser="Next, learn the proper way to carry ice skates at the rink and during travel."
