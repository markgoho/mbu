...
{{< drg/tip >}}
Practice the boneless motion slowly at first — stop on your planted foot and hold the position to feel the balance before adding the jump. Building comfort with the one-footed plant position prevents falls during the actual trick.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="How to Boneless (video)"
    url="https://youtu.be/wUZpFX0CS1g" >}}

{{< drg/next-page
    text="You have completed all five trick categories and chosen your three."
    teaser="Congratulations on finishing Option D — proceed to Extended Learning for more skating resources."
