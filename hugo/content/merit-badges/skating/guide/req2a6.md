...
req_number: "2a6"
req_path: "2.a.6"
prev: "/merit-badges/skating/guide/req2a5/"
prev_title: "Req 2a5 — Storing Skates"
next: "/merit-badges/skating/guide/req2a7/"
next_title: "Req 2a7 — Forward Glide"
---
...
{{< drg/safety-first >}}
Before attempting to stop from full speed, practice the snowplow motion slowly at a standstill. Feel the edge scraping the ice and build the muscle memory before adding speed.
{{< /drg/safety-first >}}

{{< drg/tip >}}
During your counselor demonstration, choose the stop type you have practiced most. Both options satisfy the requirement — pick the one you can execute cleanly every time.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Snowplow Stop (video)"
    url="https://youtu.be/rhQY1_bTjVs" >}}

{{< drg/next-page
    text="You can skate forward 40 feet and come to a complete snowplow stop."
    teaser="Next, practice gliding forward — first on two feet, then on one foot at a time."
