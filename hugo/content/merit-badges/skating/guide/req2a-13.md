...
{{< drg/tip >}}
When your counselor asks about race safety, organize your answer around three themes: gear, behavior on the ice, and what to do if something goes wrong. That structure covers all the key points.
{{< /drg/tip >}}

## Official Resources

{{< drg/external-link
    title="How Speed Skaters Stay Safe on the Ice (website)"
    url="https://healthcare.utah.edu/healthfeed/2022/02/how-speed-skaters-stay-safe-ice"
    description="A sports medicine perspective on speed skating injury prevention, covering gear, technique, and the specific risks of skating at competitive speeds — directly applicable to your race safety discussion." >}}

{{< drg/external-link
    title="Safety Tips: Ice Skating (website)"
    url="https://kidshealth.org/en/parents/safety-ice-skating.html"
    description="KidsHealth's overview of ice skating safety for parents and youth, covering protective gear, ice conditions, and rink rules — useful for reinforcing the foundational safety points." >}}

{{< drg/next-page
    text="You can explain the safety considerations for participating in an ice-skating race."
    teaser="One more skill to go — Requirement 2a14 asks you to perform a hockey stop."
