...
req_number: "2d14a"
req_path: "2.d.14.a"
prev: "/merit-badges/skating/guide/req2d-14/"
prev_title: "Req 2d14 — Three Trick Types"
next: "/merit-badges/skating/guide/req2d-14b/"
next_title: "Req 2d14b — Flip & Shove-It Tricks"
---

{{< drg/requirement number="2d14a" >}}
Flat ground tricks
{{< /drg/requirement >}}
...
{{< drg/video
    title="Flatland Tricks (video)"
    url="https://youtu.be/-LwtQJFqNOA" >}}

{{< drg/external-link
    title="How to Manual on Skateboard (video)"
    url="https://player.vimeo.com/video/901305720"
    description="A step-by-step guide to landing a smooth manual — foot placement, weight balance, and technique for holding the balance point." >}}

{{< drg/external-link
    title="How to Throwdown on Skateboard (video)"
    url="https://player.vimeo.com/video/901305789"
    description="Tutorial for the throwdown (board toss) flat ground trick — a creative entry move where the board is dropped and the rider mounts it from standing." >}}

{{< drg/external-link
    title="How to 180 on a Skateboard (video)"
    url="https://player.vimeo.com/video/901305968"
    description="Covers both frontside and backside 180 techniques with detailed foot placement, shoulder rotation, and landing cues." >}}

{{< drg/next-page
    text="You can demonstrate at least one flat ground trick."
    teaser="Next, explore flip and shove-it tricks — board rotation tricks beneath the rider."
