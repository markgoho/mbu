...
req_number: "2d12"
req_path: "2.d.12"
prev: "/merit-badges/skating/guide/req2d-11/"
prev_title: "Req 2d11 — Braking Techniques"
next: "/merit-badges/skating/guide/req2d-13/"
next_title: "Req 2d13 — Drop-In from Coping"
---

{{< drg/requirement number="2d12" >}}
...
{{< drg/tip >}}
Film yourself from the side while practicing ollies. The most common mistake is not popping hard enough and not sliding the front foot far enough forward. Video helps you see which part of the motion needs work.
{{< /drg/tip >}}

## Official Resources

{{< drg/external-link
    title="How to Ollie on Skateboard (video)"
    url="https://player.vimeo.com/video/901305845"
    description="A step-by-step ollie tutorial with detailed slow-motion breakdown of foot placement, pop timing, and front-foot slide — essential preparation for your counselor demonstration." >}}

{{< drg/next-page
    text="You can land a basic ollie and at least one variation."
    teaser="Next, commit to the ramp — Requirement 2d13 asks you to drop-in from coping."
