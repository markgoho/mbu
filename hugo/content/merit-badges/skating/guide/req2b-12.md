...
{{< drg/tip >}}
Practice the stepover motion standing still, holding a wall if needed, before adding it to a moving skate. Walking your feet through the cross-and-uncross pattern on a stationary surface builds the muscle memory first.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You can perform a stepover on roller skates."
    teaser="One final skill for Option B — Requirement 2b13 adds sport-skill challenge to your skating."
