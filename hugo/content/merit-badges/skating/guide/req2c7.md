...
{{< drg/safety-first >}}
Practice the heel brake at slow speeds first — find the range of pressure that gives you a smooth, controlled stop before attempting to stop from full skating speed.
{{< /drg/safety-first >}}

## Official Resources

{{< drg/video
    title="Braking with In-Line Skates (video)"
    url="https://youtu.be/phN9uBIXkAw" >}}

{{< drg/next-page
    text="You can stop on command using the heel brake."
    teaser="Next, learn forward crossovers — the technique for maintaining speed through turns."
