...
req_number: "2a7"
req_path: "2.a.7"
prev: "/merit-badges/skating/guide/req2a6/"
prev_title: "Req 2a6 — Forward Skating & Stop"
next: "/merit-badges/skating/guide/req2a8/"
next_title: "Req 2a8 — T-Position Stroking"
---
...
{{< drg/tip >}}
Practice stepping onto one foot while standing still before attempting a moving glide. Feel what "balanced over one blade" means before you add speed.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Forward Stroking (video)"
    url="https://youtu.be/-7QqRz2EZAM" >}}

{{< drg/next-page
    text="You can glide forward on two feet and then on each foot individually."
    teaser="Next, learn to stroke forward from a T position — the standard ice skating ready stance."
