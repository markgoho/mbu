...
{{< drg/tip >}}
Practice stopping from moderate speed before your counselor demonstration. Stopping from very slow speeds feels different from stopping from real skating speed — make sure you are practiced at both.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Skating Forward (video)"
    url="https://youtu.be/znYKw5GQZVA" >}}

{{< drg/next-page
    text="You can skate forward with linked strokes in both directions and demonstrate stopping."
    teaser="Next, extend your balance by gliding on a single skate for at least 15 feet."
