...
req_number: "2a5"
req_path: "2.a.5"
prev: "/merit-badges/skating/guide/req2a4/"
prev_title: "Req 2a4 — Carrying Skates"
next: "/merit-badges/skating/guide/req2a6/"
next_title: "Req 2a6 — Forward Skating & Stop"
---
...
{{< drg/tip >}}
A light coat of oil (like 3-in-1 oil) on the blade before long-term storage prevents surface rust. Wipe it off completely before skating next season — oil on the ice creates a slip hazard.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="How Do I Store My Skates Correctly? (video)"
    url="https://youtu.be/xCibThdzynI" >}}

{{< drg/external-link
    title="Care for Your Ice Skates (website)"
    url="https://www.skatepro.ca/en/a65.htm"
    description="A practical guide to ice skate care and storage, covering blade drying, guard use, boot maintenance, and seasonal storage tips to keep your skates in top condition." >}}

{{< drg/next-page
    text="You can describe how to store ice skates properly between seasons."
    teaser="Now it is time to get on the ice — Requirement 2a6 is your first performance skill."
