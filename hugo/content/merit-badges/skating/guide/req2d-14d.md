---
title: "Air & Grab Tricks"
layout: "guide"
group_title: "2. Option D — Skateboarding"
req_number: "2d14d"
req_path: "2.d.14.d"
prev: "/merit-badges/skating/guide/req2d-14c/"
prev_title: "Grind & Slide Tricks"
next: "/merit-badges/skating/guide/req2d-14e/"
next_title: "Footplant Tricks"
---

{{< drg/requirement number="2d14d" >}}
Air and grab tricks
{{< /drg/requirement >}}
...
{{< drg/tip >}}
If you are new to air tricks, start with a low-consequence grab (like an Indy) on a small quarter pipe or mini ramp. Focus on getting consistent air height before adding the grab — a solid air without a grab still demonstrates the category if paired with a grab on a subsequent attempt.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Frontside Air (video)"
    url="https://youtu.be/4tz-HFSoEZY" >}}

{{< drg/video
    title="Grab Tricks (video)"
    url="https://youtu.be/UEYsZH49H_o" >}}

{{< drg/next-page
    text="You can demonstrate at least one air and grab trick."
    teaser="Last trick category — footplant tricks use a brief foot contact to redirect the board."
