...
{{< drg/tip >}}
For your demonstration, choose the step method if you are less experienced — it is slower, more controlled, and demonstrates the required technique just as well as the jump. Reserve the jump for when you have practiced it thoroughly.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Maneuvering Curbs (video)"
    url="https://youtu.be/3hq3sID5emE" >}}

{{< drg/next-page
    text="You have completed all 16 subrequirements for Option C — In-Line Skating."
    teaser="Continue to Option D — Skateboarding, or jump to your chosen option."
