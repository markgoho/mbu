...
{{< drg/checklist title="What to observe during a blind test" subtitle="These moments are especially valuable" >}}
...
Those lessons connect directly back to [Req 4d](/merit-badges/game-design/guide/req4d/), where you practiced analyzing how changes affect player experience.
...
{{< drg/tip >}}
A useful reflection sentence is: “The players reacted most strongly to ____, which showed me that ____.” That helps connect observation to design learning.
{{< /drg/tip >}}

{{< drg/external-link
    title="NPR — How Game Designers Use Playtesting"
    url="https://www.npr.org/"
    description="General reporting on game design often highlights the role of testing, feedback, and revision in making games better." >}}
...
{{< drg/next-page
    text="You have blind tested your game, gathered fresh feedback, and reflected on what the design process taught you."
    teaser="Next, choose a professional path and learn how game development connects to real careers and classrooms."
