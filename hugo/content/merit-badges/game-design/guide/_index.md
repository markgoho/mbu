...
- **Tools:** Boards, cards, dice, fields, simple tokens
- **Design style:** Small rule sets, face-to-face play, lots of local variations
...
- **Tools:** Paper prototypes, design notebooks, art software, game engines, analytics
- **Design style:** Deliberate testing, repeated revision, many possible mediums

{{< drg/did-you-know >}}
The ancient game Senet was played more than 5,000 years ago. That means people were arguing about rules, taking turns, and trying to outsmart each other long before modern sports or video games existed.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
When you design or modify a physical game, safety is part of the design. Rules should reduce unsafe contact, define clear boundaries, and match the age, ability, and space available for the players.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
As you play games this week, ask yourself two questions: “What is this game trying to make me feel?” and “What rule creates that feeling?” Those two questions will help you think like a designer.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have a big-picture view of what game design is and where it shows up."
    teaser="Start by comparing four different games and breaking them into their core parts."
    url="/merit-badges/game-design/guide/req1a/" >}}
