...
req_number: "6a"
prev: "/merit-badges/game-design/guide/req5d/"
prev_title: "Req 5d — Drawing Game Elements"
next: "/merit-badges/game-design/guide/req6bc/"
next_title: "Req 6bc — Test, Change, Repeat"
---
...
{{< drg/checklist title="Prototype priorities" subtitle="What version one needs most" >}}
...
{{< drg/image src="images/prototype-build-materials-and-safety.avif" alt="Two-part comparison showing rough prototype materials on one side and a safely marked active play area on the other." >}}
...
{{< drg/safety-first >}}
If your prototype uses physical movement, walk the play area before starting. Remove hazards, mark boundaries clearly, and explain any no-contact or low-contact rules before anyone begins. Use safe equipment and stop the test immediately if players begin improvising unsafe actions.
{{< /drg/safety-first >}}
...
These notes will make [Req 6bc](/merit-badges/game-design/guide/req6bc/) and [Req 7bc](/merit-badges/game-design/guide/req7bc/) much easier.
...
{{< drg/tip >}}
Label your prototype pieces, even if they are temporary. When players can tell what a card, token, or zone means right away, you learn more about the game and less about your own messy handwriting.
{{< /drg/tip >}}

{{< drg/external-link
    title="Games for Change — Student Game Design"
    url="https://www.gamesforchange.org/"
    description="Examples and resources showing how prototypes help young designers build, test, and improve game ideas." >}}

{{< drg/video
    title="How to Prototype Games so FAST that it feels ILLEGAL — Soul Engine Studio"
    url="https://www.youtube.com/watch?v=arxcB32hrHc" >}}

Once the prototype exists, the real work begins: test it, revise it, and test it again.

{{< drg/next-page
    text="You have built a first playable version of your game and documented how it works."
    teaser="Next, run repeated playtests, fix problems, and track how your changes affect player experience."
