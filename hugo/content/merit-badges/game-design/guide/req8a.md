...
{{< drg/checklist title="Strong interview questions" subtitle="Questions that reveal both the job and the process" >}}
...
{{< drg/image src="images/game-development-role-pipeline.avif" alt="Pipeline diagram showing game development roles like designer, programmer, artist, writer, producer, audio, QA, and UX across project stages." >}}
...
{{< drg/tip >}}
Listen for verbs when the person talks about their job. Words like “prototype,” “coordinate,” “debug,” “review,” “revise,” and “communicate” often reveal the true shape of the role.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    url="https://igda.org/"
    description="A professional organization for game developers with resources about roles, communities, and career pathways in the industry." >}}

{{< drg/external-link
    title="Entertainment Software Association"
    url="https://www.theesa.com/"
    description="Industry information about how the video game industry works and the many people involved in making games." >}}

If you would rather focus on learning and teaching skills than on a studio role, the next option may fit you better.

{{< drg/next-page
    text="You know how to prepare for a conversation with a real game industry professional and what to listen for."
    teaser="Next, explore the classroom side of game development and the skills educators emphasize most."
