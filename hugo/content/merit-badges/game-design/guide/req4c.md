...
req_number: "4c"
prev: "/merit-badges/game-design/guide/req4b/"
prev_title: "Req 4b — Predict Rule Changes"
next: "/merit-badges/game-design/guide/req4d/"
next_title: "Req 4d — Analyze the Results"
---
...
{{< drg/image src="images/three-playtest-results-comparison.avif" alt="Three-column comparison of the same game under different rule changes, showing different player behavior such as teamwork, rushed play, and confusion." >}}
...
{{< drg/checklist title="What to watch during each test" subtitle="Focus on evidence, not just opinions" >}}
...
{{< drg/be-prepared title="If a rule change breaks the game" >}}
That is still useful information.
- **Stop and note what broke**: Was it confusion, unfairness, endless loops, or no clear way to win?
- **Record when the problem appeared**: Right away or later in the game?
- **Explain why it matters**: Broken tests often reveal which rules are holding the whole system together.
{{< /drg/be-prepared >}}
...
Later, in [Req 4d](/merit-badges/game-design/guide/req4d/), you will explain how accurate your predictions were. That is hard to do if your notes are vague. Write down specifics like “players stopped passing and took more direct shots” or “the new objective made teammates talk constantly.”

Those details are more convincing than “it was fun.”

{{< drg/tip >}}
Ask players for one short reaction right after each test, before they forget. A sentence like “I felt rushed” or “This version made teamwork matter more” can help confirm what you observed.
{{< /drg/tip >}}

{{< drg/external-link
    title="International Game Developers Association Resource Library"
    url="https://igda.org/resourcelibrary/"
    description="Professional resources and articles about design practice, iteration, and game development workflows." >}}

Next, you will step back and compare your predictions with the real results.

{{< drg/next-page
    text="You have tested multiple rule changes and gathered observations about player actions and emotions."
    teaser="Next, explain what changed, what surprised you, and how accurate your predictions were."
