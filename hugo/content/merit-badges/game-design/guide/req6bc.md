...
Compare what happens in play to what you promised in [Req 5b](/merit-badges/game-design/guide/req5b/). If you said the game would feel fast and exciting, did it? If you said it would create teamwork, did players actually talk and coordinate? If not, that gap matters.
...
{{< drg/checklist title="Record each test round" subtitle="This makes your notebook useful instead of vague" >}}
...
{{< drg/image src="images/iteration-cycle-playtest-loop.avif" alt="Circular diagram showing the repeated game design loop of prototype, playtest, observe problems, revise, and retest." >}}
...
{{< drg/tip >}}
Try changing one major thing per round when possible. If you rewrite the whole game between tests, it becomes hard to know which change caused the new result.
{{< /drg/tip >}}

In [Req 4d](/merit-badges/game-design/guide/req4d/), you analyzed how rule changes affected an existing game. Now you are doing the same work on your own design. That connection is the whole point of the badge.

{{< drg/video
    title="Making Your First Game: Minimum Viable Product - Scope Small, Start Right - Extra Credits"
...
{{< drg/next-page
    text="You have tested your prototype multiple times, fixed problems, and tracked whether your revisions worked."
    teaser="Next, write instructions clear enough for new players to use on their own."
