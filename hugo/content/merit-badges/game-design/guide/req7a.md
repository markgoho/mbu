...
{{< drg/image src="images/instruction-sheet-structure-example.avif" alt="Example instruction sheet layout with sections for objective, materials, setup, turn sequence, end condition, and win condition." >}}
...
{{< drg/checklist title="Signs your instruction sheet is clear" subtitle="A new player should be able to answer these quickly" >}}
...
Think back to your playtests in [Req 6bc](/merit-badges/game-design/guide/req6bc/). Where did players get confused? Those moments tell you what the rule sheet must explain better.

A strong instruction sheet often answers questions before they are asked.

{{< drg/tip >}}
Read your rule sheet out loud to yourself. If a sentence feels awkward to say, it may also be awkward to understand.
{{< /drg/tip >}}
...
This page matters because [Req 7bc](/merit-badges/game-design/guide/req7bc/) asks you to blind test your game. That means a new group will use your instructions without coaching from you. If the sheet is weak, the blind test will show it immediately.
...
{{< drg/external-link
    title="Write the Docs — Clear Technical Writing Tips"
    url="https://www.writethedocs.org/guide/writing/beginners-guide-to-docs/"
    description="General writing guidance that helps with clarity, structure, and user-focused instructions." >}}

{{< drg/video
    title="How to Write a RULEBOOK - Designing a New Board Game — Jesse Ross"
    url="https://www.youtube.com/watch?v=eaayIuMtAfQ" >}}

Next, you will put your rules to the hardest test yet: handing the game to fresh players and staying silent.

{{< drg/next-page
    text="You now have an instruction sheet that explains setup, play, objectives, and end conditions."
    teaser="Next, use that sheet in a blind test and learn what new players really understand."
