---
title: "Why Your Game Is Fun"
layout: guide
group_title: "5. Designing Your Game"
req_number: "5b"
prev: "/merit-badges/game-design/guide/req5a/"
prev_title: "Vision, Theme, and Players"
next: "/merit-badges/game-design/guide/req5c/"
next_title: "Rules and Resources"
---
...
That reason might be challenge, laughter, teamwork, story, creativity, competition, speed, discovery, or something else. In [Req 1b](/merit-badges/game-design/guide/req1b/), you explored different kinds of play value. Now you need to choose which value your own game is built to deliver.
...
- “It is a fast bluffing game where nobody knows who to trust.”
- “You and your teammates race against the clock to rescue everyone.”
- “You get to build your own weird machine and see if it works.”
- “Every round creates funny arguments and surprise reversals.”
...
{{< drg/checklist title="Ways a game can attract players" subtitle="Pick the ones that fit your design best" >}}
...
{{< drg/image src="images/core-appeal-player-motivation-grid.avif" alt="Six-panel grid showing different player motivations such as challenge, competition, cooperation, story, creativity, and humor." >}}
...
That is why this requirement comes before [Req 5c](/merit-badges/game-design/guide/req5c/) and [Req 6bc](/merit-badges/game-design/guide/req6bc/). You need to know what the game is trying to do before you can test whether it does it.

{{< drg/tip >}}
If you cannot explain why someone would want to play your game in two or three clear sentences, pause and simplify the design. Usually the problem is not your writing. It is that the core appeal is still blurry.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If people sound confused by your game idea" >}}
Refocus on one strong promise.
- **Cut extra features** that do not support the main appeal.
- **Rename the objective** in clearer language.
- **Describe the feeling first** before explaining every rule.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Gamedesigning.org — Why Players Keep Playing"
    url="https://www.gamedesigning.org/learn/"
    description="Beginner-friendly articles about motivation, systems, and what makes game experiences stick with players." >}}

{{< drg/video
    title="How to Keep Players Engaged (Without Being Evil) — Game Maker's Toolkit"
...
{{< drg/next-page
    text="You have identified the main play value your game is supposed to deliver."
    teaser="Next, turn that idea into a working ruleset and define the materials your game needs."
