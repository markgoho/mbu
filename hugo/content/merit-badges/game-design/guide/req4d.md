...
2. what you predicted for each rule change
...
{{< drg/image src="images/prediction-vs-results-analysis-board.avif" alt="Analysis board comparing the original game, predicted effects, and actual results to help explain how accurate rule-change predictions were." >}}
...
{{< drg/checklist title="A strong analysis for each change" subtitle="Use this structure when talking with your counselor" >}}
...
In [Req 5b](/merit-badges/game-design/guide/req5b/), you will describe why someone would want to play your game. In [Req 6bc](/merit-badges/game-design/guide/req6bc/), you will have to test whether your design really creates that experience. The habit you build here will help a lot.

{{< drg/did-you-know >}}
In many professional studios, a feature is not considered successful just because the team likes it. It must be tested with players to see whether it truly creates the intended experience.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
A great sentence starter is: “I predicted ____, but the players actually ____ because ____.” That format helps you explain both the result and the reason behind it.
{{< /drg/tip >}}

{{< drg/external-link
    title="ESA — How Video Games Are Made"
    url="https://www.theesa.com/resources/"
    description="Industry resources from the Entertainment Software Association about how game development works, including iteration and collaboration." >}}

You have now practiced analyzing and testing existing systems. Next, you will start designing one of your own from scratch.

{{< drg/next-page
    text="You have compared predictions with actual results and learned how rule changes reshape player experience."
    teaser="Next, begin your own game by writing a vision statement and defining who it is for."
