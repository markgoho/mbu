...
4. score or update the board
5. pass play to the next player
...
{{< drg/checklist title="Rules that should appear early in your notebook" subtitle="You can refine the wording later" >}}
...
{{< drg/image src="images/prototype-rules-and-resources-layout.avif" alt="Top-down prototype layout showing setup area, player actions, turn order, score tracking, components, and shared resources." >}}
...
Since you will build a prototype in [Req 6a](/merit-badges/game-design/guide/req6a/), avoid writing rules that require materials you cannot produce. Fancy parts are optional. Clear systems matter more.
...
{{< drg/tip >}}
If you find yourself saying, “This rule only works if I have custom electronics, special art, or a huge map,” look for a paper version of the same idea first.
{{< /drg/tip >}}

### Leave Room for Testing

Do not treat your preliminary rule list like a sacred document. It is a starting point. In [Req 6bc](/merit-badges/game-design/guide/req6bc/), you are required to fix unclear rules, close loopholes, and change at least one rule, mechanic, or objective. That means change is not failure. It is part of the assignment.
...
{{< drg/external-link
    title="The Strong National Museum of Play — Game Design"
    url="https://www.museumofplay.org/"
    description="A major play and game museum with resources and examples that show how rules, components, and player interaction shape games." >}}

{{< drg/video
    title="How to write a Game Design Document — Game Dev Beginner"
    url="https://www.youtube.com/watch?v=bro4rwYVo0I" >}}

Once the rules exist on paper, the next step is making the components visible through sketches and drawings.

{{< drg/next-page
    text="You now have a preliminary ruleset and a list of the resources your game requires."
    teaser="Next, draw the parts players will actually see, hold, or interact with."
