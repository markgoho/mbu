---
title: "Core Design Terms"
layout: guide
group_title: "1. Thinking Like a Designer"
req_number: "2"
prev: "/merit-badges/game-design/guide/req1b/"
prev_title: "Why People Play"
next: "/merit-badges/game-design/guide/req3/"
next_title: "Intellectual Property"
---
...
{{< drg/tip >}}
If a game has “one best strategy” that wins too often, that is usually a balance problem. If players keep discovering new tactics after many sessions, that is usually a sign of depth.
{{< /drg/tip >}}
...
{{< drg/image src="images/game-design-terms-map.avif" alt="Diagram mapping major game design terms around a central game concept to show how ideas like story, balance, pace, and player structure relate." >}}
...
{{< drg/checklist title="A strong counselor discussion answer" subtitle="What makes an explanation better than a definition" >}}
...
{{< drg/external-link
    title="Game Design Concepts — Core Design Vocabulary"
    url="https://gamedesignconcepts.wordpress.com/"
    description="A long-running educational blog that explains major game design ideas in clear, beginner-friendly language." >}}
...
{{< drg/next-page
    text="You have a working vocabulary for discussing how games are structured and experienced."
    teaser="Next, learn how intellectual property affects the game industry and your own ideas."
