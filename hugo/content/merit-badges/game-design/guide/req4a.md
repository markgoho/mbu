...
{{< drg/checklist title="Before you play" subtitle="Build a useful baseline" >}}
...
{{< drg/image src="images/baseline-game-observation-notes.avif" alt="Annotated playtest scene showing players in a baseline game session while an observer records notes about pace, choices, fairness, and reactions." >}}

These observations will become very helpful in [Req 4b](/merit-badges/game-design/guide/req4b/) and [Req 4c](/merit-badges/game-design/guide/req4c/).

{{< drg/tip >}}
Write your notes during or right after the game, not later that night. Small details about player reactions fade fast, and designers need fresh observations.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If your group disagrees about the standard rules" >}}
Settle that problem before you start your baseline test.
- **Pick one official version** from a rule sheet or trusted source.
- **Explain it out loud** so everyone starts with the same expectations.
- **Use that same baseline** when judging later rule changes.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Common Sense Education — How Games Build Systems Thinking"
    url="https://www.commonsense.org/education/articles/what-playing-games-can-teach-us-about-learning"
    description="An education article that shows how games help players notice systems, rules, and cause-and-effect relationships." >}}

Next, you will become the designer by proposing rule changes before you test them.

{{< drg/next-page
    text="You now have a baseline version of your chosen game and notes on how it normally feels to play."
    teaser="Next, propose several rule or objective changes and predict what each one will do."
