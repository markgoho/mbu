...
{{< drg/image src="images/game-mediums-comparison-grid.avif" alt="Four side-by-side game scenes comparing a board game, card game, sport, and digital game to show how medium changes setup and player interaction." >}}

{{< drg/checklist title="What to record for each game" subtitle="Use the same categories every time so your chart is easy to compare" >}}
...
{{< drg/tip >}}
If you get stuck, explain the game to someone who has never played it. The moment you try to teach it clearly, you will notice what the true objective, rules, and resources really are.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If your chart feels too shallow" >}}
Try adding one more column: **What one design change would improve this game for me?**
- **If the game drags**: Suggest a shorter round structure or timer.
- **If it feels unfair**: Suggest a balancing rule or catch-up mechanic.
- **If it feels confusing**: Suggest clearer setup steps or player aids.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Smithsonian Lemelson Center — The Art of Video Game Design"
    url="https://invention.si.edu/video-game-design"
    description="A museum resource about the design choices that shape how games work and what players experience." >}}

In the next requirement, you will go deeper into a big question every designer asks: why do people play at all?

{{< drg/next-page
    text="You can now break a game into medium, rules, objectives, resources, and player experience."
    teaser="Next, explore the different kinds of value games create for players."
