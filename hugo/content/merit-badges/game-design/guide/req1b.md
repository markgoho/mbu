...
req_number: "1b"
prev: "/merit-badges/game-design/guide/req1a/"
prev_title: "Comparing Games"
next: "/merit-badges/game-design/guide/req2/"
next_title: "Core Design Terms"
---
...
{{< drg/image src="images/play-value-four-types-grid.avif" alt="Four-panel comparison showing challenge, social, story, and creativity play value through distinct game scenes and player reactions." >}}

{{< drg/did-you-know >}}
Many designers discover that players enjoy “expressing themselves” almost as much as winning. That is one reason character customization, level building, and creative modes are so popular.
{{< /drg/did-you-know >}}
...
- to compete and prove skill
- to explore a world they find interesting
- to laugh and be silly
- to feel progress and achievement
- to practice teamwork
- to learn something new
- to solve problems
- to enjoy surprise and unpredictability
...
{{< drg/checklist title="Questions to ask about play value" subtitle="Use these when choosing your examples" >}}
...
{{< drg/tip >}}
When you talk with your counselor, it is okay if one game contains more than one type of play value. Most good games do. Just explain which type feels strongest and why.
{{< /drg/tip >}}

{{< drg/external-link
    title="Edutopia — What Students Learn From Game Design"
    url="https://www.edutopia.org/article/what-students-learn-game-design/"
    description="A classroom-focused article showing how games create motivation, problem-solving, and creative engagement." >}}

In [Req 1a](/merit-badges/game-design/guide/req1a/), you compared whole games. Next you will zoom in on the language designers use to describe how those games are built.

{{< drg/next-page
    text="You now understand several kinds of play value and the reasons people choose to play."
    teaser="Next, learn the core game design terms you can use to analyze almost any game."
