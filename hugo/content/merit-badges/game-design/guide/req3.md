...
{{< drg/image src="images/intellectual-property-game-assets-breakdown.avif" alt="Diagram of a fictional game project broken into parts like logo, art, code, and rulebook to show different kinds of intellectual property protection." >}}
...
{{< drg/did-you-know >}}
Copyright usually protects the *expression* of a game, not the basic idea of the game. That is why many games can share similar mechanics while still being legally distinct.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="If you are inspired by a favorite franchise" >}}
Use the inspiration as a design direction, not as content to copy.
- **Instead of** using a famous character, invent your own role or faction.
- **Instead of** borrowing a logo or art style directly, create a new visual identity.
- **Instead of** retelling an existing story, build a fresh setting with similar feelings.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="U.S. Copyright Office — What Is Copyright?"
    url="https://www.copyright.gov/what-is-copyright/"
    description="An official overview of what copyright protects and what it does not protect." >}}

{{< drg/external-link
    title="USPTO — Basic Facts About Trademarks"
    url="https://www.uspto.gov/trademarks/basics/basic-facts-about-trademarks"
    description="A beginner-friendly guide from the U.S. Patent and Trademark Office on how trademarks work." >}}

In the next requirement, you will stop talking about existing designs and start changing one yourself by testing rule changes in action.

{{< drg/next-page
    text="You understand the main kinds of intellectual property and why they matter in game design."
    teaser="Next, start with an existing game and see how changing rules changes player behavior."
