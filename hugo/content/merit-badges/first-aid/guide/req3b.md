...
req_number: "3b"
prev: "/merit-badges/first-aid/guide/req3a/"
prev_title: "Req 3a — Closed Wounds & Burns"
next: "/merit-badges/first-aid/guide/req3c/"
next_title: "Req 3c — Punctures, Plants & Stings"
---
...
**First aid:**
- Move the person to a dark or dimly lit area.
- Apply cool, damp cloths over closed eyes.
- Do not rub the eyes.
- Pain relievers (with parent/guardian approval) can help with discomfort.
- Snow blindness usually heals on its own within 24–48 hours, but seek medical attention if symptoms persist or vision does not return to normal.
...
{{< drg/did-you-know >}}
Inuit people have used "snow goggles" carved from bone or antler for thousands of years. The narrow slits block most UV light while still allowing enough vision to travel safely across ice and snow.
{{< /drg/did-you-know >}}
...
| Stage | Skin Appearance | Sensation |
|-------|----------------|-----------|
| **Superficial** | White or grayish-yellow, waxy | Numb, hard on the surface but soft underneath |
| **Deep** | White or blotchy, hard all the way through | Completely numb, wooden feeling |
...
{{< drg/safety-first >}}
Never rewarm frostbitten tissue with direct heat — no campfires, heating pads, or car heaters against the skin. The numb tissue cannot feel if it is being burned. Use warm water only.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Chafing is one of the most common complaints on long hikes. A small container of petroleum jelly or anti-chafing balm weighs almost nothing in your pack but can save you hours of misery.
{{< /drg/tip >}}
...
- **Hot spot (pre-blister):** Cover immediately with moleskin, athletic tape, or a blister-prevention patch. Eliminate the friction source — adjust socks, retie boots, add padding.
- **Intact blister:** Do not pop it if you can avoid it. The fluid cushion protects healing skin underneath. Cover with a donut-shaped moleskin pad (hole over the blister, padding around it) to relieve pressure.
- **Popped blister:** Clean the area with antiseptic. Do not remove the loose skin — it acts as a natural bandage. Apply antibiotic ointment and cover with a sterile bandage.
...
- Stop and address hot spots immediately. Five minutes of prevention saves hours of pain.

{{< drg/be-prepared title="Hot Spot on the Trail" >}}
Two miles into a hike, you notice a warm, tender spot on your heel.

- **Stop immediately.** Do not push through it — it will only get worse.
- **Remove your boot and sock.** Inspect the area.
- **Apply moleskin or tape** directly over the hot spot, smoothing out wrinkles.
- **Check your sock** for bunching or moisture. Switch to a dry pair if needed.
...
{{< drg/external-link
    ...
    url="https://my.clevelandclinic.org/health/diseases/15439-frostbite"
    description="A clear, medical overview of frostbite stages, treatment, and when to seek emergency care." >}}

{{< drg/next-page
    text="You have learned about cold injuries, abrasions, and blisters."
    teaser="Next, learn how to handle puncture wounds, poisonous plant rashes, insect bites, and animal bites."
