...
req_number: "3a"
prev: "/merit-badges/first-aid/guide/req2b/"
prev_title: "Req 2b — First-Aid Kits"
next: "/merit-badges/first-aid/guide/req3b/"
next_title: "Req 3b — Cold Injuries & Abrasions"
---
...
**First aid:**
- Apply a cold pack or ice wrapped in cloth for 20 minutes on, 20 minutes off.
- Elevate the injured area if possible.
- Rest the injured area.
- For a large hematoma or one that does not improve, seek medical attention — it may indicate a deeper injury like a fracture.

**Prevention:** Wear protective gear during sports and activities. Be aware of your surroundings to avoid bumps and falls.

{{< drg/tip >}}
Remember **R.I.C.E.** for closed soft-tissue injuries: **R**est, **I**ce, **C**ompression, **E**levation. This simple framework works for bruises, sprains, and strains alike.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Never approach a victim who is still in contact with a live electrical source. Do not try to move a downed power line with a stick, rope, or any object. Call 911 and keep everyone at least 35 feet away. Electricity can arc through the ground.
{{< /drg/safety-first >}}
...
{{< drg/external-link
    ...
    url="https://ameriburn.org/prevention/"
    description="Resources and fact sheets on burn prevention for home, work, and outdoor activities." >}}

{{< drg/next-page
    text="You have learned about closed wounds, thermal burns, chemical burns, electrical burns, and sunburn."
    teaser="Continue with cold-related injuries, abrasions, and blisters — common problems you will encounter on the trail."
