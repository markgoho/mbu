...
{{< drg/safety-first >}}
Do not cut the wound, suck out venom, apply ice, or use a tourniquet for a venomous snake bite.
{{< /drg/safety-first >}}

{{< drg/next-page
    text="You now have a quick guide to wounds and injuries without external bleeding."
    teaser="Next, move on to wounds that do bleed, starting with nosebleeds and mild bleeding."
