...
req_number: "4a"
prev: "/merit-badges/first-aid/guide/req3c/"
prev_title: "Req 3c — Punctures, Plants & Stings"
next: "/merit-badges/first-aid/guide/req4b/"
next_title: "Req 4b — Severe Bleeding & Tourniquets"
---
...
- The nosebleed was caused by a blow to the head
- The person is on blood-thinning medication
- Nosebleeds happen frequently without clear cause

{{< drg/tip >}}
The most common mistake with nosebleeds is letting go too early to check if the bleeding stopped. Set a timer for 10 minutes and commit to holding pressure the entire time without peeking.
{{< /drg/tip >}}

{{< drg/did-you-know >}}
The inside of the nose has some of the most delicate blood vessels in the body. Dry winter air is the number one cause of nosebleeds — which is why they are so common at cold-weather Scout events. A small tube of saline nasal gel in your first-aid kit can prevent them.
{{< /drg/did-you-know >}}
...
1. **Put on gloves** — always protect yourself with BSI (see [Req 1c](/merit-badges/first-aid/guide/req1c/)).
...
{{< drg/safety-first >}}
Watch for signs of infection in the days after an injury: increasing redness, swelling, warmth, red streaks radiating from the wound, pus, fever, or worsening pain. Any of these signs mean the person should see a doctor.
{{< /drg/safety-first >}}
...
- It is deeper than a quarter-inch
- It will not stop bleeding after 10 minutes of direct pressure
- It is on the face, hands, or over a joint
- The edges of the wound gape open and do not hold together
- You can see fat, muscle, or bone

{{< drg/be-prepared title="Pocketknife Slip" >}}
While whittling at camp, a Scout cuts their finger with a pocketknife. The cut is about an inch long and bleeding steadily but not gushing.

- **Put on gloves.**
- **Apply direct pressure** with a gauze pad. Hold firmly for 5–10 minutes.
- **Once bleeding stops,** rinse the cut under clean water to flush out wood shavings.
- **Check the depth.** Can you see tissue below the skin? Do the edges stay together?
...
{{< drg/next-page
    ...
    teaser="Learn how to manage severe, life-threatening bleeding and when to use a tourniquet."
