...
{{< drg/tip >}}
If you're a patrol leader or junior leader helping run a campout, ask the Scoutmaster or adult leader to brief you on any significant health information for participants. You don't need to know everyone's full medical history — but knowing "two Scouts have severe bee sting allergies and carry EpiPens" could save a life.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="Scout Annual Health and Medical Record"
    url="https://www.scouting.org/health-and-safety/safety-moments/annual-health-and-medical-record/"
    description="Scouting America's official page for downloading the current AHMR form and understanding which parts apply to different types of events." >}}

---

Next up: you'll build the first aid kit that will sit in your pack for every hike and backpacking trip you take.

{{< drg/next-page
    text="Health records tell you about the person you're helping"
    teaser="A first aid kit is what you have to help them with — learn what goes in yours and how to use everything in it."
