...
req_number: "2a"
prev: "/merit-badges/first-aid/guide/req1f/"
prev_title: "Req 1f — Shock & Triage"
...
{{< drg/tip >}}
If you are the first aider at a troop event, ask the adult leaders where the AHMR forms are kept **before** the activity starts. In an emergency, you do not want to be searching through bags for paperwork.
{{< /drg/tip >}}
...
Think of the AHMR as a cheat sheet. When you perform a [SAMPLE history](/merit-badges/first-aid/guide/req1e/) on a conscious victim, you are gathering the same kind of information this form already contains. For an unconscious person, the AHMR may be the only source of critical medical information available to you.

{{< drg/be-prepared title="An Unconscious Scout at Camp" >}}
A Scout collapses during a hike and is unresponsive. You do not know their medical history.

- **Check and call:** Assess the scene, check breathing, call for help.
- **Find the AHMR:** Ask a leader for the Scout's medical form.
- **Review it:** You discover the Scout has Type 1 diabetes and takes insulin. This points to a possible hypoglycemic episode.
- **Report:** When EMS arrives, hand them the form — it saves precious time.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    title="Scouting America — Annual Health and Medical Record"
...
{{< drg/next-page
    ...
    teaser="Learn how to assemble your own personal first-aid kit and inspect a unit or home kit."
