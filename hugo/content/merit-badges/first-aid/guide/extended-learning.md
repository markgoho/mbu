...
{{< drg/tip >}}
The Federal Emergency Management Agency (FEMA) offers a free online course called "Community Emergency Response Team" (CERT) training for teens and adults. It covers disaster preparedness, fire safety, light search and rescue, and triage — building directly on the skills you learned in this badge.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Several Scouting high-adventure bases — including Philmont Scout Ranch in New Mexico — offer Wilderness First Aid training as part of their programs. You can earn your WFA certification while on a Scouting adventure.
{{< /drg/did-you-know >}}
...
{{< drg/experience-card
    ...
    details="Free, 2-hour hands-on training in bleeding control. Available at hospitals and fire stations nationwide. Many locations welcome teens. Find a class at stopthebleed.org." >}}

{{< drg/experience-card
    title="American Red Cross Volunteer"
    details="The Red Cross accepts volunteers age 13 and older for disaster response support, blood drives, and community education. Visit redcross.org/volunteer to find local opportunities." >}}

{{< drg/experience-card
    title="CERT Training (Community Emergency Response Team)"
    details="A free 20-hour FEMA training program that teaches disaster preparedness, fire suppression, medical operations, and search and rescue. Many programs accept teens. Find your local CERT at ready.gov/cert." >}}

{{< drg/experience-card
    title="Hospital or EMS Ride-Along"
    details="Many fire departments and EMS agencies offer ride-along programs for young people interested in emergency medicine. Contact your local station's non-emergency number to ask about explorer programs or youth ride-alongs." >}}

{{< drg/experience-card
    title="Lifeguard Certification"
    details="The American Red Cross offers lifeguard certification for ages 15 and up. The course combines swimming skills with CPR, AED, and first aid training — and it is a paid job at pools, waterparks, and beaches." >}}

## F. Organizations

{{< drg/org-card
    name="American Red Cross"
    description="The nation's premier first aid, CPR, and disaster response organization. Offers free and low-cost training, volunteer opportunities, and resources for communities and individuals."
    url="https://www.redcross.org/" >}}

{{< drg/org-card
    name="American Heart Association"
    description="The leading authority on CPR and cardiovascular emergency care. Provides CPR/AED certification courses, Heartsaver programs, and community training resources."
    url="https://www.heart.org/" >}}

{{< drg/org-card
    name="National Safety Council"
    description="America's leading nonprofit safety advocate. Offers first aid training, workplace safety programs, and defensive driving courses. Publishes the annual Injury Facts report."
    url="https://www.nsc.org/" >}}

{{< drg/org-card
    name="Stop the Bleed"
    description="A national awareness campaign and training program to empower bystanders to help in bleeding emergencies. Offers free courses and instructor training."
    url="https://www.stopthebleed.org/" >}}

{{< drg/org-card
    name="National Association of Emergency Medical Technicians (NAEMT)"
    description="The professional organization representing EMTs and paramedics. Offers advanced training courses, advocacy, and career resources."
    url="https://www.naemt.org/" >}}

{{< drg/org-card
    name="Wilderness Medical Society"
    description="The leading medical organization focused on wilderness and environmental medicine. Publishes clinical practice guidelines and offers educational programs."
    url="https://wms.org/" >}}
