...
- **8d1** — Arm slings for forearm, upper arm, or collarbone fractures
- **8d2** — Elastic wrap and cravat bandages for ankle sprain
- **8d3** — Elastic wrap and cravat bandages for wrist sprain or hand injury

---

## Requirement 8d1: Arm Slings

{{< drg/inherited-requirement number="8d1" req_path="8.d.1" topic="Arm slings for forearm or upper arm or collarbone fractures" />}}
...
- Capillary refill (press a fingernail for 2 seconds, release — color should return within 2 seconds)
- Sensation (can they feel you touch each finger?)
- Movement (can they wiggle their fingers?)
...
{{< drg/inherited-requirement number="8d2" req_path="8.d.2" topic="Elastic wrap and cravat bandages for ankle sprain" />}}
...
{{< drg/tip >}}
After wrapping an ankle sprain, recheck toes every 15–30 minutes. Swelling after injury can make a properly applied wrap become too tight. If toes become numb or pale, loosen and rewrap.
{{< /drg/tip >}}

{{< drg/video
    title="Elastic Wrap for Ankle Sprain"
    url="https://youtu.be/KRyaemlcJAM?si=_A2ie3PNfdiH1n-0" >}}

---

## Requirement 8d3: Wrist Sprain and Hand Injury Bandaging

{{< drg/inherited-requirement number="8d3" req_path="8.d.3" topic="Elastic wrap and cravat bandages for wrist sprain or hand injury." />}}
...
{{< drg/video
    title="Wrist Wrap"
    url="https://youtu.be/tdRMJIu2E08" >}}
...
{{< drg/next-page
    text="You can apply slings and wrap injured extremities"
    teaser="Now learn how to splint suspected fractures and dislocations of the finger, arm, and leg."
