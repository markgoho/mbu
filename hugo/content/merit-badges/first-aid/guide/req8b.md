...
- **R**est — stop the activity causing pain; protect from further injury
- **I**ce — apply ice or cold pack (wrapped in cloth) 20 minutes on, 20 minutes off, for the first 24–48 hours
- **C**ompress — a light elastic bandage reduces swelling
- **E**levate — raise the injured area above heart level when possible
...
- **Improvise support:** Use a sleeping pad or foam rolled into a splint; wrap with a bandage to maintain a neutral ankle position.
- **Evacuate:** This injury will require surgery — don't wait until you return from a week-long trip.
- **Use a human crutch** (described in Req 10) to transport them from the backcountry to a trailhead.
{{< /drg/be-prepared >}}

{{< drg/video
    title="Muscle Strains and Tears"
    url="https://www.youtube.com/watch?v=IM7BIO_kdk8" >}}
...
{{< drg/next-page
    text="You know how to manage soft tissue injuries"
    teaser="Now learn the symptoms and complications of sprains, fractures, and dislocations — and when field first aid isn't enough."
