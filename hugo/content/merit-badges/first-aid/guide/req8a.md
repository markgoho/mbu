...
req_number: "8a"
prev: "/merit-badges/first-aid/guide/req7b/"
prev_title: "Req 7b — AEDs"
next: "/merit-badges/first-aid/guide/req8b/"
next_title: "Req 8b — Bandaging & Splinting"
---
...
| Injury | What Is Damaged | Severity | Key Difference |
|--------|----------------|----------|----------------|
| **Strain** | Muscle or tendon (stretched or partially torn) | Mild to moderate | Affects the muscle-tendon unit |
| **Muscle tear** | Muscle fibers (significantly or completely torn) | Moderate to severe | More severe than a strain — actual tearing of muscle tissue |
| **Tendon rupture** | Tendon (completely torn) | Severe | Loss of function — muscle cannot move the bone |
| **Sprain** | Ligament (stretched or torn) | Mild to severe | Affects the joint — ligaments hold bones together |
| **Dislocation** | Joint (bone forced out of position) | Severe | Bone is visibly out of alignment at the joint |
...
{{< drg/tip >}}
The hallmark of a tendon rupture versus a strain is **loss of function**. A strained muscle hurts but still works (weakly). A ruptured tendon means the muscle is disconnected from the bone — it cannot move the joint at all.
{{< /drg/tip >}}
...
**Severity:**
- **Grade I (mild):** Ligament stretched but not torn. Mild pain and swelling.
- **Grade II (moderate):** Ligament partially torn. Moderate pain, swelling, and bruising. Joint is somewhat unstable.
- **Grade III (severe):** Ligament completely torn. Severe swelling, bruising, and instability. The joint may feel "loose."
...
2. **Do not move the injured limb.** Splint it in the position you find it (you will learn splinting in [Req 8b](/merit-badges/first-aid/guide/req8b/)).
...
{{< drg/safety-first >}}
Never try to straighten a deformed limb, push a bone back into place, or "reset" a dislocation. Immobilize the injury in the position you find it and let medical professionals handle the rest. Moving a fracture or dislocation incorrectly can turn a simple injury into a permanent one.
{{< /drg/safety-first >}}

{{< drg/did-you-know >}}
The shoulder is the most commonly dislocated joint in the body because it has the greatest range of motion of any joint. That incredible flexibility comes at the cost of stability — the shoulder socket is shallow, making it easier for the ball of the upper arm bone to slip out.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="OrthoInfo — Sprains, Strains, and Fractures"
    url="https://orthoinfo.aaos.org/"
    description="The American Academy of Orthopaedic Surgeons offers detailed, reliable information on every type of musculoskeletal injury." >}}

{{< drg/next-page
    text="You now understand the differences between strains, sprains, fractures, and dislocations."
    teaser="Learn the hands-on skills — bandaging techniques and splinting methods for arms, legs, and extremities."
