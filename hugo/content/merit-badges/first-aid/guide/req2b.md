...
{{< drg/inherited-requirement number="2b1" req_path="2.b.1" topic="Assemble a personal first-aid kit for hiking and backpacking. Demonstrate the proper use of each item in your first-aid kit to your counselor." />}}
...
{{< drg/external-link
    title="Personal, Family, and Troop First Aid Kit Checklist (PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/First%20Aid/Personal%20Family%20Troop%20First%20Aid%20Kit%20Checklist.pdf"
    description="BSA's official checklist covering personal, family, and troop kit contents — the authoritative reference for assembling kits that meet counselor expectations." >}}

{{< drg/external-link
    title="First Aid Kit Checklists and Buying Guide"
    url="https://scoutlife.org/video-audio/4937/first-aid-kit-buying-guide/"
    description="Scout Life's practical guide to assembling and customizing first aid kits for different Scouting activities." >}}

---

## Requirement 2b2: Inspect a Shared First Aid Kit

{{< drg/inherited-requirement number="2b2" req_path="2.b.2" topic="With your counselor, inspect a unit, home, vehicle, or camp first-aid kit and discuss your findings." />}}
...
{{< drg/tip >}}
Bring a pencil and paper to your kit inspection. Write down everything that needs to be restocked, replaced, or added. Then actually help restock it — that's the Scout approach.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="Your kit is ready and your health records are filed"
    teaser="Now learn about the full range of outdoor injuries — burns, bites, blisters, and more — and how to treat each one."
