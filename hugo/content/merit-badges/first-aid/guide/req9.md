...
prev_title: "Req 8b — Bandaging & Splinting"
...
{{< drg/safety-first >}}
The single most important rule for suspected head and spine injuries: **do not move the victim** unless their life is in immediate danger (fire, flooding, building collapse). Moving a person with a spinal fracture can sever the spinal cord, turning a survivable injury into permanent paralysis.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
You do not have to lose consciousness to have a concussion. In fact, most concussions happen without any loss of consciousness. If someone takes a hit to the head and seems "off" — confused, slow to answer questions, dizzy — assume a concussion and act accordingly.
{{< /drg/did-you-know >}}
...
If the victim is not breathing and you need to open the airway, use the **jaw-thrust maneuver** instead of the head-tilt, chin-lift — this opens the airway without moving the neck (see [Req 1d](/merit-badges/first-aid/guide/req1d/)).

{{< drg/be-prepared title="Fall from a Climbing Wall" >}}
A Scout falls from a climbing wall and lands on their back. They are conscious but say their neck hurts and their fingers feel tingly.

- **Suspect a spinal injury.** Neck pain and tingling are red flags.
- **Stabilize the head.** Kneel at their head, hold both sides, and keep the neck in a neutral position.
- **Tell them not to move.** Be calm and reassuring.
- **Call 911.** Have someone bring a phone and call for EMS.
- **Do not move them.** Wait for paramedics with spinal immobilization equipment.
- **Monitor breathing and pulse** while maintaining stabilization.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    ...
    description="The CDC's comprehensive concussion resource with fact sheets, training, and return-to-activity guidelines for athletes, coaches, and parents." >}}

{{< drg/next-page
    text="You now understand head and spine injuries, concussions, and how to stabilize a spinal injury."
    teaser="Learn when and how to move a patient — and when moving them could do more harm than good."
