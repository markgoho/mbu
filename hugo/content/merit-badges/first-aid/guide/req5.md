...
{{< drg/inherited-requirement number="5a" req_path="5.a" topic="Choking" />}}
...
1. **Ask:** "Are you choking?" If they cannot answer, act.
2. **Give 5 firm back blows:** Stand to the side, support the chest with one hand, and deliver 5 firm blows between the shoulder blades with the heel of your other hand.
3. **Give 5 abdominal thrusts (Heimlich maneuver):** Stand behind the person, make a fist, place it above the navel and below the breastbone. Grab your fist with the other hand. Give 5 quick, inward-and-upward thrusts.
4. **Alternate 5 back blows and 5 abdominal thrusts** until the object is expelled or the person becomes unconscious.
...
{{< drg/safety-first >}}
Do not perform abdominal thrusts on a conscious choking victim who can still cough effectively — forceful coughing is more effective than Heimlich and you risk injuring the victim.
{{< /drg/safety-first >}}

{{< drg/video
    title="Back Blows and Abdominal Thrusts for Choking"
    url="https://youtu.be/8R3RWC-xx1I" >}}

{{< drg/video
    title="First Aid for an Unresponsive Choking Adult"
    url="https://youtu.be/9pTnepZd5as" >}}

---

## Requirement 5b: Asthmatic Attack

{{< drg/inherited-requirement number="5b" req_path="5.b" topic="Asthmatic attack" />}}
...
**First aid:**
1. Help the person use their prescribed **rescue inhaler (bronchodilator)** — usually albuterol (blue inhaler). This is a fast-acting medication that relaxes the airway muscles.
2. Have them sit upright and lean forward slightly — this position opens the airways.
3. Stay calm and reassuring — anxiety worsens bronchospasm.
4. Remove the trigger if identifiable (move away from smoke, cold air, the allergen).
5. If symptoms don't improve within 15 minutes of using the inhaler, or if this is a severe attack from the start, call 911.
...
{{< drg/video
    ...
    url="https://youtu.be/batzSytA1Y0" >}}

{{< drg/video
    title="Using Albuterol for an Asthma Attack"
    url="https://youtu.be/VyqzylUADp0" >}}

{{< drg/video
    title="Pursed Lip Breathing for Asthma"
    url="https://youtu.be/wcKgqYXF2gA" >}}

---

## Requirement 5c: Anaphylaxis

{{< drg/inherited-requirement number="5c" req_path="5.c" topic="Anaphylaxis from an insect bite or sting or from food or product allergy" />}}
...
1. **Administer epinephrine auto-injector (EpiPen)** into the outer thigh (can be given through clothing). This is the FIRST action, not a last resort.
2. **Call 911** immediately.
3. Lay the person flat with legs elevated (unless breathing is easier sitting up).
4. If a second dose is available and symptoms return or persist after 5–15 minutes, administer it.
5. Do NOT give epinephrine and then consider the emergency over — anaphylaxis can have a **biphasic reaction** where symptoms return hours later. Hospital monitoring is essential.
...
{{< drg/did-you-know >}}
A person can have severe anaphylaxis to a food they've eaten dozens of times before with no reaction — the immune system can sensitize over repeated exposures and then overreact suddenly. Past tolerance does not guarantee future safety.
{{< /drg/did-you-know >}}

{{< drg/video
    title="Food Allergy with Anaphylaxis"
    url="https://youtu.be/veHAMX6vukY?si=jtG07MJUuoWZVQfU" >}}

{{< drg/video
    title="How to Inject an EpiPen"
    url="https://youtu.be/K7QyCMNDHAs?si=T0eBEn7GpbW9BjQa" >}}

---

## Requirement 5d: Inhalation Injuries

{{< drg/inherited-requirement number="5d" req_path="5.d" topic="Inhalation injuries" />}}
...
{{< drg/safety-first >}}
Never use a camp stove, charcoal grill, or gas generator inside a tent, cabin, or vehicle — even with a window cracked open. Carbon monoxide builds up fast in enclosed spaces. Every year, Scouts and outdoor recreationists die from CO poisoning that was entirely preventable.
{{< /drg/safety-first >}}

{{< drg/video
    title="Airway Burns"
    url="https://youtu.be/YJVGTJPQMEw?si=_HQifwBCjA3Lzgh8" >}}

{{< drg/video
    title="Carbon Monoxide Poisoning"
    url="https://youtu.be/PqiAtelp-Qc?si=Q2Klj56m0pB95pEm" >}}

---

## Requirement 5e: Altitude Sickness

{{< drg/inherited-requirement number="5e" req_path="5.e" topic="Altitude sickness" />}}
...
{{< drg/video
    title="High Altitude Illness Treatment and Prevention"
    url="https://youtu.be/8D9dwH16GLw?si=HDHXNT8t1mw5QijT" >}}
...
{{< drg/next-page
    text="Now that you understand breathing emergencies"
    teaser="Learn to recognize and respond when someone loses consciousness — from a simple faint to a seizure to a drowning."
