...
prev_title: "Req 4 — Bleeding Wounds"
next: "/merit-badges/first-aid/guide/req6/"
next_title: "Req 6 — Loss of Consciousness"
---
...
{{< drg/safety-first >}}
For choking infants (under 1 year), the technique is different: alternate 5 back blows and 5 chest thrusts. Never perform abdominal thrusts on an infant — their organs are too fragile. If you babysit or care for young children, take an infant CPR class.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
If a Scout in your patrol has asthma, know where they keep their inhaler and make sure they bring it to every activity. During cold-weather events, remind them that cold air is a common asthma trigger.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Anaphylaxis can return hours after the initial reaction (called a biphasic reaction). Even if epinephrine relieves symptoms, the person must go to the hospital for observation. Epinephrine buys time — it is not a cure.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Carbon monoxide is called the "silent killer" because it is colorless and odorless. It can build up from gas heaters, generators, or stoves used in enclosed spaces. Early symptoms — headache, dizziness, nausea — are easily mistaken for the flu. Never use fuel-burning devices inside a tent or closed shelter.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Headache at Philmont" >}}
On day two of a Philmont trek, a crew member complains of a pounding headache, nausea, and feeling "off." You are at 9,500 feet.

- **Recognize it:** These are classic altitude sickness symptoms.
- **Stop and rest.** Do not push to the next camp if someone is symptomatic.
- **Hydrate and eat.** Offer water and a light snack.
- **Monitor closely.** If symptoms improve with rest, you may continue slowly the next day.
...
{{< drg/external-link
    title="American College of Emergency Physicians — Anaphylaxis"
    url="https://www.emergencyphysicians.org/article/know-when-to-go/anaphylaxis---severe-allergic-reaction"
    description="Emergency physician guidance on recognizing and responding to severe allergic reactions." >}}

{{< drg/next-page
    text="You have learned about five different breathing emergencies and how to respond to each one."
    teaser="Learn about conditions that cause loss of consciousness — from fainting to seizures to drowning."
