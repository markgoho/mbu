...
req_number: "1e"
prev: "/merit-badges/first-aid/guide/req1d/"
prev_title: "Req 1d — Airway & Breathing"
next: "/merit-badges/first-aid/guide/req1f/"
next_title: "Req 1f — Shock & Triage"
---
...
1. **Primary assessment** — Find and address life-threatening conditions (you already learned this in [Req 1a](/merit-badges/first-aid/guide/req1a/) and [Req 1d](/merit-badges/first-aid/guide/req1d/)).
...
- **D — Deformities:** Anything that looks out of place — a bent limb, a sunken area of the skull, asymmetry
- **O — Open wounds:** Cuts, scrapes, punctures, or any break in the skin
- **T — Tenderness:** Does the person flinch or say "ow" when you touch an area?
- **S — Swelling:** Puffiness, lumps, or areas that look larger than normal
...
{{< drg/did-you-know >}}
Medical alert bracelets and necklaces carry critical information about a person's health conditions, allergies, and medications. Always check the victim's wrists and neck. Some people also carry medical ID cards in their wallets or use smartphone medical ID features.
{{< /drg/did-you-know >}}
...
- **Who** the victim is (name, age if known)
- **What** happened (mechanism of injury)
- **What** you found (injuries, vital signs, SAMPLE history)
- **What** you did (first aid provided)
- **When** key events occurred (time of injury, time you arrived, any changes in condition)
...
{{< drg/external-link
    ...
    url="https://wms.org/"
    description="The Wilderness Medical Society provides evidence-based guidelines for patient assessment and wilderness medicine." >}}

{{< drg/next-page
    text="You now know how to perform a thorough examination and gather a patient history."
    teaser="Learn why shock is an emergency and what triage means in a mass casualty situation."
