...
{{< drg/requirement number="13d" >}}
Abdominal pain
{{< /drg/requirement >}}

{{< drg/requirement number="13e" >}}
Stroke.
{{< /drg/requirement >}}
...
{{< drg/safety-first >}}
Never try to remove an object that is embedded in the eyeball. Do not use tweezers, fingers, or anything rigid near the eye. Cover the eye loosely to prevent movement and get to an eye doctor or emergency room immediately.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Milk works as a temporary storage solution for a knocked-out tooth because its pH and osmotic pressure are similar to the cells on the tooth root. If you are at camp and someone loses a tooth, grab a milk carton from the dining hall.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The "danger zone" for food temperature is between 40°F and 140°F (4°C and 60°C). Bacteria can double in number every 20 minutes in this range. On a hot day at camp, perishable food left out for more than 1 hour should be discarded.
{{< /drg/did-you-know >}}
...
- Pain after an injury or blow to the abdomen (possible internal bleeding)
- Signs of shock
...
| **T** | Time | **Time to call 911!** Note the time symptoms started. |
...
{{< drg/external-link
    ...
    description="Learn to recognize stroke symptoms and find local stroke centers with the ASA's online resources." >}}

{{< drg/next-page
    text="You have covered the remaining miscellaneous first aid conditions."
    teaser="Learn how to teach a first aid skill to others using the EDGE method."
