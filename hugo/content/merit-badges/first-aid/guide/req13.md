...
{{< drg/inherited-requirement number="13a" req_path="13.a" topic="Object in the eye" />}}
...
{{< drg/video
    ...
    url="https://youtu.be/uJFZPFsHcCE?si=YgmlNzHWSWm3iWWH" >}}

{{< drg/video
    title="Penetrating and Chemical Eye Injuries"
    url="https://youtu.be/46UgImUrAG0" >}}

---

## Requirement 13b: Dental Injuries

{{< drg/inherited-requirement number="13b" req_path="13.b" topic="Broken, chipped, loosened, or knocked out tooth" />}}
...
{{< drg/did-you-know >}}
Milk is a surprisingly effective emergency tooth storage medium — it has the right pH and osmolarity to keep dental cells alive for up to an hour. Most people have it in their camp cooler.
{{< /drg/did-you-know >}}

{{< drg/video
    title="Dental Emergencies"
    url="https://youtu.be/eJnKf1jM6xY" >}}

{{< drg/external-link
    title="Dental Injuries"
    url="https://my.clevelandclinic.org/health/diseases/16916-dental-injuries"
    description="Cleveland Clinic's overview of dental trauma types, emergency treatment, and when to seek care." >}}

---

## Requirement 13c: Vomiting and Diarrhea from Food Poisoning

{{< drg/inherited-requirement number="13c" req_path="13.c" topic="Vomiting and diarrhea associated with food poisoning" />}}
...
{{< drg/video
    title="First Aid for Vomiting and Diarrhea"
    url="https://youtu.be/K5UxbbnSjxc?si=pf6WbrBictHhwad8" >}}

---

## Requirement 13d: Abdominal Pain

{{< drg/inherited-requirement number="13d" req_path="13.d" topic="Abdominal pain" />}}
...
{{< drg/video
    title="Causes of Abdominal Pain"
    url="https://youtu.be/2RxEHcGpwnA" >}}

{{< drg/video
    title="Appendicitis"
    url="https://youtu.be/pFCfQwYWxcM?si=r3inhA-IMeSBDkCz" >}}

{{< drg/video
    title="What Does Appendix Pain Feel Like?"
    url="https://youtu.be/8CUEPNcGtWs?si=c7X8WPlAAwQvtPWC" >}}

---

## Requirement 13e: Stroke

{{< drg/inherited-requirement number="13e" req_path="13.e" topic="Stroke" />}}
...
{{< drg/safety-first >}}
There is a lifesaving treatment for ischemic stroke (clot-dissolving medication, tPA) that must be given within 3–4.5 hours of symptom onset. But it requires imaging to rule out hemorrhage first. Every minute you delay calling 911 reduces the treatment window and worsens outcomes.
{{< /drg/safety-first >}}

{{< drg/video
    title="Types of Strokes"
    url="https://youtu.be/EsshJLm5CN8" >}}

{{< drg/video
    title="First Aid for Stroke"
    url="https://youtu.be/v0AqhXminV8" >}}

{{< drg/video
    title="FAST Symptoms and Signs of a Stroke"
    url="https://youtu.be/mkpbbWZvYmw" >}}

{{< drg/video
    title="What Causes Strokes?"
    url="https://youtu.be/-NJm4TJ2it0?si=Q1rK65yZDzBZ9V47" >}}
...
{{< drg/next-page
    text="You've learned to recognize and respond to a remarkable range of emergencies"
    teaser="Now learn how to teach a first aid skill to someone else — using the Scout EDGE method."
