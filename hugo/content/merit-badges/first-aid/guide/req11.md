...
{{< drg/inherited-requirement number="11a" req_path="11.a" topic="Dehydration and over-hydration" />}}
...
**Signs and symptoms:**
- Thirst (a late sign — you're already mildly dehydrated by the time you feel thirsty)
- Decreased urine output; dark, concentrated urine
- Headache
- Fatigue and weakness
- Dizziness when standing
- Dry mouth and skin
- Severe: confusion, rapid heart rate, sunken eyes, no urination

**First aid:**
- Mild dehydration: oral fluid replacement — water, sports drinks, or broth.
- Moderate to severe: oral fluids if conscious; IV fluids in a hospital setting.
- Stop exertion in the heat; move to cool environment.
...
- For mild cases: consume salty food or an electrolyte drink.
- Severe cases require emergency medical treatment — do not give more water.
...
{{< drg/video
    ...
    url="https://youtu.be/KahsIEbFROI?si=6m37jPgHqsLiRl_2" >}}

{{< drg/video
    title="Overhydration"
    url="https://youtu.be/sD6j5sNo5Zk" >}}

---

## Requirement 11b: Heat Cramps and Muscle Pain After Exertion

{{< drg/inherited-requirement number="11b" req_path="11.b" topic="Heat cramps and muscle pain after exertion" />}}
...
**First aid:**
- Stop activity; move to a cool environment.
- Stretch and gently massage the cramped muscle.
- Drink fluid containing sodium (sports drink, lightly salted water, broth).
- Do not return to strenuous activity until cramps resolve.
...
{{< drg/video
    title="Heat Cramps, Heat Exhaustion, and Heat Stroke"
    url="https://youtu.be/KOQJB3jlln4?si=F-O0xr3ak9Hk-rbg" >}}

{{< drg/video
    title="Muscle Damage from Over-exercising"
    url="https://youtu.be/6nZOTJ_8guI?si=UgozPCQZg125bGoC" >}}

---

## Requirement 11c: Heat Exhaustion

{{< drg/inherited-requirement number="11c" req_path="11.c" topic="Heat exhaustion" />}}
...
**Signs and symptoms:**
- Heavy sweating
- Pale, cool, clammy skin (sweating mechanism still working)
- Rapid, weak pulse
- Weakness, fatigue
- Nausea or vomiting
- Headache
- Dizziness, possible fainting
- Normal or slightly elevated core temperature (up to 104°F)
- Normal mental status (may be mildly confused)
...
{{< drg/video
    ...
    url="https://youtu.be/8gn3DEYOPuE" >}}

---

## Requirement 11d: Heat Stroke

{{< drg/inherited-requirement number="11d" req_path="11.d" topic="Heat stroke" />}}
...
There are two forms:
- **Classic heat stroke:** Occurs in elderly or medically compromised individuals during environmental heat waves. Skin is typically hot and dry (sweating mechanism may have failed).
- **Exertional heat stroke:** Occurs in young, physically active people exercising intensely in the heat. Skin may still be sweating.

**Signs and symptoms:**
- **Hot skin** (may be dry OR sweating)
- Core temperature above 104°F
- **Altered mental status** — confusion, irrational behavior, combativeness, or loss of consciousness (this is the key difference from heat exhaustion)
- Rapid, strong pulse
- Possible seizures
...
{{< drg/safety-first >}}
Heat stroke has a mortality rate exceeding 50% when cooling is delayed. Do not wait to see if the patient "gets better." Begin aggressive cooling and call 911 simultaneously. Every degree of temperature reduction before EMS arrives improves survival.
{{< /drg/safety-first >}}

{{< drg/video
    title="Diagnosis and Treatment of Heat Stroke"
    url="https://youtu.be/PpHM4DfPZQU?si=mb_BftAlZP8amve9" >}}

---

## Requirement 11e: Chest Pains Associated with Cold Exposure

{{< drg/inherited-requirement number="11e" req_path="11.e" topic="Chest pains associated with cold exposure" />}}
...
**First aid:**
- Stop the activity immediately; move to warmth.
- If symptoms suggest heart attack: call 911; have the person rest in a position of comfort; consider aspirin (see Req 7b).
- Begin CPR if they lose consciousness and stop breathing.
...
{{< drg/video
    title="Heart Attacks from Shoveling Snow"
    url="https://youtu.be/xP6Nya7nH_g?si=Lk2KfMloGzl6ZgPk" >}}

---

## Requirement 11f: Hypothermia

{{< drg/inherited-requirement number="11f" req_path="11.f" topic="Hypothermia" />}}
...
| Stage | Core Temp | Key Signs |
|-------|-----------|-----------|
| Mild | 90–95°F | Shivering, slurred speech, confusion, impaired coordination |
| Moderate | 82–90°F | Shivering stops, increasing confusion, muscle rigidity |
| Severe | Below 82°F | Unconsciousness, cardiac arrhythmias, appears dead |
...
- **Carry rain gear.** An emergency poncho in your pack weighs almost nothing.
- **Know the "umbles."** If any group member is shivering hard, slurring words, or stumbling, stop and address it immediately — don't push on to camp.
- **Eat and drink.** Your body generates heat from food. Stay fueled and hydrated in cold weather.
- **Turn back when in doubt.** Summit fever kills Scouts. A miserable retreat beats a fatal bivouac.
{{< /drg/be-prepared >}}

{{< drg/video
    title="Hypothermia"
    url="https://youtu.be/my6JB41apTw" >}}

{{< drg/external-link
    title="C.O.L.D. Guidelines for Staying Warm"
    url="https://www.scouting.org/health-and-safety/safety-moments/winter-activity/"
    description="BSA's safety framework for winter activities: Cover, Overexertion, Layers, and Dry." >}}

{{< drg/external-link
    title="Frostbite and Hypothermia"
    url="https://health.mo.gov/living/healthcondiseases/hypothermia/index.php"
    description="A practical reference covering both hypothermia and frostbite — common cold-weather companions." >}}

{{< drg/video
    title="Recognize the 'Umbles' and Avoid Hypothermia"
    url="https://youtu.be/aDAqWLpHXXU" >}}
...
{{< drg/next-page
    text="You know how to respond when the environment itself is the threat"
    teaser="Now explore a different kind of emergency — stress, anxiety, and the mental health situations a Scout may face."
