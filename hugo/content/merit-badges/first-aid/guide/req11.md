---
title: "Req 11 — Heat & Cold Conditions"
layout: guide
group_title: "Environmental Conditions"
req_number: "11"
prev: "/merit-badges/first-aid/guide/req10/"
prev_title: "Req 10 — Moving a Patient"
next: "/merit-badges/first-aid/guide/req12/"
next_title: "Req 12 — Mental Health & Stress"
---
...
{{< drg/requirement number="11d" >}}
Heat stroke
{{< /drg/requirement >}}

{{< drg/requirement number="11e" >}}
Chest pains associated with cold exposure
{{< /drg/requirement >}}

{{< drg/requirement number="11f" >}}
Hypothermia.
{{< /drg/requirement >}}
...
{{< drg/did-you-know >}}
Over-hydration has caused fatalities at endurance events and even military training exercises. The guideline is simple: drink to thirst, not beyond it. Your body knows how much it needs.
{{< /drg/did-you-know >}}
...
**First aid:** Stop all physical activity. Move to a warm environment. Loosen restrictive clothing. If the person has prescribed nitroglycerin, help them take it. **Call 911 if the pain does not subside within a few minutes** — treat as a possible heart attack (see [Req 7a](/merit-badges/first-aid/guide/req7a/)).
...
|-------|-------------|-------|
| **Mild** | 95–90°F (35–32°C) | Shivering, cold pale skin, fumbling hands, confusion, poor judgment |
| **Moderate** | 90–82°F (32–28°C) | Violent shivering that may stop, drowsiness, slurred speech, loss of coordination |
| **Severe** | Below 82°F (28°C) | Shivering stops, very slow breathing, weak pulse, loss of consciousness, may appear dead |
...
{{< drg/tip >}}
The phrase "you're not dead until you're warm and dead" is a real principle in emergency medicine. Cold dramatically slows the body's metabolism, and people have survived extended hypothermia — especially in cold water. Always attempt resuscitation on a hypothermic person, even if they show no signs of life.
{{< /drg/tip >}}

{{< drg/be-prepared title="Cold Rain on a Campout" >}}
During a spring campout, it starts raining and the temperature drops to 45°F. A Scout is shivering uncontrollably, fumbling with gear, and seems confused.

- **Recognize mild hypothermia.** Shivering + confusion = act now.
- **Get them into a tent** or shelter immediately.
- **Remove wet clothing** and replace with dry layers from your pack.
- **Wrap them in a sleeping bag** with warm water bottles at their neck and armpits.
- **Give warm drinks** — hot cocoa or warm water.
...
{{< drg/external-link
    ...
    description="The CDC's guide to recognizing and treating heat-related illness, with prevention strategies for outdoor activities." >}}

{{< drg/next-page
    text="You now understand how heat and cold affect the body and how to respond to environmental emergencies."
    teaser="Learn about an equally important topic — mental health, stress reactions, and recognizing when someone may be a danger to themselves or others."
