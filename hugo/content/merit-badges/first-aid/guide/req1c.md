...
req_number: "1c"
prev: "/merit-badges/first-aid/guide/req1b/"
prev_title: "Req 1b — Getting Help"
next: "/merit-badges/first-aid/guide/req1d/"
next_title: "Req 1d — Airway & Breathing"
---
...
{{< drg/checklist title="Personal Protective Equipment (PPE)" subtitle="Items every first aider should have ready" >}}
...
{{< drg/safety-first >}}
Always put on gloves **before** you touch a victim or any blood. If you do not have gloves, use a plastic bag, extra clothing, or any clean barrier between your hands and body fluids. Never provide first aid with open cuts or sores on your own hands without a barrier.
{{< /drg/safety-first >}}
...
2. Pull a glove over each hand, making sure it fits snugly with no tears.
3. Check for rips or holes before you begin.

### Taking Gloves Off (The Pinch-and-Peel Method)

1. **Pinch** the outside of one glove near the wrist. Peel it off, turning it inside out as you go.
2. **Hold** the removed glove in your still-gloved hand.
3. **Slide** a finger under the wrist of the remaining glove. Peel it off over the first glove, creating a neat inside-out bundle.
4. **Dispose** of the gloves in a sealed plastic bag or biohazard container.
5. **Wash** your hands thoroughly with soap and water.

{{< drg/tip >}}
Practice the glove removal technique before an emergency. The goal is to never touch the contaminated outside surface with your bare skin. It takes a few tries to get the motion smooth.
{{< /drg/tip >}}

<!-- IMAGE: glove-removal.png | Step-by-step illustration showing the correct pinch-and-peel technique for removing disposable gloves safely -->
...
1. **Contain it.** Place all used supplies — gloves, gauze, bandages, wrappers — into a sealed plastic bag. A zip-lock bag from your first-aid kit works well.
2. **Label it.** If a biohazard bag is available, use it. Otherwise, mark the bag clearly so others know not to open it.
3. **Transport it.** Bring the sealed bag to a proper disposal location. At home, double-bag it and place it in the trash. In a medical facility, use the designated biohazard bins.
4. **Clean up.** Wipe down any surfaces that contacted body fluids with a disinfectant or a bleach solution (one part bleach to nine parts water).

{{< drg/did-you-know >}}
The red biohazard symbol you see on sharps containers and medical waste bags was created in 1966 by a Dow Chemical engineer. It was specifically designed to be memorable and unlike any other symbol so people would never confuse it with something harmless.
{{< /drg/did-you-know >}}
...
<!-- IMAGE: handwashing-after-first-aid.png | A Scout thoroughly washing their hands with soap and water at a campsite wash station after providing first aid -->
...
{{< drg/next-page
    ...
    teaser="Learn how to evaluate and manage a patient's airway and breathing."
