...
- **Purpose:** Food, survival, and practical outdoor skill
- **Tools:** Hand lines, simple poles, handmade hooks, nets, and traps
- **Mindset:** Know the water, understand fish behavior, and waste nothing
...
- **Purpose:** Recreation, food, family tradition, and conservation
- **Tools:** Spinning outfits, baitcasting gear, fly rods, sonar, and specialized tackle
- **Mindset:** Enjoy the sport while protecting the resource
...
{{< drg/tip >}}
Look for places where fish naturally gather: near weeds, fallen logs, rocks, shaded banks, or where moving water meets calm water. Fish like cover for the same reason you do — it gives protection and makes finding food easier.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
On a boat, wear a properly fitted life jacket when conditions require it or whenever the operator says to. Keep decks uncluttered, stay aware of hooks during casts, and never stand up suddenly in a small craft without checking your balance.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/fishing-types-comparison.avif" alt="Side-by-side comparison of freshwater shore fishing and saltwater pier fishing with clearly different settings and tackle" >}}
...
{{< drg/did-you-know >}}
Fish can detect tiny vibrations and pressure changes through a sensory system called the **lateral line**. That is one reason a noisy splash, a badly presented bait, or heavy footsteps on a dock can sometimes spook them before you ever get a bite.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You now have a big-picture view of fishing and the different ways people enjoy it."
    teaser="Start with the hazards you may face while fishing and how to prevent them."
    url="/merit-badges/fishing/guide/req1a/" >}}
