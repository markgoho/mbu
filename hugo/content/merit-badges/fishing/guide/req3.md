...
req_number: "3"
prev: "/merit-badges/fishing/guide/req2/"
prev_title: "Req 2 — Fishing Outfits & Equipment Care"
next: "/merit-badges/fishing/guide/req4/"
next_title: "Req 4 — Essential Fishing Knots"
---
...
{{< drg/tip >}}
When you practice with a baitcaster, start with a heavier practice plug and short casts. Accuracy and control matter more than distance in the beginning.
{{< /drg/tip >}}

{{< drg/image src="images/spinning-vs-baitcaster-casting-hand-position.avif" alt="Side-by-side comparison of proper spinning and baitcasting casting hand positions and reel controls" >}}
...
In [Req 2](/merit-badges/fishing/guide/req2/), you learned about drag and outfit differences. Here, you show that you can use those ideas under control.
...
{{< drg/checklist title="Common Beginner Errors" subtitle="What to avoid during your demonstration" >}}
...
{{< drg/be-prepared title="Getting Ready for Your Demonstration" >}}
You want to feel confident instead of rushed.
- **Step one:** Pick the two equipment types you will demonstrate.
- **Step two:** Practice with no hook or with a casting plug in an open area.
- **Step three:** Focus on smooth, repeatable motions.
- **Step four:** Practice talking through what you are doing while you do it.
- **Step five:** Double-check safety space before every cast.
{{< /drg/be-prepared >}}
...
{{< drg/safety-first >}}
Never practice with a live hook in a crowded area. Use a practice plug, a hookless lure, or remove the hook points when practicing basic casting on land.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="Take Me Fishing — Learn How to Cast"
    url="https://www.takemefishing.org/how-to-fish/fishing-techniques/how-to-cast-a-fishing-rod/"
    description="Simple casting basics for beginners using common fishing outfits." >}}

The next skill is one every angler depends on: tying knots that hold when the fish is finally on.

{{< drg/next-page
    text="You are ready to demonstrate safe, controlled use of fishing equipment."
    teaser="Next, learn the knots that connect your line, lures, and reel to the fish."
