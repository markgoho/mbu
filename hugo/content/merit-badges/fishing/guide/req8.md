...
In [Req 7](/merit-badges/fishing/guide/req7/), you learned what regulations do. Sportsmanship means obeying them even when it would be easy not to.
...
This requirement overlaps directly with [Req 6a](/merit-badges/fishing/guide/req6a/). That is not accidental. Ethical fishing depends on the same ideas.
...
{{< drg/checklist title="What Good Angler Sportsmanship Looks Like" subtitle="Habits that earn trust and respect" >}}
...
{{< drg/be-prepared title="Someone Is Fishing Your Favorite Spot" >}}
You arrive at a bank you love, but another angler is already there.
- **Step one:** Do not crowd in beside them.
- **Step two:** Say hello and assess whether there is truly enough space.
- **Step three:** If not, move and find another spot.
- **Step four:** Keep a positive attitude instead of acting annoyed.
- **Step five:** Remember that courtesy is part of the sport.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
One easy test for sportsmanship is this: if a younger Scout copied exactly what you were doing, would you be proud of that example? If the answer is no, change the behavior.
{{< /drg/tip >}}

{{< drg/did-you-know >}}
Public access to fishing areas is sometimes lost because of repeated littering, property damage, or rude behavior — not because the fish disappeared. Angler behavior can directly affect where people are allowed to fish in the future.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Keep America Beautiful"
    url="https://kab.org/"
    description="Resources and campaigns focused on preventing litter and caring for shared outdoor spaces." >}}
...
{{< drg/next-page
    text="You now understand how ethics and sportsmanship shape the behavior of a real angler."
    teaser="Next, focus on preparing to catch and identify a fish with confidence."
