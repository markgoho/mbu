...
This practice prevents eye injuries, puncture wounds, and tangled chaos. It also shows courtesy, which connects directly to [Req 8](/merit-badges/fishing/guide/req8/).
...
{{< drg/checklist title="Five Safety Habits to Always Follow" subtitle="Simple rules that prevent many fishing accidents" >}}
...
{{< drg/did-you-know >}}
A discarded monofilament fishing line can take hundreds of years to break down. Along the way, it can injure birds, turtles, and fish. Safe fishing includes what you do with gear after the cast is over.
{{< /drg/did-you-know >}}
...
In [Req 1a](/merit-badges/fishing/guide/req1a/), you looked at hazards. In [Req 1b](/merit-badges/fishing/guide/req1b/), you learned treatment. This page turns that knowledge into habits that help prevent emergencies in the first place.

{{< drg/safety-first >}}
If you are ever unsure whether a situation is safe, stop and reassess before making the next cast. Fish are never worth rushing into deep water, lightning, unstable footing, or unsafe boat conditions.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="U.S. Coast Guard Boating Safety"
    url="https://www.uscgboating.org/"
    description="Safety guidance that is especially useful for anglers fishing from boats, docks, and launch ramps." >}}

You now have a solid safety foundation. Next comes the gear itself — rods, reels, and the fishing outfits that match different situations.

{{< drg/next-page
    text="You have built the safety habits every angler should carry on every trip."
    teaser="Now learn how different fishing outfits work, when to use them, and how to care for them."
