...
{{< drg/tip >}}
If you are just starting out, learn spinning gear first. Once you can cast accurately, manage line, and understand drag, moving to baitcasting becomes much easier.
{{< /drg/tip >}}

### Parts of a Rod

{{< drg/video
    title="3 Types of Fishing Reels and How to Use Them for Beginners - Spinning vs. Spincast vs. Baitcasting — Fishing with Nat"
    url="https://www.youtube.com/watch?v=C7CWIywYmxk" >}}
...
{{< drg/image src="images/spinning-vs-baitcasting-outfit-parts.avif" alt="Side-by-side labeled diagram of spinning and baitcasting outfits with rod and reel parts identified" >}}
...
{{< drg/checklist title="Basic Gear Care" subtitle="What smart anglers do after a trip" >}}
...
{{< drg/did-you-know >}}
A tiny crack in one rod guide can act like sandpaper on fishing line. You may not notice it until a big fish breaks you off on the hook-set.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    title="Take Me Fishing — Rods and Reels Basics"
    url="https://www.takemefishing.org/how-to-fish/fishing-gear-and-tackle/fishing-rods-reels/"
    description="A beginner-friendly overview of common rod and reel types and how they are used." >}}

Now that you understand the parts and purposes of common outfits, it is time to put equipment into action and think about how to use it correctly.

{{< drg/next-page
    text="You can now compare common fishing outfits and identify the main parts of rods and reels."
    teaser="Next, focus on the proper use of different kinds of fishing equipment."
