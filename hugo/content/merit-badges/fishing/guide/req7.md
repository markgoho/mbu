...
req_number: "7"
prev: "/merit-badges/fishing/guide/req6b/"
prev_title: "Catch and Release"
next: "/merit-badges/fishing/guide/req8/"
next_title: "Sportsmanship for Anglers"
---
...
{{< drg/checklist title="How to Review Your Local Rules" subtitle="What to bring to your counselor discussion" >}}
...
{{< drg/tip >}}
Always check the newest official regulations before a trip. Rules can change from year to year, and some waters have special exceptions that are easy to miss.
{{< /drg/tip >}}

In [Req 6b](/merit-badges/fishing/guide/req6b/), you learned why catch and release matters. Regulations and ethical release practices work together. One is the legal minimum. The other is the mindset of a responsible angler.

{{< drg/did-you-know >}}
Many fisheries agencies use creel surveys, population sampling, and long-term biology data to decide on regulation changes. That means a daily bag limit may reflect years of research, not a guess.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Take Me Fishing — State Fishing License and Regulation Finder"
    url="https://www.takemefishing.org/state-fishing-license/"
    description="A quick way to find official state licensing and regulation resources before you review your local rules." >}}

The next requirement moves from legal rules to personal behavior — what good sportsmanship looks like when you are actually on the water with other people.

{{< drg/next-page
    text="You now understand how fishing regulations protect fish populations and fair use of the resource."
    teaser="Next, connect ethics, courtesy, and outdoor conduct to what it means to be a true angler."
