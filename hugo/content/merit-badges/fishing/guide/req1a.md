---
title: "Fishing Hazards"
layout: guide
group_title: "1. Safety on the Water"
req_number: "1a"
prev: "/merit-badges/fishing/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/fishing/guide/req1b/"
next_title: "Treating Fishing Injuries"
---
...
- **Anticipate** means noticing what could go wrong before it does.
- **Prevent** means taking steps to stop the problem from happening.
- **Mitigate** means reducing the seriousness if the problem does happen.
- **Respond** means acting correctly once there is an actual emergency.
...
{{< drg/safety-first >}}
If someone falls into moving water or deep water, do not jump in automatically. Reach with a pole, throw a flotation device, or call for help if needed. A second victim does not solve the problem.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/hazard-scan-fishing-scene.avif" alt="Shoreline fishing scene with major hazards called out, including loose hook, storm clouds, slippery bank, hot sun, and brushy shoreline" >}}

### A Pre-Trip Hazard Check

{{< drg/checklist title="Before You Fish" subtitle="A fast hazard scan before the first cast" >}}
...
- **Step three:** Head to a building or vehicle, not a picnic shelter or lone tree.
- **Step four:** Wait until the storm has clearly passed before returning.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    title="NOAA Lightning Safety"
    url="https://www.weather.gov/safety/lightning"
    description="Clear guidance on recognizing lightning danger and getting to safety fast." >}}
...
{{< drg/next-page
    text="You can now think through fishing hazards before they turn into emergencies."
    teaser="Learn how to prevent and treat the common injuries and health problems that happen on fishing trips."
