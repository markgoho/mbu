...
- **Tools:** T-square, triangle, compass, protractor, ruling pen, mechanical pencil
- **Mindset:** Precision was life-and-death — a misplaced dimension on a bridge truss could cause collapse
...
- **Tools:** CAD software, 3D printers, CNC machines, laser cutters, tablets with styluses
- **Mindset:** Digital tools accelerate the process, but spatial thinking and drafting fundamentals still drive every great design
...
{{< drg/image src="images/scout-drafting-table.avif" alt="A Scout at a drafting table working on a technical drawing with T-square and triangle" >}}
...
{{< drg/did-you-know >}}
The Great Pyramid of Giza was built around 2560 BCE with such precision that its base is level to within just 2.1 centimeters across its entire 230-meter length. Ancient Egyptian builders achieved this without modern surveying instruments — just ropes, plumb bobs, and careful measurement.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/drafting-types-trio.avif" alt="Three-panel comparison showing an architectural floor plan, a mechanical orthographic drawing, and an electrical schematic diagram" >}}
...
{{< drg/safety-first >}}
Drafting accuracy is a safety issue. In professional practice, a dimension error on a structural drawing can lead to a beam that is too short, a connection that fails, or a building that does not meet code. Throughout this badge, practice the habit of double-checking every measurement and dimension before you consider a drawing finished.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/cad-3d-model-screen.avif" alt="A computer screen displaying a 3D CAD model of a mechanical part with dimensions and section views visible" >}}
...
{{< drg/next-page
    text="You have learned about the history and branches of drafting."
    teaser="Learn how to format your drawing sheets with proper borders and title blocks."
    url="/merit-badges/drafting/guide/req1a/" >}}
