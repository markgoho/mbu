...
- A missing or incorrect dimension
- A feature to add, remove, or modify
- A bill of materials quantity change
- A note that needs clarification
- A scale error or inconsistency

{{< drg/tip >}}
When presenting your drawings, give your counselor a **copy** — not your original. For paper drawings, make a photocopy or scan. For CAD drawings, export a PDF. This way, the counselor can mark up the copy freely while your original stays clean.
{{< /drg/tip >}}

{{< drg/image src="images/redlined-drawing-example.avif" alt="An engineering drawing with red pen markups showing correction clouds, dimension changes, and annotation notes typical of a professional redline review" >}}
...
| Markup | Meaning |
|--------|---------|
| Cloud/bubble around an area | Something inside needs attention |
| Crossed-out dimension with new number | Change this measurement |
| Arrow with note | Add something at this location |
| X through a feature | Delete this feature |
| Delta triangle (Δ) | Revision identifier |
| "RFI" notation | Request for information — the checker has a question |

{{< drg/did-you-know >}}
In the construction industry, the cost of fixing an error found on a drawing is estimated at about $1. Fixing the same error during construction costs roughly $10. Fixing it after the building is complete can cost $100 or more. The redline review process exists to catch that $1 fix before it becomes a $100 problem.
{{< /drg/did-you-know >}}
...
|-----|-------------|------|----|
| A | Changed wall thickness per redline | 03/04/2026 | JDS |

The revision block is a permanent record of every change made to the drawing after its initial release.

5. **Update the title block.** Some drafters update the date in the title block to reflect the latest revision. Others leave the original date and let the revision block tell the revision story. Follow your counselor's preference.

{{< drg/checklist title="Revision Processing Checklist" subtitle="Steps to complete Requirement 4b" >}}
...
{{< drg/image src="images/revision-block-detail.avif" alt="A close-up of a drawing revision block table showing columns for revision letter, description, date, and initials, with two sample entries filled in" >}}

{{< drg/be-prepared title="What If You Disagree With a Redline?" >}}
In professional practice, drafters sometimes disagree with a checker's markup. The correct response is never to silently ignore it. Instead:
- **Discuss it.** Talk to the checker (or your counselor) and explain your reasoning.
- **Document the decision.** If the markup is withdrawn, note it. If you are overruled, make the change.
- **Learn from it.** Redlines often reveal knowledge gaps or alternative approaches you had not considered.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    title="ASME Y14.35 — Revision of Engineering Drawings"
    url="https://www.asme.org/codes-standards/find-codes-standards/y14-35m-revision-engineering-drawings-associated-documents"
    description="The official ASME standard for revision tracking on engineering drawings. This is the professional reference used across industries." >}}
...
{{< drg/next-page
    text="You have processed redlines and documented revisions on your drawings."
    teaser="Compare your manual and CAD drafting experiences and discuss CAD benefits."
