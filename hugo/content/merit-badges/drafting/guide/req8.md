...
{{< drg/did-you-know >}}
According to the U.S. Bureau of Labor Statistics, the median annual wage for drafters in 2023 was around $60,000, with experienced drafters in specialized fields like aerospace or electrical earning significantly more. Many drafting careers require only a two-year associate degree to get started — not a four-year bachelor's degree.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/drafting-career-paths.avif" alt="An infographic showing three career paths branching from a central drafting skills hub to architectural, mechanical, and electrical engineering careers" >}}

{{< drg/image src="images/drafting-salary-outlook.avif" alt="Infographic showing drafting career facts: entry with associate degree, median salary around $60,000, and stable demand across industries" >}}

{{< drg/external-link
    title="U.S. Bureau of Labor Statistics — Drafters"
    url="https://www.bls.gov/ooh/architecture-and-engineering/drafters.htm"
    description="Official government data on drafter careers including job outlook, median pay, education requirements, and what drafters do day to day." >}}

{{< drg/external-link
    title="American Design Drafting Association (ADDA)"
    url="https://www.adda.org/"
    description="Professional organization for drafters and designers. Offers certification programs, educational resources, and industry standards." >}}

{{< drg/external-link
    title="U.S. Bureau of Labor Statistics — Architects"
    url="https://www.bls.gov/ooh/architecture-and-engineering/architects.htm"
    description="Career information for architecture, including education requirements, licensing, salary data, and job outlook." >}}

{{< drg/checklist title="Career Research Checklist" subtitle="What to cover in your discussion with your counselor" >}}
...
{{< drg/tip >}}
The Bureau of Labor Statistics Occupational Outlook Handbook (bls.gov/ooh) is the gold standard for career research. It has reliable, up-to-date data on every career area — salary, education, job outlook, and more. Start your research there.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have explored career opportunities in drafting and related fields."
    teaser="Go beyond the badge with advanced topics, real-world experiences, and organizations."
