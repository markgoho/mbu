...
Discuss with your counselor how fulfilling requirements 2, 3 and 4 differed from each other. Tell about the benefits derived from using CAD for requirements 3 and 4. Include in your discussion the software you used as well as other software options that are available.
{{< /drg/requirement >}}
...
**Making changes:**
- Think back to [Requirement 4](/merit-badges/drafting/guide/req4/) — when you received redline corrections, which drawing was easier to revise?
...
{{< drg/tip >}}
Be honest with your counselor about your experience. If you found manual drafting more satisfying, say so. If CAD frustrated you at first but got easier, share that journey. Your counselor is not looking for a "right answer" — they want to hear that you thought about the differences.
{{< /drg/tip >}}
...
{{< drg/image src="images/manual-vs-cad-comparison.avif" alt="Split comparison showing the same simple mechanical bracket: hand-drawn pencil version on the left, clean CAD version on the right" >}}

{{< drg/did-you-know >}}
The Boeing 777, which first flew in 1995, was the first commercial aircraft designed entirely with CAD — no paper drawings at all. Over 230 design teams around the world worked on the same digital model simultaneously. The result was a plane that fit together on the first try, with fewer engineering changes than any previous Boeing aircraft.
{{< /drg/did-you-know >}}

{{< drg/image src="images/cad-revision-ease.avif" alt="Split comparison showing a messy manual revision with eraser smudges versus a clean CAD revision with automatic dimension updates" >}}
...
{{< drg/checklist title="Discussion Prep Checklist" subtitle="Points to cover with your counselor" >}}
...
{{< drg/external-link
    title="CAD Software Comparison — All3DP"
    url="https://all3dp.com/1/best-free-cad-software-2d-3d-cad-programs-design/"
    description="A comprehensive comparison of free CAD software options for beginners, covering 2D, 3D, and specialized tools." >}}

## When Manual Drafting Still Wins

Do not leave your counselor with the impression that manual drafting is obsolete. It is not. Engineers and architects still sketch by hand every day — on whiteboards, in notebooks, on napkins during lunch meetings. Hand sketching is faster for brainstorming, requires no computer, and develops your spatial thinking in ways that CAD cannot replicate. The rough sketches you made in [Requirement 1a](/merit-badges/drafting/guide/req1a/) are a perfect example of where hand drawing excels.

The real takeaway: manual and CAD drafting are not competitors — they are partners. A skilled drafter uses both.

{{< drg/next-page
    text="You have compared manual and CAD drafting and discussed software options."
    teaser="Put your Gothic lettering skills to use writing about CAD benefits."
