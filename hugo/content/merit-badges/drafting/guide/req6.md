...
This requirement brings together two skills: the Gothic lettering you practiced in [Requirement 1b](/merit-badges/drafting/guide/req1b/) and the understanding of CAD benefits you developed in [Requirements 2 through 5](/merit-badges/drafting/guide/req5/). You will hand-letter a short essay — in proper Gothic lettering, without templates — on the formatted sheet you prepared at the start of the badge.
...
{{< drg/did-you-know >}}
SpaceX uses CAD and simulation so extensively that they can design, test, and iterate on rocket engine components in days rather than months. Their Raptor engine went through hundreds of digital design iterations before the first physical prototype was built — an approach that would have been impossible with manual drafting.
{{< /drg/did-you-know >}}
...
- How many lines of text you will need
- What letter height to use (1/8 inch is standard for body text; 3/16 or 1/4 inch for a title)
- How the text will be centered or aligned on the sheet
- Where to place a title (e.g., "CAD IN AEROSPACE MANUFACTURING")
...
{{< drg/checklist title="Lettering Project Checklist" subtitle="Quality checks for your finished piece" >}}
...
{{< drg/image src="images/scout-lettering-project.avif" alt="A Scout carefully hand-lettering Gothic text on a formatted drawing sheet at a desk, with guidelines visible and a mechanical pencil in hand" >}}

{{< drg/tip >}}
If your hand cramps during lettering, take a break every few lines. Grip the pencil lightly — a death grip causes fatigue and inconsistent strokes. Rest your hand on the sheet and move your whole forearm, not just your fingers.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
This requirement specifies "without the aid of a template or lettering guide." That means no Ames lettering guide, no lettering stencils, and no pre-printed guide sheets underneath your paper. You may use a straightedge to draw your own guidelines, but the letter forms must come from your hand alone.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="CAD in Industry — Autodesk Overview"
    url="https://www.autodesk.com/solutions/cad-software"
    description="Overview of how CAD software is used across architecture, engineering, construction, and manufacturing industries." >}}
...
{{< drg/next-page
    text="You have completed your Gothic lettering project on CAD benefits."
    teaser="Discover how drafting is used in real workplaces and industries."
