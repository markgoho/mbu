...
{{< drg/tip >}}
Places to look for a visit: architecture firms, engineering consulting companies, manufacturing plants, construction companies, electrical contractors, civil engineering firms, HVAC companies, or any business with an engineering or design department. Ask your counselor, parents, or troop leaders if they have contacts at any of these types of businesses.
{{< /drg/tip >}}

{{< drg/image src="images/professional-drafting-office.avif" alt="A modern engineering office with large monitors showing CAD drawings, a plotter printing a large-format drawing, and engineers collaborating at a workstation" >}}

{{< drg/checklist title="Workplace Visit Prep" subtitle="Be ready before you arrive" >}}
...
{{< drg/image src="images/drafting-tools-evolution.avif" alt="Split comparison showing a vintage drafting setup with wooden board, T-square, and vellum versus a modern CAD workstation with 3D model and 3D printer" >}}
...
{{< drg/did-you-know >}}
The blueprint process, invented in 1842 by Sir John Herschel (son of the astronomer), used potassium ferricyanide and ferric ammonium citrate coated on paper. When exposed to ultraviolet light through a translucent original drawing, the exposed areas turned deep blue while the drawn lines remained white. The distinctive blue color gave "blueprints" their name — even though modern copies are printed with ink on white paper.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    title="History of Technical Drawing — Engineering.com"
    url="https://www.engineering.com/story/a-brief-history-of-technical-drawing"
    description="An illustrated history of drafting from ancient engineering to modern CAD, covering tools, media, and methods." >}}

{{< drg/external-link
    title="Smithsonian — Tools of the Draftsman"
    url="https://americanhistory.si.edu/collections/subjects/engineering"
    description="The Smithsonian's collection of historical engineering and drafting artifacts, including drawing instruments, blueprints, and drafting equipment." >}}
...
{{< drg/next-page
    text="You have explored how drafting works in the real world."
    teaser="Research career opportunities in the drafting field."
