...
req_number: "1b"
prev: "/merit-badges/chemistry/guide/req1a/"
prev_title: "Safety Data Sheets"
next: "/merit-badges/chemistry/guide/req1c/"
next_title: "Safety Pictograms"
---
...
{{< drg/tip >}}
Not all gloves protect against all chemicals. Check Section 8 of the SDS to find which glove material is recommended for the specific chemical you are handling. A nitrile glove that protects against rubbing alcohol might not protect against a strong solvent.
{{< /drg/tip >}}
...
{{< drg/image src="images/ppe-types-labeled.avif" alt="Four types of PPE for chemistry: safety goggles, nitrile gloves, a lab coat, and a respirator, each clearly labeled" >}}
...
{{< drg/safety-first >}}
Always put on your PPE before you open any chemical container, and keep it on until you have finished working and cleaned up. Removing goggles "just for a second" is when accidents happen.
{{< /drg/safety-first >}}

{{< drg/did-you-know >}}
The concept of PPE in chemistry labs dates back to the early 1900s, but safety goggles did not become standard until the 1970s when OSHA was established. Before that, chemists routinely worked with dangerous chemicals wearing nothing more than a regular apron.
{{< /drg/did-you-know >}}

{{< drg/video title="How to Dress in the Lab and the Use of PPE" url="https://youtu.be/i1D6zpSw_6Q" >}}

{{< drg/external-link
    title="CDC — Personal Protective Equipment"
    url="https://www.cdc.gov/niosh/topics/emres/ppe.html"
    description="NIOSH guide to selecting and using personal protective equipment for chemical hazards." >}}

{{< drg/next-page
    text="You now know what PPE to use and why. Next, let's decode the warning symbols you see on chemical labels."
    teaser="Learn what GHS safety pictograms mean and where you encounter them every day."
