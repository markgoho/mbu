...
{{< drg/tip >}}
For your experiment, cut identical swatches of fabric (old cotton T-shirt material works well). Treat each swatch with a different waterproofing method, leave one untreated as a control, and then test them all the same way — pour the same amount of water on each and measure how much soaks through. Photograph your results.
{{< /drg/tip >}}
...
{{< drg/video title="Waterproofing Fabrics" url="https://youtu.be/y83uXupu5tY" >}}
...
{{< drg/safety-first >}}
Never use water on a Class B (grease/oil) fire — water can cause the burning oil to splatter and spread the fire explosively. Never use water on a Class C (electrical) fire — water conducts electricity and you could be electrocuted. If you ever see a fire you cannot safely extinguish, evacuate immediately and call 911.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/fire-triangle-diagram.avif" alt="The fire triangle showing heat, fuel, and oxygen, with arrows indicating how different extinguishers remove each element" >}}

{{< drg/video title="How to Distinguish Between the Different Classes of Fire" url="https://www.youtube.com/watch?v=B8PrA_AOa6w" >}}
...
{{< drg/safety-first >}}
Flame tests require an open flame and must be done under adult supervision. Work in a well-ventilated area, away from flammable materials. Wear safety goggles and tie back long hair. Keep a fire extinguisher or bucket of sand nearby. Never leave the torch unattended.
{{< /drg/safety-first >}}

{{< drg/did-you-know >}}
The colors you see in fireworks come from the exact same chemistry as flame tests. Strontium compounds produce red, barium produces green, copper produces blue, and sodium produces gold. Fireworks engineers are essentially performing flame tests on a massive scale.
{{< /drg/did-you-know >}}

{{< drg/video title="The Flame Test Experiment" url="https://www.youtube.com/watch?v=7hC-KyFraCQ" >}}
...
{{< drg/tip >}}
Nylon synthesis kits are available online and contain pre-measured, safer amounts of the chemicals needed. Using a kit is the recommended approach. Ask your counselor or a chemistry teacher for help obtaining one. Some science museums and university chemistry departments also host demonstrations.
{{< /drg/tip >}}
...
{{< drg/video title="Nylon Synthesis Chemistry Demo" url="https://www.youtube.com/watch?v=NQpTQFGKRN8" >}}

---

{{< drg/external-link
    title="NFPA — Fire Extinguisher Types"
    url="https://www.nfpa.org/education-and-research/home/safety-tips/fire-safety-equipment/fire-extinguishers"
    description="National Fire Protection Association guide to fire extinguisher types and proper use." >}}

{{< drg/next-page
    text="You have explored the chemistry of camping — from waterproofing to fire science. Now let's look at how chemistry can help solve one of the biggest environmental challenges of our time."
    teaser="Discover how chemistry is tackling the problem of single-use plastics, batteries, and more."
