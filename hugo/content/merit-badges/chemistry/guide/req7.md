...
{{< drg/image src="images/epa-water-testing.avif" alt="An environmental scientist collecting water samples from a river, wearing protective equipment, with testing equipment visible" >}}
...
{{< drg/did-you-know >}}
The 1937 sulfanilamide disaster — in which a drug dissolved in a toxic solvent killed over 100 people, including many children — led directly to the 1938 Federal Food, Drug, and Cosmetic Act. This law, for the first time, required drug companies to prove their products were safe before selling them. Before that, there was no pre-market safety testing requirement at all.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
For your counselor discussion, choose three agencies and be ready to explain when each was founded, why it was created, and how its work connects to what you have learned in this merit badge. Drawing connections to specific requirements shows deep understanding.
{{< /drg/tip >}}

{{< drg/video title="Why Does the FDA Exist?" url="https://youtu.be/DmYX23j5rnQ" >}}

{{< drg/external-link
    title="EPA — About EPA"
    url="https://www.epa.gov/aboutepa"
    description="Learn about the Environmental Protection Agency's mission, history, and current priorities." >}}

{{< drg/external-link
    title="OSHA — About OSHA"
    url="https://www.osha.gov/aboutosha"
    description="Occupational Safety and Health Administration's overview of its role in workplace chemical safety." >}}

{{< drg/next-page
    text="You now understand who regulates chemicals and why. For the final requirement, let's explore where chemistry can take you as a career."
    teaser="Visit a lab, tour a chemical plant, or research a career — the choice is yours."
