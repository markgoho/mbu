...
{{< drg/did-you-know >}}
Researchers have created edible food packaging from milk proteins, seaweed, and even shrimp shells. These materials dissolve harmlessly in water or can literally be eaten along with the food. Imagine a future where you eat your snack wrapper instead of throwing it away.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/green-chemistry-solutions.avif" alt="An infographic showing four chemistry solutions for single-use waste: biodegradable plastics, chemical recycling, better batteries, and alternative materials" >}}
...
{{< drg/tip >}}
For your counselor discussion, pick two or three specific single-use items and describe the chemistry behind both the problem and the solution. For example: "A plastic water bottle is made from PET, a petroleum-based polymer that takes 450 years to decompose. Chemical recycling using enzymes can break PET back into its monomers in hours, allowing it to be remade into new bottles without quality loss."
{{< /drg/tip >}}

{{< drg/be-prepared title="What Can You Do Right Now?" >}}
You do not need to be a chemist to reduce single-use waste. Here are practical steps:

- **Carry a reusable water bottle** — one stainless steel bottle replaces hundreds of plastic ones per year.
- **Use rechargeable batteries** — they can be recharged 500–1,000 times before replacement.
- **Choose products with minimal packaging** — less packaging means less waste chemistry has to solve later.
- **Recycle batteries properly** — many hardware stores and electronics retailers accept used batteries for recycling.
{{< /drg/be-prepared >}}

{{< drg/video title="Edible, Biodegradable Food Packaging" url="https://youtu.be/wt32GgQGTcI" >}}

{{< drg/external-link
    title="ACS — Green Chemistry"
    url="https://www.acs.org/greenchemistry.html"
    description="The American Chemical Society's hub for green chemistry resources, including the 12 Principles and current research." >}}

{{< drg/external-link
    title="EPA — Reducing and Reusing Basics"
    url="https://www.epa.gov/recycle/reducing-and-reusing-basics"
    description="EPA guide to reducing waste and understanding the environmental impact of single-use items." >}}

{{< drg/next-page
    text="You have seen how chemistry is tackling environmental challenges. Now let's zoom out and explore the major branches of chemistry as a whole."
    teaser="Identify five fields of chemistry and discover how each one connects to your daily life."
