...
{{< drg/image src="images/chemistry-fields-connections.avif" alt="A web diagram showing five main fields of chemistry as interconnected nodes with lines showing how they overlap and interact" >}}
...
{{< drg/did-you-know >}}
The boundaries between chemistry fields are becoming blurrier every year. Some of the most exciting discoveries happen at the intersections — like **nanochemistry**, which combines physical, organic, and inorganic chemistry to build materials at the atomic scale. Nanoparticles are already used in sunscreen, computer chips, and cancer treatments.
{{< /drg/did-you-know >}}

{{< drg/tip >}}
When discussing this requirement with your counselor, try to connect each field back to something you did earlier in this merit badge. Show how the experiments you performed fit into the larger world of chemistry. This demonstrates that you understand how the pieces fit together.
{{< /drg/tip >}}

{{< drg/external-link
    title="ACS — Areas of Chemistry"
    url="https://www.acs.org/careers/chemical-sciences/areas.html"
    description="The American Chemical Society's interactive guide to the many areas of chemistry, with career information for each field." >}}

{{< drg/next-page
    text="You now have a map of the chemistry landscape. Next, let's look at who makes the rules — the government agencies that keep chemicals safe for everyone."
    teaser="Discover the three key agencies that regulate chemicals in the United States."
