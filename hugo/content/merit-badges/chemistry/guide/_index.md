...
- **Key figure:** Antoine Lavoisier (1743–1794), often called the "Father of Modern Chemistry," proved that burning was a chemical reaction with oxygen — not a magical substance called "phlogiston." He also established the law of conservation of mass: matter is never created or destroyed, only rearranged.
- **Mindset:** Trial and error, secrecy, a blend of science and superstition
...
- **Key breakthroughs:** mRNA vaccines, biodegradable polymers, lithium-ion batteries, water desalination membranes
- **Mindset:** Solve real-world problems, from human health to climate change
...
{{< drg/image src="images/scout-chemistry-lab.avif" alt="A Scout wearing safety goggles and gloves, working at a chemistry lab bench with colorful solutions in beakers and test tubes" >}}
...
{{< drg/did-you-know >}}
There are more known organic compounds than all other types of chemical compounds combined — over 20 million and counting. Carbon's ability to bond with itself and other elements in so many ways makes it the most versatile building block in chemistry.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Chemistry involves working with chemicals, heat sources, and sometimes sharp tools. Throughout this badge, you will learn proper safety procedures — from reading Safety Data Sheets to wearing the right protective equipment. Always follow your merit badge counselor's instructions and never experiment unsupervised.
{{< /drg/safety-first >}}

{{< drg/image src="images/chemistry-branches-overview.avif" alt="An infographic showing six branches of chemistry with icons: organic, inorganic, analytical, physical, biochemistry, and environmental" >}}
...
{{< drg/next-page
    text="You have explored the world of chemistry and its many branches."
    teaser="Learn how to read Safety Data Sheets and understand the hazards of common chemicals."
    url="/merit-badges/chemistry/guide/req1a/" >}}
