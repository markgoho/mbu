...
Discuss the safe storage of chemicals. How does the safe storage of chemicals apply to your home, school, community, and the environment?
{{< /drg/requirement >}}
...
{{< drg/image src="images/chemical-storage-cabinet.avif" alt="A properly organized chemical storage cabinet with clearly labeled sections for acids, bases, flammables, and oxidizers" >}}
...
{{< drg/checklist title="Home Chemical Storage" subtitle="Room-by-room guide" >}}
...
- **Do not mix** the spilled chemical with other cleaning products.
- **Wear gloves** and use paper towels or absorbent material to clean up the spill.
- **Check the product label** for specific cleanup instructions.
- **Call Poison Control (1-800-222-1222)** if someone is exposed or you are unsure how to handle the situation.
{{< /drg/be-prepared >}}
...
{{< drg/tip >}}
Ask your science teacher for a tour of the chemical storage area. Notice how chemicals are separated by type, how containers are labeled, and what safety equipment is nearby (fire extinguisher, spill kit, eyewash station). This first-hand observation will give you great material for your counselor discussion.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Never pour chemicals down the drain, into storm drains, or onto the ground. Many communities have **Household Hazardous Waste** collection days where you can drop off old paint, pesticides, batteries, and other chemicals for safe disposal. Check your local government website for dates and locations.
{{< /drg/safety-first >}}

{{< drg/did-you-know >}}
The EPA's Superfund program has identified over 1,300 contaminated sites across the United States — places where decades of improper chemical storage and disposal poisoned the land and water. Cleaning up a single Superfund site can take 10–30 years and cost hundreds of millions of dollars.
{{< /drg/did-you-know >}}

{{< drg/video title="Chemical Storage Safety" url="https://youtu.be/4GUSQj-xOBY" >}}

{{< drg/external-link
    title="EPA — Household Hazardous Waste"
    url="https://www.epa.gov/hw/household-hazardous-waste-hhw"
    description="EPA guide to identifying, storing, and safely disposing of hazardous household chemicals." >}}

{{< drg/next-page
    text="You now understand how to store chemicals safely at every level — from your bathroom cabinet to your community."
    teaser="Discover the surprising chemistry behind why soap and alcohol are used to clean wounds."
