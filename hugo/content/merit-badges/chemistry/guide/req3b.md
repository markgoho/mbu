...
{{< drg/did-you-know >}}
The pH scale is logarithmic, meaning each number represents a tenfold change. A solution with a pH of 3 is ten times more acidic than one with a pH of 4, and a hundred times more acidic than one with a pH of 5. Lemon juice (pH 2) is 100,000 times more acidic than pure water (pH 7).
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Indicator Materials" subtitle="What you will need" >}}
...
{{< drg/image src="images/cabbage-indicator-colors.avif" alt="Six clear cups showing red cabbage indicator at different pH levels, ranging from red (acidic) through purple (neutral) to green (basic)" >}}
...
{{< drg/tip >}}
Arrange your cups from most acidic to most basic after testing. This creates a beautiful rainbow that clearly shows the pH spectrum. Take a photo for your counselor meeting — it is a great visual aid.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Some household chemicals are corrosive — especially drain cleaners, oven cleaners, and concentrated bleach. Do not test these without adult supervision. Wear gloves when handling strong acids or bases, and never mix unknown chemicals together.
{{< /drg/safety-first >}}

{{< drg/video title="Why Is Red Cabbage a pH Indicator?" url="https://youtu.be/4AElaDIhMyA" >}}

{{< drg/external-link
    title="Compound Chemistry — Red Cabbage Indicator Infographic"
    url="https://www.compoundchem.com/2017/05/18/red-cabbage/"
    description="A beautiful infographic showing the color spectrum of red cabbage indicator across the full pH range." >}}

{{< drg/next-page
    text="You have explored the chemistry of cooking — from browning reactions to pH indicators. Now let's see how chemistry connects to the great outdoors."
    teaser="Discover the chemistry behind waterproofing, fire, flame tests, and even making your own nylon."
