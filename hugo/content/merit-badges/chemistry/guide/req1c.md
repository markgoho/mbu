...
{{< drg/image src="images/ghs-pictograms-grid.avif" alt="A grid showing all nine GHS hazard pictograms with their red diamond borders, each labeled with its name and description" >}}
...
{{< drg/did-you-know >}}
Before GHS pictograms were adopted worldwide starting in 2003, every country had its own hazard symbols. A skull and crossbones in one country might mean something slightly different in another. The GHS system unified everything so that a red-bordered diamond means the same thing everywhere on Earth.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Take a walk through your home and count how many products have GHS pictograms. Check under the kitchen sink, in the garage, in the bathroom, and in the laundry room. You might be surprised how many chemicals you interact with every day. Bring your list to your counselor meeting — it is a great conversation starter for this requirement.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Never ignore a pictogram you do not recognize. If you see a symbol on a product and are not sure what it means, look it up before using the product. Assumptions about chemical safety can lead to serious injuries.
{{< /drg/safety-first >}}

{{< drg/video title="Safety Pictograms in SDS" url="https://youtube.com/shorts/x_TebXJET0Y" >}}

{{< drg/external-link
    title="OSHA — GHS Pictograms and Hazards"
    url="https://www.osha.gov/sites/default/files/publications/OSHA3491QuickCardPictogram.pdf"
    description="Quick reference card showing all nine GHS pictograms with their meanings." >}}

{{< drg/next-page
    text="You can now read the warning symbols on any chemical label. Next, let's talk about where and how to store chemicals safely."
    teaser="Learn the rules of chemical storage and why they matter at home, school, and beyond."
