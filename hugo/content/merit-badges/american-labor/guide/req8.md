...
{{< drg/image src="images/stakeholder-web.avif" alt="An illustrated diagram showing a business at the center with lines connecting to different stakeholder groups: owners, stockholders, customers, employees, union representatives, community members, and public officials" >}}
...
{{< drg/did-you-know >}}
When a publicly traded company's workers go on strike, the company's stock price often drops because investors worry about lost production and revenue. This creates pressure on management to settle the dispute — showing how stakeholder interests are interconnected.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When discussing compromise with your counselor, use a specific example. Imagine a company negotiating a new union contract: workers want a 10% raise, management offers 2%. They might compromise at 5% with a commitment to improve health benefits — a solution that gives both sides something important while requiring both to give something up.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Mapping Stakeholder Interests" >}}
Here is a practical exercise to prepare for your counselor discussion:
- **Step one**: Pick a real company in your community (a factory, hospital, school district, or retail store).
- **Step two**: List all the stakeholder groups from this requirement.
- **Step three**: For each group, write down 2–3 specific goals they would have regarding that business.
- **Step four**: Identify where those goals conflict with each other.
- **Step five**: Propose one compromise that addresses at least two conflicting goals.
{{< /drg/be-prepared >}}
...
{{< drg/external-link title="U.S. Securities and Exchange Commission — Investing Basics" url="https://www.investor.gov/introduction-investing" description="Learn how stockholders and investors interact with businesses, from the SEC's educational resources." >}}

{{< drg/next-page
    text="You understand how different stakeholders' goals shape business decisions and labor relations."
    teaser="Now explore the careers available in the field of labor relations and find one that interests you."
