...
req_number: "3"
prev: "/merit-badges/american-labor/guide/req2/"
prev_title: "Req 2 — Visiting a Labor Organization"
next: "/merit-badges/american-labor/guide/req4/"
next_title: "Req 4 — Bargaining Models"
---
...
{{< drg/image src="images/collective-bargaining-table.avif" alt="An illustrated scene of union representatives and management sitting across from each other at a long table with documents, representing a collective bargaining session" >}}
...
{{< drg/did-you-know >}}
The right to collective bargaining is protected by federal law. The National Labor Relations Act of 1935 (also called the Wagner Act) guarantees most private-sector workers the right to form unions and bargain collectively with their employers.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When discussing union shops and open shops with your counselor, try to explain the arguments on both sides. Supporters of union shops say that everyone should pay their fair share. Supporters of open shops say that workers should have the freedom to choose. Understanding both perspectives shows real depth of knowledge.
{{< /drg/tip >}}
...
{{< drg/image src="images/mediation-session.avif" alt="A mediator at a small round table with a union representative on one side and a management representative on the other, all engaged in discussion" >}}
...
{{< drg/be-prepared title="When Negotiations Break Down" >}}
Imagine you are a union member and contract talks have stalled. Your union is considering a strike. Here is how the process typically works:
- **Step one**: The union holds a vote among its members. A majority must approve the strike.
- **Step two**: The union gives formal notice to the employer and sometimes to a federal mediator.
- **Step three**: Workers walk off the job and often form picket lines outside the workplace.
- **Step four**: Negotiations continue, often with greater urgency, until a new agreement is reached.
- **Step five**: Members vote on the new contract. If approved, they return to work.
{{< /drg/be-prepared >}}

{{< drg/external-link title="National Labor Relations Board — Rights We Protect" url="https://www.nlrb.gov/about-nlrb/rights-we-protect" description="The NLRB explains the rights of workers to organize, bargain collectively, and take action — including strikes — under federal law." >}}
...
{{< drg/next-page
    text="You now understand the key concepts of how unions operate."
    teaser="Next, explore the two major approaches to how labor and management can work together — or against each other."
