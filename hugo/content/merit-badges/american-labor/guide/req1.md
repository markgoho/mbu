...
{{< drg/image src="images/worker-concerns-brainstorm.avif" alt="A Scout sitting at a desk with an open notebook, researching worker concerns on a laptop, with sticky notes on the wall behind them listing topics like wages, safety, and benefits" >}}
...
{{< drg/safety-first >}}
Workplace safety is not optional — it is the law. The Occupational Safety and Health Act of 1970 gives every worker the right to a safe workplace. Workers can report unsafe conditions to OSHA without fear of retaliation from their employer.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
The first federal minimum wage was set in 1938 at just 25 cents per hour. Adjusted for inflation, that would be roughly $5.00 today — still below the current federal minimum wage.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When researching your eight concerns, try to find a real-world example for each one. A news article, a statistic, or a story from someone you know will make your descriptions much stronger than a textbook definition alone.
{{< /drg/tip >}}
...
{{< drg/external-link title="U.S. Bureau of Labor Statistics" url="https://www.bls.gov/" description="The BLS provides data on wages, employment, workplace injuries, and many other topics that are useful for researching worker concerns." >}}

{{< drg/external-link title="OSHA — Workers' Rights" url="https://www.osha.gov/workers" description="Learn about workplace safety rights and how workers can report unsafe conditions." >}}
...
{{< drg/be-prepared title="Getting the Most from Your Research" >}}
Before you start writing your list, gather your sources first.
- **Step one**: Check the Bureau of Labor Statistics website for current data on wages, safety, and employment trends.
- **Step two**: Search for recent news articles about at least two of your chosen concerns.
- **Step three**: If possible, talk to a working adult you know — a parent, neighbor, or family friend — and ask what concerns matter most to them.
- **Step four**: Write your descriptions, blending the facts you found with the real-world perspectives you gathered.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have explored the major concerns of American workers."
    teaser="Next, you will visit or contact a real labor organization and hear directly from the people involved."
