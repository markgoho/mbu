...
{{< drg/image src="images/global-supply-chain.avif" alt="An illustrated world map showing shipping routes and trade connections between continents, with icons representing factories, cargo ships, and workers in different regions" >}}
...
{{< drg/did-you-know >}}
A typical smartphone contains materials from more than 30 different countries. The glass might come from Japan, the rare earth minerals from the Democratic Republic of Congo, and the chips from Taiwan — all assembled in China and sold worldwide.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When discussing globalization with your counselor, avoid framing it as purely positive or purely negative. The strongest answer acknowledges that globalization has created real benefits (lower prices, new industries, economic growth) AND real costs (job displacement, wage pressure, community disruption). Showing you can hold both ideas at once demonstrates mature thinking.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Tracing a Product's Global Journey" >}}
Here is a way to make globalization concrete for your discussion with your counselor:
- **Step one**: Choose a common product you use every day (a phone, a pair of shoes, a snack).
- **Step two**: Research where its components or ingredients come from.
- **Step three**: Map the journey from raw materials to the finished product in your hands.
- **Step four**: Identify which American workers are involved in the process (retail, shipping, marketing, etc.) and which workers overseas contribute.
- **Step five**: Discuss what would change for American workers if this product were made entirely in the United States.
{{< /drg/be-prepared >}}
...
{{< drg/external-link title="U.S. Department of Labor — Trade and Globalization" url="https://www.dol.gov/agencies/ilab" description="The Bureau of International Labor Affairs works to improve working conditions and protect workers' rights around the world." >}}
...
{{< drg/next-page
    text="You have explored how globalization shapes the American workforce."
    teaser="Now sharpen your critical thinking skills by arguing both sides of a real labor issue."
