...
{{< drg/image src="images/debate-podium.avif" alt="A Scout standing at a simple podium with note cards, preparing to present arguments about management and labor perspectives" >}}
...
{{< drg/tip >}}
Pick an issue where you can see legitimate arguments on both sides. If you can only see one side, it will be hard to argue the other convincingly — and your counselor will notice. The strongest presentations show that both sides have real points, even if you personally agree with one more than the other.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Structuring Your Presentation" >}}
Whether you present orally or in writing, a clear structure will make your argument stronger:
- **Step one**: Introduce the issue in 2–3 sentences. What is the debate about, and why does it matter?
- **Step two**: Present management's case. Give 3–4 specific arguments with supporting evidence.
- **Step three**: Present labor's case. Give 3–4 specific arguments with supporting evidence.
- **Step four**: Summarize the basic rights and responsibilities of employers and employees (see below).
- **Step five**: Conclude by acknowledging the complexity — there are legitimate concerns on both sides.
{{< /drg/be-prepared >}}
...
{{< drg/external-link title="U.S. Department of Labor — Workers' Rights" url="https://www.dol.gov/general/aboutdol/majorlaws" description="A summary of the major federal laws protecting workers' rights, from the Department of Labor." >}}
...
{{< drg/next-page
    text="You have practiced seeing labor issues from both management and labor perspectives."
    teaser="Now explore how different stakeholders — from owners to community members — all have goals that shape the world of work."
