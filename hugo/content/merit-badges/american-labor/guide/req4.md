...
{{< drg/image src="images/adversarial-vs-cooperative.avif" alt="A split illustration: on the left, two groups facing each other across a table with arms crossed (adversarial); on the right, both groups collaborating on the same side of the table (cooperative)" >}}
...
{{< drg/did-you-know >}}
The Saturn automobile division of General Motors, launched in 1985, was one of the most famous experiments in cooperative labor-management relations. The United Auto Workers and GM jointly designed the factory, the production process, and even the management structure. Workers had a real voice in decisions that would normally be made only by management.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When you explain these models to your counselor, try to give a specific example of each. For the adversarial model, you might describe a long, contentious strike. For the cooperative model, you might talk about a company where union members sit on safety committees alongside management and jointly design training programs.
{{< /drg/tip >}}
...
{{< drg/external-link title="Federal Mediation and Conciliation Service (FMCS)" url="https://www.fmcs.gov/" description="The FMCS is an independent federal agency that helps labor and management resolve disputes and build cooperative relationships." >}}
...
{{< drg/next-page
    text="You have learned the two major models for how labor and management relate."
    teaser="Dive into the rich history of the American labor movement through a hands-on project."
