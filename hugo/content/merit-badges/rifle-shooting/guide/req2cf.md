...
**Material**: Tightly woven cotton or linen. Pre-cut to the correct size for the bore diameter.
**Lubrication**: Patches are lubricated with a patch lube (typically a beeswax-based product or commercial patch lubricant) to reduce friction during loading and to help keep fouling soft in the bore between shots.
...
{{< drg/next-page
    text="You know what goes into a load. Now learn the step-by-step procedure for loading safely."
    teaser="Req 2cg identifies the correct loading sequence and the accessories you'll use."
