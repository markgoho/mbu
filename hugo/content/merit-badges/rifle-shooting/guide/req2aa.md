...
{{< drg/image src="images/rifle-parts-diagram.avif" alt="Labeled side-view diagram of a bolt-action rifle showing the stock, action, barrel, and key related parts" >}}

{{< drg/next-page
    text="Now that you know what a rifle is made of, let's cover how to handle and store it safely."
    teaser="Req 2ab covers the rules for storing and handling a modern cartridge rifle on the range and at home."
