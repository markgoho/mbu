...
{{< drg/image src="images/cartridge-anatomy-diagram.avif" alt="Side-by-side cutaway diagram of rimfire and centerfire cartridges labeling the case, bullet, primer, and propellant" >}}
...
{{< drg/video
    title="Firearm Basics: Parts of a Cartridge — NRApubs"
    url="https://www.youtube.com/watch?v=rnkKZuYGH4Y" >}}

{{< drg/next-page
    text="You know how a normal shot works. Now learn what to do when it doesn't."
    teaser="Req 2ad covers misfires, hangfires, and squib fires—and the correct, calm procedure for responding to each."
