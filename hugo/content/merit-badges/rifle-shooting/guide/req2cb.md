...
{{< drg/image src="images/muzzleloader-parts-diagram.avif" alt="Labeled side-view diagram of a percussion muzzleloading rifle showing the stock, barrel, lock, hammer, nipple, ramrod, and sights" >}}

{{< drg/next-page
    text="You know how the muzzleloader works. Now learn how to store and handle it safely."
    teaser="Req 2cc covers safe storage and handling rules specific to muzzleloading rifles."
