...
**"CEASE FIRE"**
Stop shooting immediately. Take your finger off the trigger. Do not fire again until you are instructed to. If you hear this command and you are mid-shot, stop. The range safety officer may call cease fire for any reason—including someone downrange.

**"MAKE THE RANGE SAFE" / "OPEN YOUR ACTIONS"**
...
**"THE RANGE IS COLD" / "GO DOWNRANGE"**
All rifles are verified safe and staged. Only now may anyone go downrange to check or set targets. Never go downrange on a hot range (one where rifles are loaded or shooters are present on the line without an explicit cold range call from the RSO).

**"THE RANGE IS HOT" / "COMMENCE FIRING"**
Everyone is back behind the firing line. Shooters may approach the line, load, and fire.

**"LOAD"**
Insert a magazine or load the chamber as instructed.

**"FIRE" / "BEGIN SHOOTING"**
Firing may now commence.
...
{{< drg/video
    title="Introduction to Range Safety and Etiquette - Firearm Safety — NSSF—The Firearm Industry Trade Association"
    url="https://www.youtube.com/watch?v=COvFyw-6Fqs" >}}

{{< drg/next-page
    text="You've learned how to behave on the range. Now learn how to take care of the rifle when you're done shooting."
    teaser="Req 2ag covers the safety rules for cleaning a rifle and the materials you'll need."
