...
req_number: "1a"
req_path: "1.a"
prev: "/merit-badges/rifle-shooting/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/rifle-shooting/guide/req1b/"
next_title: "Req 1b — The Four Rules of Safe Gun Handling"
---
...
{{< drg/image src="images/projectile-energy-diagram.avif" alt="Side-by-side comparison of a thrown baseball, a BB, and a rifle bullet with simple visual indicators of speed and penetration depth" >}}

{{< drg/next-page
    text="Now that you understand why projectiles are serious business, let's cover the rules that govern every firearm, every time."
    teaser="Req 1b covers the four universal rules of safe gun handling that apply whether the gun is loaded or not."
