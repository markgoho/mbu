...
{{< drg/video
    title="Two-Shot Sight-In: How to Zero a Rifle in Two Shots - Rifle Tip — NSSF—The Firearm Industry Trade Association"
    url="https://www.youtube.com/watch?v=TiOpQY2ORo4" >}}

{{< drg/next-page
    text="You've completed Option A. If you are doing Option B instead, the next page is your Air Rifle overview."
    teaser="Req 2b is the overview page for the Air Rifle option—what you'll do and what to expect."
