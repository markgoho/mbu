...
{{< drg/image src="images/air-rifle-parts-diagram.avif" alt="Labeled side-view diagram of a break-barrel air rifle showing the stock, powerplant, barrel, and major external parts" >}}

{{< drg/next-page
    text="You know how an air rifle is built and powered. Now learn how to store and handle it safely."
    teaser="Req 2bb covers safe storage and handling rules specific to air rifles."
