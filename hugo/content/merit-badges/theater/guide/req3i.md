...
{{< drg/did-you-know >}}
On Broadway, the stage manager has the authority to cancel a performance if conditions are unsafe. They are also responsible for maintaining the director's artistic vision after the show opens — if an actor starts changing their performance, it is the stage manager who brings them back in line.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/stage-manager-calling.avif" alt="A stage manager wearing a headset, sitting at a desk backstage with a calling script open, a small desk lamp illuminating the pages, monitors showing the stage visible nearby" >}}
...
{{< drg/tip >}}
Always say the cue number *before* the word "go," never after. If you say "Go, lights cue 15," the operator might fire the wrong cue because they heard "go" before knowing which cue you meant. This is one of the most important rules in stage management.
{{< /drg/tip >}}

### Staying Organized

{{< drg/checklist title="Stage Manager's Toolkit" subtitle="Items to keep in your kit at all times" >}}
...
{{< drg/be-prepared title="An Actor Misses an Entrance" >}}
If an actor does not appear when they should:

- **Stay calm on headset.** Do not panic the crew.
- **Send an ASM (assistant stage manager)** to find the actor backstage immediately.
- **Hold the next cue** if it depends on the actor's entrance.
- **Trust the other actors** to improvise and cover the gap on stage — experienced cast members can usually stall.
- **After the show**, talk to the actor privately and positively to prevent it from happening again.
{{< /drg/be-prepared >}}

### Explore More Resources

{{< drg/external-link title="Stage Managers Association" url="https://www.stagemanagers.org/" description="A professional network for stage managers with resources, mentorship programs, and career guidance." >}}

{{< drg/image src="images/prompt-book-closeup.avif" alt="A closeup of an open prompt book showing a script page with handwritten cue notations in the margins, colored tabs, and blocking diagrams on the facing page" >}}

{{< drg/next-page text="Stage management keeps the whole production running" teaser="Discover the unique role of the musical director — the person who brings the music of a musical to life." url="/merit-badges/theater/guide/req3j/" >}}
