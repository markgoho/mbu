...
req_number: "3j"
prev: "/merit-badges/theater/guide/req3i/"
prev_title: "Req 3i — Stage Management"
next: "/merit-badges/theater/guide/req4/"
next_title: "Req 4 — Mime & Pantomime"
---
...
{{< drg/tip >}}
Even if your production uses pre-recorded backing tracks instead of a live orchestra, you still need a musical director. Someone has to teach the songs, coach the singers, and make sure everyone is synchronized with the tracks during the show.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The first true "book musical" — where songs and dialogue tell a single, integrated story — was *Show Boat* in 1927. Before that, musicals were mostly a collection of unrelated songs strung together around a loose plot. *Show Boat* changed everything by using music to develop character and advance the story.
{{< /drg/did-you-know >}}

{{< drg/image src="images/musical-director-piano.avif" alt="A teenager sitting at an upright piano on a stage, leading a small group of cast members in a vocal rehearsal, sheet music spread across the piano top" >}}
...
{{< drg/checklist title="Musical Director's Vocabulary" subtitle="Terms you will use frequently" >}}
...
{{< drg/be-prepared title="A Singer Struggles with a Song" >}}
If a cast member cannot hit a note or struggles with a passage:

- **Lower the key** if possible. Transposing a song down a step or two can make it singable without losing the character's emotional intent.
- **Simplify the part.** If a harmony line is too difficult, have them sing the melody instead.
- **Practice in smaller chunks.** Isolate the tricky measure and repeat it slowly until it clicks.
- **Be encouraging.** Singing in front of others is vulnerable. Build their confidence with praise for what they are doing well.
{{< /drg/be-prepared >}}

### Explore More Resources

{{< drg/external-link title="Music Theatre International (MTI)" url="https://www.mtishows.com/" description="One of the largest licensors of musicals for schools and community theaters, with educational resources and show guides." >}}

{{< drg/image src="images/pit-orchestra-rehearsal.avif" alt="A small pit orchestra of teenagers with various instruments rehearsing in front of a stage, a conductor standing with a baton, sheet music on stands" >}}

{{< drg/next-page text="Music brings energy and emotion to musical theater" teaser="Now explore a completely different performance art — telling a story without saying a single word." url="/merit-badges/theater/guide/req4/" >}}
