...
{{< drg/tip >}}
Pay attention to the differences between social classes. In most historical periods, a wealthy person and a poor person dressed very differently. The fabrics, colors, and level of decoration all communicated status. Your costumes should reflect these differences.
{{< /drg/tip >}}
...
{{< drg/checklist title="Costume Design Elements" subtitle="Include these for each character" >}}
...
{{< drg/image src="images/costume-sketches.avif" alt="A set of five costume design sketches pinned to a cork board, showing characters from different social classes in a historical period, with fabric swatches and color notes attached" >}}

{{< drg/did-you-know >}}
In Shakespeare's time, costumes were the most expensive part of a production — often costing more than the playwright was paid for writing the play. Companies spent lavishly on real silk, velvet, and gold thread, because costumes were the main way to create visual spectacle on a mostly bare stage.
{{< /drg/did-you-know >}}
...
{{< drg/external-link title="Costume Designer's Guild" url="https://costumedesignersguild.com/" description="The professional organization for costume designers in entertainment, with galleries of professional work and career resources." >}}

{{< drg/external-link title="The Metropolitan Museum of Art — Costume Institute" url="https://www.metmuseum.org/about-the-met/collection-areas/the-costume-institute" description="Explore thousands of real historical garments from the Met's world-class collection." >}}

{{< drg/image src="images/historical-costume-research.avif" alt="A Scout at a library table surrounded by open books showing historical clothing illustrations, with colored pencils and a sketchpad nearby" >}}

{{< drg/next-page text="Costumes tell us what a character wears" teaser="Hair and makeup complete the picture by transforming an actor's face and appearance." url="/merit-badges/theater/guide/req3e/" >}}
