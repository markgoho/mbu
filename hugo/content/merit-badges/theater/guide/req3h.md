...
req_number: "3h"
prev: "/merit-badges/theater/guide/req3g/"
prev_title: "Lighting Design"
next: "/merit-badges/theater/guide/req3i/"
next_title: "Stage Management"
---
...
{{< drg/image src="images/sound-mixing-desk.avif" alt="A sound mixing desk in a theater booth with faders, knobs, and meters, a pair of headphones resting on it, the stage visible in the background" >}}
...
{{< drg/safety-first >}}
Speakers can be heavy — always use proper lifting techniques and have help when hanging speakers overhead. Audio cables should be taped down or run through cable troughs to prevent trip hazards. Never handle electrical connections with wet hands, and make sure all equipment is properly grounded.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
When equalizing, trust your ears more than the equipment displays. Play a recording of someone speaking through the system and adjust until it sounds like a real person talking in the room — not boomy, not tinny, just natural and clear.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The first Broadway show to use wireless microphones was *Hair* in 1968. Before that, actors had to project their voices to fill entire theaters without any amplification at all — a skill that took years to develop and is still taught in acting schools today.
{{< /drg/did-you-know >}}

### Common Sound Challenges

{{< drg/be-prepared title="Feedback Squeal" >}}
Feedback happens when a microphone picks up its own sound from a speaker, creating a painful loop. To fix it:

- **Lower the microphone volume** immediately.
- **Move the microphone** farther from the speaker.
- **Adjust EQ** to cut the frequency that is feeding back.
- **Reposition speakers** so they point away from microphone positions.
- Prevention is the best cure — always do a thorough sound check before the audience arrives.
{{< /drg/be-prepared >}}

### Explore More Resources

{{< drg/external-link title="Theatrical Sound Designers and Composers Association" url="https://www.tsdca.org/" description="The professional organization for theatrical sound designers, with resources on techniques and career paths in theater sound." >}}

{{< drg/image src="images/mic-check-backstage.avif" alt="A sound technician backstage helping an actor adjust a wireless microphone pack attached to their costume, both looking focused" >}}

{{< drg/next-page text="Sound brings the audience into the world of the play" teaser="Now learn about the person who holds the entire production together — the stage manager." url="/merit-badges/theater/guide/req3i/" >}}
