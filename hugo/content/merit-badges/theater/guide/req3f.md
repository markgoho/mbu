---
title: "Scenery Building"
layout: guide
group_title: "3. Behind the Curtain"
req_number: "3f"
prev: "/merit-badges/theater/guide/req3e/"
prev_title: "Hair & Makeup"
next: "/merit-badges/theater/guide/req3g/"
next_title: "Lighting Design"
---
...
{{< drg/safety-first >}}
Scene shops involve real power tools. Always wear safety glasses when cutting or drilling. Use hearing protection around loud saws. Never use a power tool without proper instruction and supervision. Keep your workspace clean — sawdust on the floor is a slip hazard, and scrap lumber can cause trips and falls. Wear closed-toe shoes at all times.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Scenic painting is always done on a large scale. Stand back frequently to check your work from a distance — what looks messy up close often looks perfect from the audience's perspective. A detail that looks great from three feet away might be invisible from the back row.
{{< /drg/tip >}}

{{< drg/image src="images/scene-shop-building.avif" alt="Teenagers in a scene shop building a flat, one holding lumber while another uses a drill, with partially completed scenery pieces visible around them" >}}

### Tools of the Trade

Here are the basic tools you will encounter in a scene shop:

{{< drg/checklist title="Scene Shop Tools" subtitle="Common tools used in scenery construction" >}}
...
{{< drg/did-you-know >}}
Broadway shows sometimes spend over a million dollars on scenery alone. The set for the musical *Hamilton*, with its iconic rotating turntables, weighs over 20 tons and required months of engineering and construction in a specialized scenic studio.
{{< /drg/did-you-know >}}

### Explore More Resources

{{< drg/external-link title="USITT — Scenic Design & Technology" url="https://www.usitt.org/" description="The United States Institute for Theatre Technology offers resources on scenic construction, painting, and design for students and professionals." >}}

{{< drg/image src="images/scenic-painting.avif" alt="A teenager painting a large scenic flat on the floor, using a long-handled brush to create a brick wall texture, paint cans and brushes nearby" >}}

{{< drg/next-page text="You have helped build the physical world of the show" teaser="Now discover how lighting design shapes the mood, focus, and magic of every scene." url="/merit-badges/theater/guide/req3g/" >}}
