...
- **Person vs. Person** — Another character actively opposes your protagonist (a rival, an authority figure, a friend who disagrees)
- **Person vs. Self** — Your character struggles with their own fears, doubts, or choices
- **Person vs. Situation** — Circumstances create obstacles (a storm, a deadline, a rule)
...
{{< drg/did-you-know >}}
The basic story structure — setup, rising action, climax, resolution — was first described by the ancient Greek philosopher Aristotle in his work *Poetics* around 335 BCE. Playwrights have been following this blueprint for nearly 2,400 years.
{{< /drg/did-you-know >}}

{{< drg/image src="images/playwright-notebook.avif" alt="A notebook open on a desk showing a hand-drawn story arc diagram with labels for setup, rising action, climax, and resolution, with a pencil and coffee mug nearby" >}}
...
{{< drg/tip >}}
Read your dialogue out loud as you write it. If a line sounds awkward when you say it, it will sound awkward on stage too. Real people use contractions, interrupt each other, and sometimes do not finish their sentences.
{{< /drg/tip >}}
...
- **Inciting incident** — Something happens that sets the conflict in motion
- **Rising action** — Tension builds as the character tries to solve the problem
- **Climax** — The moment of greatest tension and decision
- **Resolution** — The aftermath (keep it short)
...
{{< drg/be-prepared title="Writer's Block?" >}}
Every writer hits a wall sometimes. Here are ways to push through:

- **Change the setting.** If your scene takes place in a living room, what happens if you move it to a bus stop?
- **Add a deadline.** Characters under time pressure make more interesting choices.
- **Have a character say the worst possible thing.** It creates instant drama.
- **Skip ahead.** Write the climax first, then figure out how to get there.
{{< /drg/be-prepared >}}
...
- **Pages 1–2:** Setup — introduce your character and their world
- **Pages 3–4:** Inciting incident — the conflict kicks in
- **Pages 5–8:** Rising action — obstacles pile up, tension builds
- **Pages 9–10:** Climax and resolution — the big moment and its aftermath

{{< drg/checklist title="One-Act Play Checklist" subtitle="Make sure your script has all of these before sharing it with your counselor" >}}
...
{{< drg/external-link title="Young Playwrights Inc." url="https://youngplaywrights.org/" description="A national organization that supports young writers in creating original plays, with contests and workshops." >}}

{{< drg/external-link title="Playwriting 101 — The Basics" url="https://www.playwriting101.com/" description="Free online tutorials covering script format, character development, and story structure for beginning playwrights." >}}

{{< drg/image src="images/scouts-reading-script.avif" alt="Two Scouts sitting cross-legged on a stage reading from a script together, laughing and gesturing, with stage lights dimly visible above" >}}

{{< drg/next-page text="You have learned how to write a play from scratch" teaser="Before you step onto the stage, let's talk about keeping everyone safe in a theater environment." url="/merit-badges/theater/guide/req3/" >}}
