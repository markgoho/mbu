...
{{< drg/tip >}}
Keep a small notebook with you when you see a live play. During intermission, jot down your first impressions — what stood out, what surprised you, what confused you. These notes will make writing your review much easier later.
{{< /drg/tip >}}
...
{{< drg/image src="images/audience-watching-play.avif" alt="Teenagers sitting in theater seats watching a play, leaning forward with engaged expressions, stage visible in the background with warm lighting" >}}
...
{{< drg/checklist title="Play Review Outline" subtitle="Include these elements in each of your three reviews" >}}
...
{{< drg/did-you-know >}}
Professional theater critics often see over 200 shows a year. The most respected critics do not just say whether a show is "good" or "bad" — they explain *why*, which is exactly what your counselor will want to discuss with you.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Reading a Play vs. Watching One" >}}
Reading a play is a different skill than watching one. When you read, you have to imagine everything — the set, the costumes, the actors' expressions. Here is how to get the most out of reading a play:

- **Read the stage directions carefully.** They tell you what the playwright envisioned.
- **Read dialogue out loud.** It was written to be spoken, and you will catch rhythms and emotions you would miss reading silently.
- **Pause between acts.** Give yourself time to process what happened, just like an intermission.
- **Visualize the stage.** Picture where the characters are standing, what the room looks like, and how the lights might change.
{{< /drg/be-prepared >}}

### Explore More Resources

{{< drg/external-link title="TDF — Theatre Development Fund" url="https://www.tdf.org/" description="A nonprofit that makes theater accessible and affordable, with discount ticket programs and educational resources." >}}

{{< drg/external-link title="Playscripts, Inc." url="https://www.playscripts.com/" description="Browse thousands of plays for reading or production, with synopses and samples to help you choose." >}}

{{< drg/image src="images/scout-writing-review.avif" alt="A Scout sitting in a library with an open play script and a notebook, writing a review with a pencil, bookshelves visible in the background" >}}

{{< drg/next-page text="Now that you have experienced plays as an audience member" teaser="It is time to step into the playwright's shoes and write your own one-act play." url="/merit-badges/theater/guide/req2/" >}}
