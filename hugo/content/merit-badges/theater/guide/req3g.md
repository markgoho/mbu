...
Stage lights (called "instruments") come in several types, each designed for a specific purpose. You will learn more about spotlights, floodlights, and the lighting control board in [Requirement 5](/merit-badges/theater/guide/req5/), but here is a practical overview:
...
{{< drg/did-you-know >}}
Before electric lights were invented in the late 1800s, theaters used candles, oil lamps, and gas lamps to light the stage. The term "limelight" comes from an actual technique where a block of lime (calcium oxide) was heated until it glowed white-hot, producing an intensely bright light used to spotlight performers.
{{< /drg/did-you-know >}}

{{< drg/image src="images/lighting-instruments.avif" alt="Various stage lighting instruments hanging from a lighting pipe above a stage, including an ellipsoidal, a fresnel, and LED fixtures, with colored gel frames visible" >}}
...
{{< drg/safety-first >}}
Working with stage lighting means working at height and with electricity. Never climb a ladder without a spotter. Always use safety cables on every instrument in case a clamp fails. Never touch a lighting instrument that has been on — they get extremely hot. Turn off circuits before making any electrical connections. Wear gloves when handling instruments.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
If you are designing the lighting, start by reading the script and marking every moment where the lighting needs to change — a new scene, a time shift, a mood change, a special effect. This list becomes your "cue sheet" and is the foundation of your entire design.
{{< /drg/tip >}}
...
{{< drg/external-link title="USITT — Lighting Design" url="https://www.usitt.org/" description="Resources for student and professional lighting designers from the United States Institute for Theatre Technology." >}}

{{< drg/external-link title="ETC Learning Center" url="https://www.etcconnect.com/Support/Training/" description="ETC is a leading manufacturer of stage lighting equipment and offers free training resources and tutorials." >}}

{{< drg/image src="images/lighting-board-operator.avif" alt="A teenager sitting at a computerized lighting control board in a darkened theater booth, the stage visible through a window with colorful lighting on the set" >}}

{{< drg/next-page text="Light creates the mood and focus of a production" teaser="Sound design adds another invisible layer — the music, effects, and audio that bring the show to life." url="/merit-badges/theater/guide/req3h/" >}}
