...
req_number: "3b"
prev: "/merit-badges/theater/guide/req3a/"
prev_title: "Acting"
next: "/merit-badges/theater/guide/req3c/"
next_title: "Set Design"
---
...
{{< drg/tip >}}
If you wrote your own play for Requirement 2, directing it is a natural next step. You already know the story inside and out, which gives you a head start. Just remember that once actors bring their own ideas to your words, the play may evolve in ways you did not expect — and that is a good thing.
{{< /drg/tip >}}
...
{{< drg/checklist title="Rehearsal Timeline" subtitle="A sample schedule working backward from performance day" >}}
...
{{< drg/image src="images/director-giving-notes.avif" alt="A teenage director sitting in the front row of an auditorium, notebook in hand, giving notes to actors standing on stage" >}}
...
Use simple shorthand in your script to record blocking: "X DSR" means "cross to downstage right." You will learn more about these stage directions in [Requirement 5](/merit-badges/theater/guide/req5/).
...
{{< drg/did-you-know >}}
The role of the theater director as we know it today is actually quite modern. Before the late 1800s, plays were usually staged by the lead actor or the playwright. The first person widely recognized as a modern director was the Duke of Saxe-Meiningen in Germany, who insisted on unified artistic vision and realistic staging in the 1870s.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="An Actor Is Not Prepared" >}}
What if someone shows up on performance day still shaky on their lines or blocking?

- **Stay calm.** Your energy sets the tone for the whole cast.
- **Run the rough spots.** Use your warm-up time to quickly review the actor's most challenging scenes.
- **Assign a buddy.** Pair the struggling actor with a confident scene partner who can subtly guide them.
- **Remind them that imperfection is okay.** The audience does not know the script. A live performance has its own energy that covers a lot of rough edges.
{{< /drg/be-prepared >}}

### Explore More Resources

{{< drg/external-link title="Stage Directions Magazine" url="https://www.stage-directions.com/" description="Practical articles on directing, stage management, and technical theater for community and school productions." >}}

{{< drg/image src="images/blocking-diagram.avif" alt="A hand-drawn blocking diagram on graph paper showing a stage layout with arrows indicating actor movements, character initials, and furniture placement" >}}

{{< drg/next-page text="Directing brings actors to life on stage" teaser="Now explore how set design creates the world they inhabit." url="/merit-badges/theater/guide/req3c/" >}}
