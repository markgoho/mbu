...
req_number: "3e"
prev: "/merit-badges/theater/guide/req3d/"
prev_title: "Req 3d — Costume Design"
next: "/merit-badges/theater/guide/req3f/"
next_title: "Req 3f — Scenery Building"
---
...
{{< drg/safety-first >}}
Always use makeup products designed for skin use. Never apply adhesives or latex near the eyes without proper training. Do a patch test on a small area of skin before applying any new product to check for allergic reactions. Remove all makeup thoroughly after use with proper makeup remover — never sleep in stage makeup.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/makeup-application.avif" alt="A teenager applying stage makeup to a friend's face at a makeup table with a lighted mirror, makeup brushes and palettes visible" >}}
...
{{< drg/tip >}}
When making up as a historical figure, focus on the two or three features people recognize most. Abraham Lincoln's beard and angular face. Cleopatra's bold eye makeup. Benjamin Franklin's round glasses and receding hairline. Capture those signature elements and the audience will know who you are.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The classic "Bride of Frankenstein" hairstyle — that towering streak of white in dark hair — was created for the 1935 film by building a wire frame covered with hair. Stage versions of this look use the same basic technique today, proving that some theatrical inventions never go out of style.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Makeup Kit Essentials" subtitle="Basic supplies for theater makeup" >}}
...
{{< drg/external-link title="Stage Makeup Online" url="https://www.stagemakeup.com/" description="Tutorials and product guides specifically designed for theater makeup applications." >}}

{{< drg/image src="images/character-makeup-comparison.avif" alt="A split image showing a teenager before and after stage makeup application as a historical figure, demonstrating the transformation" >}}

{{< drg/next-page text="With makeup, you transform the actor" teaser="Scenery building transforms the stage itself — learn how to build the physical world of a play." url="/merit-badges/theater/guide/req3f/" >}}
