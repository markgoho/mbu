...
req_number: "5b"
req_path: "5.b"
prev: "/merit-badges/exploration/guide/req5a/"
prev_title: "Req 5a — Visit an Exploration Organization"
next: "/merit-badges/exploration/guide/req6/"
next_title: "Req 6 — Plan an Expedition That Works"
---
...
{{< drg/checklist title="Questions to Ask During a Visit" subtitle="Use these to gather useful notes" >}}
...
{{< drg/be-prepared title="If You Visit Online Instead of In Person" >}}
Use the visit almost like a guided tour.

- **Take notes while you watch** rather than trying to remember later.
- **Write down the names of instruments or programs** you hear mentioned.
- **Pause and summarize** the facility's main purpose in one sentence before moving on.
  {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have seen how real organizations and facilities support discovery."
    teaser="Next, learn the planning steps that turn curiosity into a safe, successful expedition."
