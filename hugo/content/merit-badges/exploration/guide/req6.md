---
title: "Plan an Expedition That Works"
layout: "guide"
group_title: "6. Planning the Mission"
req_number: "6"
req_path: "6"
prev: "/merit-badges/exploration/guide/req5b/"
prev_title: "Visit a Research Facility"
next: "/merit-badges/exploration/guide/req7/"
next_title: "Prepare for the Real Thing"
---
...
{{< drg/video
    title="EXPEDITIONS | How to Get Started! (video)"
    url="https://www.youtube.com/watch?v=80_ltIRYjd0" >}}

## Requirement 6b

{{< drg/inherited-requirement number="6b" req_path="6.b" topic="Plan the mission. Create an expedition agenda or schedule. List potential documents or permits needed." />}}
...
{{< drg/video
    title="How to Plan an Expedition (video)"
    url="https://www.youtube.com/watch?v=qcLKcFrnzlk&t=8s" >}}

{{< drg/video
    title="Plan Your DREAM ADVENTURE: Expert Tips From a Pro Expedition Leader (video)"
    url="https://youtu.be/WahqTpIFAhs?si=lGt65nOwLExTvtbJ" >}}

{{< drg/video
    title="How to Plan an Adventure | Plan a Camping Trip (video)"
    url="https://youtu.be/79WYqkiExZU?si=eSNcCQUrJ53JlcRL" >}}

## Requirement 6c

{{< drg/inherited-requirement number="6c" req_path="6.c" topic="Budget and plan for adequate financial resources. Estimate costs for travel, equipment, accommodations, meals, permits or licenses, and other expedition expenses." />}}
...
{{< drg/video
    title="How to Plan for Permits and Reservations (video)"
    url="https://youtu.be/nup-uvbAfuU?si=CeutkSlZvOuJ81hU" >}}

## Requirement 6d

{{< drg/inherited-requirement number="6d" req_path="6.d" topic="Determine equipment and supplies required for personal and mission needs for the length of the expedition." />}}
...
{{< drg/tip >}}
Split equipment into two lists: "personal safety and comfort" and "mission objective." That keeps your planning honest and helps you explain each item to your counselor.
{{< /drg/tip >}}

## Requirement 6e

{{< drg/inherited-requirement number="6e" req_path="6.e" topic="Determine communication and transportation needs. Plan how to keep in contact with your base or the outside world, and determine how you will communicate with each other on-site." />}}
...
{{< drg/inherited-requirement number="6f" req_path="6.f" topic="Establish safety and first aid procedures (including planning for medical evacuation). Identify the hazards that explorers could encounter on the expedition, and establish procedures to prevent or avoid those hazards." />}}
...
{{< drg/safety-first >}}
Never treat safety as the final item you think about after the fun parts are finished. Safety planning belongs at the center of expedition planning from the beginning because route choice, timing, gear, and team size all depend on it.
{{< /drg/safety-first >}}

{{< drg/video
    title="Wilderness Primary Care Kit Walkthrough | Essential Expedition Essentials Medical Kit Guide (video)"
    url="https://www.youtube.com/watch?v=A-pbC5aDBY0" >}}

## Requirement 6g

{{< drg/inherited-requirement number="6g" req_path="6.g" topic="Determine team selection. Identify who is essential for the expedition to be successful and what skills are required by the expedition leader." />}}
...
{{< drg/video
    title="Flight of the Osprey Media Team Selection (video)"
    url="https://youtu.be/pDJHtE3BB_c?si=W6oyFePTcGnXQSM1" >}}

## Requirement 6h

{{< drg/inherited-requirement number="6h" req_path="6.h" topic="Establish detailed recordkeeping (documentation) procedures. Plan the interpretation and sharing of information at the conclusion of the expedition." />}}
...
{{< drg/external-link
    title="The 7 Fundamentals of Documenting Your Travels (website)"
    url="https://matadornetwork.com/notebook/the-7-fundamentals-of-documenting-your-travels/"
    description="Offers practical ideas for recording what happens so you can share a clear story and useful evidence afterward." >}}

{{< drg/image src="images/expedition-planning-board.avif" alt="Expedition planning board organizing route, schedule, budget, hazards, gear, and team roles in one layout" >}}
...
{{< drg/next-page
    text="You now have the full planning framework for a real expedition."
    teaser="Next, use those planning steps to prepare for an actual exploration activity with qualified adult supervision."
