...
req_number: "8"
req_path: "8"
prev: "/merit-badges/exploration/guide/req7/"
prev_title: "Req 7 — Prepare for the Real Thing"
next: "/merit-badges/exploration/guide/req9/"
next_title: "Req 9 — Choose Your Next Path"
---
...
{{< drg/tip >}}
Your best expedition notes usually come from short, frequent observations. Write a little every time you stop instead of trying to remember everything at the end of the day.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    description="A quick introduction to the habits that help explorers reduce their impact on the places they study and enjoy." >}}

{{< drg/video
    title="Leave No Trace Outdoor Ethics (video)"
    url="https://youtu.be/jXO1uY0MvmQ?si=_UhIOYBkw69c87ug" >}}

{{< drg/safety-first >}}
Ethics and safety often work together. Staying on appropriate routes, respecting closures, and following local rules protects both the environment and the people on the expedition.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Post-Expedition Report Must Include" subtitle="Make sure your report covers every required element" >}}
...
{{< drg/be-prepared title="Do Not Hide Problems in Your Report" >}}
Explorers learn from setbacks.

- **If weather limited your data**, say that.
- **If the route changed**, explain why.
- **If you reached only part of the objective**, describe what you would do differently next time.
  {{< /drg/be-prepared >}}

{{< drg/image src="images/expedition-report-layout.avif" alt="Two-page expedition report layout showing objectives, notes, map, findings, problems, and conclusion" >}}
...
{{< drg/next-page
    text="You have completed the expedition cycle from planning to final report."
    teaser="Next, look ahead and decide whether exploration might become a career or a long-term hobby."
