...
{{< drg/inherited-requirement number="7a" req_path="7.a" topic="Make your preparations under the supervision of a trained expedition leader, expedition planner, or other qualified adult experienced in exploration (such as a school science teacher, museum representative, or qualified instructor)." />}}
...
{{< drg/tip >}}
When you meet with your supervising adult, bring a draft objective, draft schedule, and draft gear list. The more prepared you are, the more useful their feedback will be.
{{< /drg/tip >}}
...
{{< drg/checklist title="Pre-Expedition Preparation Checklist" subtitle="Make sure your plan is ready before you go" >}}
...
{{< drg/external-link
    title="Scouting America SAFE Checklist (PDF)"
    url="https://www.scouting.org/wp-content/uploads/2021/06/680-11421_SAFE.pdf"
    description="A practical checklist for reviewing supervision, assessment, fitness, and skill before your expedition begins." >}}

{{< drg/safety-first >}}
If your pre-expedition check reveals that a route is too risky, the weather window is poor, or your group lacks an important skill, the right answer is to change the plan. Responsible explorers do not force a mission to happen just because it was scheduled.
{{< /drg/safety-first >}}

{{< drg/image src="images/scout-safe-checklist-review.avif" alt="Scout and adult leader reviewing a SAFE checklist, route map, and gear before an expedition" >}}
...
{{< drg/next-page
    text="Your planning is now connected to a real, supervised expedition."
    teaser="Next, carry out the mission, apply outdoor ethics, and record what happens so you can report it afterward."
