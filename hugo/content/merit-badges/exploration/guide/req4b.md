...
req_number: "4b"
req_path: "4.b"
prev: "/merit-badges/exploration/guide/req4a/"
prev_title: "Req 4a — Profile a Living Explorer"
next: "/merit-badges/exploration/guide/req4c/"
next_title: "Req 4c — Explore Discovery in the Lab"
---
...
{{< drg/external-link
    title="Mars 2020: Perseverance Rover (website)"
    url="https://science.nasa.gov/mission/mars-2020-perseverance/"
    description="NASA's mission page explains the rover's objectives, instruments, milestones, and major findings in one place." >}}
...
{{< drg/video
    title="Expedition Amazon - Into the Waters | National Geographic (video)"
    url="https://youtu.be/Tg27pdTvG4s?si=5MzaADOB_JRPdB2B" >}}
...
{{< drg/be-prepared title="Keep Your Report Focused" >}}
When you present this requirement:

- **Do not tell the whole history of the field.**
- **Do explain one mission clearly from start to finish.**
- **End by stating what scientists know now that they did not know before.**
  {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have a framework for explaining a scientific expedition clearly."
    teaser="Next, see how exploration also happens in labs, observatories, and research facilities."
