---
title: "What Counts as Exploration"
layout: "guide"
group_title: "1. Foundations of Exploration"
req_number: "1"
req_path: "1"
prev: "/merit-badges/exploration/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/exploration/guide/req2/"
next_title: "The Story of Human Discovery"
---
...
- **Purpose** — you are trying to answer a question or reach an objective.
- **Unfamiliarity** — the place, topic, or process is new to you or not fully understood.
- **Evidence** — you collect notes, samples, measurements, images, or other observations.
- **Documentation** — you record and share what happened so others can learn from it.
...
{{< drg/checklist title="Exploration or Just an Adventure?" subtitle="Use these clues to tell the difference" >}}
...
{{< drg/tip >}}
When you talk with your counselor, do not focus only on whether a trip feels hard or remote. Focus on the mission. A difficult hike without a discovery goal is still recreation. A carefully designed visit to a lab to study a new instrument can absolutely count as exploration thinking.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="What's the Difference Between Adventure and Exploration? (website)"
    url="https://medium.com/@idee-explores/whats-the-difference-between-adventure-and-exploration-eb1a4628f925"
    description="A short comparison that helps you separate personal adventure from mission-driven exploration." >}}
...
{{< drg/did-you-know >}}
Some of the most important exploration tools never leave the ground. Mission control rooms, clean labs, and data centers are where huge discoveries are often confirmed.
{{< /drg/did-you-know >}}
...
{{< drg/video
    title="What Is Exploration (video)"
    url="https://www.youtube.com/watch?v=7u2QqMSjroQ" >}}
...
{{< drg/next-page
    text="Now you know what exploration is — and what it is not."
    teaser="Next, trace how exploration shaped history, science, and the way people understand the world."
