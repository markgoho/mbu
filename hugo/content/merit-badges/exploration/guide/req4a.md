...
{{< drg/checklist title="A Strong Explorer Presentation Includes" subtitle="Use this to organize your notes" >}}
...
{{< drg/tip >}}
If you give a presentation to your unit, use fewer facts and stronger visuals. Your goal is not to read a long paper out loud. Your goal is to make other Scouts care about the mission.
{{< /drg/tip >}}
...
{{< drg/video
    title="50 Years of Discovery | Jane Goodall and The Leakey Foundation (video)"
    url="https://www.youtube.com/watch?v=I4ivrfIOKjw" >}}

{{< drg/video
    title="The World's Greatest Living Explorer | Ranulph Fiennes (video)"
    url="https://youtu.be/ePOa2OpRQ2g?si=uN7djyhK_Zylurjq" >}}

{{< drg/video
    title="Levison Wood / Walking the Nile / Himalayas / Americas / Arabia Badlands & Beyond (video)"
    url="https://youtu.be/MkOV5Ex6puA?si=aq81Mw_U2hC6LRnl" >}}

{{< drg/video
    title="Unsung Heroes of Everest | Nat Geo Live (video)"
    url="https://youtu.be/ihmfkdEcDyk?si=2aIG3YmL5YzTaVhC" >}}
...
{{< drg/image src="images/living-explorer-presentation-board.avif" alt="Scout presentation display showing a living explorer's route map, timeline, and expedition highlights" >}}

If you would rather focus on a mission than a person, the next page may be a better fit.

{{< drg/next-page
    text="You now know how to build a strong profile of a living explorer."
    teaser="Next, look at a full scientific expedition and explain how its objectives led to real discoveries."
