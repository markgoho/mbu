...
{{< drg/safety-first >}}
Water exploration demands strict planning. Weather, currents, cold exposure, equipment failure, and distance from shore can turn a small problem into an emergency very quickly. Real expeditions rely on training, communication plans, and backup procedures.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Only a small percentage of the seafloor has been mapped in high detail. Even on our own planet, there are still major places and processes we do not fully understand.
{{< /drg/did-you-know >}}

{{< drg/image src="images/exploration-domains-collage.avif" alt="Four-panel comparison of ocean, space, field, and laboratory exploration settings with the tools used in each" >}}
...
{{< drg/next-page
    text="Start by defining the word clearly"
    teaser="Learn what makes exploration different from adventure travel, hiking, and sightseeing."
    url="/merit-badges/exploration/guide/req1/" >}}
