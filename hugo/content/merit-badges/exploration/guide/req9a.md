...
{{< drg/external-link
    title="Ocean Exploration Careers (website)"
    url="https://oceanexplorer.noaa.gov/careers/"
    description="Introduces a wide range of ocean exploration careers and shows that missions depend on many different kinds of professionals." >}}

{{< drg/video
    title="Unlocking Space Careers: Beyond Astronauts and Rocket (video)"
    url="https://youtu.be/ljlpqd1Mjjs?si=V3Yaz18BvlIVnDpQ" >}}

{{< drg/video
    title="How I Became a Researcher (video)"
    url="https://youtu.be/vOhyZ8FYCmw?si=9XLnEqu1IJIin0CH" >}}

## Best Research Methods

A career page or salary site can help, but the strongest answers usually combine sources.

{{< drg/checklist title="Strong Career Research Mix" subtitle="Use more than one method if you can" >}}
...
{{< drg/tip >}}
One of the smartest questions you can ask a professional is, "What does this career look like on an ordinary day, not the most exciting day?" That answer often tells you more than a glossy brochure.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You now know how to research an exploration-related profession in a realistic way."
    teaser="Next, explore how the skills from this badge could grow into a long-term hobby with short-term and long-term goals."
