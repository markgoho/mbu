...
{{< drg/tip >}}
A great way to explain this to your counselor is to say that field exploration finds patterns in the real world, while lab exploration helps test why those patterns happen.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Research Scientist (video)"
    url="https://www.youtube.com/watch?v=uRreC41dGz4" >}}

{{< drg/video
    title="Inside the World's Largest Science Experiment (video)"
    url="https://youtu.be/nrXhK3Gh5EE?si=xSgNbNGvMNmaBl22" >}}

{{< drg/video
    title="Day in the Life of a Research Scientist (video)"
    url="https://www.youtube.com/watch?v=biS7e79xZcs" >}}
...
{{< drg/did-you-know >}}
Some discoveries are only possible because field teams and lab teams work together. A sample collected outdoors may not reveal its full value until it is analyzed later with powerful instruments indoors.
{{< /drg/did-you-know >}}

{{< drg/image src="images/lab-and-field-comparison.avif" alt="Split comparison showing outdoor field data collection alongside indoor laboratory analysis of samples" >}}
...
{{< drg/next-page
    text="You can now explain how a laboratory can be a true place of exploration."
    teaser="Next, choose whether to learn from an exploration organization or from a research facility."
