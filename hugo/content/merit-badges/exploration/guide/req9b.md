...
{{< drg/video
    title="Ready to Dive Into the Adventure of a Lifetime? Become a PADI Scuba Diver (video)"
    url="https://youtu.be/XTeCkxJkUuE?si=VmbO1gpifOVW0QBF" >}}

{{< drg/video
    title="Astronomy for Beginners (video)"
    url="https://youtu.be/XLgPe_f-QCc?si=d_gbZFB7Spvr-vog" >}}

{{< drg/video
    title="Permanent Orienteering Course (video)"
    url="https://youtu.be/y4yfyUwkUxw?si=zGblxCqx7N5R4_W9" >}}
...
{{< drg/checklist title="Set Goals for the Hobby" subtitle="Use one short-term goal and one long-term goal" >}}
...
{{< drg/tip >}}
Choose a hobby that fits your real life. A hobby you can practice regularly with the time, money, and access you actually have is more valuable than a dream hobby you can almost never do.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have now looked at both professional and personal paths beyond the badge."
    teaser="Finish with a few deeper ideas, real-world experiences, and organizations that can keep your explorer mindset growing."
    url="/merit-badges/exploration/guide/extended-learning/" >}}
