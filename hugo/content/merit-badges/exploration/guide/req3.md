...
{{< drg/inherited-requirement number="3a" req_path="3.a" topic="Why it is important for exploration to have a scientific basis" />}}
...
{{< drg/video
    title="What It Takes to Be an Adventurer (video)"
    url="https://www.youtube.com/watch?v=aoq6jNBtNtw" >}}

## Requirement 3b

{{< drg/inherited-requirement number="3b" req_path="3.b" topic="How explorers have aided in our understanding of our world" />}}
...
- **They reveal what exists** — species, landforms, patterns, or processes.
- **They connect places and systems** — oceans influence climate, forests influence water, dust in one region can affect ecosystems in another.
- **They test ideas** — a mission can support or challenge an earlier theory.
- **They share evidence** — reports, maps, samples, and data help future teams go farther.

{{< drg/did-you-know >}}
Many discoveries that seem sudden are really the result of years of exploration records built by many different teams. Big breakthroughs often stand on small, careful observations collected over time.
{{< /drg/did-you-know >}}

{{< drg/video
    title="Why We Explore (video)"
    url="https://www.youtube.com/watch?v=6_SRZiU9EuI" >}}

## Requirement 3c

{{< drg/inherited-requirement number="3c" req_path="3.c" topic="What you think it takes to be an explorer." />}}
...
{{< drg/checklist title="What Makes an Explorer" subtitle="Use these points in your discussion with your counselor" >}}

- **Curious enough to ask real questions**
...
{{< drg/video
    title="Why Great Scientists Ask Great Questions? w/ Neil deGrasse Tyson (video)"
    url="https://youtu.be/1B9q2eS78Tw?si=BM2e4T2u7pBcTTXq" >}}
...
{{< drg/next-page
    text="You have built the case for why exploration matters."
    teaser="Now choose a real-world path: study a living explorer, a scientific expedition, or the work of a research lab."
