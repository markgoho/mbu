...
1. **People notice a mystery.** There is something they do not understand.
2. **They build tools.** Better ships, sensors, microscopes, submersibles, or software make new observations possible.
3. **They gather evidence.** Maps, samples, measurements, photos, and records start replacing guesses.
4. **The field changes.** New evidence leads to new questions, better models, and sometimes entirely new branches of science.
...
{{< drg/checklist title="Good Fields for This Requirement" subtitle="Choose one that gives you a clear discovery story" >}}
...
{{< drg/tip >}}
If you are not sure which field to choose, pick one that connects to Requirement 4 or Requirement 9. That way your report, discussion, and future-interest pages can build on each other instead of starting from scratch each time.
{{< /drg/tip >}}
...
{{< drg/video
    title="50 Years of Space Exploration (video)"
    url="https://youtu.be/Bj3n1BIq_5I?si=v6V_FbNTqTU5P4FF" >}}
...
{{< drg/video
    title="Into the Abyss: How Humans Became the Astronauts of the Deep Sea (video)"
    url="https://youtu.be/-7xB6BT13nw?si=guCs4QMUPYQPiixG" >}}
...
{{< drg/video
    title="The Age of Exploration (video)"
    url="https://www.youtube.com/watch?v=sGeXtUZQScc" >}}
...
{{< drg/video
    title="How the Higgs Boson Was Discovered (video)"
    url="https://youtu.be/1XpCnCVfuYk?si=XrohO26RBxWr9Epg" >}}

{{< drg/be-prepared title="Counselor Conversation Strategy" >}}
When you discuss your chosen field:

- **State the field clearly**: "I chose oceanography."
- **Name the mystery**: "People wanted to know what existed in the deep ocean."
- **Give two or three examples**: missions, discoveries, or tools.
- **End with impact**: explain how those discoveries changed the field.
  {{< /drg/be-prepared >}}

The next requirement asks a bigger question: not just how exploration happened, but why it matters at all.

{{< drg/next-page
    text="You have traced how discovery changed entire fields of study."
    teaser="Now think about why exploration matters — and what makes it valuable to science and society."
