...
req_number: "3b"
prev: "/merit-badges/basketry/guide/req3a/"
prev_title: "Square Basket"
next: "/merit-badges/basketry/guide/req3c/"
next_title: "Campstool Seat"
---
...
- **Size:** A 5- to 7-inch diameter base with 3- to 4-inch walls is a manageable first round basket.
- **Materials:** Round reed for spokes (sizes #3 to #6 are common) and round or flat reed for weavers (a size or two thinner than the spokes).
- **Number of spokes:** An odd number works best for simple weave — this ensures the over-under pattern alternates on each round. Start with 7 or 9 spokes.

{{< drg/tip >}}
If you use an even number of spokes, the simple weave pattern will not alternate properly — you will end up going over the same spokes every row. Either use an odd number or switch to a twining weave, which works with any number.
{{< /drg/tip >}}

### Materials You Will Need

{{< drg/checklist title="Round Basket Supply List" subtitle="What to gather" >}}
...
{{< drg/image src="images/round-basket-base-cross.avif" alt="Close-up of a round basket base showing spokes arranged in a cross pattern at the center, with the first few rows of weaving visible" >}}
...
{{< drg/safety-first >}}
The ends of round reed spokes can be sharp, especially after cutting. Be careful when handling the base — the spokes sticking outward are at finger and eye level. Consider wearing safety glasses when working close to exposed spoke ends.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/round-basket-in-progress.avif" alt="Hands weaving a round basket showing the curved walls rising from the base, with clothespins holding spokes in place" >}}

{{< drg/tip >}}
Take a step back after every few rows and look at your basket from the side. Is it symmetrical? Are the walls rising evenly? Spotting problems early is much easier than fixing them later.
{{< /drg/tip >}}
...
| Feature | Square Basket | Round Basket |
|---------|--------------|--------------|
| Base construction | Flat grid of interlocking strips | Spokes radiating from a center cross |
| Primary material | Flat reed | Round reed (spokes) with round or flat weavers |
| Wall shape | Straight sides, sharp corners | Curved walls, no corners |
| Weave pattern | Usually plain weave | Often starts with twining, then plain weave |
| Difficulty | Beginner | Intermediate |

{{< drg/did-you-know >}}
The word "wicker" actually refers to the weaving technique, not the material. A wicker basket can be made from willow, rattan, reed, or even synthetic materials — what makes it "wicker" is the round-spoke-and-weaver construction method.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Basket Weaving 101 — Round Reed Basics"
    url="https://www.jfreedmanbasketry.com/"
    description="Jill Freedman's basketry site with instructional content on traditional round basket techniques." >}}

{{< drg/next-page
    text="Two projects down, one to go."
    teaser="Your final project is different from anything you have woven so far — a campstool seat that must support real weight."
