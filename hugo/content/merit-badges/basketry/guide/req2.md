...
{{< drg/did-you-know >}}
The oldest known baskets are coiled fragments found in Guitarrero Cave in Peru, dating back roughly 10,000 to 12,000 years. That means people were weaving baskets thousands of years before they started making pottery.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/basket-type-comparison.avif" alt="Four baskets in a 2x2 grid showing plaited, coiled, wicker, and ribbed styles, each clearly labeled" >}}

{{< drg/tip >}}
When identifying a basket, start by looking at the base. Plaited baskets have a flat, woven grid. Coiled baskets show a tight spiral. Wicker baskets have spokes radiating outward. Ribbed baskets have hoop frames. The base tells the story of how the basket was built.
{{< /drg/tip >}}
...
{{< drg/image src="images/weave-types-illustrated.avif" alt="Three weave patterns shown side by side — simple (plain) weave, twill weave, and twining — each with a clear cross-section view and label" >}}

{{< drg/external-link
    title="North Carolina Basketmakers Association"
    url="https://ncbasketmakers.com/"
    description="A community of basket weavers with resources on techniques, workshops, and basket styles." >}}

{{< drg/external-link
    title="The Caning Shop — Basketry Supplies and Tutorials"
    url="https://caning.com/"
    description="A long-running resource for basketry materials, kits, and instructional content." >}}

{{< drg/next-page
    text="You can now identify basket types and describe weaving techniques."
    teaser="Put that knowledge to work — it is time to plan and weave your first project: a square basket."
