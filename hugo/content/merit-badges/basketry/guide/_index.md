...
{{< drg/image src="images/scout-weaving-basket.avif" alt="A Scout sitting at a picnic table outdoors weaving a reed basket, with supplies like a bucket of water and reed bundles nearby" >}}
...
{{< drg/image src="images/plaited-basket-closeup.avif" alt="Close-up of a plaited basket showing the over-under checkerboard weave pattern with flat reed strips" >}}
...
{{< drg/did-you-know >}}
Some coiled baskets made by Native American weavers are so tightly constructed that they can hold water without any sealant. The Tohono O'odham people of the American Southwest are especially known for this remarkable skill.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/four-basket-types.avif" alt="Four baskets arranged in a row showing plaited, coiled, wicker, and ribbed styles, each labeled" >}}

{{< drg/tip >}}
A quick way to tell the four types apart: look at the structure. Plaited baskets have flat strips in a grid. Coiled baskets spiral outward from the center. Wicker baskets have spokes with weavers going in and out. Ribbed baskets have a hoop frame filled in between the ribs.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have explored the history and types of basketry."
    teaser="Learn about the tools and hazards you will encounter — and how to stay safe while weaving."
    url="/merit-badges/basketry/guide/req1/" >}}
