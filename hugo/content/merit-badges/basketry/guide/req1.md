...
{{< drg/safety-first >}}
Always inspect your tools before you begin. Make sure cutting tools are sharp — a dull blade requires more force, which increases the chance of slipping. Keep tools organized on your work surface so you always know where the sharp ones are.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/basketry-tools-labeled.avif" alt="Common basketry tools laid out on a workbench — reed cutters, awl, craft knife, spray bottle, and packing tool — each labeled" >}}
...
{{< drg/checklist title="The Four Steps" subtitle="How to handle basketry hazards" >}}
...
{{< drg/tip >}}
Set up your workspace before you start weaving. Place your tools on one side, your materials on the other, and keep a towel handy for drying your hands. A well-organized workspace is your best defense against accidents.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Cut or Scrape from a Tool" >}}
- **Stop the bleeding.** Apply gentle pressure with a clean cloth or gauze pad.
- **Clean the wound.** Rinse it under clean running water. Use soap around (not in) the wound to remove debris.
- **Apply antibiotic ointment.** A thin layer helps prevent infection.
- **Bandage it.** Cover with an adhesive bandage or sterile gauze secured with tape.
- **Watch for infection.** Over the next few days, look for increasing redness, swelling, warmth, or pus. If you see these signs, tell an adult and seek medical attention.
{{< /drg/be-prepared >}}

{{< drg/be-prepared title="Splinter from Reed" >}}
- **Clean the area** with soap and water.
- **Use tweezers** sterilized with rubbing alcohol to grasp the splinter as close to the skin as possible.
- **Pull it out** in the same direction it entered.
- **Clean again** and apply antibiotic ointment and a small bandage.
- If the splinter is deep, broken off, or you cannot remove it, see a medical professional.
{{< /drg/be-prepared >}}

{{< drg/safety-first >}}
Always have a first-aid kit at your workstation when doing basketry. At a minimum, it should include adhesive bandages, gauze pads, antiseptic wipes, antibiotic ointment, tweezers, and adhesive tape.
{{< /drg/safety-first >}}

{{< drg/image src="images/first-aid-kit-basketry.avif" alt="A small open first-aid kit on a work table next to basketry materials, showing bandages, tweezers, antiseptic wipes, and gauze" >}}

{{< drg/external-link
    title="Boy Scouts of America — First Aid Basics"
    url="https://www.scouting.org/health-and-safety/safety-moments/"
    description="Safety Moments from Scouting.org with tips on first aid, tool safety, and injury prevention." >}}

{{< drg/next-page
    text="Now that you know how to stay safe and treat injuries, it is time to learn about the craft itself."
    teaser="Discover the four main basket types and the weaving techniques that bring them to life."
