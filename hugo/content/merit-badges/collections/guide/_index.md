  ...
  - group_title: "Beyond the Badge"
    items:
      - title: "Extended Learning"
        url: "/merit-badges/collections/guide/extended-learning/"
---
...
{{< drg/image src="images/scout-examining-collection.avif" alt="A Scout sitting at a table examining items from a diverse collection with a magnifying glass, surrounded by organized display cases and albums" >}}
...
{{< drg/did-you-know >}}
The word "philately" — the study and collecting of stamps — comes from the Greek words *philos* (loving) and *ateleia* (tax-exempt). Postage stamps showed that the sender had already paid the delivery fee, making the letter "tax-free" for the recipient.
{{< /drg/did-you-know >}}

{{< drg/image src="images/cabinets-of-curiosities-to-modern.avif" alt="Split comparison: left side shows a Renaissance cabinet of curiosities with shells, minerals, and taxidermy; right side shows a modern collector's organized display with LED lighting, labeled cases, and a tablet for cataloging" >}}
...
{{< drg/tip >}}
You do not need an expensive collection to earn this badge. A collection of interesting rocks from family hikes, pressed pennies from tourist spots, or postcards from places you have visited all count. What matters is how you organize, preserve, and understand your collection.
{{< /drg/tip >}}

### Natural Specimens

Rocks, minerals, fossils, seashells, pressed flowers, and insects are all popular natural collections. If you have earned the [Geology](/merit-badges/geology/) merit badge, you already have a head start on mineral identification. Natural specimen collecting connects you to earth science, biology, and the outdoors.

{{< drg/safety-first >}}
Always follow local, state, and federal laws about collecting natural items. Many national parks and protected areas prohibit removing rocks, fossils, plants, or other specimens. Collect only where it is legal and ethical to do so.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/collection-variety-grid.avif" alt="A grid showing six types of collections: stamps in an album, coins in a display case, colorful mineral specimens, trading cards in protective sleeves, vintage comic books, and vinyl records on a shelf" >}}

{{< drg/next-page
    text="Now that you have a sense of how broad and exciting the world of collecting can be"
    teaser="learn how to write a compelling report about your own collection."
    url="/merit-badges/collections/guide/req1/" >}}
