...
- **Inventory management:** Numbers make your catalog ([Req 3d](/merit-badges/collections/guide/req3d/)) searchable and sortable
...
{{< drg/did-you-know >}}
The U.S. Mint marks coins with tiny letters indicating where they were made: "P" for Philadelphia, "D" for Denver, "S" for San Francisco, and "W" for West Point. Before 1979, Philadelphia coins had no mint mark at all — the absence of a mark *was* the mark.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Keep a reference for the identification marks specific to your hobby. Many collectors create a personal "cheat sheet" of the marks they encounter most often. As your knowledge grows, you will start spotting marks automatically — and occasionally catching items that sellers have misidentified.
{{< /drg/tip >}}
...
{{< drg/image src="images/identification-marks-closeup.avif" alt="A magnified close-up view showing identification marks on collectibles: a coin mint mark, a stamp catalog number, a hallmark on silver, and a serial number on a graded card slab, all labeled with arrows" >}}

{{< drg/external-link
    title="Online Encyclopedia of Silver Marks, Hallmarks & Maker's Marks"
    url="https://www.925-1000.com/"
    description="A comprehensive database of silver hallmarks and maker's marks from around the world — useful for identifying silver collectibles." >}}

{{< drg/next-page
    text="You can now read the identification marks that make each item unique"
    teaser="look ahead and plan the future of your collection."
