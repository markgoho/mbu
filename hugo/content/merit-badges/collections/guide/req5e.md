...
- **Events:** As you learned in [Req 3c](/merit-badges/collections/guide/req3c/), associations organize the major shows, conventions, and seminars
...
{{< drg/did-you-know >}}
The American Numismatic Association, founded in 1891, has a special membership tier for young collectors under 18. Their "Young Numismatists" program includes a free bi-monthly magazine, access to summer seminars, and exclusive events at national conventions.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Attending a local club meeting is one of the fastest ways to level up your collecting knowledge. Most clubs welcome visitors for free, and members are usually eager to help newcomers. Bring a few items from your collection — it is the best icebreaker.
{{< /drg/tip >}}
...
{{< drg/checklist title="Association Research" subtitle="Prepare this information for your counselor" >}}
...
{{< drg/image src="images/collector-club-meeting.avif" alt="A group of collectors of various ages gathered around a table at a local club meeting, examining items together, with display boards and a club banner in the background" >}}

{{< drg/external-link
    title="American Numismatic Association — Young Numismatists"
    url="https://www.money.org/young-numismatists"
    description="The ANA's youth program for collectors under 18, with free magazine, summer seminars, and convention programs." >}}

{{< drg/next-page
    text="You have identified the organizations that support your hobby"
    teaser="now learn about the identification numbers, series, and marks that make each item in your collection unique."
