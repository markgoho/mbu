...
{{< drg/tip >}}
Start with these columns: **Item Name**, **Date Acquired**, **Source**, **Condition/Grade**, **Estimated Value**, **Storage Location**, and **Notes**. You can always add more columns later as your system evolves.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The Library of Congress catalogs over 175 million items — books, maps, recordings, photographs, and manuscripts. Their classification system, developed in the late 1800s, is still in use today and forms the backbone of library organization worldwide.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Cataloging Essentials" subtitle="Every catalog entry should include" >}}
...
{{< drg/image src="images/cataloging-methods-comparison.avif" alt="An infographic showing three cataloging methods side by side: a physical notebook with handwritten entries, a spreadsheet on a laptop screen, and a mobile phone with a specialized collection app" >}}

{{< drg/external-link
    title="Numista — Free Online Coin Catalog"
    url="https://en.numista.com/"
    description="A free, community-driven platform for cataloging coins with detailed specifications and collector tools." >}}

{{< drg/next-page
    text="Your collection is now preserved, displayed, and cataloged"
    teaser="explore the financial side of collecting — investing, buying, and selling."
