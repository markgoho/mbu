...
{{< drg/tip >}}
Do not just memorize definitions — understand *why* each term matters. "Centering" is important because a perfectly centered card grades higher than an off-center one, which directly affects value. Context turns vocabulary from trivia into real knowledge.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The most expensive typo in philately history is the "Inverted Jenny" — a 1918 U.S. airmail stamp where the airplane was accidentally printed upside down. A sheet of 100 was sold at a post office before anyone noticed the error. Today, a single Inverted Jenny is worth over $1 million.
{{< /drg/did-you-know >}}

{{< drg/checklist title="Vocabulary Preparation" subtitle="Steps to get your 10 terms ready" >}}
...
{{< drg/image src="images/collector-terms-flashcards.avif" alt="A set of flashcards spread on a table, each showing a collector term on front and definition on back, with small illustrations — a coin showing obverse/reverse, a stamp showing perforations, a card showing centering" >}}

{{< drg/external-link
    title="PCGS — Coin Glossary"
    url="https://www.pcgs.com/glossary"
    description="A comprehensive glossary of coin collecting terms from one of the world's leading grading services." >}}

{{< drg/next-page
    text="With your vocabulary in place"
    teaser="organize your collection into groups and prepare to show them to your counselor."
