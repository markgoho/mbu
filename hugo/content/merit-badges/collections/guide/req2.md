...
{{< drg/did-you-know >}}
Professional coin collectors call the process of upgrading a collection "cherry-picking" — searching through dealers' inventory to find undergraded or underpriced coins that others have overlooked. It is one of the most satisfying skills a collector can develop.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Bring a timeline or a few "before and after" examples to your counselor meeting. Showing your earliest acquisitions alongside your most recent ones makes the growth visible and concrete.
{{< /drg/tip >}}

{{< drg/image src="images/collection-growth-timeline.avif" alt="An infographic showing the growth of a collection over time, with a horizontal timeline marking milestones: first item, first trade, first show attended, 50th item, first rare find" >}}
...
This log becomes the raw material for your counselor discussion — and it connects directly to the cataloging skills you will learn in [Req 3d](/merit-badges/collections/guide/req3d/).

{{< drg/external-link
    title="American Numismatic Association — Building a Collection"
    url="https://www.money.org/coin-collecting-basics"
    description="Practical advice on growing a coin collection — many principles apply to any type of collecting." >}}

{{< drg/image src="images/scout-comparing-items.avif" alt="A Scout holding two similar items side by side, comparing quality — one worn and one in excellent condition — with a magnifying glass nearby" >}}

{{< drg/next-page
    text="Now that you can tell the story of your collection's growth"
    teaser="learn how to protect and preserve what you have worked hard to build."
