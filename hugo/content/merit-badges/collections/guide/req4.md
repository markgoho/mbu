...
{{< drg/checklist title="Evaluating a Collection for Purchase" subtitle="Ask these questions before buying" >}}
...
{{< drg/image src="images/collector-evaluating-purchase.avif" alt="A Scout at a table examining a collection spread of coins or cards with a magnifying loupe, comparing items against a price guide book, with a notepad for recording assessments" >}}

{{< drg/be-prepared title="Avoiding Common Selling Mistakes" >}}
Selling a collection can be emotional, especially if you have spent years building it. Here are mistakes to avoid:

- **Rushing a sale** — take time to research current values and get multiple offers.
- **Selling everything to one buyer** — different buyers specialize in different items. You may get more by selling key pieces individually.
- **Ignoring fees** — online platforms charge listing fees, transaction fees, and shipping costs. Factor these into your pricing.
- **Accepting the first offer** — dealers expect negotiation. A polite counter-offer is normal.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="PSA — Price Guide & Population Reports"
    url="https://www.psacard.com/prices"
    description="Look up current market values for graded trading cards, with population data showing how many of each grade exist." >}}

{{< drg/next-page
    text="Now that you understand the financial side of collecting"
    teaser="build your collector vocabulary — the specialized terms every serious hobbyist should know."
