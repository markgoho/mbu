...
{{< drg/did-you-know >}}
Heritage Auctions, based in Dallas, Texas, is the world's largest collectibles auction house. They sell over $1 billion in coins, cards, comics, art, and memorabilia every year. Many of their specialists started as teenage collectors.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When researching your chosen career, try to find someone who actually does the job. A local museum curator, a dealer at a show, or an appraiser at a collector event can give you real-world insight that no website can match. Most professionals love talking about how they got started.
{{< /drg/tip >}}
...
{{< drg/checklist title="Career Research" subtitle="Cover these points for your chosen profession" >}}
...
{{< drg/image src="images/careers-in-collecting-montage.avif" alt="A montage showing four collecting career scenes: a museum curator arranging an exhibit, an appraiser examining an item with a loupe, an auctioneer at a podium, and a conservator carefully cleaning a historical artifact" >}}

{{< drg/external-link
    title="Bureau of Labor Statistics — Archivists, Curators, and Museum Workers"
    url="https://www.bls.gov/ooh/education-training-and-library/curators-museum-technicians-and-conservators.htm"
    description="Official career information including job outlook, median pay, and education requirements for museum and archival careers." >}}

{{< drg/next-page
    text="You have explored how collecting can become a career"
    teaser="dive deeper into the world of collecting with resources and experiences that go beyond the badge requirements."
