...
{{< drg/tip >}}
Write your goals down. Revisit them every six months. You will be surprised how much progress you make when you have clear targets. Some of the goals you set now will change completely — and that is fine. Growth is the point.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Warren Buffett, one of the world's most successful investors, started his journey as a stamp and coin collector when he was a kid. He credits his childhood collecting hobby with teaching him the fundamentals of valuation, patience, and spotting underpriced items.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="When Plans Change — and That's Okay" >}}
Your collection might take an unexpected turn. You might discover a sub-area you never knew existed at a show. A family member might give you a box of items in a completely different category. A friend might introduce you to a new hobby entirely. The best collectors stay curious and flexible. Having a plan does not mean being locked in — it means having a starting direction.
{{< /drg/be-prepared >}}

{{< drg/image src="images/collection-roadmap.avif" alt="An illustrated roadmap or path diagram showing a collector's journey from beginner to advanced, with milestone markers for first item, first set completed, first show attended, first specialty identified, and expert status" >}}

{{< drg/external-link
    title="American Philatelic Society — Getting Started"
    url="https://stamps.org/learn/getting-started"
    description="A comprehensive guide for new collectors on setting goals, building knowledge, and growing a collection thoughtfully." >}}

{{< drg/next-page
    text="You have a vision for your collection's future"
    teaser="now explore the career paths that turn collecting from a hobby into a profession."
