...
{{< drg/did-you-know >}}
The Tucson Gem and Mineral Show is so large that it takes over the entire city. More than 50 separate venues host exhibits and dealers across Tucson for two weeks every February, attracting collectors and dealers from over 50 countries.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Search for events in your area by looking up your hobby's national organization (you will identify these in [Req 5e](/merit-badges/collections/guide/req5e/)) and checking their event calendar. Many local clubs also post events on social media or hobby forums.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Making the Most of Your First Show" >}}
Walking into a big collector show can be overwhelming. Here is how to get the most out of it:

- **Bring a list** of items you are looking for so you stay focused.
- **Set a budget** before you arrive and stick to it.
- **Walk the whole show first** before buying — prices and quality vary from table to table.
- **Talk to dealers** — most love sharing knowledge and will teach you about their specialty.
- **Bring supplies** — a magnifying loupe, protective holders, and a bag to carry purchases safely.
{{< /drg/be-prepared >}}

{{< drg/image src="images/collector-show-floor.avif" alt="A wide view of a busy collector show floor with dealers at tables displaying items, attendees examining collections with magnifying glasses, and banner signs for different collecting categories" >}}

{{< drg/external-link
    title="American Numismatic Association — Events"
    url="https://www.money.org/events"
    description="Find coin shows, conventions, and seminars near you through the ANA's event calendar." >}}

{{< drg/next-page
    text="Events help you grow as a collector through community"
    teaser="but keeping your collection organized at home starts with a solid cataloging system."
