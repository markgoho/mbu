...
req_number: "9b"
req_path: "9.b"
prev: "/merit-badges/reptile-and-amphibian-study/guide/req9a/"
prev_title: "Req 9a — Listen for Frogs and Toads"
next: "/merit-badges/reptile-and-amphibian-study/guide/req9c/"
next_title: "Req 9c — Teach a Short Talk"
---
...
{{< drg/external-link
    ...
    description="Compare real reptile observations, range maps, and photos before or after your field visits." >}}

{{< drg/external-link
    title="Amphibians of the United States (website)"
    url="https://www.inaturalist.org/places/united-states#taxon=20978"
    description="Use observation photos and maps to narrow down likely amphibians in your region." >}}
...
{{< drg/checklist title="Habitats to Try" subtitle="Different places reveal different animals" >}}
...
{{< drg/tip >}}
If you are unsure, write “possible” in your notes and confirm later. Honest uncertainty is better than a wrong identification said with confidence.
{{< /drg/tip >}}
...
This option also works well with [Req 1](/merit-badges/reptile-and-amphibian-study/guide/req1/), since sketches or photos from that earlier requirement can strengthen your identifications here.

{{< drg/next-page
    text="You are ready to identify species by sight using real field marks instead of lucky guesses."
    teaser="Next, turn what you know into a short, clear talk for a small group using visual aids."
