---
title: "Care for a Captive Animal"
layout: "guide"
group_title: "8. Hands-On Observation"
req_number: "8a"
req_path: "8.a"
prev: "/merit-badges/reptile-and-amphibian-study/guide/req8/"
prev_title: "Choose Your Observation Project"
next: "/merit-badges/reptile-and-amphibian-study/guide/req8b/"
next_title: "Study an Animal in Captivity"
---
...
{{< drg/safety-first >}}
Do not take an animal from the wild unless your counselor specifically approves the method and it is legal in your area. Wild capture can harm local populations and may put the animal in stressful or unsafe conditions.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Daily or Regular Care Notes" subtitle="These notes make your counselor discussion much easier" >}}
...
{{< drg/external-link
    ...
    description="Use the journaling ideas here to keep detailed care notes, feeding records, and behavior observations over time." >}}
...
{{< drg/tip >}}
If you are observing eggs or larvae, record small changes often. Development can feel slow for days and then change quickly.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If the Animal Stops Eating or Acts Unusually" >}}
- **Check the basics first**: temperature, humidity, water, and recent habitat changes.
- **Review your notes**: unusual behavior sometimes begins before you realize it.
- **Contact the responsible adult or caretaker**: do not guess if there may be a health problem.
- **Follow veterinary guidance when needed**: this requirement includes understanding veterinary care needs, not pretending they do not exist.
{{< /drg/be-prepared >}}

{{< drg/next-page
    text="You know how to approach captive care as a recordkeeping and animal-welfare project, not just a hobby."
    teaser="Option 8b uses a different method: repeated visits to observe one animal in a professional or supervised setting."
