---
title: "Species Around You"
layout: "guide"
group_title: "1. Field Identification"
req_number: "2"
req_path: "2"
prev: "/merit-badges/reptile-and-amphibian-study/guide/req1/"
prev_title: "Identify Species in the Field"
next: "/merit-badges/reptile-and-amphibian-study/guide/req3/"
next_title: "Spot the Differences"
---
...
{{< drg/did-you-know >}}
The United States has far more salamander species than most people realize. In fact, the southern Appalachian region is one of the world's great salamander hotspots, with many species living in streams, leaf litter, and damp forests.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    title="Find Amphibian and Reptile Species in Your Area (website)"
    url="https://geonarrative.usgs.gov/amphibianreptileexplorer/"
    description="Use the USGS explorer to see which reptile and amphibian species are recorded in your state or region." >}}

{{< drg/external-link
    title="Reptiles of the United States (website)"
    url="https://www.inaturalist.org/places/united-states#taxon=26036"
    description="Study maps and recent observations to see which reptiles are regularly found near you." >}}

{{< drg/external-link
    title="Amphibians of the United States (website)"
    url="https://www.inaturalist.org/places/united-states#taxon=20978"
    description="Compare local amphibian observations, photos, and range information before you make your list." >}}
...
{{< drg/checklist title="A Strong Local Species List" subtitle="Organize it so you can actually use it with your counselor" >}}
...
{{< drg/tip >}}
Make two smaller lists instead of one giant one: common reptiles in your area and common amphibians in your area. That keeps the discussion clear and makes patterns easier to notice.
{{< /drg/tip >}}
...
{{< drg/image src="images/local-range-map-reptile-amphibian-study.avif" alt="Simplified United States map showing wetter amphibian-rich regions and warmer reptile-rich regions" >}}
...
This requirement also sets you up well for [Req 4](/merit-badges/reptile-and-amphibian-study/guide/req4/), where local protected and unprotected species matter.

{{< drg/next-page
    text="You now have a broad map of where reptiles and amphibians live and a practical list for your own area."
    teaser="Next, compare similar-looking groups so you can explain what really separates reptiles, amphibians, frogs, toads, snakes, and more."
