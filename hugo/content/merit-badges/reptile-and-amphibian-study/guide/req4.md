...
{{< drg/external-link
    ...
    description="Explore how reptiles and amphibians function as predators, prey, scavengers, and indicators of ecosystem health." >}}

{{< drg/did-you-know >}}
A single healthy wetland may depend on amphibians in multiple ways at once: tadpoles graze algae, adult frogs eat insects, and both life stages become food for fish, birds, snakes, and mammals.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    ...
    description="Search federally protected species near you and use the results to build your list of protected reptiles and amphibians." >}}
...
{{< drg/checklist title="Build Your 10-Species Discussion List" subtitle="Four protected species plus six local unprotected species" >}}
...
{{< drg/tip >}}
Choose species you can actually talk about with confidence. A list of common local species with real habitat and diet notes is better than a list of rare animals you barely know.
{{< /drg/tip >}}

{{< drg/image src="images/wetland-food-web-reptile-amphibian.avif" alt="Wetland food web diagram showing insects, frogs, salamanders, snakes, turtles, birds, and mammals" >}}

{{< drg/next-page
    text="You have connected reptile and amphibian species to real habitats, food webs, and conservation laws."
    teaser="Next, compare how reptiles and amphibians reproduce and why their life cycles look so different."
