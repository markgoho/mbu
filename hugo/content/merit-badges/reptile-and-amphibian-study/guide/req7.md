...
{{< drg/video
    title="The Most VENOMOUS Snakes in the US (video)"
    url="https://youtu.be/guMzO7vzMT0?si=3thQ8FQdwoEHXV75" >}}
...
{{< drg/safety-first >}}
Never try to handle, pin, poke, or photograph a venomous reptile at close range. Stay well back, warn others, and give the animal room to escape. Most bites happen when people try to touch or move the animal.
{{< /drg/safety-first >}}
...
- **Keep the bitten area still** and, if practical, at a comfortable level.
- **Follow medical instructions quickly** and get professional care.
{{< /drg/be-prepared >}}
...
{{< drg/tip >}}
For counselor discussion, learn one safe identification clue and one habitat clue for each venomous species you choose. That is more useful than trying to memorize a giant list of tiny details.
{{< /drg/tip >}}
...
{{< drg/image src="images/venomous-reptiles-us-overview.avif" alt="Overview panel comparing major venomous reptiles of the United States with range cues and body patterns" >}}

{{< drg/next-page
    text="You have the safety mindset and recognition basics needed to talk about venomous reptiles responsibly."
    teaser="Next, choose a longer observation project with either hands-on animal care or repeated study at a zoo, rescue, or nature center."
