...
{{< drg/checklist title="What to Record for Each Species" subtitle="Build notes you can use in your counselor discussion" >}}
...
{{< drg/tip >}}
When you make sketches or take photos, aim for the details a field guide uses: side view, top view if possible, and a close look at the head, tail, shell, or markings. A clear photo of the pattern is usually more useful than a distant full-body shot.
{{< /drg/tip >}}

{{< drg/image src="images/field-marks-reptile-amphibian-study.avif" alt="Four-panel field-mark comparison showing frog toe pads, turtle shell scutes, snake blotches, and salamander spots" >}}
...
{{< drg/external-link
    ...
    description="Browse reptiles observed across the United States and compare photos, maps, and identification clues." >}}

{{< drg/external-link
    title="Amphibians of the United States (website)"
    url="https://www.inaturalist.org/places/united-states#taxon=20978"
    description="Use real observations to study amphibian species, field marks, and where each one is found." >}}
...
{{< drg/be-prepared title="If You Get Only a Quick Look" >}}
- **Stop and watch first**: sudden movement can scare the animal away.
- **Note the habitat immediately**: wetland, woods, sunny rock, grassy edge, under a log.
- **Write down three details fast**: size, pattern, and movement.
- **Check a field guide later**: compare your notes with likely local species instead of guessing in the moment.
{{< /drg/be-prepared >}}

In [Req 2](/merit-badges/reptile-and-amphibian-study/guide/req2/), you will narrow your focus from the whole country to the species that actually live near you. That makes identification even easier.

{{< drg/next-page
    text="You can now look for field marks, habitat clues, and behavior instead of relying on guesses."
    teaser="Next, zoom in on your own state or local area and learn which species are most common around you."
