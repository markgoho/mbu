...
{{< drg/checklist title="What to Include for Each Species" subtitle="Keep the talk short, but make each animal memorable" >}}
...
{{< drg/tip >}}
Do not try to cram in every fact you know. A short talk with three clear points is stronger than a rushed talk with 20 scattered details.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If You Get Nervous While Speaking" >}}
- **Look at your first visual aid** and use it to restart your train of thought.
- **Slow down** instead of trying to race through the talk.
- **Use your notes as backup** rather than reading them word for word.
- **Remember your goal**: help the group learn three cool things about real animals.
{{< /drg/be-prepared >}}

{{< drg/next-page
    text="You are ready to turn your field knowledge into a short, clear teaching talk."
    teaser="Next, tackle myths and strange true facts that show why reptiles and amphibians are so often misunderstood."
