...
{{< drg/checklist title="What to Compare First" subtitle="Use the same field-science routine for each pair" >}}
...
{{< drg/inherited-requirement number="3a" req_path="3.a" topic="Amphibians and reptiles" />}}
...
{{< drg/video
    title="What's the Difference Between Reptiles and Amphibians? (video)"
    url="https://www.youtube.com/watch?v=j1vMyuYBqA4&t=54s" >}}

## Requirement 3b

{{< drg/inherited-requirement number="3b" req_path="3.b" topic="Alligators and crocodiles" />}}
...
{{< drg/video
    title="Alligator or Crocodile - What's the Difference? (video)"
    url="https://youtu.be/oins54YQGYI?si=k7YJDZxBk91z5IkW" >}}

## Requirement 3c

{{< drg/inherited-requirement number="3c" req_path="3.c" topic="Toads and frogs" />}}
...
{{< drg/tip >}}
If you are not sure whether you found a frog or a toad, look at the skin, leg length, and how it moves. One jump can tell you a lot.
{{< /drg/tip >}}

{{< drg/video
    title="Differences Between Frogs & Toads (video)"
    url="https://www.youtube.com/watch?v=O7QaL3xehRw" >}}

{{< drg/video
    title="What Is the Difference Between Frogs and Toads? (video)"
    url="https://www.youtube.com/watch?v=mM59TQOPDYQ" >}}

{{< drg/video
    title="Frogs and Toads: What's the Difference? (video)"
    url="https://www.youtube.com/watch?v=IF0EWfbevrM" >}}

## Requirement 3d

{{< drg/inherited-requirement number="3d" req_path="3.d" topic="Snakes and lizards" />}}
...
{{< drg/video
    title="How Are Snakes Different From Lizards? (video)"
    url="https://youtu.be/MMFcutNSKZk?si=u6Ux_2x9TxmepTJp" >}}

{{< drg/external-link
    title="Find Amphibian and Reptile Species in Your Area (website)"
    url="https://geonarrative.usgs.gov/amphibianreptileexplorer/"
    description="Compare likely local species so the differences you just learned become easier to spot in the field." >}}

In [Req 1](/merit-badges/reptile-and-amphibian-study/guide/req1/), you learned to look for markings and habitat clues. This page adds the bigger comparison skills that keep common mix-ups from tripping you up.

{{< drg/next-page
    text="You can now explain the key differences between several look-alike reptile and amphibian groups."
    teaser="Next, step back and see why these animals matter in food webs, conservation, and local ecosystems."
