...
{{< drg/checklist title="Weekly Observation Notes" subtitle="Look for patterns, not just isolated facts" >}}
...
{{< drg/tip >}}
Bring your questions written down. Caretakers are busy, and a short, focused list helps you get better answers.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If a Visit Does Not Go as Planned" >}}
- **Still record what you can**: even a hidden animal tells you something about behavior or enclosure use.
- **Note why visibility may have changed**: temperature, lighting, feeding time, or stress.
- **Ask staff what is normal**: sometimes an animal hides more during shedding or seasonal changes.
- **Return consistently**: one quiet visit does not ruin a three-month study.
{{< /drg/be-prepared >}}

Since [Req 9](/merit-badges/reptile-and-amphibian-study/guide/req9/) also asks you to use observation skills, the careful note-taking you build here will help there too.

{{< drg/next-page
    text="You can now plan a three-month observation project that combines field notes, interviews, and natural history research."
    teaser="Next, choose two shorter field challenges that test your listening, identification, or teaching skills."
