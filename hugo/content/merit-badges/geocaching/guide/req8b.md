...
Create a Scouting-related Travel Bug® that promotes one of the values of Scouting. "Release" your Travel Bug into a public geocache and, with your parent or guardian's permission, monitor its progress at www.geocaching.com for 30 days. Keep a log, and share this with your counselor at the end of the 30-day period.
{{< /drg/requirement >}}
...
{{< drg/image src="images/travel-bug-mission-flow.avif" alt="Step-by-step diagram showing a trackable tag attached to a small durable item, released into a cache, moved by different geocachers, and logged online over time so readers can visualize how a Travel Bug mission works" >}}

{{< drg/checklist title="Travel Bug Design Checklist" subtitle="What to think through before release" >}}
...
{{< drg/tip >}}
Choose a cache for release that is active, healthy, and likely to get visits. A busy, well-maintained cache gives your Travel Bug a better chance to start moving soon.
{{< /drg/tip >}}
...
1. **What Scouting value you chose and why**
2. **How your Travel Bug design and mission supported that value**
3. **What happened during the 30-day monitoring period**
...
{{< drg/external-link
    ...
    description="An official overview of how Travel Bugs work, what they are meant to do, and how geocachers track their journeys." >}}

This option shows how geocaching can carry a message from one cache to another. If you want an option with even more direct long-term responsibility, [Req 8c](/merit-badges/geocaching/guide/req8c/) focuses on hiding, maintaining, and eventually archiving your own public cache.

{{< drg/next-page
    text="You know how to design a Scouting-related Travel Bug, give it a mission, and keep a meaningful 30-day log of its journey."
    teaser="Next, learn what it takes to become a responsible cache owner with a maintenance plan and long-term stewardship."
