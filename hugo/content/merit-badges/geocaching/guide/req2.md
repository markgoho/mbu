...
- **Why cache placement must not damage the land**
- **How geocachers act responsibly when hiding, seeking, and maintaining caches**
- **How Scout outdoor ethics apply every time you search**
...
{{< drg/image src="images/buried-vs-hidden-cache-comparison.avif" alt="Side-by-side comparison showing a properly hidden surface cache under removable natural cover and an improper buried cache with disturbed soil and roots so readers can instantly see why buried caches damage the site" >}}

### Why buried caches are a problem

- They invite repeated digging by every future seeker.
- They damage soil structure and plant life.
- They can disturb archaeological or historic resources.
- They make geocachers look careless and disrespectful.
- They are harder to maintain and easier to lose.

{{< drg/safety-first >}}
Never dig, pry up rocks, tear apart logs, or break branches while looking for a geocache. If a search seems to require damaging the site, stop and rethink the location or read the hint again.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Good Geocaching Etiquette" subtitle="What responsible geocachers do" >}}
...
{{< drg/tip >}}
A clever cache is fun. A clever cache that damages a site or becomes impossible to maintain is not. The best hides balance creativity with stewardship.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="When the GPS Leads Off the Trail" >}}
Your GPS arrow points straight into a patch of brush beside a trail, but pushing through would crush plants and create a new path.

- **Step one:** Stop and look for a durable approach, not just the shortest approach.
- **Step two:** Re-check the coordinates, hint, and recent logs. GPS readings can drift.
- **Step three:** If the only approach would damage the area, do not continue. Log the attempt honestly and move on.
- **Step four:** Mention the concern in your log so the cache owner can review the location if needed.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Leave No Trace — The 7 Principles"
    url="https://lnt.org/why/7-principles/"
    description="The official Leave No Trace overview, useful for connecting each principle to your choices on a geocaching trip." >}}

{{< drg/external-link
    title="Geocaching.com — How to Play"
    url="https://www.geocaching.com/play"
    description="A helpful starting point for understanding how the geocaching community expects seekers to find, log, and replace caches." >}}

{{< drg/external-link
    title="Outdoor Code"
    url="https://www.outdoorcode.org/"
    description="A Scout-focused reminder that outdoor fun and outdoor responsibility always go together." >}}

The best geocachers do not treat ethics as extra rules. They treat them as part of the game. In [Req 3](/merit-badges/geocaching/guide/req3/), you will learn the words and ratings geocachers use to describe what they are doing and what they find.

{{< drg/next-page
    text="You know why caches are never buried, how good etiquette works, and how Scout outdoor ethics guide every search."
    teaser="Next, learn the vocabulary of geocaching so you can speak the language of waypoints, logs, ratings, and trackables."
