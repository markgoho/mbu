...
{{< drg/checklist title="Map and Compass Basics" subtitle="What to be ready to show your counselor" >}}
...
{{< drg/safety-first >}}
Never keep walking toward a coordinate if your route on the ground looks unsafe. A map and compass help you notice cliffs, water crossings, closed areas, or private property before you blunder into them.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/gps-vs-map-compass-comparison.avif" alt="Side-by-side navigation scene comparing a Scout following a GPS arrow with a Scout using a map and compass overview of the same terrain, emphasizing precision versus big-picture route awareness" >}}
...
{{< drg/tip >}}
The strongest answer for your counselor is not "GPS is better" or "maps are better." It is that each tool solves a different part of the problem, and wise geocachers know when to use both together.
{{< /drg/tip >}}

{{< drg/external-link
    title="Leave No Trace — The 7 Principles"
    url="https://lnt.org/why/7-principles/"
    description="Useful for connecting route choices and low-impact travel with navigation decisions during a geocaching trip." >}}

By now you know how to prepare, how to behave ethically, how GPS works, and why map-and-compass skills still matter. That sets you up well for [Req 6](/merit-badges/geocaching/guide/req6/), where you will describe the basic process of finding your first cache and practice waypoint skills again.

{{< drg/next-page
    text="You can explain why traditional navigation still matters and how GPS and map reading complement each other."
    teaser="Next, walk through the four basic steps to finding your first geocache and practice marking and editing a waypoint."
