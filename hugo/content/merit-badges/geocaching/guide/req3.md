...
{{< drg/did-you-know >}}
Even when your screen says you are exactly at the coordinates, the cache may still be several feet away because GPS readings drift. Many finds happen only after you stop staring at the arrow and start studying the hiding spot.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/difficulty-vs-terrain-grid.avif" alt="Simple two-axis grid with easy-to-hard difficulty on one axis and easy-to-hard terrain on the other, using four example cache scenarios to show how the two ratings describe different kinds of challenge" >}}
...
| Listing clue | What it tells you |
|---|---|
| Difficulty | How hard the hide or puzzle may be |
| Terrain | How physically demanding the trip may be |
| Attributes | Special conditions, accessibility, or timing clues |
| Hint | Extra help if the location is tricky |
| Recent logs | Whether the cache is active, damaged, or hard to find |
...
{{< drg/checklist title="Before You Attempt a Cache" subtitle="Use the listing language to prepare" >}}
...
{{< drg/tip >}}
For your counselor discussion, do not just memorize definitions. Give a quick example for each term. Saying how a term helps on a real cache hunt shows that you actually understand it.
{{< /drg/tip >}}

{{< drg/external-link
    title="Geocaching.com — How to Play"
    url="https://www.geocaching.com/play"
    description="A beginner introduction that reinforces common geocaching terms and how they appear in the real activity." >}}

{{< drg/external-link
    title="Geocaching.com — Travel Bug FAQ"
    url="https://www.geocaching.com/track/travelbugfaq.aspx"
    description="An overview of what Travel Bugs are, how they move, and what geocachers should know before tracking or releasing them." >}}

Now that you can speak the language of geocaching, you are ready to understand the technology under it. [Req 4](/merit-badges/geocaching/guide/req4/) shows how GPS works and how to teach another person to use it with the Teaching EDGE method.

{{< drg/next-page
    text="You can now explain the key terms, ratings, and listing clues that geocachers use all the time."
    teaser="Next, learn how GPS works and how to demonstrate waypoint and settings skills using the Teaching EDGE method."
