...
{{< drg/image src="images/geocaching-hazard-scan.avif" alt="Annotated trail-side geocaching scene highlighting loose rocks, roots, a drop-off, poison ivy, and a safe standing zone so readers can see the kind of quick hazard scan they should do before searching" >}}
...
{{< drg/safety-first >}}
Do not keep hunting just because you are "almost there." Turn around if weather gets dangerous, daylight is fading faster than expected, or the terrain is more difficult than your group can handle safely.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Before You Search" subtitle="Quick hazard scan at every cache site" >}}
...
{{< drg/be-prepared title="If a Search Starts Going Sideways" >}}
A Scout in your group gets quiet, stops drinking water, and starts moving slowly on a hot afternoon.

- **Step one:** Stop the search and move everyone to shade.
- **Step two:** Check for symptoms such as headache, nausea, dizziness, or unusual behavior.
- **Step three:** Cool the person, encourage small drinks of water if they are alert, and do not restart the hunt until the problem is clearly resolved.
- **Step four:** If symptoms worsen, especially confusion or collapse, get emergency help immediately.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
A small first-aid kit belongs in your geocaching bag, but prevention matters even more. The best bandage is the one you never need because you slowed down, wore the right shoes, and checked the weather first.
{{< /drg/tip >}}
...
{{< drg/checklist title="Simple Geocaching Trip Plan" subtitle="What to decide before leaving home" >}}
...
{{< drg/external-link
    ...
    description="A beginner-friendly overview of how geocaching works, from finding a cache to signing the log and logging your experience online." >}}

{{< drg/external-link
    title="Leave No Trace — The 7 Principles"
    url="https://lnt.org/why/7-principles/"
    description="A practical guide to planning ahead, protecting places, and reducing your impact while you explore outdoors." >}}

Geocaching works best when all three parts of this requirement connect. Planning helps you avoid hazards. Good hazard awareness reduces injuries. Good first aid knowledge helps when prevention is not enough. In [Req 2](/merit-badges/geocaching/guide/req2/), you will build on that by learning the ethics that keep geocaching fun for everyone.

{{< drg/next-page
    text="You know how to scan for hazards, handle common outdoor problems, and make a safe trip plan before using GPS."
    teaser="Next, learn the etiquette and outdoor ethics that keep caches, trails, and public spaces in good shape."
