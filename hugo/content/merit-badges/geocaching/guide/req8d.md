...
{{< drg/image src="images/cito-before-and-after-cleanup.avif" alt="Before-and-after comparison of a cache area with scattered litter and the same area cleaned up with collected trash bags and safer walking space, showing the visible impact of CITO service" >}}

{{< drg/checklist title="What Makes CITO Effective" subtitle="Whether you create containers or host an event" >}}
...
{{< drg/tip >}}
If you host a CITO event, keep the goal simple and measurable. "Clean the whole park" is too vague. "Remove litter from the trail loop and picnic area" is clear and easier to complete well.
{{< /drg/tip >}}

{{< drg/video
    title="Tutorial Creating an [CITO] Event Geocache with #KeepersOfTheCacheFlo — KeepersOfTheCacheFlo"
    url="https://www.youtube.com/watch?v=1HefhojIPmg" >}}

{{< drg/external-link
    title="Geocaching.com — CITO"
    url="https://www.geocaching.com/cito/"
    description="The official overview of Cache In Trash Out, including the environmental purpose behind cleanup and stewardship events." >}}

This option shows how geocaching can serve the land directly. In [Req 9](/merit-badges/geocaching/guide/req9/), you will take another leadership step by planning and running a geohunt for a youth group.

{{< drg/next-page
    text="You can explain what CITO means and how it turns geocaching into visible environmental stewardship."
    teaser="Next, plan a geohunt for a youth group and put your navigation, teaching, and leadership skills together in one event."
