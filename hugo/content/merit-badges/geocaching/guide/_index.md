  ...
  - group_title: "8. Choose Your Adventure"
    items:
      ...
      - title: "d Cache In Trash Out Leadership"
        ...
        is_sub: true
  - group_title: "Plan and Run a Geohunt"
    items:
...
- **Main tools:** Paper maps, compasses, landmarks, and observation
- **Main goal:** Travel accurately without getting lost
- **Main lesson:** Good navigation depends on preparation, not luck
...
{{< drg/image src="images/geocaching-then-vs-now-comparison.avif" alt="Side-by-side comparison of old-school map-and-compass navigation and modern geocaching with a GPS receiver, showing how the tools changed while the goal of safe navigation stayed the same" >}}
...
{{< drg/image src="images/geocache-types-overview.avif" alt="Four-panel overview showing a traditional cache, a puzzle cache, an urban hide with nearby bystanders, and a trackable item moving between caches so readers can see how common geocaching experiences differ" >}}

- **Main tools:** GPS receivers, smartphones, apps, and online cache listings
- **Main goal:** Combine navigation, exploration, and outdoor ethics
- **Main lesson:** Technology helps, but judgment still matters most
...
{{< drg/tip >}}
If you are brand new to geocaching, start with an easy traditional cache before trying puzzle or multi-stage caches. Learning the basics first makes the more complicated cache types much more fun.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Whether you are in a city park or on a wooded trail, stop searching if the location feels unsafe, private, restricted, or environmentally sensitive. A real geocacher walks away from a bad situation instead of forcing a find.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Geocaching only became possible after GPS accuracy for civilians improved in 2000. A change in satellite accuracy helped launch a hobby that now spans countries, parks, cities, and trails all over the world.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You know what geocaching is, where it came from, and the kinds of adventures it can include."
    teaser="Next, learn how to manage hazards, first aid concerns, and trip planning before you head out to hunt."
    url="/merit-badges/geocaching/guide/req1/" >}}
