---
title: "Cache to Eagle Service Stops"
layout: guide
group_title: "8. Choose Your Adventure"
req_number: "8a"
prev: "/merit-badges/geocaching/guide/req8/"
prev_title: "Pick Your Geocaching Project"
next: "/merit-badges/geocaching/guide/req8b/"
next_title: "Travel Bug Mission"
---
...
{{< drg/checklist title="At Each Cache to Eagle Stop" subtitle="Questions to help you build a strong counselor discussion" >}}
...
{{< drg/tip >}}
Take photos only where allowed and keep a few short notes right after each visit. The details of the three projects will blur together if you wait too long to write about them.
{{< /drg/tip >}}

{{< drg/be-prepared title="If Your Council Does Not Have a Cache to Eagle Series" >}}
Not every council has a Cache to Eagle® series nearby.

- **Step one:** Confirm whether the program exists in your area.
- **Step two:** If it does not, choose one of the other Req 8 options instead of forcing this one.
- **Step three:** Pick the option you can complete fully and well.
{{< /drg/be-prepared >}}

{{< drg/video
    title="Eagle Scout Pride Virtual Cache — JOY aka GeocachingJoy"
    url="https://www.youtube.com/watch?v=i3D8nrYruHo" >}}

This option emphasizes how geocaching can highlight service and public good. If you want a very different kind of project, [Req 8b](/merit-badges/geocaching/guide/req8b/) focuses on designing and tracking a Scouting-related Travel Bug® over time.

{{< drg/next-page
    text="You know how to use Cache to Eagle visits to study real Eagle Scout service projects and explain their public impact."
    teaser="Next, see how a Travel Bug mission turns geocaching into a 30-day story of movement, purpose, and recordkeeping."
