...
{{< drg/checklist title="Kitchen Safety" subtitle="Common hazards to look for" >}}
...
{{< drg/checklist title="Living Areas & Bedrooms" subtitle="Common hazards to look for" >}}
...
{{< drg/checklist title="Garage & Storage Areas" subtitle="Common hazards to look for" >}}
...
{{< drg/checklist title="Outside the Home" subtitle="Common hazards to look for" >}}
...
1. **Activity description:** Where, when, and who is involved
2. **Possible hazards:** What could go wrong? (Think about weather, traffic, crowds, terrain, health)
3. **Prevention:** What can you do to stop emergencies from happening?
4. **Protection:** What safeguards should be in place?
5. **Mitigation:** How can you reduce the impact if something goes wrong?
6. **Response:** What do you do if an emergency happens during this activity?
7. **Recovery:** How do you help everyone get back to normal after an incident?
...
{{< drg/tip >}}
Do not just list hazards — explain *why* your proposed actions work. For example, do not just write "bring sunscreen." Write "Apply sunscreen SPF 30+ every two hours to prevent sunburn and reduce the risk of heat-related illness, because sunburned skin loses its ability to regulate temperature."
{{< /drg/tip >}}

{{< drg/video title="Building an Emergency Kit" url="https://www.youtube.com/watch?v=x2GkeNvgzG8" >}}

{{< drg/next-page text="You have completed a home safety inspection or created emergency prevention plans for five family activities." teaser="Learn how to save a person from four dangerous situations — without putting yourself in danger." url="/merit-badges/emergency-preparedness/guide/req4/" >}}
