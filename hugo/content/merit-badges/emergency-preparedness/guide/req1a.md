...
{{< drg/tip >}}
Prevention is the most powerful aspect because it eliminates the emergency entirely. When reviewing your 10 emergency scenarios for Requirement 1b, always start by asking: "Could this have been prevented?"
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Protection is not the same as prevention. You cannot always prevent a tornado from forming, but you can protect yourself by having a shelter plan and knowing where to go. Both aspects work together.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
FEMA estimates that every $1 spent on hazard mitigation saves $6 in future disaster costs. Small preparations today can save thousands of dollars — and lives — tomorrow.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
During any emergency response, your personal safety comes first. You cannot help anyone if you become a victim yourself. Assess the scene for dangers before rushing in, and never attempt a rescue that puts your own life at unreasonable risk.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
As you work through Requirement 1b, use these five aspects as column headers in your chart. For each emergency scenario, think through what you can do at each stage. This framework will serve you through the entire merit badge.
{{< /drg/tip >}}

### Video Resource

{{< drg/video title="5 Steps of Disaster Risk Management" url="https://youtu.be/xjlPmSXj24Y" >}}

{{< drg/next-page text="You now understand the five aspects of emergency preparedness — the framework you will use throughout this badge." teaser="Apply these five aspects to 10 real emergency scenarios and build your preparedness chart." url="/merit-badges/emergency-preparedness/guide/req1b/" >}}
