...
Show ways to attract the attention of searchers on the ground if you are lost in the wilderness.
{{< /drg/requirement >}}

{{< drg/requirement number="5c" >}}
Show ways to attract the attention of searchers on the water if you are stranded with a capsized or disabled motorboat or sailboat.
{{< /drg/requirement >}}
...
{{< drg/tip >}}
The universal distress signal is any signal repeated three times — three fires, three whistle blasts, three mirror flashes. If you can only remember one thing about signaling, remember: three means "I need help."
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
If you are lost in the wilderness, remember **STOP**: **S**tay calm, **T**hink, **O**bserve, **P**lan. Staying in one visible location is almost always safer than wandering. Make yourself visible and audible, and wait for help to come to you.
{{< /drg/safety-first >}}

{{< drg/video title="Ways to Signal for Help in the Wilderness" url="https://youtu.be/4BHi5lBYwro" >}}
...
{{< drg/did-you-know >}}
An EPIRB signal is picked up by a global satellite network and routed to the nearest rescue coordination center within minutes. Since the system was implemented, it has helped save over 50,000 lives worldwide. PLBs are the personal, portable version and can be carried in a pocket or clipped to a life jacket.
{{< /drg/did-you-know >}}

{{< drg/video title="Signaling Devices for a Water Rescue" url="https://www.youtube.com/shorts/-0euvnZe_OM" >}}

{{< drg/video title="Water Rescue Signaling" url="https://youtu.be/mQUXLU4bQkE?si=vlr7MfwEZ4DGzzpB" >}}

{{< drg/video title="How does an EPIRB work?" url="https://youtu.be/xwbgU9envik" >}}

{{< drg/video title="PLB and EPIRB Emergency Beacons" url="https://youtu.be/CGLDG7n7g5U?si=AEWhOs7SVf-2zWCR" >}}

{{< drg/next-page text="You now know how to signal for help by air, on the ground, and on the water." teaser="Learn how to safely transport an injured person using improvised stretchers." url="/merit-badges/emergency-preparedness/guide/req6/" >}}
