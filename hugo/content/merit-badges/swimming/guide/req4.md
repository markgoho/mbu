...
| Stroke | Distance | Pool Lengths |
|--------|----------|-------------|
| Front crawl or trudgen | 25 yards | 1 |
| Back crawl | 25 yards | 1 |
| Sidestroke | 25 yards | 1 |
| Breaststroke | 25 yards | 1 |
| Elementary backstroke | 50 yards | 2 |
| **Total** | **150 yards** | **6** |
...
{{< drg/tip >}}
You can swim the strokes in any order. Many Scouts save the elementary backstroke for last since it is the most restful. Consider putting your weakest stroke early while you have the most energy, then finishing strong with the elementary backstroke.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
A 150-yard swim is roughly the distance from home plate to deep center field in a major league baseball stadium — about one and a half football fields. It sounds like a lot, but at a comfortable pace, most swimmers complete it in under five minutes.
{{< /drg/did-you-know >}}
...
- **Front crawl:** Smooth arm turnover, face in the water with side breathing, steady flutter kick
- **Back crawl:** Body flat, hips up, alternating arm windmill, flutter kick
- **Sidestroke:** On your side, coordinated arm pull and scissor kick with a visible glide
- **Breaststroke:** Symmetrical arm sweep and whip kick with a glide phase
- **Elementary backstroke:** Simultaneous arm-and-kick motion with a long, relaxed glide

If you need a refresher on any stroke, review [Req 3 — Swimming Strokes](/merit-badges/swimming/guide/req3/).

{{< drg/checklist title="Endurance Swim Preparation" subtitle="Get ready for your 150-yard swim" >}}
...
{{< drg/external-link
    title="American Red Cross — Swimming and Water Safety"
    url="https://www.redcross.org/take-a-class/swimming"
    description="Find swimming classes and resources from the American Red Cross to improve your stroke technique and endurance." >}}

{{< drg/image src="images/endurance-swim.avif" alt="A Scout swimming the breaststroke in a pool lane, showing proper form with arms extended forward during the glide phase" >}}

---

{{< drg/next-page
    text="You have proven your swimming endurance"
    teaser="Now learn how to rescue someone in the water using reaching, throwing, and line rescue techniques."
