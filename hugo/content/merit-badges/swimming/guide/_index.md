...
{{< drg/image src="images/scout-swimming-pool.avif" alt="A Scout in a swimming pool, mid-stroke, with clear blue water and lane lines visible" >}}
...
{{< drg/safety-first >}}
Even casual swimming requires attention to safety. Never swim alone, always know the depth and conditions of the water, and make sure a responsible adult knows you are in the water.
{{< /drg/safety-first >}}
...
{{< drg/safety-first >}}
Open water presents hazards you will not find in a pool: sudden drop-offs, currents, cold water, and limited visibility. Always swim with a buddy, wear a brightly colored swim cap, and check conditions before entering the water.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/open-water-swimming.avif" alt="A swimmer in open water with a brightly colored swim cap, swimming parallel to a shoreline with gentle waves" >}}

---

{{< drg/next-page
    text="Now that you have a sense of what swimming is all about"
    teaser="Learn about Scouting America's Safe Swim Defense and how it keeps you safe in the water."
    url="/merit-badges/swimming/guide/req1a/" >}}
