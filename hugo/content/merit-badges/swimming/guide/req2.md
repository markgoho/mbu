...
{{< drg/tip >}}
Practice the full swimmer test sequence before your merit badge session. Knowing what to expect reduces nervousness and helps you pace yourself. Focus on smooth, steady strokes rather than speed.
{{< /drg/tip >}}
...
- Recognizable stroke technique
- Controlled breathing
- No signs of distress

{{< drg/did-you-know >}}
A standard competition pool is 25 yards long. So 75 yards means three full pool lengths, and the entire 100-yard swimmer test is four lengths. If you are testing in a lake or other open water, your counselor will measure out the distance in advance.
{{< /drg/did-you-know >}}
...
**Tips for floating:**
- Lean your head back so your ears are in the water
- Spread your arms out to the sides, palms up
- Keep your hips up by pressing your chest toward the sky
- Take slow, deep breaths — full lungs help you float
- Relax. Tension makes you sink

{{< drg/be-prepared title="Trouble Floating?" >}}
Some people have a harder time floating than others due to body composition. If you tend to sink:
- **Focus on your lungs.** Keep them full of air — this is your built-in flotation.
- **Spread out.** Arms and legs wide distribute your weight.
- **Use small sculling motions** with your hands near your hips if needed. Minimal movement is allowed.
- **Practice in shallow water** first so you can stand up if needed.
{{< /drg/be-prepared >}}

## Preparing for the Test

{{< drg/checklist title="Swimmer Test Preparation" subtitle="Practice each component before your merit badge session" >}}
...
{{< drg/external-link
    title="Scouting America Aquatics — Swim Classification"
    url="https://www.scouting.org/health-and-safety/aquatics/"
    description="Official Scouting America aquatics page with information about swim classifications and safety procedures." >}}

{{< drg/image src="images/swimmer-test.avif" alt="A Scout jumping feetfirst into a pool from the pool deck, arms at sides, with a counselor watching from poolside" >}}

---

{{< drg/next-page
    text="Once you have passed the swimmer test"
    teaser="It is time to demonstrate five essential swimming strokes with proper form."
