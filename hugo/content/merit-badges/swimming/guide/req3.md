...
req_number: "3"
prev: "/merit-badges/swimming/guide/req2/"
prev_title: "Swimmer Test"
next: "/merit-badges/swimming/guide/req4/"
next_title: "Endurance Swim"
---
...
{{< drg/be-prepared title="Working on a Weak Stroke" >}}
If one stroke feels much harder than the others:
- **Isolate the kick.** Use a kickboard (or no board, arms extended) and practice just the kick for that stroke.
- **Isolate the arms.** Use a pull buoy between your legs and practice just the arm motion.
- **Slow down.** Good form at slow speed beats sloppy form at fast speed. Your counselor cares about technique, not speed.
- **Ask for feedback.** Have a buddy or instructor watch and tell you what looks off. Sometimes one small adjustment makes everything click.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="USA Swimming — Learn to Swim"
    url="https://www.usaswimming.org/parents-resources/learn-to-swim"
    description="Resources from USA Swimming on stroke technique, finding lessons, and improving your skills." >}}

{{< drg/image src="images/swimming-strokes-demo.avif" alt="A Scout demonstrating the front crawl stroke in a pool, showing proper arm extension and body rotation with a lane line visible" >}}

---

{{< drg/next-page
    text="Now that you know the five essential strokes"
    teaser="Put your skills to the test with a 150-yard endurance swim using all five strokes."
