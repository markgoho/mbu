...
req_number: "1a"
prev: "/merit-badges/swimming/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/swimming/guide/req1b/"
next_title: "Req 1b — Health Concerns"
---
...
{{< drg/tip >}}
Memorize these eight points. Your counselor will expect you to know them and explain how each one prevents drowning. A helpful mnemonic: **Q**uiet **P**eople **S**hould **R**eally **L**earn **A**bout **B**eing **D**isciplined (Qualified supervision, Personal health review, Safe area, Response personnel, Lookout, Ability groups, Buddy system, Discipline).
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Your body loses heat 25 times faster in water than in air at the same temperature. A 60°F day might feel comfortable on land, but 60°F water can cause hypothermia in as little as 30 to 40 minutes.
{{< /drg/did-you-know >}}
...
- **Swim parallel to the beach** until you feel the current weaken.
- **Then swim at an angle** back toward shore.
...
{{< drg/external-link
    ...
    description="The official Safe Swim Defense page from Scouting America, including the full guidelines and training information." >}}

{{< drg/image src="images/safe-swim-defense.avif" alt="A lifeguard-style lookout watching swimmers from a raised position at a lake swim area with buoy markers dividing ability zones" >}}

---

{{< drg/next-page
    text="Now that you understand Safe Swim Defense"
    teaser="Learn about the health concerns that can affect swimmers and how to prevent and treat them."
