...
prev: "/merit-badges/communication/guide/req9/"
prev_title: "Req 9 — Career Exploration"
---
...
{{< drg/tip >}}
The best stories are personal. You do not need to have climbed Mount Everest to tell a great story. A moment of frustration during a service project, a funny mistake at camp, or a lesson learned from a failed experiment — these everyday moments become compelling stories when you tell them with structure and emotion.
{{< /drg/tip >}}
...
These skills are directly connected to what you practiced in [Requirement 5](/merit-badges/communication/guide/req5/) — objective reporting. The same discipline that helped you write a fair, balanced meeting report will help you navigate the complex world of digital information.

{{< drg/did-you-know >}}
A study by Stanford University found that over 80% of middle school students could not tell the difference between a real news article and a sponsored advertisement online. Developing your media literacy skills puts you ahead of the vast majority of internet users.
{{< /drg/did-you-know >}}
...
2. **Listen first** — Before stating your position, hear the other person out completely. Use active listening — the same skills from [Requirement 1](/merit-badges/communication/guide/req1/).
...
{{< drg/be-prepared title="A Disagreement Escalates" >}}
If a conversation starts to get heated, try the **pause and redirect** technique:

- **Pause** — Say "Let's take a minute to cool down" or "I want to hear your side — can you walk me through it?"
- **Lower your voice** — Speaking more quietly naturally de-escalates tension.
- **Focus on the problem, not the person** — Shift from "You did this wrong" to "How can we fix this?"
...
{{< drg/experience-card title="Toastmasters Youth Leadership Program" details="Location: Local Toastmasters clubs nationwide | Highlights: An 8-session program where youth practice public speaking and leadership in a supportive group setting" >}}

{{< drg/experience-card title="School Newspaper or Yearbook" details="Location: Your school | Highlights: Write articles, conduct interviews, design layouts, and publish real content for your school community" >}}

{{< drg/experience-card title="Local Government Youth Board" details="Location: City or county government | Highlights: Many communities have youth advisory boards where young people contribute to real policy discussions and civic engagement" >}}

{{< drg/experience-card title="Community Theater or Debate Team" details="Location: Schools and community centers | Highlights: Build public speaking confidence, learn to think on your feet, and collaborate with others to create something meaningful" >}}

{{< drg/experience-card title="Volunteer at a Local Radio or TV Station" details="Location: Community radio or local TV stations | Highlights: See professional communication in action — some stations offer youth volunteer or internship programs" >}}

### F. Organizations

These organizations can help you continue developing your communication skills long after you earn this badge:

{{< drg/org-card name="Toastmasters International" description="The world's largest organization dedicated to helping people become better speakers and leaders. Many clubs welcome youth participants." url="https://www.toastmasters.org/" >}}

{{< drg/org-card name="National Forensic League (NSDA)" description="The honor society for high school speech and debate. Offers competitions, resources, and a supportive community for young speakers." url="https://www.speechanddebate.org/" >}}

{{< drg/org-card name="Student Press Law Center" description="Supports and defends the First Amendment rights of student journalists. Offers resources for students interested in journalism and media." url="https://splc.org/" >}}

{{< drg/org-card name="Media Literacy Now" description="Advocates for media literacy education in schools. Provides resources to help young people become critical thinkers about the media they consume." url="https://medialiteracynow.org/" >}}

{{< drg/org-card name="National Communication Association" description="The largest professional organization for communication scholars and practitioners. Offers student resources and career information." url="https://www.natcom.org/" >}}
