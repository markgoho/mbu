...
{{< drg/tip >}}
Choose something you can teach in 15–30 minutes and that your learner can practice and demonstrate back to you. A skill like "tie a bowline knot" is a better choice than "learn to play guitar," which would take weeks.
{{< /drg/tip >}}
...
{{< drg/checklist title="EDGE Method Checklist" subtitle="Follow these four steps during your lesson" >}}
...
{{< drg/did-you-know >}}
Research shows that people remember about 10% of what they hear, 30% of what they see, but 80% of what they do themselves. That is why the "Guide" and "Enable" steps of EDGE are so important — hands-on practice is where real learning happens.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Your Learner Is Not Getting It" >}}
If your learner is struggling with the skill, try these adjustments:

- **Break it down smaller** — If the step is too complex, split it into two simpler steps.
- **Use an analogy** — Compare the skill to something they already know. "Threading a needle is like lacing a shoe — the same over-under motion."
- **Switch your aid** — If talking is not working, draw a picture. If a picture is not working, guide their hands through the motion.
- **Take a break** — Sometimes stepping away for a few minutes and coming back fresh makes all the difference.
{{< /drg/be-prepared >}}
...
{{< drg/external-link title="Scouting — EDGE Method" url="https://www.scouting.org/training/adult/supplemental/" description="Learn more about how the EDGE method is used throughout Scouting to develop teaching and leadership skills." >}}

{{< drg/next-page
    text="You have experienced what it takes to be an effective teacher"
    teaser="now put your writing skills to work by creating a published piece — a letter, a blog, or a printed publication."
