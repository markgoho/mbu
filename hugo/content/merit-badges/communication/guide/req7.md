...
- An issue you learned about in [Requirement 5](/merit-badges/communication/guide/req5/) at your public meeting
...
{{< drg/checklist title="Letter to the Editor Checklist" subtitle="Include these elements" >}}
...
{{< drg/tip >}}
Before you send your letter, look up the publication's submission guidelines. Most newspapers list their letter-to-the-editor email address on the opinion or editorial page. Follow their word count and formatting rules exactly.
{{< /drg/tip >}}
...
{{< drg/tip >}}
Print a draft and look at it from arm's length before finalizing. If you cannot easily read the headlines or tell where one section ends and another begins, you need to adjust your layout.
{{< /drg/tip >}}
...
{{< drg/external-link title="Canva — Free Design Tool" url="https://www.canva.com/" description="A free online design tool with templates for newsletters, brochures, flyers, and more. Great for beginners." >}}

{{< drg/external-link title="Google Sites — Free Website Builder" url="https://sites.google.com/" description="A simple, free tool for creating web pages. No coding required — drag, drop, and publish." >}}
...
{{< drg/next-page
    text="You have created a polished written or digital publication"
    teaser="now step into the role of emcee and learn how to plan and lead a ceremony or program."
