...
{{< drg/checklist title="Exhibit Planning Checklist" subtitle="Key elements of a good archaeological exhibit" >}}
...
{{< drg/tip >}}
When writing exhibit labels, think about the "10-second rule." Most museum visitors spend about 10 seconds reading a label. Keep text short, use plain language, and lead with the most interesting fact. If you can capture someone's attention in 10 seconds, they will keep reading.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Some experimental archaeology projects involve sharp tools, fire, or heated materials. Always work under qualified supervision. Wear appropriate protective equipment — safety glasses for flintknapping, gloves when handling hot stones, and closed-toe shoes for all hands-on work.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Experiment Report Outline" subtitle="Include these sections in your writeup" >}}
...
{{< drg/did-you-know >}}
In the 1990s, a team of researchers in England built a full-size replica of a Bronze Age boat using only tools and materials available 3,500 years ago. They then sailed it across the English Channel. The project revealed that ancient boat-building required far more skill and knowledge than anyone had previously estimated.
{{< /drg/did-you-know >}}

{{< drg/image src="images/experimental-archaeology.avif" alt="A Scout under instructor supervision carefully shaping a clay pot using the coil method, with finished examples of ancient-style pottery visible on a worktable nearby" >}}

{{< drg/external-link
    title="EXARC — Experimental Archaeology"
    url="https://exarc.net/"
    description="An international organization dedicated to archaeological open-air museums and experimental archaeology, with project ideas and resources." >}}

{{< drg/external-link
    title="Primitive Technology YouTube Channel"
    url="https://www.youtube.com/channel/UCAL3JXZSzSm8AlZyD3nQdBA"
    description="A popular channel demonstrating primitive building and tool-making techniques that connect directly to experimental archaeology." >}}

{{< drg/next-page
    text="You have completed all the requirements for the Archaeology merit badge — congratulations!"
    teaser="Ready to go deeper? Explore extended learning resources to continue your archaeological journey."
    url="/merit-badges/archaeology/guide/extended-learning/" >}}
