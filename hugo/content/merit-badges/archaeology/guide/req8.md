...
{{< drg/tip >}}
Your local library is one of the best starting points. Ask a librarian for help finding local history resources — many libraries have dedicated local history rooms with old maps, photographs, newspapers, and books about the area. Your State Historic Preservation Office (SHPO) is another excellent resource.
{{< /drg/tip >}}
...
{{< drg/checklist title="Predicting Archaeological Evidence" subtitle="Think about what survives underground" >}}
...
{{< drg/did-you-know >}}
Archaeologists can learn what people ate thousands of years ago by analyzing tiny plant remains called **phytoliths** — microscopic silica structures that form inside plant cells and survive long after the plant itself has rotted away. Corn, squash, and rice each leave distinctive phytoliths in the soil.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/local-history-research.avif" alt="A Scout at a library table surrounded by old maps, local history books, and photographs, taking notes in a notebook with a laptop open nearby" >}}

{{< drg/external-link
    title="National Register of Historic Places"
    url="https://www.nps.gov/subjects/nationalregister/index.htm"
    description="Search for historic places in your area that are listed on the National Register — a good starting point for local history research." >}}

{{< drg/external-link
    title="Library of Congress — Chronicling America"
    url="https://chroniclingamerica.loc.gov/"
    description="Search digitized historical newspapers from across the United States to find firsthand accounts of life in your area more than 100 years ago." >}}

{{< drg/next-page
    text="You have discovered the history of your own community through an archaeological lens."
    teaser="Now explore the career paths that could turn your interest in archaeology into a profession."
