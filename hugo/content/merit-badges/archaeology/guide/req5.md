...
{{< drg/did-you-know >}}
Violations of ARPA can result in fines of up to $100,000 and prison sentences of up to five years for repeat offenders. The law treats the destruction of archaeological resources as seriously as many other federal crimes.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/protected-site-sign.avif" alt="A National Park Service sign at the entrance to an archaeological site, showing official protection notices with desert landscape and ruins visible in the background" >}}

{{< drg/external-link
    title="National Park Service — Archeological Resources Protection Act"
    url="https://www.nps.gov/subjects/archeology/archeological-resources-protection-act.htm"
    description="Learn about the federal law that makes it a crime to damage or remove archaeological resources from public lands." >}}

{{< drg/external-link
    title="The Archaeological Conservancy"
    url="https://www.archaeologicalconservancy.org/"
    description="A nonprofit organization dedicated to acquiring and preserving significant archaeological sites across the United States." >}}

{{< drg/external-link
    title="UNESCO World Heritage Centre"
    url="https://whc.unesco.org/"
    description="Explore the international program that identifies and protects cultural and natural heritage sites of global significance." >}}

{{< drg/next-page
    text="You now know the laws and organizations that protect archaeological sites."
    teaser="Next, learn what you can personally do to be a protector of the past."
