...
{{< drg/checklist title="Museum Visit Observation Guide" subtitle="Look for these things during your visit" >}}
...
{{< drg/tip >}}
Many museums offer free or discounted admission days. Check the museum's website before you visit. Also look for guided tours — museum docents often know fascinating stories about the artifacts that are not written on the display labels.
{{< /drg/tip >}}
...
- **What is it?** Describe the object — its material, size, condition, and any markings or details.
...
{{< drg/did-you-know >}}
Archaeologists have a term for the study of modern material culture — it is called **ethnoarchaeology**. By studying how people today make, use, and discard objects, archaeologists develop better models for interpreting what they find at ancient sites.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Trash Analysis Questions" subtitle="Discuss these with your counselor" >}}
...
{{< drg/be-prepared title="The Digital Blind Spot" >}}
Here is a thought-provoking idea to bring up with your counselor: much of modern life leaves **no physical evidence at all**. If you buy an ebook, stream a movie, or send a text message, there is nothing for a future archaeologist to find. In 1,000 years, our digital world might be invisible — just like the spoken languages and songs of ancient peoples that were never written down.
{{< /drg/be-prepared >}}

{{< drg/image src="images/museum-exhibit.avif" alt="A Scout carefully examining a pottery display in a museum, with glass cases containing labeled artifacts and informational panels visible in the background" >}}

{{< drg/external-link
    title="Smithsonian Institution — Museums and Research Centers"
    url="https://www.si.edu/museums"
    description="Find Smithsonian museums near you or explore their online collections to see archaeology in action." >}}

{{< drg/next-page
    text="You have seen how artifacts — whether ancient or modern — reveal stories about the people who created them."
    teaser="Now turn your detective skills to your own backyard: research the people who lived in your area more than 100 years ago."
