...
{{< drg/did-you-know >}}
The principle of stratigraphy was first described by Danish scientist Nicolas Steno in 1669. He figured it out by studying rock layers — but the idea works just as well for the soil layers at archaeological sites.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Dendrochronology is incredibly precise — it can sometimes pinpoint the exact *season* a tree was cut. Radiocarbon dating, by contrast, usually gives a range of dates (for example, "between 1200 and 1350 CE"). Both methods are powerful, but they work best when used together.
{{< /drg/tip >}}
...
{{< drg/image src="images/stratigraphy-diagram.avif" alt="A cross-section diagram of an archaeological excavation showing clearly labeled soil layers (strata) with artifacts at different depths, illustrating how deeper layers are older" >}}

{{< drg/be-prepared title="Your Counselor Asks: What's the Difference?" >}}
Here is a clear way to explain the two categories:

- **Relative dating** answers: "Is this older or younger than that?" It gives you an order but not a number.
- **Absolute dating** answers: "How many years old is this?" It gives you an actual age or age range.

Think of it like a race. Relative dating tells you who finished first, second, and third. Absolute dating tells you the actual time each runner crossed the finish line.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Smithsonian National Museum of Natural History — Dating Fossils and Rocks"
    url="https://naturalhistory.si.edu/education/teaching-resources/life-science/dating-fossils-and-rocks"
    description="The Smithsonian explains how scientists determine the age of specimens using a variety of dating techniques." >}}

{{< drg/external-link
    title="Beta Analytic — How Does Radiocarbon Dating Work?"
    url="https://www.radiocarbon.com/about-carbon-dating.htm"
    description="One of the world's leading radiocarbon labs explains the Carbon-14 dating process in clear, accessible language." >}}

{{< drg/next-page
    text="You now understand how archaeologists figure out the age of their discoveries."
    teaser="Next, you will explore real archaeological sites from around the world — and learn the stories they tell."
