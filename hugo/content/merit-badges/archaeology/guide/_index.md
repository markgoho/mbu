...
{{< drg/image src="images/scout-archaeology-site.avif" alt="A Scout kneeling at an archaeological dig site, carefully brushing dirt from an artifact with a small brush, with a grid system and measurement tools visible" >}}
...
{{< drg/did-you-know >}}
The oldest known stone tools are about 3.3 million years old — discovered in Kenya in 2011. That is more than a million years older than scientists previously thought humans had been making tools.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Underwater archaeology requires specialized dive training and strict safety protocols. The underwater environment adds serious risks including equipment failure, limited visibility, and strong currents. Never attempt to explore a shipwreck or submerged site without proper training and supervision.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/underwater-archaeology.avif" alt="A diver in scuba gear carefully documenting artifacts on a shipwreck site, with measuring tools and underwater camera equipment visible" >}}

{{< drg/image src="images/archaeology-branches-collage.avif" alt="A collage showing different types of archaeology: a prehistoric cave painting, a classical Greek temple ruin, an industrial-era factory building, and a researcher examining pottery in a lab" >}}
...
{{< drg/next-page
    text="You have learned about the fascinating world of archaeology and its many branches."
    teaser="Find out exactly what archaeology is — and how it is different from treasure hunting, paleontology, and other fields."
    url="/merit-badges/archaeology/guide/req1/" >}}
