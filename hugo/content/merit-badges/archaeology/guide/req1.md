...
{{< drg/did-you-know >}}
Indiana Jones is probably the world's most famous fictional archaeologist — but real archaeologists cringe at his methods. In the movies, he rips artifacts out of the ground, ignores context, and blows things up. A real archaeologist would spend weeks carefully documenting a single square meter of soil.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Think of it this way: if you found a mysterious note in a library book, the note itself is interesting — but knowing *which* book it was in, *which* page it was on, and *who* checked out the book before you could help you figure out the whole story. Removing the note without recording any of that destroys the clues.
{{< /drg/tip >}}
...
{{< drg/image src="images/archaeology-vs-collecting.avif" alt="A split-scene illustration: on the left, an archaeologist carefully documenting an artifact in a gridded excavation unit with notes and cameras; on the right, a treasure hunter with a metal detector pulling an object from the ground with no documentation" >}}

{{< drg/external-link
    title="Society for American Archaeology — What Is Archaeology?"
    url="https://www.saa.org/about-archaeology"
    description="The professional organization for archaeologists in the Americas explains the field and its importance." >}}

{{< drg/external-link
    title="National Park Service — Archaeology for Kids"
    url="https://www.nps.gov/subjects/archeology/for-kids.htm"
    description="The NPS offers hands-on activities and explanations about what archaeologists do and why it matters." >}}

{{< drg/next-page
    text="Now that you understand what archaeology is and how it stands apart from related fields,"
    teaser="learn the step-by-step process that archaeologists follow to study the past."
