...
{{< drg/checklist title="If You Find an Artifact" subtitle="Follow these steps — in this order" >}}
...
{{< drg/be-prepared title="Someone Offers You an Artifact" >}}
What if a friend or family member shows you a cool arrowhead they dug up, or a neighbor offers you an old bottle they found at a construction site? Here is how to handle it:

- **Thank them** for showing it to you. Don't lecture or accuse — most people don't know the laws or understand the importance of context.
- **Share what you know.** Explain (politely) that artifacts are most valuable when left in place, and that removing them from public land is against the law.
- **Suggest reporting it.** If they found it on public land, encourage them to contact the local SHPO or land management agency.
- **Be a positive example.** Your own actions and attitude can influence the people around you more than any rule or law.
{{< /drg/be-prepared >}}

{{< drg/image src="images/scout-leaving-artifact.avif" alt="A Scout on a hiking trail noticing an artifact partially exposed in the soil, choosing to photograph it with a phone instead of picking it up, with a national forest setting in the background" >}}

{{< drg/external-link
    title="NPS — Looting and Vandalism of Archaeological Sites"
    url="https://www.nps.gov/subjects/archeology/looting-and-vandalism.htm"
    description="Learn about the threats facing archaeological sites and what the NPS does to protect them." >}}

{{< drg/external-link
    title="Society for American Archaeology — Archaeology and You"
    url="https://www.saa.org/about-archaeology/archaeology-and-you"
    description="Practical guidance from the SAA on how everyday people can help protect archaeological resources." >}}

{{< drg/next-page
    text="You now know how to protect the past through your own actions."
    teaser="Next, discover how artifacts — from museum exhibits to your family's own treasures — tell stories about the people who made and used them."
