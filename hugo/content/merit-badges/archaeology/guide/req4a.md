...
{{< drg/checklist title="Site Research Guide" subtitle="Cover these points for each of your five sites" >}}
...
{{< drg/did-you-know >}}
The cave paintings at Lascaux were discovered when a dog named Robot fell into a hole while chasing a rabbit. The teenagers who followed him down found themselves surrounded by art that had not been seen by human eyes in 17,000 years.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Create a simple timeline on paper or poster board showing your five sites. Mark each one with its approximate date, location, and one key discovery. A visual timeline makes it easy for your counselor (and your audience in Req 4b) to see how the sites relate to each other.
{{< /drg/tip >}}

{{< drg/image src="images/world-map-sites.avif" alt="A stylized world map with five archaeological sites marked with pins and labels, showing locations across different continents" >}}

{{< drg/external-link
    title="UNESCO World Heritage List"
    url="https://whc.unesco.org/en/list/"
    description="Browse hundreds of cultural heritage sites around the world, many of which are important archaeological locations." >}}

{{< drg/external-link
    title="National Park Service — Archaeology Sites"
    url="https://www.nps.gov/subjects/archeology/sites.htm"
    description="Explore archaeological sites managed by the National Park Service across the United States." >}}

{{< drg/external-link
    title="Smithsonian — National Museum of the American Indian"
    url="https://americanindian.si.edu/"
    description="Learn about the diverse cultures and histories of Indigenous peoples of the Americas through objects, stories, and educational resources." >}}

{{< drg/next-page
    text="You have explored fascinating archaeological sites from around the world."
    teaser="Now learn how to turn your research into a presentation that brings these discoveries to life for an audience."
