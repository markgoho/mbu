...
{{< drg/external-link
    title="Eight Popular Programming Languages, Their Industries and Coding Examples (PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Programming/Req3-General.docx"
    description="This official overview gives examples of common languages, sample code, and the kinds of industries that rely on each one." >}}

{{< drg/tip >}}
For each language on your list, be ready to answer two questions: "What is it often used for?" and "Why is it a good fit for that work?" Those two ideas matter more than memorizing release dates or creators.
{{< /drg/tip >}}
...
{{< drg/checklist title="Choosing your three devices" subtitle="Pick examples you actually use and can describe clearly" >}}
...
{{< drg/be-prepared title="Your counselor asks, 'How do you know it is programmed?'" >}}
Use the same simple pattern for each device.

- **Input**: What information does the device receive?
- **Decision**: What rule or logic does it apply?
- **Output**: What action, display, or response happens next?
- **Why it matters**: How does that help you in everyday life?
{{< /drg/be-prepared >}}

{{< drg/image src="images/everyday-programmed-devices.avif" alt="Three labeled everyday objects such as a smartphone, smartwatch, and router with arrows showing input, processing, and output" >}}
...
{{< drg/next-page
    text="You can now compare programming languages and spot code in the devices around you."
    teaser="Next, learn how software is protected and why using it legally and respectfully matters."
