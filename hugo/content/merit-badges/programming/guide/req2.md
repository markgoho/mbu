...
{{< drg/did-you-know >}}
In the early home-computer era, some magazines printed entire programs on paper. Readers typed the code by hand into their machines to make a game, animation, or utility run.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Milestones worth bringing to your counselor" subtitle="Pick at least three and explain why they mattered" >}}
...
{{< drg/tip >}}
When you discuss history with your counselor, connect each milestone to a real effect. Instead of saying, "Python became popular," say, "Python became popular because its readable syntax helped more students, scientists, and professionals learn to automate tasks quickly."
{{< /drg/tip >}}

{{< drg/video
    title="5 Minute Video of Programming Language History (video)"
    url="https://youtu.be/K5yv7dY17EA?si=yYdqNCZwa0w0SzJs" >}}

{{< drg/external-link
    title="Example With Code Examples and Pictures (PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Programming/Req2-History.docx"
    description="This official resource gives short examples and visuals you can use to compare older and newer programming approaches." >}}

{{< drg/external-link
    title="Text Descriptions of Historical Progression of Programming Languages (website)"
    url="https://www.computer.org/publications/tech-news/insider-membership-news/timeline-of-programming-languages"
    description="Computer Society's timeline helps you place major languages in order and see what problems each era was trying to solve." >}}

{{< drg/external-link
    title="Computer History Museum Timeline With Pictures (website)"
    url="https://www.computerhistory.org/timeline/software-languages/"
    description="This visual timeline is useful for spotting turning points, famous languages, and how quickly software tools changed over time." >}}

{{< drg/image src="images/programming-history-timeline.avif" alt="A visual timeline from punch cards and early computers to laptops, web apps, and modern coding languages" >}}
...
{{< drg/next-page
    text="You have traced how programming grew from early machine instructions into modern languages."
    teaser="Next, compare popular languages and notice how code shows up in everyday devices around you."
