...
{{< drg/external-link
    title="Personal Safety Awareness \"Digital Safety\" video"
    url="https://www.scouting.org/training/youth-protection/scouts-bsa/"
    description="Open this official Scouting America page first so you can watch the Digital Safety training without hunting for it later on the page." >}}
...
{{< drg/checklist title="Digital safety habits for a young programmer" subtitle="Use these before you click, post, or download" >}}
...
{{< drg/tip >}}
If you want to share a project online, share the project itself — not your private information. A good rule is this: if you would not put it on a bulletin board at school, do not put it in a public profile or comment.
{{< /drg/tip >}}

{{< drg/external-link
    title="Scouting America Social Media Guidelines (website)"
    url="https://scoutingwire.org/social-media-guidelines/"
    description="These guidelines show how to share online in ways that protect privacy, respect others, and keep digital spaces Scout-friendly." >}}
...
{{< drg/safety-first >}}
Pain is useful information. Do not try to "push through" wrist, hand, shoulder, or neck pain just to finish a program. If pain continues, gets worse, or includes numbness, tell a parent, guardian, or other trusted adult and get medical advice.
{{< /drg/safety-first >}}

{{< drg/video
    title="Treating Repetitive Stress (video)"
    url="https://www.youtube.com/shorts/1yp0jOyARCk" >}}
...
{{< drg/video
    title="Treating Eye Strain (video)"
    url="https://www.youtube.com/watch?v=j3ff4aeItl0" >}}

{{< drg/external-link
    title="5 Tips to Reduce Eye Strain (website)"
    url="https://www.uab.edu/news/health-medicine/new-uab-eye-care-clinic-helps-improve-vision-in-the-workplace"
    description="UAB Eye Care shares practical steps for setting up your screen, reducing glare, and giving your eyes regular breaks." >}}

{{< drg/be-prepared title="You are on a roll and do not want to stop" >}}
If you notice your shoulders tightening, your wrist hurting, or your eyes blurring, treat that as part of the project — not an interruption.

- **Pause the code**: Save your work so you can step away without stress.
- **Reset your body**: Stand up, roll your shoulders, stretch your hands, and look across the room.
- **Fix the setup**: Adjust your chair, keyboard, or screen before you keep going.
- **Return in better shape**: Short breaks often help you solve bugs faster anyway.
{{< /drg/be-prepared >}}

{{< drg/image src="images/ergonomic-coding-setup.avif" alt="A Scout seated at a desk with neutral wrists, feet supported, and the monitor at eye level" >}}
...
{{< drg/next-page
    text="You have the safety habits every programmer should start with."
    teaser="Next, trace how programming grew from early machines into today's languages and tools."
