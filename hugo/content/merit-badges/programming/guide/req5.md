...
- **[Req 5a — First Language Project](/merit-badges/programming/guide/req5a/)**: Build your first project in a language and toolset that feels approachable. This is your chance to understand the core pattern of input, logic, output, debugging, and explanation.
- **[Req 5b — Second Language Project](/merit-badges/programming/guide/req5b/)**: Build a second program in a different language and environment so you can compare how tools, syntax, and workflow change.
- **[Req 5c — Third Language Project](/merit-badges/programming/guide/req5c/)**: Finish with a third language and environment that stretches you a little more and shows how widely programming skills transfer.

## How to Choose

{{< drg/checklist title="Choosing your three languages and environments" subtitle="Pick combinations that show variety without becoming overwhelming" >}}
...
{{< drg/tip >}}
Your counselor is likely to care more about **variety and understanding** than about choosing the hardest possible language. Pick tools that help you show real learning.
{{< /drg/tip >}}

{{< drg/be-prepared title="You cannot decide which projects to build" >}}
Use three quick filters.

- **What can I finish?** Choose projects small enough to debug and explain.
- **What will feel different?** Change the language, environment, or type of output.
- **What can I demonstrate clearly?** Your counselor should be able to see the input, the decision making, and the output.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have a strategy for choosing three projects that show real variety."
    teaser="Start with your first language project and focus on clear input, logic, output, and debugging."
