...
{{< drg/did-you-know >}}
Many programming ideas are easier to notice in games because you can see the rules happen right away. A character jumping at the wrong time, a score that will not update, or an enemy that gets stuck often points straight to the part of the code that needs attention.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/programming-robotics-laptop.avif" alt="A Scout testing simple code on a laptop while a small robot or microcontroller responds nearby" >}}
...
{{< drg/next-page
    text="You know what programming is and where it shows up in the world."
    teaser="Start with digital safety and healthy coding habits before you build anything."
    url="/merit-badges/programming/guide/req1/" >}}
