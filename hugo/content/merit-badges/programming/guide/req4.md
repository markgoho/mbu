...
{{< drg/checklist title="How the four types differ" subtitle="A quick way to keep them straight" >}}
...
{{< drg/external-link
    title="Four Different Types of Intellectual Property (PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Programming/Req4-IP.docx"
    description="This official resource gives a simple comparison of the main protection types and how they apply to software-related work." >}}
...
{{< drg/tip >}}
If you ever wonder whether you own software or only have permission to use it, read the terms of use or license agreement. The answer is usually there.
{{< /drg/tip >}}

{{< drg/external-link
    title="The Difference Between Licensing and Owning Software (PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Programming/Req4-IP.docx"
    description="This official explanation helps you discuss why most software users receive permission to use software rather than full ownership rights." >}}
...
{{< drg/video
    title="Open Source VS Commercial Software (video)"
    url="https://www.youtube.com/watch?v=SdW5pnha9kg" >}}

{{< drg/external-link
    title="Free VS Open Source Software (website)"
    url="https://www.geeksforgeeks.org/software-engineering/difference-between-free-software-and-open-source-software/"
    description="This comparison helps you sort out what 'free' means in cost, what open source means in permissions, and why the two are not identical." >}}

{{< drg/be-prepared title="A friend says, 'If it is online, it is free to use however I want'" >}}
That is not a safe assumption.

- **Check the license**: It tells you what is allowed.
- **Look for attribution rules**: Some software or code samples require credit.
- **Do not copy blindly**: Even small snippets can come with usage conditions.
- **Ask before sharing**: If you are unsure, pause and find the terms first.
{{< /drg/be-prepared >}}

{{< drg/image src="images/software-rights-comparison.avif" alt="A three-column comparison labeled freeware, open source, and commercial software with simple icons for cost, code access, and sharing rules" >}}
...
{{< drg/next-page
    text="You understand the basic rules that protect software and guide how it may be used."
    teaser="Now choose your three programming projects and plan how to show your counselor real working code."
