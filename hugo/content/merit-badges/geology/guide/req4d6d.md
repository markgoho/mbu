...
- **Age or geologic period**
- **What kind of organism it was**
- **What environment it lived in**
- **Why it was chosen as a state fossil**
...
{{< drg/checklist title="State Fossil Presentation Formula" subtitle="Keep your display clear and informative" >}}
...
{{< drg/next-page
    text="You know how to build a strong state-fossil presentation that connects image, age, classification, and environment."
    teaser="Next, return to geology in the field by focusing on Leave No Trace and the Outdoor Code."
