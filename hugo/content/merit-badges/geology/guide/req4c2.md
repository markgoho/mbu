...
{{< drg/image src="images/mineral-properties-identification-grid.avif" alt="Diagram of mineral identification properties showing hardness, streak, cleavage, luster, and crystal form with simple specimen examples" >}}

{{< drg/checklist title="Best Mineral-ID Habit" subtitle="Do not rely on only one property" >}}
...
{{< drg/tip >}}
Color alone can fool you. Quartz, for example, appears in many different colors. That is why geologists combine several properties before making an identification.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Rocks and Minerals (video)"
    url="https://youtu.be/24O79WgKZO8" >}}

{{< drg/video
    title="Identifying Rocks and Minerals - Using Physical Properties for Identification (video)"
    url="https://youtu.be/M4rzNUZFV4w?si=U7wiitA6iPA-bScM" >}}

The next page gives you a choice: build a collection of ten specimens or identify fifteen with your counselor's help.

{{< drg/next-page
    text="You now understand what a mineral is and which physical properties geologists use to identify one."
    teaser="Next, choose whether to build a labeled collection or identify 15 specimens."
