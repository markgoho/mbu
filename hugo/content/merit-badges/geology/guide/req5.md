...
{{< drg/safety-first >}}
Never collect from national parks, protected fossil sites, active road cuts, steep unstable slopes, railroad corridors, or private land without clear permission. Geology ethics includes staying legal and staying safe.
{{< /drg/safety-first >}}

## Official Resources

{{< drg/external-link
    title="Leave No Trace (video)"
    url="https://vimeo.com/1115216743/63b20c0b33?share=copy"
    description="A short overview of Leave No Trace ideas you can apply directly to field trips, specimen collecting, and geology observation." >}}
...
{{< drg/checklist title="How to Talk About Your Ethics" subtitle="Examples you can share with your counselor" >}}
...
{{< drg/tip >}}
If you did not actually remove many specimens, that can still be a strong answer. Choosing to sketch, photograph, or record a site instead of collecting from it is often the most ethical geology decision.
{{< /drg/tip >}}

{{< drg/be-prepared title="Tempted to Take the Best Fossil You See?" >}}
Pause and ask four questions:

- **Is collecting allowed here?** If not, the answer is easy: leave it.
- **Will removing it damage the site?** Educational sites lose value when the best examples disappear.
- **Do you truly need it?** A photo and notes may do the job.
- **Can you remove it safely?** If not, do not try.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You now understand how Leave No Trace and the Outdoor Code guide responsible geology fieldwork."
    teaser="Next, choose whether to explore geology as a career path or as a hobby and healthy lifestyle."
