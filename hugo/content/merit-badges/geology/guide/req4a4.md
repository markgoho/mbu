...
{{< drg/image src="images/fine-sediment-magnifier-comparison.avif" alt="Split comparison of a fine sediment sample viewed with the naked eye and through a hand lens" >}}

{{< drg/checklist title="Observation Questions" subtitle="Focus on what changed when you used magnification" >}}
...
{{< drg/did-you-know >}}
Clay minerals are so tiny that a single grain can be much too small to identify clearly without magnification, yet beds made of clay can preserve footprints, raindrop marks, and other delicate surface features in the rock record.
{{< /drg/did-you-know >}}
...
{{< drg/video
    title="Sediment in Streams (video)"
    url="https://youtu.be/-tDOu1vrNHY" >}}

Now you are ready for the field step in this option: visiting a real stream and reading the clues water leaves behind.

{{< drg/next-page
    text="You understand that some stream-carried sediment is too fine to notice easily without magnification."
    teaser="Next, visit a nearby stream and look for signs that reveal which way the water moved."
