...
req_number: "4d2"
prev: "/merit-badges/geology/guide/req4d1/"
prev_title: "Geologic Time in Your Region"
next: "/merit-badges/geology/guide/req4d3/"
next_title: "Burial, Fossils, and Extinction"
---
...
- **Volcanoes** are common where plates separate or where one plate subducts under another.
- **Earthquakes** are common where plates collide, separate, or slide past.
- **Mountain belts** often form where plates converge and crust is compressed.

{{< drg/image src="images/plate-boundaries-and-hazards.avif" alt="Three-panel diagram of divergent, convergent, and transform boundaries with their typical hazards and landforms" >}}

{{< drg/checklist title="How to Explain Plate Tectonics" subtitle="A simple structure for your chart or counselor talk" >}}
...
{{< drg/video
    title="How Plate Tectonics Work (video)"
    url="https://www.youtube.com/watch?v=xhcovHLA90s" >}}

The next page shifts from whole plates to individual organisms and asks how fossils get preserved in the first place.

{{< drg/next-page
    text="You can now explain how plate movement shapes the global pattern of volcanoes, earthquakes, and mountain belts."
    teaser="Next, learn how burial and fossilization preserve traces of ancient life."
