...
req_number: "4d5"
prev: "/merit-badges/geology/guide/req4d4/"
prev_title: "Req 4d4 — Fossils as Ancient Clues"
next: "/merit-badges/geology/guide/req4d6/"
next_title: "Req 4d6 — Visit, Observe, or Present Fossils"
---

{{< drg/requirement number="4d5" >}}
...
{{< drg/checklist title="A Strong Fossil Entry" subtitle="More than a label" >}}
...
{{< drg/safety-first >}}
Collect fossils only where it is legal and safe. Protected parks, important public outcrops, and unstable exposures are not places for casual collecting. When in doubt, photograph and leave the specimen in place.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You know how to turn a fossil collection or identification set into evidence about ancient life and environments."
    teaser="Next, choose an approved fossil visit or presentation path to finish the Earth History option."
