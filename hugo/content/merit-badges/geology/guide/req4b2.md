...
1. Organic-rich sediment becomes a source rock.
2. Heat and pressure generate oil or gas.
3. The fluids migrate through permeable pathways.
4. The fluids collect in a porous reservoir rock.
5. A trap and seal keep them from escaping farther upward.
...
{{< drg/image src="images/petroleum-system-cross-section.avif" alt="Geologic cross-section showing source rock, migration, porous reservoir, seal, and an anticline trap with oil and gas accumulation" >}}

{{< drg/checklist title="Three-Part Petroleum System" subtitle="What to mention when you discuss this with your counselor" >}}
...
{{< drg/tip >}}
Draw a simple cross-section. Even a basic sketch with a source layer below, a porous reservoir above, and a trap under a sealing layer can make this requirement much easier to explain.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Formation of Reservoir Rock (video)"
    url="https://youtu.be/_PDOD_FEnNk" >}}

Up next, you will look at the tools geologists use to find these hidden systems underground.

{{< drg/next-page
    text="You now understand the three geologic ingredients needed for oil and gas accumulation."
    teaser="Next, explore the tools geologists use to locate energy resources below the surface."
