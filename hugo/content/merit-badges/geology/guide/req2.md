...
1. **Where it forms** — What geologic setting creates it?
2. **How it is found** — What clues or tools lead geologists to it?
3. **How it is extracted** — Is it mined, quarried, pumped, or dredged?
4. **How it is processed** — What happens before people can use it?
...
{{< drg/image src="images/resource-to-product-flow.avif" alt="Side-by-side examples showing limestone, copper, sand and gravel, and oil alongside common products made from them" >}}

{{< drg/checklist title="Build Your Resource Discussion" subtitle="Questions to answer for each of your three choices" >}}
...
{{< drg/tip >}}
For your counselor discussion, make a simple three-column chart: **resource**, **how it is found**, and **how it is processed**. That keeps your explanation organized and makes it easier to compare your three choices.
{{< /drg/tip >}}

{{< drg/did-you-know >}}
The average car contains materials from dozens of mined resources, including iron, aluminum, copper, silica for glass, limestone in steel processing, and rare elements used in electronics. A single everyday object can represent geology from many different places.
{{< /drg/did-you-know >}}
...
{{< drg/video
    title="Patterns of Mineral Extraction (video)"
    url="https://youtu.be/wQhFQFeYdJU" >}}

{{< drg/external-link
    title="U.S. Geological Survey — Mineral Resources Program"
    url="https://www.usgs.gov/programs/mineral-resources-program"
    description="Reliable background on how mineral resources are studied, produced, and used in the United States." >}}
...
{{< drg/next-page
    text="You have practiced tracing Earth resources from formation to discovery and processing."
    teaser="Next, learn how to read a geologic map and use it to identify rock types, ages, and structures."
