...
req_number: "6b"
prev: "/merit-badges/geology/guide/req6a/"
prev_title: "Req 6a — Geology Careers"
next: "/merit-badges/geology/guide/extended-learning/"
...
{{< drg/image src="images/geology-hobby-paths-collage.avif" alt="Four-panel collage showing rockhounding, museum learning, labeled specimen collecting, and geology-focused hiking" >}}

{{< drg/checklist title="Hobby Planning Questions" subtitle="Use these to shape your discussion" >}}
...
{{< drg/tip >}}
The healthiest geology hobby is one that gets you outdoors, makes you notice places more carefully, and keeps good records. You do not need expensive gear to start. A notebook, hand lens, and curiosity go a long way.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Why I'm So Obsessed With Geology (video)"
    url="https://www.youtube.com/shorts/sxTzwHxxEp8?feature=share" >}}

{{< drg/video
    title="What Is Geology and How Can Rock Collecting Become a Fascinating Hobby? (video)"
    url="https://youtu.be/oLomQG6P6tc" >}}

{{< drg/video
    title="Rockhounding 101: The Best Way to Find Minerals (video)"
    url="https://youtu.be/x4iptGa2eU4" >}}

{{< drg/video
    title="Michigan Geology Tourism Series (video)"
    url="https://youtu.be/75QB3OFbEi0" >}}
...
{{< drg/next-page
    text="You can now imagine geology as a realistic hobby or healthy long-term lifestyle."
    teaser="Finish with some extra ways to keep exploring geology beyond the badge."
    url="/merit-badges/geology/guide/extended-learning/" >}}
