...
{{< drg/image src="images/rock-classes-comparison.avif" alt="Side-by-side hand specimens showing igneous crystals, sedimentary layers, and metamorphic foliation or banding" >}}

## How to Tell Them Apart

{{< drg/checklist title="Clues to Rock Class" subtitle="Questions to ask when you hold a specimen" >}}
...
{{< drg/did-you-know >}}
Marble and quartzite are metamorphic rocks that began as very different sedimentary rocks. Marble started as limestone, while quartzite started as sandstone. Heat and pressure changed them so much that their original textures may become hard to recognize.
{{< /drg/did-you-know >}}

## Official Resources

{{< drg/video
    title="Rocks for Kids (video)"
    url="https://youtu.be/xsHPA2GNF9Q" >}}

{{< drg/video
    title="Types of Rocks (video)"
    url="https://youtu.be/KtbAEYwkC1E" >}}
...
{{< drg/next-page
    text="You can now define rock and explain the origin and characteristics of igneous, sedimentary, and metamorphic rocks."
    teaser="Next, learn what a mineral is and how physical properties help identify one."
