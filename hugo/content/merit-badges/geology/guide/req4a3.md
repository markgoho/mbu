...
{{< drg/image src="images/stream-features-labeled.avif" alt="Meandering stream diagram labeling cut bank, fill bank, point bar, medial channel bar, and lake delta with sediment zones" >}}

{{< drg/tip >}}
When you label your diagram, think **outside bend = erosion** and **inside bend = deposition**. That one idea helps place several of the features correctly.
{{< /drg/tip >}}
...
{{< drg/video
    title="Point Bars and Cut Banks (video)"
    url="https://youtu.be/gjIrApP2tt8" >}}
...
{{< drg/next-page
    text="You can now place major stream features on a diagram and compare the sediment sizes found there."
    teaser="Next, investigate water-carried sediment that may be too small to see clearly with the unaided eye."
