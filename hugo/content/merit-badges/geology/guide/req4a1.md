---
title: "Sediment Settling"
layout: guide
group_title: "4. Surface & Sedimentary Processes"
req_number: "4a1"
prev: "/merit-badges/geology/guide/req4a/"
prev_title: "Streams Shape the Land"
next: "/merit-badges/geology/guide/req4a2/"
next_title: "Stream Gradients"
---
...
{{< drg/image src="images/sediment-settling-jar-sequence.avif" alt="Three-panel jar sequence showing mixed muddy water, early settling of coarse grains, and final sorted sediment layers" >}}

The point is not fancy equipment. The point is careful observation.

{{< drg/checklist title="What to Record" subtitle="Useful observations for your notebook" >}}
...
{{< drg/did-you-know >}}
Very fine clay particles are so small that they can remain suspended in quiet water far longer than most people expect. That is why floodwater and pond water can stay muddy long after the bigger grains have already settled out.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Use the words **sorting**, **suspension**, **grain size**, and **deposition** in your explanation. They are exactly the concepts this experiment is meant to teach.
{{< /drg/tip >}}
...
{{< drg/video
    title="Stream Erosion and Stream Deposition (video)"
    url="https://youtu.be/YoZZZQ2lxOc" >}}

{{< drg/video
    title="Sediment Settlement Lab (video)"
    url="https://youtu.be/p4K5N6WuVoA" >}}

{{< drg/video
    title="Separate Soil! (video)"
    url="https://youtu.be/BVWIspB8qWk" >}}
...
{{< drg/next-page
    text="You have seen how suspended sediments settle at different rates and why that matters."
    teaser="Next, calculate stream gradients and connect slope to water speed and sediment size."
