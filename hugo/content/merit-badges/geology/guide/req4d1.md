...
req_number: "4d1"
prev: "/merit-badges/geology/guide/req4d/"
prev_title: "Req 4d — Deep Time and Ancient Worlds"
next: "/merit-badges/geology/guide/req4d2/"
next_title: "Req 4d2 — Plate Tectonics"
---
...
{{< drg/image src="images/geologic-timescale-and-local-rocks.avif" alt="Vertical geologic timescale aligned with a simplified regional rock column and matching periods" >}}

{{< drg/tip >}}
Tie this page back to Req 3. If you already used a geologic map there, check the legend again and look for the period labels attached to each unit.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="The Geological Timescale (video)"
    url="https://www.youtube.com/watch?v=5Prp5iYFu4w" >}}

Next you will add the driving force behind many of Earth's biggest changes: moving tectonic plates.

{{< drg/next-page
    text="You can now organize Earth's history into eras and periods and begin placing your regional rocks within that timeline."
    teaser="Next, learn how plate tectonics shapes volcanoes, earthquakes, and mountain belts."
