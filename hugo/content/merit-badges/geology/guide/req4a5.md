...
{{< drg/image src="images/dry-streambed-flow-clues.avif" alt="Dry streambed annotated with ripple marks, imbricated pebbles, point bar, debris pile, and downstream flow direction" >}}

## What to Put in Your Notebook

Record more than a sentence or two. Your notebook should help you reconstruct the site later.

{{< drg/checklist title="Field Notes for This Visit" subtitle="What to capture while you are on site" >}}
...
{{< drg/tip >}}
Take photos if allowed, but still make a sketch. Drawing the site helps you notice relationships that are easy to miss when you only take a quick picture.
{{< /drg/tip >}}

{{< drg/safety-first >}}
Visit streams only with appropriate supervision and permission. Stay away from steep muddy banks, fast water, and channels that may rise quickly after rain. Never enter floodwater or unstable stream cuts.
{{< /drg/safety-first >}}
...
{{< drg/video
    title="How to Read Water (video)"
    url="https://youtu.be/jOQmN7EM5NE?si=bJIlc6F0lRcJR8oy" >}}
...
{{< drg/next-page
    text="You can now visit a stream and use field clues to infer the direction of flow."
    teaser="Next, explore how geology helps locate and understand energy resources."
