...
{{< drg/image src="images/evidence-in-rock-layers-roadcut.avif" alt="Roadcut with layered rocks and annotated clues such as ash, gravel channel fill, fossil-bearing mud, and a crack or fault" >}}
...
{{< drg/checklist title="What Geologists Look For" subtitle="Clues that help explain a rock formation" >}}
...
{{< drg/did-you-know >}}
James Hutton, one of the founders of modern geology, looked at rock layers in Scotland in the late 1700s and realized Earth had to be unimaginably old. He saw signs that rocks had formed, tilted, eroded, and then been buried under younger layers — a sequence that required huge amounts of time.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When you talk with your counselor, use the word **evidence** often. Geologists do not just say what they think happened. They explain which clues support their conclusion.
{{< /drg/tip >}}
...
{{< drg/video
    title="Defining Geology (video)"
    url="https://youtu.be/Kv_7jt0nvHQ" >}}

{{< drg/video
    title="Introduction to Geology (video)"
    url="https://youtu.be/qNiOXc6pSBQ" >}}

{{< drg/external-link
    title="American Geosciences Institute — What Is Geology?"
    url="https://www.americangeosciences.org/geoscience-currents/what-geology"
    description="A clear overview of what geologists study and how geology connects to everyday life." >}}
...
{{< drg/next-page
    text="You now know what geology studies and how geologists use present-day evidence to interpret the past."
    teaser="Next, explore three useful Earth resources and how they are discovered and processed."
