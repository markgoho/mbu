...
req_number: "1c"
prev: "/merit-badges/wilderness-survival/guide/req1b/"
prev_title: "Req 1b — Scout Essentials & Survival Kits"
next: "/merit-badges/wilderness-survival/guide/req2/"
next_title: "Req 2 — Seven Priorities of Survival"
---
...
{{< drg/video
    ...
    url="https://www.youtube.com/watch?v=79WYqkiExZU" >}}

{{< drg/external-link
    title="Importance of a Float Plan"
    url="https://www.boatsmartexam.com/knowledge-base/article/using-a-trip-plan/"
    description="Guide to creating a float plan (trip plan for water-based activities)." >}}
...
{{< drg/be-prepared title="You Miss Your Return Time" >}}
It's 7 PM, you're supposed to be back, and you're still 3 hours away from the trailhead. Bad weather delayed you.

- **Don't panic:** You planned for this. Your contact knows when to expect you and will alert rescuers if you're overdue.
- **Don't push recklessly:** Your trip plan included a bailout option. Find the nearest safe place to camp.
- **Stay put:** Once you're sheltered, don't wander. Rescuers will find you by following your planned route.
- **Use signals:** If rescuers arrive, use your whistle or mirror to signal them.
- **Let your contact know:** If you have cell service or a satellite device, send a message saying you're safe but delayed. This prevents an expensive rescue operation.
{{< /drg/be-prepared >}}

{{< drg/did-you-know >}}
A detailed trip plan has saved countless lives. Rescue teams can focus on a specific area instead of searching blindly. Even a few hours' head start can make the difference between a quick rescue and a tragedy.
{{< /drg/did-you-know >}}
