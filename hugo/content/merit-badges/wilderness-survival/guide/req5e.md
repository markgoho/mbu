...
{{< drg/safety-first >}}
Carbon monoxide kills. Never build a fire inside any enclosed shelter. Not a small fire, not a controlled fire. Fires consume oxygen and produce CO2 and CO. Inside an enclosed space, these gases accumulate to lethal levels quickly. If you want warmth, build the fire outside and warm yourself before entering, or rely on insulation alone.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="Your Shelter Starts Leaking During the Night" >}}
Rain comes harder than expected and water is dripping inside.

- **Don't panic.** This is fixable and part of learning.
- **Identify the leak.** Where is water coming in? The roof? The entrance? A gap you didn't notice?
- **Grab material.** Use leaves, branches, or clothing to block the leak.
- **Adjust the roof.** Add material to the leak point, angling it to shed water.
- **Move if needed.** If the leak is under where you're sleeping, move to a dry spot in the shelter.
- **Document it.** This is valuable information for the counselor conversation. "The roof wasn't steep enough on the east side" is a great observation.

After the night, assess what failed. Better insulation? Better angle? Different material? This is how you learn.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
Bring a journal or notebook. During the night (use a headlamp if you wake up), write notes: time, temperature estimate, what's working, what's not. Morning notes are fuzzy; middle-of-night observations are fresh.
{{< /drg/tip >}}
