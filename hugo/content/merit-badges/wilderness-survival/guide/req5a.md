...
{{< drg/video
    ...
    url="https://www.youtube.com/watch?v=EsoobhiExJY" >}}

{{< drg/external-link
    title="Winter Survival Skills"
    url="https://www.wildwoodsurvival.com/survival/winter/index.html"
    description="Comprehensive guide to winter survival techniques." >}}
...
{{< drg/video
    title="Building Fire in the Rain"
    url="https://www.youtube.com/watch?v=MmHkiHeoI3U" >}}
...
{{< drg/video
    title="10 Desert Survival Tips"
    url="https://www.youtube.com/watch?v=lIHczx_QlH8" >}}
...
{{< drg/video
    title="Danger of Wind Chill"
    url="https://www.youtube.com/watch?v=f4VC0fNMaQc" >}}
...
{{< drg/external-link
    title="What to do if Your Boat Capsizes"
    url="https://www.boat-ed.com/indiana/studyGuide/Ending-Up-in-the-Water-Unexpectedly/10101602_35417/"
    description="Water safety and rescue procedures." >}}

{{< drg/tip >}}
The common thread across all exposure conditions: shelter is priority one. The specific type of shelter changes (snow cave vs. shade shelter vs. wind break), but the principle is the same—protect yourself from the environment that's trying to kill you.
{{< /drg/tip >}}
