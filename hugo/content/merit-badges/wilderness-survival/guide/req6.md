...
{{< drg/video
    ...
    url="https://youtu.be/bPMKS0qzzSQ" >}}
...
{{< drg/tip >}}
The easiest method of these three is ferro rod. Master it first. Once you can reliably start a fire with a ferro rod, learn the others for backup and confidence. You don't need to be perfect at all three—you need to successfully build three fires using three different methods for the requirement.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Never leave a fire unattended. Always have water or a way to extinguish nearby. Fires spread fast and uncontrollably. Build in a cleared area with no dry material nearby. Before leaving, cool the fire completely and ensure no embers remain.
{{< /drg/safety-first >}}
