...
{{< drg/did-you-know >}}
The rumen of a single cow contains more microorganisms than there are people on Earth. These tiny bacteria, protozoa, and fungi are what allow the cow to turn grass into milk and meat.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Sudden changes in a horse's diet can cause life-threatening colic. Always introduce new feeds gradually over 7–10 days, mixing increasing amounts of the new feed with the old.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
When drawing your digestive tract models, label each organ clearly and use arrows to show the direction food travels. Color-coding the organs by function (storage, fermentation, chemical digestion, absorption) can make your diagrams easier to understand.
{{< /drg/tip >}}

{{< drg/image src="images/digestive-tract-comparison.avif" alt="A side-by-side educational diagram showing simplified outlines of four digestive systems: a ruminant with four stomach compartments labeled, a horse with its large cecum highlighted, a pig with its simple stomach, and a chicken with its crop and gizzard labeled" >}}

## Why Structure Determines Diet

The table below summarizes how digestive tract differences affect feeding:

| Animal | Fiber Digestion | Primary Feed | Feeding Frequency | Key Concern |
|--------|----------------|--------------|-------------------|-------------|
| Ruminant | Excellent (rumen) | Forages, some grain | Continuous grazing | Acidosis from too much grain |
| Horse | Moderate (cecum) | Mostly forage, limited grain | Small, frequent meals | Colic from large meals or sudden changes |
| Pig | Poor | Grain-based concentrates | 2–3 meals/day | High feed costs; cannot use forage efficiently |
| Poultry | Minimal | Ground or pelleted feed | Continuous access | Need grit and extra calcium for layers |

{{< drg/external-link
    title="University of Minnesota Extension — Ruminant Digestive System"
    url="https://extension.umn.edu/dairy-nutrition/ruminant-digestive-system"
    description="Detailed explanation of how the ruminant digestive system works, with diagrams and nutritional implications." >}}
...
{{< drg/next-page
    text="You now understand how four types of digestive systems work and why they matter for feeding."
    teaser="Put your knowledge together — choose an animal and plan how you would manage an entire operation."
