...
{{< drg/tip >}}
When describing a breed's merits, focus on the traits that make it valuable for its principal use. For a beef breed, that might be marbling quality and feed efficiency. For a horse breed, it could be speed, stamina, or temperament.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
A single Holstein cow can produce over 23,000 pounds of milk per year — that is about 2,700 gallons, enough to fill a small swimming pool.
{{< /drg/did-you-know >}}
...
{{< drg/did-you-know >}}
The White Leghorn chicken is so efficient at converting feed into eggs that it can produce about 10 times its own body weight in eggs each year.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/breed-comparison-chart.avif" alt="A visual comparison showing representative animals from each of the seven livestock categories: a horse, dairy cow, beef cow, sheep, hog, chicken, and goat standing side by side" >}}

## How to Prepare

For your counselor meeting, you will need to name **two breeds** from each of the seven categories and be ready to discuss:

{{< drg/checklist title="For Each Breed" subtitle="Be ready to discuss these points" >}}
...
{{< drg/tip >}}
A great way to learn about breeds is to visit a county or state fair. You can see the animals in person, talk to breeders, and compare different breeds side by side. Breed association websites are also excellent sources of detailed information.
{{< /drg/tip >}}

{{< drg/external-link
    title="Oklahoma State University — Breeds of Livestock"
    url="https://breeds.okstate.edu/"
    description="A comprehensive database of livestock breeds from around the world, with photos, history, and breed characteristics for cattle, sheep, goats, horses, and more." >}}
...
{{< drg/next-page
    text="You have explored breeds across seven livestock categories."
    teaser="Learn about common diseases that affect livestock — their symptoms, how they spread, and how to keep animals healthy."
