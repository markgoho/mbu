...
req_number: "6"
prev: "/merit-badges/animal-science/guide/req6-sheep-or-goat/"
prev_title: "Req 6 — Sheep or Goat Option"
next: "/merit-badges/animal-science/guide/req6-avian/"
...
{{< drg/requirement number="6.hog.a" >}}
...
{{< drg/did-you-know >}}
Pork is called "the other white meat," but it is actually classified as red meat by the USDA. The "other white meat" slogan was a marketing campaign from the 1980s designed to position pork as a lean, healthy protein comparable to chicken.
{{< /drg/did-you-know >}}

## Requirement 6b — Feeding Programs

{{< drg/requirement number="6.hog.b" >}}
...
{{< drg/tip >}}
The key principle across all phases: match the feed to the animal's current need. A lactating sow needs maximum fuel for milk production. A finishing pig needs energy-dense feed for efficient growth. Getting the nutrition wrong at any phase affects the bottom line.
{{< /drg/tip >}}

## Requirement 6c — Raise or Visit

{{< drg/requirement number="6.hog.c" >}}
...
{{< drg/checklist title="Farm Visit Questions" subtitle="Topics to explore during your visit" >}}
...
{{< drg/be-prepared title="Visiting a Hog Farm" >}}
Hog farms have some of the strictest biosecurity in agriculture because pigs are highly susceptible to diseases like PRRS and African Swine Fever.
- **Step 1**: Contact the farmer well in advance. Many operations require 48-hour visitor quarantines (no contact with other pigs for 48 hours before your visit).
- **Step 2**: Wear clean clothes and boots. The farm will likely provide coveralls and boot covers.
- **Step 3**: Follow all biosecurity instructions exactly — shower in/shower out protocols are common on large farms.
- **Step 4**: Do not bring food into the barns. Some diseases can be transmitted through meat products.
{{< /drg/be-prepared >}}

## Requirement 6d — Hog Terminology

{{< drg/requirement number="6.hog.d" >}}
...
{{< drg/tip >}}
The difference between a gilt and a sow is simple: has she had babies yet? No = gilt. Yes = sow. This same distinction applies to cattle (heifer vs. cow).
{{< /drg/tip >}}

{{< drg/image src="images/hog-barn-interior.avif" alt="Interior of a clean, well-ventilated hog barn showing pigs in pens with automated feeders and waterers, with good lighting and slatted flooring" >}}

{{< drg/external-link
    title="National Pork Board — Pork Checkoff"
    url="https://www.pork.org/"
    description="Resources on pork production, animal care, and the pork industry from the organization funded by U.S. pork producers." >}}

---

{{< drg/next-page
    text="You have completed the Hog Option guide."
    teaser="Explore the Avian Option — poultry housing, egg grading, and flock management."
