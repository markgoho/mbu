---
title: "Sheep or Goat Option"
layout: guide
group_title: "6. Specialty Options"
req_number: "6"
prev: "/merit-badges/animal-science/guide/req6-horse/"
prev_title: "Horse Option"
next: "/merit-badges/animal-science/guide/req6-hog/"
next_title: "Hog Option"
---
...
{{< drg/requirement number="6.sheep-or-goat.a" >}}
...
{{< drg/did-you-know >}}
Goat is the most widely consumed red meat in the world. More people eat goat than beef. In the United States, demand for goat meat has grown significantly in recent decades, driven by immigrant communities from Latin America, the Caribbean, Africa, and Asia.
{{< /drg/did-you-know >}}

## Requirement 6b — Wool Sorting and Grading

{{< drg/requirement number="6.sheep-or-goat.b" >}}
...
{{< drg/tip >}}
If you choose sheep for this option, try to find a local sheep farm during shearing season (usually spring). Watching a shearer work and handling raw fleece is a memorable experience. Many county fairs also have fleece competitions where you can see graded wool up close.
{{< /drg/tip >}}

## Requirement 6c — Milk Products

{{< drg/requirement number="6.sheep-or-goat.c" >}}
...
{{< drg/did-you-know >}}
Sheep's milk contains about twice the fat and 40% more protein than cow's milk, which is why it makes such rich, flavorful cheese. It takes about 5 pounds of sheep's milk to make one pound of cheese, compared to about 10 pounds of cow's milk.
{{< /drg/did-you-know >}}

## Requirement 6d — Raise or Visit

{{< drg/requirement number="6.sheep-or-goat.d" >}}
...
{{< drg/checklist title="Record-Keeping Essentials" subtitle="Track these items weekly or as events occur" >}}
...
{{< drg/checklist title="Farm Visit Questions" subtitle="Topics to explore" >}}
...
{{< drg/requirement number="6.sheep-or-goat.e" >}}
Define the following terms for a sheep (wether, ewe, ram, and lamb) OR a goat (doe, nanny, kid, buck, and billy).
{{< /drg/requirement >}}
...
{{< drg/tip >}}
Notice that the word "wether" (for a castrated sheep) is spelled differently from "weather" (the climate). This is a common spelling mistake — make sure you get it right for your counselor.
{{< /drg/tip >}}

{{< drg/image src="images/sheep-goat-pasture.avif" alt="A mixed scene showing a small flock of sheep and a few goats grazing on a green hillside pasture with a simple shelter and board fencing in the background" >}}

{{< drg/external-link
    title="American Sheep Industry Association"
    url="https://www.sheepusa.org/"
    description="The national organization for sheep producers, with resources on breeds, production practices, and wool marketing." >}}

---

{{< drg/next-page
    text="You have completed the Sheep or Goat Option guide."
    teaser="Explore the Hog Option — pork cuts, feeding programs, and swine production."
