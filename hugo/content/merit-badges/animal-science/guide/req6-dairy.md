...
req_number: "6"
prev: "/merit-badges/animal-science/guide/req6-beef-cattle/"
prev_title: "Beef Cattle Option"
next: "/merit-badges/animal-science/guide/req6-horse/"
next_title: "Horse Option"
---
...
{{< drg/requirement number="6.dairy.a" >}}
...
1. **Digestion** — The cow eats forage and grain. In her rumen (remember the four-compartment stomach from [Requirement 3](/merit-badges/animal-science/guide/req3/)?), billions of microorganisms ferment the fiber and break down nutrients.
...
{{< drg/did-you-know >}}
It takes about 400 pounds of blood flowing through a cow's udder to produce just one pound of milk. A high-producing Holstein cow's heart pumps over 7,000 gallons of blood per day.
{{< /drg/did-you-know >}}

## Requirement 6b — Milk Components Chart

{{< drg/requirement number="6.dairy.b" >}}
...
{{< drg/tip >}}
For your chart, consider using a pie chart or bar graph to make the comparisons visual. Note that goat's milk has slightly higher fat and protein content than cow's milk, and its fat globules are smaller, which some people find easier to digest.
{{< /drg/tip >}}

## Requirement 6c — Grade A Milk and Pasteurization

{{< drg/requirement number="6.dairy.c" >}}
...
{{< drg/safety-first >}}
The FDA and CDC strongly advise against drinking raw (unpasteurized) milk. Raw milk is one of the riskiest foods you can consume. Pasteurization is one of the most important public health achievements of the past 150 years.
{{< /drg/safety-first >}}

## Requirement 6d — Milking Equipment and Sanitation

{{< drg/requirement number="6.dairy.d" >}}
...
- **Robotic milking systems** — Fully automated systems where cows enter voluntarily and are milked without a human operator (covered in [Requirement 5c](/merit-badges/animal-science/guide/req5c/)).
...
{{< drg/requirement number="6.dairy.e" >}}
...
{{< drg/requirement number="6.dairy.f" >}}
...
{{< drg/checklist title="Questions to Ask During Your Visit" subtitle="Or research these topics if visiting online" >}}
...
{{< drg/be-prepared title="Preparing for a Dairy Farm Visit" >}}
Dairy farms have strict biosecurity protocols. Here is how to be a respectful visitor:
- **Step 1**: Call ahead and schedule your visit. Never show up unannounced.
- **Step 2**: Wear clean clothes and boots. The farm may provide disposable boot covers.
- **Step 3**: Do not touch animals without permission. Ask before entering any barn or pen.
- **Step 4**: Wash your hands before and after your visit.
- **Step 5**: Take notes and photos (with permission) so you can describe what you learned.
{{< /drg/be-prepared >}}

{{< drg/image src="images/dairy-milking-parlor.avif" alt="Interior of a modern dairy milking parlor showing Holstein cows being milked in a herringbone configuration, with clean stainless steel equipment and a worker monitoring the process" >}}

{{< drg/external-link
    title="Dairy Farmers of America — How Milk Gets From Farm to Table"
    url="https://www.dfamilk.com/"
    description="Learn about the dairy supply chain from one of the largest dairy cooperatives in the United States." >}}

---

{{< drg/next-page
    text="You have completed the Dairy Option guide."
    teaser="Explore the Horse Option — barn design, equine history, and horse care."
