...
{{< drg/did-you-know >}}
The United States has a significant shortage of large-animal veterinarians, especially in rural areas. The USDA offers a loan repayment program that will pay up to $25,000 per year toward a veterinarian's student loans if they agree to practice in an underserved area.
{{< /drg/did-you-know >}}

## Preparing for Your Discussion

{{< drg/checklist title="For Your Counselor Meeting" subtitle="Research one career in depth" >}}
...
{{< drg/tip >}}
One of the best ways to research a career is to talk to someone who does it. Ask your counselor, a local extension agent, or a veterinarian if they would be willing to answer a few questions about their career path. People in animal science love to share their experiences with young people.
{{< /drg/tip >}}
...
{{< drg/image src="images/animal-science-careers.avif" alt="A collage showing three animal science careers: a veterinarian examining a horse, a nutritionist analyzing feed samples in a lab, and a ranch manager checking cattle in a pasture" >}}

{{< drg/external-link
    title="American Society of Animal Science — Careers"
    url="https://www.asas.org/taking-stock/blog-post/taking-stock/careers-in-animal-science"
    description="Career information and resources from the professional society for animal scientists." >}}
...
{{< drg/next-page
    text="You have explored career paths in animal science."
    teaser="Go beyond the badge — discover advanced topics, real-world experiences, and organizations to fuel your passion."
    url="/merit-badges/animal-science/guide/extended-learning/" >}}
