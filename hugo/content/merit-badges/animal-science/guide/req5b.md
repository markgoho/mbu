...
{{< drg/did-you-know >}}
Some purebred breed registries have been keeping records for over 200 years. The English Thoroughbred stud book, called the General Stud Book, was first published in 1791 and traces every registered Thoroughbred back to just three founding stallions.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
An easy way to remember the difference: Pure breeding is about **consistency** — producing predictable animals with known traits. Cross breeding is about **combining strengths** — bringing together the best qualities of two or more breeds, often with a boost from hybrid vigor.
{{< /drg/tip >}}
...
{{< drg/image src="images/pure-vs-crossbreed-diagram.avif" alt="An educational diagram showing two paths: on the left, a purebred Angus bull bred to a purebred Angus cow producing a purebred Angus calf; on the right, an Angus bull bred to a Hereford cow producing a crossbred calf with traits from both breeds" >}}

{{< drg/external-link
    title="University of Kentucky Extension — Crossbreeding Systems for Beef Cattle"
    url="https://afs.ca.uky.edu/beef/crossbreeding-systems-for-beef-cattle"
    description="A detailed overview of crossbreeding strategies, hybrid vigor, and how to design a crossbreeding program for a beef cattle operation." >}}
...
{{< drg/next-page
    text="You can now explain pure breeding and cross breeding — the two core breeding strategies."
    teaser="Discover the modern technologies transforming livestock production, from genomics to precision agriculture."
