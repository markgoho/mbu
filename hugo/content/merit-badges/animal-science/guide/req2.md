...
{{< drg/safety-first >}}
Some livestock diseases are zoonotic, meaning they can infect humans. Always wear gloves when handling sick animals, wash your hands thoroughly after any animal contact, and never consume unpasteurized milk or undercooked meat. If you feel ill after working with livestock, tell a parent or guardian and see a doctor.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Bovine respiratory disease costs the U.S. beef industry an estimated $900 million per year in treatment costs, death loss, and reduced performance.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/veterinarian-examining-livestock.avif" alt="A veterinarian in clean work clothes examining a calf in a barn while a Scout in a clean uniform observes and takes notes" >}}
...
{{< drg/checklist title="For Each Disease" subtitle="Be ready to explain these points" >}}
- Name of the disease
...
{{< drg/be-prepared title="You Notice a Sick Animal" >}}
While visiting a farm, you notice a calf standing apart from the herd with a runny nose, droopy ears, and labored breathing.
- **Step 1**: Do not try to treat the animal yourself. Alert the farmer or ranch manager immediately.
- **Step 2**: Keep other animals away from the sick one if possible.
- **Step 3**: Wash your hands thoroughly after any contact.
- **Step 4**: Write down what you observed — the farmer and veterinarian will want to know when symptoms started.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Merck Veterinary Manual"
    url="https://www.merckvetmanual.com/"
    description="A trusted, free veterinary reference covering diseases, symptoms, and treatment for all major livestock species." >}}
...
{{< drg/next-page
    text="You have learned about diseases that affect livestock and how to prevent them."
    teaser="Discover how ruminants, horses, pigs, and poultry digest food in completely different ways — and why that matters."
