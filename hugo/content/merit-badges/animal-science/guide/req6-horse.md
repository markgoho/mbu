...
{{< drg/requirement number="6.horse.a" >}}
...
{{< drg/safety-first >}}
Fire is the greatest threat to a horse barn. Store hay separately from the barn when possible. Install fire extinguishers, keep aisles clear, and have an evacuation plan. Halters should be hung on every stall door so horses can be led out quickly in an emergency.
{{< /drg/safety-first >}}

## Requirement 6b — History and Uses of Horses

{{< drg/requirement number="6.horse.b" >}}
...
When discussing the breeds you chose in [Requirement 1](/merit-badges/animal-science/guide/req1/), focus on how each breed's physical traits match its special use. A Thoroughbred's long legs and lean build make it ideal for racing. A Quarter Horse's muscular hindquarters give it explosive speed for cattle work.

{{< drg/did-you-know >}}
All modern Thoroughbred racehorses trace their ancestry back to just three foundation stallions imported to England in the late 1600s and early 1700s: the Byerly Turk, the Darley Arabian, and the Godolphin Arabian.
{{< /drg/did-you-know >}}

## Requirement 6c — Horse Terminology

{{< drg/requirement number="6.horse.c" >}}
...
{{< drg/requirement number="6.horse.d" >}}
...
{{< drg/checklist title="Questions to Ask During Your Visit" subtitle="Or research these topics online" >}}
...
{{< drg/requirement number="6.horse.e" >}}
...
{{< drg/safety-first >}}
If you suspect a horse has colic, call a veterinarian immediately. While waiting, walk the horse gently to prevent it from rolling (which can cause a twisted intestine). Do not give the horse food, and remove it from bedding it might try to eat. Colic can become life-threatening within hours.
{{< /drg/safety-first >}}

{{< drg/image src="images/horse-barn-paddock.avif" alt="A well-designed horse barn with an attached paddock, showing board fencing, a run-in shed for shade, and two horses grazing on green pasture" >}}

{{< drg/external-link
    title="American Quarter Horse Association"
    url="https://www.aqha.com/"
    description="The world's largest equine breed registry, with resources on horse care, breeding, and competition." >}}

---

{{< drg/next-page
    text="You have completed the Horse Option guide."
    teaser="Explore the Sheep or Goat Option — meat cuts, wool grading, and small ruminant farming."
