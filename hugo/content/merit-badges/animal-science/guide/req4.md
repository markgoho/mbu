...
Every animal needs the right balance of energy, protein, vitamins, minerals, and water. What you learned about digestive systems in [Requirement 3](/merit-badges/animal-science/guide/req3/) directly applies here.
...
{{< drg/tip >}}
Feed is typically the single largest expense in any livestock operation — often 50–70% of total costs. Efficient feeding is not just about animal health; it is about economic survival.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="A New Animal Arrives at Your Farm" >}}
You just purchased a new heifer to add to your small beef herd. How do you introduce her safely?
- **Step 1**: Quarantine the new animal for at least 2–3 weeks in a separate pen, away from your existing herd.
- **Step 2**: Have a veterinarian examine her and update vaccinations.
- **Step 3**: Test for any diseases that could spread to your herd (such as BVD or Johne's disease).
- **Step 4**: Once the quarantine period is complete and she is healthy, introduce her to the herd gradually.
{{< /drg/be-prepared >}}
...
{{< drg/did-you-know >}}
Livestock manure, when composted properly, becomes a nutrient-rich soil amendment. Some dairy farms even use methane digesters to capture biogas from manure and generate electricity — turning waste into energy.
{{< /drg/did-you-know >}}
...
You will explore breeding in much more detail in [Requirement 5](/merit-badges/animal-science/guide/req5a/).
...
{{< drg/checklist title="Biosecurity Basics" subtitle="Practices every operation should follow" >}}
...
{{< drg/safety-first >}}
Biosecurity is not just about protecting your animals — it protects you, your family, and the entire agricultural community. A disease outbreak on one farm can spread to neighboring operations, devastate local economies, and even threaten food safety.
{{< /drg/safety-first >}}

{{< drg/image src="images/scout-managing-livestock.avif" alt="A Scout in clean work clothes standing at a farm gate, clipboard in hand, observing a small group of cattle in a well-maintained pasture with a clean barn in the background" >}}
...
{{< drg/external-link
    title="Penn State Extension — Livestock Management"
    url="https://extension.psu.edu/animals-and-livestock"
    description="Comprehensive resources on managing beef, dairy, sheep, goats, horses, and poultry from one of the top agricultural universities in the country." >}}
...
{{< drg/next-page
    text="You have built a complete management plan for your chosen animal."
    teaser="Find out how breeders use science and strategy to improve livestock traits over time."
