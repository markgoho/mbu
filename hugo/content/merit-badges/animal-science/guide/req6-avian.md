...
req_number: "6"
prev: "/merit-badges/animal-science/guide/req6-hog/"
prev_title: "Hog Option"
next: "/merit-badges/animal-science/guide/req7/"
next_title: "Careers in Animal Science"
---
...
{{< drg/requirement number="6.avian.a" >}}
...
{{< drg/did-you-know >}}
A hen's reproductive cycle is tied directly to day length. In nature, hens lay the most eggs in spring and summer (long days) and slow down in fall and winter (short days). Artificial lighting programs trick the hen's body into thinking it is always spring.
{{< /drg/did-you-know >}}

## Requirement 6b — Overcrowding Dangers

{{< drg/requirement number="6.avian.b" >}}
...
{{< drg/safety-first >}}
Overcrowding is not just a production issue — it is an animal welfare issue. Responsible poultry management means giving birds enough space to move, eat, drink, roost, and express natural behaviors. Many states and retailers now have minimum space requirements for commercially raised poultry.
{{< /drg/safety-first >}}

## Requirement 6c — Egg Grading and Meat Classes

{{< drg/requirement number="6.avian.c" >}}
...
{{< drg/requirement number="6.avian.d" >}}
...
{{< drg/checklist title="Record-Keeping for Flock Management" subtitle="Track these items regularly" >}}
...
{{< drg/tip >}}
If you choose to raise chickens from hatching, start with a reliable incubator and follow the manufacturer's instructions carefully. Temperature (99.5°F for forced-air incubators) and humidity (40–50% for days 1–18, then 65–75% for the final 3 days) must be maintained precisely. Chicken eggs take 21 days to hatch.
{{< /drg/tip >}}

## Requirement 6e — Poultry Terminology

{{< drg/requirement number="6.avian.e" >}}
...
{{< drg/image src="images/poultry-house-interior.avif" alt="Interior of a well-designed layer house showing hens on roosts, nest boxes along the wall, tube feeders suspended from the ceiling, and nipple waterers, with good lighting and clean litter on the floor" >}}

{{< drg/external-link
    title="University of Georgia Extension — Poultry Science"
    url="https://extension.uga.edu/topic-areas/poultry-science.html"
    description="Comprehensive poultry resources from one of the top poultry science programs in the country, covering layers, broilers, and backyard flocks." >}}

---

{{< drg/next-page
    text="You have completed the Avian Option guide."
    teaser="Explore career opportunities in animal science — and find out what it takes to turn your interest into a profession."
