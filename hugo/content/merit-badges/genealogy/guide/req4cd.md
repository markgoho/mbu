...
That thinking links this page directly to [Req 4a–4b](/merit-badges/genealogy/guide/req4ab/), where you learned about physical and digital resources.
...
{{< drg/image src="images/original-record-vs-index-comparison.avif" alt="Side-by-side comparison of a scanned historical record image and a typed index entry showing how handwriting, spellings, and household details can differ" >}}

{{< drg/be-prepared title="You Found a Record — But Is It the Right Person?" >}}
When a record seems promising but you are not fully sure:

- **Compare more than the name.** Check ages, places, relatives, and occupations.
- **Look for a cluster.** A spouse, sibling, or child can help confirm identity.
- **Check nearby records.** Another census year, a city directory, or an obituary may support the match.
- **Stay honest.** "Probably" is better than pretending you are certain.
{{< /drg/be-prepared >}}
...
{{< drg/checklist title="How to Evaluate a Genealogical Document" subtitle="Use these questions before trusting a record" >}}
...
{{< drg/tip >}}
Save a copy of the document image if you are allowed to, and record where you found it. A document without source information is much harder to trust or relocate later.
{{< /drg/tip >}}

{{< drg/external-link
    title="National Archives — Start Your Genealogy Research"
    url="https://www.archives.gov/research/genealogy/start-research"
    description="Guidance on how to begin searching for family records and evaluate what you find." >}}
...
{{< drg/next-page
    text="You can now find a genealogical document and explain why it is useful evidence."
    teaser="Learn the most likely places to search for marriage, census, birth, and burial records."
