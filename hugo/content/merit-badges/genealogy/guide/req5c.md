...
{{< drg/video
    title="How to Use Facebook Surname Groups for Genealogy Research (Tiny Tip Tuesday #1)"
    url="https://www.youtube.com/watch?v=fv9vpbktRhs" >}}
...
That means a surname organization is a place to gather clues, not a substitute for evidence. Use what you learn there as a lead to test with records, just as you learned in [Req 4](/merit-badges/genealogy/guide/req4ab/).

{{< drg/checklist title="Questions to Ask a Surname Organization" subtitle="Learn how the group collects and shares family information" >}}
...
{{< drg/tip >}}
Ask whether the group keeps a family-history newsletter, archive, or reunion booklet. Those can contain clues about names, places, and relatives worth researching further.
{{< /drg/tip >}}

{{< drg/external-link
    title="Cyndi's List — Surnames"
    url="https://www.cyndislist.com/surnames/"
    description="A directory of family-history resources related to surnames, one-name studies, and related research groups." >}}
...
{{< drg/next-page
    text="You can now explain what surname organizations do and how they help researchers share clues."
    teaser="Learn how genealogy education centers, libraries, and training facilities help people build research skills."
