...
{{< drg/did-you-know >}}
The word "genealogy" comes from Greek words that relate to birth, family line, and study. People have been tracing family connections for thousands of years.
{{< /drg/did-you-know >}}

{{< drg/video
    title="What is Genealogy? (And other terminology)"
    url="https://www.youtube.com/watch?v=7V-nmASSPRk" >}}
...
{{< drg/image src="images/pedigree-chart-layout.avif" alt="Example pedigree chart showing one person, parents, grandparents, and relationship lines across three generations" >}}
...
{{< drg/tip >}}
When two relatives share the same name, compare dates, locations, spouses, and children's names before deciding they are the same person. Names repeat often in family history.
{{< /drg/tip >}}

{{< drg/video
    title="You Are Your Own Negative First Cousin"
    url="https://www.youtube.com/watch?v=PM79Epw_cp8" >}}
...
In [Req 6](/merit-badges/genealogy/guide/req6/), you will build a pedigree chart, and in [Req 7](/merit-badges/genealogy/guide/req7/), you will make family group records. Understanding the difference now will make those pages much easier.

{{< drg/video
    title="What are Pedigree Charts and Family Group Sheets? (Genealogy)"
    url="https://www.youtube.com/watch?v=mLJhNZk-BGg" >}}

{{< drg/checklist title="Be Ready to Explain These Basics" subtitle="Use this as a quick review before meeting with your counselor" >}}
...
{{< drg/external-link
    title="National Genealogical Society — Learning Center"
    url="https://www.ngsgenealogy.org/learning-center/"
    description="Beginner-friendly articles and lessons about family history research, charts, and record keeping." >}}
...
{{< drg/next-page
    text="You can now explain the basic terms and charts that genealogists use."
    teaser="Choose a personal storytelling project: make a timeline and biography or keep a six-week journal."
