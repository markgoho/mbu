...
{{< drg/video
    title="Where to Find Records for Family History Research"
    url="https://www.youtube.com/watch?v=9HH-dtvTSOw" >}}
...
This option ties directly to [Req 4e](/merit-badges/genealogy/guide/req4e/), where you learned likely places to find marriage, census, birth, and burial records. Repositories are often those places.
...
{{< drg/checklist title="Questions to Ask a Repository" subtitle="Use these to learn what the institution preserves and how access works" >}}
...
{{< drg/tip >}}
Before contacting a repository, gather the names, dates, and places you already know. Staff can help more effectively when you ask a focused question instead of "Tell me everything about my family."
{{< /drg/tip >}}

{{< drg/external-link
    title="Library of Congress — Local History and Genealogy Reading Room"
    url="https://www.loc.gov/rr/genealogy/"
    description="An example of a major repository that preserves genealogical and local-history materials for researchers." >}}
...
{{< drg/next-page
    text="You can now explain what a genealogical repository does and why it matters."
    teaser="Use what you have learned so far to begin your own family tree across at least two additional generations."
