...
- Family members you interviewed in [Req 3](/merit-badges/genealogy/guide/req3/)
- Family records and documents from [Req 4](/merit-badges/genealogy/guide/req4ab/)
...
{{< drg/image src="images/pedigree-chart-blank-and-filled.avif" alt="Side-by-side comparison of a blank pedigree chart and the same chart partly filled with names across three generations to show how empty spaces reveal research goals" >}}

{{< drg/video
    title="How to make a family tree"
    url="https://www.youtube.com/watch?v=Ci55EXJtlDM" >}}
...
That caution becomes even more important when you reach [Req 8a–8c](/merit-badges/genealogy/guide/req8abc/), where you will study how computers and the internet have changed genealogy.

{{< drg/safety-first >}}
Do not post living people's full birth dates, addresses, or other private information on public websites without permission from a parent or guardian and the people involved. Family history should be handled with care.
{{< /drg/safety-first >}}

{{< drg/download
    title="Pedigree Chart Worksheet"
    url="/merit-badges/genealogy/guide/pedigree-chart-worksheet/"
    type="printable" >}}
...
{{< drg/checklist title="Pedigree Chart Basics" subtitle="Use this to build a chart you can explain confidently" >}}
...
{{< drg/tip >}}
If you have relatives with similar names, add locations or years in your notes right away. That will help you keep the right person in the right generation.
{{< /drg/tip >}}

{{< drg/external-link
    title="National Genealogical Society — Free Charts and Forms"
    url="https://www.ngsgenealogy.org/free-resources/charts/"
    description="Printable genealogy forms, including pedigree-style charts that can help you organize your family history." >}}
...
{{< drg/next-page
    text="You can now begin a pedigree chart that shows how generations connect."
    teaser="Learn how family group records capture more detailed information about parents, siblings, and children."
