...
{{< drg/video
    title="How Family Group Sheets can help preserve and share genealogy research for future generations"
    url="https://www.youtube.com/watch?v=nb2C3z7C_R8" >}}
...
{{< drg/image src="images/family-group-record-layout.avif" alt="Example family group record showing parents at the top and several children listed below with dates and places, demonstrating one family unit in detail" >}}


{{< drg/download
    title="Family Group Record Worksheet"
    url="/merit-badges/genealogy/guide/family-group-record-worksheet/"
    type="printable" >}}

{{< drg/checklist title="Strong Family Group Records" subtitle="Use these habits while you fill out each form" >}}
...
In [Req 6](/merit-badges/genealogy/guide/req6/), you built a pedigree chart. Together, these two requirements form the core record-keeping tools of the badge.

{{< drg/tip >}}
Before filling in the second family group record, ask your parent to review names, nicknames, middle names, and birth order. Small corrections now can save confusion later.
{{< /drg/tip >}}

{{< drg/external-link
    title="FamilySearch — Genealogy Forms"
    url="https://www.familysearch.org/en/wiki/Genealogy_Research_Forms"
    description="Examples of common genealogy forms and explanations of how family group records help organize research." >}}
...
{{< drg/next-page
    text="You can now use family group records to organize detailed information about one family unit."
    teaser="Explore how computers, photography, and indexing transformed the way genealogists work."
