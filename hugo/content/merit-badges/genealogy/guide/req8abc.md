...
But speed can create problems. When records are easy to click, people sometimes copy bad information without checking it. Public family trees can spread mistakes quickly. Good genealogy still requires the habits you practiced in [Req 4c–4d](/merit-badges/genealogy/guide/req4cd/): compare sources and test evidence.

{{< drg/video
    title="How to Use the Internet Archive for Genealogy"
    url="https://www.youtube.com/watch?v=Ltc0EjJzB5k" >}}
...
{{< drg/video
    title="Getting Involved: Quick Name Review"
    url="https://www.youtube.com/watch?v=tP-m8IWX6vU" >}}
...
{{< drg/image src="images/genealogy-workflow-then-and-now.avif" alt="Split-scene comparison showing an earlier researcher using microfilm and paper notes on one side and a modern researcher using a computer with scanned records on the other" >}}
...
{{< drg/video
    title="New: How to \"Get Involved\" with FamilySearch indexing on your phone!"
    url="https://www.youtube.com/watch?v=cFjbF7sGNoA" >}}

{{< drg/video
    title="FamilySearch: Get Involved Introduction | RootsTech 2022"
    url="https://www.youtube.com/watch?v=fzd619Xv7N8" >}}

{{< drg/checklist title="Technology's Effects on Genealogy" subtitle="Use these ideas to explain the big picture" >}}
...
{{< drg/tip >}}
When an index result looks promising, open the image behind it if possible. The indexed line is only the shortcut — the original record is the evidence.
{{< /drg/tip >}}

{{< drg/external-link
    title="FamilySearch Wiki — Indexing Overview"
    url="https://www.familysearch.org/en/wiki/Indexing"
    description="An overview of how indexing works and why it makes large record collections searchable." >}}
...
{{< drg/next-page
    text="You can now explain how digital tools, photography, and indexing transformed family-history research."
    teaser="Reflect on what your research revealed about your family members, their lives, and your connection to them."
