...
{{< drg/video
    title="Can't Find An Ancestor's Birth Record? 8 Places To Look!"
    url="https://www.youtube.com/watch?v=vhCBJEAdzkM" >}}
...
{{< drg/video
    title="7 FREE Genealogy Websites You're Overlooking"
    url="https://www.youtube.com/watch?v=WQ6ELtmhnyQ" >}}
...
In [Req 3](/merit-badges/genealogy/guide/req3/), you practiced collecting memories from living people. Now you are learning how records can support, clarify, or sometimes correct those memories.

{{< drg/checklist title="How Sources Help Your Family Tree" subtitle="Use this framework when you explain the value of a source" >}}
...
{{< drg/tip >}}
When you find a useful source, record exactly where it came from. If you want to check it again later, you will need the website, archive, book title, page number, or record collection name.
{{< /drg/tip >}}

{{< drg/external-link
    title="FamilySearch — Genealogy Records by Location"
...
{{< drg/next-page
    text="You can now name physical and digital resources and explain why each one matters."
    teaser="Learn how to obtain one genealogical document and evaluate the information it contains."
