...
Try to use at least a few different kinds of sources. You might ask a relative, look at old photos, check school programs, read obituary details, or examine records already gathered in [Req 1](/merit-badges/genealogy/guide/req1/). When information comes from memory, write it down carefully and confirm it later if you can.

{{< drg/video
    title="Avoid mistakes by using my 2nd most important genealogy tip - it's all about timelines"
    url="https://www.youtube.com/watch?v=_hKMBqEUE1w&t=95s" >}}
...
{{< drg/checklist title="Good Biography Habits" subtitle="Use these ideas as you turn your timeline into a short life story" >}}
...
These kinds of questions often produce richer stories than a general question. They also prepare you for [Req 3](/merit-badges/genealogy/guide/req3/), where you will interview a relative or family acquaintance and record the information carefully.

{{< drg/tip >}}
If you get stuck, choose five anchor events first: birth, childhood home, a school milestone, a major family event, and one recent event. Then fill in the spaces between them.
{{< /drg/tip >}}

{{< drg/be-prepared title="What if the Dates Do Not Match?" >}}
If two sources disagree about a date or event:

- **Write down both versions.** Do not erase one clue just because it does not fit.
- **Note where each version came from.** Memory, photo caption, school record, or something else.
- **Look for a third source.** Another document or another relative may clear up the conflict.
- **Use the best-supported version.** In genealogy, the strongest conclusion is the one backed by the most reliable evidence.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="National Archives — Genealogy Notes"
    url="https://www.archives.gov/research/genealogy"
    description="Tips from the National Archives for gathering family history information and locating records that can support a timeline." >}}
...
{{< drg/next-page
    text="You can now build a timeline and use it as the foundation for a short biography."
    teaser="See how a simple weekly journal can become a valuable primary source for future family historians."
