...
{{< drg/image src="images/family-history-interview-setup.avif" alt="Scout interviewing an older relative with notebook, labeled family photos, and keepsakes spread out to prompt memories" >}}
...
{{< drg/video
    title="How To Master the Art of Interviewing with 5 Easy Journalist Techniques"
    url="https://www.youtube.com/watch?v=NWDL_UYMc7Q" >}}
...
Soon after the interview, review your notes while the conversation is still fresh. Mark anything you need to verify later. If the person mentions a family Bible, box of letters, or old military papers, write that down too. Those clues may help with [Req 4](/merit-badges/genealogy/guide/req4ab/), where you will work with genealogical resources and documents.

{{< drg/checklist title="Interview Day Checklist" subtitle="Use this before and during the conversation" >}}
...
{{< drg/safety-first >}}
Always involve a parent or guardian when choosing who to contact and how to contact them. If you interview by email, phone, or letter, use safe, approved contact information and avoid sharing private details publicly.
{{< /drg/safety-first >}}

{{< drg/be-prepared title="What if the Interview Goes Quiet?" >}}
If the person gives short answers or seems unsure:

- **Switch to objects or places.** Ask about a photo, a house, or a school instead of a broad life summary.
- **Use memory helpers.** Dates, old addresses, holiday traditions, or family events can spark recall.
- **Ask follow-up questions.** "What happened next?" and "Who else was there?" often reopen the story.
- **Do not force it.** A short interview can still provide valuable clues.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
End by asking, "Who else should I talk to?" That one question often leads to your next interview, photo collection, or family record.
{{< /drg/tip >}}

{{< drg/external-link
    title="StoryCorps — Great Questions"
    url="https://storycorps.org/participate/great-questions/"
    description="A large collection of respectful, open-ended interview questions that can help you start meaningful conversations." >}}
...
{{< drg/next-page
    text="You can now plan an interview, ask stronger questions, and preserve the answers."
    teaser="Learn where family historians find physical and digital records that support the stories people tell."
