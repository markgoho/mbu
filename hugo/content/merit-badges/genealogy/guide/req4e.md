...
{{< drg/video
    title="Vital Records: (Where to Find Birth, Marriage, Death and Divorce Records for Genealogy)"
    url="https://www.youtube.com/watch?v=N5NT3-zvRhs" >}}
...
This requirement connects naturally to [Req 4c–4d](/merit-badges/genealogy/guide/req4cd/), because once you know where records are likely to be, you can search more efficiently and explain your process better.

{{< drg/checklist title="Likely Homes for Common Records" subtitle="Use this as a quick memory aid" >}}
...
{{< drg/tip >}}
If you cannot find a record where you expected, ask where older records were transferred. Many jurisdictions send older files to archives, libraries, or historical societies.
{{< /drg/tip >}}

{{< drg/external-link
    title="National Archives — Census Records"
    url="https://www.archives.gov/research/census"
    description="Background on U.S. census records and how they help researchers track families across time." >}}
...
{{< drg/next-page
    text="You can now match key genealogical record types with the places that usually hold them."
    teaser="Compare the kinds of societies, experts, and repositories that can support your research."
