...
{{< drg/did-you-know >}}
The CPSC has recalled over 5,000 products since it was created. One of the biggest categories? Children's toys. Thanks to the CPSC, manufacturers must test toys for choking hazards, lead paint, and other dangers before they can be sold.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
For your counselor discussion, aim to explain at least **three consumer protection laws** and **two seller protections**. Use real-life examples to show you understand how each law works in practice.
{{< /drg/tip >}}
...
{{< drg/checklist title="Consumer Help Organizations" subtitle="Places consumers can turn to for assistance" >}}
...
{{< drg/checklist title="Seller Help Organizations" subtitle="Resources that support businesses and sellers" >}}
...
{{< drg/external-link
    title="Consumer Information — Federal Trade Commission"
    url="https://consumer.ftc.gov/"
    description="The FTC's consumer-facing site with advice on scams, identity theft, shopping, and more." >}}

{{< drg/external-link
    title="Consumer Product Safety Commission"
    url="https://www.cpsc.gov/"
    description="Search product recalls, report unsafe products, and learn about safety standards." >}}

{{< drg/image src="images/consumer-protection-scene.avif" alt="A Scout examining a product label in a store while a magnifying glass highlights safety certification marks" >}}

---

{{< drg/next-page
    text="You now know how laws protect both buyers and sellers."
    teaser="Get ready to experience the legal system firsthand — in a real courtroom or through a mock trial."
