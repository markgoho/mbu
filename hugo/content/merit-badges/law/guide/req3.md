...
{{< drg/did-you-know >}}
Crimes are classified by severity. A **felony** is a serious crime (like robbery or arson) that can carry more than one year in prison. A **misdemeanor** is a less serious offense (like petty theft or trespassing) that typically carries less than one year in jail.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Here is a quick way to remember the difference: In criminal law, the government says "You broke society's rules." In civil law, a person says "You wronged me, and I want to be made whole."
{{< /drg/tip >}}

## Key Differences at a Glance

{{< drg/checklist title="Criminal vs. Civil Law" subtitle="Key differences between the two branches" >}}
...
{{< drg/be-prepared title="When Your Counselor Asks for Examples" >}}
Have at least **two examples of criminal cases** and **two examples of civil cases** ready. Use real-life situations that are easy to explain:
- **Criminal**: "If someone breaks into a house and steals a TV, the state charges them with burglary."
- **Civil**: "If a dog owner's dog bites a neighbor, the neighbor can sue the owner for medical expenses."

Then be ready to explain the key differences — who brings the case, the standard of proof, and the possible punishments.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Types of Cases — United States Courts"
    url="https://www.uscourts.gov/about-federal-courts/types-cases"
    description="The federal courts explain the different types of cases they handle, including criminal and civil matters." >}}

{{< drg/image src="images/courtroom-split-view.avif" alt="A courtroom scene split down the middle — one side representing a criminal case, the other a civil case" >}}

---

{{< drg/next-page
    text="Now you understand the two main branches of law."
    teaser="Discover what people in your community think about law enforcement and its role in society."
