---
title: "Becoming a Lawyer or Judge"
layout: guide
group_title: "7. Legal Careers"
req_number: "8"
prev: "/merit-badges/law/guide/req7/"
prev_title: "Visit with a Lawyer"
next: "/merit-badges/law/guide/req9/"
next_title: "Jobs in Law"
---
...
{{< drg/did-you-know >}}
The bar exam gets its name from the "bar" — a railing in a courtroom that separates the spectators from the lawyers and judge. To "pass the bar" originally meant you were qualified to step past that railing and practice law.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="How States Choose Judges" subtitle="Common methods for selecting state judges" >}}
...
{{< drg/tip >}}
This requirement asks about **your state** specifically. Before your counselor meeting, research how judges are selected where you live. Your state court system website is the best source. Search for "[your state] how judges are selected" to find the details.
{{< /drg/tip >}}

## Preparing for Your Counselor Discussion

{{< drg/be-prepared title="Know Your State's Details" >}}
Your counselor will expect you to know two things specific to your state:
1. **Lawyer requirements** — While the general process (college → law school → bar exam) is the same everywhere, look up your state's specific bar exam and any unique requirements.
2. **Judge selection** — Find out which method your state uses. Does it elect judges or appoint them? Are elections partisan or nonpartisan? Do some courts use different methods than others?

A great resource is your state bar association's website or your state court system's website.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="How to Become a Lawyer — Bureau of Labor Statistics"
    url="https://www.bls.gov/ooh/legal/lawyers.htm"
    description="The BLS Occupational Outlook Handbook covers education requirements, pay, and job outlook for lawyers." >}}

{{< drg/external-link
    title="Judicial Selection in the States — Ballotpedia"
    url="https://ballotpedia.org/Judicial_selection_in_the_states"
    description="A comprehensive state-by-state guide to how judges are chosen." >}}

{{< drg/image src="images/law-school-graduation.avif" alt="A young graduate in a cap and gown holding a law degree diploma in front of a university building" >}}

---

{{< drg/next-page
    text="You now know what it takes to become a lawyer or judge."
    teaser="Discover the wide world of careers connected to law — there are more than you might think."
