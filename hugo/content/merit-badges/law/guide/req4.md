...
{{< drg/did-you-know >}}
The first organized police force in the United States was established in Boston in 1838. Before that, communities relied on volunteer night watchmen and elected constables to keep order.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Law Enforcement Levels" subtitle="Who enforces the law at each level of government" >}}
...
{{< drg/tip >}}
Be a good listener. Take notes during or right after each conversation. Your counselor will want to hear specific responses, not just "everyone said police keep us safe." The interesting part is how people's answers are similar — and how they differ.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Reporting to Your Counselor" >}}
When you report your findings, try this structure:
- **Start** with who you interviewed (no names needed — just their role, like "a neighbor" or "my teacher")
- **Summarize** the common themes you heard
- **Highlight** any differences in perspective
- **Share** what surprised you or what you learned

Your counselor wants to see that you listened carefully, thought critically, and can talk about different viewpoints respectfully.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="About Law Enforcement — U.S. Department of Justice"
    url="https://www.justice.gov/law-enforcement"
    description="Learn about the Department of Justice's law enforcement agencies and their missions." >}}

{{< drg/image src="images/scout-interview-community.avif" alt="A Scout with a notebook talking to a community member outside a local business" >}}

---

{{< drg/next-page
    text="You have explored how law enforcement serves your community."
    teaser="Learn about the laws that protect you as a consumer — and the businesses you buy from."
