...
{{< drg/tip >}}
Choose **one** of the two options below. Both give you a hands-on look at how the courtroom works — Option A takes you to a real court, and Option B lets you build one yourself.
{{< /drg/tip >}}
...
{{< drg/checklist title="Courtroom Observation Guide" subtitle="Things to notice during a court session" >}}
...
{{< drg/safety-first >}}
When visiting a courthouse, follow all security procedures. You may need to pass through a metal detector. Leave pocket knives, multitools, and any prohibited items at home or in the car. Dress respectfully — you are visiting a place where serious decisions are made. Turn off your phone and do not take photos or recordings unless you have specific permission.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Mock Trial Roles" subtitle="Every mock trial needs these participants" >}}
...
{{< drg/be-prepared title="Making Your Mock Trial Great" >}}
The best mock trials feel real. Here are some tips:
- **Dress the part** — the judge can wear a dark robe (even a bathrobe works)
- **Use a gavel** or bang a book on the table to call order
- **Take it seriously** — stay in character and follow the procedures
- **Write it out** — have each attorney prepare a short opening statement and at least three questions for each witness
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Mock Trial Resources — American Bar Association"
    url="https://www.americanbar.org/groups/public_education/resources/law_related_education_network/mock-trial/"
    description="The ABA provides mock trial guides, case scenarios, and teaching resources for students." >}}

{{< drg/image src="images/mock-trial-setup.avif" alt="Scouts in a meeting room set up as a mock courtroom, with roles assigned as judge, attorneys, witnesses, and jury members" >}}

---

{{< drg/next-page
    text="You have experienced the courtroom — real or simulated."
    teaser="Now meet a real lawyer and find out what a career in law actually looks like."
