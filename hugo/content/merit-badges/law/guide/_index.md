...
{{< drg/image src="images/scout-courthouse-steps.avif" alt="A Scout standing at the base of a courthouse with tall columns, looking up with curiosity and interest" >}}
...
{{< drg/did-you-know >}}
In the United States, a person accused of a crime is considered "innocent until proven guilty." The government must prove the case "beyond a reasonable doubt" — one of the highest standards of proof in any legal system in the world.
{{< /drg/did-you-know >}}
...
{{< drg/did-you-know >}}
The U.S. Constitution is one of the shortest constitutions in the world — just about 4,500 words. Yet it has guided the nation for over 230 years, making it the oldest written national constitution still in use.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/scales-of-justice-cityscape.avif" alt="A stylized image of the scales of justice in the foreground with a modern city skyline behind, symbolizing law's role in society" >}}
...
{{< drg/next-page
    text="You have learned about the major kinds of law and why they matter."
    teaser="Find out what law really is — its definition, its sources, and the functions it serves."
    url="/merit-badges/law/guide/req1/" >}}
