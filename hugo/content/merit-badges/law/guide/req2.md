---
title: "Landmarks in Legal History"
layout: guide
group_title: "1. Foundations of Law"
req_number: "2"
prev: "/merit-badges/law/guide/req1/"
prev_title: "What Is Law?"
next: "/merit-badges/law/guide/req3/"
next_title: "Civil vs. Criminal Law"
---
...
{{< drg/tip >}}
You need to choose **two** of the three options below. Read through all of them to decide which two interest you most, then prepare to discuss your choices with your counselor.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Only four original copies of the 1215 Magna Carta survive today. Two are held by the British Library, one is at Salisbury Cathedral, and one is at Lincoln Cathedral. A 1297 copy is on permanent display at the National Archives in Washington, D.C.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
If you choose this option, be ready to trace the journey: Athens → medieval England → the Magna Carta → the U.S. Constitution. Your counselor will want to see that you understand how the jury system developed over time, not just what it looks like today.
{{< /drg/tip >}}
...
For whichever two trials you pick, be ready to explain:
- **Who** was on trial and **why**
- **What** the outcome was
- **Why** the trial is still important today

Your counselor is not looking for a long lecture. Focus on the big ideas and what the trial teaches us about justice.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Magna Carta — National Archives"
    url="https://www.archives.gov/exhibits/featured-documents/magna-carta"
    description="Explore the history and text of the Magna Carta at the U.S. National Archives." >}}

{{< drg/external-link
    title="Landmark Supreme Court Cases — United States Courts"
    url="https://www.uscourts.gov/about-federal-courts/educational-resources/supreme-court-landmarks"
    description="Read about the most important Supreme Court decisions in U.S. history." >}}

{{< drg/image src="images/magna-carta-document.avif" alt="A stylized illustration of an aged parchment document with a wax seal, representing the Magna Carta, with a quill pen resting beside it" >}}

{{< drg/image src="images/jury-deliberation.avif" alt="A diverse group of jurors seated around a table in a jury deliberation room, engaged in thoughtful discussion" >}}

---

{{< drg/next-page
    text="You have explored the origins of law and historic legal milestones."
    teaser="Learn the key differences between civil law and criminal law — two branches that affect everyday life."
