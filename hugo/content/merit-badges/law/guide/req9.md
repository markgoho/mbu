...
{{< drg/did-you-know >}}
Court reporters can type over 200 words per minute using a specialized machine called a **stenograph**. The machine uses a phonetic shorthand — the reporter presses combinations of keys to represent sounds rather than individual letters, allowing them to capture speech in real time.
{{< /drg/did-you-know >}}

{{< drg/tip >}}
Do not list 15 jobs and stop there. The requirement also asks you to pick the one you prefer and explain **why**. Think about what you enjoy — working with people, solving puzzles, writing, technology, public speaking — and connect that to a career. Your counselor will want to see genuine thought, not just a list.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Choosing Your Favorite" >}}
When you tell your counselor which job you prefer, make your answer personal:
- "I like solving problems and being in the middle of the action, so I would choose **detective** because..."
- "I enjoy writing and research, so **paralegal** appeals to me because..."
- "I am interested in technology and privacy, so **compliance officer** in tech sounds like..."

There is no right or wrong answer — your counselor just wants to see that you thought about it.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Legal Occupations — Bureau of Labor Statistics"
    url="https://www.bls.gov/ooh/legal/home.htm"
    description="Explore legal careers with detailed information on duties, education, pay, and job outlook." >}}

{{< drg/image src="images/law-career-collage.avif" alt="A collage of diverse law-related professionals at work — forensic scientist, court reporter, police officer, and paralegal" >}}

---

{{< drg/next-page
    text="You have explored the many careers connected to law."
    teaser="Learn how people who cannot afford a lawyer can still get the legal help they need."
