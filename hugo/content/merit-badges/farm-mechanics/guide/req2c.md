...
{{< drg/safety-first >}}
The PTO shaft is one of the most dangerous parts of a tractor. It rotates at 540 or 1,000 RPM — fast enough to catch loose clothing, hair, or a hand in a fraction of a second. Always shut down the tractor before working near the PTO shaft. Never wear loose clothing or long sleeves when working around PTOs. Always use a PTO guard — if the guard is missing or broken, do not operate the equipment.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Transmission repairs are expensive — often thousands of dollars. Many transmission problems can be prevented with simple maintenance: keeping the fluid clean, checking the level, and addressing small leaks before they become big problems. Preventive maintenance is always cheaper than repairs.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You now understand the three main power systems in farm equipment: diesel engines, hydraulics, and transmissions."
    teaser="Now let's build practical skills — learn how to maintain and repair hand tools."
