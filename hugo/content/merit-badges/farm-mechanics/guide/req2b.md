...
{{< drg/tip >}}
If a hydraulic system is losing pressure or moving slowly, the first thing to check is the filter. A clogged filter restricts flow and makes the system seem weak. Many problems that seem expensive to fix are actually just a clogged filter.
{{< /drg/tip >}}
...
- **Step 2:** Seek medical help immediately — preferably at an emergency room or urgent care.
- **Step 3:** Tell the medical team that you have a pressurized fluid injection injury. This is a surgical emergency because the fluid can damage tissue deep under the skin, and infection can develop quickly.
- **Step 4:** Even if the initial wound seems minor, pressurized injection injuries often require surgery to remove damaged tissue and prevent infection.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You now understand how hydraulic systems transfer power — the muscle of farm equipment."
    teaser="Learn about transmissions and other power transfer systems that control how equipment moves."
