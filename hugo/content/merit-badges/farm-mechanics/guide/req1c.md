...
{{< drg/video
    title="ANSI Standards: Safety Signs and Labels — Clarion Safety Systems"
    url="https://www.youtube.com/watch?v=VBY1lI9SUOw" >}}

{{< drg/video
    title="ISO Symbols for Safety Signs and Labels — Clarion Safety Systems"
    url="https://www.youtube.com/watch?v=izeWHwDCUes" >}}
...
1. **Choose your equipment:** A tractor is ideal because it has many different hazards and symbols. A combine, baler, or grain auger works too.

2. **Examine systematically:** Start at the front and work backward, looking at every side and area:
...
3. **Document what you find:** Take photos or make sketches of each symbol. Write down:
...
4. **Compare with a standard symbol reference:** The American National Standards Institute (ANSI) publishes standard symbols. You can find these online or in safety manuals. Check whether the symbols you found match the standard.

5. **Be ready to explain:** Your counselor will want to hear you explain the meaning and importance of several of these symbols. Be able to say things like:
...
{{< drg/tip >}}
If a symbol on equipment is faded or missing, that is a problem. Manufacturers are required to replace worn or damaged warning labels. If you notice missing labels on a piece of equipment you use, report it to the owner so they can order replacement labels and keep the equipment safe.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Some of the most dangerous farm equipment has no warning because people grew up using it and do not think about the hazard anymore. Grain bins are a tragic example — grain can act like quicksand and trap a person in a few seconds if they fall in. Rescue is difficult and often results in death. Yet many grain bins have no warning label. The lesson: do not assume that missing labels mean an area is safe. Think critically about what hazards might exist.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You now understand what warning symbols mean and how to find them on equipment."
    teaser="Learn what a Safety Data Sheet is — and why you need to read it for every hazardous material in the shop."
