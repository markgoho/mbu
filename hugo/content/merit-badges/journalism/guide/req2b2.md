...
{{< drg/image src="images/broadcast-station-roles-map.avif" alt="Top-down map of a station showing assignment desk, producers, studio, control room, and field crew with arrows for how information moves" >}}
...
{{< drg/safety-first >}}
If you go with a reporter to cover a live event, follow instructions immediately. Stay with the adult you are assigned to, keep gear areas clear, and never interfere with emergency responders, event staff, or the public.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You now understand how a broadcast station organizes people, technology, and deadlines."
    teaser="Next, choose one storytelling project and create journalism yourself."
