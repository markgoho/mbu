...
{{< drg/checklist title="Broadcast Writing Checklist" subtitle="Use this before you present or share your scripts" >}}
...
{{< drg/tip >}}
Mark places where a pause, sound clip, or visual would fit. Even if you are not producing the final audio or video, thinking that way improves your writing.
{{< /drg/tip >}}

This option builds on what you practiced in [Req 2b](/merit-badges/journalism/guide/req2b/), where you compared how broadcast outlets use timing, voice, and visuals.

Next, if you want to tell the story with images instead of scripts, move to the photojournalism option.

{{< drg/next-page
    text="You know how to shape one event into a news script, a feature script, and a review."
    teaser="Next, learn how to build an event story with photographs, captions, and a short synopsis."
