...
Choose a current or an unusual event of interest to you, and write either a hard news article OR a feature article about the event. Gear the article for print OR online OR audio OR video journalism. Share your article with your counselor.
{{< /drg/requirement >}}
...
{{< drg/checklist title="Reporting Plan for Option 3a" subtitle="What to gather before you write" >}}
...
{{< drg/be-prepared title="If your first idea falls apart" >}}
Sometimes an event gets canceled or the story turns out to be too thin.

- **Pivot quickly:** Keep a backup event in mind.
- **Narrow your focus:** One person or one moment may be more interesting than the whole event.
- **Report what changed:** A cancellation or surprise can become the story.
{{< /drg/be-prepared >}}

In [Req 4](/merit-badges/journalism/guide/req4/), you will cover a public event in a more structured way. This option gives you good practice before that requirement.
...
{{< drg/next-page
    text="You know how to choose an angle, gather reporting, and match your story to the right platform."
    teaser="Next, learn how to prepare for a strong interview with an influential person in your community."
