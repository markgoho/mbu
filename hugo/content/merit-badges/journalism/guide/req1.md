...
{{< drg/checklist title="How Press Freedom Helps the Public" subtitle="Why this protection matters in everyday life" >}}
...
{{< drg/image src="images/fact-vs-opinion-comparison.avif" alt="Side-by-side comparison showing how a fact is supported by evidence while an opinion uses judgment language" >}}
...
{{< drg/tip >}}
When you write, label opinion clearly. Words like *best*, *terrible*, *boring*, or *inspiring* are clues that you have moved from reporting into commentary.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
A journalist can still get a story wrong without committing actual malice. The key question is whether the reporter acted responsibly and tried honestly to verify the truth.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="If a source tells you something explosive" >}}
Before repeating it, slow down.

- **Ask for evidence:** A document, recording, eyewitness, or other proof matters more than a rumor.
- **Seek another source:** One source may be mistaken, biased, or incomplete.
- **Contact the other side:** Fair reporting gives people a chance to respond to serious claims.
- **Check your wording:** Do not turn an allegation into a proven fact.
{{< /drg/be-prepared >}}

In [Req 3](/merit-badges/journalism/guide/req3/), you will choose a storytelling challenge of your own. Everything on that page depends on what you learned here first: verify facts, label opinion honestly, and treat people fairly.

{{< drg/video
    title="Freedom of the Press: Crash Course Government and Politics #26 — CrashCourse"
    url="https://www.youtube.com/watch?v=Vtpd0EbaFoQ" >}}

{{< drg/external-link
    title="U.S. Courts — What Does Freedom of Speech Mean?"
    url="https://www.uscourts.gov/about-federal-courts/educational-resources/about-educational-outreach/activity-resources/what-does-free-speech-mean"
    description="A plain-language overview of First Amendment protections and why they matter in public life." >}}

{{< drg/external-link
    title="Society of Professional Journalists — SPJ Code of Ethics"
    url="https://www.spj.org/ethicscode.asp"
    description="A widely used ethics code covering truth, fairness, independence, and accountability in journalism." >}}
...
{{< drg/next-page
    text="You now understand the rights and responsibilities that support a free press."
    teaser="Next, choose between print-and-online reporting or broadcast journalism."
