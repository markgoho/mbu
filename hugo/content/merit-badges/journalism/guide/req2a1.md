...
{{< drg/checklist title="Questions to Ask Each Source" subtitle="Use these to guide your comparison notes" >}}
...
{{< drg/image src="images/story-comparison-notes-grid.avif" alt="Comparison worksheet showing four sources side by side with headline angle, length, sources, context, and tone" >}}
...
{{< drg/tip >}}
Keep a comparison chart while you read. If you wait until the end, small but important differences in emphasis and wording are easy to forget.
{{< /drg/tip >}}

{{< drg/be-prepared title="If a social media post seems dramatic or suspicious" >}}
Do not assume it is wrong, but do not trust it immediately either.

- **Look for the original source:** Did the post link to a full report, document, or verified newsroom account?
- **Check names and numbers:** Even a fast typo can change the meaning of a story.
- **See whether other outlets confirm it:** One isolated post is not strong evidence.
- **Notice emotional wording:** Outrage-heavy language may be trying to persuade more than inform.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have a framework for comparing how different written and digital sources handle the same event."
    teaser="Next, visit a news operation and see how editorial, business, and production teams work together."
