...
{{< drg/be-prepared title="If your first draft is too long" >}}
Cut repetition first.

- **Keep the best quote:** One strong quote is better than three average ones.
- **Trim background:** Include only the context readers truly need.
- **Shorten weak openings:** Start closer to the real news.
- **Check every sentence:** If it does not add fact, context, or voice, cut it.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You know how to report a Scouting event in a short, focused article and prepare it for submission."
    teaser="Next, choose how you will cover a public event using writing, broadcast scripting, or photography."
