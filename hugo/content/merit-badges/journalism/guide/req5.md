...
{{< drg/image src="images/journalism-careers-pathways.avif" alt="Diagram showing journalism skills branching into reporter, photojournalist, and editor or producer career paths" >}}
...
{{< drg/checklist title="Questions for Your Career Research" subtitle="Use these to organize your notes before meeting your counselor" >}}
...
{{< drg/tip >}}
Do not choose only by salary. A career may sound impressive on paper but still be a poor fit if you dislike the daily work, deadlines, travel, or public exposure that come with it.
{{< /drg/tip >}}

{{< drg/external-link
    title="U.S. Bureau of Labor Statistics — Media and Communication Occupations"
    url="https://www.bls.gov/ooh/media-and-communication/home.htm"
    description="Career profiles, outlook data, pay ranges, and job information for reporting, editing, announcing, and related communication work." >}}

{{< drg/external-link
    title="Poynter — Journalism Careers"
    url="https://www.poynter.org/"
    description="Training, industry insight, and resources from a leading journalism education organization." >}}

{{< drg/video
    title="Career Pathways Week Three—Journalism — Cawley Career Education Center"
    url="https://www.youtube.com/watch?v=SM3q_4bVERI" >}}
...
{{< drg/next-page
    text="You have explored journalism career paths and know how to research one in depth."
    teaser="Next, go beyond the badge with deeper ideas, experiences, and organizations in journalism."
    url="/merit-badges/journalism/guide/extended-learning/" >}}
