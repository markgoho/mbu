...
{{< drg/checklist title="What to Include in Your Article" subtitle="Turn your reading into a strong profile" >}}
...
{{< drg/tip >}}
Mark memorable passages as you read. A short quote from the autobiography can reveal the journalist's personality, values, or reporting style more clearly than a long summary.
{{< /drg/tip >}}

This option connects nicely to [Req 1](/merit-badges/journalism/guide/req1/). As you read, notice where ethical decisions, fairness, privacy, or courage shaped the journalist's work.

Next, the final option in this group asks you to cover a real Scouting event and submit your work for consideration.

{{< drg/next-page
    text="You know how to read a journalist's life story for lessons about craft, ethics, and impact."
    teaser="Next, learn how to cover a Scouting event and shape it into a short article for publication."
