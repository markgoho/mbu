...
{{< drg/image src="images/device-comparison.avif" alt="Three devices side by side: a desktop computer, a smartphone, and a gaming console with controller" >}}
...
{{< drg/did-you-know >}}
The processor in a modern smartphone is more powerful than the supercomputers that cost millions of dollars in the early 2000s. The iPhone 15's A17 chip contains 19 billion transistors — more than the processors in the original Xbox and PlayStation 2 combined, by a factor of thousands.
{{< /drg/did-you-know >}}

{{< drg/tip >}}
When discussing this with your counselor, do not just list specs. Think about *why* someone would choose one device over another for a specific task. Editing a school report? Laptop. Quick photo on a camping trip? Phone. Playing a new game with friends on the couch? Console. The best answer connects the device's design to real use cases.
{{< /drg/tip >}}

{{< drg/external-link
    title="GCFGlobal — Computer Basics: Understanding Computers"
    url="https://edu.gcfglobal.org/en/computerbasics/"
    description="Free lessons from GCFGlobal covering the fundamentals of different computing devices, how they work, and how to use them." >}}

You now understand the devices. Next, let's explore how they talk to each other through networks.

{{< drg/next-page
    text="Now that you can compare devices"
    teaser="Learn how computers connect and communicate through networks."
