...
- `"court of honor"` — finds pages with this specific phrase, not just pages mentioning "court" and "honor" separately
- `"campfire program" activities songs` — combines an exact phrase with additional keywords
...
- `"court of honor" -military` — excludes military results
- `"campfire program" -summer camp -commercial` — filters out summer camp business results
...
{{< drg/tip >}}
When your counselor asks how you used the search engine, describe your actual process: what search terms you started with, how you refined them, and why you chose the websites you did. Showing that you iterated and improved your search strategy is just as important as the results themselves.
{{< /drg/tip >}}

{{< drg/image src="images/search-engine-strategies.avif" alt="Infographic showing four search tips: specific keywords, quotation marks, minus sign to exclude, and checking multiple pages" >}}
...
{{< drg/checklist title="Research Planning Checklist" subtitle="Complete these steps for your counselor" >}}
...
{{< drg/external-link
    title="Google Search Help — Search Tips"
    url="https://support.google.com/websearch/answer/2466433"
    description="Google's official guide to refining searches with operators like quotes, minus signs, and site-specific searches." >}}
...
{{< drg/next-page
    text="Now that you can search effectively"
    teaser="Understand how HTTPS and security certificates protect you online."
