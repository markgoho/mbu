...
{{< drg/image src="images/digital-tech-overview.avif" alt="A teenager in a Scout uniform working at a desk with a laptop, smartphone, and tablet, with digital graphics visible on the screens" >}}
...
{{< drg/did-you-know >}}
The Apollo 11 guidance computer that helped land astronauts on the Moon in 1969 had about 74 kilobytes of memory. A single high-resolution photo on your phone takes up more space than that entire computer's memory.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/digital-tech-get-ready.avif" alt="Three teenagers in Scout uniforms gathered around a laptop at a table, one pointing at the screen while the others look engaged" >}}
...
{{< drg/safety-first >}}
Connected devices can be doorways for hackers if not properly secured. Always change default passwords on smart devices, keep firmware updated, and never connect to unknown Wi-Fi networks without a VPN. You will learn more about digital safety throughout this badge.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="Now that you know what digital technology covers"
    teaser="Learn about staying safe in the digital world."
    url="/merit-badges/digital-technology/guide/req1/" >}}
