...
{{< drg/did-you-know >}}
One ton of circuit boards contains roughly 40 times more gold than one ton of gold ore. Recycling e-waste is not just about preventing pollution — it is about recovering valuable resources that are expensive and environmentally destructive to mine from the Earth.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    title="e-Stewards — Find a Certified Recycler"
    url="https://e-stewards.org/find-a-recycler/"
    description="Search for e-Stewards certified electronics recyclers near you — these facilities meet the highest standards for responsible e-waste processing." >}}
...
{{< drg/safety-first >}}
Lithium-ion batteries can catch fire or explode if punctured, crushed, or exposed to extreme heat. Never put lithium-ion batteries in your regular recycling bin — the mechanical sorting process can crush them and start a fire. Always take them to a designated battery recycling drop-off point. If a lithium-ion battery is swollen or damaged, place it in a non-flammable container and take it to a recycling center immediately.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="Call2Recycle — Find a Battery Drop-Off Location"
    url="https://www.call2recycle.org/locator/"
    description="Search for battery recycling drop-off locations near you — accepts rechargeable batteries from phones, laptops, power tools, and more." >}}

{{< drg/image src="images/ewaste-recycling-process.avif" alt="Illustrated four-stage e-waste recycling process: collection, sorting, shredding, and material recovery" >}}
...
{{< drg/next-page
    text="Now that you understand responsible tech disposal"
    teaser="Explore careers and hobbies in digital technology."
