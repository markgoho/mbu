...
Give a brief history of the changes in digital technology over time. Discuss with your counselor how digital technology in your lifetime compares with that of your parent's, grandparent's, or other adult's lifetime.
{{< /drg/requirement >}}
...
{{< drg/did-you-know >}}
In 1956, IBM shipped the first commercial hard drive. It was the size of two refrigerators, weighed over a ton, and stored 5 megabytes of data. Today, a microSD card that fits on your fingertip stores 200,000 times more.
{{< /drg/did-you-know >}}

{{< drg/image src="images/computing-timeline.avif" alt="Infographic showing five eras of computing from the 1940s room-sized computers to modern smart home devices" >}}
...
{{< drg/checklist title="Generational Interview Questions" subtitle="Use these to guide your conversation" >}}
...
{{< drg/tip >}}
Take notes during your conversation. Your counselor will want to hear specific examples of how technology differed across generations — not just "things were different." Details like "My grandma had to use an encyclopedia at the library to write school reports" paint a much clearer picture than "They didn't have Google."
{{< /drg/tip >}}
...
{{< drg/external-link
    title="Computer History Museum — Timeline of Computer History"
    url="https://www.computerhistory.org/timeline/"
    description="An interactive timeline from the Computer History Museum covering key milestones in computing from the 1930s to today." >}}

{{< drg/image src="images/generational-tech-comparison.avif" alt="Three scenes comparing technology across generations: a 1980s teenager at a green-screen desktop, a 2000s teenager with a laptop, and a modern teenager using a tablet" >}}

You now have a solid picture of where digital technology came from. Next, let's look at where it might be going.

{{< drg/next-page
    text="Now that you know the history"
    teaser="Imagine the technology you might use as an adult."
