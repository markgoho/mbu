...
{{< drg/did-you-know >}}
The open-source movement has produced some of the most important software in the world. The Linux operating system (open source and free) runs over 90% of the world's web servers, most smartphones (Android is based on Linux), and nearly all of the world's top 500 supercomputers.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Can I Accept This Copy?" subtitle="Run through this decision checklist" >}}
...
- **Pirated software often contains malware** — cracked programs are a common way cybercriminals distribute viruses and trojans (as you learned in [Req 4c](/merit-badges/digital-technology/guide/req4c/))

{{< drg/tip >}}
If you want software but cannot afford it, look for legitimate free alternatives first. LibreOffice replaces Microsoft Office. GIMP replaces Photoshop. DaVinci Resolve replaces expensive video editors. There is almost always a free, legal option — and using it respects both the law and the Scout Law point of being trustworthy.
{{< /drg/tip >}}

{{< drg/image src="images/software-license-types.avif" alt="Infographic showing four software license types: Proprietary, Freeware, Open Source, and Shareware with sharing indicators" >}}

{{< drg/external-link
    title="Creative Commons — About the Licenses"
    url="https://creativecommons.org/licenses/"
    description="Learn about Creative Commons licenses — a popular system that lets creators specify exactly how their work can be used, shared, and modified." >}}
...
{{< drg/next-page
    text="Now that you understand software licensing"
    teaser="Research a real intellectual property dispute in the news."
