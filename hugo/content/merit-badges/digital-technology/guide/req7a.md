...
{{< drg/did-you-know >}}
The blog entries, photos, and webpage you created for Req 6 are automatically protected by copyright the moment you saved them. You are already an intellectual property owner.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/ip-types-overview.avif" alt="Infographic showing four types of intellectual property: Copyright, Patent, Trademark, and Trade Secret with icons" >}}
...
{{< drg/tip >}}
A single product can involve all four types of IP. Consider a smartphone: the physical design and chip architecture might be **patented**, the operating system code is **copyrighted**, the brand name and logo are **trademarked**, and the manufacturing process details may be **trade secrets**.
{{< /drg/tip >}}

{{< drg/external-link
    title="USPTO — Intellectual Property Basics"
    url="https://www.uspto.gov/ip-policy/ip-learning-resources"
    description="The U.S. Patent and Trademark Office's educational resources explaining all four types of intellectual property with examples and interactive content." >}}
...
{{< drg/next-page
    text="Now that you know the four types of IP"
    teaser="Explore the ethics of sharing software with friends."
