...
req_number: "4b"
prev: "/merit-badges/digital-technology/guide/req4a/"
prev_title: "Req 4a — Programs, Apps & How They Run"
next: "/merit-badges/digital-technology/guide/req4c/"
next_title: "Req 4c — Malware & Protection"
---
...
{{< drg/image src="images/apps-in-daily-life.avif" alt="Illustrated smartphone screen showing a grid of colorful app icons organized by category" >}}
...
{{< drg/tip >}}
Think about a specific moment when each app actually made a difference. Concrete stories are more convincing than abstract descriptions. Your counselor wants to see that you understand the *value* software provides, not just that you know how to open it.
{{< /drg/tip >}}
...
{{< drg/checklist title="App Analysis Questions" subtitle="Answer these for each of your four choices" >}}
...
{{< drg/external-link
    title="Common Sense Media — App Reviews"
    url="https://www.commonsensemedia.org/app-reviews"
    description="Independent reviews of apps with age ratings, privacy assessments, and educational value analysis — useful for evaluating the software you use." >}}
...
{{< drg/next-page
    text="Now that you have analyzed your apps"
    teaser="Learn about malware and how to protect your devices."
