...
**What they do:** Protect organizations from cyberattacks. They monitor networks for threats, investigate security breaches, set up defenses, and develop security policies — much of what you learned in [Req 4c](/merit-badges/digital-technology/guide/req4c/) at a professional level.
...
**What they do:** Set up, maintain, and troubleshoot the computer networks and servers that organizations depend on — connecting the LAN and WAN concepts you learned in [Req 3e](/merit-badges/digital-technology/guide/req3e/) to real infrastructure.
...
{{< drg/external-link
    title="Bureau of Labor Statistics — Computer and IT Occupations"
    url="https://www.bls.gov/ooh/computer-and-information-technology/home.htm"
    description="Detailed career profiles from the Bureau of Labor Statistics covering education requirements, salary data, job outlook, and typical duties for every major IT career." >}}

{{< drg/checklist title="Career Research Guide" subtitle="Cover these points in your counselor discussion" >}}
...
{{< drg/tip >}}
For the strongest counselor discussion, research a hobby that connects to something you already care about. Love the outdoors? Explore trail mapping apps or wildlife camera programming. Into music? Research digital audio workstation (DAW) software and music production. The most rewarding tech hobbies combine digital skills with your existing passions.
{{< /drg/tip >}}

{{< drg/image src="images/tech-careers-hobbies.avif" alt="Illustrated split scene showing technology career workspace on the left and hobby workspace with robot and 3D printer on the right" >}}

{{< drg/be-prepared title="Setting Goals for Your Hobby" >}}
Your counselor will ask about short-term and long-term goals. Think about:

- **Short-term (next 3–6 months):** What is the first project you would complete? What tools or training do you need to get started? What would you learn first?
- **Long-term (1–3 years):** Where do you want your skills to be? Could this hobby lead to a career? Would you share your work publicly? Could you teach others?

Having concrete goals — not just "I want to learn coding" but "I want to build a simple weather app using Python within three months" — shows your counselor that you are serious about pursuing this.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Code.org — Learn to Code"
    url="https://code.org/"
    description="Free coding courses for all ages and skill levels, from visual block programming to full web development — a great starting point for any digital technology hobby." >}}
...
{{< drg/next-page
    text="Now that you have explored careers and hobbies"
    teaser="Discover resources to take your digital skills even further."
    url="/merit-badges/digital-technology/guide/extended-learning/" >}}
