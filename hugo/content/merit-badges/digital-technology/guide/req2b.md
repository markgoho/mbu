...
{{< drg/did-you-know >}}
Google's DeepMind AI solved the "protein folding problem" in 2020 — a challenge that had stumped biologists for 50 years. The AI predicted the 3D structure of nearly every known protein, potentially accelerating drug discovery by decades.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
For this requirement, your counselor wants to hear *your* ideas, not a textbook answer. Think about problems you face today — slow internet on campouts, heavy textbooks, difficulty communicating in remote areas — and imagine what devices might solve them. The most interesting answers connect future technology to real needs.
{{< /drg/tip >}}

{{< drg/image src="images/future-technology-concept.avif" alt="Illustrated scene showing future technology concepts including AR glasses, an autonomous delivery drone, and a flexible transparent screen" >}}
...
{{< drg/be-prepared title="Thinking About Technology's Impact" >}}
New technology creates new questions. As you imagine future devices, also consider:

- **Privacy**: If your glasses record everything you see, who owns that footage?
- **Access**: Will advanced technology be available to everyone or only the wealthy?
- **Environment**: How will we power and recycle billions of new devices?
- **Jobs**: What careers might disappear? What new ones might emerge?

Showing your counselor that you have thought about both the exciting possibilities *and* the challenges will make your discussion much more meaningful.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="MIT Technology Review — 10 Breakthrough Technologies"
    url="https://www.technologyreview.com/lists/technologies/"
    description="MIT's annual list of emerging technologies that are poised to change the world, updated yearly with expert analysis." >}}
...
{{< drg/next-page
    text="Now that you have imagined the future"
    teaser="Discover how computers turn text, sound, and images into ones and zeros."
