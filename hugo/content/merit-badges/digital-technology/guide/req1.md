...
{{< drg/safety-first >}}
Watch this video with your parent or guardian as required. This is not just a rule — having a trusted adult present gives you someone to discuss the scenarios with and ask questions. If anything in the video raises concerns about something you have experienced online, talk to your parent, guardian, or another trusted adult immediately.
{{< /drg/safety-first >}}
...
{{< drg/external-link
    title="Scouting America Youth Protection — Digital Safety"
    url="https://www.scouting.org/training/youth-protection/scouts-bsa/"
    description="Official Scouting America page with the Personal Safety Awareness 'Digital Safety' video and related youth protection resources." >}}
...
{{< drg/tip >}}
Before posting anything online, apply the "billboard test": would you be comfortable with this information displayed on a billboard in your town for everyone to see? If not, do not post it.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
A 2023 survey found that 70% of employers screen candidates' social media profiles during the hiring process. Posts from years ago — even ones you have forgotten about — can influence whether you get a job offer.
{{< /drg/did-you-know >}}
...
- **Decline politely** or simply do not respond to the request.
- **Tell a parent or guardian** about the interaction, especially if the person is persistent.
- **Report the user** through the game's or platform's reporting system.
- Remember: **a real friend will respect your boundaries.** Anyone who pressures you to share personal information is not looking out for your interests.
{{< /drg/be-prepared >}}
...
{{< drg/image src="images/digital-safety-awareness.avif" alt="A teenager in a Scout uniform sitting at a desk with a parent beside them, both looking at a laptop screen together" >}}

Your digital safety foundation is set. Time to look at where all this technology came from — and where it is headed.

{{< drg/next-page
    text="Now that you understand digital safety"
    teaser="Explore the fascinating history of digital technology."
