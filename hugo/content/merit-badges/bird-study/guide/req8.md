...
{{< drg/tip >}}
Arrive prepared. Bring your binoculars, field guide, notebook, and water. Wear muted colors (greens, browns, grays) and avoid bright clothing — you want to blend in so you do not startle the birds.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    url="https://www.audubon.org/conservation/science/christmas-bird-count"
    description="Find your nearest Christmas Bird Count circle, view results from past years, and learn how to participate." >}}
...
{{< drg/did-you-know >}}
The Christmas Bird Count started in 1900 as an alternative to a holiday tradition called the "Christmas Side Hunt," where hunters competed to shoot as many birds as possible. Ornithologist Frank Chapman proposed counting birds instead of killing them — and the tradition stuck. The first count had 27 participants. Today, over 80,000 volunteers participate each year.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    ...
    description="Learn about the federal bird banding program, find banding stations, and report a banded bird." >}}

{{< drg/image src="images/bird-banding-station.avif" alt="A researcher carefully holding a small songbird while attaching a numbered aluminum band to its leg at a banding station, with mist nets visible in the background" >}}

{{< drg/safety-first >}}
Never attempt to capture or band a bird on your own. Only trained, federally permitted individuals may handle wild birds. Improper handling can injure or kill the bird and violates federal law (the Migratory Bird Treaty Act).
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You have completed a hands-on birding experience."
    teaser="Choose a project to attract birds — build a feeder, birdbath, sanctuary, nest box, or design a habitat plan."
