...
{{< drg/checklist title="Career Research" subtitle="Key questions for your chosen career" >}}
...
{{< drg/external-link
    title="Ornithologist Career Profile — Bureau of Labor Statistics"
    url="https://www.bls.gov/ooh/life-physical-and-social-science/zoologists-and-wildlife-biologists.htm"
    description="Government data on zoologists and wildlife biologists, including pay, job outlook, and education requirements." >}}
...
{{< drg/tip >}}
When discussing your hobby exploration with your counselor, be specific about what excites you. Do you want to photograph birds? Travel to find rare species? Contribute to science? There is no wrong answer — the best hobby is one you will actually do.
{{< /drg/tip >}}

{{< drg/external-link
    title="American Birding Association"
    url="https://www.aba.org/"
    description="The leading organization for recreational birding in North America. Membership includes Birding magazine, event access, and community resources." >}}

{{< drg/image src="images/birding-hobby-montage.avif" alt="A four-panel montage showing different aspects of birding as a hobby: backyard feeder watching, field birding with binoculars, bird photography with a telephoto lens, and sketching birds in a nature journal" >}}
...
{{< drg/next-page
    text="You have completed all the requirements for the Bird Study merit badge."
    teaser="Explore deeper topics, real-world experiences, and organizations that will keep your birding journey going."
