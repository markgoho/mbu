...
{{< drg/download
    title="Bird Study Field Notebook Worksheet"
...
{{< drg/image src="images/field-notebook-entry.avif" alt="A sample field notebook page showing a neatly filled-out entry for an American Robin with all four required data points labeled" >}}
...
{{< drg/checklist title="Habitat Hopping" subtitle="Visit these habitats to diversify your species list" >}}
...
{{< drg/tip >}}
Keep your field guide and notebook with you whenever you are outdoors — even on routine errands. Some of the best sightings happen when you are not specifically out birding.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
A Black-capped Chickadee hides thousands of seeds every fall, tucking them into bark crevices and under lichens. It can remember the locations of these hiding spots for up to a month — a remarkable feat of spatial memory for a bird with a brain smaller than a peanut.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Building Your List Over Time" >}}
You do not need to find all 20 species in a single outing. Spread your observations over several weeks:

- **Week 1–2:** Focus on common backyard and neighborhood birds (aim for 8–10 species).
- **Week 3:** Visit a new habitat (pond, forest, or open field) and add 5–6 species.
- **Week 4:** Target specific species you still need — check eBird for recent local sightings.

If you are working on this badge during migration season (spring or fall), you may find even more variety as migrants pass through.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="eBird — Explore Your Area"
    url="https://ebird.org/explore"
    description="See which bird species have been reported recently near any location. Great for knowing what to look for before you head out." >}}

{{< drg/image src="images/scout-field-birding.avif" alt="A Scout writing in a field notebook while looking at a bird perched on a fence post in a meadow habitat" >}}
...
{{< drg/next-page
    text="You are now equipped to observe, identify, and record 20 bird species."
    teaser="Discover how beaks, bodies, legs, and feathers are shaped by the habitats birds live in."
