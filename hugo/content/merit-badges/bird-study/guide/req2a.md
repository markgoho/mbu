...
{{< drg/did-you-know >}}
What looks like a bird's knee bending backward is actually its ankle. A bird's true knee is hidden up near its body, tucked under the feathers. The long, visible section of "leg" is really the tarsus — the equivalent of the top of your foot.
{{< /drg/did-you-know >}}

{{< drg/image src="images/perched-bird-labeled.avif" alt="Detailed side-view diagram of a perched songbird with all major external parts labeled: crown, forehead, nape, eye ring, lore, chin, throat, upper mandible, lower mandible, breast, belly, flanks, back, rump, wing bars, tail, tarsus, toes" >}}
...
{{< drg/checklist title="Sketching Success" subtitle="Follow these steps for a clean, labeled drawing" >}}
...
{{< drg/tip >}}
If you are tracing, look for a side-view silhouette or outline drawing of a perched songbird. The Cornell Lab's "All About Birds" website has excellent reference images for nearly every North American species.
{{< /drg/tip >}}

{{< drg/external-link
    title="Bird Anatomy — All About Birds"
    url="https://academy.allaboutbirds.org/features/birdanatomy/"
    description="Cornell Lab's interactive guide to bird anatomy with labeled diagrams and quizzes." >}}

{{< drg/image src="images/scout-sketching-bird.avif" alt="A Scout sitting outdoors with a field notebook, sketching a bird perched on a nearby branch" >}}
...
{{< drg/next-page
    text="You have learned the external parts of a perched bird."
    teaser="Next, you will study wing anatomy and label six types of wing feathers."
