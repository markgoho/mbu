...
{{< drg/tip >}}
Most field guides have a quick index on the inside cover or back cover with page numbers for each bird family. Use it. Flipping randomly through 400 pages while a bird sits in front of you is a recipe for frustration.
{{< /drg/tip >}}
...
{{< drg/image src="images/field-guide-spread.avif" alt="An open bird field guide showing a bird illustration with labeled field marks on the left page and a range map with species description on the right page" >}}
...
{{< drg/did-you-know >}}
Range maps change over time. Climate change, habitat loss, and other factors cause bird ranges to shift. The Carolina Wren, once considered a southeastern species, has expanded its range northward by hundreds of miles over the past few decades. Updated field guide editions reflect these shifts.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    title="Merlin Bird ID App"
    url="https://merlin.allaboutbirds.org/"
    description="Free bird identification app from the Cornell Lab of Ornithology. Identifies birds by photo, sound, or description." >}}

{{< drg/image src="images/range-map-example.avif" alt="A sample range map of the Red-tailed Hawk showing breeding range, wintering range, and year-round range across North America" >}}
...
{{< drg/next-page
    text="You know how to use a field guide and interpret range maps."
    teaser="Start building your field notebook — observe 20 species and record what you find."
