...
{{< drg/safety-first >}}
If you notice sick-looking birds at your feeder (lethargic, puffed up, crusty eyes), take the feeder down for at least two weeks and clean it thoroughly. Feeders can spread diseases like avian conjunctivitis when birds congregate in one spot.
{{< /drg/safety-first >}}
...
{{< drg/external-link
    ...
    description="Enter your zip code to find native plants that support birds in your area." >}}
...
{{< drg/external-link
    title="NestWatch — Cornell Lab"
    url="https://nestwatch.org/"
    description="Free nest box plans for dozens of species, plus a citizen science program where you can report your nesting observations." >}}
...
{{< drg/checklist title="Habitat Plan Elements" subtitle="Include all of these in your design" >}}
...
{{< drg/image src="images/backyard-habitat-plan.avif" alt="Illustrated overhead view of a backyard bird habitat with native shrubs, a birdbath, nest boxes, a brush pile, and shade trees" >}}

{{< drg/tip >}}
Whichever option you choose, take photos of your project at different stages — planning, building, and in use. Bring these to your counselor meeting to show the work you put in.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have built or designed a project to attract birds."
    teaser="Learn the differences between extinct, endangered, and threatened — and what these categories mean for bird conservation."
