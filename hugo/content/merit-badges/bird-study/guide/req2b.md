...
req_number: "2b"
prev: "/merit-badges/bird-study/guide/req2a/"
prev_title: "Req 2a — Bird Body Parts"
next: "/merit-badges/bird-study/guide/req3a/"
next_title: "Req 3a — Specification Numbers"
---
...
{{< drg/did-you-know >}}
The alula works on the same aerodynamic principle as the leading-edge slats on a commercial airplane wing. Both prevent stalling at low speeds by controlling airflow. Engineers did not invent this — birds had it first, and they have had it for over 100 million years.
{{< /drg/did-you-know >}}

{{< drg/image src="images/extended-wing-labeled.avif" alt="Detailed diagram of a bird wing fully extended showing all six feather types labeled: primaries, secondaries, tertials, greater coverts, lesser coverts, and alula" >}}
...
{{< drg/checklist title="Wing Sketching Guide" subtitle="Steps for a clear, labeled wing drawing" >}}
...
{{< drg/tip >}}
A helpful way to remember the order: start at the wingtip and work toward the body. **P**rimaries are at the **p**oint (tip), **s**econdaries are in the **s**econd position, and **t**ertials are **t**hird — closest to the torso.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="Feather Biology — Cornell Lab of Ornithology"
    url="https://academy.allaboutbirds.org/features/all-about-feathers/"
    description="An in-depth look at feather types, structure, and function from the Cornell Lab." >}}

{{< drg/image src="images/wing-feather-comparison.avif" alt="Side-by-side comparison of a primary feather and a covert feather with parts labeled" >}}
...
{{< drg/next-page
    text="You have learned the six types of wing feathers and how they work together for flight."
    teaser="Find out what those numbers on binoculars really mean and how to choose the right optics for birding."
