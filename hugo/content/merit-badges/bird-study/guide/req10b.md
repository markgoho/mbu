...
req_number: "10b"
prev: "/merit-badges/bird-study/guide/req10a/"
prev_title: "Extinct, Endangered, Threatened"
next: "/merit-badges/bird-study/guide/req10c/"
next_title: "Protecting Birds in Decline"
---
...
{{< drg/image src="images/endangered-birds-trio.avif" alt="Three-panel illustration showing a Whooping Crane in wetland habitat, a Red-cockaded Woodpecker on a longleaf pine, and a Piping Plover on a sandy beach" >}}

## How to Research Your Chosen Species

{{< drg/checklist title="Research Checklist" subtitle="Questions to answer about your endangered or threatened bird" >}}
...
{{< drg/be-prepared title="Discussing Recovery With Your Counselor" >}}
Your counselor will want to hear a thoughtful discussion, not just a list of facts. Structure your response like this:

1. **Name the species** and its status.
2. **Explain the cause** of decline — be specific (not just "habitat loss" but "logging of old-growth longleaf pine forests").
3. **Describe what is being done** — name specific programs or organizations.
4. **Propose what more could be done** — show that you have thought about this critically.
5. **Express whether you are optimistic** about recovery — and why.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="American Bird Conservancy — Threatened Birds"
    url="https://abcbirds.org/threatened-birds/"
    description="Profiles of threatened and endangered bird species in the Americas, with conservation status and recovery efforts." >}}
...
{{< drg/next-page
    text="You have researched a specific endangered or threatened bird species."
    teaser="Learn how to protect birds in decline before they reach the endangered list — including habitat protection and migratory bird threats."
