...
{{< drg/did-you-know >}}
The Brown Thrasher holds the record for the largest song repertoire of any North American bird — over 1,100 different song types. Each phrase is typically sung twice before moving on to the next, creating an endlessly varied performance.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Practice in short sessions. Listen to a bird's song three or four times on a recording, then go outside and try to find that bird by ear. Connecting the recorded sound to a real bird in the field makes it stick in your memory far better than listening at your computer alone.
{{< /drg/tip >}}

{{< drg/image src="images/scout-listening-birds.avif" alt="A Scout standing still in a woodland clearing at dawn, eyes closed, listening intently with a hand cupped behind one ear, birds perched in surrounding trees" >}}
...
{{< drg/be-prepared title="Describing Songs in Writing" >}}
Writing down what a bird sounds like is tricky. Here are some useful descriptive words:

- **Pitch:** high, low, rising, falling, steady
- **Tone:** clear, buzzy, raspy, nasal, musical, harsh, mellow
- **Pattern:** repeated phrases, alternating notes, trill (rapid series), warble (complex and varied)
- **Rhythm:** fast, slow, accelerating, decelerating, evenly spaced
- **Volume:** loud, soft, carrying (heard from far away)

Example: "The Carolina Wren's song is a loud, clear, rapidly repeated phrase of three syllables — 'teakettle teakettle teakettle.' The bird was perched on a low branch at the edge of a thicket, singing persistently. I believe it was defending its territory because it sang from the same spot for several minutes and chased another wren that approached."
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Macaulay Library — Bird Sounds"
    url="https://www.macaulaylibrary.org/"
    description="The world's largest archive of bird sounds and videos, maintained by the Cornell Lab. Search any species to hear its songs and calls." >}}

{{< drg/image src="images/song-vs-call-diagram.avif" alt="Infographic comparing bird songs and calls, showing differences in length, who sings, timing, and purpose" >}}
...
{{< drg/next-page
    text="You can now explain bird songs and calls and identify five species by sound."
    teaser="Choose one of three hands-on birding experiences: a field trip, the Christmas Bird Count, or bird banding."
