...
{{< drg/did-you-know >}}
All 200+ million European Starlings in North America descended from roughly 100 birds released in Central Park in 1890–1891. That is one of the most dramatic examples of an invasive species explosion in history.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/invasive-birds-trio.avif" alt="Three-panel illustration showing a House Sparrow, a European Starling, and a Rock Pigeon, each labeled with their common name and origin" >}}
...
{{< drg/be-prepared title="Talking About Invasive Species" >}}
When discussing non-native birds with your counselor, be ready to explain:

1. **Which species** you chose and where it came from.
2. **How and when** it was introduced.
3. **Why** it was introduced (if intentional) — crop pest control, sentiment, food source, etc.
4. **What damage** it causes to native birds and ecosystems.
5. **What makes it successful** — diet flexibility, aggressiveness, adaptability.
6. **What could be done** — nest box design that excludes non-natives, monitoring, public awareness.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
If you have House Sparrows or European Starlings visiting your backyard, use them as your example. You can point to real observations — how they behave, how they interact with other birds at the feeder, and how many of them you see compared to native species.
{{< /drg/tip >}}

{{< drg/external-link
    title="USGS — Invasive Species Program"
    url="https://www.usgs.gov/programs/invasive-species"
    description="Information on invasive species in the United States, including identification, impacts, and management." >}}
...
{{< drg/next-page
    text="You have identified a non-native bird and explained how introduced species damage ecosystems."
    teaser="Learn how the Leave No Trace Seven Principles and the Outdoor Code apply specifically to bird study."
