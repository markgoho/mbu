...
{{< drg/did-you-know >}}
The Passenger Pigeon may have been the most abundant bird that ever lived. A single flock observed in 1866 over southern Ontario was estimated at 3.5 billion birds and took 14 hours to pass overhead. Within 50 years, the species was extinct.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/conservation-continuum.avif" alt="Infographic showing the conservation status continuum from Healthy to Extinct, with ESA protection zone marked" >}}
...
{{< drg/tip >}}
When explaining these terms to your counselor, use a specific bird example for each category. It is much more powerful to say "The Passenger Pigeon went extinct because of overhunting" than to simply recite a definition.
{{< /drg/tip >}}

{{< drg/external-link
    title="U.S. Fish & Wildlife Service — Endangered Species"
    url="https://www.fws.gov/program/endangered-species"
    description="Search for endangered and threatened species by state, view recovery plans, and learn about the Endangered Species Act." >}}
...
{{< drg/next-page
    text="You can now explain the differences between extinct, endangered, and threatened."
    teaser="Research a specific endangered or threatened bird species and explore what caused its decline."
