  ...
  - group_title: "Beyond the Badge"
    items:
      - title: "Extended Learning"
        url: "/merit-badges/bird-study/guide/extended-learning/"
---
...
{{< drg/image src="images/scout-binoculars-wetland.avif" alt="A Scout looking through binoculars at a wetland area with birds flying overhead at golden hour" >}}
...
{{< drg/did-you-know >}}
The Cornell Lab of Ornithology's eBird database receives over 100 million bird sightings every year from birders in every country on Earth. Your observations can become part of that global dataset.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/audubon-to-ebird.avif" alt="Split image showing a vintage Audubon-style bird illustration on the left and a modern birder using a smartphone app in the field on the right" >}}
...
{{< drg/safety-first >}}
When birding in the field, always tell someone where you are going and when you expect to return. Wear appropriate clothing for the weather, bring water, and watch your footing — birders tend to look up when they should be watching the trail.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/hawk-watch-ridge.avif" alt="Birders standing on a mountain ridge with binoculars and spotting scopes, watching hawks soaring overhead against a blue sky" >}}
...
{{< drg/tip >}}
Start by learning the songs of five common birds in your area. Once those sounds become automatic, add five more. Building your "ear list" gradually makes it manageable and fun.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The current Big Year record for North America is 840 species, set in 2023. That means someone identified more than two new bird species every single day for an entire year.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You have explored the world of birding and the many ways to enjoy it."
    teaser="Find out why birds are essential indicators of environmental health — and how they fit into the ecosystem."
    url="/merit-badges/bird-study/guide/req1/" >}}
