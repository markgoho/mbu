...
{{< drg/did-you-know >}}
Birds are among the best-studied groups of animals on Earth. Scientists have over 100 years of consistent population data for many North American species — far more than for most mammals, insects, or fish.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When discussing this with your counselor, think of a specific example. The decline of the Bald Eagle in the mid-1900s warned scientists about the dangers of the pesticide DDT — long before its effects on humans were fully understood.
{{< /drg/tip >}}
...
{{< drg/image src="images/bald-eagle-recovery.avif" alt="A Bald Eagle perched on a branch near a lake, symbolizing the species' recovery as an environmental success story" >}}
...
{{< drg/be-prepared title="Explaining Ecosystems to Your Counselor" >}}
When your counselor asks how birds fit into the ecosystem, organize your answer around **roles**:

- **Seed dispersers** — spreading plants to new areas
- **Pollinators** — helping certain flowers reproduce
- **Pest controllers** — eating insects that damage crops and forests
- **Scavengers** — cleaning up dead animals and preventing disease
- **Prey** — feeding larger predators and maintaining the food web

Pick two or three roles and give a specific bird example for each. This shows you understand the concept, not just the vocabulary.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="All About Birds — Cornell Lab of Ornithology"
    url="https://www.allaboutbirds.org/"
    description="The Cornell Lab's free bird guide with species profiles, range maps, sounds, and ID tips for every North American bird." >}}

{{< drg/image src="images/ecosystem-web-birds.avif" alt="Infographic showing birds at the center of an ecosystem web with arrows connecting them to seeds, insects, plants, predators, and scavengers" >}}
...
{{< drg/next-page
    text="You have learned why birds are essential to ecosystems and why scientists study them."
    teaser="Next, you will learn the parts of a bird's body so you can describe what you see in the field."
