...
{{< drg/safety-first >}}
The railroad right-of-way is private property. Trains cannot swerve, brake quickly, or honk with enough warning to protect someone who steps into their path. Every safety rule in this requirement exists because trains are fast, quiet on certain track surfaces, and physically unable to stop in time.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Operation Lifesaver's "See Tracks? Think Train!" campaign is one of the most widely recognized rail-safety slogans in North America. You may already know it without realizing it came from an organized national program.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Operation Lifesaver — oli.org"
    url="https://oli.org/"
    description="The official OL site with safety tips, presenter resources, and national crossing-incident statistics." >}}
...
{{< drg/checklist title="9 Track Safety Tips" subtitle="Know all nine — you must list them for your counselor" >}}
...
{{< drg/tip >}}
Your counselor will likely ask you to say all nine without looking. Read the list several times, then cover it and recite from memory. Group them in your mind: "stay off / cross smart / speed and multiple tracks / platforms and items / bridges."
{{< /drg/tip >}}

{{< drg/image src="images/railroad-right-of-way-boundary.avif" alt="Diagram of a railroad corridor showing the right-of-way boundary, train overhang hazard zone, and a person standing safely outside it" >}}
...
{{< drg/checklist title="9 Pedestrian Safety Considerations" subtitle="For walking near (not on) railroad tracks" >}}
...
{{< drg/safety-first >}}
Distraction is the number-one factor in pedestrian incidents at crossings. Even a brief glance at a phone can cost a second of reaction time that matters enormously when a train is seconds away.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Freight trains traveling at highway speed can take a mile or longer to stop after the engineer applies emergency brakes. Even at 30 mph, the stopping distance is several hundred feet—much longer than a car.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Before your counselor meeting, ride a commuter or light rail line if you have access to one. Firsthand experience will make your explanation much more specific and convincing.
{{< /drg/tip >}}

{{< drg/external-link
    title="FRA — Rail Safety"
    url="https://railroads.dot.gov/rail-safety/rail-safety"
    description="Federal Railroad Administration safety resources, crossing statistics, and public education materials." >}}

{{< drg/next-page
    text="You can now explain Operation Lifesaver's mission and list the key safety rules for tracks, walking, driving, and light rail"
    teaser="Learn to identify and explain the railroad signs and crossing devices you will encounter on roads and along rail corridors."
