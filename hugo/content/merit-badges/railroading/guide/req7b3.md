---
title: "Rail Preservation Groups"
layout: "guide"
group_title: "7. Railfanning Option"
req_number: "7b3"
req_path: "7.b.3"
prev: "/merit-badges/railroading/guide/req7b2/"
prev_title: "Ride a Historic Railroad"
next: "/merit-badges/railroading/guide/req7b4/"
next_title: "Plan and Take a Rail Trip"
---
...
**Railway and Locomotive Historical Society (RLHS)** — rlhs.org
One of the oldest railroad historical societies in North America (founded 1921). Publishes the *Railroad History* journal. Maintains a directory of member societies and preservation efforts across the US.

**National Railway Historical Society (NRHS)** — nrhs.com
A large membership organization with chapters in cities and regions across the country. Hosts annual conventions, publishes the *NRHS Bulletin*, and maintains local chapter activities ranging from excursions to volunteer restoration work.
...
**Tourist Railroad and Museum Association (TRMA)** — trainhistory.org
A trade association for heritage railroad operators and museum directors. Its member directory is a useful starting point for finding operating heritage railroads near you.

{{< drg/tip >}}
You are not limited to national organizations. A local chapter of the NRHS, a regional railroad historical society, or the volunteer group maintaining a specific preserved locomotive all qualify. Local groups are often easier to reach, more eager for young volunteers, and can lead to hands-on opportunities.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Many heritage railroad volunteers have no railroad industry background at all — they are machinists, welders, carpenters, painters, electricians, and historians who learned their restoration skills on the job. Some groups also need help with photography, web content, and event planning — no technical experience required.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="Your research is done and you have connected with a preservation group."
    teaser="Activity 7b4 takes you onto the modern rail network — planning and making a real passenger rail trip."
