...
{{< drg/tip >}}
If you are building for this requirement and do not have a power pack, borrow one from your counselor or a local club. What matters is that you make and understand the electrical connection — not that you own the equipment.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Some of the most famous model railroad layouts in the world were built by groups over many years. The California Zephyr module at the National Model Railroad Association (NMRA) national conventions is assembled fresh each year from hundreds of modules contributed by modelers around the country — all snapping together on a standard module spec.
{{< /drg/did-you-know >}}

{{< drg/checklist title="Ready to Show Your Counselor?" subtitle="Your layout should include all of these" >}}
...
{{< drg/next-page
    text="Your layout runs — that is a real achievement."
    teaser="Activity 7a7 turns layout operation into competition: the Timesaver switching contest."
