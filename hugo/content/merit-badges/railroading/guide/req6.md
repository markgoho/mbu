...
{{< drg/did-you-know >}}
The first automatic block signal systems were installed in the United States in the 1870s. The principle—use a train's own wheels to detect its position—has not changed. The electronics have.
{{< /drg/did-you-know >}}

### Signal Type 1: Color-Light Signal

{{< drg/image src="images/color-light-signal-aspects.avif" alt="Three-aspect color-light railroad signal with inset views showing its green, yellow, and red indications" >}}
...
{{< drg/tip >}}
For your counselor, describe each signal type by its physical appearance first ("it has three round lenses stacked vertically"), then its color or position meanings. You do not need to memorize every aspect of a full signal rulebook—the requirement asks for two basic signal types.
{{< /drg/tip >}}

{{< drg/checklist title="Signal Review" subtitle="Be able to describe both types and explain the logic" >}}
...
{{< drg/video
    title="How to Read Railroad Signals — The Central Texas Railfan"
    url="https://www.youtube.com/watch?v=Q1UlOEUdows" >}}
...
{{< drg/safety-first >}}
The horn is not a substitute for crossing signals or your own observation. Trains may be delayed in sounding the horn, or you may be too far away to hear it clearly. Always look before crossing tracks, regardless of whether you hear a horn.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
The — — • — crossing signal is so well-established that railroad fans can identify an approaching freight train at a crossing from a mile away purely by horn sound. The pattern was standardized federally to reduce inconsistency between railroads.
{{< /drg/did-you-know >}}

{{< drg/checklist title="Three Horn Signals" subtitle="Know the pattern and what it means" >}}
...
{{< drg/safety-first >}}
Never stand on the tracks to signal a train. Stand beside the tracks—visible to the engineer, but not in the train's path. The goal is to stop the train, not to be struck by it.
{{< /drg/safety-first >}}

{{< drg/tip >}}
Your counselor will most likely ask you to describe the ENS system in detail and at least one physical method. Know both so you can explain each clearly and explain why you would use one over the other depending on the situation.
{{< /drg/tip >}}
...
{{< drg/image src="images/eotd-fred-rear-device.avif" alt="Close-up of an end-of-train device attached to the rear of a freight car with its red flashing light visible" >}}
...
{{< drg/did-you-know >}}
"FRED" was originally a joking acronym used by railroad workers: "Flashing Rear End Device" or, in the less formal version, "F---ing Rear End Device." The official name is EOTD, but FRED stuck. Some crews also use "HEU" (head-end unit) to refer to the locomotive-cab display that receives FRED's transmissions.
{{< /drg/did-you-know >}}

{{< drg/checklist title="EOTD / FRED Key Points" subtitle="Be able to explain each function clearly" >}}
...
{{< drg/external-link
    title="FRA — Rear-End Protection Regulations"
    url="https://www.ecfr.gov/current/title-49/subtitle-B/chapter-II/part-232"
    description="The federal brake system and EOTD regulations that govern rear-end device requirements on freight trains." >}}

{{< drg/next-page
    text="You can now explain railroad signals, horn patterns, emergency stop methods, and how the EOTD works"
    teaser="Choose a special interest — model railroading or railfanning — and complete an activity that puts your knowledge to work."
