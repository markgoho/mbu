...
[Go to Plan a Layout →](/merit-badges/railroading/guide/req7a1/)
...
[Go to Build a Rolling Stock Kit →](/merit-badges/railroading/guide/req7a2/)
...
[Go to Scales and Gauges →](/merit-badges/railroading/guide/req7a3/)
...
[Go to Makers and Magazines →](/merit-badges/railroading/guide/req7a4/)
...
[Go to Structures and Scenery →](/merit-badges/railroading/guide/req7a5/)
...
[Go to Build and Run a Layout →](/merit-badges/railroading/guide/req7a6/)
...
[Go to Switching Contest Skills →](/merit-badges/railroading/guide/req7a7/)
...
[Go to DC and DCC Control →](/merit-badges/railroading/guide/req7a8/)
...
{{< drg/tip >}}
Pick one activity that plays to a strength you already have, and one that stretches you a little. For example: pair the layout drawing (7a1) with the scales-and-gauges research (7a3) for a lower-cost, at-home combination — or pair structure building (7a5) with running a full layout (7a6) for a more immersive crafting experience.
{{< /drg/tip >}}

| Activity | Hands-on building | Research / discussion | Needs club access |
|---|---|---|---|
| 7a1 Plan a Layout | — | ✓ | — |
| 7a2 Build a Kit | ✓ | — | — |
| 7a3 Scales & Gauges | — | ✓ | — |
...
| 7a6 Build & Run a Layout | ✓ | — | Helpful |
| 7a7 Switching Contest | ✓ | — | ✓ |
| 7a8 DC and DCC | — | ✓ | — |

{{< drg/next-page
    text="You have reviewed all eight Model Railroading activities."
    teaser="Start with activity 7a1 — Plan a Layout — and learn what makes a great layout design."
