...
req_number: "1b"
req_path: "1.b"
prev: "/merit-badges/railroading/guide/req1a/"
prev_title: "Req 1a — Modern Freight Trains"
next: "/merit-badges/railroading/guide/req1c/"
next_title: "Req 1c — Freight and Passenger Cars"
---
...
{{< drg/tip >}}
BNSF and Union Pacific are popular choices because their route maps are easy to find and their networks are large and varied. CSX and Norfolk Southern are excellent choices if you live in the eastern half of the country.
{{< /drg/tip >}}
...
{{< drg/image src="images/class-i-railroad-route-map.avif" alt="Route map of a major Class I railroad with its main lines, major served cities, terminals, service facilities, and crew change points marked" >}}
...
{{< drg/checklist title="Req 1b Research Checklist" >}}
...
{{< drg/external-link
    url="https://www.bnsf.com/about-bnsf/our-railroad/maps.html"
    title="BNSF System Map"
    description="Official interactive route map — good for research if you choose BNSF." >}}

{{< drg/external-link
    url="https://www.up.com/customers/track-record/tr2023/by-the-numbers/index.htm"
    title="Union Pacific By the Numbers"
    description="Annual stats including commodity breakdown, terminal locations, and network overview." >}}

{{< drg/next-page
    text="Option 1b done? Continue to the next option."
    teaser="Req 1c is about car identification — learn to recognize 10 types of freight and passenger cars by sight."
