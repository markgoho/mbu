...
{{< drg/did-you-know >}}
A Class I railroad may spend $2–3 billion per year on capital improvements to its track and infrastructure. A single mile of new track can cost $1–2 million to build.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/railroad-company-departments.avif" alt="Organizational chart showing Transportation, Engineering, Mechanical, and Marketing departments with their main roles" >}}
...
{{< drg/checklist title="Req 3a Preparation Checklist" >}}
...
{{< drg/tip >}}
When describing each department to your counselor, try to explain what would go wrong if that department did not exist. "Without the Engineering department, the tracks would deteriorate and trains would derail" is a memorable way to convey why each piece matters.
{{< /drg/tip >}}

{{< drg/next-page
    text="Option 3a done? Continue to the next option — or head back to pick a different one."
    teaser="Req 3b is a personal reflection: which railroading opportunities interest you most, and why?"
