...
{{< drg/tip >}}
Some of the most scenic Amtrak routes with multiple stops include the California Zephyr (Denver to San Francisco via the Rockies and Sierra Nevada), the Coast Starlight (Los Angeles to Seattle), the Empire Builder (Chicago to Seattle/Portland), and the Vermonter (Washington DC to St. Albans, VT). Even a short regional route on the Northeast Corridor has plenty of intermediate stops and is easy to plan.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Amtrak's long-distance trains do not own their own tracks — they run on freight railroad track owned by Class I railroads like BNSF, UP, and CSX. By federal law (the Passenger Rail Investment and Improvement Act), freight railroads are required to give Amtrak trains preference — but delays still happen when freight volume is heavy. This is why on-time performance varies so much between Amtrak's Northeast Corridor (which Amtrak owns) and its long-distance routes (which it does not).
{{< /drg/did-you-know >}}

{{< drg/checklist title="Trip Planning Checklist" subtitle="Complete this before your counselor meeting" >}}
...
{{< drg/next-page
    text="Your rail trip is planned, taken, and you are ready to debrief."
    teaser="The final section of this guide celebrates your achievement and points you toward what is next in the world of railroading."
