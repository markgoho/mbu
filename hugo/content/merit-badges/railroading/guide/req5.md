...
{{< drg/tip >}}
A strong counselor conversation goes beyond reciting definitions. Be ready to describe what a specific sign looks like, where you would see it relative to the crossing, and exactly what you must do when you encounter it.
{{< /drg/tip >}}
...
{{< drg/inherited-requirement number="5a" req_path="5.a" topic="Passive signs and active signs" />}}
...
{{< drg/safety-first >}}
Active devices fail occasionally. If a gate or light appears to be malfunctioning, treat the crossing as if a train is always approaching. Do not assume a malfunction means the crossing is clear.
{{< /drg/safety-first >}}
...
{{< drg/inherited-requirement number="5b" req_path="5.b" topic="Devices at the crossing (flashing red lights—with or without bells, flashing red lights and gates, and cantilever flashing lights)" />}}
...
{{< drg/image src="images/crossing-signal-with-flashing-lights.avif" alt="Real highway-rail grade crossing signal assembly showing a crossbuck mounted above two flashing red lights" >}}
...
{{< drg/inherited-requirement number="5c" req_path="5.c" topic="Markings on the road (pavement markings and stop bars)" />}}

Road-surface markings give drivers guidance even before they reach the active device zone.

### Pavement Markings (RXR)

{{< drg/image src="images/rxr-pavement-marking-and-stop-bar.avif" alt="Road-approach diagram showing the white RXR pavement marking, no-passing lines, and stop bar placed before the nearest rail" >}}
...
{{< drg/inherited-requirement number="5d" req_path="5.d" topic="Signs before the crossing (advance warning sign, advance warning sign for side streets, no train horn sign, and low ground clearance grade crossing sign)" />}}
...
{{< drg/safety-first >}}
Quiet zone crossings can feel safer because they are quieter—but they require more attention from drivers and pedestrians, not less. The absence of a horn means you must rely entirely on visual signals and your own observation.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
A vehicle high-centered on railroad tracks is one of the most common causes of non-distraction related crossing incidents. Low ground clearance warning signs exist specifically because this has happened enough times to require a permanent warning.
{{< /drg/did-you-know >}}
...
{{< drg/inherited-requirement number="5e" req_path="5.e" topic="Signs along the railroad property (no trespassing sign)" />}}
...
{{< drg/be-prepared >}}
Railroading scouts sometimes ask whether recreational trail corridors that follow old rail lines are still "no trespassing" zones. Rail-trails converted to public use are fine—but an active railroad right-of-way adjacent to a trail is still private property. The sign is the boundary marker.
{{< /drg/be-prepared >}}
...
{{< drg/inherited-requirement number="5f" req_path="5.f" topic="Signs at the crossing (crossbuck sign, emergency notification system sign, multiple track sign, stop sign, and yield sign)" />}}

These signs are mounted at or immediately adjacent to the crossing itself.

### Crossbuck Sign

{{< drg/image src="images/crossbuck-and-ens-signs.avif" alt="Grade crossing sign assembly showing a white crossbuck above a blue emergency notification sign and a multiple-track plaque" >}}
...
{{< drg/checklist title="Signs at the Crossing — Quick Review" subtitle="Make sure you can describe all five for your counselor" >}}
...
{{< drg/external-link
    title="Operation Lifesaver — Grade Crossing Safety"
    url="https://oli.org/about-us/news/grade-crossing-safety"
    description="OL's crossing-safety resources, including sign identification materials used in driver education programs." >}}

{{< drg/next-page
    text="You can now identify and explain every crossing sign and device in Requirement 5"
    teaser="Learn how trains communicate through signals, horn patterns, and rear-end devices—and what each one means for anyone near the tracks."
