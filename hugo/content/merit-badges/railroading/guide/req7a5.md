...
{{< drg/tip >}}
For wood kits: use a slow-drying wood glue (not super glue). It gives you time to adjust parts before the glue sets. For plastic kits: use liquid plastic cement applied to the joint with a small brush.
{{< /drg/tip >}}
...
{{< drg/checklist title="Finished Diorama Checklist" subtitle="Before showing your counselor" >}}
...
{{< drg/next-page
    text="Your structure and scenery project is complete."
    teaser="Activity 7a6 is the biggest project of the option — building and operating a full model railroad layout."
