...
req_number: "1a"
req_path: "1.a"
prev: "/merit-badges/railroading/guide/req1/"
prev_title: "Req 1 — Choose Three Rail Foundations"
next: "/merit-badges/railroading/guide/req1b/"
next_title: "Req 1b — Mapping a Railroad System"
---
...
{{< drg/image src="images/unit-train-vs-intermodal.avif" alt="Side-by-side comparison of a unit coal train made of matching open hoppers and a double-stack intermodal train with containers stacked two high" >}}
...
{{< drg/checklist title="Unit Train Efficiency Factors" subtitle="Know all of these for your counselor discussion" >}}
...
{{< drg/did-you-know >}}
A loaded coal unit train can weigh more than 15,000 tons and stretch over a mile long. BNSF alone operates hundreds of these trains weekly, moving coal from Wyoming's Powder River Basin to power plants across the Midwest and South.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Pick three train types that are meaningfully different from each other — for example, unit trains, manifest trains, and intermodal trains. Naming three varieties of unit trains (coal, grain, oil) only counts as one type if your counselor is strict about the distinction. Check with your counselor in advance.
{{< /drg/tip >}}

{{< drg/next-page
    text="Option 1a done? Move on to the next option."
    teaser="Req 1b asks you to map out a real Class I or regional railroad — its cities, terminals, and what it hauls."
