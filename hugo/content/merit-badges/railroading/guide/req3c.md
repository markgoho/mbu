...
req_number: "3c"
req_path: "3.c"
prev: "/merit-badges/railroading/guide/req3b/"
prev_title: "Req 3b — Rail Jobs That Interest You"
next: "/merit-badges/railroading/guide/req3d/"
next_title: "Req 3d — Interview a Rail Professional"
---
...
{{< drg/did-you-know >}}
Positive Train Control (PTC) was mandated by Congress after the 2008 Chatsworth, California collision killed 25 people. Railroads spent an estimated $15 billion and over a decade implementing PTC across the U.S. network. The technology automatically stops a train if it is about to run a stop signal, exceed a speed limit, or enter a work zone.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Req 3c Preparation Checklist" >}}
...
{{< drg/tip >}}
The key distinction: a **railroad** operates trains over tracks to move freight or passengers. A **rail support industry** supplies something the railroad needs to do that — equipment, materials, technology, or services. Your counselor may ask you to make this distinction explicit, so practice saying it.
{{< /drg/tip >}}

{{< drg/next-page
    text="Option 3c done? The final option involves interviewing a rail professional."
    teaser="Req 3d is the interview option — learn what a real rail industry professional does and how they got there."
