...
{{< drg/image src="images/railroad-car-types-reference.avif" alt="Reference sheet with labeled side-view silhouettes of ten common freight and passenger car types" >}}
...
- **Maintenance-of-way (MOW) equipment** (ballast tampers, rail grinders — technically not revenue cars but often seen on tracks)

{{< drg/did-you-know >}}
The autorack car was invented in the 1960s when Ford and General Motors pushed railroads to carry new cars more efficiently. Before autoracks, vehicles were driven onto flatcars one at a time — slow, labor-intensive, and exposed to the elements. Today a single three-level autorack can carry 15 full-size pickup trucks.
{{< /drg/did-you-know >}}

{{< drg/video
    title="Every Type of Railcar Explained in 15 Minutes — Practical Engineering"
    url="https://www.youtube.com/watch?v=psjExhXfvbI" >}}

## How to Prepare

{{< drg/checklist title="Req 1c Preparation Checklist" >}}
...
{{< drg/tip >}}
Google Images or Wikimedia Commons has excellent photographs of every car type. Search "[car type] railroad car" for quick results. If you can spot each type on a passing freight train, you have learned what you need to know.
{{< /drg/tip >}}

{{< drg/next-page
    text="Option 1c complete? On to the final option."
    teaser="Req 1d covers locomotive power — how diesel-electric drives work, and what dynamic braking and radial steering trucks mean."
