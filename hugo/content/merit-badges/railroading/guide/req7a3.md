...
{{< drg/image src="images/model-scale-size-comparison.avif" alt="Comparison of Z, N, HO, and O scale model locomotives lined up with a ruler and coin for size reference" >}}

## The Four Most Popular Model Railroad Gauges and Their Scales

{{< drg/checklist title="Gauge Reference" subtitle="Name these four for your counselor" >}}
...
{{< drg/did-you-know >}}
There is also G gauge (Large Scale / Garden Scale), popular for outdoor layouts and holiday trains. Its scale varies by manufacturer (1:22.5 to 1:32), but all G gauge trains share the same wide track gauge of 45 mm — making them compatible on the track even if the sizes differ slightly.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Ready for Your Counselor?" subtitle="Make sure you can do all of these" >}}
...
{{< drg/next-page
    text="You have mastered the language of scales and gauges."
    teaser="Activity 7a4 takes you online to explore the manufacturers and magazines that drive the hobby."
