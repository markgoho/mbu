...
{{< drg/did-you-know >}}
Amtrak owns only about 600 miles of track — mainly the Northeast Corridor between Washington, D.C. and Boston. For every other route, Amtrak trains run over tracks owned by freight railroads. This means Amtrak trains must yield to freight trains, which is one reason long-distance Amtrak trains often run late.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="How to Find Amtrak Schedule Information" >}}
...
{{< drg/tip >}}
You do not need to actually purchase a ticket — you are planning a hypothetical trip. But the exercise is much more realistic if you look up real schedules on amtrak.com. Print or screenshot the timetable page and bring it to your counselor meeting.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    title="Amtrak Train Schedules & Timetables"
    description="Find any Amtrak route's complete timetable — use this to plan your 2a trip." >}}

{{< drg/video
    title="Amtrak Map USA: Understand America’s Train Routes — T1D Wanderer"
    url="https://www.youtube.com/watch?v=anKNW1YHBoU" >}}
...
{{< drg/image src="images/heavy-rail-vs-light-rail.avif" alt="Side-by-side comparison of a grade-separated heavy-rail subway train and a street-running light rail vehicle" >}}
...
{{< drg/checklist title="Req 2b Review Checklist" >}}
...
{{< drg/next-page
    text="Requirement 2 complete. On to Requirement 3 — the career and business side of railroading."
    teaser="Req 3 is a select-one requirement covering railroad departments, career interests, support industries, or a professional interview."
