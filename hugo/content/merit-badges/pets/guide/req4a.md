...
{{< drg/video
    title="Cat Agility Course at Cat Fanciers Cat Show (video)"
    url="https://www.youtube.com/watch?v=QABTG6FldFE" >}}
...
{{< drg/checklist title="Pre-Show Preparation" subtitle="Build your plan a week or two in advance" >}}
...
{{< drg/safety-first >}}
Never force a pet through obvious panic, overheating, heavy stress, or unsafe handling. A show is optional. Your pet's welfare is not. If the environment is too intense, remove the animal and reassess with an adult and your counselor.
{{< /drg/safety-first >}}

{{< drg/image src="images/pet-show-prep-kit.avif" alt="Labeled pet show prep kit with carrier, water bowl, brush, treats, cleanup supplies, and paperwork" >}}
...
This is one reason [Req 2](/merit-badges/pets/guide/req2/) matters. The more clearly you understand your pet, the more confident you will sound when talking about it.
...
{{< drg/external-link
    ...
    description="An example of a national organization that runs pet events and publishes guidance about shows, sports, and responsible handling for dogs." >}}
...
{{< drg/next-page
    text="A show tests readiness in public."
    teaser="Next, see how everyday training can teach your pet three or more useful tricks or special abilities."
