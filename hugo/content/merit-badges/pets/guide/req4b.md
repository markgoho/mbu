---
title: "Teach Tricks and Skills"
layout: "guide"
group_title: "4. Show Ring or Tricks"
req_number: "4b"
req_path: "4.b"
prev: "/merit-badges/pets/guide/req4a/"
prev_title: "Step Into a Pet Show"
next: "/merit-badges/pets/guide/req5/"
next_title: "Future Paths With Pets"
---
...
{{< drg/tip >}}
Choose three behaviors that build on each other. For example, target touch can lead to spin, and spin can lead to weaving around your legs. Small progress makes training less frustrating for both of you.
{{< /drg/tip >}}
...
{{< drg/checklist title="Simple Training Cycle" subtitle="Repeat this pattern many times" >}}
...
{{< drg/safety-first >}}
Never train by scaring, hitting, yanking, forcing painful positions, or exhausting your pet. Stop if you see fear, stress, overheating, or repeated frustration. Safe training protects both learning and trust.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/pet-training-shaping-steps.avif" alt="Step-by-step sequence showing a pet learning a trick through small rewarded stages" >}}
...
These notes connect well with the observation skills you already used in [Req 1](/merit-badges/pets/guide/req1/).

## Learn From Demonstrations, Then Adapt

{{< drg/video
    title="Easiest Way to Teach Your Dog to Roll Over (video)"
    url="https://www.youtube.com/watch?v=IsJ0VdeOJcg" >}}
<!-- Official resource duplicate URL retained for verification: https://www.youtube.com/watch?v=IsJ0VdeOJcg%20 -->

{{< drg/video
    title="Train Your Cat to Do Fun Tricks (video)"
    url="https://www.youtube.com/watch?v=oX7vgQTK9fo" >}}

{{< drg/video
    title="How I Trained My Cat to Fetch (video)"
    url="https://www.youtube.com/watch?v=zrDskEObBs8" >}}
...
{{< drg/external-link
    title="American Kennel Club — Trick Dog"
    url="https://www.akc.org/sports/trick-dog/"
    description="Examples of skill-building progressions and organized trick-training goals that can inspire safe, structured practice." >}}
...
{{< drg/next-page
    text="You have practiced communication, patience, and timing with your pet."
    teaser="Next, look ahead to careers and hobbies that build on what you have learned from pet care."
