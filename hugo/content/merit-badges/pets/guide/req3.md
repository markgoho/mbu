...
{{< drg/tip >}}
Ask your counselor to approve the book or pamphlet *before* you spend time reading it. That saves you from doing extra work with a source that does not meet the requirement.
{{< /drg/tip >}}
...
{{< drg/checklist title="Smart Reading Notes" subtitle="These notes make the counselor discussion much easier" >}}
...
This is where [Req 2](/merit-badges/pets/guide/req2/) and this requirement work together. One teaches you to explain care. The other helps you refine that explanation with expert guidance.
...
{{< drg/be-prepared title="How to Talk About What You Read" >}}
- **Step one:** Name the book or pamphlet and why it was a good match for your pet.
- **Step two:** Share two or three things you learned that felt important.
- **Step three:** Explain one point that connected directly to your own pet's behavior or care.
- **Step four:** Mention any change you would make, or already made, because of what you read.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    ...
    description="Veterinarian-reviewed pet health and welfare information that can help you compare what you read with professional guidance." >}}
...
{{< drg/next-page
    text="You have learned from an approved source, not just your own experience."
    teaser="Now choose your path: prepare for a pet show or train tricks and special abilities."
