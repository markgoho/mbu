...
{{< drg/checklist title="What Your Write-Up Should Cover" subtitle="Use these five buckets to organize your ideas" >}}
...
{{< drg/tip >}}
Use the notes from [Req 1](/merit-badges/pets/guide/req1/) to make this requirement easier. Your care log already contains real examples of what your pet needs and how often those needs come up.
{{< /drg/tip >}}
...
{{< drg/video
    title="Understanding Hamsters: Care, Feeding, Housing, and More (video)"
    url="https://www.youtube.com/watch?v=Pi_slxuGJUg" >}}
...
{{< drg/image src="images/pet-housing-needs-grid.avif" alt="Comparison grid showing proper housing basics for a dog, bird, fish, and reptile" >}}
...
{{< drg/external-link
    ...
    description="A strong starting point for practical pet-care topics such as feeding, safety, behavior, enrichment, and responsible ownership." >}}
...
{{< drg/next-page
    text="You can now explain how your pet's care fits together."
    teaser="Next, turn approved reading into a thoughtful discussion with your counselor."
