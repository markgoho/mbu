...
{{< drg/checklist title="What to Track" subtitle="Pick the items that fit your type of pet" >}}
...
{{< drg/tip >}}
Short notes beat perfect notes. A log entry like "Fed 1 cup kibble, fresh water, 20-minute walk, checked ears, no issues" is far more useful than waiting a week and trying to remember everything at once.
{{< /drg/tip >}}

{{< drg/image src="images/pet-care-log-example.avif" alt="Sample weekly pet care log showing feeding, cleaning, exercise, and health-check entries across several days" >}}
...
Those patterns help you catch trouble early. They also give you strong material for [Req 2](/merit-badges/pets/guide/req2/), where you will explain care, feeding, and housing in detail.

{{< drg/be-prepared title="If Your Routine Gets Interrupted" >}}
- **Step one:** Make sure another responsible person knows your pet's food, water, and safety needs.
- **Step two:** Leave clear written instructions, not just verbal reminders.
- **Step three:** Return to your log as soon as possible so your record stays complete.
- **Step four:** If something unusual happened, note it honestly instead of pretending the routine was normal.
{{< /drg/be-prepared >}}
...
{{< drg/video
    title="Create an Activity Log (video)"
    url="https://www.youtube.com/watch?v=uh8tDZj9I_A" >}}

{{< drg/external-link
    title="ASPCA"
    url="https://www.aspca.org"
    description="Pet care guidance, behavior information, and welfare resources that can help you think more clearly about your animal's daily needs." >}}
...
{{< drg/next-page
    text="You have shown that you can stick with the job."
    teaser="Next, organize what you know about your pet's care, feeding, housing, and local rules."
