...
Fire Behavior. Do the following:
{{< /drg/requirement >}}
...
The diagram you make for 5c is not busywork, either — you will use it again in [Req 7a](/merit-badges/wildland-fire-management/guide/req7a/) to demonstrate suppression tactics, so make it good.

## Requirement 5a: The Fire Environment

{{< drg/requirement number="5a" >}}
Discuss with your counselor how the fire environment affects wildland fire behavior. Include examples of the influences of weather, topography, and fuel.
{{< /drg/requirement >}}
...
{{< drg/video
    title="The Relationship Between Relative Humidity, Fuel Moisture, and Fire Behavior (video)"
    url="https://youtu.be/FUdPfKL8lXA" >}}

{{< drg/external-link
    title="Wildland Fire Behavior (website)"
    url="https://www.nps.gov/articles/wildland-fire-behavior.htm"
    description="The National Park Service's plain-language explanation of the fire environment and the factors that drive how a wildfire spreads." >}}
...
{{< drg/did-you-know >}}
A wildfire moving uphill can spread several times faster than the same fire on flat ground with the same fuel and weather, and the effect compounds steeply as the slope increases. This is why "building fireline downhill with fire below" is one of the 18 Watch Out Situations you will study in [Req 6b](/merit-badges/wildland-fire-management/guide/req6b/) — the fire has the advantage, and the crew has the worst possible escape problem.
{{< /drg/did-you-know >}}

### Fuel

Fuel is the leg people can actually manage, which is why [Req 3a](/merit-badges/wildland-fire-management/guide/req3/) and [Req 4b](/merit-badges/wildland-fire-management/guide/req4b/) matter so much.
...
{{< drg/tip >}}
When your counselor asks for "examples," give paired ones. *Weather:* a cold front pushed a fire's east flank into a new head and it ran four miles in an afternoon. *Topography:* the fire crossed a ridge, dropped onto a north-facing slope with damp heavy timber, and slowed to a crawl. *Fuel:* the fire raced through cured cheatgrass at highway speed and then stalled where the grass gave way to bare rock. Concrete examples show you understand the mechanism, not just the vocabulary.
{{< /drg/tip >}}

## Requirement 5b: Removing Heat, Fuel, or Oxygen

{{< drg/requirement number="5b" >}}
Explain how a wildfire can be suppressed by removing heat, fuel, or oxygen.
{{< /drg/requirement >}}
...
{{< drg/video
    title="Fire Triangle Explained (video)"
    url="https://youtu.be/8WPk15XqN2E" >}}

{{< drg/checklist title="Sort the Tactic, Name the Side" subtitle="Practice for your counselor conversation" >}}
...
Draw a diagram to illustrate the parts of a wildfire.
{{< /drg/requirement >}}
...
{{< drg/image src="images/parts-of-a-wildfire-diagram.avif" alt="Overhead map-style diagram of a wildfire on sloping terrain with a labeled point of origin, head, rear or heel, right and left flanks, perimeter, two fingers with a pocket between them, an unburned island inside the perimeter, spot fires ahead of the head, the black burned area, and the green unburned area, with a wind direction arrow" >}}
...
{{< drg/tip >}}
Draw your diagram on a real map or a sketch of terrain you know — your Scout camp, a nearby ridge, the hills behind your neighborhood — rather than a blank oval. Add a wind arrow and a slope indicator, because the head's location only makes sense in relation to them. And keep the diagram; in [Req 7a](/merit-badges/wildland-fire-management/guide/req7a/) you will place tokens on it to demonstrate suppression tactics, and a diagram with real roads, a creek, and a ridge gives you far more to work with than a circle.
{{< /drg/tip >}}

{{< drg/video
    title="How To Describe the Behavior and Parts of a Wildfire (video)"
    url="https://youtu.be/b1KvTswZYNA" >}}
...
{{< drg/next-page
    text="You can read the fire environment and name every part of a wildfire"
    teaser="Suit up: eight pounds of protective gear and the reason each piece exists."
