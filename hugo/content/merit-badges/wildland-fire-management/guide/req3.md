...
Fire as a Management Tool. Discuss with your counselor how prescribed fire is used to accomplish the following:
{{< /drg/requirement >}}
...
{{< drg/safety-first >}}
Everything on this page describes work performed by certified professionals under legal authority. Scouts do not conduct prescribed burns, assist with ignition, or hold line on a burn. If your counselor arranges for you to *observe* a burn or visit a recently burned unit, that is an outstanding experience — go, ask questions, and follow every instruction you are given without exception.
{{< /drg/safety-first >}}

{{< drg/did-you-know >}}
Prescribed fire never stopped in the southeastern United States. While western agencies spent the mid-1900s trying to eliminate fire entirely, southern foresters kept burning pine stands on a two-to-four-year cycle because they could see what happened when they did not. Today the Southeast burns several million acres a year on purpose — more than the rest of the country combined — and it is one reason southern pine forests generally do not produce the extreme fire behavior seen in the West.
{{< /drg/did-you-know >}}

{{< drg/video
    title="Misconceptions and Benefits of Fire (video)"
    url="https://youtu.be/vFPIoH4ML2U" >}}

## Requirement 3a: Fuel Reduction

{{< drg/inherited-requirement number="3a" req_path="3.a" topic="Fuel reduction" />}}

Fire needs fuel, and the amount and arrangement of fuel is the one part of the fire environment that people can actually change. (You will meet the other two — weather and topography — in [Req 5a](/merit-badges/wildland-fire-management/guide/req5/).)
...
{{< drg/video
    title="Good Fire: Prescribed Burning (video)"
    url="https://youtu.be/E542gY7uR0s" >}}

## Requirement 3b: Fish and Wildlife Habitat Enhancement

{{< drg/inherited-requirement number="3b" req_path="3.b" topic="Fish and wildlife habitat enhancement" />}}

In [Req 2b](/merit-badges/wildland-fire-management/guide/req2/) you looked at how severe fire damages habitat. Here is the other side of the same coin: fire of the right intensity is one of the most powerful habitat tools available.
...
{{< drg/video
    title="Wildlife That Depends on Fire To Survive (video)"
    url="https://youtu.be/Q8mD-4rexo0" >}}

## Requirement 3c: Ecosystem Restoration

{{< drg/inherited-requirement number="3c" req_path="3.c" topic="Ecosystem restoration" />}}
...
{{< drg/video
    title="How Does Fire Affect Wildlife? (video)"
    url="https://youtu.be/iKRYDp6VpyA" >}}

## Requirement 3d: Forest Regeneration

{{< drg/inherited-requirement number="3d" req_path="3.d" topic="Forest regeneration" />}}
...
{{< drg/video
    title="Fire Effects in the Forest (video)"
    url="https://youtu.be/BxKh86ukZMc" >}}

## Requirement 3e: Insect and Disease Control

{{< drg/inherited-requirement number="3e" req_path="3.e" topic="Insect and disease control" />}}
...
{{< drg/video
    title="Insects, Disease, Drought, and Fire (video)"
    url="https://youtu.be/e_cOMAioE54" >}}

## Bringing the Five Together

{{< drg/checklist title="Talking Points for Your Counselor" subtitle="One sentence you should be able to say about each objective" >}}
...
{{< drg/tip >}}
Prescribed fire has real costs and real risks, and acknowledging them makes your discussion stronger, not weaker. Burns produce smoke that affects neighbors and highways. Narrow prescription windows and limited staffing mean agencies routinely burn far fewer acres than they plan. And occasionally a burn escapes — the 2000 Cerro Grande Fire near Los Alamos began as a prescribed burn and destroyed hundreds of homes. The honest position is that prescribed fire is a managed risk taken to avoid a much larger unmanaged one.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You can explain the five jobs prescribed fire is used to accomplish"
    teaser="Find out what actually causes American wildfires — and what you can do about it on your next outing."
