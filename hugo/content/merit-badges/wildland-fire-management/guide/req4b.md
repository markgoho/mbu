...
{{< drg/inherited-requirement number="4b1" req_path="4.b.1" topic="Wildland-Urban Interface" />}}
...
{{< drg/external-link
    title="Understanding the Wildland Urban Interface (website)"
    url="https://storymaps.arcgis.com/stories/6b2050a0ded0498c863ce30d73460c9e"
    description="An interactive story map that walks through what the WUI is, how it has expanded, and why it drives modern wildfire risk." >}}

{{< drg/tip >}}
Figure out whether *you* live in the WUI, and whether your Scout camp does. Then look at your own access: how many ways are there out of your neighborhood, is your address readable from the road at night, and could an engine turn around at the end of your street? Those three answers will make your counselor discussion concrete instead of theoretical.
{{< /drg/tip >}}

## Requirement 4b2: Defensible Space and Protecting Homes and Communities

{{< drg/inherited-requirement number="4b2" req_path="4.b.2" topic="Defensible space and how homes and communities in the wildland-urban interface can be protected from wildfire" />}}
...
| Zone | Distance | What it does | Key actions |
| --- | --- | --- | --- |
| **Immediate** (Zone 0) | 0–5 ft from the structure, including under decks | Stops embers from finding anything to burn against the house | Gravel, pavers, or bare soil instead of combustible mulch; no shrubs or trees; nothing stored under decks; clean gutters and roof valleys; screen vents |
| **Intermediate** (Zone 1) | 5–30 ft | Keeps flames low and prevents fire from climbing into tree crowns | Mow grass to 4 inches; remove ladder fuels and dead plants; space shrubs and trees apart; prune branches up off the ground; move woodpiles and propane tanks out of this zone |
| **Extended** (Zone 2) | 30–100 ft (farther on slopes) | Slows an approaching fire and drops it out of the canopy before it reaches the house | Thin trees so crowns do not touch; remove accumulated litter, dead limbs, and small dead trees; break up continuous brush |
...
{{< drg/checklist title="Home Hardening Priorities" subtitle="What inspectors look at first, roughly in order of impact" >}}
...
{{< drg/video
    title="Separating Your Home From Wildfire—the Zones of Defensible Space (video)"
    url="https://youtu.be/isf6COwOXPw" >}}
...
{{< drg/safety-first >}}
Defensible space work is real work with real hazards. Chain saws, brush cutters, chippers, and ladders all require training, and none of them are appropriate for Scouts to operate without proper instruction, supervision, and protective equipment. Scouting America's Age-Appropriate Guidelines and the *Guide to Safe Scouting* restrict power tool use by age, so check them before planning any project. If you take on [Req 9c](/merit-badges/wildland-fire-management/guide/req9c/), plan a project built on hand work — raking needles, cleaning gutters from the ground, moving woodpiles, hauling brush — and leave the saw work to qualified adults.
{{< /drg/safety-first >}}

{{< drg/did-you-know >}}
Researchers who study post-fire neighborhoods have found that houses can survive a wildfire that burns everything around them, and that surviving houses are not usually the ones with the most cleared land — they are the ones with clean roofs, screened vents, and nothing combustible within a few feet of the wall. In other words, the most decisive fireproofing work happens with a ladder and a rake, not a bulldozer.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You can explain the WUI and what defensible space really requires"
    teaser="Learn the fire environment — weather, topography, and fuel — and how to draw a wildfire's anatomy."
