...
{{< drg/safety-first >}}
Never collect alone near water. Wear appropriate footwear — stream and pond bottoms can be slippery and have unstable drop-offs. Use polarized sunglasses to see the bottom clearly. Tell someone where you're going and when you'll return. In areas with stinging invertebrates (large predacious diving beetle larvae, water scorpions) use a net rather than your bare hands.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Start with animals at different trophic levels to create an observable food chain. A plant base (algae, elodea), herbivores (snails, tadpoles, amphipods), and one small predator (dragonfly nymph or small fish) will show you energy moving through the food web in real time.
{{< /drg/tip >}}

{{< drg/video
    title="A guide to fish in your wildlife pond — The Wildlife Garden Project"
    url="https://www.youtube.com/watch?v=Oe1QzwH39SE" >}}
...
- What would happen if you introduced an invasive species?
These are the same questions a real lake manager faces at larger scale.
...
{{< drg/did-you-know >}}
The National Invasive Species Information Center estimates that improperly discarded aquarium fish and plants are responsible for establishing multiple invasive species populations in U.S. waters, including goldfish, koi, and numerous aquatic plants. A few seconds of thought at disposal prevents years of ecological damage.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Center for Invasive Species and Ecosystem Health — Aquatic Invasives"
    url="https://www.invasive.org/"
    description="Information on aquatic invasive species and how to prevent accidental introduction — relevant to proper disposal of your aquarium organisms." >}}

{{< drg/external-link
    title="USGS Nonindigenous Aquatic Species — State Maps"
    url="https://nas.er.usgs.gov/"
    description="Track established invasive aquatic species in your state — and understand why proper disposal of aquarium species matters so much." >}}
...
{{< drg/next-page
    text="You've practiced real fisheries science"
    teaser="Req 8 explores the careers that make this work a profession — and how you might pursue one."
