...
{{< drg/did-you-know >}}
You don't need to travel far. Studies of urban wildlife diversity consistently find that even city parks and suburban neighborhoods host 40–80 bird species, along with foxes, raccoons, opossums, and a surprising variety of reptiles and amphibians. Some of the most accomplished wildlife observers in the country have spent their lives watching a single 5-acre woodlot.
{{< /drg/did-you-know >}}
...
{{< drg/download
    ...
    url="/merit-badges/fish-and-wildlife-management/guide/wildlife-observation-log/"
    type="printable" >}}
...
{{< drg/checklist title="Getting to 25 Species" subtitle="Start with the easiest groups and work toward the harder ones" >}}
...
{{< drg/external-link
    ...
    description="Log your 25 species observations here and get expert identification help. Your records contribute to scientific biodiversity databases used by researchers worldwide." >}}

{{< drg/external-link
    title="eBird — Cornell Lab of Ornithology"
    url="https://ebird.org/"
    description="Submit your bird species to eBird and compare your list to local species expected in your area. eBird's species bar charts show which birds are likely at your location by month." >}}

{{< drg/video
    title="Introduction to eBird — Cornell Lab of Ornithology"
    url="https://www.youtube.com/watch?v=-t-0xAjxakw" >}}

Once you've documented your 25 species, you're ready to move to the fish study requirement.

{{< drg/next-page
    text="You've observed wildlife in the field"
    teaser="Req 6b takes a different approach — researching how your state officially classifies the species that live there."
