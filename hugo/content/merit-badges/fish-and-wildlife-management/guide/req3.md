...
{{< drg/tip >}}
The National Wildlife Federation's Certified Wildlife Habitat program lets you register your property — whether a large rural acreage or a tiny apartment balcony — as a certified wildlife habitat once it meets criteria for food, water, shelter, and sustainable practices. It's a great goal to work toward and a way to show your neighbors what's possible.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Lead ammunition fragments into hundreds of tiny particles when a bullet hits an animal. When deer gut piles left in the field are scavenged by bald eagles, California condors, and other raptors, those birds ingest lead fragments that cause neurological damage and death. Switching to non-lead (copper) ammunition costs slightly more but eliminates this exposure entirely.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Never brake suddenly to avoid a large animal on a highway — especially deer, elk, or moose. A controlled, straight-ahead braking is safer than swerving, which can roll a vehicle or bring you into oncoming traffic. Reduce speed in posted wildlife crossing areas and use high beams on rural roads when no other vehicles are present.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Personal Conservation Checklist" subtitle="How many of these can you commit to?" >}}
...
{{< drg/external-link
    ...
    description="A free app and website where you record wildlife observations that become research-quality data. Used by millions of scientists, educators, and naturalists worldwide." >}}

{{< drg/external-link
    title="eBird — Cornell Lab of Ornithology"
    url="https://ebird.org/"
    description="The world's largest bird data resource, powered by citizen scientist observations. Log your bird sightings and contribute to global avian research." >}}
...
{{< drg/next-page
    text="Individual actions matter, but professional management scales them up"
    teaser="Explore the five major practices fish and wildlife managers use in your state."
