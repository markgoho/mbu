...
{{< drg/video
    title="Fisheries Management: It's Better with Predators — Pew"
    url="https://www.youtube.com/watch?v=cLDWk4oic6s" >}}
...
{{< drg/tip >}}
The best projects address a specific, identifiable problem rather than just "making the yard better." Before you start, write one sentence describing the problem: "The pond shoreline has bare eroded banks where invasive plants have removed native vegetation, causing sedimentation and reducing shallow-water fish habitat." That kind of specificity helps you design a targeted solution and measure whether it worked.
{{< /drg/tip >}}
...
{{< drg/checklist title="Project Planning Checklist" subtitle="Complete before starting any work" >}}
...
{{< drg/be-prepared title="When Your Project Hits a Snag" >}}
Habitat projects rarely go exactly as planned. Here's how to handle common problems:

- **Landowner won't give permission**: Find another site — a school, park, or neighbor's property. The project just needs to be real.
- **Permit required**: Work with your counselor or a local land trust to understand what's needed. This is itself a learning experience about how management works in the real world.
- **Native plants aren't available or are expensive**: Contact your state's native plant society, local conservation district, or a native plant nursery — many offer discounted or free plants for habitat restoration projects. Your state may have a cost-share program.
- **You can't tell if it's working**: Talk to your counselor before you give up. Sometimes results take longer than expected, or you need to adjust your evaluation method.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Native Plant Finder — National Wildlife Federation"
    url="https://www.nwf.org/NativePlantFinder/"
    description="Enter your zip code to find native plants that support the most wildlife species in your specific area. Essential tool for planning a backyard habitat project." >}}

{{< drg/external-link
    title="NRCS Backyard Conservation — USDA Natural Resources Conservation Service"
    url="https://www.nrcs.usda.gov/conservation-basics/natural-resource-concerns/wildlife/backyard-conservation"
    description="Practical guidance on ten backyard practices that improve wildlife habitat, from the federal agency that funds large-scale habitat conservation across the country." >}}
...
{{< drg/next-page
    text="Habitat projects change the land — wildlife blinds help you watch what lives there"
    teaser="Explore Req 5d and learn how to build a blind and document 10 wild species through photographs or sketches."
