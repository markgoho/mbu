...
{{< drg/did-you-know >}}
A species doesn't have to be rare to be listed. The flatwoods salamander of the Southeast isn't widely known, but habitat loss from pine plantation forestry drove it onto the federal threatened list. Meanwhile, common species like white-tailed deer — which number in the tens of millions — are never listed because abundance, not familiarity, determines status.
{{< /drg/did-you-know >}}

{{< drg/video
    title="The Endangered Species Act: 40 Years at the Forefront — U.S. Fish & Wildlife Service"
    url="https://www.youtube.com/watch?v=DojGPBV4U0w" >}}
...
{{< drg/be-prepared title="Preparing to Discuss Three Species with Your Counselor" >}}
For each of the three species you discuss, prepare:

- **Species name and classification**: What is it, and how is it classified in your state?
- **Why it's in that category**: What factor placed it there — population decline, invasive status, ecological role, harvest demand?
- **Current management practices**: What is your state actively doing? What federal programs are involved?
- **Status and outlook**: Is it recovering, stable, or declining? What do managers consider the biggest challenge going forward?

Choosing three species from different categories (one endangered, one invasive, one game species) makes for a more interesting discussion than three deer management programs.
{{< /drg/be-prepared >}}

{{< drg/checklist title="Research Checklist" subtitle="Check off each category as you complete your list" >}}
...
{{< drg/external-link
    title="USFWS Endangered Species — State Listings"
    url="https://www.fws.gov/program/ecological-services/endangered-species"
    description="The U.S. Fish and Wildlife Service's Ecological Services program maintains the federal Endangered Species list and provides state-by-state information on listed species." >}}

{{< drg/external-link
    title="Association of Fish and Wildlife Agencies — State Agency Contacts"
    url="https://www.fishwildlife.org/afwa-members"
    description="Direct links to every state fish and wildlife agency — where you'll find state-specific endangered species lists, game species regulations, and invasive species information." >}}

Once you've completed your species classification research, you can compare options or move to the fish study requirement.

{{< drg/next-page
    text="You've explored how states classify wildlife"
    teaser="Req 6c offers a different path — building a structured reference scrapbook covering all five animal groups."
