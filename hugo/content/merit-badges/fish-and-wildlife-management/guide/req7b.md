...
{{< drg/video
    title="A Creel Survey — Texas Parks and Wildlife"
    url="https://www.youtube.com/watch?v=XmwezZbtQww" >}}

{{< drg/did-you-know >}}
CPUE has been used to track fish populations for so long that historical creel records from the 1940s and 1950s are still scientifically valuable today. A researcher comparing modern CPUE to 70-year-old records can document long-term population trends that would be impossible to study any other way.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Creel Census Data Sheet" subtitle="Copy this or use it as a template for your interviews" >}}
...
{{< drg/be-prepared title="When Anglers Don't Want to Be Interviewed" >}}
Some people are private about their fishing and won't want to share their results. That's their right, and you should respect it politely.

- **Approach**: Friendly, non-threatening, explain your purpose clearly ("I'm working on a Scouting merit badge survey — do you have two minutes to answer a few questions?")
- **Accept refusals gracefully**: "No problem, thanks for your time." Don't push.
- **Record non-responses**: Note how many parties declined so your counselor knows your response rate
- **Safety**: Always survey in daylight, preferably at a public boat launch with other people present. Have an adult accompany you.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="American Fisheries Society — Fisheries Techniques Manual"
    url="https://fisheries.org/"
    description="The American Fisheries Society publishes standard methods for fisheries surveys, including detailed creel census protocols used by professional biologists." >}}
...
{{< drg/next-page
    text="Creel surveys measure how many fish are caught"
    teaser="Req 7c shows you what those fish have been eating — and what that reveals about the ecosystem."
