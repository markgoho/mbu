...
{{< drg/checklist title="More Fish and Wildlife Career Options" subtitle="One of these might be a better fit for your interests" >}}
...
{{< drg/be-prepared title="Career Research Framework" >}}
Use this framework to structure your research:

- **Entry requirements**: What degree(s) are needed? What certifications? Any physical requirements?
- **How to build experience**: What internships, volunteer opportunities, or starting positions lead into this career? Many state agencies have student internship programs.
- **Cost of education**: What does the necessary degree cost at in-state universities? Are scholarships available? (Many conservation organizations offer scholarships for students entering wildlife fields.)
- **Starting salary and advancement**: What does an entry-level position pay? What does a senior position pay? What are typical advancement timelines?
- **Job market**: Is the field growing or contracting? What states or regions have the most positions? Are there geographic limitations you should know about?
- **Day in the life**: What does a typical work week actually look like? Field time vs. office time? Travel? Irregular hours?
{{< /drg/be-prepared >}}

## Finding Career Information

{{< drg/external-link
    title="The Wildlife Society — Careers in Wildlife"
    url="https://wildlife.org/careers/"
    description="Professional organization for wildlife biologists. Their careers section includes job listings, salary surveys, student membership, and guidance on entering the profession." >}}

{{< drg/external-link
    title="American Fisheries Society — Careers"
    url="https://fisheries.org/careers/"
    description="The primary professional organization for fisheries scientists. Job listings, student resources, and a searchable directory of fisheries professionals you could contact for informational interviews." >}}

{{< drg/external-link
    title="Bureau of Labor Statistics — Occupational Outlook Handbook: Zoologists and Wildlife Biologists"
    url="https://www.bls.gov/ooh/life-physical-and-social-science/zoologists-and-wildlife-biologists.htm"
    description="Official U.S. government salary data, employment projections, and work environment descriptions for wildlife and fisheries careers." >}}

{{< drg/video
    title="Wildlife Management - Careers in Action — Oregon State University Ecampus"
    url="https://www.youtube.com/watch?v=vApuhek--To" >}}

{{< drg/video
    title="Careers in Fish & Wildlife Law Enforcement — Kentucky Department of Fish & Wildlife Resources"
    url="https://www.youtube.com/watch?v=k0lWtspbdGo" >}}

{{< drg/tip >}}
An informational interview — a 20–30 minute conversation with an actual wildlife biologist or conservation officer asking about their career path — is one of the most valuable things you can do for this requirement. Your merit badge counselor, a local hatchery, your state fish and wildlife agency, or a nearby nature center are all places to find professionals willing to talk with a Scout.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You've completed all eight requirements"
    teaser="The Extended Learning page takes you deeper into fisheries ecology, wildlife corridors, citizen science, and the front edge of conservation biology."
    url="/merit-badges/fish-and-wildlife-management/guide/extended-learning/" >}}
