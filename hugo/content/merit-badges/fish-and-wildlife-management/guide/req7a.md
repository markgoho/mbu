...
{{< drg/video
    title="FWRI Age and Growth Lab — FWC Research"
    url="https://www.youtube.com/watch?v=CQtwfmdv0GM" >}}

{{< drg/did-you-know >}}
The world's oldest known fish, a rougheye rockfish caught off Alaska, was determined to be 205 years old — using the same annuli-counting technique you're learning here. Otoliths (small bones in the inner ear) are used for deep-sea species where scales are less reliable, but the counting principle is identical.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="When Scale Reading Is Difficult" >}}
Not every scale gives a clean reading. Here's how to handle common problems:

- **Blurry rings**: Try cleaning the scale with water and a soft brush, or look at a different scale from the same fish — scales vary in quality
- **Can't find the center**: Some species have very tiny centers; start counting from the smallest visible ring and work outward
- **Disagreeing counts**: Age two or three scales from the same fish and average your counts — even experienced biologists sometimes disagree by one year
- **Catfish, muskellunge, or other scale-less/small-scale species**: Use a dorsal spine cross-section or the opercle (gill cover) bone, which shows similar annual rings — ask your counselor or a fisheries contact for help
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    ...
    description="The primary professional organization for fisheries scientists in North America. Their educational resources and age-and-growth literature provide background on the methods you're using." >}}

{{< drg/external-link
    title="FishBase — Species Accounts"
    url="https://www.fishbase.se/"
    description="Species accounts for virtually every fish species, including maximum age, typical growth rates, and references to age-and-growth studies — useful for verifying your results make sense." >}}

{{< drg/tip >}}
Before presenting your results to your counselor, make a simple table: species, sample size, ages found, and a brief statement of what your results suggest about the population. This shows you understand the management significance of the data, not just the mechanics of reading scales.
{{< /drg/tip >}}

With fish aging behind you, you can explore the other options or advance to the career requirement.

{{< drg/next-page
    text="Scale aging reveals individual fish histories"
    teaser="Req 7b takes a population-level view — a creel census estimates what the whole lake's anglers are catching."
