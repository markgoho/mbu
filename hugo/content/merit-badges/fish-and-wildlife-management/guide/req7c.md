...
{{< drg/safety-first >}}
Treat fish stomachs as you would any biological specimen. Wash your hands thoroughly before and after. Use disposable gloves if available. Keep specimens cool to prevent decomposition (a small cooler with ice works well). If you're examining fish that have been dead for a while, the stomach contents may be partially digested — note this in your records as it affects identification.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Photographing each stomach's contents before and after spreading them out gives you a visual record to reference when writing your report. A white paper plate is a cheap and effective background for close-up phone photos.
{{< /drg/tip >}}

{{< drg/video
    title="Fish and Wildlife Management merit badge: req. 7c — ScoutingWithTheFam"
    url="https://www.youtube.com/watch?v=UxcqdzQqHD8" >}}
...
{{< drg/checklist title="Diet Analysis Data Sheet" subtitle="Complete one for each of your three fish" >}}
...
{{< drg/did-you-know >}}
Stomach content analysis revealed that sea otters in Alaska weren't just eating urchins — they were eating specific urchin species selectively based on size, which had cascading effects on kelp forest structure. Diet analysis of this kind has reshaped our understanding of how top predators shape entire ecosystems.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Stroud Water Research Center — Aquatic Invertebrate ID"
    url="https://stroudcenter.org/"
    description="Resources on freshwater macroinvertebrate identification — useful for identifying the insects and invertebrates you'll find in fish stomachs." >}}
...
{{< drg/next-page
    text="Stomach contents show what fish eat"
    teaser="Req 7d lets you build an entire mini-ecosystem and observe food chains and life cycles firsthand over 60 days."
