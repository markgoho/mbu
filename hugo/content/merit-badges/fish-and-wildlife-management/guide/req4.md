...
{{< drg/tip >}}
Your state's fish and wildlife agency publishes its annual regulations guide online and usually in printed copies available at sporting goods stores and bait shops. Reading through your state's regulations is one of the best ways to understand how management actually works in your area.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Chronic wasting disease (CWD) spreads partly through the illegal movement of deer carcasses across state lines — which is why many states prohibit bringing whole deer carcasses in from other states. A single poached deer moving through the wrong checkpoint can introduce a disease that devastates local herds for decades.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Researching Your State's Five Practices" >}}
When you present this to your counselor, they'll expect state-specific examples, not just generic descriptions. Here's how to find them:

- **Step 1**: Visit your state fish and wildlife agency's website. Most agencies have a "Programs" or "Species Management" section that lists their active management practices.
- **Step 2**: Search for recent press releases — agencies routinely announce new habitat projects, stocking programs, and regulation changes.
- **Step 3**: Look for your state's Annual Report or Comprehensive Wildlife Conservation Strategy — these documents describe exactly what practices are in use and why.
- **Step 4**: Note specific places: a named WMA where prescribed burns occur, a specific lake where walleye are stocked, the name of your state's poaching tip hotline.
{{< /drg/be-prepared >}}

{{< drg/checklist title="More Management Practices to Consider" subtitle="Pick the five most relevant to your state" >}}
...
{{< drg/external-link
    ...
    description="Direct links to every state fish and wildlife agency — your first stop for finding state-specific management practices to describe to your counselor." >}}
...
{{< drg/next-page
    text="You understand the science and the strategy"
    teaser="Now choose a hands-on field project and put management principles into action yourself."
