...
{{< drg/tip >}}
If you're unsure what species to target, install two different box designs for two different species. This satisfies the "at least two" requirement and teaches you the important lesson that different species need different accommodations — just like different people prefer different houses.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
When using power tools to build your boxes, follow all standard woodworking safety procedures: eye protection, hearing protection, keep fingers away from blades, and adult supervision if you're under 18. When erecting boxes on poles or trees, use a ladder properly — someone should hold the base. Never work alone at height.
{{< /drg/safety-first >}}
...
{{< drg/download
    title="Nest Box Monitoring Log"
    url="/merit-badges/fish-and-wildlife-management/guide/nest-box-log/"
    type="printable" >}}
...
{{< drg/video
    title="Keeping Peace Between Bluebirds and House Wrens — Nest Hollow"
    url="https://www.youtube.com/watch?v=CJYhEynyFEg" >}}

{{< drg/external-link
    title="North American Bluebird Society — Nestbox Construction and Monitoring"
    url="https://www.nabluebirdsociety.org/nestbox-info/"
    description="Detailed plans for multiple nestbox designs, monitoring protocols, and troubleshooting guides from the leading bluebird conservation organization in North America." >}}

{{< drg/external-link
    title="NestWatch — Cornell Lab of Ornithology"
    url="https://nestwatch.org/"
    description="A citizen science nest monitoring program. You can register your nest boxes and submit your data — your observations become part of a national research database." >}}

{{< drg/be-prepared title="What If Nothing Uses Your Boxes?" >}}
Don't panic if your boxes sit empty for weeks:

- **Check timing**: Is it before nesting season? Bluebirds scout boxes early but may not start nesting until late March or April depending on your region.
- **Check placement**: Is the habitat right for your target species? A box in dense woods won't attract bluebirds.
- **Check for competitors**: House sparrows and starlings may be evicting your target species. Remove house sparrow nests immediately — house sparrows are a non-native species and their nests are not legally protected. Starlings can be excluded by ensuring the entrance hole diameter is correct (1.5" for bluebirds excludes starlings but not house sparrows).
- **Be patient**: It often takes two years for a box location to become established. Keep your records even if occupancy is low — "box not used" is a valid and useful data point.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="Nest boxes provide housing — feeders draw birds in for close observation"
    teaser="Explore Req 5b and learn how to set up bird feeders and conduct a two-week bird census."
