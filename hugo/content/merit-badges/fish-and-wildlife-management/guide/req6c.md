...
{{< drg/tip >}}
Leave room in each species' section for future additions. A scrapbook you built for this merit badge can grow with you — there's nothing stopping you from adding species 6, 7, and 8 after you've earned the badge.
{{< /drg/tip >}}
...
{{< drg/checklist title="Scrapbook Structure Checklist" subtitle="Verify your scrapbook meets all requirements before meeting with your counselor" >}}
...
{{< drg/external-link
    ...
    description="Detailed life history accounts, photos, sound files, and range maps for every North American bird species — ideal for building your Birds section." >}}

{{< drg/external-link
    title="FishBase — Global Species Database"
    url="https://www.fishbase.se/"
    description="Comprehensive species accounts for fish worldwide, including North American freshwater species — habitat, diet, behavior, and distribution information." >}}

Once your scrapbook is complete and you've reviewed it with your counselor, you're ready for the fish study requirement.

{{< drg/next-page
    text="Your scrapbook builds a knowledge base about wildlife"
    teaser="Req 7 takes you directly into fish biology — choose one hands-on technique for studying fish populations."
