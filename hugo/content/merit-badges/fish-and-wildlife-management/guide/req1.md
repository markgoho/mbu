---
title: "What Is Fish and Wildlife Management?"
layout: guide
group_title: "1. Conservation Fundamentals"
req_number: "1"
prev: "/merit-badges/fish-and-wildlife-management/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/fish-and-wildlife-management/guide/req2/"
next_title: "Major Threats to Fish and Wildlife"
---
...
{{< drg/did-you-know >}}
The word "conservation" in the wildlife context was popularized by Gifford Pinchot, the first chief of the U.S. Forest Service, in the early 1900s. He defined it as "the greatest good for the greatest number for the longest time" — a balancing act between use and protection that still drives wildlife policy today.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Key Terms to Know" subtitle="Make sure you can define each of these for your counselor" >}}
...
{{< drg/be-prepared title="Explaining Management to Someone Who Doesn't Hunt or Fish" >}}
You might encounter people who think wildlife management is just a cover for killing animals. Here's how to explain it clearly:

- **Start with the problem**: Without management, some species overpopulate and degrade their own habitat (deer destroying forest understory), while others are driven to extinction by unregulated hunting or habitat loss.
- **Explain the tools**: Management includes protection, restoration, and research — not just harvest regulation.
- **Use a success story**: Bald eagle recovery, wild turkey expansion, and the return of wolves to the West all happened because of active management.
- **Acknowledge tension**: Reasonable people disagree about how to manage specific species. The goal is decisions based on science and public input, not any one interest group.
{{< /drg/be-prepared >}}

{{< drg/video
    title="Conserving the Nature of America — U.S. Fish & Wildlife Service"
    url="https://www.youtube.com/watch?v=d1mOhYGjbP0" >}}

{{< drg/external-link
    title="North American Model of Wildlife Conservation — The Wildlife Society"
    url="https://wildlife.org/north-american-model-of-wildlife-conservation/"
    description="The Wildlife Society's overview of the seven principles that define the North American approach to managing fish and wildlife populations." >}}
...
{{< drg/next-page
    text="Conservation and management give us the tools"
    teaser="Now learn what threats are forcing managers to use those tools in your state right now."
