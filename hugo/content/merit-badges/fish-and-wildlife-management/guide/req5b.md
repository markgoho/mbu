...
req_number: "5b"
prev: "/merit-badges/fish-and-wildlife-management/guide/req5a/"
prev_title: "Nest Boxes"
next: "/merit-badges/fish-and-wildlife-management/guide/req5c/"
next_title: "Habitat Improvement Project"
---
...
{{< drg/tip >}}
Black-oil sunflower seed is the single best seed for attracting the most diverse range of bird species. Its thin shell is easier to crack than striped sunflower, and its high fat content is attractive to birds year-round. If you want to attract finches specifically, nyjer (thistle) seed in a tube feeder with small holes is unbeatable.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Keep feeders and the ground beneath them clean. Bird feeders concentrate birds, which concentrates bacteria and fungal diseases like salmonellosis and aspergillosis. Scrub feeders with a 10% bleach solution weekly. Remove spoiled or wet seed. If you see sick-looking birds — puffed, lethargic, discharge from eyes — take feeders down for two weeks and let the birds disperse before cleaning and rehanging.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Weather has a dramatic effect on feeder activity. On the day before a winter storm, birds "load up" on calories in anticipation — feeder activity can spike to 2–3 times normal. Scientists have documented that birds can detect dropping barometric pressure and respond by feeding more intensively, even before any visible weather change.
{{< /drg/did-you-know >}}
...
{{< drg/video
    title="Merlin Bird ID Demo — Cornell Lab of Ornithology"
    url="https://www.youtube.com/watch?v=xmSUOLxyatY" >}}

{{< drg/download
    title="Bird Feeder Daily Log Worksheet"
    url="/merit-badges/fish-and-wildlife-management/guide/bird-feeder-log/"
    type="printable" >}}
...
{{< drg/external-link
    title="Merlin Bird ID — Cornell Lab of Ornithology"
    url="https://merlin.allaboutbirds.org/"
    description="Free app with photos, sounds, and a step-by-step ID wizard. The Sound ID feature identifies birds by their calls in real time — invaluable for beginners." >}}

{{< drg/external-link
    title="Project FeederWatch — Cornell Lab of Ornithology"
    url="https://feederwatch.org/"
    description="A citizen science program running November through April that asks participants to count birds at feeders on two-day periods throughout winter. Your two-week log could be the start of a multi-year contribution to national bird population data." >}}
...
{{< drg/next-page
    text="You've watched wildlife come to you"
    teaser="Req 5c shows you how to go out and improve wildlife habitat — a project with lasting impact."
