...
{{< drg/did-you-know >}}
The lower 48 states have lost more than 53% of their original wetlands since European settlement. In some states like California, Iowa, and Ohio, wetland loss exceeds 90%. Wetlands support more than a third of all threatened and endangered species in the U.S. despite covering less than 10% of the land.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Common Invasive Species by Region" subtitle="Research which of these affect your state" >}}
...
{{< drg/video
    title="Climate Change & Habitat Loss: Fisheries at Risk — NOAA Fisheries"
    url="https://www.youtube.com/watch?v=RiSRcx6Z9Oc" >}}

{{< drg/be-prepared title="Researching Your State's Specific Threats" >}}
Your counselor will ask you to discuss threats specific to your state. Here's how to find solid information:

- **Step 1**: Visit your state fish and wildlife agency's website (e.g., "Pennsylvania Fish and Boat Commission" or "Florida Fish and Wildlife Conservation Commission"). Look for a "Species of Concern" or "Wildlife Issues" section.
- **Step 2**: Search your state's name plus "invasive species" to find your state's invasive species council — every state has one.
- **Step 3**: Look up your state on the U.S. Fish and Wildlife Service's website for a list of federally threatened and endangered species in your area.
- **Step 4**: Ask your merit badge counselor — they likely know the local landscape better than any website.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Find Your State Fish and Wildlife Agency"
    url="https://www.fishwildlife.org/afwa-members"
    description="The Association of Fish and Wildlife Agencies lists every state and territorial fish and wildlife agency with direct links to their websites — your best source for state-specific threat information." >}}

{{< drg/external-link
    title="USGS Nonindigenous Aquatic Species — State Maps"
    url="https://nas.er.usgs.gov/"
    description="Interactive maps and data on invasive aquatic species in every U.S. state, maintained by the U.S. Geological Survey. Search by state or species." >}}

Understanding what threatens fish and wildlife is the first step. The next question is: what can *you* do about it?

{{< drg/next-page
    text="Now that you know what threatens fish and wildlife"
    teaser="Discover the concrete actions every citizen — including you — can take right now to be part of the solution."
