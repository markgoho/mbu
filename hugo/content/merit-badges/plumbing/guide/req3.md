...
{{< drg/video
    title="6 Essential Plumbing Hand Tools...and Others to Keep Around! (video)"
    url="https://youtu.be/uppuvS8BShU?si=a2SBD-wzgASkoSy2" >}}
...
{{< drg/checklist title="How to Demonstrate a Tool Well" subtitle="Show your counselor more than just the name" >}}
...
{{< drg/safety-first >}}
Never put your full body weight on a tool just to “make it work.” If a fitting will not move, something is wrong: the tool may be the wrong one, the part may be fragile, or the connection may need a different approach. Forcing tools is a fast way to crack fixtures, strip fittings, or hurt your hands.
{{< /drg/safety-first >}}

{{< drg/tip >}}
If you are choosing which five tools to show, pick tools that cover different kinds of tasks: gripping, cutting, tightening in tight spaces, and clearing clogs. That gives you a better demonstration than five tools that all do nearly the same thing.
{{< /drg/tip >}}

{{< drg/image src="images/plumbing-hand-tools-layout.avif" alt="Five labeled plumbing hand tools laid out on a workbench: pipe wrench, tongue-and-groove pliers, basin wrench, tubing cutter, and closet auger" >}}
...
{{< drg/next-page
    text="You now know several core tools and what each one is designed to do."
    teaser="Next, build your plumbing vocabulary by learning the parts and terms plumbers use every day."
