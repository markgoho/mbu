...
req_number: "1"
req_path: "1"
prev: "/merit-badges/plumbing/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/plumbing/guide/req2/"
next_title: "Req 2 — Home Water Systems"
---
...
{{< drg/video
    title="How Plumbing Transformed Public Health (video)"
    url="https://youtu.be/MVGgjYigmDE?si=nwaqXmHn2CuYYAnK" >}}

{{< drg/did-you-know >}}
Modern indoor plumbing is one of the biggest public-health improvements in human history. Clean water and safe sewage systems helped cities cut deaths from waterborne disease long before many modern medicines existed.
{{< /drg/did-you-know >}}
...
1. **Approved drinking-water pipe materials** — Codes limit which materials may carry potable water so harmful substances do not leach into the supply.
2. **Backflow or cross-connection protection** — These rules prevent dirty water from flowing backward into clean water lines.
3. **Trap and vent requirements** — Codes require traps and vents so drains work properly and sewer gases stay out of the building.
4. **Fixture clearances and installation rules** — Toilets, sinks, and water heaters need enough space and proper connections to work safely and be serviced.
5. **Water-heater temperature and pressure relief protection** — These rules help prevent scalds, pressure buildup, and tank failure.
...
{{< drg/checklist title="How to Research Your Local Rules" subtitle="Bring specific examples to your counselor" >}}
...
{{< drg/tip >}}
If code language feels hard to read, look for homeowner guides, permit FAQs, or inspection checklists. Those often explain the same rules in simpler words.
{{< /drg/tip >}}
...
{{< drg/video
    title="Plumbing Safety Tips (video)"
    url="https://youtu.be/gyWrbmQp5a0?si=mSS8s25KUFkV39Z5" >}}

{{< drg/safety-first >}}
Always shut off the correct water valve before opening a supply line or removing a fixture. If you are working near a water heater, disposal, dishwasher, or any powered appliance, confirm the electrical power or fuel source is safe too. Never use a torch, power tool, or chemical drain product without knowledgeable adult supervision.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="What if a small repair becomes a bigger leak?" >}}

- **Step one**: Shut off the nearest valve immediately.
- **Step two**: If the leak continues, use the house main shutoff.
- **Step three**: Move anything that can be damaged by water.
- **Step four**: Tell the supervising adult exactly what happened and do not restart work until the problem is understood.
  {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have the health-and-safety foundation for the rest of the badge."
    teaser="Trace how water enters a home, moves through supply lines, and leaves through drains and vents."
