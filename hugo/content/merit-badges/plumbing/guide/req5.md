...
{{< drg/video
    title="Four Types of Pipes Explained! (video)"
    url="https://youtu.be/OJkj4T9_X9I?si=b2eBR2WGlANFrxyF" >}}

{{< drg/checklist title="How Plumbers Choose a Pipe Material" subtitle="Think about the job, not just the pipe" >}}
...
{{< drg/did-you-know >}}
PEX became popular partly because fewer fittings are needed on long runs. Fewer fittings can mean faster installation and fewer possible leak points hidden inside walls.
{{< /drg/did-you-know >}}

{{< drg/tip >}}
When explaining pipe choices to your counselor, compare at least two materials directly. For example: “Copper is rigid and heat-resistant, while PEX is flexible and faster to route through finished spaces.”
{{< /drg/tip >}}

{{< drg/image src="images/pipe-material-comparison.avif" alt="Side-by-side labeled samples of copper, PEX, PVC, CPVC, and steel pipe with short notes on common uses" >}}
...
{{< drg/next-page
    text="You can now compare the main pipe materials found in home plumbing."
    teaser="Next, choose four supervised hands-on tasks and decide which ones fit your tools, setting, and skill level."
