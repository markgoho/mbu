...
{{< drg/video
    title="Why Plumbing is the Best Job Ever (video)"
    url="https://youtu.be/6cmAKvZScrQ?si=TbI4S2w6b0DMWN8A" >}}

{{< drg/video
    title="Plumbing Jobs Explained: From Odd Jobs to Owning a Small Business (video)"
    url="https://youtu.be/vIr4tUV9YNk?si=Gq8NZD-MQVrOokGr" >}}
...
{{< drg/checklist title="Questions to Answer in Your Career Research" subtitle="Bring useful details to your counselor discussion" >}}
...
{{< drg/tip >}}
If possible, interview a real plumber, plumbing instructor, or inspector. A short conversation can teach you more than a long list of job postings because you can ask what the work is actually like day to day.
{{< /drg/tip >}}

{{< drg/be-prepared title="How to decide whether this career fits you" >}}

- **Think about the work environment**: Do you like solving hands-on problems in changing locations?
- **Think about the schedule**: Some plumbing work includes emergency calls or early starts.
- **Think about the satisfaction**: Many plumbers like work where they can see a real result at the end of the day.
  {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have explored where plumbing skills can lead in the real world."
    teaser="Finish with ideas for deeper learning, real-world experiences, and organizations connected to the trade."
    url="/merit-badges/plumbing/guide/extended-learning/" >}}