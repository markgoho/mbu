...
Identify and explain the following terms: washer, retaining nut, plunger (rubber force cup), solder, flux, elbow, tee, nipple, coupling, plug, union, trap, drainpipe, and water meter.
{{< /drg/requirement >}}
...
{{< drg/safety-first >}}
Soldering involves heat, open flame, and very hot metal. For this badge, treat soldering as a supervised skill. Never touch a recently heated fitting just because the flame is off.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="A Good Way to Study These Terms" subtitle="Move from words to real objects" >}}
...
{{< drg/tip >}}
Do not try to memorize the list as random vocabulary. Ask yourself what each part does in the system: seal, connect, branch, redirect, close, measure, or protect.
{{< /drg/tip >}}

{{< drg/image src="images/plumbing-terms-reference-board.avif" alt="Labeled board showing common plumbing fittings and parts including elbow, tee, coupling, union, plug, trap, washer, retaining nut, plunger, and water meter" >}}
...
{{< drg/next-page
    text="You can now identify the basic parts and fittings that appear in plumbing work."
    teaser="Next, compare the most common kinds of pipe and why plumbers choose each one."
