...
{{< drg/inherited-requirement number="6a1" req_path="6.a.1" topic="PVC pipe and fittings" />}}
...
{{< drg/inherited-requirement number="6a2" req_path="6.a.2" topic="CPVC pipe and fittings" />}}
...
{{< drg/inherited-requirement number="6a3" req_path="6.a.3" topic="PEX pipe and fittings" />}}
...
{{< drg/inherited-requirement number="6a4" req_path="6.a.4" topic="Copper pipe and fittings" />}}
...
{{< drg/inherited-requirement number="6a5" req_path="6.a.5" topic="Steel pipe and fittings" />}}
...
{{< drg/inherited-requirement number="6a6" req_path="6.a.6" topic="Specialty plumbing tools" />}}
...
{{< drg/checklist title="Store Visit Strategy" subtitle="How to make the most of your field trip" >}}
...
{{< drg/tip >}}
If the store has cutaway displays or sample boards, spend extra time there. Seeing a labeled display is often the fastest way to connect the name of a pipe to its real-world use.
{{< /drg/tip >}}

{{< drg/image src="images/hardware-store-plumbing-aisle.avif" alt="Scout and adult examining labeled shelves of PVC, CPVC, PEX, copper, steel fittings, and specialty plumbing tools in a hardware store aisle" >}}
...
{{< drg/next-page
    text="You can now recognize the major plumbing materials and tool categories in a store."
    teaser="Next, practice preparing and solvent welding plastic pipe connections the right way."
