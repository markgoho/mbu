...
{{< drg/video
    title="How Your Home Plumbing Works (From Start to Finish) (video)"
    url="https://youtu.be/8jxRn-T_LCs?si=pwjNJvf0MCXM5gdY" >}}

## Requirement 2a

{{< drg/inherited-requirement number="2a" req_path="2.a" topic="Make a drawing and explain how a home hot- and cold-water supply system works. Tell how you would make it safe from freezing." />}}
...
{{< drg/tip >}}
When drawing the supply system, use one color for cold water and another for hot water. That makes it much easier to explain the layout to your counselor.
{{< /drg/tip >}}

{{< drg/image src="images/house-water-supply-diagram.avif" alt="Simple labeled diagram showing water entry, shutoff, water meter, water heater, hot branches, cold branches, and fixture shutoffs" >}}

## Requirement 2b

{{< drg/inherited-requirement number="2b" req_path="2.b" topic="Make a drawing and explain the drainage system of the plumbing in a house. Show and explain the use of drains and vents." />}}
...
{{< drg/checklist title="What to Include in Your Drainage Drawing" subtitle="Show the path of wastewater clearly" >}}
...
{{< drg/be-prepared title="Why is a sink draining slowly and gurgling?" >}}

- **Possibility one**: The trap or branch drain is partly clogged.
- **Possibility two**: The vent is blocked, so air cannot move correctly in the system.
- **What to do**: Stop guessing, observe the symptoms, and talk through the possibilities with your supervising adult before taking anything apart.
  {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have traced both the supply side and the drainage side of home plumbing."
    teaser="Next, learn what five key plumber's tools do and how to use them correctly."
