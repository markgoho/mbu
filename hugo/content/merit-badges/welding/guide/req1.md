...
{{< drg/checklist title="Your first welding mindset" subtitle="Before you strike an arc, train yourself to scan for these risks" >}}
...
{{< drg/safety-first >}}
Electrical shock is one of the most serious welding hazards because it can injure you instantly and may also cause a fall, a burn, or contact with moving equipment. If a person is still in contact with live current, do not grab them with your bare hands. Shut off power first or use a nonconductive object if you have been trained to do so.
{{< /drg/safety-first >}}
...
{{< drg/video
    title="Keep Yourself Safe: 6 Welding Safety Hazards & How To Avoid Them (video)"
    url="https://youtu.be/-oq3mS7EBX8?si=ePEbVQwTrMP92s8X" >}}

{{< drg/tip >}}
If your counselor asks, "What hazard are you most likely to encounter?" a good answer is often not the most dramatic one. In a beginner shop, the most likely hazards are usually hot metal, eye exposure, poor posture, small burns, and careless setup errors.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="How to Treat Welding Burns (website)"
    url="https://weldingheadquarters.com/how-to-treat-welding-burns/?utm_source=chatgpt.com"
    description="A practical overview of mild welding-burn care and the warning signs that mean a burn needs professional treatment." >}}
...
- **Tell an adult or counselor**: Do not "push through it."
- **Recheck the setup**: Look at ventilation, coatings, gas, and body position before anyone resumes.
  {{< /drg/be-prepared >}}

{{< drg/did-you-know >}}
Arc flash often does not feel serious at the moment it happens. Several hours later, though, the injured person may feel intense pain, tearing, and the sensation that grit is trapped in both eyes. That delayed pain is one reason welders are so strict about helmets and screens.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You know the main welding hazards and the first-aid responses that go with them."
    teaser="Next, learn how safety data sheets, protective gear, and careful equipment storage make the welding area safer from the start."
