...
{{< drg/did-you-know >}}
One reason a weld can fail even when it "looks melted together" is that oxygen, nitrogen, or other contamination got into the molten puddle before it solidified. Good welding is not only about making metal hot enough — it is also about protecting that hot metal at the right moment.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/welding-puddle-protection.avif" alt="Diagram of a weld pool showing base metal, electrode, filler metal, shielding gas or flux, slag, and cooling bead" >}}
...
{{< drg/external-link
    title="Understanding Common Welding Terms—A Guide for Beginners (website)"
    url="https://www.millerwelds.com/resources/article-library/understanding-common-welding-terms-a-guide-for-beginners"
    description="A beginner-friendly glossary that helps reinforce the shop vocabulary you will need when discussing welding processes with your counselor." >}}

{{< drg/tip >}}
If you forget a textbook definition during your counselor discussion, explain the idea using the process you actually practiced. Real examples are easier to remember than word-for-word definitions.
{{< /drg/tip >}}

In [Req 2](/merit-badges/welding/guide/req2/), you learned how to prepare the shop and protect yourself. The next step is preparing the metal itself by learning how welding shops cut material to size before joining it.

{{< drg/next-page
    text="You now understand the core terms and the basic science behind a weld puddle."
    teaser="Next, compare mechanical and thermal cutting methods and learn why a clean, accurate cut matters before the first tack weld."
