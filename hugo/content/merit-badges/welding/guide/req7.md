...
{{< drg/checklist title="Questions to answer for your chosen career" subtitle="Use these when preparing for your counselor discussion" >}}
...
{{< drg/video
    title="Should You Become a Welder?—Everything You Need to Know About The Welding Profession (video)"
    url="https://youtu.be/tVOvC_e9spA?si=twqMhlBcM9FL64iJ" >}}
...
{{< drg/did-you-know >}}
Professional welding standards do more than help welders make nicer-looking beads. They help decide whether a weld is acceptable on structures and systems where failure could injure people or cause major damage.
{{< /drg/did-you-know >}}

{{< drg/video
    title="What Does the American Welding Society Do For Welders? (video)"
    url="https://youtu.be/tZaEMO4bPHg?si=deNNIvCoSNCICh4S" >}}

{{< drg/tip >}}
If your counselor asks why AWS matters, try answering in one sentence first: "AWS helps the welding profession stay safer, more consistent, and more trustworthy by supporting standards, training, and certification." Then add examples.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have explored where welding skills can lead and why AWS matters to the profession."
    teaser="Next, go beyond the badge with deeper ideas, real-world experiences, and organizations worth exploring."
