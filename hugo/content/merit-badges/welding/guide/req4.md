...
{{< drg/safety-first >}}
Thermal cutting combines flame, hot metal, sparks, fumes, and compressed gas systems in one operation. Before describing the process to your counselor, mention ventilation, cylinder safety, fire prevention, and hot-material handling. Those are part of using the process correctly.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/cutting-methods-compare.avif" alt="Mechanical cutting tools and thermal cutting torch and plasma examples shown side by side with labeled differences" >}}

{{< drg/external-link
    title="Types of Cutting Methods: Mechanical, Thermal & More (website)"
    url="https://engineerfix.com/types-of-cutting-methods-mechanical-thermal-more/"
    description="A broad overview that helps you compare common metal-cutting methods before choosing one process to describe in detail." >}}

{{< drg/be-prepared title="If your cut starts going wrong" >}}

- **Stop forcing the process**: A bad cut usually gets worse if you rush it.
- **Check the setup**: Recheck clamp position, consumables, torch settings, or blade condition.
- **Ask what caused it**: Speed, angle, tip condition, heat, and material thickness all matter.
- **Clean up before welding**: A rough edge may need grinding, dressing, or re-cutting before it is ready for a sound weld.
  {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You can now explain the difference between mechanical and thermal cutting and describe one process in a practical way."
    teaser="Next, compare welding processes, choose one, and plan the exact setup you will use for your hands-on work."
