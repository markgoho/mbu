...
Explain the meaning of 10 of the following terms: warp, harness, heddle, shed, aramid, spandex, sliver, yarn, spindle, distaff, loom, cellulose, sericulture, extrusion, carbon fibers, spinneret, staple, worsted, nonwoven, and greige goods.
{{< /drg/requirement >}}
...
{{< drg/video
    title="Loom and Weaving Terminology (video)"
    url="https://youtu.be/QNEB-fjMauc?si=zEm50ZTr7PgymZCE" >}}
...
{{< drg/checklist title="An Easy Way to Study the Terms" subtitle="Group the words instead of memorizing them randomly" >}}
...
{{< drg/tip >}}
Pick 10 terms and make one real-world example for each. For instance, "spandex—stretch leggings" or "greige goods—fabric before it is dyed or finished." Examples make the definition easier to explain out loud.
{{< /drg/tip >}}

{{< drg/image src="images/textile-terms-reference.avif" alt="Diagram of loom parts and manufactured-fiber spinneret process paired with key textile terms" >}}
...
{{< drg/next-page
    text="You now have a stronger textile vocabulary"
    teaser="Next, compare fiber categories and think about their ecological tradeoffs."
