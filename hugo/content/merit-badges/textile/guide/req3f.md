...
{{< drg/video
    title="A Simple DIY Way to Waterproof Anything (video)"
    url="https://youtu.be/y83uXupu5tY" >}}

{{< drg/video
    title="DIY Seam Seal (video)"
    url="https://youtu.be/UlHfbltn6hI" >}}
...
{{< drg/checklist title="Simple Waterproofing Test" subtitle="Show that your project changed the fabric's performance" >}}
...
{{< drg/safety-first >}}
Some sprays, sealers, or wax products give off fumes or require heat. Use them only with adult supervision, follow the label exactly, and work in a well-ventilated area away from flames.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Choose a fabric small enough to test safely and repeatedly. A scrap of canvas or nylon is easier to evaluate than trying to treat a whole large item on your first attempt.
{{< /drg/tip >}}

{{< drg/image src="images/waterproofing-water-bead-test.avif" alt="Comparison of treated fabric beading water and untreated fabric absorbing water droplets" >}}
...
{{< drg/next-page
    text="You have tested how finishing changes performance"
    teaser="Next, identify fibers by close observation and comparison."
