...
{{< drg/video
    title="Identification of Basic Textile Fibers by Polarized Light Microscopy (video)"
    url="https://youtu.be/BbeZvRi3eUI" >}}
...
{{< drg/checklist title="Fiber Clues" subtitle="Notice behavior, not just appearance" >}}
...
{{< drg/tip >}}
Label your samples before testing. Once a piece is cut into short lengths, it becomes much easier to mix them up.
{{< /drg/tip >}}

{{< drg/be-prepared title="How to Present Your Demonstration" >}}
Walk your counselor through it in this order:

- name the sample you are testing
- describe the method you are using
- point out what you observe
- compare it with another sample
- explain what those differences suggest about the fiber
{{< /drg/be-prepared >}}

{{< drg/image src="images/fiber-identification-comparison.avif" alt="Side-by-side comparison of microscope fiber views and a hand breaking test for textile samples" >}}
...
{{< drg/next-page
    text="You have practiced textile investigation"
    teaser="Next, learn the vocabulary that helps you describe fiber, yarn, weaving, and finishing more precisely."
