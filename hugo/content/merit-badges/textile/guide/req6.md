...
{{< drg/video
    title="Careers in the Fashion & Textiles Industry (video)"
    url="https://youtu.be/uumtJp43Kfg?si=lOoILqksN5TWYQjK" >}}

{{< drg/video
    title="Want to Work in the Textiles Industry? (video)"
    url="https://youtu.be/Z-WValUr6z8" >}}

{{< drg/video
    title="Textile Engineering Careers (video)"
    url="https://www.youtube.com/shorts/rClr3NSF-CM?feature=share" >}}

{{< drg/video
    title="Day in the Life of a Textile Engineer (video)"
    url="https://youtu.be/Ify9Fo2IhB4" >}}
...
{{< drg/checklist title="Career Report Framework" subtitle="Use this structure for each job you discuss" >}}
...
{{< drg/tip >}}
If you do a written report, compare the two careers directly. For example: one may require more science and math, while the other depends more on design sense, communication, or hands-on production experience.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have completed the Textile merit badge guide"
    teaser="Go beyond the requirements with deeper ideas, places to explore, and organizations in the textile world."
    url="/merit-badges/textile/guide/extended-learning/" >}}
