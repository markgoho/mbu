...
{{< drg/video
    title="Natural Dyes From Plants and Vegetables | DIY Eco-Friendly Dyes | Homeschool with Everyday Food (video)"
    url="https://youtu.be/jHpPuvibjZ8" >}}

Use this resource for ideas about easy dye sources and basic process setup.

{{< drg/video
    title="Short Tie Dye Demo - No Narration (video)"
    url="https://www.youtube.com/shorts/J6Ib3Ehy_pw?feature=share" >}}

{{< drg/video
    title="Short Tie Dye Demo - With Narration (video)"
    url="https://www.youtube.com/shorts/Oeth97r7VCw?feature=share" >}}

These short videos can help if you want a resist pattern rather than a single solid color.

## A Basic Dye Process

{{< drg/checklist title="Natural Dye Workflow" subtitle="Keep your process simple and consistent" >}}
...
{{< drg/safety-first >}}
Work with adult supervision if you use hot pots, stovetops, or heated dye baths. Use tools and containers meant for craft work, not food preparation, and protect clothing and surfaces from stains.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Cut a small test swatch from the same kind of fabric before dyeing the whole piece. A quick test can save you from ruining a larger project.
{{< /drg/tip >}}

{{< drg/image src="images/natural-dye-swatch-grid.avif" alt="Cotton swatches showing different shades produced by two natural dye baths" >}}

Dyeing changes color. The next option changes performance by helping fabric resist water.

{{< drg/next-page
    text="You have experimented with textile color"
    teaser="Next, explore how finishes can help fabric shed or resist water."
