...
{{< drg/video
    title="Woven vs. Knit vs. Non-Woven Fabrics | Textile Talk w/ A Thrifty Notion (video)"
    url="https://youtu.be/2Q_04oCLZVs" >}}
...
{{< drg/checklist title="What to Include in Your Sketches" subtitle="Make your observations easy to explain" >}}
...
{{< drg/tip >}}
If the structures are hard to see, shine light across the fabric from the side instead of straight down. Side lighting often makes the texture easier to notice.
{{< /drg/tip >}}

{{< drg/image src="images/woven-knit-nonwoven-closeup.avif" alt="Magnified comparison of woven grid, knitted loops, and nonwoven felted fibers" >}}
...
{{< drg/next-page
    text="You can now see how structure changes performance"
    teaser="Next, make felt by hand and experience how fibers bond without weaving or knitting."
