...
req_number: "3a"
req_path: "3.a"
prev: "/merit-badges/textile/guide/req3/"
prev_title: "Req 3 — Pick Your Two Projects"
next: "/merit-badges/textile/guide/req3b/"
next_title: "Req 3b — Weave on a Homemade Loom"
---
...
{{< drg/checklist title="Questions to Guide Your Visit" subtitle="Use these to build a stronger report" >}}
...
{{< drg/tip >}}
Take notes during the visit if permission is given. Small details are easy to forget later, especially machine names, fiber types, and the reasons workers gave for choosing one material over another.
{{< /drg/tip >}}

{{< drg/be-prepared title="If You Cannot Tour a Large Plant" >}}
Look for a smaller but still valid option:

- a local sewing or alteration business
- a screen-printing shop
- a college theater costume shop
- a weaving studio or fiber arts center
- an outdoor gear repair business

The key is seeing textiles being studied, made, modified, or evaluated in a real setting.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="A visit shows how professionals work"
    teaser="Next, build a simple loom and weave an item so you can feel how structure is created by hand."
