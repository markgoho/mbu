...
{{< drg/safety-first >}}
When you test, dye, cut, heat, or waterproof fabrics for this badge, work with adult supervision and follow product directions exactly. Some finishes, glues, or dye methods use heat, fumes, or chemicals that should only be handled in a well-ventilated workspace with proper protection.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="Start by noticing the fabrics already around you"
    teaser="Learn the difference between fiber, fabric, and textile, and why those words are not interchangeable."
    url="/merit-badges/textile/guide/req1/" >}}
