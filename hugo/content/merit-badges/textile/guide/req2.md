...
{{< drg/checklist title="A Balanced Swatch Set" subtitle="Choose samples that are easy to compare" >}}
...
{{< drg/tip >}}
Label each swatch as soon as you get it. Small scraps all start to look alike once they are off the bolt or cut from a garment.
{{< /drg/tip >}}

{{< drg/image src="images/textile-swatch-comparison.avif" alt="Labeled comparison of cotton, wool, polyester, nylon, and lyocell swatches showing different surface textures and drape" >}}
...
{{< drg/video
    title="Natural vs Synthetic Fibers (Which to Choose and Why) (video)"
    url="https://youtu.be/cRLPUAPCfuo" >}}
...
{{< drg/video
    title="From Cotton to Yarn (video)"
    url="https://youtu.be/vFaNiTlHeCY" >}}

{{< drg/video
    title="Weaving Process (video)"
    url="https://youtu.be/NIt9SGk55b4" >}}

{{< drg/video
    title="Knitting Process (video)"
    url="https://youtu.be/yRXuKFy89Mg" >}}

{{< drg/video
    title="Complete Process of Textile Manufacturing Fiber to Complete Garments (video)"
    url="https://youtu.be/5nUjGNDImIk" >}}

{{< drg/did-you-know >}}
In weaving, the warp yarns act like the fabric's skeleton. The fill or weft yarns travel across them to build the cloth row by row.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="How to Explain Your Choice" >}}
When you talk to your counselor, cover these points:

- **Item:** What are you buying?
- **Fiber or blend:** What do you want it made from?
- **Performance reason:** Do you need softness, warmth, stretch, durability, absorbency, or quick drying?
- **Care reason:** Does it need to wash easily or resist wrinkles?
- **Tradeoff:** What downside are you accepting, such as higher cost, wrinkling, or lower breathability?
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You can now compare fibers with confidence"
    teaser="Next, choose two textile activities that let you visit, weave, test, dye, felt, waterproof, or identify fabrics."
