...
{{< drg/video
    title="How to Have a Great Coffee Chat (video)"
    url="https://youtu.be/RaSoVVF18n8?si=wbVez7VytPC0E0es" >}}
...
{{< drg/checklist title="Questions That Fit This Requirement" subtitle="Use these to guide the conversation" >}}
...
{{< drg/tip >}}
Take notes during or right after each interview. You do not need a full transcript. Just capture names, training steps, useful quotes, and one or two examples of how education helped that person do the job well.
{{< /drg/tip >}}
...
That connects naturally to [Req 5a](/merit-badges/scholarship/guide/req5a/), where you write about how you will continue educating yourself in the future.

{{< drg/be-prepared title="If You Feel Nervous About Interviewing Adults" >}}
Use a simple routine.

- **Introduce yourself clearly** and say you are working on the Scholarship merit badge.
- **Explain how long the interview will take** so the person knows what to expect.
- **Bring your questions on paper** so you do not freeze up.
- **Thank them afterward** and write down your notes while the conversation is still fresh.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="Interviews can show how education keeps shaping careers over time."
    teaser="Next, look at how a planner turns school responsibilities into a system you can actually manage."
