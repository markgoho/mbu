...
{{< drg/video
    title="The Internet vs the Library (video)"
    url="https://youtu.be/RH3Z9BZryd8?si=hszmMA4edfUrH0gA" >}}

{{< drg/video
    title="How to Use AI in School Without Cheating (Video)"
    url="https://youtu.be/1iVcFKAFu2E?si=3ZZUS2aXuxu3s_A9" >}}
...
{{< drg/checklist title="Questions to Ask About Any Source" subtitle="These work whether the source is a book, website, or AI answer" >}}
...
{{< drg/tip >}}
The best research often uses more than one method. You might start online to understand the topic, use library databases for strong evidence, and then return to the internet for current updates.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If an Online Source Looks Sketchy" >}}
Pause before using it.

- **Check the author or organization.**
- **Look for a publication date.**
- **See whether other reliable sources say the same thing.**
- **Ask whether a library source or official site would be stronger.**
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You now have a framework for choosing research tools wisely."
    teaser="Next, look at the behavior, leadership, and service that schools often expect from strong students."
