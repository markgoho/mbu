---
title: "Keeping a B Average"
layout: "guide"
group_title: "1. Academic Momentum"
req_number: "1a"
req_path: "1.a"
prev: "/merit-badges/scholarship/guide/req1/"
prev_title: "Building Strong Grades"
next: "/merit-badges/scholarship/guide/req1b/"
next_title: "Showing Improvement"
---
...
{{< drg/checklist title="What to Bring to Your Counselor" subtitle="Keep your proof simple and organized" >}}
...
That connects directly to [Req 2c](/merit-badges/scholarship/guide/req2c/), where you look at planners and time management. Students who keep track of deadlines are much less likely to lose points on missing work.

{{< drg/video
    title="How to Do Better in School (video)"
    url="https://www.youtube.com/shorts/pZMXqaY-bYc" >}}
...
{{< drg/tip >}}
Do not try to make yourself sound impressive. Be specific instead. “I started reviewing my science notes for 10 minutes every night” is more believable and useful than “I just worked really hard.”
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If Your Grade Record Is Not Obvious" >}}
If your school does not hand out one simple average, prepare before meeting your counselor.

- **Print the clearest summary you can find** from your school portal.
- **Highlight the grading period** you are using.
- **Ask a teacher, counselor, or parent** to help you understand what the numbers mean.
- **Bring a short explanation** if your school uses quarters, trimesters, standards, or weighted grades.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="A strong average is one kind of academic success."
    teaser="Now look at the improvement path and see how progress from one grading period to the next can also show real scholarship."
