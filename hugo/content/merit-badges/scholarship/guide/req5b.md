...
{{< drg/video
    title="Informative Writing (video)"
    url="https://www.youtube.com/watch?v=o22BiMAMKPA" >}}
...
Good choices might come from curiosity you already have, from [Req 2b](/merit-badges/scholarship/guide/req2b/) interviews, or from jobs you have seen in your family or community.
...
{{< drg/checklist title="What a Strong Report Usually Includes" subtitle="Keep the writing balanced between both careers" >}}
...
That is why this badge keeps returning to the same ideas. The habits behind [Req 1a](/merit-badges/scholarship/guide/req1a/), [Req 2c](/merit-badges/scholarship/guide/req2c/), and [Req 2d](/merit-badges/scholarship/guide/req2d/) are the same habits that support future career paths.

{{< drg/tip >}}
If your two careers are very different, that is fine. In fact, it may help you notice which school skills matter in almost every path, such as communication, problem-solving, and responsibility.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Before You Finalize the Report" >}}
Check whether you can answer yes to these questions.

- **Did I name two careers that genuinely interest me?**
- **Did I connect each career to specific classes?**
- **Did I explain how good scholarship in general helps?**
- **Did I stay within 250 to 300 words?**
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have connected school subjects and scholarship habits to possible career goals."
    teaser="Continue into Extended Learning for deeper ways to grow as a student, researcher, and lifelong learner."
    url="/merit-badges/scholarship/guide/extended-learning/" >}}
