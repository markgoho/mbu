...
{{< drg/video
    title="How to Be a Great Team Player (video)"
    url="https://www.youtube.com/watch?v=GZnvHzivMkQ" >}}

{{< drg/video
    title="How to Be a Team Player To Succeed (video)"
    url="https://www.youtube.com/watch?v=zdAfzLry85I" >}}
...
{{< drg/checklist title="Build Your Story" subtitle="These details will make your discussion stronger" >}}
...
That idea connects with [Req 3](/merit-badges/scholarship/guide/req3/), where scholarship includes leadership and service. A good teammate often serves the group by doing useful work without needing all the attention.

{{< drg/tip >}}
If the project had problems, you can still talk about it. In fact, explaining how you helped a struggling team often shows more maturity than describing a project where everything went smoothly.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If the Team Had Conflict" >}}
Conflict is common in group work. What matters is how it was handled.

- **Explain the problem briefly** without blaming everyone else.
- **Describe your positive action,** such as clarifying jobs, listening, or helping the group refocus.
- **Say what you learned** about teamwork from that experience.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have reflected on how teamwork works in a real school project."
    teaser="Next, choose between writing about the value of your education or writing about careers that interest you."
