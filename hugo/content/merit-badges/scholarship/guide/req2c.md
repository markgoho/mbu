...
{{< drg/video
    title="How to Use Your Planner: Time-Management Tricks for Better Grades (video)"
    url="https://youtu.be/9z35XeolxMU?si=haH_-yZvpcaTXy05" >}}

{{< drg/video
    title="My Daily Planner (video)"
    url="https://www.youtube.com/shorts/ybb3h4re8kU" >}}
...
{{< drg/checklist title="What to Show Your Counselor" subtitle="Make your system visible" >}}
...
{{< drg/tip >}}
When a teacher assigns a long project, never write only the final due date. Add mini-deadlines such as “pick topic,” “find sources,” “draft outline,” and “final edit.” That is how a planner prevents last-minute panic.
{{< /drg/tip >}}
...
That kind of organization can also support [Req 1a](/merit-badges/scholarship/guide/req1a/) or [Req 1b](/merit-badges/scholarship/guide/req1b/). When you manage your time better, grades often improve because fewer things fall through the cracks.
...
{{< drg/be-prepared title="When Your Week Gets Overloaded" >}}
If your planner shows too many things stacked on the same day, do not just hope it works out.

- **Move up what can be started early.**
- **Break big tasks into smaller actions.**
- **Ask for help or clarification before the last minute.**
- **Protect time for sleep**, because exhausted studying usually leads to weaker work.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="A good planner helps you control your schedule instead of letting it control you."
    teaser="Next, compare libraries, books, the internet, and AI so you can choose the right research tool for the job."
