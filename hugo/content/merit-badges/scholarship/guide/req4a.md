...
req_number: "4a"
req_path: "4.a"
prev: "/merit-badges/scholarship/guide/req4/"
prev_title: "Teamwork Through Participation"
next: "/merit-badges/scholarship/guide/req4b/"
next_title: "Contribute to a Team Project"
---
...
{{< drg/video
    title="What Extracurriculars Should You Do? (video)"
    url="https://www.youtube.com/watch?v=_YrIAc3YL3E" >}}
...
That last point ties back to [Req 2c](/merit-badges/scholarship/guide/req2c/). Students in activities often need a planner even more because their schedules fill up fast.

{{< drg/checklist title="Questions to Help You Reflect" subtitle="Use these to prepare for your counselor discussion" >}}
...
{{< drg/tip >}}
When you discuss teamwork, use one real example. “I learned teamwork matters” is weak. “When two of us were absent, the rest of the crew had to reset the stage alone, and I realized how much each person’s work matters” is much stronger.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If Your Role Felt Small" >}}
Small roles still count if they were real.

- **Focus on reliability.** Did you show up, practice, prepare, or support the group?
- **Notice support work.** Teams depend on people who set up, organize, check details, and encourage others.
- **Explain what you learned.** You do not need to be the captain or lead performer to learn teamwork.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="Extracurriculars show how teamwork grows through shared goals and repeated practice."
    teaser="Next, look at the project-based path and how to describe your positive contribution to a team assignment."
