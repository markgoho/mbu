...
{{< drg/video
    title="Why Do We Have Museums (video)"
    url="https://www.youtube.com/watch?v=MHo928fd2wE" >}}
...
{{< drg/checklist title="What Makes a Good Visit?" subtitle="Choose a place where you can learn on purpose" >}}
...
{{< drg/tip >}}
Your report does not need to sound formal or fancy. It just needs to show that you made a real learning choice, paid attention, and can describe what you got from the visit.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If You Are Not Sure Where to Go" >}}
Start local and practical.

- **Check your public library website** for events, local history rooms, and teen programs.
- **Search your city or county parks department** for nature centers and interpretive trails.
- **Look at nearby museums or historic sites** for youth-friendly exhibits.
- **Ask an adult** what educational places they have visited nearby.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have seen how a place in your community can become part of your education."
    teaser="Next, learn how talking with working adults can reveal what education looks like in real careers."
