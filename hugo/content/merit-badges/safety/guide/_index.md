...
{{< drg/image src="images/safety-layers-of-protection.avif" alt="A Scout noticing several safety layers in everyday life, including a seat belt, bike helmet, smoke alarm, and crosswalk signal" >}}
...
{{< drg/did-you-know >}}
Smoke alarms can cut the risk of dying in a home fire roughly in half — but only if they are installed correctly and actually work. A dead battery turns a life-saving tool into decoration.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Safety is not the same as panic. Good safety habits should make you calmer, not more afraid. The goal is to notice hazards early, reduce risk, and be ready to act without freezing.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/public-safety-scan.avif" alt="A Scout entering a public building and quietly noticing exit signs, stairwells, and crowd flow before an event starts" >}}
...
{{< drg/next-page
    text="You have seen how broad safety really is."
    teaser="Start with the basics: what safety means, what hazards are, and how smart people manage risk." 
    url="/merit-badges/safety/guide/req1/" >}}