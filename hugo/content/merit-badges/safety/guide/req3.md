...
{{< drg/tip >}}
When explaining crimes that affect teens, connect each one to a real situation: school parking lot, gaming account, group chat, dating situation, public transit, or home alone after school.
{{< /drg/tip >}}
...
{{< drg/checklist title="What criminals like" subtitle="Weaknesses your inspection should look for" >}}
...
{{< drg/external-link
    ...
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Crime%20Prevention/Home%20Security%20Checklists%20%231%20%232.pdf"
    description="A room-by-room and outside-area checklist for spotting common home security weaknesses." >}}

{{< drg/be-prepared title="If you notice a serious security gap" >}}
Do not try to fix every problem by yourself.

- **Document what you found** on the checklist.
- **Tell the adult helping you** why it matters.
- **Recommend the simplest useful fix first** such as better lighting, a repaired lock, or moving valuables out of sight.
- **Review the result with your counselor** so they can see how you evaluated the risk.
  {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have looked at crime risks and home security with a sharper eye."
    teaser="Next, learn how to move safely in public places, respond to emergencies, and act early when something feels wrong."
