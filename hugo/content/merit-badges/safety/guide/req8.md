...
{{< drg/inherited-requirement number="8a" req_path="8.a" topic="As a pedestrian in a city" />}}
...
{{< drg/video
    ...
    url="https://youtu.be/QUXLT3gcFb8" >}}

## Requirement 8b

{{< drg/inherited-requirement number="8b" req_path="8.b" topic="In a friend's car or truck" />}}
...
{{< drg/external-link
    title="Passenger Responsibilities for Safety (website)"
    url="https://www.fmins.com/blog/how-to-be-a-better-passenger/"
    description="Explains how passengers help a driver stay focused and make safer choices on the road." >}}

## Requirement 8c

{{< drg/inherited-requirement number="8c" req_path="8.c" topic="In a rideshare vehicle" />}}
...
{{< drg/external-link
    title="Rideshare Safety Tips (website)"
    url="https://riskadvisory.ucsf.edu/tips-stay-safe-while-ridesharing"
    description="A practical checklist for verifying rideshare drivers, sharing trip details, and riding more safely." >}}

{{< drg/video
    title="Ride-Sharing Safety (video)"
    url="https://youtu.be/3ElQynt6rV4?si=ZqpLU9aEY7P2SzLY" >}}

## Requirement 8d

{{< drg/inherited-requirement number="8d" req_path="8.d" topic="On a bus" />}}
...
{{< drg/video
    title="Riding a Bus Safely (video)"
    url="https://youtu.be/fbsDdX7auRo?si=KB3o4EPoNUeZc2xQ" >}}

{{< drg/video
    title="How to Ride a Bus Safely (video)"
    url="https://youtu.be/YiI8bnDwkcE" >}}

## Requirement 8e

{{< drg/inherited-requirement number="8e" req_path="8.e" topic="On a subway or train" />}}
...
{{< drg/video
    title="How to Ride a Train Safely (video)"
    url="https://youtu.be/5w2X_16tuK4" >}}

## Requirement 8f

{{< drg/inherited-requirement number="8f" req_path="8.f" topic="On a commercial airplane" />}}
...
{{< drg/tip >}}
Count the rows to the nearest exit. In low visibility, that number helps you find the door even if you cannot see well.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Air Travel Do Not Do's (video)"
    url="https://youtu.be/vsfudxcksHI" >}}

{{< drg/checklist title="The travel safety pattern" subtitle="Questions that help in almost any travel setting" >}}
...
{{< drg/next-page
    text="You have covered the practical guidelines for moving safely in many different travel settings."
    teaser="Next, choose one path: explore a safety career or explore how safety skills fit service, hobbies, and volunteer work."
