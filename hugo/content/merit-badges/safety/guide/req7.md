...
{{< drg/inherited-requirement number="7a" req_path="7.a" topic="How to avoid being the victim of online crimes" />}}
...
{{< drg/external-link
    title="Protect Your Personal Information From Hackers and Scammers (website)"
    url="https://consumer.ftc.gov/protect-your-personal-information-hackers-scammers#keep"
    description="FTC guidance on passwords, personal information, device security, and scam prevention." >}}

{{< drg/video
    title="Passkeys Explained in Under 4 Minutes (video)"
    url="https://youtu.be/bdp8RdjV6PU?si=MPYq7d0la_3KVSuX" >}}

## Requirement 7b

{{< drg/inherited-requirement number="7b" req_path="7.b" topic="Common online financial scams" />}}
...
{{< drg/video
    title="Common Online Scams (video)"
    url="https://youtu.be/k8UVnkh8i0c" >}}

{{< drg/video
    title="10 Common Internet Scams (video)"
    url="https://youtu.be/CDhAOvsyw2s?si=42nASL5CjtBBKwru" >}}

## Requirement 7c

{{< drg/inherited-requirement number="7c" req_path="7.c" topic="Effective online security" />}}
...
{{< drg/checklist title="A strong online security baseline" subtitle="Simple habits that protect most people from common attacks" >}}
...
{{< drg/video
    title="Effective Online Security (video)"
    url="https://youtu.be/aO858HyFbKI" >}}

## Requirement 7d

{{< drg/inherited-requirement number="7d" req_path="7.d" topic="Identity theft and how to prevent it" />}}
...
{{< drg/video
    title="Preventing Identity Theft (video)"
    url="https://youtu.be/kDFeSUUwRnA?si=ncAfMQF1RIdIWetC" >}}

## Requirement 7e

{{< drg/inherited-requirement number="7e" req_path="7.e" topic="How criminals use social media to target victims" />}}
...
{{< drg/image src="images/social-media-oversharing-risks.avif" alt="A mock social media post with risky details like live location, school logo, and travel plans highlighted" >}}

## Official Resources

{{< drg/video
    title="How Criminals Use Social Media (video)"
    url="https://youtu.be/5bdBvNCBeho?si=bJdF2LM50LG_tm74" >}}

## Requirement 7f

{{< drg/inherited-requirement number="7f" req_path="7.f" topic="How bullying, texting, and sharing photos can become crimes" />}}
...
- **Block and report** through the platform when appropriate.
- **Tell a trusted adult** right away if threats, coercion, or explicit content are involved.
  {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have covered scams, accounts, privacy, and digital reputation."
    teaser="Next, look at travel safety on foot, in cars, on transit, and in the air."
