...
{{< drg/inherited-requirement number="4a" req_path="4.a" topic="How a person would safely exit from public buildings, a hotel, and a stadium in an emergency" />}}
...
{{< drg/safety-first >}}
In a fire or smoke emergency, elevators can fail, open on the wrong floor, or expose you to smoke. Use stairs unless trained responders give different instructions.
{{< /drg/safety-first >}}

## Official Resources

{{< drg/video
    title="How to Survive a Stampede (video)"
    url="https://youtu.be/KaDcgIx2PlY?si=1EIJSxfDfMlG0AfV" >}}

{{< drg/video
    title="How to Survive a Burning High Rise (video)"
    url="https://youtu.be/P8Naa4pzDdo?si=5Wr7bMJOmXW9p0XG" >}}

## Requirement 4b

{{< drg/inherited-requirement number="4b" req_path="4.b" topic="How and why Scouts would take shelter at camp" />}}
...
{{< drg/tip >}}
Ask on the first day of camp: "Where is the shelter for lightning, severe weather, and wildfire?" Knowing that answer early is part of being prepared, not being nervous.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Camp Emergency Planning (video)"
    url="https://www.youtube.com/shorts/no3dR86WRss" >}}

{{< drg/external-link
    title="Camp Evacuation Planning (website)"
    url="https://www.acacamps.org/resources/wildfire-evacuations"
    description="Shows how camps prepare for evacuation, accountability, and shelter decisions during emergencies." >}}

## Requirement 4c

{{< drg/inherited-requirement number="4c" req_path="4.c" topic="How should Scouts respond to an active shooter" />}}
...
{{< drg/safety-first >}}
This is one of the most serious topics in the badge. The goal is not to sound brave or dramatic. The goal is to survive by making the safest move available as early as possible.
{{< /drg/safety-first >}}

## Official Resources

{{< drg/video
    title="How to Respond to an Active Shooter (video)"
    url="https://youtu.be/sshDd_AgRAA?si=IRhkIwBLtRN6uqjF" >}}

## Requirement 4d

{{< drg/inherited-requirement number="4d" req_path="4.d" topic="The meaning of this saying: &quot;If You See Something, Say Something&#174;&quot;" />}}
...
{{< drg/be-prepared title="When a situation feels wrong in public" >}}

- **Notice specific details** like location, clothing, behavior, and direction of travel.
- **Move to a safer place** if needed.
- **Tell a responsible adult or security staff member quickly.**
- **Stay available to answer questions** without exaggerating what you saw.
  {{< /drg/be-prepared >}}

## Official Resources

{{< drg/video
    title="If You See Something, Say Something® (video)"
    url="https://youtu.be/Lgm5QWD1T3k?si=ABHK45yx-DqYETJh" >}}
...
{{< drg/next-page
    text="You have worked through exits, sheltering, suspicious activity, and high-stress decisions in public spaces."
    teaser="Next, learn how Scouting's safeguarding rules protect youth and what to do when behavior crosses a line."
