...
1. **Awareness** — You notice the hazard.
2. **Preparation** — You have the right gear, knowledge, or plan.
3. **Good choices** — You act in a way that lowers risk.
4. **Follow-through** — You keep paying attention instead of assuming the danger is gone.
...
{{< drg/tip >}}
When your counselor asks what safety means, do not stop at "following rules." Explain **why** the rules exist and how they lower the chance of harm.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Many serious injuries happen during familiar, everyday activities — not extreme adventures. People often get hurt when they stop paying attention because a task feels routine.
{{< /drg/did-you-know >}}

## Official Resources

{{< drg/video
    title="What is Safety? (video)"
    url="https://youtu.be/qNmd4z2VFAY?si=KG7EvkG4mt08gSxz" >}}

{{< drg/video
    title="What Does Safety Mean to You? (video)"
    url="https://youtu.be/GRqwuAMqjnY" >}}
...
{{< drg/checklist title="Hazard Control Ideas" subtitle="Ways people make a risky situation safer" >}}
...
{{< drg/video
    title="Hazard and Risk - What's the Difference? (video)"
    url="https://youtu.be/_GwVTdsnN1E?si=FyaKmgWPC4Hrod-P" >}}
...
{{< drg/be-prepared title="When you notice a hazard first" >}}
If you are the first person to notice a danger, do not assume someone else already handled it.

- **Pause the activity** if needed.
- **Warn the people nearby** in a calm voice.
- **Tell the right adult or leader** what you found.
- **Help fix or isolate the problem** if it is safe for you to do so.
  {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You can now explain safety, hazards, and risk."
    teaser="Apply those ideas at home by spotting common injuries, fire risks, and emergency planning gaps."
