...
{{< drg/inherited-requirement number="6a" req_path="6.a" topic="Assault on a street" />}}
...
{{< drg/video
    title="Muggers Reveal How They Target Their Victims (video)"
    url="https://youtu.be/aQdCVTon3HQ" >}}

## Requirement 6b

{{< drg/inherited-requirement number="6b" req_path="6.b" topic="Assault at a restaurant event" />}}
...
- **Leave with your group or arrange a safe ride.**
- **Do not worry about seeming rude.** Your safety matters more than politeness.
  {{< /drg/be-prepared >}}

## Requirement 6c

{{< drg/inherited-requirement number="6c" req_path="6.c" topic="Sexual assault at a party or on a date" />}}
...
{{< drg/safety-first >}}
If you or a friend are in danger, focus on getting to a safer place and contacting trusted adults or emergency services. If an assault happens, the person harmed is never to blame.
{{< /drg/safety-first >}}

{{< drg/tip >}}
A good line to remember is: "I am leaving now." You do not owe a long explanation when your safety is on the line.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have focused on reducing personal safety risks in real-world situations."
    teaser="Next, take those same awareness skills online to protect your privacy, accounts, money, and reputation."
