...
{{< drg/video
    title="Nekton, Benthos, and Plankton (video)"
    url="https://youtu.be/4cguoY4qTXA" >}}

{{< drg/checklist title="How to Tell the Groups Apart" subtitle="Ask where the organism spends most of its time" >}}
...
{{< drg/video
    title="Feeding the Sea: Phytoplankton Fuel Ocean Life (video)"
    url="https://youtu.be/AWfebk0_auY" >}}

{{< drg/video
    title="NASA | Earth Science Week: The Ocean's Green Machines (video)"
    url="https://youtu.be/H7sACT0Dx0Q" >}}

{{< drg/external-link
    title="Open Ocean Food Chain (website)"
    url="https://teara.govt.nz/en/video/5354/open-ocean-food-chain"
    description="A simple look at how ocean producers and consumers fit together in the open-sea food web." >}}

{{< drg/did-you-know >}}
A spoonful of seawater can contain thousands of phytoplankton cells, yet those tiny drifters help support giant animals like whales.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You now know how seawater properties shape marine life and food webs."
    teaser="Next, choose one investigation and start doing oceanography for yourself."
