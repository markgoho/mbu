...
{{< drg/video
    title="How to Make and Use a Secchi Disk (video)"
    url="https://youtu.be/lr66G09PuKg" >}}
...
- midwater = about 3 feet down
- bottom = just above the bottom sediment

{{< drg/safety-first >}}
Do not lean dangerously over docks or enter unsafe water to get measurements. If the site is slippery, deep, or fast-moving, pick a safer location or work with an adult who can help you collect the data safely.
{{< /drg/safety-first >}}
...
- wind stirring sediment
- algae growth
- boat traffic or wave action

## Graphing Your Results

Make graphs for air temperature, water temperature, and turbidity. You might use:

- one graph with separate lines for surface, midwater, bottom, and air temperature
- one separate graph for turbidity over time
...
{{< drg/checklist title="Questions to Ask Your Data" subtitle="Use these when you discuss your results" >}}
...
{{< drg/tip >}}
Write down unusual events in your notes. A heavy rain, strong wind, or cold front may explain a sudden change on your graph.
{{< /drg/tip >}}

{{< drg/image src="images/secchi-disk-water-study.avif" alt="A Scout lowering a black-and-white Secchi disk from a dock while recording water-study notes on a clipboard" >}}

The next option leaves data logging behind and moves to a model of shoreline change.

{{< drg/next-page
    text="You can now plan a five-day water study and explain what patterns to look for."
    teaser="Next, build a model showing how sediment moves along a coastline."
