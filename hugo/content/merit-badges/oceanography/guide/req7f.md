...
{{< drg/external-link
    title="Weather Satellite Images (website)"
    url="https://www.nhc.noaa.gov/satellite.php"
    description="NOAA satellite imagery that lets you monitor storms, cloud patterns, and ocean regions over time." >}}
...
{{< drg/checklist title="Questions to Ask the Images" subtitle="Use these prompts to turn watching into investigation" >}}
...
{{< drg/tip >}}
Screenshots are great evidence. Save a few images from the beginning, middle, and end of the three weeks so you can compare them side by side.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You can now plan a three-week satellite-image study and explain what patterns to watch for."
    teaser="Next, choose how you want to report and share your oceanography learning."
