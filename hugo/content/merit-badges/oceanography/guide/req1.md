...
{{< drg/checklist title="A Quick Way to Tell the Branches Apart" subtitle="Match the question to the branch" >}}
...
{{< drg/did-you-know >}}
More people have walked on the Moon than have visited the deepest part of the ocean in person.
{{< /drg/did-you-know >}}
...
{{< drg/video
    title="What is Oceanography (video)"
    url="https://youtu.be/NMM_GboBZyc?si=xq_9tR0kLLbCYoQo" >}}

{{< drg/tip >}}
If you freeze up while explaining the five reasons, start with people, weather, food, and life support. Those are easy, concrete examples, and you can build from there.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You can now name the four branches of oceanography and explain why the oceans matter."
    teaser="Next, learn how salinity, temperature, density, currents, and climate all connect."
