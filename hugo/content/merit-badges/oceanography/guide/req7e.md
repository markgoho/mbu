...
- gently tapping the water with a flat piece of plastic
- moving a small board up and down
- using repeated finger taps at one end

{{< drg/video
    title="DIY Ripple Tank (video)"
    url="https://youtu.be/9l-tIvvtCPA" >}}

{{< drg/video
    title="Wave Tank Demonstration (video)"
    url="https://youtu.be/3yNoy4H2Z-o?si=spekLgWh6z3YHC8W" >}}
...
{{< drg/video
    title="Reflecting Waves in a Ripple Tank (video)"
    url="https://youtu.be/iGuUKRmytLw" >}}
...
{{< drg/video
    title="Refraction of Waves in a Ripple Tank (video)"
    url="https://youtu.be/7wfEczDapHA" >}}
...
{{< drg/video
    title="Coastal Erosion and the Methods Used to Reduce It (video)"
    url="https://youtu.be/_eeKpz8oD7E" >}}

{{< drg/checklist title="What to Watch in the Tank" subtitle="Notice these pattern changes as you test structures" >}}
...
{{< drg/tip >}}
Record short video clips of each setup. It is much easier to explain reflection and refraction to your counselor if you can replay the wave pattern you created.
{{< /drg/tip >}}

The final Req 7 option steps away from tanks and models and uses satellite images to study change from above.

{{< drg/next-page
    text="You can now demonstrate reflection, refraction, and the impact of shoreline structures."
    teaser="Next, learn how to track one location over time using satellite images."
