...
{{< drg/video
    title="Oceanography Careers (video)"
    url="https://youtu.be/uFHREUrMLSY" >}}

{{< drg/video
    title="How to Work with the Ocean (video)"
    url="https://youtu.be/N4d6YRKEaxg" >}}
...
3. one memorable example for each point
4. closing idea that sticks with the audience
...
{{< drg/checklist title="Speech Prep Checklist" subtitle="Before you stand up to speak" >}}
...
{{< drg/tip >}}
Practice once by yourself, once in front of a family member or friend, and once with your notes trimmed down. That usually makes the final version much smoother.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You can now plan a focused five-minute speech on oceanography."
    teaser="Next, learn four major methods marine scientists use to investigate the ocean."
