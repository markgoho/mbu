...
{{< drg/tip >}}
A good memory trick is: **cold + salty = more dense**. That is not the whole story in every case, but it is a strong rule of thumb.
{{< /drg/tip >}}
...
{{< drg/video
    title="Temperature and Salinity (video)"
    url="https://youtu.be/jKWc5oy0NCQ?si=2B4crDCxvuYbGQce" >}}

{{< drg/image src="images/ctd-ocean-profile.avif" alt="Diagram of a CTD instrument being lowered from a research ship with conductivity, temperature, and depth sensors labeled" >}}
...
{{< drg/video
    title="An Ocean in Motion (video)"
    url="https://youtu.be/R5-s6O8qyvE" >}}

{{< drg/checklist title="What Drives Ocean Circulation?" subtitle="Four forces to remember" >}}
- **Wind** pushes surface water.
- **Earth's rotation** bends moving water through the Coriolis effect.
- **Density differences** make some water sink and other water rise.
- **Continents and seafloor shape** steer currents into patterns instead of straight lines.
{{< /drg/checklist >}}
...
{{< drg/video
    title="Oceans and Climate (video)"
    url="https://youtu.be/zO2153cJORI" >}}

{{< drg/video
    title="How Do Ocean Currents Affect the Weather Pattern? (video)"
    url="https://youtu.be/T9LTtqcKDw0?si=qNZusyjB_bPjS0UQ" >}}

{{< drg/did-you-know >}}
The top few meters of the ocean can store more heat than the entire atmosphere above it. That is one reason ocean temperature changes matter so much.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You now know how seawater properties drive circulation and influence weather."
    teaser="Next, study waves, dangerous surf conditions, and rip currents."
