...
{{< drg/video
    title="Coral Reefs: Types and Formation (video)"
    url="https://youtu.be/mPA9Ze16lGw?si=pVw56hFgRlnPJtro" >}}

{{< drg/video
    title="How Coral Reefs are Formed (video)"
    url="https://youtu.be/anDSRfSY7LQ" >}}
...
{{< drg/checklist title="What to Label on the Models" subtitle="Make the science easy to see" >}}
- volcanic island
- coral reef
- lagoon
...
{{< drg/tip >}}
Do not make all three models look almost the same. Exaggerate the changes a little so the progression from fringing reef to atoll is obvious at a glance.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You can now model reef development from volcanic island to atoll."
    teaser="Next, collect repeated measurements of water and air conditions over five days."
