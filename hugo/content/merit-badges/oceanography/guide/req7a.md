...
{{< drg/video
    title="How to Make a Soda Bottle Plankton Net (video)"
    url="https://youtu.be/e-MYhWcWWXw" >}}

{{< drg/video
    title="Make Your Own Plankton Net! (video)"
    url="https://youtu.be/HBcuGbMc8cU?si=c6sGRZYkRXv9QDtE" >}}
...
{{< drg/safety-first >}}
Collect samples only where you have safe footing, calm conditions, and the permission you need. If you are near a dock, boat ramp, or deeper water, wear a properly fitted life jacket and work with an adult.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Sketch what you see before you look up names. The act of drawing helps you notice details that are easy to miss when you only glance through a lens.
{{< /drg/tip >}}
...
{{< drg/image src="images/plankton-sample-microscope.avif" alt="Microscope-slide view of several different plankton forms circled for comparison" >}}
...
{{< drg/next-page
    text="You know how to collect a plankton sample and identify the main types you found."
    teaser="Next, model how fringing reefs can become barrier reefs and atolls."
