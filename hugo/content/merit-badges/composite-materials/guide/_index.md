  ...
  - group_title: "Beyond the Badge"
    items:
      - title: "Extended Learning"
        url: "/merit-badges/composite-materials/guide/extended-learning/"
---
...
{{< drg/did-you-know >}}
The carbon fibers used in aerospace composites are thinner than a human hair — about 5 to 10 micrometers in diameter — yet a bundle of them can be stronger than steel at a fraction of the weight.
{{< /drg/did-you-know >}}

{{< drg/image src="images/composite-history-timeline.avif" alt="Timeline showing key milestones in composite materials history from ancient mud bricks to modern carbon fiber aircraft" >}}
...
{{< drg/safety-first >}}
Working with fiber-reinforced polymers means handling resins that produce fumes and fibers that irritate skin, eyes, and lungs. Never work with these materials without proper ventilation, gloves, safety glasses, and a respirator. You will learn the full safety protocol in [Req 1a](/merit-badges/composite-materials/guide/req1a/).
{{< /drg/safety-first >}}

{{< drg/image src="images/frp-examples-collage.avif" alt="Three fiber-reinforced polymer products shown side by side: a fiberglass kayak hull, a carbon fiber bicycle frame, and a Kevlar ballistic helmet" >}}
...
{{< drg/tip >}}
When your counselor asks about types of composites, do not just memorize the names. Think of a real-world example for each type — it shows you understand how the categories connect to things you have actually seen or used.
{{< /drg/tip >}}

{{< drg/image src="images/natural-composite-cross-section.avif" alt="Cross-section diagram of a piece of bone showing the collagen fibers and mineral crystals that make it a natural composite material" >}}
...
{{< drg/next-page
    text="Before you touch any resin or cut any fiber"
    teaser="learn the safety hazards of composite materials and the gear that protects you."
    url="/merit-badges/composite-materials/guide/req1a/" >}}
