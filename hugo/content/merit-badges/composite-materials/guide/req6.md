...
{{< drg/video
    title="Materials Engineer — Careers in Science and Engineering"
    url="https://youtu.be/DtosXFgP7C4" >}}

{{< drg/video
    title="My Job in F1: Rachel, Materials Science Engineer"
    url="https://youtu.be/j_xotv7npsQ" >}}
...
{{< drg/external-link
    title="Bureau of Labor Statistics — Materials Engineers"
    url="https://www.bls.gov/ooh/architecture-and-engineering/materials-engineers.htm"
    description="Official job outlook data including salary, education requirements, and projected growth for materials engineers." >}}
...
{{< drg/video
    title="Surfboard Shaping and Glassing"
    url="https://youtu.be/rYYuDt8Z2cY" >}}

{{< drg/video
    title="Resin Infused Skateboard Using Carbon Fibre, Flax and Bio Resin"
    url="https://youtu.be/s2aS1G6yp-4" >}}
...
{{< drg/tip >}}
If your composites hobby leads you to build something for your troop or community — a repair on a canoe, a custom equipment rack, a lightweight trail marker — you might have the seed of an Eagle Scout project.
{{< /drg/tip >}}

{{< drg/image src="images/composites-hobby-montage.avif" alt="Four hobby applications of composites: custom surfboards, RC aircraft building, boat building, and cosplay prop making" >}}

{{< drg/external-link
    title="SAMPE — Society for the Advancement of Material and Process Engineering"
    url="https://www.sampe.org/"
    description="Professional society for materials engineers — offers student memberships, competitions, and educational resources." >}}

{{< drg/video
    title="Materials Science — A Building Block for the Future of Aerospace Technologies"
    url="https://youtu.be/c0EXAuWkMqA" >}}
...
{{< drg/next-page
    text="All six requirements are complete"
    teaser="go deeper with advanced composites topics, real-world experiences, and organizations to explore."
