...
req_number: "2b"
prev: "/merit-badges/composite-materials/guide/req2a/"
prev_title: "Req 2a — What Are Composites?"
next: "/merit-badges/composite-materials/guide/req3a/"
next_title: "Req 3a — Reinforcement Materials"
---
...
{{< drg/tip >}}
When your counselor asks you to compare these materials, do not just list properties from a table. Pick a specific application — say, a bicycle frame — and explain *why* one material works better than the others for that job. That shows real understanding.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The Statue of Liberty's skin is made of copper (which is why it turned green), its skeleton is steel, and its pedestal is concrete (a composite of cement, sand, and gravel). One monument, three material classes — each chosen for the property it does best.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/materials-comparison-infographic.avif" alt="Side-by-side comparison of five material samples: a carbon fiber composite panel, a wooden plank, an aluminum sheet, a copper pipe, and a steel beam, each labeled with top properties" >}}

{{< drg/video
    title="Properties of Materials"
    url="https://youtu.be/XbX4xY1sqQo" >}}

{{< drg/external-link
    title="MatWeb — Material Property Data"
    url="https://www.matweb.com/"
    description="Searchable database of material properties for metals, polymers, ceramics, and composites — useful for comparing specific materials." >}}
...
{{< drg/next-page
    text="You can compare composites to wood, aluminum, copper, and steel"
    teaser="now learn about the three main types of reinforcement fibers and what makes each one special."
