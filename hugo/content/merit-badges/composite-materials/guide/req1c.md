...
req_number: "1c"
prev: "/merit-badges/composite-materials/guide/req1b/"
prev_title: "Handling, Storage & Disposal"
next: "/merit-badges/composite-materials/guide/req2a/"
next_title: "What Are Composites?"
---
...
You just learned general rules for handling and disposing of composite materials in [Req 1b](/merit-badges/composite-materials/guide/req1b/). But every resin, hardener, solvent, and fiber product has its own specific hazards, exposure limits, and emergency procedures. A Safety Data Sheet is where all of that information lives.
...
{{< drg/tip >}}
When you get a new resin or hardener, read **Section 8** first. It tells you exactly what PPE the manufacturer recommends — and it might be different from what you expected. Some hardeners require specific glove materials that others do not.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Before 2012, Safety Data Sheets were called Material Safety Data Sheets (MSDS) and had no standard format — each manufacturer organized them differently. The switch to the GHS format made them consistent worldwide, so a firefighter in Texas can read an SDS from a German chemical company just as easily as a local one.
{{< /drg/did-you-know >}}
...
For [Req 3a](/merit-badges/composite-materials/guide/req3a/) and [Req 3b](/merit-badges/composite-materials/guide/req3b/), you will need to obtain and read the actual SDSs for the reinforcement materials and resins you choose. Start practicing now — find the SDS for a common product like acetone or a household epoxy and read through Sections 2, 4, 7, and 8.

{{< drg/image src="images/sds-document-sections.avif" alt="A Safety Data Sheet document with the 16 section headers visible, with sections 2, 4, 7, 8, and 13 highlighted as most important for composites work" >}}

{{< drg/video
    title="Safety Data Sheets Training"
    url="https://youtu.be/_yWF-w3CwmU" >}}

{{< drg/external-link
    title="OSHA — Hazard Communication Safety Data Sheets"
    url="https://www.osha.gov/sites/default/files/publications/OSHA3514.pdf"
    description="OSHA's official quick reference guide explaining each of the 16 SDS sections and what information they contain." >}}
...
{{< drg/next-page
    text="Safety is covered"
    teaser="now explore what composite materials actually are and how they evolved from mud bricks to carbon fiber."
