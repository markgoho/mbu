...
Always wear the PPE you learned about in [Req 1a](/merit-badges/composite-materials/guide/req1a/) before opening any container. Beyond personal protection, follow these handling rules:
...
{{< drg/tip >}}
Pour solvent onto your cleaning rag rather than dipping the rag into the can. This reduces evaporation, keeps the solvent cleaner, and cuts down on fumes in your work area.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
MEKP catalyst (methyl ethyl ketone peroxide) is an organic peroxide and one of the most dangerous chemicals in a composites shop. A spill of concentrated MEKP can ignite on contact with certain materials. It must always be stored separately from resins, away from heat, and handled with extreme care. Never add resin to catalyst — always add catalyst to resin.
{{< /drg/safety-first >}}

{{< drg/image src="images/composite-materials-storage.avif" alt="A well-organized workshop storage area showing labeled shelves for composite materials: resin containers on one shelf, hardener on a separate shelf, rolled fiberglass fabric stored horizontally, and a red flammable liquids cabinet for solvents" >}}
...
{{< drg/did-you-know >}}
Improperly disposed composite chemicals can contaminate groundwater for decades. A single gallon of uncured polyester resin poured on the ground can affect thousands of gallons of drinking water. Environmental responsibility is not just a rule — it is a real-world consequence.
{{< /drg/did-you-know >}}
...
{{< drg/video
    title="How to Dispose of Epoxy Resin Leftovers and Used Materials"
    url="https://youtu.be/tVwFisroxrg" >}}

{{< drg/external-link
    title="Allan Chemical — Ultimate Guide to Resin Handling Safety"
    url="https://allanchem.com/ultimate-guide-to-resin-handling-safety/"
    description="Comprehensive guide covering safe handling practices for epoxy, polyester, and vinyl ester resins." >}}
...
{{< drg/next-page
    text="Handling and disposal rules keep you safe day-to-day"
    teaser="but every chemical product has its own specific hazards — learn how to find them on a Safety Data Sheet."
