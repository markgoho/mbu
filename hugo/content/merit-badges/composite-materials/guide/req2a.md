...
{{< drg/did-you-know >}}
The word "composite" comes from the Latin *compositus*, meaning "put together." Engineers adopted the term in the mid-20th century, but humans have been putting materials together to make better ones for over 5,000 years.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/composite-evolution-examples.avif" alt="Four examples showing the evolution of composites: an ancient mud brick with visible straw fibers, a WWII-era fiberglass boat hull, a carbon fiber F1 car monocoque, and a modern wind turbine blade being transported on a flatbed truck" >}}

{{< drg/video
    title="Intro to Composites"
    url="https://youtu.be/WYqCnEvTRUQ" >}}

{{< drg/video
    title="What is a Composite?"
    url="https://youtu.be/8tEf_X9Rzts" >}}

{{< drg/external-link
    title="CompositesWorld — History of Composites"
    url="https://www.compositesworld.com/articles/the-evolution-of-composite-materials"
    description="An in-depth timeline of how composite materials developed from early experiments to modern industrial applications." >}}
...
{{< drg/next-page
    text="You can now define composites and trace their history"
    teaser="see how they stack up against wood, aluminum, copper, and steel in a direct comparison."
