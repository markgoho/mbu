---
title: "Safety Hazards & Protective Gear"
layout: guide
group_title: "1. Safety & Responsibility"
req_number: "1a"
prev: "/merit-badges/composite-materials/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/composite-materials/guide/req1b/"
next_title: "Handling, Storage & Disposal"
---
...
{{< drg/safety-first >}}
Sensitization to epoxy is **irreversible**. Once your body develops an allergic response, you will react to even trace amounts for the rest of your life. This is why barrier protection — gloves, long sleeves, and avoiding any skin contact — is non-negotiable from the very first time you handle resin.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Carbon fiber dust is electrically conductive. In a workshop with exposed electronics, airborne carbon particles can cause short circuits in computers, outlets, and electrical panels — a hazard most people never think about.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Personal Protective Equipment (PPE) Checklist" subtitle="Have all of these ready before you start any composite work" >}}
...
- **Do** wipe off the excess with a dry paper towel immediately.
- **Then** wash the area thoroughly with soap and warm water.
- **If** redness, itching, or swelling develops, stop work and inform your counselor. Seek medical attention if symptoms persist or spread.
- **Document** the exposure — your counselor needs to know, and an SDS (covered in [Req 1c](/merit-badges/composite-materials/guide/req1c/)) will tell medical providers exactly what chemicals were involved.
{{< /drg/be-prepared >}}

{{< drg/image src="images/ppe-composite-worker.avif" alt="Personal protective equipment for composites work laid out on a workbench: safety glasses, respirator with cartridges, nitrile gloves, and long-sleeve work shirt" >}}

{{< drg/video
    title="Fibreglass Safety 101"
    url="https://youtu.be/tXmTLRSMZSM" >}}

{{< drg/external-link
    title="OSHA — Composite Materials Safety Guidelines"
    url="https://www.osha.gov/composite-materials"
    description="Federal safety standards and best practices for working with composite materials in various settings." >}}
...
{{< drg/next-page
    text="You have the right gear on"
    teaser="now learn the rules for safely handling, storing, and disposing of resins and reinforcement materials."
