...
{{< drg/tip >}}
Be your own toughest critic. When evaluating your project, point out the flaws before your counselor does. Saying "I see a bubble here — I think it happened because I did not roll thoroughly enough in this corner" shows more understanding than a perfect-looking part from a kit.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
In aerospace manufacturing, composite parts are inspected using ultrasonic testing — sound waves are sent through the material, and any internal void or delamination shows up as a change in the echo pattern. A technician can map every hidden defect without cutting the part open.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/composite-part-evaluation.avif" alt="A teenager and an adult examining a finished fiberglass composite part together at a workbench" >}}

{{< drg/video
    title="A Simple Composite Material to Make at Home"
    url="https://youtu.be/vxKlbik4QjM" >}}
...
{{< drg/next-page
    text="Your projects are complete and evaluated"
    teaser="explore careers and hobbies where composite materials could shape your future."
