...
{{< drg/safety-first >}}
Epoxy hardeners (amines) are the primary sensitization risk. Even brief, unprotected skin contact can trigger sensitization in some people. Always wear nitrile gloves and long sleeves. If you feel tingling, itching, or see redness on skin that contacted epoxy, stop work immediately, wash thoroughly, and tell your counselor.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
A single injection-molding machine can produce a nylon composite car part in under 60 seconds — then the scrap plastic from trimming and rejected parts gets ground up and fed back into the machine. Try doing that with a thermoset.
{{< /drg/did-you-know >}}

{{< drg/image src="images/resin-types-comparison.avif" alt="Three resin types shown in their working state: a two-part epoxy system being mixed in a cup, liquid polyester resin being catalyzed with MEKP drops, and nylon pellets next to a molded nylon gear" >}}
...
{{< drg/video
    title="Introduction to Matrix Materials"
    url="https://youtu.be/yQo4ucV3jfA" >}}

{{< drg/external-link
    title="Entropy Resins — Resin Safety and Handling"
    url="https://entropyresins.com/safety/"
    description="Practical safety guidance from a resin manufacturer, with links to SDS documents for common epoxy systems." >}}
...
{{< drg/next-page
    text="You know three resins inside and out"
    teaser="now use that knowledge to dream up new applications that nobody has tried yet."
