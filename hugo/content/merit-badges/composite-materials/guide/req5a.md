...
req_number: "5a"
prev: "/merit-badges/composite-materials/guide/req4/"
prev_title: "Req 4 — Explore the Industry"
next: "/merit-badges/composite-materials/guide/req5b/"
next_title: "Req 5b — Finding a Workspace"
---
...
{{< drg/safety-first >}}
Before starting any project, review the safety protocols from [Req 1a](/merit-badges/composite-materials/guide/req1a/) and [Req 1b](/merit-badges/composite-materials/guide/req1b/). Wear your full PPE — gloves, safety glasses, respirator — even for small projects. Have your SDS sheets accessible. Make sure your counselor or approved adult supervisor is present.
{{< /drg/safety-first >}}
...
- **Available workspace:** Some projects need more room, ventilation, and mess tolerance than others (see [Req 5b](/merit-badges/composite-materials/guide/req5b/))
...
{{< drg/tip >}}
Take photos at every stage — unmixed materials, the lay-up process, the curing stage, and the finished part. These show your counselor the full process and give you something to be proud of. A time-lapse video of a lay-up is especially impressive.
{{< /drg/tip >}}
...
{{< drg/image src="images/hand-layup-process.avif" alt="Step-by-step hand lay-up process showing placing fiberglass fabric on a mold, wetting out with resin, and rolling out air bubbles" >}}

{{< drg/video
    title="STEM Flix — Fun with Composite Materials with Science Bob"
    url="https://youtu.be/Ry7_Yuo-FYM" >}}

{{< drg/video
    title="How to Hand Lay Up a Carbon Fibre Skateboard"
    url="https://youtu.be/scvXKij1hQ0" >}}

{{< drg/external-link
    title="Fibre Glast — Tutorials and How-To Guides"
    url="https://www.fibreglast.com/product/Learning-Center"
    description="Step-by-step composites fabrication tutorials, from beginner lay-ups to advanced vacuum infusion techniques." >}}

You know what you want to build. Now you need to figure out where to build it.

{{< drg/next-page
    text="Your projects are planned"
    teaser="find a safe, well-ventilated workspace where you and your counselor can fabricate your composites."
