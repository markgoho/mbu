...
{{< drg/safety-first >}}
Never work with resins in a closed, unventilated space — not a basement without windows, not an enclosed garage with the door shut, not a bedroom. Even with a respirator, you are still exposing your skin and eyes to fumes, and concentrations can build to dangerous levels quickly.
{{< /drg/safety-first >}}
...
- Access to **soap and water** for skin decontamination (not solvent — remember [Req 1a](/merit-badges/composite-materials/guide/req1a/))
...
{{< drg/tip >}}
If your counselor works in a professional composites shop, that is the best option. You will have proper ventilation, tools, and an expert watching your technique. Ask your counselor first — many are happy to host Scouts in their workspace.
{{< /drg/tip >}}
...
{{< drg/checklist title="Workspace Setup" subtitle="Prepare all of this before opening any resin" >}}
...
{{< drg/image src="images/composites-workspace-setup.avif" alt="A well-organized composites workspace in a garage with the door open, showing a covered work table, ventilation fan, PPE, and fire extinguisher" >}}
...
{{< drg/next-page
    text="Your workspace is set up and your projects are curing"
    teaser="learn how to evaluate the quality of your finished composite parts."
