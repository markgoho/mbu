...
req_number: "3c"
prev: "/merit-badges/composite-materials/guide/req3b/"
prev_title: "Req 3b — Resins"
next: "/merit-badges/composite-materials/guide/req4/"
next_title: "Req 4 — Explore the Industry"
---
...
{{< drg/tip >}}
Your counselor is not expecting a patentable invention. They want to see that you understand the resin's properties well enough to connect them to a real-world need. A thoughtful, practical idea backed by reasoning is worth more than an ambitious but vague concept.
{{< /drg/tip >}}
...
1. **Name the resin** and its key properties
2. **Describe the problem** you are trying to solve
3. **Explain your proposed application** — what would the product be?
4. **Connect the properties** — why is this resin a good fit?
5. **Acknowledge the trade-offs** — what limitations might need to be overcome?

{{< drg/be-prepared title="Your Counselor Asks 'Why Not Use Something Else?'" >}}
A good counselor will push back on your ideas to test your understanding. Be ready for questions like:

- **"Why not just use metal?"** — Explain the specific advantage your resin provides (weight, corrosion resistance, cost, recyclability).
- **"Isn't that too expensive?"** — If you chose epoxy, acknowledge the cost and explain why the performance justifies it for this application.
- **"Has anyone tried this?"** — If you are not sure, say so honestly. The point is the reasoning, not the originality.
- **"What could go wrong?"** — Discuss the resin's weaknesses and how they might affect the application.
{{< /drg/be-prepared >}}

{{< drg/image src="images/innovation-brainstorm.avif" alt="A teenager at a desk with sketches and notes spread out, brainstorming new composite material applications" >}}

{{< drg/video
    title="How Do Composites Work?"
    url="https://youtu.be/gYTjC8GIwcU" >}}

{{< drg/external-link
    title="CompositesWorld — Innovation in Composites"
    url="https://www.compositesworld.com/trend/innovation"
    description="Latest developments in composite materials, applications, and manufacturing — a great source for seeing what kinds of new ideas are already being explored." >}}
...
{{< drg/next-page
    text="You have designed your own composite applications"
    teaser="now explore the composites industry by visiting a manufacturer or researching online."
