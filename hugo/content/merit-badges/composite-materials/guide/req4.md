...
{{< drg/tip >}}
Call ahead and explain that you are working on your Composite Materials merit badge. Many companies are happy to host a brief tour for a Scout — especially smaller shops where the owner can show you around personally. Your counselor may already know a good contact.
{{< /drg/tip >}}
...
- **What PPE do workers wear?** Does it match what you learned in [Req 1a](/merit-badges/composite-materials/guide/req1a/)?
...
{{< drg/checklist title="Visit Preparation" subtitle="Get these ready before your visit" >}}
...
{{< drg/image src="images/composites-facility-tour.avif" alt="A teenager in safety glasses observing a technician performing a hand lay-up in a composites manufacturing shop" >}}
...
{{< drg/external-link
    title="American Composites Manufacturers Association (ACMA)"
    url="https://www.acmanet.org/"
    description="The main trade association for the North American composites industry — includes industry news, educational resources, and career information." >}}

{{< drg/external-link
    title="CompositesWorld"
    url="https://www.compositesworld.com/"
    description="Leading industry publication covering composites technology, applications, and manufacturing trends." >}}

{{< drg/external-link
    title="NASA — Composite Materials"
    url="https://www.nasa.gov/feature/glenn/2024/new-composite-materials/"
    description="NASA's composites research, including advanced materials for spacecraft and aircraft." >}}

{{< drg/be-prepared title="Discussing What You Learned" >}}
Whether you visited a facility or explored websites, your counselor will want a real conversation — not a rehearsed report. Be ready to:

- **Describe one thing that surprised you.** Maybe the scale of a manufacturing operation, or a composite application you never expected.
- **Connect your findings to earlier requirements.** "I noticed they use epoxy instead of polyester because..." or "Their PPE setup matched what we discussed in Req 1a, but they also used..."
- **Ask your own follow-up questions.** A Scout who comes back with new questions shows genuine curiosity.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have seen how the professionals work"
    teaser="now it is your turn — plan and build two composite materials projects."
