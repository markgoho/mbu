...
{{< drg/safety-first >}}
On a real job site, only one person acts as the designated signal person at a time. The operator follows signals only from that designated person. This prevents conflicting commands and keeps everyone safe.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Signal persons on major construction sites go through formal certification training. A single misread signal could result in a load dropping on workers below—which is why the standardized system exists and is legally required.
{{< /drg/did-you-know >}}

{{< drg/video
    title="Crane Operator Hand Signal Training Video | Crane U — Crane U"
    url="https://www.youtube.com/watch?v=me2fjrX9hf8" >}}

{{< drg/next-page
    text="From construction sites to aircraft carrier flight decks—next are the signals that launch and recover aircraft from the most dangerous workplace in the world."
    teaser="Req 8c — Aircraft Carrier Deck Signals"
