...
{{< drg/did-you-know >}}
The first transatlantic telegraph cable was completed in 1866. Suddenly a message that took two weeks by ship could cross the Atlantic in minutes using Morse code—one of the most dramatic communication revolutions in history.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
This requirement is a discussion, so practice talking out loud. Ask a parent, guardian, or fellow Scout to listen while you explain the history—you'll spot any gaps in your knowledge quickly.
{{< /drg/tip >}}

{{< drg/next-page
    text="Now that you understand why communication systems exist, let's look at the most critical use case: signaling for help when your life depends on it."
    teaser="Req 2 — Distress Signals That Get You Found"
