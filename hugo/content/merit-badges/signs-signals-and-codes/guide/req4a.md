...
{{< drg/video
    title="How To Do The Semaphore Alphabet (Old Scout Field Guide) — Christian Strevy"
    url="https://www.youtube.com/watch?v=LFWQ6usrSCM" >}}

{{< drg/tip >}}
Your explanation to the counselor should cover all four points: what semaphore is, why it's used, how to use it (the mechanics of sending), and where it's found in real-world use. Practice saying this aloud so you don't miss any part.
{{< /drg/tip >}}

{{< drg/next-page
    text="Semaphore flags and nautical flags are both used on ships, but they serve completely different purposes. Next you'll learn to tell them apart."
    teaser="Req 4b — Semaphore Flags vs. Nautical Flags"
