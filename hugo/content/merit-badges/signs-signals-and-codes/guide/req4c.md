...
{{< drg/inherited-requirement number="4c1" req_path="4.c.1" topic="Spell your first name using semaphore. Send or receive a message of six to 10 words using semaphore." />}}
...
{{< drg/tip >}}
Work on the letters of your name in isolation first. Once each individual position feels solid, practice the full name as a sequence. Aim for smooth, deliberate movement—speed comes with practice.
{{< /drg/tip >}}
...
{{< drg/checklist title="Semaphore Practice Checklist" >}}
...
{{< drg/did-you-know >}}
Nautical flags are used by both commercial shipping and naval vessels across the world. The International Code of Signals is published in dozens of languages, so a ship from any country can decode a flag hoist from any other—no translator needed.
{{< /drg/did-you-know >}}

{{< drg/next-page
    text="From flags to fingers—next you'll explore braille, the tactile writing system that gives millions of people independent access to written language."
    teaser="Req 5 — Reading and Writing Braille"
