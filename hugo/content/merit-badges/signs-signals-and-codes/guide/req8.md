...
### [Req 8a — Sports Officiating Signals](/merit-badges/signs-signals-and-codes/guide/req8a/)
...
### [Req 8b — Heavy-Equipment Hand Signals](/merit-badges/signs-signals-and-codes/guide/req8b/)
...
### [Req 8c — Aircraft Carrier Deck Signals](/merit-badges/signs-signals-and-codes/guide/req8c/)
...
### [Req 8d — Cyclist Hand Signals](/merit-badges/signs-signals-and-codes/guide/req8d/)
...
### [Req 8e — Your Custom Signal Set](/merit-badges/signs-signals-and-codes/guide/req8e/)
...
- **Played team sports?** → 8a is a natural fit
- **Interested in construction, machinery, or safety?** → 8b is worth learning
- **Fascinated by military aviation?** → 8c is genuinely impressive
- **Cyclist or road safety interest?** → 8d is practical and immediately useful
- **Have a sport, hobby, or career field with its own signals?** → 8e gives you flexibility
...
{{< drg/next-page
    text="Start with the first option and work through the ones you've chosen. Each page gives you the signals, their meanings, and tips for demonstrating them well."
    teaser="Req 8a — Sports Officiating Signals"
