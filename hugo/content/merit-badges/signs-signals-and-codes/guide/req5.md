...
{{< drg/did-you-know >}}
Charles Barbier called his system "night writing" (*écriture nocturne*). He intended it for soldiers to pass messages on the battlefield without striking a match or making a sound. Louis Braille heard a demonstration of it at age 12 and spent years refining it into the system that bears his name.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/braille-cell-reading-technique.avif" alt="Instructional diagram showing the six numbered dot positions of a braille cell and fingertips moving lightly across a line of braille" >}}
...
- **Independence**: the ability to read privately, at your own pace, without assistance
- **Literacy**: access to the same written information sighted people take for granted
- **Employment**: workplaces use braille labels, technical manuals, and accessibility tools
- **Navigation**: elevator buttons, public signage, ATMs, and medicine labels all use braille
...
{{< drg/inherited-requirement number="5a" req_path="5.a" topic="Either by sight or by touch, identify the letters of the braille alphabet that spell your name. By sight or touch, decode a braille message at least six words long." />}}
...
{{< drg/tip >}}
You can find printable braille alphabet charts online, or download a free braille translation app to generate braille text for any message. Many libraries and Lighthouse for the Blind organizations provide braille materials on request.
{{< /drg/tip >}}
...
{{< drg/checklist title="Req 5a Readiness" >}}
...
{{< drg/tip >}}
Remember braille is written right-to-left when using a slate and stylus, so the finished side (the raised bumps) reads left-to-right when the paper is flipped. If you're hand-drawing dots, draw them left-to-right in the "reading orientation" (imagining yourself as the reader, not the writer).
{{< /drg/tip >}}

{{< drg/checklist title="Req 5b Readiness" >}}
...
{{< drg/next-page
    text="Braille communicates through touch. Now let's look at two very different ways of reaching groups of people: sound signals and silent Scout hand signals."
    teaser="Req 6 — Sound Signals and Silent Scout Signals"
