...
{{< drg/did-you-know >}}
Morse code was the backbone of global communication for nearly a century. When the *Titanic* sank in 1912, the distress call sent in Morse code (CQD, then SOS) was picked up by ships hundreds of miles away.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
The best way to learn Morse code is by *sound*, not by memorizing a chart. Practice sending and receiving by ear—the rhythm of the dots and dashes becomes muscle memory faster that way.
{{< /drg/tip >}}
...
1. Spell your first name in Morse code on paper. Practice saying it aloud (dit-dah for · —, dah-dit for — ·, etc.).
2. Write out a six-to-ten-word message in Morse code.
3. Practice sending it by tapping on a table or flashing a light. Each letter should be clearly separated; each word should have a longer pause between it and the next.
4. Have a friend or family member try to receive your message.

{{< drg/checklist title="Morse Code Readiness" >}}
...
{{< drg/video
    title="LEARN MORSE CODE from a MEMORY CHAMP (in 15 minutes) — Nelson Dellis"
    url="https://www.youtube.com/watch?v=D8tPkb98Fkk" >}}
...
{{< drg/did-you-know >}}
ASL is more closely related to French Sign Language than to British Sign Language. Laurent Clerc, a Deaf educator from France, helped found the first permanent school for the Deaf in America in 1817, bringing French Sign Language with him.
{{< /drg/did-you-know >}}
...
1. **Find your letters** — look up each letter of your name in a fingerspelling chart and practice each hand shape until it feels natural.
2. **Spell smoothly** — work toward smooth transitions between letters rather than pausing at each one.
3. **Add a simple message** — learn six to ten common ASL signs (simple signs like HELLO, MY, NAME, I, LIKE, SCOUT, THANK YOU are great starting points).
4. **Use your face** — ASL grammar uses facial expressions for yes/no questions, negation, and emphasis. Even for fingerspelling, a natural expression helps.
5. **Watch native signers** — short videos of native ASL signers online show natural rhythm and fluency better than static charts.

{{< drg/video
    title="ASL: Basic Signs 1 - Everyday Vocabulary in ASL — Miacademy & MiaPrep Learning Channel"
    url="https://www.youtube.com/watch?v=fnFWAzd3Kfw" >}}

{{< drg/checklist title="ASL Readiness" >}}
...
{{< drg/next-page
    text="You've practiced two landmark communication systems. Now let's move into flag signaling—a method that has kept ships, airfields, and expeditions connected for centuries."
    teaser="Req 4a — How Semaphore Works"
