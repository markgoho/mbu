...
{{< drg/tip >}}
Practice making each signal while keeping your other hand steady on an imaginary handlebar. Real cyclists can't look down at their arm; the signal needs to be instinctive.
{{< /drg/tip >}}

{{< drg/did-you-know >}}
The downward-pointing left arm for "stop" came from motor vehicle signaling law before cars had electric brake lights. Drivers used the same signal to indicate stopping. Today, cyclists still use it as the traditional stop signal.
{{< /drg/did-you-know >}}

{{< drg/video
    title="How To Use Hand Signals Whilst Cycling | Essential Group Ride Communication For Bike Riders — Global Cycling Network"
    url="https://www.youtube.com/watch?v=prYMM7D2qF8" >}}

{{< drg/next-page
    text="If you're picking a custom activity for your third option, the next page walks you through how to choose and prepare your own signal set."
    teaser="Req 8e — Your Custom Signal Set"
