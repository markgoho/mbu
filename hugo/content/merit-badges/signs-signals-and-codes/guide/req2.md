...
{{< drg/be-prepared title="Carry two or three signaling tools every time you go outdoors" >}}
A mirror, a whistle, and a bright orange or red cloth weigh almost nothing but can save your life. Pack them on every hike, even short ones.
{{< /drg/be-prepared >}}
...
{{< drg/image src="images/ground-to-air-signals-reference.avif" alt="Instructional diagram showing seven large ground-to-air rescue symbols at realistic scale: V, X, arrow, F, LL, N, and Y" >}}
...
2. Extend your other arm and create a "V" with two fingers aimed at the aircraft.
3. Tilt the mirror until the reflected sun lands in the "V."
4. Flash slowly three times—the universal distress signal.

{{< drg/image src="images/signal-mirror-aiming-technique.avif" alt="Close instructional view of a hiker aiming a signal mirror with the mirror near one eye and two fingers forming a V toward an aircraft" >}}
...
{{< drg/tip >}}
Green leaves, grass, or rubber material creates dark smoke. Dry grass or cloth creates light smoke. Choose based on the sky color and terrain behind you.
{{< /drg/tip >}}
...
At night, use your flashlight to signal SOS in Morse code: **· · · — — — · · ·** (three short flashes, three long, three short). Flash slowly enough that the pattern is clear. You'll learn more about SOS in [Requirement 3](/merit-badges/signs-signals-and-codes/guide/req3/).
...
{{< drg/checklist title="Before Your Counselor Meeting" >}}
...
{{< drg/next-page
    text="Emergency signaling is about getting found. Now let's look at two landmark communication systems you'll learn to use yourself: Morse code and ASL."
    teaser="Req 3 — Morse Code and ASL in Action"
