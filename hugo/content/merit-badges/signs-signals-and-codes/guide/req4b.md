...
{{< drg/image src="images/semaphore-vs-nautical-flags.avif" alt="Split comparison showing a person signaling with semaphore flags on one side and nautical flags hoisted on a ship mast on the other" >}}

{{< drg/tip >}}
When your counselor asks for the difference, focus on the core: semaphore is a motion-based spelling system where the flag is just a visual aid, while nautical flags are a standing-message system where each flag design carries its own meaning.
{{< /drg/tip >}}

{{< drg/video
    title="Nautical & Sailing Flags Meanings, International Code of Signals — Flagsbook"
    url="https://www.youtube.com/watch?v=gGOtPA8sNJA" >}}

{{< drg/next-page
    text="Now that you understand both systems, it's time to put them to use—spelling your name in semaphore and identifying real nautical flags."
    teaser="Req 4c — Practice With Flags"
