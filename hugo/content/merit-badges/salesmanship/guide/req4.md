...
{{< drg/tip >}}
Practice out loud at least twice before presenting. You will hear awkward wording much faster than you will see it on paper.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If you get nervous while presenting" >}}

- **Slow down** instead of trying to talk faster.
- **Use your outline** to find your place again.
- **Ask a question** to re-engage the listener.
- **Keep going honestly** instead of pretending nothing happened.
  {{< /drg/be-prepared >}}

{{< drg/image src="images/scout-sales-presentation.avif" alt="A Scout giving a simple sales presentation with a sample product, note card, and labeled callouts showing eye contact, open posture, and visible product placement" >}}

## Official Resources

{{< drg/video
    title="How to Give Effective Sales Presentations (video)"
    url="https://youtu.be/8eo01Wlkd4o" >}}

{{< drg/external-link
    title="FTC — Truthful Advertising Basics"
    url="https://www.ftc.gov/business-guidance/advertising-marketing"
    description="Guidance on truthful claims and responsible marketing. A good reminder that strong selling still has to be honest selling." >}}
...
{{< drg/next-page
    text="You have practiced how to make the pitch."
    teaser="Now choose a real sales project and keep a record of what happens."
