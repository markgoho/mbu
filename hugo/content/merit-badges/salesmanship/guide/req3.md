...
{{< drg/checklist title="Sales plan outline" subtitle="Use these sections in your written plan" >}}
...
{{< drg/tip >}}
Do not make your plan sound bigger than it is. A simple, realistic plan for one neighborhood or one event is much stronger than a huge plan you cannot actually carry out.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If your counselor assigns a product you know little about" >}}

- **Ask clarifying questions early** about the customer and territory.
- **Do quick research** before writing anything.
- **Focus on value to the customer** instead of listing random features.
- **Keep the plan simple and specific** rather than pretending to know more than you do.
  {{< /drg/be-prepared >}}

{{< drg/download
    title="Sales Plan Worksheet"
    url="/merit-badges/salesmanship/guide/sales-plan-worksheet/"
    type="printable" >}}

## Official Resources

{{< drg/video
    title="How to Write Your Marketing Plan (video)"
    url="https://youtu.be/pFG_Q7e14AA" >}}

{{< drg/external-link
    title="SCORE — What Is a Marketing Plan?"
    url="https://www.score.org/resource/blog-post/what-marketing-plan"
    description="A beginner-friendly overview of the parts of a marketing plan and why planning matters before you try to sell." >}}
...
{{< drg/next-page
    ...
    teaser="Now practice turning that plan into a clear, confident sales presentation."
