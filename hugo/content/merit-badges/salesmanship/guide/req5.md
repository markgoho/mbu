...
- **[Req 5a — Support a Scout Fundraiser](/merit-badges/salesmanship/guide/req5a/)**: Help your unit sell merchandise or event tickets. You will practice short customer conversations, teamwork, and cause-based selling.
- **[Req 5b — Sell a Neighborhood Service](/merit-badges/salesmanship/guide/req5b/)**: Offer a service like mowing, pet watching, or car washing. You will practice setting expectations, doing the work, and following up afterward.
- **[Req 5c — Try Retail Selling](/merit-badges/salesmanship/guide/req5c/)**: Earn money through retail selling. You will see how product display, customer questions, and transaction flow work in a retail setting.

## How to Choose

{{< drg/checklist title="Choosing the best option for you" subtitle="Think about time, setting, and what you want to learn" >}}
...
{{< drg/tip >}}
If you want the clearest example of follow-up and customer satisfaction, Req 5b usually gives you the strongest practice. If you want a team setting and a built-in purpose, Req 5a may fit better.
{{< /drg/tip >}}
...
{{< drg/download
    ...
    url="/merit-badges/salesmanship/guide/sales-project-cost-sheet/"
    type="printable" >}}
...
{{< drg/next-page
    text="Pick your path and start with the first option page."
    teaser="Req 5a shows how to support a Scout fundraiser through real sales."
