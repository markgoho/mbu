...
{{< drg/checklist title="Quick market research questions" subtitle="Ask these before trying to sell" >}}
...
{{< drg/video
    title="Market Research The Secret Ingredient for Business Success (video)"
    url="https://youtu.be/CqaFYgRGDmo" >}}
...
{{< drg/inherited-requirement number="2b" req_path="2.b" topic="Learn all about the product to be sold." />}}
...
{{< drg/tip >}}
Try explaining the product in one sentence to a friend who knows nothing about it. If you cannot do that clearly, you probably need to learn it better.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="3 Keys for Successful Selling Know Your Product (video)"
    url="https://youtu.be/FDVR9MoQb44" >}}

## Requirement 2c

{{< drg/inherited-requirement number="2c" req_path="2.c" topic="If possible, visit the location where the product is built and learn how it is constructed. If a service is being sold, learn about the benefits of the service to the customer." />}}
...
{{< drg/image src="images/sales-process-steps.avif" alt="Two-column diagram comparing a product sales path and a service sales path, with labeled stages from creation through customer result" >}}

## Requirement 2d

{{< drg/inherited-requirement number="2d" req_path="2.d" topic="Follow up with customers after their purchase to confirm their satisfaction and discuss their concerns about the product." />}}
...
{{< drg/be-prepared title="If a customer is unhappy" >}}

- **Listen fully first** without interrupting.
- **Repeat the concern back clearly** so the customer knows you understand.
- **Be honest about what you can fix** and what you need help with.
- **Offer the next step quickly** instead of disappearing.
  {{< /drg/be-prepared >}}

## Official Resources

{{< drg/video
    title="Why Is Following Up Important (video)"
    url="https://youtu.be/DMfH_03nR0o" >}}
...
{{< drg/next-page
    text="You now know why strong sales starts with preparation."
    teaser="Next, build a real sales plan for a product and territory assigned by your counselor."
