...
req_number: "5a"
req_path: "5.a"
prev: "/merit-badges/salesmanship/guide/req5/"
prev_title: "Req 5 — Choose Your Sales Project"
next: "/merit-badges/salesmanship/guide/req5b/"
next_title: "Req 5b — Sell a Neighborhood Service"
---
...
{{< drg/checklist title="Fundraiser selling checklist" subtitle="Be ready with these facts before your first conversation" >}}
...
{{< drg/tip >}}
Smile, stand up straight, and keep your message short. People are more likely to listen when you sound prepared and respectful.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If customers say no" >}}

- **Stay polite** and thank them.
- **Do not argue** or guilt them.
- **Keep your energy up** for the next conversation.
- **Notice patterns** in objections so you can improve your message.
  {{< /drg/be-prepared >}}

If you want more independence and a stronger follow-up component, compare this option with [Req 5b](/merit-badges/salesmanship/guide/req5b/), where you sell a service directly to neighbors.

{{< drg/next-page
    text="That is one way to complete the requirement."
    teaser="Req 5b shows how selling a service changes the job before and after the sale."
