...
{{< drg/checklist title="Include these in your written statement" subtitle="Short and specific is better than long and vague" >}}
...
{{< drg/video
    title="Easy Guide to Writing a High School Student Resume (video)"
    url="https://youtu.be/-z4v-Dw7n50" >}}
...
{{< drg/tip >}}
When you talk with your counselor, do not aim for the "perfect" answer. Aim for an honest next step. Maybe that means taking a business class, practicing public speaking, or getting experience helping customers.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="How to become a Highly Paid Salesperson (video)"
    url="https://youtu.be/frRl9nrntpM" >}}

{{< drg/video
    title="Is Sales the Perfect Career for YOU? Career Deep Dive (video)"
    url="https://youtu.be/2iQ6clokEPo" >}}

{{< drg/external-link
    title="BLS Occupational Outlook Handbook — Wholesale and Manufacturing Sales Representatives"
    url="https://www.bls.gov/ooh/sales/wholesale-and-manufacturing-sales-representatives.htm"
    description="A reliable overview of one major sales career path, including duties, work environment, pay, and training." >}}

{{< drg/external-link
    title="CareerOneStop — Sales Manager"
    url="https://www.careeronestop.org/Toolkit/Careers/Occupations/occupation-profile.aspx?keyword=Sales%20Managers&onetcode=11-2022.00"
    description="Career exploration details on sales-related jobs, skills, and education paths." >}}
...
{{< drg/next-page
    text="You have finished the required path through the badge."
    teaser="Keep going with deeper ideas, real-world experiences, and organizations connected to sales and business."
    url="/merit-badges/salesmanship/guide/extended-learning/" >}}
