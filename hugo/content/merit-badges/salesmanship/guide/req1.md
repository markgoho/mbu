...
{{< drg/checklist title="What customers want from a salesperson" subtitle="These habits build trust fast" >}}
...
{{< drg/did-you-know >}}
Many products on store shelves got there only because a salesperson convinced a manager to give them space. If nobody explains why a product is worth carrying, customers may never even get the chance to see it.
{{< /drg/did-you-know >}}

## Official Resources

{{< drg/video
    title="Sales Representative Duties and Responsibilities (video)"
    url="https://youtu.be/bpuVvUZnWxE" >}}
...
{{< drg/tip >}}
If you ever wonder whether something is B2B or consumer sales, ask one question: "Who is the buyer using this for?" If the answer is "for a business or organization," it is likely B2B.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Understanding B2C vs B2B for Beginners (video)"
    url="https://youtu.be/XEVR9zIbMiw" >}}
...
{{< drg/next-page
    text="Now that you understand the role, the next step is learning how a salesperson gets ready."
    teaser="See why research, product knowledge, and follow-up can make or break a sale."
