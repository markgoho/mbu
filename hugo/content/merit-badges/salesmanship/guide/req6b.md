...
req_number: "6b"
req_path: "6.b"
prev: "/merit-badges/salesmanship/guide/req6a/"
prev_title: "Req 6a — Interview a Sales Professional"
next: "/merit-badges/salesmanship/guide/req7/"
next_title: "Req 7 — Explore Sales Careers"
---
...
{{< drg/inherited-requirement number="6b1" req_path="6.b.1" topic="How often is the owner approached by a sales representative?" />}}
...
{{< drg/inherited-requirement number="6b2" req_path="6.b.2" topic="What good traits should a sales representative have? What habits should the sales representative avoid?" />}}
...
{{< drg/tip >}}
This question can give you one of the clearest real-world definitions of professionalism in sales. Pay close attention to the examples the owner gives.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Top 5 Traits of Great Sales People (video)"
    url="https://youtu.be/OjCnfTSrq1s" >}}

## Requirement 6b3

{{< drg/inherited-requirement number="6b3" req_path="6.b.3" topic="What does the owner consider when deciding whether to establish an account with a sales representative?" />}}
...
{{< drg/inherited-requirement number="6b4" req_path="6.b.4" topic="Include at least two of your own questions." />}}
...
{{< drg/checklist title="What this interview can teach you" subtitle="Watch for these themes in the owner's answers" >}}
...
This option can improve your own sales quickly because you hear directly what buyers appreciate and what they avoid. Many of those answers will connect back to [Req 2](/merit-badges/salesmanship/guide/req2/), especially research, product knowledge, and follow-up.

After learning from professionals, the last requirement asks you to look at sales as a possible career path.

{{< drg/next-page
    text="You have now seen how buyers judge sales representatives."
    teaser="Next, investigate sales careers and think about what preparation they require."
