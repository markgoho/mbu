---
title: "Sell a Neighborhood Service"
layout: "guide"
group_title: "5. Earning Through Real Sales"
req_number: "5b"
req_path: "5.b"
prev: "/merit-badges/salesmanship/guide/req5a/"
prev_title: "Support a Scout Fundraiser"
next: "/merit-badges/salesmanship/guide/req5c/"
next_title: "Try Retail Selling"
---
...
{{< drg/checklist title="Before you offer a service" subtitle="Know the details before knocking on a door or sending a message" >}}
...
{{< drg/tip >}}
If a customer gives you feedback, write it down soon afterward. That makes it much easier to share the experience accurately with your counselor.
{{< /drg/tip >}}

{{< drg/be-prepared title="If weather or another problem changes the job" >}}

- **Tell the customer early** instead of waiting until the last minute.
- **Offer a new time** or a clear adjustment.
- **Do not promise what you cannot deliver.**
- **Confirm the new plan** so both sides understand it.
  {{< /drg/be-prepared >}}
...
{{< drg/safety-first >}}
Use tools and cleaning supplies the right way. Do not mow on steep unsafe ground, handle chemicals carelessly, or take on animal care tasks you do not understand well enough to do safely.
{{< /drg/safety-first >}}
...
This option often gives the best practice for follow-up, which connects directly back to [Req 2](/merit-badges/salesmanship/guide/req2/).

{{< drg/next-page
    text="Service selling is one path."
    teaser="Req 5c shows the different rhythm of earning money through retail selling."
