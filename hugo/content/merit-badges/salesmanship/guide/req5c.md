...
1. notices when a customer may need help
2. asks a short useful question
3. gives a recommendation without pressure
...
{{< drg/checklist title="Retail selling habits" subtitle="Simple things that help customers feel comfortable" >}}
...
{{< drg/tip >}}
In retail, helpfulness matters more than talking a lot. Often the best move is one good question followed by one clear recommendation.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have now seen all three Req 5 options."
    teaser="Next, choose an interview path and learn directly from people who work in sales."
