...
{{< drg/inherited-requirement number="6a1" req_path="6.a.1" topic="What made the person choose sales as a profession?" />}}
...
{{< drg/inherited-requirement number="6a2" req_path="6.a.2" topic="What are the most important things to remember when talking to customers?" />}}

### What this question reveals

This is where you will often hear the best practical advice. Experienced salespeople may mention listening, honesty, patience, preparation, empathy, or confidence. Compare what they say to what you learned in [Req 1](/merit-badges/salesmanship/guide/req1/) and [Req 4](/merit-badges/salesmanship/guide/req4/).
...
{{< drg/inherited-requirement number="6a3" req_path="6.a.3" topic="How is the product sold?" />}}
...
{{< drg/inherited-requirement number="6a4" req_path="6.a.4" topic="Include your own questions." />}}
...
{{< drg/checklist title="Interview habits that help" subtitle="These make you sound prepared and respectful" >}}
...
{{< drg/tip >}}
At the end, ask, "What is one thing people misunderstand about sales?" That question often leads to your most memorable answer.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="That is the salesperson's side of the conversation."
    teaser="Req 6b shows how store owners decide which sales representatives they trust and buy from."
