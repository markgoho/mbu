...
{{< drg/checklist title="Food Chain Quality Check" subtitle="Use this before you present your chains" >}}
...
{{< drg/video
    title="Animal of the Week: Food Chains (video)"
    url="https://www.youtube.com/watch?v=FpVXlk_Z-4E" >}}

{{< drg/video
    title="Food Chains & Food Webs (video)"
    url="https://www.youtube.com/watch?v=JCl_yDf0Qok" >}}

{{< drg/external-link
    title="Tundra Food Chain (website)"
    url="https://www.sciencefacts.net/tundra-food-chain.html"
    description="An example of how producers, prey, and predators connect in one ecosystem, which can help you model your own food chains clearly." >}}

{{< drg/did-you-know >}}
Many carnivorous mammals are not at the very top of every food web. A young fox, for example, can be both predator and prey depending on where it is in the chain.
{{< /drg/did-you-know >}}

{{< drg/tip >}}
Draw your food chain with arrows showing energy flow from food to eater. If you can sketch it clearly, you can usually explain it clearly too.
{{< /drg/tip >}}

The next requirement asks you to move from studying mammals to doing something that can actually influence their numbers.

{{< drg/next-page
    text="You can now trace how energy reaches a carnivorous mammal"
    teaser="Next, plan and carry out a project that affects one or more mammal populations."
