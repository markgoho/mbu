...
req_number: "3b"
req_path: "3.b"
prev: "/merit-badges/mammal-study/guide/req3a/"
prev_title: "Req 3a — Two Habitats, Six Hours"
next: "/merit-badges/mammal-study/guide/req3c/"
next_title: "Req 3c — Nongame Mammal Life History"
---
...
{{< drg/checklist title="Observation Routine" subtitle="Follow the same system each time" >}}
...
In [Req 3a](/merit-badges/mammal-study/guide/req3a/), you compared habitats. Here, you are comparing time.
...
{{< drg/be-prepared title="When You See Very Little" >}}
A quiet outing still counts if you stay observant and record honestly.

- **Look lower**: Many clues are on the ground, not at eye level.
- **Slow down**: Mammal study rewards careful scanning more than distance covered.
- **Check transitions**: Edges between woods and field often hold more sign.
- **Return anyway**: One empty day can be followed by a very active one.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
Bring a simple map or sketch of your study area and mark where signs were found. Even rough location marks can help you notice repeated movement routes.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You know how to build a long-term field log"
    teaser="Next, learn how to write a clear life history of one nongame mammal in your area."
