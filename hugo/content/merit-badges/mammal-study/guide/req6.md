...
{{< drg/checklist title="Outdoor Ethics in Mammal Study" subtitle="Real examples you can discuss with your counselor" >}}
...
{{< drg/external-link
    ...
    description="A video overview of Leave No Trace principles that can help you connect outdoor ethics to your own field behavior." >}}

{{< drg/video
    title="Leave No Trace Outdoor Ethics (video)"
    url="https://youtu.be/jXO1uY0MvmQ" >}}

{{< drg/safety-first >}}
Respecting wildlife includes respecting your own limits. Never approach large mammals, mothers with young, or animals that show stress or defensive behavior. Ethical distance is also safe distance.
{{< /drg/safety-first >}}

{{< drg/tip >}}
Before you meet with your counselor, think of two or three specific moments from your own field work. Concrete examples are much stronger than general statements like “I followed Leave No Trace.”
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You can now connect outdoor ethics to real mammal-study behavior"
    teaser="Next, choose whether to explore careers or hobbies related to Mammal Study."
