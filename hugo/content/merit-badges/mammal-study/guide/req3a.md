...
{{< drg/checklist title="What to Record in Both Habitats" subtitle="Bring the same level of detail to each outing" >}}
...
{{< drg/image src="images/mammal-sign-comparison.avif" alt="Side-by-side comparison of deer tracks, raccoon tracks, scat, gnawed sticks, and a small mammal burrow entrance" >}}
...
{{< drg/did-you-know >}}
Some mammals can use the same broad area in very different ways. A fox may travel across an open field to hunt, while a mouse in that same field rarely ventures far from cover because open ground is much more dangerous for it.
{{< /drg/did-you-know >}}
...
{{< drg/video
    title="How to Find Mammal Signs (video)"
    url="https://www.youtube.com/watch?v=x8DfP0Nh7kA" >}}

{{< drg/external-link
    title="Animal Tracks Identification Guide | Animal Footprint ID Charts (website)"
    url="https://www.greenbelly.co/pages/animal-tracks-identification-guide"
    description="A visual guide that helps you compare track shapes and common field clues when you are trying to identify mammals by sign." >}}

{{< drg/safety-first >}}
Choose observation sites where you can legally and safely be present. Avoid approaching dens, young animals, or any mammal that may feel cornered. If your study area includes roads, steep ground, water, or dusk travel, plan for visibility and a safe exit.
{{< /drg/safety-first >}}

{{< drg/tip >}}
If you find uncertain evidence, label it honestly as “possible raccoon” or “small rodent sign” instead of guessing. Careful uncertainty is better science than a confident wrong answer.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You know how to compare two habitats"
    teaser="See how repeated visits to one site can reveal mammal activity over time."
