...
{{< drg/tip >}}
A simple memory aid is “King Philip Came Over For Good Soup,” but do not rely on the mnemonic alone. Make sure you can explain what each level actually means.
{{< /drg/tip >}}
...
{{< drg/checklist title="Good Classification Habits" subtitle="Use these to avoid common mistakes" >}}
...
In [Req 3c](/merit-badges/mammal-study/guide/req3c/) and [Req 4c](/merit-badges/mammal-study/guide/req4c/), good classification will make your life-history work much stronger because it helps you put one species in the right biological context.
...
{{< drg/video
    title="The 5 Kingdoms in Classification (video)"
    url="https://youtu.be/oID1h-zL-uw?si=jHkAIYYgKaxKTZwG" >}}

{{< drg/video
    title="Animal Classification (video)"
    url="https://youtu.be/L6anmd7DnYw?si=tVuoSQOwEYpKbYO7" >}}

{{< drg/video
    title="The Three Types of Mammals, Differences, and How to Tell (video)"
    url="https://youtu.be/YAgjPwiSbvA?si=gwU-5Y3dVcmjt8Z7" >}}

{{< drg/external-link
    title="Mammal Species of the World Database (website)"
    url="https://www.departments.bucknell.edu/biology/resources/msw3/browse.asp"
    description="A large reference database you can use to confirm scientific names, genera, and families for many mammal species." >}}
...
{{< drg/next-page
    text="You can now place mammals in the larger animal kingdom"
    teaser="Choose a field-study option that fits your time, location, and interests."
