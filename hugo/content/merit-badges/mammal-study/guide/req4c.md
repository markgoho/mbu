...
This option builds directly on [Req 3c](/merit-badges/mammal-study/guide/req3c/), but now your subject is a **native game mammal**. That adds a management angle because game species are often studied carefully for population health, habitat use, seasons, and sustainable harvest rules.
...
{{< drg/checklist title="Strong Source Mix" subtitle="Use more than one type of source" >}}
...
{{< drg/tip >}}
If two sources disagree, do not hide that. Check a third source or ask which one is more local and more current. Wildlife facts can vary by region.
{{< /drg/tip >}}

A different kind of field investigation comes next: building a tracking pit and letting mammals come to you.

{{< drg/next-page
    text="You can now structure a well-sourced life history report"
    teaser="Next, learn how to set up a tracking pit and read what visits it."
