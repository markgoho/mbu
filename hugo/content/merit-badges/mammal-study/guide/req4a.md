...
{{< drg/safety-first >}}
This option must be done only under the guidance required by the badge. Follow all instructions for hygiene, handling tools, protective equipment, and specimen disposal. Never try to prepare specimens on your own without trained supervision and permission.
{{< /drg/safety-first >}}
...
{{< drg/video
    title="Skinning Your Rat (video)"
    url="https://youtu.be/m93WO9praZE?si=DG3Wt7aD9EBE-Zma" >}}

{{< drg/video
    title="Preparing Mammal Specimens (video)"
    url="https://www.youtube.com/watch?v=dBk9jwQBiuA" >}}

{{< drg/tip >}}
Bring a notebook and write down the exact steps, tools, and labeling practices you see. Those details will help you explain the uses of study skins and mounted specimens clearly to your counselor.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have seen how specimens can support science"
    teaser="Next, explore how photography can document mammals without handling them at all."
