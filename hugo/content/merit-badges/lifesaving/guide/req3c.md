...
req_number: "3c"
prev: "/merit-badges/lifesaving/guide/req3b/"
prev_title: "Req 3b — Identifying Distress"
next: "/merit-badges/lifesaving/guide/req3d/"
next_title: "Req 3d — Adapting Rescue Techniques"
---
...
- Your arm or leg (lie flat to avoid being pulled in)
- A towel, shirt, or belt
- A pole, paddle, branch, or pool noodle
...
- Throw bag (a bag filled with coiled rope)
- Any buoyant object: cooler, empty jug, kickboard, life jacket
...
{{< drg/image src="images/reach-throw-row-go.avif" alt="Four-panel illustration showing the rescue order: reaching with a pole from a dock, throwing a ring buoy, rowing a canoe toward a victim, and swimming with a rescue tube" >}}

{{< drg/safety-first >}}
The order exists for a reason: **your safety matters too.** A rescuer who becomes a victim makes the situation worse, not better. Always call for help (shout, send someone to call 911) as you begin your rescue — even if you think you can handle it alone.
{{< /drg/safety-first >}}
...
- Shout for help — alert other people nearby
- Send someone to call 911
- If at a facility, activate the emergency alarm
- Point at a specific person and say: "You — call 911 now!"
...
{{< drg/tip >}}
Practice the order by imagining yourself at different locations — your backyard pool, a lake, a river. At each location, ask: What could I reach with? What could I throw? Is there a boat? Only after answering those questions should you consider going in.
{{< /drg/tip >}}

{{< drg/did-you-know >}}
Professional lifeguards at pools almost always use "reach" or "throw" rescues. Studies show that the vast majority of pool rescues are completed without the lifeguard ever entering the water — because the right equipment is always within reach.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    ...
    description="Water safety tips and resources from the American Red Cross, including how to respond to water emergencies." >}}

{{< drg/next-page
    text="You know the order of rescue. But every situation is different."
    teaser="Find out how to adapt your rescue techniques based on the setting and the victim's condition."
