...
{{< drg/safety-first >}}
According to the CDC, about 75% of drowning deaths in children ages 1–4 happen in residential swimming pools. A fence with a self-latching gate reduces the risk of childhood drowning by more than 50%.
{{< /drg/safety-first >}}
...
- **Use your feet** to push off rocks and obstacles.
- **Work your way to the side**, angling toward shore with backstrokes.
- **Do not try to stand** until the water is knee-deep and the current is weak.
{{< /drg/be-prepared >}}

{{< drg/image src="images/rip-current-diagram.avif" alt="A diagram showing a beach from above with a rip current flowing away from shore, arrows showing the current direction and the escape path swimming parallel to shore" >}}
...
{{< drg/did-you-know >}}
Rip currents account for more than 80% of beach rescues performed by surf lifeguards. The United States Lifesaving Association estimates that over 100 people die in rip currents each year in the U.S. alone.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When discussing these scenarios with your counselor, use real-world examples from your own community. Is there a river, lake, or pool nearby? What specific hazards does it present? Your counselor will be impressed when you connect the requirement to the world around you.
{{< /drg/tip >}}

{{< drg/external-link
    title="CDC Drowning Prevention"
    url="https://www.cdc.gov/drowning/prevention/index.html"
    description="Data-driven strategies for preventing drowning, from the Centers for Disease Control and Prevention." >}}

{{< drg/next-page
    text="Now that you understand where drowning happens, you need to know how to recognize it."
    teaser="Learn the signs that someone in the water needs help — often very different from what you would expect."
