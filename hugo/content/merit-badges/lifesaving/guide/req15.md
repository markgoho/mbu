...
req_number: "15"
prev: "/merit-badges/lifesaving/guide/req14/"
prev_title: "Submerged Victim Recovery"
next: "/merit-badges/lifesaving/guide/req16/"
next_title: "CPR & Rescue Breathing"
---
...
{{< drg/safety-first >}}
The number one rule of aquatic spinal injury prevention: **never dive into water where you do not know the depth.** Enter feetfirst until you have confirmed the depth is at least 9 feet for headfirst diving. This single rule prevents the majority of aquatic spinal injuries.
{{< /drg/safety-first >}}

**Signs and Symptoms to Watch For:**

{{< drg/checklist title="Spinal Injury Indicators" subtitle="If you see any of these, suspect a spinal injury" >}}
...
{{< drg/checklist title="Do's and Don'ts" subtitle="Absolute rules when managing a suspected spinal injury" >}}
...
- **Call 911 immediately.** Send a bystander.
- **Wade carefully** to the victim. Do not create waves.
- **Perform the vice grip turn** — rotate them faceup while keeping head, neck, and body aligned.
- **Support in the faceup position.** Check for breathing.
- **If not breathing**, you must remove them from the water and begin CPR — keeping the spine as straight as possible during extrication.
- **Wait for EMS.** Maintain stabilization until paramedics take over.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Mayo Clinic — Spinal Cord Injury First Aid"
    url="https://www.mayoclinic.org/first-aid/first-aid-spinal-injury/basics/art-20056677"
    description="First aid guidelines for spinal cord injuries, including when to suspect one and how to immobilize the victim." >}}

{{< drg/next-page
    text="You now know how to manage a spinal injury in the water."
    teaser="The next critical skill every lifesaver needs: CPR and rescue breathing. Learn how to bring someone back."
