...
{{< drg/tip >}}
When practicing the 400-yard swim, do not sprint. Focus on smooth, sustainable technique. In a real rescue, you need to arrive at the victim with enough energy to perform the rescue — not gasping and exhausted from the swim out.
{{< /drg/tip >}}
...
{{< drg/checklist title="Stroke Quality Checklist" subtitle="What your counselor will evaluate" >}}
...
{{< drg/did-you-know >}}
The sidestroke was actually the dominant competitive swimming stroke in the 1800s before the front crawl was introduced. It was developed because it allowed swimmers to breathe easily during long open-water swims — the same reason it is still the primary rescue stroke today.
{{< /drg/did-you-know >}}

{{< drg/safety-first >}}
Never practice distance swimming alone. Always swim in a supervised area with a buddy. If you feel dizzy, experience muscle cramps, or become unusually short of breath, stop immediately and signal for help.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="Swimming Merit Badge Guide"
    url="/merit-badges/swimming/"
    description="Complete the Swimming merit badge requirements and build the foundation for Lifesaving." >}}

{{< drg/next-page
    text="With your swimming skills verified, you are ready to learn about water emergencies."
    teaser="Discover the common drowning situations every lifesaver needs to recognize."
