...
{{< drg/image src="images/canoe-rowing-rescue.avif" alt="A rescuer in a canoe extending a paddle to a person in the water, approaching from a controlled angle with calm lake water around them" >}}
...
{{< drg/checklist title="Observation Checklist" subtitle="Key elements to evaluate" >}}
...
{{< drg/tip >}}
When discussing the rescue with your counselor, be specific. Instead of saying "it was good," say things like: "The rescuer approached from downwind, which was smart because the boat drifted toward the victim naturally." Concrete observations show real understanding.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
A rowing rescue requires that you know how to operate the watercraft safely. Do not attempt a boat rescue in a craft you are unfamiliar with — you could capsize and become a victim yourself. If you have not completed the appropriate boating training, stick to reach and throw methods.
{{< /drg/safety-first >}}

{{< drg/did-you-know >}}
Stand up paddleboard (SUP) rescues are one of the newest additions to lifeguard training. In California, some beach lifeguard services have found that SUPs can reach drowning victims faster than traditional rescue boats because they can be launched directly through the surf.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="BSA Aquatics Supervision — Safety Afloat"
    url="https://www.scouting.org/health-and-safety/gss/gss03/"
    description="BSA's Safety Afloat guidelines for all boating activities, including the eight safety points for watercraft use." >}}

{{< drg/next-page
    text="You have seen how watercraft can be used for rescue."
    teaser="Now let's prepare for the final step in the rescue sequence — the 'Go' rescue — by learning about the aids that make it safer."
