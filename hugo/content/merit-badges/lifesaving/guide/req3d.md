...
{{< drg/tip >}}
Before any water activity, take a moment to survey the area as a rescuer would. Where is the rescue equipment? How deep is the water? What obstacles exist? Where is the nearest phone? Getting answers to these questions before an emergency means you will not waste precious seconds figuring them out during one.
{{< /drg/tip >}}

{{< drg/image src="images/rescue-settings-comparison.avif" alt="A four-panel illustration showing rescue approaches in different settings: pool, lake, river, and ocean" >}}
...
{{< drg/safety-first >}}
An active drowning victim is the most dangerous to rescue because their survival instinct drives them to climb on top of anything — including you. Never approach an active drowning victim without a buoyant aid. If they grab you, submerge — they will let go and push away because their instinct tells them to stay at the surface.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Professional ocean lifeguards are trained to use rescue boards that allow them to reach a victim up to 400 yards offshore in just a few minutes — far faster than any swimming rescue. The rescue board also provides a large, stable flotation platform for the victim.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="United States Lifesaving Association"
    url="https://www.usla.org/page/SAFETY"
    description="Open water safety guidelines and rescue information from the national organization for beach lifeguards." >}}

{{< drg/next-page
    text="You now know how to adapt your rescue to the situation."
    teaser="But sometimes the bravest thing a rescuer can do is NOT go in. Find out when."
