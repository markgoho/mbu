---
title: "When NOT to Rescue"
layout: guide
group_title: "3. Recognizing & Responding"
req_number: "3e"
prev: "/merit-badges/lifesaving/guide/req3d/"
prev_title: "Adapting Rescue Techniques"
next: "/merit-badges/lifesaving/guide/req4/"
next_title: "Reaching Rescues"
---
...
{{< drg/checklist title="Do NOT Enter the Water If..." subtitle="Situations where a swimming rescue puts you at unacceptable risk" >}}
...
{{< drg/safety-first >}}
A rescuer who drowns while attempting a rescue does not save anyone. Every year, would-be rescuers — including strong swimmers — die trying to save others in conditions they were not trained or equipped to handle. Your life has value. Protect it.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/shore-based-rescue.avif" alt="A Scout on a dock calling 911 on a phone while pointing toward the water, another Scout extending a pole from the shore" >}}
...
- **Shout to the victim.** Even if they cannot respond, hearing a voice can help.
- **Look for throwable items.** A cooler, a jug, a branch — anything that floats.
- **Fix the victim's last known location** using a tree, rock, or other landmark on shore.
- **Stay on shore** and guide emergency responders when they arrive.
- **Do not enter the water.** You are the only link between the victim and professional help.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
When you discuss this requirement with your counselor, demonstrate that you understand the balance. Lifesaving is not about being reckless — it is about being effective. The best lifesavers know their limits and use every tool available before putting themselves at risk.
{{< /drg/tip >}}

{{< drg/external-link
    title="National Drowning Prevention Alliance"
    url="https://ndpa.org/"
    description="Education, advocacy, and resources for drowning prevention — including bystander response guidance." >}}

{{< drg/next-page
    text="You now understand when to go in — and when to stay out."
    teaser="Let's start building your rescue toolkit with reaching rescues — the safest method in the sequence."
