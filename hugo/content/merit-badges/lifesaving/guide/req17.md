...
{{< drg/safety-first >}}
Cold-water shock is different from hypothermia. When a person suddenly enters cold water (below 60°F), the body's gasp reflex can cause them to inhale water within seconds. Even strong swimmers can drown from cold-water shock before hypothermia ever sets in.
{{< /drg/safety-first >}}

{{< drg/image src="images/hypothermia-prevention.avif" alt="Scouts near a lake, one wrapping up in a towel after swimming, another drinking from a warm thermos, demonstrating cold-water safety practices" >}}
...
{{< drg/tip >}}
The difference between heat exhaustion and heat stroke is critical. Heat exhaustion is uncomfortable but manageable. Heat stroke is a life-threatening emergency. The key indicator: if the person stops sweating and their skin becomes hot and dry, it is heat stroke — call 911.
{{< /drg/tip >}}
...
- **Roll onto your back** and float while you address the cramp.
- **Grab your toes** and pull them toward your shin to stretch the calf.
- **Massage the muscle** if you can reach it.
- **Use your arms** to scull and slowly move toward shore.
- **Call out to your buddy** for assistance if needed.
{{< /drg/be-prepared >}}
...
{{< drg/safety-first >}}
If anyone in your group has a known allergy to insect stings, make sure they carry an epinephrine auto-injector (EpiPen) and that everyone in the group knows where it is and how to use it. Anaphylaxis can become fatal in minutes.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Shallow-water blackout caused by hyperventilation before breath-hold swimming kills experienced swimmers — not beginners. It is most common among competitive swimmers, free divers, and military trainees who are trying to push their breath-hold limits. The victims are often strong swimmers who simply never come back up.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="CDC — Healthy Swimming"
    url="https://www.cdc.gov/healthy-swimming/about/index.html"
    description="Comprehensive information about staying healthy and safe while swimming, including injury and illness prevention." >}}

{{< drg/next-page
    text="You have now covered all 17 requirements for the Lifesaving merit badge."
    teaser="Ready to go further? Explore career paths, advanced training, and real-world lifesaving opportunities."
