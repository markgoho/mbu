---
title: "Go Rescue Aids"
layout: guide
group_title: "6. Rowing & Go Rescues"
req_number: "7"
prev: "/merit-badges/lifesaving/guide/req6/"
prev_title: "Rowing Rescue"
next: "/merit-badges/lifesaving/guide/req8/"
next_title: "Buoyant Aid Rescues"
---
...
{{< drg/image src="images/buoyant-aids-lineup.avif" alt="A collection of rescue aids arranged on a pool deck: rescue tube, torpedo buoy, ring buoy, kickboard, life jacket, and a sealed plastic jug" >}}
...
{{< drg/safety-first >}}
The single most important rule of a "Go" rescue: **always bring a buoyant aid.** A swimming rescue without a flotation device puts you in extreme danger. If you cannot find anything buoyant, seriously reconsider whether you should enter the water at all.
{{< /drg/safety-first >}}

{{< drg/tip >}}
For your counselor discussion, prepare a list of at least five buoyant aids and three nonbuoyant aids. Then explain in your own words why buoyancy makes such a difference. Connecting the concept to the instinctive drowning response (the victim's need to stay at the surface) shows deep understanding.
{{< /drg/tip >}}

{{< drg/did-you-know >}}
The modern rescue tube was invented in the 1960s by a lifeguard named Pete Peterson. Before that, lifeguards used heavy metal rescue cans that weighed over 10 pounds — difficult to swim with and dangerous if they hit a victim. Peterson's lightweight foam tube revolutionized water rescue.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="American Red Cross — Lifeguarding Resources"
    url="https://www.redcross.org/take-a-class/lifeguarding"
    description="Information about lifeguard training, including the equipment used in professional water rescue." >}}

{{< drg/next-page
    text="You know what aids to bring and why buoyancy matters."
    teaser="Now it's time to put it into practice — learn how to perform a buoyant aid rescue for a conscious victim."
