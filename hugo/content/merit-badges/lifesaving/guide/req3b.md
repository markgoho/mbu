...
req_number: "3b"
prev: "/merit-badges/lifesaving/guide/req3a/"
prev_title: "Req 3a — Drowning Situations"
next: "/merit-badges/lifesaving/guide/req3c/"
next_title: "Req 3c — Rescue Order"
---
...
{{< drg/safety-first >}}
Drowning is one of the fastest emergencies you will ever encounter. From the moment the instinctive drowning response begins, a person may have less than one minute before going under. Scan the water constantly — every few seconds — when you are responsible for watching swimmers.
{{< /drg/safety-first >}}

{{< drg/image src="images/distress-vs-drowning.avif" alt="A side-by-side comparison showing a distressed swimmer versus an actively drowning person" >}}
...
{{< drg/tip >}}
Here is a simple test lifeguards use: if a person looks like they might be in trouble, ask yourself — **can they answer you?** Shout to them. If they cannot respond, do not wait. Begin your rescue immediately.
{{< /drg/tip >}}
...
{{< drg/checklist title="Warning Signs" subtitle="Red flags that someone may be in trouble" >}}
...
{{< drg/did-you-know >}}
Dr. Frank Pia, who identified the Instinctive Drowning Response in the 1970s, made his discoveries by reviewing real drowning footage from public pools. His work revolutionized lifeguard training worldwide and has saved countless lives.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Drowning Doesn't Look Like Drowning — Mario Vittone"
    url="https://mariovittone.com/drowning/"
    description="An essential article on recognizing the real signs of drowning, written by a U.S. Coast Guard rescue expert." >}}

{{< drg/next-page
    text="You can now spot a person in distress. But what do you do next?"
    teaser="Learn the order of rescue methods — starting with the safest option first."
