---
title: "Unconscious Rescue"
layout: guide
group_title: "13. Unconscious Victim Rescues"
req_number: "13"
prev: "/merit-badges/lifesaving/guide/req12/"
prev_title: "Escape Techniques"
next: "/merit-badges/lifesaving/guide/req14/"
next_title: "Submerged Victim Recovery"
---
...
- A victim who appears unconscious may actually be in the final moments of active drowning — barely conscious and about to grab you.
- Splashing water on the face can trigger a response (blinking, flinching, turning) that tells you the victim is still somewhat conscious.
- If there is **no response** to voice or splash, you can proceed with a contact rescue more safely — an unconscious victim will not grab you.
...
{{< drg/checklist title="Extrication Steps" subtitle="Getting the victim onto the deck or shore" >}}
...
4. **If not breathing, begin CPR immediately.** You will learn the specifics in [Req 16](/merit-badges/lifesaving/guide/req16/).
5. **Send someone to call 911 and get an AED** if not already done.

{{< drg/tip >}}
Practice the full sequence — entry, approach, verification, rescue, extrication, CPR positioning — as one continuous drill. In a real emergency, each step flows directly into the next. Hesitation between steps wastes precious seconds.
{{< /drg/tip >}}

{{< drg/did-you-know >}}
The "splash and shout" verification step was added to lifesaving training after multiple incidents where rescuers approached victims they assumed were unconscious — only to be grabbed. Even a few seconds of assessment can prevent a dangerous surprise.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="American Heart Association — CPR & First Aid"
    url="https://www.heart.org/en/health-topics/cardiac-arrest/emergency-cardiovascular-care/cpr-facts-and-stats"
    description="CPR facts, statistics, and training resources from the American Heart Association." >}}

{{< drg/next-page
    text="You can now rescue an unconscious victim at the surface."
    teaser="But what if the victim has already gone under? Learn how to recover a submerged victim using surface dives."
