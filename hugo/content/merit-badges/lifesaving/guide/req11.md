...
req_number: "11"
prev: "/merit-badges/lifesaving/guide/req10/"
prev_title: "Lead-and-Wait Techniques"
next: "/merit-badges/lifesaving/guide/req12/"
next_title: "Escape Techniques"
---
...
{{< drg/image src="images/cross-chest-carry.avif" alt="A rescuer performing a cross-chest carry, with the victim on their back against the rescuer's hip, both faces above water" >}}

### Key Differences

| Element | Armpit Tow | Cross-Chest Carry |
|---|---|---|
| Victim condition | Calm, floating on back | Exhausted, treading water |
| Grip | One hand under armpit | Arm across chest, locked at hip |
| Your swimming position | On your back or side | On your side (sidestroke) |
| Control over victim | Minimal — they float independently | High — you control their body position |
| Energy required | Lower | Higher |
| Best for | Tired swimmers who can float | Exhausted swimmers who cannot float |

### Building the Physical Skills

Both tows require strong kicking and core endurance. Here are ways to prepare:

{{< drg/checklist title="Training Exercises" subtitle="Build the strength and stamina you need" >}}
...
{{< drg/safety-first >}}
Contact tows should only be performed on cooperative victims. If a victim begins to panic and grab at you during a contact tow, immediately release them, submerge to escape, and revert to the lead-and-wait technique from [Req 10](/merit-badges/lifesaving/guide/req10/). Never fight a panicking victim in the water.
{{< /drg/safety-first >}}

{{< drg/did-you-know >}}
The cross-chest carry has been a standard lifesaving technique for over 100 years. It was one of the original rescue methods taught by the Royal Life Saving Society in England in the 1890s — and the basic mechanics have hardly changed since then because they work so well.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="American Red Cross — Swimming & Water Safety"
    url="https://www.redcross.org/get-help/how-to-prepare-for-emergencies/types-of-emergencies/water-safety.html"
    description="Water safety resources including rescue techniques and swimming safety guidance." >}}

{{< drg/next-page
    text="You can now tow a cooperative victim to safety."
    teaser="But what happens when a victim grabs you and won't let go? Learn the escape techniques that free you from a panicking grip."
