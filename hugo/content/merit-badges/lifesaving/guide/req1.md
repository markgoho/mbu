...
req_number: "1"
prev: "/merit-badges/lifesaving/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/lifesaving/guide/req2/"
next_title: "Swimming Prerequisites"
---
...
{{< drg/tip >}}
When you are practicing lifesaving skills, your counselor is acting as both supervisor and instructor. But during open swim, lifeguards should be dedicated watchers — not swimmers, not conversationalists, not phone-checkers. Eyes on the water, always.
{{< /drg/tip >}}
...
{{< drg/image src="images/safe-swim-defense-pool.avif" alt="A supervised swimming area at a Scout camp with clearly marked lanes, buddy boards visible, and a lifeguard on an elevated chair" >}}

{{< drg/safety-first >}}
Safe Swim Defense is not optional. It is required for every BSA aquatic activity. These eight principles have been refined over decades and have prevented countless emergencies. Know them, follow them, and hold others accountable to them.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
The BSA introduced its first water safety program in 1910, making it one of the oldest organized youth aquatic safety programs in the world. Safe Swim Defense in its current eight-point form has been the standard since 1990.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Safe Swim Defense — BSA"
    url="https://www.scouting.org/health-and-safety/gss/gss02/"
    description="The official BSA guide to Safe Swim Defense, including all eight principles and their application." >}}

{{< drg/next-page
    text="You now understand the safety system that protects every aquatic activity in Scouting."
    teaser="Next, make sure you have the swimming skills to back it up."
