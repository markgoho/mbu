...
{{< drg/checklist title="How behavior changes the search plan" subtitle="The subject profile affects tactics, urgency, and where teams look first" >}}
...
{{< drg/tip >}}
A strong explanation for this requirement compares behavior patterns, not just ages. Tell your counselor how those differences change where teams search first.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="Move from subject behavior to key SAR terminology."
    teaser="Learn twelve core terms that search teams use when planning, briefing, and searching."
