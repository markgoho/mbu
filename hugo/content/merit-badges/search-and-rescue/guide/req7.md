...
{{< drg/inherited-requirement number="7a" req_path="7.a" topic="Choose a hypothetical SAR scenario, either one presented in the Search and Rescue merit badge pamphlet or one approved by your counselor." />}}
...
{{< drg/tip >}}
The best practice scenario is specific. Give the subject an age, experience level, last-seen location, time, weather, and one or two useful facts such as gear carried or likely destination.
{{< /drg/tip >}}

## Requirement 7b

{{< drg/inherited-requirement number="7b" req_path="7.b" topic="Develop an Incident Action Plan (IAP) for a hasty search using the scenario information." />}}
...
{{< drg/download
    ...
    url="/merit-badges/search-and-rescue/guide/practice-search-mission-log/"
    type="printable" >}}
...
{{< drg/safety-first >}}
A practice mission should stay within the skills and supervision level of your group. Avoid technical terrain, moving water, night operations beyond your group's ability, and any scenario that creates a real rescue hazard.
{{< /drg/safety-first >}}

## Requirement 7d

{{< drg/inherited-requirement number="7d" req_path="7.d" topic="Execute the search." />}}
...
{{< drg/checklist title="What success looks like in a practice SAR exercise" subtitle="The point is learning, not pretending to be professionals" >}}
...
{{< drg/external-link
    ...
    url="https://training.fema.gov/icsresource/icsforms.aspx"
    description="The official form set referenced in the merit badge pamphlet if you want to see what a full-scale incident plan looks like." >}}
...
{{< drg/next-page
    text="Move from practice mission work to future opportunities."
    teaser="Choose between researching a career path or exploring volunteer response roles."
