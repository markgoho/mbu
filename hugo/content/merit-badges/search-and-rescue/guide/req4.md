...
{{< drg/did-you-know >}}
The planning section chief in the pamphlet is described as the person responsible for collecting information and documenting the Incident Action Plan. That means good SAR depends as much on thinking and documentation as on hiking fast.
{{< /drg/did-you-know >}}

{{< drg/video
    title="Introduction to the Incident Command System (ICS) — Justice Institute of British Columbia (JIBC)"
    url="https://www.youtube.com/watch?v=P-dPBso2xPM" >}}
...
{{< drg/checklist title="Why agencies train together" subtitle="A practice mission teaches more than a written plan" >}}
...
{{< drg/external-link
    title="FEMA — Incident Command System Resources"
    url="https://training.fema.gov/icsresource/"
    description="Official ICS forms and training resources that show how incident organization and planning are documented." >}}

{{< drg/external-link
    title="Ready.gov — Community Emergency Response Team (CERT)"
    url="https://www.ready.gov/cert"
    description="An example of how communities train volunteers to support emergency response in an organized way." >}}
...
{{< drg/next-page
    text="Move from structure to people."
    teaser="See what SAR teams do, how environments differ, and when specialty teams are used."
