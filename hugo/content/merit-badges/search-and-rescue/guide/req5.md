...
{{< drg/safety-first >}}
Water rescue and technical rescue are highly specialized for a reason. Strong swimmers or confident hikers can still become victims if they enter moving water, unstable debris, or other technical environments without the right training.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
A strong answer for this requirement does not just name the team. It explains the situation that makes that team the right tool.
{{< /drg/tip >}}

{{< drg/external-link
    title="National Association for Search and Rescue"
    url="https://www.nasar.org/"
    description="National SAR organization with education resources and examples of many search disciplines and team roles." >}}

{{< drg/external-link
    title="Mountain Rescue Association"
    url="https://mra.org/"
    description="A good example of specialty teams that train for difficult terrain, technical rescue, and mountain response." >}}
...
{{< drg/next-page
    text="Move from team types to search procedure choices."
    teaser="Choose four SAR procedure topics and learn how searchers describe and plan the mission."
