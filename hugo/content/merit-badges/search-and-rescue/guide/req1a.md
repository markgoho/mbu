...
{{< drg/safety-first >}}
Serious conditions such as heatstroke, hypothermia, shock, venomous bites, severe allergic reactions, and eye trauma need adult help and professional medical care right away. Your job is to recognize the problem, give appropriate first aid, protect the person from getting worse, and get help quickly.
{{< /drg/safety-first >}}

In the [First Aid merit badge](/merit-badges/first-aid/), you learn these skills in greater depth. Here, focus on how they show up in outdoor searches where weather, terrain, distance, and time all make treatment harder.

## Requirement 1a1

{{< drg/inherited-requirement number="1a1" req_path="1.a.1" topic="Dehydration" />}}
...
{{< drg/inherited-requirement number="1a2" req_path="1.a.2" topic="Heatstroke" />}}
...
{{< drg/inherited-requirement number="1a3" req_path="1.a.3" topic="Hypothermia" />}}
...
{{< drg/inherited-requirement number="1a4" req_path="1.a.4" topic="Shock" />}}
...
{{< drg/inherited-requirement number="1a5" req_path="1.a.5" topic="Blisters" />}}
...
{{< drg/inherited-requirement number="1a6" req_path="1.a.6" topic="Eye injuries" />}}
...
{{< drg/inherited-requirement number="1a7" req_path="1.a.7" topic="Ankle and knee sprains" />}}
...
{{< drg/inherited-requirement number="1a8" req_path="1.a.8" topic="Bug bites of chiggers, ticks, mosquitoes, and biting gnats" />}}
...
{{< drg/image src="images/tick-removal-technique.avif" alt="Correct tick removal with fine-tipped tweezers pulling straight out close to the skin" >}}

## Requirement 1a9

{{< drg/inherited-requirement number="1a9" req_path="1.a.9" topic="Bee stings" />}}
...
{{< drg/inherited-requirement number="1a10" req_path="1.a.10" topic="Bites of spiders" />}}
...
{{< drg/inherited-requirement number="1a11" req_path="1.a.11" topic="Sting of a scorpion" />}}
...
{{< drg/inherited-requirement number="1a12" req_path="1.a.12" topic="Bite of a wild mammal" />}}
...
{{< drg/inherited-requirement number="1a13" req_path="1.a.13" topic="Bite of a venomous snake" />}}
...
{{< drg/checklist title="Field first-aid habits that matter in SAR" subtitle="These habits prevent small problems from becoming mission-stopping problems" >}}
...
{{< drg/external-link
    ...
    description="Clear field guidance for avoiding tick exposure and doing thorough checks after an outing." >}}

{{< drg/external-link
    title="National Park Service — Heat Illness"
    url="https://www.nps.gov/articles/heat-illness.htm"
    description="Simple signs, prevention, and response steps for heat emergencies during outdoor activity." >}}
...
{{< drg/next-page
    text="Move from treatment to prevention."
    teaser="See how the Scout Basic Essentials help keep lost Scouts and searchers safe outdoors."
