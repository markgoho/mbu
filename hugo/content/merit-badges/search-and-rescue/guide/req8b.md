...
req_number: "8b"
req_path: "8.b"
prev: "/merit-badges/search-and-rescue/guide/req8a/"
prev_title: "Req 8a — Research an SAR Career"
next: "/merit-badges/search-and-rescue/guide/extended-learning/"
...
{{< drg/video
    title="Volunteers Need to Know This Before Joining A Search and Rescue Team — Emhance International Responder Development®"
    url="https://www.youtube.com/watch?v=dMD9OudzeXs" >}}
...
{{< drg/checklist title="Turning interest into goals" subtitle="Use one short-term goal and one long-term goal" >}}
...
{{< drg/tip >}}
A realistic volunteer goal sounds like a ladder, not a leap. "Improve first aid, map skills, and fitness this year" is stronger than "join a rescue team tomorrow."
{{< /drg/tip >}}

{{< drg/external-link
    title="American Red Cross Volunteer Opportunities"
    url="https://www.redcross.org/volunteer/become-a-volunteer.html"
    description="Examples of disaster-relief volunteer roles and the training paths that support them." >}}

{{< drg/external-link
    title="National Ski Patrol"
    url="https://www.nsp.org/"
    description="Information about ski patrol service, training, and the outdoor rescue side of winter response." >}}

{{< drg/external-link
    title="National Association for Search and Rescue"
    url="https://www.nasar.org/"
    description="A useful starting point for learning how search volunteers train and what professional standards look like." >}}
...
{{< drg/next-page
    text="Go beyond the badge."
    teaser="Explore advanced training ideas, real-world experiences, and organizations connected to search and rescue."
    url="/merit-badges/search-and-rescue/guide/extended-learning/" >}}
