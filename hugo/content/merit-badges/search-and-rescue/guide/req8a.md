...
req_number: "8a"
req_path: "8.a"
prev: "/merit-badges/search-and-rescue/guide/req8/"
prev_title: "Req 8 — Choose Your Career Path"
next: "/merit-badges/search-and-rescue/guide/req8b/"
next_title: "Req 8b — Volunteer Response Paths"
---
...
{{< drg/checklist title="Questions to ask in an interview" subtitle="Use these if you speak with a real professional" >}}
...
{{< drg/tip >}}
If you interview someone, ask about a normal week, not just the biggest rescue of their career. Everyday work tells you much more about whether the job truly fits you.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    description="Reliable federal career profiles with salary, job-growth, and education information." >}}

{{< drg/external-link
    title="CareerOneStop"
    url="https://www.careeronestop.org/"
    description="A practical career-research tool for training pathways, wages, and related occupations." >}}
...
{{< drg/next-page
    text="Move from careers to community service roles."
    teaser="Explore how this badge can lead toward volunteer disaster relief, wilderness rescue, or ski patrol work."
