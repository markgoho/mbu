...
{{< drg/inherited-requirement number="6e1" req_path="6.e.1" topic="Evaluating search urgency" />}}
...
{{< drg/inherited-requirement number="6e2" req_path="6.e.2" topic="Establishing confinement" />}}
...
{{< drg/inherited-requirement number="6e3" req_path="6.e.3" topic="Scent item" />}}
...
{{< drg/inherited-requirement number="6e4" req_path="6.e.4" topic="Area air scent dog" />}}
...
{{< drg/inherited-requirement number="6e5" req_path="6.e.5" topic="Briefing and debriefing" />}}
...
{{< drg/inherited-requirement number="6e6" req_path="6.e.6" topic="Clue awareness" />}}
...
{{< drg/inherited-requirement number="6e7" req_path="6.e.7" topic="Evidence preservation" />}}
...
{{< drg/inherited-requirement number="6e8" req_path="6.e.8" topic="Tracking a subject" />}}
...
{{< drg/inherited-requirement number="6e9" req_path="6.e.9" topic="Locating a subject using attraction" />}}
...
{{< drg/inherited-requirement number="6e10" req_path="6.e.10" topic="Hasty search" />}}
...
{{< drg/inherited-requirement number="6e11" req_path="6.e.11" topic="Trail sweep search" />}}
...
{{< drg/inherited-requirement number="6e12" req_path="6.e.12" topic="Grid search" />}}
...
{{< drg/checklist title="A useful way to organize these terms" subtitle="Think of them by mission phase" >}}
...
{{< drg/external-link
    title="National Search and Rescue School"
    url="https://www.forcecom.uscg.mil/Our-Organization/FORCECOM-UNITS/TraCen-Yorktown/Training/Maritime-Search-Rescue/"
    description="One of the official resources listed in the merit badge pamphlet for deeper SAR education and terminology." >}}
...
{{< drg/next-page
    text="Move from SAR vocabulary to action."
    teaser="Plan a scenario, brief your team, run a hasty search, and debrief what happened."
