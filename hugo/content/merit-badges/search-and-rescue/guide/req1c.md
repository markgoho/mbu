...
{{< drg/checklist title="What a field pack is trying to do" subtitle="Every item should answer one of these questions" >}}
...
{{< drg/tip >}}
If you are discussing field packs with your counselor, organize your answer around hazards instead of listing random gear. That shows you understand why the equipment is carried.
{{< /drg/tip >}}
...
{{< drg/image src="images/sar-pack-layout.avif" alt="Search and rescue field pack with major safety gear laid out and labeled by hazard category" >}}

{{< drg/safety-first >}}
Carrying gear does not replace training. Rope systems, swiftwater equipment, technical rescue hardware, and advanced medical gear should only be used by people trained and authorized to use them.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="National Association for Search and Rescue — Hug-A-Tree and Survive"
    url="https://www.nasar.org/education/hug-a-tree"
    description="A respected SAR education program that explains prevention, survival, and what trained teams look for in the field." >}}

{{< drg/external-link
    title="Ready.gov — Build A Kit"
    url="https://www.ready.gov/kit"
    description="A practical checklist for organizing emergency gear with purpose, especially for weather and delayed-return situations." >}}
...
{{< drg/next-page
    text="Step into the prevention side of search and rescue."
    teaser="Learn how trip plans, buddies, signals, and locator tools help Scouts stay found and get found."
