...
{{< drg/tip >}}
When counselors hear "staying found," they are usually listening for prevention first and signaling second. A smart trip plan beats a great rescue signal every time.
{{< /drg/tip >}}
...
{{< drg/checklist title="What belongs in a trip plan" subtitle="The clearer the plan, the smaller the search area if something goes wrong" >}}
...
| Condition | Trip-plan change it may require |
| --- | --- |
| Hot weather | Earlier start, more water, more shade breaks |
| Thunderstorms | Avoid ridges, lakes, and exposed high ground |
| Cold rain | Add insulation, rain gear, and emergency shelter |
| Short winter daylight | Shorter route and firmer turnaround time |
...
{{< drg/be-prepared title="You hear a helicopter but cannot see the crew looking your way" >}}
Stay in the most open safe spot nearby. Use your whistle and mirror, then wave a bright item in a steady pattern. Do not run under the aircraft or move into dangerous terrain just to be seen.

- **First:** Make yourself bigger and brighter.
- **Next:** Repeat the same signal instead of trying five different ones.
- **Then:** Stay put so the crew can relocate you.
  {{< /drg/be-prepared >}}
...
{{< drg/image src="images/signal-mirror-aiming.avif" alt="Scout using a signaling mirror and sighting hole to aim sunlight toward a distant search aircraft" >}}
...
{{< drg/safety-first >}}
Never activate a PLB just because you are delayed or uncomfortable. It is for real emergencies where rescue help is needed.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="NOAA — Personal Locator Beacons"
    url="https://www.sarsat.noaa.gov/emergency-beacons/personal-locator-beacons/"
    description="How PLBs work, when to register them, and how they fit into the rescue-alert system." >}}

{{< drg/external-link
    title="Air Force Rescue Coordination Center"
    url="https://www.1af.acc.af.mil/Units/AFRCC/"
    description="Official overview of the inland search-and-rescue coordination center referenced in the merit badge pamphlet." >}}
...
{{< drg/next-page
    text="Move from trip plans and signals to map skills."
    teaser="Learn how searchers read maps, coordinates, bearings, and containment areas."
