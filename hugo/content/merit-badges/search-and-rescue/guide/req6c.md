...
{{< drg/video
    title="Urban Search and Rescue Communications Specialist Training 2015 — FEMA"
    url="https://www.youtube.com/watch?v=YE-WG9_IWTc" >}}

{{< drg/be-prepared title="You find a possible clue on the trail" >}}
Do not guess that it belongs to the subject and do not start moving it around.

- **First:** Observe carefully and mark the location.
- **Next:** Report what you saw, where you saw it, and why it may matter.
- **Then:** Wait for direction so clue handling stays organized.
  {{< /drg/be-prepared >}}

{{< drg/tip >}}
A great report sounds boring in the best possible way: exact time, exact place, exact observation, no drama added.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="FEMA — ICS Resource Center"
    url="https://training.fema.gov/icsresource/"
    description="Examples of the standardized forms and structure used to keep incident information organized." >}}
...
{{< drg/next-page
    text="Move from reporting to prediction."
    teaser="Learn how age and behavior patterns help teams choose search tactics for children, teens, and adults."
