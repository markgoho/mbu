...
req_number: "7"
prev: "/merit-badges/horsemanship/guide/req6/"
prev_title: "Req 6 — Hoof Care and Horseshoes"
next: "/merit-badges/horsemanship/guide/req8/"
next_title: "Req 8 — Feeding a Horse"
---
...
{{< drg/video
    title="Caring for a Horse (video)"
    url="https://youtu.be/fdGhd2phEHs" >}}

{{< drg/video
    title="How to Groom a Horse (video)"
    url="https://youtu.be/9Leym8QeBM8" >}}
...
{{< drg/image src="images/horse-grooming-tool-sequence.avif" alt="Four-panel grooming sequence showing curry comb, stiff brush, soft brush, and mane comb use on the same horse" >}}

{{< drg/checklist title="What to Look For While Grooming" subtitle="Grooming doubles as a health check" >}}
...
{{< drg/safety-first >}}
Never kneel under a horse or sit on the ground while working on hooves. If the horse shifts suddenly, you need to be able to step away immediately.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="After a Hot Summer Lesson" >}}
You finish riding and notice the horse is sweaty, still breathing hard, and has damp foam under the saddle area.

- **Walk first:** Keep the horse moving calmly until breathing slows.
- **Loosen gear thoughtfully:** Follow your instructor's routine instead of stripping tack off in a rush.
- **Check the body:** Look for rubs, heat, or soreness where tack touched.
- **Finish the job:** Brush away dried sweat, pick the hooves, and leave the horse comfortable and tidy.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
When you groom, use both your eyes and your hands. Your hands often notice heat, swelling, or soreness before your eyes do.
{{< /drg/tip >}}

{{< drg/external-link
    title="University of Minnesota Extension — Horse Grooming Basics"
    url="https://extension.umn.edu/horse-care-and-management/basic-horse-care"
    description="Basic horse-care guidance that reinforces grooming, observation, and routine stable habits." >}}
...
{{< drg/next-page
    text="You now know how grooming and after-ride care keep a horse clean, comfortable, and easier to monitor."
    teaser="Next, learn how riders decide what to feed a horse and why those choices change with the work the horse does."
