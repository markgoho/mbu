...
{{< drg/image src="images/horse-career-pathways-grid.avif" alt="Four-panel overview of horse careers showing an equine veterinarian, farrier, riding instructor, and barn manager at work" >}}

{{< drg/video
    title="Careers Working With Horses (video)"
    url="https://youtu.be/00UQQttaXUs?si=wkiU7zrCaLhmzHis" >}}

{{< drg/video
    title="Explore a Career as a Horse Doctor (video)"
    url="https://youtu.be/BCnueH9iemg?si=e9ZwFO8jJ6T7ue5C" >}}

## What to Research

Your counselor wants more than a job title. They want to hear that you understand the path into the profession.

{{< drg/checklist title="Career Research Questions" subtitle="Build your discussion around these topics" >}}
...
{{< drg/tip >}}
If possible, interview someone in the career you chose. Ask what they wish people understood before entering the field. That answer is often more helpful than any website summary.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Interviewing a Horse Professional" >}}
You get a chance to speak with a farrier, trainer, or veterinarian.

- **Prepare questions ahead of time:** Ask about training, cost, pay, and daily tasks.
- **Be respectful of time:** Keep your questions focused.
- **Listen for surprises:** The most valuable answers are often about challenges and trade-offs.
- **Write notes right away:** You will remember more for your counselor discussion.
{{< /drg/be-prepared >}}

{{< drg/did-you-know >}}
Becoming an equine veterinarian usually requires four years of college plus four years of veterinary school, and some vets complete internships or residencies after that. Horse careers can require as much training as many other highly skilled professions.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="American Association of Equine Practitioners"
    url="https://aaep.org/"
    description="Professional organization for equine veterinarians with career and horse-health information." >}}

{{< drg/external-link
    title="American Farrier's Association"
    url="https://americanfarriers.org/"
    description="Information about farrier skills, certification, and the hoof-care profession." >}}
...
{{< drg/next-page
    text="You now know how to research a horse-related career in a practical, realistic way."
    teaser="The other option explores how horsemanship could become a hobby, sport, or healthy lifestyle over time."
