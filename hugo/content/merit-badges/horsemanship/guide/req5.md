...
{{< drg/checklist title="What People Notice in Conformation" subtitle="Common features discussed when evaluating a horse" >}}
...
{{< drg/image src="images/conformation-vs-lameness-visual-guide.avif" alt="Split comparison of a balanced horse standing square for conformation and a horse moving unevenly to show lameness" >}}
...
{{< drg/video
    title="Lameness vs. Unsoundness (video)"
    url="https://www.youtube.com/shorts/Ica4d4jK2eo" >}}

{{< drg/external-link
    title="Signs of Lameness (video)"
    url="https://youtu.be/c9Mn9RP39lE?si=T2D88HPDsxFjWU8v"
    description="A YouTube watch link showing common lameness warning signs if you want another visual example." >}}
...
{{< drg/safety-first >}}
If a horse appears lame, do not keep riding to “work through it.” Stop, tell the responsible adult, and let an experienced person decide what to do next. Continuing to ride can make an injury worse.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
When you watch horses move, compare what you see at the walk and the trot. It is often easier to notice unevenness at the trot because each diagonal pair of legs lands in a clearer rhythm.
{{< /drg/tip >}}

{{< drg/external-link
    title="University of Kentucky — Evaluating Horse Conformation"
    url="https://afs.ca.uky.edu/horse/horse-selection-evaluating-conformation"
    description="A practical overview of how horse build affects balance, movement, and long-term usefulness." >}}
...
{{< drg/next-page
    text="You now understand how horse build affects movement and how lameness differs from general unsoundness."
    teaser="Next, look down to the feet and learn why hoof care is one of the most important parts of horsemanship."
