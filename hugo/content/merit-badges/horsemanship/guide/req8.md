...
{{< drg/video
    title="What Do Horses Eat? (video)"
    url="https://youtu.be/AcgfzGhaoes" >}}
...
{{< drg/checklist title="Questions That Shape a Feeding Plan" subtitle="Ask these before deciding what or how much to feed" >}}
...
{{< drg/image src="images/horse-body-condition-feeding-comparison.avif" alt="Side-by-side comparison of an underweight horse, a horse in healthy condition, and an overweight easy-keeper pony" >}}

{{< drg/did-you-know >}}
Horses are designed to graze for many hours a day. Their stomach is relatively small compared with their body size, so large, infrequent meals can upset the digestive system more than steady access to forage.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Never change a horse's diet suddenly without adult direction. Quick feed changes can contribute to colic, diarrhea, or other digestive trouble. Any change should happen gradually.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
When discussing “how much” with your counselor, talk in terms of body size, forage amount, workload, and professional guidance rather than guessing one exact scoop size for every horse.
{{< /drg/tip >}}

{{< drg/be-prepared title="The Easy Keeper Problem" >}}
A pony in your barn is not in hard work, but it gains weight quickly in spring pasture.

- **Reduce access carefully:** Adults may limit pasture time or use other management strategies.
- **Keep forage thoughtful:** The goal is controlled nutrition, not starving the horse.
- **Watch body condition:** Thick crest, fat pads, and stiffness matter.
- **Ask professionals:** A veterinarian or knowledgeable manager should guide changes.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="AAEP — Horse Nutrition"
    url="https://aaep.org/horsehealth/nutrition"
    description="Veterinary nutrition guidance that explains forage, concentrates, water, and feeding management." >}}
...
{{< drg/next-page
    text="You now understand how horse feeding changes with body type, workload, and individual needs."
    teaser="Next, learn the tack parts you use and how to saddle, bridle, mount, and dismount safely."
