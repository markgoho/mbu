...
{{< drg/image src="images/horse-breed-comparison-grid.avif" alt="Four-panel comparison of an American Quarter Horse, Arabian, Thoroughbred, and Clydesdale showing their distinct builds side by side" >}}
...
{{< drg/video
    title="Ten Popular Horse Breeds (video)"
    url="https://youtu.be/FiBBNX8WszQ" >}}
...
{{< drg/checklist title="How to Describe a Breed" subtitle="A simple pattern for counselor discussion" >}}
...
{{< drg/did-you-know >}}
Arabian horses have one fewer lumbar vertebra than many other breeds. That slightly shorter back is one reason they often look compact and balanced.
{{< /drg/did-you-know >}}

{{< drg/tip >}}
If you know horses at your stable, pick four breeds you have actually seen. Real examples are easier to remember and easier to explain than a random list from memory.
{{< /drg/tip >}}

{{< drg/external-link
    title="American Quarter Horse Association — About the Breed"
    url="https://www.aqha.com/"
    description="Breed information and examples of the jobs and sports Quarter Horses are known for." >}}
...
{{< drg/next-page
    text="You can now describe how different horse breeds are built and what each is known for."
    teaser="Next, learn to recognize colic and other health problems before they become emergencies."
