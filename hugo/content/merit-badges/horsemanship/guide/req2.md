...
{{< drg/video
    title="Parts of a Horse (video)"
    url="https://youtu.be/y369q1jh8HQ" >}}

{{< drg/external-link
    title="Parts of a Horse (filled) (PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Horsemanship/Parts%20of%20a%20Horse.jpg"
    description="A labeled horse diagram you can study to match each part with its location." >}}

{{< drg/external-link
    title="Parts of a Horse (blank) (PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Horsemanship/Parts%20of%20a%20Horse%20-%20blank%20worksheet.pdf"
    description="A blank practice sheet you can use to quiz yourself before meeting with your counselor." >}}
...
{{< drg/image src="images/horse-parts-labeled-diagram.avif" alt="Labeled horse anatomy diagram showing major external body parts such as muzzle, withers, shoulder, flank, hock, fetlock, and hoof" >}}
...
{{< drg/checklist title="Fifteen Useful Parts to Learn First" subtitle="A strong starter list for counselor discussion" >}}
...
{{< drg/did-you-know >}}
A horse has only one toe on each foot. The hoof is the enlarged end of that single toe, supported by bones, tendons, and sensitive internal structures that act together like a shock absorber.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Study on a real horse whenever possible, but ask permission before pointing near the eyes, ears, legs, or belly. If the horse seems restless, step back and continue with a diagram until it is calm again.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="University of Minnesota Extension — Horse Anatomy Basics"
    url="https://extension.umn.edu/horse-care-and-management/basic-horse-care"
    description="Overview information that helps connect anatomy with daily horse care and observation." >}}
...
{{< drg/next-page
    text="You now have a working map of the horse's body and why each part matters."
    teaser="Next, compare horse breeds and the special traits that make each one stand out."
