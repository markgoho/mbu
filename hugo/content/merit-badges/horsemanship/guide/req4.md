...
{{< drg/image src="images/colic-warning-signs-comparison.avif" alt="Multi-panel comparison showing a horse pawing, looking at its side, trying to roll, and standing normally for contrast" >}}

{{< drg/safety-first >}}
If you suspect colic, alert the horse's owner, instructor, or veterinarian right away. Do not force feed, do not give medicine unless an adult professional directs it, and be careful around a horse that wants to lie down and roll because it may strike out with its legs.
{{< /drg/safety-first >}}
...
{{< drg/video
    title="Health Problems in Horses (video)"
    url="https://youtu.be/_ZeUDXMmSXE?si=mw4HfkBBedTRvh5a" >}}
...
{{< drg/checklist title="What to Notice Each Day" subtitle="Small observations can catch problems early" >}}
...
{{< drg/did-you-know >}}
A horse cannot vomit. That is one reason digestive trouble can become so dangerous. Pressure and pain build inside the digestive system instead of being relieved the way they sometimes can in other animals.
{{< /drg/did-you-know >}}

{{< drg/be-prepared title="A Horse Starts Pawing After Dinner" >}}
A horse that seemed normal at feeding time now keeps pawing, looking at its side, and refusing hay.

- **Stay calm and observe:** Notice the specific signs and when they started.
- **Get an adult immediately:** Report what you are seeing to the owner, barn manager, or instructor.
- **Keep yourself safe:** Stay out of the way if the horse becomes restless or tries to roll.
- **Be ready to help:** You might be asked to fetch a halter, clear an aisle, or call the veterinarian.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="AAEP — Colic"
    url="https://aaep.org/horsehealth/colic"
    description="Veterinary guidance on what colic is, signs to watch for, and why prompt attention matters." >}}
...
{{< drg/next-page
    text="You can now describe the warning signs of colic and several other common horse health problems."
    teaser="Next, learn how body structure affects movement and what riders mean by lameness and unsoundness."
