...
{{< drg/image src="images/horse-blind-spots-safety-diagram.avif" alt="Side-view horse diagram showing the safe approach zone at the shoulder and the blind spots directly in front and behind the horse" >}}
...
{{< drg/safety-first >}}
Never wrap a lead rope around your hand, wrist, or waist. If a horse pulls back, that rope can tighten instantly and cause serious injury. Fold the extra rope in loose loops instead.
{{< /drg/safety-first >}}
...
{{< drg/video
    title="Safety Precautions When Handling Horses (video)"
    url="https://youtu.be/B5KeqtLZoUA?si=FD2BQR4jCnU4E6OS" >}}
...
{{< drg/checklist title="Daily Handling Habits" subtitle="Simple habits that prevent many horse injuries" >}}
...
{{< drg/be-prepared title="A Nervous Horse in the Cross-Ties" >}}
You bring a horse into the aisle to groom it, and suddenly a loud clang from a dropped bucket makes the horse jump sideways.

- **Step with the horse, not against it:** Give yourself room instead of trying to out-muscle the horse.
- **Speak calmly:** Use a steady voice and avoid yelling.
- **Check the setup:** Make sure the ties, halter, and aisle are still safe.
- **Reset before continuing:** Wait until the horse relaxes before you resume grooming or tacking up.
{{< /drg/be-prepared >}}
...
{{< drg/video
    title="Barn Fire Safety (video)"
    url="https://youtu.be/w-05f23oJVA" >}}
...
{{< drg/safety-first >}}
If there is smoke or fire, alert an adult and call 911 immediately. Do not run into a smoky barn alone to rescue a horse unless trained adults are directing the evacuation. Fire can trap people faster than they expect.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/barn-fire-hazards-vs-safe-barn-comparison.avif" alt="Split comparison of an unsafe barn aisle with fire hazards and a properly organized safe barn aisle" >}}

{{< drg/tip >}}
When you visit a barn, quietly notice the exits, extinguisher locations, and where halters are stored. That habit helps you think like a safe horse person before an emergency ever happens.
{{< /drg/tip >}}

{{< drg/external-link
    title="National Ag Safety Database — Barn Fire Prevention"
    url="https://nasdonline.org/1225/d001023/fire-prevention-and-control-on-horse-farms.html"
    description="Practical barn fire prevention steps, including wiring, hay storage, and emergency planning." >}}
...
{{< drg/next-page
    text="You now understand how safe horse handling and barn fire prevention protect both people and animals."
    teaser="Learn the major parts of a horse so you can discuss movement, care, and health with confidence."
