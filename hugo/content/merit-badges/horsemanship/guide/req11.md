...
{{< drg/video
    title="How to Steer Your Horse (video)"
    url="https://youtu.be/uZ_5lxUyCdw" >}}

{{< drg/video
    title="How to Ride a Horse (video)"
    url="https://youtu.be/fV7kuUrjutY" >}}

{{< drg/video
    title="Riding Despite Physical Challenges (video)"
    url="https://youtu.be/oFy6FqQ_PXM?si=Qk7V2jJdKykcp9il" >}}
...
{{< drg/video
    title="How to Trot a Horse (video)"
    url="https://youtu.be/-3CMZSbQRgg" >}}
...
{{< drg/image src="images/straight-line-vs-half-circle-riding-patterns.avif" alt="Bird's-eye arena diagram showing the straight-line and half-circle riding patterns with their required sizes at walk and trot or jog" >}}

{{< drg/video
    title="Tips for Trotting (video)"
    url="https://youtu.be/KCSkmYEQxEg?si=ET5yK-3VM_Pjzae3" >}}
...
{{< drg/video
    title="How to Stop Your Horse (video)"
    url="https://youtu.be/GJ0Y_ZaCSmo" >}}
...
{{< drg/video
    title="How to Back Up a Horse (video)"
    url="https://youtu.be/aolJGYfOZI0" >}}

## Requirement 11g

{{< drg/requirement number="11g" >}}
Halt and dismount.
{{< /drg/requirement >}}
...
{{< drg/video
    title="Mount and Dismount a Horse (video)"
    url="https://youtu.be/vBdXfiNXu7I?si=Cb12AYTlH2J_lbtg" >}}
...
{{< drg/checklist title="What Harmony Looks Like" subtitle="Signs that horse and rider are working together" >}}
...
{{< drg/safety-first >}}
Always follow the instructions of your counselor or riding instructor about helmets, arena spacing, and whether the horse is ready to trot or jog. Riding skills should be practiced on a suitable horse in a controlled setting.
{{< /drg/safety-first >}}

{{< drg/tip >}}
Pick a point ahead when riding straight lines. Your horse often follows where your eyes and shoulders point, so looking past the end of the line helps you stay straighter.
{{< /drg/tip >}}

{{< drg/be-prepared title="The Horse Drifts Off the Line" >}}
You ask for a straight walk, but the horse keeps drifting toward the rail.

- **Check yourself first:** Are your eyes, shoulders, and reins even?
- **Support with both legs:** A drifting horse often needs clearer guidance from the rider's body.
- **Make a quiet correction:** Avoid sudden pulling.
- **Try again with a clear destination:** Ride toward a visible point.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="United States Pony Clubs — Horsemanship Education"
    url="https://ponyclub.org/"
    description="Educational horsemanship resources that reinforce position, safety, and riding fundamentals." >}}
...
{{< drg/next-page
    text="You now understand the riding movements that show balance, control, and harmony with the horse."
    teaser="Choose your final path: horse careers or horsemanship as a hobby and healthy lifestyle."
