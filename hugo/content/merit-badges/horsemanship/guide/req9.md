...
{{< drg/image src="images/saddle-and-bridle-parts-diagram.avif" alt="Labeled diagram of a saddled and bridled horse showing major saddle and bridle parts in place" >}}

{{< drg/video
    title="Parts of a Saddle (video)"
    url="https://www.youtube.com/watch?v=CXkV6LxGJF8" >}}
...
{{< drg/checklist title="Ten Useful Tack Parts" subtitle="A practical starter list for this requirement" >}}
...
{{< drg/video
    title="How to Saddle a Horse (video)"
    url="https://youtu.be/MZHl9zBHD10" >}}

{{< drg/video
    title="How to Bridle a Horse (video)"
    url="https://youtu.be/sI7A5aTFUnE" >}}

{{< drg/safety-first >}}
Always check the girth or cinch again before mounting. A loose saddle can shift dangerously when you put weight in the stirrup.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/mounting-block-safe-mount-sequence.avif" alt="Three-panel sequence showing preparation at the mounting block, stepping into the stirrup, and mounting softly into the saddle" >}}

{{< drg/video
    title="Using a Mounting Block and Adjusting Tack (video)"
    url="https://youtu.be/a40XR220wd8?si=yAKM4J6yhQAYZufm" >}}

{{< drg/video
    title="Mounting and Dismounting a Horse (video)"
    url="https://youtu.be/p3T7tUwyNBg?si=Rnuup5QA8iw_DLlU" >}}

{{< drg/video
    title="How to Mount a Horse (video)"
    url="https://youtu.be/CafSxVC-1I8" >}}

{{< drg/video
    title="How to Ride a Horse (video)"
    url="https://youtu.be/NC9Tr2hXfFk?si=-mIGi5Woskl7jBPn" >}}

{{< drg/be-prepared title="The Saddle Slips as You Start to Mount" >}}
You put your foot in the stirrup and feel the saddle move more than expected.

- **Stop immediately:** Do not try to climb on anyway.
- **Step back down:** Keep control of the horse calmly.
- **Check the girth or cinch:** It may need tightening or repositioning.
- **Ask for help if needed:** A second set of eyes is better than taking a chance.
{{< /drg/be-prepared >}}
...
{{< drg/tip >}}
Before naming tack parts to your counselor, picture the whole setup in order from the horse's back or head outward. Visual order helps you remember names much better than memorizing a random list.
{{< /drg/tip >}}

{{< drg/external-link
    title="Horse Illustrated — Basic Tack Cleaning"
    url="https://www.horseillustrated.com/horse-care-tack-cleaning"
    description="A rider-friendly overview of routine tack cleaning and inspection habits." >}}
...
{{< drg/next-page
    text="You now understand tack parts, tack care, and the safe sequence for saddling, bridling, mounting, and dismounting."
    teaser="Next, practice the ground-handling skills that let you approach, lead, and secure a horse safely."
