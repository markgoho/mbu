...
{{< drg/did-you-know >}}
Some vaccines do not just protect the person who gets the shot. They also help protect babies, elders, and people with weakened immune systems who may be at greater risk if a disease spreads.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Do not guess when you talk with your counselor. Bring a current schedule from a reliable source and point to examples from it.
{{< /drg/tip >}}

{{< drg/image src="images/vaccine-memory-cells.avif" alt="Friendly diagram showing a vaccine teaching immune cells to recognize a germ faster the next time" >}}
...
{{< drg/checklist title="When there is no vaccine" subtitle="Ask what public health uses instead" >}}
...
{{< drg/video
    title="How do vaccines help babies fight infections? | How Vaccines Work — Centers for Disease Control and Prevention (CDC)"
    url="https://www.youtube.com/watch?v=k7DGeWlKu0Q" >}}

{{< drg/external-link
    title="CDC — Vaccines for Children and Teens"
    url="https://www.cdc.gov/vaccines-children-teens/vaccinations/teen.html"
    description="A reliable place to review how vaccine recommendations are organized for young people." >}}

{{< drg/external-link
    title="CDC"
    url="https://www.cdc.gov/"
    description="Use the CDC homepage to look up current immunization recommendations and current disease guidance before your counselor discussion." >}}
...
{{< drg/next-page
    text="Next, shift from immunization to sanitation"
    teaser="Requirement 3 shows how safe water, dishwashing, and camp hygiene stop disease before it starts."
