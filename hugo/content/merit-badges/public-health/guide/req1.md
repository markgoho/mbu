...
req_number: "1"
req_path: "1"
prev: "/merit-badges/public-health/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/public-health/guide/req2/"
next_title: "Req 2 — Immunization Basics"
---
...
{{< drg/did-you-know >}}
One contaminated well, one unsafe kitchen, or one broken sewer line can affect hundreds or thousands of people. Public health looks for those shared weak points before they become larger problems.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="American Public Health Association — What Is Public Health?"
    url="https://www.apha.org/"
    description="A leading professional organization for the field. Use it to see how public health connects prevention, policy, education, and community action." >}}
...
{{< drg/tip >}}
If you can finish the sentence "This disease usually reaches people by..." you are halfway to explaining how to prevent it.
{{< /drg/tip >}}

{{< drg/image src="images/disease-transmission-routes.avif" alt="Diagram showing foodborne, vector-borne, respiratory, bloodborne, and wound-entry transmission routes with simple icons" >}}

## Requirement 1c

{{< drg/inherited-requirement number="1c" req_path="1.c" topic="Choose any four of the following diseases and explain how each one is contracted and possibly prevented: gonorrhea, West Nile virus, botulism, influenza, syphilis, hepatitis, emphysema, meningitis, herpes, or lead poisoning." />}}
...
{{< drg/checklist title="A strong way to choose your four" subtitle="Pick diseases that let you show different routes of transmission and prevention" >}}
...
{{< drg/tip >}}
If you choose **hepatitis** or **meningitis**, say out loud that the answer depends on the type. That shows your counselor you understand those names describe a group of illnesses, not one single transmission route.
{{< /drg/tip >}}

## Requirement 1d

{{< drg/inherited-requirement number="1d" req_path="1.d" topic="For all 10 diseases from 1(c), explain the type or form of the disease (viral, bacterial, environmental, toxin), any possible vectors for transmission, ways to help prevent exposure or the spread of infection, and available treatments." />}}
...
{{< drg/be-prepared title="How to present 1d to your counselor" >}}
Come with a simple comparison chart and be ready to talk through patterns.

- **Group the bacterial diseases together** so treatment differences stand out
- **Point out the viral diseases** and explain why prevention matters so much
- **Call out the noninfectious items** like emphysema and lead poisoning
- **Name the only clear vector on this list**: mosquitoes for West Nile virus
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="CDC — Clean Hands"
    url="https://www.cdc.gov/clean-hands/about/index.html"
    description="A useful reminder that many infectious-disease prevention strategies begin with handwashing and other basic hygiene habits." >}}

{{< drg/external-link
    title="CDC — Tick Bite Prevention"
    url="https://www.cdc.gov/ticks/prevention/index.html"
    description="Helpful for comparing true vector-borne transmission with diseases that spread by other routes." >}}
...
{{< drg/next-page
    text="Next, turn from disease spread to disease prevention"
    teaser="Requirement 2 focuses on immunization, why it matters, and where vaccines fit into the bigger public health picture."
