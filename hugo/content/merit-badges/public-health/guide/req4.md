...
{{< drg/checklist title="Simple vector control that Scouts can do" subtitle="Small actions can lower risk fast" >}}
...
{{< drg/tip >}}
When your counselor asks which vectors individuals can control, do not answer "all of them" or "none of them." Explain the difference between local habits and bigger infrastructure problems.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Do not handle wild rodents, nests, or dead animals with bare hands. If you find a serious infestation or a pest-control issue involving chemicals, get an adult involved and follow local guidance. The goal is safer conditions, not risky heroics.
{{< /drg/safety-first >}}

{{< drg/image src="images/vector-control-home-camp-community.avif" alt="Three-panel diagram showing mosquito control at home, tick prevention on trail, and community rodent-control sanitation work" >}}

{{< drg/external-link title="CDC — Tick Bite Prevention" url="https://www.cdc.gov/ticks/prevention/index.html" description="Useful guidance for one of the clearest examples of how individuals can lower vector-related disease risk." >}}
...
{{< drg/next-page
    text="Next, choose a real public health system to study"
    teaser="Requirement 5 lets you compare waste management and food service, then pick the field investigation that interests you most."
