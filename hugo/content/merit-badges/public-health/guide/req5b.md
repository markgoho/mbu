...
{{< drg/inherited-requirement number="5b1" req_path="5.b.1" topic="Observe food preparation, handling, and storage. Learn how the facility keeps food from becoming contaminated." />}}
...
{{< drg/checklist title="What to notice during your visit" subtitle="Look for signs that contamination is being prevented on purpose" >}}
...
{{< drg/inherited-requirement number="5b2" req_path="5.b.2" topic="Find out what conditions allow microorganisms to multiply in food, what can be done to help prevent them from growing and spreading, and how to kill them." />}}
...
{{< drg/did-you-know >}}
A pan of food can look hot on the outside and still be unsafe in the middle. That is why public health guidance depends on internal temperature, not appearance.
{{< /drg/did-you-know >}}

{{< drg/image src="images/food-safety-danger-zone.avif" alt="Food thermometer inserted into different foods with a labeled danger zone temperature band and arrows for chill fast and cook thoroughly" >}}
...
{{< drg/tip >}}
If you want one of the strongest takeaways from this entire option, remember this: "Hot enough" is not a feeling. It is a measured temperature.
{{< /drg/tip >}}

{{< drg/video
    title="The Importance of Cooking to a Safe Internal Temperature and How to Use a Food Thermometer — USDAFoodSafety"
    url="https://www.youtube.com/watch?v=-2KkV2yFiN0" >}}

## Requirement 5b4

{{< drg/requirement number="5b4" >}}
...
{{< drg/be-prepared title="How to organize your counselor discussion" >}}
Bring notes under three headings.

- **What I observed**: storage, prep, cleaning, temperatures, staff habits
- **Why it matters**: how each habit stops contamination or microbial growth
- **What surprised me**: one thing you never noticed before your visit
{{< /drg/be-prepared >}}

{{< drg/external-link title="FDA — Safe Food Handling" url="https://www.fda.gov/food/buy-store-serve-safe-food/safe-food-handling" description="Clear guidance on contamination prevention, cooking, chilling, and kitchen sanitation." >}}
...
{{< drg/next-page
    text="Next, move from inspection visits to broader health risks"
    teaser="Requirement 6 compares pollution hazards with the harms caused by tobacco, alcohol, and drug misuse."
