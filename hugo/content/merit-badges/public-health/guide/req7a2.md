...
{{< drg/checklist title="A smart way to study the website" subtitle="Collect examples you can bring into Requirement 7b" >}}
...
{{< drg/tip >}}
If the local agency website is thin, compare it with your state health department or a federal site like the CDC. That can help you see the same mission at different levels of government.
{{< /drg/tip >}}

{{< drg/external-link title="CDC" url="https://www.cdc.gov/" description="A strong example of how a public health agency organizes outbreak updates, prevention guidance, data, and public resources." >}}
...
{{< drg/next-page
    text="Now build on your agency research"
    teaser="Requirement 7b asks you to explain how public health agencies respond to mortality, outbreaks, and disasters."
