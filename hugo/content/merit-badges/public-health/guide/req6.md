...
{{< drg/safety-first >}}
Hearing damage is often permanent. If you need to shout to be heard at arm's length, the environment may be loud enough to harm your ears over time. Use hearing protection around loud equipment, concerts, engines, and tools.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Secondhand smoke is not just unpleasant. It exposes nearby people to many of the same harmful chemicals the smoker inhales directly.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Patterns to mention in your discussion" subtitle="Show that you understand both immediate and long-term harm" >}}
...
{{< drg/external-link title="CDC — Health Effects of Tobacco Use" url="https://www.cdc.gov/tobacco/about/health-effects.html" description="A clear overview of how tobacco affects multiple body systems and why secondhand exposure matters." >}}

{{< drg/external-link title="NIDA — Drug Use and Addiction" url="https://nida.nih.gov/publications/drugfacts/understanding-drug-use-addiction" description="A reliable explanation of how misuse and addiction affect the brain, behavior, and health." >}}
...
{{< drg/next-page
    text="Next, investigate the agencies that put public health into action"
    teaser="Requirement 7 starts by helping you choose whether to visit a health agency in person or study its website carefully."
