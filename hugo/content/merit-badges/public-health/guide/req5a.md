...
{{< drg/checklist title="Questions to ask during the visit" subtitle="These help you turn observations into a better explanation" >}}
...
{{< drg/image src="images/wastewater-treatment-flow.avif" alt="Simple step-by-step diagram from incoming sewage to treated water discharge with public-health notes at each stage" >}}
...
{{< drg/tip >}}
Bring notes, a sketch of the process, or a short list of observations. Specific details make your counselor conversation much stronger than saying only, "It was interesting."
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Always follow the rules for the specific park, forest, or backcountry area you are in. Some fragile or high-use areas require pack-out systems even when other places allow catholes. Using the wrong method can damage the area and put other campers at risk.
{{< /drg/safety-first >}}

{{< drg/external-link title="EPA — Facts and Figures about Materials, Waste and Recycling" url="https://www.epa.gov/facts-and-figures-about-materials-waste-and-recycling" description="Useful context for understanding how large the solid-waste challenge is and why safe management matters." >}}

If this option is not the one you plan to do, compare it with the food-service option next. If it is your choice, the next page still helps you see how public health works in another everyday system.

{{< drg/next-page
    text="Compare this infrastructure-focused option with a food-safety investigation"
    teaser="Req 5b moves from pipes and disposal systems to kitchens, storage, and contamination control."
