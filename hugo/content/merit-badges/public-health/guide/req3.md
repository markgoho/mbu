...
{{< drg/did-you-know >}}
Many waterborne illnesses do not start with dramatic symptoms right away. A Scout can drink unsafe water on Saturday and feel sick hours or even days later.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="What to show in your demonstration" subtitle="Make your counselor discussion practical" >}}
...
{{< drg/safety-first >}}
Never assume that clear, cold, or fast-moving water is automatically safe. Also, do not treat water in a container that previously held fuel or chemicals. A good purification method cannot fix chemical contamination from the wrong bottle.
{{< /drg/safety-first >}}

{{< drg/image src="images/camp-water-treatment-methods.avif" alt="Scout comparing boiling water on a stove and pumping through a backpacking filter with labeled pros and limits" >}}
...
1. **Scrape food scraps first.** Less food left on dishes means less organic material for germs.
2. **Wash in hot, soapy water.** This removes grease and visible dirt.
3. **Rinse in clean water.** Soap left behind is unpleasant and can interfere with sanitation steps.
4. **Sanitize when appropriate.** Follow the guidance your unit and counselor use for camp sanitation.
5. **Air-dry completely.** Towels can spread contamination if they are dirty. Air-drying is usually safer than wiping everything dry with the same cloth.
...
{{< drg/tip >}}
If your patrol keeps getting lazy at cleanup time, remind everyone that dishwashing is not just a chore. It is one of the easiest ways to prevent diarrhea, vomiting, and a miserable campout.
{{< /drg/tip >}}

{{< drg/video
    title="How to Filter Water in the Backcountry || REI — REI"
    url="https://www.youtube.com/watch?v=Kb_6eXF8kVE" >}}

{{< drg/external-link title="CDC — Making Water Safe in the Outdoors" url="https://www.cdc.gov/drinking-water/about/making-water-safe-outdoors.html" description="A practical guide to outdoor water treatment methods and what each method can and cannot do." >}}
...
{{< drg/next-page
    text="Next, look at disease carriers instead of water sources"
    teaser="Requirement 4 explains vectors, why mosquitoes and rodents matter, and what individuals and communities can do to control them."
