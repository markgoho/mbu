...
{{< drg/checklist title="A strong comparison for your counselor" subtitle="Use this structure when you organize your notes" >}}
...
{{< drg/tip >}}
If your counselor asks for the agency's role, answer with verbs: **track, investigate, communicate, coordinate, and prevent**.
{{< /drg/tip >}}

{{< drg/video
    title="CDC NERD Academy Student Quick Learn: How is an outbreak investigated? — Centers for Disease Control and Prevention (CDC)"
    url="https://www.youtube.com/watch?v=kYFIqTbRd2o" >}}
...
{{< drg/be-prepared title="A disaster example to think through" >}}
Imagine a major flood in your county.

- **Immediate public health needs**: safe water, shelter sanitation, injury prevention, food safety
- **Next-step needs**: mold cleanup guidance, mosquito control, waste removal, health messaging
- **Longer recovery**: monitoring water systems, mental health support, rebuilding safer systems
{{< /drg/be-prepared >}}

{{< drg/external-link title="ASTHO — State and Territorial Public Health" url="https://www.astho.org/" description="A helpful resource for understanding how public health agencies work at the state level during everyday operations and emergencies." >}}

You have now looked at public health as a system of prevention, response, and recovery. The last badge requirement asks you to connect that work to a real career path.

{{< drg/next-page
    text="Finish the badge by looking at the people who do this work professionally"
    teaser="Requirement 8 helps you explore a public health career and what it takes to prepare for it."
