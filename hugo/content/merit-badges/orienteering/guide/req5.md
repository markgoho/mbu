...
{{< drg/tip >}}
Most people get a walking pace count between 60 and 70 double-steps per 100 meters. Running usually drops this to 45–55. Write your numbers down — you will need them for every orienteering event.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Military land navigators use pace-counting beads (called "ranger beads") — a set of beads on a cord that they slide with each 100 meters counted. You can make your own from cord and small beads. Slide one bead for every 100 meters completed, and you will never lose track of your distance.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/pace-counting-course.avif" alt="A Scout walking along a measured 100-meter course marked with orange cones on a flat grassy field, counting paces with focused concentration, a notebook in hand for recording counts" >}}

{{< drg/video
    title="Establishing a Pace Count"
    url="https://www.youtube.com/watch?v=YAS9Cc8fhO8" >}}

{{< drg/checklist title="Pace Count Record" subtitle="Fill in after your calibration" >}}
...
{{< drg/next-page
    text="You can now navigate by bearing and measure distance by pace"
    teaser="learn the international symbols and techniques that orienteering competitors use on the course."
