...
{{< drg/safety-first >}}
The safety officer's job is the most critical role at any event. Every competitor must be accounted for at the end of the event — no exceptions. If someone is missing, do not assume they went home early. Begin search procedures immediately.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
If you designed the course for Req 8, officiating at that same event is the most efficient approach. You already know the terrain, the control locations, and the course layout. You can serve as event director, starter, and safety officer all at once for a small troop event.
{{< /drg/tip >}}

{{< drg/image src="images/event-official-start.avif" alt="A Scout wearing a high-visibility vest standing at an event start area, holding a clipboard and stopwatch, briefing two younger Scouts who hold compasses and look attentive" >}}

{{< drg/video
    title="How to Setup a Compass Course"
    url="https://www.youtube.com/watch?v=IfSaBKaau4k" >}}

{{< drg/checklist title="Official's Event Checklist" subtitle="Complete before, during, and after the event" >}}
...
{{< drg/next-page
    text="You have run an event from the official side"
    teaser="complete your badge by teaching orienteering techniques to others."
