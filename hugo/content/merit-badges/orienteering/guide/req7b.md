...
req_number: "7b"
prev: "/merit-badges/orienteering/guide/req7a/"
prev_title: "Orienteering Events"
next: "/merit-badges/orienteering/guide/req8/"
next_title: "Setting Up a Course"
---
...
{{< drg/tip >}}
Keep a running log across all three events. Your weaknesses from Event 1 become practice goals for Event 2. If your report shows you fixed a problem, that is concrete evidence of improvement — and it makes a great discussion point with your counselor.
{{< /drg/tip >}}
...
{{< drg/image src="images/event-report-map.avif" alt="Close-up of an orienteering map with a red line showing a competitor's route, annotations highlighting a wrong turn that lost 3 minutes, and a dotted blue line showing the ideal route for comparison" >}}

{{< drg/did-you-know >}}
Elite orienteers use GPS watches during training (not competition — GPS is banned in races) to record their exact route. Afterward, they upload the data and compare their route to other competitors on platforms like Livelox and 2DRerun. This "route gadget" analysis is the modern version of what you are doing with your paper report.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Orienteering USA — Find Events"
    url="https://orienteeringusa.org/events/"
    description="Search the national event calendar to find orienteering events near you. Filter by state, date, and event type." >}}

{{< drg/next-page
    text="After competing in and analyzing three events"
    teaser="take on the challenge of designing your own orienteering course."
