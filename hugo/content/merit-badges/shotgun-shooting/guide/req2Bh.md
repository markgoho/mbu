...
req_number: "2B-h"
req_path: "2.B.h"
prev: "/merit-badges/shotgun-shooting/guide/req2Bg/"
prev_title: "Loading Procedures and Accessories"
next: "/merit-badges/shotgun-shooting/guide/req2Bi/"
next_title: "Range Procedures and Commands"
---

{{< drg/requirement number="2B-h" >}}
...
- Clogged nipple flash channel (oil, fouling, or debris blocks the flame)
- Moisture in the powder charge
- Insufficient or deteriorated powder
- Defective percussion cap
- Nipple not properly seated
...
- Snap a cap on the empty barrel before loading to clear the flash channel.
- Use fresh, properly stored black powder and caps.
- Keep powder and caps dry—especially on humid or rainy days.
- Clean the nipple regularly during a shooting session.
- Measure the powder charge carefully—never guess.
...
{{< drg/next-page
    text="Failure procedures covered. Time to demonstrate safe behavior on the range."
    teaser="Req 2B-i covers the range procedures and commands specific to muzzleloading shotgun sessions."
