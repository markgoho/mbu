...
{{< drg/image src="images/muzzleloading-shotgun-parts.avif" alt="Labeled diagram of a percussion-cap muzzleloading shotgun showing its main parts" >}}
...
{{< drg/next-page
    text="Parts identified. Now: how to store and handle a muzzleloader safely."
    teaser="Req 2B-c covers the rules for safely storing and handling a muzzleloading shotgun—with some important differences from modern firearms."
