...
- **Your state legislature's website**: Search for your state's firearms statutes. Many states publish a summary or FAQ page.
- **Your state's fish and wildlife agency**: Publishes hunting regulations and often summarizes firearms transport and use laws.
- **Local police department or sheriff's office**: Can direct you to municipal ordinances about firearms.
- **NRA-ILA (Institute for Legislative Action)**: Maintains a state-by-state summary of firearms laws at nraila.org.
...
{{< drg/next-page
    text="Laws govern human behavior with firearms. The next requirement looks at how firearms connect to wildlife."
    teaser="Req 1f explores the relationship between regulated hunting and the wise use of renewable wildlife resources."
