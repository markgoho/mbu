...
{{< drg/next-page
    text="Selection covered. Time for the final challenge: breaking clay targets with a muzzleloader."
    teaser="Req 2B-m is the scored shooting exercise—hit at least 5 out of 15 in each of two groups using the four fundamentals."
