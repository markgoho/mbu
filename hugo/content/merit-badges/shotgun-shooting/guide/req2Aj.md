...
{{< drg/image src="images/shotgun-mount-cheek-shoulder-placement.avif" alt="Side view showing a correct shotgun mount with cheek contact and shoulder placement" >}}
...
{{< drg/video
    title="How to Shoot Trap | Shotgun Tips with Gil Ash — NSSF—The Firearm Industry Trade Association"
    url="https://www.youtube.com/watch?v=yOcxjSEDPmk" >}}

{{< drg/next-page
    text="That completes Option A. Next is the Option B overview for muzzleloading shotgun."
    teaser="Option B covers the history, mechanics, and shooting of a muzzleloading shotgun using black powder."
