...
{{< drg/image src="images/shotgun-pellet-spread-pattern.avif" alt="Diagram showing shotgun pellet spread widening at 10, 20, and 40 yards" >}}
...
{{< drg/next-page
    text="Now that you understand what a projectile is and why it matters, let's cover the rules that apply to every firearm, every time."
    teaser="Req 1b covers the universal rules of safe gun handling—the foundation for everything you'll do on the range."
