...
{{< drg/image src="images/break-action-shotgun-parts.avif" alt="Labeled diagram of a break-action shotgun showing its main parts" >}}
...
{{< drg/next-page
    text="You know the parts and action types. Next: how to store and handle a shotgun safely."
    teaser="Req 2A-b covers the rules for safe storage at home and proper handling on and off the range."
