...
{{< drg/safety-first >}}
Full-size pioneering projects must follow the Guide to Safe Scouting and your counselor's instructions. Height, load, anchoring, supervision, and user traffic all matter. Never climb or cross a structure until a qualified adult has inspected it and approved it.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="Before you build anything, build a safety plan"
    teaser="Learn how to spot hazards, prevent injuries, and respond when something goes wrong on the spar yard."
    url="/merit-badges/pioneering/guide/req1/" >}}
