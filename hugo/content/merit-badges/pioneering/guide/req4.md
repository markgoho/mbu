...
{{< drg/tip >}}
For many pioneering projects, Scouts and counselors like rope that grips well and holds a lashing firmly. That is why a textured rope, often manila or a similar material, is still common in instruction even when stronger synthetic ropes exist.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
A knot or bend can reduce a rope's strength by a surprising amount. That means the number on a rope chart is not the same as the strength of that rope after you tie it into a real project.
{{< /drg/did-you-know >}}
...
1. **Enough strength for the intended load**
2. **Enough grip to hold lashings securely**
3. **Good condition, with no major wear or damage**
...
{{< drg/checklist title="How to care for pioneering rope" subtitle="Simple habits that make rope last longer" >}}
...
{{< drg/safety-first >}}
Do not use rope with severe fraying, rot, melted fibers, or unknown history on any load-bearing pioneering project. If you would not trust it above your own head or hands, do not use it in the structure.
{{< /drg/safety-first >}}
...
{{< drg/video
    title="How to Prepare and Preserve Lashing Ropes and Pioneering Spars (video)"
    url="https://youtu.be/2GfbsP7G5YE?si=VuSeeyD_YzDOVzEO" >}}

{{< drg/image src="images/rope-types-comparison.avif" alt="Side-by-side comparison of natural-fiber and synthetic rope with labels for grip, stretch, weather resistance, and common pioneering uses" >}}

In [Req 5](/merit-badges/pioneering/guide/req5/), you will go a step farther and learn splices, which let you finish or repair rope in ways knots cannot.

{{< drg/next-page
    text="Now that you know how to choose good rope"
    teaser="Learn how back splices, eye splices, and short splices change what a rope can do."
