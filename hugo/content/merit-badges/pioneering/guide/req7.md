...
{{< drg/did-you-know >}}
Many pioneering failures do not start with a snapped lashing. They start with a slow shift at the anchor point that gets worse as more load is added.
{{< /drg/did-you-know >}}
...
- **Three stakes** are set in line with the pull.
- **Two stakes** help distribute the force and support the main line of pull.
- **One anchor point** is created where the load line attaches.
...
{{< drg/checklist title="Questions to ask about any anchor" subtitle="Use these before trusting the system" >}}
...
{{< drg/safety-first >}}
Never assume an anchor is safe just because it is hard to move by hand. Human use creates repeated and changing loads. Test, inspect, and get approval before anyone climbs, crosses, or loads the structure.
{{< /drg/safety-first >}}
...
{{< drg/video
    title="Anchoring Pioneering Projects (video)"
    url="https://youtu.be/_z-GzDAjVZM?si=qyEvV1jFW0nCHHT8" >}}

The rope-making video is also useful here because anchors depend on understanding rope tension, twist, and load path.

{{< drg/video
    title="Making a Rope from Twine (video)"
    url="https://youtu.be/1yb5fqq4dxU?si=Zkl9MOFSFyIRwdwD" >}}

{{< drg/image src="images/anchoring-systems-comparison.avif" alt="Diagram comparing a 3-2-1 anchoring system and a log-and-stake anchoring system with arrows showing direction of pull" >}}

In [Req 8](/merit-badges/pioneering/guide/req8/), you will look at trestles, pole placement, and X braces—the structural pieces that make a project resist movement before the anchors even engage.

{{< drg/next-page
    text="Anchors hold the project in place"
    teaser="Next, learn how trestles, lashings, and braces make the frame itself strong."
