...
{{< drg/inherited-requirement number="2a1" req_path="2.a.1" topic="Making sculpture using the hand-building method" />}}
...
{{< drg/tip >}}
If a sculpture keeps sagging, the problem is often not your idea. The clay may simply be too soft or too smooth for the shape you are trying to build.
{{< /drg/tip >}}

## Requirement 2a2

{{< drg/inherited-requirement number="2a2" req_path="2.a.2" topic="Throwing on the wheel" />}}
...
{{< drg/video
    title="Best Clay for Pottery: Hand-Building, Wheel Throwing & Sculpting Explained (video)"
    url="https://youtu.be/d2l-Aup2QMM?si=WqEsE2JrVKcD5MIK" >}}
...
{{< drg/checklist title="A strong comparison for your counselor" subtitle="Try explaining the two clay bodies side by side" >}}
...
{{< drg/image src="images/clay-body-comparison.avif" alt="A side-by-side diagram comparing rougher groggy hand-building clay with smoother wheel-throwing clay and their matching uses" >}}
...
{{< drg/next-page
    text="You have compared the clay body that fits two very different pottery tasks."
    teaser="Next, learn how three kinds of potter's wheels make that clay move."
