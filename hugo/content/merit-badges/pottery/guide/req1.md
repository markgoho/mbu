...
req_number: "1"
req_path: "1"
prev: "/merit-badges/pottery/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/pottery/guide/req2a/"
next_title: "Req 2a — Clay Bodies for Two Jobs"
---
...
{{< drg/safety-first >}}
Never blow clay dust off a table, apron, or tool with your mouth or compressed air. That only sends the dust into the air where people can breathe it in.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/pottery-safety-setup.avif" alt="A realistic pottery studio worktable arranged for safe use, with wet-cleanup tools, safely stored carving tools, tied-back hair, and a clear safety zone around a kiln" >}}

## Safe Studio Habits

{{< drg/checklist title="Safe Habits Before You Start" subtitle="A quick routine that prevents most pottery accidents" >}}
...
{{< drg/be-prepared title="If the studio starts getting dusty" >}}
If you notice dry dust building up on tables or the floor, pause the project instead of working through it.

- **Step one**: Tell the instructor or experienced adult.
- **Step two**: Wipe surfaces with a damp sponge or cloth.
- **Step three**: Wet mop or wet-clean the floor instead of sweeping.
- **Step four**: Wash your hands before returning to clay.
  {{< /drg/be-prepared >}}

## Official Resource

{{< drg/video
    title="6 Steps to a Safe Pottery Studio (video)"
    url="https://youtu.be/6kH2KWwFW4w?si=cUxiSFBWOp3k5yA0" >}}
...
{{< drg/tip >}}
When you talk with your counselor, use examples from the studio where you are actually working. Saying "In our studio, we wet-mop instead of sweep" sounds stronger than giving a generic safety speech.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have the safety basics every pottery project depends on."
    teaser="Next, compare the kind of clay body that works for hand-built sculpture versus wheel throwing."
