...
{{< drg/tip >}}
A good memory trick is this: **score and slip** go together. Scratch first, then add the wet clay mixture, then press the parts together.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Bone-dry ware looks sturdy, but it can snap or chip very easily. Handle greenware and bone-dry pieces with two hands and a clear path to your shelf.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="A useful way to organize the terms" subtitle="Group them by what they describe" >}}
...
{{< drg/video
    title="Ceramics 101: Clay Vocabulary and Processes (video)"
    url="https://youtu.be/OdUBdRI3Iyw?si=agyum4noQ3XJTzH7" >}}

{{< drg/external-link
    title="Ceramic and Pottery Glossary (website)"
    url="https://lakesidepottery.com/HTML%20Text/Tips/A%20pottery%20glossary.htm"
    description="A browseable glossary you can use to review unfamiliar pottery terms before talking with your counselor." >}}

{{< drg/be-prepared title="If you forget a pottery term in conversation" >}}
Do not panic or guess wildly.

- **Step one**: Connect the word to where it fits in the process.
- **Step two**: Describe what it does or when it happens.
- **Step three**: Use a real example from your own project if possible.
  {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You now speak more of the language of the pottery studio."
    teaser="Next, put that vocabulary into action by building, throwing, and learning about firing."
