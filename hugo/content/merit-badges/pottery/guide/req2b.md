---
title: "How Potters' Wheels Work"
layout: "guide"
group_title: "2. Clay Bodies & Wheels"
req_number: "2b"
req_path: "2.b"
prev: "/merit-badges/pottery/guide/req2a/"
prev_title: "Clay Bodies for Two Jobs"
next: "/merit-badges/pottery/guide/req3/"
next_title: "Drawing Pottery Forms"
---
...
{{< drg/checklist title="How to compare wheel types" subtitle="A quick way to organize your counselor discussion" >}}
...
{{< drg/tip >}}
When you explain wheel types, do not stop at naming them. Say how the motion gets to the wheel head and what the potter experiences while using each one.
{{< /drg/tip >}}

## Official Resources

{{< drg/external-link
    title="Selecting a Potter's Wheel (PDF)"
    url="https://select.schoolspecialty.com/wcsstore/SSICatalogAssetStore/ideas-resources/V2182323.pdf"
    description="A simple overview of wheel features, controls, and practical differences between common models." >}}

{{< drg/external-link
    title="Pottery Wheels - a Buyers Guide (website)"
    url="https://ceramic.school/pottery-wheels/"
    description="A broader comparison of wheel styles, useful for seeing how power, speed, and studio needs affect wheel choice." >}}

{{< drg/image src="images/pottery-wheel-types.avif" alt="A three-part diagram comparing kick, treadle, and electric potter's wheels and how each one drives the wheel head" >}}
...
{{< drg/next-page
    text="You now know three different ways a potter's wheel can create motion."
    teaser="Next, sketch one historical pottery form and one design of your own."
