...
{{< drg/did-you-know >}}
The heat shield tiles used on spacecraft are a kind of advanced ceramic. They are designed to handle temperatures that would destroy many metals or plastics.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    title="What Are Ceramics? (website)"
    url="https://ceramics.org/about/what-are-ceramics/"
    description="An overview from a ceramics organization that shows how pottery connects to engineering, manufacturing, and advanced materials." >}}

{{< drg/tip >}}
A strong answer for this requirement starts broad and then gets specific. First explain that U.S. ceramics includes both art and industry. Then give several non-pottery examples from daily life and technology.
{{< /drg/tip >}}

{{< drg/image src="images/ceramics-industry-grid.avif" alt="A four-part illustration comparing floor tile, a sink fixture, spark plugs, and a technical ceramic part with a handmade mug for scale" >}}
...
{{< drg/next-page
    text="You have zoomed out from studio pottery to the much larger world of ceramics in American life."
    teaser="Next, choose the field experience that fits your interests, schedule, and access."
