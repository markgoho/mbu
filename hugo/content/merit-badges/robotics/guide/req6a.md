...
{{< drg/checklist title="Competition observation notes" subtitle="Use these prompts while you watch" >}}
...
{{< drg/tip >}}
Bring a notebook or phone note page with you. If you wait until later, the details of how teams were organized and managed are easy to forget.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You know what to observe at a live robotics competition"
    teaser="Next, compare three youth leagues so you can explain how the programs differ."
