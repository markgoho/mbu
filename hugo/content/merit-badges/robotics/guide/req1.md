...
{{< drg/checklist title="Safety scan before you begin" subtitle="Run this quick check every time you power up a robot" >}}
...
{{< drg/safety-first >}}
Tie back long hair, remove dangling jewelry, and avoid loose sleeves when working around moving parts. Never reach into a powered robot to “just adjust one thing.” Shut the system down first.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/robotics-ppe-bench.avif" alt="Scout at a robotics workbench with safety glasses, secured hair, and an organized tool layout" >}}

{{< drg/video
    title="Hazards and Robot Safety (video)"
    url="https://youtu.be/7v3cylLL9hw?list=PLHGEvyG5wuthXQZzTc-mLwFrP5F6_1Lce" >}}

{{< drg/tip >}}
When your team starts testing, assign one person to be the caller. That Scout says when power goes on, when hands come off the robot, and when the test is over. Clear communication prevents rushed mistakes.
{{< /drg/tip >}}
...
- **Shut down power and clear people away from the area.**
- **Alert an adult, mentor, or event safety volunteer immediately.**
- **Follow the battery maker's disposal and handling rules.**
{{< /drg/be-prepared >}}

{{< drg/video
    title="How to Treat Cuts and Scrapes (video)"
    url="https://www.youtube.com/watch?v=0jp5FgLmKtk&list=PLHGEvyG5wuthXQZzTc-mLwFrP5F6_1Lce&index=1" >}}

{{< drg/external-link
    title="American Red Cross — Cuts, Scrapes, and Burns"
    url="https://www.redcross.org/take-a-class/resources/learn-first-aid"
    description="A trusted first-aid reference for deciding what you can treat on site and when to get more help." >}}

In [Req 4e](/merit-badges/robotics/guide/req4e/), you will test your own robot. The safer you are now, the easier it will be to test with confidence later.

{{< drg/next-page
    text="You know how to work safely and respond to common injuries"
    teaser="Next, look at what robots actually do, how they are controlled, and how they move."
