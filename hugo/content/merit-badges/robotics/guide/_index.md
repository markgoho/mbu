...
{{< drg/safety-first >}}
Industrial robots can move fast and with great force. In real workplaces, safety cages, emergency stops, and lockout procedures are essential because the machine may not be able to sense a nearby person unless it was designed to do so.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
NASA's Mars rovers are not driven like toy cars. Because radio signals take minutes to travel between Earth and Mars, the rover often has to sense hazards and make short-range decisions on its own.
{{< /drg/did-you-know >}}

{{< drg/image src="images/robotics-collage-overview.avif" alt="Four robotics scenes showing an industrial robot arm, hospital service robot, Mars rover, and student competition robot" >}}

You have the big picture. Next, start with the skill that every good robotics team uses before turning on the power: safety.

{{< drg/next-page
    text="Every successful robot project starts with safe habits"
    teaser="Learn how to spot hazards, choose the right protective gear, and respond to common injuries."
    url="/merit-badges/robotics/guide/req1/" >}}
