...
{{< drg/video
    title="How to Make Anything - Learn to Think Like an Engineer (video)"
    url="https://www.youtube.com/watch?v=IIwTCyu2wS4" >}}

{{< drg/video
    title="Why Try Computer Quilting ? (video)"
    url="https://youtu.be/Z_ftO9LanyI?si=p7e9HkOE8mGD2RpS" >}}

{{< drg/video
    title="How I Built a Difference | My Engineering Journey (video)"
    url="https://youtu.be/PCQHSzoPoO8" >}}

{{< drg/video
    title="Tertill Weeding Robot Overview Video (video)"
    url="https://youtu.be/wAMXnxXa3UU?si=U8BNl3na8OfxNTWd" >}}
...
{{< drg/checklist title="Hobby planning notes" subtitle="Turn the idea into something real" >}}
- Hobby I chose
...
{{< drg/tip >}}
Pick a hobby path that already sounds fun to you. Robotics is easier to keep learning when it supports something you would want to do anyway.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have explored how robotics can grow into a personal hobby"
    teaser="Next, go beyond the requirements with deeper ideas, real-world experiences, and organizations to explore."
    url="/merit-badges/robotics/guide/extended-learning/" >}}
