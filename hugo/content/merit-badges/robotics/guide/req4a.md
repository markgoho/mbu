...
req_number: "4a"
req_path: "4.a"
prev: "/merit-badges/robotics/guide/req4/"
prev_title: "Req 4 — From Idea to Finished Robot"
next: "/merit-badges/robotics/guide/req4b/"
next_title: "Req 4b — Sketch the System"
---
...
1. **A specific job** the robot must accomplish
2. **At least one sensor** that affects behavior
3. **Programming logic** that makes decisions or sequences actions
...
{{< drg/checklist title="Mission definition checklist" subtitle="Use these questions before you ask for counselor approval" >}}
...
{{< drg/tip >}}
When you talk with your counselor, bring two ideas instead of one. If your first idea is too large, you can quickly shift to a simpler backup plan without losing momentum.
{{< /drg/tip >}}

{{< drg/image src="images/robotics-notebook-mission-plan.avif" alt="Open engineering notebook with robot mission statement, sensor notes, and success criteria" >}}

The mission comes first. Next, turn that mission into a design you can actually build.

{{< drg/next-page
    text="You have chosen a realistic robotics mission"
    teaser="Next, sketch the robot, plan its sensors and degrees of freedom, and describe how the system will work."
