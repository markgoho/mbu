...
{{< drg/tip >}}
If the robot is noisy or the demo space is crowded, narrate while it runs: “The distance sensor is reading the wall now. When it gets close enough, the program should stop the drive motors and lift the arm.”
{{< /drg/tip >}}

## Requirement 5b:

{{< drg/inherited-requirement number="5b" req_path="5.b" topic="Share your robot engineering notebook with your counselor. Talk about how well your robot accomplished the task, the improvements you would make in your next design, and what you learned about the design process." />}}
...
{{< drg/checklist title="Demo day checklist" subtitle="Bring these talking points to your counselor" >}}
...
{{< drg/next-page
    text="You have shown the robot and explained the engineering behind it"
    teaser="Next, choose whether to learn from attending a competition or by comparing youth robotics leagues."
