...
{{< drg/tip >}}
The most common mistake beginners make is lifting their head to breathe. When you lift your head, your hips and legs drop, creating drag that slows you down dramatically. Practice breathing by rotating your head to the side — one goggle should stay in the water.
{{< /drg/tip >}}

### 100m vs. 200m: Pacing Strategy

**100 meters (4 lengths of a 25-meter pool):**
This is a sprint. You can afford to go hard from the start. Focus on strong turns, a powerful push-off the wall, and maintaining your stroke technique even as fatigue sets in during the last 25 meters.

**200 meters (8 lengths):**
Pacing matters here. Start at a strong but sustainable effort — about 85–90% of your sprint speed. Save something for the last two lengths. Even splits (swimming each length in roughly the same time) is the goal.

### Training for Swimmers

{{< drg/checklist title="Swim Training Plan" subtitle="Build speed and endurance in the pool" >}}
...
{{< drg/image src="images/swimmer-freestyle.avif" alt="A swimmer doing freestyle in a lane of an outdoor pool, with water splashing cleanly and lane ropes visible" >}}

{{< drg/safety-first >}}
Never swim alone. Always train with a buddy, a coach, or a lifeguard present. Know the depth of the pool before diving. If you feel dizzy, lightheaded, or unusually short of breath, stop swimming and get out of the water immediately.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Competitive swimmers shave their entire bodies before major races. Removing body hair reduces drag and can improve race times by 1–2%. While you definitely do not need to do this for your merit badge, it shows how much every small detail matters at the elite level.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="USA Swimming — Learn to Swim"
    url="https://www.usaswimming.org/parents-resources/learn-to-swim"
    description="Resources and programs from the national governing body for competitive swimming." >}}

{{< drg/next-page
    text="You have explored the fundamentals of competitive swimming."
    teaser="Build raw strength with the next option — pull-ups and push-ups."
