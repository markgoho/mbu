...
{{< drg/did-you-know >}}
Until 1992, the Olympic Games were strictly for amateurs — professional athletes were banned from competing. The rules were relaxed starting with the 1992 Barcelona Olympics, which is why the famous U.S. "Dream Team" in basketball (featuring Michael Jordan, Magic Johnson, and Larry Bird) was able to play for the first time.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When discussing this with your counselor, think about athletes you admire — both amateur and professional. What motivates them? What sacrifices do they make? How is their experience different from yours as a Scout athlete?
{{< /drg/tip >}}

{{< drg/image src="images/amateur-pro-contrast.avif" alt="A split scene showing a Scout running on a school track on the left side and a professional athlete in a stadium with a crowd on the right side, both in mid-stride" >}}

{{< drg/external-link
    title="Scouting America — Amateur vs. Professional (PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Athletics/amateur_vs_professional.pdf"
    description="Official Scouting resource explaining the differences between amateur and professional athletes." >}}

{{< drg/next-page
    text="You now understand the distinction between amateur and professional athletes."
    teaser="Next, explore one of the most important qualities any athlete can have — sportsmanship."
