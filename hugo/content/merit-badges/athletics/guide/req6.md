...
{{< drg/tip >}}
Mix competitive events with fun ones. A field day that is all timed races can feel exhausting. Adding events like tug of war, relay races, or an obstacle course keeps the energy positive and gives everyone a chance to participate regardless of their athletic specialty.
{{< /drg/tip >}}
...
{{< drg/checklist title="Officials and Roles" subtitle="Key positions for a sports meet" >}}
...
{{< drg/checklist title="Equipment Checklist" subtitle="What your meet will need" >}}
...
{{< drg/did-you-know >}}
There are over 750,000 registered high school sports officials in the United States, and the number has been declining. Many sports leagues at all levels face a shortage of referees and officials. Volunteering as a young official is a valuable service to your community.
{{< /drg/did-you-know >}}

{{< drg/be-prepared title="An Athlete Argues a Call" >}}
During the meet, a competitor insists that their long jump was measured incorrectly and becomes upset with you.

- **Stay calm and professional.** Do not argue back or get defensive.
- **Acknowledge their concern.** Say something like, "I understand you feel that way. Let me check the measurement again."
- **Re-measure if appropriate.** If there is any doubt, a second measurement costs nothing and builds trust.
- **If the result stands, explain it clearly.** "The measurement was taken from the takeoff line to the nearest mark in the sand, which is the standard method."
- **Involve the meet director** if the athlete continues to dispute the result.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="National Federation of State High School Associations (NFHS)"
    url="https://www.nfhs.org/resources/officials"
    description="Resources for sports officials, including training courses and certification information." >}}

{{< drg/next-page
    text="You have learned how to plan and officiate a sports meet."
    teaser="Explore careers and lifelong connections to athletics in the final requirement."
