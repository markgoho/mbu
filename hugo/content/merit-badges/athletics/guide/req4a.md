...
{{< drg/checklist title="Rules Research Framework" subtitle="Cover these topics for each activity" >}}
...
{{< drg/image src="images/referee-signals.avif" alt="A referee on an athletics track making an official hand signal, with runners at the starting line in the background" >}}
...
{{< drg/tip >}}
The best way to learn rules is to watch a game and try to identify every rule as it is applied. Watch a track meet, a swim meet, or a basketball game — either in person or on TV — and take notes on what the officials are doing and why.
{{< /drg/tip >}}

{{< drg/did-you-know >}}
The rules of basketball were originally just 13 points long when James Naismith invented the game in 1891. Today, the NBA rulebook is over 70 pages. Sports evolve, and their rules evolve with them.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Rules of Sport"
    url="https://www.rulesofsport.com/"
    description="A comprehensive resource covering the rules of dozens of sports in clear, easy-to-understand language." >}}

{{< drg/next-page
    text="You now understand why rules matter and how to research them for any sport."
    teaser="Next, learn about warming up and cooling down — two of the most important habits in an athlete's routine."
