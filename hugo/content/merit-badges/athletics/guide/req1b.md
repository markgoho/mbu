...
- **R**est — Stop using the injured area immediately.
- **I**ce — Apply a cold pack wrapped in a cloth for 15–20 minutes at a time.
- **C**ompression — Wrap the area with an elastic bandage to reduce swelling (not too tight!).
- **E**levation — Raise the injured area above the level of the heart to help fluid drain away.
...
{{< drg/tip >}}
An easy way to remember the difference: **sprains** happen to **ligaments** (joint connectors), and **strains** happen to **muscles or tendons** (movers and attachers). Both use RICE.
{{< /drg/tip >}}
...
{{< drg/image src="images/rice-method-diagram.avif" alt="An illustrated diagram showing the four steps of the RICE method: Rest, Ice, Compression, and Elevation, each with a simple visual example" >}}
...
{{< drg/did-you-know >}}
Most blisters are completely preventable. Wearing moisture-wicking socks, properly fitted shoes, and applying body glide or petroleum jelly to high-friction areas before activity can eliminate blisters almost entirely.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Do not wait until you are thirsty to drink. By the time you feel thirst, you are already mildly dehydrated. Drink water before, during, and after every practice and event. A good rule of thumb: 7–10 ounces every 10–20 minutes of activity.
{{< /drg/safety-first >}}
...
- **Remove excess clothing** and apply cool, wet towels to their skin.
- **Give small sips of water or sports drink** if they are alert and not vomiting.
- **Monitor closely.** If they become confused, stop sweating, or lose consciousness, call 911 — heat exhaustion may be progressing to heat stroke.
{{< /drg/be-prepared >}}
...
{{< drg/safety-first >}}
There is no such thing as a "minor" concussion. Every concussion is a brain injury. The rule is simple: **when in doubt, sit it out.** An athlete who returns to play too soon after a concussion risks a second, much more dangerous brain injury.
{{< /drg/safety-first >}}

{{< drg/image src="images/sports-first-aid-action.avif" alt="A Scout providing first aid to a teammate on a sports field, applying an ice pack to the teammate's ankle while the teammate sits on a bench" >}}

### Your Athletic First-Aid Kit

In addition to a standard Scout first-aid kit, athletes should carry a few extra items:

{{< drg/checklist title="Athletic First-Aid Additions" subtitle="Items to add for sports activities" >}}
...
{{< drg/external-link
    title="American Red Cross — First Aid Training"
    url="https://www.redcross.org/take-a-class/first-aid"
    description="Find in-person and online first-aid courses near you to build your skills." >}}

{{< drg/next-page
    text="You now know how to recognize and treat the most common athletic injuries."
    teaser="Next, learn why annual physical exams are important for every athlete."
