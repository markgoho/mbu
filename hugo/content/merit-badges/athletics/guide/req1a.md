...
req_number: "1a"
prev: "/merit-badges/athletics/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/athletics/guide/req1b/"
next_title: "Req 1b — First Aid for Athletes"
---
...
{{< drg/tip >}}
Before every practice or event, do a quick mental scan: What is the weather like? Is the equipment in good shape? Did I eat and drink enough today? Have I warmed up? These four questions take 30 seconds and can prevent hours of pain.
{{< /drg/tip >}}
...
{{< drg/checklist title="Injury Prevention Basics" subtitle="Habits that keep you in the game" >}}
...
{{< drg/image src="images/warmup-stretching.avif" alt="A group of Scouts on a grass field doing dynamic stretches together before practice, with a coach standing nearby" >}}

{{< drg/safety-first >}}
Never ignore pain. Pain is your body's warning system. If something hurts during an activity, stop and assess the situation. Pushing through pain often turns a minor issue into a major injury.
{{< /drg/safety-first >}}
...
- **Move to a sturdy building or a hard-topped vehicle.** Open shelters, dugouts, and tents are not safe.
- **Wait at least 30 minutes** after the last flash of lightning or clap of thunder before returning to the field.
- **Never shelter under a lone tree** — trees attract lightning strikes.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    title="Scouting America — Preventing Injuries in Youth Athletes"
    url="https://youtu.be/yC3blqv3kp4?si=TLnyOxBv96ZuyubP"
    description="Video resource on recognizing and preventing common injuries in youth sports." >}}

{{< drg/did-you-know >}}
According to the CDC, more than 2.6 million children visit the emergency room each year for sports- and recreation-related injuries. The most common injuries — sprains, strains, and fractures — are often preventable with proper warm-ups, equipment, and rest.
{{< /drg/did-you-know >}}

{{< drg/image src="images/first-aid-kit-field.avif" alt="A first-aid kit open on a bench next to an athletics track, showing bandages, tape, and an ice pack" >}}

{{< drg/next-page
    text="Now that you know how to anticipate and prevent hazards on the field"
    teaser="learn the specific first-aid skills you need for the most common athletic injuries."
