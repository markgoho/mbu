...
{{< drg/image src="images/myplate-foods.avif" alt="A colorful plate of food arranged to show the five MyPlate food groups: grains, protein, fruits, vegetables, and dairy, on a table with a glass of water" >}}
...
{{< drg/tip >}}
Try the "rainbow rule" — aim to eat fruits and vegetables of as many different colors as possible each day. Different colors usually mean different vitamins and minerals. A plate with red tomatoes, orange carrots, green spinach, and blueberries covers a wide range of nutrients.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Your body cannot produce most vitamins and minerals on its own — you have to get them from food. That is why eating a variety of foods is so important. No single food contains everything you need.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Game Day Without a Plan" >}}
You have an important track meet after school, but you skipped breakfast and had only chips and a soda for lunch. By the time you warm up, you feel lightheaded and sluggish.

- **Prevention is key:** Plan your meals the night before a competition day. Pack a lunch if the cafeteria options are limited.
- **Quick fix:** If you are in a bind, grab a banana, a granola bar, or a small handful of trail mix at least 30 minutes before your event. Pair it with water, not soda.
- **Lesson:** Nutrition is part of your training. Skipping meals before competition is like running on an empty gas tank.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    ...
    description="Interactive tools, quizzes, and meal planning resources to help you build a balanced diet." >}}

{{< drg/next-page
    text="You now understand how to fuel your body for athletic performance."
    teaser="Put it all together — choose your sport and build a personal training program."
