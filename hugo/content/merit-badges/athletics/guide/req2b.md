...
req_number: "2b"
prev: "/merit-badges/athletics/guide/req2a/"
prev_title: "Physical Examinations"
next: "/merit-badges/athletics/guide/req2c/"
next_title: "Balanced Diet"
---
...
{{< drg/tip >}}
Rest does not mean doing nothing. "Active recovery" — a light walk, gentle stretching, or an easy swim — keeps blood flowing to your muscles and speeds up the recovery process without adding stress.
{{< /drg/tip >}}
...
{{< drg/image src="images/healthy-habits-montage.avif" alt="A split image showing a Scout sleeping peacefully at night on one side, and the same Scout drinking water from a bottle during outdoor training on the other side" >}}
...
{{< drg/safety-first >}}
Nicotine is highly addictive. Many people who start using tobacco products as teens find it extremely difficult to quit later. The safest choice is never to start.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
The World Anti-Doping Agency (WADA) maintains a list of banned substances that applies to athletes from youth leagues all the way to the Olympics. Some substances on the list can be found in common over-the-counter supplements and cold medicines. Always check with a doctor before taking any supplement.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    title="CDC — Health Effects of Cigarette Smoking"
    url="https://www.cdc.gov/tobacco/about/health-effects.html"
    description="Detailed information on how tobacco use damages every system in the body." >}}

{{< drg/next-page
    text="You have explored the habits that support athletic performance and the substances that undermine it."
    teaser="Now learn about building a balanced diet that fuels your training."
