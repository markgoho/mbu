...
{{< drg/safety-first >}}
When ABS activates, do not lift your foot off the brake pedal. Press and hold firmly — the system will do the modulating for you. ABS helps you steer while braking hard, but it does not reduce stopping distances on all surfaces. On gravel or deep snow, ABS may actually increase stopping distance slightly.
{{< /drg/safety-first >}}

{{< drg/video title="Understanding ABS" url="https://youtu.be/98DXe3uKwfc?si=G4NpfHoDLA1k-_qu" >}}
...
{{< drg/did-you-know >}}
The front brakes do the majority of the stopping work because when you brake, the vehicle's weight shifts forward. This is why front brake pads typically wear out about twice as fast as rear brake pads — and why front brakes are almost always disc brakes for better performance.
{{< /drg/did-you-know >}}

{{< drg/image src="images/disc-vs-drum-brakes.avif" alt="A side-by-side comparison showing a cutaway of a disc brake system (rotor, caliper, and brake pad) on the left and a drum brake system (drum, brake shoes, and wheel cylinder) on the right, with key parts labeled" >}}

{{< drg/video title="Disc vs Drum Brakes" url="https://youtu.be/RAQcvP07RHE?si=ppH7voCgequLWmeo" >}}
...
{{< drg/checklist title="Brake Inspection Checklist" subtitle="What to check and what to look for" >}}
...
{{< drg/be-prepared title="Your Brakes Start Grinding" >}}
If you hear a grinding noise when braking:

- **Reduce your speed** and drive cautiously. Avoid sudden or hard braking if possible.
- **Get the vehicle inspected immediately.** Grinding means metal-on-metal contact, which damages the rotors and reduces braking effectiveness.
- **Do not drive long distances.** Get to a repair shop or home as soon as safely possible.
- The repair will likely include new brake pads and possibly new or resurfaced rotors.
{{< /drg/be-prepared >}}

{{< drg/image src="images/brake-pad-inspection.avif" alt="A gloved hand pointing to a brake pad visible through the wheel spokes of a vehicle, with a ruler or caliper showing the pad thickness measurement" >}}

{{< drg/video title="How to Check Brake Pads and Rotors" url="https://youtu.be/WzXjTrMu3lg?si=WU6olZplgEwSJXrU" >}}

{{< drg/external-link title="Brake Safety — National Highway Traffic Safety Administration" url="https://www.nhtsa.gov/equipment/vehicle-brakes" description="NHTSA information on brake safety, recalls, and when to have your brakes serviced." >}}

{{< drg/next-page text="You now understand the brake system — how it works, disc vs. drum, and how to inspect it." teaser="Time to get hands-on with two practical projects of your choice." url="/merit-badges/automotive-maintenance/guide/req11/" >}}
