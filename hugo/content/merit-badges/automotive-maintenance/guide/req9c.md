---
title: "Fluids & Drive Configurations"
layout: guide
group_title: "9. Drive Train"
req_number: "9c"
prev: "/merit-badges/automotive-maintenance/guide/req9a/"
prev_title: "Drive Train & Transmissions"
next: "/merit-badges/automotive-maintenance/guide/req10/"
next_title: "Brakes"
---
...
{{< drg/safety-first >}}
Automatic transmission fluid is a petroleum product and should be handled with care. Wear gloves, avoid skin contact, and dispose of used ATF at a recycling center or auto parts store — never pour it down a drain or into the ground.
{{< /drg/safety-first >}}
...
{{< drg/video title="The Complexities of Automatic Transmission Fluid" url="https://youtu.be/0jnewEGKAp0?si=coMA15wWraII-t2m" >}}
...
{{< drg/tip >}}
Differential and transfer case fluid changes are often overlooked because they are not on the "basic" maintenance list most people follow. But these fluids break down over time just like engine oil. If you hear whining, humming, or grinding from the rear axle or transfer case, worn-out fluid could be the cause.
{{< /drg/tip >}}

{{< drg/video title="Which Fluids to Use" url="https://youtu.be/3le9ZT5HUlk?si=WmA2BT2KcmgCqFqe" >}}
...
{{< drg/did-you-know >}}
The terms "4WD" and "AWD" are often used interchangeably, but they are different systems. Traditional 4WD uses a transfer case with a locking mechanism and is designed for off-road use. AWD uses a center differential or electronic coupling and is designed for on-road traction in rain, snow, and varying conditions. Some modern vehicles blur the line by offering both capabilities.
{{< /drg/did-you-know >}}

{{< drg/image src="images/drive-configurations.avif" alt="A three-panel top-down diagram showing FWD (front wheels shaded, power arrows pointing to front), RWD (rear wheels shaded, drive shaft visible), and 4WD/AWD (all four wheels shaded, transfer case visible) with labels for each configuration" >}}

{{< drg/video title="Ultimate Drive Train Guide" url="https://youtu.be/-cTJqNWwmf0?si=qapozBPNfBih0PCY" >}}

{{< drg/external-link title="Kelley Blue Book — FWD vs RWD vs AWD" url="https://www.kbb.com/car-advice/awd-vs-fwd-vs-rwd/" description="A clear comparison of drive configurations with recommendations for different driving needs and climates." >}}

{{< drg/next-page text="You now understand the drive train, transmissions, fluids, and drive configurations." teaser="Next up: the brake system — how your vehicle actually stops." url="/merit-badges/automotive-maintenance/guide/req10/" >}}
