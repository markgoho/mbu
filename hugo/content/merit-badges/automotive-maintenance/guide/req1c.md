...
You will learn much more about how internal combustion engines work in [Requirement 5a](/merit-badges/automotive-maintenance/guide/req5a/).
...
{{< drg/did-you-know >}}
Rudolf Diesel, the inventor of the diesel engine in 1893, originally designed it to run on peanut oil. Modern diesel engines can actually run on biodiesel made from vegetable oils, used cooking grease, and other renewable sources.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Electric and plug-in hybrid vehicles contain high-voltage battery systems that can be lethal. Never attempt to service, open, or touch any orange-colored cables, connectors, or components — these indicate high-voltage circuits. We will cover high-voltage safety in detail in Requirement 1d on this page.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
When discussing vehicle power types with your counselor, be ready to compare them. Think about fuel source, how the engine or motor works, maintenance requirements, environmental impact, and availability of fuel or charging infrastructure. A simple comparison chart can be a great visual aid.
{{< /drg/tip >}}

{{< drg/image src="images/vehicle-power-types.avif" alt="Five vehicles side by side in a dealership lot: a gasoline sedan, a diesel pickup truck, a hybrid SUV, a battery electric car at a charging station, and a hydrogen fuel cell vehicle — all clearly labeled" >}}
...
{{< drg/safety-first >}}
High-voltage vehicle components can deliver a fatal electric shock. Only trained, qualified technicians with specialized insulated tools and high-voltage PPE should service these systems. As a Scout, you should learn to **identify and avoid** high-voltage components — not service them.
{{< /drg/safety-first >}}
...
- **Call 911.** Tell the dispatcher that it is an electric or hybrid vehicle with a possible battery fire.
- **Do not use water** from a garden hose. Lithium-ion battery fires require large amounts of water or specialized suppression agents that only fire departments have.
- **Do not return to the vehicle** until emergency responders clear the scene.
{{< /drg/be-prepared >}}

{{< drg/video title="Working on High Voltage Vehicles" url="https://youtu.be/t_jDdsC5UBc?si=X3i6HvfGoSnFMV05" >}}

{{< drg/video title="Difference Between Diesel and Gas Engines" url="https://youtu.be/rlK7JIAz9WY?si=zlHbl7TXVzW_9W0K" >}}

{{< drg/external-link title="Alternative Fuels Data Center — U.S. Department of Energy" url="https://afdc.energy.gov/vehicles" description="Comprehensive information on alternative fuel vehicles including electric, hydrogen, biodiesel, and more." >}}

{{< drg/image src="images/high-voltage-warning.avif" alt="Close-up of an orange high-voltage cable and connector under the hood of a hybrid vehicle, with a high-voltage warning sticker clearly visible" >}}

{{< drg/next-page text="You now understand how vehicles are powered and how to stay safe around high-voltage systems." teaser="Learn about maintenance schedules and why safety restraints matter." url="/merit-badges/automotive-maintenance/guide/req1e/" >}}
