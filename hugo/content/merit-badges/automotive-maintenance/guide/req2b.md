...
req_number: "2b"
prev: "/merit-badges/automotive-maintenance/guide/req2a/"
prev_title: "Req 2a — Checking Fluids"
next: "/merit-badges/automotive-maintenance/guide/req2d/"
next_title: "Req 2d — Lights & Air Filters"
---
...
{{< drg/safety-first >}}
Always replace a blown fuse with one of the **exact same amperage rating**. Installing a higher-rated fuse defeats the protection — the wiring could overheat and start a fire before the fuse blows.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Keep a small assortment of spare fuses in your glove compartment. Many auto parts stores sell variety packs with multiple sizes and amperage ratings. If the same fuse blows again after replacement, there is an underlying electrical problem that needs professional diagnosis — do not keep replacing fuses.
{{< /drg/tip >}}

{{< drg/video title="How to Check Car Fuses" url="https://youtu.be/PF5G4llnvQs?si=TTLfI1ev6g2UtMw-" >}}

{{< drg/image src="images/fuse-box-inspection.avif" alt="A Scout using a fuse puller to remove a blade fuse from a vehicle's interior fuse box, with the fuse box diagram visible on the inside of the cover panel" >}}
...
{{< drg/did-you-know >}}
A single serpentine belt typically costs $25 to $75, but if it breaks while you are driving, the engine can overheat within minutes (because the water pump stops) and the battery will drain (because the alternator stops). Replacing a belt on schedule is far cheaper than the damage a broken belt can cause.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/belt-hose-inspection.avif" alt="A gloved hand squeezing a radiator hose to check its condition, with the serpentine belt and pulleys visible in the background of the engine bay" >}}

{{< drg/video title="How to Inspect Belts" url="https://youtu.be/XlUK0XDpCSY?si=mPiotbFHaGk0grht&t=20" >}}

{{< drg/video title="How to Check Serpentine Belt" url="https://youtu.be/Clv2ZlS3hB0?feature=shared" >}}

{{< drg/external-link title="Gates — Belt & Hose Inspection Guide" url="https://www.gates.com/us/en/knowledge-center/resource-library/catalogs/automotive-belts-and-hoses.html" description="Gates is a leading manufacturer of belts and hoses. Their inspection guide shows exactly what wear looks like." >}}

{{< drg/next-page text="You can now check fuses, belts, and hoses — three systems that are easy to inspect and critical to vehicle reliability." teaser="Learn how to check your vehicle's lights and air filters." url="/merit-badges/automotive-maintenance/guide/req2d/" >}}
