...
req_number: "5a"
prev: "/merit-badges/automotive-maintenance/guide/req4c/"
prev_title: "Req 4c — Alignment, Wear & Disposal"
next: "/merit-badges/automotive-maintenance/guide/req5b/"
next_title: "Req 5b — Engine Oil"
---
...
{{< drg/tip >}}
An easy way to remember the four strokes is the phrase: **"Suck, Squeeze, Bang, Blow."** Intake sucks in the mixture, compression squeezes it, the power stroke is the bang, and exhaust blows out the gases.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
A diesel engine compresses air to roughly twice the pressure of a gasoline engine. This extreme compression heats the air inside the cylinder to over 900°F — hot enough to ignite diesel fuel instantly without any spark. This is why diesel engines are sometimes called "compression-ignition" engines.
{{< /drg/did-you-know >}}

{{< drg/image src="images/four-stroke-cycle.avif" alt="A four-panel diagram showing the four strokes of an internal combustion engine: intake (piston moving down with air-fuel entering), compression (piston moving up), power (explosion pushing piston down), and exhaust (piston pushing gases out)" >}}
...
{{< drg/tip >}}
Because hybrids use regenerative braking so extensively, their conventional brake pads often last much longer than those on a gasoline-only vehicle — sometimes 80,000 to 100,000 miles or more. The trade-off is that brake rotors can sometimes develop rust or corrosion from infrequent use.
{{< /drg/tip >}}

{{< drg/image src="images/hybrid-powertrain-diagram.avif" alt="A simplified diagram of a hybrid vehicle showing the gasoline engine, electric motor, battery pack, and regenerative braking system with arrows indicating energy flow" >}}

{{< drg/video title="Engines 101: Basics of How Engines Work" url="https://youtu.be/gqK3dCpwzxE?si=UPmmasiMdCvH9Z18" >}}

{{< drg/video title="Engines 101: How Does a Diesel Engine Work" url="https://youtu.be/PFKppLZNVuU?si=IXxylkf44UZj8UOt" >}}

{{< drg/video title="How Hybrid Cars Work" url="https://youtu.be/hRYWqdiUlbA?feature=shared" >}}

{{< drg/external-link title="U.S. Department of Energy — How Hybrid Electric Vehicles Work" url="https://afdc.energy.gov/vehicles/how-do-hybrid-electric-cars-work" description="Clear explanation of hybrid vehicle technology from the Department of Energy's Alternative Fuels Data Center." >}}

{{< drg/next-page text="You now understand how gasoline, diesel, and hybrid engines work." teaser="Learn about engine oil — what it does, how to read the labels, and why using the right oil matters." url="/merit-badges/automotive-maintenance/guide/req5b/" >}}
