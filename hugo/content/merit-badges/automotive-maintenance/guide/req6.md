...
{{< drg/safety-first >}}
Never mix different types of coolant unless the manufacturer specifically says it is safe. Mixing incompatible coolants can create a gel-like substance that clogs passages and causes overheating. Always check the owner's manual for the correct coolant specification.
{{< /drg/safety-first >}}

{{< drg/tip >}}
Coolant has a sweet taste and smell that attracts pets and wildlife, but it is highly toxic — even a small amount can be fatal. Clean up any spills immediately and store coolant containers with tight, sealed lids in a secure location.
{{< /drg/tip >}}

{{< drg/image src="images/coolant-types.avif" alt="Three different bottles of antifreeze/coolant (green, orange, and yellow) sitting on a workbench next to a vehicle with an open hood, showing the coolant reservoir" >}}

{{< drg/video title="Role of Antifreeze/Coolant" url="https://youtu.be/E6UieoMzvxM?si=5IYkQMMWHf8N-LIf" >}}
...
{{< drg/checklist title="Coolant Flush Steps" subtitle="General procedure (always consult the vehicle's owner's manual)" >}}
...
{{< drg/safety-first >}}
Used coolant is toxic and an environmental hazard. Never pour it down a drain, onto the ground, or into the trash. It must be disposed of properly — most auto parts stores and recycling centers accept used coolant for free.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Modern "long-life" coolants (OAT and HOAT formulations) can last up to 150,000 miles or 10 years in some vehicles. Older green IAT coolant typically needed to be changed every 2 years or 30,000 miles. Always follow your specific vehicle's maintenance schedule rather than assuming all coolants last the same.
{{< /drg/did-you-know >}}

{{< drg/image src="images/coolant-flush-drain.avif" alt="A drain pan catching old greenish coolant from a radiator petcock, with a gloved hand operating the valve and the underside of the vehicle visible above" >}}

{{< drg/video title="Flushing and Filling Your Coolant System" url="https://youtu.be/XdyZDw7jOP0?si=erJ4Yd2RGSk2-DGB" >}}

{{< drg/external-link title="Earth911 — How to Recycle Antifreeze" url="https://earth911.com/recycling-guide/how-to-recycle-antifreeze/" description="Find antifreeze recycling locations near you and learn about the recycling process." >}}

{{< drg/next-page text="You understand the cooling system — why coolant matters, how to choose the right type, and how to flush and dispose of it safely." teaser="Next, learn how air and fuel work together to power your engine." url="/merit-badges/automotive-maintenance/guide/req7/" >}}
