...
{{< drg/did-you-know >}}
Synthetic oil is not actually "made" from oil at all — it is engineered in a lab from chemical compounds. Because its molecules are uniform in size and shape, synthetic oil flows better in cold weather, resists breakdown at high temperatures, and lasts longer than conventional oil. Most new vehicles are designed to use synthetic or synthetic-blend oil.
{{< /drg/did-you-know >}}

{{< drg/image src="images/oil-bottle-labels.avif" alt="Close-up of an engine oil bottle showing the API donut certification mark and the SAE viscosity grade label, with callout arrows explaining each part" >}}

{{< drg/video title="API Motor Oil Ratings Explained" url="https://youtu.be/zOm_qlge9sE?si=Cmjw88X-dBXCAZC-" >}}

{{< drg/video title="What Do SAE Grades Mean" url="https://youtu.be/I09djHVZbaw?si=iAYgnRyx2mwjtNF2" >}}
...
{{< drg/tip >}}
When performing or observing an oil change, always check the oil level with the dipstick after adding the recommended amount. Add oil slowly — it is easy to add more but difficult to remove excess oil. Overfilling can cause foaming and loss of proper lubrication.
{{< /drg/tip >}}

{{< drg/video title="Choosing the Correct Engine Oil" url="https://youtu.be/UdzbRMy0sYU?si=K1C5G09GxYyQ3Q-m" >}}

{{< drg/external-link title="API Motor Oil Guide" url="https://www.api.org/products-and-services/engine-oil/eolcs-categories-and-documents/motor-oil-guide" description="The American Petroleum Institute's official guide to motor oil categories and certifications." >}}

{{< drg/next-page text="You now understand engine oil — its purpose, how to read the labels, and where to find the right specifications." teaser="Next up: the cooling system that keeps your engine from overheating." url="/merit-badges/automotive-maintenance/guide/req6/" >}}
