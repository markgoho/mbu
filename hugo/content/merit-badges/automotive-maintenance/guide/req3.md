...
- **Turn on the heater** to full blast. This sounds strange, but the heater core acts as a small radiator and helps pull heat away from the engine.
- **Pull over safely** as soon as possible. Turn off the engine and let it cool for at least 15 to 20 minutes.
- **Do not open the radiator cap** while the engine is hot. The system is under pressure and can spray boiling coolant.
- Call for assistance if the vehicle cannot be driven safely.
{{< /drg/be-prepared >}}

{{< drg/video title="Understanding the Car Gauges" url="https://youtu.be/EDZbQdvM-dI?feature=shared" >}}

{{< drg/image src="images/instrument-cluster-labeled.avif" alt="A modern vehicle instrument cluster with labeled callouts pointing to each gauge: fuel gauge, speedometer, tachometer, oil pressure, and engine temperature" >}}
...
{{< drg/tip >}}
When you turn the key to "ON" (without starting the engine), all warning lights should briefly illuminate. This is a **bulb check**. If a warning light does not come on during this test, the bulb may be burned out — and you would never know if that system had a real problem later.
{{< /drg/tip >}}

{{< drg/video title="Dashboard Warning Lights Explained" url="https://youtu.be/DswOF-reMRo?si=N020Ga39csW2d_28" >}}
...
{{< drg/did-you-know >}}
Oil life monitors have largely replaced the old "change your oil every 3,000 miles" rule. Modern synthetic oils and advanced engines can often go 7,500 to 10,000 miles between changes under normal conditions. Following the oil life monitor instead of an arbitrary mileage interval saves money and reduces waste.
{{< /drg/did-you-know >}}

{{< drg/image src="images/driver-info-center.avif" alt="A close-up of a vehicle's driver information center screen showing a maintenance reminder message and trip computer data, with the instrument cluster gauges visible around it" >}}

{{< drg/external-link title="NHTSA — Dashboard Symbols Guide" url="https://www.nhtsa.gov/equipment/car-dashboard-light-guide" description="Official guide to understanding warning lights and symbols on your vehicle's dashboard." >}}

{{< drg/next-page text="You can now read every gauge, warning light, and message on the dashboard." teaser="Let's move to tires — how to read tire specs, check pressure, and know when they need replacing." url="/merit-badges/automotive-maintenance/guide/req4a/" >}}
