...
req_number: "1e"
prev: "/merit-badges/automotive-maintenance/guide/req1c/"
prev_title: "Req 1c — Vehicle Power Types"
next: "/merit-badges/automotive-maintenance/guide/req1g/"
next_title: "Req 1g — Inspections & Registration"
---
...
{{< drg/tip >}}
Ask a parent or guardian to show you the owner's manual for your family's car. Find the maintenance schedule and check what service is due next. This is a great way to prepare for your counselor discussion and help your family at the same time.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Most people's daily driving actually qualifies as "severe" according to manufacturer definitions. Short commutes, city traffic, and extreme temperatures are all on the list. If your family does a lot of short-trip driving, the severe schedule might be the right one to follow.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/owners-manual-schedule.avif" alt="An open vehicle owner's manual on a table showing a maintenance schedule chart, with a Scout's hand pointing at a specific service interval" >}}
...
{{< drg/safety-first >}}
Seat belts reduce the risk of death in a crash by about 45% for front-seat passengers and 60% for rear-seat passengers. Wearing your seat belt every time you get in a vehicle — no exceptions — is the simplest and most effective thing you can do to protect yourself on the road.
{{< /drg/safety-first >}}
...
{{< drg/external-link title="NHTSA — Seat Belt Safety" url="https://www.nhtsa.gov/vehicle-safety/seat-belts" description="Official information on seat belt effectiveness, proper use, and child safety seat guidelines." >}}

{{< drg/external-link title="NHTSA — Air Bag Safety" url="https://www.nhtsa.gov/vehicle-safety/air-bags" description="Learn how air bags work, their limitations, and important safety guidelines." >}}

{{< drg/video title="Seatbelt — How Does it Work?" url="https://youtu.be/uRaU1HMJyCo?si=35wRwtjnIBBaBQk3" >}}

{{< drg/image src="images/seatbelt-airbag-diagram.avif" alt="A clear diagram showing a vehicle's interior safety systems: three-point seat belt properly positioned on a crash-test dummy, with frontal and side airbag deployment zones highlighted" >}}

{{< drg/next-page text="You understand maintenance schedules and how safety restraints protect you." teaser="Find out about vehicle inspections and registration requirements in your state." url="/merit-badges/automotive-maintenance/guide/req1g/" >}}
