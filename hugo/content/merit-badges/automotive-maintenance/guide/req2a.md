...
{{< drg/safety-first >}}
Most fluid checks should be done when the engine is cool and the vehicle is parked on a level surface. Never open the radiator cap on a hot engine — pressurized coolant can spray out and cause severe burns. Wear nitrile gloves to protect your hands from chemicals.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Brake fluid absorbs moisture from the air over time, which lowers its boiling point and can cause brake fade. If the fluid looks dark, mention it to your counselor — it may be due for a change.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Many newer vehicles use **electric power steering** instead of hydraulic systems. These vehicles have no power steering fluid to check — the steering assist comes from an electric motor. If you cannot find a power steering reservoir, check the owner's manual; your vehicle may have an electric system.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Battery terminal corrosion can be cleaned with a mixture of baking soda and water and an old toothbrush. Disconnect the cables first (negative terminal first!), scrub the corrosion away, rinse with clean water, dry thoroughly, and reconnect (positive terminal first).
{{< /drg/tip >}}

{{< drg/image src="images/under-hood-fluids.avif" alt="A labeled under-hood diagram of a typical car engine bay showing the locations of the oil dipstick, coolant reservoir, brake fluid reservoir, power steering reservoir, windshield washer fluid, and battery" >}}

{{< drg/image src="images/checking-oil-dipstick.avif" alt="Close-up of a Scout's gloved hands pulling out an engine oil dipstick to check the level, with the oil visible between the min and max marks" >}}

{{< drg/video title="A Guide to Your Car's Fluids" url="https://youtu.be/RaxZUGP1Zr0?si=_Z1CMmzpR5nAPJkp" >}}

{{< drg/external-link title="Car and Driver — How to Check Your Car's Fluids" url="https://www.caranddriver.com/features/a27109757/how-to-check-car-fluid-levels/" description="Step-by-step visual guide to checking all major vehicle fluids." >}}

{{< drg/next-page text="You can now check all seven essential fluids under the hood." teaser="Learn how to find and replace fuses, and how to inspect belts and hoses." url="/merit-badges/automotive-maintenance/guide/req2b/" >}}
