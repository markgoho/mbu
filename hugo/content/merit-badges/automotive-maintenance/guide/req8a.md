...
You turn the key → the solenoid engages → the starter motor spins the flywheel → the engine starts combustion → the alternator takes over, generating electricity to recharge the battery and power all electrical systems.

{{< drg/video title="Automotive Starting and Charging System" url="https://youtu.be/IixqxkWpT5M?si=iTXN07OTcbwFCpzB" >}}
...
**How they work together:**
You press the accelerator → the motor controller signals the inverter → the inverter converts DC battery power to AC → the electric motor spins → you lift off the accelerator or brake → the motor becomes a generator → the inverter converts AC back to DC → energy returns to the battery.

{{< drg/video title="The Role of Inverters for EV Propulsion Systems" url="https://youtu.be/wbfOoQgg7Tk?si=CK1dIlvuJJDSXKlC" >}}
...
**How they work together:**
You flip the headlight switch → current flows from the battery through the fuse box → through the headlight relay → through the wiring harness → to the headlight bulbs → current returns to the battery through the ground circuit, completing the loop.

{{< drg/video title="Automotive Lighting Circuits" url="https://youtu.be/ST5nz8M9Lcg?si=yIgLMjiU5VL_Gu1_" >}}

---

{{< drg/tip >}}
When creating your diagram, label every component clearly and draw arrows showing the direction of electrical current or energy flow. Use different colors for power lines and ground/return lines if possible. Your counselor will want to see that you understand how the components connect and why each one is necessary.
{{< /drg/tip >}}

{{< drg/image src="images/starting-charging-diagram.avif" alt="A clean, labeled diagram of a vehicle's starting and charging system showing the battery, starter motor with solenoid, alternator, ignition switch, and voltage regulator connected by color-coded wires" >}}

{{< drg/image src="images/lighting-system-diagram.avif" alt="A labeled diagram of a vehicle lighting system showing the battery, fuse box, headlight switch, headlight relay, dimmer switch, and headlight assemblies connected by wiring" >}}

{{< drg/video title="Car Electrical System Explained" url="https://youtu.be/XO-3nCYHeFQ?si=eNmJgO9ya1a2jzJP" >}}

{{< drg/external-link title="How Stuff Works — Car Electrical System" url="https://auto.howstuffworks.com/car-electrical-system.htm" description="Comprehensive overview of how a vehicle's electrical system works, with diagrams." >}}

{{< drg/next-page text="You have explored the three electrical system options and are ready to diagram one for your counselor." teaser="Learn about engine firing order and why the spark plug gap matters." url="/merit-badges/automotive-maintenance/guide/req8b/" >}}
