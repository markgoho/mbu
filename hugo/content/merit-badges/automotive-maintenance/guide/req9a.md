...
{{< drg/did-you-know >}}
The name "differential" comes from the fact that it allows two wheels to rotate at different speeds. Without a differential, both drive wheels would be forced to spin at the same speed. On a turn, the inside tire would have to skip and scrub across the pavement — wearing out tires quickly and making the vehicle difficult to control.
{{< /drg/did-you-know >}}

{{< drg/tip >}}
When creating your drive train diagram for your counselor, draw it from a top-down or side view showing: engine → transmission → drive shaft (if applicable) → differential → axle shafts → wheels. Label each component and use arrows to show the direction of power flow.
{{< /drg/tip >}}

{{< drg/image src="images/drive-train-diagram.avif" alt="A top-down diagram of a rear-wheel-drive vehicle showing the power flow from engine through transmission, down the drive shaft, through the differential, and out the axle shafts to the rear wheels, with each component clearly labeled" >}}
...
{{< drg/video title="Manual vs Automatic Transmission" url="https://youtu.be/qAdJu3cwVME?si=iBSSp4Jwxk3jhgyr" >}}

{{< drg/image src="images/transmission-types.avif" alt="Side-by-side comparison showing a cutaway of a manual transmission (with visible gear sets and shift fork) and an automatic transmission (with torque converter and planetary gears visible)" >}}

{{< drg/external-link title="Edmunds — Transmission Types Explained" url="https://www.edmunds.com/car-technology/manual-vs-automatic-transmission.html" description="A clear comparison of manual, automatic, CVT, and dual-clutch transmissions with pros and cons." >}}

{{< drg/next-page text="You understand drive train components and the difference between manual and automatic transmissions." teaser="Learn about transmission and differential fluids, and the difference between FWD, RWD, and 4WD." url="/merit-badges/automotive-maintenance/guide/req9c/" >}}
