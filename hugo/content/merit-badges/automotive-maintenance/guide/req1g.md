...
{{< drg/tip >}}
Research your own state's inspection requirements before meeting with your counselor. A great place to start is your state's Department of Motor Vehicles (DMV) website. Write down the requirements, frequency, and any exemptions so you can explain them clearly.
{{< /drg/tip >}}

{{< drg/image src="images/inspection-sticker.avif" alt="A mechanic applying an inspection sticker to the windshield of a vehicle inside a service station, with the inspection report visible on a clipboard nearby" >}}

### Requirement 1h — Vehicle Registration
...
Registration must be **renewed** periodically — usually every one or two years. The renewal process is simpler (often done online or by mail) and typically requires only payment of the renewal fee and proof of insurance.

### Finding Your Family's Registration Fee

{{< drg/checklist title="Research Steps" subtitle="Find your family's annual registration cost" >}}
...
{{< drg/did-you-know >}}
The first U.S. state to require vehicle registration was New York in 1901 — and the fee was just one dollar. Today, registration fees range from under $30 in some states to over $200 in others, and some states also charge a property tax based on the vehicle's value.
{{< /drg/did-you-know >}}

{{< drg/external-link title="USA.gov — Vehicle Registration" url="https://www.usa.gov/vehicle-registration" description="Find links to your state's DMV and registration requirements through this federal resource." >}}

{{< drg/next-page text="You have completed all of Requirement 1 — safety, equipment, vehicle types, schedules, inspections, and registration." teaser="Time to get hands-on! Learn how to check the essential fluids that keep a vehicle running." url="/merit-badges/automotive-maintenance/guide/req2a/" >}}
