...
{{< drg/checklist title="Exterior Light Check" subtitle="Test each of these with a helper" >}}
...
{{< drg/tip >}}
If you do not have a helper, you can check brake lights and reverse lights by backing up close to a wall or garage door and looking for the reflection. You can also use your phone's camera to record the rear of the vehicle while you press the brake pedal.
{{< /drg/tip >}}
...
{{< drg/image src="images/light-check-helper.avif" alt="Two people checking vehicle lights: one Scout sitting in the driver's seat operating the headlight controls, another Scout standing behind the vehicle giving a thumbs up as the brake lights illuminate" >}}

{{< drg/video title="How to Check Car Lights" url="https://youtu.be/WLDE5-QVEi8?si=xxbnuJv2QtXKRNuf" >}}
...
{{< drg/did-you-know >}}
A clogged engine air filter can reduce fuel efficiency by up to 10% on older vehicles with carburetors. Modern fuel-injected engines compensate by adjusting the air-fuel mixture, but a dirty filter still reduces airflow and can decrease acceleration performance.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
If you notice musty or unpleasant smells when you turn on the air conditioning or heat, the cabin air filter is a likely culprit. Replacing it is usually a simple, no-tools task that takes less than five minutes.
{{< /drg/tip >}}

{{< drg/image src="images/air-filter-inspection.avif" alt="A Scout holding up a used engine air filter to the light to check its condition, with a new clean filter sitting on the fender for comparison" >}}

{{< drg/video title="Check and Change Air Filter" url="https://youtu.be/noid4J2TbpU?si=skrUm5VlKpkcKADO" >}}

{{< drg/external-link title="Consumer Reports — When to Replace Filters" url="https://www.consumerreports.org/cars/car-maintenance/when-to-replace-your-car-air-filter-a1133133312/" description="Guidance on how often to check and replace both engine and cabin air filters." >}}

{{< drg/next-page text="You have completed all of Requirement 2 — fluids, fuses, belts, hoses, lights, and air filters." teaser="Time to learn what all those gauges and warning lights on the dashboard mean." url="/merit-badges/automotive-maintenance/guide/req3/" >}}
