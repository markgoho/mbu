...
{{< drg/checklist title="Essential PPE for Automotive Work" subtitle="Wear these every time you work on a vehicle" >}}
...
{{< drg/safety-first >}}
Remove all jewelry — rings, watches, bracelets, and necklaces — before working on a vehicle. A ring caught on a moving part or touching a battery terminal can cause a severe injury or burn in an instant. Tie back long hair for the same reason.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Keep a dedicated set of "shop clothes" that you don't mind getting stained. Old jeans and a fitted cotton t-shirt are perfect. Change out of them when you are done so you don't track grease and chemicals into your home.
{{< /drg/tip >}}

{{< drg/image src="images/ppe-lineup.avif" alt="Safety equipment laid out neatly on a workbench: safety glasses, nitrile gloves, mechanic's gloves, ear plugs, and steel-toe boots" >}}
...
{{< drg/checklist title="Starter Tool Kit" subtitle="The basics every Scout mechanic needs" >}}
...
{{< drg/did-you-know >}}
Most American-made vehicles before the 1980s used SAE (inch-based) fasteners, while most imports used metric. Today, nearly all new vehicles — including American brands — use metric fasteners exclusively. However, you may still encounter SAE bolts on older vehicles, so having both sets is smart.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Shop Safety Essentials" subtitle="Every workspace should have these" >}}
...
{{< drg/image src="images/jack-stands-safety.avif" alt="A car properly supported on jack stands on a flat concrete surface, with wheel chocks visible on the rear tires and a hydraulic floor jack set to the side" >}}
...
- **Flush immediately** with clean water for at least 15 minutes. Use an eyewash station if one is available, or hold your eye open under a gentle stream of cool water.
- **Seek medical attention** after flushing, even if the pain subsides.

This is why wearing safety glasses is so important — they prevent the splash from happening in the first place.
{{< /drg/be-prepared >}}

{{< drg/video title="Garage and Shop Safety Basics" url="https://youtu.be/lT_42grmnUk?si=9Ov1c-5CUwWuXg5m" >}}

{{< drg/external-link title="AAA — Car Maintenance Basics" url="https://www.aaa.com/autorepair/articles/car-maintenance-basics" description="Overview of basic car maintenance tasks and the tools you need to do them safely." >}}

{{< drg/next-page text="You know the hazards and you have the right gear. Now let's explore how modern vehicles are powered." teaser="Learn about gasoline, diesel, electric, hybrid, and hydrogen vehicles." url="/merit-badges/automotive-maintenance/guide/req1c/" >}}
