...
If you drive a battery electric vehicle (BEV) or plug-in hybrid (PHEV), understanding what affects your range — and how to recharge efficiently — is just as important as knowing where the nearest gas station is for a conventional vehicle.
...
**Temperature:**
- Cold weather is the biggest range reducer. At 20°F, range can drop by **25% to 40%** compared to ideal conditions. This happens because the battery's chemical reactions slow down in the cold, and heating the cabin draws significant power.
...
{{< drg/tip >}}
Most EVs have an "Eco" or "Range" mode that limits acceleration, reduces climate control output, and maximizes regenerative braking. Use it when range is a concern — like on a long trip or when the battery is getting low.
{{< /drg/tip >}}
...
- Uses the portable charging cord that comes with most EVs — plugs into a regular wall outlet.
...
- Uses a wall-mounted charging station (called an EVSE — Electric Vehicle Supply Equipment) connected to a 240-volt circuit, like the ones used for clothes dryers.
...
- Not recommended for daily use — frequent DC fast charging can accelerate battery degradation over time.

{{< drg/did-you-know >}}
Most EV owners do about 80% of their charging at home, overnight — just like charging a phone. The average American drives about 37 miles per day, which means even a Level 1 charger can fully replenish a day's driving in about 8 to 10 hours.
{{< /drg/did-you-know >}}

{{< drg/image src="images/ev-charging-levels.avif" alt="A three-panel illustration showing the three levels of EV charging: a car plugged into a regular household outlet (Level 1), a car connected to a wall-mounted home charger (Level 2), and a car at a commercial DC fast charging station (Level 3)" >}}
...
{{< drg/tip >}}
If your battery dies, you will lose much more than just the ability to start the car. Power door locks may not work (trapping you or locking you out), the alarm system may activate unexpectedly, and electronically controlled transmissions may lock in "park." A healthy electrical system is the foundation everything else builds on.
{{< /drg/tip >}}

{{< drg/video title="Factors Affecting Range" url="https://youtu.be/FlaskUlzdmU?si=CIjEtDAEGsjmaiP6" >}}

{{< drg/video title="Fundamentals of Automotive Electrical Systems" url="https://youtu.be/17DdpIJ6IsI?si=TsLAiKVhMLMmEeh_" >}}

{{< drg/external-link title="U.S. Department of Energy — EV Charging" url="https://afdc.energy.gov/fuels/electricity-charging" description="Comprehensive guide to EV charging levels, station types, and finding public chargers near you." >}}

{{< drg/next-page text="You now understand EV range, charging, and why a reliable electrical system is the backbone of every modern vehicle." teaser="Let's explore the drive train — how power gets from the engine to the wheels." url="/merit-badges/automotive-maintenance/guide/req9a/" >}}
