...
{{< drg/video
    title="Brag Book (video)"
    url="https://youtu.be/W9G0X6gAhwY" >}}

{{< drg/checklist title="Book drive workflow" subtitle="Plan from need to delivery" >}}
...
{{< drg/tip >}}
People donate more when they know the exact destination. "Books for the Oak Street youth center" is stronger than "Books for people who need them."
{{< /drg/tip >}}

{{< drg/image src="images/book-drive-sorting-table.avif" alt="A Scout sorting donated books into labeled boxes by age level and type before delivery to a community partner" >}}
...
{{< drg/next-page
    text="You have used reading as a tool for service and community support"
    teaser="Next, explore careers that depend on strong reading skills every day."
