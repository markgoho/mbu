...
{{< drg/checklist title="Good discussion notes" subtitle="Bring these points to your counselor conversation" >}}
...
{{< drg/video
    title="Summarizing Main Ideas (video)"
    url="https://youtu.be/LbO3lRXT0ww?si=GDgqXvC8Jw_0S09p" >}}

{{< drg/tip >}}
Do not choose two sources that simply repeat each other word for word. A better match is two sources on the same topic that come at it from different angles.
{{< /drg/tip >}}

{{< drg/safety-first >}}
If one of your sources is online, get parent or guardian permission first. Stick to reliable organizations, established news outlets, museums, universities, government agencies, or respected nonprofits rather than random posts or anonymous videos.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="Library of Congress"
    url="https://www.loc.gov/"
    description="Explore articles, collections, and primary sources that can help you compare reliable information on many topics." >}}
...
{{< drg/next-page
    text="You have practiced comparing sources instead of trusting just one"
    teaser="Next, choose a reading service project and see how books can help your community."
