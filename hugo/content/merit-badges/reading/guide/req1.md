...
{{< drg/checklist title="What this page covers" subtitle="Five practical library skills" >}}
...
{{< drg/inherited-requirement number="1a" req_path="1.a" topic="Take a tour of a library. Discuss with your counselor how the library is organized and what resources and/or services are offered in the library." />}}
...
{{< drg/tip >}}
Bring a notebook or phone note and write down three things that surprised you on the tour. Those details make your counselor discussion stronger than simply saying, "They had a lot of books."
{{< /drg/tip >}}

{{< drg/video
    title="How Is a Library Organized (video)"
    url="https://youtu.be/wm3OYbqWGt4" >}}

{{< drg/video
    title="Library of Congress Classification (video)"
    url="https://youtu.be/Vq_nXCKqvvI?si=GIOeyfCbat453Qtp" >}}

## Requirement 1b

{{< drg/inherited-requirement number="1b" req_path="1.b" topic="Learn how to search for material using a library's card catalog or computerized catalog by author, title, and subject." />}}
...
{{< drg/video
    title="How to Use a Card Catalog (video)"
    url="https://youtu.be/bBoBFioGVJc?si=W5X75XCeu-dxS8if" >}}

## Requirement 1c

{{< drg/inherited-requirement number="1c" req_path="1.c" topic="In a library, search the card catalog or computerized catalog for six books of four different types, such as poetry, fiction, nonfiction, and biographies." />}}
...
{{< drg/did-you-know >}}
Two books about the same topic may end up in very different parts of the library if one is fiction and one is nonfiction. Format matters just as much as topic.
{{< /drg/did-you-know >}}

{{< drg/video
    title="Locating a Book in a Library (video)"
    url="https://youtu.be/yqg41rMDlKA" >}}
...
{{< drg/be-prepared title="If the book is not where the catalog says it should be" >}}
- **Check the status**: Make sure the book is really available.
- **Scan nearby shelves**: Books are often returned to the wrong place by one or two spots.
- **Look for displays**: New or themed books may be pulled to a special table.
- **Ask a librarian**: Staff can often track whether the book is on a cart, on hold, or misshelved.
{{< /drg/be-prepared >}}
...
{{< drg/video
    title="How Do I...Get a Library Card (video)"
    url="https://youtu.be/LOhNkY0yb4s?si=fCdFQINKX1P4wNYJ" >}}

{{< drg/image src="images/library-call-number-search.avif" alt="A Scout comparing a library catalog screen entry with the call number label on a nonfiction book spine in the library stacks" >}}
...
{{< drg/next-page
    text="You can now navigate a library with confidence"
    teaser="Next, learn how to follow authors, use best-books lists, and pick books you actually want to read."
