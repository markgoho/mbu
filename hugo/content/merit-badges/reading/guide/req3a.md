...
{{< drg/checklist title="Questions to answer in your review" subtitle="Use these to turn your opinion into evidence" >}}
...
{{< drg/video
    title="How to Write a Book Review (video)"
    url="https://youtu.be/IhYF3v3zTeo" >}}

{{< drg/video
    title="How to Write a Book Review (12 Steps) (video)"
    url="https://youtu.be/BJfKSm0VpuU?si=IsukhqXWGXupIMa1" >}}

{{< drg/tip >}}
Avoid spoilers unless they are absolutely necessary. You want to help someone decide whether to read the book, not take away the surprise that made the book fun.
{{< /drg/tip >}}

{{< drg/external-link
    title="Library of Congress — Read.gov"
    url="https://read.gov/"
    description="Use free classic texts to practice reviewing different genres and reading levels." >}}
...
{{< drg/next-page
    text="You know how to build a review with reasons"
    teaser="Next, compare what happens when a story changes from page to screen."
