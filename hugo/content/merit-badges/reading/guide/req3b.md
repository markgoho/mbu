...
req_number: "3b"
req_path: "3.b"
prev: "/merit-badges/reading/guide/req3a/"
prev_title: "Req 3a — Write a Thoughtful Review"
next: "/merit-badges/reading/guide/req3c/"
next_title: "Req 3c — Give a Book Talk"
---
...
{{< drg/be-prepared title="How to keep your comparison fair" >}}
- **Take notes while reading or watching**: Do not trust memory alone.
- **Compare major moments**: Focus on scenes that matter, not tiny details.
- **Judge each format by what it does best**: Books give depth; movies give sound and visuals.
- **Pick a winner with reasons**: "I liked the book better" is only the start. Explain why.
{{< /drg/be-prepared >}}

{{< drg/video
    title="7 Big Differences (video)"
    url="https://youtu.be/Ho70o1kiwf4" >}}

{{< drg/did-you-know >}}
Even very faithful movies often leave out entire subplots because a two-hour film rarely has room for everything a novel can include.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Library of Congress — Read.gov"
    url="https://read.gov/"
    description="A useful source for classic books that have been adapted many times into movies or TV productions." >}}
...
{{< drg/next-page
    text="You can now compare a story across two formats"
    teaser="Next, learn how to talk about a book in a way that makes other people want to read it."
