...
req_number: "4"
req_path: "4"
prev: "/merit-badges/reading/guide/req3c/"
prev_title: "Req 3c — Give a Book Talk"
next: "/merit-badges/reading/guide/req5/"
next_title: "Req 5 — Read the Wider World"
---
...
{{< drg/checklist title="Before you begin" subtitle="Set yourself up for a successful project" >}}
...
In [Req 1](/merit-badges/reading/guide/req1/), you practiced finding the right materials. Here, you are using reading to turn information into action. If something goes wrong, ask yourself whether the problem came from the instructions, your setup, or the way you followed the steps.

{{< drg/video
    title="How to Improve Reading Comprehension (video)"
    url="https://youtu.be/3nLX0CjMO-Q?si=4SNTBq8jqKAhZioe" >}}

{{< drg/safety-first >}}
If your project involves tools, heat, electricity, sharp objects, chemicals, or online interaction, stop and review the safety rules before you begin. Get an adult's permission, use the right protective gear, and do not improvise with equipment you do not understand.
{{< /drg/safety-first >}}

{{< drg/tip >}}
Take a few photos during the project or save a rough draft, sketch, or test version. Those details make it easier to explain your process to your counselor later.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    url="https://read.gov/"
    description="A starting point for exploring how published writing can teach, guide, and inspire hands-on learning." >}}
...
{{< drg/next-page
    text="You have used reading to make something happen"
    teaser="Next, compare two sources about the world around you and discuss what you learned from each one."
