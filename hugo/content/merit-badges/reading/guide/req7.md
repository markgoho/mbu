...
{{< drg/checklist title="Career research questions" subtitle="Bring these answers to your counselor discussion" >}}
...
{{< drg/tip >}}
The strongest counselor discussion usually compares the job to your own interests. Do not just report facts. Explain whether the daily reading work sounds interesting to you and why.
{{< /drg/tip >}}

{{< drg/external-link
    title="U.S. Bureau of Labor Statistics — Occupational Outlook Handbook"
    url="https://www.bls.gov/ooh/"
    description="A reliable source for job outlook, pay, training, and career descriptions across many fields that use strong reading skills." >}}

{{< drg/external-link
    title="American Library Association"
    url="https://www.ala.org/"
    description="Learn more about library careers, advocacy, and the many roles libraries play in communities." >}}

{{< drg/external-link
    title="Library of Congress"
    url="https://www.loc.gov/"
    description="Explore an institution where reading, research, preservation, and public access all come together." >}}
...
{{< drg/next-page
    text="You have connected reading to real jobs and future paths"
    teaser="Finish with deeper ways to keep reading, exploring, and serving beyond the badge."
    url="/merit-badges/reading/guide/extended-learning/" >}}
