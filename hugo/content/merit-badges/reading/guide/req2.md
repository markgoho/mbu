...
{{< drg/tip >}}
When you tell your counselor about the author, mention one thing beyond the book list. Maybe the author writes for a certain age group, focuses on history, or is known for a certain style. That shows you paid attention to the reader experience, not just the title count.
{{< /drg/tip >}}

{{< drg/external-link
    title="Library of Congress — Read.gov"
    url="https://read.gov/"
    description="Free access to classic books, author collections, and reading-themed resources from the Library of Congress." >}}
...
{{< drg/checklist title="How to judge a best-books list" subtitle="Not every recommendation is the right recommendation for you" >}}
...
{{< drg/video
    title="Best Selling Books Ever (video)"
    url="https://www.youtube.com/watch?v=wPDAjvQCgIg" >}}

{{< drg/video
    title="10 Most Read Books of All Time (video)"
    url="https://www.youtube.com/shorts/_FWW0V4rwj4" >}}
...
{{< drg/next-page
    text="You have practiced choosing books on purpose"
    teaser="Next, pick one way to share what you noticed about the books you read."
