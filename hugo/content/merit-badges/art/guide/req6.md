...
{{< drg/tip >}}
If you live in a rural area far from a major museum, do not overlook local options. Many towns have community art centers, craft guilds, or local artists who welcome visitors. A visit to a potter's studio or a local artisan's workshop counts and can be an even more personal experience than a large museum.
{{< /drg/tip >}}

{{< drg/image src="images/scout-at-museum.avif" alt="A Scout standing in a museum gallery, looking up at a large framed painting on a white wall, with other artworks visible in the background" >}}

### How to Prepare

Going in with a plan will make your visit more meaningful — and give you plenty to discuss with your counselor afterward.

{{< drg/checklist title="Before Your Visit" subtitle="Plan ahead for a great experience" >}}
...
- **What elements of art** do I see? (Line, value, shape, form, space, color, texture — you learned these in [Requirement 2](/merit-badges/art/guide/req2/))
- **What principles of design** are at work? (Rhythm, balance, proportion, variety, emphasis, unity — from [Requirement 3](/merit-badges/art/guide/req3/))
...
{{< drg/did-you-know >}}
Many museums display information cards (called "tombstones" in the museum world) next to each artwork. These tell you the artist's name, the title, the year, the medium, and sometimes a brief description. Reading these cards is one of the fastest ways to learn about what you are seeing.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Not Sure What to Say About an Artwork?" >}}
Use this simple framework: **See — Think — Wonder.**

- **See:** What do I literally see? Describe the colors, shapes, and subject.
- **Think:** What do I think this artwork is about? What was the artist trying to communicate?
- **Wonder:** What questions do I have? Why did the artist make the choices they did?

This approach works for any artwork, even ones you do not immediately understand.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    title="Google Arts & Culture — Virtual Museum Tours"
    url="https://artsandculture.google.com/partner"
    description="Walk through hundreds of museums around the world from your computer or phone. Explore collections from the Metropolitan Museum of Art, the Louvre, the Smithsonian, and many more." >}}

{{< drg/external-link
    title="Smithsonian American Art Museum"
    url="https://americanart.si.edu/"
    description="The Smithsonian's art museum features one of the largest collections of American art in the world, with free admission and extensive online resources." >}}

{{< drg/external-link
    title="National Gallery of Art"
    url="https://www.nga.gov/"
    description="Located in Washington, D.C., the National Gallery offers free admission and an incredible collection spanning centuries of art from around the world." >}}

{{< drg/next-page
    text="You have experienced art in person and learned how to observe and discuss it."
    teaser="Now explore the many career paths where art skills are in demand."
