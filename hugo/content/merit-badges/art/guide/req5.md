...
{{< drg/tip >}}
Great functional design is simple and solves a real problem. You do not need to invent something wildly complex. A better pencil holder for your desk, a redesigned patrol flag, or a more efficient camp kitchen organizer are all excellent starting points.
{{< /drg/tip >}}

**Project ideas:**
- A multi-tool holder for your camp kitchen
- A weather-resistant trail marker
- A new design for a merit badge sash or patch organizer
- A phone stand made from natural materials
- A better system for organizing your patrol box

{{< drg/image src="images/design-sketch-model.avif" alt="A Scout's sketchbook open to a product design page showing multiple concept sketches of a camp kitchen organizer, with a small cardboard prototype model sitting next to it" >}}
...
- **Comic strip** — 3–6 panels telling a short, complete story
- **Single illustration** — One powerful image that captures a moment and implies a larger story
- **Triptych** — Three images that show a progression (before, during, after)
- **3-D diorama** — A scene built from clay, cardboard, or other materials
- **Storyboard** — A sequence of scenes like a movie director would plan

{{< drg/did-you-know >}}
The Bayeux Tapestry, created around 1070 AD, tells the story of the Norman conquest of England in a 230-foot-long embroidered cloth. It is one of the earliest and most famous examples of sequential narrative art — essentially a medieval comic strip.
{{< /drg/did-you-know >}}

---

### Option C: Design a Logo
...
{{< drg/checklist title="Logo Design Principles" subtitle="What makes a great logo" >}}
...
{{< drg/tip >}}
Start in black and white. If your logo works without color, it will work with color. If it only works in color, the design is not strong enough. The Nike swoosh and the Apple logo both work perfectly in a single color.
{{< /drg/tip >}}

{{< drg/image src="images/logo-design-process.avif" alt="A sketchbook page showing the evolution of a patrol logo design: multiple rough thumbnail sketches at the top narrowing down to a refined final logo at the bottom, with notes and arrows showing the design thinking" >}}
...
{{< drg/external-link
    ...
    description="Free lessons on graphic design fundamentals including logo design, color theory, and layout — useful for all three project options." >}}

{{< drg/external-link
    title="Making Comics by Scott McCloud"
    url="https://scottmccloud.com/2-print/3-mc/index.html"
    description="Scott McCloud is the world's leading expert on visual storytelling. His books on comics and sequential art are invaluable for Option B." >}}

{{< drg/next-page
    text="You have applied your art skills to a real-world project."
    teaser="Now step outside your own studio and experience art created by others — visit a museum, gallery, or artist's workshop."
