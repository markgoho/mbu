...
{{< drg/image src="images/scout-art-studio.avif" alt="A Scout standing at an easel in a bright, organized art studio, looking at a canvas with paint supplies on a nearby table" >}}
...
{{< drg/image src="images/pencil-sketching-still-life.avif" alt="A Scout's hands sketching a still-life arrangement of an apple and a vase with a pencil on a sketchpad" >}}
...
{{< drg/did-you-know >}}
The first piece of digital art was created in 1967 when a computer scientist used a program to generate patterns on a screen. Today, digital art sells for millions of dollars and hangs in major museums alongside oil paintings and marble sculptures.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
When working with art supplies, always read labels and follow safety instructions. Some materials — like spray fixatives, certain paints, and solvents — require good ventilation. Never eat or drink while using art materials, and wash your hands thoroughly when you are finished.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You have explored the world of art and why it matters."
    teaser="Learn how to define art, discuss its importance, and explore what it means to you personally."
    url="/merit-badges/art/guide/req1/" >}}
