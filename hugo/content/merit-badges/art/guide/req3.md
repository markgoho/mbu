...
req_number: "3"
prev: "/merit-badges/art/guide/req2/"
prev_title: "Req 2 — Elements of Art"
next: "/merit-badges/art/guide/req4/"
next_title: "Req 4 — Creating in Different Media"
---
...
{{< drg/image src="images/principles-of-design-grid.avif" alt="A six-panel illustration, each panel showing one principle of design with a simple visual example: rhythm (repeating arches), balance (symmetrical butterfly), proportion (large tree beside a small house), variety (different-colored leaves), emphasis (one red circle among gray circles), unity (a harmonious landscape painting)" >}}
...
{{< drg/tip >}}
To spot rhythm in art, look for anything that repeats. Columns, arches, brushstrokes, dots, stripes — if your eye travels across them in a pattern, you have found rhythm.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The Great Wave off Kanagawa by the Japanese artist Hokusai is one of the most famous examples of asymmetrical balance. The massive wave dominates the left side, but the small, distant Mount Fuji on the right perfectly balances the composition — proving that a small element with strong visual weight can hold its own against something much larger.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When looking at any artwork, ask yourself: "Where does my eye go first?" That is the focal point. Then ask: "How did the artist make my eye go there?" The answer will be one or more of the emphasis techniques above.
{{< /drg/tip >}}

{{< drg/image src="images/emphasis-example.avif" alt="A painting of a busy market scene where one person in a bright yellow jacket stands out as the clear focal point against the muted colors of the crowd" >}}
...
{{< drg/checklist title="Preparation Checklist" subtitle="Get ready for your counselor discussion" >}}
...
{{< drg/external-link
    title="The Art Story — Principles of Design"
    url="https://www.theartstory.org/definition/principles-of-design/"
    description="A detailed overview of each design principle with examples from famous artworks throughout history." >}}

{{< drg/next-page
    text="You now understand both the building blocks and the rules for arranging them."
    teaser="Time to get your hands dirty — explore nine different art media and create your own works."
