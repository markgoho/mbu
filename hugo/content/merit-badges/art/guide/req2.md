...
{{< drg/image src="images/elements-of-art-overview.avif" alt="A colorful infographic-style illustration showing the seven elements of art (line, value, shape, form, space, color, texture) each represented by a simple visual example" >}}
...
{{< drg/tip >}}
To find examples of line, look at pen-and-ink drawings, architectural blueprints, comic strips, or the patterns on a zebra. Even a road stretching into the distance is a powerful example of line in the real world.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
If you take a color photograph and convert it to black and white, you remove all the color information but keep all the value information. If the image still looks interesting and three-dimensional in black and white, the artist used strong values.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
A simple exercise: Draw a circle, then shade one side darker and add a shadow underneath. That circle now looks like a sphere — you have created the illusion of form using value.
{{< /drg/tip >}}
...
{{< drg/image src="images/positive-negative-space.avif" alt="A side-by-side illustration showing positive and negative space: on the left, a black vase on a white background; on the right, the same image but highlighting how the white space creates two face profiles" >}}
...
{{< drg/did-you-know >}}
The color blue was once more expensive than gold. In the Renaissance, the pigment ultramarine was made by grinding lapis lazuli, a rare gemstone imported from Afghanistan. It was so costly that artists reserved it for the most important figures in their paintings, like the Virgin Mary.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Finding Examples" subtitle="Where to look for the seven elements" >}}
...
{{< drg/external-link
    title="Khan Academy — Elements of Art"
    url="https://www.khanacademy.org/computing/pixar/color"
    description="Free video lessons from Khan Academy and Pixar exploring how color and other elements work in art and animation." >}}

{{< drg/external-link
    title="National Gallery of Art — Learning Resources"
    url="https://www.nga.gov/learn.html"
    description="Explore the National Gallery's collection while learning about the elements and principles of art through interactive activities." >}}

{{< drg/next-page
    text="Now that you know the seven building blocks of art"
    teaser="discover the six principles that show you how to arrange them into a great composition."
