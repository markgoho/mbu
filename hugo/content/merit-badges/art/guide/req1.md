...
req_number: "1"
prev: "/merit-badges/art/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/art/guide/req2/"
next_title: "Req 2 — Elements of Art"
---
...
{{< drg/did-you-know >}}
The word "art" comes from the Latin word *ars*, which originally meant "skill" or "craft." In ancient Rome, everything from carpentry to medicine was considered an *ars*. The idea that art is something separate from practical skill is actually a modern invention.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Not Sure What Art Means to You?" >}}
If you are struggling with this question, try a quick experiment before your counselor meeting. Spend ten minutes sketching something — anything. It can be your shoe, your pet, or a random shape. When you are done, notice how you feel. Did you get lost in concentration? Did you feel frustrated? Satisfied? That emotional response is part of what art means to you.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    ...
    description="Explore thousands of artworks from museums around the world. Zoom in on brushstrokes, take virtual museum tours, and discover art from every era and culture." >}}

{{< drg/external-link
    title="The Art Story — What Is Art?"
    url="https://www.theartstory.org/definition/art/"
    description="A clear, well-organized overview of how the definition of art has evolved over centuries." >}}

{{< drg/next-page
    text="Now that you can define art, explain why it matters, and reflect on what it means to you"
    teaser="learn the seven building blocks that every piece of visual art is made from."
