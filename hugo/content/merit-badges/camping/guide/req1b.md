...
req_number: "1b"
prev: "/merit-badges/camping/guide/req1a/"
prev_title: "Req 1a — Camping Hazards"
next: "/merit-badges/camping/guide/req1c/"
next_title: "Req 1c — Camping First Aid"
---
...
{{< drg/checklist title="Pre-Trip Weather Check" subtitle="What to look for in a forecast" >}}
...
{{< drg/tip >}}
Save your local National Weather Service forecast page as a bookmark on your phone. NWS forecasts are free, accurate, and include detailed hourly breakdowns. Check it one more time right before you leave — forecasts can change fast.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
When a thunderstorm approaches, use the 30/30 rule: if the time between a flash of lightning and the sound of thunder is 30 seconds or less, seek shelter immediately. Wait at least 30 minutes after the last thunder before going back outside. If you are caught in the open, get to low ground, crouch down on the balls of your feet, and stay away from tall trees, metal poles, and water.
{{< /drg/safety-first >}}
...
- If lightning is close, get inside a hard-topped vehicle if available. If not, crouch in a low area away from water and tall objects.
- Keep calm, stay together, and wait it out.
{{< /drg/be-prepared >}}

### Weather Resources

{{< drg/external-link title="National Weather Service" url="https://www.weather.gov/" description="Free, accurate weather forecasts for any location in the United States. Bookmark your local office before your trip." >}}

{{< drg/video title="Wet Weather Camping Mistakes" url="https://youtu.be/HzktQBzrSQw?si=AZLAxj0KuDmWjhLl" >}}
...
{{< drg/next-page
    ...
    teaser="Next, learn the first aid skills you need for common camping injuries and illnesses."
