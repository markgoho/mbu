...
{{< drg/tip >}}
Rotate duties across meals and days so everyone gets experience in every role. The Scout who cooks breakfast should not also cook lunch — spread the work around. This also means everyone learns every skill.
{{< /drg/tip >}}
...
{{< drg/checklist title="Helping a Group Prepare" subtitle="Key areas to cover" >}}
...
{{< drg/safety-first >}}
When working with younger Scouts or Webelos, remember that they may have never camped before. Be patient, demonstrate each task step by step, and let them do it themselves with your guidance. The goal is to teach, not to do the work for them.
{{< /drg/safety-first >}}
...
You will dive much deeper into menu planning in [Requirement 8c — Menu Planning](/merit-badges/camping/guide/req8c/).
...
{{< drg/next-page
    ...
    teaser="Learn what clothing to pack for warm and cold weather camping."
