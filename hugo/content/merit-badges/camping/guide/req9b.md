...
req_number: "9b"
prev: "/merit-badges/camping/guide/req9a/"
prev_title: "Req 9a — 20 Nights of Camping"
next: "/merit-badges/camping/guide/req9c/"
next_title: "Req 9c — Conservation Project"
---
...
{{< drg/tip >}}
Use a topo map to calculate elevation gain before your hike. Count the contour lines from the trailhead to the summit. If your map has a 40-foot contour interval, 25 contour lines equals 1,000 feet of gain.
{{< /drg/tip >}}
...
{{< drg/video title="Learn to Snowshoe" url="https://youtu.be/bIylS8VFGcg?si=_C2XoAWrFGsx0bSa" >}}
...
{{< drg/safety-first >}}
Always wear a properly fitted helmet when cycling. Follow traffic laws, ride with traffic (not against it), and use hand signals for turns and stops. Ride single file on roads.
{{< /drg/safety-first >}}

{{< drg/video title="What I Wish I Knew Before Bikepacking" url="https://youtu.be/eC-XDuniSco?si=ThrPiNPJvBWOimjp" >}}
...
{{< drg/safety-first >}}
Every person on the water must wear a Coast Guard-approved personal flotation device (PFD). No exceptions. Even strong swimmers can be incapacitated by cold water, currents, or an unexpected capsize.
{{< /drg/safety-first >}}

{{< drg/video title="Canoeing with Leave No Trace" url="https://youtu.be/F8vjVVCf9YI?si=5TuRYuF6q8BjpESE" >}}
...
{{< drg/video title="Winter Camping Tips" url="https://youtu.be/ReanLLCCKIc?si=hlHXtTKcefLmsVuJ" >}}
...
{{< drg/safety-first >}}
Rappelling is an inherently risky activity that requires professional supervision and equipment. Never attempt to rappel without a qualified instructor, proper gear inspection, and a backup safety system (like a fireman's belay). This is not an activity to learn from videos alone.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Scouting America's four High Adventure Bases each offer activities that can count toward this requirement. Philmont (backpacking), Northern Tier (canoeing), Sea Base (water trips), and the Summit (rappelling and biking) are bucket-list experiences that many Scouts work toward throughout their Scouting career.
{{< /drg/did-you-know >}}

{{< drg/next-page
    text="You have planned your adventure activities."
    teaser="Complete a conservation project to give back to the land that hosts your camping adventures."
