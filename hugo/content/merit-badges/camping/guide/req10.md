...
- First aid for conditions like hypothermia, heat reactions, and blisters ([Req 1c](/merit-badges/camping/guide/req1c/))
- Dressing properly for weather conditions ([Req 5a](/merit-badges/camping/guide/req5a/))
- The physical fitness required for hiking, backpacking, and outdoor activities ([Req 9b](/merit-badges/camping/guide/req9b/))
...
- How to anticipate and respond to hazards ([Req 1a](/merit-badges/camping/guide/req1a/))
- How to navigate with a map and compass ([Req 3](/merit-badges/camping/guide/req3/))
- How to find and treat water ([Req 6b](/merit-badges/camping/guide/req6b/))
- How to build shelter and stay warm ([Req 6a](/merit-badges/camping/guide/req6a/), [Req 6e](/merit-badges/camping/guide/req6e/))
...
- Proper dishwashing and waste disposal ([Req 6b](/merit-badges/camping/guide/req6b/))
- Food protection and safe cooking practices ([Req 8c](/merit-badges/camping/guide/req8c/), [Req 8d](/merit-badges/camping/guide/req8d/))
...
- The seven Leave No Trace principles ([Req 2](/merit-badges/camping/guide/req2/))
- Responsible campsite selection ([Req 6c](/merit-badges/camping/guide/req6c/))
- Hands-on conservation work ([Req 9c](/merit-badges/camping/guide/req9c/))
...
- Taking responsibility for your role on the team ([Req 4](/merit-badges/camping/guide/req4/))
...
{{< drg/tip >}}
When discussing this with your counselor, use specific examples from your own camping experiences. Instead of saying "I was helpful," tell a story: "During our winter campout, I noticed a new Scout was struggling to pitch his tent in the cold, so I showed him how to set up the poles with gloves on." Specific stories are much more powerful than general statements.
{{< /drg/tip >}}
...
{{< drg/next-page
    ...
    teaser="Explore additional resources, experiences, and organizations to keep your outdoor adventures going."
    url="/merit-badges/camping/guide/extended-learning/" >}}
