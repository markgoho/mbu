...
{{< drg/checklist title="Personal Gear Checklist" subtitle="Items each camper brings" >}}
- Backpack (properly fitted).
- Sleeping bag (rated for expected temperatures).
- Sleeping pad.
- Tent (or your share of a shared tent).
- Clothing for expected weather (see [Req 5a](/merit-badges/camping/guide/req5a/)).
- Footwear — hiking boots plus camp shoes (see [Req 5b](/merit-badges/camping/guide/req5b/)).
- Outdoor essentials (see [Req 5d](/merit-badges/camping/guide/req5d/)).
...
{{< drg/checklist title="Patrol Gear Checklist" subtitle="Shared items divided among the patrol" >}}
- Camp stove and fuel.
...
{{< drg/checklist title="Packing for Success" subtitle="Key principles" >}}
...
{{< drg/did-you-know >}}
Many experienced backpackers use a kitchen scale to weigh every item in their pack. This practice, called "shakedown," helps identify heavy items that could be replaced with lighter alternatives. Even small savings add up — replacing a heavy camp mug with a lightweight one saves ounces, and ounces become pounds over a full pack.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    ...
    teaser="Learn about camp stove safety — an essential skill before you start cooking outdoors."
