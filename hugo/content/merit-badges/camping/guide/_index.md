  ...
  - group_title: "6. Shelter & Camp Setup"
    items:
      ...
      - title: "e Sleeping Bags"
        ...
        is_sub: true
  - group_title: "Gear Checklist & Packing"
    items:
  ...
  - group_title: "9. Camping Experience"
    items:
      ...
      - title: "c Conservation Project"
        ...
        is_sub: true
  - group_title: "Scout Spirit & Reflection"
    items:
...
{{< drg/safety-first >}}
Backpacking in remote areas means you are far from help. Always file a trip plan, travel with a buddy, and carry the outdoor essentials. Know your limits — start with shorter trips and build up your endurance.
{{< /drg/safety-first >}}
...
{{< drg/safety-first >}}
Water-based camping requires swimming ability and knowledge of water safety. Always wear a properly fitted personal flotation device (PFD) while on the water, and store your gear in waterproof bags or dry sacks.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Hammock camping has been used by militaries for centuries. Sailors in the Spanish navy slept in hammocks as early as the 1500s, and jungle troops still use them today because they keep soldiers off the wet ground and away from insects and snakes.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You have explored what camping is and the many ways to do it."
    teaser="Learn about the hazards you may face while camping — and how to handle them."
    url="/merit-badges/camping/guide/req1a/" >}}
