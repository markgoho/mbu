...
{{< drg/checklist title="What to include in your 3–4 paragraphs" subtitle="Each paragraph should move the movie forward" >}}
...
{{< drg/tip >}}
Use strong action verbs. "Carries," "drops," "signals," "searches," and "laughs" are much easier to film than abstract phrases like "realizes something important."
{{< /drg/tip >}}
...
This is especially important before you build your storyboard in [Req 2b](/merit-badges/moviemaking/guide/req2b/) and choose your filming option in [Req 2d](/merit-badges/moviemaking/guide/req2d/).
...
{{< drg/download
    ...
    type="printable"
    description="Print this worksheet to shape your treatment, define your main story beats, and sketch early storyboard ideas." >}}

{{< drg/video
    title="Film Production Explained, Each Step of the Production Process (video)"
    url="https://youtu.be/puF9CkvmJt0?si=jiFW5a-I3X0vZDV4" >}}

{{< drg/external-link
    title="Khan Academy"
    url="https://www.khanacademy.org"
    description="Khan Academy hosts free storytelling and media-learning resources that can help you think about how ideas turn into visual scenes." >}}
...
- Did you leave room for camera choices from [Req 1](/merit-badges/moviemaking/guide/req1/)?

If the answer to those questions is yes, your treatment is doing its job.

{{< drg/next-page
    text="Your story now has a clear shape"
    teaser="Turn that written treatment into a shot-by-shot visual plan with a storyboard."
