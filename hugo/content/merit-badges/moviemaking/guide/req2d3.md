...
{{< drg/checklist title="What instructional videos need" subtitle="These choices help a beginner follow along" >}}
...
This is one place where your practice from [Req 2c](/merit-badges/moviemaking/guide/req2c/) becomes especially useful. Stable tripod shots, careful framing, and good lighting make instruction easier to follow.

{{< drg/be-prepared title="What if your first version is confusing?" >}}
Ask someone who does not already know the skill to watch your rough cut.

- **Where did they get lost?**
- **What detail did they wish they could see better?**
- **Which step needed a slower shot or clearer explanation?**
{{< /drg/be-prepared >}}

{{< drg/image src="images/moviemaking-scout-skill-vignette.avif" alt="Overhead training video setup showing Scout hands demonstrating a knot for instruction" >}}
...
{{< drg/safety-first >}}
Only film Scouting skills the right way. If a mistake would create a safety problem in real life, re-shoot the demonstration rather than leaving a confusing or incorrect step in the final video.
{{< /drg/safety-first >}}

{{< drg/video
    title="How to Make a Great Instructional Video (video)"
    url="https://youtu.be/cLLuuV_57JY?si=vcdpLOuyRcHeC1jf" >}}

{{< drg/external-link
    title="Khan Academy"
    url="https://www.khanacademy.org"
    description="Free educational resources that can help you think about how to explain an idea visually and step by step." >}}
...
{{< drg/next-page
    text="You now know how one planned production can teach, document, or entertain"
    teaser="Next, choose whether to visit a real set or study the zoom lens in detail."
