...
{{< drg/checklist title="Must-have coverage for a court of honor" subtitle="Protect these shots first" >}}
...
{{< drg/safety-first >}}
During a ceremony, do not block aisles, emergency exits, or the view of families and guests. Move only when it will not distract from the event, and always follow the directions of the adults running the program.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
If you miss a key line of dialogue, do not panic. Cutaways of hands clapping, awards, or faces listening can help you cover edits and keep the story understandable.
{{< /drg/tip >}}

{{< drg/video
    title="4 Videography Tips for Beginners (video)"
    url="https://youtu.be/oPfet0ypjmY?si=flKBth5nUkcFZelI" >}}

{{< drg/external-link
    title="The American Society of Cinematographers"
    url="https://theasc.com"
    description="Professional cinematography resources that show how camera placement and coverage choices shape audience experience." >}}
...
If you want more creative control than event coverage allows, compare this option with [Req 2d2](/merit-badges/moviemaking/guide/req2d2/). If you would rather teach clearly than capture an event, [Req 2d3](/merit-badges/moviemaking/guide/req2d3/) may fit better.

{{< drg/next-page
    text="You have seen how event coverage depends on preparation and timing"
    teaser="Next, compare that with creating a short feature of your own design."
