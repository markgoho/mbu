...
req_number: "2b"
req_path: "2.b"
prev: "/merit-badges/moviemaking/guide/req2a/"
prev_title: "Write the Treatment"
next: "/merit-badges/moviemaking/guide/req2c/"
next_title: "Master Camera Moves"
---

{{< drg/requirement number="2b" >}}
Prepare a storyboard for your motion picture. Note: This can be done with rough sketches and stick figures.
{{< /drg/requirement >}}
...
In other words, your treatment from [Req 2a](/merit-badges/moviemaking/guide/req2a/) tells the story in paragraphs. The storyboard tells it in frames.

{{< drg/tip >}}
If you cannot explain what a panel is supposed to show, the shot may still be too vague. Tightening the storyboard usually improves the finished movie.
{{< /drg/tip >}}
...
{{< drg/checklist title="Storyboard essentials" subtitle="These details make a panel useful on shoot day" >}}
...
{{< drg/image src="images/moviemaking-storyboard-example.avif" alt="Six-panel storyboard example with rough sketch frames showing different shot types and movement" >}}
...
{{< drg/be-prepared title="What if the real event changes?" >}}
If your planned order changes during filming, keep the story goal in mind.

- **Protect the key moments**: Get the shots that explain what happened.
- **Grab cutaways**: Hands clapping, flags, faces, gear, and signs help smooth edits.
- **Adapt, do not panic**: A flexible storyboard is still useful because it tells you what matters most.
{{< /drg/be-prepared >}}

{{< drg/download
    title="Production Planning Worksheet"
    url="/merit-badges/moviemaking/guide/production-planning-worksheet/"
    type="printable"
    description="Print this worksheet to draft your treatment, list shot details, and rough out storyboard panels before filming." >}}

{{< drg/video
    title="What Is a Storyboard and Why Is It Important? Pre-Production Filmmaking (video)"
    url="https://youtu.be/yPtqHdQcOOw?si=24Rdiz36nJTayneu" >}}

{{< drg/external-link
    title="BFI homepage"
    url="https://www.bfi.org.uk"
    description="The British Film Institute offers film-learning resources and examples that can help you understand how scenes are planned and built." >}}
...
{{< drg/next-page
    text="Your movie now exists on paper"
    teaser="Next, practice the camera techniques that will bring those storyboard panels to life."
