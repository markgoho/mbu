...
req_number: "3b"
req_path: "3.b"
prev: "/merit-badges/moviemaking/guide/req3a/"
prev_title: "Req 3a — Visit a Working Set"
next: "/merit-badges/moviemaking/guide/req4/"
next_title: "Req 4 — Choose Your Next Step"
---
...
{{< drg/checklist title="Other zoom-lens ideas worth mentioning" subtitle="These can strengthen your counselor discussion" >}}
...
Zoom lenses shine when the subject changes distance quickly or when you cannot easily move your camera position. That is one reason they are popular for event coverage like the court-of-honor option in [Req 2d1](/merit-badges/moviemaking/guide/req2d1/). They are also practical on documentaries and school productions.
...
{{< drg/image src="images/moviemaking-zoom-lens-parts.avif" alt="Diagram of a zoom lens labeled with zoom ring, focus ring, aperture area, and focal length markings" >}}

## A strong explanation for your counselor

If you are discussing this requirement out loud, try this structure:

1. Explain what changing focal length does to the frame.
2. Name three important parts and what each one controls.
3. Give an example of when a zoom lens is helpful in real filming.
4. Compare zooming with physically moving the camera.

{{< drg/tip >}}
If you have access to a camera or even a phone with multiple built-in lens views, demonstrate the difference while you explain it. Seeing the frame change makes the concept much easier to understand.
{{< /drg/tip >}}

{{< drg/video
    title="How Lens Work in Camera (video)"
    url="https://youtu.be/fRKsKR9wvqE" >}}

{{< drg/video
    title="The Parts of a Camera Lens - Anatomy of a DSLR Lens (video)"
    url="https://youtu.be/15h9iG-Rdwk?si=TUp4-HL00H50ZX79" >}}

{{< drg/external-link
    title="The American Society of Cinematographers"
    url="https://theasc.com"
    description="Cinematography articles and professional resources that help explain how lenses affect image-making decisions." >}}
...
{{< drg/next-page
    text="You now have a clearer view of how camera optics shape a shot"
    teaser="Next, decide whether to explore a moviemaking career path or a long-term hobby."
