  ...
  - group_title: "Getting Started"
    items:
      - title: "Introduction & Overview"
        ...
        is_sub: false
  - group_title: "Film Language Basics"
    items:
  ...
  - group_title: "Beyond the Badge"
    items:
      - title: "Extended Learning"
        url: "/merit-badges/moviemaking/guide/extended-learning/"
        is_sub: false
---
...
{{< drg/external-link
    title="Moviemaking Merit Badge Pamphlet"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Pamphlets/Moviemaking.pdf"
    description="The official merit badge pamphlet gives background, vocabulary, and examples you can use alongside this guide." >}}
...
{{< drg/tip >}}
The best moviemaking projects get easier after the first hour of planning. If you know your story, your shots, and your audience before filming starts, production becomes much less stressful.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Many of the skills that make a big-budget movie work — framing, camera movement, and editing for rhythm — are exactly the same skills used in a one-person event video.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/moviemaking-types-collage.avif" alt="Four-panel collage comparing narrative, documentary, event, and training video setups in moviemaking" >}}
...
{{< drg/next-page
    text="Every good movie is built from clear visual choices"
    teaser="Learn the film language behind storytelling, framing, rhythm, and camera movement."
    url="/merit-badges/moviemaking/guide/req1/" >}}
