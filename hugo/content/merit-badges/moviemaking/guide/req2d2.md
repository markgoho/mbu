---
title: "Create a Short Feature"
layout: "guide"
group_title: "2. Planning Your Movie"
req_number: "2d2"
req_path: "2.d.2"
prev: "/merit-badges/moviemaking/guide/req2d1/"
prev_title: "Cover a Court of Honor"
next: "/merit-badges/moviemaking/guide/req2d3/"
next_title: "Teach a Scout Skill"
---
...
- a small number of performers
- a running time that stays focused
...
This is where [Req 1](/merit-badges/moviemaking/guide/req1/) really pays off. Your lens choice, framing, movement, and rhythm should support the emotional beat of each moment. A wide establishing shot helps the audience understand where they are. A close-up can capture reaction. A slower rhythm may fit a thoughtful scene, while faster cutting may fit a problem-solving sequence.

{{< drg/checklist title="Short feature planning questions" subtitle="Answer these before you shoot" >}}
...
{{< drg/image src="images/moviemaking-short-feature-set.avif" alt="Small short-feature film set with Scout filmmaker, actors, tripod camera, and storyboard" >}}
...
{{< drg/tip >}}
If your feature feels confusing, the problem is often missing setup. Add or protect one simple shot that establishes location, object, or intention.
{{< /drg/tip >}}

{{< drg/video
    title="10 Tips for Beginner Videographers (video)"
    url="https://youtu.be/kZWH6OBDdR0?si=e1VBvG2lGwQHKqEY" >}}

{{< drg/external-link
    title="BFI homepage"
    url="https://www.bfi.org.uk"
    description="Film-learning resources and short-film inspiration that can help you think about story structure and creative choices." >}}
...
If you prefer a real event, see [Req 2d1](/merit-badges/moviemaking/guide/req2d1/). If you want your movie to teach a skill clearly, [Req 2d3](/merit-badges/moviemaking/guide/req2d3/) may be a better fit.

{{< drg/next-page
    text="You have explored the most creative path in this requirement"
    teaser="Now compare it with making a training vignette for a new Scout."
