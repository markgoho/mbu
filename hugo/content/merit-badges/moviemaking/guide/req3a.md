...
{{< drg/checklist title="Questions to keep in mind during the visit" subtitle="These observations will help you talk with your counselor afterward" >}}
...
{{< drg/safety-first >}}
Stay with the approved adult, obey every instruction from the crew, and never cross into active equipment areas unless invited. Sets may include hot lights, cables, moving carts, elevated platforms, or quiet zones where distraction creates real problems.
{{< /drg/safety-first >}}

{{< drg/tip >}}
Bring a notebook. Right after the visit, jot down the crew roles you saw, the most interesting equipment, and one moment that changed how you think about moviemaking.
{{< /drg/tip >}}

{{< drg/video
    title="Film Set Order of Operations (video)"
    url="https://youtu.be/zqUAiM-FLrs?si=xK2hkF_sD9zCzGcM" >}}

{{< drg/external-link
    title="The Academy — Education"
    url="https://www.oscars.org/education"
    description="The Academy's education programs can help you explore how film professionals learn the craft and how productions are organized." >}}
...
If a set visit is not available, the zoom-lens option in [Req 3b](/merit-badges/moviemaking/guide/req3b/) still gives you a strong technical skill to discuss with your counselor.

{{< drg/next-page
    text="A real production visit shows how many moving parts support one finished shot"
    teaser="Now take a closer look at the zoom lens and why filmmakers value it."
