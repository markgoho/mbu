...
When you plan your own movie in [Req 2a](/merit-badges/moviemaking/guide/req2a/), ask yourself: what can the camera show instead of what a character can say? Movies become stronger when actions, objects, and faces carry part of the meaning.

{{< drg/tip >}}
If a line of dialogue only repeats what the audience can already see, cut or shorten it. Let the image do some of the work.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Your audience starts feeling a scene's rhythm before they consciously notice it. That is why even simple edits can make a video feel exciting or dull.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="How to protect screen direction" subtitle="Use these habits while filming conversations or action" >}}
...
{{< drg/safety-first >}}
When demonstrating camera movement, keep the filming area clear. Do not walk backward without a spotter, swing a tripod into other people, or move while distracted near stairs, roads, or water.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/moviemaking-composition-guide.avif" alt="Diagram comparing weak and strong on-camera framing with headroom, looking room, and subject placement" >}}
...
- **Wide** for locations, groups, or action in tight spaces
- **Normal** for natural-looking interviews and everyday scenes
- **Longer / telephoto** for isolating a subject or filming from farther away

The best lens is not the most dramatic one. It is the one that helps the audience understand the scene.

{{< drg/video
    title="Film Making Basics (video)"
    url="https://youtu.be/BFwMRVwrKcA?si=uW4whxq0-SZjyFHJ" >}}

{{< drg/external-link
    title="The American Society of Cinematographers"
    url="https://theasc.com"
    description="A professional cinematography organization with articles and learning resources that show how visual choices shape a scene." >}}
...
{{< drg/next-page
    text="Now you know the language of camera and editing choices"
    teaser="Use that film language to write a treatment that turns your idea into a clear visual story."
