...
{{< drg/checklist title="Build a hobby plan you can sustain" subtitle="Use these categories when talking with your counselor" >}}
...
{{< drg/tip >}}
A hobby lasts longer when you make things for real people. If your troop, family, or school actually wants the finished video, you are more likely to keep practicing.
{{< /drg/tip >}}

{{< drg/external-link
    title="The Academy — Education"
    url="https://www.oscars.org/education"
    description="Education programs and film-learning opportunities that can help young filmmakers keep building their skills." >}}

{{< drg/external-link
    title="BFI homepage"
    url="https://www.bfi.org.uk"
    description="Film-learning resources and youth opportunities that can inspire realistic next steps for a continuing hobby." >}}

{{< drg/video
    title="Filmmaking as a Hobby - Getting Started (video)"
    url="https://youtu.be/d30kfqueNKI" >}}
...
{{< drg/next-page
    text="You now have a path for continuing beyond the requirements"
    teaser="Celebrate what you have learned and explore deeper film ideas in Extended Learning."
