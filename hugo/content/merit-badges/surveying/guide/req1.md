...
{{< drg/checklist title="Field Safety Scan" subtitle="Use this before setting up an instrument" >}}
...
{{< drg/safety-first >}}
Surveying sometimes puts you in places where emergency help is not right next to you. Treat every field session like an outdoor activity: wear proper clothing, carry water, tell people where you are, and stop work if weather or terrain becomes unsafe.
{{< /drg/safety-first >}}
...
{{< drg/video
    title="How to Treat Cuts & Scrapes | First Aid Training (video)"
    url="https://youtu.be/L77rERL64zc?si=3OoxbYxRfSOm5dX7" >}}

{{< drg/tip >}}
In thick brush, long pants and gloves prevent many small injuries before they start. Good first aid begins with good prevention.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="Snake Bites (website)"
    url="https://www.scouting.org/health-and-safety/safety-moments/snake-bites/"
    description="Official Scouting guidance on preventing snakebites and responding correctly if one happens in the field." >}}
...
{{< drg/video
    title="Bites or Stings of Insects and Arachnids (video)"
    url="https://youtu.be/qP2ETKAOPWo?si=_tmXRhrdNV5cbQRn" >}}
...
{{< drg/image src="images/tick-check-after-fieldwork.avif" alt="Scout checking socks and pant legs for ticks after brushy fieldwork with survey gear nearby" >}}

{{< drg/be-prepared title="If your work area is full of brush" >}}
Before you begin, tuck pant legs into socks if needed, use insect repellent as directed, and choose a break spot away from tall grass. When the session ends, do a full tick check before riding home.
{{< /drg/be-prepared >}}
...
{{< drg/video
    title="Heat and Cold Emergencies - How to Treat Dehydration (video)"
    url="https://youtu.be/3q0s8uKfE8I?si=9vjG5zfeGQpDo3mv" >}}
...
{{< drg/video
    title="First Aid Training - St John Ambulance (video)"
    url="https://youtu.be/DXo5hmiFQmQ?si=pAKne0eAc6FdMZOo" >}}

{{< drg/checklist title="Water and Weather Habits" subtitle="Simple habits prevent many field injuries" >}}
...
{{< drg/did-you-know >}}
A surveyor may return to the same corner marker months or years later. Good field notes about plant cover, insect activity, and other hazards can help the next crew stay safer too.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="Use your safety habits to step into real field measurements."
    teaser="Set up an instrument, record angles and distances, and compare that work with GPS." 
