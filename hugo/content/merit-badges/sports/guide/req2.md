...
{{< drg/inherited-requirement number="2a" req_path="2.a" topic="The importance of the physical exam" />}}
...
{{< drg/tip >}}
Be honest during a physical exam. Hiding symptoms to avoid missing a season can lead to longer injuries and much more missed time later.
{{< /drg/tip >}}

## Requirement 2b

{{< drg/inherited-requirement number="2b" req_path="2.b" topic="The importance of maintaining good health habits for life (such as exercising regularly), and how the use of tobacco products, alcohol, and other harmful substances can negatively affect your health and your performance in sports activities" />}}
...
{{< drg/did-you-know >}}
One poor night of sleep can affect reaction time enough to change how you catch, throw, balance, sprint, or make decisions in a fast game.
{{< /drg/did-you-know >}}

{{< drg/checklist title="Healthy habits athletes can control" subtitle="These choices often matter more than flashy drills" >}}
...
{{< drg/inherited-requirement number="2c" req_path="2.c" topic="The importance of maintaining a healthy diet" />}}
...
{{< drg/be-prepared title="Game day eating" >}}
You do not need a magic pregame meal. Aim for simple, familiar food that gives steady energy.

- **Eat early enough** that you are not starting activity with a heavy stomach.
- **Choose foods you know work well for you.**
- **Bring water and a simple recovery snack** if the event is long.
- **Do not try extreme diets** just because someone online promises better performance.
{{< /drg/be-prepared >}}

{{< drg/image src="images/athlete-plate-balance.avif" alt="Plate showing balanced athlete meal with grains, lean protein, vegetables, fruit, and water bottle" >}}
...
{{< drg/next-page
    text="Healthy athletes need healthy habits."
    teaser="Next, explore warmups, strength training, amateur sports, and sportsmanship."
