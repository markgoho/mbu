...
{{< drg/safety-first >}}
If you choose a sport with frequent contact, learn the rules that protect players before you worry about advanced skills. Bad technique and careless play can turn a normal contest into a serious injury in seconds.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="Every strong season starts with safety."
    teaser="Learn how to spot sports risks, reduce them, and respond to common injuries."
    url="/merit-badges/sports/guide/req1/" >}}
