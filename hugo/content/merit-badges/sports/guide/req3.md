...
{{< drg/inherited-requirement number="3a" req_path="3.a" topic="The importance of warming up and cooling down" />}}
...
{{< drg/tip >}}
A real warm-up should match the sport. A swimmer, a wrestler, and a soccer player should not all warm up in exactly the same way.
{{< /drg/tip >}}

## Requirement 3b

{{< drg/inherited-requirement number="3b" req_path="3.b" topic="The importance of weight training" />}}
...
{{< drg/safety-first >}}
Never copy advanced lifts or heavy programs from social media without coaching. Poor form under load can injure your back, shoulders, knees, or wrists.
{{< /drg/safety-first >}}

## Requirement 3c

{{< drg/inherited-requirement number="3c" req_path="3.c" topic="What an amateur athlete is and the differences between an amateur and a professional athlete" />}}
...
{{< drg/inherited-requirement number="3d" req_path="3.d" topic="The attributes (qualities) of a good sport, the importance of sportsmanship, and the traits of a good team leader and player who exhibits Scout spirit on and off the playing field" />}}
...
{{< drg/checklist title="Scout spirit in sports" subtitle="What it looks like in real life" >}}
...
{{< drg/be-prepared title="Your team gets a bad call" >}}
How you react in that moment says a lot about you.

- **Do not escalate** by yelling or copying bad behavior.
- **Reset your focus** to the next play or next action.
- **Support teammates** who are upset.
- **Let coaches and officials do their jobs.**
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="Preparation is not just physical."
    teaser="Next, choose two sports that meet the badge rules and fit your schedule."
