---
title: "Sports Safety and First Aid"
layout: "guide"
group_title: "1. Safety and Injury Prevention"
req_number: "1"
req_path: "1"
prev: "/merit-badges/sports/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/sports/guide/req2/"
next_title: "Health Habits That Support Performance"
---
...
{{< drg/checklist title="Sports Risk Scan" subtitle="Use these questions before practice or competition" >}}
...
- **Look for warning signs** like limping, dizziness, confusion, unusual pain, or trouble moving normally.
- **Tell a coach, trainer, parent, or other responsible adult right away.**
- **Do not let pride make the decision.** Returning too soon can turn a manageable injury into weeks or months of recovery.
{{< /drg/be-prepared >}}

{{< drg/safety-first >}}
Any possible head, neck, or back injury should be treated seriously. Do not move the person unless they are in immediate danger, and get trained adult help at once.
{{< /drg/safety-first >}}
...
{{< drg/safety-first >}}
If you suspect heat stroke, call emergency services immediately. Move the person to a cooler place and begin active cooling while waiting for help.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
A concussion does not require someone to be knocked unconscious. Many concussions happen with no blackout at all, which is why paying attention to behavior and symptoms matters so much.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="What your counselor wants to hear" subtitle="Show understanding, not memorized words" >}}
...
{{< drg/image src="images/sports-first-aid-essentials.avif" alt="Sports first-aid kit with elastic wrap, instant cold pack, gauze, athletic tape, blister care, and water bottle arranged for quick access" >}}
...
{{< drg/next-page
    text="Safety is only the beginning."
    teaser="Next, look at physical exams, health habits, and nutrition that support strong performance."
