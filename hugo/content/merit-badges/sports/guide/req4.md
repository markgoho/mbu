...
{{< drg/checklist title="Choosing two workable sports" subtitle="Ask these questions before you commit" >}}
...
{{< drg/tip >}}
Bring details to your counselor, not just sport names. A stronger conversation sounds like: "I plan to do tennis through the parks league on Tuesdays and Thursdays, plus weekend matches" instead of just "I choose tennis."
{{< /drg/tip >}}
...
{{< drg/be-prepared title="One of your sports falls through" >}}
Maybe the season gets canceled, you move, or you cannot meet the competition requirement.

- **Tell your counselor early.**
- **Review whether a different approved sport is available.**
- **Keep any records you already made** in case some work still helps your understanding.
- **Do not wait until the end** and hope the missing competitions will somehow count.
{{< /drg/be-prepared >}}

{{< drg/image src="images/sports-choice-planner.avif" alt="Scout comparing two sports options with schedule, equipment, travel, and competition boxes on a planning sheet" >}}
...
{{< drg/next-page
    text="Your sport choices create the rest of the badge."
    teaser="Next, build the training, tracking, technique, and competition plan for your two sports."
