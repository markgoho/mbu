...
{{< drg/checklist title="A workable personal training program" subtitle="Keep it simple enough to follow" >}}
...
{{< drg/download
    title="Sports Season Tracking Worksheet"
    url="/merit-badges/sports/guide/sports-season-tracking-worksheet/"
    type="printable" >}}
...
{{< drg/tip >}}
Ask a coach or experienced instructor to name one correction for each sport that would most improve your form. A single clear cue is easier to remember than ten at once.
{{< /drg/tip >}}
...
{{< drg/inherited-requirement number="5f" req_path="5.f" topic="Draw and explain a diagram of the playing area for each sport." />}}
...
{{< drg/image src="images/playing-area-diagram-example.avif" alt="Simple labeled sports playing area diagram with boundaries, scoring areas, and player positions" >}}

## Requirement 5g

{{< drg/inherited-requirement number="5g" req_path="5.g" topic="Participate in each sport as a competitive individual or as a member of an organized team for one season (or for three months)." />}}
...
{{< drg/be-prepared title="Progress feels slow in the middle of the season" >}}
That happens to almost every athlete.

- **Keep following the plan** instead of chasing random new drills.
- **Use your chart** to look for small improvements you might miss day to day.
- **Ask for one practical adjustment** from a coach or counselor.
- **Remember that consistency is part of the badge.**
{{< /drg/be-prepared >}}

## Requirement 5h

{{< drg/inherited-requirement number="5h" req_path="5.h" topic="At the end of the season, share your completed chart with your counselor and discuss how your participation in the sports you chose has affected you mentally and physically." />}}
...
{{< drg/checklist title="End-of-season reflection" subtitle="Good topics to discuss with your counselor" >}}
...
{{< drg/next-page
    text="A full season teaches more than scores and stats."
    teaser="Next, choose whether to explore a sports career or a sports-based hobby and lifestyle."
