...
req_number: "6a"
req_path: "6.a"
prev: "/merit-badges/sports/guide/req6/"
prev_title: "Req 6 — Choose Your Next Step"
next: "/merit-badges/sports/guide/req6b/"
next_title: "Req 6b — Build a Sports-Based Lifestyle"
---
...
{{< drg/checklist title="Career research checklist" subtitle="These are the details your counselor will want to hear" >}}
...
{{< drg/tip >}}
When you discuss the career with your counselor, include at least one thing that attracts you and one thing that gives you pause. That shows you thought beyond the surface.
{{< /drg/tip >}}

{{< drg/external-link title="National Athletic Trainers' Association" url="https://www.nata.org/" description="Professional organization with information about athletic training, career pathways, and the role athletic trainers play in sports safety and performance." >}}

{{< drg/external-link title="American Physical Therapy Association" url="https://www.apta.org/" description="Learn about physical therapy careers, education paths, and the role movement science plays in sports and rehabilitation." >}}

{{< drg/be-prepared title="The career sounds great, but the path is longer than you expected" >}}
That is useful information, not bad news.

- **Break the path into stages** such as school, certification, early experience, and later advancement.
- **Ask what part still interests you most.**
- **Compare it with your other two careers.**
- **Remember that ruling something out thoughtfully is still a good outcome.**
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="Sports can lead to work, but they do not have to."
    teaser="Next, explore how sports skills can support a hobby and a long-term healthy lifestyle."
