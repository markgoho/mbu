...
With your parent or guardian's permission, visit three websites that belong to graphic arts professional organizations and/or printing-related companies (suppliers, manufacturers, printers). Print out or download product or service information from two of the sites.
{{< /drg/requirement >}}
...
{{< drg/external-link
    title="GCEA - Graphic Communicators Education Association (website)"
    url="https://www.gceaonline.org/"
    description="This organization helps you see how educators and industry supporters promote graphic communications learning and career development." >}}

{{< drg/external-link
    title="Book Arts Associations (website)"
    url="https://guildofbookworkers.org/book-arts-organization"
    description="This directory introduces organizations connected to book arts, binding, printing, and related crafts across the field." >}}
...
{{< drg/checklist title="Website Research Checklist" subtitle="Use the same questions for each site so you can compare them" >}}
...
{{< drg/tip >}}
Save the two downloaded or printed items in a folder and label where each one came from. That makes it much easier to show your counselor that you completed the research carefully.
{{< /drg/tip >}}
...
This option also sets you up well for [Req 7 — Careers in Graphic Arts](/merit-badges/graphic-arts/guide/req7/), because the sites you explore may introduce jobs and specialties you had never heard of before.
...
{{< drg/next-page
    text="You now know how to compare professional organizations and companies by the information they share online."
    teaser="Next, explore career paths in graphic arts and choose one to research more deeply."
