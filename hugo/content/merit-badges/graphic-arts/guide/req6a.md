---
title: "Newspaper Printing Visit"
layout: guide
group_title: "6. Explore the Industry"
req_number: "6a"
prev: "/merit-badges/graphic-arts/guide/req6/"
prev_title: "Choose a Graphic Arts Visit"
next: "/merit-badges/graphic-arts/guide/req6b/"
next_title: "Commercial Printing Visit"
---
...
1. a reporter gathers information
2. an editor reviews and revises the story
3. designers or page editors place text, headlines, and images into a layout
4. the final page file is checked and sent to production
5. plates or digital systems prepare the job for the press
6. the press prints, folds, and organizes the paper
...
{{< drg/image src="images/newspaper-story-workflow-diagram.avif" alt="Workflow diagram showing a story moving from reporting and editing through layout, prepress, and printing" >}}

{{< drg/video
    title="How The New York Times Is Made (video)"
    url="https://youtu.be/MrWP2z8I0Qk?si=zVnbTit-WqZa2BFD" >}}
...
{{< drg/video
    title="How Are Newspapers Made? (video)"
    url="https://www.youtube.com/watch?v=dEqMu7IVURE%20" >}}

Use this video to compare what you see on your visit with another newspaper production workflow.

## Questions to Ask

{{< drg/checklist title="Good Questions for a Newspaper Visit" subtitle="Use these to help you notice the most important parts of the process" >}}
...
{{< drg/tip >}}
Take notes in sequence. If you write your observations in the order the work happens, it becomes much easier to explain the visit clearly later.
{{< /drg/tip >}}

## Connecting the Visit to the Badge

This option ties together several earlier requirements. You will see printing processes from [Req 1 — Printing Processes](/merit-badges/graphic-arts/guide/req1/), image handling from [Req 2 — Images, Halftones, and Digital Files](/merit-badges/graphic-arts/guide/req2/), and layout decisions from [Req 3 — Design Choices and Production Planning](/merit-badges/graphic-arts/guide/req3/). A newspaper plant is almost like watching the whole badge come alive in one place.
...
{{< drg/next-page
    text="You now know how to follow a newspaper story from editing and layout all the way to the press."
    teaser="Next, look at a commercial printing facility where customer jobs move from order to finished product."
