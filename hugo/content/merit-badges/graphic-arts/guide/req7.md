...
{{< drg/video
    title="Desktop Publishing as a Career (video)"
    url="https://www.youtube.com/watch?v=tuP-G9wJxmY" >}}

This video can help you think about careers focused on layout, digital publishing, and document production.

{{< drg/video
    title="Printing Press Operators (video)"
    url="https://www.youtube.com/watch?v=hOArtAsYeP8" >}}

This video is useful if you want to understand the more technical and machine-centered side of the field.

{{< drg/external-link
    title="Graphic Design and Printing Career Guide (website)"
    url="https://www.khake.com/page27.html"
    description="This career guide introduces multiple print and design jobs so you can compare roles, duties, and preparation paths." >}}

## What to Research for One Career

Once you pick one profession, go deeper. Your counselor will want more than a job title.

{{< drg/checklist title="Career Research Checklist" subtitle="Gather these details for the profession you choose" >}}
...
{{< drg/tip >}}
A strong answer sounds like this: "I am interested in prepress because I like catching mistakes and making systems work correctly. I also enjoyed learning how design files affect the final printed result." Specific reasons are stronger than "It seems fun."
{{< /drg/tip >}}

## Looking Back at the Badge

By this point, you have already sampled many parts of the field: printing processes, image handling, design, production, finishing, visits, and research. Use those experiences to guide your career choice. If you liked [Req 3 — Design Choices and Production Planning](/merit-badges/graphic-arts/guide/req3/) most, design-centered careers may appeal to you. If you loved [Req 4 — Pick Your Production Path](/merit-badges/graphic-arts/guide/req4/), technical production roles might be a better fit.

You have finished the badge requirements. The last page goes beyond the badge and shows where graphic arts can lead next.

{{< drg/next-page
    text="You now have a clearer picture of how graphic arts careers match different interests, strengths, and training paths."
    teaser="Finish with extended learning and explore how this field keeps growing beyond the badge."
    url="/merit-badges/graphic-arts/guide/extended-learning/" >}}
