...
{{< drg/video
    title="Tree and Shrub ID (video)"
    url="https://youtu.be/YcMsvqqmorM?si=NO405TME8veCY23U" >}}

{{< drg/tip >}}
Choose examples that clearly differ from one another. If all five trees have the same general shape and leaf texture, you are missing the point of the requirement. Try to include upright, spreading, rounded, fine-textured, coarse-textured, evergreen, and deciduous examples where possible.
{{< /drg/tip >}}
...
{{< drg/image src="images/plant-form-comparison-grid.avif" alt="Comparison grid of common tree, shrub, and ground cover growth forms with labels showing shape differences" >}}

{{< drg/checklist title="Plant Study Questions" subtitle="Use these prompts for every plant you present" >}}
...
{{< drg/be-prepared title="What if two plants look equally good?" >}}
If two choices seem similar, compare them by long-term performance:

- Which one handles your local climate better?
- Which one needs less pruning or watering?
- Which one supports shade, privacy, erosion control, or habitat better?
- Which one is less likely to cause problems with roots, litter, or crowding?

Landscape architects often choose the plant that solves more problems, not just the one with the prettiest flowers.
{{< /drg/be-prepared >}}
...
{{< drg/did-you-know >}}
A tree planted in the wrong place can cost far more to maintain over time than a tree planted in the right place. Root conflicts, repeated pruning, pavement damage, and poor survival often come from bad siting, not a bad species.
{{< /drg/did-you-know >}}
...
This requirement also connects directly to [Req 2](/merit-badges/landscape-architecture/guide/req2/). When you studied the finished landscape, you were looking at what plant choices achieved. Now you are learning how those choices get made.

{{< drg/external-link
    title="USDA Plant Hardiness Zone Map"
    url="https://planthardiness.ars.usda.gov/"
    description="Use the national zone map as a starting point for understanding which plants are likely to survive winter temperatures in your area." >}}

{{< drg/safety-first >}}
If you collect branches, leaves, or flowers for your presentation, get permission first and avoid poisonous or irritating plants. Do not taste plant material, and wash your hands after handling unfamiliar species.
{{< /drg/safety-first >}}

Now that you know how to read plant choices, you are ready to measure a real site and redesign part of it yourself.

{{< drg/next-page
    text="You have practiced selecting plants for appearance, function, and maintenance."
    teaser="Next, map a real site, study drainage, and propose a safer, more comfortable redesign."
