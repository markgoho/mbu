...
{{< drg/video
    title="Defining Spaces and Adding Privacy Outdoors | Design Tips | HGTV (video)"
    url="https://youtu.be/uVVCpugREjY?si=UjWU7ZHOL0LUOErs" >}}

{{< drg/checklist title="How to Evaluate Site Organization" subtitle="Use these prompts when discussing 2a with your counselor" >}}
...
{{< drg/image src="images/site-organization-example.avif" alt="Top-down example showing entry plaza, shaded seating area, open lawn, and connecting paths as distinct outdoor rooms" >}}
...
{{< drg/video
    title="Ripple Park | Landscape Architecture Capstone (video)"
    url="https://youtu.be/lEXvdRFBC8s?si=bSb-EyaJNFCsz99C" >}}

{{< drg/tip >}}
When you talk about structures or seating, do more than say whether you like them. Explain whether they are in the right place, sized for real use, and visually consistent with the rest of the site.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="Spaces that Heal and Comfort (website)"
    url="https://eptdesign.com/spaces-that-heal-and-comfort/"
    description="Shows how outdoor spaces can be designed to reduce stress, support recovery, and make users feel more comfortable and welcome." >}}

{{< drg/be-prepared title="If a site feels uncomfortable, ask why" >}}
Instead of saying only "this area seems bad," try breaking the problem into parts:

- **Is there too much sun or wind?**
- **Are there places to sit and wait?**
- **Can users see where to go next?**
- **Is lighting likely to be strong enough after dark?**
- **Would a younger child, older adult, or person using mobility aids feel supported here?**

That kind of analysis sounds much more like the work of a designer.
{{< /drg/be-prepared >}}
...
{{< drg/video
    title="Landscaping with Trees and Shrubs: Types and Planting (video)"
    url="https://youtu.be/aBVcBep4Gv8?si=qvfbVWL4ZB2Qb4DJ" >}}
...
{{< drg/did-you-know >}}
A shade tree planted near pavement can lower surface temperatures dramatically on hot days. In some places, shaded pavement can be dozens of degrees cooler than pavement in full sun.
{{< /drg/did-you-know >}}
...
This is also a good time to bring back observations from [Req 1](/merit-badges/landscape-architecture/guide/req1/). Use your site visit notes, photos, and plan to explain what the design did well and what you might improve.

{{< drg/safety-first >}}
If you revisit the site to study shade, drainage, or traffic patterns, do it in daylight and stay alert around parking lots, curbs, and loading zones. Some of the most important design features are closest to moving vehicles.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You have analyzed how a completed site handles movement, comfort, structures, and planting."
    teaser="Next, learn how to choose trees, shrubs, and ground covers for function, beauty, and long-term care."
