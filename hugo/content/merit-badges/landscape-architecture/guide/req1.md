...
{{< drg/tip >}}
A project with clear walkways, planting areas, gathering spaces, and a visible entrance is easier to study than a huge site with many scattered features. Pick a place you can walk in one visit and understand without rushing.
{{< /drg/tip >}}
...
{{< drg/checklist title="Site Visit Prep" subtitle="Bring these tools so you can observe carefully" >}}
...
{{< drg/image src="images/site-observation-checkpoints.avif" alt="Small designed site with arrival point, path system, seating, planting zone, and drainage direction highlighted" >}}

{{< drg/did-you-know >}}
People often create "desire paths" by walking where they want to go instead of where the sidewalk tells them to go. Designers study these worn tracks because they reveal how people actually move through space.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="What if you cannot get a plan?" >}}
If the designer cannot provide a plan, you can still complete the requirement well:

- **Sketch the site yourself** as a simple map.
- **Photograph key areas** from several angles.
- **Label the main entrance, paths, seating, structures, and planting zones.**
- **Ask the site owner or manager** what the project was meant to improve.

A simple hand-drawn plan is still useful because it forces you to observe relationships between features.
{{< /drg/be-prepared >}}
...
These questions will help you in [Req 2](/merit-badges/landscape-architecture/guide/req2/), where you discuss how the site functions.
...
{{< drg/safety-first >}}
Choose a site visit time when the location is open and safe to access. Stay out of planting beds, construction zones, drainage channels, and roadways. If you need measurements or close-up photos near traffic, bring an adult and stay well clear of moving vehicles.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You have visited a designed landscape and practiced observing it closely."
    teaser="Next, analyze how spaces, entries, comfort, and planting choices make the site succeed or fail."
