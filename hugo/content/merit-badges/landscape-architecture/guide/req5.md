...
{{< drg/video
    title="Career Connections: Landscape Architect (video)"
    url="https://youtu.be/vVRUsQ8WrW8?si=miQ1-ySUPKVHHO8s" >}}

{{< drg/checklist title="Compare Three Career Options" subtitle="Use these categories to organize your research" >}}
...
{{< drg/image src="images/career-pathway-overview.avif" alt="Visual comparison of three landscape-related career paths with distinct work settings and task types" >}}
...
{{< drg/tip >}}
When researching salary and job outlook, use current sources and pay attention to location. A public-sector job, a private design firm, and a specialized restoration practice may all have different pay ranges and advancement paths.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Not sure whether you would like the career?" >}}
Ask yourself which parts of this badge you enjoyed most:

- **If you loved sketching plans and redesigning spaces**, design or planning careers may fit you.
- **If you liked choosing plants and thinking about maintenance**, horticulture, arboriculture, or nursery work may fit you.
- **If you enjoyed solving drainage and access problems**, site planning, civil design support, or environmental work may fit you.

You do not have to decide your future now. You only need to notice what kinds of problems you like solving.
{{< /drg/be-prepared >}}
...
This is also a good place to reflect on the badge as a whole. In [Req 1](/merit-badges/landscape-architecture/guide/req1/), you studied a completed project. In [Req 4](/merit-badges/landscape-architecture/guide/req4/), you created your own redesign. Those are exactly the kinds of observation and problem-solving skills professionals use.

{{< drg/did-you-know >}}
Landscape architects often work in teams with civil engineers, architects, ecologists, planners, artists, and construction professionals. The job sits at the meeting point of many different fields.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="American Society of Landscape Architects — Discover Landscape Architecture"
    url="https://www.asla.org/discoverlandscapearchitecture.aspx"
    description="Explains what landscape architects do and offers a strong starting point for career research and examples of real projects." >}}
...
{{< drg/next-page
    text="You have explored careers that turn outdoor problem-solving into real work."
    teaser="Go beyond the badge with deeper topics, field experiences, and organizations to follow."
