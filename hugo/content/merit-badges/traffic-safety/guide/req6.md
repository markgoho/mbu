...
{{< drg/video
    title="Bike Safety - Sharing the Road (video)"
    url="https://youtu.be/zm_uXZJnCSk" >}}

{{< drg/video
    title="The Basics of Bicycle Safety (video)"
    url="https://youtu.be/DJc18FiARLc?si=tV7T0fXYYDHGVdmm" >}}

{{< drg/video
    title="What to Do to Make Driving at Night Safer (video)"
    url="https://youtu.be/uYhwXwVDlF0?si=3M13qEkL7YbemovD" >}}

{{< drg/safety-first >}}
Drivers should never assume a dark roadway is empty. At night, reduce speed, scan farther ahead, and expect people walking, biking, or stepping out where you least expect them.
{{< /drg/safety-first >}}
...
{{< drg/video
    title="The Basics of Pedestrian Safety (video)"
    url="https://youtu.be/Lsv1TSy8JbA?si=Yv-ODDQIlOvnSNbC" >}}

{{< drg/tip >}}
If you are walking with a group, do not spread across the shoulder or cross casually in a pack. A compact, alert group is easier for drivers to understand and avoid.
{{< /drg/tip >}}
...
{{< drg/video
    title="Driving Safety 101: School Bus Safety (video)"
    url="https://youtu.be/XSYE2z3LCUI" >}}
...
{{< drg/checklist title="Safe lane-change routine" subtitle="Make each step deliberate" >}}
...
{{< drg/video
    title="Blind Spots Lessons (video)"
    url="https://youtu.be/bkX_NSCM0Hw" >}}

{{< drg/video
    title="Lane Changes (video)"
    url="https://youtu.be/H0EA2RD-w2c" >}}

{{< drg/image src="images/car-and-truck-blind-spots.avif" alt="Top-down comparison diagram showing blind-spot zones around a passenger car and a large truck during a lane change" >}}
...
{{< drg/next-page
    text="You have focused on the people around the vehicle and the habits that protect them."
    teaser="Next, choose a community-based project that turns traffic safety from knowledge into action."
