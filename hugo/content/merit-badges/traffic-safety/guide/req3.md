...
{{< drg/video
    title="Types of Car Lights & Their Purposes (video)"
    url="https://youtu.be/8FW-7dfAIwQ" >}}

{{< drg/tip >}}
Turn signals are a courtesy and a safety tool. Signal early enough that other drivers can react, not at the exact moment you start moving.
{{< /drg/tip >}}
...
{{< drg/checklist title="Visibility problems to notice" subtitle="Look through every window, not just the windshield" >}}
...
{{< drg/video
    title="How to Check Your Wipers (video)"
    url="https://youtu.be/MmA6Cbn5vH8" >}}
...
{{< drg/video
    title="How to Check Your Tires (video)"
    url="https://youtu.be/2Tcvmp4Cqao" >}}

{{< drg/image src="images/tire-pressure-tread-check.avif" alt="Annotated photo of a Scout checking tire pressure with a gauge and measuring tire tread depth on a parked car" >}}
...
{{< drg/safety-first >}}
If you have a flat near fast-moving traffic, your first job is scene safety. Move as far from traffic as possible, turn on hazard flashers, and use the procedure your adult supervisor approves. If the location is unsafe, call for roadside assistance instead of trying to change the tire there.
{{< /drg/safety-first >}}
...
{{< drg/video
    title="Tire Inflator and Sealant Kit (video)"
    url="https://youtu.be/X3kjWwCENX4" >}}
...
- **reaction distance** — how far the car travels before the driver even begins braking
...
{{< drg/external-link
    title="Stopping Distance Table and Graphs (PDF)"
    url="https://filestore.scouting.org/filestore/Merit_Badge_ReqandRes/Requirement%20Resources/Traffic%20Safety/Stopping%20Distances%20Table%20and%20Graphs.pdf?_t=1764661254"
    description="The official distance chart and graph set you can use to mark off emergency-stop distances for the required demonstration." >}}

{{< drg/video
    title="Thinking, Braking, and Stopping Distances (video)"
    url="https://youtu.be/ZLHgYgEAPhY" >}}

{{< drg/video
    title="Stopping Distance Demonstration (video)"
    url="https://youtu.be/3mDp0k8Nfjc?si=Zoy8bAbLADxtlsz3" >}}

{{< drg/be-prepared title="What changes stopping distance" >}}

- **Impaired driving:** Slower decisions mean a longer reaction distance.
- **Night driving:** Hazards are seen later, so braking begins later.
- **Rain or slick roads:** Less traction means a longer braking distance.
- **Fatigue or distraction:** The brain notices danger later, even if the brakes work perfectly.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have checked the vehicle systems and seen how quickly stopping distances grow."
    teaser="Next, learn the legal rules and road procedures every driver should understand."
