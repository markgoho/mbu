...
{{< drg/safety-first >}}
Never tuck the shoulder belt behind your back or under your arm just because it feels more comfortable. That changes where crash forces go and can turn the belt into a source of injury instead of protection.
{{< /drg/safety-first >}}

{{< drg/video
    title="How to Wear a Seat Belt Properly (video)"
    url="https://youtu.be/Cq1auN7xtlo" >}}

{{< drg/video
    title="Car Seat Safety (video)"
    url="https://youtu.be/TPGjlzUenL0" >}}

{{< drg/tip >}}
Before a trip starts, glance around the vehicle. A driver should never pull away until every passenger is buckled, every child seat is properly used, and loose gear is secured.
{{< /drg/tip >}}
...
{{< drg/checklist title="How to describe a safety feature" subtitle="Use this pattern when talking with your counselor" >}}
...
{{< drg/video
    title="10 Car Safety Features That Every Car Must Have (video)"
    url="https://youtu.be/D2kM8gEoGYY" >}}

{{< drg/image src="images/vehicle-safety-features-dashboard.avif" alt="Driver's-eye view diagram of a vehicle interior and safety-system indicators including backup camera, blind-spot warning, ABS, stability control, and automatic headlights" >}}
...
{{< drg/next-page
    text="You now know how restraints and built-in safety systems protect people in a crash."
    teaser="Next, learn how to inspect lights, wipers, tires, and emergency equipment before driving."
