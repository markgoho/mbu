---
title: "Reading Signs, Signals, and Markings"
layout: "guide"
group_title: "5. Road Design and Traffic Signs"
req_number: "5b"
req_path: "5.b"
prev: "/merit-badges/traffic-safety/guide/req5a/"
prev_title: "Safer Roads by Design"
next: "/merit-badges/traffic-safety/guide/req6/"
next_title: "Sharing the Road Safely"
---
...
{{< drg/video
    title="Understanding Road Signs (video)"
    url="https://youtu.be/KxrfkcDAgsY" >}}

{{< drg/video
    title="Traffic Signals (video)"
    url="https://youtu.be/Hj87mH_a4jk" >}}

{{< drg/video
    title="Pavement Markings (video)"
    url="https://youtu.be/Lq3p5i9g9c0" >}}

{{< drg/checklist title="How to explain a sign or marking" subtitle="Use this structure when discussing examples with your counselor" >}}
...
{{< drg/tip >}}
When you ride with an adult, practice calling out signs and markings before the car reaches them. That turns passive riding into active traffic-safety training.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You can now read the road's visual language more quickly and clearly."
    teaser="Next, learn how to share roads safely with pedestrians, bicyclists, school buses, and vehicles with dangerous blind spots."
