...
{{< drg/video
    title="How Highways Are Designed and Built (video)"
    url="https://youtu.be/SdYilULmeAc" >}}

{{< drg/did-you-know >}}
Many of the safest road features are ones drivers barely notice when everything goes right. A shoulder, median, or well-timed ramp merge may feel ordinary, but those details quietly prevent serious crashes every day.
{{< /drg/did-you-know >}}

{{< drg/image src="images/safer-road-design-elements.avif" alt="Overhead roadway safety diagram showing a median, shoulders, turn lane, crosswalk, and interstate-style entrance ramp" >}}
...
{{< drg/next-page
    text="You have seen how physical roadway features lower risk before a driver even reacts."
    teaser="Next, compare that with the road's visual language: signs, signals, and pavement markings."
