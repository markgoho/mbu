...
req_number: "1"
req_path: "1"
prev: "/merit-badges/traffic-safety/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/traffic-safety/guide/req2/"
next_title: "Req 2 — Vehicle Safety Basics"
---
...
{{< drg/did-you-know >}}
A driver does not need to fall asleep or be intoxicated to become unsafe. Even a short mental lapse can delay braking long enough to turn a close call into a collision.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Distraction-Prevention Routine" subtitle="Set up the car before you start moving" >}}
...
{{< drg/video
    title="Distracted Driving (video)"
    url="https://youtu.be/zWdfeE2YsNc" >}}

{{< drg/tip >}}
If something inside the car suddenly demands attention, do not try to solve it while moving. Pull over somewhere safe first. That includes arguments, dropped objects, and phone alerts.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Never assume a legal substance is automatically safe for driving. If a label says a medicine may cause drowsiness or impair alertness, treat that as a serious warning, not a suggestion.
{{< /drg/safety-first >}}
...
1. the legal BAC limit
2. the penalties for DUI or DWI
3. the state's open-container law
...
{{< drg/be-prepared title="How to research your state's rules" >}}
Use official state sources whenever possible.

- **Search your state DMV or public safety website** for BAC limits and DUI penalties.
- **Look for the official wording on open containers** so you understand where alcohol may and may not be carried.
- **Write down the exact consequences** for a first offense and for repeat offenses.
- **Bring the source with you** so you can show your counselor where you found it.
{{< /drg/be-prepared >}}

{{< drg/video
    title="The Deadly Truth About Drinking and Driving (video)"
    url="https://youtu.be/6uH75bY8Gd0" >}}

{{< drg/video
    title="Blood Alcohol Content & Driving: What You Need to Know (video)"
    url="https://youtu.be/1cs2t3SiSNw" >}}
...
{{< drg/checklist title="Alert-Driver Planning" subtitle="Use this before long drives, late returns, or troop travel" >}}
...
{{< drg/video
    title="Recognizing Fatigue—Warning Signs (video)"
    url="https://youtu.be/YhK2VLGYMng?si=YdLr0d7mJ020XzSV" >}}

{{< drg/video
    title="Driver Tiredness, Fatigue, and Road Safety (video)"
    url="https://youtu.be/fVl88Q5DJ2w" >}}

{{< drg/tip >}}
Fresh air, loud music, or an open window might help for a minute, but they do not fix fatigue. If a driver is truly sleepy, the only real solution is to stop and rest.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="7 Common Mistakes New Drivers Make—and How to Avoid Them (website)"
    url="https://studentdrivercarmagnets.com/blogs/news/common-driving-mistakes"
    description="A quick review of beginner errors that can help you compare your own habits and spot weak points before they become risky patterns." >}}

{{< drg/video
    title="Most Common Driving Mistakes to Avoid (video)"
    url="https://youtu.be/Arrgxna3L2E" >}}
...
{{< drg/did-you-know >}}
Insurance rates are not only about age. They also reflect choices. Tickets, crashes, and risky behavior can follow a driver financially long after the trip is over.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You have seen how distraction, substances, fatigue, and inexperience raise crash risk."
    teaser="Next, learn how belts, child restraints, and vehicle safety features protect people when something goes wrong."
