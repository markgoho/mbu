...
req_number: "3a"
prev: "/merit-badges/cooking/guide/req2e/"
prev_title: "Req 2e — Food Label Terms"
next: "/merit-badges/cooking/guide/req3b/"
next_title: "Req 3b — Stoves vs. Fires"
---
...
This is one of the most important requirements in the entire merit badge. These ten cooking methods are the foundation of everything you will cook — at home, at camp, and on the trail. You will use at least five of them when you prepare your home meals in [Req 4](/merit-badges/cooking/guide/req4d/), and several more when you cook outdoors in [Req 5](/merit-badges/cooking/guide/req5d/).
...
{{< drg/safety-first >}}
Broiling happens fast. Food can go from perfectly done to burned in less than a minute. Never walk away from a broiler — watch your food the entire time and keep the oven door slightly open if your oven manual recommends it.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Test if your oil is ready by dropping a tiny piece of food or a drop of water into the pan. If it sizzles immediately, you are good to go. If it just sits there quietly, the oil needs more time to heat up.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Never use a charcoal or gas grill indoors or inside a tent. Carbon monoxide from the burning fuel is odorless and deadly. Always grill in a well-ventilated outdoor area.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Use the "drugstore wrap" for foil packets: place food in the center of a large sheet of foil, bring the long sides together and fold them down in small folds, then fold each short end toward the center. This creates a tight seal that prevents leaking and keeps steam inside.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Dutch ovens have been used for centuries. Lewis and Clark carried one on their expedition across America in 1804–1806, and pioneers on the Oregon Trail relied on them daily. The Dutch oven is so important to American culinary history that it is the official state cooking pot of Utah.
{{< /drg/did-you-know >}}
...
{{< drg/video
    title="Types of Cooking Techniques"
    url="https://youtu.be/GE7FJU_9JsA?si=pahlJikaqGxsi8yK" >}}

{{< drg/video
    title="Dutch Oven Basics for Beginners"
    url="https://youtu.be/9uP1mauAtuI?si=tD0sbJHF2nxcapP8" >}}

{{< drg/external-link
    title="Scouting.org — Camp Cooking Resources"
    url="https://www.scouting.org/merit-badges/cooking/"
    description="Official Scouting America page for the Cooking merit badge, including links to requirement resources." >}}

{{< drg/next-page
    text="You now know ten cooking methods and the equipment each one requires."
    teaser="Compare the pros and cons of using a camp stove versus a campfire for outdoor cooking."
