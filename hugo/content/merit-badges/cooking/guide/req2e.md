...
In [Req 1e](/merit-badges/cooking/guide/req1e/), you learned how to read food labels to spot allergens. Now you are going deeper — understanding what each nutrition term means and how to use those numbers to make smart food choices.
...
{{< drg/did-you-know >}}
The American Heart Association recommends no more than 2,300 milligrams of sodium per day for teens — that is about one teaspoon of salt. A single serving of canned soup can contain over 800 milligrams, and a fast-food meal can exceed the entire daily limit in one sitting.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Before looking at any other number on the label, always check the serving size first. A container of ice cream might list 150 calories per serving — but if the serving size is ½ cup and you eat 2 cups, you are actually consuming 600 calories.
{{< /drg/tip >}}
...
4. Check the %DV — is the food high or low in sodium? Fiber? Added sugars?
...
{{< drg/external-link
    ...
    description="The FDA's detailed guide to every section of the Nutrition Facts label, with interactive examples." >}}

{{< drg/video
    title="How to Read Food Labels"
    url="https://youtu.be/76g2wabvA-w?si=gUuXZXKcrK7HY4vZ" >}}

{{< drg/next-page
    text="You can now decode a food label and calculate nutrition for multiple servings."
    teaser="Time to get cooking — learn about ten different cooking methods and the equipment each one requires."
