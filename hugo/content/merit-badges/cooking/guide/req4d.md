...
{{< drg/checklist title="Pre-Cooking Checklist" subtitle="Run through this before every meal" >}}
...
You need to use at least five of the ten methods from [Req 3a](/merit-badges/cooking/guide/req3a/). As you cook each meal, note which method you used. Here is a quick reference:
...
{{< drg/tip >}}
Keep a simple log as you cook. For each meal, write down: (1) what you cooked, (2) which cooking method(s) you used, (3) any challenges you faced, and (4) what you would do differently. This log will help you in [Req 4f](/merit-badges/cooking/guide/req4f/) when you evaluate your meals.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Always check the internal temperature of meats, poultry, and eggs with a food thermometer before serving. Do not rely on color or guesswork. Poultry: 165°F. Ground meat: 160°F. Steaks and fish: 145°F. Eggs: cook until both white and yolk are firm.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="A Dish Does Not Turn Out Right" >}}
You followed the recipe, but the food just does not taste good. What do you do?

- **Step 1:** Stay calm. Assess what went wrong — is it underseasoned, overcooked, or missing something?
- **Step 2:** If possible, fix it. Add salt, a squeeze of acid (lemon juice or vinegar), or a sauce to rescue the dish.
- **Step 3:** If it cannot be saved, serve what you have and be honest with the person eating. "The chicken got a little dry — next time I will take it out sooner."
- **Step 4:** Write down what happened in your cooking log. Learning from mistakes is the whole point.
{{< /drg/be-prepared >}}

{{< drg/next-page
    text="You are cooking and serving real meals."
    teaser="Learn how to time your cooking so every course comes out together."
