...
1. **Weight** — You carry everything on your back. Heavy food means a heavier pack, which means more fatigue and less enjoyment.
2. **No refrigeration** — You cannot bring fresh meat, dairy, or anything that spoils at room temperature.
3. **Calorie density** — You burn a lot of energy hiking. Your food needs to deliver maximum calories per ounce.

{{< drg/did-you-know >}}
Backpackers aim for about 100–125 calories per ounce of food. By comparison, fresh fruits and vegetables provide only 10–30 calories per ounce. That is why trail food looks very different from home cooking — you need lightweight, calorie-dense options to fuel miles of hiking.
{{< /drg/did-you-know >}}
...
**Lunch — No-Cook or Minimal Prep**
Trail lunches should not require a stove. You want to eat quickly and keep moving.
...
**Dinner — The Hot Meal**
Dinner is usually when you set up camp and cook your one big meal of the day.
...
{{< drg/tip >}}
The "GORP" formula (Good Old Raisins and Peanuts) is the classic trail snack for a reason — it is lightweight, calorie-dense, does not spoil, and tastes great. Customize your trail mix with your favorites: almonds, cashews, M&Ms, sunflower seeds, dried cranberries, coconut flakes, and more.
{{< /drg/tip >}}
...
{{< drg/checklist title="Trail Cooking Equipment" subtitle="Keep it light and simple" >}}
...
{{< drg/safety-first >}}
On the trail, water purification is a food safety issue. You need clean water for cooking, drinking, and cleanup. Always purify water from natural sources — even clear, fast-moving streams can contain harmful parasites like Giardia. Bring a reliable purification method and know how to use it.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="MyPlate Kitchen — Recipe Ideas"
    url="https://www.myplate.gov/myplate-kitchen"
    description="Search for simple, adaptable recipes that can be modified for trail cooking with shelf-stable ingredients." >}}

{{< drg/next-page
    text="Your trail menu is planned and your cook kit is packed."
    teaser="Create a shopping list and calculate the cost for your trail meals."
