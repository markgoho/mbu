...
req_number: "5a"
prev: "/merit-badges/cooking/guide/req4f/"
prev_title: "Req 4f — Evaluate & Reflect"
next: "/merit-badges/cooking/guide/req5b/"
next_title: "Req 5b — Camp Recipes & Budget"
---
...
{{< drg/tip >}}
Plan your meals in chronological order. Use perishable items (fresh meat, eggs, dairy) in your first meals when your cooler is coldest. Save shelf-stable options (canned goods, dried pasta, peanut butter) for later meals.
{{< /drg/tip >}}
...
Remember — [Req 5d](/merit-badges/cooking/guide/req5d/) requires specific cooking methods:
...
{{< drg/safety-first >}}
Keep your cooler at 40°F or below. Use a thermometer to check. Pack coolers tight — a full cooler stays cold longer than a half-empty one. Keep the cooler in the shade and open it as infrequently as possible. Use separate coolers for drinks (opened frequently) and food (opened less often).
{{< /drg/safety-first >}}

{{< drg/checklist title="Camp Food Safety Plan" subtitle="Address these in your menu plan" >}}
...
{{< drg/checklist title="Camp Cooking Equipment" subtitle="Common items for patrol-size camp cooking" >}}
...
{{< drg/external-link
    title="MyPlate Resources & Tools"
    url="https://www.myplate.gov/resources/tools"
    description="USDA tools for planning meals that meet nutritional guidelines — useful for scaling camp menus to your group size." >}}

{{< drg/next-page
    text="Your camp menu is planned and your equipment list is ready."
    teaser="Find recipes, create a shopping list, and calculate the per-person cost for your camping trip."
