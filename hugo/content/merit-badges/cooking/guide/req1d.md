...
{{< drg/did-you-know >}}
Roughly 1 in 13 children in the United States has a food allergy — that means in a typical Scout troop, there is a good chance at least one person has a serious food allergy. Always ask before you cook for others.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
As a food handler, you must take food allergies as seriously as any other safety hazard. A mistake with allergens can send someone to the emergency room. Always ask, always read labels, and when in doubt, do not serve the food.
{{< /drg/safety-first >}}
...
- **Labels are your friend.** Learn to read ingredient labels and watch for hidden allergens (you will practice this in [Req 1e](/merit-badges/cooking/guide/req1e/)).
...
- **Know the symptoms.** If someone shows signs of an allergic reaction after eating, act fast. Review the first aid steps from [Req 1b](/merit-badges/cooking/guide/req1b/).

{{< drg/tip >}}
When cooking for your patrol on a camping trip, create a simple "Allergy Card" for each person with allergies. Post these cards in the cooking area so everyone on cooking duty can see them at a glance.
{{< /drg/tip >}}

{{< drg/external-link
    title="FARE — Food Allergy Research & Education"
    url="https://www.foodallergy.org/"
    description="The leading nonprofit organization dedicated to food allergy awareness, education, and research." >}}

{{< drg/next-page
    text="You now understand the differences between food allergies, intolerance, and foodborne illness."
    teaser="Next, learn how to read food labels and spot hidden allergens."
