...
{{< drg/tip >}}
Divide food by meal, not by category. Give one person all the breakfast ingredients, another person the lunch ingredients, and another the dinner ingredients. This makes it easy to find what you need at mealtime — just ask the person carrying that meal.
{{< /drg/tip >}}
...
Trail kitchen cleanup follows the same Leave No Trace principles from [Req 5h](/merit-badges/cooking/guide/req5h/), but in a more austere environment:

{{< drg/checklist title="Trail Kitchen Cleanup" subtitle="Complete these before breaking camp" >}}
...
{{< drg/safety-first >}}
"Scented items" means more than just food. Toothpaste, sunscreen, lip balm, deodorant, and even the clothes you cooked in can attract bears and other animals. Store ALL scented items with your food — not in your tent.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
The saying "a fed bear is a dead bear" is unfortunately true. Bears that learn to get human food often become aggressive and must be relocated or euthanized. Proper food storage does not just protect your gear — it protects the wildlife.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Cleaning Up and Washing Dishes on the Trail"
    url="https://youtu.be/NNcu_Ujoiv4?si=_ihxT_zdA1-mfoJI"
    description="A practical video on trail dishwashing techniques that minimize water use and protect the environment." >}}

{{< drg/next-page
    text="You have covered trail cooking from planning to cleanup to food storage."
    teaser="Explore careers and hobbies in the world of cooking."
