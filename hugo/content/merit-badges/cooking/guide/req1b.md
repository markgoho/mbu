...
{{< drg/safety-first >}}
Steam burns are deceptive. Steam is actually hotter than boiling water because it carries extra energy. Always tilt lids away from your face when opening a pot, and stand back when draining pasta or boiling water.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
If you cut yourself while preparing food, stop cooking immediately. Wash your hands thoroughly, treat the wound, and put on a bandage AND a food-safe glove before returning to food preparation. Blood is a contamination risk.
{{< /drg/tip >}}

**Prevention:**

- Always cut away from your body on a stable cutting board.
- Use the claw grip (from [Req 1a](/merit-badges/cooking/guide/req1a/)) to protect your fingers.
...
- **Step 2:** Stand behind them. Place your fist above their navel.
- **Step 3:** Deliver firm upward thrusts until the object comes out.
- **Step 4:** If they lose consciousness, lower them to the floor and begin CPR. Continue until help arrives.
{{< /drg/be-prepared >}}
...
- Read every ingredient label carefully (you will learn more about this in [Req 1e](/merit-badges/cooking/guide/req1e/)).
...
{{< drg/external-link
    ...
    description="The Red Cross provides step-by-step first aid guides for burns, cuts, choking, and allergic reactions." >}}

{{< drg/video
    title="Treating Burns and Cuts"
    url="https://www.youtube.com/watch?v=tm0mRPy2VH4" >}}

{{< drg/next-page
    text="You now know how to handle the most common kitchen injuries."
    teaser="Next, learn how to store, transport, and prepare food safely to prevent illness."
