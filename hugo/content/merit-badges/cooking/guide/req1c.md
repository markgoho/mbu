...
req_number: "1c"
prev: "/merit-badges/cooking/guide/req1b/"
prev_title: "Req 1b — First Aid for the Kitchen"
next: "/merit-badges/cooking/guide/req1d/"
next_title: "Req 1d — Allergies & Food Illness"
---
...
{{< drg/did-you-know >}}
Food that has been sitting in the danger zone for more than two hours should be thrown away — no exceptions. On a hot day (above 90°F), that window shrinks to just one hour. When in doubt, throw it out.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Never wash raw chicken. The USDA and food safety experts agree that rinsing poultry does not remove bacteria — it spreads them. Water droplets can splash bacteria up to three feet from the sink, contaminating countertops, utensils, and other foods.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Preventing Cross-Contamination" subtitle="Follow these rules every time you cook" >}}
...
{{< drg/external-link
    ...
    url="https://www.fsis.usda.gov/food-safety/safe-food-handling-and-preparation/food-safety-basics/safe-minimum-internal-temperature-chart"
    description="The official USDA chart showing the minimum safe cooking temperatures for all types of meat, poultry, seafood, and eggs." >}}

{{< drg/video
    title="Basic Food Safety: Avoiding Cross Contamination"
    url="https://youtu.be/yiNTqUU-h6w?si=vlMbmOnZnVFqYRTW" >}}

{{< drg/next-page
    text="You now understand how to store, transport, and prepare food safely."
    teaser="Next, explore food allergies, food intolerance, and food-related illnesses."
