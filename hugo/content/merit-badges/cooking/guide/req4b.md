...
{{< drg/tip >}}
Read the entire recipe from start to finish before you buy a single ingredient. This helps you spot unfamiliar techniques, special equipment, or long prep times (like overnight marinating) that could affect your plan.
{{< /drg/tip >}}
...
{{< drg/checklist title="Shopping List Organization" subtitle="Group ingredients by where you find them in the store" >}}
...
{{< drg/external-link
    title="MyPlate Kitchen — Recipe Search"
    url="https://www.myplate.gov/myplate-kitchen"
    description="Search for healthy, budget-friendly recipes by food group, meal type, and cooking time." >}}

{{< drg/next-page
    text="You have your recipes, shopping list, and budget ready."
    teaser="Share and discuss your complete meal plan with your counselor."
