...
{{< drg/external-link
    ...
    description="Enter your age, sex, height, weight, and activity level to get a personalized daily food plan with recommended amounts from each food group." >}}
...
{{< drg/checklist title="Activity Tracking Tips" subtitle="What to record each day" >}}
...
{{< drg/tip >}}
Track a mix of weekdays and weekend days. Most people are more active on some days than others, and your five-day log should capture that variety. Try to include at least one Scout activity day if possible.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
On a strenuous hiking day, a Scout can burn 3,000 to 4,000 calories or more. That is why trail meals need to be calorie-dense — you literally cannot carry enough low-calorie food to keep up with your energy output. This concept will come back in a big way when you work on [Req 6](/merit-badges/cooking/guide/req6a/).
{{< /drg/did-you-know >}}

{{< drg/next-page
    text="You have tracked your activity and built a meal plan."
    teaser="Discuss your current eating habits and how to improve them."
