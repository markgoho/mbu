...
{{< drg/tip >}}
Test your topic with the "So What?" question. After you state your topic, imagine your audience asking "So what? Why should I care?" If you can answer that clearly, you have a strong topic. If you struggle, keep searching.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Professional speechwriters often spend ten hours researching for every one hour of speaking time. For an eight-minute speech, that means a few solid hours of research is not unusual — and it shows in the quality of the final product.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/scout-researching-speech.avif" alt="A Scout sitting at a desk with a laptop, notebook, and pen, taking notes and organizing research for a speech, with a printed outline visible on the desk" >}}
...
{{< drg/be-prepared title="Your Speech Is Too Short or Too Long" >}}
Timing problems are common, and they are easy to fix:

- **Too short?** Add another example or story to one of your main points. Expand your opening hook. Add a brief "Did you know?" fact. Do not pad with filler words — add substance.
- **Too long?** Cut your weakest main point entirely. Trim examples down to their essence. Remove any sentences that repeat what you have already said. If you have to choose between cutting a fact and cutting a story, keep the story.
- **Practice with a timer** every time, and adjust until you consistently land between eight and ten minutes.
{{< /drg/be-prepared >}}
...
{{< drg/checklist title="Delivery Day Checklist" subtitle="Final preparations before you speak" >}}
...
{{< drg/image src="images/scout-delivering-speech.avif" alt="A Scout standing at the front of a room delivering a speech to an attentive audience of peers and adults, using natural hand gestures and making eye contact, with a simple outline on a notecard" >}}
...
{{< drg/external-link
    ...
    description="A TED playlist on what makes presentations powerful — structure, storytelling, and delivery techniques from the world's best speakers." >}}

{{< drg/external-link
    title="ReadWriteThink: Speech Writing"
    url="https://www.readwritethink.org/"
    description="Educational resources from the National Council of Teachers of English, including tools for organizing and writing speeches." >}}

{{< drg/next-page
    text="You have researched, written, practiced, and delivered a full speech."
    teaser="Now learn how to lead a meeting using the formal rules that keep discussions organized and fair."
