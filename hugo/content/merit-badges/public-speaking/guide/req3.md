...
{{< drg/did-you-know >}}
Many professional speakers say that impromptu speaking is actually harder than prepared speaking — but it is also more impressive. When you can think on your feet, people notice. Debate teams, Model United Nations, and Toastmasters all include impromptu rounds specifically because this skill is so important.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Practice the PREP method at home with random topics. Have a family member name a topic — "pizza," "rain," "your favorite animal" — and give a two-minute PREP response. Do this three or four times a week, and impromptu speaking will start to feel natural.
{{< /drg/tip >}}
...
{{< drg/image src="images/scout-impromptu-speaking.avif" alt="A Scout standing and speaking confidently to a small group seated in a circle at a troop meeting, with no notes or visual aids, gesturing naturally" >}}
...
{{< drg/be-prepared title="You Get a Topic You Know Nothing About" >}}
Even if the topic feels unfamiliar, you can still give a solid response:

- **Connect it to something you do know.** "I do not know much about beekeeping, but I do know that bees are essential to the food we eat, and here is why..."
- **Be honest.** "This is not a topic I have studied, but here is what I think..." Honesty is more impressive than bluffing.
- **Use the PREP framework anyway.** State a point, give a reason, share any example you can think of, and restate. The structure does the heavy lifting.
- **Keep talking.** Silence feels worse than an imperfect sentence. Keep your thoughts moving forward.
{{< /drg/be-prepared >}}

### Tips for Impromptu Success

{{< drg/checklist title="Impromptu Speaking Survival Guide" subtitle="Quick tips for when you are put on the spot" >}}
...
{{< drg/image src="images/prep-method-diagram.avif" alt="A Scout at a whiteboard showing the PREP method for impromptu speaking with four connected steps: Point, Reason, Example, Point" >}}

### Explore More Resources

{{< drg/external-link
    title="Toastmasters: Table Topics"
    url="https://www.toastmasters.org/membership/club-meeting-roles/table-topicsmaster"
    description="Learn about the Toastmasters Table Topics exercise — the gold standard for practicing impromptu speaking in a supportive environment." >}}

{{< drg/external-link
    title="National Speech and Debate Association"
    url="https://www.speechanddebate.org/"
    description="The national organization for competitive speech and debate in middle and high schools. A great way to take your speaking skills to the next level." >}}

{{< drg/next-page
    text="You have learned how to think on your feet and speak without preparation."
    teaser="Now it is time for the main event — researching, writing, and delivering a full eight- to ten-minute speech."
