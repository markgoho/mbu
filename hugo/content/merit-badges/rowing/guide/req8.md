...
- **The kinds of boats people row in different settings**
- **The materials boats are built from**
- **The hardware that lets an oar pivot efficiently**

A rower who understands equipment makes better decisions about safety, storage, performance, and maintenance.

## Requirement 8a

{{< drg/inherited-requirement number="8a" req_path="8.a" topic="Types of craft used in commercial, competitive, and recreational rowing" />}}
...
{{< drg/tip >}}
When describing craft to your counselor, focus on what the boat is built to do. A workboat solves a different problem than a racing shell.
{{< /drg/tip >}}

## Requirement 8b

{{< drg/inherited-requirement number="8b" req_path="8.b" topic="Four common boatbuilding materials. Give some positive and negative points of each" />}}
...
{{< drg/checklist title="Material Tradeoffs" subtitle="A simple way to compare boatbuilding choices" >}}
...
{{< drg/inherited-requirement number="8c" req_path="8.c" topic="Types of oarlocks used in competitive and recreational rowing" />}}
...
{{< drg/did-you-know >}}
A tiny rigging change in a racing shell can affect how every stroke feels. At competitive levels, rowers pay close attention to details measured in millimeters.
{{< /drg/did-you-know >}}

{{< drg/video
    title="An insider look at rowing equipment — World Rowing"
    url="https://www.youtube.com/watch?v=HYH1hANh1Ms" >}}

{{< drg/image src="images/rowing-oarlock-comparison.avif" alt="Side-by-side diagram comparing a recreational oarlock and a competitive gate-and-pin rowing setup" >}}

{{< drg/external-link
    title="World Rowing"
    url="https://worldrowing.com/"
    description="The international governing body for rowing, with boat classes, event information, and competitive rowing background." >}}
...
{{< drg/next-page
    text="You now understand how craft design, materials, and oarlocks shape the rowing experience."
    teaser="Next, tie equipment knowledge to technique, rough-water judgment, and boat maintenance."
