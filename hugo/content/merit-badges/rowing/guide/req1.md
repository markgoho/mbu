...
req_number: "1"
req_path: "1"
prev: "/merit-badges/rowing/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/rowing/guide/req2/"
...
{{< drg/checklist title="Hazard Scan Before Rowing" subtitle="Questions smart rowers answer before launch" >}}
...
{{< drg/be-prepared title="The wind is stronger on the return than on the launch" >}}
- **Turn back before the crew gets tired.** Early decisions are easier than late rescues.
- **Stay in the most sheltered water you can.** Shorelines and coves may reduce wave action.
- **Shorten the outing.** Skipping part of the plan is better than forcing it.
- **Keep the boat under control first.** Speed matters less than safe, steady handling.
- **Land and reassess if needed.** Good judgment is part of good rowing.
{{< /drg/be-prepared >}}

{{< drg/safety-first >}}
If you hear thunder or see lightning, get off the water immediately. Do not wait for “one more piece” or “one more pass.”
{{< /drg/safety-first >}}

{{< drg/external-link
    title="National Weather Service — Water Safety"
    url="https://www.weather.gov/safety/water"
    description="Learn how storms, cold water, floods, and other water hazards affect recreation and rescue." >}}

## Requirement 1b

{{< drg/inherited-requirement number="1b" req_path="1.b" topic="Review prevention, symptoms, and first-aid treatment for the following injuries or illnesses that can occur while rowing: blisters, hypothermia, heat-related illnesses, dehydration, sunburn, sprains, and strains." />}}
...
{{< drg/tip >}}
On long outings, do a self-check every so often: When did I last drink? Am I gripping too hard? Am I getting colder or hotter than I expected? Those simple questions prevent many bigger problems.
{{< /drg/tip >}}

{{< drg/did-you-know >}}
Cold water can take control of your breathing in seconds. The first danger after sudden immersion is often the gasp reflex, not your swimming skill.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="American Red Cross — First Aid Steps"
    url="https://www.redcross.org/get-help/how-to-prepare-for-emergencies/types-of-emergencies/first-aid.html"
    description="Trusted first-aid guidance for many of the injuries and illnesses rowers may face." >}}

## Requirement 1c

{{< drg/inherited-requirement number="1c" req_path="1.c" topic="Review the Scouting America Safety Afloat policy. Explain to your counselor how this applies to rowing activities." />}}
...
{{< drg/checklist title="Explain Safety Afloat Like a Rower" subtitle="Turn the policy into practical examples" >}}
...
{{< drg/external-link
    ...
    description="Read the full Safety Afloat policy used for Scouting boating activities." >}}
...
{{< drg/next-page
    text="You have the hazard awareness, first-aid awareness, and Safety Afloat habits every rower needs."
    teaser="Next, make sure your swimming ability matches the demands of rowing and rescue work."
