...
req_number: "4b"
req_path: "4.b"
prev: "/merit-badges/rowing/guide/req4a/"
prev_title: "Req 4a — Boat Handling Skills"
next: "/merit-badges/rowing/guide/req5/"
next_title: "Req 5 — Choose Your Dockside Skill"
---
...
{{< drg/checklist title="What to Learn Before the Meet" subtitle="Ten practice hours should build these habits" >}}
...
{{< drg/tip >}}
Bring dry clothes, water, sunscreen, and a small snack. Regattas often involve waiting, weather changes, and long stretches between races.
{{< /drg/tip >}}

{{< drg/be-prepared title="You feel race nerves at the start line" >}}
- **Shrink the moment.** Focus on the first ten strokes, not the whole race.
- **Trust the practice.** Your job is to row the plan your crew rehearsed.
- **Listen for commands.** The coxswain or coach gives the rhythm when stress rises.
- **Stay with the crew.** A calm, connected boat usually beats a frantic one.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    title="USRowing"
    url="https://www.usrowing.org/"
    description="The national governing body for rowing in the United States, with pathways into clubs, events, and athlete development." >}}

After race-day teamwork, the guide moves back to another choose-one requirement focused on dockside handling skills in fixed-seat or sliding-seat boats.

{{< drg/next-page
    text="You have seen how rowing works as a real team sport under race conditions."
    teaser="Next, compare the two dockside skill options in Requirement 5 and choose the one that fits your setting."
