...
{{< drg/safety-first >}}
Never practice swamp drills without qualified supervision, fitted life jackets, and a controlled setting chosen for training. Rescue practice should feel serious because the real situation is serious.
{{< /drg/safety-first >}}

{{< drg/video
    title="How to Get Back into Your Scull after Flipping — rowingwithcalmwaters"
    url="https://www.youtube.com/watch?v=nhtv53MOrqA" >}}
...
{{< drg/checklist title="Swamped Boat Priorities" subtitle="Think in this order, not all at once" >}}
...
{{< drg/did-you-know >}}
In many boating accidents, victims are found farther from their boat than rescuers expect because they tried to swim away from the craft instead of using it as flotation and a visual target.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="US Coast Guard — Cold Water Survival"
    url="https://www.uscgboating.org/recreational-boaters/cold-water-survival.php"
    description="Official boating-safety guidance on immersion, flotation, and surviving unexpected time in the water." >}}

The next rescue skill adds another layer: using the boat to reach and tow a swimmer while keeping both of you as safe as possible.

{{< drg/next-page
    text="You now understand why rescue starts with staying with the swamped boat and regaining control."
    teaser="Next, learn how to approach a swimmer, position the boat, and tow them safely to shore."
