...
{{< drg/safety-first >}}
A life jacket only protects you if it is on, fastened, and fitted before the problem starts. Wearing it halfway, or keeping it under a seat, is not the same as wearing it.
{{< /drg/safety-first >}}
...
1. Loosen the straps before putting the life jacket on.
2. Zip and buckle every closure.
3. Tighten from the bottom up until the fit is snug.
4. Raise your arms and mimic rowing strokes to check freedom of movement.
5. Do the **lift test**: have a buddy pull up at the shoulders. If the jacket rides up past your chin or ears, it is too loose.

A properly fitted life jacket should feel secure, allow deep breathing, and stay put when lifted.

{{< drg/checklist title="Quick Fit Check" subtitle="Use this before every launch" >}}
...
{{< drg/image src="images/rowing-pfd-fit-check.avif" alt="A Scout in a low-profile life jacket while a buddy performs the shoulder lift test, with fit checkpoints called out" >}}
...
{{< drg/tip >}}
Do your fit check before the boat leaves the dock, not once you are already drifting away from it.
{{< /drg/tip >}}

{{< drg/external-link
    title="US Coast Guard — Choosing the Right Life Jacket"
    url="https://www.uscgboating.org/recreational-boaters/life-jacket-wear-types.php"
    description="Official guidance on life jacket types, sizing, and fit for recreational boaters." >}}

Now that you know how to protect yourself, it is time to choose which rowing path you want to complete first: practical boat-handling skills or the team-racing option.

{{< drg/next-page
    text="You know how to choose and fit the life jacket that belongs on every rowing trip."
    teaser="Next, compare the two paths for Requirement 4 and decide which rowing experience fits you best."
