...
{{< drg/checklist title="Pier Exchange Basics" subtitle="How to keep a sliding-seat boat calm during boarding" >}}
...
{{< drg/tip >}}
Talk through the move before you do it. A five-second plan prevents many pier-side mistakes.
{{< /drg/tip >}}

{{< drg/be-prepared title="The shell starts drifting away from the pier during boarding" >}}
- **Stop the movement immediately.** Do not keep climbing in while the boat is separating.
- **Re-stabilize first.** Bring the shell back under control before trying again.
- **Reset the instructions.** Confusion usually means the next attempt should be slower.
- **Treat the reset as good judgment, not failure.** Safe boat handling includes knowing when to restart.
{{< /drg/be-prepared >}}

{{< drg/image src="images/sliding-seat-pier-exit.avif" alt="A Scout stepping carefully from a sliding-seat rowboat to a dock while a buddy stabilizes the shell" >}}
...
{{< drg/next-page
    text="You now know how controlled pier exchanges work in a sliding-seat boat."
    teaser="Next, learn how to right, stabilize, and reboard a swamped boat without giving up on it."
