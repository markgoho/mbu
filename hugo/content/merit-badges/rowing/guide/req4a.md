...
{{< drg/inherited-requirement number="4a1" req_path="4.a.1" topic="Launch." />}}
...
{{< drg/tip >}}
The best launches look almost boring. If a launch feels dramatic, it was probably sloppy.
{{< /drg/tip >}}

## Requirement 4a2

{{< drg/inherited-requirement number="4a2" req_path="4.a.2" topic="Row in a straight line for 100 yards. Stop, pivot, and return to the starting point." />}}
...
{{< drg/checklist title="What Makes Straight Rowing Work" subtitle="Simple habits that improve control" >}}
...
{{< drg/image src="images/rowboat-pivot-maneuver.avif" alt="Top-down diagram of a rowboat stopping, pivoting, and returning between marker buoys" >}}

## Requirement 4a3

{{< drg/inherited-requirement number="4a3" req_path="4.a.3" topic="Backwater in a straight line for 25 yards. Make a turn underway and return to the starting point." />}}
...
{{< drg/be-prepared title="The boat starts drifting sideways while you backwater" >}}
- **Slow down your pressure.** Hard, uneven strokes often cause the problem.
- **Reset your hand timing.** Make the oars work together again.
- **Pick one correction, not three.** One calm change is better than frantic adjustments.
- **Keep the area clear.** Tight-space maneuvers demand extra awareness around docks and boats.
{{< /drg/be-prepared >}}

## Requirement 4a4

{{< drg/inherited-requirement number="4a4" req_path="4.a.4" topic="Land and moor or rack your craft." />}}
...
{{< drg/safety-first >}}
Hands, fingers, and feet get hurt most often at docks and landings. Move slowly when the boat is close to hard surfaces.
{{< /drg/safety-first >}}

## Requirement 4a5

{{< drg/inherited-requirement number="4a5" req_path="4.a.5" topic="Tie the following mooring knots—clove hitch, roundturn with two half-hitches, bowline, Wellman's knot, and mooring hitch." />}}

### Know what each knot does

These knots are not random rope tricks. They solve common dockside problems.

- **Clove hitch:** fast way to secure a line around a post, though it may need backup depending on the load.
- **Roundturn with two half-hitches:** strong choice when a line may stay under steady tension.
- **Bowline:** makes a fixed loop that is easy to untie after load.
- **Wellman's knot:** useful in rowing traditions for securing boats quickly at a dock.
- **Mooring hitch:** designed for temporary attachment that can still be released efficiently.
...
{{< drg/tip >}}
Practice each knot slowly until you know its shape, then practice it with wet rope and from awkward dock positions. That is closer to real rowing than tying on dry carpet.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have seen how Req 4a builds practical boat control from launch to final knot."
    teaser="Next, look at the team-racing option and see how rowing changes when the whole boat has to move as one."
