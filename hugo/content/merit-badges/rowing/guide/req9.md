...
{{< drg/inherited-requirement number="9a" req_path="9.a" topic="The advantage of feathering oars while rowing" />}}
...
{{< drg/inherited-requirement number="9b" req_path="9.b" topic="Precautions regarding strong winds and heavy waves, and boat-handling procedures in rough water and windstorms" />}}
...
{{< drg/safety-first >}}
Windstorms are not a test of toughness. When conditions outrun your plan or your skill, the correct decision is to land early.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="National Weather Service"
    url="https://www.weather.gov/"
    description="Use official forecasts and warnings to make smart decisions before and during rowing activities." >}}

## Requirement 9c

{{< drg/inherited-requirement number="9c" req_path="9.c" topic="How to properly fit out and maintain a boat in season, and how to prepare and store a boat for winter" />}}
...
{{< drg/inherited-requirement number="9d" req_path="9.d" topic="How to determine the proper length of oars" />}}
...
{{< drg/tip >}}
If a boat feels cramped, awkward, or hard to keep balanced, the issue may not be your effort. Setup matters.
{{< /drg/tip >}}

## Requirement 9e

{{< drg/inherited-requirement number="9e" req_path="9.e" topic="The differences between fixed-seat and sliding-seat rowing" />}}
...
{{< drg/inherited-requirement number="9f" req_path="9.f" topic="The different meanings of the term sculling in fixed- and sliding-seat rowing" />}}
...
{{< drg/inherited-requirement number="9g" req_path="9.g" topic="The health benefits from rowing for exercise" />}}
...
{{< drg/checklist title="Why Rowing Is Good Exercise" subtitle="Benefits you can explain clearly to your counselor" >}}
...
{{< drg/next-page
    text="You have finished the core rowing requirements and can now discuss the sport with real depth."
    teaser="Go beyond the badge with racing culture, adventure paths, and organizations that can keep you rowing."
    url="/merit-badges/rowing/guide/extended-learning/" >}}
