...
In a fixed-seat rowboat, come alongside a pier and help a passenger into the boat. Pull away from the pier, change positions with your passenger, and demonstrate sculling over the stern or side. Resume your rowing position, return alongside the pier, and help your passenger out of the boat.
{{< /drg/requirement >}}
...
{{< drg/safety-first >}}
Never let a passenger leap into or out of the boat. Slow, low, and one move at a time is the rule.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Many cultures developed single-oar sculling methods long before modern racing shells existed. It is one of the oldest efficient ways to move a small boat without switching sides every stroke.
{{< /drg/did-you-know >}}

{{< drg/image src="images/stern-sculling-motion.avif" alt="Diagram showing a single oar moving in a figure-eight sculling motion over the stern of a rowboat" >}}

{{< drg/checklist title="Dockside Communication Script" subtitle="Simple phrases that keep the boat calm" >}}
...
{{< drg/next-page
    text="You have seen how fixed-seat dock work combines communication, balance, and sculling skill."
    teaser="Next, compare that with the sliding-seat option, where you and your buddy exchange positions from the pier."
