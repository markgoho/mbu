...
req_number: "5b"
prev: "/merit-badges/forestry/guide/req5a/"
prev_title: "Req 5a — Managed Forest Visit"
next: "/merit-badges/forestry/guide/req5c/"
next_title: "Req 5c — Fire Prevention Campaign"
---
...
{{< drg/checklist title="Report Notes to Capture" subtitle="You do not need to memorize everything if you record it clearly during the visit" >}}
...
{{< drg/safety-first >}}
Logging sites and manufacturing plants can be dangerous. Stay with your guide, wear any required protective gear, and never wander near moving equipment, log decks, saw lines, or conveyors. Even a quiet-looking work area may have blind spots, falling material, or machinery that starts suddenly.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="USDA Forest Service — Forest Products Laboratory"
    url="https://www.fpl.fs.usda.gov/"
    description="Research and educational information about wood properties, wood products, and how forest materials are used." >}}

{{< drg/next-page
    text="You know how to observe the flow of wood from the forest into real products and document what you learn."
    teaser="Next, explore how a wildfire prevention campaign protects forests and communities."
