...
{{< drg/image src="images/forest-threats-comparison.avif" alt="Six-panel comparison of major forest threats including wildfire, insects, disease, browse, erosion, and fragmentation" >}}

{{< drg/checklist title="A Good Way to Tackle 7a" subtitle="Choose five threats you can explain with real cause-and-effect details" >}}
...
2. **Call 911 or your local wildfire control agency.**
3. **Give the best location you can** using road names, trail names, mile markers, GPS, landmarks, or map coordinates.
4. **Warn nearby adults or staff** if you are in a park, camp, or recreation area.
5. **Leave the area if directed or if the fire is spreading toward you.**
...
- **Move to a safe place with a clear exit route.**
- **Note your location carefully** before calling for help.
- **Tell adults, rangers, or camp staff immediately.**
{{< /drg/be-prepared >}}

{{< drg/safety-first >}}
Wildfire spreads faster uphill and can change direction suddenly with wind. Never assume you can outrun or outsmart a fire by getting closer “just for a minute.” Distance and early reporting save lives.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="National Interagency Fire Center"
    url="https://www.nifc.gov/"
    description="Information on wildfire response, fire behavior, and the agencies that coordinate wildland firefighting in the United States." >}}

{{< drg/next-page
    text="You now understand several major forest threats and how forestry professionals respond to them."
    teaser="Finish the badge by learning what foresters do, how they train, and what career paths exist in forestry."
