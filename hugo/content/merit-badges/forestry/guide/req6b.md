...
Review a hazardous tree report done by a professional for this area and visit those trees and the results of the prescription to prune or remove them.
{{< /drg/requirement >}}
...
1. **What the report said** was wrong with the tree.
2. **What work was prescribed** — pruning, removal, or other action.
3. **What you can see now** after the work was completed, or what still remains if work is pending.
...
{{< drg/tip >}}
Ask what made the professional choose pruning instead of removal, or vice versa. The reasoning is often more important than the action itself.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Do not approach recently cut trees, root plates, suspended limbs, or active work zones without permission. Even after work is finished, debris and unstable wood can remain. Stay with the adult guiding the visit.
{{< /drg/safety-first >}}

{{< drg/video
    title="Tree Risk Assessment Explained (ISA TRAQ Module 1) #TreeRiskAssessment#ISATRAQ#TRAQReview#Arborist — Arborist-podcast"
    url="https://www.youtube.com/watch?v=ByoF3U0ZEEg" >}}

{{< drg/external-link
    title="Arbor Day Foundation — Tree Care"
    url="https://www.arborday.org/trees/tree-care/"
    description="General tree care guidance that helps explain pruning, tree condition, and why healthy structure matters." >}}

{{< drg/next-page
    text="You can now read a professional hazard tree report and compare it with what happened in the field."
    teaser="Next, look at larger threats to forests — including wildfire, insects, disease, and urban growth."
