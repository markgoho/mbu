...
- **Elevation** — how high the site is above sea level
- **Aspect** — the direction the slope faces, such as north, south, east, or west
- **Slope** — how steep the ground is
- **Position on slope** — ridge top, upper slope, middle slope, lower slope, or bottomland
...
{{< drg/checklist title="What to Notice in Ring Patterns" subtitle="Use these clues while examining each stump, log, or core" >}}
...
- **Competition for light** — A tree growing under a closed canopy may show many narrow rings until a gap opens above it.
- **Water availability** — Drought years often produce narrow rings, while wetter years may produce wider ones.
- **Site quality** — Deeper, richer soil usually supports faster growth than rocky, shallow soil.
- **Damage** — Fire scars, insect outbreaks, broken tops, and root problems can slow growth.
- **Stand changes** — Thinning or storm damage in the surrounding stand can suddenly give a tree more light and space.
...
{{< drg/image src="images/tree-ring-patterns-comparison.avif" alt="Three wood cross-sections comparing narrow rings, release growth, and scarred stressed growth" >}}

{{< drg/tip >}}
Photograph the whole site before you photograph the rings. A close-up of the stump is useful, but a wider view of the slope, stream, opening, or surrounding stand makes your explanation much stronger.
{{< /drg/tip >}}

{{< drg/video
    title="What Can Tree Rings Tell Us? - Ecosystem Essentials — Ecosystem Essentials"
    url="https://www.youtube.com/watch?v=G4FHVIL3Fh0" >}}
...
{{< drg/external-link
    title="USDA Forest Service — Forests and Water"
    url="https://www.fs.usda.gov/managing-land/private-land/forest-management/water"
    description="Information on how forest conditions, soils, and management affect water and the health of forested landscapes." >}}

{{< drg/next-page
    text="You can now read ring patterns as clues about competition, moisture, and disturbance."
    teaser="Next, investigate what insects, animals, and diseases can do to tree health."
