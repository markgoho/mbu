...
- **Identification clues** — leaves, twigs, cones, fruits, bark, and other visible features
- **Habitat** — the kind of place where each species grows best
- **Uses and native status** — how people or wildlife use the species, and whether it belongs in your area naturally
...
{{< drg/download
    ...
    url="/merit-badges/forestry/guide/forest-field-notebook-worksheet/"
    type="printable" >}}
...
- **Leaf arrangement** — opposite, alternate, or whorled on the twig
- **Leaf type** — simple or compound
- **Leaf shape** — oval, lobed, needlelike, heart-shaped, and more
- **Leaf edge** — smooth, toothed, or deeply lobed
- **Twig features** — buds, scars, color, fuzz, smell, or pith
- **Bark** — smooth, shaggy, scaly, furrowed, peeling, or patchy
- **Cones, nuts, berries, seed pods, or fruits** — shape, size, and season matter
...
{{< drg/image src="images/tree-identification-clues-comparison.avif" alt="Side-by-side comparison of common tree identification clues including leaves, buds, cones, and bark textures" >}}

{{< drg/checklist title="What to Record for Each Species" subtitle="Use more than one clue whenever possible" >}}
...
{{< drg/be-prepared title="What If Two Species Look Similar?" >}}
If two species seem close, do not force a guess.

- **Pause and record what you know**: leaf shape, bark, fruit, habitat, and growth form.
- **Take a photo or sketch** of the most useful clue.
- **Use a field guide or tree key** later to compare the look-alikes.
...
{{< drg/safety-first >}}
Never taste leaves, berries, seeds, or bark while identifying plants. Some species are toxic, and even harmless-looking plants can cause allergic reactions. Observe, photograph, sketch, and research — but do not sample unknown plants.
{{< /drg/safety-first >}}
...
{{< drg/external-link
    title="Arbor Day Foundation — Tree Identification"
    url="https://www.arborday.org/trees/treeguide/"
    description="A beginner-friendly tree guide that helps you compare common identification clues such as leaves, bark, and fruit." >}}

{{< drg/next-page
    text="You now know how to build a strong field notebook and study plants as part of a forest system."
    teaser="Next, choose one tree investigation: wood samples, growth rings, or signs of damage."
