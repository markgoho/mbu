...
req_number: "2a"
prev: "/merit-badges/forestry/guide/req2/"
prev_title: "Req 2 — Choose a Tree Investigation"
next: "/merit-badges/forestry/guide/req2b/"
next_title: "Req 2b — Reading Tree Rings"
---
...
{{< drg/checklist title="Sample Collection Tips" subtitle="Keep your collection clear and counselor-friendly" >}}
...
- **Strength** — needed for framing, flooring, tool handles, and structural lumber
- **Decay resistance** — useful for outdoor furniture, decking, fence posts, and boat parts
- **Straight grain** — helpful for lumber, trim, and anything that needs predictable cuts
- **Light weight** — useful for boxes, carvings, models, and some musical instruments
- **Attractive appearance** — valued for furniture, cabinets, veneer, and paneling
- **Shock resistance** — useful for handles, sporting goods, and equipment
...
{{< drg/did-you-know >}}
The same tree can produce wood for very different products. A single pine stand might eventually become framing lumber, plywood, paper pulp, boxes, landscaping mulch, and bioenergy feedstock depending on tree size and quality.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
If tools are involved in trimming or sanding samples, use eye protection and follow adult supervision rules. Never use power tools by yourself unless you already have permission, training, and direct supervision appropriate for your age and experience.
{{< /drg/safety-first >}}
...
{{< drg/external-link
    title="Arbor Day Foundation — About Trees"
    url="https://www.arborday.org/trees/"
    description="Background information on tree species, growth, and why different trees matter in different settings." >}}

{{< drg/next-page
    text="You have seen how wood properties connect to real-world uses."
    teaser="Next, learn how rings inside a stump or log can reveal the story of how a tree grew."
