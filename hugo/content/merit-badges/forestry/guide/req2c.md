...
{{< drg/image src="images/tree-damage-types-grid.avif" alt="Four-panel comparison of deer rub, insect galleries, fungal conks, and diseased leaves" >}}

{{< drg/checklist title="Questions to Ask About Damage" subtitle="These questions help you explain cause and effect" >}}
...
{{< drg/be-prepared title="What If You Are Not Sure What Caused the Damage?" >}}
That is common, especially in the field.

- **Start by describing the evidence clearly** instead of guessing too fast.
- **Take several photos**: close-up, mid-range, and whole tree.
- **Compare the pattern** with extension guides, tree health resources, or a local forester's advice.
- **Explain your best-supported conclusion** and mention any uncertainty honestly.
{{< /drg/be-prepared >}}
...
{{< drg/safety-first >}}
Do not peel bark off live trees, break branches, or probe decayed trunks aggressively just to investigate damage. Old wood can collapse, insects may sting, and damaged trees can shed limbs without warning. Observe carefully and keep a safe distance from unstable trees.
{{< /drg/safety-first >}}
...
{{< drg/external-link
    title="USDA Forest Service — Forest Health Protection"
    url="https://www.fs.usda.gov/foresthealth/"
    description="Forest health information about insects, diseases, invasive species, and monitoring tree damage." >}}

{{< drg/next-page
    text="You have practiced reading damage as evidence of what a tree has experienced."
    teaser="Next, zoom out from individual trees to see what forests do for water, wildlife, air, and people."
