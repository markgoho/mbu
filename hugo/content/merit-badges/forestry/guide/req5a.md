...
{{< drg/be-prepared title="If the Forest Looks 'Messy'" >}}
A managed forest does not always look neat.

- **Recently thinned areas** may have slash on the ground.
- **Prescribed burn units** may show blackened trunks and open understory.
- **Wildlife openings** may look brushy instead of park-like.
- **Regenerating harvest areas** may be full of saplings rather than big trees.

Ask what stage of management you are seeing before deciding whether the area looks healthy.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    ...
    url="https://www.stateforesters.org/"
    description="A hub for state forestry agencies that can help you locate nearby forestry professionals, public forests, and programs." >}}

{{< drg/next-page
    text="You know what to watch for during a managed forest visit and how to turn observations into a clear report."
    teaser="Next, see how trees move from the forest into logging operations, mills, and finished products."
