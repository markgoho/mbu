...
{{< drg/image src="images/forestry-career-paths-grid.avif" alt="Illustrated overview of six forestry career paths in field, urban, fire, research, consulting, and wood-products settings" >}}

{{< drg/checklist title="Questions to Ask a Forester" subtitle="Use these if you interview someone for the report option" >}}
...
{{< drg/tip >}}
Even if you do not plan to become a forester, learning how foresters think will make you a better camper, hiker, land steward, and citizen. Forests affect drinking water, fire risk, recreation, wildlife, and climate whether you work in the field or not.
{{< /drg/tip >}}

{{< drg/video
    title="What is a Forester? — TreeStand Forestry"
    url="https://www.youtube.com/watch?v=ZEmBFp95VL0" >}}

{{< drg/external-link
    title="Society of American Foresters"
    url="https://www.eforester.org/"
    description="Professional information about forestry education, certification, careers, and the many specialties within the field." >}}

{{< drg/next-page
    text="You now have a clearer picture of what foresters do and how people enter the profession."
    teaser="Go beyond the badge with deeper topics, real-world experiences, and organizations connected to forestry."
    url="/merit-badges/forestry/guide/extended-learning/" >}}
