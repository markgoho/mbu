  ...
  - group_title: "1. Reading the Forest"
    items:
      ...
      - title: "c Tree Damage Detectives"
        ...
        is_sub: true
  - group_title: "a Forest Benefits & Your Watershed"
    items:
...
{{< drg/image src="forestry-merit-badge.avif" alt="Forestry merit badge" >}}
...
{{< drg/did-you-know >}}
Trees can cool neighborhoods by casting shade and by releasing water vapor through their leaves. In hot weather, that can make tree-covered areas noticeably cooler than nearby pavement and parking lots.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Never experiment with fire in a forest on your own. Prescribed burning is planned and carried out by trained professionals under strict weather, fuel, staffing, and safety conditions. One careless spark can threaten lives, homes, and entire watersheds.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
As you work through this badge, keep asking two questions: "What is this forest doing for people?" and "What does this forest need to stay healthy?" Those questions are at the center of nearly every forestry decision.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have the big picture of what forestry includes and why forests matter."
    teaser="Head into the field to identify species, describe their habitats, and build your field notebook."
    url="/merit-badges/forestry/guide/req1/" >}}
