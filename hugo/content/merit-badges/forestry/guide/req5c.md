...
{{< drg/be-prepared title="If Your Area Doesn't Have Huge Forest Fires" >}}
Wildfire prevention still matters.

- **Grass, brush, and woodland fires** can still threaten homes and parks.
- **Small local fires** can injure people and damage habitat even if they never make national news.
- **Prevention campaigns** are often tailored to local risks like campfires, leaf burning, or equipment use.
{{< /drg/be-prepared >}}
...
{{< drg/safety-first >}}
Never perform any wildfire prevention activity that puts you near active fire, smoke, or emergency response operations unless professionals specifically direct and supervise you. Your role is education and prevention, not firefighting.
{{< /drg/safety-first >}}

{{< drg/video
    title="Firewise Ohio: ODNR Forestry and Ohio Fire Departments - Cooperative Efforts for Community Safety — OhioDNR"
    url="https://www.youtube.com/watch?v=IdQvjwq1BAo" >}}

{{< drg/external-link
    title="National Park Service — Fire and Aviation"
    url="https://www.nps.gov/subjects/fire/index.htm"
    description="Educational information on wildfire, prescribed fire, and how agencies use fire management to protect land and people." >}}

{{< drg/next-page
    text="You understand how wildfire prevention campaigns work and how to explain your role in one."
    teaser="Next, choose a hazard tree activity and learn how foresters think about tree risk near people and structures."
