...
Inventory the trees within a specific area above (campsite, road, trail, street, etc.) that may be a hazard to structures or people. Note the species and hazardous condition, and suggest a remedy (removal or trimming). Make your list available to the proper authority or agency.
{{< /drg/requirement >}}
...
{{< drg/image src="images/hazard-tree-warning-signs.avif" alt="Annotated hazard tree near a campsite showing dead limb, trunk crack, root issues, and decay" >}}
...
{{< drg/checklist title="Hazard Tree Notes" subtitle="Keep your list practical and easy for others to review" >}}
...
- **Let trained staff decide how to secure the site.**
{{< /drg/be-prepared >}}

{{< drg/safety-first >}}
Never climb, push, shake, cut, or pull on a tree you think may be hazardous. A damaged tree can fail without warning. Stay outside the likely fall zone and report what you see from a safe distance.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="USDA Forest Service — Hazard Trees"
    url="https://www.fs.usda.gov/managing-land/fire/ibp/hazard-trees"
    description="Background on why hazardous trees matter for safety and how agencies think about tree risk in developed or frequently used areas." >}}

{{< drg/next-page
    text="You know how to inventory a site for hazard trees and communicate findings responsibly."
    teaser="Next, learn how to review a professional hazard tree report and compare it with real results on the ground."
