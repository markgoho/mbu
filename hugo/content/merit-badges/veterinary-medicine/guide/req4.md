...
{{< drg/checklist title="What Technician Training Includes" subtitle="Common parts of an R.V.T. or A.H.T. program" >}}
...
{{< drg/external-link
    title="AVMA — Veterinary Technology Programs"
    url="https://www.avma.org/education/center-for-veterinary-accreditation/accredited-veterinary-technology-programs"
    description="Find AVMA-accredited veterinary technology programs in the United States." >}}
...
{{< drg/tip >}}
A strong answer compares the technician's role across settings. Do not just say, "They help the veterinarian." Explain **how** they help in a dog clinic versus a horse barn versus a fish or zoo setting.
{{< /drg/tip >}}

{{< drg/video
    title="Behind the Scenes as a Licensed Veterinary Technician — Cornell University College of Veterinary Medicine"
    url="https://www.youtube.com/watch?v=ytCu_rnC37E" >}}

{{< drg/did-you-know >}}
The pamphlet notes that veterinary technicians now work not only in clinics, but also in research, schools, zoos, diagnostic labs, military and government services, food-inspection programs, and humane societies.
{{< /drg/did-you-know >}}

{{< drg/image src="images/veterinary-technician-task-board.avif" alt="Diagram collage showing a veterinary technician taking vital signs, preparing lab samples, monitoring anesthesia, and guiding a pet owner" >}}
...
{{< drg/next-page
    text="You have mapped out what veterinary technicians do and how they train."
    teaser="Next, explore why the relationship between people and animals matters so much in veterinary medicine."
