...
- **[Req 6a — Observe a Veterinary Facility](/merit-badges/veterinary-medicine/guide/req6a/)**: Visit a clinic, hospital, or teaching hospital connected to one of the practice types from Req 1. This option helps you see direct patient care, teamwork, equipment, workflow, and communication with pet owners or animal caretakers.
- **[Req 6b — Shadow a Public-Service Veterinarian](/merit-badges/veterinary-medicine/guide/req6b/)**: Spend time with a veterinarian in one of the public-service or specialized fields from Req 2. This option helps you see how veterinary medicine serves the general public through health protection, food safety, research, inspection, education, or government work.

## How to Choose

{{< drg/checklist title="Choosing Your Option" subtitle="Compare the two experiences before deciding" >}}
...
{{< drg/tip >}}
If you think of veterinarians mainly as pet doctors, Option 6b may stretch your understanding the most. If you want to test whether clinic life feels exciting, Option 6a may be the better fit.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Observe professionally. Follow instructions, stay where you are told, wash your hands when asked, and do not touch animals, equipment, medicines, or samples unless a supervising adult clearly invites you to and says it is safe.
{{< /drg/safety-first >}}

Start with the first option page. Even if you later choose 6b, it helps to see what a strong observation plan looks like.

{{< drg/next-page
    text="You are ready to choose the field experience that fits you best."
    teaser="First, look at how to make the most of a clinic or hospital visit."
