...
{{< drg/checklist title="Presentation Questions" subtitle="Make sure your talk answers these" >}}
...
{{< drg/be-prepared title="Possible Special Training To Listen For" >}}
- **Internships or residencies** in specialties like pathology, public health, or laboratory animal medicine.
- **Graduate degrees** such as an M.P.H. or Ph.D.
- **Board certification** in a veterinary specialty.
- **Military service training** or security-related preparation.
- **Agency-specific training** for inspection, disease response, or emergency management.
{{< /drg/be-prepared >}}

{{< drg/video
    title="20 Cool Careers in Veterinary Medicine — Dr. Jasmine Shanelle"
    url="https://www.youtube.com/watch?v=HPBfPUcOwDw" >}}

{{< drg/tip >}}
At the end of your visit, ask this direct question: **"How does your work help the general public, even if most people never see it?"** That answer can become the strongest part of your presentation.
{{< /drg/tip >}}

{{< drg/external-link
    title="CDC One Health"
    url="https://www.cdc.gov/one-health/"
    description="Helpful background for understanding how animal health careers can protect public health." >}}

{{< drg/external-link
    title="USDA APHIS"
    url="https://www.aphis.usda.gov/"
    description="Examples of how veterinarians work in inspection, disease control, wildlife, and federal service." >}}
...
{{< drg/next-page
    text="You know how to study a public-service veterinary career in the field."
    teaser="Next, choose one veterinary career and think carefully about why someone would pursue it."
