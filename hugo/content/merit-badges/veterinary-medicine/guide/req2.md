...
{{< drg/inherited-requirement number="2a" req_path="2.a" topic="Public health medicine and zoonotic disease surveillance and control" />}}
...
{{< drg/did-you-know >}}
The veterinary pamphlet describes public-health veterinarians as "silent sentinels" because many people never see their work, even though it helps protect water, food, and disease safety for entire communities.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="CDC One Health"
    url="https://www.cdc.gov/one-health/"
    description="The CDC explains how human, animal, and environmental health connect, especially when tracking zoonotic disease." >}}

## Requirement 2b

{{< drg/inherited-requirement number="2b" req_path="2.b" topic="The military" />}}
...
{{< drg/tip >}}
If you choose a military career for Req 7, be ready to discuss service, discipline, travel, and public responsibility along with animal care.
{{< /drg/tip >}}

## Requirement 2c

{{< drg/inherited-requirement number="2c" req_path="2.c" topic="Food safety and inspection" />}}
...
{{< drg/checklist title="Food-Safety Questions" subtitle="What a veterinarian may be watching for" >}}
...
{{< drg/inherited-requirement number="2d" req_path="2.d" topic="Laboratory animal medicine and research" />}}
...
{{< drg/safety-first >}}
Research settings have strict rules because animals, medicines, chemicals, and disease agents all require careful handling. Respecting those rules is part of humane care and good science.
{{< /drg/safety-first >}}

## Requirement 2e

{{< drg/inherited-requirement number="2e" req_path="2.e" topic="Teaching and government" />}}
...
{{< drg/external-link
    title="USDA APHIS — Careers and Animal Health Work"
    url="https://www.aphis.usda.gov/"
    description="USDA Animal and Plant Health Inspection Service shows how veterinarians work in federal animal-health, wildlife, and regulatory roles." >}}

You have now seen how veterinarians move from clinics into public-health, military, research, and policy work. Next, you will focus on the education path that prepares someone for those careers.

{{< drg/next-page
    text="You have mapped the public-service side of veterinary medicine."
    teaser="Next, learn what it takes to get into veterinary school and become a veterinarian."
