...
{{< drg/tip >}}
When you talk with your counselor, do not just name the animals in each field. Explain what problems veterinarians solve there, who they work with, and why that work matters.
{{< /drg/tip >}}

## Requirement 1a

{{< drg/inherited-requirement number="1a" req_path="1.a" topic="Companion or small animal medicine, and equine medicine" />}}
...
{{< drg/image src="images/vet-small-animal-and-equine-compare.avif" alt="Split comparison showing a veterinarian examining a dog in a clinic and another veterinarian examining a horse at a barn" >}}

{{< drg/checklist title="Roles You Could Mention" subtitle="Key jobs in companion and equine practice" >}}
...
{{< drg/inherited-requirement number="1b" req_path="1.b" topic="Food animal or large animal medicine" />}}
...
{{< drg/be-prepared title="Questions a Large-Animal Veterinarian Asks" >}}
When a herd problem appears, a veterinarian usually wants to know:

- **How many animals are affected** and whether the cases are spreading.
- **What changed recently** in feed, weather, housing, transport, or new animal arrivals.
- **Which ages are affected**, because calves, adults, and pregnant animals face different risks.
- **Whether this could affect food safety or the food supply.**
{{< /drg/be-prepared >}}

## Requirement 1c

{{< drg/inherited-requirement number="1c" req_path="1.c" topic="Exotic animal medicine" />}}
...
{{< drg/did-you-know >}}
A bearded dragon with weak bones may not have a broken-bone problem first. It may have a lighting and nutrition problem. In exotic medicine, housing mistakes often become medical problems.
{{< /drg/did-you-know >}}

## Requirement 1d

{{< drg/inherited-requirement number="1d" req_path="1.d" topic="Marine animal medicine (mammal and fish)" />}}
...
{{< drg/safety-first >}}
Marine-animal work can include slippery surfaces, heavy lifting equipment, deep water, unfamiliar wildlife, and strict disease-control rules. Observation is valuable, but hands-on help should happen only under direct professional supervision.
{{< /drg/safety-first >}}

## Requirement 1e

{{< drg/inherited-requirement number="1e" req_path="1.e" topic="Poultry medicine" />}}
...
{{< drg/tip >}}
If you discuss poultry medicine with your counselor, mention the words **biosecurity** and **flock health**. They show that you understand this field is about prevention, monitoring, and system-wide care.
{{< /drg/tip >}}

## Requirement 1f

{{< drg/inherited-requirement number="1f" req_path="1.f" topic="Wildlife medicine and aquaculture medicine" />}}
...
{{< drg/external-link
    title="AVMA — Veterinary Career Center"
    url="https://www.avma.org/resources-tools/careers/veterinary-career-center"
    description="A broad overview of veterinary career paths, including companion, equine, food-animal, public-health, and specialty settings." >}}

Before you move on, make sure you can explain not just where each veterinarian works, but how the goal of the job changes from pet care to herd health to wildlife, fish, and conservation work.

{{< drg/next-page
    text="You have compared the major clinical practice settings."
    teaser="Next, explore how veterinarians serve the public through health protection, food safety, research, government, and the military."
