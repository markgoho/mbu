...
{{< drg/checklist title="What To Bring" subtitle="Simple tools that make your visit more useful" >}}
...
{{< drg/image src="images/veterinary-clinic-workflow-map.avif" alt="Diagram showing a veterinary patient workflow from check-in to exam, diagnostics, treatment, and discharge" >}}

## Questions that lead to a better presentation

{{< drg/be-prepared title="Questions You Could Ask" >}}
- **What kinds of cases do you see most often here?**
- **What part of your day is most challenging?**
- **How do technicians and assistants support the veterinarian?**
- **What skills matter most besides science?**
- **What do clients usually misunderstand about this work?**
{{< /drg/be-prepared >}}

{{< drg/video
    title="CVM Clinical Facilities Tour — UMN College of Veterinary Medicine"
    url="https://www.youtube.com/watch?v=NZvR3WT4w_4" >}}

## Building your presentation

A good presentation is not a list of random facts. Organize it around a few clear ideas:

1. **What kind of facility you visited**
2. **What the veterinarian and staff actually did**
3. **What surprised you**
4. **How the work connected to one of the Req 1 practice types**
5. **What you learned about teamwork, communication, or patient care**

{{< drg/tip >}}
If you are allowed to observe only for a short time, focus on one patient journey from start to finish. Seeing one case clearly is better than collecting scattered details you cannot explain later.
{{< /drg/tip >}}

{{< drg/external-link
    title="AVMA — Veterinary Career Center"
    url="https://www.avma.org/resources-tools/careers/veterinary-career-center"
    description="Use this after your visit to compare what you observed with other veterinary practice settings." >}}
...
{{< drg/next-page
    text="You know how to turn a clinic visit into a strong field observation."
    teaser="Next, see how to learn from veterinarians who work in public-service and specialized careers."
