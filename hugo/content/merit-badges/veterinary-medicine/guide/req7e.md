...
{{< drg/checklist title="What Continuing Education Can Include" subtitle="Ways professionals stay current" >}}
...
{{< drg/tip >}}
If you cannot find the exact CE number for your chosen career quickly, bring one reliable source to your counselor and explain that renewal rules vary by state, employer, and specialty. That is still an accurate and thoughtful answer.
{{< /drg/tip >}}

{{< drg/video
    title="Why Continuous Learning Matters for Veterinarians — Vet Konect"
    url="https://www.youtube.com/watch?v=OtNdXANrZvI" >}}

{{< drg/external-link
    title="AVMA — Continuing Education Resources"
    url="https://www.avma.org/education/center-for-veterinary-accreditation"
    description="AVMA resources are a useful starting point for understanding accreditation, credentials, and professional standards in veterinary careers." >}}
...
{{< drg/next-page
    text="You have completed the final career reflection for this badge."
    teaser="Next, go beyond the requirements with deeper topics, real-world experiences, and organizations to explore."
    url="/merit-badges/veterinary-medicine/guide/extended-learning/" >}}
