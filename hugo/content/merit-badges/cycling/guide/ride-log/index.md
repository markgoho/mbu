...
<a href="/merit-badges/cycling/guide/req6a/" class="req-worksheet__back-link">
...
<h2 class="req-worksheet__title">Ride Log</h2>
<p class="req-worksheet__subtitle">Cycling Merit Badge — Requirement 6</p>
<p style="font-size: var(--step--1); color: var(--gray-600); margin-top: 0;">Record each ride for your chosen option. Space for up to 10 rides (road option needs 7, trail option needs 7).</p>

<div class="req-worksheet__section">
  <h3 class="req-worksheet__section-title">Ride Records</h3>
...
<div class="req-worksheet__section">
  <h3 class="req-worksheet__section-title">Interesting Things Seen</h3>
  <p style="font-size: var(--step--1); color: var(--gray-600); margin-top: 0;">Use this space to describe highlights from your rides — landmarks, wildlife, scenic views, or anything noteworthy.</p>

  <div class="req-worksheet__writing-area" style="min-height: 140px;"></div>
</div>

<div class="req-worksheet__section">
  <h3 class="req-worksheet__section-title">Counselor Verification</h3>
