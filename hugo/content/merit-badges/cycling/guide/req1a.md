...
{{< drg/checklist title="The Four Principles" subtitle="Your cycling safety framework" >}}
...
{{< drg/safety-first >}}
Never assume a driver sees you. Make eye contact with drivers at intersections before proceeding. If you cannot see the driver's eyes, they cannot see you.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Cross railroad tracks and metal grates at a right angle (perpendicular). If you cross them at a shallow angle, your tire can slip into the gap and cause a crash.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Avoiding the Door Zone" >}}
- Ride at least 4 feet away from parked cars whenever possible.
- Watch for signs that a door might open: brake lights, movement inside the car, or a driver checking their mirror.
- If the lane is too narrow to ride outside the door zone safely, take the full lane — you have the right to do so.
{{< /drg/be-prepared >}}
...
{{< drg/tip >}}
In wet conditions, your braking distance can double. Start braking earlier than you normally would, and avoid sharp turns. Painted road lines and metal surfaces become especially slick when wet.
{{< /drg/tip >}}
...
{{< drg/video title="Avoiding Road Hazards" url="https://www.youtube.com/watch?v=dcRpBP9WvKg" >}}

{{< drg/video title="Hazards, Prevention, and First Aid | Scouting America" url="https://vimeo.com/1125028263" >}}

{{< drg/external-link title="League of American Bicyclists — Smart Cycling" url="https://bikeleague.org/ridesmart/" description="Learn the principles of safe, confident cycling from the nation's leading bicycle advocacy organization." >}}

{{< drg/next-page
    text="Now that you understand the hazards of cycling and how to stay safe on the road"
    teaser="learn about the first-aid skills every cyclist needs."
