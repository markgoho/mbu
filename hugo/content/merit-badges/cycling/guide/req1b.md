---
title: "First Aid for Cyclists"
layout: guide
group_title: "1. Hazards & First Aid"
req_number: "1b"
prev: "/merit-badges/cycling/guide/req1a/"
prev_title: "Cycling Hazards"
next: "/merit-badges/cycling/guide/req2/"
next_title: "Bicycle Laws"
---
...
{{< drg/checklist title="Treating Cuts and Scratches" subtitle="Step-by-step first aid" >}}
...
{{< drg/tip >}}
Pack a few alcohol-free antiseptic wipes in your saddle bag. They are lightweight and perfect for cleaning road rash on the go.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
If a rider shows any signs of a concussion — confusion, dizziness, headache, nausea, blurred vision, or difficulty balancing — stop riding immediately. Do not let them ride home. Seek medical attention right away. A concussion is a medical emergency, and "toughing it out" can make things much worse.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="Blister Prevention and Treatment" >}}
- **Prevent:** Wear padded cycling gloves and properly fitted shoes. Break in new shoes on short rides first.
- **Treat:** If a blister forms, do not pop it — the skin acts as a natural bandage. Cover it with moleskin or a blister bandage to reduce friction. If it pops on its own, clean it, apply antibiotic ointment, and cover with a sterile bandage.
{{< /drg/be-prepared >}}
...
{{< drg/checklist title="Heat Illness Response" subtitle="Know the difference and act fast" >}}
...
{{< drg/safety-first >}}
Drink water before you feel thirsty. A good rule for cycling is to take a few sips every 15 minutes. On hot days, aim for one water bottle (about 20 ounces) per hour. Sports drinks with electrolytes can help on rides longer than an hour.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Cycling First-Aid Kit" subtitle="Lightweight essentials for every ride" >}}
...
{{< drg/video title="First Aid Guide for Mountain Bikers" url="https://www.youtube.com/watch?v=oPCWzECMD_4" >}}

{{< drg/external-link title="American Red Cross — First Aid Steps" url="https://www.redcross.org/get-help/how-to-prepare-for-emergencies/types-of-emergencies/first-aid.html" description="Comprehensive first-aid guides covering all the injuries and illnesses listed in this requirement." >}}

{{< drg/next-page
    text="Now that you know how to handle injuries and illnesses on the road and trail"
    teaser="learn about the bicycle laws that keep you safe and legal."
