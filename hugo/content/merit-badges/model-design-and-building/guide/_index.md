...
{{< drg/safety-first >}}
Small projects can create big hazards. Sharp blades, hot glue, dust, fumes, lasers, and spinning tools all deserve your full attention. Build only in a space your counselor and another responsible adult have approved, and stop any time you are unsure how to use a tool safely.
{{< /drg/safety-first >}}

{{< drg/did-you-know >}}
Movie effects artists still build physical miniatures for some films because real light, texture, and shadows can make a model feel more convincing than a computer image alone.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="Cooper Hewitt Smithsonian Design Museum Collection"
    url="https://collection.cooperhewitt.org/"
    description="Explore design drawings, objects, and models to see how professionals communicate ideas visually." >}}

{{< drg/image src="images/model-design-overview-collage.avif" alt="A Scout reviewing hand sketches, a foam-board house model, and a laptop 3D model on the same worktable" >}}
...
{{< drg/next-page
    text="Every strong model starts with safe habits"
    teaser="Learn how to protect yourself when using hand tools, design software, and hazardous materials."
    url="/merit-badges/model-design-and-building/guide/req1/" >}}
