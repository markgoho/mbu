...
{{< drg/checklist title="Career Research Questions" subtitle="Bring answers to these topics for your counselor discussion" >}}
...
{{< drg/video
    title="Architect - Career Spotlight — USAGov"
    url="https://www.youtube.com/watch?v=ag-JKMCf-SE" >}}
...
{{< drg/tip >}}
When you research a career, keep notes in your own words. That makes it much easier to explain your findings naturally when you talk with your counselor.
{{< /drg/tip >}}
...
If you liked [Req 4a](/merit-badges/model-design-and-building/guide/req4a/), architecture or drafting may appeal to you. If you liked [Req 4d](/merit-badges/model-design-and-building/guide/req4d/), mechanical engineering or prototype work may be a better fit. If [Req 5](/merit-badges/model-design-and-building/guide/req5/) was your favorite, design for entertainment, concept art, or industrial design might be worth exploring.

{{< drg/external-link
    title="O*NET — Commercial and Industrial Designers"
    url="https://www.onetonline.org/link/summary/27-1021.00"
    description="A strong career overview covering tasks, tools, required skills, and job outlook for industrial design work." >}}

{{< drg/external-link
    title="O*NET — Architects, Except Landscape and Naval"
    url="https://www.onetonline.org/link/summary/17-1011.00"
    description="Helpful for understanding architecture training, common tasks, and how designers turn concepts into buildings." >}}

{{< drg/external-link
    title="O*NET — Mechanical Engineers"
    url="https://www.onetonline.org/link/summary/17-2141.00"
    description="Useful background on machine design, engineering problem solving, and the skills needed for mechanical careers." >}}

{{< drg/external-link
    title="NCARB — Get Licensed"
    url="https://www.ncarb.org/get-licensed"
    description="A clear explanation of the path to becoming a licensed architect in the United States." >}}

You have reached the end of the badge requirements. Next, go beyond the badge with deeper ideas, real-world experiences, and organizations that can keep you learning.

{{< drg/next-page
    text="You have connected modelmaking skills to real careers"
    teaser="Now explore deeper design ideas, experiences, and organizations that can take you further."
    url="/merit-badges/model-design-and-building/guide/extended-learning/" >}}
