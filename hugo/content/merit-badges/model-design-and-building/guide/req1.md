...
Safety. Discuss all safety procedures with your counselor before beginning your modelmaking project, and explain why each is important—both in traditional and computer-assisted design and construction:
{{< /drg/requirement >}}
...
{{< drg/checklist title="Three Safety Questions" subtitle="Ask these before you begin any modelmaking step" >}}
...
Explain the requirements for personal safety when using modelmaking hand tools, and when to use proper protective equipment.
{{< /drg/requirement >}}
...
{{< drg/tip >}}
If you catch yourself rushing, stop and reset. Most modelmaking injuries happen when someone tries to finish one more cut, one more trim, or one more hole without pausing to hold the work correctly.
{{< /drg/tip >}}

{{< drg/safety-first >}}
Never carve toward your hand, leg, or lap. Always work on a solid surface with good light, and never use a damaged blade, loose handle, or cracked cutting tool. If a blade falls, let it fall. Do not try to grab it.
{{< /drg/safety-first >}}

## Requirement 1b

{{< drg/requirement number="1b" >}}
Explain digital safety best practices when using computer design software, and digital fabrication tools.
{{< /drg/requirement >}}
...
{{< drg/be-prepared title="Before You Press Start" >}}
When you are about to run a digital fabrication tool, pause and check these items:

- **Correct file**: You opened the latest version and confirmed the dimensions.
- **Correct material**: The stock in the machine matches the material setting in the software.
- **Correct setup**: The bed, clamps, or workholding are secure.
- **Correct supervision**: A trained adult is present if the tool requires it.
- **Correct emergency response**: You know where the stop button is before the machine moves.
{{< /drg/be-prepared >}}

## Requirement 1c

{{< drg/requirement number="1c" >}}
Explain what precautions to take when using flammable or hazardous materials.
{{< /drg/requirement >}}
...
{{< drg/did-you-know >}}
A laser cutter can safely cut some materials, but cutting the wrong plastic can release dangerous gases and damage the machine. In many labs, material choice is a safety decision, not just a design decision.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="OSHA — Hand and Power Tools"
    url="https://www.osha.gov/hand-power-tools"
    description="A practical overview of safe tool use, guarding, and common hazards that applies well to modelmaking benches." >}}

{{< drg/external-link
    title="OSHA — Eye and Face Protection"
    url="https://www.osha.gov/eye-face-protection"
    description="Clear guidance on when eye protection matters and why flying particles are a serious hazard." >}}

{{< drg/external-link
    title="CDC/NIOSH — 3D Printing with Filaments"
    url="https://www.cdc.gov/niosh/docs/2020-115/"
    description="Safety guidance for hot surfaces, fumes, ventilation, and protective practices when using filament-based 3D printers." >}}

{{< drg/external-link
    title="OSHA — Laser Hazards"
    url="https://www.osha.gov/laser-hazards"
    description="A helpful summary of why lasers require controlled procedures, supervision, and eye protection." >}}

{{< drg/image src="images/modelmaking-safety-bench.avif" alt="A well-organized modelmaking bench with safety glasses, cutting mat, clamps, labeled glue, and a clear blade path" >}}
...
{{< drg/next-page
    text="Safe habits give you a strong foundation"
    teaser="Now compare the main types of models and the materials designers use to build them."
