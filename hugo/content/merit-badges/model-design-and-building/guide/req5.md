...
{{< drg/did-you-know >}}
Many famous movie spacecraft feel believable because their designers studied real aircraft carriers, bombers, submarines, and industrial machines before inventing futuristic details.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Designing Components" subtitle="Give each major area a reason to exist" >}}
...
{{< drg/tip >}}
If one angle keeps looking wrong, do not keep decorating it. Step back and fix the big shape first. Strong silhouettes matter more than tiny details.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="A Good Counselor Discussion Covers" >}}
When you present, be ready to explain:

- **Mission of the spacecraft** and how that drove the shape.
- **Scale choice** and why it was practical.
- **Materials or software used** and why you chose them.
- **Main challenge** and what you changed to solve it.
- **What you learned** about design, not just what you built.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="NASA Glenn — Beginners Guide to Aeronautics"
    url="https://www1.grc.nasa.gov/beginners-guide-to-aeronautics/"
    description="A strong source for studying real vehicle design logic, propulsion ideas, and shape decisions that can inspire more believable fantasy spacecraft." >}}

{{< drg/external-link
    title="Stanford d.school — Design Thinking Bootleg"
    url="https://dschool.stanford.edu/resources/design-thinking-bootleg"
    description="Useful for understanding how professional designers iterate, test ideas, and improve a concept through multiple revisions." >}}

{{< drg/image src="images/fantasy-spacecraft-concept-sheet.avif" alt="A Scout-designed fantasy spacecraft shown from front, side, top, and perspective views with separate cockpit, engine, and storage concept sketches" >}}
...
{{< drg/next-page
    text="You have used real-world logic to design an imaginative vehicle"
    teaser="Next, explore careers where scale drawings, prototypes, digital models, and physical builds are part of the job."
