...
Explain the uses for each of the following types of models: architectural, structural, process, mechanical, and industrial.
{{< /drg/requirement >}}
...
{{< drg/tip >}}
When you talk with your counselor, do not just define each model type. Give an example of when someone would actually use it. That shows you understand the purpose, not just the vocabulary.
{{< /drg/tip >}}

## Requirement 2b

{{< drg/requirement number="2b" >}}
Explain to your counselor how either traditional and/or computer design tools can be used to create plans, simulate function, visualize models, and assist in constructing or fabricating parts.
{{< /drg/requirement >}}
...
{{< drg/checklist title="Traditional vs. Digital" subtitle="Both approaches are useful at different moments" >}}
- **Traditional tools** are excellent for quick idea generation, learning scale, and hands-on problem solving.
- **Digital tools** are excellent for precision, revisions, repeated parts, and machine-assisted fabrication.
- **Best practice** is often to combine them: sketch first, model second, build third, revise as needed.
{{< /drg/checklist >}}

## Requirement 2c

{{< drg/requirement number="2c" >}}
Describe to your counselor traditional and modern materials and fabrication methods that can be used for making these models. Include physical and digital materials and methods.
{{< /drg/requirement >}}
...
{{< drg/video
    title="CardBoard Basics Tutorial Guide Chip/Matte Board model making: modeling for Designers & Architects — Eric Strebel"
    url="https://www.youtube.com/watch?v=x6s3lGH4MyI" >}}

{{< drg/be-prepared title="Choose Materials on Purpose" >}}
Ask these questions before you buy or cut anything:

- **What does this part need to do?** Display shape, carry weight, move, or connect to another part.
- **How clean must it look?** Rough prototype, neat presentation model, or finished showpiece.
- **How many copies do I need?** One custom part or many identical parts.
- **What tools do I actually have?** Use materials your available tools can handle safely.
{{< /drg/be-prepared >}}

{{< drg/did-you-know >}}
Designers often build more than one kind of model for the same idea. A rough foam mock-up may come first, a precise digital model second, and a polished presentation version last.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="American Wood Council — Wood Frame Construction Resources"
    url="https://www.awc.org/codes-standards/publications/wcd1"
    description="Useful background for understanding common structural members, framing layouts, and why wood behaves the way it does in models and real buildings." >}}

{{< drg/external-link
    title="NASA Glenn — Beginners Guide to Aeronautics"
    url="https://www1.grc.nasa.gov/beginners-guide-to-aeronautics/"
    description="Shows how real designers and engineers use models and simulations to study shape, motion, and performance." >}}

{{< drg/image src="images/model-types-comparison-board.avif" alt="Five small labeled example models showing architectural, structural, process, mechanical, and industrial model types side by side" >}}
...
{{< drg/next-page
    text="Understanding model types helps you choose wisely"
    teaser="Next, turn an idea into a real project plan with scale drawings, materials, and tool lists."
