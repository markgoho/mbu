...
{{< drg/checklist title="Architectural Plan Essentials" subtitle="Make sure your drawings include these items" >}}
...
{{< drg/tip >}}
Build a quick scrap version of one wall with a window opening before you cut every part. Testing one section first can show whether your chosen material is too thick, too flimsy, or too hard to cut neatly.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Architectural Model Build Order" >}}
A clean sequence makes this option easier:

- **Draw first**: Finalize floor plan and elevations.
- **Cut major parts**: Walls, floors, and roof planes.
- **Dry-fit everything**: Check that edges meet before gluing.
- **Add openings and structure**: Windows, doors, and major support details.
- **Finish last**: Paint, site details, and landscaping.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Cooper Hewitt Smithsonian Design Museum Collection"
    url="https://collection.cooperhewitt.org/"
    description="A rich source of design drawings and presentation ideas that can help you see how professionals communicate form and proportion." >}}

{{< drg/image src="images/architectural-house-model.avif" alt="A Scout-built 1:48 house model beside matching floor plan and elevation drawings, with clean window openings and simple landscaping" >}}
...
{{< drg/next-page
    text="You know how an architectural model tells the story of a house"
    teaser="Next, strip away the finish and study the framing that actually supports a building."
