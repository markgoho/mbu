...
### Build a real catalog, not a random gallery
...
{{< drg/video
    title="Plant Photography for Beginners (video)"
    url="https://youtu.be/ChxvvKV2Gx8?si=PXSE1d46dKsQqDmv" >}}

{{< drg/video
    title="How I Shot My First Plant Time-Lapse (video)"
    url="https://youtu.be/gqoAL4-XTNg?si=p-r1McCO7JyXONJH" >}}

{{< drg/tip >}}
Place a ruler, coin, or pencil near the leaf or seed for at least one photo. A scale reference makes size comparisons much easier later.
{{< /drg/tip >}}

{{< drg/image src="images/plant-photo-catalog-layout.avif" alt="Example plant photo catalog page with whole-plant shot, close-up leaf image, seed image, scale reference, and habitat notes" >}}

With plants finished, close out the field-study options by comparing soil and rock types from your area.

{{< drg/next-page
    text="You know how to turn plant photos into a useful identification catalog."
    teaser="Next, examine the ground itself through soils and rocks."
