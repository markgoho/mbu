...
{{< drg/video
    title="Science at Play: Preserving Fall Leaves (video)"
    url="https://www.youtube.com/watch?v=06nhKenT410" >}}

{{< drg/video
    title="Harvesting & Saving Seeds! (video)"
    url="https://www.youtube.com/watch?v=QqIoGe-m2OM" >}}

{{< drg/checklist title="Specimen label basics" subtitle="Every leaf or seed should stay tied to its data" >}}
...
{{< drg/safety-first >}}
Do not collect poisonous plants or seeds unless a knowledgeable adult says it is safe. Wash your hands after handling plant material, especially sap, berries, or seed pods you do not know well.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You know how to collect and label plant material responsibly."
    teaser="Now compare that with building a plant photo catalog instead."
