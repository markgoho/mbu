...
{{< drg/external-link
    title="Game Fish Identification Reference Guides (website)"
    url="https://igfa.org/game-fish-database/"
    description="A species reference that helps you compare fish shape, markings, and range while learning local identification." >}}

## Requirement 4e2

{{< drg/inherited-requirement number="4e2" req_path="4.e.2" topic="Collect four kinds of animal food eaten by fish in the wild." />}}
...
{{< drg/video
    title="What Do Fish Eat? (video)"
    url="https://www.youtube.com/watch?v=LVTGIn4gnTw" >}}

{{< drg/tip >}}
If you cannot collect every food item physically, ask your counselor what evidence is acceptable in your setting. Photos, notes, and careful field observation may still help you explain the relationship clearly.
{{< /drg/tip >}}

Studying fish teaches you to think below the surface. Next, look at mollusks, crustaceans, and shells from aquatic habitats.

{{< drg/next-page
    text="You have connected local fish to the foods they eat in the wild."
    teaser="Next, identify mollusks and crustaceans and organize a shell collection."
