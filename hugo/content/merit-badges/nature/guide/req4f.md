...
{{< drg/video
    title="All About Mollusks (video)"
    url="https://www.youtube.com/watch?v=G_GJH1t7VVM" >}}

{{< drg/video
    title="Crustaceans Facts (video)"
    url="https://youtu.be/nfTQUX-GMjc?si=uWRRlR9ez4Tc5ymm" >}}

## Requirement 4f2

{{< drg/inherited-requirement number="4f2" req_path="4.f.2" topic="Collect, mount, and label six shells." />}}
...
{{< drg/video
    title="Organizing My Massive Seashell Collection. Identifying Similar Shells & Comparing Shells to Critters (video)"
    url="https://youtu.be/MMkynhuI_1w?si=ZC4ur2DlM9Sl2IFw" >}}

{{< drg/external-link
    title="Organizing a Shell Collection (website)"
    url="https://conchologistsofamerica.org/organizing-a-shell-collection/"
    description="Practical ideas for sorting, storing, and labeling shells so your collection stays useful and easy to discuss." >}}

{{< drg/tip >}}
Use small paper slips or cards with pencil or waterproof ink. Labels written later from memory are often the first thing Scouts get wrong.
{{< /drg/tip >}}

From shell shapes and shoreline clues, move back onto land and begin the plant-study section of Req 4.

{{< drg/next-page
    text="You have practiced identifying invertebrates and organizing shell evidence carefully."
    teaser="Next, identify 15 wild plants in the field."
