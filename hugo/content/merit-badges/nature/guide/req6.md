...
{{< drg/video
    title="Ecological Succession (video)"
    url="https://www.youtube.com/watch?v=IrIvMt6HWlA" >}}

{{< drg/video
    title="Ecological Succession: Change Is Good (video)"
    url="https://www.youtube.com/watch?v=jZKIHe2LDP8" >}}

{{< drg/did-you-know >}}
Some habitats that look “messy,” like weedy fields and shrubby edges, are actually important succession stages that support animals needing young growth and lots of cover.
{{< /drg/did-you-know >}}
...
{{< drg/video
    title="Ecological Succession-Primary and Secondary (video)"
    url="https://youtu.be/8ceDE01iWLE?si=kzFlf4WEsd2ArppS" >}}

{{< drg/checklist title="Succession field notes" subtitle="Questions to answer while you are on-site" >}}
...
{{< drg/tip >}}
Pick one site you can describe clearly rather than trying to sound dramatic. A school meadow, pond edge, old field, or neighborhood woodlot can all work if you observe it carefully.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    description="A reminder to read changing landscapes without damaging the habitats you are trying to understand." >}}
...
{{< drg/next-page
    text="You can now explain how habitats change over time and how to read a real site for clues."
    teaser="Finish by choosing a future path in nature work or nature hobbies."
