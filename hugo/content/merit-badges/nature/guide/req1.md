...
{{< drg/checklist title="When you explain plants to your counselor" subtitle="Use examples from a place you know" >}}
...
{{< drg/did-you-know >}}
Oak trees are famous for supporting wildlife. In some regions, a single oak can support hundreds of species of insects, plus the birds and mammals that feed on them.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Use your state natural heritage program, state parks agency, native plant society, or state department of natural resources. Those sources are usually better than random list sites because they are local and up to date.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    description="A short overview showing how plants provide food, oxygen, and habitat for animals." >}}
...
{{< drg/external-link
    ...
    description="Examples of plant-animal partnerships that can help you think beyond simple food relationships." >}}

### A Strong Way to Discuss This Requirement

Try organizing your answer like this:

1. Name the plant-to-animal connection.
2. Give a specific example from nature.
3. Explain why the connection matters.
4. Then describe your protected plant and what threatens it.

You do not need the “perfect” rare plant. You need a real local example and a clear explanation.

{{< drg/image src="images/plant-animal-connections-web.avif" alt="Diagram showing plants providing food, shelter, and habitat support to several animals in one ecosystem" >}}

Plants help animals survive. Next, turn the relationship around and look at the surprising ways animals help plants.

{{< drg/next-page
    text="You have seen how plants feed, shelter, and support animals."
    teaser="Now explore how animals pollinate, spread seeds, and help plants survive."
