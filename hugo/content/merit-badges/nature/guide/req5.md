...
Discuss the importance of the Leave No Trace Seven Principles and the Outdoor Code and how they relate to nature. Explain how you have followed the Leave No Trace Seven Principles and the Outdoor Code while in natural areas during field observation, specimen collection, and identification.
{{< /drg/requirement >}}
...
{{< drg/checklist title="Outdoor ethics during nature study" subtitle="What your counselor wants to hear in a real example" >}}
...
{{< drg/video
    title="The Outdoor Code Explained (video)"
    url="https://www.youtube.com/watch?v=XoOSgw6sOPA" >}}

{{< drg/video
    title="What is Leave No Trace? (video)"
    url="https://www.youtube.com/watch?v=Rpq01rO9ZR0" >}}

{{< drg/external-link
    title="Leave No Trace Basics (video)"
    url="https://vimeo.com/1115216743/63b20c0b33?share=copy"
    description="A practical overview of the habits that reduce impact while you hike, observe, and collect field evidence." >}}

{{< drg/be-prepared title="You find a great observation spot, but it is fragile habitat" >}}
- **Pause first.** A perfect view is not worth damaging a nesting area, stream bank, or wildflower patch.
- **Back up to durable ground.** Observe from rock, packed soil, or an established trail.
- **Use tools instead of getting closer.** Binoculars, zoom, and careful note-taking reduce disturbance.
- **Leave signs of wildlife alone.** Feathers, nests, egg masses, and occupied shells should usually stay where they are.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have connected outdoor ethics to real choices in the field."
    teaser="Next, study ecological succession and how landscapes change over time."
