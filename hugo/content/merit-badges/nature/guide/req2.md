...
req_number: "2"
req_path: "2"
prev: "/merit-badges/nature/guide/req1/"
prev_title: "Req 1 — Plants Support Animal Life"
next: "/merit-badges/nature/guide/req3/"
next_title: "Req 3 — Food Chains in Action"
---
...
{{< drg/checklist title="Good examples to share" subtitle="Choose examples that fit your region" >}}
...
{{< drg/tip >}}
When you research your protected animal, look for one sentence that clearly connects the threat to the habitat. “This species needs clean, slow-moving streams, but sediment and pollution smother its breeding areas” is much stronger than “it is endangered.”
{{< /drg/tip >}}
...
{{< drg/external-link
    title="How Do Animals Help Plants? (4 Symbiotic Interactions) (website)"
    url="https://nature-mentor.com/how-do-animals-help-plants/"
    description="Examples of pollination, seed dispersal, and other plant-animal partnerships you can use in your explanation." >}}

{{< drg/external-link
    title="Why Animals Need Plants (video)"
    url="https://www.pbs.org/video/why-animals-need-plants-y469zr"
    description="A quick review of the back-and-forth relationship between plants and animals in ecosystems." >}}

{{< drg/external-link
    title="11 Plants That Use Animals to Do Their Dirty Work (website)"
    url="https://completegardening.com/11-plants-that-use-animals-to-do-their-dirty-work/"
    description="Shows how some plants rely on animals in surprising ways, especially for reproduction and seed movement." >}}

{{< drg/be-prepared title="Choosing a protected animal to discuss" >}}
- **Start local.** Check your state wildlife agency or conservation department.
- **Find its habitat.** Forest, stream, grassland, wetland, coast, or desert?
- **Name the threat.** What is changing that makes survival harder?
- **Connect it back to plants.** Does the species pollinate, disperse seeds, or help the ecosystem in another way?
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have explored how animals help plants reproduce and thrive."
    teaser="Next, map those relationships into land and water food chains."
