...
{{< drg/inherited-requirement number="4a1" req_path="4.a.1" topic="In the field, identify eight species of birds." />}}
...
{{< drg/video
    title="How to Identify Birds [TOP 10 BACKYARD BIRDS] (video)"
    url="https://www.youtube.com/watch?v=HtBcOk8ICpA" >}}

{{< drg/external-link
    title="Merlin Bird ID (website)"
    url="https://merlin.allaboutbirds.org/"
    description="A trusted tool for identifying birds by appearance, sound, and location while you are in the field." >}}

{{< drg/tip >}}
Do not chase numbers first. Learn three or four common species really well, then add more. Strong observation beats guessing from a quick look.
{{< /drg/tip >}}

## Requirement 4a2

{{< drg/inherited-requirement number="4a2" req_path="4.a.2" topic="Make and set out a birdhouse OR a feeding station OR a birdbath. List what birds used it during a period of one month." />}}
...
{{< drg/video
    title="DIY Birdhouse (video)"
    url="https://www.youtube.com/watch?v=u4iAhnbWpz8" >}}

{{< drg/video
    title="How to Pick (or Build) the Right Bird Bath for Your Garden (video)"
    url="https://www.youtube.com/watch?v=yZl2N2XlHDA" >}}

{{< drg/video
    title="Build a Bird House for Under $5 in Under 5 Minutes (video)"
    url="https://www.youtube.com/watch?v=j0werPvrrPI" >}}

{{< drg/checklist title="Bird station success checklist" subtitle="Simple habits that improve your results" >}}
...
{{< drg/image src="images/backyard-bird-station-observation.avif" alt="Scout observing a feeder and birdbath from a notebook station while different birds visit" >}}
...
{{< drg/next-page
    text="You have practiced bird identification and habitat observation."
    teaser="Move on to mammals and learn how to read tracks and signs."
