...
req_number: "7b"
req_path: "7.b"
prev: "/merit-badges/nature/guide/req7a/"
prev_title: "Req 7a — Nature Careers"
next: "/merit-badges/nature/guide/extended-learning/"
...
{{< drg/video
    title="Other Hobbies in Your Journal: The Nature Journal Show (video)"
    url="https://www.youtube.com/watch?v=Pt1UqDNcaFg" >}}

{{< drg/external-link
    title="15 Hobbies for Animal and Nature Lovers (website)"
    url="https://wildlifeinformer.com/hobbies-for-animal-and-nature-lovers/"
    description="A broad list of nature-related hobbies that may help you choose one worth researching more deeply." >}}
...
{{< drg/checklist title="Questions for choosing a hobby" subtitle="Use these to shape your discussion" >}}
...
{{< drg/tip >}}
The best hobby is usually the one you can actually do where you live with the time and tools you have now. Start close to home, then expand.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have connected nature skills to hobbies, goals, and community."
    teaser="Go beyond the badge with deeper projects, places, and organizations to explore."
    url="/merit-badges/nature/guide/extended-learning/" >}}
