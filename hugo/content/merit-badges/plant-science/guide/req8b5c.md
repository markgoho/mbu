...
{{< drg/inherited-requirement number="8b5c1" req_path="8.b.5.c.1" topic="Plant five or more trees or shrubs in a landscape setting. Take full care of the trees or shrubs you have planted for one growing season." />}}
...
{{< drg/inherited-requirement number="8b5c2" req_path="8.b.5.c.2" topic="Prune a tree or shrub properly. Explain why pruning is necessary." />}}
...
{{< drg/video
    title="Ask an Arborist: Why Do I Need to Prune? (video)"
    url="https://youtu.be/-RjCGdgF7Jo?si=TFYAJs23hB21ewOn" >}}

{{< drg/video
    title="Ask an Arborist: What Are the Rules of Pruning? (video)"
    url="https://youtu.be/O1UBV35JAxI?si=v9bsuqKs9l5Tdjj8" >}}

{{< drg/video
    title="Ask an Arborist: The ABC's of Pruning (video)"
    url="https://youtu.be/IQhmIK-0HOc?si=owIKfbXa8G-lcX1q" >}}

## Requirement 8b5c3

{{< drg/requirement number="8b5c3" >}}
...
{{< drg/video
    title="10 Most Popular Ornamental Trees for Your Garden (video)"
    url="https://youtu.be/pTcQTifb6lI?si=JzJ9j6xsPbckdtjW" >}}

## Requirement 8b5c4

{{< drg/requirement number="8b5c4" >}}
...
{{< drg/video
    title="The Importance of Trees for Our Environment and Health (video)"
    url="https://youtu.be/E6VvooVLgq4?si=wpybhPMXwOSnZ8y5" >}}

{{< drg/external-link
    title="6 Ways Trees Benefit All of Us (website)"
    url="https://www.nature.org/en-us/what-we-do/our-priorities/build-healthy-cities/cities-stories/benefits-of-trees-forests/"
    description="The Nature Conservancy's overview of the environmental, health, and economic benefits that urban and rural trees provide to communities." >}}

{{< drg/next-page
    text="The final project track covers home gardening for people and wildlife—continue if browsing other options."
    teaser="Design and plant a mixed garden, demonstrate nine care techniques, and identify native plants for wildlife."
