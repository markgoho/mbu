...
{{< drg/inherited-requirement number="8b5a1" req_path="8.b.5.a.1" topic="Grow bedding plants appropriate for your area in pots or flats from seed or cuttings in a manufactured soil mix. Explain why you chose the mix and tell what is in it." />}}
...
{{< drg/inherited-requirement number="8b5a2" req_path="8.b.5.a.2" topic="Transplant plants to a bed in the landscape and maintain the bed until the end of the growing season. Record your activities, observations, materials used, and costs." />}}
...
{{< drg/video
    title="Transplanting Ferns & Other Plants: A Guide to Success (video)"
    url="https://youtu.be/vd3w_hmtm9A?si=ryWERSwz8LEQQssw" >}}

## Requirement 8b5a3

{{< drg/requirement number="8b5a3" >}}
...
{{< drg/video
    title="The Big Five - Weeding, Pruning, Fertilizing, Mulching, Watering (video)"
    url="https://youtu.be/mgviGaoWO1w" >}}

## Requirement 8b5a4

{{< drg/requirement number="8b5a4" >}}
...
{{< drg/video
    title="The Difference Between Annuals and Perennials (video)"
    url="https://youtu.be/-jQsd1fNFA8" >}}

{{< drg/video
    title="Annuals or Perennials? Which Is Best, and How Do I Choose? (video)"
    url="https://youtu.be/nbJJMwsp0TM?si=eweSHAYVtUPc8cs4" >}}

{{< drg/next-page
    text="The next project track covers fruit, berry, and nut crops—continue if browsing other options."
    teaser="Plant five fruit or nut plants, prune one, demonstrate a graft, and describe how a crop is processed."
