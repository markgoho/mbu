...
{{< drg/requirement number="8c6c3a" >}}
Identify, measure, and map each tree in a 100-by-100-foot plot. (Measure the diameter of each tree larger than 3 inches in diameter at 4&frac12; feet above the ground.)
{{< /drg/requirement >}}
...
{{< drg/video
    title="Tree Identification | Ask the Arborist (video)"
    url="https://youtu.be/7M4PUM_eIIQ" >}}

## Requirement 8c6c3c

{{< drg/requirement number="8c6c3c" >}}
...
{{< drg/next-page
    text="That completes the Nested Plot option."
    teaser="The next project option moves indoors to the preserved-plant collections used by botanists."
