...
{{< drg/checklist title="Seedbed Preparation Steps" subtitle="Work from site cleanup to final planting surface" >}}
...
{{< drg/tip >}}
If you squeeze a handful of soil and it stays in a sticky lump, it is too wet to work. Working wet soil creates hard clods and compaction that can hurt seedlings later.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="How To Prepare Your Seedbed For Spring Planting (video)"
    url="https://youtu.be/YYbzM7halC0?si=UYbTPYp_l47celkS" >}}

{{< drg/external-link
    title="Plan Your Best Garden Ever: Testing Soil and Seeds (website)"
    url="https://www.growveg.com/guides/plan-your-best-garden-ever-testing-soil-and-seeds/"
    description="Practical guide to checking soil condition and seed quality before planting so you can build a seedbed that gives crops a stronger start." >}}

{{< drg/next-page
    text="Once the seedbed is ready, the next question is whether the seeds themselves are ready."
    teaser="Build a germination tester and measure how many seeds in a sample are still alive."
