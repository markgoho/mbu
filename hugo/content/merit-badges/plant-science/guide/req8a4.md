...
{{< drg/video
    title="Major Crops of United States (video)"
    url="https://youtu.be/AHx27-1Qjxw" >}}

{{< drg/video
    title="Major Agricultural Crops in United States (video)"
    url="https://youtu.be/ulHKu0l0xds" >}}
...
{{< drg/external-link
    ...
    description="Official USDA maps and production charts that help you identify where major crops are grown and compare regions using current data." >}}

{{< drg/next-page
    text="Now choose one crop area for a deeper study."
    teaser="Pick the crop track you can best observe, grow, or research well."
