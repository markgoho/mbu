...
{{< drg/inherited-requirement number="8b5d1" req_path="8.b.5.d.1" topic="Design and plant a garden or landscape that is at least 10 by 10 feet." />}}
...
{{< drg/video
    title="How to Design the Perfect Landscape | Landscape Design 101 (video)"
    url="https://youtu.be/e-wO-LqEQb4?si=_RjhdI1Bh7eIlgd-" >}}

{{< drg/external-link
    title="10 Plants for a Bird-Friendly Yard | Audubon (website)"
    url="https://www.audubon.org/news/10-plants-bird-friendly-yard"
    description="Curated list of plants that attract birds through food, cover, and nesting opportunities—useful for planning the wildlife-friendly elements of your garden design." >}}

## Requirement 8b5d2

{{< drg/inherited-requirement number="8b5d2" req_path="8.b.5.d.2" topic="Plant 10 or more different types of plants in your garden. Tell why you selected particular varieties of vegetables and flowers. Take care of the plants in your garden for one season." />}}
...
{{< drg/external-link
    title="Caring for a Vegetable Garden | HowStuffWorks (website)"
    url="https://home.howstuffworks.com/caring-for-a-vegetable-garden.htm"
    description="Practical overview of the full range of garden maintenance tasks from watering and fertilizing to pest management and end-of-season cleanup." >}}

## Requirement 8b5d3

{{< drg/requirement number="8b5d3" >}}
...
{{< drg/video
    title="Remove Weeds Using These Effective Methods | Gardening 101 (video)"
    url="https://youtu.be/3zNij-aGpVw?si=_alv-L6QxChk5Ukk" >}}

{{< drg/video
    title="How to Mulch Your Garden: A Step-by-Step Guide (video)"
    url="https://youtu.be/gy6q5f75O7k?si=HJltpHrtGxdpt2i_" >}}

{{< drg/video
    title="Composting For Beginners (video)"
    url="https://youtu.be/1LZzgi1k9aA?si=8UAYVwjNPRBB90g5" >}}

## Requirement 8b5d4

{{< drg/requirement number="8b5d4" >}}
...
{{< drg/external-link
    title="Get to Know These 20 Common Types of Native Plants (website)"
    url="https://www.audubon.org/news/get-know-these-20-common-types-native-plants"
    description="Audubon's illustrated guide to widely available native plants, including their wildlife value—a good starting point for building your list of 10 regionally appropriate species." >}}

{{< drg/external-link
    title="Native Plant Recommendations | United States Botanic Garden (website)"
    url="https://www.usbg.gov/native-plant-recommendations"
    description="The U.S. Botanic Garden's regionally organized recommendations for native plants that support pollinators, birds, and other wildlife." >}}

{{< drg/next-page
    text="Option B — Horticulture is complete. If you have not already started Option B's earlier requirements, review the roadmap. Otherwise, proceed to Option C — Field Botany."
    teaser="Option C explores plant communities, identification keys, and field botany methods in natural areas."
