...
{{< drg/inherited-requirement number="8c6b3b" req_path="8.c.6.b.3.b" topic="Measure the diameter of each tree at 4&frac12; feet above the ground, and map and list each tree." />}}
...
{{< drg/next-page
    text="That completes the Transect Study option."
    teaser="The next project option uses nested plots to compare canopy, shrub, and ground layers at two sites."
