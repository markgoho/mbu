...
{{< drg/video
    title="How to Use Twigs to Identify Trees (video)"
    url="https://youtu.be/X2TDSiaqfbQ?si=h0rb2-D_5zUSTcgN" >}}

## Requirement 8c6a2

{{< drg/inherited-requirement number="8c6a2" req_path="8.c.6.a.2" topic="Collect, press, and label leaves, flowers, or fruits to document your inventory." />}}
...
{{< drg/requirement number="8c6a3" >}}
List the types of trees by scientific name and give common names. Note the number and size (diameter at 4&frac12; feet above ground) of trees observed and determine the largest of each species in your study area.
{{< /drg/requirement >}}
...
{{< drg/next-page
    text="Tree Inventory is one way to complete Req 8c6."
    teaser="The next option uses a long study line to compare two plant communities."
