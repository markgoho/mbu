...
{{< drg/video
    title="US Plant Zones: Explained // Garden Answer (video)"
    url="https://youtu.be/O6AM0pNiUOs" >}}

{{< drg/external-link
    title="Glossary - Grow Native! (website)"
    url="https://grownative.org/learn/glossary/"
    description="Plain-language definitions for many of the 14 terms above, plus native-plant context useful for building your climate-appropriate plant list." >}}

{{< drg/external-link
    title="USDA Plant Hardiness Zone Map (website)"
    url="https://planthardiness.ars.usda.gov/"
    description="Enter your ZIP code to find your exact hardiness zone, then use the interactive map to explore zone boundaries across the country." >}}

{{< drg/next-page
    text="With your vocabulary and plant list ready, move on to the hands-on skill requirement."
    teaser="Choose one of four practical horticultural skills—propagation, transplanting, pruning, or planting."
