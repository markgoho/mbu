...
{{< drg/inherited-requirement number="8.a.5.c.1" req_path="8.a.5.c.1" topic="Collect, count, and label samples of each for display: perennial grasses, annual grasses, legumes, and broadleaf weeds. Indicate how each grass and legume is used. Keep a log of the site where you found each sample and share it with your counselor." />}}
...
{{< drg/video
    title="Importance of Legumes (video)"
    url="https://youtu.be/fUJXV-lHDKk" >}}

{{< drg/video
    title="The Science of Soil Health: Understanding the Value of Legumes and Nitrogen-Fixing Microbes (video)"
    url="https://youtu.be/0yRYdvEzXag?si=vcj8GD4Awd1EoLJZ" >}}

## Requirement 8a5c3

{{< drg/requirement number="8a5c3" >}}
...
{{< drg/video
    title="Local Veterinarian Explains What Plants Are Toxic to Large Animals (video)"
    url="https://youtu.be/vwrNGUx0TJ4" >}}

{{< drg/next-page
    text="If you chose forage crops, be ready to explain both the plant side and the animal side of the system."
    teaser="The next option follows small grains from production data to harvest and processing."
