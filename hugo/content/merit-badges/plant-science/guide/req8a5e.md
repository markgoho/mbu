...
{{< drg/inherited-requirement number="8a5e1" req_path="8.a.5.e.1" topic="Grow a plot of soybeans and have your plot inspected by your counselor." />}}
...
{{< drg/video
    title="How to Produce Millions Of Tons Of Soybeans | Modern Agricultural Technology | Soy milk Processing (video)"
    url="https://youtu.be/1olmtb3MpME" >}}

## Requirement 8a5e2

{{< drg/requirement number="8a5e2" >}}
...
{{< drg/external-link
    title="Soybeans and Oil Crops - Oil Crops Sector at a Glance | Economic Research Service (website)"
    url="https://www.ers.usda.gov/topics/crops/soybeans-and-oil-crops/oil-crops-sector-at-a-glance"
    description="USDA's overview of soybean and oil-crop production, uses, and market importance in the United States." >}}

## Requirement 8a5e3

{{< drg/requirement number="8a5e3" >}}
...
{{< drg/video
    title="Soybean School: Assessing the Impact of Frost (video)"
    url="https://youtu.be/x86tt8PPwiA" >}}

{{< drg/next-page
    text="That completes the Agronomy branch."
    teaser="If you are comparing branches, the next section shows how horticulture focuses on gardens, landscapes, and plant care."
