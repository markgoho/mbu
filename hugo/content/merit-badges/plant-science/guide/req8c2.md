...
{{< drg/video
    title="Native Plants vs Exotic Plants | Which Are More Beneficial to the Ecosystem (video)"
    url="https://youtu.be/Af80dnhp2QY" >}}

{{< drg/next-page
    text="With your plant list and native/exotic status in hand, move on to Requirement 8c3, where you'll learn to use a dichotomous identification key and understand why scientific names are the universal language of botany."
    teaser="You'll identify 10 additional plants using a key—a systematic tool botanists use to work through characteristics step by step—and explain the difference between a common name and a scientific name."
