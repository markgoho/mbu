...
{{< drg/tip >}}
To make your drawing easier, pick a large, simple flower like a lily, tulip, or daffodil. Carefully pull the flower apart and lay the pieces on a sheet of paper in order: sepals, petals, stamens, pistil. Then draw what you see and label each part.
{{< /drg/tip >}}

{{< drg/image src="images/flowering-plant-parts-diagram.avif" alt="Dissected flowering plant with roots, stem, leaf, petals, sepals, stamens, pistil, fruit, and seeds clearly labeled" >}}

## Drawing Tips

{{< drg/checklist title="Drawing Checklist" subtitle="Make sure your drawing includes" >}}
...
{{< drg/video
    ...
    url="https://youtu.be/493WeySyf-8?si=u7d6_2RKO2h03wNo" >}}

{{< drg/video
    title="Flower Structures and Functions"
    url="https://youtu.be/GkzFimUJdD8" >}}
...
{{< drg/next-page
    text="You can identify the major parts of a flowering plant and explain their functions."
    teaser="Discover how plants turn sunlight into food — and why almost every living thing depends on that process."
