---
title: "Corn in the Field"
layout: "guide"
group_title: "8. Option A — Agronomy"
req_number: "8a5a"
req_path: "8.a.5.a"
prev: "/merit-badges/plant-science/guide/req8a5/"
prev_title: "Choose a Crop"
next: "/merit-badges/plant-science/guide/req8a5b/"
next_title: "Cotton"
---

{{< drg/requirement number="8a5a" >}}
Corn
{{< /drg/requirement >}}
...
{{< drg/inherited-requirement number="8a5a1" req_path="8.a.5.a.1" topic="Grow a plot of corn and have your plot inspected by your counselor. Record seed variety or experimental code number." />}}
...
{{< drg/checklist title="Corn Plot Basics" subtitle="Set yourself up for a better stand" >}}
...
{{< drg/video
    title="The Incredible Logistics Behind Corn Farming (video)"
    url="https://youtu.be/R9pxFgJwxFE" >}}

## Requirement 8a5a2

{{< drg/requirement number="8a5a2" >}}
...
{{< drg/video
    title="Different Types of Diseases in Corn (video)"
    url="https://youtu.be/lpIsRU63qIE" >}}

{{< drg/tip >}}
Even though the official video focuses on disease, it is still useful for seeing how crop-health problems show up in a real field. Be ready to explain the difference between insect damage and disease symptoms.
{{< /drg/tip >}}

{{< drg/next-page
    text="If you chose the corn track, make sure your notes and plot records are complete."
    teaser="The next crop-study option looks at cotton, from field production to fiber use."
