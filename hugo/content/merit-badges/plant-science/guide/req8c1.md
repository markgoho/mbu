...
{{< drg/inherited-requirement number="8c1a" req_path="8.c.1.a" topic="Determine which species of plants are the largest and which are the most abundant. Note whether they cast shade on other plants." />}}
...
{{< drg/external-link
    title="Environmental Factors Affecting Plant Growth (website)"
    url="https://extension.oregonstate.edu/gardening/techniques/environmental-factors-affecting-plant-growth"
    description="Oregon State Extension's overview of the key abiotic factors—light, temperature, water, soil, and more—that determine which plants succeed in a given location." >}}

## Requirement 8c1c

{{< drg/requirement number="8c1c" >}}
...
{{< drg/next-page
    text="With your natural area observations recorded, move on to Requirement 8c2, where you'll formally survey a study site and classify plants as native or exotic."
    teaser="You'll select a 100×100-foot plot, list 10 woody and 10 non-woody plants, and research which species belong to your region and which arrived from elsewhere."
