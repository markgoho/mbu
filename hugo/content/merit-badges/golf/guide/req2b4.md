...
{{< drg/video
    title="Health Benefits of Disc Golf (video)"
    url="https://youtu.be/SkZaOSeLMZw?si=SXifoCdgqPr_99RM" >}}

{{< drg/tip >}}
When you explain the health side to your counselor, do not stop at "it is exercise." Mention both the physical side of walking and throwing and the mental side of patience, focus, and staying calm.
{{< /drg/tip >}}

## Requirement 2b4b

{{< drg/requirement number="2b4b" >}}
...
{{< drg/video
    title="Disc Golf Exercise Plan (video)"
    url="https://youtu.be/Pe3rtET4RUs?si=Ys_Ni1kDwdws-Ra1" >}}

{{< drg/checklist title="How Exercise Helps Your Disc Golf Game" subtitle="Link the movement to the result" >}}
...
{{< drg/safety-first >}}
Warm up before throwing hard, especially in cool weather. Fast rotational movements with cold muscles can lead to strains in the shoulders, back, hips, or elbows.
{{< /drg/safety-first >}}

{{< drg/be-prepared title="You Want More Distance Fast" >}}
You are tempted to throw as hard as possible every practice session because you want longer drives.

- **Build movement quality first**: Smooth mechanics and balance matter more than muscling the disc.
- **Use drills, not just full-power throws**: Repetition with control builds better habits.
- **Add strength and mobility gradually**: Disc golf improvement comes from coordination as much as raw power.
- **Stop if something hurts sharply**: Pain is a sign to pause, not to force more throws.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="With the fitness basics in mind, move on to the actual throws, putting positions, and marking skills of disc golf."
    teaser="Learn the grips, runup, shots, putting mechanics, and mini-marker habits that counselors will expect you to demonstrate."
