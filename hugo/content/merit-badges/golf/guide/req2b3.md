---
title: "Disc Design & Disc Golf Leaders"
layout: guide
group_title: "2. Disc Golf Path"
req_number: "2b3"
prev: "/merit-badges/golf/guide/req2b2/"
prev_title: "Disc Golf History & Inclusion"
next: "/merit-badges/golf/guide/req2b4/"
next_title: "Fitness for Disc Golf"
---
...
{{< drg/video
    title="The History of Disc Golf (video)"
    url="https://youtu.be/U0sNVO5anuk?si=d_6UcMdJxIxfF98w" >}}

## Requirement 2b3a

{{< drg/requirement number="2b3a" >}}
...
{{< drg/did-you-know >}}
One invention can change an entire sport. In disc golf, better target design helped turn a loose pastime into a game that could be played and scored consistently from one course to another.
{{< /drg/did-you-know >}}

## Requirement 2b3c

{{< drg/requirement number="2b3c" >}}
...
{{< drg/image src="images/disc-golf-disc-types-grid.avif" alt="Illustrated grid comparing disc golf driver, midrange, and putter shapes from top and side views" >}}

{{< drg/checklist title="How Disc Design Changed" subtitle="Simple ways to explain the evolution" >}}
...
{{< drg/external-link
    title="Top Disc Golfers in the World (website)"
    url="https://www.pdga.com/world-rankings"
    description="Use the PDGA world rankings to find current top players and compare their standing in the sport." >}}

A good counselor discussion might include:
...
{{< drg/tip >}}
Try not to give a shallow answer like "they are really good." Name specific accomplishments such as championships, major wins, or consistent top rankings.
{{< /drg/tip >}}

{{< drg/be-prepared title="You Cannot Decide Which Player to Research" >}}
You are choosing between several well-known players and are not sure who gives you the best discussion with your counselor.

- **Pick a player with a clear record**: Championships and rankings are easier to explain than vague popularity.
- **Use official sources first**: Rankings and event results are stronger than rumors or fan opinions.
- **Choose someone you genuinely find interesting**: It is easier to talk about a player whose story grabs you.
- **Write down two or three accomplishments**: Specific facts make the conversation stronger.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="With the sport's history and equipment in mind, focus on what disc golf does for your body and mind."
    teaser="Learn how the game supports healthy living and how exercise can improve balance, power, and control."
