...
{{< drg/checklist title="Safe Golf Habits" subtitle="Use these habits every time you play" >}}
...
{{< drg/safety-first >}}
If you hear thunder, do not wait to see lightning again. Leave open fairways, ridges, isolated trees, and metal fencing immediately. Head to a substantial building or a fully enclosed vehicle and stay there until the storm has clearly passed.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/lightning-safety-shelter-decision.avif" alt="Comparison showing golfers moving to a substantial building or fully enclosed vehicle while unsafe lightning shelter choices like an isolated tree and open cart are crossed out" >}}
...
{{< drg/did-you-know >}}
A serious sunburn does more than hurt. It can raise your body temperature, speed up dehydration, and make heat illness more likely later in the day.
{{< /drg/did-you-know >}}
...
- **Check the injury**: Ask what happened, where it hurts, and whether the person can move the ankle.
- **Stop play**: Do not tell them to "walk it off" right away.
- **Use simple first aid**: Rest the ankle, cool it, and help the person avoid putting weight on it.
- **Get more help if needed**: If the ankle looks badly misshapen, pain is severe, or the person cannot stand, contact an adult and seek medical care.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
When you talk with your counselor, group the problems by type: weather hazards, overuse and friction injuries, environmental exposures, and movement injuries. That makes it easier to remember what first aid steps go with each one.
{{< /drg/tip >}}

## Official Resource

{{< drg/video
    title="First Aid on the Golf Course (video)"
    url="https://youtu.be/26c7909-iKg?si=ZUt8TQ5_jKrBFdJh" >}}
...
{{< drg/external-link
    ...
    description="A clear guide to checking the scene, getting help, and giving first aid for common emergencies." >}}
...
{{< drg/next-page
    text="Safety comes first. Next, choose which version of the badge matches your interests and access."
    teaser="Compare traditional golf and disc golf so you can pick your path with confidence."
