...
req_number: "2a3"
prev: "/merit-badges/golf/guide/req2a2/"
prev_title: "Req 2a2 — Understanding the Handicap System"
next: "/merit-badges/golf/guide/req2a4/"
next_title: "Req 2a4 — Fitness for Golf"
---
...
{{< drg/video
    title="History of Golf (video)"
    url="https://youtu.be/B8hKb4r0yh4?si=tVKbyMEubsrkD-Xx" >}}
...
{{< drg/video
    title="The Incomplete History of Golf in America (video)"
    url="https://youtu.be/dlGT57kHEQs?si=fTnLU-rMoGewBsX3" >}}
...
{{< drg/external-link
    title="LPGA Player Profiles (website)"
    url="https://www.lpga.com/athletes/directory"
    description="Browse official player profiles to research major wins, career highlights, and personal background for LPGA golfers." >}}

{{< drg/external-link
    title="PGA Player Profiles (website)"
    url="https://www.pgatour.com/players"
    description="Use the PGA Tour player directory to find statistics, achievements, and career summaries for top golfers." >}}

{{< drg/tip >}}
Pick a golfer whose story gives you something interesting to say. A strong choice might be someone who broke barriers, changed the sport's popularity, or became known for a special strength like putting, course strategy, or mental toughness.
{{< /drg/tip >}}

## Putting the History Together

Golf history is not just a list of dates. It explains why the game cares so much about honor, rules, records, and tradition. In [Req 2a1](/merit-badges/golf/guide/req2a1/), you studied rules and etiquette. This page shows where that culture came from.

{{< drg/did-you-know >}}
St Andrews is often called the "Home of Golf," and its Old Course is one of the most famous sporting venues in the world. Golfers still treat it almost like a living museum.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You have the history. Now turn to how golf affects the body and mind."
    teaser="Learn how golf supports a healthy lifestyle and how exercise can improve your game."
