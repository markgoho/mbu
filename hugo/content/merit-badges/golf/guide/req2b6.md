---
title: "Playing a Full Disc Golf Round"
layout: guide
group_title: "2. Disc Golf Path"
req_number: "2b6"
prev: "/merit-badges/golf/guide/req2b5/"
prev_title: "Disc Golf Skills"
next: "/merit-badges/golf/guide/req2b7/"
next_title: "Careers in Disc Golf"
---

{{< drg/requirement number="2b6" >}}
...
{{< drg/video
    title="Playing a Round of Disc Golf (video)"
    url="https://youtu.be/M4bcozlUX9g?si=X_Kwf7_PAcIjPgaq" >}}

{{< drg/checklist title="Round-Day Habits for Disc Golf" subtitle="What to remember before and during play" >}}
...
{{< drg/be-prepared title="Your Disc Kicks Toward a Picnic Area" >}}
A throw glances off a tree and heads toward people using the park.

- **Warn people immediately**: Use your voice right away.
- **Do not rush into the area**: Wait until it is safe and respectful to approach.
- **Acknowledge the interruption politely**: Shared-space courtesy matters.
- **Choose the safe next shot**: Do not force a risky throw just to save score.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
A calm player usually makes better choices. If a round starts going badly, slow your breathing, focus on one hole at a time, and keep your behavior steady.
{{< /drg/tip >}}

{{< drg/safety-first >}}
Never throw when people, animals, or other players could realistically be hit. Public park courses create surprises, and a safe delay is always better than a dangerous throw.
{{< /drg/safety-first >}}

This round should pull together what you learned in [Req 2b1](/merit-badges/golf/guide/req2b1/) about rules and courtesy and in [Req 2b5](/merit-badges/golf/guide/req2b5/) about technique. The final disc golf page looks beyond playing and asks where the sport can lead as a career.

{{< drg/next-page
    text="You have seen how disc golf works in actual play."
    teaser="Finish the disc golf path by exploring careers connected to the game."
