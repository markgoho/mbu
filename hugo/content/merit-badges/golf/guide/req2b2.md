---
title: "Disc Golf History & Inclusion"
layout: guide
group_title: "2. Disc Golf Path"
req_number: "2b2"
prev: "/merit-badges/golf/guide/req2b1/"
prev_title: "Rules, Courtesy & Scoring"
next: "/merit-badges/golf/guide/req2b3/"
next_title: "Disc Design & Disc Golf Leaders"
---
...
{{< drg/external-link
    title="PDGA Disc Golfer's Code (website)"
    url="https://www.pdga.com/files/disc-golfers-code-en-us_1.pdf"
    description="This short official guide shows how safety, respect, and course care help make disc golf welcoming to many kinds of players." >}}

{{< drg/checklist title="Signs a Sport Feels Inclusive" subtitle="What a new player notices on their first visit" >}}
...
{{< drg/tip >}}
When discussing inclusion with your counselor, give examples. Saying "disc golf is cheaper" is fine, but saying "a beginner can often start with one driver, one midrange, and one putter on a public course" is stronger.
{{< /drg/tip >}}

{{< drg/be-prepared title="You Bring a First-Time Player to the Course" >}}
A friend wants to try disc golf but is worried they will slow everyone down.

- **Pick an easier course or shorter tees**: Set them up for success.
- **Keep expectations simple**: Focus on safety, fun, and basic rules.
- **Model patience**: Show that learning the sport is welcome.
- **Celebrate improvement, not just score**: That is how many people stay with the game.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="Now move from the big picture to the people and equipment that shaped the game."
    teaser="Learn about Ed Headrick, the evolution of disc design, and the achievements of top players."
