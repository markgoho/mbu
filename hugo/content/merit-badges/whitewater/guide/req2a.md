...
Demonstrate understanding of the following river features by drawing lines to show the flow of water: upstream V, downstream V, riffle, eddy with an eddy line, ledge, river bend, shallows, current at different depths, drop, horizon line, and hydraulic.
{{< /drg/requirement >}}
...
{{< drg/image src="images/whitewater-river-features-diagram.avif" alt="Overhead river diagram labeled with upstream V, downstream V, riffle, eddy line, ledge, drop, horizon line, hydraulic, bend, and shallows" >}}

{{< drg/tip >}}
When drawing your flow lines, do not just label the features. Show how the current speeds up, bends, splits, curls, or slows. That is what turns a vocabulary test into real river reading.
{{< /drg/tip >}}

{{< drg/checklist title="How to sketch a rapid" subtitle="A simple order for drawing the current" >}}
...
In [Req 2b](/merit-badges/whitewater/guide/req2b/), you will zoom in on one of the river's most recognizable features: whitewater waves.

{{< drg/next-page
    text="Now that you can spot the river's major surface clues, look closer at how waves are created."
    teaser="Learn why some waves stay put, why others arrive in trains, and what that means for paddlers."
