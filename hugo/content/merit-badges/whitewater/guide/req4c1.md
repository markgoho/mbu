...
Demonstrate the following strokes: bow draw, rudder, and sculling draw.
{{< /drg/requirement >}}
...
{{< drg/checklist title="What makes these strokes effective" subtitle="Habits to build on calm water" >}}
...
{{< drg/tip >}}
Kayaks respond quickly, which is great when your stroke is clean and frustrating when it is sloppy. Slow practice with clear body mechanics usually beats hurried practice every time.
{{< /drg/tip >}}

{{< drg/next-page
    text="Direction control is only half the story. Now practice the support strokes that stop a kayak from going over."
    teaser="Build a reliable low brace and high brace before moving on to river classification and judgment."
