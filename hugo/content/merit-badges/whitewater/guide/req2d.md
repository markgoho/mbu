...
Explain when, why, and how you should scout a river while ashore, while on the river, and when you should portage your boat.
{{< /drg/requirement >}}
...
{{< drg/checklist title="What to look for while scouting" subtitle="Focus on these questions before making the run" >}}
...
{{< drg/safety-first >}}
If you are asking yourself whether the rapid is too risky, that is often your answer. Whitewater rewards honest judgment. Portaging early is far better than needing a rescue late.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="Your group reaches an unfamiliar drop" >}}
- **Catch an eddy early**: Do not drift up to the lip while debating.
- **Send one or two experienced paddlers to scout**: Everyone else waits in control.
- **Make a clear decision**: Run, set safety, or portage.
- **Commit as a group**: Confusion during the decision phase creates more risk than the rapid itself.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You can now judge when to stop, scout, or walk. Next, choose the craft that matches your training path."
    teaser="Decide whether you are completing Whitewater in a canoe or a kayak, and build from the right paddling base."
