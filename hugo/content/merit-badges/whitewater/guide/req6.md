...
{{< drg/safety-first >}}
The pamphlet gives one especially important reminder: never point directional paddle signals toward hazards. Only point where you want the next paddler to go.
{{< /drg/safety-first >}}

{{< drg/image src="images/universal-river-signals.avif" alt="Six-panel diagram showing the universal whitewater river signals with paddle and arm positions" >}}

{{< drg/checklist title="Good signal habits" subtitle="How to make sure the group actually understands you" >}}
...
{{< drg/be-prepared title="The lead paddler stops above a drop" >}}
- **Look upstream and downstream**: Figure out whether the signal is for you or for someone below.
- **Hold position if you can**: Catch an eddy instead of drifting into the problem.
- **Wait for the next clear instruction**: Stop often comes before run-left, run-right, or portage.
- **Pass the message along**: Groups stay safer when information moves fast. 
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="Communication keeps the group together. Next, look at how different whitewater boats are built for different jobs."
    teaser="Choose the canoe or kayak equipment page that matches your craft path and compare design, materials, and purpose."
