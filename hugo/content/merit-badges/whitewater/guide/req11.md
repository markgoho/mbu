...
{{< drg/inherited-requirement number="11a" req_path="11.a" topic="Self-rescue and procedures when capsized in moving water, including a wet exit if necessary" />}}
...
{{< drg/inherited-requirement number="11b" req_path="11.b" topic="Proper use of a throw rope to rescue a swimmer in whitewater" />}}
...
{{< drg/inherited-requirement number="11c" req_path="11.c" topic="Proper technique for receiving a throw rope as a swimmer" />}}
...
{{< drg/inherited-requirement number="11d" req_path="11.d" topic="Portaging-where portaging would be appropriate, and when and how to do it" />}}
...
Land in control above the hazard, organize gear, choose a safe walking route, and move as a team. This is the practical version of the judgment you already studied in [Req 2d](/merit-badges/whitewater/guide/req2d/).

## Requirement 11e

{{< drg/inherited-requirement number="11e" req_path="11.e" topic="The whitewater buddy system using at least three persons and three craft" />}}
...
{{< drg/image src="images/whitewater-throw-rope-rescue.avif" alt="Instructional rescue image showing a throw-rope rescue from shore to a swimmer in current" >}}

{{< drg/safety-first >}}
Never stand up in swift water above your knees, and never tie off a rescue rope to a swimmer. Both mistakes can turn a rescue into a trapping situation very quickly.
{{< /drg/safety-first >}}

{{< drg/checklist title="Rescue mindset" subtitle="A simple order for handling trouble on the river" >}}
...
{{< drg/next-page
    text="You now know how to prevent problems and how to react when they still happen."
    teaser="Plan an actual Class I or II trip, protect the gear, follow the safety systems, and reflect on how the plan worked."
