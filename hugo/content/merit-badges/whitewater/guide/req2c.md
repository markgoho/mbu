...
{{< drg/inherited-requirement number="2c1" req_path="2.c.1" topic="When entering and exiting an eddy." />}}
...
{{< drg/tip >}}
A good self-check is whether your nose stays roughly over the centerline of the boat. If your face is hanging out over the water, you are probably leaning your body instead of edging the hull.
{{< /drg/tip >}}

## Requirement 2c2

{{< drg/inherited-requirement number="2c2" req_path="2.c.2" topic="When ferrying in downstream and upstream directions." />}}
...
{{< drg/image src="images/eddy-turn-and-ferry-edge.avif" alt="Two-panel diagram showing correct boat edge for an eddy line crossing and a ferry" >}}

{{< drg/checklist title="Body position for edging" subtitle="What to remember when the water starts pushing back" >}}
...
If you want a clean eddy turn or ferry later in [Req 10](/merit-badges/whitewater/guide/req10/), this is one of the quiet fundamentals doing most of the work.

{{< drg/next-page
    text="You can now connect hull angle to current. The next step is deciding when not to run the rapid at all."
    teaser="Learn when to scout from shore, when to read on the fly, and when portaging is the smartest call."
