...
req_number: "5"
req_path: "5"
prev: "/merit-badges/whitewater/guide/req4c2/"
prev_title: "Req 4c2 — Bracing a Kayak"
next: "/merit-badges/whitewater/guide/req6/"
next_title: "Req 6 — River Signals That Matter"
---
...
{{< drg/checklist title="Questions that help classify a rapid" subtitle="Use these when talking through your approved river section" >}}
...
{{< drg/did-you-know >}}
The Whitewater pamphlet also notes a handy judgment rule: consider a river one class higher if the combined air and water temperature is under 120 degrees, or if the trip is on a remote river. That is a reminder that consequence matters as much as raw wave size.
{{< /drg/did-you-know >}}

{{< drg/tip >}}
When describing a river to your counselor, say both the class and the reasons: "I would call this Class II because the channels are clear, the waves are moderate, maneuvering is needed, and a swimmer still has a realistic self-rescue path."
{{< /drg/tip >}}

In the next requirement, you will study the signals paddlers use when talking is impossible over the noise of the river.

{{< drg/next-page
    text="Once you can judge the river, you need a way to communicate those judgments to the rest of the group."
    teaser="Learn the visual and whistle signals that tell paddlers to stop, run left, run right, ask for help, or come ahead."
