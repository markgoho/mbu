...
{{< drg/checklist title="How to explain a Class II line" subtitle="A simple structure for your counselor discussion" >}}
...
{{< drg/tip >}}
A strong river-reading explanation often sounds like coaching: "Start center, angle slightly right, ride the tongue past the first wave, avoid the rock pile on river left, then catch the eddy below if you need to regroup."
{{< /drg/tip >}}

{{< drg/be-prepared title="The first line you picked no longer looks best" >}}
- **Adjust early**: If you still have time to change, do it before you are committed.
- **Use the easier option**: There is no bonus for picking the flashiest route.
- **Communicate clearly**: Make sure the next paddler knows the updated plan.
- **Portage if necessary**: If neither line looks right for the group, do not force the run. 
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="Reading the line matters, but you still have to paddle the line."
    teaser="Practice launching, ferries, eddy turns, peel-outs, and other core maneuvers in moving water."
