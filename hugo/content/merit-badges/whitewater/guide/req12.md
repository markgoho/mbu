...
{{< drg/inherited-requirement number="12a" req_path="12.a" topic="Help to prepare a written plan, specifying the route (put-ins and takeouts), schedule, equipment, safety precautions, and emergency procedures." />}}
...
{{< drg/inherited-requirement number="12b" req_path="12.b" topic="Determine local rules and obtain permission from landowners and land managers in advance." />}}
...
{{< drg/checklist title="Trip debrief questions" subtitle="Good prompts for your discussion after the run" >}}
...
{{< drg/tip >}}
Counselors usually learn the most from your mistakes, provided you can explain them clearly and show how you would fix them next time.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have finished the badge path. Now look past the requirements and into the larger whitewater world."
    teaser="Explore deeper skills, river stewardship ideas, events, and organizations that can keep you paddling safely long after the badge is complete."
    url="/merit-badges/whitewater/guide/extended-learning/" >}}
