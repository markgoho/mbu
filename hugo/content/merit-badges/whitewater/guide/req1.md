...
If someone is being swept toward a strainer, the goal is to avoid going underneath. Swim aggressively and try to climb on top of the obstruction, not through it. In [Req 11](/merit-badges/whitewater/guide/req11/), you will build the rescue skills that support that response.
...
{{< drg/safety-first >}}
Never treat a lowhead dam like a small drop you can sneak over. They are often called "drowning machines" because the returning water can keep boats and swimmers trapped in place. If a lowhead dam is anywhere on your route, the correct plan is to identify it early and stay far away.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Hazard Scan Before You Launch" subtitle="Ask these questions before the first paddle stroke" >}}
...
- **Decide early**: If symptoms are worsening, coordinate evacuation instead of hoping the person simply warms up.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
You are not expected to become a wilderness doctor for this badge. You are expected to recognize trouble early, give appropriate first aid within your training, and know when the trip needs to stop so the person can get higher-level care.
{{< /drg/tip >}}
...
{{< drg/image src="images/whitewater-pfd-helmet-fit.avif" alt="Scout wearing a properly fitted whitewater helmet and life jacket with labeled fit points and whistle placement" >}}

{{< drg/did-you-know >}}
On a cold river, the first danger after an unexpected swim may be the gasp reflex from cold-water shock, not poor swimming skill. A life jacket helps protect you during those first critical seconds when breathing and judgment can both go sideways.
{{< /drg/did-you-know >}}

{{< drg/checklist title="What your counselor wants to hear" subtitle="Use these points when discussing Safety Afloat and river safety rules" >}}
...
The rest of this guide keeps building on these ideas. In [Req 2a](/merit-badges/whitewater/guide/req2a/), you will learn to recognize what the river surface is telling you before you commit to a line.

{{< drg/next-page
    text="You know the safety rules. Now it is time to learn the language of the river itself."
    teaser="Start identifying the surface features that reveal where current is fast, calm, deep, shallow, safe, or dangerous."
