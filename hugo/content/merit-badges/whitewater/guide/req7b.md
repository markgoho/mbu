...
{{< drg/checklist title="How kayaks differ" subtitle="Helpful talking points for your counselor discussion" >}}
...
{{< drg/tip >}}
When comparing kayak types, avoid saying one is simply "better." A creek boat may be better for one river and a playboat better for another. Match the design to the purpose.
{{< /drg/tip >}}

{{< drg/next-page
    text="Boat design is only half the equipment story. Next, look at what every safe whitewater outing requires people to carry."
    teaser="Review the personal and group gear that keeps a river trip organized, dry, and ready for emergencies."
