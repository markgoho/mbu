...
{{< drg/safety-first >}}
Do not begin building until your counselor has approved your design and building plan. If your prototype involves tools, electricity, sharp parts, heat, weight-bearing stress, or moving pieces, get adult supervision and use proper safety gear.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Prototype evaluation" subtitle="Look at each of these areas when you test" >}}
...
{{< drg/image src="images/prototype-evaluation-scorecard-visual.avif" alt="Visual scorecard showing the five prototype evaluation categories around a central prototype" >}}
...
{{< drg/tip >}}
Be specific when describing differences. Instead of saying "it did not work as expected," say something like "the handle angle made the tool harder to grip than I expected" or "the organizer held more gear, but it took too long to set up." Specific observations show real evaluation.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If the prototype fails during testing" >}}
That is not the end of the project. Write down what failed, why you think it failed, and what you would change next. Many first prototypes are really proof-of-concept builds, not final versions.
{{< /drg/be-prepared >}}
...
This requirement pulls together almost everything from [Req 5](/merit-badges/inventing/guide/req5/) and [Req 6](/merit-badges/inventing/guide/req6/): spotting problems, planning carefully, listening to users, and improving after critique.

{{< drg/external-link
    title="National Institute of Standards and Technology — STEM Resources"
    url="https://www.nist.gov/education/stem-resources"
    description="Resources about testing, measurement, and practical engineering thinking that can strengthen the way you evaluate a prototype." >}}

After building and testing your own invention, you will zoom back out and look at inventing in clubs, teams, and museums.

{{< drg/next-page
    text="You built a working prototype and evaluated how well it matched your original vision."
    teaser="Choose a real-world inventing experience through a team or a museum visit."
