...
{{< drg/checklist title="How to explain economic impact" subtitle="Use these points when talking with your counselor" >}}
...
{{< drg/did-you-know >}}
Between 1860 and 1900, the number of patents issued in the United States exploded as railroads, factories, telegraphs, and electrical systems spread across the country. Inventing was one of the engines of industrial growth.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
If you get stuck during your counselor discussion, use a simple sentence frame: "This invention helped the United States grow because it made ___ easier, which led to ___." That keeps your explanation focused.
{{< /drg/tip >}}

{{< drg/external-link
    title="United States Patent and Trademark Office — Kids' Pages"
    url="https://www.uspto.gov/kids"
    description="A beginner-friendly introduction to inventions, patents, and how inventors turn ideas into protected creations." >}}
...
{{< drg/be-prepared title="If your first three ideas feel too obvious" >}}
If you start with inventions like the wheel, the light bulb, and the airplane, ask one more question: what makes each one important?

- **Look for a specific effect**: not just "it helped transportation," but "it allowed long-distance travel and shipping at a much larger scale."
- **Think about ordinary life**: inventions that improve water, shelter, food, medicine, and communication often give you the strongest explanations.
- **Pick examples you can actually talk about**: a less famous invention you understand is better than a famous one you cannot explain.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    title="National Inventors Hall of Fame — Inventor Search"
    url="https://www.invent.org/inductees"
    description="Profiles of major inventors and their inventions that can help you find strong examples of inventions that changed daily life." >}}
...
{{< drg/next-page
    text="You now have a clear picture of what inventing is and why inventions matter."
    teaser="Choose whether to interview an inventor or research inventors through reading."
