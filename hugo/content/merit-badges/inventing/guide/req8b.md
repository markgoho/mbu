...
{{< drg/checklist title="Notes to gather during your visit" subtitle="These details will help you build a stronger presentation" >}}
...
{{< drg/image src="images/museum-presentation-story-flow.avif" alt="Diagram showing the five-step story flow for an invention presentation" >}}

{{< drg/tip >}}
If the museum allows photos, take a few that help explain the invention's key features. If photos are not allowed, make quick sketches or detailed notes while you are there.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Many museum exhibits show several versions of the same invention because the first version is rarely the best one. Improvement is one of the main themes of invention history.
{{< /drg/did-you-know >}}

This option connects back to [Req 1](/merit-badges/inventing/guide/req1/), where you looked at how inventions help humankind. A museum visit gives you concrete examples of that impact.

{{< drg/external-link
    title="Smithsonian Lemelson Center for the Study of Invention and Innovation"
    url="https://invention.si.edu/"
    description="Exhibits and resources focused on the history of inventors, inventions, and the people affected by them." >}}

Next, you will look ahead to the future by thinking about the skills, preparation, and careers connected to inventing.

{{< drg/next-page
    text="You know how to turn a museum visit into a clear presentation about invention and impact."
    teaser="Explore the skills inventors need and the careers that use inventive thinking every day."
