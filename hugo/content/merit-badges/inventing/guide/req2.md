...
req_number: "2"
prev: "/merit-badges/inventing/guide/req1/"
prev_title: "What Inventing Does"
next: "/merit-badges/inventing/guide/req2a/"
next_title: "Interview an Inventor"
---
...
- **[Req 2a — Interview an Inventor](/merit-badges/inventing/guide/req2a/)**: Talk directly with an adult who invented a useful item or process. You will hear real stories about problems, failures, revisions, and what it took to turn an idea into something useful.
- **[Req 2b — Study Inventors](/merit-badges/inventing/guide/req2b/)**: Read about three inventors, then choose one to report on. You will compare different inventing journeys and practice spotting the habits and decisions that led to success.

## How to Choose

{{< drg/checklist title="Choosing your option" subtitle="Think about access, time, and the kind of learning you want" >}}
...
{{< drg/tip >}}
If you already have an inventor in mind — maybe a local engineer, entrepreneur, designer, or maker — choose Req 2a. If you do not have a good contact yet, Req 2b is a smart and practical choice.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="National Inventors Hall of Fame — Meet the Inductees"
    url="https://www.invent.org/inductees"
    description="A large collection of inventor profiles that can help you research inventors or find inspiration for strong interview questions." >}}
...
{{< drg/next-page
    text="You know what each option involves and what each one teaches."
    teaser="See how to plan a useful inventor interview and ask questions that lead to great answers."
