...
{{< drg/checklist title="Product evaluation questions" subtitle="Use these to spot what needs improving" >}}
...
{{< drg/tip >}}
If you are stuck, focus on one of these improvement categories: easier to carry, easier to set up, easier to clean, safer to use, lighter to pack, or stronger in bad weather.
{{< /drg/tip >}}
...
{{< drg/image src="images/original-vs-improved-camping-product-sketch.avif" alt="Side-by-side sketch showing an original camping lantern and an improved version with a larger raised button" >}}

{{< drg/be-prepared title="If your first idea seems too complicated" >}}
Scale down. You do not have to redesign the entire tent or stove. Improving one handle, latch, attachment point, grip surface, drainage feature, or storage detail can still be a strong inventing exercise.
{{< /drg/be-prepared >}}

This requirement is excellent practice for [Req 6](/merit-badges/inventing/guide/req6/), where you will invent something of your own. Here, you are training your eyes to notice user needs and design weaknesses.

{{< drg/external-link
    title="Consumer Product Safety Commission — Recalls"
    url="https://www.cpsc.gov/Recalls"
    description="Examples of real consumer product problems and safety failures that show why product design details matter." >}}

Next, you will move from improving an existing product to inventing a new solution for a real need.

{{< drg/next-page
    text="You have practiced spotting weaknesses in real camping gear and proposing better designs."
    teaser="Now define a problem, listen to users, and plan an invention of your own."
