...
{{< drg/safety-first >}}
This requirement specifically says to get your parent or guardian's permission and your counselor's approval first. Follow that exactly. Meet in a safe setting, include an adult when needed, and use respectful communication if the interview happens by phone or video call.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Interview question ideas" subtitle="Pick the ones that fit your inventor" >}}
...
Those same ideas will show up again in [Req 3](/merit-badges/inventing/guide/req3/), [Req 6](/merit-badges/inventing/guide/req6/), and [Req 7](/merit-badges/inventing/guide/req7/).

{{< drg/tip >}}
Bring a notebook and ask if you may take notes during the interview. If the adult agrees, you can also ask whether you may record audio so you do not miss important details. Do not record without permission.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If the interview feels awkward at first" >}}
Start with an easy question like "What did you invent?" or "What problem were you trying to solve?" Once the person starts telling the story, follow up with questions like "What happened next?" and "Why did you change that part?"
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    title="National Inventors Hall of Fame — Camp Invention and Inventor Resources"
    url="https://www.invent.org/program-search/camp-invention"
    description="Examples of inventor-focused programs and resources that show how inventors identify problems and build solutions." >}}
...
{{< drg/next-page
    text="You know how to set up a strong inventor interview and what to listen for."
    teaser="See how to research three inventors and choose one to present clearly."
