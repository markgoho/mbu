...
{{< drg/safety-first >}}
If an invention could hurt people when used incorrectly, safety instructions, adult supervision, and proper testing matter just as much as the invention itself. A clever idea is not enough if it is unsafe in real life.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="How to talk about an unpatented invention" subtitle="Organize your discussion around impact" >}}
...
{{< drg/tip >}}
A strong example for the second half of this requirement is often a small-scale invention or improvement you have seen in real life. Counselors usually appreciate concrete examples more than vague ones.
{{< /drg/tip >}}

This requirement connects to [Req 9](/merit-badges/inventing/guide/req9/), where you will think about the character traits inventors need. Responsibility is one of them. Good inventors do not just make new things. They think about the effect those things will have on real people.

{{< drg/external-link
    title="Smithsonian Lemelson Center for the Study of Invention and Innovation"
    url="https://invention.si.edu/"
    description="Stories and resources about inventors, innovation, and how inventions influence society in both large and small ways." >}}
...
{{< drg/next-page
    text="You have thought through how inventions should be shared and why impact matters."
    teaser="Choose a camping product, spot its weaknesses, and sketch a better version."
