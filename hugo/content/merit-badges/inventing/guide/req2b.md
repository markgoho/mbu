...
{{< drg/checklist title="Research notes to gather" subtitle="These details will make your counselor report stronger" >}}
...
{{< drg/did-you-know >}}
Many famous inventors are remembered for one breakthrough, but their real success often came from dozens or even hundreds of experiments, revisions, and partial failures that happened first.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
If two inventors seem equally interesting, choose the one whose problem-solving process you understand best. Clear explanation matters more than choosing the most famous name.
{{< /drg/tip >}}

You can use what you learn here again in [Req 6](/merit-badges/inventing/guide/req6/). When you create your own invention, you will start seeing some of the same patterns the inventors you researched used: noticing needs, sketching ideas, testing, and revising.

{{< drg/external-link
    title="National Inventors Hall of Fame — Inductee Profiles"
    url="https://www.invent.org/inductees"
    description="Reliable profiles of inventors from many fields, useful for comparing inventions, obstacles, and real-world impact." >}}

Next, you will turn from inventors themselves to the rules that protect inventions and ideas.

{{< drg/next-page
    text="You know how to research inventors and report what makes one inventor especially interesting."
    teaser="Learn how patents and intellectual property protect ideas and why those protections matter."
