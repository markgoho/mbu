...
{{< drg/checklist title="Core inventor skills" subtitle="These skills matter in many inventing careers" >}}
...
You have already practiced many of these in this badge. In [Req 2](/merit-badges/inventing/guide/req2/), you learned from inventors. In [Req 6](/merit-badges/inventing/guide/req6/) and [Req 7](/merit-badges/inventing/guide/req7/), you went through the real inventing cycle yourself.
...
{{< drg/tip >}}
One of the best ways to become more inventive is to start keeping an "idea list." Every time something at home, school, or camp is awkward, slow, wasteful, or annoying, write it down. Problems are raw material for inventors.
{{< /drg/tip >}}

{{< drg/video
    title="What to do FIRST With Your Invention Idea — Patents Demystified"
    url="https://www.youtube.com/watch?v=9F-GXB-XAIs" >}}
...
{{< drg/be-prepared title="If you are not sure what careers to discuss" >}}
Choose careers connected to problems you actually care about. If you enjoy camping, outdoor gear design could be a strong example. If you like coding, software development or robotics may fit better. Your discussion will be stronger if the fields feel real to you.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Bureau of Labor Statistics — Occupational Outlook Handbook"
    url="https://www.bls.gov/ooh/"
    description="Reliable career information you can use to explore jobs that depend on design, engineering, creativity, and problem-solving." >}}
...
{{< drg/next-page
    text="You understand the skills, preparation, and career paths that support inventive thinking."
    teaser="Go beyond the badge with deeper inventing ideas, experiences, and organizations to explore next."
    url="/merit-badges/inventing/guide/extended-learning/" >}}
