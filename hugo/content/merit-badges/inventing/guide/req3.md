...
{{< drg/tip >}}
A quick way to remember the difference is this: patents protect inventions, trademarks protect brands, copyrights protect creative expression, and trade secrets protect confidential know-how.
{{< /drg/tip >}}

{{< drg/external-link
    title="USPTO — What Is Intellectual Property?"
    url="https://www.uspto.gov/ip-policy"
    description="A clear introduction to patents, trademarks, and the purpose of intellectual property protection in the United States." >}}
...
{{< drg/image src="images/patent-document-components-diagram.avif" alt="Diagram showing the main components of a patent document in order" >}}
...
{{< drg/did-you-know >}}
A design patent can protect the look of a product even when the product's basic function is not new. That means appearance alone can sometimes be worth protecting.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="USPTO — Patents Basics"
    url="https://www.uspto.gov/patents/basics"
    description="An overview of what patents are, what they contain, and the main types recognized by the USPTO." >}}
...
{{< drg/checklist title="Patent comparison checklist" subtitle="Notice how the real product matches the patent document" >}}
...
{{< drg/be-prepared title="If you cannot find a patent number easily" >}}
Check several parts of the item: the base, inside surfaces, small molded text, instruction labels, or the original packaging. Some products say "patent pending" or list a website instead of printing the full number clearly.
{{< /drg/be-prepared >}}

This requirement connects directly to [Req 5](/merit-badges/inventing/guide/req5/). When you evaluate a camping product later, you will start seeing how much thought goes into even small design choices.

{{< drg/external-link
    title="Google Patents"
    url="https://patents.google.com/"
    description="A searchable patent database that makes it easier to read patent drawings, claims, and background information for real products." >}}
...
{{< drg/tip >}}
When explaining infringement to your counselor, say it in simple words: "Patent infringement means using or selling someone else's patented invention without permission when what you made falls inside the patent's protected claims." That is accurate and easy to understand.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You now know what intellectual property is and how patents protect inventions."
    teaser="Think about which inventions should be shared broadly and why some unpatented ideas still change society."
