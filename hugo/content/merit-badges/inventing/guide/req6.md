...
{{< drg/checklist title="User interview starter questions" subtitle="Ask these before you finalize your design" >}}
...
{{< drg/image src="images/labeled-invention-sketch-example.avif" alt="Labeled sketch example of a simple invention showing major parts and callouts" >}}

{{< drg/tip >}}
If your sketch feels weak, imagine a builder who has never met you. Could that person look at your drawing and understand what the invention is supposed to do? If not, add labels and arrows.
{{< /drg/tip >}}

{{< drg/video
    title="Little Inventors: How to think up invention ideas! — Little Inventors"
    url="https://www.youtube.com/watch?v=ERFgorcRCJY" >}}
...
{{< drg/image src="images/cardboard-model-to-prototype-materials-comparison.avif" alt="Comparison between a rough cardboard model and the real materials needed for a prototype" >}}
...
{{< drg/safety-first >}}
Choose prototype materials that match your skill level and available supervision. If the build would require power tools, wiring, heat, or load-bearing parts, make sure an adult approves the plan and helps where needed.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Useful feedback prompts" subtitle="Ask for comments that help you improve the invention" >}}
...
Record feedback in a notebook as clearly as you can. Separate comments into categories such as function, comfort, safety, durability, and appearance. That will help you later in [Req 7](/merit-badges/inventing/guide/req7/) when you build and evaluate the prototype.

{{< drg/be-prepared title="If feedback hurts your feelings" >}}
Pause before defending your idea. Ask one more question instead: "Can you show me what you mean?" Real inventors improve faster when they treat criticism as information.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="MIT Lemelson — Inventing Resources"
    url="https://lemelson.mit.edu/"
    description="Resources and stories focused on the real process of invention, including user needs, prototypes, and iteration." >}}
...
{{< drg/next-page
    text="You have planned your invention by listening to users, modeling the idea, and gathering feedback."
    teaser="Build the working prototype, test it, and compare it with your original vision."
