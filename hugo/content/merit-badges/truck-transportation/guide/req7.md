...
{{< drg/checklist title="How to explain each truck type" subtitle="Use the same pattern each time" >}}
- Name the truck type.
...
{{< drg/video
    title="Different Types of Trucks and Their Uses"
    url="https://youtu.be/wMil4tzaOcU" >}}

{{< drg/tip >}}
If you have trouble picking five types, think by cargo first: dry freight, liquids, refrigerated goods, oversized materials, or local delivery loads. Then match each cargo type to the truck built for it.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You can now match different truck types to the jobs they are built to do."
    teaser="Next, plan a 500-pound shipment and think through preparation, carrier comparison, and insurance."
