...
{{< drg/image src="images/bill-of-lading-labeled-example.avif" alt="Clean sample bill of lading layout with major fields visually highlighted such as shipper, consignee, destination, weight, freight charges, and driver receipt copy" >}}
...
{{< drg/checklist title="A simple way to remember the terms" subtitle="Group them by what they describe" >}}
...
{{< drg/video
    title="Decoding Freight Abbreviations, Acronyms and Initialisms"
    url="https://youtu.be/0H0Q0VNLMu4?si=91WiYyuzDzCTWV2r" >}}

{{< drg/video
    title="What's That? Bill of Lading (BOL)"
    url="https://youtu.be/cSp3ryfdyFM?si=rPSekMOLuDdcueKb" >}}

{{< drg/video
    title="What's That? Intermodal & Multimodal"
    url="https://youtu.be/GSWxDr6mt8c?si=b1VrZKtrLyYmUMLm" >}}

{{< drg/video
    title="What's That? Container vs. Trailer"
    url="https://youtu.be/UlstPHRwhA8?si=DJa8Oa9evpW0wc7B" >}}

{{< drg/tip >}}
The easiest way to explain these terms to your counselor is to use them in one short shipping story. For example: "The shipper gave the carrier a bill of lading, the container moved intermodally, and the consignee tracked the ETA." Using the words in context proves that you understand them.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You can now explain the vocabulary used in freight movement and shipping paperwork."
    teaser="Next, explore trucking-related careers and research one in depth."
