...
{{< drg/checklist title="Advantages of diesel engines" subtitle="Why many larger trucks use diesel power" >}}
...
{{< drg/checklist title="Advantages of gasoline engines" subtitle="Why some trucks still use gas engines" >}}
...
{{< drg/tip >}}
When your counselor asks for differences, do not stop at "diesel is stronger." Explain that diesel usually gives more torque and better fuel economy for heavy work, while gasoline can be cheaper and more practical for lighter-duty service.
{{< /drg/tip >}}

{{< drg/video
    title="Diesel vs. Gasoline Engines: Key Differences Explained"
    url="https://youtu.be/3G9x6U3VkwQ" >}}
...
{{< drg/next-page
    text="You have compared the two main engine types used in trucks."
    teaser="Next, step inside a truck terminal and learn how operations and safety work together."
