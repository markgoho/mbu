...
{{< drg/did-you-know >}}
Many products you see in one store may have ridden on several different trucks before you buy them: one from the factory, one to a distribution center, and one more for the final delivery to the store.
{{< /drg/did-you-know >}}

{{< drg/video
    title="10 Advantages of Road Transport"
    url="https://youtu.be/j4EfFO-MAoY" >}}
...
{{< drg/checklist title="Where trucks fit in the supply chain" subtitle="Look for these roles when explaining your answer" >}}
...
{{< drg/video
    title="Transportation & Logistics Industry Overview - Introduction"
    url="https://youtu.be/kMm-13EdnqA" >}}

{{< drg/video
    title="How Does Trucking Fit Into the Supply Chain?"
    url="https://youtu.be/6ScpuV1aStM" >}}

{{< drg/external-link
    title="The Vital Role of Trucks in Transporting Goods: A Comprehensive Overview"
    url="https://considerblog.com/transportation/the-vital-role-of-trucks-in-transporting-goods-a-comprehensive-overview.html"
    description="Use this overview to compare how trucking supports manufacturers, wholesalers, retailers, and other parts of the supply chain." >}}
...
1. **Factory overseas** — Goods are manufactured and packaged.
2. **Origin port or inland transfer point** — The shipment is loaded into a container.
3. **Ocean voyage** — The container travels by ship to the United States.
4. **U.S. port** — The shipment is unloaded, inspected if needed, and released.
5. **Drayage or rail movement** — A truck or rail service moves the container inland.
6. **Warehouse or distribution center** — Goods are sorted, stored, or repacked.
7. **Retail delivery** — A truck takes the freight to the store.
8. **Store shelf** — The product is stocked for customers.

{{< drg/tip >}}
Draw arrows between each stage and label what changes at that point. For example, note when the freight changes from ship to truck, when it enters a warehouse, or when it becomes a local store delivery.
{{< /drg/tip >}}

{{< drg/be-prepared title="A simple overseas freight example" >}}
Imagine a store in your town ordering backpacks made in another country.

- The backpacks are packed at the factory.
- A truck takes them to an ocean port.
- A container ship carries them to a U.S. port.
- A drayage truck moves the container to a rail yard or nearby warehouse.
- Rail or long-haul trucking moves the freight closer to your region.
- A regional warehouse sorts the order.
- A local truck delivers the backpacks to the retailer.
{{< /drg/be-prepared >}}

{{< drg/video
    title="Global Supply Chain Management Explained: Key Players, Risks & Incoterms"
    url="https://youtu.be/fdg9nhmZuJw" >}}
...
{{< drg/next-page
    text="You now understand how trucks support commerce and move freight through the supply chain."
    teaser="Next, compare gasoline and diesel engines and the advantages of each."
