...
{{< drg/safety-first >}}
Large trucks need more space to turn, stop, and change lanes than passenger cars. Never cut in close in front of a truck, linger beside the trailer, or assume the driver can see you in every mirror. Safety around trucks starts with giving them room.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
A truck can carry enough groceries in one trip to restock an entire supermarket department. That is one reason short delays in trucking can quickly show up as empty shelves.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/intermodal-freight-flow.avif" alt="Simple step-by-step intermodal freight diagram showing an ocean container moving from factory to port, ship, rail yard, truck chassis, warehouse, and retail store" >}}

{{< drg/tip >}}
As you work on this badge, keep a simple notebook of trucks you notice in daily life: package vans, tanker trucks, flatbeds, dump trucks, and tractor-trailers. Those real examples will make later requirements much easier to understand.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have the big picture of how trucking fits into daily life and commerce."
    teaser="Start local by finding the major truck lines that serve your town."
    url="/merit-badges/truck-transportation/guide/req1/" >}}
