...
{{< drg/checklist title="Career research checklist" subtitle="Cover each of these in your notes" >}}
...
{{< drg/tip >}}
The best career report includes both facts and reflection. After you gather the information, explain what sounds interesting to you: travel, teamwork, technology, mechanical work, leadership, or problem-solving.
{{< /drg/tip >}}

{{< drg/video
    title="What Career Opportunities are in Trucking? A LOT!"
    url="https://youtu.be/TJGXJwNyw8U?si=y5Qr4fDUORdf3lZY" >}}

{{< drg/video
    title="What Life Is Like for a Trucker on the Road | NewsNation"
    url="https://youtu.be/CiAbSIXwMSs?si=YT7HzX_P99DskdIn" >}}

{{< drg/video
    title="How to Become a Truck Dispatcher in 5 Steps? - Beginner Training"
    url="https://youtu.be/hbJqSgcQWj8?si=pwS-oHaKebXXdijD" >}}

{{< drg/video
    title="Logistics Coordinator Job Description"
    url="https://youtu.be/MbmX3ZAjHbw?si=ddep_jZOj9FLgQEC" >}}

{{< drg/video
    title="5 Must Have Skills to earn $10,000 a month as a Truck Dispatcher"
    url="https://youtu.be/zVZ3RASiXoA?si=FhUizvScSxHerKZy" >}}

{{< drg/be-prepared title="Three good ways to gather career information" >}}
- Interview a professional and ask what a normal day is really like.
- Compare two or three sources so you do not rely on one opinion.
- Write down what you would enjoy and what might be challenging in that job.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have explored careers in truck transportation and researched what it takes to enter one."
    teaser="Continue into Extended Learning for more ways to explore the freight world beyond the badge."
