...
{{< drg/checklist title="Finding truck lines" subtitle="Use more than one source so your list is based on evidence" >}}
...
{{< drg/tip >}}
If your town is small, it is fine to include carriers that serve your community from a nearby city terminal. What matters is that the company regularly serves your area, not that its main office sits inside your town limits.
{{< /drg/tip >}}

## Official Resource

{{< drg/external-link
    title="Search Trucking Companies - Find Carriers By City And State"
    url="https://www.quicktransportsolutions.com/quickfreight/loadboard/carrier-searchby-citystate.php"
    description="Search carriers by city and state to identify trucking companies that operate near your town and compare the kinds of service they provide." >}}
...
{{< drg/be-prepared title="If you cannot tell what a truck line does" >}}
Use clues from the truck and where you saw it.

- **Trailer type:** A tanker, flatbed, refrigerated trailer, or parcel van gives you hints.
- **Where you saw it:** Near a grocery warehouse, fuel terminal, rail yard, or home-improvement store.
- **Company website or directory listing:** Look for words such as LTL, dedicated, refrigerated, tanker, construction, or logistics.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have identified the truck lines that connect your community to the freight system."
    teaser="Next, learn how trucks move goods, information, and money through commerce."
