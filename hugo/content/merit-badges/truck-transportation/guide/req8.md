...
{{< drg/image src="images/palletized-freight-prep-diagram.avif" alt="Labeled diagram of a properly prepared palletized shipment showing stacked cartons, corner protection, shrink wrap, pallet base, shipping label, and measurement points for length width, height, and weight" >}}

{{< drg/checklist title="Shipment preparation checklist" subtitle="What to get right before pickup" >}}
...
{{< drg/video
    title="How to Prepare Freight for Shipping to Avoid Damages"
    url="https://youtu.be/xZqB2-jTows?si=AtPDbOqNDr8aWCLi" >}}

{{< drg/video
    title="How To Ship A Pallet: Preparing A Palletized LTL Freight Shipment Warehousing Tutorial"
    url="https://youtu.be/UEaNCBHQVZc?si=UrYkr7yNQgw-6Te3" >}}

{{< drg/video
    title="How to Package Freight for Shipping"
    url="https://youtu.be/478XjiLWg80?si=nplGRI0kARBcrtE9" >}}
...
{{< drg/video
    title="Mastering Load Board Bookings: A Step-by-Step Guide to Efficient Load Booking"
    url="https://youtu.be/CGhqH0849cs" >}}

{{< drg/video
    title="Truck Dispatcher and Broker Call Simulation - Negotiation Scenario #1"
    url="https://youtu.be/-yppE9CJ2Yk" >}}
...
{{< drg/tip >}}
Use a sentence like this in your write-up: "I would choose Carrier B because it can deliver within the required three-day window, offers better tracking, and provides a reasonable rate for class 65 freight." That shows judgment, not just preference.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="Understanding Freight Shipping Insurance: A Comprehensive Guide"
    url="https://www.flockfreight.com/blog/understanding-freight-shipping-insurance-a-comprehensive-guide?utm_source=chatgpt.com"
    description="Use this guide to understand the difference between basic carrier liability and added freight insurance protection." >}}

{{< drg/be-prepared title="What paperwork matters most" >}}
If freight is lost or damaged, the bill of lading and your shipment records become very important.

- Keep the bill of lading.
- Record what was shipped and how it was packed.
- Save weight and dimension details.
- Take photos before pickup if the shipment is valuable or fragile.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have planned how to prepare, compare, choose, and insure a shipment."
    teaser="Next, learn the trucking terms that appear in freight paperwork and daily operations."
