...
{{< drg/safety-first >}}
Small boats can capsize. That is part of why they are useful teaching craft. Treat capsizes as serious training events under supervision, not as horseplay.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
A sailboat can move upwind even though the wind is coming from ahead at an angle. That is one of the coolest ideas in sailing: the boat is not simply pushed like a leaf. The sails and hull work together to create controlled motion.
{{< /drg/did-you-know >}}

Before you take the helm, you need the safety mindset that supports every skill in the badge.

{{< drg/next-page
    text="Start by learning the hazards, injuries, and Safety Afloat habits that shape every safe sailing trip."
    teaser="Next, build the safety foundation that makes the rest of the badge possible."
    url="/merit-badges/small-boat-sailing/guide/req1/" >}}