...
req_number: "5"
req_path: "5"
prev: "/merit-badges/small-boat-sailing/guide/req4/"
prev_title: "Req 4 — Planning, Weather & Gear"
next: "/merit-badges/small-boat-sailing/guide/req6/"
next_title: "Req 6 — Sailing Skills Underway"
---
...
{{< drg/did-you-know >}}
Two boats only a short distance apart can feel different wind because shorelines, hills, docks, and buildings bend airflow. That is why good sailors keep checking instead of trusting one glance from shore.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Pre-Launch Wind Check" subtitle="A fast routine before you leave shore" >}}
...
{{< drg/image src="images/lake-wind-indicators-guide.avif" alt="Shoreline scene showing flags, ripples, tree movement, and telltales as clues to wind direction before sailing" >}}

{{< drg/tip >}}
When talking with your counselor, point to more than one indicator. A good sailor confirms wind direction with several clues instead of depending on a single flag or guess.
{{< /drg/tip >}}

{{< drg/video
    title="Video tip: Wind direction — American Sailing"
    url="https://www.youtube.com/watch?v=5B1YdpLkYFE" >}}

{{< drg/external-link
    title="National Weather Service"
    url="https://www.weather.gov/"
    description="Useful for checking local forecasts and understanding how changing weather may affect wind before you sail." >}}

Once you can read the wind from shore, you are ready to connect that information to real boat-handling skills underway.

{{< drg/next-page
    text="You can identify wind direction and explain why that matters before launch."
    teaser="Next, use that knowledge while preparing, launching, maneuvering, and recovering a sailboat underway."
