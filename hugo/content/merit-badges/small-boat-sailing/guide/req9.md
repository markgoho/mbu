...
{{< drg/checklist title="How to Explain the Points of Sail" subtitle="A simple structure for your counselor discussion" >}}
...
{{< drg/image src="images/points-of-sail-small-boat-sailing.avif" alt="Top-down diagram of a sailboat showing beating, close reach, beam reach, broad reach, and running relative to wind direction" >}}
...
{{< drg/video
    title="What's the Best Sailboats for Beginners? — Practical Sailor"
    url="https://www.youtube.com/watch?v=wy13QKapiq4" >}}

{{< drg/did-you-know >}}
The same wind can feel very different from one sailboat to another. Hull shape, keel or centerboard design, sail plan, and total weight all change how quickly a boat accelerates, turns, and reacts to gusts.
{{< /drg/did-you-know >}}

{{< drg/tip >}}
When comparing sailboats with your counselor, talk about tradeoffs. A lighter boat may be more responsive, while a heavier keelboat may feel steadier. A one-sail rig may be simpler, while a sloop gives more sail-control options.
{{< /drg/tip >}}

{{< drg/external-link
    title="U.S. Coast Guard Navigation Center"
    url="https://www.navcen.uscg.gov/navigation-rules-amalgamated"
    description="Helpful for understanding the shared navigation language and collision-avoidance mindset that support sailing discussions." >}}
...
{{< drg/next-page
    text="You can now talk about sailboats with the vocabulary and concepts sailors actually use."
    teaser="Next, go beyond the badge with deeper sailing paths, experiences, and organizations to explore."
