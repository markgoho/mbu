...
{{< drg/safety-first >}}
The boom is one of the easiest parts of the boat to underestimate. During a sudden jibe it can swing hard and fast enough to injure someone who is not paying attention.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Explain the Boat by Function" subtitle="A clean way to organize your answer" >}}
...
{{< drg/image src="images/small-boat-sailing-parts-labeled.avif" alt="Labeled training sailboat showing hull, bow, stern, mast, boom, mainsail, jib, rudder, tiller, mainsheet, and centerboard" >}}
...
{{< drg/tip >}}
Walk around the boat on land before your session. Touch each major part and say its name out loud. That makes the vocabulary much easier to remember once you are on the water.
{{< /drg/tip >}}

{{< drg/external-link
    title="U.S. Coast Guard Boating Safety"
    url="https://www.uscgboating.org/"
    description="Reliable boating-safety background that helps you connect boat parts with safe operation on the water." >}}

Once you know the boat, the next step is planning the trip around safety, weather, and gear before you launch.

{{< drg/next-page
    text="You can name the boat's major parts and explain what each one does."
    teaser="Next, plan for weather, rules, float plans, and clothing before you head afloat."
