...
{{< drg/checklist title="Year-Round Boat Care Mindset" subtitle="What responsible sailors keep doing" >}}
...
{{< drg/tip >}}
A good maintenance description does not sound fancy. It sounds specific: “I would rinse the boat, inspect the rigging for wear, dry the sails, store the lines properly, and cover the boat so water cannot collect.”
{{< /drg/tip >}}

{{< drg/be-prepared title="You find a small problem during cleanup" >}}
- **Do not ignore it because the day is over.** Small failures grow.
- **Tag or note the issue** so the next crew does not miss it.
- **Take unsafe gear out of service** until it is repaired.
- **Tell the adult leader or boat manager** what you found.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="BoatUS Foundation for Boating Safety and Clean Water"
    url="https://www.boatus.org/foundation/"
    description="Boating education resources that support safe equipment habits and routine care." >}}

With boat care covered, finish the guide by sharpening your sailing vocabulary and comparing different kinds of sailboats.

{{< drg/next-page
    text="You know how year-round care keeps a sailboat safe, reliable, and ready to use."
    teaser="Next, review the sailing terms, points of sail, and boat types that tie the badge together."
