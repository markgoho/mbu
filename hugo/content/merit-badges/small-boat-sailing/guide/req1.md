...
req_number: "1"
req_path: "1"
prev: "/merit-badges/small-boat-sailing/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/small-boat-sailing/guide/req2/"
...
{{< drg/checklist title="Hazard Thinking for Sailors" subtitle="The verbs in the requirement matter" >}}
...
{{< drg/safety-first >}}
The most dangerous moment in beginner sailing is often the moment right before someone says, “I think we can still handle this.” If weather, wind, or traffic are building faster than your skill, get off the water early.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="A gust hits while you are turning" >}}
- **Stay low and balanced.** Sudden movement can make the boat less stable.
- **Ease the sails if needed.** Too much power is the problem.
- **Keep talking.** Let your buddy know what is happening.
- **Choose control over pride.** Slow down, reset, or head back in if conditions keep building.
{{< /drg/be-prepared >}}

## Requirement 1b

{{< drg/inherited-requirement number="1b" req_path="1.b" topic="Review prevention, symptoms, and first-aid treatment for the following injuries or illnesses that can occur while sailing: blisters, cold-water shock and hypothermia, dehydration, heat-related illnesses, sunburn, sprains, and strains." />}}
...
{{< drg/tip >}}
A sailor who is getting quiet, clumsy, or slow to answer may not just be “tired.” On the water, those can be early signs that cold, heat, dehydration, or stress is taking over.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    description="Trusted first-aid guidance for common injuries and illnesses, including when to get more advanced care." >}}
...
{{< drg/checklist title="Explain Safety Afloat Like a Sailor" subtitle="Turn policy into on-the-water examples" >}}
...
{{< drg/image src="images/safety-afloat-small-boat-sailing-grid.avif" alt="Nine-panel visual guide showing each Safety Afloat point in a small-boat sailing context" >}}

{{< drg/external-link
    title="Scouting America Safety Afloat"
    url="https://www.scouting.org/health-and-safety/safety-afloat/"
    description="Read the full Safety Afloat policy used for all Scouting boating activities." >}}
...
{{< drg/next-page
    text="You understand the hazards, common health problems, and Safety Afloat habits behind every safe sailing trip."
    teaser="Next, focus on the swimmer test that clears you for the badge's on-the-water skills."
