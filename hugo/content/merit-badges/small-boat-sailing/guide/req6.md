...
{{< drg/checklist title="Pre-Sail Boat Check" subtitle="What to inspect before launch" >}}
...
{{< drg/inherited-requirement number="6b" req_path="6.b" topic="Get underway from a dock, mooring, or beach." />}}
...
{{< drg/tip >}}
A messy launch usually leads to a messy first minute under sail. Talk through who does what before the boat moves.
{{< /drg/tip >}}

## Requirement 6c

{{< drg/inherited-requirement number="6c" req_path="6.c" topic="Properly set sails for a round-trip course approved by your counselor that will include running, beating, and reaching-the basic points of sail. While sailing, demonstrate good helmsmanship skills." />}}
...
{{< drg/be-prepared title="The boat starts feeling overpowered on the course" >}}
- **Ease sail power if appropriate** instead of fighting the boat.
- **Flatten the boat with crew position** when trained to do so.
- **Steer smoothly** and avoid sudden, panicked movements.
- **Choose control first** and shorten the drill if conditions exceed the crew's skill.
{{< /drg/be-prepared >}}

## Requirement 6d

{{< drg/inherited-requirement number="6d" req_path="6.d" topic="Change direction by tacking; change direction by jibing." />}}
...
{{< drg/safety-first >}}
Jibes deserve respect. The crew should know the maneuver is coming, stay low, and keep clear of the boom as it crosses.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
If your first reaction in irons is to move faster and pull harder on everything, the boat usually stays stuck longer. Think angle and airflow, not panic.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Do not practice capsize recovery casually. This requirement specifically calls for close counselor supervision and standby rescue support because cold water, tangled gear, and hull movement can injure people quickly.
{{< /drg/safety-first >}}
...
{{< drg/inherited-requirement number="6i" req_path="6.i" topic="Accept a single line or side tow and maneuver the craft being towed safely for 20 boat lengths." />}}
...
{{< drg/inherited-requirement number="6j" req_path="6.j" topic="Upon returning to the dock, mooring, or beach, properly secure all equipment, furl or stow sails, and prepare the craft for unattended docking or beaching overnight or longer." />}}
...
{{< drg/checklist title="What This Requirement Really Tests" subtitle="More than boat handling alone" >}}
...
{{< drg/image src="images/small-boat-sailing-underway-sequence.avif" alt="Multi-panel sequence showing pre-sail check, launch, tack, jibe, safety position, capsize recovery, and end-of-day securing steps" >}}

Once you can handle the boat underway, the next skill set is the ropework and line knowledge sailors use constantly.

{{< drg/next-page
    text="You have worked through the full rhythm of getting a small sailboat underway, handling it, recovering from problems, and securing it afterward."
    teaser="Next, build the knot and line-handling skills that support real seamanship."
