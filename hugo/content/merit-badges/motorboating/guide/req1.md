...
{{< drg/checklist title="Hazard Response Habits" subtitle="What smart boaters do before trouble grows" >}}
...
{{< drg/be-prepared title="Someone Falls Overboard" >}}
A passenger slips while the boat is slowing for a dock.

- **Shout and point.** Keep eyes on the person in the water.
- **Cut power immediately.** Do not let the propeller remain a threat.
- **Throw flotation if needed.** Even if the person is wearing a life jacket, extra buoyancy helps.
- **Approach carefully from downwind or down-current if conditions allow.** Keep the person away from the prop area.
- **Get help early.** A cold, injured, or panicked person can get into real trouble fast.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="U.S. Coast Guard Boating Safety"
    url="https://www.uscgboating.org/"
    description="Official boating safety guidance on life jackets, required equipment, accident prevention, and operator responsibilities." >}}
...
{{< drg/safety-first >}}
On the water, a “small” illness can become a boating hazard. A passenger who is dizzy, confused, or vomiting is not just uncomfortable. They may be unable to stay balanced, follow instructions, or help in an emergency.
{{< /drg/safety-first >}}

{{< drg/tip >}}
Build a boating first-aid mindset around three questions: Is this getting worse? Is this affecting the person's judgment or balance? Do we need to head back now instead of later?
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    description="Trusted first-aid guidance for common injuries and illnesses, including when to seek more advanced care." >}}
...
{{< drg/checklist title="What Your Counselor Wants to Hear" subtitle="How to explain Safety Afloat well" >}}
...
{{< drg/image src="images/safety-afloat-motorboating-grid.avif" alt="Nine-panel visual guide showing the Safety Afloat points in a motorboating context" >}}

{{< drg/external-link
    title="Scouting America Safety Afloat"
    url="https://www.scouting.org/health-and-safety/safety-afloat/"
    description="The full Safety Afloat policy used for all Scouting boating activities, including trip planning and supervision expectations." >}}
...
{{< drg/next-page
    text="You have the hazard awareness and first-aid foundation for safe motorboating."
    teaser="Next, focus on swim readiness and life jackets so you can protect yourself before the engine ever starts."
