...
{{< drg/inherited-requirement number="4a" req_path="4.a" topic="Review how each item of the Scouting America Safety Afloat policy applies, including checking the weather prior to and during time on the water, confirming all required equipment is present and functional, and following a float plan." />}}
...
{{< drg/checklist title="Pre-Departure Safety Afloat Review" subtitle="A practical application of the policy" >}}
...
{{< drg/external-link
    title="Scouting America Safety Afloat"
    url="https://www.scouting.org/health-and-safety/safety-afloat/"
    description="The full Safety Afloat policy, including supervision, planning, equipment, and discipline for every Scout boating activity." >}}
...
{{< drg/tip >}}
A good answer to your counselor sounds like this: “I would start with my own state's boating agency for local rules, then check the official agency in another state before boating there, because permit and education rules can differ.”
{{< /drg/tip >}}

{{< drg/external-link
    title="NASBLA — State Boating Laws"
    url="https://www.nasbla.org/education/boating-laws"
    description="A national starting point for finding boating-law information and education requirements by state." >}}
...
{{< drg/safety-first >}}
If lightning is possible, or if heavy weather is building faster than expected, the correct move is usually to head in early. Good judgment on the water often looks like ending the trip before anyone else thinks it is necessary.
{{< /drg/safety-first >}}

{{< drg/be-prepared title="The Forecast Looked Fine, But the Wind Starts Building" >}}
- **Reduce exposure.** Do not keep pushing farther from shelter.
- **Secure loose gear.** Rougher water punishes clutter.
- **Bring passengers into stable positions.** Balance matters more now.
- **Head for the safest practical landing or protected water.** Early is better than late.
{{< /drg/be-prepared >}}

{{< drg/video
    title="How to drive a boat in rough water | Big sea throttle techniques explained | Motor Boat & Yachting — Motor Boat & Yachting"
    url="https://www.youtube.com/watch?v=dAxC2xAi12c" >}}

{{< drg/external-link
    title="National Weather Service"
    url="https://www.weather.gov/"
    description="Official forecasts, warnings, radar, and local forecast offices to help you plan and reassess weather before and during boating trips." >}}

## Requirement 4d

{{< drg/inherited-requirement number="4d" req_path="4.d" topic="Promise that you will follow Scouting America Safety Afloat guidelines. Explain the meaning of each point." />}}
...
{{< drg/did-you-know >}}
Many serious incidents happen after people decide that a rule can be ignored “just for a minute.” Discipline is what prevents the small shortcut that starts the bigger emergency.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Required Gear Mindset" subtitle="Questions to ask about every item aboard" >}}
- **Is it required here?**
...
{{< drg/image src="images/required-motorboat-safety-gear-layout.avif" alt="Annotated overhead photo of common required motorboat safety gear laid out on a dock" >}}

{{< drg/external-link
    title="U.S. Coast Guard Boating Safety — Required Safety Equipment"
    url="https://www.uscgboating.org/recreational-boaters/required-safety-equipment.php"
    description="Official overview of common federally required equipment for recreational boats." >}}
...
{{< drg/tip >}}
When discussing signals with your counselor, tie them to collision prevention. Signals are not decoration. They are a language boaters use so they do not surprise one another.
{{< /drg/tip >}}
...
{{< drg/checklist title="Anchoring Sequence" subtitle="A simple way to describe the process" >}}
...
{{< drg/next-page
    text="You have the legal and seamanship framework for safe motorboating."
    teaser="Next, put it all together with hands-on boat handling, anchoring, docking, and boating knots."
