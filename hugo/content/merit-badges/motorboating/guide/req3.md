...
{{< drg/tip >}}
A strong answer compares the tradeoffs. For example: “An outboard saves space and is common on small boats, while an inboard protects the engine inside the hull and is common on larger or specialized boats.”
{{< /drg/tip >}}
...
{{< drg/checklist title="Before-Start Engine Area Check" subtitle="Simple things that prevent bigger problems" >}}
...
{{< drg/safety-first >}}
Never treat the engine compartment or stern area like storage space for random loose items. Fuel systems, battery connections, and moving parts need clearance, inspection, and airflow.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="U.S. Coast Guard Boating Safety — Fueling Your Boat"
    url="https://www.uscgboating.org/recreational-boaters/fueling-your-boat.php"
    description="Official fueling steps and precautions to reduce fire, explosion, and vapor-related hazards." >}}
...
{{< drg/did-you-know >}}
One forgotten pocket of water in the wrong place can crack expensive engine components when temperatures drop below freezing. Prevention is much cheaper than repair.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="A Skier Falls and Disappears Behind the Wake" >}}
- **Throttle down immediately and stay oriented.**
- **Keep visual contact.** Assign another person to point if possible.
- **Approach carefully and predictably.** Avoid bringing the prop area near the person.
- **Communicate before anyone reboards.** No sudden gear changes.
{{< /drg/be-prepared >}}

{{< drg/image src="images/boat-wake-and-passenger-positions.avif" alt="Diagram showing safe passenger positions, lookout zones, and wake spread around a moving motorboat" >}}

{{< drg/external-link
    title="National Safe Boating Council"
    url="https://www.safeboatingcampaign.com/"
    description="Practical boating-safety guidance on operator awareness, passenger safety, and responsible behavior on the water." >}}
...
{{< drg/next-page
    text="You now understand the motor layouts and operating precautions behind safe boat use."
    teaser="Next, learn the laws, weather decisions, required gear, and seamanship rules that guide every trip."
