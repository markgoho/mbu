...
{{< drg/inherited-requirement number="5a" req_path="5.a" topic="Board and assist others in boarding. Confirm that all passengers on board are wearing properly fitted life jackets." />}}
...
{{< drg/tip >}}
A calm, confident boarding briefing prevents most awkward starts. People do better when they know exactly where to step and where to sit.
{{< /drg/tip >}}

## Requirement 5b

{{< drg/inherited-requirement number="5b" req_path="5.b" topic="Fuel the boat and complete a safety check." />}}
...
{{< drg/checklist title="Quick Launch Safety Check" subtitle="Items worth saying out loud before departure" >}}
...
{{< drg/inherited-requirement number="5c" req_path="5.c" topic="If equipped, attach the engine cut-off switch link and safely start the motor. Get underway from dockside or from a beach launch." />}}
...
{{< drg/video
    title="Driving a boat: The basics — boatsales"
    url="https://www.youtube.com/watch?v=FjkVFTHBizI" >}}

{{< drg/safety-first >}}
The first thirty seconds after starting matter a lot. This is when people are still settling, lines may still be near the boat, and the operator can be tempted to rush.
{{< /drg/safety-first >}}

## Requirement 5d

{{< drg/inherited-requirement number="5d" req_path="5.d" topic="Run a course for at least a mile, showing procedures for overtaking and passing slower vessels, yielding right-of-way, passing oncoming traffic, making turns, reversing direction, and using navigation aids." />}}
...
{{< drg/be-prepared title="Traffic Gets Busy Near the Marina Entrance" >}}
- **Slow early.** Crowded water rewards patience.
- **Keep a full lookout.** Not just ahead, but to the sides and behind.
- **Signal your intentions with obvious boat movement and proper spacing.**
- **Do not force your way into a gap.** Wait for the clean opening.
{{< /drg/be-prepared >}}

{{< drg/image src="images/motorboat-course-handling-diagram.avif" alt="Bird's-eye diagram of a motorboat practice course with passing, yielding, turning, and navigation markers" >}}

## Requirement 5e

{{< drg/inherited-requirement number="5e" req_path="5.e" topic="Stop and secure the boat in position on the open water using anchors. Raise and stow the anchor and get underway." />}}
...
{{< drg/inherited-requirement number="5f" req_path="5.f" topic="Land or dock the boat, disembark, and assist others in doing the same." />}}
...
{{< drg/tip >}}
If a docking approach is not working, go around and try again. Skilled operators do not force a bad approach just to avoid embarrassment.
{{< /drg/tip >}}

## Requirement 5g

{{< drg/inherited-requirement number="5g" req_path="5.g" topic="Moor, dock, or beach the boat and secure all gear." />}}
...
{{< drg/checklist title="Knot Practice Goals" subtitle="What your counselor is really looking for" >}}
...
{{< drg/image src="images/boating-knots-reference-board.avif" alt="Practice board displaying five boating knots: cleating hitch, bowline, clove hitch, anchor bend, and sheet bend" >}}

{{< drg/external-link
    title="BoatUS Foundation — Knot Guide"
    url="https://www.boatus.org/study-guide/navigation/lines-and-knots"
    description="A beginner-friendly guide to practical boating knots and when to use them." >}}
...
{{< drg/next-page
    text="You have worked through the hands-on skills that make a motorboater dependable on the water."
    teaser="Go beyond the badge with advanced seamanship ideas, real-world boating experiences, and organizations worth knowing."
