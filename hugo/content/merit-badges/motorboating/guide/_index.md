...
layout: "guide"
badge_name: "Motorboating"
group_title: "Getting Started"
next: "/merit-badges/motorboating/guide/req1/"
next_title: "Req 1 — Hazards, First Aid & Safety Afloat"
guide_nav:
  - group_title: "Getting Started"
    items:
      - title: "Introduction & Overview"
...
{{< drg/did-you-know >}}
Many boating emergencies begin with small choices, not dramatic storms. A loose life jacket, poor lookout, skipped weather check, or rushed fueling stop can start the chain of problems.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Fast acceleration can make a motorboat feel easy to control when the water is open and calm. That confidence can disappear quickly near docks, swimmers, shallow areas, or other boats. Slow, controlled boat handling is a safety skill.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
When you talk with your counselor, connect every skill to the kind of water you expect to use. A smart boater does not just ask, “Can this boat move?” A smart boater asks, “Is this the right boat, gear, and plan for this place today?”
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have the overview of what motorboating demands from a Scout operator."
    teaser="Start with the risks, first-aid situations, and Safety Afloat habits that shape every safe trip."
    url="/merit-badges/motorboating/guide/req1/" >}}
