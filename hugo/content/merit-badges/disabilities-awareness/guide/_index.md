...
{{< drg/image src="images/scouts-community-inclusion.avif" alt="A Scout in a clean Scout uniform shaking hands with a person in a wheelchair at a community center, with other people of various abilities in the background" >}}
...
{{< drg/did-you-know >}}
The ADA was modeled in part on the Civil Rights Act of 1964. Disability rights activists staged sit-ins, marches, and protests — including the famous "Capitol Crawl" of 1990, when activists abandoned their wheelchairs and crawled up the steps of the U.S. Capitol to dramatize the need for accessible design.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/ada-signing-historical.avif" alt="A comparison showing the before and after of disability rights — left side shows a 1970s institutional hallway, right side shows a modern inclusive classroom with students of various abilities learning together" >}}
...
{{< drg/tip >}}
Many people who are deaf do not consider deafness a disability at all — they see it as a cultural identity. Deaf culture has its own language (ASL), history, art, and community. When talking with someone who is deaf, ask how they prefer to communicate rather than assuming.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
According to the Invisible Disabilities Association, roughly 10% of Americans have a medical condition that qualifies as an invisible disability. That is over 33 million people — far more than use wheelchairs or other visible assistive devices.
{{< /drg/did-you-know >}}

{{< drg/image src="images/disability-types-overview.avif" alt="An infographic showing six icons representing the main categories of disabilities: a wheelchair symbol for physical, an ear symbol for sensory, a brain symbol for intellectual, a heart symbol for mental health, a book symbol for learning, and a hidden figure symbol for invisible disabilities" >}}
...
{{< drg/next-page
    text="You have explored the history and types of disabilities."
    teaser="Learn the essential terms — from person-first language to accommodation — that will guide every conversation in this badge."
    url="/merit-badges/disabilities-awareness/guide/req1a/" >}}
