...
{{< drg/checklist title="Universal Etiquette Principles" subtitle="Start here — these apply in every situation" >}}
...
- Use person-first language: As you learned in [Req 1a](/merit-badges/disabilities-awareness/guide/req1a/), lead with the person, not the condition — unless they prefer otherwise.
{{< /drg/checklist >}}
...
- **Offer** specific help: "Would it help if I held the chair steady?"
- **Call for help** only if the person asks you to or appears injured.
{{< /drg/be-prepared >}}
...
{{< drg/image src="images/guiding-technique.avif" alt="A Scout offering their elbow to a person with a white cane, demonstrating the proper sighted guide technique on a sidewalk" >}}
...
{{< drg/tip >}}
When you prepare your three examples for your counselor, choose disabilities from three different categories. For instance, one example about a mobility disability, one about a hearing disability, and one about an invisible disability would show that you understand how etiquette varies across different situations.
{{< /drg/tip >}}
...
{{< drg/image src="images/disability-etiquette-conversation.avif" alt="Two teenagers having a conversation, one seated in a wheelchair and the other sitting in a chair at the same eye level, in a school hallway" >}}

{{< drg/external-link
    title="Disability Etiquette Guide — United Spinal Association"
    url="https://unitedspinal.org/disability-etiquette/"
    description="A comprehensive guide to interacting respectfully with people who have various types of disabilities, with practical tips for specific situations." >}}
...
{{< drg/next-page
    text="You understand the language and etiquette of disabilities awareness."
    teaser="Learn how to find and visit a disability services agency — and what to look for when you get there."
