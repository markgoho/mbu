...
{{< drg/tip >}}
When you discuss this term with your counselor, think about the difference between the **medical model** (disability is a problem in the person) and the **social model** (disability is caused by barriers in the environment). Most disability advocates today prefer the social model because it focuses on removing barriers rather than "fixing" people.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The concept of "curb cuts" — the small ramps built into sidewalk curbs — was pioneered by disability activists in Berkeley, California in the 1970s. Today, curb cuts benefit everyone: parents with strollers, delivery workers with hand trucks, travelers with luggage, and skateboarders. This is called the "curb cut effect" — designing for disability improves life for all.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="When Someone Requests an Accommodation" >}}
If someone asks for an accommodation — at school, at a Scout event, or in your community — the right response is simple:
- **Listen** to what they need without judgment.
- **Ask** how you can help (do not assume you know).
- **Follow through** on what you promise.
- **Keep it private** — a person's disability is their information to share.
{{< /drg/be-prepared >}}

{{< drg/image src="images/accommodation-vs-adaptation.avif" alt="An infographic comparing adaptations and accommodations, with examples of each in a clean two-column layout" >}}
...
{{< drg/safety-first >}}
Never assume you know what someone is capable of based on how they look. A person who parks in an accessible parking spot and walks into a store without a visible limp may have a heart condition, a pain disorder, or extreme fatigue. Their disability is real even if you cannot see it.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
The easiest rule to remember: lead with the person, not the condition. And if you are not sure which language someone prefers, just ask. The question itself shows respect.
{{< /drg/tip >}}

{{< drg/image src="images/person-first-language-examples.avif" alt="Diverse teenagers including a Scout having a friendly conversation around a table, one person using a wheelchair and another wearing a hearing aid, all engaged naturally" >}}
...
{{< drg/next-page
    text="You have learned the six foundational terms of disabilities awareness."
    teaser="Discover the do's and don'ts of disability etiquette — and why good manners go beyond holding doors."
