...
{{< drg/tip >}}
Start by searching for your city or county name plus "disability services" or "independent living center." Your school counselor, local United Way chapter, or 2-1-1 hotline (dial 2-1-1 from any phone) can also point you to agencies in your area.
{{< /drg/tip >}}
...
{{< drg/checklist title="Pre-Visit Checklist" subtitle="Steps to take before your agency visit" >}}
...
{{< drg/did-you-know >}}
The unemployment rate for people with disabilities is roughly double the rate for people without disabilities. The gap is not because people with disabilities cannot work — it is because of barriers like inaccessible workplaces, employer bias, and lack of transportation.
{{< /drg/did-you-know >}}

{{< drg/image src="images/scout-visiting-agency.avif" alt="A Scout sitting across a desk from an agency staff member at a disability services organization, taking notes in a notebook" >}}
...
{{< drg/be-prepared title="Making the Most of Your Discussion" >}}
Your counselor will want more than a list of programs. Be ready to share:
- **A specific story** you heard or a person you met (without using names unless given permission)
- **Something that surprised you** about the agency or the people it serves
- **A connection** between what you saw and the terminology you learned in [Req 1a](/merit-badges/disabilities-awareness/guide/req1a/) — for example, how the agency provides accommodations or promotes accessibility
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Find a Center for Independent Living"
    url="https://www.ilru.org/projects/cil-net/cil-center-and-association-directory"
    description="The Independent Living Research Utilization (ILRU) directory helps you find an independent living center near you — one of the best types of agencies to visit for this requirement." >}}

{{< drg/image src="images/agency-programs-collage.avif" alt="A community center activity room where people with various disabilities are engaged in a job skills training workshop with computers and accessible desks" >}}
...
{{< drg/next-page
    text="You have visited an agency and learned how your community supports people with disabilities."
    teaser="Hear directly from people who live with disabilities — through conversations, adaptive sports, assistive technology, or awareness activities."
