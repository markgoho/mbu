...
{{< drg/image src="images/sensory-friendly-space.avif" alt="A calm, softly-lit quiet room in a community building with comfortable seating, dim adjustable lamps, and muted colors designed as a sensory-friendly space" >}}

## Talking with Staff

This option specifically asks you to talk with staff members. Here are ways to start that conversation:

{{< drg/be-prepared title="Starting the Conversation with Staff" >}}
Try an approach like this:
- **Introduce yourself:** "Hi, I am a Scout working on my Disabilities Awareness merit badge. Could I ask you a few questions about how this location accommodates people with invisible disabilities?"
- **Ask open-ended questions:** "What accommodations does this location offer for people who might have conditions that are not immediately obvious?" Staff may not have thought about this before — that is valuable information in itself.
- **Ask about training:** "Has staff received any training on working with people who have invisible disabilities?"
- **Ask about specific situations:** "If someone had a panic attack or a seizure here, what would the protocol be?"
{{< /drg/be-prepared >}}

{{< drg/tip >}}
If a staff member is not sure about accommodations, that itself is a finding worth noting. It may mean the location has not thought much about invisible disabilities — which is a common gap you can highlight in your discussion with your counselor.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Many museums and theme parks now offer "social stories" — visual guides that walk visitors through what to expect, step by step, before they arrive. Originally developed for people on the autism spectrum, these guides help anyone who experiences anxiety about unfamiliar environments.
{{< /drg/did-you-know >}}

{{< drg/image src="images/staff-training-invisible-disabilities.avif" alt="Staff members in a training room discussing invisible disability accommodations, with one person at a whiteboard with icons representing different types of invisible disabilities" >}}
...
{{< drg/external-link
    title="Invisible Disabilities Association"
    url="https://invisibledisabilities.org/"
    description="A nonprofit organization dedicated to raising awareness and providing resources about invisible disabilities. Their site includes personal stories, educational materials, and a helpful FAQ." >}}
...
{{< drg/next-page
    text="You have audited your community for invisible disability accommodations."
    teaser="Learn what advocacy means and choose a way to share your knowledge — through a presentation, volunteer work, or myth-busting research."
