...
{{< drg/did-you-know >}}
Judy Heumann, often called the "mother of the disability rights movement," was denied a teaching license in New York City in 1970 because she used a wheelchair. She sued, won, and spent the next 50 years fighting for disability rights — including helping draft the ADA. Her memoir, *Being Heumann*, is a powerful introduction to disability advocacy.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Presentation Planning" subtitle="Steps to build an effective awareness program" >}}
...
{{< drg/tip >}}
For a Cub Scout audience, keep your presentation to 15–20 minutes and include at least one hands-on activity. Younger kids learn best by doing, not listening.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Getting Started as a Volunteer" >}}
When you contact an organization to volunteer:
- **Explain your situation:** "I am a Scout working on my Disabilities Awareness merit badge, and I would like to volunteer eight hours with your organization."
- **Be flexible:** The organization may need you for tasks you did not expect — and those tasks may teach you the most.
- **Ask about training:** Many organizations provide a brief orientation. Take it seriously — it will help you be a better volunteer.
- **Follow through:** Show up when you say you will. Reliability matters.
{{< /drg/be-prepared >}}
...
{{< drg/safety-first >}}
When presenting about myths, be respectful. The goal is to correct misconceptions, not to embarrass anyone who may have believed them. Approach the topic as "things most people get wrong" rather than "things people are wrong about." Everyone has held incorrect beliefs at some point — the point is to learn better.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/advocacy-presentation.avif" alt="A Scout presenting about disability awareness to a group of Cub Scouts using a colorful poster board in a well-lit meeting room" >}}

{{< drg/external-link
    title="National Disability Rights Network"
    url="https://www.ndrn.org/"
    description="The largest provider of legally based advocacy services for people with disabilities in the United States. Their resources section includes educational materials about disability rights and common misconceptions." >}}
...
{{< drg/next-page
    text="You have put advocacy into action through a presentation, volunteering, or research."
    teaser="Reflect on your journey and make a personal commitment to promote positive attitudes toward people with disabilities."
