...
{{< drg/image src="images/disability-professionals-collage.avif" alt="Split image showing a physical therapist helping a young person with exercises on parallel bars, and a special education teacher working one-on-one with a student using adaptive materials" >}}
...
{{< drg/did-you-know >}}
The Bureau of Labor Statistics projects that demand for occupational therapists, physical therapists, and speech-language pathologists will grow much faster than average through 2032. An aging population and advances in medical treatment mean more people than ever will need rehabilitation and assistive services.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Career Research Guide" subtitle="Questions to answer about your chosen profession" >}}
...
{{< drg/tip >}}
If you visited an agency for [Req 2](/merit-badges/disabilities-awareness/guide/req2/), think about the professionals you met there. Asking someone who does the job every day is one of the best ways to learn what a career is really like — including the parts that do not show up in a job description.
{{< /drg/tip >}}

{{< drg/external-link
    title="O*NET Online — Disability Services Careers"
    url="https://www.onetonline.org/"
    description="The U.S. Department of Labor's career exploration tool. Search for any of the professions listed above to find detailed information about education, skills, salary, and job outlook." >}}

{{< drg/external-link
    title="Bureau of Labor Statistics — Occupational Outlook Handbook"
    url="https://www.bls.gov/ooh/"
    description="Detailed profiles of hundreds of occupations, including education requirements, median pay, and projected job growth. Search for professions like 'occupational therapist' or 'speech-language pathologist.'" >}}

{{< drg/image src="images/career-exploration-scout.avif" alt="A Scout visiting a prosthetics workshop, observing a prosthetist showing a prosthetic hand while taking notes in a notebook" >}}
...
{{< drg/next-page
    text="You have completed all seven requirements for the Disabilities Awareness merit badge."
    teaser="Go deeper with extended learning — from universal design to disability in media to real-world experiences and organizations."
