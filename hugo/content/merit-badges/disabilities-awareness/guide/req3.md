...
{{< drg/tip >}}
Focus on what the Scout has accomplished, not on their limitations. Ask about their favorite camping trip, their toughest merit badge, or the rank advancement they are most proud of. You will probably discover you have more in common than you expected.
{{< /drg/tip >}}
...
**What to do:** Have a conversation with someone who has a disability — a family member, neighbor, teacher, coach, or someone you met through the agency visit in [Req 2](/merit-badges/disabilities-awareness/guide/req2/). Learn about their daily life, their interests, and the activities they enjoy.

**How to prepare:** Approach this conversation with genuine curiosity and the etiquette you learned in [Req 1b](/merit-badges/disabilities-awareness/guide/req1b/). Ask about their life — not just their disability. People with disabilities are whole people with hobbies, careers, families, and dreams.
...
{{< drg/safety-first >}}
Remember: it is never okay to ask someone about their disability unless they volunteer the information or you have a trusted relationship. If you are reaching out to someone you do not know well, explain your merit badge project first and let them decide if they want to participate.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
The Paralympic Games feature over 500 events across 22 sports. At the 2024 Paris Paralympics, over 4,400 athletes from more than 180 countries competed. Athletes use racing wheelchairs, running blades, tandem bicycles, and other specialized equipment designed for peak performance.
{{< /drg/did-you-know >}}

{{< drg/image src="images/adaptive-sports-montage.avif" alt="A wheelchair basketball game in action, with athletes in sport wheelchairs racing down the court showing intense competitive focus" >}}
...
{{< drg/tip >}}
If you choose this option, try to go beyond just listing aids. Learn how specific technologies have changed someone's life. A power wheelchair is not just a chair — it is freedom. A communication device is not just a tablet — it is a voice.
{{< /drg/tip >}}

{{< drg/external-link
    title="AbleData — Assistive Technology Database"
    url="https://abledata.acl.gov/"
    description="A comprehensive database of assistive technology products maintained by the U.S. Administration for Community Living. Search by disability type or activity to find specific devices." >}}
...
- Lead a discussion about invisible disabilities using the myths and facts you will research in [Req 5](/merit-badges/disabilities-awareness/guide/req5/)
- Invite a speaker with a disability to share their story with your troop or pack

{{< drg/safety-first >}}
Disability simulations can be powerful learning tools, but they must be handled with care. A five-minute wheelchair ride does not replicate the lifelong experience of a disability — and poorly designed simulations can actually reinforce negative stereotypes (like the idea that disability is tragic or limiting). Always pair a simulation with a conversation with someone who actually has the disability. Focus on environmental barriers, not on how "hard" it is to be disabled.
{{< /drg/safety-first >}}

{{< drg/image src="images/awareness-activity-troop.avif" alt="A Scout presenting about disability awareness to an engaged group of fellow Scouts at a troop meeting using a poster board" >}}
...
{{< drg/next-page
    text="You have learned from people with disabilities and explored adaptive sports, assistive technology, or awareness activities."
    teaser="Put your awareness to the test — evaluate how accessible your school, place of worship, or community really is."
