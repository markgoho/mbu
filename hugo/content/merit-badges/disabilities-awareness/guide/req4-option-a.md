...
req_number: "4"
prev: "/merit-badges/disabilities-awareness/guide/req4/"
prev_title: "Accessibility Observations"
next: "/merit-badges/disabilities-awareness/guide/req4-option-b/"
next_title: "Req 4 Option B — Invisible Disability Accommodations"
---

{{< drg/requirement number="4" option="Option A" >}}
...
{{< drg/image src="images/accessibility-features-building.avif" alt="A diagram of a building entrance showing key accessibility features including a wheelchair ramp, automatic door opener, tactile warning strip, accessible parking sign, and curb cut" >}}

{{< drg/checklist title="Audit Note-Taking Template" subtitle="Record five positives and five areas for improvement at each location" >}}
...
{{< drg/did-you-know >}}
The ADA was signed into law in 1990, but many buildings predate it. Older buildings are required to remove architectural barriers when it is "readily achievable" — meaning easy to do without much expense. But "readily achievable" is a judgment call, and many older buildings still have significant accessibility gaps.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    ...
    url="https://www.adachecklist.org/"
    description="A detailed, printable checklist from the New England ADA Center that covers every aspect of physical accessibility. Use it as a reference during your visits." >}}
...
{{< drg/next-page
    text="You have explored how to audit physical accessibility."
    teaser="Discover the hidden accommodations for invisible disabilities — quiet rooms, sensory aids, and flexible policies that most people never notice."
