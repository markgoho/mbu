...
{{< drg/video
    title="Beekeeping 101 ( video)"
    url="https://youtu.be/C2h4fYL73_M?si=GSvoxnXeVd8E9MA4" >}}

{{< drg/safety-first >}}
Never inspect a hive without the permission and guidance of an experienced adult. Wear the protective gear they require, move slowly, and do not use this option if you have a bee-sting allergy. The requirement itself directs allergic Scouts to choose the ant-colony option instead.
{{< /drg/safety-first >}}

{{< drg/checklist title="What to notice on each frame" subtitle="A simple inspection checklist" >}}
...
{{< drg/image src="images/bee-hive-frame-reading-diagram.avif" alt="Illustrated hive frame showing the queen, worker brood area, enlarged queen cells, and capped honey sections with simple labels so readers can see how beekeepers read one frame at a glance" >}}
...
{{< drg/next-page
    text="You have seen how hive inspection reveals the queen, brood, queen cells, and honey stores."
    teaser="Next, zoom back out and look at how insects fit into food webs and plant pollination."
