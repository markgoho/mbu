...
{{< drg/checklist title="What makes an insect an insect?" subtitle="Use these features in your counselor discussion" >}}
...
{{< drg/video
    title="Insect Anatomy ( video)"
    url="https://www.youtube.com/watch?v=B4oL9P0J8eA" >}}

{{< drg/external-link
    title="Insect Pictures and Facts (website)"
    url="https://www.nationalgeographic.com/animals/topic/insects"
    description="Offers examples and photos that help you connect insect body features with real species you might see outdoors." >}}
...
{{< drg/image src="images/insect-spider-millipede-comparison-grid.avif" alt="Side-by-side identification grid comparing an insect, a spider, and a millipede with clear visual emphasis on leg count, body sections, antennae, and segment pattern" >}}

{{< drg/video
    title="Insects vs Arachnids ( video)"
    url="https://www.youtube.com/watch?v=91x0CV9CkFw" >}}

{{< drg/tip >}}
When you are unsure in the field, count legs first. Six means insect. Eight points toward spider or another arachnid. “Too many to count quickly” usually means you are looking at something else entirely.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
A dragonfly's compound eyes can contain tens of thousands of tiny visual units. That helps it detect movement so well that dragonflies are some of the most successful aerial hunters on Earth.
{{< /drg/did-you-know >}}

{{< drg/video
    title="Basic Insect Anatomy: Head, Thorax, and Abdomen (video)"
    url="https://youtu.be/bC9a35k1uFo?si=RD2MLMXIBaX72XC_" >}}
...
{{< drg/video
    title="Top 5 Insect Orders and How to Identify Them (video)"
    url="https://www.youtube.com/watch?v=h9sKpQNd8DI" >}}

{{< drg/be-prepared title="When you need to identify an unknown insect" >}}
Do not guess based on color alone.

- **Start with body shape**: Is it long, round, flattened, or narrow-waisted?
- **Count visible wings**: One pair, two pairs, or none visible?
- **Check the legs and antennae**: Long jumping legs and clubbed antennae tell different stories.
- **Notice behavior and habitat**: On flowers, under bark, near water, or hopping in grass can all be useful clues.
  {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You can now explain what an insect is, name its main parts, and use anatomy to sort major groups."
    teaser="Next, compare insect life cycles and learn how complete metamorphosis changes an animal from larva to adult."
