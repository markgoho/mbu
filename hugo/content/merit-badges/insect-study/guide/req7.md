...
{{< drg/image src="images/healthy-hive-vs-colony-collapse-comparison.avif" alt="Comparison showing a healthy hive with workers, brood, and food stores beside a colony collapse scenario with queen and brood left behind but most workers missing" >}}
...
{{< drg/video
    title="Hundreds of Millions of Bees Mysteriously Dying ( video)"
    url="https://youtu.be/qWsBZbnt_4A?si=cYkszuDmpwAm3ELw" >}}

{{< drg/video
    title="Why Are the Bees Dying? (video)"
    url="https://youtu.be/Eelf07i3ESA?si=yzK6c2on91pQjr_o" >}}

{{< drg/external-link
    title="Colony Collapse Disorder (website)"
    url="https://www.epa.gov/pollinator-protection/colony-collapse-disorder"
    description="Summarizes what CCD is, the factors scientists study, and why colony health matters to pollination and agriculture." >}}
...
{{< drg/video
    title="Ultimate Pest Control Guide for Farmers (Video)"
    url="https://www.youtube.com/watch?v=AVSs-EkYTCo" >}}

{{< drg/video
    title="4 Ways Nuclear Techniques Help Feed the World ( video)"
    url="https://youtu.be/2ef83qy2R6I?si=_MDuPzsxkk6a0Z8v" >}}

{{< drg/tip >}}
If your counselor asks for pros and cons, do not just say one method is “good” or “bad.” Explain what it costs, how quickly it works, what scale it fits, and whether it protects helpful insects such as pollinators and predators.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="You have explored how bees support people and how crop protection can go beyond spraying chemicals."
    teaser="Next, follow insect migration and learn how conservation can help threatened species survive."
