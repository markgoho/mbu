...
{{< drg/checklist title="Signs of social insect life" subtitle="What to mention to your counselor" >}}
...
{{< drg/image src="images/social-vs-solitary-insect-comparison.avif" alt="Comparison showing a coordinated ant or honey bee colony with brood care and task-sharing beside a solitary insect handling nesting and foraging alone" >}}
...
{{< drg/external-link
    title="Social Insects (website)"
    url="https://genent.cals.ncsu.edu/bug-bytes/social-insects/"
    description="Explains the major traits of social insects and gives examples you can compare with solitary species." >}}

{{< drg/external-link
    title="What Are Social Insects? (website)"
    url="https://www.thoughtco.com/what-are-social-insects-1968157"
    description="Breaks down colony behavior, caste roles, and the key features that define insect social life." >}}

{{< drg/did-you-know >}}
An ant colony can act so much like a single coordinated organism that scientists sometimes call it a “superorganism.” No one ant understands the whole plan, but together the colony can solve surprisingly complex problems.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You can now explain what makes colony insects different from species that live alone."
    teaser="Next, choose whether to study an ant colony or a bee hive for your social insect project."
