...
{{< drg/external-link
    title="Leave No Trace Basics ( video)"
    url="https://vimeo.com/1115216743/63b20c0b33?share=copy"
    description="Introduces the core Leave No Trace ideas you can apply directly to observation, handling, and habitat protection." >}}

{{< drg/video
    title="Leave No Trace Outdoor Ethics ( video)"
    url="https://www.youtube.com/watch?v=jXO1uY0MvmQ" >}}

{{< drg/tip >}}
When you explain this to your counselor, use a real example from your own outing. Saying “I stepped around milkweed instead of through it because monarch caterpillars might be feeding there” is much stronger than giving a generic definition.
{{< /drg/tip >}}
...
{{< drg/image src="images/insect-microhabitat-search-grid.avif" alt="Identification grid showing five microhabitats side by side: flowers, grassy edge, pond margin, rotting log, and porch light at night, with representative insects in each setting" >}}
...
{{< drg/video
    title="Insect Orders ( video)"
    url="https://www.youtube.com/watch?v=RFMA3u-lZ3U" >}}

{{< drg/video
    title="Crash Course in Entomology: The \"Big Four\" Insect Orders ( video)"
    url="https://www.youtube.com/watch?v=HOhbf5JtCGo" >}}

{{< drg/video
    title="An Introduction to Insect Orders ( video)"
    url="https://www.youtube.com/watch?v=Ogh7_ITZ3Xg" >}}

{{< drg/download
    title="Insect Observation Scrapbook Worksheet"
    url="/merit-badges/insect-study/guide/insect-observation-scrapbook-worksheet/"
    type="printable" >}}

## Requirement 4c

{{< drg/requirement number="4c" >}}
Make a scrapbook of the 20 insects you observe in 5(b) Include photographs, sketches, illustrations, and articles. Label each insect with its common and scientific names, where possible. Share your scrapbook with your counselor.
{{< /drg/requirement >}}
...
{{< drg/video
    title="How to Start a Bug Collection (video)"
    url="https://youtu.be/_Ep2ronR_io?si=VWUcH8SZodx_njzz" >}}

{{< drg/video
    title="How to Make an Insect Collection: Spreading ( video)"
    url="https://www.youtube.com/watch?v=KFacqZ9CM4w" >}}

{{< drg/video
    title="Collecting Insects: Tools and Supplies (Video)"
    url="https://www.youtube.com/watch?v=CcBOm6DQ20g" >}}

{{< drg/video
    title="Insect Collecting - Tools & Tips ( video)"
    url="https://www.youtube.com/watch?v=hB9lyBkWaEE" >}}

{{< drg/checklist title="What to include for each scrapbook entry" subtitle="Keep every page useful and easy to review" >}}
...
{{< drg/video
    title="Why Insects Are So Crucial to Life on Earth ( video)"
    url="https://www.youtube.com/watch?v=6QwiYfqX1sg" >}}

{{< drg/video
    title="Why Are Insects Important? (website)"
    url="https://www.youtube.com/watch?v=19iEWe-qH5o" >}}

{{< drg/did-you-know >}}
Many freshwater fish depend heavily on insects during some part of their lives. That means insects you see near streams and ponds are helping feed animals far bigger than themselves.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You have practiced outdoor ethics, built an observation record, and started thinking like an ecologist."
    teaser="Next, compare solitary insects with social ones and see what makes colonies work."
