...
{{< drg/image src="images/monarch-migration-route-and-stopover-habitat.avif" alt="Map-style illustrated diagram showing monarch migration routes from northern breeding areas to Mexico and the California coast, with stopover habitat examples such as milkweed patches and nectar gardens along the route" >}}

{{< drg/external-link
    title="Monarch Migration (website)"
    url="https://www.monarchwatch.org/migration/"
    description="Maps the monarch migration and explains the habitats and seasonal challenges that shape the journey." >}}

{{< drg/checklist title="Ways Scouts can help migrating insects" subtitle="Small actions matter when many people do them" >}}
...
{{< drg/external-link
    title="Endangered Species Conservation (website)"
    url="https://www.xerces.org/endangered-species"
    description="Provides examples of at-risk insect species and explains practical conservation work that supports their survival." >}}

{{< drg/be-prepared title="When you want to help a species you care about" >}}
Start with the habitat, not just the insect.

- **Learn the species' needs**: Host plant, nesting area, moisture, or overwintering site.
- **Avoid one-size-fits-all advice**: What helps a monarch may not help a ground-nesting bee.
- **Use local native plants**: They are usually the best match for local insects.
- **Work with experts when possible**: Nature centers, native plant groups, and conservation groups can guide projects.
  {{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have traced insect migration and explored what conservation looks like in real habitats."
    teaser="Next, choose whether to explore insect-study careers or build a long-term personal hobby."
