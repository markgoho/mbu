...
{{< drg/checklist title="Safe habits around ants and bees" subtitle="Simple choices prevent most problems" >}}
...
{{< drg/image src="images/ant-bee-hazard-scan-comparison.avif" alt="Comparison showing unsafe versus safe field behavior around ants and bees, including kneeling in an ant mound versus scanning the ground first and standing in a hive flight path versus observing from the side" >}}
...
{{< drg/safety-first >}}
Trouble breathing, swelling of the face or throat, faintness, widespread hives, vomiting, or confusion after a sting can signal anaphylaxis. This is a medical emergency. Use prescribed epinephrine if available, call 911, and get adult help immediately.
{{< /drg/safety-first >}}

{{< drg/video
    title="Insects, Bites, and Stings (video)"
    url="https://www.youtube.com/watch?v=-_c7225EkbA" >}}

{{< drg/external-link
    title="Fire Ant Bites (website)"
    url="https://my.clevelandclinic.org/health/diseases/23362-fire-ant-bites"
    description="Explains what fire ant stings look like, how to clean and treat them, and when to get medical help." >}}

{{< drg/external-link
    title="Are There Risks Associated With Keeping Honey Bees? (website)"
    url="https://peskylittlecritters.com/are-there-risks-associated-with-keeping-honey-bees/"
    description="Reviews common beekeeping risks so you can discuss what makes hive work different from ordinary field observation." >}}

{{< drg/tip >}}
When you talk with your counselor, organize your answer in four parts: anticipate, prevent, mitigate, and respond. That structure makes it easier to explain safety clearly instead of listing random facts.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="If someone shows signs of anaphylaxis" >}}
Stay calm and act fast.

- **Move away from the insects**: Prevent additional stings.
- **Call 911 immediately**: Do not wait to see if the person “gets over it.”
- **Use the person's epinephrine auto-injector if prescribed**: Follow the device instructions and get adult help right away.
- **Monitor breathing and responsiveness**: Be ready to help until EMS arrives.
- **Report the sting time and symptoms**: That information helps rescuers.
  {{< /drg/be-prepared >}}
...
This requirement connects strongly to First Aid skills. If you have also worked on the [/merit-badges/first-aid/](/merit-badges/first-aid/) badge, you already know that recognizing the emergency early is one of the most important steps.

{{< drg/video
    title="Anaphylactic Shock: Symptoms, Triggers, and Life-Saving First Aid Tips ( video)"
    url="https://youtu.be/tIQGcVpAFvM?si=FQuPgmqx0GSGi_L9" >}}

{{< drg/video
    title="First Aid for a Bee Sting ( video)"
    url="https://www.youtube.com/watch?v=Adx9mKSoBNU" >}}

{{< drg/did-you-know >}}
A honey bee usually dies after stinging because its barbed stinger tears away from its body. Wasps and hornets, by contrast, can usually sting more than once.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You now know how to avoid common hazards and respond if bites, stings, or allergic reactions happen."
    teaser="Next, learn how to tell insects apart by body plan, major features, and insect orders."
