...
{{< drg/did-you-know >}}
A kayak usually turns because of more than just the paddle stroke you choose. The shape of the hull, how much edge the boat is tilted on, wind direction, and even how you packed the boat can all change how it handles.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
If you are just starting out, do not worry about using the “fastest” kayak. A stable, well-fitted boat helps you learn faster because you can focus on technique instead of feeling tippy the whole time.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Whitewater, cold water, wind, and open crossings can turn a simple outing into an emergency fast. Paddle only where your training matches the conditions, and never assume calm water at the launch will stay calm all day.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You now know where kayaking came from and the different ways people paddle today."
    teaser="Learn the hazards, common injuries, and Safety Afloat habits that protect every kayaking trip."
    url="/merit-badges/kayaking/guide/req1/" >}}
