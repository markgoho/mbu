...
{{< drg/checklist title="Major Kayak Parts to Know" subtitle="Common terms a Scout should recognize and point out" >}}
...
{{< drg/image src="images/kayak-parts-labeled-diagram.avif" alt="Educational diagram with side and top views of a kayak labeled with the major parts." >}}

{{< drg/tip >}}
When you first look at a kayak, trace it from bow to stern with your hand and say the parts out loud. That is one of the fastest ways to make the vocabulary stick.
{{< /drg/tip >}}

{{< drg/external-link
    title="Paddling.com — Kayak Anatomy"
    url="https://paddling.com/learn/basic-kayak-terminology"
    description="A beginner-friendly overview of kayak parts and common paddling terms." >}}
...
{{< drg/did-you-know >}}
Two kayaks can feel “stable” for different reasons. One may feel steady when sitting flat, while another may feel steadier once it is slightly edged and moving. Paddlers often call this difference primary and secondary stability.
{{< /drg/did-you-know >}}

{{< drg/be-prepared title="Choosing the Wrong Boat for the Job" >}}
Imagine taking a short, highly maneuverable whitewater kayak on a long, windy lake crossing.

- **You will work harder to keep it straight.**
- **Wind may push the boat around more.**
- **You may tire out before the trip is over.**
- **The boat is not “bad” — it is just built for a different job.**
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="American Canoe Association — Paddlesports Basics"
    url="https://americancanoe.org/education/resource-hub/"
    description="Explore instruction resources that explain how boat design affects paddling performance." >}}
...
{{< drg/checklist title="Basic Kayak Care Routine" subtitle="What to do after a trip" >}}
...
{{< drg/safety-first >}}
Do not paddle a kayak with damage you do not understand. A small crack, missing flotation compartment cover, or loose outfitting may seem minor on shore but can matter a lot during a capsize or rescue.
{{< /drg/safety-first >}}

{{< drg/tip >}}
Treat loading and unloading as part of kayak care. Many boats are damaged in parking lots and driveways, not on the water.
{{< /drg/tip >}}

{{< drg/external-link
    title="REI Expert Advice — How to Store a Kayak"
    url="https://www.rei.com/learn/expert-advice/kayak-storage.html"
    description="Practical guidance for storing kayaks to reduce damage and warping." >}}
...
{{< drg/next-page
    text="You can now identify key kayak parts, compare designs, and explain how to care for the boat."
    teaser="Next, learn how to use the paddle correctly, name its parts, and keep it in good condition."
