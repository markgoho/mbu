...
req_number: "2"
prev: "/merit-badges/kayaking/guide/req1/"
prev_title: "Req 1 — Hazards, Injuries & Safety Afloat"
next: "/merit-badges/kayaking/guide/req3/"
next_title: "Req 3 — Life Jackets & Rescue Equipment"
---
...
The swimmer test also supports Safety Afloat. In [Req 1](/merit-badges/kayaking/guide/req1/), you learned that safe boating depends on honest planning. Knowing your real swimming ability is part of that honesty.
...
{{< drg/checklist title="Swimmer Test Prep" subtitle="Habits that make the test feel more manageable" >}}
...
{{< drg/tip >}}
If you get nervous before the test, focus on one part at a time. A relaxed stroke rhythm is usually more helpful than trying to "power through" the whole test.
{{< /drg/tip >}}

{{< drg/be-prepared title="If the Test Does Not Go Well the First Time" >}}
Not passing on the first try does not mean kayaking is off-limits forever.

- **Find out what part broke down.** Was it endurance, breathing, technique, or confidence?
- **Practice that specific weakness.** Targeted practice works better than vague "getting better at swimming."
- **Retest when ready.** The goal is real readiness, not rushing to the next requirement.
- **Keep learning safety skills.** Reviewing equipment and terminology still helps while you improve your swimming.
{{< /drg/be-prepared >}}

{{< drg/safety-first >}}
Never fake your swim ability to move ahead faster. In kayaking, overestimating yourself can put you and your buddy at risk during a capsize or rescue.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="Scouting America — Aquatics Supervision"
    url="https://www.scouting.org/health-and-safety/gss/gss02/"
    description="Review Scouting aquatics supervision guidance that connects swimming ability to safe boating activities." >}}
...
{{< drg/next-page
    text="You understand why the swimmer test is a real safety skill, not just a box to check."
    teaser="Next, learn how to choose a kayaking life jacket and why rescue gear matters before every launch."
