...
{{< drg/checklist title="Life Jacket Fit Test" subtitle="What to check before launching" >}}
...
{{< drg/image src="images/kayaking-life-jacket-fit-comparison.avif" alt="Side-by-side comparison of a properly fitted paddling life jacket and a poorly fitted jacket riding up at the shoulders while seated in a kayak." >}}
...
{{< drg/safety-first >}}
Wear your life jacket every time you paddle, even on warm, shallow, familiar water. Most paddling emergencies happen too quickly for a “put it on later” plan to work.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="U.S. Coast Guard Boating Safety — Life Jackets"
    url="https://www.uscgboating.org/recreational-boaters/life-jackets.php"
    description="See how to choose, fit, and inspect life jackets for safe boating activities." >}}
...
{{< drg/tip >}}
When you learn a new piece of safety gear, ask two questions: Where is it stored, and could I reach it quickly if the boat were upside down or full of water?
{{< /drg/tip >}}

{{< drg/be-prepared title="A Paddle Breaks Far from the Launch" >}}
Your group is halfway across a lake when one paddler's blade cracks.

- **Stabilize the group first.** Keep boats close together.
- **Bring out the spare paddle.** This is why carrying one matters on longer trips.
- **Shorten the plan.** Head for the nearest safe landing or return route.
- **Watch fatigue.** A paddler using backup gear may tire faster.
{{< /drg/be-prepared >}}

{{< drg/checklist title="What Each Piece of Gear Solves" subtitle="Match the item to the problem" >}}
...
{{< drg/external-link
    title="American Canoe Association — Safety Tips"
    url="https://americancanoe.org/education/resource-hub/safety-tips/"
    description="Review paddlesports safety advice, equipment basics, and risk-reduction habits." >}}
...
{{< drg/next-page
    text="You now know how a properly fitted life jacket and simple rescue gear protect a paddler."
    teaser="Next, learn the parts of a kayak, how design changes performance, and how to care for the boat well."
