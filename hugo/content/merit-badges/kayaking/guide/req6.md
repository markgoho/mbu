...
- **Wet exit after a capsize**
- **Reentry with assistance**
- **Kayak-over-kayak rescue**
- **The HELP position in the water**
- **Swimming the kayak and paddle to shore and emptying the boat**
...
{{< drg/checklist title="Wet Exit Sequence" subtitle="Simple actions to practice in order" >}}
...
{{< drg/image src="images/wet-exit-sequence-four-panel.avif" alt="Four-panel instructional sequence showing a kayaker practicing a wet exit from capsize to resurfacing beside the boat." >}}

{{< drg/safety-first >}}
Wet exits should be learned under trained supervision in controlled conditions before you ever need one unexpectedly. Panic is reduced by good practice, not by guessing in the moment.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
During any assisted reentry, talk clearly and keep instructions short. Rescue attempts go better when one paddler leads and the other listens.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Why Practice the Rescue Slowly First" >}}
If you try to rush a kayak-over-kayak rescue, the flooded boat may slip away or refill.

- **Slow down and position the boats carefully.**
- **Keep the rescuer's boat stable.**
- **Empty as much water as possible before reentry.**
- **Communicate every step so both paddlers move together.**
{{< /drg/be-prepared >}}
...
{{< drg/checklist title="HELP Position Basics" subtitle="What the position is trying to do" >}}
...
{{< drg/external-link
    title="Cold Water Safety — National Center for Cold Water Safety"
    url="https://coldwatersafety.org/"
    description="Learn why cold water immersion is dangerous and how posture and preparation affect survival." >}}
...
{{< drg/safety-first >}}
A rescue is successful only if it actually improves the situation. If repeated reentry attempts are failing, switch to the simpler plan: control the boat, go to shore, warm up, and regroup.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="American Canoe Association — Cold Water and Rescue Safety"
    url="https://americancanoe.org/education/resource-hub/safety-tips/"
    description="Review rescue-focused paddlesports safety guidance and why controlled practice matters." >}}

{{< drg/video
    title="Kayaking | How to Self-Rescue || REI — REI"
    url="https://www.youtube.com/watch?v=IUHYtQR79Z4" >}}

If [Req 3](/merit-badges/kayaking/guide/req3/) taught you why safety gear matters, this requirement teaches you what that gear and training are for. Next you will shift from rescue skills to the strokes that make solo paddling controlled and efficient.

{{< drg/next-page
    text="You now understand how to exit, recover, reenter, and protect yourself after a capsize."
    teaser="Next, build solo control with the six essential kayak strokes every paddler should recognize and demonstrate."
