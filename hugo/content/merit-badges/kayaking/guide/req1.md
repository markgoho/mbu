...
{{< drg/checklist title="Hazard Scan Before Launch" subtitle="Questions to ask before your kayak touches the water" >}}
...
- **Stay near shore if possible.** That reduces exposure and gives you landing options.
- **Shorten the route.** Skip the farther cove or island if the conditions are changing.
- **Keep the group together.** A spread-out group is harder to supervise and help.
- **Land and reassess if needed.** There is no rule that says you must finish the original plan.
{{< /drg/be-prepared >}}

{{< drg/safety-first >}}
If you hear thunder, see lightning, or watch dark storm clouds building fast, get off the water immediately. A kayak is never the place to “wait and see” whether a thunderstorm will pass around you.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="National Weather Service — Water Safety"
    url="https://www.weather.gov/safety/water"
    description="Learn how weather, cold water, flooding, and storms affect people on the water." >}}
...
{{< drg/checklist title="Know the Signs" subtitle="Problems a paddler should catch early" >}}
...
{{< drg/tip >}}
On a kayak trip, do a quick self-check every so often: How warm am I? How tired am I? When did I last drink water? Catching a problem early is much easier than fixing it late.
{{< /drg/tip >}}

{{< drg/did-you-know >}}
Cold shock can happen so fast that a strong swimmer may struggle before they even begin swimming. The first danger is often uncontrolled breathing, not lack of swimming ability.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="CDC — How to Prevent Hypothermia"
    url="https://www.cdc.gov/disasters/winter/staysafe/hypothermia.html"
    description="A clear guide to recognizing and responding to dangerous cold exposure." >}}
...
{{< drg/checklist title="How Safety Afloat Shows Up in Kayaking" subtitle="What the policy looks like on a real trip" >}}
...
{{< drg/safety-first >}}
Safety rules are not there to make kayaking less fun. They exist because once you are on the water, small mistakes can pile up fast. Follow the policy every trip, even on water that looks easy.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="Scouting America — Safety Afloat"
    url="https://www.scouting.org/health-and-safety/gss/gss02/"
    description="Read the full Safety Afloat policy and see how it applies to all Scouting boating activities." >}}
...
{{< drg/next-page
    text="You now understand the hazards, health risks, and Safety Afloat habits behind every safe kayaking trip."
    teaser="Get ready for the swimmer test, the gateway skill for the rest of the badge's on-water requirements."
