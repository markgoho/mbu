---
title: "Paddle Skills & Paddle Care"
layout: guide
group_title: "5. Paddling Fundamentals"
req_number: "5"
prev: "/merit-badges/kayaking/guide/req4/"
prev_title: "Kayak Parts, Design & Care"
next: "/merit-badges/kayaking/guide/req6/"
next_title: "Capsize Recovery Skills"
---
...
Correct methods for the use of a kayak paddle.
{{< /drg/requirement >}}
...
{{< drg/checklist title="Efficient Paddle Use" subtitle="What counselors usually want to see" >}}
...
{{< drg/image src="images/efficient-kayak-forward-stroke-annotated.avif" alt="Annotated side-view image of a kayaker demonstrating an efficient forward stroke with posture and blade-path callouts." >}}

{{< drg/tip >}}
If your shoulders are doing all the work, you are probably overpulling with your arms. Think about turning your body and planting the blade cleanly instead.
{{< /drg/tip >}}

{{< drg/external-link
    title="Paddling.com — Forward Stroke Basics"
    url="https://paddling.com/learn/kayak-forward-stroke"
    description="A beginner-friendly guide to efficient kayak stroke mechanics and posture." >}}
...
{{< drg/did-you-know >}}
Feathered paddles were partly developed to reduce wind resistance on the blade that is out of the water. Some paddlers like them, while others prefer both blades aligned the same way.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="REI Expert Advice — Choosing a Kayak Paddle"
    url="https://www.rei.com/learn/expert-advice/kayak-paddle.html"
    description="Learn paddle terminology, sizing basics, and how paddle design affects performance." >}}
...
{{< drg/be-prepared title="The Ferrule Won't Lock Cleanly" >}}
Your two-piece paddle suddenly feels loose when assembled.

- **Take it apart and inspect the joint.** Sand or grit may be interfering.
- **Rinse and dry the connection.**
- **Test the lock before launching again.**
- **Do not ignore looseness.** A failing joint can ruin control at the wrong moment.
{{< /drg/be-prepared >}}

{{< drg/checklist title="Basic Paddle Care" subtitle="Quick checks that keep a paddle dependable" >}}
...
{{< drg/safety-first >}}
Do not wait for a paddle to fail on the water. If the shaft or blade is damaged enough that you do not trust it, repair or replace it before the next trip.
{{< /drg/safety-first >}}
...
{{< drg/next-page
    text="You now know how to use a kayak paddle more efficiently and how to care for it."
    teaser="Next, build the rescue mindset with wet exits, buddy reentry, kayak-over-kayak rescue, and shore recovery."
