...
- **Turn while moving**
- **Reverse effectively**
- **Link maneuvers in a figure 8 course**
...
{{< drg/checklist title="Boat Control Habits" subtitle="What helps every maneuver in this requirement" >}}
...
{{< drg/tip >}}
Practice one goal at a time. If you are working on a straight line, focus on quiet correction strokes. If you are practicing pivots, exaggerate clean sweep strokes instead of mixing in random forward strokes.
{{< /drg/tip >}}

{{< drg/be-prepared title="You Keep Missing the Figure 8 Line" >}}
If your figure 8 turns turn into wide circles or sudden zigzags:

- **Start the turn earlier.** Waiting too long is the most common mistake.
- **Pick a line through the markers before you reach them.**
- **Use the stroke that matches the job.** Sweeps for turning, stern draw for fine control.
- **Keep the kayak moving.** A little forward momentum often makes the boat easier to guide.
{{< /drg/be-prepared >}}

{{< drg/image src="images/kayak-figure-eight-course-overhead.avif" alt="Bird's-eye diagram of a kayak paddling a figure-eight course around two buoys." >}}

{{< drg/safety-first >}}
Boat-control practice should happen in water and conditions that let you focus on skill, not survival. Strong wind, heavy traffic, or cold, rough water make learning harder and raise the consequences of mistakes.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="Paddling.com — Beginner Skills and Drills"
    url="https://paddling.com/learn"
    description="Browse stroke and control drills that help paddlers practice turns, edging, and maneuvering with intention." >}}

{{< drg/external-link
    title="Proper Technique for Paddling a Kayak — PaddleTV"
    url="https://www.youtube.com/watch?v=v0-efrwppWQ" >}}
...
{{< drg/next-page
    text="You now know how to turn basic strokes into real boat control on the water."
    teaser="Go beyond the badge with touring ideas, trip planning, cold-water judgment, and organizations that can help you keep paddling."
