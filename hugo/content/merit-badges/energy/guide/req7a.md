...
{{< drg/tip >}}
A strong counselor explanation compares two goals at once: getting more usable energy and reducing the problems caused by the waste stream itself.
{{< /drg/tip >}}

{{< drg/external-link title="EPA — Basic Information about Landfill Gas" url="https://www.epa.gov/lmop/basic-information-about-landfill-gas" description="Explains how organic waste produces gas and how that gas can be captured for useful energy." >}}
...
{{< drg/next-page
    text="You have seen how organic waste and trash can become useful fuel or electricity"
    teaser="Now explore combined heat and power, where one system produces electricity and useful heat together."
