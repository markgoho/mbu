...
req_number: "5"
req_path: "5"
prev: "/merit-badges/energy/guide/req4/"
prev_title: "Req 4 — Home Energy Audit"
next: "/merit-badges/energy/guide/req6/"
next_title: "Req 6 — Energy by the Numbers"
---
...
{{< drg/checklist title="Make each example stronger" subtitle="For every waste example, include these parts" >}}
...
{{< drg/be-prepared title="Thinking through trade-offs" >}}
Ask these questions for each idea:

- **What gets better right away?**
- **What becomes less convenient?**
- **Who has to change a habit?**
- **Is there an upfront cost?**
- **How long might it take before the savings pay that cost back?**
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You have practiced noticing waste, benefits, and trade-offs in the real world"
    teaser="Now turn big energy facts into charts and learn what national and global patterns reveal."
