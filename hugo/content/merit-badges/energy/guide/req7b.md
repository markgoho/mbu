...
{{< drg/did-you-know >}}
One reason CHP can be so efficient is that “waste” heat is only waste if nobody uses it. In the right setting, that same heat becomes part of the useful output.
{{< /drg/did-you-know >}}

{{< drg/external-link title="U.S. Department of Energy — Combined Heat and Power" url="https://www.energy.gov/eere/amo/combined-heat-and-power-basics" description="A clear DOE overview of how CHP works and why it can improve overall efficiency." >}}
...
{{< drg/next-page
    text="You have explored how one system can produce electricity and useful heat together"
    teaser="Next, see how fossil fuel power plants try to produce more usable energy with better efficiency and cleaner controls."
