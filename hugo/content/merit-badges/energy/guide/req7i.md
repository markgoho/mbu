...
{{< drg/checklist title="Why bigger turbines can help" subtitle="A few design ideas to explain with confidence" >}}
- **Longer blades** sweep a larger area and can capture more wind energy.
- **Taller towers** reach steadier, faster winds.
- **Blade pitch controls** adjust to changing wind so the turbine works efficiently and safely.
- **Smart siting** reduces turbulence and helps each turbine perform better.
{{< /drg/checklist >}}

{{< drg/external-link title="U.S. Department of Energy — Wind Energy Basics" url="https://www.energy.gov/eere/wind/wind-energy-basics" description="DOE explanation of how wind turbines work and what affects wind power performance." >}}
...
{{< drg/next-page
    text="You have completed the technology comparison section and seen how wind turbines capture more usable energy"
    teaser="Next, research careers that use energy knowledge in engineering, maintenance, utilities, and beyond."
