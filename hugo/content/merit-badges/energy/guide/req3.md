...
{{< drg/did-you-know >}}
Efficiency does not mean “no losses.” It means a larger share of the input energy becomes the result you want. Even a very efficient machine still wastes some energy.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Explain your system clearly" subtitle="One sentence for each part of the story" >}}
...
{{< drg/be-prepared title="If your counselor asks, “How could this system be more efficient?”" >}}
Think about:

- reducing friction
- adding insulation
- improving controls so the system runs only when needed
- maintaining parts so they do not waste energy
- upgrading to designs that produce the same useful result with less input energy
{{< /drg/be-prepared >}}

{{< drg/tip >}}
Draw a picture with arrows before you talk. Energy systems become much easier to explain when you can point from source to parts to outcome.
{{< /drg/tip >}}

{{< drg/external-link title="Energy Saver" url="https://www.energy.gov/energysaver/energy-saver" description="The Department of Energy's practical guide to how systems in homes use energy and where efficiency improvements matter most." >}}
...
{{< drg/next-page
    text="You have learned how to follow energy from source to result"
    teaser="Now conduct a real home energy audit and keep a 14-day log of smarter choices."
