...
{{< drg/checklist title="Choose a strong source" subtitle="Pick something that gives you enough to discuss" >}}
...
{{< drg/tip >}}
Do not try to sound impressive. A simple honest question like “Why does wasting energy as heat matter so much?” often leads to a better discussion than pretending you already understand everything.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Your second conversation" >}}
When you revisit your source, be ready to answer these kinds of questions:

- **What idea makes more sense now?** Name it clearly.
- **What vocabulary do you understand better?** Efficiency, emissions, grid, storage, cost, conversion, and similar terms often come up.
- **Did any question get answered by the badge?** Point to a requirement that helped.
- **What still seems uncertain?** Real energy questions often stay open because they involve trade-offs.
{{< /drg/be-prepared >}}

{{< drg/did-you-know >}}
One reason energy stories can feel confusing is that they often mix science questions with economics, engineering, environment, and politics all at once. That does not mean the topic is impossible. It means you need multiple tools to understand it well.
{{< /drg/did-you-know >}}

{{< drg/external-link title="EIA — Energy Explained" url="https://www.eia.gov/energyexplained/" description="A reliable starting place for clear explanations of major energy topics, from fuels and electricity to conservation and prices." >}}
...
{{< drg/next-page
    text="You have learned how to notice the important questions inside an energy source"
    teaser="Now follow energy as it changes form in real devices and in a system you build yourself."
