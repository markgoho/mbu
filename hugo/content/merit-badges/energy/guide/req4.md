...
{{< drg/download title="Energy Audit Log Worksheet" url="/merit-badges/energy/guide/energy-audit-log/" type="printable" description="Print this worksheet to track energy sources, bill details, transportation fuel, and your 14-day energy-saving log." >}}
...
{{< drg/checklist title="What to record" subtitle="Use one of these two paths" >}}
...
{{< drg/tip >}}
Pick actions your family can actually repeat for two weeks. A small change done 14 times teaches you more than an ambitious plan that lasts one day.
{{< /drg/tip >}}

{{< drg/did-you-know >}}
Heating water is often one of the bigger energy uses in a home. That means a habit as ordinary as shower length can affect energy use more than people expect.
{{< /drg/did-you-know >}}

{{< drg/be-prepared title="Talking with your counselor after 14 days" >}}
Be ready to explain:

- which changes were easiest to keep doing
- which changes were hardest
- what your family noticed about convenience
- whether any actions probably saved only a little and which likely mattered more
- what you would keep doing even after the requirement is done
{{< /drg/be-prepared >}}

{{< drg/external-link title="Energy Saver" url="https://www.energy.gov/energysaver/energy-saver" description="Practical guidance from the Department of Energy on home energy use, bills, appliances, insulation, and everyday ways to save energy." >}}
...
{{< drg/next-page
    text="You have measured energy use where you live and tracked real changes for two weeks"
    teaser="Now look outward and identify waste in your school or community, along with the trade-offs behind fixing it."
