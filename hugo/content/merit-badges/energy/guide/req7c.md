...
{{< drg/checklist title="Why combined-cycle matters" subtitle="A quick way to explain improved fossil fuel efficiency" >}}
...
{{< drg/external-link title="EIA — Electricity Explained" url="https://www.eia.gov/energyexplained/electricity/" description="Useful background on how power plants generate electricity and how fuel choices shape the electric grid." >}}
...
{{< drg/next-page
    text="You have seen how large fossil fuel plants improve efficiency and control emissions"
    teaser="Next, study fuel cells, which use an electrochemical process instead of ordinary combustion."
