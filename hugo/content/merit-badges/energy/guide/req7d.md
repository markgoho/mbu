...
{{< drg/tip >}}
When discussing fuel cells, separate the **fuel cell device** from the **hydrogen supply chain**. The device may be very clean at use, but the bigger picture depends on where the fuel came from.
{{< /drg/tip >}}

{{< drg/external-link title="U.S. Department of Energy — Hydrogen and Fuel Cell Technologies Office" url="https://www.energy.gov/eere/fuelcells/hydrogen-and-fuel-cell-technologies-office" description="DOE overview of fuel cells, hydrogen systems, current uses, and technology challenges." >}}
...
{{< drg/next-page
    text="You have explored how fuel cells generate electricity electrochemically"
    teaser="Next, look at geothermal power, where usable energy comes from heat already stored inside the Earth."
