...
{{< drg/checklist title="Career research checklist" subtitle="Gather facts you can explain clearly" >}}
...
{{< drg/tip >}}
Pick one career that genuinely interests you, even if you are not sure you would choose it. Your counselor discussion will be stronger if you can honestly explain what sounds appealing and what does not.
{{< /drg/tip >}}

{{< drg/be-prepared title="Questions to ask yourself" >}}
When deciding whether a career fits you, think about:

- Do you like working indoors, outdoors, or both?
- Do you want hands-on field work or more design and analysis?
- Are you comfortable with safety rules, heights, shift work, or travel if the job requires them?
- Do you enjoy solving technical problems over long periods of time?
{{< /drg/be-prepared >}}

{{< drg/external-link title="Bureau of Labor Statistics — Architecture and Engineering Occupations" url="https://www.bls.gov/ooh/architecture-and-engineering/home.htm" description="Reliable government information on training, salary, and outlook for many engineering and energy-related careers." >}}

{{< drg/external-link title="Bureau of Labor Statistics — Installation, Maintenance, and Repair Occupations" url="https://www.bls.gov/ooh/installation-maintenance-and-repair/home.htm" description="Useful for researching technician and hands-on careers related to energy systems." >}}
...
{{< drg/next-page
    text="You have finished the requirements and connected energy concepts to real career paths"
    teaser="Go beyond the badge with deeper topics, real-world experiences, and organizations worth exploring next."
    url="/merit-badges/energy/guide/extended-learning/" >}}
