...
{{< drg/inherited-requirement number="6a" req_path="6.a" topic="The energy resources that supply the United States with most of its energy" />}}
...
{{< drg/inherited-requirement number="6b" req_path="6.b" topic="The share of energy resources used by the United States that comes from other countries" />}}
...
{{< drg/inherited-requirement number="6c" req_path="6.c" topic="The proportion of energy resources used by homes, businesses, industry, and transportation" />}}
...
{{< drg/inherited-requirement number="6d" req_path="6.d" topic="The fuels used to generate America's electricity" />}}
...
{{< drg/inherited-requirement number="6e" req_path="6.e" topic="The world's known and estimated primary energy resource reserves." />}}
...
{{< drg/checklist title="Explain each chart clearly" subtitle="Use the same simple structure each time" >}}
...
{{< drg/tip >}}
Put the source name and year directly on each chart. That makes your counselor discussion easier and shows you are handling data responsibly.
{{< /drg/tip >}}

{{< drg/external-link title="EIA — Energy Explained" url="https://www.eia.gov/energyexplained/" description="A strong source for U.S. energy production, consumption, imports, electricity generation, and reserve-related background." >}}

{{< drg/external-link title="EIA — Electricity Explained" url="https://www.eia.gov/energyexplained/electricity/" description="Helpful for charting fuels used to generate electricity and understanding how electricity differs from total energy use." >}}
...
{{< drg/next-page
    text="You have turned national and global energy data into understandable patterns"
    teaser="Now choose five energy systems and compare their technology, cost, environmental impacts, and safety concerns."
