...
{{< drg/did-you-know >}}
About 75% of all flowering plants and roughly 35% of the world's food crops depend on animal pollinators. Without pollinators, we would lose many of the fruits, vegetables, and nuts we eat every day — including apples, blueberries, almonds, chocolate, and coffee.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When listing your five pollinators and their plants, be specific. Instead of just "bees," say "Eastern bumblebee" or "honeybee." Instead of just "flowers," name the species — "purple coneflower" or "wild bergamot." Specific examples show real research.
{{< /drg/tip >}}

{{< drg/video
    title="The Power of Pollinators"
    url="https://www.youtube.com/watch?v=eDxZojp9yNg" >}}
...
{{< drg/checklist title="Pollination Observation Log" subtitle="What to record during your hour of observation" >}}
...
{{< drg/video
    title="The Beauty of Pollination"
    url="https://www.youtube.com/watch?v=MQiszdkOwuU" >}}
...
{{< drg/video
    title="Pollinators and Agriculture"
    url="https://www.youtube.com/watch?v=RczHxJI57xU" >}}

{{< drg/external-link
    title="Pollinator Partnership — Find Your Planting Guide"
    url="https://www.pollinator.org/guides"
    description="Enter your zip code to get a free planting guide for pollinator-friendly plants native to your region." >}}

{{< drg/image src="images/pollinator-garden.avif" alt="A vibrant garden with diverse flowering plants and several pollinators — a bumblebee on purple coneflower, a monarch butterfly on milkweed, and a hummingbird at a trumpet vine" >}}

{{< drg/image src="images/scout-pollinator-observation.avif" alt="A Scout sitting quietly near a flower bed with a notebook, watching a bee on a sunflower, with other flowering plants around" >}}
...
{{< drg/next-page
    text="You have explored the vital role of pollinators in our environment and food supply."
    teaser="Investigate invasive species — the uninvited guests that disrupt ecosystems."
