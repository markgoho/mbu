...
{{< drg/be-prepared title="Investigating a Golf Course or Farm" >}}
Golf courses and farms are excellent sites for this option because they typically use a variety of chemicals on a regular schedule. Here is how to approach them:

- **Contact the superintendent or manager** in advance and explain your merit badge project.
- **Ask for a chemical application log** — many facilities keep detailed records.
- **Tour the site** and note how close treated areas are to streams, ponds, or wells.
- **Ask about integrated pest management (IPM)** — a strategy that reduces chemical use by combining biological, cultural, and chemical controls.
{{< /drg/be-prepared >}}

{{< drg/video
    title="Do We Really Need Pesticides?"
    url="https://www.youtube.com/watch?v=GLllZ-qiXJA" >}}
...
{{< drg/did-you-know >}}
It takes nature about 500 years to form one inch of topsoil. Erosion can strip away that inch in a single heavy rainstorm if the ground is bare. Topsoil is essentially a nonrenewable resource on any human timescale.
{{< /drg/did-you-know >}}

{{< drg/video
    title="Soil Erosion — Causes, Effects, and Solutions"
...
{{< drg/video
    title="Introduction to Superfund"
    url="https://www.youtube.com/watch?v=klO1hJBJjns" >}}

{{< drg/external-link
    title="EPA Superfund Site Search"
    url="https://www.epa.gov/superfund/search-superfund-sites-where-you-live"
    description="Search for Superfund sites near you and read about their contamination history and cleanup progress." >}}

{{< drg/image src="images/erosion-prevention.avif" alt="A hillside showing erosion control techniques — terracing, planted ground cover, and a riparian buffer along a stream at the bottom" >}}

{{< drg/image src="images/scout-soil-sample.avif" alt="A Scout kneeling on a riverbank collecting a soil sample in a small container, with visible erosion patterns on the bank" >}}
...
{{< drg/next-page
    text="You have investigated land pollution — chemicals, erosion, and toxic waste sites."
    teaser="Learn about endangered species, conservation success stories, and habitat restoration."
