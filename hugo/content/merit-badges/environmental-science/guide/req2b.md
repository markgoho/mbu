...
{{< drg/did-you-know >}}
A single dead tree can support more species than a living one. Woodpeckers drill nesting cavities. Owls move in after. Insects colonize the bark. Fungi break down the wood. Ecologists call standing dead trees "snags," and they are some of the most valuable structures in a forest.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When building a food chain for your ecosystem, start with a plant you observed. Ask: what eats this plant? Then ask: what eats that animal? Keep going until you reach a top predator — an animal with no natural predators in that ecosystem.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="How to Identify Invasive Species" >}}
If you are not sure whether a species is native or invasive, try these steps:

- **Use an app:** iNaturalist can identify species from a photo and often flags invasive ones.
- **Check your state's invasive species list:** Most state departments of natural resources publish lists online.
- **Ask a local expert:** Park rangers, extension agents, and nature center staff can help.
- **Look for warning signs:** A single species covering a large area and crowding everything else out is often invasive.
{{< /drg/be-prepared >}}
...
{{< drg/tip >}}
Human impact is not always negative. A restored wetland, a community garden, or a newly planted native tree is also a human impact — a positive one. Be sure to note both harmful and helpful effects.
{{< /drg/tip >}}

{{< drg/image src="images/ecosystem-food-web.avif" alt="An illustrated food web diagram showing connections between sun, plants, insects, frogs, birds, and a hawk in a meadow ecosystem" >}}

{{< drg/external-link
    title="National Wildlife Federation — Ecosystem Guide"
    url="https://www.nwf.org/Educational-Resources/Wildlife-Guide"
    description="Wildlife and habitat guides from the National Wildlife Federation to help identify species in your area." >}}

{{< drg/image src="images/scout-examining-log.avif" alt="A Scout using a magnifying glass to examine insects on a decomposing log in a forest, with mushrooms growing on the bark" >}}
...
{{< drg/next-page
    text="You have identified the components of your ecosystem and how they interact."
    teaser="Explore how air pollution affects the environment — and what is being done about it."
