...
{{< drg/safety-first >}}
On days when PM levels are high (check AirNow.gov for your area), limit outdoor physical activity. If you can see haze or smell smoke in the air, it is a sign that particulate levels may be elevated.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
For a stronger experiment, place cards at different heights (ground level, waist level, above your head) at the same location. This shows how particulate concentration changes with elevation.
{{< /drg/tip >}}

{{< drg/video
    title="Particulate Matter — What It Is and How to Avoid It"
    url="https://www.youtube.com/watch?v=zj4rd77EAt4" >}}
...
{{< drg/did-you-know >}}
A fully loaded city bus can replace 40 to 60 individual cars on the road. Public transit systems dramatically reduce per-person emissions, even when the buses themselves run on diesel.
{{< /drg/did-you-know >}}

{{< drg/video
    title="What Really Comes Out of Your Car Exhaust"
    url="https://www.youtube.com/watch?v=WTg4i-5N62U" >}}
...
{{< drg/video
    title="What Is the Clean Air Act?"
    url="https://www.youtube.com/watch?v=um517CsDC2w" >}}

{{< drg/external-link
    title="AirNow — Check Air Quality in Your Area"
    url="https://www.airnow.gov/"
    description="Real-time air quality data and forecasts from the EPA. Check the Air Quality Index (AQI) for your zip code." >}}

{{< drg/video
    title="Air Pollution 101 — National Geographic"
    url="https://www.youtube.com/watch?v=e6rglsLy1Ys" >}}

{{< drg/image src="images/air-quality-monitoring.avif" alt="A Scout holding up a sticky card air quality test near a roadside, comparing it against a clean card, with trees and a road in the background" >}}
...
{{< drg/next-page
    text="You have explored how air pollution works and what is being done about it."
    teaser="Investigate where your water comes from, where it goes, and what threatens it."
