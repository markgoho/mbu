...
{{< drg/did-you-know >}}
Environmental science became its own recognized field only in the 1960s and 1970s. Before that, the ideas were spread across biology, chemistry, and geography. It took major events like oil spills and rivers catching fire to convince people that the environment needed its own dedicated science.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Conservation is not just for professionals. Every time you follow Leave No Trace principles on a campout, you are practicing conservation. Small actions — picking up litter, staying on trails, using reusable water bottles — add up.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Talking to Your Counselor" >}}
Your counselor wants to hear your thinking, not a rehearsed answer. A strong response might sound like:

- **Start with a definition:** "Environmental science is the study of how humans and nature interact, and how we can use data and research to protect the environment."
- **Give an example:** "For instance, scientists used water testing to figure out that a local stream was contaminated by runoff from a nearby farm."
- **Connect it to action:** "That kind of research helps communities make rules to prevent pollution and clean up what is already there."
{{< /drg/be-prepared >}}

{{< drg/video
    title="What is Environmental Science? Definition and Scope of the Field"
    url="https://www.youtube.com/watch?v=kB0JA7jsqMw" >}}

{{< drg/external-link
    title="EPA: What Is Environmental Science?"
    url="https://www.epa.gov/education/what-environmental-education"
    description="The EPA's overview of environmental education and why it matters." >}}

{{< drg/image src="images/scout-nature-observation.avif" alt="A Scout writing in a field notebook while sitting on a fallen log in a forest clearing, with diverse plants and a small stream visible" >}}
...
{{< drg/next-page
    text="You now know what environmental science means and how science helps us protect our world."
    teaser="Head into the field to observe a real ecosystem up close."
