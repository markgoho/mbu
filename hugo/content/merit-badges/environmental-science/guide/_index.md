...
{{< drg/image src="images/scout-ecosystem-observation.avif" alt="A Scout kneeling beside a stream with a notebook, observing plants and wildlife in a healthy ecosystem" >}}
...
{{< drg/did-you-know >}}
The word "ecology" comes from the Greek word *oikos*, meaning "house" or "home." Ecology is literally the study of nature's home — and how all the residents get along.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Air quality directly affects your health. On days when the Air Quality Index (AQI) is high, outdoor activities like hiking and running can be harmful — especially for people with asthma. Always check air quality before planning vigorous outdoor activities.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/soil-layers-cross-section.avif" alt="A cross-section illustration showing layers of soil with roots, earthworms, and rock beneath" >}}
...
{{< drg/tip >}}
As you work through this merit badge, notice how these branches connect. Air pollution affects water quality. Soil contamination harms wildlife. Pollinators depend on healthy ecosystems. Environmental science is all about understanding these connections.
{{< /drg/tip >}}

{{< drg/image src="images/environmental-science-branches.avif" alt="An illustrated diagram showing the six branches of environmental science connected by arrows, with icons representing each field" >}}
...
{{< drg/next-page
    text="You have an overview of what environmental science covers and why it matters."
    teaser="Define environmental science in your own words and explore how science helps us protect our world."
    url="/merit-badges/environmental-science/guide/req1/" >}}
