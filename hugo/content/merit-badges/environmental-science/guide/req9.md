...
{{< drg/did-you-know >}}
Invasive species are the second-largest cause of species extinction worldwide, right behind habitat loss. In the United States alone, invasive species cause an estimated $120 billion in damage and control costs every year.
{{< /drg/did-you-know >}}
...
{{< drg/checklist title="Invasive Species Research Guide" subtitle="What to learn about each species" >}}
...
{{< drg/be-prepared title="Finding Invasive Species Near You" >}}
You do not need to travel far to find invasive species. Try these approaches:

- **Walk your neighborhood** and look for plants like English ivy, Japanese honeysuckle, or garlic mustard growing in wooded areas.
- **Visit a local park** and read interpretive signs — many parks identify invasive species and their management efforts.
- **Check bodies of water** for invasive aquatic species like zebra mussels, hydrilla, or water hyacinth.
- **Look for signs** at boat launches — many states require boaters to clean their equipment to prevent spreading aquatic invasive species.
- **Ask your Scout camp** — camp rangers often manage invasive species as part of their land stewardship work.
{{< /drg/be-prepared >}}

{{< drg/tip >}}
Consider choosing one invasive plant and one invasive animal for your two species. This gives you a broader perspective and a more interesting discussion with your counselor.
{{< /drg/tip >}}

{{< drg/video
    title="The Threat of Invasive Species"
    url="https://www.youtube.com/watch?v=spTWwqVP_2s" >}}

{{< drg/video
    title="Why We Don't Just Kill Off Invasive Species"
    url="https://www.youtube.com/watch?v=TNfIGtZ3k1Q" >}}

{{< drg/external-link
    title="USDA National Invasive Species Information Center"
    url="https://www.invasivespeciesinfo.gov/"
    description="Comprehensive federal resource for identifying and managing invasive species across the United States." >}}

{{< drg/image src="images/invasive-species-examples.avif" alt="A split illustration showing kudzu vine covering trees on one side and spotted lanternflies clustered on a tree trunk on the other side" >}}
...
{{< drg/next-page
    text="You have investigated invasive species — where they come from, how they spread, and what can be done."
    teaser="Learn how environmental scientists evaluate the impact of construction and development projects."
