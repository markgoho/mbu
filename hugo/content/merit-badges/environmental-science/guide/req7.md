...
{{< drg/tip >}}
For your one-week practice, choose methods you can measure. For example, time your showers before and after changing your habits, or count how many single-use items you avoid. Numbers make your discussion with your counselor much stronger.
{{< /drg/tip >}}

{{< drg/video
    title="10 Ways to Take Care of the Environment"
...
{{< drg/did-you-know >}}
Recycling one aluminum can saves enough energy to run a television for three hours. Aluminum is one of the most efficient materials to recycle — it can be melted down and remade into a new can in as little as 60 days.
{{< /drg/did-you-know >}}

{{< drg/video
    title="Reduce, Reuse, Recycle"
    url="https://www.youtube.com/watch?v=u8MQwOR2og8" >}}
...
{{< drg/safety-first >}}
Never mix household chemicals. Some combinations — like bleach and ammonia — create toxic gases that can cause serious injury or death. Always store hazardous materials in their original containers with labels intact, away from heat and out of reach of children and pets.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="Finding Disposal Options in Your Area" >}}
To find out what is available near you:

- **Search online** for "[your city/county] household hazardous waste disposal"
- **Call your local solid waste department** — they can tell you about collection events and drop-off locations
- **Check Earth911.org** — enter the material and your zip code to find recycling and disposal options
- **Ask at hardware stores** — many accept paint, batteries, and light bulbs
{{< /drg/be-prepared >}}

{{< drg/video
    title="Proper Disposal of Household Hazardous Waste"
    url="https://www.youtube.com/watch?v=MJX0rvGsRpA" >}}

{{< drg/external-link
    title="Earth911 — Recycling and Disposal Locator"
    url="https://earth911.com/"
    description="Search by material type and zip code to find recycling, disposal, and drop-off options near you." >}}

{{< drg/image src="images/reduce-reuse-recycle.avif" alt="A Scout organizing items into three labeled bins — Reduce, Reuse, Recycle — with common household items like bottles, cans, and bags" >}}
...
{{< drg/next-page
    text="You have explored pollution prevention, resource recovery, and conservation practices."
    teaser="Discover the world of pollinators — the tiny creatures that make much of our food supply possible."
