---
title: "Observing an Ecosystem"
layout: guide
group_title: "2. Ecology"
req_number: "2a"
prev: "/merit-badges/environmental-science/guide/req1/"
prev_title: "Defining Environmental Science"
next: "/merit-badges/environmental-science/guide/req2b/"
next_title: "Ecosystem Components"
---
...
{{< drg/did-you-know >}}
A single handful of healthy soil contains more microorganisms than there are people on Earth. These tiny creatures break down dead material, recycle nutrients, and keep the ecosystem running.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Visit the same spot at different times of day if you can. A field at dawn sounds completely different from the same field at noon. Morning brings birdsong and dew; midday brings insect buzz and heat.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
If you detect a strong chemical odor at your observation site, do not stay to investigate. Move away and report it to an adult. Some chemical spills or gas leaks can be dangerous to breathe.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Field Observation Kit" subtitle="What to bring to your observation site" >}}
...
{{< drg/video
    title="Observe Nature Like a Scientist!"
    url="https://www.youtube.com/watch?v=7NVce3RK-Lo" >}}

{{< drg/video
    title="Observe Nature with iNaturalist"
    url="https://www.youtube.com/watch?v=Mb_i-WoUKt0" >}}

{{< drg/image src="images/scout-field-notebook.avif" alt="A Scout sitting cross-legged in a meadow with binoculars around their neck, writing observations in a field notebook with wildflowers and trees in the background" >}}

{{< drg/external-link
    title="iNaturalist — Citizen Science App"
    url="https://www.inaturalist.org/"
    description="A free app that helps you identify plants and animals from photos, and contributes your observations to real scientific research." >}}
...
{{< drg/next-page
    text="You have learned how to observe an ecosystem using sight, sound, and smell."
    teaser="Organize your observations into living, nonliving, and formerly living components — and trace the connections between them."
