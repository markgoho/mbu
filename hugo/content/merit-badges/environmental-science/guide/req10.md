...
{{< drg/tip >}}
The no-action alternative is not just "nothing changes." It means describing what the consequences are of NOT building the project. If you do not build the new dining hall, what happens to the camp? Do they turn away Scouts? Eat in shifts? This helps weigh the project's benefits against its environmental costs.
{{< /drg/tip >}}
...
{{< drg/checklist title="Environmental Impact Topics" subtitle="Areas to evaluate for your project" >}}
...
{{< drg/did-you-know >}}
The concept of the "no-action alternative" was revolutionary when NEPA introduced it. Before 1970, most projects were evaluated only on whether they could be built — not whether they should be. NEPA forced decision-makers to consider "what if we just don't?" as a legitimate option.
{{< /drg/did-you-know >}}

{{< drg/video
    title="What Is an Environmental Impact Assessment?"
    url="https://www.youtube.com/watch?v=V7W3l1Qgj-0" >}}

{{< drg/video
    title="Environmental Impact Assessments — Key to Sustainable Development"
    url="https://www.youtube.com/watch?v=aznhAlo8rJo" >}}

{{< drg/external-link
    title="EPA: National Environmental Policy Act (NEPA)"
    url="https://www.epa.gov/nepa"
    description="Learn about the federal law that requires environmental impact assessment for major projects." >}}

{{< drg/image src="images/scout-camp-site-assessment.avif" alt="A Scout standing at the edge of a wooded clearing at a Scout camp, holding a clipboard and looking at the terrain, considering where a new building might go" >}}
...
{{< drg/next-page
    text="You have evaluated the environmental impact of a construction project."
    teaser="Explore career paths in environmental science — and find one that excites you."
