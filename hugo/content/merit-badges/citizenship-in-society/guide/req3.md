...
{{< drg/checklist title="Planning Your Three Examples" subtitle="For each example, think through these questions" >}}
...
{{< drg/be-prepared title="What If Speaking Up Feels Too Risky?" >}}
You see a group of older students making fun of a younger student, and you are afraid that stepping in will make you a target too.

- **Step one**: You do not have to confront the group directly. Focus on the person being targeted instead.
- **Step two**: After the moment passes, approach the younger student privately. "I saw what happened, and it was not okay. Are you alright?"
- **Step three**: Report the incident to a teacher or counselor. Describe what you saw factually.
- **Step four**: Check in with the student again later. Knowing someone cares can make all the difference.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="StopBullying.gov — How to Be an Upstander"
    url="https://www.stopbullying.gov/"
    description="Government resource with practical advice on recognizing bullying and taking effective action." >}}
...
{{< drg/next-page
    text="You have reflected on your own ethical decisions."
    teaser="Now put your skills to the test — discuss real-world scenarios where you can stand up for others."
