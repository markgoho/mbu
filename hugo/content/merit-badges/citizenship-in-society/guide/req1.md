...
{{< drg/tip >}}
Try listing five parts of your own identity. Then ask a friend or family member to do the same. You might be surprised by how much overlap — and how much difference — you discover.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The difference between equality and equity is one of the most discussed ideas in modern citizenship. Understanding it does not mean you have to agree on every policy — it means you understand why some people need different kinds of support to have the same opportunities.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
If you experience or witness discrimination, tell a trusted adult — a parent, teacher, Scoutmaster, or counselor. You do not have to handle it alone, and speaking up is not "tattling." It is leadership.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="What If You See Someone Being Excluded?" >}}
You notice a Scout being left out of a group activity. No one is being mean on purpose — they just forgot to include them. What do you do?

- **Step one**: Walk over and invite them to join. "Hey, we're about to start — come join us!"
- **Step two**: If they seem hesitant, pair up with them yourself so they are not alone.
- **Step three**: Later, mention it casually to the group. "Let's make sure we grab everyone next time."
...
{{< drg/checklist title="Terms & the Scout Law" subtitle="Think about which points of the Scout Law each term connects to" >}}
...
{{< drg/external-link
    ...
    description="Review the full text of the Scout Oath and Scout Law on the official Scouting America website." >}}
...
{{< drg/next-page
    text="You now have a solid understanding of the key terms."
    teaser="Explore what ethical leadership looks like in action — and find a real-world example of someone who demonstrated it."
