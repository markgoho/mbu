...
{{< drg/tip >}}
One of the best ways to challenge your own assumptions is to ask yourself: "Would I want someone to make this assumption about me based on one part of my identity?" If the answer is no, do not make it about someone else.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="What If Someone Stereotypes You?" >}}
It happens. Someone makes an assumption about you based on how you look, where you are from, or what group you belong to.

- **Step one**: Take a breath. It is natural to feel frustrated or hurt.
- **Step two**: If you feel comfortable, correct the assumption calmly. "Actually, that's not really how it is for me."
- **Step three**: If the situation feels unsafe or hostile, remove yourself and talk to a trusted adult.
- **Step four**: Remember that someone else's ignorance does not define you. You know who you are.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Project Implicit — Implicit Association Tests"
    url="https://implicit.harvard.edu/"
    description="Harvard's Project Implicit lets you explore your own unconscious biases through free, anonymous online tests. A powerful self-awareness tool." >}}
...
{{< drg/next-page
    text="You have explored how stereotypes work and how to challenge them."
    teaser="Bring everything together — create your personal action plan for leading with diversity, equity, and inclusion."
