...
{{< drg/tip >}}
This works best when both people are genuinely curious and willing to be open. Approach the conversation as two people learning from each other, not as an interviewer and a subject. You are both sharing.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
This conversation may bring up difficult memories. Both you and your partner should feel free to share only what you are comfortable with. If either of you needs to pause or change topics, that is completely okay. There is no requirement to share anything that feels too personal or painful.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Studies show that being socially excluded activates the same areas of the brain as physical pain. Exclusion literally hurts — which is why small acts of inclusion can have such a powerful positive effect on someone's day.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Take notes right after your conversation while the details are fresh. You do not need to share everything with your counselor, but having notes will help you remember the key moments and insights.
{{< /drg/tip >}}

{{< drg/external-link
    title="ADL — Having Conversations About Identity"
    url="https://www.adl.org/"
    description="The Anti-Defamation League offers resources for having productive conversations about identity, bias, and inclusion." >}}
...
{{< drg/next-page
    text="You have connected across differences through genuine conversation."
    teaser="Now find someone in your community who has made a real impact in promoting diversity and inclusion — and learn from their story."
