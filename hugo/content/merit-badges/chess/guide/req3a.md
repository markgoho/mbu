...
{{< drg/image src="images/chess-piece-lineup.avif" alt="Six classic Staunton chess pieces in a row — king, queen, rook, bishop, knight, pawn — each labeled with its name" >}}
...
{{< drg/external-link
    title="ChessKid — Learn the Pieces"
    url="https://www.chesskid.com/learn-how-to-play-chess"
    description="Kid-friendly interactive lessons on piece names, movement, and basic rules." >}}

Now that you know your army, it is time to arrange them for battle.

{{< drg/next-page
    text="Now that you know each piece by name"
    teaser="Learn the correct way to set up a chessboard."
