...
{{< drg/tip >}}
Scholar's Mate is easy to defend against once you know it. After 3. Qh5, Black should play 3...g6!, attacking the queen and forcing it to retreat. Then Black can develop normally with a good position. Knowing this trap protects you from falling for it *and* helps you punish opponents who try it.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Fool's Mate almost never happens in tournament play because it requires White to make two terrible moves in a row. But it is an excellent teaching tool — it shows new players exactly how dangerous it is to weaken the king's position with careless pawn moves.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
When demonstrating these patterns for your counselor, make sure you can explain not just the *moves* but the *ideas*. Why does each trap work? What mistake did the losing side make? How could they have defended? A Scout who understands the "why" impresses more than one who just memorizes moves.
{{< /drg/safety-first >}}
...
Unlike the other patterns, Noah's Ark Trap does not end in checkmate — it wins material. Arising from the Ruy Lopez (which you learned in [Req 4c](/merit-badges/chess/guide/req4c/)), Black uses pawn advances (...a6, ...b5) and a knight maneuver (...Na5) to trap White's bishop on b3. The bishop has no escape squares, and White loses a piece.
...
{{< drg/image src="images/chess-scholars-mate.avif" alt="Chess board diagram showing the final position of Scholar's Mate with the queen delivering checkmate on f7 supported by the bishop" >}}
...
{{< drg/external-link
    title="Lichess Checkmate Patterns Practice"
    url="https://lichess.org/practice/checkmate-patterns/piece-checkmates-i/JGmNVMjy/tVMlnUeB"
    description="Practice recognizing and delivering checkmate patterns in interactive exercises." >}}
...
{{< drg/next-page
    text="Now that you know the famous checkmate patterns"
    teaser="Explore the strategic elements that guide your long-term plans."
