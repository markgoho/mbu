...
{{< drg/tip >}}
The next time you face a tough decision at school or in your troop, try the chess player's approach: identify your options, consider what could go wrong with each one, and choose the option that gives you the best position going forward — even if it is not the flashiest choice.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Handling a Tough Loss" >}}
Everyone loses at chess. Even World Champions lose. The key is how you respond:

- **Stay calm.** Take a breath. Do not slam pieces or walk away from the board.
- **Congratulate your opponent** sincerely.
- **Review the game later** to find where you went wrong — every loss is a lesson if you study it.
- **Remember**: your chess rating goes up over time as you improve. One game does not define you as a player.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="USCF Sportsmanship Guidelines"
    url="https://new.uschess.org/sites/default/files/media/documents/us-chess-lets-play-fair-2022.pdf"
    description="The US Chess Federation's official guide to fair play and sportsmanship for tournament players." >}}
...
{{< drg/next-page
    text="Now that you understand the value of chess"
    teaser="Meet the six pieces that make up your army."
