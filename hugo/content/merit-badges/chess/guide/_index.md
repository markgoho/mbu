...
{{< drg/image src="images/chess-overview-scene.avif" alt="A wooden chess set on an outdoor picnic table at a campsite, with pine trees in the background and warm afternoon sunlight casting long shadows across the board" >}}
...
{{< drg/did-you-know >}}
After just four moves by each player, there are more than 288 billion possible board positions. The total number of possible chess games is estimated to exceed the number of atoms in the observable universe.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/chess-get-ready.avif" alt="Two teenagers sitting across from each other at a chess board in a community center, one mid-move, both concentrating intently, with a chess clock beside the board" >}}
...
{{< drg/tip >}}
Start with longer time controls (15 minutes or more per side) when you are learning. Blitz is fun, but you will build better habits when you have time to think through your moves.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="Lichess — Free, Open-Source Chess"
    url="https://lichess.org"
    description="Play chess for free against players worldwide, solve puzzles, and analyze your games — no ads, no paywalls." >}}
...
{{< drg/did-you-know >}}
Chess960 gets its name from the 960 possible starting positions for the pieces. Bobby Fischer designed the variant specifically to reduce the advantage of opening memorization and emphasize creativity.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="Now that you know what chess is all about"
    teaser="Discover how a game from ancient India conquered the world."
    url="/merit-badges/chess/guide/req1a/" >}}
