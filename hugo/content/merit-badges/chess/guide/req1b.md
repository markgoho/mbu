...
{{< drg/did-you-know >}}
Bobby Fischer's IQ was estimated at 181. He dropped out of high school at 16 to focus entirely on chess, saying, "All I want to do, ever, is play chess."
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/chess-famous-players.avif" alt="Six portrait-style illustrations of chess players in thoughtful poses, each seated at a chess board, arranged in two rows of three" >}}
...
{{< drg/checklist title="Research Framework" subtitle="Use these questions to guide your research" >}}
...
{{< drg/tip >}}
Do not just list facts. When you discuss your player with your counselor, tell their *story*. What drove them? What obstacles did they face? What made them different from every other strong player of their era?
{{< /drg/tip >}}

## Where to Find Reliable Information

{{< drg/external-link
    title="Chess.com Player Biographies"
    url="https://www.chess.com/players"
    description="Detailed biographies and game collections of the greatest chess players in history." >}}

You can also find famous games by these players on databases like Lichess and Chessgames.com — replaying their games is one of the best ways to understand what made them great.

{{< drg/be-prepared title="Preparing for Your Counselor Discussion" >}}
Your counselor will want more than a Wikipedia summary. Be ready to:

- **Explain** what made your player's style unique — could you describe their approach in one sentence?
- **Show** a famous game if possible — even walking through 5–10 key moves demonstrates deeper understanding.
- **Connect** their accomplishments to the bigger picture of chess history (covered in Req 1a).
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="Now that you've met the legends"
    teaser="Learn why chess is the ultimate game of strategy and how it sharpens your mind."
