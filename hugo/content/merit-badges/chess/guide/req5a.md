...
req_number: "5a"
prev: "/merit-badges/chess/guide/req4d/"
prev_title: "Req 4d — Famous Checkmates & Traps"
next: "/merit-badges/chess/guide/req5b/"
next_title: "Req 5b — Chess Tactics"
---
...
{{< drg/tip >}}
When you are ahead in material, simplify. Trade pieces, reduce complications, and convert your advantage in a quiet endgame. When you are behind in material, complicate. Keep pieces on the board, create threats, and look for tactical tricks.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Philidor's famous 18th-century statement — "Pawns are the soul of chess" — was radical at the time. Other players viewed pawns as expendable foot soldiers. Philidor understood that pawn structure determines which pieces are good, where attacks should happen, and who holds the long-term advantage.
{{< /drg/did-you-know >}}
...
- In the openings from [Req 4c](/merit-badges/chess/guide/req4c/), the Ruy Lopez (3. Bb5) gains tempo by forcing Black to spend a move on ...a6.
...
{{< drg/be-prepared title="Choosing Your Four" >}}
You need to explain four of these seven elements. Pick the four you understand best, but be ready for your counselor to ask follow-up questions. A strong approach:

- **Explain the concept** in one or two sentences.
- **Give a concrete example** — a position type or game scenario that illustrates it.
- **Connect it to your own games** — can you remember a time when pawn structure or tempo affected one of your games?
{{< /drg/be-prepared >}}

{{< drg/image src="images/chess-strategy-elements.avif" alt="Infographic showing seven hexagonal tiles in a honeycomb pattern, each labeled with a strategic chess element: Weaknesses, Force, King Safety, Pawn Structure, Space, Tempo, and Clock Management" >}}

{{< drg/external-link
    title="Lichess — Strategic Concepts"
    url="https://lichess.org/practice"
    description="Interactive practice sets covering key strategic concepts including pawn structure, piece activity, and endgame technique." >}}

Strategy gives you the plan. But you also need the tools to execute it — and those tools are called tactics.

{{< drg/next-page
    text="Now that you understand strategic thinking"
    teaser="Learn the tactical weapons that win games: forks, pins, skewers, and more."
