...
req_number: "1a"
prev: "/merit-badges/chess/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/chess/guide/req1b/"
next_title: "Req 1b — Famous Chess Players"
---
...
{{< drg/did-you-know >}}
The original Ashtāpada board was also used for a racing game involving dice. When Chaturanga was invented, the dice were dropped — making it one of the first pure strategy games in history, where victory depended entirely on skill.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When discussing chess history with your counselor, try to explain *why* the game changed — not just *what* changed. The "Mad Queen" reform happened during a period when powerful queens like Isabella of Castile were reshaping European politics.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="Chess History Timeline — Chess.com"
    url="https://www.chess.com/article/view/history-of-chess"
    description="A detailed interactive timeline of chess history from ancient India to the modern era." >}}
...
{{< drg/image src="images/chess-history-timeline.avif" alt="An infographic-style timeline showing key moments in chess history from ancient India through medieval Europe to modern day" >}}
...
{{< drg/next-page
    ...
    teaser="Research a famous chess player who changed the game."
