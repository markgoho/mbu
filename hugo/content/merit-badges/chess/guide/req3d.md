...
{{< drg/did-you-know >}}
In 2022, a study of online chess games found that stalemate occurs in roughly 3–5% of games between intermediate players — most often when the winning side gets careless in a dominant position. At the grandmaster level, stalemate is almost always intentional — a deliberate escape from a lost position.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Never offer a draw in a position where you are clearly winning — your opponent will decline, and it can seem unsportsmanlike. Similarly, do not make repeated draw offers in a losing position. Let the game speak for itself.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Using Draws as a Defensive Weapon" >}}
When you are losing, do not give up. Look for drawing chances:

- **Stalemate**: If your opponent has a big material advantage, can you maneuver your king to a corner where it has no moves?
- **Perpetual check**: Can you keep checking the opponent's king, forcing them to repeat positions?
- **Fortress**: Can you build a defensive position so solid that your opponent cannot break through within 50 moves?
- **Sacrifice material** to reach a position with insufficient material (e.g., trade down to king vs. king and bishop).

Many "lost" games are saved by players who refuse to resign and find creative drawing resources.
{{< /drg/be-prepared >}}
...
{{< drg/image src="images/chess-stalemate-position.avif" alt="Chess board diagram showing a classic stalemate position with the king trapped in the corner with no legal moves but not in check" >}}

{{< drg/external-link
    title="Lichess — Practice Draw Scenarios"
    url="https://lichess.org/practice/basic-endgames/stalemate/UFRnjnMb/hyHKGR20"
    description="Interactive exercises where you practice identifying and avoiding stalemate in simple endgame positions." >}}
...
{{< drg/next-page
    text="Now that you know all the rules"
    teaser="Learn how to write down chess moves in algebraic notation."
