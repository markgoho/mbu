...
{{< drg/tip >}}
If you are stuck, try working backward. Imagine the checkmate position — where would all the pieces need to be? Then figure out how to reach that position in the allowed number of moves.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Chess composition — the art of creating beautiful mate problems — has been a respected discipline since the 9th century. The best problems feature surprising "key moves" that are hard to find, elegant solutions, and positions that look natural. Some composers spend months crafting a single problem.
{{< /drg/did-you-know >}}

## Where to Practice

{{< drg/external-link
    title="Lichess Puzzles — Mate-in-1"
    url="https://lichess.org/training/mateIn1"
    description="Hundreds of mate-in-1 puzzles to build your checkmate pattern recognition. Free, unlimited, and sorted by difficulty." >}}

{{< drg/external-link
    title="Lichess Puzzles — Mate-in-2"
    url="https://lichess.org/training/mateIn2"
    description="Mate-in-2 puzzles that challenge you to think two moves ahead. A great next step after mastering mate-in-1." >}}
...
{{< drg/image src="images/chess-mate-patterns.avif" alt="Four chess board diagrams showing common checkmate patterns: back-rank mate, smothered mate, Arabian mate, and queen-and-bishop mate" >}}

{{< drg/be-prepared title="At Your Counselor Meeting" >}}
When your counselor gives you five problems:

- **Take your time.** There is no clock. Think through each problem carefully.
- **Talk through your thinking** if asked. Explaining your reasoning demonstrates understanding better than just announcing the answer.
- **If you get one wrong**, ask your counselor to show the solution. Understanding why you missed it is more valuable than getting it right by guessing.
- **Do not be discouraged** if some problems are hard. Mate-in-3 or longer problems can stump even experienced players.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="Now that you can solve checkmate puzzles"
    teaser="Learn how chess tournaments are organized, scored, and rated."
