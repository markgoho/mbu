...
1. **Practice your notation** ([Req 4a](/merit-badges/chess/guide/req4a/)) so you can record every move during the game.
...
- **The opening**: What opening did you play? Did you follow the principles from [Req 4c](/merit-badges/chess/guide/req4c/)?
...
{{< drg/tip >}}
If you played your games online (with your counselor's approval), you can use the computer analysis feature on Lichess or Chess.com to identify your mistakes. Then bring the annotated game to your counselor meeting.
{{< /drg/tip >}}
...
This option takes things to the next level. A real tournament gives you the experience of tournament pairings, time controls, and the atmosphere of competitive play — all concepts you studied in [Req 6](/merit-badges/chess/guide/req6/).
...
{{< drg/checklist title="Tournament Preparation" subtitle="Be ready for your first tournament" >}}
...
{{< drg/be-prepared title="Your First Tournament" >}}
First tournaments can feel intimidating. Here is how to handle it:

- **Nerves are normal.** Even grandmasters get nervous before important games. Take a few deep breaths before each round.
- **Focus on playing your best**, not on winning. Learning from every game matters more than the result.
- **Record your moves** carefully. You will want those score sheets later.
- **Be gracious** in both victory and defeat — sportsmanship matters most (review [Req 2](/merit-badges/chess/guide/req2/) on etiquette).
{{< /drg/be-prepared >}}
...
**Step 1: Choose a format.** With 4–5 players, a **round robin** works perfectly — everyone plays everyone. With more players, consider a **Swiss system** with 3–4 rounds (see [Req 6](/merit-badges/chess/guide/req6/) for details on both formats).
...
{{< drg/checklist title="Tournament Director Duties" subtitle="What the TD does each round" >}}
...
{{< drg/image src="images/chess-club-tournament.avif" alt="A small casual chess tournament in a community room with teenagers playing chess and a tournament bracket on a whiteboard in the background" >}}
...
{{< drg/external-link
    title="US Chess — How to Run a Tournament"
    url="https://new.uschess.org/how-run-chess-tournament"
    description="The US Chess Federation's guide to organizing chess events, from casual meetups to rated tournaments." >}}
...
{{< drg/next-page
    text="Now that you've completed all the requirements"
    teaser="Explore advanced topics, find chess communities, and continue your chess journey."
    url="/merit-badges/chess/guide/extended-learning/" >}}
