...
In [Req 4b](/merit-badges/chess/guide/req4b/), you learned that the opening is about development, center control, and king safety. Now let's get specific: four principles to guide your opening play, and four of the most important openings in chess history.
...
{{< drg/tip >}}
These four principles are guidelines, not laws. Strong players sometimes break them for specific reasons (like the Scandinavian Defense, which develops the queen early). But until you can explain *why* you are breaking a principle, follow it.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The Queen's Gambit is called a "gambit" because White offers the c4 pawn, but if Black takes it (2...dxc4), White can usually win it back quickly. A true gambit — like the King's Gambit (1. e4 e5 2. f4) — sacrifices material for attacking chances without expecting it back immediately.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/chess-four-openings.avif" alt="Four chess board diagrams showing positions after five moves of the Ruy Lopez, French Defense, Queen's Gambit Declined, and Sicilian Defense" >}}

## Preparing for Your Counselor

{{< drg/checklist title="Opening Demonstration Checklist" subtitle="Be ready to show your counselor all of these" >}}
...
{{< drg/external-link
    ...
    description="Explore any opening move by move, see how often each continuation is played, and view statistics from millions of games." >}}
...
{{< drg/next-page
    text="Now that you know the four openings"
    teaser="Learn Scholar's Mate, Fool's Mate, and three more famous checkmate patterns."
