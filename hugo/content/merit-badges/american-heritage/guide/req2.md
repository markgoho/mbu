...
{{< drg/tip >}}
Choose people from different time periods or backgrounds. Comparing a founding-era leader with a 20th-century private citizen creates a richer contrast.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    description="Search for biographical information on any member of Congress, past or present." >}}
...
{{< drg/did-you-know >}}
The Boy Scouts of America was founded in 1910 and has been promoting citizenship, character, and fitness for over a century. Scouting itself is an organization that changed American society.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    title="Library of Congress — Primary Sources by Topic"
    url="https://www.loc.gov/classroom-materials/primary-sources-by-topic/"
    description="Explore primary source documents organized by historical topic — great for researching organizations and movements." >}}
...
{{< drg/safety-first >}}
Always get your counselor's approval before conducting interviews. Be respectful of the veteran's time and boundaries. Some experiences may be difficult to talk about — let the veteran share what they are comfortable sharing.
{{< /drg/safety-first >}}

### Interview Tips

{{< drg/checklist title="Interview Preparation" subtitle="Steps to prepare for a great interview" >}}
...
{{< drg/tip >}}
After all three interviews, look for patterns. Did your interviewees agree on anything? Where did they disagree? The differences are just as interesting as the similarities.
{{< /drg/tip >}}

{{< drg/image src="images/scout-interviewing-veteran.avif" alt="A Scout sitting across from a veteran in a living room, holding a notebook and listening attentively during an interview" >}}
...
{{< drg/next-page
    text="You have studied the people and groups who built America's heritage."
    teaser="See how current events are connected to America's past — and explore the symbols that unite us."
