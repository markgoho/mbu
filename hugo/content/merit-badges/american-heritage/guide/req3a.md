...
{{< drg/tip >}}
Avoid topics that are purely entertainment or sports news. Look for stories about government, rights, the economy, the environment, immigration, or national security — these have the deepest historical roots.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="PBS NewsHour — Student Reporting Labs"
    url="https://studentreportinglabs.com/"
    description="News stories and media literacy resources designed for students. A great starting point for finding current events." >}}
...
{{< drg/be-prepared title="Not Sure About the History?" >}}
If you find a current event but are not sure about its historical roots:
- **Step one:** Search for your topic + "history" or "timeline" to find background.
- **Step two:** Check your school or public library for books on the broader subject.
- **Step three:** Ask a teacher, librarian, or your merit badge counselor for suggestions.
- **Step four:** Look for primary source documents at the Library of Congress website.
{{< /drg/be-prepared >}}

{{< drg/did-you-know >}}
The Library of Congress is the largest library in the world, with more than 170 million items. Its digital collection lets you explore primary sources — original documents, photographs, and recordings — from almost every period of American history, all for free.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/scout-reading-news.avif" alt="A Scout sitting in a library reading a newspaper, with historical books and a laptop on the table nearby" >}}
...
{{< drg/next-page
    text="You have explored how today's events connect to America's past."
    teaser="Learn the stories behind the flag, the anthem, the Great Seal, and other national symbols."
