...
{{< drg/external-link
    title="National Register of Historic Places — Search by Location"
    url="https://www.nps.gov/subjects/nationalregister/database-research.htm"
    description="Search the National Register database to find listed properties near you. You can search by state, county, or city." >}}
...
{{< drg/tip >}}
Start with the National Register database to find listed properties near you. Then add other historical points of interest — old buildings, monuments, battlefields, historic markers, cemeteries, or sites of important local events. Your public library and local historical society are great resources for finding these.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Historical markers exist in every state. The Historical Marker Database (HMdb.org) catalogs more than 200,000 markers across the United States, making it easy to find ones near you.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Compare old photographs of your town with how it looks today. Many libraries and historical societies have photo archives. The contrast between then and now can be striking and makes a great visual for your counselor presentation.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="National Trails System — National Park Service"
    url="https://www.nps.gov/subjects/nationaltrailssystem/index.htm"
    description="Explore the national system of trails including National Historic Trails, National Scenic Trails, and National Recreation Trails." >}}
...
{{< drg/image src="images/historic-trail-marker.avif" alt="A Scout standing next to a historic trail marker, reading the information on the plaque with a notepad in hand" >}}
...
{{< drg/next-page
    text="You have discovered the historical landmarks and stories in your community."
    teaser="Explore American heritage through the lens of film, literature, and music."
