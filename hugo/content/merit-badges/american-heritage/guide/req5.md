...
{{< drg/tip >}}
Choose films from two different periods of American history. This gives you more to compare and shows your counselor that you explored a range of the American experience.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Sorting Fact from Fiction" >}}
After watching each film, use this process to evaluate it:
- **Step one:** Write down the major events and characters.
- **Step two:** Research the actual history — use books, encyclopedias, or reliable websites.
- **Step three:** Compare the film's version to the real story. Note what matched and what did not.
- **Step four:** Consider *why* the filmmakers might have changed things — entertainment, time limits, or a particular perspective.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    title="Library of Congress — Read.gov"
    url="https://read.gov/"
    description="Free access to classic American books, including biographies, through the Library of Congress." >}}
...
{{< drg/tip >}}
Keep a reading journal as you go through the biography. Jot down quotes, events, and your reactions. This will make your counselor discussion much easier.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    description="The Smithsonian's collection of American folk music, spoken word, and sound recordings — a treasure trove of historical music." >}}
...
{{< drg/did-you-know >}}
"The Battle Hymn of the Republic," written by Julia Ward Howe in 1861, was set to the tune of "John Brown's Body," a marching song already popular with Union soldiers. Howe wrote her new lyrics after visiting an army camp near Washington, D.C.
{{< /drg/did-you-know >}}

{{< drg/image src="images/scout-listening-music.avif" alt="A Scout wearing headphones in a library, surrounded by books and a laptop, listening to historical music recordings and taking notes" >}}
...
{{< drg/next-page
    text="You have experienced American heritage through film, books, or music."
    teaser="Discover career opportunities in heritage preservation and related fields."
