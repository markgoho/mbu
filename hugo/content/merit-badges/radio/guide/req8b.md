...
{{< drg/requirement number="8" option="Radio Broadcasting" >}}
...
- **[Req 8b1 — Broadcast Regulations](../req8b1/):** Discuss FCC broadcast rules including power levels, frequencies, and low-power station regulations.
- **[Req 8b2 — Produce a Program](../req8b2/):** Create and record a half-hour program schedule for fictional station "KBSA."
- **[Req 8b3 — Log Broadcast Stations](../req8b3/):** Listen to and log 15 broadcast stations, analyzing format and audience for five.
- **[Req 8b4 — Broadcasting Terms](../req8b4/):** Explain at least eight commercial broadcasting terms.
- **[Req 8b5 — Alternative Platforms](../req8b5/):** Discuss internet streaming, satellite radio, and podcasts with your counselor.
...
{{< drg/next-page
    text="Start with the regulatory framework"
    teaser="Learn how the FCC regulates broadcast power, frequencies, and low-power stations."
    url="/merit-badges/radio/guide/req8b1/" >}}
