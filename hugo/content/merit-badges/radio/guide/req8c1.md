...
{{< drg/tip >}}
Start on well-known frequencies. The BBC World Service, Radio Havana Cuba, Radio Romania International, and China Radio International are all relatively easy to find and identify. Short-wave.info is a helpful database for finding who's broadcasting on what frequency right now.
{{< /drg/tip >}}

---

{{< drg/next-page
    text="Shortwave sessions are logged"
    teaser="Now switch to the AM broadcast band for two one-hour medium-wave listening sessions."
    url="/merit-badges/radio/guide/req8c2/" >}}
