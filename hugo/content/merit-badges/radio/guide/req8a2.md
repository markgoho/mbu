...
{{< drg/tip >}}
Many ham clubs run special "Ham in a Day" events for Scouts where you study in the morning and take the Technician exam in the afternoon. Ask your merit badge counselor or local ARRL section about upcoming sessions.
{{< /drg/tip >}}

{{< drg/external-link
    title="Find an Amateur Radio Exam Session — ARRL"
    url="https://www.arrl.org/find-an-amateur-radio-license-exam-session"
    description="Search for upcoming Volunteer Examiner sessions near you." >}}

---

{{< drg/next-page
    text="You know the license classes"
    teaser="Now learn the shorthand language hams use on the air — Q signals and common amateur radio terms."
    url="/merit-badges/radio/guide/req8a3/" >}}
