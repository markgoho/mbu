...
{{< drg/requirement number="8" option="Amateur Radio" >}}
...
- **[Req 8a1 — Why Amateur Radio Exists](../req8a1/):** Learn why the FCC created the amateur service and what licensed hams can do on the air.
- **[Req 8a2 — License Classes](../req8a2/):** Understand the three amateur license levels — Technician, General, and Extra — and who administers the exams.
- **[Req 8a3 — Q Signals & Terms](../req8a3/):** Learn at least five Q signals or amateur radio terms used in everyday ham communication.
- **[Req 8a4 — Emergency Calls](../req8a4/):** Know how to make an emergency call on voice or Morse code.
- **[Req 8a5 — Transceivers & Repeaters](../req8a5/):** Compare handheld, mobile, and base station radios and understand how repeaters extend range.
- **[Req 8a6 — Make a Contact](../req8a6/):** Conduct a 10-minute real or simulated contact using proper procedures and log it.

### Getting Started

If possible, contact a local amateur radio club before beginning these requirements. The American Radio Relay League (ARRL) maintains a [club finder](https://www.arrl.org/find-a-club) that can connect you with hams in your area. Many clubs offer "ham-in-a-day" events, field days, and mentoring specifically for Scouts.

{{< drg/next-page
    text="Start with the foundation"
    teaser="Learn why the FCC created amateur radio and what activities licensed operators can pursue."
    url="/merit-badges/radio/guide/req8a1/" >}}
