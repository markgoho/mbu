...
{{< drg/safety-first >}}
The FCC rules (§97.405) explicitly state that no amateur radio rule prevents an operator from providing communications needed for the immediate safety of human life or immediate protection of property. In a true emergency, use whatever frequency and mode gives you the best chance of being heard. Worry about the rules later.
{{< /drg/safety-first >}}

---

{{< drg/next-page
    text="You know how to call for help"
    teaser="Next, compare the three types of transceivers — handheld, mobile, and base — and learn how repeaters extend your range."
    url="/merit-badges/radio/guide/req8a5/" >}}
