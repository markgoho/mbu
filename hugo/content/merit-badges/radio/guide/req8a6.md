...
{{< drg/tip >}}
If you're doing a simulated contact (no actual radio transmission), set up the scenario as realistically as possible. Sit with your counselor or a licensed ham, use real call signs and proper procedures, and fill out a real log. The goal is to demonstrate that you know the protocol — simulation is explicitly allowed by the requirement.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="Option A is complete"
    teaser="Browse Option B next — or skip ahead to Requirement 9 (Careers) if you've finished your chosen option."
    url="/merit-badges/radio/guide/req8b/" >}}
