...
{{< drg/image src="images/smartphone-radio-systems.avif" alt="Diagram of a smartphone connecting to a cell tower, Wi-Fi router, Bluetooth earbuds, GPS satellites, and an NFC payment terminal" >}}
...
{{< drg/tip >}}
On most phones, you can re-enable Wi-Fi and Bluetooth individually while Airplane Mode is still on. Airlines often allow this, which is how you can use in-flight Wi-Fi while still complying with the cellular radio restriction.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Never rely solely on a cell phone for emergency communication in the backcountry. Carry a backup: a satellite messenger (Garmin inReach, SPOT), a personal locator beacon (PLB), or at minimum, leave a detailed trip plan with someone who will raise the alarm if you don't check in.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Wireless charging is really just radio at extremely close range and very low frequency. The charging pad is a transmitter, the phone is a receiver, and the "signal" is a magnetic field carrying power instead of information. Nikola Tesla demonstrated similar wireless power transfer over 100 years ago.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You've built a strong foundation in radio"
    teaser="Choose one of five hands-on options: amateur radio, broadcasting, shortwave listening, direction finding, or FRS/GMRS walkie-talkies."
    url="/merit-badges/radio/guide/req8/" >}}
