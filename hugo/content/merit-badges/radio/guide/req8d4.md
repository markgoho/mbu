...
{{< drg/be-prepared title="Fox Hunt Gear Checklist" >}}
- Directional antenna (your tape-measure Yagi)
- VHF receiver (HT or provided receiver)
- Compass
- Map of the hunt area
- Attenuator (if available)
- Comfortable walking shoes
- Water bottle
- Notebook and pencil for logging bearings
{{< /drg/be-prepared >}}

---

{{< drg/next-page
    text="You found the fox"
    teaser="Now map your hunt — show the path you took and the bearings you used to locate the transmitter."
    url="/merit-badges/radio/guide/req8d5/" >}}
