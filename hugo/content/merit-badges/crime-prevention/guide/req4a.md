...
{{< drg/did-you-know >}}
Research consistently shows that after-school programs reduce juvenile crime by as much as 20% in communities where they're available. The key factor isn't the specific activity — it's having a safe place with caring adults during the hours when young people are most vulnerable.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
As you prepare for the security survey in Req 4b, start looking at your own neighborhood through CPTED eyes. Notice where the lighting is good and where it's poor. Look for hiding spots created by overgrown bushes. See which buildings have windows facing the street and which have blank walls. You're training yourself to see what criminals see — and that's the first step to fixing it.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="CPTED Guidelines — National Institute of Crime Prevention"
    url="https://www.cpted.net/"
    description="Learn more about Crime Prevention Through Environmental Design principles and certification programs." >}}

{{< drg/image src="images/cpted-neighborhood-comparison.avif" alt="Side-by-side comparison of a residential street — left side shows neglected design with overgrown bushes and broken streetlight; right side shows good design with trimmed landscaping and bright lighting" >}}

{{< drg/next-page
    text="Now that you understand how design and community prevent crime"
    teaser="Put these principles into practice by conducting a real security survey."
