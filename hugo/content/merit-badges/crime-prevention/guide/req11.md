...
{{< drg/tip >}}
Choose three careers that genuinely interest you, not just the most obvious ones. If you're into computers, cybersecurity analyst might be fascinating. If you love science, forensic science could be your path. If you care about helping people directly, victim advocacy or social work might call to you.
{{< /drg/tip >}}
...
{{< drg/external-link
    ...
    description="Detailed career profiles including job duties, education requirements, salary data, and employment outlook for hundreds of occupations." >}}
...
{{< drg/did-you-know >}}
Many crime prevention professionals say their career path wasn't a straight line. A cybersecurity analyst might have started in IT support. A victim advocate might have begun as a social worker. A crime analyst might have majored in math before discovering that criminal justice needed data experts. Keeping your options open and building transferable skills is often the best career strategy.
{{< /drg/did-you-know >}}

{{< drg/image src="images/crime-prevention-careers-montage.avif" alt="A four-panel infographic showing different crime prevention careers — forensic scientist, cybersecurity analyst, community officer, and urban planner" >}}

{{< drg/next-page
    text="You've completed all the requirements"
    teaser="Explore extended learning opportunities to go even deeper into crime prevention."
    url="/merit-badges/crime-prevention/guide/extended-learning/" >}}
