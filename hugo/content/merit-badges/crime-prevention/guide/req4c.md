---
title: "Teaching Crime Prevention"
layout: guide
group_title: "4. Home & Neighborhood Safety"
req_number: "4c"
prev: "/merit-badges/crime-prevention/guide/req4b/"
prev_title: "Conducting a Security Survey"
next: "/merit-badges/crime-prevention/guide/req5/"
next_title: "Retail Crime Prevention"
---
...
{{< drg/tip >}}
The EDGE method works best when you focus on one or two key topics rather than trying to cover everything from your survey. Pick the most important vulnerabilities you found and teach those well. A focused lesson that sticks is better than an overwhelming one that people forget.
{{< /drg/tip >}}
...
{{< drg/checklist title="Lesson Plan Template" subtitle="Fill in for your specific topic" >}}
...
{{< drg/be-prepared title="Sample Lesson: Home Lighting Security" >}}
Here's how an EDGE lesson on exterior lighting might look:

**Explain** (2 min): "I did a security survey of our house and found that three exterior lights are burned out. Poor lighting is one of the biggest factors that makes a home a target — burglars prefer to work in the dark."

**Demonstrate** (3 min): Walk outside and show the three dark areas. Compare them to the well-lit front entrance. "See how much harder it would be for someone to approach unseen here versus over there?"

**Guide** (5 min): Give each person a flashlight and have them walk the perimeter. "Find one more spot where lighting is weak or missing. What would you recommend?"

**Enable** (2 min): "This week, I need your help. Mom and Dad, can we replace these three bulbs? And going forward, if you notice a light is out, let's fix it within 24 hours."
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Teaching EDGE — Scouting America"
    url="https://www.scouting.org/training/youth/edge/"
    description="Scouting America's guide to the EDGE teaching method, with additional tips and examples." >}}

{{< drg/image src="images/edge-method-teaching.avif" alt="A teenager standing in front of a small group of seated Scouts, pointing at a poster or whiteboard showing a simple home security diagram during an EDGE method presentation" >}}

{{< drg/next-page
    text="With your crime prevention lesson delivered"
    teaser="Shift focus to the retail world — how stores protect against shoplifting and employee theft."
