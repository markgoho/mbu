---
title: "Retail Crime Prevention"
layout: guide
group_title: "5. Retail Crime Prevention"
req_number: "5"
prev: "/merit-badges/crime-prevention/guide/req4c/"
prev_title: "Teaching Crime Prevention"
next: "/merit-badges/crime-prevention/guide/req6/"
next_title: "Reporting Crime"
---
...
{{< drg/did-you-know >}}
When a store closes due to excessive theft or lost profitability, it creates what's called a "retail desert" — a neighborhood without convenient access to groceries, pharmacies, or everyday goods. Communities that lose stores often see further economic decline, making retail crime a community-wide problem, not just a business one.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Notice the overlap with CPTED from Req 4a? Natural surveillance (open sightlines, visible staff), access control (checkout gates, fitting room limits), and territorial reinforcement (signage, maintained spaces) apply to retail just like they do to neighborhoods. Crime prevention principles are universal.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
If you ever witness shoplifting in progress, **do not confront the shoplifter.** Tell a store employee or manager and let trained loss prevention professionals handle the situation. Confronting a thief can be dangerous — some shoplifters become violent when caught, and many states have laws about who can legally detain a suspected shoplifter.
{{< /drg/safety-first >}}

{{< drg/external-link
    title="National Retail Federation — Retail Security"
    url="https://nrf.com/research/national-retail-security-survey"
    description="Annual survey data on retail shrinkage, organized retail crime, and loss prevention strategies." >}}

{{< drg/image src="images/retail-loss-prevention-techniques.avif" alt="Interior of a retail store showing visible security measures — a convex mirror in the corner, a security camera on the ceiling, an EAS gate at the exit, and an attentive employee on the sales floor" >}}

{{< drg/next-page
    text="Now that you understand how retail crime affects communities"
    teaser="Learn when and how to report crimes — and the warning signs that someone may be in danger."
