...
{{< drg/tip >}}
News stories often mention which agency is "leading the investigation" or which court the case was filed in. Look for phrases like "the FBI is investigating," "arraigned in county court," or "the district attorney's office charged." These clues tell you exactly who is involved.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Criminologists use a concept called the "Crime Triangle" to analyze why crimes happen. Every crime requires three elements: a motivated offender, a suitable target, and the absence of a capable guardian (someone or something that could prevent it). Remove any one of the three, and the crime doesn't happen.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="Presenting to Your Counselor" >}}
When you review your research with your counselor, organize your notes clearly:

- **For each crime**, have a brief summary of what happened, which agencies and courts were involved, your analysis of why it was committed, and your prevention ideas.
- **Be ready to discuss** — your counselor will likely ask follow-up questions. Why do you think one prevention strategy would work better than another? Could the crime have been prevented at multiple points?
- **Show your sources** — bring your notes, printouts, or bookmarks so your counselor can see the quality of your research.
{{< /drg/be-prepared >}}

{{< drg/checklist title="Analysis Notes Template" subtitle="Complete this for each of your three crimes" >}}
...
{{< drg/image src="images/crime-triangle-diagram.avif" alt="A triangular diagram showing the Crime Triangle with three vertices labeled Motivated Offender, Suitable Target, and Absence of Guardian" >}}

{{< drg/external-link
    title="FBI Crime Data Explorer"
    url="https://cde.ucr.cjis.gov/"
    description="Search and explore national crime data by state, agency, and crime type to support your research." >}}

{{< drg/next-page
    text="With your crime research complete"
    teaser="Shift focus to your own backyard — how communities and physical spaces prevent crime."
