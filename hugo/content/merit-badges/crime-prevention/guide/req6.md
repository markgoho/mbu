...
{{< drg/be-prepared title="Making a Good Report" >}}
When you report a crime or suspicious activity, clear information helps law enforcement respond effectively:

- **What happened** — Describe what you saw or what occurred
- **Where** — Give the exact address or location, including landmarks
- **When** — Note the time it happened or when you noticed it
- **Who** — Describe any people involved (clothing, height, hair color, direction of travel)
- **Vehicles** — Note make, model, color, and license plate if possible
- **Your safety** — Stay on the line, stay in a safe location, and follow the dispatcher's instructions
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    ...
    description="24/7 crisis line (1-800-422-4453) offering help for children and adults dealing with child abuse." >}}

{{< drg/image src="images/reporting-crime-safely.avif" alt="A teenager using a smartphone to call for help while standing in a safe, well-lit public area near other people" >}}

{{< drg/next-page
    text="Now that you know how and when to report"
    teaser="Explore how your peers influence crime — and how to resist negative pressure."
