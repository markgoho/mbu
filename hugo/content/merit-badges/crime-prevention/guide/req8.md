...
{{< drg/safety-first >}}
Fentanyl has changed the drug landscape dramatically. It is now mixed into counterfeit pills, cocaine, heroin, and other substances — often without the user's knowledge. There is no way to see, smell, or taste fentanyl, and an amount small enough to fit on the tip of a pencil can kill. This makes any use of illegal drugs significantly more dangerous than it was even a decade ago.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Crisis Resources" subtitle="Save these numbers — you may need them for yourself or a friend" >}}
...
{{< drg/image src="images/substance-prevention-community.avif" alt="A school assembly with a speaker at a podium and a drug awareness banner, with attentive teenagers in the audience" >}}

{{< drg/next-page
    text="With the substance use and crime connection clear"
    teaser="Turn your attention to the digital world — where a different set of threats awaits."
