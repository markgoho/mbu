...
req_number: "4b"
prev: "/merit-badges/crime-prevention/guide/req4a/"
prev_title: "Req 4a — How Communities Prevent Crime"
next: "/merit-badges/crime-prevention/guide/req4c/"
next_title: "Req 4c — Teaching Crime Prevention"
---
...
{{< drg/safety-first >}}
You must have **adult supervision** throughout your survey. Follow Scouting's Youth Protection guidelines — never go alone, stay with your group, and don't enter any area that feels unsafe. If you're surveying a neighborhood, stay on public sidewalks and don't enter private property without permission. This is an observation exercise, not an investigation.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Try conducting your survey at two different times — once during daylight and once at dusk or after dark (with adult supervision). Lighting problems that are invisible during the day become obvious at night, and areas that feel safe in sunshine may feel very different when the sun goes down.
{{< /drg/tip >}}
...
{{< drg/checklist title="Survey Best Practices" subtitle="Tips for a thorough security assessment" >}}
...
{{< drg/external-link
    title="Home Security Checklist — National Crime Prevention Council"
    url="https://www.ncpc.org/resources/home-neighborhood-safety/"
    description="Additional home and neighborhood security resources from the National Crime Prevention Council." >}}

{{< drg/image src="images/security-survey-in-action.avif" alt="A teenager with a clipboard and an adult walking along the outside of a residential home, looking up at exterior lighting and noting observations" >}}

{{< drg/next-page
    text="With your security survey complete"
    teaser="Turn your findings into a lesson you'll teach to your family or fellow Scouts."
