...
{{< drg/be-prepared title="The Integrity Test" >}}
You notice a classmate left their phone on the cafeteria table after lunch. The cafeteria is emptying out and nobody else has noticed.

- **Recognize** the situation: this is someone's valuable property, left unattended.
- **Act with integrity**: Pick up the phone and bring it to the school office or directly to your classmate.
- **Consider the alternative**: If you walk away, someone else might take it — and a crime that could have been prevented just happened.
...
{{< drg/external-link
    ...
    description="Explore national and state-level crime statistics from the FBI's Uniform Crime Reporting program." >}}

{{< drg/image src="images/types-of-crime-infographic.avif" alt="Infographic showing four categories of crime — property crimes, crimes against people, white collar crime, and environmental crime — each with representative icons and brief descriptions" >}}

{{< drg/next-page
    text="Now that you understand the foundation of criminal law"
    teaser="Discover the groups — from citizens to courts — that work together to prevent crime."
