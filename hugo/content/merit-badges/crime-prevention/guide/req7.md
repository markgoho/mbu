...
{{< drg/be-prepared title="If You Witness Bullying" >}}
You have more power as a bystander than you might think. Research shows that when a bystander intervenes, bullying stops within 10 seconds more than half the time.

- **Don't join in** — Even laughing at bullying encourages it
- **Speak up if safe** — "Hey, that's not cool" or "Leave them alone" can be enough
- **Support the target** — Stand near them, sit with them, include them
- **Report it** — Tell a teacher, coach, counselor, or parent what you saw
...
{{< drg/external-link
    ...
    description="Federal government resources on bullying prevention, cyberbullying, and how to get help." >}}

{{< drg/image src="images/positive-peer-group.avif" alt="A group of teenagers working together on a community service project, cleaning up a park and demonstrating positive peer influence" >}}

{{< drg/next-page
    text="Now that you understand how peers influence behavior"
    teaser="Explore the connection between substance use and crime — and how prevention programs make a difference."
