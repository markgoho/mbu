...
{{< drg/did-you-know >}}
The Wright brothers' 1903 Flyer was powered by a custom-built four-cylinder piston engine that produced only 12 horsepower — about the same as a riding lawn mower. A modern Cessna 172 engine produces about 180 horsepower.
{{< /drg/did-you-know >}}

{{< drg/image src="images/piston-engine-diagram.avif" alt="A simplified cutaway diagram of a four-cylinder aircraft piston engine showing the pistons, crankshaft, and propeller connection, with labels for each major component" >}}
...
{{< drg/tip >}}
Here is a simple way to remember the three engine types: **Piston** engines use explosions to push pistons that turn a propeller. **Turbine** engines use continuous combustion to spin a turbine that turns a propeller. **Jet** engines use continuous combustion to push exhaust out the back — no propeller needed.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="NASA — How Does a Jet Engine Work?"
    url="https://www.grc.nasa.gov/www/k-12/airplane/turbine.html"
    description="NASA's beginner-friendly explanation of turbine and jet engine operation with interactive diagrams." >}}

{{< drg/next-page
    text="Now that you understand what powers an aircraft"
    teaser="let's look at the four invisible forces that keep it in the air — or bring it back down."
