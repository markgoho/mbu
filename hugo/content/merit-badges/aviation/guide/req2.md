...
{{< drg/tip >}}
The FPG-9 is a perfect way to see the four forces in action. When you adjust the elevon, you are changing lift. When you add nose weight, you are changing the balance of weight. Every tweak is a mini-lesson in aerodynamics.
{{< /drg/tip >}}
...
{{< drg/image src="images/balsa-wood-airplane-build.avif" alt="A Scout at a workbench assembling a balsa wood rubber-band airplane, with the fuselage partially built and the propeller and rubber band visible alongside building tools" >}}
...
{{< drg/safety-first >}}
Flying a powered model aircraft or drone is real aviation, and the FAA treats it that way. You must:

- Pass the TRUST certification before your first flight.
- Keep the aircraft within visual line of sight at all times.
- Stay below 400 feet above ground level.
- Never fly near airports, stadiums, or emergency response scenes.
- Never fly over people who are not part of your flight operation.
- Yield the right of way to manned aircraft — always.
{{< /drg/safety-first >}}
...
{{< drg/external-link
    title="FAA — The Recreational UAS Safety Test (TRUST)"
    url="https://www.faa.gov/uas/recreational_flyers/knowledge_test_updates"
    description="Official FAA page with links to free, approved TRUST test providers. Complete the test and download your certificate." >}}

{{< drg/external-link
    title="Academy of Model Aeronautics (AMA)"
    url="https://www.modelaircraft.org/"
    description="The national community for model aviation enthusiasts, with clubs, events, and safety resources for building and flying model aircraft." >}}

{{< drg/be-prepared title="What If Your Model Crashes?" >}}
Crashes are a normal part of learning to fly model aircraft. Here is what to do:

- **Stay calm.** Retrieve the aircraft only after all moving parts have stopped.
- **Check for damage.** Look at the propeller, wings, and electronics. A cracked propeller must be replaced — never fly with a damaged prop.
- **Analyze what happened.** Was it wind? A control input error? A mechanical failure? Each crash teaches you something.
- **Repair and try again.** Most model aircraft crashes are fixable with glue, tape, or replacement parts.
{{< /drg/be-prepared >}}

{{< drg/next-page
    text="You have built and flown your own aircraft"
    teaser="now let's explore real-world flight operations — from simulators and preflight inspections to aeronautical charts and discovery flights."
