...
{{< drg/tip >}}
Fly the route several times in good weather conditions before trying it with crosswinds or clouds. Landing is the hardest part — practice approaches until you can consistently put the airplane on the runway.
{{< /drg/tip >}}
...
{{< drg/checklist title="Typical Preflight Checklist" subtitle="Items checked during a walk-around of a single-engine airplane" >}}
...
{{< drg/safety-first >}}
A preflight inspection is not optional. It is the pilot's responsibility to ensure the aircraft is airworthy before every flight. If anything does not look right, the flight does not happen until the issue is resolved. No exceptions.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
An aircraft engine gets an oil change roughly every 50 flight hours. Compare that to your family car, which gets an oil change every 5,000–7,500 miles. The difference? An engine failure in a car means you pull over. An engine failure in an airplane means you are looking for a field to land in.
{{< /drg/did-you-know >}}
...
{{< drg/external-link
    title="SkyVector — Free Aeronautical Charts"
    url="https://skyvector.com/"
    description="Browse free digital sectional charts, plan routes, and explore airspace online." >}}
...
{{< drg/image src="images/discovery-flight-cockpit.avif" alt="A young Scout seated in the left seat of a Cessna cockpit with a flight instructor in the right seat, both wearing headsets, with the runway visible through the windshield" >}}

{{< drg/tip >}}
Bring a small notebook to jot down your impressions right after landing, while the experience is fresh. Your counselor will want to hear specific details — not just "it was cool," but what you saw, felt, and learned.
{{< /drg/tip >}}

{{< drg/external-link
    title="EAA Young Eagles"
    url="https://www.eaa.org/eaa/youth/free-ye-flights"
    description="Free introductory flights for youth ages 8–17 with volunteer EAA pilots. Find a Young Eagles event near you." >}}

{{< drg/next-page
    text="You have experienced real flight operations firsthand"
    teaser="now let's visit the places where it all comes together — airports and aviation facilities."
