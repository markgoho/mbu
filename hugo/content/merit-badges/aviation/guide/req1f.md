...
req_number: "1f"
prev: "/merit-badges/aviation/guide/req1e/"
prev_title: "Four Forces of Flight"
next: "/merit-badges/aviation/guide/req1g/"
next_title: "Control Surfaces"
---
...
{{< drg/image src="images/airfoil-cross-section.avif" alt="A clean cross-section diagram of an airfoil showing the curved upper surface and flatter lower surface, with the leading edge on the left and trailing edge on the right, and airflow lines illustrated going over and under the shape" >}}
...
{{< drg/did-you-know >}}
Bernoulli's principle is not just for airplanes. It is the same reason a curveball curves in baseball. The spinning ball makes air move faster on one side than the other, creating a pressure difference that pushes the ball sideways.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Stalls are one of the most important things a student pilot learns to recognize and recover from. A stall can happen at any speed and any altitude if the angle of attack is too high. Recovery involves lowering the nose to reduce the angle of attack and restoring smooth airflow over the wings.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
When explaining lift to your counselor, mention both Bernoulli's principle (pressure difference from airflow speed) and Newton's Third Law (deflecting air downward). Real lift comes from a combination of both. Showing that you understand both sides will impress your counselor.
{{< /drg/tip >}}

{{< drg/external-link
    title="NASA — What Is Lift?"
    url="https://www.grc.nasa.gov/www/k-12/airplane/lift1.html"
    description="NASA's detailed explanation of how lift works, including interactive simulations you can run in your browser." >}}

{{< drg/next-page
    text="Now you understand how a wing generates lift"
    teaser="so let's learn how a pilot uses control surfaces to steer the aircraft through the sky."
