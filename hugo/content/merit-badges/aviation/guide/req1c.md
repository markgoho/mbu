...
{{< drg/image src="images/fixed-vs-rotary-comparison.avif" alt="A side-by-side comparison showing a fixed-wing Cessna in level flight on the left and a helicopter hovering on the right, with arrows indicating the direction of airflow over their respective wings" >}}
...
{{< drg/tip >}}
A great way to remember the difference: a fixed-wing aircraft trades flexibility for efficiency, while a rotary-wing aircraft trades efficiency for flexibility. Each gives up something to gain something else.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The first practical helicopter flight happened in 1939, when Igor Sikorsky flew his VS-300 in Stratford, Connecticut. Sikorsky had been dreaming about vertical flight since he was a boy in Ukraine, inspired by sketches of a flying machine drawn by Leonardo da Vinci more than 400 years earlier.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="NASA — How Do Helicopters Fly?"
    url="https://www.grc.nasa.gov/www/k-12/helicopter/helicopter.html"
    description="NASA's interactive guide explaining how helicopter rotors generate lift and how pilots control them." >}}

{{< drg/next-page
    text="You now understand the two main wing types and their strengths"
    teaser="so let's look under the hood at the engines that make aircraft move — piston, turbine, and jet."
