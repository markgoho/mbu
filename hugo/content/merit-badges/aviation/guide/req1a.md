...
{{< drg/did-you-know >}}
The Cessna 172 Skyhawk is the most-produced aircraft in history — over 45,000 have been built since 1956. It is the airplane most student pilots learn to fly in, and there is a good chance one is parked at an airport near you right now.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When you talk to your counselor about kinds of aircraft, go beyond just naming them. Explain *why* each type is good at its job. For example, a helicopter can hover over a rescue scene while an airplane cannot — that is why medical helicopters exist.
{{< /drg/tip >}}

{{< drg/image src="images/aircraft-types-comparison.avif" alt="Three aircraft shown in separate panels: a single-engine Cessna in flight, a red rescue helicopter hovering, and a modern quadcopter drone with a camera" >}}
...
{{< drg/external-link
    title="FAA — Types of Aircraft"
    url="https://www.faa.gov/education/students/career-and-education-resources"
    description="The FAA's education portal with resources about different aircraft types and aviation careers." >}}

{{< drg/next-page
    text="Now that you can define an aircraft and describe several kinds"
    teaser="take a look back in time at how human flight went from impossible dream to everyday reality."
