...
req_number: "1g"
prev: "/merit-badges/aviation/guide/req1f/"
prev_title: "Req 1f — Airfoils & Lift"
next: "/merit-badges/aviation/guide/req1h/"
next_title: "Req 1h — Flight Instruments"
---
...
{{< drg/image src="images/control-surfaces-labeled.avif" alt="A three-quarter view of a single-engine airplane with each control surface clearly labeled: ailerons on the wings, elevator on the horizontal tail, and rudder on the vertical tail, with arrows showing the direction each surface moves" >}}
...
{{< drg/checklist title="Control Surface Summary" subtitle="How the pilot controls each axis" >}}
...
{{< drg/tip >}}
When you pick an aircraft to describe for your counselor, choose one you can find good diagrams or photos of. A Cessna 172 or a Piper Cherokee are great choices because their control surfaces are easy to see and well-documented online.
{{< /drg/tip >}}

{{< drg/did-you-know >}}
The Wright brothers did not have ailerons. Instead, they used a system called "wing warping" — they physically twisted the entire wing to control roll. Ailerons were invented a few years later and replaced wing warping because they were simpler and more effective.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="NASA — Aircraft Rotations"
    url="https://www.grc.nasa.gov/www/k-12/airplane/rotations.html"
    description="Interactive guide to the three axes of rotation and how control surfaces affect aircraft attitude." >}}

{{< drg/next-page
    text="You can now identify every control surface on an airplane and explain what it does"
    teaser="so let's step inside the cockpit and learn what all those instruments are telling the pilot."
