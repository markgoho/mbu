...
{{< drg/image src="images/aviation-careers-collage.avif" alt="A collage showing four aviation professionals at work: a pilot in a cockpit, an air traffic controller at a radar screen, a mechanic inspecting an engine, and an engineer reviewing blueprints of an aircraft wing" >}}
...
{{< drg/checklist title="Career Research Framework" subtitle="What to investigate and discuss with your counselor" >}}
...
{{< drg/be-prepared title="What If You Are Not Sure Yet?" >}}
It is completely okay to not know exactly what you want to do. The goal of this requirement is not to pick a career right now — it is to learn *how* to research a career so you can make good decisions later. Practice the skill of investigating a field, and the right career will become clearer over time.

- Start by identifying what excites you most about aviation: the flying, the technology, the problem-solving, the people, or the travel.
- Talk to people who work in aviation. Most professionals are happy to share their experiences.
- Join one of the organizations from Requirement 5d to get real-world exposure.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Bureau of Labor Statistics — Airline and Commercial Pilots"
    url="https://www.bls.gov/ooh/transportation-and-material-moving/airline-and-commercial-pilots.htm"
    description="Official government data on pilot careers, including pay, job outlook, and education requirements." >}}

{{< drg/external-link
    title="FAA — Aviation Careers"
    url="https://www.faa.gov/jobs/career_fields"
    description="Explore the wide range of career fields within the FAA itself — from air traffic control to engineering to safety inspection." >}}

{{< drg/next-page
    text="You have explored the certificates, organizations, and careers that make up the world of aviation"
    teaser="take your knowledge further with deep dives, real-world experiences, and organizations that can keep your aviation journey going."
    url="/merit-badges/aviation/guide/extended-learning/" >}}
