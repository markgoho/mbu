...
{{< drg/image src="images/scout-watching-airplane.avif" alt="A Scout shielding their eyes and looking up at a small single-engine airplane flying overhead against a blue sky" >}}
...
{{< drg/did-you-know >}}
The busiest airport in the world — Hartsfield-Jackson Atlanta International Airport — handles nearly 300,000 passengers every single day. That is roughly the population of a mid-sized city passing through one building.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Military airfields and restricted airspace are off-limits to civilian pilots unless they have explicit permission. Flying into restricted airspace is dangerous and illegal. Always check a current aeronautical chart before flying any aircraft — even a drone.
{{< /drg/safety-first >}}
...
{{< drg/safety-first >}}
Flying a drone is real aviation. In the United States, all recreational drone pilots must pass The Recreational UAS Safety Test (TRUST) before flying. You must also follow FAA rules: stay below 400 feet, keep the drone in visual line of sight, and never fly near airports or over people without authorization.
{{< /drg/safety-first >}}

{{< drg/image src="images/types-of-aircraft-lineup.avif" alt="A lineup showing different types of aircraft side by side: a commercial jetliner, a small single-engine Cessna, a military helicopter, and a quadcopter drone" >}}
...
{{< drg/did-you-know >}}
The boundary between Earth's atmosphere and outer space is generally considered to be 62 miles (100 kilometers) above sea level. This imaginary line is called the Kármán line, named after the physicist Theodore von Kármán.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You have learned about the world of aviation and why it matters."
    teaser="Start with the basics — what exactly is an aircraft, and what kinds fly today?"
    url="/merit-badges/aviation/guide/req1a/" >}}
