...
{{< drg/image src="images/cockpit-instrument-panel.avif" alt="A clean illustration of a single-engine aircraft instrument panel showing the six-pack arrangement of flight instruments with each gauge clearly visible and labeled" >}}
...
{{< drg/safety-first >}}
An altimeter that is set to the wrong reference pressure will give an incorrect altitude reading. In mountains or during approach to landing, this error can be extremely dangerous. Pilots always verify their altimeter setting with the latest weather report or with air traffic control.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
A simple way to remember the six-pack layout: the top row (attitude indicator, heading indicator, altimeter) tells you *where you are*, and the bottom row (airspeed indicator, turn coordinator, vertical speed indicator) tells you *how you are moving*.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Modern "glass cockpit" aircraft replace the traditional round gauges with large digital screens that display all the same information — and more — in a customizable format. But even glass-cockpit airplanes still carry a magnetic compass as a backup. Some things never go out of style.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="FAA — Pilot's Handbook of Aeronautical Knowledge, Chapter 8: Flight Instruments"
    url="https://www.faa.gov/regulationspolicies/handbooksmanuals/aviation/phak/chapter-8-flight-instruments"
    description="The FAA's official guide to flight instruments with detailed diagrams and explanations." >}}

{{< drg/next-page
    text="You now know your way around the cockpit"
    teaser="so it is time to get hands-on — build a model aircraft and put the principles of flight to the test."
