...
req_number: "5c"
prev: "/merit-badges/aviation/guide/req5b/"
prev_title: "Req 5b — Instrument Rating"
next: "/merit-badges/aviation/guide/req5d/"
next_title: "Req 5d — Aviation Organizations"
---
...
{{< drg/tip >}}
Many commercial pilots build flight hours by working jobs like banner towing, aerial surveying, or flying skydivers. These jobs may not be glamorous, but they provide valuable real-world experience and help pilots reach the hours needed for an airline career.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
The 1,500-hour rule for ATP certification was established in 2013 after the Colgan Air Flight 3407 crash near Buffalo, New York, in 2009. Before that rule change, first officers at regional airlines could fly with as few as 250 hours. The rule significantly increased the experience level of airline pilots.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/pilot-career-ladder.avif" alt="A visual ladder or staircase showing the progression from Student Pilot at the bottom to ATP at the top, with each certificate level labeled and the minimum age and hours shown" >}}

{{< drg/external-link
    title="FAA — Airline Transport Pilot Certificate"
    url="https://www.faa.gov/pilots/become/atp"
    description="FAA guide to the ATP certificate, including eligibility requirements and the restricted ATP option for military and collegiate pilots." >}}

{{< drg/next-page
    text="You now understand the full pilot certification pathway"
    teaser="let's find out about organizations that can help you get started in aviation right now — Aviation Exploring and Civil Air Patrol."
