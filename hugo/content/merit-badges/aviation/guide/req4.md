...
req_number: "4"
prev: "/merit-badges/aviation/guide/req3/"
prev_title: "Req 3 — Flight Operations"
next: "/merit-badges/aviation/guide/req5a/"
next_title: "Req 5a — Pilot Certificates"
---
...
Runways are numbered based on their magnetic heading, rounded to the nearest 10 degrees, with the last digit dropped. For example:
...
**How the "active" runway is determined:**
Pilots take off and land into the wind whenever possible, because headwind increases the aircraft's airspeed relative to the ground, which means shorter takeoff rolls and slower landing speeds. The active runway is the one that points most directly into the current wind direction. At towered airports, controllers designate the active runway. At non-towered airports, pilots choose based on the wind.

{{< drg/did-you-know >}}
Large airports with multiple runways sometimes use letters to distinguish parallel runways. At Los Angeles International Airport (LAX), you will find Runways 24L (left), 24R (right), and even 25L and 25R. The letters tell pilots which of the parallel strips to aim for.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
Contact the facility well in advance to schedule a tour. FAA facilities sometimes offer group tours for Scouts, but they require advance arrangement and security clearance. Your merit badge counselor may be able to help make the connection.
{{< /drg/tip >}}
...
{{< drg/image src="images/airport-runway-aerial.avif" alt="An aerial view of a small general aviation airport showing two intersecting runways with visible numbers painted on the pavement, taxiways, hangars, and parked aircraft" >}}
...
{{< drg/external-link
    ...
    description="Explore the world's largest collection of historic air and spacecraft, including the Wright Flyer and Apollo 11." >}}

{{< drg/external-link
    title="EAA AirVenture Oshkosh"
    url="https://www.eaa.org/airventure"
    description="The world's largest annual aviation gathering, held every summer in Oshkosh, Wisconsin. Features air shows, exhibits, and thousands of aircraft." >}}

{{< drg/next-page
    text="You have seen how airports and aviation facilities operate"
    teaser="now let's look ahead — at the certificates, ratings, and careers that could take you from Scout to pilot."
