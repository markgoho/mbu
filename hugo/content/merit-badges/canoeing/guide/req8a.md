...
req_number: "8a"
prev: "/merit-badges/canoeing/guide/req7/"
prev_title: "Req 7 — On the Water Basics"
next: "/merit-badges/canoeing/guide/req8b/"
next_title: "Req 8b — Controlled Capsize"
---
...
{{< drg/safety-first >}}
Never lose contact with the canoe in deep water. Even with a life jacket, staying with the canoe is safer than swimming alone. The canoe is visible to rescuers, provides flotation for multiple people, and gives you something to hold onto while you conserve energy.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
The person in the water should give a count ("one, two, three, GO") so the counterbalancing partner knows exactly when to lean hard on the opposite side. Timing matters — if the kick and the counterbalance are not coordinated, the canoe can roll.
{{< /drg/tip >}}
...
{{< drg/image src="images/canoe-reentry-assist.avif" alt="One Scout in the water gripping the near gunwale of a canoe while the other Scout leans over the far side to counterbalance during a deep-water reentry" >}}

{{< drg/external-link
    title="American Canoe Association — Safety & Rescue"
    url="https://americancanoe.org/safety/"
    description="ACA rescue and safety skills resources for canoeists." >}}
...
{{< drg/next-page
    text="You can safely exit and reenter a canoe in deep water."
    teaser="Learn how to perform a controlled capsize and why staying with a capsized canoe is your best survival strategy."
