...
3. **If anyone needs immediate help** (unconscious, panicking, or injured), prioritize the swimmer rescue (see [Requirement 8e](/merit-badges/canoeing/guide/req8e/)) before dealing with the canoe.
...
{{< drg/tip >}}
When pulling the swamped canoe across your gunwales, start by lifting the end closest to you. Break the suction of the water by rocking the swamped canoe slightly before pulling it up. This makes the lift much easier.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
The paddlers in the water should never try to climb in between the two canoes. Fingers and hands can be crushed between gunwales. Always reenter from the far side — the side away from the rescue canoe.
{{< /drg/safety-first >}}

{{< drg/image src="images/canoe-over-canoe-rescue.avif" alt="A top-down diagram showing the T-rescue sequence: rescue canoe approaching perpendicular, swamped canoe being pulled across the rescue canoe's gunwales to drain, and the two canoes held side-by-side for paddler reentry" >}}

## Communication During the Rescue

Clear communication makes this rescue work smoothly:

- **Rescue canoe:** "Are you both okay? Hold the far end of your canoe."
- **Rescue canoe:** "I am going to pull your canoe across ours. Stay clear."
- **Rescue canoe:** "Your canoe is drained. Come around to the far side."
- **Rescue canoe:** "One at a time — climb in at the center, stay low."
- **Rescue canoe:** "You are in. We are going to let go now."

{{< drg/did-you-know >}}
The canoe-over-canoe rescue has been taught to paddlers for over a century. It works with any size canoe, requires no special equipment, and can be performed by two people in moderate conditions. It is one of the most reliable rescue techniques in paddlesports.
{{< /drg/did-you-know >}}

{{< drg/external-link
    title="American Canoe Association — Rescue Techniques"
    url="https://americancanoe.org/safety/"
    description="ACA rescue skills and training resources for tandem canoe paddlers." >}}

You can rescue a swamped canoe and its crew from deep water. Next, you will learn how to rescue a swimmer from your canoe.

{{< drg/next-page
    text="You can perform a canoe-over-canoe rescue in deep water."
    teaser="Learn how to rescue a conscious swimmer from the water using your canoe."
