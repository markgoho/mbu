...
{{< drg/tip >}}
The J-stroke and the thumb-down rudder stroke achieve the same result — keeping the canoe straight from the stern. Try both during practice and use whichever feels more natural to you. Your counselor may ask you to demonstrate either one.
{{< /drg/tip >}}

{{< drg/image src="images/canoe-paddle-strokes.avif" alt="A top-down diagram showing the six core paddle strokes around a canoe: forward stroke, back stroke, draw, pushaway, forward sweep, and reverse sweep — each with an arrow indicating the blade path through the water" >}}
...
{{< drg/be-prepared title="The Canoe Keeps Turning Despite Your J-Stroke" >}}
If your J-stroke is not keeping the canoe straight:

- **Check your forward stroke angle.** If the paddle is angled outward during the pull, it creates more turning force that the J-stroke cannot overcome.
- **Keep the shaft more vertical** during the power phase. The closer the paddle is to the hull, the less the canoe turns.
- **Apply the J-correction earlier** in the stroke, not just at the very end.
...
{{< drg/image src="images/figure-eight-course.avif" alt="A top-down diagram of a figure-eight course with two markers (buoys), showing the canoe's path around them with arrows indicating direction, stroke labels at key points in the turns" >}}

## Tips for All Maneuvers

{{< drg/checklist title="Tandem Maneuver Keys" subtitle="Keep these in mind for every skill" >}}
...
{{< drg/external-link
    title="American Canoe Association — Paddling Strokes"
    url="https://americancanoe.org/learn-to-canoe/"
    description="ACA's guide to fundamental canoeing strokes and tandem techniques." >}}
...
{{< drg/next-page
    text="You have demonstrated all eight tandem maneuvers and mastered your paddle strokes."
    teaser="Explore advanced canoeing topics, real-world paddling experiences, and organizations that can take your skills even further."
    url="/merit-badges/canoeing/guide/extended-learning/" >}}
