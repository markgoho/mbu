...
req_number: "1c"
prev: "/merit-badges/canoeing/guide/req1b/"
prev_title: "Req 1b — Injuries & First Aid"
next: "/merit-badges/canoeing/guide/req2/"
...
{{< drg/tip >}}
A float plan does not need to be complicated. Write down where you are launching, your planned route, your expected return time, and the phone number of the person to call if you are overdue. Leave a copy with a responsible adult on shore.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Safety Afloat is not bureaucracy — it is a system designed to keep you alive. Every point exists because, at some time in the past, someone was hurt or killed when that precaution was not taken. Know the nine points, follow them every time, and help others follow them too.
{{< /drg/safety-first >}}

{{< drg/image src="images/safety-afloat-infographic.avif" alt="An infographic showing the nine points of Safety Afloat as numbered icons arranged in a grid: supervision, health review, swimming ability, life jackets, buddy system, skill proficiency, planning, equipment, discipline" >}}
...
{{< drg/external-link
    ...
    description="The full text of the Safety Afloat policy directly from Scouting America." >}}

With safety covered, it is time to make sure you are water-ready. Next up: the swimming prerequisite.

{{< drg/next-page
    text="You now understand the Safety Afloat policy and how it applies to canoeing."
    teaser="Before you can paddle, you need to prove you can swim. Learn about the BSA swimmer test."
