...
req_number: "1a"
prev: "/merit-badges/canoeing/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/canoeing/guide/req1b/"
next_title: "Injuries & First Aid"
---
...
{{< drg/tip >}}
Check the weather forecast before every paddle — not just the morning forecast, but the hourly forecast for your specific area. Weather apps with radar are your friend. If conditions look uncertain, have a backup plan.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Never wrap a rope or line around your hand, wrist, or any body part while in or near a canoe. If the canoe shifts or capsizes, you could be trapped or dragged underwater. Always hold ropes with an open grip so you can release instantly.
{{< /drg/safety-first >}}
...
{{< drg/image src="images/canoe-weather-hazards.avif" alt="A split scene showing two conditions: calm sunny canoeing on the left and a dark stormy sky with wind-driven whitecaps approaching on the right" >}}

## The Four-Step Hazard Approach

Your counselor will want to hear you think through hazards using four steps:

1. **Anticipate** — What could go wrong? Check weather, scout the water, review your route.
2. **Prevent** — What can you do ahead of time? Wear your life jacket, bring proper gear, paddle with a buddy.
...
- **Turn your bow into the waves** at a slight angle (about 30°). Never let waves hit you broadside.
- **Lower your center of gravity.** Kneel instead of sitting.
- **Head for the nearest sheltered shoreline** — this may not be your original destination.
- **Communicate with your partner.** Agree on a plan before you start paddling.
{{< /drg/be-prepared >}}

{{< drg/external-link
    title="Scouting America Safety Afloat"
    url="https://www.scouting.org/health-and-safety/safety-afloat/"
    description="Official BSA safety guidelines for all activities on the water." >}}
...
{{< drg/next-page
    text="You now know how to spot and prepare for hazards on the water."
    teaser="Learn about the specific injuries and illnesses you might encounter while canoeing — and how to provide first aid."
