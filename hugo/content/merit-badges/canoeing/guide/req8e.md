---
title: "Swimmer Rescue from Canoe"
layout: guide
group_title: "8. Capsizing & Rescue"
req_number: "8e"
prev: "/merit-badges/canoeing/guide/req8d/"
prev_title: "Deep Water Canoe Rescue"
next: "/merit-badges/canoeing/guide/req8f/"
next_title: "Throw Bag Rescue"
---
...
{{< drg/safety-first >}}
A panicking swimmer can grab the canoe or the rescuers in ways that capsize the boat. If the swimmer is panicking, extend a paddle or throw a line to them first rather than bringing the canoe directly alongside. A panicking person will instinctively grab whatever they can — give them something to hold that is not you or the gunwale directly.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
Practice all three methods. In a real situation, you will use whichever one works for the swimmer's strength, size, and condition. A tired or cold swimmer may not have the strength for a self-rescue over the gunwale — that is when the paddle bridge or rescue sling earns its place.
{{< /drg/tip >}}
...
{{< drg/image src="images/canoe-swimmer-rescue.avif" alt="A rescue canoe approaching a conscious swimmer in the water — the swimmer has one hand raised, the bow paddler is communicating, and the stern paddler is positioning the canoe alongside" >}}

{{< drg/external-link
    title="American Canoe Association — Water Safety"
    url="https://americancanoe.org/safety/"
    description="ACA guidelines for water rescue from canoes and other paddlecraft." >}}
...
{{< drg/next-page
    text="You can rescue a conscious swimmer using your canoe."
    teaser="Learn how to use a throw bag to reach a swimmer from shore and how to repack it when done."
