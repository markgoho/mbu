...
Cold-water shock (discussed in [Requirement 1b](/merit-badges/canoeing/guide/req1b/)) can cause involuntary gasping within seconds of immersion. A life jacket keeps your head above water during those critical moments. Even strong swimmers can be incapacitated by cold water, exhaustion, or a blow to the head during a capsize.

{{< drg/safety-first >}}
According to US Coast Guard statistics, drowning is the leading cause of death in boating accidents — and the vast majority of drowning victims were not wearing a life jacket. A PFD only works if you are wearing it.
{{< /drg/safety-first >}}
...
{{< drg/tip >}}
For canoeing, look for a Type III or paddlesport-specific Type V PFD. These are designed with arm mobility in mind — a critical feature when you are making hundreds of paddle strokes per hour. Avoid bulky offshore PFDs that restrict your shoulders.
{{< /drg/tip >}}
...
{{< drg/image src="images/pfd-types-comparison.avif" alt="Four life jackets side by side on a dock: Type I (bulky offshore), Type II (near-shore vest), Type III (paddlesport), and Type V (special use) — each labeled with type number and best use case" >}}

{{< drg/external-link
    title="US Coast Guard — Life Jacket Information"
    url="https://www.uscgboating.org/recreational-boaters/life-jacket-wear-types.php"
    description="Official USCG guide to life jacket types, selection, and regulations." >}}

Now that you know what to look for in a life jacket, let's make sure it fits properly.

{{< drg/next-page
    text="You understand which life jacket types work best for canoeing and why you must always wear one."
    teaser="Learn how to select the right size and properly fit a life jacket for safe paddling."
