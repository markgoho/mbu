---
title: "Paddle Anatomy & Sizing"
layout: guide
group_title: "4. Know Your Paddle"
req_number: "4"
prev: "/merit-badges/canoeing/guide/req3/"
prev_title: "Canoe Anatomy & Design"
next: "/merit-badges/canoeing/guide/req5a/"
next_title: "Life Jacket Selection"
---
...
{{< drg/image src="images/paddle-parts-labeled.avif" alt="A single canoe paddle shown vertically with all parts labeled: grip (showing both T-grip and palm grip variations), shaft, throat, blade (with power face and back face indicated), and tip" >}}
...
{{< drg/tip >}}
If you are borrowing or renting a paddle and cannot do the full sizing test, use this shortcut: stand the paddle upright next to you. For sitting, the grip should reach between your chin and nose. For kneeling, aim for between your armpit and shoulder. It is not as precise, but it gets you close.
{{< /drg/tip >}}
...
{{< drg/image src="images/paddle-sizing-demo.avif" alt="A Scout kneeling beside a canoe on shore, holding a paddle upside down with the grip on the ground, demonstrating the 90-degree arm angle sizing method" >}}

{{< drg/external-link
    title="REI — How to Choose Canoe Paddles"
    url="https://www.rei.com/learn/expert-advice/canoe-paddle.html"
    description="Detailed guide to selecting the right paddle based on your body, paddling style, and intended use." >}}

You know your canoe and your paddle. Now let's gear up with the most important piece of safety equipment — your life jacket.

{{< drg/next-page
    text="You can identify every part of a paddle and know how to size one correctly."
    teaser="Learn how to choose the right life jacket for canoeing and why you must always wear one."
