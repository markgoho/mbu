...
- **Keep lithium batteries away from heat** and moisture.
 ...
 {{< drg/checklist title="Home Fire Hazard Inspection" subtitle="Walk through each room and check" >}}
...
- **Do not use homemade fireworks** or fireworks purchased outside the U.S. (safety standards are lax).
 ...
 {{< drg/did-you-know >}}
A Christmas tree fire in a properly watered tree takes about 17 minutes to fully engulf the tree. A dry tree (in a stand with no water) ignites completely in about 5 minutes. The difference is water.
 {{< /drg/did-you-know >}}
...
Let's look at one specific fire risk that deserves special attention: safely using candles.
 ...
 {{< drg/next-page
    text="You've learned the common household fire hazards,"
    teaser="now let's focus on how to use one of the most popular hazards—candles—safely."
