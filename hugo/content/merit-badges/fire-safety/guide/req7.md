...
{{< drg/video
    ...
    url="https://www.youtube.com/watch?v=_yCllHMvQ_0" >}}
...
7. **Do not jump** unless fire is immediately life-threatening and the floor is low enough that jumping is survivable.
 ...
 {{< drg/safety-first >}}
Public buildings are designed with fire safety in mind, but the system only works if people follow procedures. When an alarm sounds, do not stay to ask questions or finish what you're doing. Exit immediately.
 {{< /drg/safety-first >}}

 {{< drg/checklist title="Public Building Safety Checklist" subtitle="When you enter a building" >}}
...
Now let's move to an environment most Scouts know well: camp.
 ...
 {{< drg/next-page
    text="You've learned how large buildings protect people from fire,"
    teaser="let's explore fire safety in the place where Scouts spend so much time—camp."
