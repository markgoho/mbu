...
{{< drg/video
    ...
    url="https://www.youtube.com/watch?v=B8PrA_AOa6w" >}}
...
In commercial kitchens, fires often involve hot cooking oil (olive oil, vegetable oil, or animal fat). When water hits hot oil, it flashes to steam, and burning oil spatters everywhere. Class K fires need wet chemical agents that cool the oil and form a foam blanket.
 ...
 {{< drg/safety-first >}}
If you're unsure what's burning, do not attempt to extinguish it. Get out, close the door, and call 911. A fire that grows beyond the size of a trash can is beyond the ability of a home fire extinguisher to handle safely.
 {{< /drg/safety-first >}}

| Fire Class | What's Burning | Common Location | Safe Extinguisher |
|---|---|---|---|
| **A** | Wood, paper, cloth, plastic | Homes, offices, forests | Water, multipurpose dry powder (ABC) |
| **B** | Gasoline, oil, propane, paint | Garages, workshops, kitchens | Foam, CO₂, dry powder (ABC, BC, or B) |
| **C** | Live electrical equipment | Appliances, panels, wiring | CO₂, dry powder (BC or ABC) |
...
After the fire is out, watch it for a minute. If flames restart (a common problem because some fuel wasn't cooled enough), repeat the process.
 ...
 {{< drg/be-prepared title="Extinguisher Failure" >}}
**What if the extinguisher doesn't work?**
- **Stop immediately.** Do not keep trying.
- **Leave the area.** Get out of the building.
- **Close the door behind you** to slow the fire's spread.
- **Call 911** from outside.
- Never risk your life on equipment that isn't working.
 {{< /drg/be-prepared >}}
...
Fire blankets are best for small fires in pots or pans. For larger fires, a fire extinguisher or evacuation is safer.
 ...
 {{< drg/safety-first >}}
A fire blanket works only on small, contained fires. Never use one on a person whose clothing is on fire—use stop, drop, and roll instead (see Req 3a). And never use a fire blanket on a chemical fire—some chemicals react violently with certain materials.
 {{< /drg/safety-first >}}
...
Now that you understand how to fight fires with tools, let's shift to protecting *people* from fire. What happens when fire injures someone, and what do you do?
 ...
 {{< drg/next-page
    text="With fire extinguishers in mind,"
    teaser="learn how to respond if someone's clothing catches fire or if someone is exposed to smoke."
