...
{{< drg/video
    title="Every Second Counts in a Home Fire—Practice Your Escape Plan — NFPA"
    url="https://www.youtube.com/watch?v=Vc-AkbpdSYk" >}}
...
**Vary the starting location:** Run drills starting from different rooms (bedroom, kitchen, living room) so everyone practices different routes.
 ...
 {{< drg/tip >}}
Some families set drills during specific events (first day of summer, first day of school, New Year's Day) to make them predictable and easier to remember to do.
 {{< /drg/tip >}}
...
Now let's address two more immediate dangers: detecting gas leaks and properly reporting fires.
 ...
 {{< drg/next-page
    text="You've planned for evacuation,"
    teaser="but what if you smell natural gas or smoke? Here's what to do."
