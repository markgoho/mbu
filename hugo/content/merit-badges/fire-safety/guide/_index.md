  ...
  - group_title: "Beyond the Badge"
    items:
      - title: "Extended Learning"
        url: "/merit-badges/fire-safety/guide/extended-learning/"
---
...
Some materials burn in ways that solid wood doesn't. Flammable liquids like gasoline ignite at lower temperatures and burn faster. Metals like magnesium can burn with extreme heat. Each requires a different approach to extinguish safely.
 ...
 {{< drg/safety-first >}}
Never assume you understand a fire's behavior. Some fires *look* small but spread explosively. Others produce smoke that kills before flames reach you. When in doubt, get out and call the fire department.
 {{< /drg/safety-first >}}
...
You're about to dive into how fire actually works—the science behind what you've seen and what you need to know to work with it safely. Let's understand the fire tetrahedron.
 ...
 {{< drg/next-page
    text="Now that you understand the role fire plays in our lives,"
    teaser="let's explore the science behind how fire actually works."
    url="/merit-badges/fire-safety/guide/req1/" >}}
