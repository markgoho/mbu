...
- Write the installation date on the new alarm with a marker.
 ...
 {{< drg/safety-first >}}
Expired alarms are useless. They look fine but won't detect smoke or CO. If you find expired alarms in your home, replace them immediately. An expired alarm in a house is like having no alarm at all—you have a false sense of security.
 {{< /drg/safety-first >}}

 {{< drg/checklist title="Alarm Maintenance Checklist" subtitle="Do this monthly" >}}
...
Now let's plan for evacuation. What will you do if fire strikes your home?
 ...
 {{< drg/next-page
    text="With alarms in place,"
    teaser="let's plan what your family will do when every second counts."
