...
{{< drg/video
    title="Stop, Drop, Roll — Cool and Call! — eMedia Workshop"
    url="https://www.youtube.com/watch?v=K_roagbwfoU" >}}
...
- Do not panic. Calm movements are faster and more effective than frantic ones.
- If you have a blanket, coat, or jacket nearby, you can throw it over the burning person to smother flames, then help them drop and roll.
- Do not try to remove burning clothing—focus on smothering the flames first.
- Once flames are out, cool the area and call for emergency help.
 {{< /drg/safety-first >}}
...
The physical memory helps when stress takes over.
 ...
 {{< drg/tip >}}
You might see the old phrase "stop, drop, and roll" in some materials. The modern version adds "cool" and "call" because those steps are just as critical. Cooling prevents ongoing tissue damage, and calling 911 ensures proper medical care.
 {{< /drg/tip >}}
...
Now let's explore how and why clothing catches fire, and what types of fabric are safer.
 ...
 {{< drg/next-page
    text="You now know what to do if clothing catches fire,"
    teaser="but understanding *how* it happens is the key to prevention."
