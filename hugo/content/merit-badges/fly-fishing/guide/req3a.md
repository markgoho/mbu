...
{{< drg/image src="images/arbor-knot-tying-sequence.avif" alt="Four-panel step-by-step diagram showing backing wrapped around a reel arbor, overhand knot around the standing line, stopper knot in the tag end, and the finished arbor knot seated on the spool" >}}
...
{{< drg/tip >}}
Say the steps out loud while you practice: wrap, overhand around the standing line, stopper knot in the tag, tighten. The words help many Scouts remember the sequence when it is time to demonstrate.
{{< /drg/tip >}}
...
{{< drg/checklist title="What Your Counselor May Look For" subtitle="Demonstration details that matter" >}}
...
In [Req 2](/merit-badges/fly-fishing/guide/req2/), you learned how each part of the tackle system depends on the others. This page starts building that system from the inside out.

{{< drg/external-link
    title="Animated Knots — Arbor Knot"
    url="https://www.animatedknots.com/arbor-knot"
    description="Step-by-step visuals for tying an arbor knot correctly and understanding how it seats on the spool." >}}

{{< drg/video
    title="A short film showing how to attach backing to a fly reel — RIO Products"
    url="https://www.youtube.com/watch?v=xkWyoYyhd40" >}}

Once backing is on the reel, the next connection is between backing and fly line.

{{< drg/next-page
    text="You now know how backing is secured to the reel using an arbor knot."
    teaser="Next, connect the backing to the fly line using a nail knot."
