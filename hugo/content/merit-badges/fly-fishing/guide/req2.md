...
req_number: "2"
prev: "/merit-badges/fly-fishing/guide/req1c/"
prev_title: "Req 1c — Removing a Hook Safely"
next: "/merit-badges/fly-fishing/guide/req3a/"
next_title: "Req 3a — Backing to the Reel"
---
...
{{< drg/image src="images/balanced-fly-tackle-system.avif" alt="Labeled diagram of a complete fly-fishing setup from reel to fly, showing rod, reel, fly line, tapered leader, tippet, and fly with each section scaled and connected in order" >}}
...
{{< drg/checklist title="How to Build a Balanced Setup" subtitle="Questions to ask before you rig up" >}}
...
{{< drg/tip >}}
If you are new to fly fishing, a weight-forward floating line matched to the rod's weight is usually the best place to start. It covers the widest range of beginner situations.
{{< /drg/tip >}}
...
{{< drg/safety-first >}}
Never carry a rigged fly rod with the fly loose and swinging. Secure the fly to a hook keeper or strip the rig down before moving. That prevents painful accidents and broken rods.
{{< /drg/safety-first >}}
...
{{< drg/external-link
    title="Orvis Learning Center — Fly Fishing Lines, Leaders, and Tippet"
    url="https://howtoflyfish.orvis.com/fly-fishing-basics/line-leader-and-tippet"
    description="A reliable overview of how fly lines, leaders, and tippet work together in a complete fly-fishing system." >}}

{{< drg/video
    title="How to Set Up Your Fly Line, Leader, Tippet, & Flies | Episode 8 — Ventures Fly Co."
    url="https://www.youtube.com/watch?v=w_5V08fYXnQ" >}}

Now it is time to rig the setup piece by piece, starting at the reel.

{{< drg/next-page
    text="You now understand how rod, line, and leader are matched into a balanced fly-fishing system."
    teaser="Next, start rigging from the reel by tying backing to the arbor with an arbor knot."
