...
{{< drg/did-you-know >}}
Trout can shift from one food source to another very quickly. A pattern that worked an hour ago may suddenly stop working because the fish changed from eating nymphs underwater to sipping adult insects on the surface.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/matching-the-hatch-observation-scene.avif" alt="Comparison image showing a streamside observation setup above and below the water surface: rising trout and drifting adult insects on top, with overturned rock revealing nymphs and subsurface prey below" >}}

{{< drg/checklist title="Observation Routine at the Water" subtitle="How to study what fish are eating before choosing a fly" >}}
...
{{< drg/be-prepared title="Nothing Is Rising" >}}
You expected a dry-fly evening, but the water looks quiet.

- Pause and observe instead of blind-casting.
- Look under rocks or in shallows for nymphs or larvae.
- Choose a subsurface fly if that is what the evidence supports.
- Keep watching, because surface feeding can begin later.
{{< /drg/be-prepared >}}

In [Req 4](/merit-badges/fly-fishing/guide/req4/), you learned what the main fly types imitate. This requirement puts that knowledge into the real world by asking you to compare your flies to actual fish food.

{{< drg/external-link
    title="Orvis Learning Center — Matching the Hatch"
    url="https://howtoflyfish.orvis.com/fly-fishing-basics/matching-the-hatch"
    description="A practical explanation of how anglers observe insect activity and choose flies that better match what fish are eating." >}}

{{< drg/video
    title="First Cast Fly Fishing Academy: How to Match the Hatch! — Postfly"
    url="https://www.youtube.com/watch?v=kro47XlZVMM" >}}

Once you understand fish behavior, it is time to think about something bigger than catching fish: how to protect the places where fly fishing happens.

{{< drg/next-page
    text="You now understand how observing insect and fish behavior helps you choose a more effective fly."
    teaser="Next, learn how Leave No Trace and the Outdoor Code protect fly-fishing waters for everyone."
