...
{{< drg/image src="images/fly-line-types-comparison.avif" alt="Comparison of floating, sink-tip, full-sinking, and intermediate fly lines showing where each rides in the water column and the kinds of presentations each supports" >}}
...
{{< drg/safety-first >}}
Moving water is stronger than it looks. Wear secure footwear, use a wading staff when needed, and never wade deeper or faster water than you can handle safely.
{{< /drg/safety-first >}}
...
{{< drg/safety-first >}}
In saltwater, rinse rods, reels, and flies with fresh water after every outing. Salt left on gear can quickly damage metal parts and line coatings.
{{< /drg/safety-first >}}
...
{{< drg/did-you-know >}}
Some trout will ignore a fly that is only slightly the wrong size, even if the color looks close. To a fish feeding on tiny insects, size and how the fly rides in the water can matter more than making a perfect cast.
{{< /drg/did-you-know >}}
...
{{< drg/next-page
    text="You have a big-picture view of what fly fishing is and the many ways people practice it."
    teaser="Start with the hazards and safety habits every fly angler needs before making the first cast."
    url="/merit-badges/fly-fishing/guide/req1a/" >}}
