...
req_number: "7b"
prev: "/merit-badges/fly-fishing/guide/req7a/"
prev_title: "Req 7a — Leave No Trace on the Water"
next: "/merit-badges/fly-fishing/guide/req8/"
next_title: "Req 8 — Fishing Regulations"
---
...
- Fish populations are fragile
- Water temperatures are stressful
- Regulations require release
- You catch a species or size class that should not be harvested
...
{{< drg/image src="images/safe-fish-release-technique.avif" alt="Annotated photo of hands gently supporting a fish upright in shallow water with wet hands, forceps removing the fly, and crossed-out wrong actions like squeezing, dry hands, and fingers in the gills" >}}

{{< drg/safety-first >}}
If a fish is deeply hooked or badly bleeding, survival chances may already be low. Follow local regulations and your counselor's guidance. Do not rip and tear at the hook if that will cause even more damage.
{{< /drg/safety-first >}}

## Barbless Hooks and Better Release

Many anglers pinch down barbs or use barbless hooks because fish can be unhooked faster and with less tissue damage. This also makes accidental hook injuries to people easier to handle, which connects directly to [Req 1c](/merit-badges/fly-fishing/guide/req1c/).
...
{{< drg/tip >}}
If you want a photo, plan it before lifting the fish. Camera ready, quick lift, quick shot, fish back in the water. Long photo sessions are hard on fish.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="The Fish Rolls on Its Side" >}}
You remove the fly, but the fish does not kick away strongly.

- Keep the fish upright in gentle current or still water.
- Support it lightly without squeezing.
- Let water move naturally past the gills.
- Release only when the fish regains strength and swims off on its own.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    ...
    description="A conservation-focused resource showing best practices for handling and releasing fish with minimal stress and injury." >}}

{{< drg/video
    title="ETHICAL CATCH AND RELEASE FISHING — The Orvis Company"
    url="https://www.youtube.com/watch?v=SMGO50R_lrA" >}}
...
{{< drg/next-page
    text="You now understand why catch and release matters and how to return fish with less stress and injury."
    teaser="Next, look at local fishing regulations and why following them protects fish populations."
