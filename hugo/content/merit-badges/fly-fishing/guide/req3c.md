---
title: "Leader to Fly Line"
layout: guide
group_title: "2. Gear & Rigging"
req_number: "3c"
prev: "/merit-badges/fly-fishing/guide/req3b/"
prev_title: "Backing to the Fly Line"
next: "/merit-badges/fly-fishing/guide/req3d/"
next_title: "Tippet Connections"
---
...
The process is similar to the nail knot in [Req 3b](/merit-badges/fly-fishing/guide/req3b/): the thicker butt end of the leader is wrapped around the fly line with the help of a tube, then tightened carefully.
...
{{< drg/image src="images/leader-to-fly-line-loop-connection.avif" alt="Diagram showing two welded loops being connected handshake-style, with the leader loop passing through the fly-line loop and the leader threaded through itself to form a loop-to-loop connection" >}}
...
{{< drg/tip >}}
Your counselor may allow either method because the requirement does. Be ready to explain *why* you chose it, not just how to do it.
{{< /drg/tip >}}
...
{{< drg/checklist title="Before You Cast" subtitle="Quick rigging check after attaching a leader" >}}
...
{{< drg/external-link
    title="RIO Products — Loop to Loop Connection"
    url="https://farbank.com/blogs/rio/how-to-make-a-loop-to-loop-connection"
    description="A practical explanation of loop-to-loop rigging and why it is popular for modern fly-fishing setups." >}}

{{< drg/video
    title="Nail Knot Tutorial - Attach your leader to your fly line with this method! — Mad River Outfitters"
    url="https://www.youtube.com/watch?v=_I0u9URCbNM" >}}

Once the leader is attached, you are ready to lengthen or refresh the fine terminal section with tippet.

{{< drg/next-page
    text="You now know two common ways to attach a leader to a fly line."
    teaser="Next, learn how to add tippet to the leader using a surgeon's knot or loop-to-loop connection."
