---
title: "Hazards on the Water"
layout: guide
group_title: "1. Safety First"
req_number: "1a"
prev: "/merit-badges/fly-fishing/guide/"
prev_title: "Introduction & Overview"
next: "/merit-badges/fly-fishing/guide/req1b/"
next_title: "Preventing Fishing Injuries"
---
...
{{< drg/image src="images/casting-safety-bubble-comparison.avif" alt="Side-by-side comparison showing a fly angler with safe clear casting space and eye protection versus an unsafe crowded casting lane with a person in the back-cast zone" >}}
...
{{< drg/safety-first >}}
Do not wade just because other anglers are doing it. Water depth, current speed, and bottom footing can change from one step to the next. If you are unsure, stay out.
{{< /drg/safety-first >}}
...
- **Anticipate** by studying the location, forecast, regulations, and water conditions before you go.
- **Prevent** by using the right clothing, gear, spacing, and habits.
- **Mitigate** by lowering the severity of a problem when it starts, such as leaving the water when current feels too strong or moving to shade before heat illness develops.
- **Respond** by using first aid, getting help, and ending the outing if safety is no longer under control.

{{< drg/checklist title="Five Safety Practices Every Fly Angler Should Follow" subtitle="These are strong examples to discuss with your counselor" >}}
...
- **Check the scene** for strong current, deeper water, or loose footing before helping.
- **Help from a stable position** rather than rushing into bad footing yourself.
- **Assess the injury** for bleeding, swelling, or inability to stand.
- **Leave the water** and move to shore before deciding whether first aid or emergency help is needed.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    ...
    description="Review the seven core outdoor ethics principles that also help keep anglers safer and more aware in the field." >}}
...
{{< drg/next-page
    text="You now know the main hazards of fly fishing and the habits that prevent them."
    teaser="Next, learn how to prevent and treat common injuries and health problems that can happen on the water."
