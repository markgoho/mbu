---
title: "Preventing Fishing Injuries"
layout: guide
group_title: "1. Safety First"
req_number: "1b"
prev: "/merit-badges/fly-fishing/guide/req1a/"
prev_title: "Hazards on the Water"
next: "/merit-badges/fly-fishing/guide/req1c/"
next_title: "Removing a Hook Safely"
---

{{< drg/requirement number="1b" >}}
Discuss the prevention of and treatment for the following health concerns that could occur while fly-fishing: cuts and scratches, puncture wounds, insect bites, hypothermia, dehydration, heat exhaustion, heatstroke, and sunburn.
{{< /drg/requirement >}}
...
{{< drg/tip >}}
If a cut is deep, will not stop bleeding, or exposes deeper tissue, stop fishing and get medical help. "Fishing through it" is not tough. It is a bad decision.
{{< /drg/tip >}}
...
{{< drg/image src="images/tick-removal-technique.avif" alt="Close-up annotated photo showing fine-tipped tweezers gripping a tick close to the skin and pulling straight upward, with crossed-out twisting and squeezing mistakes" >}}

{{< drg/safety-first >}}
Trouble breathing, facial swelling, confusion, or collapse after a bite or sting can mean a severe allergic reaction. Call emergency help right away. If the person has a prescribed epinephrine auto-injector, help them use it according to their training.
{{< /drg/safety-first >}}
...
{{< drg/safety-first >}}
Heatstroke is life-threatening. Call emergency help immediately. Begin rapid cooling with cold wet cloths, shade, fans, or cool water while waiting for professional care.
{{< /drg/safety-first >}}
...
{{< drg/checklist title="Build a Fishing Health Kit" subtitle="Simple items that help with the problems in this requirement" >}}
...
In [Req 1a](/merit-badges/fly-fishing/guide/req1a/), you learned how to spot risks before they cause trouble. This requirement adds the first-aid side: once a problem happens, stay calm, treat the person, and decide whether the trip should end.

{{< drg/external-link
    title="CDC — Heat Stress"
    url="https://www.cdc.gov/niosh/heat-stress/about/"
    description="Learn to recognize heat exhaustion, heatstroke, and other heat-related illnesses and how to respond." >}}

One special puncture wound deserves its own requirement because it happens often in fishing and needs careful handling: a hook lodged in skin.

{{< drg/next-page
    text="You now know how to prevent and respond to the most common health concerns in fly fishing."
    teaser="Next, focus on one of the most fishing-specific injuries of all: how to remove a lodged hook safely."
