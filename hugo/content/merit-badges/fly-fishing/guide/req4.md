...
{{< drg/did-you-know >}}
In many trout streams, fish eat underwater insects far more often than they sip bugs from the surface. That means some of the most productive fly fishing happens where you cannot even see the take clearly.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/fly-categories-identification-grid.avif" alt="Illustrated comparison grid showing seven fly categories side by side: dry fly, wet fly, nymph, streamer, bass bug, popper, and saltwater fly, each with a representative silhouette and the kind of prey it imitates" >}}

## How to Choose the Right Category

Think about three things:

1. **Where are fish feeding?** Surface, just under it, or deep?
2. **What food is available?** Insects, baitfish, frogs, crayfish, shrimp?
3. **How do you want the fly to move?** Dead drift, swing, strip, pop, or skitter?

{{< drg/checklist title="What Each Fly Category Imitates" subtitle="A fast comparison to help you explain this requirement" >}}
...
{{< drg/tip >}}
When you tie a practice fly, do not chase perfection right away. Ask a better question: does this pattern clearly imitate the kind of food it is supposed to represent?
{{< /drg/tip >}}

In [Req 6](/merit-badges/fly-fishing/guide/req6/), you will use this same thinking to observe real fish food at the water and match your fly choice to it.

{{< drg/external-link
    title="Orvis Learning Center — Fly Fishing Flies"
    url="https://howtoflyfish.orvis.com/fly-fishing-basics/types-of-flies"
    description="A beginner-friendly overview of the main fly categories and what they imitate." >}}

{{< drg/video
    title="Fly Fishing Flies Explained (Streamers, Nymphs, Dry Flies & More) — Trident Fly Fishing"
    url="https://www.youtube.com/watch?v=jz189rWAMfw" >}}

Once you understand the flies, you still need to put them where the fish are. That means casting.

{{< drg/next-page
    text="You now know the main categories of flies, what they imitate, and when anglers use them."
    teaser="Next, learn how overhead and roll casts help you place a fly accurately at 30 feet."
