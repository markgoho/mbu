...
req_number: "9"
prev: "/merit-badges/fly-fishing/guide/req8/"
prev_title: "Req 8 — Fishing Regulations"
next: "/merit-badges/fly-fishing/guide/req10/"
next_title: "Req 10 — Catch and Identify a Fish"
---
...
{{< drg/be-prepared title="Someone Is Already Fishing the Run" >}}
You arrive at a promising stretch of water, but another angler is already working through it.

- Do not step in right above or below them.
- Ask politely how far they plan to fish.
- Move to another stretch if needed.
- Treat the water as shared space, not something to claim.
{{< /drg/be-prepared >}}

## Obeying Regulations

In [Req 8](/merit-badges/fly-fishing/guide/req8/), you learned why regulations exist. Sportsmanship means following them willingly, not just to avoid a ticket. The rule is part of respecting the fishery.
...
{{< drg/checklist title="Sportsmanship and Scout Ethics" subtitle="How these ideas connect directly to angling" >}}
...
{{< drg/tip >}}
A simple "Mind if I fish below you?" or "Thanks for letting us use this access" goes a long way. Courtesy is one of the cheapest and most effective tools in the outdoors.
{{< /drg/tip >}}

Sportsmanship is the human side of conservation. It shows whether your knowledge is turning into responsibility.

{{< drg/external-link
    title="Scouting America — Outdoor Code"
    url="https://www.scouting.org/outdoor-programs/outdoor-code/"
    description="Review the Outdoor Code and its connection to clean, respectful, conservation-minded outdoor behavior." >}}

Now the guide shifts from ethics back to action on the water: catching and identifying a fish on the fly.

{{< drg/next-page
    text="You now understand how sportsmanship shapes responsible behavior toward fish, land, rules, and other people."
    teaser="Next, focus on catching one fish on a fly and identifying it accurately."
