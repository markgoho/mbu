...
req_number: "5"
prev: "/merit-badges/fly-fishing/guide/req4/"
prev_title: "Req 4 — Fly Types and Imitation"
next: "/merit-badges/fly-fishing/guide/req6/"
next_title: "Req 6 — Matching the Hatch"
---
...
{{< drg/image src="images/overhead-vs-roll-cast-comparison.avif" alt="Side-by-side comparison of an overhead cast and a roll cast, showing line path, back-cast space needed, and the D-loop shape behind the rod in the roll cast" >}}

{{< drg/tip >}}
For both casts, imagine painting a straight line in the air with your rod tip. Wild arm swings and huge circles usually waste energy and reduce accuracy.
{{< /drg/tip >}}
...
Aiming in fly fishing usually means aiming with the **line and leader turnover**, not just the fly itself. That is another reason a balanced system from [Req 2](/merit-badges/fly-fishing/guide/req2/) matters.

## Practice Habits That Help

{{< drg/checklist title="30-Foot Practice Routine" subtitle="A smart way to build skill before your demonstration" >}}
...
{{< drg/be-prepared title="Brush Behind You" >}}
You step into a small stream and realize trees are tight behind your shoulder.

- Skip the full overhead cast.
- Strip in enough line to stay in control.
- Use a roll cast to place the fly ahead of you.
- If you need more room, reposition your feet instead of forcing a bad cast.
{{< /drg/be-prepared >}}
...
{{< drg/external-link
    title="Orvis Learning Center — Fly Casting Lessons"
    url="https://howtoflyfish.orvis.com/video-lessons/fly-casting"
    description="A large collection of casting tutorials covering overhead casts, roll casts, accuracy, and common mistakes." >}}
...
{{< drg/next-page
    text="You now understand how overhead and roll casts help you deliver a fly accurately at fishing distance."
    teaser="Next, learn how to observe what fish are eating and choose a fly that matches the hatch."
