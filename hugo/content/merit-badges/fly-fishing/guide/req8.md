...
req_number: "8"
prev: "/merit-badges/fly-fishing/guide/req7b/"
prev_title: "Req 7b — Catch and Release"
next: "/merit-badges/fly-fishing/guide/req9/"
next_title: "Req 9 — Sportsmanship for Anglers"
---
...
{{< drg/checklist title="Questions to Ask When Reading Regulations" subtitle="This helps you explain them to your counselor" >}}
...
{{< drg/tip >}}
Always check regulations shortly before a trip, even if you fished there last year. Seasons, stocking policies, and special rules can change.
{{< /drg/tip >}}
...
In [Req 7b](/merit-badges/fly-fishing/guide/req7b/), you learned why responsible release matters. Regulations turn that same conservation mindset into official rules that apply to everyone.

{{< drg/external-link
    title="Take Me Fishing — State Fishing License and Regulation Finder"
    url="https://www.takemefishing.org/state-fishing-license-and-boat-registration/"
    description="A directory that helps anglers quickly locate official state fishing regulations and licensing pages." >}}

Knowing the law is important, but good angling also depends on character. That leads to sportsmanship.

{{< drg/next-page
    text="You now understand what fishing regulations do and why they are essential for sustainable angling."
    teaser="Next, connect those rules and ethics to sportsmanlike behavior on and off the water."
