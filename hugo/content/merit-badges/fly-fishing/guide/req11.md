...
req_number: "11"
prev: "/merit-badges/fly-fishing/guide/req10/"
prev_title: "Req 10 — Catch and Identify a Fish"
next: "/merit-badges/fly-fishing/guide/extended-learning/"
...
- Is it in season?
- Does it meet size and bag rules from [Req 8](/merit-badges/fly-fishing/guide/req8/)?
...
{{< drg/safety-first >}}
Always check local fish consumption advisories before eating wild-caught fish. Some waters contain contaminants that make certain species unsafe or only safe in limited amounts.
{{< /drg/safety-first >}}
...
1. Rinse or wipe the fish clean of slime and dirt.
2. Use a sharp knife carefully and cut away from yourself.
3. Remove the guts and any unwanted parts.
4. Rinse again if appropriate.
5. Keep edible portions cold until cooking.
...
{{< drg/checklist title="Safe Fish-to-Meal Process" subtitle="A smart sequence from catch to camp kitchen" >}}
...
Keeping a fish for food carries responsibility. Catch-and-release from [Req 7b](/merit-badges/fly-fishing/guide/req7b/) shows one form of respect. Harvesting a legal fish and using it well shows another. Waste is never respectful.

{{< drg/tip >}}
If you think you may keep a fish, bring what you need before the trip: a cooler or cold pack, a legal stringer if appropriate, a knife, and a cleaning plan. Good preparation prevents rushed bad decisions.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="FDA — Safe Minimum Internal Temperatures"
    url="https://www.foodsafety.gov/food-safety-charts/safe-minimum-internal-temperatures"
    description="Food safety guidance for cooking fish and other foods to safe temperatures." >}}

You are ready to go beyond the badge and explore where fly fishing can lead next.

{{< drg/next-page
    text="You now understand how to approach cleaning and cooking a fish lawfully, safely, and responsibly."
    teaser="Finish with ideas for deeper learning, real-world experiences, and organizations connected to fly fishing."
    url="/merit-badges/fly-fishing/guide/extended-learning/" >}}
