...
{{< drg/tip >}}
The best research comes from combining methods. Start with an internet search to get basic facts — founding date, charter number, early leaders — then interview a longtime Scouter to fill in the stories behind those facts. People remember details that never made it into written records.
{{< /drg/tip >}}
...
{{< drg/did-you-know >}}
Many Scout troops have been continuously active for over 100 years. If your troop has a long history, you may be carrying on traditions that stretch back to the earliest days of Scouting in America. Even relatively new troops have stories worth telling — every unit was started by someone with a reason and a vision.
{{< /drg/did-you-know >}}

**Planning note:** The people you interview for this requirement must be *different* from those you interview for [Requirement 8](/merit-badges/scouting-heritage/guide/req8/). Decide early who you will talk to for each requirement so there is no overlap.

If you completed [Requirement 4c](/merit-badges/scouting-heritage/guide/req4c/) by visiting a local exhibit or historian, some of what you learned there may also inform your research here — but this requirement asks for your own deeper investigation and a formal report.

{{< drg/next-page
    text="You have a plan for researching your own Scouting community's history."
    teaser="Build a collection of personal Scouting memorabilia for Requirement 6."
