...
req_number: "4b"
req_path: "4.b"
prev: "/merit-badges/scouting-heritage/guide/req4a/"
prev_title: "Req 4a — Jamboree or High Adventure Journal"
next: "/merit-badges/scouting-heritage/guide/req4c/"
next_title: "Req 4c — Local Scouting History Visit"
---
...
{{< drg/tip >}}
If you cannot visit in person, the virtual tour of the Philmont museum (linked below) is an excellent alternative. Take notes as you explore the virtual exhibits just as you would during an in-person visit — your counselor will expect the same depth of reflection either way.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="National Scouting Museum at Summit Bechtel Reserve Virtual Tour (video)"
    url="https://www.youtube.com/watch?v=QU8IcMvygmc&list=PLeqxtqwBBzS_SXfxztRYSvmUzirJSZ1SU&index=8" >}}

{{< drg/external-link
    title="National Scouting Museum at Philmont Virtual Tour (website)"
    url="https://www.philmontscoutranch.org/museums/national-scouting-museum-virtual-tour/"
    description="Explore the National Scouting Museum at Philmont through an interactive virtual tour — a great option if you cannot visit in person." >}}

{{< drg/next-page
    text="You have explored Option B for experiencing Scouting history."
    teaser="Learn about Option C — visiting a local Scouting exhibit or meeting with a council Scouting historian."
