...
{{< drg/tip >}}
Think about your own path. You probably started in Cub Scouts, moved into Scouts BSA, and maybe have friends in Venturing or Exploring. Your personal journey through these programs is a living example of how Scouting grew to serve different ages and interests — and your counselor will appreciate hearing that connection.
{{< /drg/tip >}}

## Official Resources

{{< drg/video
    title="Legacy Video Scouting History Timeline (video)"
    url="https://youtu.be/p8DUnLSK3Zo?si=ImcKI8FOY2CrZYue" >}}

{{< drg/video
    title="Artifact of the Week - Development of Cub Scouting (video)"
    url="https://youtu.be/p8DUnLSK3Zo?si=xIdh_FcI2SZ8JQ4a" >}}

{{< drg/video
    title="Artifact of the Week - Sea Scouts (video)"
    url="https://youtu.be/FxKOogN-oiU?si=dqO2hetBuV0FoTXg" >}}

{{< drg/external-link
    title="History of Exploring (website)"
    url="https://www.scouting.org/commissioners/exploring-a-bit-of-a-background/"
    description="A brief history of the Exploring program from Scouting America, covering its origins and evolution into a career-focused youth program." >}}

{{< drg/external-link
    title="20 Facts About Venturing (website)"
    url="https://blog.scoutingmagazine.org/2018/02/09/20-facts-about-venturing-on-the-programs-20th-birthday/"
    description="A fun overview of Venturing's history, milestones, and key facts from Scouting Magazine, published on the program's 20th anniversary." >}}

{{< drg/video
    title="Legacy Video Scouting History Timeline (video)"
    url="https://youtu.be/KavSY2fFb-4?si=BmKsD_8QHVTJ-pGd" >}}

{{< drg/next-page
    text="You understand how Scouting's programs grew to serve every age and interest."
    teaser="Experience Scouting history firsthand — choose a jamboree, museum, or local visit for Requirement 4."
