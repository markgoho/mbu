...
{{< drg/tip >}}
Kim's Game is one of the easiest games to prepare and teach. You only need a tray (or bandanna), 20-30 small objects, a cloth to cover them, and paper and pencils for each player. It works indoors or outdoors and is fun for any size group.
{{< /drg/tip >}}
...
{{< drg/external-link
    title="Troop Games - Large Area (website)"
    url="https://troopleader.scouting.org/activities/troop-games/troop-games-large-area/"
    description="A collection of Scout troop games designed for large outdoor areas — great for finding active games to teach." >}}

{{< drg/external-link
    title="Troop Games - Small Space (website)"
    url="https://troopleader.scouting.org/activities/troop-games/troop-games-small-space/"
    description="Scout troop games that work in small indoor or outdoor spaces — useful if your meeting location is limited." >}}

{{< drg/external-link
    title="Troop Games - Pre-Meeting (website)"
    url="https://troopleader.scouting.org/activities/troop-games/pre-opening-gathering-period-activities/"
    description="Quick games and activities for the pre-meeting gathering period — many of these are based on classic Scouting observation and skill games." >}}

{{< drg/next-page
    text="You have a plan for reproducing, teaching, and playing an old-time Scouting game."
    teaser="Interview former Scouts to learn how Scouting has impacted lives across generations."
