...
Organized by the World Organization of the Scout Movement (WOSM), the World Jamboree draws Scouts from more than 150 countries and is held every four years in a different host nation. Attending connects you to the global Scouting community that Baden-Powell envisioned — a powerful link to the history you studied in [Requirement 1](/merit-badges/scouting-heritage/guide/req1/).
...
{{< drg/tip >}}
Start your journal on the day you arrive and include your travel day. First impressions are often the most vivid, and your counselor will want to hear about the full arc of your experience — not just the highlights at the end.
{{< /drg/tip >}}
...
{{< drg/video
    title="100 Years of the World Scout Jamboree (video)"
    url="https://youtu.be/cpbtEAtIlWc?si=T4QAeuUnWo_uy9PT" >}}

{{< drg/video
    title="Scouting America High Adventure Overview (video)"
    url="https://youtu.be/EbC5b5dyBo0?si=0iu96JjlTcPaVrjq" >}}

{{< drg/next-page
    text="You have explored Option A for experiencing Scouting history."
    teaser="Learn about Option B — visiting or writing to the National Scouting Museum."
