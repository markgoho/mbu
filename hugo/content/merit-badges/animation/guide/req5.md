...
{{< drg/image src="images/animation-career-roles.avif" alt="Three side-by-side panels showing different animation careers: a character animator at a tablet bringing a digital character to life, a storyboard artist sketching sequential panels on a large drawing board, and a 3D modeler sculpting a virtual character on a dual-monitor setup" >}}
...
{{< drg/checklist title="Career Research Checklist" subtitle="For the career you choose to go deep on" >}}
...
{{< drg/external-link
    ...
    description="Official U.S. government data on animator salaries, job outlook, education requirements, and what animators do." >}}
...
{{< drg/next-page
    text="You have researched animation careers and found one that interests you."
    teaser="Explore advanced resources, real-world experiences, and organizations to continue your animation journey."
