...
{{< drg/image src="images/scout-animation-desk.avif" alt="A Scout sitting at a desk with a drawing tablet and laptop, sketching an animated character that appears to leap off the screen" >}}
...
{{< drg/did-you-know >}}
A 90-minute traditionally animated film can require over one million individual drawings. Teams of artists would work for years to complete a single movie.
{{< /drg/did-you-know >}}
...
{{< drg/image src="images/kinds-of-animation-collage.avif" alt="A split-panel collage showing five animation styles side by side: a hand-drawn pencil sketch of a character, a clay stop-motion figure on a miniature set, a colorful 2D digital character on a tablet screen, a 3D CGI robot model with wireframe visible, and a motion graphics title card with animated text" >}}
...
{{< drg/next-page
    text="You have explored the world of animation and its many forms."
    teaser="Learn how to describe animation in your own words and prepare for your counselor discussion."
    url="/merit-badges/animation/guide/req1a/" >}}
