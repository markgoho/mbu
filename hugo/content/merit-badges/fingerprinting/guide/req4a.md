---
title: "Official Fingerprint Cards"
layout: guide
group_title: "4. Taking Your Own Fingerprints"
req_number: "4a"
prev: "/merit-badges/fingerprinting/guide/req3c/"
prev_title: "Positive Identification"
next: "/merit-badges/fingerprinting/guide/req4b/"
next_title: "Tape and Pencil Method"
---
...
{{< drg/did-you-know >}}
The term "roll" comes from the original practice of literally rolling your finger across an ink pad and then across a card. It's the same technique used for over 100 years, and it works so well that modern law enforcement still uses it.
{{< /drg/did-you-know >}}
...
{{< drg/be-prepared title="You Want to Show Your Fingerprints to a Police Officer" >}}
If you complete this merit badge and want to show your fingerprints to law enforcement (with your parent's permission), here's what to expect:
- **Step One**: Find a local police officer or visit your local police station.
- **Step Two**: Explain that you're working on the Fingerprinting merit badge and have completed fingerprinting yourself.
- **Step Three**: Show them your official fingerprint card with rolled and plain impressions.
- **Step Four**: Ask them to explain what they see—they'll probably point out your ridge patterns, loops, and whorls.
- **Step Five**: If they're interested, they might explain how the print would be used in their department or show you photos of latent prints from crime scenes.
...
{{< drg/checklist title="Taking Rolled and Plain Impressions" subtitle="Checklist for completing this requirement" >}}
...
{{< drg/next-page
    text="You've successfully created an official fingerprint card with rolled and plain impressions,"
    teaser="now learn an alternative method using tape and pencil."
