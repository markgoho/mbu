...
{{< drg/did-you-know >}}
The FBI's AFIS system called NGIS (Next Generation Identification) can search 70 million fingerprints and return results in minutes. In the pre-AFIS era, the same search took weeks of manual card-filing.
{{< /drg/did-you-know >}}
...
{{< drg/safety-first >}}
Biometric fingerprint systems are convenient, but remember: once someone has your fingerprint data, they have it permanently. Make sure you enroll only with reputable companies and organizations. Check their privacy policy to understand how your biometric data will be stored and protected.
{{< /drg/safety-first >}}
...
{{< drg/be-prepared title="You Encounter a Fingerprint Scanner at the Airport" >}}
Here's what's happening when you scan your fingerprint at airport immigration:
- **Step One**: The scanner captures a high-quality image of your index or thumb.
- **Step Two**: It creates a digital template—a mathematical representation of your fingerprint's key features.
- **Step Three**: That template is compared to the template you enrolled when you got your passport or entered the trusted traveler program.
- **Step Four**: If they match with sufficient confidence, you're cleared. If not, a human agent reviews it manually.

The system is NOT connected to the criminal AFIS database (those are separate). It's verifying your identity against your own enrolled print, similar to how a smartphone fingerprint reader works.
{{< /drg/be-prepared >}}
...
{{< drg/next-page
    text="You've learned how AFIS and biometric systems use fingerprints in different ways,"
    teaser="now explore the broader world of authentication technology that keeps us secure."
