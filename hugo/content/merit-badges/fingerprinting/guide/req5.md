...
{{< drg/did-you-know >}}
Only about 5% of people have arch patterns on their fingertips. Arches are the least common pattern, which is one reason they're easy to identify—when you see one, you notice it's different from loops and whorls.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
A helpful way to remember: "ulnar" sounds like "outer," and ulnar loops open toward the outer edge of your hand (the pinky side). It's not a perfect memory aid, but it works for many people.
{{< /drg/tip >}}
...
{{< drg/be-prepared title="Showing Your Patterns to Your Counselor" >}}
When you meet with your counselor to show you can identify patterns, here's what to expect:
- **Step One**: Show your counselor your fingerprints (either recorded on a card, on tape, or on your actual hands).
- **Step Two**: Explain the pattern you see on each finger (arch, loop, or whorl).
- **Step Three**: For loops, specify whether it's radial or ulnar.
- **Step Four**: For whorls, identify the subcategory if you can (plain whorl, central pocket loop, double loop, or accidental).
- **Step Five**: Your counselor will ask clarifying questions to make sure you understand. They might ask, "Why did you identify that as a loop rather than a whorl?" or "Which side does this loop open?"

Be prepared to explain your reasoning.
{{< /drg/be-prepared >}}

{{< drg/checklist title="Identifying Your Fingerprint Patterns" subtitle="Checklist for this requirement" >}}
...
{{< drg/next-page
    text="You've learned to identify the patterns in your own fingerprints,"
    teaser="now explore careers that use fingerprinting and biometric skills."
