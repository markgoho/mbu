...
{{< drg/did-you-know >}}
Footprints are so unique that some hospitals still use them as backup identification for newborns, even though DNA testing is now available. A baby's footprint record can prove parentage decades later if needed.
{{< /drg/did-you-know >}}
...
{{< drg/tip >}}
When forensic examiners talk about "volar surfaces," they're referring to the palms, fingers, soles, and toes. When a detective says "We found a latent print on the doorknob," they almost always mean a fingerprint, but they could also mean a partial palm print or even a toe print, depending on the crime scene.
{{< /drg/tip >}}
...
{{< drg/next-page
    text="Now that you know where friction ridges are found,"
    teaser="explore the two fundamental principles that make fingerprints scientifically reliable."
