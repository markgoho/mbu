...
{{< drg/tip >}}
Some forensic examiners use graphite powder (sold for crime scene kits) instead of pencil graphite, but pencil graphite works just as well and is readily available.
{{< /drg/tip >}}
...
- **Step One**: Take your own fingerprints using the tape method.
- **Step Two**: Take a classmate's fingerprints using the same method.
- **Step Three**: Compare the tape impressions side by side.
- **Step Four**: Look for the ridge patterns—one person might have loops, the other whorls.
- **Step Five**: Notice that even though both people have similar ridge patterns overall (both probably have a mix of loops and whorls), the specific patterns are different.

This simple comparison demonstrates the principle of uniqueness—no two people have identical prints.
{{< /drg/be-prepared >}}

{{< drg/checklist title="Taking Fingerprints with Tape and Pencil" subtitle="Checklist for completing this requirement" >}}
...
{{< drg/next-page
    text="You've now created fingerprints using two different methods—ink and tape,"
    teaser="learn how to identify the three basic fingerprint patterns."
